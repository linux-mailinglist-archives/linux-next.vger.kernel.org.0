...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 37646596867
	for <lists+linux-next@lfdr.de>; Wed, 17 Aug 2022 07:13:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229737AbiHQFLP (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 17 Aug 2022 01:11:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49260 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229448AbiHQFLO (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 17 Aug 2022 01:11:14 -0400
Received: from mail-pf1-x42c.google.com (mail-pf1-x42c.google.com [IPv6:2607:f8b0:4864:20::42c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 18D4D6DF99
        for <linux-next@vger.kernel.org>; Tue, 16 Aug 2022 22:11:12 -0700 (PDT)
Received: by mail-pf1-x42c.google.com with SMTP id k14so11180942pfh.0
        for <linux-next@vger.kernel.org>; Tue, 16 Aug 2022 22:11:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc;
        bh=qjbs1nXovifI0N86IKj5Z+hjahToWAXpYl9vC5PnD3c=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=qjbs1nXovifI0N86IKj5Z+hjahToWAXpYl9vC5PnD3c=;
        b=
X-Gm-Message-State: ACgBeo2/OBZcYt+eN9Q26e8L/+aJbjaqCceq8/hMHc6UkDiN2y4o2du0
        pdSAE6wBghVF8XRkhtZliHPKagi+FotwoHne
X-Google-Smtp-Source: AA6agR6AI1egbjBPpXBDQlrEx5fBc15XehPeeKcTqJGd1lnGXugJRO+MNEVLYxDyNGfl2WEdlPaTtw==
X-Received: by 2002:a63:4511:0:b0:41d:70c0:ffbf with SMTP id s17-20020a634511000000b0041d70c0ffbfmr21093138pga.574.1660713070692;
        Tue, 16 Aug 2022 22:11:10 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id n5-20020a170903110500b0016d295888e3sm330341plh.241.2022.08.16.22.11.09
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 16 Aug 2022 22:11:09 -0700 (PDT)
Message-ID: <62fc786d.170a0220.a5fc8.09be@mx.google.com>
Date:   Tue, 16 Aug 2022 22:11:09 -0700 (PDT)
...
Subject: next/master build: 207 builds: 11 failed, 196 passed, 16 errors,
 56 warnings (next-20220817)
...
next/master build: 207 builds: 11 failed, 196 passed, 16 errors, 56 warning=
s (next-20220817)
...
=80=98-mhard-float=E2=80=99
    1    sound/soc/codecs/src4xxx.c:280:3: error: variable 'pj' is used uni=
nitialized whenever switch default is taken [-Werror,-Wsometimes-uninitiali=
zed]
    1    sound/soc/codecs/src4xxx.c:280:3: error: variable 'jd' is used uni=
nitialized whenever switch default is taken [-Werror,-Wsometimes-uninitiali=
zed]
    1    sound/soc/codecs/src4xxx.c:280:3: error: variable 'd' is used unin=
...
ted "0,0"
    ...
    1    sound/soc/codecs/src4xxx.c:223:20: note: initialize the variable '=
d' to silence this warning
    1    sound/soc/codecs/src4xxx.c:223:17: note: initialize the variable '=
jd' to silence this warning
    1    sound/soc/codecs/src4xxx.c:223:13: note: initialize the variable '=
