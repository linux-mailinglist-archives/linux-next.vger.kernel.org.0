...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C8860623E83
	for <lists+linux-next@lfdr.de>; Thu, 10 Nov 2022 10:24:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229750AbiKJJYs (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 10 Nov 2022 04:24:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49830 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229745AbiKJJYr (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 10 Nov 2022 04:24:47 -0500
Received: from mail-pl1-x635.google.com (mail-pl1-x635.google.com [IPv6:2607:f8b0:4864:20::635])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 78C735FCF
        for <linux-next@vger.kernel.org>; Thu, 10 Nov 2022 01:24:44 -0800 (PST)
Received: by mail-pl1-x635.google.com with SMTP id d20so957358plr.10
        for <linux-next@vger.kernel.org>; Thu, 10 Nov 2022 01:24:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=6KdCI6y6OHbjnir1F6BC6aluxQT3MScX2F9TdYLpaBw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=6KdCI6y6OHbjnir1F6BC6aluxQT3MScX2F9TdYLpaBw=;
        b=
X-Gm-Message-State: ACrzQf1nHDUHPP3cFG9R5lRTL/RcyZP+/iSCTGSkbJU5cd0NkcFmA79Y
        M39hygdBHZzLu2LPovjD2lrGMvoHVQAbgZNQrFc=
X-Google-Smtp-Source: AMsMyM4wtz5KXrOgdouMGXyfOidgvHWcacwr2QJ8/aHipVtZo4kV4OlKV2pvtVNQ58iqYz3ylAjCqQ==
X-Received: by 2002:a17:90b:1982:b0:212:fe7f:4a49 with SMTP id mv2-20020a17090b198200b00212fe7f4a49mr83913762pjb.156.1668072282271;
        Thu, 10 Nov 2022 01:24:42 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id s4-20020a170902ea0400b001837463f654sm10721408plg.251.2022.11.10.01.24.41
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 10 Nov 2022 01:24:41 -0800 (PST)
Message-ID: <636cc359.170a0220.f48a4.2032@mx.google.com>
Date:   Thu, 10 Nov 2022 01:24:41 -0800 (PST)
...
Subject: next/master build: 233 builds: 20 failed, 213 passed, 45 errors,
 577 warnings (next-20221110)
...
next/master build: 233 builds: 20 failed, 213 passed, 45 errors, 577 warnin=
gs (next-20221110)
...
Tree: next
Branch: master
Git Describe: next-20221110
Git Commit: 382d2f9e739bc6f151c718b38537ae522ff848cd
...
Errors summary:
    ...
    9    drivers/block/zram/zram_drv.c:1909:7: error: variable 'err' is use=
...
fined but not used [-Wunused-function]
    7    drivers/pwm/pwm-tegra.c:148:53: warning: result of =E2=80=98100000=
