...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 700103B1EEE
	for <lists+linux-next@lfdr.de>; Wed, 23 Jun 2021 18:46:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229755AbhFWQsf (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 23 Jun 2021 12:48:35 -0400
Received: from mx0a-001b2d01.pphosted.com ([148.163.156.1]:1906 "EHLO
        mx0a-001b2d01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S229523AbhFWQsf (ORCPT
        <rfc822;linux-next@vger.kernel.org>);
        Wed, 23 Jun 2021 12:48:35 -0400
Received: from pps.filterd (m0098396.ppops.net [127.0.0.1])
        by mx0a-001b2d01.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id 15NGXlNf037313;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from : message-id :
 ...
 mime-version; s=pp1; bh=DiJYOkT6JJO3u9sWc6zlFEtdtZAAXWO/hkPqGhEffhk=;
 b= lQ== 
Received: from ppma04ams.nl.ibm.com (63.31.33a9.ip4.static.sl-reverse.com [169.51.49.99])
        by mx0a-001b2d01.pphosted.com with ESMTP id 39c7xd20sd-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 23 Jun 2021 12:46:06 -0400
Received: from pps.filterd (ppma04ams.nl.ibm.com [127.0.0.1])
        by ppma04ams.nl.ibm.com (8.16.1.2/8.16.1.2) with SMTP id 15NGj9UM026322;
        Wed, 23 Jun 2021 16:46:04 GMT
Received: from b06cxnps3074.portsmouth.uk.ibm.com (d06relay09.portsmouth.uk.ibm.com [9.149.109.194])
        by ppma04ams.nl.ibm.com with ESMTP id 399878a469-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Wed, 23 Jun 2021 16:46:03 +0000
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (b06wcsmtp001.portsmouth.uk.ibm.com [9.149.105.160])
        by b06cxnps3074.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 15NGk1q225428398
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Wed, 23 Jun 2021 16:46:01 GMT
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id A484AA405F;
        Wed, 23 Jun 2021 16:46:01 +0000 (GMT)
Received: from b06wcsmtp001.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 25DB3A4054;
        Wed, 23 Jun 2021 16:46:00 +0000 (GMT)
Received: from smtpclient.apple (unknown [9.77.197.182])
        by b06wcsmtp001.portsmouth.uk.ibm.com (Postfix) with ESMTP;
        Wed, 23 Jun 2021 16:45:59 +0000 (GMT)
From:   Sachin Sant <sachinp@linux.vnet.ibm.com>
Message-Id: <5D874F72-B575-4830-91C3-8814A2B371CD@linux.vnet.ibm.com>
Content-Type: multipart/mixed;
        boundary="Apple-Mail=_0AC76155-CBD3-4EA5-9434-CF2F2CE307B1"
...
X-TM-AS-GCONF: 00
X-Proofpoint-ORIG-GUID: YhDLgySUPK-6lL7kEW5_kQZMm7kxSUBg
X-Proofpoint-GUID: YhDLgySUPK-6lL7kEW5_kQZMm7kxSUBg
X-Proofpoint-UnRewURL: 0 URL was un-rewritten
MIME-Version: 1.0
X-Proofpoint-Virus-Version: vendor=fsecure engine=2.50.10434:6.0.391,18.0.790
 definitions=2021-06-23_12:2021-06-23,2021-06-23 signatures=0
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 malwarescore=0 clxscore=1015
 ...
 engine=8.12.0-2104190000 definitions=main-2106230096
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org


--Apple-Mail=_0AC76155-CBD3-4EA5-9434-CF2F2CE307B1
Content-Type: text/plain;
	charset=us-ascii
Content-Transfer-Encoding: quoted-printable


> Ok. This becomes even more weird. Could you share your config file and mo=
re details about
> you setup ?
>=20
> Have you applied the patch below ?=20
> https://lore.kernel.org/lkml/20210621174330.11258-1-vincent.guittot@linar=
o.org/
>=20
> Regarding the load_avg warning, I can see possible problem during attach.=
 Could you add
> the patch below. The load_avg warning seems to happen during boot and sch=
ed_entity
> creation.
>=20

Here is a summary of my testing.=20

I have a POWER box with PowerVM hypervisor. On this box I have a logical pa=
rtition(LPAR) or guest
(allocated with 32 cpus 90G memory) running linux-next.=20
...
Applied patch #3 from Vincent which contains changes to attach_entity_load_=
avg()
Applied patch #4 from https://lore.kernel.org/lkml/20210621174330.11258-1-v=
incent.guittot@linaro.org/

With these changes applied I was still able to recreate the issue. I could =
see kernel warning
during boot.

I then applied patch #5 from Odin which contains changes to update_cfs_rq_l=
oad_avg()

With all the 5 patches applied I was able to boot the kernel without any wa=
rning messages.
...
Have also attached .config in case it is useful. config has CONFIG_HZ_100=
=3Dy
=20
Thanks
-Sachin
...
Content-Disposition: attachment;
	filename=config_next_powerpc.txt
Content-Type: text/plain;
	x-unix-mode=0644;
	name="config_next_powerpc.txt"
Content-Transfer-Encoding: quoted-printable

#
# Automatically generated file; DO NOT EDIT.
# Linux/powerpc 5.13.0-rc7 Kernel Configuration
#
CONFIG_CC_VERSION_TEXT=3D"gcc (GCC) 8.4.1 20200928 (Red Hat 8.4.1-1)"
CONFIG_CC_IS_GCC=3Dy
CONFIG_GCC_VERSION=3D80401
CONFIG_CLANG_VERSION=3D0
CONFIG_AS_IS_GNU=3Dy
CONFIG_AS_VERSION=3D23000
CONFIG_LD_IS_BFD=3Dy
CONFIG_LD_VERSION=3D23000
...
CONFIG_PPC_HAVE_KUEP=3Dy
CONFIG_PPC_KUEP=3Dy
CONFIG_PPC_HAVE_KUAP=3Dy
CONFIG_PPC_KUAP=3Dy
...
CONFIG_MQ_IOSCHED_DEADLINE_CGROUP=3Dy
...
CONFIG_HOTPLUG_PCI_POWERNV=3Dm
...
# CONFIG_SERIAL_CORTINA_ACCESS is not set
...
=
CONFIG_LSM=3D"yama,loadpin,safesetid,integrity,selinux,smack,tomoyo,apparm=
or"
