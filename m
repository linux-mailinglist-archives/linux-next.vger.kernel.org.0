...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id A491018AD63
	for <lists+linux-next@lfdr.de>; Thu, 19 Mar 2020 08:39:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727249AbgCSHje (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 19 Mar 2020 03:39:34 -0400
Received: from ozlabs.org ([203.11.71.1]:56975 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726063AbgCSHjd (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 19 Mar 2020 03:39:33 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48jf1W6jswz9sPR;
        Thu, 19 Mar 2020 18:39:27 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1584603568;
        bh=R5dQKFvPQiUR48Tiw/cI30xJi3rSsjULxx4Fy78ilNE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 19 Mar 2020 18:39:26 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 19
Message-ID: <20200319183926.23c571fb@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/9Su1lV6VK/kXJ7dO3jj.vF4";
...
Non-merge commits (relative to Linus' tree): 9215
 7837 files changed, 358153 insertions(+), 172877 deletions(-)
...
Merging origin/master (5076190daded mm: slub: be more careful about the dou=
ble cmpxchg of freelist)
Merging fixes/master (fb33c6510d55 Linux 5.6-rc6)
Merging kbuild-current/fixes (4b8a5cfb5fd3 modpost: Get proper section inde=
x by get_secindex() instead of st_shndx)
...
ux into arm/fixes)
Merging arm64-fixes/for-next/fixes (f50b7dacccba arm64: smp: fix crash_smp_=
send_stop() behaviour)
...
Merging net/master (2de9780f7507 net: core: dev.c: fix a documentation warn=
ing)
...
Merging sound-asoc-fixes/for-linus (c7a8aedc3f62 Merge branch 'asoc-5.6' in=
to asoc-linus)
Merging regmap-fixes/for-linus (87fc8230f7aa Merge branch 'regmap-5.6' into=
 regmap-linus)
Merging regulator-fixes/for-linus (e91587eaacc1 Merge branch 'regulator-5.6=
...
Merging xfs/for-next (8a6271431339 xfs: fix unmount hang and memory leak on=
 shutdown during quotaoff)
...
le' into for-next)
Merging pci/next (cf21d34fbdf6 Merge branch 'remotes/lorenzo/pci/vmd')
...
in imxfb_probe())
Merging pm/linux-next (c03d064a440c Merge branch 'pnp' into linux-next)
...
Merging rdma/for-next (026ded373483 RDMA/hns: Check if depth of qp is 0 bef=
ore configure)
Merging net-next/master (2c4b58dc75dd net: sched: Fix hw_stats_type setting=
 in pedit loop)
...
Merging drm-intel/for-linux-next (639e0db2d70f drm/i915/dp: Add dpcd link_r=
ate quirk for Apple 15" MBP 2017 (v3))
...
4x/j721e soc)
Merging tty/tty-next (089b6d365491 serial: 8250_port: Disable DMA operation=
s for kernel console)
...
rflow
Merging akpm/master (01fc3617f9f7 drivers/media/platform/sti/delta/delta-ip=
...

=Ax2W
-----END PGP SIGNATURE-----
