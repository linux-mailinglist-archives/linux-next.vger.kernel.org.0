Return-Path: <linux-next+bounces-9378-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id CB414CAEB1F
	for <lists+linux-next@lfdr.de>; Tue, 09 Dec 2025 03:11:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CF4C63022F25
	for <lists+linux-next@lfdr.de>; Tue,  9 Dec 2025 02:11:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C0BEB274B46;
	Tue,  9 Dec 2025 02:11:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="c5NfZaEh"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4ADCF1DDC3F;
	Tue,  9 Dec 2025 02:10:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765246265; cv=none; b=QVto884X+HgcGFN8iJrjMPK0mAzovb0i/4V2yJxUyMXexY0AW+P+lxq4uN8l6BLRAZMmXPQC0PPKLEjYoH8sqNiSB96lgSEExbK2ff7rvsc8hFBeN5YBFB/Ylp4+S+0uieSsfd7p0Mxc2rL9woBq86+iz7pH9h64F7N46zz7ll0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765246265; c=relaxed/simple;
	bh=efydW0xxmO237B0oZZk0S3pEFtSBtWToBy3jCUMl4os=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=njoB3q0BNlXW0gUd4MXUxNaGKAmBYH+wTlfJQA5rbz8aCRx+A/o/EsqedjIY8JhwkKzsrF4SQt5xiHR/KaxteYMLoZbl84+bm3Bn25PJ1m0qhdjxo4xn1dXNPu+ojqFRtWPvKJx9QdA6mQwwbEA14Fhz36PzVhSOrWfXwZmOY+o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=c5NfZaEh; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1765246250;
	bh=1jzNG94ZeyG6p4keITJr7buhfFkqwUhv3NAc71lCOuo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dQMlG5fgKz4wHF;
	Tue, 09 Dec 2025 13:10:50 +1100 (AEDT)
Date: Tue, 9 Dec 2025 13:10:50 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 9
Message-ID: <20251209131050.7688df86@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/QaDtnuQGBwxGj+81Mw8C9IM";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/QaDtnuQGBwxGj+81Mw8C9IM
...
Changes since 20251208:

The mm-hotfixes tree still had its build failure for which I reverted
3 commits.

Non-merge commits (relative to Linus' tree): 1296
 1462 files changed, 139542 insertions(+), 18998 deletions(-)
...
Merging origin/master (c2f2b01b74be Merge tag 'i3c/for-6.19' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/i3c/linux)
...
Merging btrfs-fixes/next-fixes (3072f7801555 Merge branch 'misc-6.19' into =
next-fixes)
...
Merging ceph/master (d64d92b4a2f6 rbd: stop selecting CRC32, CRYPTO, and CR=
YPTO_AES)
Merging cifs/for-next (d8f52650b24d smb/client: update some SMB2 status str=
ings)
...
t_extent())
Merging f2fs/dev (76ee7fd6af68 f2fs: ignore discard return value)
...
och_work())
Merging gfs2/for-next (afcbce74f358 Merge tag 'gfs2-for-6.19' of git://git.=
...
ezable kthread)
Merging ksmbd/ksmbd-for-next (6461f77077e7 smb: server: defer the initial r=
...
n-persistent dentry)
Merging mm-hotfixes/mm-hotfixes-unstable (75ec05fd4496 kasan-unpoison-vms-a=
ddresses-with-a-common-tag-v4)
Applying: Revert "kasan-unpoison-vms-addresses-with-a-common-tag-v4"
Applying: Revert "kasan-unpoison-vms-addresses-with-a-common-tag-fix"
Applying: Revert "kasan: unpoison vms[area] addresses with a common tag"
Merging fs-current (a6d10bbef33b Merge branch 'nfsd-fixes' of https://git.k=
...
Merging net/main (0373d5c387f2 bnxt_en: Fix XDP_TX path)
Merging bpf/master (861111b69896 net: smc: SMC_HS_CTRL_BPF should depend on=
 BPF_JIT)
Merging ipsec/master (8f7aa3d3c732 Merge tag 'net-next-6.19' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/netdev/net-next)
Merging netfilter/main (0373d5c387f2 bnxt_en: Fix XDP_TX path)
...
Merging sound-current/for-linus (9a97857db0c5 ALSA: uapi: Fix typo in asoun=
d.h comment)
Merging sound-asoc-fixes/for-linus (e4deadb3e562 Merge remote-tracking bran=
ch 'asoc/for-6.18' into asoc-linus)
Merging regmap-fixes/for-linus (6146a0f1dfae Linux 6.18-rc4)
Merging regulator-fixes/for-linus (99fece7ab29c Merge remote-tracking branc=
...
Merging pci-current/for-linus (43dfc13ca972 Merge tag 'pci-v6.19-changes' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/pci/pci)
Merging driver-core.current/driver-core-linus (67a454e6b1c6 Merge tag 'memb=
lock-6.19-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/rppt/memblo=
ck)
Merging tty.current/tty-linus (7d0a66e4bb90 Linux 6.18)
Merging usb.current/usb-linus (67a454e6b1c6 Merge tag 'memblock-6.19-rc1' o=
...
Merging staging.current/staging-linus (67a454e6b1c6 Merge tag 'memblock-6.1=
9-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/rppt/memblock)
...
Merging char-misc.current/char-misc-linus (67a454e6b1c6 Merge tag 'memblock=
-6.19-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/rppt/memblock)
...
_* confusion)
Merging hwmon-fixes/hwmon (08bfcf4ff9d3 docs: hwmon: fix link to g762 devic=
etree binding)
...
Merging devicetree-fixes/dt/linus (b907e826b941 arm64: kdump: Fix elfcorehd=
r overlap caused by reserved memory processing reorder)
...
Merging gpio-brgl-fixes/gpio/for-current (2d967310c49e gpiolib: acpi: Add q=
uirk for Dell Precision 7780)
...
Merging trace-fixes/trace/fixes (c5108c58b991 tracing: Fix typo in trace_se=
q.c)
Merging tracefs-fixes/tracefs/fixes (8b55572e5180 tracing/selftests: Add tr=
acefs mount options test)
Merging spacemit-fixes/fixes (3a8660878839 Linux 6.18-rc1)
Merging tip-fixes/tip/urgent (7f6bf3ad36e6 Merge branch into tip/master: 'x=
86/urgent')
Merging slab-fixes/slab/for-next-fixes (0f35040de593 mm/slab: introduce kvf=
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (a585c7ef9cab drm/tilcdc: Fix r=
emoval actions in case of failed probe)
...
der inclusion)
Merging mm-unstable/mm-unstable (ecc46e02e0ab mm/damon/tests/core-kunit: av=
oid damos_test_commit stack warning)
Merging mm-nonmm-unstable/mm-nonmm-unstable (f38557294736 mm: memfd_luo: ad=
d CONFIG_SHMEM dependency)
Merging kbuild/kbuild-next (2a9c8c0b59d3 kbuild: add target to build a cpio=
 containing modules)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (2eeb09fe1c51 libperf: Use 'extern' in LIBPERF=
_API visibility macro)
...
Merging fs-next (5126caab6189 Merge branch 'vfs.all' of https://git.kernel.=
...
e)
Merging i2c-host/i2c/i2c-host (25faa5364638 i2c: spacemit: fix detect issue)
...
Merging amdgpu/drm-next (35bb80e68329 drm/amdgpu: pass the entity to use to=
 ttm public functions)
...
Merging drm-xe/drm-xe-next (b64a14334ef3 drm/xe/throttle: Skip reason prefi=
x while emitting array)
...
Merging sound/for-next (9a97857db0c5 ALSA: uapi: Fix typo in asound.h comme=
nt)
Merging ieee1394/for-next (036176d9dba7 firewire: core: abort pending trans=
actions at card removal)
Merging sound-asoc/for-next (e4deadb3e562 Merge remote-tracking branch 'aso=
...
Merging block/for-next (2690a553fb6c Merge branch 'io_uring-6.19' into for-=
next)
Merging device-mapper/for-next (58a0cbb4f70a dm pcache: fix segment info in=
dexing)
...
Merging regulator/for-next (99fece7ab29c Merge remote-tracking branch 'regu=
...
18' into spi-linus)
Merging tip/master (5e8f8a25efb2 Merge branch into tip/master: 'x86/boot')
...
Merging sched-ext/for-next (12b5cd99a05f sched/ext: Avoid null ptr traversa=
l when ->put_prev_task() is called with NULL next)
Merging drivers-x86/for-next (4df66a74d2a5 Merge branch 'intel-sst' of http=
s://github.com/spandruvada/linux-kernel into for-next)
...
PMI driver)
Merging driver-core/driver-core-next (67a454e6b1c6 Merge tag 'memblock-6.19=
-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/rppt/memblock)
Merging usb/usb-next (67a454e6b1c6 Merge tag 'memblock-6.19-rc1' of git://g=
...
Merging tty/tty-next (75a9f4c54770 serial: sh-sci: Fix deadlock during RSCI=
 FIFO overrun error)
Merging char-misc/char-misc-next (67a454e6b1c6 Merge tag 'memblock-6.19-rc1=
...
Merging staging/staging-next (67a454e6b1c6 Merge tag 'memblock-6.19-rc1' of=
...
lock and friends)
Merging hyperv/hyperv-next (615a6e7d83f9 mshv: Cleanly shutdown root partit=
ion with MSHV)
...
Merging turbostat/next (34aad5f39d3a tools/power turbostat: Harden against =
unexpected values)
...

=+Ica
-----END PGP SIGNATURE-----
