...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 91B9F7980BE
	for <lists+linux-next@lfdr.de>; Fri,  8 Sep 2023 04:59:29 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233603AbjIHC7a (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 7 Sep 2023 22:59:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60852 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229948AbjIHC7a (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 7 Sep 2023 22:59:30 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 149D31BD9;
        Thu,  7 Sep 2023 19:59:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1694141961;
        bh=yuWznI/96Q6OVsO69sHLmdCuqU5rpC9U599MeKotT5o=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Rhgn52HxSz4x5M;
        Fri,  8 Sep 2023 12:59:21 +1000 (AEST)
Date:   Fri, 8 Sep 2023 12:59:20 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 8
Message-ID: <20230908125920.4db436e2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/MR5sA8l90w+IhVXk353.i6j";
...
Changes since 20230907:

Non-merge commits (relative to Linus' tree): 1121
 1499 files changed, 266176 insertions(+), 21031 deletions(-)
...
Merging origin/master (ff6e6ded5472 Merge tag 'rtc-6.6' of git://git.kernel=
...
Merging net/main (1b36955cc048 net: enetc: distinguish error from valid poi=
nters in enetc_fixup_clear_rss_rfs())
Merging bpf/master (08c6d8bae48c net: phy: Provide Module 4 KSZ9477 errata =
(DS80000754C))
...
n in DMA mode)
Merging pci-current/for-linus (8ec9c1d5d0a5 PCI: Free released resource aft=
er coalescing)
Merging driver-core.current/driver-core-linus (7ba2090ca64e Merge tag 'ceph=
-for-6.6-rc1' of https://github.com/ceph/ceph-client)
Merging tty.current/tty-linus (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of=
 https://github.com/ceph/ceph-client)
Merging usb.current/usb-linus (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of=
 https://github.com/ceph/ceph-client)
Merging usb-serial-fixes/usb-linus (706a74159504 Linux 6.5-rc7)
Merging phy/fixes (52a93d39b17d Linux 6.5-rc5)
Merging staging.current/staging-linus (7ba2090ca64e Merge tag 'ceph-for-6.6=
...
Merging char-misc.current/char-misc-linus (7ba2090ca64e Merge tag 'ceph-for=
-6.6-rc1' of https://github.com/ceph/ceph-client)
...
Merging spdx/spdx-linus (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of https=
...
o mm-everything)
Merging kbuild/for-next (65d6e954e378 Merge tag 'gfs2-v6.5-rc5-fixes' of gi=
...
ite-only variable)
Merging risc-v/for-next (accb14aa1e69 soc: renesas: Kconfig: For ARCH_R9A07=
...
Merging cifs/for-next (30bded94dcef cifs: update internal module version nu=
mber for cifs.ko)
...
Merging bluetooth/master (f2fc183c43e4 Bluetooth: ISO: Pass BIG encryption =
info through QoS)
...
Merging crypto/master (85b9bf9a514d Revert "dt-bindings: crypto: qcom,prng:=
 Add SM8450")
Merging drm/drm-next (d9809d242ff5 Merge tag 'drm-misc-next-fixes-2023-09-0=
...
linus)
Merging ieee1394/for-next (fd416616d099 firewire: allow deactivating the IE=
EE1394 menuconfig section at once)
...
A mode)
Merging tip/master (5a76e238b904 Merge branch into tip/master: 'x86/asm')
...
Merging driver-core/driver-core-next (7ba2090ca64e Merge tag 'ceph-for-6.6-=
rc1' of https://github.com/ceph/ceph-client)
Merging usb/usb-next (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of https://=
github.com/ceph/ceph-client)
...
Merging tty/tty-next (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of https://=
github.com/ceph/ceph-client)
Merging char-misc/char-misc-next (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1'=
...
Merging staging/staging-next (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of =
https://github.com/ceph/ceph-client)
...

=uHgE
-----END PGP SIGNATURE-----
