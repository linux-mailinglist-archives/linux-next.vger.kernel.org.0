Return-Path: <linux-next+bounces-3971-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 33FCD986BDA
	for <lists+linux-next@lfdr.de>; Thu, 26 Sep 2024 06:53:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id D83852833BD
	for <lists+linux-next@lfdr.de>; Thu, 26 Sep 2024 04:53:28 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B03DC4120B;
	Thu, 26 Sep 2024 04:53:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="ZfG11BVx"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4BAE31D5AA2;
	Thu, 26 Sep 2024 04:53:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727326406; cv=none; b=KXb9Sm8GEyGFbwdan9g4JQCF1nvnliIi5zLTJiEiBJllNRQFOk+PyuSPjJrgHhIMrgiWZ7eV0jChuo6IFEEoMmkoS7bALBHDePjzXC327SKyHC4SqtEKHZCheTIai9ZOZVpp+uglV29Wv+wOTOb3vYl1V9am1sGH4c+Efb+Hvaw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727326406; c=relaxed/simple;
	bh=C3wgLx47zqveg8hCwer5TTej4hfzCBVlVingNJtolkQ=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=T/RFLDCt03p+Z2P8QkyO0z6qFM3FOKRB+ZGPmQFBsCVkc2Y6Qa5nX81qU3wnUvUQWFd+2dKGDNA8Sl/dmXrNtFIA4G3bxzHQCEX+qx6LKPogrMT6shhP9bv6JZCOTNpaP1ovGTEsOnTPb6B7Cj8WYQ4FuzSpL20XGriPkA9Gcgs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=ZfG11BVx; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1727326396;
	bh=zNoUULiFjO5pI0KnkNRqIVO2KQLN8d4gYdsWHW+JSHo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XDh7J14KRz4xQX;
	Thu, 26 Sep 2024 14:53:16 +1000 (AEST)
Date: Thu, 26 Sep 2024 14:53:15 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 26
Message-ID: <20240926145315.711b1c6c@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/GSpFgyrn++YQPIPZJ6EVauX";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/GSpFgyrn++YQPIPZJ6EVauX
...
Changes since 20240925:

I have dropped the -unstable parts of the mm tree (apart from the
hotfixes-unstable part) until the merge window closes.

My build of Linus' tree failed for which I reverted some commits from
the rust tree merge.

Non-merge commits (relative to Linus' tree): 1666
 1748 files changed, 55588 insertions(+), 30515 deletions(-)
...
Merging origin/master (11a299a7933e Merge tag 'for-6.12/block-20240925' of =
git://git.kernel.dk/linux)
Merging fixes/fixes (18afec8706e7 Revert "rust: cfi: add support for CFI_CL=
ANG with Rust")
...
Merging cifs/for-next (e8f847b67396 smb: client: stop flooding dmesg in smb=
2_calc_signature())
...
_to_fd())
Merging mm-hotfixes/mm-hotfixes-unstable (f46eedd3c070 ocfs2: fix uninit-va=
lue in ocfs2_get_block())
Merging fs-current (44591a176fa1 Merge branch 'nfsd-fixes' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/cel/linux)
Merging kbuild-current/fixes (684a64bf32b6 Merge tag 'nfs-for-6.12-1' of gi=
t://git.linux-nfs.org/projects/anna/linux-nfs)
...
Merging bpf/master (8b62645b09f8 bpf: Use raw_spinlock_t in ringbuf)
...
Merging i2c-host-fixes/i2c/i2c-host-fixes (512b4969597c i2c: xiic: Fix pm_r=
...
Merging drm-misc-fixes/for-linux-next-fixes (8b0d2f615455 drm: Consistently=
 use struct drm_mode_rect for FB_DAMAGE_CLIPS)
...
Merging perf/perf-tools-next (f115506d2ce4 perf evsel: display dmesg comman=
d of showing a hardcoded path)
...
Merging fs-next (3f392c9ba99b Merge branch 'vfs.all' of git://git.kernel.or=
...
raw_spinlock_t)
Merging hid/for-next (defaec3988b8 Merge branch 'for-6.12/upstream-fixes' i=
nto for-next)
Merging i2c/i2c/for-next (f69a9516e557 Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
Merging i2c-host/i2c/i2c-host (c8338a1a918c MAINTAINERS: Add AMD ASF driver=
 entry)
...
Merging bluetooth/master (257d7307d348 Bluetooth: hci_event: Align BR/EDR J=
UST_WORKS paring with LE)
...
ntf fails for hmac)
Merging drm/drm-next (d7126c0cfc13 Merge tag 'drm-xe-next-fixes-2024-09-19'=
...
Merging amdgpu/drm-next (d52ac79053a2 drm/amdkfd: Add SDMA queue quantum su=
pport for GFX12)
...
ile lock usage.)
  02fdf821ed79 ("drm/xe/guc: Fix GUC_{SUBMIT,FIRMWARE}_VER helper macros")
  3b04c2cfd71c ("drm/xe/bo: add some annotations in bo_put()")
  9ba0e0f30ca4 ("drm/xe/oa: Fix overflow in oa batch buffer")
  f96dbf7c321d ("drm/xe: Do not run GPU page fault handler on a closed VM")
  fbd73b7d2ae2 ("drm/xe/client: use mem_type from the current resource")
...
Merging fbdev/for-next (81a361c86d61 fbdev: omapfb: Call of_node_put(ep) on=
ly once in omapdss_of_find_source_for_first_ep())
...
Merging block/for-next (b1be535eb2e5 Merge branch 'for-6.12/block' into for=
-next)
...
11' into spi-linus)
Merging tip/master (f441318ec664 Merge branch into tip/master: 'x86/splitlo=
ck')
...
o for-next)
Merging sched-ext/for-next (a748db0c8c6a tools/sched_ext: Receive misc upda=
tes from SCX repo)
...
sysfs entries)
Merging driver-core/driver-core-next (eb46cb321f1f Revert "driver core: don=
't always lock parent in shutdown")
...

=rG/S
-----END PGP SIGNATURE-----
