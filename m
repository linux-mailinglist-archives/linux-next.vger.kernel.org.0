...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6C73857C97B
	for <lists+linux-next@lfdr.de>; Thu, 21 Jul 2022 13:02:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232925AbiGULCZ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 21 Jul 2022 07:02:25 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56516 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232927AbiGULCW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 21 Jul 2022 07:02:22 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A21EF45F74;
        Thu, 21 Jul 2022 04:02:18 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LpV5M0GT7z4x1k;
        Thu, 21 Jul 2022 21:02:15 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1658401335;
        bh=G8qsA9thVPgqETAS4mykVkVJNW9FDph+j9RTZ8JCgXM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 21 Jul 2022 21:02:13 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 21
Message-ID: <20220721210214.043ada3e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/q3zOXQtpJ_r3.g9gtP0=Av2";
...
The arm64 builds are broken in this tree (my arm64 asm skills are
non-existant).

The perf tree gained a build failure for which I installed a new Python
package.

The asm-generic tree fixed up its build failure.
...
Non-merge commits (relative to Linus' tree): 11348
 11146 files changed, 1100832 insertions(+), 286601 deletions(-)
...
Merging origin/master (353f7988dd84 watchqueue: make sure to serialize 'wqu=
eue->defunct' properly)
...
Merging arm64-fixes/for-next/fixes (f7b4c3b82e7d arm64: set UXN on swapper =
page tables)
...
Merging net/master (44484fa8eedf Merge tag 'linux-can-fixes-for-5.19-202207=
20' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can)
...
or-linus)
Merging sound-asoc-fixes/for-linus (dadd02077b14 Merge remote-tracking bran=
...
t MP5496 ranges)
Merging spi-fixes/for-linus (e1502ba41699 spi: spi-cadence: Fix SPI NO Slav=
e Select macro definition)
...
er for_each macros)
Merging perf/perf/core (41d0914d861e perf python: Ignore unused command lin=
e arguments when building with clang)
...
Merging arm-soc/for-next (25658fbe9abb Merge branch 'arm/drivers' into for-=
next)
...
Merging s390/for-next (5fcd0d8ae23a s390/uvdevice: autoload module based on=
 CPU facility)
...
Merging erofs/dev (cd084cb3db6e erofs: get rid of erofs_prepare_dio() helpe=
r)
...
erspace)
Merging net-next/master (47f058ce9807 Merge tag 'mlx5-updates-2022-07-17' o=
...
pi-r2-pro.dts
Merging bpf-next/for-next (9cb61fda8c71 bpf: Fix bpf_trampoline_{,un}link_c=
group_shim ifdef guards)
...
Merging bluetooth/master (f7913b8db3c4 Bluetooth: hci_sync: Correct hci_set=
_event_mask_page_2_sync() event mask)
...
Merging drm-misc/for-linux-next (6f2c8d5f1659 drm/amdgpu: Fix for drm buddy=
 memory corruption)
Merging amdgpu/drm-next (1f3221352b1e drm/amd/display: reduce stack size in=
 dcn32 dml (v2))
...
Merging block/for-next (ed14e5d60a21 Merge branch 'for-5.20/drivers-post' i=
nto for-next)
...
Applying: fix for "md: simplify md_open"
...
Merging spi/for-next (960f6d94ca4c Merge remote-tracking branch 'spi/for-5.=
20' into spi-next)
...

=SNt4
-----END PGP SIGNATURE-----
