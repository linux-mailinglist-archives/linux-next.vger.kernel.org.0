Return-Path: <linux-next+bounces-9388-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id CB16BCB480B
	for <lists+linux-next@lfdr.de>; Thu, 11 Dec 2025 03:03:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id C61163011AA7
	for <lists+linux-next@lfdr.de>; Thu, 11 Dec 2025 02:03:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B230C28D8DF;
	Thu, 11 Dec 2025 02:03:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="e/toQEFY"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8857C1EFF80;
	Thu, 11 Dec 2025 02:03:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765418630; cv=none; b=I5SE8l87CEcnJ6gvhAdCuLSvpstGP5KzA7X0bLQu6ogwChsU/xFxhApRX9IHPW82IPCFvI7eDybaRUUpIuvKjJEVlrG9VlXJvQvOVBgQi/L3bEuzHuQf9wfqXK6n3lbTfSUW9zLQzt7fbdleEpT1rr6lQjqUZ+baThcZvr2DU18=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765418630; c=relaxed/simple;
	bh=GAG00prqhlco74jN6KVOvgS8AH2K/R98z21A6AGbM1o=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=G42Hey/0bMC/B5pDlOcq0UKX6vEesNleg9wryjGWVULqMz7kDte+V/sNUXo41a29cNqThDzt4MgQH0zVkq5ewhFokKTWZb07qnx5RaavRtHkiGa0HNvzrcPZwm8iBzMM2dRa3WoiqPqd+tD+9eJk/3/EZyzjlQ8JaWem/aG9NcE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=e/toQEFY; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1765418622;
	bh=LJwPG3QLo/5odcGG9FUNCPyjoJ8K+lEqbFJsqkOlRno=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dRbV6275nz4w9j;
	Thu, 11 Dec 2025 13:03:42 +1100 (AEDT)
Date: Thu, 11 Dec 2025 13:03:40 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 11
Message-ID: <20251211130340.7b1c283f@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/7sOT/s_I.5Ndvd6iiddHsZK";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/7sOT/s_I.5Ndvd6iiddHsZK
...
Merging origin/master (0048fbb4011e Merge tag 'locking-futex-2025-12-10' of=
...
YPTO_AES)
Merging cifs/for-next (dcbc073956fa smb: update struct duplicate_extents_to=
_file_ex)
...
Merging fs-current (6325ed25cea4 Merge branch 'nfsd-fixes' of https://git.k=
...
Merging net/main (6bcb7727d9e6 Merge branch 'inet-frags-flush-pending-skbs-=
in-fqdir_pre_exit')
...
Merging sound-current/for-linus (161a0c617ab1 ALSA: hda: intel-dsp-config: =
Prefer legacy driver as fallback)
...
Merging tip-fixes/tip/urgent (c8991df4f68a Merge branch into tip/master: 'x=
86/urgent')
...
Merging fs-next (c4d4c1d1357c Merge branch 'vfs.all' of https://git.kernel.=
...
Merging drm-xe/drm-xe-next (1898840d6c44 drm/xe/guc: Recommend GuC v70.54.0=
 for BMG, PTL)
...
Merging sound/for-next (161a0c617ab1 ALSA: hda: intel-dsp-config: Prefer le=
gacy driver as fallback)
...
Merging mailbox/for-next (e1fe978a07c7 mailbox: mtk-cmdq: Remove unsued cmd=
q_get_shift_pa())
$ git reset --hard HEAD^
Merging next-20251210 version of mailbox
Merging spi/for-next (865a1f17d5e4 Merge remote-tracking branch 'spi/for-6.=
18' into spi-linus)
Merging tip/master (62fb2425af02 Merge branch into tip/master: 'x86/boot')
...

=I8cn
-----END PGP SIGNATURE-----
