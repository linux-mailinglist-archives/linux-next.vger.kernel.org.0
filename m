...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E9185597D8B
	for <lists+linux-next@lfdr.de>; Thu, 18 Aug 2022 06:34:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242890AbiHREaE (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 18 Aug 2022 00:30:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45706 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238358AbiHREaD (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 18 Aug 2022 00:30:03 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CB82A868A0;
        Wed, 17 Aug 2022 21:29:59 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4M7X3h3Qhbz4x1P;
        Thu, 18 Aug 2022 14:29:52 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1660796992;
        bh=U704uciC0Nf3psMZ6X+BSJTxMdRmYwwZioZQiquk5VU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 18 Aug 2022 14:29:48 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 18
Message-ID: <20220818142948.20ea2a62@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/rv3R6HQAJUeyayyC9dhQX9Z";
...
New tree: vfs-idmapping

The icc tree gained a build failure so I used the version from
next-20220817.

Non-merge commits (relative to Linus' tree): 1588
 2438 files changed, 71709 insertions(+), 32248 deletions(-)
...
Merging origin/master (3b06a2755758 Merge tag 'ntfs3_for_6.0' of https://gi=
thub.com/Paragon-Software-Group/linux-ntfs3)
...
Merging kbuild-current/fixes (65c526495879 kbuild: fix the modules order be=
tween drivers and libs)
...
Merging net/master (36c0d9350157 net: dsa: microchip: ksz9477: fix fdb_dump=
 last invalid entry)
Merging bpf/master (14b20b784f59 bpf: Restrict bpf_sys_bpf to CAP_PERFMON)
...
Merging sound-asoc-fixes/for-linus (c6e14bb9f50d ASoC: qcom: sm8250: add mi=
ssing module owner)
...
Merging devicetree-fixes/dt/linus (2f945a792f67 of: fdt: fix off-by-one err=
or in unflatten_dt_nodes())
...
Merging drm-fixes/drm-fixes (568035b01cfb Linux 6.0-rc1)
...
Merging risc-v-fixes/fixes (eb6354e11630 riscv: Ensure isa-ext static keys =
are writable)
...
Merging drm-misc-fixes/for-linux-next-fixes (cf36ae3e5802 Merge drm/drm-fix=
...
Merging drivers-memory/for-next (a17fbf2cb7a2 Merge branch 'for-v6.1/brcm-s=
tb' into for-next)
...
Merging pidfd/for-next (6a857ab5b57c Merge branch 'fs.idmapped.overlay.acl'=
 into for-next)
Merging vfs-idmapping/for-next (bf1ac16edf67 fs: require CAP_SYS_ADMIN in t=
arget namespace for idmapped mounts)
Merging fscrypt/master (a3c001190799 fscrypt: remove fscrypt_set_test_dummy=
_encryption())
Merging fscache/fscache-next (0885eacdc81f Merge tag 'nfsd-5.19-1' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/cel/linux)
Merging afs/afs-next (26291c54e111 Linux 5.17-rc2)
Merging btrfs/for-next (59b53e36cd8c Merge branch 'for-next-next-v6.0-20220=
817' into for-next-20220817)
Merging ceph/master (a8af0d682ae0 libceph: clean up ceph_osdc_start_request=
 prototype)
Merging cifs/for-next (f08791fd0061 cifs: remove unused server parameter fr=
om calc_smb_size())
...
_release_private())
Merging vfs/for-next (47091e4ed9af dma_buf_getfile(): don't bother with ->f=
_flags reassignments)
...
EVX indirect mkey)
Merging net-next/master (fd78d07c7c35 Merge branch 'net-dsa-bcm_sf2-utilize=
-phylink-for-all-ports')
Merging bpf-next/for-next (df78da27260c selftests/bpf: Few fixes for selfte=
sts/bpf built in release mode)
Merging ipsec-next/master (7ebfc85e2cd7 Merge tag 'net-6.0-rc1' of git://gi=
...
Merging regmap/for-next (81c0386c1376 regmap: mmio: Support accelerared noi=
nc operations)
Merging sound/for-next (90d74fdbd805 ALSA: hda/realtek: Add quirk for Clevo=
 NS50PU, NS70PU)
Merging sound-asoc/for-next (c66ce9ad5500 Merge remote-tracking branch 'aso=
...
1' into spi-next)
Merging tip/master (8bc016bdd48d Merge branch into tip/master: 'core/urgent=
')
...
Merging icc/icc-next (c86cfdbaf8e3 Merge branch 'icc-ignore-return-val' int=
o icc-next)
$ git reset --hard HEAD^
Merging next-20220817 version of icc
...
Merging staging/staging-next (654d1855bc40 staging: r8188eu: make rtw_init_=
recv_timer() static)
...

=iS0M
-----END PGP SIGNATURE-----
