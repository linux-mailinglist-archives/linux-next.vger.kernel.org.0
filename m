...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D274D19E96C
	for <lists+linux-next@lfdr.de>; Sun,  5 Apr 2020 06:49:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726300AbgDEEte (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 5 Apr 2020 00:49:34 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:34463 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726219AbgDEEte (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sun, 5 Apr 2020 00:49:34 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48w1RS552Dz9sPF;
        Sun,  5 Apr 2020 14:49:24 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1586062164;
        bh=k4XGNGOwUZcPSaesSjK022OlvJE8I+8VA5INLq59uxg=;
        h=Date:From:To:Cc:Subject:From;
        b=
...
Message-ID: <20200405144919.2fb00abd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/qz7oKSj+mC8jFlzCR9a.5hd";
...
Changes since 20200404:

The ide tree gained a build failure for which I applied a pacteh.

The rcu tree gained a build failure for which I reverted a comit.

Non-merge commits (relative to Linus' tree): 2214
 2078 files changed, 73650 insertions(+), 26489 deletions(-)
...
Merging origin/master (4c205c84e249 Merge tag 'keys-fixes-20200329' of git:=
...
double free of ptr)
Merging ide/master (6a0033457f23 drivers/ide: convert to list_for_each_entr=
y_safe())
...
Merging drm-misc/for-linux-next (cc46c03397c1 Merge drm/drm-next into drm-m=
isc-next-fixes)
...
Merging rcu/rcu/next (c9a503a8ebd2 rcu: Remove self-stack-trace when all qu=
iescent states seen)
CONFLICT (content): Merge conflict in tools/memory-model/litmus-tests/.giti=
gnore
Applying: Revert "ftrace: Use synchronize_rcu_tasks_rude() instead of ftrac=
e_sync()"
...
Applying: drivers/ide: fix for conversion
...
rflow
Merging akpm/master (e793b3276816 drivers/media/platform/sti/delta/delta-ip=
...

=Z/rQ
-----END PGP SIGNATURE-----
