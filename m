...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2294C59D077
	for <lists+linux-next@lfdr.de>; Tue, 23 Aug 2022 07:29:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239928AbiHWF0g (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 23 Aug 2022 01:26:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55044 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238497AbiHWF0g (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 23 Aug 2022 01:26:36 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7DAB35C9C3;
        Mon, 22 Aug 2022 22:26:32 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4MBd4k2CKLz4x1P;
        Tue, 23 Aug 2022 15:26:30 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1661232390;
        bh=65op3u1fqJnnDxcYtHF6FCPAbmaYLymp+4/1bQ5hrak=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 23 Aug 2022 15:26:29 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 23
Message-ID: <20220823152629.01249b33@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/oMklV9EJg1n1OpvSzbwaKgK";
...
--Sig_/oMklV9EJg1n1OpvSzbwaKgK
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220822:
...
Non-merge commits (relative to Linus' tree): 2118
 3208 files changed, 135371 insertions(+), 53985 deletions(-)
...
Merging origin/master (072e51356cd5 Merge tag 'nfs-for-5.20-2' of git://git=
.linux-nfs.org/projects/trondmy/linux-nfs)
Merging fixes/fixes (4a57a8400075 vf/remap: return the amount of bytes actu=
ally deduplicated)
Merging mm-hotfixes/mm-hotfixes-unstable (8821290d01aa mm/damon/dbgfs: avoi=
d duplicate context directory creation)
...
Merging net/master (f1e941dbf80a nfc: pn533: Fix use-after-free bugs caused=
 by pn532_cmd_timeout)
...
Merging sound-asoc-fixes/for-linus (221ab1f0bf46 ASoC: mediatek: mt8186: fi=
x DMIC record noise)
...
Merging usb.current/usb-linus (8d1e09cfbd4d Merge tag 'thunderbolt-for-v6.0=
...
Merging devicetree-fixes/dt/linus (272da4d49f3c dt-bindings: display: arm,v=
ersatile-tft-panel: Drop erroneous properties in example)
...
lnierkiewicz)
Merging scmi/for-linux-next (cb8931783ba1 Merge branch 'for-next/scmi' of g=
...
Merging btrfs/for-next (4172f9ecd2ef Merge branch 'for-next-next-v6.0-20220=
822' into for-next-20220822)
Merging ceph/master (a8af0d682ae0 libceph: clean up ceph_osdc_start_request=
 prototype)
Merging cifs/for-next (1c23f9e627a7 Linux 6.0-rc2)
...
l to strscpy)
Merging net-next/master (704438dd4f03 net: prestera: cache port state for n=
on-phylink ports too)
...
Merging drm-misc/for-linux-next (ee50b0024408 drm/panel-edp: add AUO B133UA=
N02.1 panel entry)
...
Merging drm-intel/for-linux-next (48bc9d5245a4 drm/i915/dsc/mtl: Enable alt=
ernate ICH method)
...
Merging drm-msm-lumag/msm-next-lumag (f45c07d9c908 Merge branch 'msm-next-l=
...
Merging regmap/for-next (176f0bef61a9 Merge remote-tracking branch 'regmap/=
for-6.1' into regmap-next)
Merging sound/for-next (b01104fc62b6 ALSA: usb-audio: Add quirk to enable A=
vid Mbox 3 support)
Merging sound-asoc/for-next (94703fa73e33 Merge remote-tracking branch 'aso=
...
ice support)
Merging block/for-next (15e543410e9b Merge branch 'for-6.1/block' into for-=
next)
...
Merging regulator/for-next (778b8d36ca5a Merge remote-tracking branch 'regu=
...
Merging devicetree/for-next (7a12dd077e52 of: move from strlcpy with unused=
 retval to strscpy)
...
interrupts)
Merging spi/for-next (1cf18fa9731c Merge remote-tracking branch 'spi/for-6.=
1' into spi-next)
...
Merging mm/mm-everything (4c36875d094e Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...

=m0/v
-----END PGP SIGNATURE-----
