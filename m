...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B39617ACF47
	for <lists+linux-next@lfdr.de>; Mon, 25 Sep 2023 06:53:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229578AbjIYExE (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 25 Sep 2023 00:53:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38750 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229504AbjIYExD (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 25 Sep 2023 00:53:03 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 24044C2;
        Sun, 24 Sep 2023 21:52:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1695617572;
        bh=t0Jeb8PdGoCg9+tTP0K2xBWT3UuyVYhVn1jAssub00g=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Rv9VD5p35z4wxd;
        Mon, 25 Sep 2023 14:52:52 +1000 (AEST)
Date:   Mon, 25 Sep 2023 14:52:52 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 25
Message-ID: <20230925145252.5bf3c563@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/KGwU=Cv+//MhPl1EGcJkcfg";
...
--Sig_/KGwU=Cv+//MhPl1EGcJkcfg
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20230921:

The qcom tree lost its build failure.

The pmdomain tree gained a conflict against the asahi-soc tree.
...
Non-merge commits (relative to Linus' tree): 6967
 5020 files changed, 486851 insertions(+), 135652 deletions(-)
...
Merging mm-hotfixes/mm-hotfixes-unstable (f9911db48293 mm: zswap: fix poten=
tial memory corruption on duplicate store)
...
e())
Merging wireless/for-next (684e45e120b8 wifi: mt76: mt76x02: fix MT76x0 ext=
ernal LNA gain handling)
...
Merging drm-fixes/drm-fixes (b41b28366d3b MAINTAINERS: remove myself as nou=
veau maintainer)
...
Merging gpio-brgl-fixes/gpio/for-current (5cb9606a901a gpio: sim: fix an in=
valid __free() usage)
...
stem to pmdomain)
Merging drm-misc-fixes/for-linux-next-fixes (f75f71b2c418 fbdev/sh7760fb: D=
epend on FB=3Dy)
Merging mm-stable/mm-stable (ce9ecca0238b Linux 6.6-rc2)
Merging mm-nonmm-stable/mm-nonmm-stable (ce9ecca0238b Linux 6.6-rc2)
Merging mm/mm-everything (3fb939749744 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging imx-mxs/for-next (8728c381dac2 Merge branch 'imx/defconfig' into fo=
r-next)
...
or-next)
Merging scmi/for-linux-next (b35ca7ae2cda Merge branches 'for-next/scmi/fix=
...
Merging nfsd/nfsd-next (dc3bc4295f70 NFSD: Rename nfsd4_encode_fattr())
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (e5029ac8418d Merge branch 'vfs.misc' into vfs.=
all)
...
to for-next)
Merging i2c/i2c/for-next (80977d5a0692 Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
...
93 sensor driver)
Merging pm/linux-next (57594c77e5b2 Merge branch 'acpi-fixes' into linux-ne=
xt)
...
Merging bpf-next/for-next (831916fb93d4 Merge branch 'libbpf: Support symbo=
l versioning for uprobe')
...
ng vhci device)
Merging wireless-next/for-next (5ee7b2ea07cc wifi: rtw89: load TX power rel=
ated tables from FW elements)
...
- add missing escape)
Merging drm-misc/for-linux-next (217b812364d3 accel/qaic: Add QAIC_DETACH_S=
LICE_BO IOCTL)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (6a18ae51d265 drm/i915/display: Print disp=
lay info inside driver display initialization)
...
ith __counted_by)
Merging sound-asoc/for-next (bb594b80a608 Merge remote-tracking branch 'aso=
...
7' into spi-next)
Merging tip/master (b996cbe1203c Merge branch into tip/master: 'x86/tdx')
...
Merging kspp/for-next/kspp (5fb07db970cf lkdtm/bugs: add test for panic() w=
ith stuck secondary CPUs)
...

=/0o6
-----END PGP SIGNATURE-----
