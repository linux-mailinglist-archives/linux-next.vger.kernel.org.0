Return-Path: <linux-next+bounces-724-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 4961682A920
	for <lists+linux-next@lfdr.de>; Thu, 11 Jan 2024 09:29:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 970491F245F9
	for <lists+linux-next@lfdr.de>; Thu, 11 Jan 2024 08:29:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 00341DF4F;
	Thu, 11 Jan 2024 08:29:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="JRqcRX6O"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pl1-f170.google.com (mail-pl1-f170.google.com [209.85.214.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0455DDDD3
	for <linux-next@vger.kernel.org>; Thu, 11 Jan 2024 08:28:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pl1-f170.google.com with SMTP id d9443c01a7336-1d3ef33e68dso35505815ad.1
        for <linux-next@vger.kernel.org>; Thu, 11 Jan 2024 00:28:54 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1704961734; x=1705566534; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=r0B2ohsC4FR4kI3sSrkOfnZ6ETY4oDJ0kpoA7hbAv2w=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704961734; x=1705566534;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=r0B2ohsC4FR4kI3sSrkOfnZ6ETY4oDJ0kpoA7hbAv2w=;
        b=
X-Gm-Message-State: AOJu0YzomLXT4a7vZoJCKgIWGFhv/dORc6+Q2r4LdCHVQTQDv9kwJCfL
	1IjgGZlwRnOsqxXApIN2qWNCyoiMz9UyRJ/mHfJSRJlmiRlE5A==
X-Google-Smtp-Source: AGHT+IGtWV1LqJo21Je8HOEQ/HfaLQizCi3ZaDOjPNgQ3SqVXUidg++9vTXTHk7jbhowIESp8pG83w==
X-Received: by 2002:a17:902:8609:b0:1d5:731a:ac7e with SMTP id f9-20020a170902860900b001d5731aac7emr532081plo.35.1704961732433;
        Thu, 11 Jan 2024 00:28:52 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id d4-20020a170902cec400b001d3c0074f33sm610462plg.170.2024.01.11.00.28.51
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 11 Jan 2024 00:28:51 -0800 (PST)
Message-ID: <659fa6c3.170a0220.9f7f3.1374@mx.google.com>
Date: Thu, 11 Jan 2024 00:28:51 -0800 (PST)
...
Subject: next/master build: 178 builds: 14 failed, 164 passed, 15 errors,
 384 warnings (next-20240111)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 178 builds: 14 failed, 164 passed, 15 errors, 384 warnin=
gs (next-20240111)
...
Tree: next
Branch: master
Git Describe: next-20240111
Git Commit: 9e21984d62c56a0f6d1fc6f76b646212cfd7fe88
...
i386:
    allnoconfig (clang-17): 3 warnings
...
mips:
    ...
    omega2p_defconfig (gcc-10): 3 warnings
    ...
    rt305x_defconfig (gcc-10): 3 warnings
    sb1250_swarm_defconfig (gcc-10): 16 warnings
    vocore2_defconfig (gcc-10): 3 warnings
...
Errors summary:
    ...
    6    mm/vmalloc.c:4691:25: error: variable 'addr' is uninitialized when=
...
32 is out of the bounds [0, 0] [-Werror=3Darray-bounds]
    2    include/linux/fortify-string.h:402:12: error: writing 1 byte into =
...
Warnings summary:
    ...
    16   mm/vmalloc.c:4691:8: warning: =E2=80=98addr=E2=80=99 is used unini=
tialized in this function [-Wuninitialized]
    14   mm/vmalloc.c:4684:20: note: initialize the variable 'addr' to sile=
nce this warning
...
t 32 is out of the bounds [0, 0] [-Warray-bounds]
    ...
    8    mm/vmalloc.c:4691:25: warning: variable 'addr' is uninitialized wh=
...
Section mismatches summary:
    ...
    2    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x18 (section: .text.unlikely) -> vmlist (section: .init.data)
    2    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x16 (section: .text) -> vmlist (section: .init.data)
    2    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x14 (section: .text.unlikely) -> vmlist (section: .init.data)
    2    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x10 (section: .text.unlikely) -> vmlist (section: .init.data)
    1    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x40 (section: .text.unlikely) -> (unknown) (section: .init.da=
ta)
    1    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x34 (section: .text.unlikely) -> (unknown) (section: .init.da=
ta)
    1    WARNING: modpost: vmlinux: section mismatch in reference: vmap_ini=
t_free_space+0x28 (section: .text.unlikely) -> vmlist (section: .init.data)
...
Section mismatches:
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x34 (section: .text.unlikely) -> (unknown) (section: .init.data)
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x40 (section: .text.unlikely) -> (unknown) (section: .init.data)
...
---------------------------------------------------------------------------=
-----
allnoconfig (x86_64, clang-17) =E2=80=94 PASS, 0 errors, 3 warnings, 0 sect=
ion mismatches

Warnings:
    mm/vmalloc.c:4691:25: warning: variable 'addr' is uninitialized when us=
ed here [-Wuninitialized]
    mm/vmalloc.c:4684:20: note: initialize the variable 'addr' to silence t=
his warning
    1 warning generated.
...
---------------------------------------------------------------------------=
-----
allnoconfig (i386, clang-17) =E2=80=94 PASS, 0 errors, 3 warnings, 0 sectio=
n mismatches
...
Warnings:
    mm/vmalloc.c:4691:8: warning: =E2=80=98addr=E2=80=99 is used uninitiali=
...
Section mismatches:
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x28 (section: .text.unlikely) -> vmlist (section: .init.data)
...
Section mismatches:
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x14 (section: .text.unlikely) -> vmlist (section: .init.data)
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x14 (section: .text.unlikely) -> vmlist (section: .init.data)
...
Errors:
    mm/vmalloc.c:4691:25: error: variable 'addr' is uninitialized when used=
...
---------------------------------------------------------------------------=
-----
omega2p_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 se=
ction mismatches
...
---------------------------------------------------------------------------=
-----
rt305x_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 sec=
tion mismatches
...
Section mismatches:
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x10 (section: .text.unlikely) -> vmlist (section: .init.data)
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x18 (section: .text.unlikely) -> vmlist (section: .init.data)
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x10 (section: .text.unlikely) -> vmlist (section: .init.data)
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x18 (section: .text.unlikely) -> vmlist (section: .init.data)
...
---------------------------------------------------------------------------=
-----
vocore2_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 se=
ction mismatches
...
Section mismatches:
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x16 (section: .text) -> vmlist (section: .init.data)
    WARNING: modpost: vmlinux: section mismatch in reference: vmap_init_fre=
e_space+0x16 (section: .text) -> vmlist (section: .init.data)
