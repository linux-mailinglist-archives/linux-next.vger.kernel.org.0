...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CC5AB743227
	for <lists+linux-next@lfdr.de>; Fri, 30 Jun 2023 03:14:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231681AbjF3BN7 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 29 Jun 2023 21:13:59 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40440 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230106AbjF3BNz (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 29 Jun 2023 21:13:55 -0400
Received: from mail-pf1-x42e.google.com (mail-pf1-x42e.google.com [IPv6:2607:f8b0:4864:20::42e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AB9742681
        for <linux-next@vger.kernel.org>; Thu, 29 Jun 2023 18:13:52 -0700 (PDT)
Received: by mail-pf1-x42e.google.com with SMTP id d2e1a72fcca58-668709767b1so943484b3a.2
        for <linux-next@vger.kernel.org>; Thu, 29 Jun 2023 18:13:52 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1688087631; x=1690679631;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=J/jRE5YTqg1EDqG8JcpNbDW1B+mbvsUkjrGQ+TDN6ak=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1688087631; x=1690679631;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=J/jRE5YTqg1EDqG8JcpNbDW1B+mbvsUkjrGQ+TDN6ak=;
        b=
X-Gm-Message-State: ABy/qLZeO/dLMneVhYryp7qSFrx2PABkjIyVer9a3FGqfzTvp9Sgy2pq
        rIUE/Lk6hlXTDUs6gqY6+UHCfagXdGuXwjsJ4Gd0qQ==
X-Google-Smtp-Source: APBJJlEHa99I3w3GBmt1VvJusfdRALP0MdBrm7vgAK8R1XrMVGY1EvjnoiTrqvZirbNKun6IuuiHgA==
X-Received: by 2002:a05:6a00:179a:b0:668:99aa:3f17 with SMTP id s26-20020a056a00179a00b0066899aa3f17mr1599952pfg.16.1688087630962;
        Thu, 29 Jun 2023 18:13:50 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id j25-20020aa78dd9000000b006687b4f2044sm8886987pfr.164.2023.06.29.18.13.49
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 29 Jun 2023 18:13:50 -0700 (PDT)
Message-ID: <649e2c4e.a70a0220.91618.25d1@mx.google.com>
Date:   Thu, 29 Jun 2023 18:13:50 -0700 (PDT)
...
Subject: next/pending-fixes build: 174 builds: 6 failed, 168 passed, 10 errors,
 40 warnings (v6.4-8718-g6b8b1f7dba504)
...
next/pending-fixes build: 174 builds: 6 failed, 168 passed, 10 errors, 40 w=
arnings (v6.4-8718-g6b8b1f7dba504)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v6.4-8718-g6b8b1f7dba504/

Tree: next
Branch: pending-fixes
Git Describe: v6.4-8718-g6b8b1f7dba504
Git Commit: 6b8b1f7dba5043f44735d95d500faf1104dc3484
...
sparc:
    ...
    sparc32_defconfig (gcc-10): 1 error, 1 warning
...
=80=98-mhard-float=E2=80=99
    3    arch/sparc/mm/fault_32.c:315:42: error: =E2=80=98regs=E2=80=99 und=
...
vec_from_user.part.0() with UACCESS enabled
    7    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [=
-Wcpp]
...
---------------------------------------------------------------------------=
-----
allnoconfig (sparc, gcc-10) =E2=80=94 FAIL, 1 error, 1 warning, 0 section m=
ismatches

Errors:
    arch/sparc/mm/fault_32.c:315:42: error: =E2=80=98regs=E2=80=99 undeclar=
...
---------------------------------------------------------------------------=
-----
sparc32_defconfig (sparc, gcc-10) =E2=80=94 FAIL, 1 error, 1 warning, 0 sec=
tion mismatches
