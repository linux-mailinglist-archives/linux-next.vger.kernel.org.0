...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6BEF44AE98B
	for <lists+linux-next@lfdr.de>; Wed,  9 Feb 2022 06:53:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229623AbiBIFxR (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 9 Feb 2022 00:53:17 -0500
Received: from gmail-smtp-in.l.google.com ([23.128.96.19]:57724 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229817AbiBIFw1 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 9 Feb 2022 00:52:27 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DB68BC0302DC;
        Tue,  8 Feb 2022 21:52:28 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Jtptg2Z6yz4xcp;
        Wed,  9 Feb 2022 16:52:27 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1644385947;
        bh=k2h7r52PmKQqqEnu9p70dnodda0JXsQRU89cNNQgoFw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 9 Feb 2022 16:52:26 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 9
Message-ID: <20220209165226.727b0dac@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/SOabUQA3wEgSY3rQmoyugUH";
...
--Sig_/SOabUQA3wEgSY3rQmoyugUH
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220208:
...
Non-merge commits (relative to Linus' tree): 4097
 4488 files changed, 170944 insertions(+), 62826 deletions(-)
...
Merging origin/master (e6251ab4551f Merge tag 'nfs-for-5.17-2' of git://git=
...
Merging net/master (fe4f57bf7b58 net: phy: marvell: Fix RGMII Tx/Rx delays =
...
-linus)
Merging sound-asoc-fixes/for-linus (4c33de0673ce ASoC: rt5682: do not block=
 workqueue if card is unbound)
...
Merging spi-fixes/for-linus (ba8681733dbc Merge remote-tracking branch 'spi=
...
Merging gpio-brgl-fixes/gpio/for-current (cc38ef936840 gpio: sifive: use th=
e correct register to read output values)
...
1-next)
Merging drivers-memory/for-next (5b8950b4a7a5 Merge branch 'for-v5.18/media=
tek' into for-next)
...
Merging cifs/for-next (cf16d89f3707 cifs: call helper functions for marking=
 channels for reconnect)
...
Merging pm/linux-next (1e2d75f89fc7 Merge branch 'acpi-pm' into linux-next)
...
to variable nreq)
Merging net-next/master (c3e676b98326 Merge branch 'inet-separate-dscp-from=
-ecn-bits-using-new-dscp_t-type')
Merging bpf-next/for-next (19face1093b0 Merge branch 'fix bpf_prog_pack bui=
ld errors')
$ git reset --hard HEAD^
...
c_link_dp.c
Merging drm-intel/for-linux-next (053f2b856313 drm/i915: Fix mbus join conf=
ig lookup)
...
Merging sound/for-next (8f85b4da579e kselftest: alsa: fix spelling mistake =
"desciptor" -> "descriptor")
Merging sound-asoc/for-next (960a89045e14 ASoC: SOF: dma-trace: Change trac=
e_init() ops parameter list)
...
Merging spi/for-next (c17756beacf4 spi: Add compatible for Mediatek MT8186)
...
isting file)
Merging gpio-brgl/gpio/for-next (4f351edd2675 dt-bindings: gpio: gpio-vf610=
: Add imx93 compatible string)
...
Merging random/master (ebd8ad64804d random: fix locking in crng_fast_load())
...
Merging akpm-current/current (d92f5865fe03 ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
CONFLICT (content): Merge conflict in lib/Kconfig.debug
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (707bc2c50c04 Merge branch 'akpm-current/current')
...

=W09Z
-----END PGP SIGNATURE-----
