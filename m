...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8B0C045E72C
	for <lists+linux-next@lfdr.de>; Fri, 26 Nov 2021 06:24:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237669AbhKZF1n (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 26 Nov 2021 00:27:43 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:49431 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1348927AbhKZFZn (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 26 Nov 2021 00:25:43 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4J0jmj3kfXz4xZ0;
        Fri, 26 Nov 2021 16:22:29 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1637904149;
        bh=5KpnCtB1TL9T1/BGPFB/LflLZR/eRPwEsxU5pss0ubk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 26 Nov 2021 16:22:28 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 26
Message-ID: <20211126162228.276a83d9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/aPUjiwHK3e1FNfvlDMEYS41";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/aPUjiwHK3e1FNfvlDMEYS41
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211125:
...
Non-merge commits (relative to Linus' tree): 3263
 3698 files changed, 144192 insertions(+), 57194 deletions(-)
...
Merging origin/master (8ced7ca35703 Merge tag 'block-5.16-2021-11-25' of gi=
...
Merging net/master (9dbe33cf371b mdio: aspeed: Fix "Link is Down" issue)
...
-linus)
Merging sound-asoc-fixes/for-linus (8ca2f82c97ac Merge remote-tracking bran=
...
n IRQ helper docs)
Merging spi-fixes/for-linus (0e1ecfda2c5b Merge remote-tracking branch 'spi=
...
inter dereference)
Merging parisc-hd/for-next (9322b7ebb4a2 parisc: Avoid using hardware singl=
e-step in kprobes)
...
Merging fuse/for-next (3e2b6fdbdc9a fuse: send security context of inode on=
 file)
Merging gfs2/for-next (562edb33af8c gfs2: remove redundant set of INSTANTIA=
TE_NEEDED)
Merging jfs/jfs-next (c48a14dca2cb JFS: fix memleak in jfs_mount)
Merging ksmbd/ksmbd-for-next (178ca6f85aa3 ksmbd: fix memleak in get_file_s=
tream_info())
...
Merging hwmon-staging/hwmon-next (32556f31d0bc hwmon: (k10temp) Support up =
to 12 CCDs on AMD Family of processors)
...
ode)
Merging pm/linux-next (a3f78507f993 Merge branch 'pm-sleep' into linux-next)
...
Merging net-next/master (305e95bb893c net-ipv6: changes to ->tclass (via IP=
V6_TCLASS) should sk_dst_reset())
Merging bpf-next/for-next (2fe256a429cb selftests/bpf: Migrate selftests to=
 bpf_map_create())
...
Merging drm-misc/for-linux-next (11632d4aa2b3 drm/bridge: megachips: Ensure=
 both bridges are probed before registration)
...
Merging drm-intel-gt/for-linux-next-gt (16d69a891970 Merge drm/drm-next int=
o drm-intel-gt-next)
...
ce assignment)
Merging sound-asoc/for-next (2b9c8d2b3c89 ASoC: rt5640: Add the HDA header =
support)
...
t)
Merging block/for-next (de5de0813b7d Merge branch 'for-5.17/block' into for=
-next)
...
Merging pcmcia/pcmcia-next (e39cdacf2f66 pcmcia: i82092: fix a null pointer=
 dereference bug)
Merging mmc/next (500660564028 mmc: sdhci-pci: Add PCI ID for Intel ADL)
...
apacity lookup)
Merging regulator/for-next (432dd1fc134e regulator: rohm-generic: remove un=
used dummies)
...
Merging iommu/next (a8f52558a79f iommu/rockchip: Fix PAGE_DESC_HI_MASKs for=
 RK3568)
...
LP S4 MU)
Merging spi/for-next (e10a6bb5f52d spi: bcm-qspi: set transfer parameter on=
ly if they change)
...
kqueue)
Merging driver-core/driver-core-next (393c3714081a kernfs: switch global ke=
rnfs_rwsem lock to per-fs lock)
...
Merging tty/tty-next (136057256686 Linux 5.16-rc2)
...
Merging phy-next/next (97ba12d3feca phy: bcm-ns-usb2: improve printing ref =
clk errors)
...
d domains)
Applying: Revert "vsock/virtio: suppress used length validation"
...
Merging pinctrl-intel/for-next (6b4542664c2d pinctrl: baytrail: Set IRQCHIP=
_SET_TYPE_MASKED flag on the irqchip)
...
Merging akpm-current/current (e6070f7f44f4 configs: introduce debug.config =
for CI-like setup)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (cb8100695ec6 lib/stackdepot: allow optional init and s=
...

=7KgA
-----END PGP SIGNATURE-----
