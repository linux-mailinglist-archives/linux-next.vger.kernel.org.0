Return-Path: <linux-next+bounces-4328-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id C28929A34DD
	for <lists+linux-next@lfdr.de>; Fri, 18 Oct 2024 07:59:11 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 14A4E1F22E69
	for <lists+linux-next@lfdr.de>; Fri, 18 Oct 2024 05:59:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3FA14186616;
	Fri, 18 Oct 2024 05:55:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="kYxZhEPI"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 293CF17D346;
	Fri, 18 Oct 2024 05:54:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1729230903; cv=none; b=MmzojlOO/tUnjiqq6AIFTybMCPlJAZPr5PjqJu7mDaaSpDs5aFquMQWoevA7Yuqb71DwT/spAOFgLIaUZgYhqlpjqAegJiOE74dOZ48tVqf1RuWYKQJotmQPCNMMJxHE4ALAOlHOCZgllCAAz8EqCVhVbM+Hq7oBf/l3RuobTcM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1729230903; c=relaxed/simple;
	bh=8H/5a9ue4Fc+eHE1DppFJ3kY4PFVCF5YPj8azLlSznE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=faAl06Xm0LLLs6ErqMSmvb3tveYqG2vM/4vY1so5uoJMAfpb4W2KD5zSCTWndImkrrEYAhz2F5Y7VE4epdLrUjSOGYXJj7K1wq1ns1/Xb7t33v2pP9eeSRgUvfJSC6lA9ZpEMGLEtVa0mns+uB0Oir3hhS5JzvBmx1Vsy8war0g=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=kYxZhEPI; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1729230891;
	bh=EjfgJy4O4jmpcJ2y7fDjrMhWC3VVmWsaXY8o5Z9X+4s=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XVDSC6NzRz4wcs;
	Fri, 18 Oct 2024 16:54:51 +1100 (AEDT)
Date: Fri, 18 Oct 2024 16:54:51 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 18
Message-ID: <20241018165451.65b4780c@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/H51jMRTaJhczYImCYHAqAnW";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/H51jMRTaJhczYImCYHAqAnW
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241017:

The vfs-brauner-fixes tree lost its build failure.
...
Non-merge commits (relative to Linus' tree): 4919
 6684 files changed, 216319 insertions(+), 191544 deletions(-)
...
Merging origin/master (6efbea77b390 Merge tag 'arm64-fixes' of git://git.ke=
...
Merging vfs-brauner-fixes/vfs.fixes (610a79ffea02 afs: Fix lock recursion)
...
Merging nfsd/nfsd-next (0f8b1a418425 lockd: Remove unneeded initialization =
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (7101637b8871 Merge branch 'vfs.exportfs' into =
...
Merging mm-hotfixes/mm-hotfixes-unstable (3fa1175f6aa0 mm: numa_clear_kerne=
l_node_hotplug: Add NUMA_NO_NODE check for node id)
Merging fs-current (f25590b9d416 Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (cb560795c8c2 Merge branch 'mlx5-misc-fixes-2024-10-15')
...
nd functions)
Merging usb.current/usb-linus (30c9ae5ece8e xhci: dbc: honor usb transfer s=
ize boundaries.)
...
Merging drm-fixes/drm-fixes (49ff3e79a7f4 Merge tag 'drm-misc-fixes-2024-10=
-17' of https://gitlab.freedesktop.org/drm/misc/kernel into drm-fixes)
...
Merging drm-misc-fixes/for-linux-next-fixes (c09c4f2a972c drm/ast: vga: Cle=
ar EDID if no display is connected)
...
Merging mm/mm-everything (f4d8d0b514e1 foo)
Merging kbuild/for-next (f8746e3712be kconfig: remove zconfprint())
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (05a62936e6b1 perf dso: Fix symtab_type for km=
od compression)
...
' into for-next)
Merging arm64/for-next/core (cc7330592e19 Merge branch 'for-next/mops' into=
 for-next/core)
...
Merging risc-v/for-next (5fb0ecf73e7a riscv: defconfig: enable gpio support=
 for TH1520)
...
Merging uml/next (1e3071d629b2 um: Disable auto variable initialization for=
 stub_exe.c)
Merging xtensa/xtensa-for-next (b7cf2a1d9881 xtensa: remove redundant flush=
_dcache_page and ARCH_IMPLEMENTS_FLUSH_DCACHE_PAGE macros)
Merging fs-next (6c45b06c22f3 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging hwmon-staging/hwmon-next (51da05bd3492 hwmon: (isl28022) new driver=
 for ISL28022 power monitor)
...
ic)
Merging net-next/main (ff1d3484d6d2 net: ethernet: ti: am65-cpsw: Fix unini=
tialized variable)
...
Merging bpf-next/for-next (fbc520739752 Merge branch 'bpf-next/master' into=
 bpf-next/for-next)
Merging ipsec-next/master (e60fa8ebc2af Merge branch 'ethtool-rss-track-rss=
-ctx-busy-from-core')
...
nce)
Merging drm/drm-next (c391220314a8 Merge tag 'drm-misc-next-2024-10-17' of =
...
Merging drm-misc/for-linux-next (128a9bf8ace2 drm/rockchip: Add basic RK358=
8 HDMI output support)
Merging amdgpu/drm-next (3d73327b748b drm/amdgpu/swsmu: add automatic param=
eter to set_soft_freq_range)
  144df260f3da ("drm/amdgpu/mes: fix issue of writing to the same log buffe=
r from 2 MES pipes")
  336568de918e ("drm/amdgpu/swsmu: default to fullscreen 3D profile for dGP=
Us")
  3b6e7d40649c ("drm/radeon: Fix encoder->possible_clones")
  40f2cd98828f ("drm/amdgpu: prevent BO_HANDLES error from being overwritte=
n")
  580ad7cbd4b7 ("drm/amdgpu/swsmu: Only force workload setup on init")
  62f38b4ccaa6 ("drm/amdgpu/smu13: always apply the powersave optimization")
  98c0b0efcc11 ("drm/amdkfd: Accounting pdd vram_usage for svm")
  bfaf1883605f ("drm/amd/amdgpu: Fix double unlock in amdgpu_mes_add_ring")
  dc8847b054fd ("drm/amdgpu: enable enforce_isolation sysfs node on VFs")
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/dc/dc_typ=
es.h
Merging drm-intel/for-linux-next (595798297432 drm/i915: Fix irq related do=
cumentation)
...
eback on SM6350)
Merging drm-xe/drm-xe-next (61ef737db9f2 drm/xe/ptl: Apply Wa_14022866841)
...
rom 512 to 2048)
Merging sched-ext/for-next (b3f6bf5e277a Merge branch 'for-6.13' into for-n=
ext)
...
Merging staging/staging-next (fef10146def9 staging: gpib: Remove unused val=
ue)
...

=V3gu
-----END PGP SIGNATURE-----
