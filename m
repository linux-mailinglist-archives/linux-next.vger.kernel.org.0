...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 58CD770D55E
	for <lists+linux-next@lfdr.de>; Tue, 23 May 2023 09:40:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229836AbjEWHkk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 23 May 2023 03:40:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38792 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229883AbjEWHki (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 23 May 2023 03:40:38 -0400
Received: from mail-pg1-x531.google.com (mail-pg1-x531.google.com [IPv6:2607:f8b0:4864:20::531])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 37BC78E
        for <linux-next@vger.kernel.org>; Tue, 23 May 2023 00:40:34 -0700 (PDT)
Received: by mail-pg1-x531.google.com with SMTP id 41be03b00d2f7-53474b0c494so5004924a12.3
        for <linux-next@vger.kernel.org>; Tue, 23 May 2023 00:40:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1684827633; x=1687419633;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=dZR0OaTTwCR+YvAH8aHaotUq0M+sChteavXDiFAwaCg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1684827633; x=1687419633;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=dZR0OaTTwCR+YvAH8aHaotUq0M+sChteavXDiFAwaCg=;
        b=
X-Gm-Message-State: AC+VfDwpi01ReLty4puLzlOIIaZeHgWT4TMDd+Xb3E/FwvEd3muzniZf
        dhovVd+5yunlaCwik8X1lWPzacNlO3/UWclXT4sqnw==
X-Google-Smtp-Source: ACHHUZ5g5KCm2vhB8RlTjlGtvyfVTAneWkpwD5FvCEth4pHUyU76yt0X0r0K87jj2Yd2154nPkJ+7A==
X-Received: by 2002:a17:903:245:b0:1ac:5382:6e24 with SMTP id j5-20020a170903024500b001ac53826e24mr15536258plh.10.1684827632225;
        Tue, 23 May 2023 00:40:32 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id q3-20020a170902dac300b001ac94b33ab1sm6042217plx.304.2023.05.23.00.40.31
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 23 May 2023 00:40:31 -0700 (PDT)
Message-ID: <646c6def.170a0220.d2618.a494@mx.google.com>
Date:   Tue, 23 May 2023 00:40:31 -0700 (PDT)
...
Subject: next/master build: 196 builds: 13 failed, 183 passed, 81 errors,
 46 warnings (next-20230523)
...
next/master build: 196 builds: 13 failed, 183 passed, 81 errors, 46 warning=
s (next-20230523)
...
Tree: next
Branch: master
Git Describe: next-20230523
Git Commit: 9f925874281f7e8855855d6210d6e29d844e4307
...
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    4    drivers/gpu/drm/panel/panel-samsung-s6d7aa0.c:443:14: error: initi=
alizer element is not a compile-time constant
    4    drivers/gpu/drm/panel/panel-samsung-s6d7aa0.c:415:14: error: initi=
alizer element is not a compile-time constant
    4    drivers/gpu/drm/panel/panel-samsung-s6d7aa0.c:312:14: error: initi=
alizer element is not a compile-time constant
...
declared with 'error' attribute: BUILD_BUG_ON failed: (((16 - 3) * (4 - (2)=
    ...
    1    drivers/scsi/aacraid/commsup.c:1785:15: error:   CC [M]  fs/nfsd/n=
fs4layouts.o
    1    drivers/gpu/drm/amd/amdgpu/../display/dc/dce110/dce110_hw_sequence=
r.c:2293:14: error: =E2=80=98struct hwseq_private_funcs=E2=80=99 has no mem=
ber named =E2=80=98resync_fifo_dccg_dio=E2=80=99
    1    drivers/gpu/drm/amd/amdgpu/../display/dc/dce110/dce110_hw_sequence=
r.c:2292:17: error: =E2=80=98struct hwseq_private_funcs=E2=80=99 has no mem=
ber named =E2=80=98resync_fifo_dccg_dio=E2=80=99
    1    arch/arm/kernel/head.S:319: Error: missing expression -- `ldr r7,=
=3D0x'
    1    arch/arm/kernel/head.S:319: Error: missing expression -- `ldr r3,=
=3D0x'
    1    19: error: array index 6 is past the end of the array (that has ty=
...
ndant UACCESS disable
    1    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x773b: sta=
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, clang-17) =E2=80=94 FAIL, 16 errors, 0 warnings, 0 sec=
tion mismatches
...
e end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), cast to=
 '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    19: error: array index 6 is past the end of the array (that has type 'u=
...
Errors:
    drivers/gpu/drm/amd/amdgpu/../display/dc/dce110/dce110_hw_sequencer.c:2=
292:17: error: =E2=80=98struct hwseq_private_funcs=E2=80=99 has no member n=
amed =E2=80=98resync_fifo_dccg_dio=E2=80=99
    drivers/gpu/drm/amd/amdgpu/../display/dc/dce110/dce110_hw_sequencer.c:2=
293:14: error: =E2=80=98struct hwseq_private_funcs=E2=80=99 has no member n=
amed =E2=80=98resync_fifo_dccg_dio=E2=80=99
...
e end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), cast to=
 '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    drivers/scsi/aacraid/commsup.c:1785:15: error:   CC [M]  fs/nfsd/nfs4la=
youts.o
    drivers/scsi/aacraid/commsup.c:1786:15: error: array index 3 is past th=
e end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), cast to=
 '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
...
Warnings:
    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x773b: stack st=
