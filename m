...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CDE541C33CD
	for <lists+linux-next@lfdr.de>; Mon,  4 May 2020 09:43:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727827AbgEDHnT (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 4 May 2020 03:43:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45322 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1727088AbgEDHnS (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 4 May 2020 03:43:18 -0400
Received: from mail-pl1-x643.google.com (mail-pl1-x643.google.com [IPv6:2607:f8b0:4864:20::643])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3356FC061A0E
        for <linux-next@vger.kernel.org>; Mon,  4 May 2020 00:43:18 -0700 (PDT)
Received: by mail-pl1-x643.google.com with SMTP id t16so6463653plo.7
        for <linux-next@vger.kernel.org>; Mon, 04 May 2020 00:43:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=scTQZWa6jctvsQTK94mN0/Om4A1H28fyuyEfX92rP+Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=scTQZWa6jctvsQTK94mN0/Om4A1H28fyuyEfX92rP+Q=;
        b=
X-Gm-Message-State: AGi0PuYljgJOkkIfcnTHeEk3UWy94apv9uy29/DlSAM8JgTfwTLM41gf
        X5lR4XZucQ/MCJnFJIMmpjA59cfWn9M=
X-Google-Smtp-Source: APiQypKu0UUGrgab8ejD/P4dmeTFlhBIPps1B4wp1lNVw1iIdYjUpyRvhGkdy6QfFWNMukQYZvY57w==
X-Received: by 2002:a17:902:d216:: with SMTP id t22mr16050399ply.186.1588578195478;
        Mon, 04 May 2020 00:43:15 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id m9sm2740485pgd.1.2020.05.04.00.43.14
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 04 May 2020 00:43:14 -0700 (PDT)
Message-ID: <5eafc792.1c69fb81.3f9c5.d544@mx.google.com>
Date:   Mon, 04 May 2020 00:43:14 -0700 (PDT)
Content-Type: text/plain; charset="utf-8"
MIME-Version: 1.0
Content-Transfer-Encoding: quoted-printable
X-Kernelci-Branch: pending-fixes
X-Kernelci-Tree: next
X-Kernelci-Kernel: v5.7-rc4-211-g6d4315023bc9
X-Kernelci-Report-Type: build
Subject: next/pending-fixes build: 217 builds: 2 failed, 215 passed, 17 errors,
 266 warnings (v5.7-rc4-211-g6d4315023bc9)
...
next/pending-fixes build: 217 builds: 2 failed, 215 passed, 17 errors, 266 =
warnings (v5.7-rc4-211-g6d4315023bc9)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.7-rc4-211-g6d4315023bc9/

Tree: next
Branch: pending-fixes
Git Describe: v5.7-rc4-211-g6d4315023bc9
Git Commit: 6d4315023bc932fcdb9d268d3c1597f1b51a325d
...
arm:
    ...
    omap2plus_defconfig (gcc-8): 12 errors, 1 warning
...
et/ethernet/ti/netcp_ethss.c:3812: undefined reference to `cpts_release'
    1    /home/buildslave/workspace/kernel-build@2/linux/build/../drivers/n=
...
/ethernet/ti/cpsw_priv.c:68: undefined reference to `cpts_tx_timestamp'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
/ethernet/ti/cpsw_priv.c:525: undefined reference to `cpts_create'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
...
/ethernet/ti/cpsw_new.c:379: undefined reference to `cpts_rx_timestamp'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
/ethernet/ti/cpsw_new.c:2029: undefined reference to `cpts_release'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
/ethernet/ti/cpsw_new.c:2005: undefined reference to `cpts_release'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
...
/ethernet/ti/cpsw.c:437: undefined reference to `cpts_rx_timestamp'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
/ethernet/ti/cpsw.c:1742: undefined reference to `cpts_release'
    1    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net=
/ethernet/ti/cpsw.c:1717: undefined reference to `cpts_release'
...
g to symbol LEDS_TRIGGER_ONESHOT
    1    /tmp/ccn4QQqN.s:18191: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccn4QQqN.s:18119: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccn4QQqN.s:18119: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccn4QQqN.s:18191: Warning: using r15 results in unpredictable beha=
viour
...
hernet/ti/netcp_ethss.c:3719: undefined reference to `cpts_create'
    /home/buildslave/workspace/kernel-build@2/linux/build/../drivers/net/et=
hernet/ti/netcp_ethss.c:3812: undefined reference to `cpts_release'
    /home/buildslave/workspace/kernel-build@2/linux/build/../drivers/net/et=
...
---------------------------------------------------------------------------=
-----
omap2plus_defconfig (arm, gcc-8) =E2=80=94 FAIL, 12 errors, 1 warning, 0 se=
ction mismatches
...
rnet/ti/cpsw.c:886: undefined reference to `cpts_unregister'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw.c:1742: undefined reference to `cpts_release'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw.c:437: undefined reference to `cpts_rx_timestamp'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw.c:840: undefined reference to `cpts_register'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw.c:1717: undefined reference to `cpts_release'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw_priv.c:68: undefined reference to `cpts_tx_timestamp'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw_priv.c:525: undefined reference to `cpts_create'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw_new.c:814: undefined reference to `cpts_unregister'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw_new.c:2029: undefined reference to `cpts_release'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw_new.c:379: undefined reference to `cpts_rx_timestamp'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
rnet/ti/cpsw_new.c:2005: undefined reference to `cpts_release'
    /home/buildslave/workspace/kernel-build/linux/build/../drivers/net/ethe=
