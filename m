...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F08925282B7
	for <lists+linux-next@lfdr.de>; Mon, 16 May 2022 12:57:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242675AbiEPK5s (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 16 May 2022 06:57:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49332 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229527AbiEPK5a (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 16 May 2022 06:57:30 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9640FE0A8;
        Mon, 16 May 2022 03:57:24 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4L1x681Nlhz4xZ0;
        Mon, 16 May 2022 20:57:20 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1652698640;
        bh=M6EwsL6jR4z47Iytn4L+7IVXMlZfy8ndZ2bCNgzMz0I=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 16 May 2022 20:57:18 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 16
Message-ID: <20220516205718.2c5a52f9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/zV_CFNi54AflXdieEF.qdJp";
...
The nvdimm tree gained a build failure for which I applied a patch.

The rust tree gained a conflict against the char-misc tree.

Non-merge commits (relative to Linus' tree): 10952
 10931 files changed, 983744 insertions(+), 230133 deletions(-)
...
Merging origin/master (0cdd776ec92c Merge tag 'driver-core-5.18-rc7' of git=
...
Merging net/master (9500acc631db net: macb: Increment rx bd head after allo=
cating skb and buffer)
...
Merging sound-current/for-linus (8b3b2392ed68 ALSA: hda/realtek: Add quirk =
for TongFang devices with pop noise)
...
upts too early)
Merging usb.current/usb-linus (757b9f6e6a20 Merge tag 'usb-serial-5.18-rc7'=
 of https://git.kernel.org/pub/scm/linux/kernel/git/johan/usb-serial)
...
Merging char-misc.current/char-misc-linus (d83ea024091e Merge tag 'icc-5.18=
...
Merging renesas-fixes/fixes (432b52eea3dc ARM: shmobile: defconfig: Restore=
 graphical consoles)
Merging perf-current/perf/urgent (c46721e4604f MAINTAINERS: Add James and M=
ike as Arm64 performance events reviewers)
...
Merging arm64/for-next/core (c7f18c2fe8d1 Merge branch 'for-next/kselftest'=
 into for-next/core)
...
Merging net-next/master (d9713088158b ice: Expose RSS indirection tables fo=
r queue groups via ethtool)
...
cp_join.sh
Merging bpf-next/for-next (418fbe82578e bpftool: Use sysfs vmlinux when dum=
ping BTF by ID)
...
Merging wireless-next/main (ad732da434a2 rtlwifi: Use pr_warn instead of WA=
RN_ONCE)
Merging mtd/mtd/next (9a7459fd9be4 mtd: phram: Allow cached mappings)
Merging nand/nand/next (66d7a40beb41 mtd: nand: MTD_NAND_ECC_MEDIATEK shoul=
d depend on ARCH_MEDIATEK)
...
lper_prepare_fb)
Merging amdgpu/drm-next (2f8867693a3b drm/amdkfd: Fix static checker warnin=
g on MES queue type)
...
R329 and D1)
Merging block/for-next (195fbdc42ab9 Merge branch 'for-5.19/cdrom' into for=
-next)
...
finition for mt8186)
Merging spi/for-next (22d35e40419a spi: spi-cadence: Update ISR status vari=
able type to irqreturn_t)
...
Merging kvm-arm/next (82288d6eb8de Merge branch kvm-arm64/misc-5.19 into kv=
marm-master/next)
...
isting file)
Merging gpio-brgl/gpio/for-next (5561a2b08639 gpio: ws16c48: Utilize iomap =
interface)
...
Merging nvdimm/libnvdimm-for-next (e4628f04a31a mce: fix set_mce_nospec to =
always unmap the whole page)
...
s_get())
Merging kspp/for-next/kspp (8c296a9ad2c8 loadpin: stop using bdevname)
...
Merging mm/mm-everything (524570b6f2a0 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: fixup for "mm: change huge_ptep_clear_flush() to return the origi=
nal pte"
Applying: fix up for "x86/mce: relocate set{clear}_mce_nospec() functions"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (5b6c2b5566e8 mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=ZZ3p
-----END PGP SIGNATURE-----
