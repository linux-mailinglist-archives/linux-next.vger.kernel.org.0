Return-Path: <linux-next+bounces-736-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 9906582B9F0
	for <lists+linux-next@lfdr.de>; Fri, 12 Jan 2024 04:22:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 8EDE71C21E0F
	for <lists+linux-next@lfdr.de>; Fri, 12 Jan 2024 03:22:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7F7DA1A720;
	Fri, 12 Jan 2024 03:22:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="pv7E3vTS"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1CBCB1A5B0;
	Fri, 12 Jan 2024 03:22:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1705029724;
	bh=5mzrbixH+Le8ZocK84m8z7hyke2TUvomqMMRI6ZNaYI=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TB6K85gL8z4wc8;
	Fri, 12 Jan 2024 14:22:04 +1100 (AEDT)
Date: Fri, 12 Jan 2024 14:22:04 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 12
Message-ID: <20240112142204.21a56b8a@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/5_GuGqwFhjMqqn.B.ckt5q7";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/5_GuGqwFhjMqqn.B.ckt5q7
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

News: there will be no linux-next releases on Monday or Tuesday.
...
Changes since 20240111:

I applied 2 patches for issues with the mm tree.
...
Non-merge commits (relative to Linus' tree): 6791
 6129 files changed, 322781 insertions(+), 91393 deletions(-)
...
Merging origin/master (457e4f99765c Merge tag 'auxdisplay-6.8' of https://g=
ithub.com/ojeda/linux)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (8ec4efc7d34f selftests: mm: hugep=
age-vmemmap fails on 64K page size systems.)
...
Merging net/main (3e7aeb78ab01 Merge tag 'net-next-6.8' of git://git.kernel=
.org/pub/scm/linux/kernel/git/netdev/net-next)
...
Merging sound-current/for-linus (fd38dd6abda5 kselftest/alsa - conf: String=
ify the printed errno in sysfs_get())
Merging sound-asoc-fixes/for-linus (fefffa76b41f Merge remote-tracking bran=
...
Merging drm-misc-fixes/for-linux-next-fixes (024b32db43a3 drm/bridge: parad=
e-ps8640: Wait for HPD when doing an AUX transfer)
...
linux-kselftest)
Merging mm/mm-everything (004879ab0fe9 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Merging kbuild/for-next (0f493ceef61b linux/export.h: remove unneeded .bali=
gn directive)
...
Merging dma-mapping/for-next (3dc2f209208d swiotlb: check alloc_size before=
 the allocation of a new memory pool)
...
or-next)
Merging scmi/for-linux-next (31261eceb9b0 Merge branches 'for-next/ffa/fixe=
...
Merging loongarch/loongarch-next (836e94e82ca8 Merge branch 'loongarch-kvm'=
 into loongarch-next)
...
ite-only variable)
Merging risc-v/for-next (d3e591a38c98 dt-bindings: riscv: Document cbop-blo=
ck-size)
...
Merging s390/for-next (46ca2e27f112 Merge branch 'features' into for-next)
...
Merging bcachefs/for-next (3bf0400008e0 bcachefs: Don't log errors if BCH_W=
RITE_ALLOC_NOWAIT)
...
Merging gfs2/for-next (bfed9a92940b Merge tag 'gfs2-v6.7-rc1-fixes' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/gfs2/linux-gfs2)
Merging jfs/jfs-next (a280c9ceeca7 jfs: Add missing set_freezable() for fre=
ezable kthread)
Merging ksmbd/ksmbd-for-next (8fb7b723924c ksmbd: Add missing set_freezable=
() for freezable kthread)
Merging nfs/linux-next (de927f6c0b07 Merge tag 's390-6.8-1' of git://git.ke=
...
Merging pci/next (5a9c70ec9348 Merge branch 'pci/misc')
...
G_FW_LOADER)
Merging pm/linux-next (2b2cd068b24c Merge branches 'pm-cpufreq' and 'pm-sle=
ep' into linux-next)
...
Merging bluetooth/master (f8c47ee39e6d Bluetooth: hci_event: Use HCI error =
defines instead of magic values)
...
Merging crypto/master (b8910630c967 crypto: iaa - Account for cpu-less numa=
 nodes)
Merging drm/drm-next (b76c01f1d950 Merge tag 'drm-intel-gt-next-2023-12-15'=
...
Merging drm-misc/for-linux-next (2ad62d16cd24 drm/v3d: Free the job and ass=
ign it to NULL if initialization fails)
Merging amdgpu/drm-next (6e7a29f011ac drm/amdgpu: add new INFO IOCTL query =
for input power)
...
Merging fbdev/for-next (581cea3f4f63 fbdev/intelfb: Remove driver)
...
ermilion.c drivers/video/fbdev/intelfb/intelfb_i2c.c
Merging regmap/for-next (632cdb1dab49 Merge remote-tracking branch 'regmap/=
for-6.8' into regmap-next)
Merging sound/for-next (fd38dd6abda5 kselftest/alsa - conf: Stringify the p=
rinted errno in sysfs_get())
...
Merging sound-asoc/for-next (fefffa76b41f Merge remote-tracking branch 'aso=
...
Merging block/for-next (ab1413f84f60 Merge branch 'for-6.8/io_uring' into f=
or-next)
...
8' into spi-next)
Merging tip/master (8a695270c872 Merge branch into tip/master: 'sched/urgen=
t')
...
l-doc warnings)
Merging vhost/linux-next (6fa5e0b86f2b virtio_net: Fix "=E2=80=98%d=E2=80=
...
Merging cxl/next (3601311593eb Merge branch 'for-6.8/cxl-cper' into for-6.8=
/cxl)
...
Merging header_cleanup/header_cleanup (1e2f2d31997a Kill sched.h dependency=
 on rcupdate.h)
Applying: mm: vmalloc: Fix a wrong value passed to __find_vmap_area()
Applying: userfaultfd: avoid huge_zero_page in UFFDIO_MOVE
...

=gQkt
-----END PGP SIGNATURE-----
