...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 05557583CC4
	for <lists+linux-next@lfdr.de>; Thu, 28 Jul 2022 13:02:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235236AbiG1LCn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 28 Jul 2022 07:02:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60450 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234881AbiG1LCm (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 28 Jul 2022 07:02:42 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0F70B6391B;
        Thu, 28 Jul 2022 04:02:39 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LtnmY3szPz4x1H;
        Thu, 28 Jul 2022 21:02:37 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1659006157;
        bh=oIVdzBE3gctUBDFue8kyj+URwiyvHRX7mBvobwISohE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 28 Jul 2022 21:02:36 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 28
Message-ID: <20220728210236.76654a0e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/CF6E8HJnzZH5YUS378VVlqp";
...
Changes since 20220727:

The hid tree still had its build failure so I used the version from
next-20220722.

The drm tree inherited the amdgpu tree build failure, so I reverted a
commit from the drm tree.
...
The kspp tree gained a semantic conflict against the device-mapper tree.

Non-merge commits (relative to Linus' tree): 12393
 12163 files changed, 1151749 insertions(+), 315914 deletions(-)
...
Merging origin/master (6e7765cb477a Merge tag 'asm-generic-fixes-5.19-2' of=
 git://git.kernel.org/pub/scm/linux/kernel/git/arnd/asm-generic)
Merging fixes/fixes (4a57a8400075 vf/remap: return the amount of bytes actu=
ally deduplicated)
Merging mm-hotfixes/mm-hotfixes-unstable (e6cde625497a mm/hmm: fault non-ow=
...
Merging arc-current/for-curr (952deecb065e arc: dts: Harmonize EHCI/OHCI DT=
 nodes name)
Merging arm-current/fixes (fb0fd3469ead ARM: 9216/1: Fix MAX_DMA_ADDRESS ov=
erflow)
...
Merging net/master (e62d2e110356 tcp: md5: fix IPv4-mapped support)
...
or-linus)
Merging sound-asoc-fixes/for-linus (3e22a82e120c Merge remote-tracking bran=
...
Merging arm/for-next (42656b71cd86 Merge branches 'misc' and 'fixes' into f=
or-next)
...
Merging arm-soc/for-next (5a4fd8456648 soc: document merges)
...
Merging reset/reset/next (8a4e6154fb17 reset: tps380x: Add TPS380x device d=
river supprt)
...
Merging powerpc/next (d6b551b8f90c powerpc/64e: Fix build failure with GCC =
...
e)
Merging cifs/for-next (fe67bd563ec2 cifs: avoid use of global locks for hig=
h contention data)
Merging configfs/for-next (84ec758fb2da configfs: fix a race in configfs_{,=
un}register_subsystem())
Merging ecryptfs/next (682a8e2b41ef Merge tag 'ecryptfs-5.13-rc1-updates' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/tyhicks/ecryptfs)
Merging erofs/dev (4cdfa6ef7aa0 erofs: update ctx->pos for every emitted di=
rent)
...
Merging ksmbd/ksmbd-for-next (caf998641a96 ksmbd: fix racy issue while dest=
roying session on multichannel)
Merging nfs/linux-next (f201bdfd7c87 NFSv4.1 probe offline transports for t=
runking on session creation)
Merging nfs-anna/linux-next (4f40a5b55446 NFSv4: Add an fattr allocation to=
 _nfs4_discover_trunking())
Merging nfsd/for-next (94d75868c355 nfsd: silence extraneous printk on nfsd=
.ko insertion)
...
or-next)
Merging pci/next (2609e5c554b9 Merge branch 'pci/header-cleanup-immutable')
...
run_task)
Merging net-next/master (5ffcba41de55 Merge branch 'smc-updates')
...
pi-r2-pro.dts
Merging bpf-next/for-next (40b09653b197 selftests/bpf: Adjust vmtest.sh to =
use local kernel configuration)
...
Merging bluetooth/master (13474ba176c9 Bluetooth: ISO: unlock on error path=
 in iso_sock_setsockopt())
Merging wireless-next/for-next (70c898d4bad1 wifi: plfxlc: Use eth_zero_add=
r() to assign zero address)
...
submission.c
Applying: Revert "drm/amd/display: Remove FPU flags from DCN30 Makefile"
Merging drm-misc/for-linux-next (6f2c8d5f1659 drm/amdgpu: Fix for drm buddy=
 memory corruption)
Merging amdgpu/drm-next (ba1de919d19b drm/amd/display: remove unneeded semi=
colon)
...
Merging fbdev/for-next (3eb8fccc244b video: fbdev: sis: fix typos in SiS_Ge=
tModeID())
...
Merging sound-asoc/for-next (1b9d1dbb3001 Merge remote-tracking branch 'aso=
...
Merging block/for-next (39f2a5c001cb Merge branch 'for-5.20/block-iter' int=
o for-next)
...
Merging device-mapper/for-next (cab3b1fb66e4 dm raid: fix address sanitizer=
 warning in raid_resume)
...
Merging regulator/for-next (efc93392960c regulator: Consumer load managemen=
t improvements)
...
Merging devicetree/for-next (60320e6ef485 dt-bindings: watchdog: qcom,pm891=
6-wdt: convert to dtschema)
...
20' into spi-next)
Merging tip/master (64ddd185badb Merge perf/core into tip/master)
...
r)
Merging char-misc/char-misc-next (9f8267b9b299 misc: Mark MICROCODE_MINOR u=
nused)
...
Merging cgroup/for-next (17b6a0395d23 Merge branch 'for-5.20' into for-next)
Merging scsi/for-next (a9f4c3a39708 Merge branch 'fixes' into for-next)
...
Merging cxl/next (04ad63f086d1 cxl/region: Introduce cxl_pmem_region object=
s)
...
ruct line)
Merging kspp/for-next/kspp (aaf50b1969d7 kasan: test: Silence GCC 12 warnin=
gs)
...
inux/gfp.h>"
Applying: fix up for "dm: Add verity helpers for LoadPin"
...

=CKTe
-----END PGP SIGNATURE-----
