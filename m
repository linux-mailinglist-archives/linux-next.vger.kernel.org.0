Return-Path: <linux-next+bounces-1681-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id D3439881AC4
	for <lists+linux-next@lfdr.de>; Thu, 21 Mar 2024 02:53:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 8920E283015
	for <lists+linux-next@lfdr.de>; Thu, 21 Mar 2024 01:53:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C084917FD;
	Thu, 21 Mar 2024 01:53:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="Ws7wFr5X"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9AB6D10E9;
	Thu, 21 Mar 2024 01:52:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710985984; cv=none; b=sqoUCc2JJp+TQmtx8x8fyxtcbwbe/YD7hjKLspbS4DvcavSVtieL+lMZ6RneM74nHQxUXoPeqChR2sIX6ak3P1JFrUnCICl0dBkVpFNqB/xY2mTViDxu/Alh9QZlM2axs2yt554VmzhR+f/J+nAk147Uv96D1Cy727tvbrd55Bo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710985984; c=relaxed/simple;
	bh=WRc2YutKYxTxkz1bZZY9qoOU+5CVfp+1YyVhzVfDpjE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=lKOp367xag8AnJ2ZXKEdZIn8H2MO0dsw6+i9ilCwCwS5z3dXLM6zjEISHTZ0eOXgCSVcBSCTzl3TtLMAB90yIBSAAou3tw3McPxuvJC4jEeZOYVlxbcJ/jS7BMJZ50OHECx7QnQ9wNoaRfZ9RZq9+oghjqb/u+uVU29TD8b73XY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=Ws7wFr5X; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1710985977;
	bh=7+fWFAfnZERKJQBNUKancQeE1Y6VQYT50rKr/wnXDuU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4V0T4T2qcCz4wbr;
	Thu, 21 Mar 2024 12:52:57 +1100 (AEDT)
Date: Thu, 21 Mar 2024 12:52:53 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 21
Message-ID: <20240321125253.4bc7c343@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/OlPeNS5za+MrcAp1_jIODzv";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/OlPeNS5za+MrcAp1_jIODzv
...
Merging origin/master (a4145ce1e7bc Merge tag 'bcachefs-2024-03-19' of http=
...
t warnings)
Merging sound-current/for-linus (14d811467f65 ALSA: control: Fix unannotate=
d kfree() cleanup)
...
Merging spi-fixes/for-linus (2ff0573e7aff spi: docs: spidev: fix echo comma=
nd format)
...
ite-only variable)
Merging risc-v/for-next (eeb7a8933e71 Merge patch series "riscv: mm: Extend=
 mappable memory up to hint address")
...
Merging drm-intel/for-linux-next (8353939042e8 drm/i915: Rename ICL_PORT_TX=
_DW6 bits)
...
Merging drm-xe/drm-xe-next (4c15a6dcee20 drm/xe/uc: Use u64 for offsets for=
 which we use upper_32_bits())
Merging etnaviv/etnaviv/next (b735ee173f84 drm/etnaviv: Restore some id val=
ues)
Merging fbdev/for-next (0688d3b1d882 fbdev: panel-tpo-td043mtea1: Convert s=
printf() to sysfs_emit())
Merging regmap/for-next (62861ddcb27e Merge remote-tracking branch 'regmap/=
for-6.9' into regmap-next)
Merging sound/for-next (14d811467f65 ALSA: control: Fix unannotated kfree()=
 cleanup)
...
Merging device-mapper/for-next (6e7132ed3c07 dm snapshot: fix lockup in dm_=
exception_table_exit)
...
/ELE/V2X MU)
Merging spi/for-next (2ff0573e7aff spi: docs: spidev: fix echo command form=
at)
...

=5ZtU
-----END PGP SIGNATURE-----
