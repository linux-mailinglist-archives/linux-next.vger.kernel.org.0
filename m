Return-Path: <linux-next+bounces-4849-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id DF1CE9DA10E
	for <lists+linux-next@lfdr.de>; Wed, 27 Nov 2024 04:09:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 9B19C2831AF
	for <lists+linux-next@lfdr.de>; Wed, 27 Nov 2024 03:09:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AD95D41E4E;
	Wed, 27 Nov 2024 03:09:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="vAVKbrHW"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1A82C139D;
	Wed, 27 Nov 2024 03:09:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1732676962; cv=none; b=G9TwLXjkbN77FnnoPddxEpgwpz/C4BgIU/oTJSCXssLA8om/3wHVQURhAzKRtdtRxworOtn2SKr+r4tWhoxdAm8EWmXl54T9pIiVBedYmKjlLgQVgqnxicYSgpAxBW0f2ZtTEe7Ek89oZk5O1v5hZu+yCdU9iwlOY+AMpDZYweE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1732676962; c=relaxed/simple;
	bh=RJP5RCXPmeH9Ct1Fn4+uhKmso8UXp/zT5REshh1mLCE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=OTifkk7lMkpKhpxbnjZTdki0Ar6QbJBtDE0z4obwure1Aa2bXOqK2jZJLe4QKnw9gKfAvDYhb/J6rohzWaY9TE1Q/0pEgxYyrabgk8f2O+OeNsByHeA6Js7kVRru2J0GkRMt0cz0ahJhczaK4jR6z4MYhbR8qXz3lauThYhxvDc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=vAVKbrHW; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1732676942;
	bh=+u60kLo48C862dL0yDCFDKsGIvGoCIJWZeILIgtRYWQ=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XyktQ2MF3z4x4v;
	Wed, 27 Nov 2024 14:09:02 +1100 (AEDT)
Date: Wed, 27 Nov 2024 14:09:05 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 27
Message-ID: <20241127140905.30a98d78@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/f750WCKzbB.pn2SiSjB+tXe";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/f750WCKzbB.pn2SiSjB+tXe
...
Changes since 20241126:

Non-merge commits (relative to Linus' tree): 2635
 3323 files changed, 123622 insertions(+), 112041 deletions(-)
...
Merging origin/master (6daf0882c63a Merge tag 'vfs-6.13.ecryptfs.mount.api'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/vfs/vfs)
...
Merging fs-current (901e4c6bacac Merge branch 'next-fixes' of git://git.ker=
...
Merging sound-current/for-linus (db2eee614348 ALSA: hda: Show the codec qui=
rk info at probing)
...
Merging tip-fixes/tip/urgent (d29bdce2c7b6 Merge branch into tip/master: 'x=
86/urgent')
...
Merging kbuild/for-next (fef35a5fceb0 kbuild: rename .tmp_vmlinux.kallsyms0=
...
Merging fs-next (2ffe3f871d04 Merge branch 'for-next' of git://git.kernel.o=
...
mentation comments)
Merging drm-xe/drm-xe-next (f161809b362f drm/xe/guc_submit: fix race around=
 suspend_pending)
...
Merging sound/for-next (db2eee614348 ALSA: hda: Show the codec quirk info a=
t probing)
...
ble_read_voltage())
Merging block/for-next (c0d171e482a8 Merge branch 'for-6.13/io_uring' into =
for-next)
...
12' into spi-linus)
Merging tip/master (6ff908de1eaf Merge branch into tip/master: 'x86/mm')
...

=8ceI
-----END PGP SIGNATURE-----
