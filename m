...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6B72CFAD59
	for <lists+linux-next@lfdr.de>; Wed, 13 Nov 2019 10:43:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727605AbfKMJmu (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 13 Nov 2019 04:42:50 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:56951 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725996AbfKMJmZ (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 13 Nov 2019 04:42:25 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47Cfls4RQWz9s7T;
        Wed, 13 Nov 2019 20:42:17 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1573638137;
        bh=GeZsUvfNPYvjmjRYPqUG46hlywiUsL79AMnCkveieVo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 13 Nov 2019 20:42:15 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 13
Message-ID: <20191113204215.6dd85780@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/C/+bdeej4Zoji3GLpDA60MK";
...
--Sig_/C/+bdeej4Zoji3GLpDA60MK
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20191112:
...
Non-merge commits (relative to Linus' tree): 10004
 8886 files changed, 387446 insertions(+), 167388 deletions(-)
...
Merging origin/master (eb094f06963b Merge branch 'x86-pti-for-linus' of git=
...
Merging net/master (6d6dd528d5af net/smc: fix refcount non-blocking connect=
() -part 2)
...
es)
Merging kvm-fixes/master (a78986aae9b2 KVM: MMU: Do not treat ZONE_DEVICE p=
ages as being reserved)
...
in imxfb_probe())
Merging pm/linux-next (bb98c894ef91 Merge branch 'acpi-mm' into linux-next)
...
Merging net-next/master (e0580b50d9d4 Merge tag 'linux-can-next-for-5.5-201=
91111' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can-next)
...
Merging drm-intel/for-linux-next (cee7fb437edc drm/i915/userptr: Try to acq=
uire the page lock around set_page_dirty())
Merging drm-tegra/drm/tegra/for-next (84db889e6d82 drm/tegra: Unconditional=
ly select IOMMU_IOVA)
Merging drm-misc/for-linux-next (3ca3a9eab708 Merge tag 'drm-misc-next-fixe=
s-2019-11-06' of git://anongit.freedesktop.org/drm/drm-misc into drm-next)
...
Merging usb/usb-next (1ec13abac58b USBIP: add config dependency for SGL_ALL=
OC)
Merging usb-gadget/next (726b4fba94be usb: dwc3: of-simple: add a shutdown)
Merging usb-serial/usb-next (067814c97494 USB: serial: mos7840: drop port o=
pen flag)
...
Merging staging/staging-next (e11898460e89 staging: rtl8723bs: Remove comme=
nted code)
CONFLICT (content): Merge conflict in drivers/staging/Makefile
CONFLICT (content): Merge conflict in drivers/staging/Kconfig
...
Merging gpio-brgl/gpio/for-next (adce11839322 gpio: tegra186: Add debounce =
support)
...
rflow
Merging akpm/master (d3a2ab1900a0 drivers/media/platform/sti/delta/delta-ip=
...

=JnrK
-----END PGP SIGNATURE-----
