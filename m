...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DC7D57408E2
	for <lists+linux-next@lfdr.de>; Wed, 28 Jun 2023 05:20:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229718AbjF1DUx (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 27 Jun 2023 23:20:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55634 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229488AbjF1DUu (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 27 Jun 2023 23:20:50 -0400
Received: from mail-pg1-x530.google.com (mail-pg1-x530.google.com [IPv6:2607:f8b0:4864:20::530])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B039710CF
        for <linux-next@vger.kernel.org>; Tue, 27 Jun 2023 20:20:46 -0700 (PDT)
Received: by mail-pg1-x530.google.com with SMTP id 41be03b00d2f7-55b0e7efb1cso782022a12.1
        for <linux-next@vger.kernel.org>; Tue, 27 Jun 2023 20:20:46 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1687922446; x=1690514446;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=c1MmUHCuXz9eMOln6wXTvee0JFrtwp9YiOHBwBdQ43A=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1687922446; x=1690514446;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=c1MmUHCuXz9eMOln6wXTvee0JFrtwp9YiOHBwBdQ43A=;
        b=
X-Gm-Message-State: AC+VfDx9n1vsQKw1cwB/EWHZGBu2bnWKCENUZZDVeuDNDrQReC0DXSOt
        Veh5/PbuqjhWHlzETonTLsgX9N3UeXdiX+AUYY3jbQ==
X-Google-Smtp-Source: ACHHUZ5WYWVW90+q1SHs95fcy8guMs/K2yVxHU5PRTuo5jjE6op4nauW7mQgV28Ls7Zpi4RiaWTbVQ==
X-Received: by 2002:a17:90a:284e:b0:262:d7db:2520 with SMTP id p14-20020a17090a284e00b00262d7db2520mr7614704pjf.26.1687922444909;
        Tue, 27 Jun 2023 20:20:44 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id sk15-20020a17090b2dcf00b0025eb5aafd3csm6718005pjb.32.2023.06.27.20.20.44
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 27 Jun 2023 20:20:44 -0700 (PDT)
Message-ID: <649ba70c.170a0220.a15f0.d2b5@mx.google.com>
Date:   Tue, 27 Jun 2023 20:20:44 -0700 (PDT)
...
Subject: next/pending-fixes build: 167 builds: 2 failed, 165 passed, 6 errors,
 39 warnings (v6.4-4072-ge8f5f1933319)
...
next/pending-fixes build: 167 builds: 2 failed, 165 passed, 6 errors, 39 wa=
rnings (v6.4-4072-ge8f5f1933319)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v6.4-4072-ge8f5f1933319/

Tree: next
Branch: pending-fixes
Git Describe: v6.4-4072-ge8f5f1933319
Git Commit: e8f5f19333191a84312f70b0bae33bdf0f934218
...
vec_from_user.part.0() with UACCESS enabled
    6    vmlinux.o: warning: objtool: .altinstr_replacement+0x1781: redunda=
nt UACCESS disable
    2    WARNING: modpost: EXPORT symbol "_mcount" [vmlinux] version genera=
tion failed, symbol will not be versioned.
    1    vmlinux.o: warning: objtool: __import_iovec+0x342: call to copy_io=
vec_from_user.part.0() with UACCESS enabled
    1    vmlinux.o: warning: objtool: .altinstr_replacement+0x1932: redunda=
nt UACCESS disable
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1781: redundant UA=
CCESS disable
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1932: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
