...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id DF3C25B6C9F
	for <lists+linux-next@lfdr.de>; Tue, 13 Sep 2022 13:54:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231516AbiIMLyu (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 13 Sep 2022 07:54:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49288 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231335AbiIMLyt (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 13 Sep 2022 07:54:49 -0400
Received: from mail-pl1-x636.google.com (mail-pl1-x636.google.com [IPv6:2607:f8b0:4864:20::636])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CC147BE13
        for <linux-next@vger.kernel.org>; Tue, 13 Sep 2022 04:54:45 -0700 (PDT)
Received: by mail-pl1-x636.google.com with SMTP id c2so11574687plo.3
        for <linux-next@vger.kernel.org>; Tue, 13 Sep 2022 04:54:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date;
        bh=XWImnNAVs24XD5hPwa6hxqmxTtTBdBi8d5MBy/ouLxo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=XWImnNAVs24XD5hPwa6hxqmxTtTBdBi8d5MBy/ouLxo=;
        b=
X-Gm-Message-State: ACgBeo3+q9oVHJ9BtjoDHLYEmh6lcDTADtPdb4RgF+JibMEs7tV/lTLj
        sC0Ig+Q0IaUt64bPSBMlBOx6d4lx1L/AjSFmSwA=
X-Google-Smtp-Source: AA6agR6GvpI5yQS3YBxl/BXXmpiGn9L7hV8bgh/UBx/72dGYsT6DSyzVx3V9Cf1njJS7Z6y2Jn2FEA==
X-Received: by 2002:a17:90b:2c0d:b0:202:54a1:d502 with SMTP id rv13-20020a17090b2c0d00b0020254a1d502mr3737939pjb.70.1663070084151;
        Tue, 13 Sep 2022 04:54:44 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id h9-20020a63df49000000b0041cd5ddde6fsm7454937pgj.76.2022.09.13.04.54.42
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 13 Sep 2022 04:54:42 -0700 (PDT)
Message-ID: <63206f82.630a0220.ee8b5.c521@mx.google.com>
Date:   Tue, 13 Sep 2022 04:54:42 -0700 (PDT)
...
Subject: next/master build: 223 builds: 9 failed, 214 passed, 26 errors,
 55 warnings (next-20220913)
...
next/master build: 223 builds: 9 failed, 214 passed, 26 errors, 55 warnings=
 (next-20220913)
...
Tree: next
Branch: master
Git Describe: next-20220913
Git Commit: 0caac1da994900d12a9be6106edb8e98696712a3
...
arm64:
    ...
    defconfig (clang-16): 1 error, 2 warnings
    defconfig+CONFIG_ARM64_64K_PAGES=3Dy (clang-16): 1 error, 2 warnings
...
=80=98-mhard-float=E2=80=99
    2    drivers/power/supply/bq25890_charger.c:625:40: error: implicit con=
version from enumeration type 'enum bq25890_fields' to different enumeratio=
n type 'enum bq25890_table_ids' [-Werror,-Wenum-conversion]
...
ted "0,0"
    ...
    2    drivers/power/supply/bq25890_charger.c:625:40: warning: implicit c=
onversion from enumeration type 'enum bq25890_fields' to different enumerat=
ion type 'enum bq25890_table_ids' [-Wenum-conversion]
    2    WARNING: modpost: EXPORT symbol "_mcount" [vmlinux] version genera=
tion failed, symbol will not be versioned.
    1    printk(KERN_WARNING pr_fmt(fmt), ##__VA_ARGS__)
    1    drivers/net/ethernet/mellanox/mlx5/core/en_accel/macsec_fs.c:523:3=
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, clang-16) =E2=80=94 FAIL, 4 errors, 2 warnings, 0 sect=
ion mismatches

Errors:
    error: write on a pipe with no reader
    drivers/power/supply/bq25890_charger.c:625:40: error: implicit conversi=
on from enumeration type 'enum bq25890_fields' to different enumeration typ=
e 'enum bq25890_table_ids' [-Werror,-Wenum-conversion]
...
---------------------------------------------------------------------------=
-----
allmodconfig (i386, clang-16) =E2=80=94 FAIL, 4 errors, 0 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
defconfig (arm64, clang-16) =E2=80=94 PASS, 1 error, 2 warnings, 0 section =
mismatches
...
Warnings:
    drivers/power/supply/bq25890_charger.c:625:40: warning: implicit conver=
sion from enumeration type 'enum bq25890_fields' to different enumeration t=
ype 'enum bq25890_table_ids' [-Wenum-conversion]
    1 warning generated.
