Return-Path: <linux-next+bounces-5957-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B991A6D9AD
	for <lists+linux-next@lfdr.de>; Mon, 24 Mar 2025 13:01:37 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B506618931F1
	for <lists+linux-next@lfdr.de>; Mon, 24 Mar 2025 12:01:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7163525DCF1;
	Mon, 24 Mar 2025 12:01:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="kCzCkWBl"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 022DD18D65F;
	Mon, 24 Mar 2025 12:01:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1742817692; cv=none; b=kP1iTq15M5Eq4llgZJNog511k9cy4It8LZFv5pptpZpIj8zHctHK9jZCkdVZHHWKgksaHY2IKkUawohr6UwJ8JO4877ie2NlJ3a7s2L8s8WQzYDGOefM/a2XWR4Mx8WmR0atG4zm5PWJqfg+SkQTub33Jcxz1LiyAguwz7UMsmY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1742817692; c=relaxed/simple;
	bh=/6HqzORjvfY4nb5PVseqRnH8ce74UCGmHvVOSpqzUKk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=q7WeqaznYKENnaMrKBpdFPiIlxmcZFafjTJKq9Akz9PGMHa0XXbaFBZRxpWMTkybGpFSYta6JCML+xbmMLniSQpw/+Dsf+21K49WhAgjVq/YEfW55OQWMw3KN3tRDvCHSKZK3eUDVdSCgAcnfzw0Kgy7IvzFrJ91eClFBeayK84=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=kCzCkWBl; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1742817683;
	bh=62QDrhFWlhvmrZlCAV419Q/RGbeqdFm23z2Bky/3uUQ=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4ZLs8g3JJlz4wbX;
	Mon, 24 Mar 2025 23:01:23 +1100 (AEDT)
Date: Mon, 24 Mar 2025 23:01:22 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 24
Message-ID: <20250324230122.106602ef@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/0g1A/eo5hQToAS0lgfHhjQs";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/0g1A/eo5hQToAS0lgfHhjQs
...
The security tree gained a semantic conflict against Linus' tree.

The tip tree gained a conflict against the btrfs and zstd trees.
the tip tree gained a build failure for which I reverted a commit.

The ftrace tree gained a conflict against the kbuild tree.

The led-lj tree lost its build failure.

The tty tree gained a build failure for which I applied a patch.

The zstd tree gained a conflict against the tip tree.

The rust tree gained a build failure so I used the version from
next-20250320.

Non-merge commits (relative to Linus' tree): 12172
 11811 files changed, 648732 insertions(+), 253099 deletions(-)
...
Merging origin/master (586de92313fc Merge tag 'i2c-for-6.14-rc8' of git://g=
...
Merging bcachefs/for-next (b4de3a7a16a7 bcachefs: Kill unnecessary bch2_dev=
_usage_read())
...
X)
Merging cifs/for-next (69eedc2a61ad cifs: avoid NULL pointer dereference in=
 dbg call)
...
Merging fs-current (63ed4ca22c13 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (ed3ba9b6e280 net: Remove RTNL dance for SIOCBRADDIF and S=
IOCBRDELIF.)
...
e_rd)
Merging sound-current/for-linus (29951021367f ALSA: hda/realtek: Add suppor=
t for various HP Laptops using CS35L41 HDA)
...
Merging perf/perf-tools-next (182f12f31933 perf vendor events arm64 AmpereO=
neX: Fix frontend_bound calculation)
...
r-next)
Merging scmi/for-linux-next (00698fe55203 Merge branches 'for-next/scmi/fix=
...
Merging fs-next (0a489ce41b62 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (4fed181ddb87 Merge branch 'for-6.15' into for-next)
Merging pci/next (99b6885f951e Merge branch 'pci/misc')
...
Merging net-next/main (bfc17c165835 net: phy: realtek: disable PHY-mode EEE)
...
tion')
Merging bluetooth/master (a37df2815c1b Bluetooth: hci_event: Fix handling o=
f HCI_EV_LE_DIRECT_ADV_REPORT)
...
ntation)
Merging drm-xe/drm-xe-next (676da6ba5bdc drm/xe: Allow to inject error in e=
arly probe)
...
lin-A series)
Merging block/for-next (a067889444d5 Merge branch 'for-6.15/block' into for=
-next)
...
Merging devicetree/for-next (065cadf3c8ff media: dt-bindings: mediatek,vcod=
ec-encoder: Drop assigned-clock properties)
...
15' into spi-next)
Merging tip/master (8f0a90905e1d Merge branch into tip/master: 'x86/sev')
...
Applying: Revert "x86/kbuild/64: Add the CONFIG_X86_NATIVE_CPU option to lo=
cally optimize the kernel with '-march=3Dnative'"
...
Merging ftrace/for-next (6d7cd7a8800c Merge tools/for-next)
...
Merging usb-serial/usb-next (6a7713ec5337 USB: serial: mos7840: drop unused=
 defines)
Merging tty/tty-next (2790ce23951f serial: stm32: do not deassert RS485 RTS=
 GPIO prematurely)
  e10865aa8ebc ("tty: mmc: sdio: use bool for cts and remove parentheses")
Applying: fix up for "tty: serial: fsl_lpuart: use port struct directly to =
simply code"
...
Merging random/master (602c988b7827 prandom: remove next_pseudo_random32)
  87be9e42244f ("drm/i915/selftests: use prandom in selftest")
Merging landlock/next (5d1bd467a9e5 landlock: Add audit documentation)
Merging rust/rust-next (a0b539ad369f rust: macros: fix `make rusttest` buil=
d on macOS)
...
$ git reset --hard HEAD^
Merging next-20250320 version of rust
CONFLICT (content): Merge conflict in drivers/gpu/drm/drm_panic_qr.rs
CONFLICT (content): Merge conflict in rust/Makefile
CONFLICT (content): Merge conflict in rust/kernel/init.rs
CONFLICT (content): Merge conflict in rust/kernel/sync/condvar.rs
...
CONFLICT (content): Merge conflict in rust/pin-init/src/macros.rs
CONFLICT (content): Merge conflict in scripts/generate_rust_analyzer.py
[master 6af78500f492] next-20250320/rust
Applying: fix up for "rust: init: fix `Zeroable` implementation for `Option=
<NonNull<T>>` and `Option<KBox<T>>`"
[master 3ab1206f6f36] next-20250320/rust
...

=Iofe
-----END PGP SIGNATURE-----
