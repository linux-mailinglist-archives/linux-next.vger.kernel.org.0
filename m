...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ECD632EC8AF
	for <lists+linux-next@lfdr.de>; Thu,  7 Jan 2021 04:03:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725952AbhAGDBy (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 6 Jan 2021 22:01:54 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:37095 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725815AbhAGDBx (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 6 Jan 2021 22:01:53 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DB9wf4rpFz9sVm;
        Thu,  7 Jan 2021 14:01:06 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1609988466;
        bh=0Bpl4m7YH+pRGG67TbRTBKmb7/s5eu9JOn9k6CFVbFY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 7 Jan 2021 14:01:03 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 7
Message-ID: <20210107140103.0cca6432@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/XwyBvoNKmsb3=pcF0Zp51bW";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/XwyBvoNKmsb3=pcF0Zp51bW
...
Merging origin/master (71c061d24438 Merge tag 'for-5.11-rc2-tag' of git://g=
...
Merging net/master (3503ee6c0bec selftests: fix the return value for UDP GR=
O test)
Merging bpf/master (67208692802c tools/resolve_btfids: Warn when having mul=
tiple IDs for single type)
...
Merging sound-current/for-linus (4bfd6247fa91 ALSA: hda/via: Fix runtime PM=
 for Clevo W35xSS)
Merging sound-asoc-fixes/for-linus (a41db6b750d5 Merge remote-tracking bran=
...
Merging usb.current/usb-linus (10a05404c4fe Merge tag 'usb-serial-5.11-rc3'=
...
Merging drm-misc-fixes/for-linux-next-fixes (da21afa69a8c dmabuf: fix use-a=
fter-free of dmabuf's file->f_inode)
...
or-next)
Merging qcom/for-next (030a0b7dc0f7 Merge branches 'arm64-defconfig-for-5.1=
...
n send_sig{io, urg}())
Merging vfs/for-next (24069db7ac98 Merge branches 'fixes', 'work.sparc', 'w=
...
t into Kconfig)
Merging hid/for-next (78aae108ab3a Merge branch 'for-5.12/intel-ish' into f=
or-next)
...
Merging net-next/master (ede71cae7285 net-next: docs: Fix typos in snmp_cou=
nter.rst)
...
Merging drm-intel/for-linux-next (956aee8fa366 drm/i915/rkl: new rkl ddc ma=
p for different PCH)
...
Merging sound-asoc/for-next (a062942f27bd Merge remote-tracking branch 'aso=
...
Merging rpmsg/for-next (6e05cd807a5a Merge branches 'hwspinlock-next', 'rpm=
...
Merging akpm/master (68745302179e secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=V6Gq
-----END PGP SIGNATURE-----
