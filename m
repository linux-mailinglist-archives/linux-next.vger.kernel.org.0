...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DD9BB19CFC3
	for <lists+linux-next@lfdr.de>; Fri,  3 Apr 2020 07:29:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387532AbgDCF3f (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 3 Apr 2020 01:29:35 -0400
Received: from ozlabs.org ([203.11.71.1]:39655 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732763AbgDCF3e (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 3 Apr 2020 01:29:34 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48tpQc4BVBz9sRf;
        Fri,  3 Apr 2020 16:29:28 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1585891768;
        bh=zMPOdwGV0iqMdbjeQ7h41y/EE1TaY8l4cwbM6TrPqfM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 3 Apr 2020 16:29:26 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 3
Message-ID: <20200403162926.3ff57e99@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/RXzIifTpVEnjPSL+r=D5uu=";
...
The akpm-current tree gained conflicts against the drm tree.

Non-merge commits (relative to Linus' tree): 4919
 4882 files changed, 195091 insertions(+), 80338 deletions(-)
...
Merging origin/master (7be97138e727 Merge tag 'xfs-5.7-merge-8' of git://gi=
...
Merging net/master (21f64e72e707 net: stmmac: xgmac: Fix VLAN register hand=
ling)
...
Merging kbuild/for-next (580ff3dfafe3 Documentation/llvm: fix the name of l=
lvm-size)
...
in imxfb_probe())
Merging pm/linux-next (90ffa1f5a089 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
ifi/iwlwifi-next)
Merging bluetooth/master (92516cd97fd4 Bluetooth: Always request for user c=
...
-next)
Merging sound/for-next (dbdd24eaac4e edd: Use scnprintf() for avoiding pote=
ntial buffer overflow)
...
Merging device-mapper/for-next (fdd5b7d474f8 Revert "dm: always call blk_qu=
eue_split() in dm_process_bio()")
...
build warning)
Merging rtc/rtc-next (3edf29d9d585 rtc: class: remove redundant assignment =
to variable err)
...
rflow
Merging akpm/master (8cbeecd470ba drivers/media/platform/sti/delta/delta-ip=
...

=w0AJ
-----END PGP SIGNATURE-----
