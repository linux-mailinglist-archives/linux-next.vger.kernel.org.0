...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 815605082B0
	for <lists+linux-next@lfdr.de>; Wed, 20 Apr 2022 09:50:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1376421AbiDTHxO (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 20 Apr 2022 03:53:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48936 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1376505AbiDTHxH (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 20 Apr 2022 03:53:07 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B79ED344F6;
        Wed, 20 Apr 2022 00:50:19 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KjtBG6mSvz4xL3;
        Wed, 20 Apr 2022 17:50:14 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1650441015;
        bh=iboypqwsGYxiG9gumY3pH3S0vt56UYHnns6xnOypru0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 20 Apr 2022 17:50:14 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 20
Message-ID: <20220420175014.1bf94e55@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/21oTOlBC7wXCpTST5pwAgQf";
...
--Sig_/21oTOlBC7wXCpTST5pwAgQf
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220419:
...
The pinctrl tree gained a conflict against the devicetree tree.

The pinctrl-renesas tree gained a build failure so I used the version
from next-20220419.

The kunit-next tree gained a conflict against the thunderbolt tree.

The sysctl tree gained a conflict against the rcu tree.

The bitmap tree lost its build failure.

Non-merge commits (relative to Linus' tree): 4398
 5024 files changed, 193080 insertions(+), 81846 deletions(-)
...
Merging origin/master (559089e0a93d vmalloc: replace VM_NO_HUGE_VMAP with V=
M_ALLOW_HUGE_VMAP)
...
Merging net/master (99c07327ae11 netlink: reset network and mac headers in =
netlink_dump())
...
Merging sound-current/for-linus (0aea30a07ec6 Merge tag 'asoc-fix-v5.18-rc3=
' of https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for=
-linus)
Merging sound-asoc-fixes/for-linus (f8090b950836 Merge remote-tracking bran=
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (9df1e3ff6024 drm/i915/display=
...
Merging qcom/for-next (6f27c7fe8260 Merge branches 'arm64-for-5.19', 'arm64=
...
' into for-next)
Merging samsung-krzk/for-next (94d08b503002 Merge branch 'fixes' into for-n=
ext)
...
ort)
Merging net-next/master (cc4bdef26ecd Merge branch 'rtnetlink-improve-alt_i=
fname-config-and-fix-dangerous-group-usage')
CONFLICT (content): Merge conflict in drivers/net/ethernet/microchip/lan966=
x/lan966x_main.c
Merging bpf-next/for-next (0d7fefebea55 selftests/bpf: Use non-autoloaded p=
rograms in few tests)
$ git reset --hard HEAD^
...
Merging drm-misc/for-linux-next (4ab85930b718 drm: bridge: icn6211: Add DSI=
 lane count DT property parsing)
...
Merging drm-intel/for-linux-next (72c3c8d6e527 drm/i915/rpl-p: Add PCI IDs)
...
Merging sound-asoc/for-next (9053b4814958 Merge remote-tracking branch 'aso=
...
L pointer)
Merging block/for-next (cdac696fab3d Merge branch 'for-5.19/io_uring-socket=
' into for-next)
...
finition for mt8186)
Merging spi/for-next (dd769f15483c spi: using pm_runtime_resume_and_get ins=
tead of pm_runtime_get_sync)
Merging tip/master (8fc779bd3f12 Merge x86/urgent into tip/master)
...
to trace/for-next)
Merging rcu/rcu/next (cec83620bfa1 rcu/torture: Change order of warning and=
 trace dump)
...
Merging chrome-platform/for-next (8d4668064cce platform/chrome: cros_ec: ap=
pend newline to all logs)
...
Merging ipmi/for-next (982fac8f3de4 ipmi: When handling send message respon=
ses, don't process the message)
...
Merging pinctrl/for-next (3a683fa3b5b2 Merge branch 'devel' into for-next)
...
Merging pinctrl-renesas/renesas-pinctrl (ca3c550b6d00 pinctrl: renesas: rzg=
2l: Restore pin config order)
$ git reset --hard HEAD^
Merging next-20220419 version of pinctrl-renesas
...
Merging random/master (63bcbb33c9a1 random: insist on random_get_entropy() =
...
Merging execve/for-next/execve (8d005269c50d binfmt_flat: Drop vestiges of =
coredump support)
Merging bitmap/bitmap-for-next (1588a180e9cc include/linux/find: Fix docume=
ntation)
...
Merging akpm/master (9c3773eeb279 kselftest/vm: override TARGETS from argum=
ents)
...

=9P4D
-----END PGP SIGNATURE-----
