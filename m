...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 691DD1A1A48
	for <lists+linux-next@lfdr.de>; Wed,  8 Apr 2020 05:26:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726453AbgDHD0E (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 7 Apr 2020 23:26:04 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:52389 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726436AbgDHD0E (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 7 Apr 2020 23:26:04 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48xqRk00pyz9sSX;
        Wed,  8 Apr 2020 13:25:53 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1586316354;
        bh=ONa4QJ2L/r80lAGa5A5J0OVwlOFX5pPSyfxyx5rMhgs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 8 Apr 2020 13:25:53 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 8
Message-ID: <20200408132553.114abcac@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bDjnjdBAA2=wEk7qAWLFle+";
...
Changes since 20200407:

The kbuild tree lost its build failure.

The kspp tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 1370
 1491 files changed, 52756 insertions(+), 18183 deletions(-)
...
Merging origin/master (63bef48fd6c9 Merge branch 'akpm' (patches from Andre=
w))
...
Merging sparc/master (763dede1b248 Merge tag 'for-linus-5.7-rc1' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/rw/ubifs)
Merging fscrypt-current/for-stable (2b4eae95c736 fscrypt: don't evict dirty=
 inodes after removing key)
Merging net/master (aa81700cf232 macsec: fix NULL dereference in macsec_upd=
_offload())
...
Merging netfilter/master (ef516e8625dd netfilter: nf_tables: reintroduce th=
e NFT_SET_CONCAT flag)
...
Merging sound-current/for-linus (c47914c00be3 ALSA: ice1724: Fix invalid ac=
cess for enumerated ctl items)
Merging sound-asoc-fixes/for-linus (fff876253c1e Merge branch 'asoc-5.7' in=
to asoc-linus)
...
Merging driver-core.current/driver-core-linus (a10c9c710f9e Merge tag 'for-=
v5.7' of git://git.kernel.org/pub/scm/linux/kernel/git/sre/linux-power-supp=
ly)
Merging tty.current/tty-linus (a10c9c710f9e Merge tag 'for-v5.7' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/sre/linux-power-supply)
Merging usb.current/usb-linus (7e63420847ae Merge tag 'acpi-5.7-rc1-2' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
...
Merging char-misc.current/char-misc-linus (7e63420847ae Merge tag 'acpi-5.7=
...
double free of ptr)
Merging ide/master (763dede1b248 Merge tag 'for-linus-5.7-rc1' of git://git=
.kernel.org/pub/scm/linux/kernel/git/rw/ubifs)
...
Merging kbuild/for-next (21466c8b8fba kbuild: add dummy toolchains to enabl=
e all cc-option etc. in Kconfig)
...
Merging csky/linux-next (aefd9461d34a csky: Fixup cpu speculative execution=
 to IO area)
...
_notify_op_lock())
Merging cifs/for-next (2bcb4fd6ba91 smb3: smbdirect support can be configur=
ed by default)
...
Merging orangefs/for-next (dda33e713f36 orangefs: complete Christoph's "rem=
ember count" reversion.)
...
Merging jc_docs/docs-next (19905fe667b6 Documentation: driver-api/usb/writi=
ng_usb_driver.rst Updates documentation links)
...
in imxfb_probe())
Merging pm/linux-next (7e63420847ae Merge tag 'acpi-5.7-rc1-2' of git://git=
...
ic)
Merging net-next/master (763dede1b248 Merge tag 'for-linus-5.7-rc1' of git:=
...
ifi/iwlwifi-next)
Merging bluetooth/master (d1d900f822b6 Bluetooth: Simplify / fix return val=
ues from tk_request)
...
Merging drm/drm-next (9c346968b862 Merge branch 'linux-5.7' of git://github=
.com/skeggsb/linux into drm-next)
Merging amdgpu/drm-next (def0f42d98fc drm/amdgpu: Re-enable FRU check for m=
ost models v5)
...
Merging drm-misc/for-linux-next (b513b0d4563a drm/virtio: fix OOB in virtio=
_gpu_object_create)
...
-next)
Merging sound/for-next (c47914c00be3 ALSA: ice1724: Fix invalid access for =
enumerated ctl items)
Merging sound-asoc/for-next (fff876253c1e Merge branch 'asoc-5.7' into asoc=
-linus)
...
sm unsharing)
Merging xen-tip/linux-next (3a169c0be75b xen/blkfront: fix memory allocatio=
n flags in blkfront_setup_indirect())
...
Merging driver-core/driver-core-next (a10c9c710f9e Merge tag 'for-v5.7' of =
git://git.kernel.org/pub/scm/linux/kernel/git/sre/linux-power-supply)
Merging usb/usb-next (7e63420847ae Merge tag 'acpi-5.7-rc1-2' of git://git.=
kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
...
Merging tty/tty-next (a10c9c710f9e Merge tag 'for-v5.7' of git://git.kernel=
.org/pub/scm/linux/kernel/git/sre/linux-power-supply)
Merging char-misc/char-misc-next (7e63420847ae Merge tag 'acpi-5.7-rc1-2' o=
...
Merging vhost/linux-next (160d3945ecd7 vhost: batching fetches)
...
rflow
Merging akpm/master (e2b76a09c8dc drivers/media/platform/sti/delta/delta-ip=
...

=yZDX
-----END PGP SIGNATURE-----
