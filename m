...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BCE4C3212E1
	for <lists+linux-next@lfdr.de>; Mon, 22 Feb 2021 10:15:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230232AbhBVJOV (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 22 Feb 2021 04:14:21 -0500
Received: from ozlabs.org ([203.11.71.1]:37591 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230231AbhBVJN4 (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 22 Feb 2021 04:13:56 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Dkc0f4PRsz9sCD;
        Mon, 22 Feb 2021 20:13:06 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1613985186;
        bh=eO4PazpikaGJ9D5B34NtoctFytqLGdJZpEUB2Kf4ApY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 22 Feb 2021 20:13:05 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 22
Message-ID: <20210222201305.0ecd28c4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/nswNJVHmFezc.xcBQHL=7Xk";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/nswNJVHmFezc.xcBQHL=7Xk
...
The devicetree tree gained a conflict against the arm64-fixes tree.

Non-merge commits (relative to Linus' tree): 6982
 7148 files changed, 281467 insertions(+), 189425 deletions(-)
...
Merging origin/master (5bbb336ba75d Merge tag 'for-5.12/io_uring-2021-02-17=
...
invalidated)
Merging arm64-fixes/for-next/fixes (f5c6d0fcf90c arm64 module: set plt* sec=
tion addresses to 0x0)
...
Merging tty.current/tty-linus (55f62bc87347 Merge tag 'pnp-5.12-rc1' of git=
://git.kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
Merging usb.current/usb-linus (55f62bc87347 Merge tag 'pnp-5.12-rc1' of git=
://git.kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
...
BLE())
Merging staging.current/staging-linus (55f62bc87347 Merge tag 'pnp-5.12-rc1=
...
Merging input-current/for-linus (6524d8eac258 Input: st1232 - add IDLE stat=
e as ready condition)
...
ings for Clang)
Merging kbuild/for-next (835a63af22b0 kbuild: remove deprecated 'always' an=
d 'hostprogs-y/m')
$ git reset --hard HEAD^
Merging next-20210219 version of kbuild
...
Merging soc-fsl/next (e95f287deed2 soc: fsl: handle RCPM errata A-008646 on=
 SoC LS1021A)
Merging risc-v/for-next (f49815047c1a riscv: Disable KSAN_SANITIZE for vDSO)
...
b is used)
Merging cifs/for-next (751ecea06263 cifs: change confusing field serverName=
 (to ip_addr))
...
Merging vfs/for-next (44903da5c0ff Merge branch 'work.namei' into for-next)
...
d in drm/drm-next and modified in HEAD. Version HEAD of drivers/gpu/drm/gma=
500/tc35876x-dsi-lvds.c left in tree.
CONFLICT (modify/delete): drivers/gpu/drm/gma500/mdfld_output.c deleted in =
drm/drm-next and modified in HEAD. Version HEAD of drivers/gpu/drm/gma500/m=
dfld_output.c left in tree.
CONFLICT (modify/delete): drivers/gpu/drm/gma500/mdfld_dsi_output.c deleted=
 in drm/drm-next and modified in HEAD. Version HEAD of drivers/gpu/drm/gma5=
00/mdfld_dsi_output.c left in tree.
CONFLICT (modify/delete): drivers/gpu/drm/gma500/mdfld_device.c deleted in =
drm/drm-next and modified in HEAD. Version HEAD of drivers/gpu/drm/gma500/m=
dfld_device.c left in tree.
...
$ git rm -f drivers/gpu/drm/gma500/tc35876x-dsi-lvds.c drivers/gpu/drm/gma5=
00/mdfld_output.c drivers/gpu/drm/gma500/mdfld_dsi_output.c drivers/gpu/drm=
/gma500/mdfld_device.c
Merging drm-misc/for-linux-next (b1b805f3cb22 dt-bindings: dp-connector: Dr=
op maxItems from -supply)
Merging amdgpu/drm-next (fbce8fc8f9e7 drm/amdgpu: always reset the asic in =
suspend)
...
Merging input/next (e64123949e6c Input: applespi - fix occasional crc error=
s under load.)
Merging block/for-next (2709d6ab511e Merge branch 'for-5.12/block-ipi' into=
 for-next)
...
CONFLICT (content): Merge conflict in arch/arm64/kernel/machine_kexec_file.c
...
Merging usb/usb-next (55f62bc87347 Merge tag 'pnp-5.12-rc1' of git://git.ke=
...
Merging tty/tty-next (55f62bc87347 Merge tag 'pnp-5.12-rc1' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
...
5.12/vfio/next)
Merging staging/staging-next (55f62bc87347 Merge tag 'pnp-5.12-rc1' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
...
Merging nvdimm/libnvdimm-for-next (89400b1e4866 Merge branch 'for-5.12/dax'=
...
Merging akpm/master (229c23bf1331 MIPS: make userspace mapping young by def=
ault)
...

=d4Hg
-----END PGP SIGNATURE-----
