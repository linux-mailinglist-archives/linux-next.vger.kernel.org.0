...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7A08369C615
	for <lists+linux-next@lfdr.de>; Mon, 20 Feb 2023 08:41:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230362AbjBTHla (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 20 Feb 2023 02:41:30 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44944 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230410AbjBTHl3 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 20 Feb 2023 02:41:29 -0500
Received: from mail-pl1-x62f.google.com (mail-pl1-x62f.google.com [IPv6:2607:f8b0:4864:20::62f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 02A5810247
        for <linux-next@vger.kernel.org>; Sun, 19 Feb 2023 23:41:13 -0800 (PST)
Received: by mail-pl1-x62f.google.com with SMTP id q11so705681plx.5
        for <linux-next@vger.kernel.org>; Sun, 19 Feb 2023 23:41:12 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=xt4ptY4qmC1SC5oeoGfKuN+5IoV8RGTrwOO6ubs5XLw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=xt4ptY4qmC1SC5oeoGfKuN+5IoV8RGTrwOO6ubs5XLw=;
        b=
X-Gm-Message-State: AO0yUKXDAZz7es3hv9m3NhC+T0QaoTgbCF481HcX5EDN4rPjWg6LK8w2
        61awwUnX5ItEvnxfcHIB6HA5e8sqII/h03QW3qQ=
X-Google-Smtp-Source: AK7set9oVvhJTCN+Rcj+zl9qw8Skssuk8yWtElZC9Cw/IKElIrxchKwo4Op5FRTpuLFSPltbtqA7lg==
X-Received: by 2002:a17:903:2441:b0:196:5bac:e319 with SMTP id l1-20020a170903244100b001965bace319mr847402pls.35.1676878870930;
        Sun, 19 Feb 2023 23:41:10 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id p3-20020a170902bd0300b0019a9b73f229sm7110286pls.300.2023.02.19.23.41.10
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 19 Feb 2023 23:41:10 -0800 (PST)
Message-ID: <63f32416.170a0220.f0e67.cb15@mx.google.com>
Date:   Sun, 19 Feb 2023 23:41:10 -0800 (PST)
...
next/master build: 210 builds: 15 failed, 195 passed, 22 errors, 17 warning=
s (next-20230220)
...
Tree: next
Branch: master
Git Describe: next-20230220
Git Commit: d2af0fa4bfa4ec29d03b449ccd43fee39501112d
...
Errors summary:
    ...
    5    ERROR: modpost: "__umoddi3" [fs/btrfs/btrfs.ko] undefined!
...
!ENDBR: native_write_cr4+0x4
    1    drivers/net/ethernet/sfc/ef100_nic.c:1155:21: warning: unused vari=
able =E2=80=98net_dev=E2=80=99 [-Wunused-variable]
...
Warnings:
    drivers/net/ethernet/sfc/ef100_nic.c:1155:21: warning: unused variable =
=E2=80=98net_dev=E2=80=99 [-Wunused-variable]
