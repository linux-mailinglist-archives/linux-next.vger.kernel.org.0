...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 96E927DDB88
	for <lists+linux-next@lfdr.de>; Wed,  1 Nov 2023 04:30:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231164AbjKADat (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 31 Oct 2023 23:30:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49170 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231924AbjKADas (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 31 Oct 2023 23:30:48 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 13BE4A4;
        Tue, 31 Oct 2023 20:30:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1698809439;
        bh=Taf4fn2oGT8N62B5Xf3kYBnVubNJ17wgfkjAOLwTmN0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SKswH4Zyrz4wcH;
        Wed,  1 Nov 2023 14:30:39 +1100 (AEDT)
Date:   Wed, 1 Nov 2023 14:30:38 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 1
Message-ID: <20231101143038.5e101312@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/I37J/9SXovfzUhFiCWdJKPs";
...
Changes since 20231031:

The bcachefs tree gained a conflict against the mm tree.

Non-merge commits (relative to Linus' tree): 11190
 11320 files changed, 680198 insertions(+), 272334 deletions(-)
...
Merging origin/master (5a6a09e97199 Merge tag 'cgroup-for-6.7' of git://git=
.kernel.org/pub/scm/linux/kernel/git/tj/cgroup)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (2037364ec54f mm/damon/sysfs: fix =
unnecessary monitoring results removal when online-commit inputs)
...
a comment)
Merging mm/mm-everything (fe5eebc3ee67 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: bcachefs: convert to dynamically allocated shrinkers
Merging kbuild/for-next (766b7007a1cc kbuild: Correct missing architecture-=
specific hyphens)
...
riant)
Merging bcachefs/for-next (487ed6712ae1 bcachefs: Fix MEAN_AND_VARIANCE kco=
nfig options)
...
tems)
Merging cifs/for-next (d09c19c72bf8 cifs: update internal module version nu=
mber for cifs.ko)
...
ECT_IO_ALLOW_MMAP)
Merging gfs2/for-next (779fb265bfec fs/gfs2: Fix slab-use-after-free in gfs=
2_qd_dealloc)
...
Merging pm/linux-next (25839bdc2530 Merge branch 'acpi-fixes' into linux-ne=
xt)
...
Merging kvm-x86/next (35dcbd9e4703 Merge branches 'apic', 'docs', 'misc', '=
mmu', 'pmu', 'svm' and 'xen')
...

=CRpM
-----END PGP SIGNATURE-----
