...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C250262B53E
	for <lists+linux-next@lfdr.de>; Wed, 16 Nov 2022 09:31:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238866AbiKPIbh (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 16 Nov 2022 03:31:37 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34088 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238871AbiKPIbS (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 16 Nov 2022 03:31:18 -0500
Received: from mail-pl1-x634.google.com (mail-pl1-x634.google.com [IPv6:2607:f8b0:4864:20::634])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D4A34C15
        for <linux-next@vger.kernel.org>; Wed, 16 Nov 2022 00:28:25 -0800 (PST)
Received: by mail-pl1-x634.google.com with SMTP id p12so15772922plq.4
        for <linux-next@vger.kernel.org>; Wed, 16 Nov 2022 00:28:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=fK5dSAPiKeR/Ps/0EneiqVPWhqE6721sfdVxDvD5G+4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=fK5dSAPiKeR/Ps/0EneiqVPWhqE6721sfdVxDvD5G+4=;
        b=
X-Gm-Message-State: ANoB5pnRXaOBsiEPPFEmuqHwWwcOfaw0wioxu7H+d9zLXZu+5O2ddRLv
        XTtxZMzjNF1NlsD3IYf0Q05ql8YySJL71Jg0Y2Q=
X-Google-Smtp-Source: AA0mqf4dGVFVIMBDQvdZHs/egR/xGRZQo+af/0EIWvs8uYT/LrJ2Iz+IDoFGm3jITi/6GUHdW4iDKA==
X-Received: by 2002:a17:90a:d502:b0:218:37b0:d621 with SMTP id t2-20020a17090ad50200b0021837b0d621mr2733448pju.6.1668587303478;
        Wed, 16 Nov 2022 00:28:23 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id jj3-20020a170903048300b001714c36a6e7sm11286738plb.284.2022.11.16.00.28.22
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 16 Nov 2022 00:28:23 -0800 (PST)
Message-ID: <63749f27.170a0220.33b49.0fe0@mx.google.com>
Date:   Wed, 16 Nov 2022 00:28:23 -0800 (PST)
...
Subject: next/master build: 235 builds: 22 failed, 213 passed, 50 errors,
 581 warnings (next-20221116)
...
next/master build: 235 builds: 22 failed, 213 passed, 50 errors, 581 warnin=
gs (next-20221116)
...
Tree: next
Branch: master
Git Describe: next-20221116
Git Commit: 15f3bff12cf6a888ec2ad39652828c60e6836b3d
...
,-Wshift-overflow]
    1    drivers/net/ethernet/mellanox/mlx5/core/en_main.c:3596:12: error: =
...
7:12: error: stack frame size (1028) exceeds limit (1024) in 'smu_v13_0_7_g=
...
Errors:
    drivers/gpu/drm/amd/amdgpu/../pm/swsmu/smu13/smu_v13_0_7_ppt.c:1437:12:=
...
alized when used here [-Werror,-Wuninitialized]
    drivers/net/ethernet/mellanox/mlx5/core/en_main.c:3596:12: error: stack=
