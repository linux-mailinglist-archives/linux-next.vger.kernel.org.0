...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7B95A3C7CE7
	for <lists+linux-next@lfdr.de>; Wed, 14 Jul 2021 05:25:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237536AbhGND2p (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 13 Jul 2021 23:28:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51694 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237694AbhGND2p (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 13 Jul 2021 23:28:45 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8D588C0613DD;
        Tue, 13 Jul 2021 20:25:50 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GPjZM2FTmz9sV8;
        Wed, 14 Jul 2021 13:25:47 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1626233147;
        bh=QSGenBIbtyN9IM1qXZNTeWKy62CTRNzv7iLz7mG7Cu4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 14 Jul 2021 13:25:44 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 14
Message-ID: <20210714132544.2a8dda3e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_AxcLwTg38vT7ofZJ6Iybzv";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/_AxcLwTg38vT7ofZJ6Iybzv
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210713:

New tree: renesas-fixes

Non-merge commits (relative to Linus' tree): 1298
 1336 files changed, 97251 insertions(+), 25924 deletions(-)
...
Merging origin/master (40226a3d96ef Merge tag 'vboxsf-v5.14-1' of git://git=
...
Merging net/master (bcb9928a1554 net: dsa: properly check for the bridge_le=
ave methods in dsa_switch_bridge_leave())
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (e73f0f0ee754 Linux 5.14-rc1)
...
Merging renesas-fixes/fixes (432b52eea3dc ARM: shmobile: defconfig: Restore=
 graphical consoles)
Merging drm-misc-fixes/for-linux-next-fixes (0af778269a52 fbmem: Do not del=
ete the mode that is still in use)
Merging kspp-gustavo/for-next/kspp (7c4548d2cc81 Makefile: Enable -Wimplici=
...
nto for-next)
Merging scmi/for-linux-next (067eadbb0f2f Merge branch 'for-next/scmi' of g=
...
k gates)
Merging clk-renesas/renesas-clk (aaac4af5b013 clk: renesas: r9a07g044: Add =
...
point of assignment)
Merging cifs/for-next (32eda9f08e05 cifs: handle reconnect of tcon when the=
re is no cached dfs referral)
...
Merging drm-misc/for-linux-next (35d283658a61 drm/shmem-helper: Align to pa=
ge size in dumb_create)
Merging amdgpu/drm-next (785a89f5ed9c drm/amdgpu/display: add support for m=
ultiple backlights)
Merging drm-intel/for-linux-next (d5bfbad21436 Merge drm/drm-next into drm-=
intel-next)
...
Merging selinux/next (e73f0f0ee754 Linux 5.14-rc1)
...
Merging akpm/master (61e05437d915 Merge branch 'akpm-current/current')
...

=4NOv
-----END PGP SIGNATURE-----
