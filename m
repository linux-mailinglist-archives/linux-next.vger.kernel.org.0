...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5FDF2142426
	for <lists+linux-next@lfdr.de>; Mon, 20 Jan 2020 08:21:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726019AbgATHVI (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 20 Jan 2020 02:21:08 -0500
Received: from ozlabs.org ([203.11.71.1]:60821 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725851AbgATHVI (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 20 Jan 2020 02:21:08 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 481NPR6Mqxz9sRp;
        Mon, 20 Jan 2020 18:20:59 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1579504860;
        bh=VQY94FCnl2jWY3nGnyjMgMBWMPpKn43PeUo3nsSwV/4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 20 Jan 2020 18:20:55 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 20
Message-ID: <20200120182055.55a2c8b4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/pS/2_bLzPKu_G+obGvEOXEm";
...
Merging origin/master (7008ee121089 Merge tag 'riscv/for-v5.5-rc7' of git:/=
...
Merging net/master (b2383ad987a6 cxgb4: reject overlapped queues in TC-MQPR=
IO offload)
...
linus)
Merging sound-asoc-fixes/for-linus (06a4e2b11608 Merge branch 'asoc-5.5' in=
to asoc-linus)
Merging regmap-fixes/for-linus (b3a987b0264d Linux 5.5-rc6)
Merging regulator-fixes/for-linus (5129189b6038 Merge branch 'regulator-5.5=
' into regulator-linus)
Merging spi-fixes/for-linus (b5b1d0732a21 Merge branch 'spi-5.5' into spi-l=
inus)
...
t desc)
Merging usb-serial-fixes/usb-linus (9715a43eea77 USB: serial: quatech2: han=
dle unbound ports)
...
g in ioctl)
Merging drm-fixes/drm-fixes (f66d84c8b4db Merge tag 'drm-misc-fixes-2020-01=
...
_pin_request())
Merging risc-v-fixes/fixes (fc585d4a5cf6 riscv: Less inefficient gcc tishif=
t helpers (and export their symbols))
...
Merging arm/for-next (af9b8094a3b1 Merge branches 'fixes' and 'misc' into f=
or-next)
...
in imxfb_probe())
Merging pm/linux-next (9018880287f9 Merge branch 'pm-devfreq' into linux-ne=
xt)
...
Merging net-next/master (b3f7e3f23a76 Merge ra.kernel.org:/pub/scm/linux/ke=
rnel/git/netdev/net)
Merging bpf-next/master (a6ed02cac690 libbpf: Load btf_vmlinux only once pe=
r object.)
...
Merging mlx5-next/mlx5-next (a880a6dd8537 net/mlx5: Expose relaxed ordering=
 bits)
Merging netfilter-next/master (7f013edebaa4 Merge git://git.kernel.org/pub/=
...
Merging drm-intel/for-linux-next (cd69952778aa drm/i915/gt: Be paranoid and=
 reset the GPU before release)
Merging drm-tegra/drm/tegra/for-next (033ccdb7f6b1 gpu: host1x: Remove dev_=
err() on platform_get_irq() failure)
Merging drm-misc/for-linux-next (d1d511d516f7 drm: tiny: st7735r: Add suppo=
rt for Okaya RH128128T)
...
-next)
Merging sound/for-next (5af29028fd6d ALSA: hda/realtek - Add Headset Mic su=
pported for HP cPC)
Merging sound-asoc/for-next (cf7613ab317d Merge branch 'asoc-5.6' into asoc=
-next)
...
Merging block/for-next (5d73acad9291 Merge branch 'for-5.6/io_uring-vfs' in=
to for-next)
CONFLICT (add/add): Merge conflict in tools/testing/selftests/openat2/opena=
t2_test.c
CONFLICT (add/add): Merge conflict in tools/testing/selftests/openat2/helpe=
rs.h
...
Merging regulator/for-next (92dbef90caed Merge remote-tracking branch 'regu=
...
rflow
Merging akpm/master (f1268a8760b8 drivers/media/platform/sti/delta/delta-ip=
...

=pfGX
-----END PGP SIGNATURE-----
