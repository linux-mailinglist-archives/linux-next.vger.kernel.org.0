...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E1722680695
	for <lists+linux-next@lfdr.de>; Mon, 30 Jan 2023 08:40:00 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235456AbjA3Hj7 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 30 Jan 2023 02:39:59 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48732 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235351AbjA3Hj4 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 30 Jan 2023 02:39:56 -0500
Received: from mail-pf1-x436.google.com (mail-pf1-x436.google.com [IPv6:2607:f8b0:4864:20::436])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9171219F09
        for <linux-next@vger.kernel.org>; Sun, 29 Jan 2023 23:39:52 -0800 (PST)
Received: by mail-pf1-x436.google.com with SMTP id g9so5000688pfk.13
        for <linux-next@vger.kernel.org>; Sun, 29 Jan 2023 23:39:52 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=rm9pb5CX11/BdUIoC3M4JZpYnOUAGdt/exz09QcvZAU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=rm9pb5CX11/BdUIoC3M4JZpYnOUAGdt/exz09QcvZAU=;
        b=
X-Gm-Message-State: AO0yUKXWhr4mdf/fJaEB9NzYz4VAIMQSNTRCGBovrd7QOkfLufRoSS8V
        Z4QeydJDLUSXenW4lIBlyWPdoAo0GK5Vm+/jWNA=
X-Google-Smtp-Source: AK7set/6fzOF1B8hW5hLrtIyR19hgiECERvu50oj9AruzyzJATO2u4Gtv+U0I0CE/04embNU2fASKw==
X-Received: by 2002:a05:6a00:368c:b0:593:6a2e:b96b with SMTP id dw12-20020a056a00368c00b005936a2eb96bmr9965744pfb.8.1675064391082;
        Sun, 29 Jan 2023 23:39:51 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id w22-20020a056a0014d600b00590444eae14sm6652995pfu.183.2023.01.29.23.39.50
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 29 Jan 2023 23:39:50 -0800 (PST)
Message-ID: <63d77446.050a0220.bc97e.a3f4@mx.google.com>
Date:   Sun, 29 Jan 2023 23:39:50 -0800 (PST)
...
Subject: next/master build: 195 builds: 12 failed, 183 passed, 20 errors,
 32 warnings (next-20230130)
...
next/master build: 195 builds: 12 failed, 183 passed, 20 errors, 32 warning=
s (next-20230130)
...
Tree: next
Branch: master
Git Describe: next-20230130
Git Commit: ae0c77e1bc6963c67c6c09e8c72959fcb1ed8d5f
...
Errors summary:
    ...
    4    fs/udf/partition.c:86:28: error: variable 'loc' is uninitialized w=
hen used here [-Werror,-Wuninitialized]
    4    drivers/gpu/drm/msm/msm_drv.h:237:38: error: field =E2=80=98gpu_de=
vfreq_config=E2=80=99 has incomplete type
    4    cc1: error: =E2=80=98-mloongson-mmi=E2=80=99 must be used with =E2=
=80=98-mhard-float=E2=80=99
    2    drivers/gpu/host1x/dev.c:520:6: error: variable 'syncpt_irq' is un=
...
-Wcpp]
    4    fs/udf/partition.c:52:14: note: initialize the variable 'loc' to s=
ilence this warning
    3    drivers/gpu/host1x/dev.c:490:16: note: initialize the variable 'sy=
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-16) =E2=80=94 FAIL, 2 errors, 2 warnings, 0 sectio=
n mismatches
...
---------------------------------------------------------------------------=
-----
allmodconfig (i386, clang-16) =E2=80=94 FAIL, 2 errors, 1 warning, 0 sectio=
n mismatches
