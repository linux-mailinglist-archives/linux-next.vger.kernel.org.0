Return-Path: <linux-next+bounces-4947-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C61C69EDE9B
	for <lists+linux-next@lfdr.de>; Thu, 12 Dec 2024 05:48:35 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 300E7165B3B
	for <lists+linux-next@lfdr.de>; Thu, 12 Dec 2024 04:48:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A4CD11465AD;
	Thu, 12 Dec 2024 04:48:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="pN5IVolb"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8BA3813C918;
	Thu, 12 Dec 2024 04:48:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1733978911; cv=none; b=h0R9qrNMF/at1fL/j2axW6beyZSXHW0eQGYe+LRUzg0AD9BN+5U/Pt+r3BBI/Kbye8ayBIulWa8/gWu1BhFUnPDGbtJE0GHGpIW0NzAOIvQIzkqDp3xeqB3sA1qSbc+DiWecSU2G0DTv/t4vxxuu5Pi7PKRq2SppVatDor6LD4M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1733978911; c=relaxed/simple;
	bh=1iEJbxAC79T4PZoLUK3nPjARCp2M0yV5GHtCFnBKOCo=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=HFDOYjq6vKudJKdrqXWbTsGoI7NF7G/rfAACa4yQievBXoszdazefIZkh6z+aQyyrBBw5ySoacpDcLlyWtDWNLxQtxW2VtURUdShh1JK4pP01c+O/WCXb5Cg8Fuy11L4NQ9skfftM9JmFdkwPA0/LgJCZdlFzNZzlramJ7qn2z4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=pN5IVolb; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1733978900;
	bh=zud63cNEE4nQeGHpXMXCtUB0O8Q423z4p2ERnNsJOrU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Y80N40tHqz4x4y;
	Thu, 12 Dec 2024 15:48:20 +1100 (AEDT)
Date: Thu, 12 Dec 2024 15:48:24 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 12
Message-ID: <20241212154824.372d4488@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8HzGoWd/cB9c7Ga.fjjnHNM";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/8HzGoWd/cB9c7Ga.fjjnHNM
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241211:
...
Non-merge commits (relative to Linus' tree): 2997
 3346 files changed, 127874 insertions(+), 53260 deletions(-)
...
Merging origin/master (f92f4749861b Merge tag 'clk-fixes-for-linus' of git:=
...
when mounting)
Merging cifs/for-next (633609c48a35 smb: client: destroy cfid_put_wq on mod=
ule exit)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (c9b1291c4291 Merge branch 'vfs-6.14.mount' int=
o vfs.all)
$ git reset --hard HEAD^
Merging next-20241211 version of vfs-brauner
...
Merging fs-current (113aff803ee7 Merge branch 'fixes' of git://git.kernel.o=
...
arning)
Merging net/main (3dd002f20098 net: renesas: rswitch: handle stop vs interr=
upt race)
...
or symlink errors)
Merging sound-asoc-fixes/for-linus (bb76e82bfe57 ASoC: fsl_spdif: change IF=
ACE_PCM to IFACE_MIXER)
...
Merging perf-current/perf-tools (65f55012e0a7 libperf: evlist: Fix --cpu ar=
gument on hybrid platform)
...
Merging tip-fixes/tip/urgent (9416d1852b19 Merge branch into tip/master: 's=
ched/urgent')
Merging slab-fixes/slab/for-next-fixes (b7ffecbe198e memcg: slub: fix SUnre=
claim for post charged objects)
Merging drm-misc-fixes/for-linux-next-fixes (2872e21c47c3 MAINTAINERS: alig=
n Danilo's maintainer entries)
...
Merging fs-next (d0beab22e00a Merge branch 'for-next' of git://git.kernel.o=
...
Merging hid/for-next (bea1262ef58b Merge branch 'for-6.14/constify-bin-attr=
ibute' into for-next)
...
-next)
Merging v4l-dvb/next (b98d5000c505 media: rc: iguanair: handle timeouts)
Merging v4l-dvb-next/master (b36c41c51e9d media: atomisp: set lock before c=
alling vb2_queue_init())
Merging pm/linux-next (f61f1cb58c52 Merge branches 'pm-cpuidle' and 'pm-cpu=
...
Merging net-next/main (c0b8980e6041 l2tp: Handle eth stats using NETDEV_PCP=
U_STAT_DSTATS.)
...
p-zero-copy-tx')
Merging bluetooth/master (845b4c649f56 Bluetooth: btmtk: avoid UAF in btmtk=
_process_coredump)
...
Merging ath-next/for-next (58fa8109fa8d wifi: ath12k: Off by one in ath12k_=
wmi_process_csa_switch_count_event())
...
Merging drm-misc/for-linux-next (19851fa2ba98 drm/rockchip: dw_hdmi_qp: Sim=
plify clock handling)
Merging amdgpu/drm-next (e70ba4679540 drm/amdgpu/jpeg5.0.1: use num_jpeg_in=
st for SR-IOV)
Merging drm-intel/for-linux-next (0937c6e7113e drm/i915/dg2: Implement Wa_1=
4022698537)
...
anagement)
Merging sound-asoc/for-next (52a65ee955cb Merge remote-tracking branch 'aso=
...
hecks)
Merging tip/master (d803bbbb55f4 Merge branch into tip/master: 'x86/tdx')
...

=pxQ+
-----END PGP SIGNATURE-----
