...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 131FE147895
	for <lists+linux-next@lfdr.de>; Fri, 24 Jan 2020 07:33:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725887AbgAXGdK (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 24 Jan 2020 01:33:10 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:42231 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725843AbgAXGdJ (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 24 Jan 2020 01:33:09 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 483q8H0HJTz9sP3;
        Fri, 24 Jan 2020 17:33:03 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1579847583;
        bh=eAMWkBarGDKMD751Q3or6GUiGAawLl6bwgpzvk+AP5Y=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 24 Jan 2020 17:33:02 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 24
Message-ID: <20200124173302.2c3228b2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/MwbBJ5tFohBYcuN4r8y.gCL";
...
Non-merge commits (relative to Linus' tree): 10053
 9911 files changed, 465826 insertions(+), 205226 deletions(-)
...
Merging origin/master (4703d9119972 Merge tag 'xarray-5.5' of git://git.inf=
radead.org/users/willy/linux-dax)
...
Merging net/master (61678d28d4a4 net_sched: fix datalen for ematch)
...
Merging sound-asoc-fixes/for-linus (20230620b445 Merge branch 'asoc-5.5' in=
to asoc-linus)
...
Merging drm-fixes/drm-fixes (a48d4a33b6ef Merge tag 'drm-misc-fixes-2020-01=
-22-1' of git://anongit.freedesktop.org/drm/drm-misc into drm-fixes)
...
Merging arm-soc/for-next (0973f800f31b ARM: Document merges)
...
64K from 32K)
Merging mips/mips-next (1306cc0a3091 MIPS: Loongson64: Disable exec hazard)
...
set}xattr() douts)
Merging cifs/for-next (90036ba29469 CIFS: Fix task struct use-after-free on=
 reconnect)
...
Merging f2fs/dev (fc7100ea2a52 f2fs: Add f2fs stats to sysfs)
...
cking...)
Merging overlayfs/overlayfs-next (b7f459376548 ovl: implement async IO rout=
ines)
...
in imxfb_probe())
Merging pm/linux-next (0e81d3b76b98 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
or flow)
Merging net-next/master (9bbc8be29d66 Merge tag 'mlx5-updates-2020-01-22' o=
...
Merging bpf-next/master (485ec2ea9cf5 bpf, devmap: Pass lockdep expression =
to RCU lists)
...
Merging drm-intel/for-linux-next (231946109ea4 drm/i915/cdclk: use new stru=
ct drm_device logging macros)
...
-next)
Merging sound/for-next (5396c4bd9fd8 ALSA: cs46xx: fix spelling mistake "to=
" -> "too")
Merging sound-asoc/for-next (a7196caf83ea Merge branch 'asoc-5.6' into asoc=
-next)
...
Merging block/for-next (31cdd2ec4096 Merge branch 'for-5.6/drivers' into fo=
r-next)
...
Merging security/next-testing (362b8b1981ff security: remove EARLY_LSM_COUN=
T which never used)
...
Merging kvm/linux-next (72263e0bae9c Merge tag 'kvm-ppc-next-5.6-1' of git:=
...
er reference)
Merging driver-core/driver-core-next (72a9cc952f12 devtmpfs: factor out com=
mon tail of devtmpfs_{create,delete}_node)
CONFLICT (content): Merge conflict in include/linux/device.h
Merging usb/usb-next (eb7a3bb8c955 usb: typec: fusb302: fix "op-sink-microw=
att" default that was in mW)
...
ition)
Merging tty/tty-next (1ddeb5a74ab6 tty: baudrate: SPARC supports few more b=
aud rates)
Merging char-misc/char-misc-next (eb143f8756e7 binder: fix log spam for exi=
sting debugfs file creation.)
...
Merging staging/staging-next (0443b3f44363 staging: axis-fifo: replace spin=
lock with mutex)
...
Merging slave-dma/next (6c0157be02f0 dmaengine: ti: k3-udma: fix spelling m=
istake "limted" -> "limited")
...
rflow
Merging akpm/master (06639068b70d drivers/media/platform/sti/delta/delta-ip=
...

=L8Hk
-----END PGP SIGNATURE-----
