...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 90CDE57E031
	for <lists+linux-next@lfdr.de>; Fri, 22 Jul 2022 12:44:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234746AbiGVKnt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 22 Jul 2022 06:43:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50840 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235196AbiGVKnm (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 22 Jul 2022 06:43:42 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9AD78BB5CC;
        Fri, 22 Jul 2022 03:43:38 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Lq5dN3xdFz4xGM;
        Fri, 22 Jul 2022 20:43:36 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1658486616;
        bh=ZMD9xREj4zmDq+Vic6z4Nbe6JWfvQmPumjaUY2bo7+U=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 22 Jul 2022 20:43:35 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 22
Message-ID: <20220722204335.478b1598@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/FDWCMjhs21GtgS81W7XmQn0";
...
The arm64 builds should be good again.
...
The random tree gained a conflict against the s390-fixes tree.

The bitmap tree gained a build failure so I used the version from
next-20220721.

Non-merge commits (relative to Linus' tree): 11370
 11226 files changed, 1104375 insertions(+), 288262 deletions(-)
...
Merging origin/master (68e77ffbfd06 Merge tag 'mtd/fixes-for-5.19-final' of=
...
Merging net/master (7ca433dc6ded Merge tag 'net-5.19-rc8' of git://git.kern=
...
or-linus)
Merging sound-asoc-fixes/for-linus (a871b65505af Merge remote-tracking bran=
...
rate to Disabled)
Merging drm-fixes/drm-fixes (1c46f3c07591 Merge tag 'amd-drm-fixes-5.19-202=
2-07-20' of https://gitlab.freedesktop.org/agd5f/linux into drm-fixes)
...
Merging risc-v-fixes/fixes (c1f6eff304e4 riscv: add as-options for modules =
with assembly compontents)
...
Merging gpio-brgl-fixes/gpio/for-current (f63731e18e8d selftests: gpio: fix=
 include path to kernel headers for out of tree builds)
...
Merging arm-soc/for-next (7f40c1eca12f soc: document merges)
...
-next)
Merging scmi/for-linux-next (d95e624af5ab Merge branch 'for-next/arch_topol=
...
Merging risc-v/for-next (8916c9054f94 RISC-V: Support for 64bit hartid on R=
V64 platforms)
Merging risc-v-mc/dt-for-next (88d319c6abae riscv: dts: microchip: Add mpfs=
' topology information)
Merging s390/for-next (e229c657a779 Merge branch 'features' into for-next)
...
e)
Merging cifs/for-next (57656487463b cifs: update MAINTAINERS file with revi=
ewers)
Merging configfs/for-next (84ec758fb2da configfs: fix a race in configfs_{,=
un}register_subsystem())
Merging ecryptfs/next (682a8e2b41ef Merge tag 'ecryptfs-5.13-rc1-updates' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/tyhicks/ecryptfs)
Merging erofs/dev (d0e5ad05996e erofs: get rid of the leftover PAGE_SIZE in=
 dir.c)
...
ng fid creation)
Merging xfs/for-next (c78c2d090318 xfs: don't leak memory when attr fork lo=
ading fails)
...
pe)
Merging hid/for-next (aa8c1129bd45 Merge branch 'for-5.19/upstream-fixes' i=
nto for-next)
...
s)
Merging rdma/for-next (0c6ab0ca9a66 RDMA/mlx5: Expose steering anchor to us=
erspace)
Merging net-next/master (b945804d9930 Merge tag 'linux-can-next-for-5.20-20=
220721' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can-next)
...
pi-r2-pro.dts
Merging bpf-next/for-next (5cb62b7598f2 bpf, docs: Use SPDX license identif=
ier in bpf_doc.py)
...
Merging bluetooth/master (4e0b765cefea Bluetooth: mgmt: Fix using hci_conn_=
abort)
...
name of f25l32qa)
Merging crypto/master (ed221835a7ae crypto: lib - add module license to lib=
sha1)
...
Merging drm-misc/for-linux-next (6f2c8d5f1659 drm/amdgpu: Fix for drm buddy=
 memory corruption)
Merging amdgpu/drm-next (987949933127 drm/amd/display: reduce stack for dml=
32_CalculatePrefetchSchedule)
...
Merging sound-asoc/for-next (9f26bd6417fc Merge remote-tracking branch 'aso=
...
Merging block/for-next (03bcc540a432 Merge branch 'for-5.20/block' into for=
-next)
...
Merging device-mapper/for-next (9087782bc518 dm raid: fix crash if md_handl=
e_request() splits bio)
...
Merging spi/for-next (3857fb0303e8 Merge remote-tracking branch 'spi/for-5.=
20' into spi-next)
...
Merging irqchip/irq/irqchip-next (9f1ed5c1a612 Merge branch irq/misc-5.20 i=
nto irq/irqchip-next)
Merging ftrace/for-next (41065bf81386 selftests/kprobe: Update test for no =
event name syntax error)
Merging rcu/rcu/next (4dfb06442fd2 selftests/nolibc: Avoid generated files =
being committed)
CONFLICT (content): Merge conflict in arch/loongarch/Kconfig
Merging kvm/next (8031d87aa995 KVM: x86: Check target, not vCPU's x2APIC ID=
, when applying hotplug hack)
...
Merging gpio-brgl/gpio/for-next (949506dc608f gpio: gpio-mm: Implement and =
utilize register structures)
...
Merging random/master (2b85d0d98f18 random: handle archrandom with multiple=
 longs)
...
Merging bitmap/bitmap-for-next (bbe8fb1a3c53 lib/nodemask: inline next_node=
_in() and node_random())
...
$ git reset --hard HEAD^
Merging next-20220721 version of bitmap
CONFLICT (content): Merge conflict in include/linux/gfp.h
[master 8da0aaa3f394] next-20220721/bitmap
Applying: fix up for "mm: kasan: Skip unpoisoning of user pages"
[master dd05710ccef6] next-20220721/bitmap
Applying: fix up for bitmap_weight return value changing
[master 8ecc89957f63] next-20220721/bitmap
...

=cK7l
-----END PGP SIGNATURE-----
