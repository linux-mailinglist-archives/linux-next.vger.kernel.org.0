...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D471B5894D4
	for <lists+linux-next@lfdr.de>; Thu,  4 Aug 2022 01:29:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238354AbiHCX3p (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 3 Aug 2022 19:29:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59562 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236598AbiHCX3p (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 3 Aug 2022 19:29:45 -0400
Received: from mail-pf1-x430.google.com (mail-pf1-x430.google.com [IPv6:2607:f8b0:4864:20::430])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 18A224D4C2
        for <linux-next@vger.kernel.org>; Wed,  3 Aug 2022 16:29:42 -0700 (PDT)
Received: by mail-pf1-x430.google.com with SMTP id d20so10405667pfq.5
        for <linux-next@vger.kernel.org>; Wed, 03 Aug 2022 16:29:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=8Gzb3g6FPhiVrmXicJ48b3hbuFmEt6VdGeMwDeYskXU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8Gzb3g6FPhiVrmXicJ48b3hbuFmEt6VdGeMwDeYskXU=;
        b=
X-Gm-Message-State: AJIora+uoc6AtegJ1VRtEN7tpF9IfdkoaaCWqh+LFS8D0LpOriW840PX
        aXV8CpeeJ0wIRk4wh66VkhADW5E3QEbPTpQXEEY=
X-Google-Smtp-Source: AGRyM1uU9RkCgKzy1Rm1RjK5c9Mi/jLsX0y3EXPQA969N/Fcg01YXEolmQP3lz3sL68OBkWCHl55rQ==
X-Received: by 2002:a05:6a00:1688:b0:517:cf7b:9293 with SMTP id k8-20020a056a00168800b00517cf7b9293mr28054904pfc.7.1659569380648;
        Wed, 03 Aug 2022 16:29:40 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id 68-20020a621747000000b0052d3a442760sm8762293pfx.161.2022.08.03.16.29.39
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 03 Aug 2022 16:29:40 -0700 (PDT)
Message-ID: <62eb04e4.620a0220.eebe.eccc@mx.google.com>
Date:   Wed, 03 Aug 2022 16:29:40 -0700 (PDT)
...
Subject: next/master build: 179 builds: 10 failed, 169 passed, 29 errors,
 34 warnings (next-20220803)
...
next/master build: 179 builds: 10 failed, 169 passed, 29 errors, 34 warning=
s (next-20220803)
...
Tree: next
Branch: master
Git Describe: next-20220803
Git Commit: 861397378de91c64dec69a160595b891f443294f
...
x86_64:
    allmodconfig (clang-15): 8 errors, 13 warnings

Errors summary:

    4    cc1: error: =E2=80=98-mloongson-mmi=E2=80=99 must be used with =E2=
=80=98-mhard-float=E2=80=99
    3    ERROR: modpost: "set_posix_acl" [fs/nfsd/nfsd.ko] undefined!
    2    sound/soc/sof/ipc3-topology.c:2343:4: error: format specifies type=
 'unsigned char' but the argument has type 'int' [-Werror,-Wformat]
    2    sound/soc/sof/ipc3-topology.c:2343:34: error: format specifies typ=
e 'unsigned char' but the argument has type 'int' [-Werror,-Wformat]
    2    sound/soc/sof/ipc3-topology.c:2343:19: error: format specifies typ=
e 'unsigned char' but the argument has type 'int' [-Werror,-Wformat]
    2    drivers/usb/cdns3/cdns3-gadget.c:2290:11: error: variable 'priv_de=
v' is uninitialized when used here [-Werror,-Wuninitialized]
    2    drivers/rtc/rtc-zynqmp.c:223:7: error: variable 'fract_tick' is us=
ed uninitialized whenever 'if' condition is false [-Werror,-Wsometimes-unin=
itialized]
    2    drivers/rtc/rtc-zynqmp.c:218:6: error: variable 'fract_tick' is us=
ed uninitialized whenever 'if' condition is false [-Werror,-Wsometimes-unin=
itialized]
    1    vfs.c:(.text+0x257c): undefined reference to `set_posix_acl'
    1    vfs.c:(.text+0x2520): undefined reference to `set_posix_acl'
    1    vfs.c:(.text+0x24f4): undefined reference to `set_posix_acl'
...
0_ModeSupportAndSystemConfigurationFull' [-Werror,-Wframe-larger-than]
    1    arm-linux-gnueabihf-ld: vfs.c:(.text+0x2754): undefined reference =
to `set_posix_acl'
    1    arm-linux-gnueabihf-ld: vfs.c:(.text+0x2718): undefined reference =
to `set_posix_acl'
    1    arm-linux-gnueabihf-ld: vfs.c:(.text+0x26ec): undefined reference =
to `set_posix_acl'
...
ted "0,0"
    2    drivers/usb/cdns3/cdns3-gadget.c:2278:31: note: initialize the var=
iable 'priv_dev' to silence this warning
    2    drivers/rtc/rtc-zynqmp.c:206:26: note: initialize the variable 'fr=
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, clang-15) =E2=80=94 FAIL, 6 errors, 2 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-15) =E2=80=94 FAIL, 8 errors, 13 warnings, 0 se=
ction mismatches
...
alls through to next function m5mols_enum_mbus_code()
    drivers/usb/cdns3/cdns3-gadget.c:2278:31: note: initialize the variable=
 'priv_dev' to silence this warning
    drivers/rtc/rtc-zynqmp.c:206:26: note: initialize the variable 'fract_t=
ick' to silence this warning
...
Errors:
    vfs.c:(.text+0x257c): undefined reference to `set_posix_acl'
    arm-linux-gnueabihf-ld: vfs.c:(.text+0x2754): undefined reference to `s=
et_posix_acl'
...
Errors:
    vfs.c:(.text+0x2520): undefined reference to `set_posix_acl'
    arm-linux-gnueabihf-ld: vfs.c:(.text+0x2718): undefined reference to `s=
et_posix_acl'
...
Errors:
    vfs.c:(.text+0x24f4): undefined reference to `set_posix_acl'
    arm-linux-gnueabihf-ld: vfs.c:(.text+0x26ec): undefined reference to `s=
et_posix_acl'
