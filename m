...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 980117ED92E
	for <lists+linux-next@lfdr.de>; Thu, 16 Nov 2023 03:17:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230250AbjKPCR5 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 15 Nov 2023 21:17:57 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51242 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232310AbjKPCR5 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 15 Nov 2023 21:17:57 -0500
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 343098E;
        Wed, 15 Nov 2023 18:17:50 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1700101064;
        bh=YepiNiOmTG6aR4Wo8S164iNecmA7pUtzSFBWRCT3wro=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SW3bD3dgwz4x5J;
        Thu, 16 Nov 2023 13:17:44 +1100 (AEDT)
Date:   Thu, 16 Nov 2023 13:17:33 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 16
Message-ID: <20231116131733.0eae6e6a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/9H9uxCalqAO8oiWXc3lFYLS";
...
Non-merge commits (relative to Linus' tree): 1311
 1465 files changed, 48377 insertions(+), 76883 deletions(-)
...
Merging origin/master (c42d9eeef8e5 Merge tag 'hardening-v6.7-rc2' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/kees/linux)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (24cfe644de19 kexec-fix-kexec_file=
-dependencies-fix)
...
Merging net/main (674e31808946 net: Fix undefined behavior in netdev name a=
llocation)
Merging bpf/master (1fda5bb66ad8 bpf: Do not allocate percpu memory at init=
 stage)
Merging ipsec/master (de5724ca38fd xfrm: fix a data-race in xfrm_lookup_wit=
h_ifid())
Merging netfilter/main (8837ba3e58ea netfilter: nf_tables: split async and =
...
Merging mm/mm-everything (3cca0532d407 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
or-next)
Merging samsung-krzk/for-next (48c89bcb9382 Merge branch 'next/dt' into for=
-next)
...
riant)
Merging bcachefs/for-next (f59c21a6d935 bcachefs: Improved backpointer mess=
ages in fsck)
$ git reset --hard HEAD^
...
- add missing escape)
Merging drm-misc/for-linux-next (312292a4ee19 drm/client: Do not acquire mo=
dule reference)
Merging amdgpu/drm-next (8473bfdcb5b1 drm/amdgpu: fix error handling in amd=
gpu_vm_init)
Merging drm-intel/for-linux-next (7c8601aea3a5 drm/i915: Fix fractional bpp=
 handling in intel_link_bw_reduce_bpp())
...
Merging pinctrl-samsung/for-next (4f2ffb1c3ffe dt-bindings: pinctrl: samsun=
g: add exynosautov920)
...

=kr61
-----END PGP SIGNATURE-----
