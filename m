Return-Path: <linux-next+bounces-4-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CBF9C7F24A7
	for <lists+linux-next@lfdr.de>; Tue, 21 Nov 2023 04:32:54 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CBDCC2816C2
	for <lists+linux-next@lfdr.de>; Tue, 21 Nov 2023 03:32:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ABBB1168AB;
	Tue, 21 Nov 2023 03:32:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="sdVn2ICd"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CC207C1;
	Mon, 20 Nov 2023 19:32:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1700537555;
	bh=LQZ6AMEO8GLYSTKuBfy50UX5CciUIrq2Ter5GnxUSZ0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4SZ91H5J6Hz4xSy;
	Tue, 21 Nov 2023 14:32:35 +1100 (AEDT)
Date: Tue, 21 Nov 2023 14:32:34 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 21
Message-ID: <20231121143234.53b053c6@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/VMicGxuYMhq1TWHVWq/MrSM";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/VMicGxuYMhq1TWHVWq/MrSM
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20231120:

The pm tree gained a build failure for which I reverted 3 commits.
...
Non-merge commits (relative to Linus' tree): 1775
 2176 files changed, 69701 insertions(+), 85111 deletions(-)
...
DIAG modules)
Merging bpf/master (fcb905d83133 Merge branch 'bpf_redirect_peer fixes')
...
Merging drivers-x86-fixes/fixes (c6ea14d55734 platform/x86/amd/pmc: adjust =
getting DRAM size behavior)
...
Merging iommufd-fixes/for-rc (98b1cc82c4af Linux 6.7-rc2)
...
_parse_param())
Merging drm-misc-fixes/for-linux-next-fixes (bb0a05acd612 drm/rockchip: vop=
: Fix color for RGB888/BGR888 format on VOP full)
...
o for-linux-next)
Merging stm32/stm32-next (482543590fc9 ARM: dts: stm32: use the same 3v3 fo=
r SD and DSI nodes on stm32f469-disco)
...
Merging loongarch/loongarch-next (13b5db3da906 Docs/zh_CN/LoongArch: Update=
...
Merging parisc-hd/for-next (238484ec4f1f parisc: Specify alignments for .PA=
RISC.unwind and .data..lock_aligned)
...
riant)
Merging bcachefs/for-next (b78ad0b94d2a bcachefs: Make sure bch2_move_ratel=
imit() also waits for move_ops)
...
Merging nfsd/nfsd-next (45e38a1de7ce NFSD: Remove nfsd_drc_gc() tracepoint)
...
Merging pm/linux-next (0f38380fcf37 Merge branch 'acpi-scan' into linux-nex=
t)
...
Merging bpf-next/for-next (57b97ecb40ca selftests/bpf: reduce verboseness o=
f reg_bounds selftest logs)
...
- add missing escape)
Merging drm-misc/for-linux-next (ae3436a5e7c2 drm/rockchip: rk3066_hdmi: Sw=
itch encoder hooks to atomic)
...
Merging drm-intel/for-linux-next (f1dfb517cc57 drm/i915/fbc: Bump ivb FBC m=
ax surface size to 4kx4k)
...
ith __counted_by)
Merging sound-asoc/for-next (03d1f43c85a6 Merge remote-tracking branch 'aso=
...
rt to DT schema)
Merging block/for-next (fe005daa67fc Merge branch 'block-6.7' into for-next)
...
Merging tip/master (2eb90844772e Merge branch into tip/master: 'perf/core')
...
Merging kspp-gustavo/for-next/kspp (167820dd258d Makefile: Enable -Wstringo=
p-overflow globally)
$ git reset --hard HEAD^
Merging next-20231120 version of kspp-gustavo
...
Applying: Revert "ACPI: property: Replicate DT-aligned u32 properties from =
DisCo for Imaging"
Applying: Revert "ACPI: property: Dig "rotation" property for devices with =
CSI2 _CRS"
Applying: Revert "ACPI: scan: Extract MIPI DisCo for Imaging data into swno=
des"
...

=GWLc
-----END PGP SIGNATURE-----
