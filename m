...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1BCF04A6AA9
	for <lists+linux-next@lfdr.de>; Wed,  2 Feb 2022 04:55:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243973AbiBBDzW (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 1 Feb 2022 22:55:22 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:46367 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232069AbiBBDzW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 1 Feb 2022 22:55:22 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JpScn17mKz4xjx;
        Wed,  2 Feb 2022 14:55:21 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1643774121;
        bh=428n4iZMFjMAPVsmg7Cf9Ue1iekvHnEoMZGaopdnlBM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 2 Feb 2022 14:55:20 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 2
Message-ID: <20220202145520.258ae4bf@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/oueAdUlE3RvSdGJ7CgzwSnF";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/oueAdUlE3RvSdGJ7CgzwSnF
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220201:

The drm-intel-fixes tree lost its build failure.

The amdgpu tree still had its build failure for which I applied a patch.

Non-merge commits (relative to Linus' tree): 3233
 3631 files changed, 140729 insertions(+), 45407 deletions(-)
...
Merging origin/master (9f7fb8de5d9b Merge tag 'spi-fix-v5.17-rc2' of git://=
...
Merging net/master (881cc731df6a net: phy: Fix qca8081 with speeds lower th=
an 2.5Gb/s)
...
er_active flag)
Merging wireless/main (fcda1cb81663 MAINTAINERS: add DT bindings files for =
ath10k and ath11k)
...
-linus)
Merging sound-asoc-fixes/for-linus (a4f399a1416f Input: wm97xx: Simplify re=
source management)
...
Merging spi-fixes/for-linus (19b2c9002d6b Merge remote-tracking branch 'spi=
/for-5.16' into spi-linus)
Merging pci-current/for-linus (053ca37c87af PCI: j721e: Initialize pcie->cd=
ns_pcie before using it)
...
Merging drivers-x86-fixes/fixes (836f35f79153 platform/x86: thinkpad_acpi: =
...
Merging zstd-fixes/zstd-linus (88a309465b3f lib: zstd: clean up double word=
 in comment.)
Merging drm-misc-fixes/for-linux-next-fixes (92c4cfaee687 dma-buf: heaps: F=
ix potential spectre v1 gadget)
...
Applying: net/mlx5e: Avoid field-overflowing memcpy()
Applying: net/mlx5e: Use struct_group() for memcpy() region
...
nto for-next)
Merging samsung-krzk/for-next (306b86074daf Merge branch 'next/dt64' into f=
or-next)
...
Merging ceph/master (4584a768f22b ceph: set pool_ns in new inode layout for=
 async creates)
Merging cifs/for-next (8b3c5f35feae Invalidate fscache cookie only when ino=
de attributes are changed.)
...
Merging hwmon-staging/hwmon-next (073e47255244 hwmon: Fix possible NULL poi=
nter)
...
rp_list)
Merging net-next/master (e4d2763f9aaf Merge branch 'lan966x-ptp')
Merging bpf-next/for-next (533de4aea6a9 Merge branch 'libbpf: deprecate xdp=
_cpumap, xdp_devmap and classifier sec definitions')
...
')
Merging bluetooth/master (25c7e34ec8d2 Bluetooth: mgmt: Remove unneeded var=
iable)
...
Merging amdgpu/drm-next (349fbcd8a3d7 drm/amdgpu/smu11.5: restore cclks in =
...
Applying: drm/amd: fix semicolon positioning
Merging drm-intel/for-linux-next (657b15d672f4 drm/i915: s/GRAPHICS_VER/DIS=
PLAY_VER/ where appropriate)
Merging drm-intel-gt/for-linux-next-gt (86df41418693 drm/i915: Introduce G1=
2 subplatform of DG2)
...
Merging fbdev/for-next (e2bc55335904 video: fbdev: pxa3xx-gcu: Remove unnec=
...
ting invalid values)
Merging sound-asoc/for-next (bb45f689fa62 ASoC: max98927: add missing heade=
r file)
...
n kobj_type)
Merging libata/for-next (6e163f9b866a ata: libata-scsi: Simplify scsi_XX_lb=
a_len())
...
Merging battery/for-next (28e54414a890 Merge tag 'psy-extcon-i2c-mfd-for-v5=
.18-signed' into psy-next)
...
comments)
Merging integrity/next-integrity (8a7153c2dd77 ima: Allow template selectio=
n with ima_template[_fmt]=3D after ima_hash=3D)
Merging keys/keys-next (2d743660786e Merge branch 'fixes' of git://git.kern=
el.org/pub/scm/linux/kernel/git/viro/vfs)
Merging safesetid/safesetid-next (1b8b71922919 LSM: SafeSetID: Mark safeset=
id_initialized as __initdata)
Merging selinux/next (6bc1968c14e9 selinux: try to use preparsed sid before=
 calling parse_sid())
...
Merging spi/for-next (70ee8d48f465 spi: Enhance and export helpers for ACPI=
 resources)
...
works for s390)
Merging rcu/rcu/next (8194b9a5e4a0 tools/memory-model: Explain syntactic an=
...
Merging drivers-x86/for-next (836f35f79153 platform/x86: thinkpad_acpi: Fix=
 incorrect use of platform profile on AMD platforms)
...
Merging cgroup/for-next (b1c852c71719 Merge branch 'for-5.17-fixes' into fo=
r-next)
...
l on remove)
Merging rpmsg/for-next (26291c54e111 Linux 5.17-rc2)
...
' into for-next)
Merging coresight/next (30d1f1c71bdd coresight: syscfg: Fix memleak on regi=
stration failure in cscfg_create_device)
...
Merging akpm/master (e1fd691398ee Merge branch 'akpm-current/current')
...

=5s0t
-----END PGP SIGNATURE-----
