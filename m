...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B03BB6EE4D8
	for <lists+linux-next@lfdr.de>; Tue, 25 Apr 2023 17:37:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234237AbjDYPhD (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 25 Apr 2023 11:37:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54662 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233442AbjDYPhC (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 25 Apr 2023 11:37:02 -0400
Received: from mail-pf1-x431.google.com (mail-pf1-x431.google.com [IPv6:2607:f8b0:4864:20::431])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EF53FAF22
        for <linux-next@vger.kernel.org>; Tue, 25 Apr 2023 08:36:57 -0700 (PDT)
Received: by mail-pf1-x431.google.com with SMTP id d2e1a72fcca58-63b62d2f729so4792956b3a.1
        for <linux-next@vger.kernel.org>; Tue, 25 Apr 2023 08:36:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1682437017; x=1685029017;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=T+O45jvNdRfrrhXKfRA6oojXmFYQ6zYoxsZ5v6HXUes=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1682437017; x=1685029017;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=T+O45jvNdRfrrhXKfRA6oojXmFYQ6zYoxsZ5v6HXUes=;
        b=
X-Gm-Message-State: AAQBX9eRYTWKztow98eyULAmIL7lBd1Hhx5PFmej3vwm2+AwuTkEquop
        H9n9FlXzlRKE9MewtgRGCYim6oYaOaTEfQRgN+x4igLm
X-Google-Smtp-Source: AKy350Z01jqqgEqUw7Zs0u7g/BOQGMhwjkh4xW3lY7DisvHIQpDj71FQ7NlMJB2Dxavzyn8U5QEqwQ==
X-Received: by 2002:a05:6a00:2448:b0:63b:7a55:ae89 with SMTP id d8-20020a056a00244800b0063b7a55ae89mr22989689pfj.27.1682437015727;
        Tue, 25 Apr 2023 08:36:55 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id s26-20020a056a00179a00b0063b58d2d7ddsm9856536pfg.140.2023.04.25.08.36.54
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 25 Apr 2023 08:36:54 -0700 (PDT)
Message-ID: <6447f396.050a0220.ad3bd.391a@mx.google.com>
Date:   Tue, 25 Apr 2023 08:36:54 -0700 (PDT)
...
Subject: next/master build: 200 builds: 13 failed, 187 passed, 16 errors,
 228 warnings (next-20230425)
...
next/master build: 200 builds: 13 failed, 187 passed, 16 errors, 228 warnin=
gs (next-20230425)
...
Tree: next
Branch: master
Git Describe: next-20230425
Git Commit: f600e0bbde8562a06bee31b3eb1b69d49acac4c5
...
Warnings summary:
    ...
    77   fs/ext4/super.c:5200:15: warning: unused variable =E2=80=98i=E2=80=
=99 [-Wunused-variable]
    77   fs/ext4/super.c:1262:6: warning: unused variable =E2=80=98i=E2=80=
=99 [-Wunused-variable]
...
Section mismatches summary:
    ...
    10   WARNING: modpost: vmlinux.o: section mismatch in reference: smp_ca=
