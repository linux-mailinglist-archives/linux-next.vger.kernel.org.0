...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E2A091F80BA
	for <lists+linux-next@lfdr.de>; Sat, 13 Jun 2020 05:30:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726424AbgFMDac (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 12 Jun 2020 23:30:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34124 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726392AbgFMDac (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 12 Jun 2020 23:30:32 -0400
Received: from mail-pj1-x1042.google.com (mail-pj1-x1042.google.com [IPv6:2607:f8b0:4864:20::1042])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12280C03E96F
        for <linux-next@vger.kernel.org>; Fri, 12 Jun 2020 20:30:32 -0700 (PDT)
Received: by mail-pj1-x1042.google.com with SMTP id k2so4427444pjs.2
        for <linux-next@vger.kernel.org>; Fri, 12 Jun 2020 20:30:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=n5CsxiKfHhMtm3791m8venh21/ZOiuSoSP80rOAepaY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=n5CsxiKfHhMtm3791m8venh21/ZOiuSoSP80rOAepaY=;
        b=
X-Gm-Message-State: AOAM530XMETNU0seSwJN5ank3CpmlWCf2w4fcPYiLni+SiSETeZLGNXZ
        tEC6VkV+nMm0zAZQoD2CL+saEl0EpWk=
X-Google-Smtp-Source: ABdhPJz2UQw9+MKjUB1pUd2VbwbfJxqefCMLv6sVIOl1dXzT8Q6kJX9NRRHMw/4zBjJplwqPtAupiw==
X-Received: by 2002:a17:90a:e60c:: with SMTP id j12mr1851841pjy.185.1592019029138;
        Fri, 12 Jun 2020 20:30:29 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id 204sm154778pfx.119.2020.06.12.20.30.27
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 12 Jun 2020 20:30:28 -0700 (PDT)
Message-ID: <5ee44854.1c69fb81.d704.0999@mx.google.com>
Date:   Fri, 12 Jun 2020 20:30:28 -0700 (PDT)
...
Subject: next/pending-fixes build: 150 builds: 4 failed, 146 passed, 4 errors,
 92 warnings (v5.7-14706-g24b012885d29)
...
next/pending-fixes build: 150 builds: 4 failed, 146 passed, 4 errors, 92 wa=
rnings (v5.7-14706-g24b012885d29)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.7-14706-g24b012885d29/

Tree: next
Branch: pending-fixes
Git Describe: v5.7-14706-g24b012885d29
Git Commit: 24b012885d29e4417cbbe62ebc2f4675099bb362
...
time_assert_488=E2=80=99 declared with attribute error: BUILD_BUG_ON failed=
...
Errors:
    include/linux/compiler.h:392:38: error: call to =E2=80=98__compiletime_=
assert_488=E2=80=99 declared with attribute error: BUILD_BUG_ON failed: off=
setof(struct task_struct, wake_entry_type) - offsetof(struct task_struct, w=
ake_entry) !=3D offsetof(struct __call_single_data, flags) - offsetof(struc=
t __call_single_data, llist)
