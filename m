...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id F3DF95A75ED
	for <lists+linux-next@lfdr.de>; Wed, 31 Aug 2022 07:50:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229530AbiHaFuF (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 31 Aug 2022 01:50:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40764 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229504AbiHaFuE (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 31 Aug 2022 01:50:04 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A5F5D1EC7F;
        Tue, 30 Aug 2022 22:50:00 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4MHYD66N1vz4x2c;
        Wed, 31 Aug 2022 15:49:58 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1661924999;
        bh=9k9yY4gDgIlCofvX/fpm5814VkNpLxk/izugTzLWIi4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 31 Aug 2022 15:49:57 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 31
Message-ID: <20220831154957.5dc03ff0@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/DO=WjBKc/NZcM/6lN/IHH=p";
...
--Sig_/DO=WjBKc/NZcM/6lN/IHH=p
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220830:
...
The hwmon-staging tree gained a semantic conflict against the i2c tree.
...
Non-merge commits (relative to Linus' tree): 3885
 5778 files changed, 264861 insertions(+), 79081 deletions(-)
...
Merging net/master (f612466ebecb net/sched: fix netdevice reference leaks i=
n attach_default_qdiscs())
...
Merging usb.current/usb-linus (b46a6b09fa05 usb: cdns3: fix issue with rear=
ming ISO OUT endpoint)
Merging usb-gadget-fixes/fixes (e49d033bddf5 Linux 5.12-rc6)
Merging usb-serial-fixes/usb-linus (6f721d9eacf3 USB: serial: cp210x: add D=
ecagon UCA device id)
...
Merging v4l-dvb-fixes/fixes (568035b01cfb Linux 6.0-rc1)
...
er for_each macros)
Merging perf/perf/core (2f4c2fbd2ff5 perf branch: Add PERF_BR_NEW_ARCH_[N] =
map for BRBE on arm64 platform)
$ git reset --hard HEAD^
...
Merging arm/for-next (a72b4b3ba681 Merge branches 'misc' and 'fixes' into f=
or-next)
...
o next)
Merging mediatek/for-next (7eee010a8b15 Merge branch 'v6.0-next/soc' into f=
or-next)
...
Merging ceph/master (a8af0d682ae0 libceph: clean up ceph_osdc_start_request=
 prototype)
Merging cifs/for-next (3e3761f1ec7d smb3: use filemap_write_and_wait_range =
...
ock uuid)
Merging f2fs/dev (35c981206518 f2fs: fix missing mapping caused by the moun=
t/umount race)
...
Merging hwmon-staging/hwmon-next (47efd143900b docs: hwmon: add emc2305.rst=
 to docs)
...
Merging v4l-dvb-next/master (61890ccaefaf media: platform: mtk-mdp3: add Me=
diaTek MDP3 driver)
...
Merging net-next/master (146ecbac1d32 net: devlink: stub port params cmds f=
or they are unused internally)
Merging bpf-next/for-next (6f95de6d7131 bpftool: Add support for querying c=
group_iter link)
...
Merging sound-asoc/for-next (56950c685574 Merge remote-tracking branch 'aso=
...
interrupts)
Merging spi/for-next (3cfcb7b6f2d8 Merge remote-tracking branch 'spi/for-6.=
1' into spi-next)
...
Merging mm/mm-everything (ccde883b85c1 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...

=Jl6I
-----END PGP SIGNATURE-----
