...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4E1CC5E78DB
	for <lists+linux-next@lfdr.de>; Fri, 23 Sep 2022 12:56:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229584AbiIWK4s (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 23 Sep 2022 06:56:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34276 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231433AbiIWK4T (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 23 Sep 2022 06:56:19 -0400
Received: from mail-pj1-x102e.google.com (mail-pj1-x102e.google.com [IPv6:2607:f8b0:4864:20::102e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 47D592F033
        for <linux-next@vger.kernel.org>; Fri, 23 Sep 2022 03:55:23 -0700 (PDT)
Received: by mail-pj1-x102e.google.com with SMTP id q9-20020a17090a178900b0020265d92ae3so5371377pja.5
        for <linux-next@vger.kernel.org>; Fri, 23 Sep 2022 03:55:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date;
        bh=tHFKPGKCxCf4bkTFuTJG7H3kL0pKTAWDKZsJ0rccnOE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=tHFKPGKCxCf4bkTFuTJG7H3kL0pKTAWDKZsJ0rccnOE=;
        b=
X-Gm-Message-State: ACrzQf0hxtX/PIPuSJxWNg32NWfkuaCdz75xnK8TVwlbFzfjlun41VI3
        CYueBoDog0Ek+wiVZgS9ozt+GTLuMtnk4BvQJvE=
X-Google-Smtp-Source: AMsMyM58K8523c/ePVjk7cfmvQhJxVsSbScmV6tO479Q0xK19Wa/AR5cbGtEqCA0FABQ456hfHXcog==
X-Received: by 2002:a17:90b:314b:b0:203:41c:2dbb with SMTP id ip11-20020a17090b314b00b00203041c2dbbmr8828131pjb.18.1663930521254;
        Fri, 23 Sep 2022 03:55:21 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id p3-20020a170902e74300b00176ab6a0d5fsm5841787plf.54.2022.09.23.03.55.20
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 23 Sep 2022 03:55:20 -0700 (PDT)
Message-ID: <632d9098.170a0220.4b287.b4c0@mx.google.com>
Date:   Fri, 23 Sep 2022 03:55:20 -0700 (PDT)
...
Subject: next/master build: 221 builds: 13 failed, 208 passed, 48 errors,
 98 warnings (next-20220923)
...
next/master build: 221 builds: 13 failed, 208 passed, 48 errors, 98 warning=
s (next-20220923)
...
Tree: next
Branch: master
Git Describe: next-20220923
Git Commit: aaa11ce2ffc84166d11c4d2ac88c3fcf75425fbd
...
warnings
    ...
    multi_v5_defconfig (clang-16): 2 errors
...
sparc:
    ...
    tinyconfig (gcc-10): 22 errors, 12 warnings

x86_64:
    allmodconfig (clang-16): 2 errors, 8 warnings
    allnoconfig (clang-16): 1 error
    cros://chromeos-5.10/x86_64/chromeos-intel-denverton.flavour.config+x86=
...
Errors summary:
    ...
    11   include/linux/srcu.h:226:3: error: implicit declaration of functio=
n =E2=80=98__srcu_read_unlock_nmisafe=E2=80=99; did you mean =E2=80=98srcu_=
read_unlock_nmisafe=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    11   include/linux/srcu.h:181:12: error: implicit declaration of functi=
on =E2=80=98__srcu_read_lock_nmisafe=E2=80=99; did you mean =E2=80=98srcu_r=
ead_lock_nmisafe=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    11   error: write on a pipe with no reader
    3    drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c:222:6=
: error: variable 'ret' is used uninitialized whenever 'if' condition is tr=
ue [-Werror,-Wsometimes-uninitialized]
    3    cc1: error: =E2=80=98-mloongson-mmi=E2=80=99 must be used with =E2=
=80=98-mhard-float=E2=80=99
    2    arch/arm/probes/kprobes/core.c:412:29: error: .fnstart must preced=
e .pad directive
    2    arch/arm/probes/kprobes/core.c:409:30: error: .fnstart must preced=
e .save or .vsave directives
    1    ld.lld: error: undefined symbol: memblk_nr_poison_sub
    1    ld.lld: error: undefined symbol: memblk_nr_poison_inc
    1    arch/arm/kernel/head.S:319: Error: missing expression -- `ldr r7,=
=3D0x'
    1    arch/arm/kernel/head.S:319: Error: missing expression -- `ldr r3,=
=3D0x'
    1    ./usr/include/asm/perf_regs.h:42:26: error: C++ style comments are=
...
-Wcpp]
    3    drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c:211:9=
...
t() falls through to next function m5mols_open()
...
Errors:
    ...
    ld.lld: error: undefined symbol: memblk_nr_poison_inc
    ld.lld: error: undefined symbol: memblk_nr_poison_sub

---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-16) =E2=80=94 FAIL, 2 errors, 8 warnings, 0 sec=
tion mismatches

Errors:
    error: write on a pipe with no reader
    drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c:222:6: err=
or: variable 'ret' is used uninitialized whenever 'if' condition is true [-=
...
alls through to next function m5mols_open()
    drivers/thermal/intel/int340x_thermal/int340x_thermal_zone.c:211:9: not=
e: initialize the variable 'ret' to silence this warning
...
Errors:
    ./usr/include/asm/perf_regs.h:42:26: error: C++ style comments are not =
allowed in ISO C90
...
Errors:
    arch/arm/probes/kprobes/core.c:409:30: error: .fnstart must precede .sa=
ve or .vsave directives
    arch/arm/probes/kprobes/core.c:412:29: error: .fnstart must precede .pa=
d directive
...
---------------------------------------------------------------------------=
-----
multi_v5_defconfig (arm, clang-16) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
tinyconfig (sparc, gcc-10) =E2=80=94 FAIL, 22 errors, 12 warnings, 0 sectio=
n mismatches

Errors:
    include/linux/srcu.h:181:12: error: implicit declaration of function =
=E2=80=98__srcu_read_lock_nmisafe=E2=80=99; did you mean =E2=80=98srcu_read=
_lock_nmisafe=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    include/linux/srcu.h:226:3: error: implicit declaration of function =E2=
=80=98__srcu_read_unlock_nmisafe=E2=80=99; did you mean =E2=80=98srcu_read_=
unlock_nmisafe=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    include/linux/srcu.h:181:12: error: implicit declaration of function =
=E2=80=98__srcu_read_lock_nmisafe=E2=80=99; did you mean =E2=80=98srcu_read=
_lock_nmisafe=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    include/linux/srcu.h:226:3: error: implicit declaration of function =E2=
