...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7B19E571715
	for <lists+linux-next@lfdr.de>; Tue, 12 Jul 2022 12:19:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232464AbiGLKTn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 12 Jul 2022 06:19:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43300 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232428AbiGLKTl (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 12 Jul 2022 06:19:41 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4E0BFACF54;
        Tue, 12 Jul 2022 03:19:38 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LhxZJ4rFZz4xMW;
        Tue, 12 Jul 2022 20:19:36 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1657621176;
        bh=Iz+6fakA6UkIN8FtRBlR2d/KW3RtsQiKYxmXT+R6RDw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 12 Jul 2022 20:19:35 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 12
Message-ID: <20220712201935.4b458d1f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/vyfP+/DSD/Un4My=8TwS8_E";
...
--Sig_/vyfP+/DSD/Un4My=8TwS8_E
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220711:

The apparmor tree gained a build failure so I used the version from
next-20220711.

The irqchip tree lost its build failure.

The rust tree gained conflicts against the block and kbuild trees.

The mm tree gained conflicts against the m68k tree.

Non-merge commits (relative to Linus' tree): 8936
 9593 files changed, 853024 insertions(+), 249501 deletions(-)
...
Merging origin/master (5a29232d870d Merge tag 'for-5.19-rc6-tag' of git://g=
...
Merging net/master (e45955766b43 Merge git://git.kernel.org/pub/scm/linux/k=
...
context BUG)
Merging sound-current/for-linus (d16d69bf5a25 ALSA: hda/conexant: Apply qui=
rk for another HP ProDesk 600 G3 model)
Merging sound-asoc-fixes/for-linus (e33836690925 Merge remote-tracking bran=
...
Merging arm-soc/for-next (8faad023b18b soc: document merges)
...
Merging m68k/for-next (f80261e4764b m68k: defconfig: Update defconfigs for =
v5.19-rc1)
...
Merging mips/mips-next (40c0f5016391 MIPS: Fixed __debug_virt_addr_valid())
...
e)
Merging cifs/for-next (6136a99bbaf4 cifs: on force umount, force close all =
handles)
...
Merging net-next/master (10c8fd2f7a40 bcm63xx: fix Tx cleanup when NAPI pol=
l budget is zero)
...
Merging bpf-next/for-next (efc9909fdce0 bpf, arm64: Add bpf trampoline for =
arm64)
...
Merging drm/drm-next (c6a3d73592ae Merge tag 'drm-intel-gt-next-2022-06-29'=
...
Merging drm-misc/for-linux-next (fc8d29e298cf drm: selftest: convert drm_mm=
 selftest to KUnit)
...
Merging drm-intel/for-linux-next (e2cecf5f3a53 drm/i915/selftests: fix subt=
raction overflow bug)
...
Merging fbdev/for-next (a58f4c5f3f90 video: fbdev: Make *fb_setup() and *fb=
_init() static)
...
ion)
Merging sound-asoc/for-next (d26502a15d8d Merge remote-tracking branch 'aso=
c/for-5.20' into asoc-next)
Merging modules/modules-next (c76654e22da1 MAINTAINERS: Update file list fo=
r module maintainers)
Merging input/next (39636805cab2 dt-bindings: input: iqs7222: Use central '=
linux,code' definition)
Merging block/for-next (89207938fce6 Merge branch 'for-5.20/io_uring' into =
for-next)
...
ting)
Merging apparmor/apparmor-next (6ff81169592d apparmor: add a kernel label t=
o use on kernel objects)
$ git reset --hard HEAD^
Merging next-20220711 version of apparmor
...
Merging devicetree/for-next (912cbf13a544 dt-bindings: mtd/partitions: Conv=
ert arm-firmware-suite to DT schema)
...
Merging spi/for-next (b46fc3ca9aaa Merge remote-tracking branch 'spi/for-5.=
20' into spi-next)
...
marm-master/next)
Merging kvms390/next (1b6abe95b522 s390: Add attestation query information)
Merging xen-tip/linux-next (166d38632316 xen/gntdev: Ignore failure to unma=
p INVALID_GRANT_HANDLE)
...
gsmld_poll())
Merging char-misc/char-misc-next (7e724422a7e9 Merge tag 'coresight-next-v5=
.20' of git://git.kernel.org/pub/scm/linux/kernel/git/coresight/linux into =
char-misc-next)
...
Merging staging/staging-next (39c1b1af3ea7 Merge 5.19-rc6 into staging-next)
...
Merging gpio-brgl/gpio/for-next (0397aefa7037 dt-bindings: gpio: Convert TI=
...
Merging pinctrl/for-next (1bc08c9bbf3e Merge branch 'devel' into for-next)
...
())
Merging random/master (7d035183e9d7 x86/rdrand: Remove "nordrand" flag in f=
...
o mm-everything)
CONFLICT (content): Merge conflict in arch/m68k/include/asm/sun3_pgtable.h
...

=9pgq
-----END PGP SIGNATURE-----
