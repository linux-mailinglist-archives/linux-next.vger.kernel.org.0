Return-Path: <linux-next+bounces-4989-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 810419F5DCF
	for <lists+linux-next@lfdr.de>; Wed, 18 Dec 2024 05:32:42 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id B04311688F2
	for <lists+linux-next@lfdr.de>; Wed, 18 Dec 2024 04:32:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 630CA3597A;
	Wed, 18 Dec 2024 04:32:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="mD+TTLG+"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0AA804A02;
	Wed, 18 Dec 2024 04:32:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1734496356; cv=none; b=IElXywoESdpVcXhLhHToCgUD1uFj8JMECxd7B+S84MXP+kxgbguW/f1PYgVBvocEiKtv9tH5eeibacjlo2XO8niZ23aDaN83eUTbkrIYX5/xHK29TTpvLbWXun05KEbCmf+mZiB2KxMtv9P6C+m46OyfKbu2VGL9iEtOdSNK5FQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1734496356; c=relaxed/simple;
	bh=vTOMDWDaAiDXjVpQfdgCYFU8Lhvdqen+yVJ2htjCP1s=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=uyQfkR3ZvQ0K6wifx2zJvytG079ec7zxUFOQtXZsqJtDlyEwhlnnTknjoYQLJqSYQ17qhLWiISMVhIMmrL9/r8XZmIO6DnNAx1UYYudkevjYmvqteuUwJxigbZlA64yC2m66TpZVFI3c0F+xB9YJ8dlfhxE5F2Geu77r0y5pjXc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=mD+TTLG+; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1734496344;
	bh=n0aK9+Sri8c5aryo4jih30kskJVFUxfxTi2GnMNONPk=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YCgkw0vjlz4wcw;
	Wed, 18 Dec 2024 15:32:24 +1100 (AEDT)
Date: Wed, 18 Dec 2024 15:32:28 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 18
Message-ID: <20241218153228.695ee650@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_3KedCrpMSrrsJ+DL9QPPc7";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/_3KedCrpMSrrsJ+DL9QPPc7
...
Non-merge commits (relative to Linus' tree): 3899
 4239 files changed, 187192 insertions(+), 67622 deletions(-)
...
Merging origin/master (5529876063e1 Merge tag 'ftrace-v6.13-rc3' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/trace/linux-trace)
...
Merging fs-current (c8ac6956e882 Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (7ed2d9158877 qed: fix possible uninit pointer read in qed=
_mcp_nvm_info_populate())
...
-linus)
Merging sound-asoc-fixes/for-linus (e8d0ba147d90 ASoC: SOF: Intel: hda-dai:=
 Do not release the link DMA on STOP)
...
set ramp_delay)
Merging spi-fixes/for-linus (78d4f34e2115 Linux 6.13-rc3)
...
Merging tip-fixes/tip/urgent (fb52a2d376b2 Merge branch into tip/master: 'x=
86/urgent')
...
Merging s390/for-next (e322bafbe198 Merge branch 'pci-device-recovery' into=
 for-next)
...
Merging fs-next (753cde7214be Merge branch 'for-next' of git://git.kernel.o=
...
Merging pm/linux-next (d4e4250f2fbb Merge branch 'thermal-core' into linux-=
next)
...
Merging rdma/for-next (1950af31dc66 RDMA/bnxt_re: Remove unnecessary header=
 file inclusion)
Merging net-next/main (d22f955cc2cb rust: net::phy scope ThisModule usage i=
n the module_phy_driver macro)
...
ary checking)
Merging drm-misc/for-linux-next (6a8d72b80807 accel/amdxdna: Remove DRM_AMD=
XDNA_HWCTX_CONFIG_NUM)
Merging amdgpu/drm-next (e70ba4679540 drm/amdgpu/jpeg5.0.1: use num_jpeg_in=
st for SR-IOV)
Merging drm-intel/for-linux-next (1e28fbf8cbec drm/i915/dsc: Expose dsc sin=
k max slice count via debugfs)
...
Merging drm-xe/drm-xe-next (5637797add2a drm/xe/oa/uapi: Expose an unblock =
...
anagement)
Merging sound-asoc/for-next (f2ca2fb40c4c Merge remote-tracking branch 'aso=
...
Merging spi/for-next (5f96c211c639 Merge remote-tracking branch 'spi/for-6.=
14' into spi-next)
Merging tip/master (f220c40fae28 Merge branch into tip/master: 'x86/tdx')
...
Merging pwm/pwm/for-next (1c75bccc863b pwm: stm32-lp: Add check for clk_ena=
ble())
...
Merging rust/rust-next (517743c4e303 rust: alloc: align Debug implementatio=
n for Box with Display)
...
uild for PREEMPT_RT)
Applying: fix up for "x86/static-call: provide a way to do very early stati=
c-call updates"
...

=9Pup
-----END PGP SIGNATURE-----
