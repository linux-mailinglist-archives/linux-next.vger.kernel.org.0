...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 899FF2718CC
	for <lists+linux-next@lfdr.de>; Mon, 21 Sep 2020 02:19:58 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726221AbgIUATy (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 20 Sep 2020 20:19:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51660 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726126AbgIUATy (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 20 Sep 2020 20:19:54 -0400
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 723A0C061755
        for <linux-next@vger.kernel.org>; Sun, 20 Sep 2020 17:19:54 -0700 (PDT)
Received: by mail-pg1-x529.google.com with SMTP id u13so7420153pgh.1
        for <linux-next@vger.kernel.org>; Sun, 20 Sep 2020 17:19:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=6zGFi9NfL2JLua06CJ2PFRx30d6Z0iccslnsLKZJSb8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=6zGFi9NfL2JLua06CJ2PFRx30d6Z0iccslnsLKZJSb8=;
        b=
X-Gm-Message-State: AOAM532/b51zgqq9B2np4dGLXo6LuZ9GokV2LTlhdYKYSejQVyVvxQYs
        XqH0+XFR0l09dJwsChNygF9G22yZDUDEGA==
X-Google-Smtp-Source: ABdhPJxLWGwnAwpIHu2AsaatySU7QuJ+I5T29z4JK8w+pxZF5LoIvh+ZRxj1Fx3xktE/uvSBPDLhKA==
X-Received: by 2002:a17:902:a405:b029:d1:e598:3ffc with SMTP id p5-20020a170902a405b02900d1e5983ffcmr25592846plq.54.1600647591097;
        Sun, 20 Sep 2020 17:19:51 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id hg16sm8580069pjb.37.2020.09.20.17.19.49
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 20 Sep 2020 17:19:50 -0700 (PDT)
Message-ID: <5f67f1a6.1c69fb81.c0ae9.393d@mx.google.com>
Date:   Sun, 20 Sep 2020 17:19:50 -0700 (PDT)
...
Subject: next/pending-fixes build: 211 builds: 1 failed, 210 passed, 993 errors,
 186 warnings (v5.9-rc5-476-g3d0d0d2eb359)
...
next/pending-fixes build: 211 builds: 1 failed, 210 passed, 993 errors, 186=
 warnings (v5.9-rc5-476-g3d0d0d2eb359)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.9-rc5-476-g3d0d0d2eb359/
...
Errors summary:
    ...
    439  /usr/include/features.h:424:12: fatal error: sys/cdefs.h: No such =
file or directory
    242  /scratch/linux/tools/testing/selftests/kselftest_harness.h:56:10: =
fatal error: asm/types.h: No such file or directory
    92   /usr/include/stdio.h:27:10: fatal error: bits/libc-header-start.h:=
...
: No such file or directory
    ...
    8    test_execve.c:4:10: fatal error: cap-ng.h: No such file or directo=
ry
...
rgs=E2=80=99 isn=E2=80=99t known
    1    /scratch/linux/drivers/dax/super.c:325:6: error: redefinition of =
...
s" property but its #address-cells (1) differs from / (2)
    ...
    8    cc1: warning: -fsanitize=3Daddress not supported for this target
...
or SPI bus
    ...
    5    rsync -a /root/build/kselftest/lkdtm/PANIC.sh /root/build/kselftes=
...
ot/build/kselftest/lkdtm/CFI_FORWARD_PROTO.sh /root/build/_kselftest_/lkdtm/
    5    install -m 0744 run.sh /root/build/kselftest/lkdtm/WARNING_MESSAGE=
.sh
...
tiple instructions
    1    /tmp/cc4Rec6i.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/cc4Rec6i.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Errors:
    /scratch/linux/drivers/dax/super.c:325:6: error: redefinition of =E2=80=
=98dax_supported=E2=80=99

Warnings:
    /tmp/cc4Rec6i.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/cc4Rec6i.s:18192: Warning: using r15 results in unpredictable beha=
viour
