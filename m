...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6F1C54D1274
	for <lists+linux-next@lfdr.de>; Tue,  8 Mar 2022 09:41:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345041AbiCHIl6 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 8 Mar 2022 03:41:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47244 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1345030AbiCHIl5 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 8 Mar 2022 03:41:57 -0500
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6C6903FBE7;
        Tue,  8 Mar 2022 00:40:59 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KCTLf06Z4z4xxt;
        Tue,  8 Mar 2022 19:40:57 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1646728858;
        bh=lQyoXB9PApYNpDMeWWrgc7v5HVaf4+KmcxiZlzvfq28=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 8 Mar 2022 19:40:57 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 8
Message-ID: <20220308194057.235d14aa@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/jnsXUX3/UBvaBhGEyyFHxai";
...
--Sig_/jnsXUX3/UBvaBhGEyyFHxai
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220307:

The net-next tree gained a conflict against the staging.current tree.

The kspp tree lost its build failures.

Non-merge commits (relative to Linus' tree): 10354
 10401 files changed, 926977 insertions(+), 240164 deletions(-)
...
Merging origin/master (ea4424be1688 Merge tag 'mtd/fixes-for-5.17-rc8' of g=
...
Merging net/master (c70c453abcbf smsc95xx: Ignore -ENODEV errors when devic=
e is unplugged)
Merging bpf/master (18b1ab7aa76b xsk: Fix race at socket teardown)
Merging ipsec/master (a3d9001b4e28 Revert "xfrm: state and policy should fa=
il if XFRMA_IF_ID 0")
...
Merging regulator-fixes/for-linus (113bf7c7a9d1 Merge remote-tracking branc=
h 'regulator/for-5.16' into regulator-linus)
Merging spi-fixes/for-linus (8d1898c89e95 Merge remote-tracking branch 'spi=
...
Merging gpio-brgl-fixes/gpio/for-current (660c619b9d7c gpiolib: acpi: Conve=
rt ACPI value of debounce to microseconds)
...
Merging powerpc/next (2ca48dbb2107 powerpc/ftrace: Use STK_GOT in ftrace_mp=
rofile.S)
...
ct I/O support)
Merging fscache/fscache-next (e06b589ece07 netfs: Change the docs to match =
the renaming)
...
Merging pm/linux-next (0b4cb964dac5 Merge branch 'pm-core' into linux-next)
...
Merging net-next/master (72f00505f2d2 ptp: ocp: off by in in ptp_ocp_tod_gn=
ss_name())
...
Merging drm-msm/msm-next (cca96584b357 drm/msm/a6xx: Fix missing ARRAY_SIZE=
() check)
...
Merging sound-asoc/for-next (ba107416f8f7 Merge remote-tracking branch 'aso=
...
Merging input/next (f28af984e771 Input: mt6779-keypad - add MediaTek keypad=
 driver)
Merging block/for-next (92699143fa6b Merge branch 'for-5.18/64bit-pi' into =
for-next)
CONFLICT (content): Merge conflict in drivers/block/virtio_blk.c
CONFLICT (content): Merge conflict in fs/iomap/direct-io.c
Merging device-mapper/for-next (19b00594bfa7 dm: support bio polling)
...
S_DB1XXX boards)
Merging mmc/next (c43f91126b32 mmc: wmt-sdmmc: Fix an error handling path i=
n wmt_mci_probe())
...
inic power bank ICs)
Merging regulator/for-next (f31e493443f5 Merge remote-tracking branch 'regu=
...
rules)
Merging devicetree/for-next (ea87f1eb4fd8 dt-bindings: arm: Allow 32-bit 'c=
pu-release-addr' values)
Merging mailbox/mailbox-for-next (869b6ca39c08 dt-bindings: mailbox: Add mo=
re protocol and client ID)
Merging spi/for-next (651831162c57 Merge remote-tracking branch 'spi/for-5.=
18' into spi-next)
...
Merging usb-serial/usb-next (5b6ab28d0678 USB: serial: pl2303: fix GS type =
detection)
...
4.2.0.0 patches)
Merging vhost/linux-next (e4db3e7e6fb9 tools/virtio: fix after premapped bu=
f support)
...
Merging mhi/mhi-next (f87bbc906582 bus: mhi: ep: Add uevent support for mod=
ule autoloading)
...
Merging akpm/master (7fe0483bf990 kselftest/vm: override TARGETS from argum=
ents)
...

=Md7+
-----END PGP SIGNATURE-----
