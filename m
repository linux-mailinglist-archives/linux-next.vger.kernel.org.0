...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1EA2F6D17A8
	for <lists+linux-next@lfdr.de>; Fri, 31 Mar 2023 08:42:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230116AbjCaGmg (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 31 Mar 2023 02:42:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58288 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230095AbjCaGmc (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 31 Mar 2023 02:42:32 -0400
Received: from mail-pj1-x1033.google.com (mail-pj1-x1033.google.com [IPv6:2607:f8b0:4864:20::1033])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2BCB91B366
        for <linux-next@vger.kernel.org>; Thu, 30 Mar 2023 23:42:01 -0700 (PDT)
Received: by mail-pj1-x1033.google.com with SMTP id q102so19535003pjq.3
        for <linux-next@vger.kernel.org>; Thu, 30 Mar 2023 23:42:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112; t=1680244920;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=T4hZvSjbcO1szvOCVgscdOL6ecrH0kKzDLyeBf57z4g=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1680244920;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=T4hZvSjbcO1szvOCVgscdOL6ecrH0kKzDLyeBf57z4g=;
        b=
X-Gm-Message-State: AO0yUKXsCm9n9kK9RdmjoXlLe7Kh3JxnJJe0iCMjcvnsZcAOp0aks8FP
        8gBeDyrAqMl9KLg9GefX8hIOvbZfxXnL0rsW7Y4=
X-Google-Smtp-Source: AK7set8fhSxo/z9OKd9mcpZTdxpm8DnPjRgibInxk6BhD6QX/8/OtGKHie3fQZhcX1T+TQPnnx7CqA==
X-Received: by 2002:a05:6a20:3f0c:b0:db:4c00:7918 with SMTP id az12-20020a056a203f0c00b000db4c007918mr21298059pzb.0.1680244919405;
        Thu, 30 Mar 2023 23:41:59 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id c16-20020aa78c10000000b005e5b11335b3sm943269pfd.57.2023.03.30.23.41.58
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 30 Mar 2023 23:41:58 -0700 (PDT)
Message-ID: <642680b6.a70a0220.e764.2956@mx.google.com>
Date:   Thu, 30 Mar 2023 23:41:58 -0700 (PDT)
...
Subject: next/master build: 208 builds: 8 failed, 200 passed, 11 errors,
 42 warnings (next-20230331)
...
next/master build: 208 builds: 8 failed, 200 passed, 11 errors, 42 warnings=
 (next-20230331)
...
Tree: next
Branch: master
Git Describe: next-20230331
Git Commit: 4b0f4525dc4fe8af17b3daefe585f0c2eb0fe0a5
...
directory
    1    drivers/net/ethernet/ti/netcp_core.c:2085:4: error: format specifi=
es type 'long' but the argument has type 'int' [-Werror,-Wformat]
    1    drivers/net/ethernet/ti/netcp_core.c:2084:16: error: format =E2=80=
=98%ld=E2=80=99 expects argument of type =E2=80=98long int=E2=80=99, but ar=
gument 3 has type =E2=80=98int=E2=80=99 [-Werror=3Dformat=3D]
    1    drivers/cdx/cdx.c:393:8: error: incompatible function pointer type=
s initializing 'ssize_t (*)(const struct bus_type *, const char *, size_t)'=
 (aka 'long (*)(const struct bus_type *, const char *, unsigned long)') wit=
h an expression of type 'ssize_t (struct bus_type *, const char *, size_t)'=
 (aka 'long (struct bus_type *, const char *, unsigned long)') [-Wincompati=
ble-function-pointer-types]
    1    drivers/cdx/cdx.c:393:20: error: initialization of =E2=80=98ssize_=
t (*)(const struct bus_type *, const char *, size_t)=E2=80=99 {aka =E2=80=
=98long int (*)(const struct bus_type *, const char *, long unsigned int)=
=E2=80=99} from incompatible pointer type =E2=80=98ssize_t (*)(struct bus_t=
ype *, const char *, size_t)=E2=80=99 {aka =E2=80=98long int (*)(struct bus=
_type *, const char *, long unsigned int)=E2=80=99} [-Werror=3Dincompatible=
-pointer-types]
...
dant UACCESS disable
    1    drivers/net/ethernet/ti/netcp_core.c:2084:16: warning: format =E2=
=80=98%ld=E2=80=99 expects argument of type =E2=80=98long int=E2=80=99, but=
 argument 3 has type =E2=80=98int=E2=80=99 [-Wformat=3D]
...
Errors:
    drivers/cdx/cdx.c:393:20: error: initialization of =E2=80=98ssize_t (*)=
(const struct bus_type *, const char *, size_t)=E2=80=99 {aka =E2=80=98long=
 int (*)(const struct bus_type *, const char *, long unsigned int)=E2=80=99=
} from incompatible pointer type =E2=80=98ssize_t (*)(struct bus_type *, co=
nst char *, size_t)=E2=80=99 {aka =E2=80=98long int (*)(struct bus_type *, =
const char *, long unsigned int)=E2=80=99} [-Werror=3Dincompatible-pointer-=
types]
...
Errors:
    drivers/net/ethernet/ti/netcp_core.c:2084:16: error: format =E2=80=98%l=
d=E2=80=99 expects argument of type =E2=80=98long int=E2=80=99, but argumen=
t 3 has type =E2=80=98int=E2=80=99 [-Werror=3Dformat=3D]
...
Errors:
    drivers/cdx/cdx.c:393:8: error: incompatible function pointer types ini=
tializing 'ssize_t (*)(const struct bus_type *, const char *, size_t)' (aka=
 'long (*)(const struct bus_type *, const char *, unsigned long)') with an =
expression of type 'ssize_t (struct bus_type *, const char *, size_t)' (aka=
 'long (struct bus_type *, const char *, unsigned long)') [-Wincompatible-f=
...
Errors:
    drivers/net/ethernet/ti/netcp_core.c:2085:4: error: format specifies ty=
pe 'long' but the argument has type 'int' [-Werror,-Wformat]
...
Warnings:
    drivers/net/ethernet/ti/netcp_core.c:2084:16: warning: format =E2=80=98=
%ld=E2=80=99 expects argument of type =E2=80=98long int=E2=80=99, but argum=
ent 3 has type =E2=80=98int=E2=80=99 [-Wformat=3D]
