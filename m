...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EEF722E182D
	for <lists+linux-next@lfdr.de>; Wed, 23 Dec 2020 05:46:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726387AbgLWEq1 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 22 Dec 2020 23:46:27 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58490 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726361AbgLWEq1 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 22 Dec 2020 23:46:27 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 87C2AC0613D3;
        Tue, 22 Dec 2020 20:45:46 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4D10yH0WwSz9sVY;
        Wed, 23 Dec 2020 15:45:43 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1608698743;
        bh=eGg/3h7YJnITEqTK0KA4Fpx8U3P+FcOwBVKgpBF2ehw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 23 Dec 2020 15:45:42 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 23
Message-ID: <20201223154542.544915be@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/svKFM_r.q7moCOsP207/B=k";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/svKFM_r.q7moCOsP207/B=k
...
Merging kbuild-current/fixes (e37b12e4bb21 Merge tag 'for-linus-5.11-ofs1' =
...
Merging arm-soc-fixes/arm/fixes (f012afb6af3d ARM: dts: ux500/golden: Set d=
isplay max brightness)
Merging drivers-memory-fixes/fixes (3650b228f83a Linux 5.10-rc1)
Merging m68k-current/for-linus (2ae92e8b9b7e MAINTAINERS: Update m68k Mac e=
ntry)
Merging powerpc-fixes/fixes (9c7422b92cb2 powerpc/32s: Fix RTAS machine che=
ck with VMAP stack)
...
Merging net/master (2575bc1aa9d5 net: mvpp2: Fix GoP port 3 Networking Comp=
lex Control configurations)
Merging bpf/master (e7e518053c26 bpf: Add schedule point in htab_init_bucke=
ts())
Merging ipsec/master (56ce7c25ae15 xfrm: Fix oops in xfrm_replay_advance_bm=
p)
Merging netfilter/master (2575bc1aa9d5 net: mvpp2: Fix GoP port 3 Networkin=
g Complex Control configurations)
...
Merging sound-current/for-linus (13be30f156fd ALSA/hda: apply jack fixup fo=
r the Acer Veriton N4640G/N6640G/N2510G)
...
Merging regulator-fixes/for-linus (639b12846819 Merge remote-tracking branc=
...
ough cpumask_of(cpu))
Merging risc-v-fixes/fixes (de043da0b9e7 RISC-V: Fix usage of memblock_enfo=
rce_memory_limit)
...
Merging arm-soc/for-next (f012afb6af3d ARM: dts: ux500/golden: Set display =
max brightness)
...
Merging exfat/dev (9eb78c253275 exfat: Avoid allocating upcase table using =
kcalloc())
...
Merging bluetooth/master (05672a2c14a4 Bluetooth: btrtl: Enable central-per=
ipheral role)
...
Merging sound/for-next (13be30f156fd ALSA/hda: apply jack fixup for the Ace=
r Veriton N4640G/N6640G/N2510G)
...
IOMEM)
Merging block/for-next (eeb64f9ff09d Merge branch 'io_uring-5.11' into for-=
next)
Merging device-mapper/for-next (b77709237e72 dm cache: simplify the return =
...
Merging battery/for-next (c2362519a04a power: supply: Fix a typo in warning=
 message)
Merging regulator/for-next (639b12846819 Merge remote-tracking branch 'regu=
...
Merging kvm-arm/next (767c973f2e4a KVM: arm64: Declutter host PSCI 0.1 hand=
ling)
...
Merging akpm-current/current (f1ad893cd7da aio: simplify read_events())
CONFLICT (content): Merge conflict in Documentation/dev-tools/kasan.rst
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (3df7368a7dd7 secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=Lxc5
-----END PGP SIGNATURE-----
