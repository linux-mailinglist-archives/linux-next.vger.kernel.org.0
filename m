Return-Path: <linux-next+bounces-9294-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 42E42C99E36
	for <lists+linux-next@lfdr.de>; Tue, 02 Dec 2025 03:36:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id EABDB3A5189
	for <lists+linux-next@lfdr.de>; Tue,  2 Dec 2025 02:35:59 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 34CEB255F52;
	Tue,  2 Dec 2025 02:35:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="ZuE9uALe"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E86EF18BC3D;
	Tue,  2 Dec 2025 02:35:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764642957; cv=none; b=uHdnFMqd/GdZxijCz0iu4weWaugSveSQmYLid8AEfqwyGm5Jwm8g7NchN/wQwVf/mxhmOhpYN9HZrdy5iNSLdY84KnrZPopPaO3M2XtsRHp6VEY/bC1FkglDJ8llSk8VV5c+snN+4d62n8I8j7pDcUFMux0P6rwFYFpojsh0i4g=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764642957; c=relaxed/simple;
	bh=ohq7HIp3SQjnM8Sis3uqibPpUYVLHhVdwJ0mZ2Z1VbU=;
	h=Date:From:To:Cc:Subject:Message-ID:In-Reply-To:References:
	 MIME-Version:Content-Type; b=D3Miktu4HFBH3R58pg9raUuhBLeEI0+Poh6bsG8hm1yYccapR5zFm5Yqk2MTlwxYjKDH3JwDMLLgPi2Sby/8k8DQnsdUWHVViGqYOkkufWtWWJc0F5N4/nc9ykgHMjHoaV+U9A2ggweSODLFBUt1HpSOjTzglXKg6G9RChmB58s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=ZuE9uALe; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1764642948;
	bh=P9V/6xZ62FavdtS5WP/3i1ezIRFDd0uCIW1OMBCCf7g=;
	h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dL4dJ4Jpcz4w23;
	Tue, 02 Dec 2025 13:35:48 +1100 (AEDT)
Date: Tue, 2 Dec 2025 13:35:47 +1100
...
Subject: Re: linux-next: manual merge of the vfs-brauner tree with the s390
 tree
Message-ID: <20251202133547.207e6609@canb.auug.org.au>
In-Reply-To: <20251118110822.72e36c15@canb.auug.org.au>
References: <20251118110822.72e36c15@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/M6KYjZqp04E/C6R_StuadZW";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/M6KYjZqp04E/C6R_StuadZW
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

On Tue, 18 Nov 2025 11:08:22 +1100 Stephen Rothwell <sfr@canb.auug.org.au> =
wrote:
>
...
> between commit:
>=20
>   4ac286c4a8d9 ("s390/syscalls: Switch to generic system call table gener=
ation")
>=20
> from the s390 tree and commit:
>=20
>   b36d4b6aa88e ("arch: hookup listns() system call")
>=20
...
> index eb1175d627cf,5863787ab036..000000000000
...
>  -156  common	sched_setscheduler	sys_sched_setscheduler		sys_sched_setsch=
eduler
>  -157  common	sched_getscheduler	sys_sched_getscheduler		sys_sched_getsch=
eduler
>  -158  common	sched_yield		sys_sched_yield			sys_sched_yield
>  -159  common	sched_get_priority_max	sys_sched_get_priority_max	sys_sched=
_get_priority_max
>  -160  common	sched_get_priority_min	sys_sched_get_priority_min	sys_sched=
_get_priority_min
>  -161  common	sched_rr_get_interval	sys_sched_rr_get_interval	sys_sched_r=
r_get_interval_time32
...
>  -175  common	rt_sigprocmask		sys_rt_sigprocmask		compat_sys_rt_sigprocma=
sk
>  -176  common	rt_sigpending		sys_rt_sigpending		compat_sys_rt_sigpending
>  -177  common	rt_sigtimedwait		sys_rt_sigtimedwait		compat_sys_rt_sigtime=
dwait_time32
>  -178  common	rt_sigqueueinfo		sys_rt_sigqueueinfo		compat_sys_rt_sigqueu=
einfo
...
>  -239  common	sched_setaffinity	sys_sched_setaffinity		compat_sys_sched_s=
etaffinity
>  -240  common	sched_getaffinity	sys_sched_getaffinity		compat_sys_sched_g=
etaffinity
...
>  -262  common	clock_nanosleep		sys_clock_nanosleep		sys_clock_nanosleep_t=
ime32
...
>  -274  common	mq_timedreceive		sys_mq_timedreceive		sys_mq_timedreceive_t=
ime32
...
>  -285  common	inotify_add_watch	sys_inotify_add_watch		sys_inotify_add_wa=
tch
...
>  -304  common	set_robust_list		sys_set_robust_list		compat_sys_set_robust=
_list
>  -305  common	get_robust_list		sys_get_robust_list		compat_sys_get_robust=
_list
>  -306  common	splice			sys_splice			sys_splice
>  -307  common	sync_file_range		sys_sync_file_range		compat_sys_s390_sync_=
file_range
...
>  -330  common	rt_tgsigqueueinfo	sys_rt_tgsigqueueinfo		compat_sys_rt_tgsi=
gqueueinfo
...
>  -335  common	name_to_handle_at	sys_name_to_handle_at		sys_name_to_handle=
_at
>  -336  common	open_by_handle_at	sys_open_by_handle_at		compat_sys_open_by=
_handle_at
>  -337  common	clock_adjtime		sys_clock_adjtime		sys_clock_adjtime32
>  -338  common	syncfs			sys_syncfs			sys_syncfs
>  -339  common	setns			sys_setns			sys_setns
>  -340  common	process_vm_readv	sys_process_vm_readv		sys_process_vm_readv
>  -341  common	process_vm_writev	sys_process_vm_writev		sys_process_vm_wri=
tev
>  -342  common	s390_runtime_instr	sys_s390_runtime_instr		sys_s390_runtime=
_instr
...
>  -352  common	s390_pci_mmio_write	sys_s390_pci_mmio_write		sys_s390_pci_m=
mio_write
>  -353  common	s390_pci_mmio_read	sys_s390_pci_mmio_read		sys_s390_pci_mmi=
o_read
...
>  -378  common	s390_guarded_storage	sys_s390_guarded_storage	sys_s390_guar=
ded_storage
...
>  -424  common	pidfd_send_signal	sys_pidfd_send_signal		sys_pidfd_send_sig=
nal
>  -425  common	io_uring_setup		sys_io_uring_setup              sys_io_urin=
g_setup
>  -426  common	io_uring_enter		sys_io_uring_enter              sys_io_urin=
g_enter
>  -427  common	io_uring_register	sys_io_uring_register           sys_io_ur=
ing_register
...
>  -444  common	landlock_create_ruleset	sys_landlock_create_ruleset	sys_lan=
dlock_create_ruleset
>  -445  common	landlock_add_rule	sys_landlock_add_rule		sys_landlock_add_r=
ule
>  -446  common	landlock_restrict_self	sys_landlock_restrict_self	sys_landl=
ock_restrict_self
...
>  -459  common	lsm_get_self_attr	sys_lsm_get_self_attr		sys_lsm_get_self_a=
ttr
>  -460  common	lsm_set_self_attr	sys_lsm_set_self_attr		sys_lsm_set_self_a=
ttr
...

=IpFu
-----END PGP SIGNATURE-----
