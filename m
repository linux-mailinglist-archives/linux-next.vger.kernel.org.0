...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 12D644DC40E
	for <lists+linux-next@lfdr.de>; Thu, 17 Mar 2022 11:35:52 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232638AbiCQKgz (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 17 Mar 2022 06:36:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37026 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231676AbiCQKgy (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 17 Mar 2022 06:36:54 -0400
Received: from mx0a-001b2d01.pphosted.com (mx0b-001b2d01.pphosted.com [148.163.158.5])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CAFF21DEAA9;
        Thu, 17 Mar 2022 03:35:35 -0700 (PDT)
Received: from pps.filterd (m0098420.ppops.net [127.0.0.1])
        by mx0b-001b2d01.pphosted.com (8.16.1.2/8.16.1.2) with SMTP id 22HA8rtu015017;
        Thu, 17 Mar 2022 10:35:35 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from : content-type :
 mime-version : subject : message-id : date : cc : to; s=pp1;
 bh=6WnJtNszyeUf5fw33JHbCCGPkDQlfRZiVGRWkTgd33c=;
 b= HA== 
Received: from pps.reinject (localhost [127.0.0.1])
        by mx0b-001b2d01.pphosted.com with ESMTP id 3ev10cjr0w-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 17 Mar 2022 10:35:34 +0000
Received: from m0098420.ppops.net (m0098420.ppops.net [127.0.0.1])
        by pps.reinject (8.16.0.43/8.16.0.43) with SMTP id 22HAYY8b010402;
        Thu, 17 Mar 2022 10:35:34 GMT
Received: from ppma04fra.de.ibm.com (6a.4a.5195.ip4.static.sl-reverse.com [149.81.74.106])
        by mx0b-001b2d01.pphosted.com with ESMTP id 3ev10cjqyv-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 17 Mar 2022 10:35:33 +0000
Received: from pps.filterd (ppma04fra.de.ibm.com [127.0.0.1])
        by ppma04fra.de.ibm.com (8.16.1.2/8.16.1.2) with SMTP id 22HADXjU012755;
        Thu, 17 Mar 2022 10:35:31 GMT
Received: from b06cxnps4074.portsmouth.uk.ibm.com (d06relay11.portsmouth.uk.ibm.com [9.149.109.196])
        by ppma04fra.de.ibm.com with ESMTP id 3erk58sdxx-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Thu, 17 Mar 2022 10:35:31 +0000
Received: from d06av21.portsmouth.uk.ibm.com (d06av21.portsmouth.uk.ibm.com [9.149.105.232])
        by b06cxnps4074.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 22HAZSeo48497124
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Thu, 17 Mar 2022 10:35:28 GMT
Received: from d06av21.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id D181552052;
        Thu, 17 Mar 2022 10:35:28 +0000 (GMT)
Received: from smtpclient.apple (unknown [9.79.180.42])
        by d06av21.portsmouth.uk.ibm.com (Postfix) with ESMTP id 63DE752063;
        Thu, 17 Mar 2022 10:35:27 +0000 (GMT)
From:   Sachin Sant <sachinp@linux.ibm.com>
Content-Type: multipart/mixed;
        boundary="Apple-Mail=_47608743-7173-4516-9826-EA2B6864AFEC"
Mime-Version: 1.0 (Mac OS X Mail 15.0 \(3693.60.0.1.1\))
Subject: [powerpc] 5.17-rc8-next-20220317 build break kernel/sched/fair.o
Message-Id: <EF33D230-9A8F-41C5-A38D-95128603224F@linux.ibm.com>
Date:   Thu, 17 Mar 2022 16:05:26 +0530
Cc:     open list <linux-kernel@vger.kernel.org>
To:     linux-next@vger.kernel.org, Ingo Molnar <mingo@redhat.com>
X-Mailer: Apple Mail (2.3693.60.0.1.1)
X-TM-AS-GCONF: 00
X-Proofpoint-ORIG-GUID: Vwrtqa8O29w7uHnXLz1Ecf5ZCAvx0qE2
X-Proofpoint-GUID: KTconokPGOIrcO3Bg9VijZz5Dv4BW7wT
...
--Apple-Mail=_47608743-7173-4516-9826-EA2B6864AFEC
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain;
	charset=utf-8

Today=E2=80=99s next (5.17.0-rc8-next-20220317) fails to build on =
powerpc
...
'__WRITE_ONC'
  *(volatile typeof(x) *)&(x) =3D (val);    \
                                 ^~~
./arch/powerpc/include/asm/barrier.h:74:2: note: in expansion of macro =
'WRITE_ONCE'
  WRITE_ONCE(*p, v);      \
  ^~~~~~~~~~
./include/asm-generic/barrier.h:164:55: note: in expansion of macro =
'__smp_store_release'
 #define smp_store_release(p, v) do { kcsan_release(); =
__smp_store_release(p, v); } while (0)
                                                       =
^~~~~~~~~~~~~~~~~~~
./include/linux/rcupdate.h:455:3: note: in expansion of macro =
'smp_store_releas'
   smp_store_release(&p, RCU_INITIALIZER((typeof(p))_r_a_p__v)); \
   ^~~~~~~~~~~~~~~~~
./include/linux/rcupdate.h:455:25: note: in expansion of macro =
'RCU_INITIALIZER'
   smp_store_release(&p, RCU_INITIALIZER((typeof(p))_r_a_p__v)); \
                         ^~~~~~~~~~~~~~~
./include/linux/psi.h:58:2: note: in expansion of macro =
'rcu_assign_pointer'
...
commit c4ad6fcb67c42d65481c85733c8009c8afdfdf4e (refs/bisect/bad)
    sched/headers: Reorganize, clean up and optimize kernel/sched/fair.c =
dependencies
...
Content-Disposition: attachment;
	filename=config_next.txt
Content-Type: text/plain;
	x-unix-mode=0644;
	name="config_next.txt"
Content-Transfer-Encoding: quoted-printable

#
# Automatically generated file; DO NOT EDIT.
# Linux/powerpc 5.17.0-rc5 Kernel Configuration
#
