Return-Path: <linux-next+bounces-1674-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 9051588098D
	for <lists+linux-next@lfdr.de>; Wed, 20 Mar 2024 03:21:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E392B1F22456
	for <lists+linux-next@lfdr.de>; Wed, 20 Mar 2024 02:21:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B99107490;
	Wed, 20 Mar 2024 02:21:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="YwGGo7XR"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8A07E748E;
	Wed, 20 Mar 2024 02:21:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710901310; cv=none; b=bh0pquZcjaM0kX/cM76Up+V+ZMVnu3HsoLoxkOhO3DGGG0VfpDZ5ZbT8Yee0ECI1JMbuVrrg+p1t45wG7mhuIkYvM06G/hvq4dsgDN9miQV8HIVG3R4l+LBziU3Yz7OhvMHpAF6SiEopDMliaQTexchKEpJGYBA7IAulIkBY+eY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710901310; c=relaxed/simple;
	bh=sZ9CxW5pBXQAWSUrqzAiMl6KTIlZ/swBxGxGIGm7gkk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=eZWKErT0t9hrLxcGfSugagY6kWDdFg9VQ6bDUgxV8flncwI6aFbQ5HrImI5oTPq0JQOyZ7MxCLWxwVpnH7pTS/rNWABZ073tzt17lkn4mUBs30PDiKl53s1Z0igY6BBXiNeZEDRSrj2OHuMHPNP3B5OgK6BJPf6zGC+f1wFQGRs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=YwGGo7XR; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1710901302;
	bh=qzy5ruGtaehST+TqdvKiYBm1i4mZXO79QeFFxzredSo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Tzsm60PHvz4wZx;
	Wed, 20 Mar 2024 13:21:42 +1100 (AEDT)
Date: Wed, 20 Mar 2024 13:21:40 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 20
Message-ID: <20240320132140.4251a4df@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/CNeGXQLdkOpAbd9Hsp.Fks8";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/CNeGXQLdkOpAbd9Hsp.Fks8
...
Merging origin/master (78c3925c048c Merge tag 'soc-late-6.9' of git://git.k=
...
Merging net/main (32fa4366cc4d net: phy: fix phy_read_poll_timeout argument=
 type in genphy_loopback)
Merging bpf/master (f6e922365faf xsk: Don't assume metadata is always reque=
sted in TX completion)
Merging ipsec/master (773bb766ca4a xfrm: Allow UDP encapsulation only in of=
fload modes)
...
Merging spi-fixes/for-linus (cf6d79a0f576 spi: spi-imx: fix off-by-one in m=
x51 CPU mode burst length)
...
Merging nfsd-fixes/nfsd-fixes (c8d71dcaa396 nfsd: Fix error cleanup path in=
 nfsd_rename())
...
Merging omap/for-next (69f4343fc41d Merge branch 'omap-for-v6.9/n8x0-fixes'=
 into for-next)
Merging qcom/for-next (2eb303d4add3 Merge branches 'arm32-for-6.10', 'arm64=
...
Merging cifs/for-next (354c620afff2 smb311: additional compression flag def=
ined in updated protocol spec)
$ git reset --hard HEAD^
Merging next-20240319 version of cifs
...
Merging drm-intel/for-linux-next (4df6ac223cad drm/i915: Add includes for B=
UG_ON/BUILD_BUG_ON in i915_memcpy.c)
...
Merging drm-xe/drm-xe-next (43c4ff3ca2d1 drm/xe/guc: Don't support older Gu=
C 70.x releases)
  521db22a1d70 ("drm/xe: Invalidate userptr VMA on page pin fault")
  58480c1c912f ("drm/xe: Skip VMAs pin when requesting signal to the last X=
E_EXEC")
  989d07ac6bb7 ("drm/xe: Return if kobj creation is failed")
Merging etnaviv/etnaviv/next (b735ee173f84 drm/etnaviv: Restore some id val=
ues)
Merging fbdev/for-next (c2d953276b8b fbmon: prevent division by zero in fb_=
videomode_from_videomode())
...
Merging device-mapper/for-next (55e565c42dce dm-integrity: fix a memory lea=
k when rechecking the data)
...
/ELE/V2X MU)
Merging spi/for-next (cf6d79a0f576 spi: spi-imx: fix off-by-one in mx51 CPU=
 mode burst length)
Merging tip/master (eb8ed5b0e9d9 Merge branch into tip/master: 'x86/fpu')
...

=pvRW
-----END PGP SIGNATURE-----
