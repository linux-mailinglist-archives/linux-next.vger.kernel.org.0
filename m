Return-Path: <linux-next+bounces-9284-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CCB0C95A25
	for <lists+linux-next@lfdr.de>; Mon, 01 Dec 2025 04:11:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 462DC342163
	for <lists+linux-next@lfdr.de>; Mon,  1 Dec 2025 03:11:45 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 77B181B85F8;
	Mon,  1 Dec 2025 03:11:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="p1Uk6OPd"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ADD6736D51A;
	Mon,  1 Dec 2025 03:11:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764558703; cv=none; b=u/wR/XRZiEnh5Wxix2VX7yvdK5YgWn3GcdKXCxvylFyo4+upZwIY6JsWjFrZuRs9xapwF489M9bKV7NYuVXE6kjvrUG3rOrPtKLRB/ZeRQj7JhMrFQX9rEJP+wxONtyBBDQ0LyIvqfslcooZwVAsyGMZciCIhuQ51Sa7vD795pM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764558703; c=relaxed/simple;
	bh=j+xMUt94PAzumiYE5buKzeo89hGwZAYXRNp77Th6vQU=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=QW8qE+yqQQ5QnyekNONXIL8iZR2lwnh6ANJajzTo1YjrjQRPqEtRwm+g1AxjA6HyszmlG+JcrVVr9emMhBXk82PO3T5ZxrzTRK4I2UugycycRFoOuUz5Ffhi2NC3CFWmq/MVc7FMuUcY+lW1sv8nKdVFx3fkp8Lh7uWkZMYxCDQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=p1Uk6OPd; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1764558692;
	bh=/ngWR8XPWfgtOzml32A/Z+AdyAqbG7rWkGxEDvffQt0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dKTT06My0z4w93;
	Mon, 01 Dec 2025 14:11:32 +1100 (AEDT)
Date: Mon, 1 Dec 2025 14:11:32 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 1
Message-ID: <20251201141132.71c4a767@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ZF3LiV=JPW9P+xK7Zv53TsX";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/ZF3LiV=JPW9P+xK7Zv53TsX
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

The merge window is open, so please to not addd any v6.20 (v7.0?) material
to your linux-next included branches until after the merge window closes.

Changes since 20251128:

This kernel no longer produces a warning at boot time.

The vfs-brauner tree lost its build failure.

The ftrace tree gained a conflict against the bpf-next tree.

The vfio tree gained conflicts against the mm-nonmm-stable tree and a
semantic conflict against the mm-stable tree..

The memblock tree gained a conflict against the mm-nonmm-stable tree.

The iommufd tree gained a conflict against the vfio tree.

The devsec-tsm tree gained a conflict against the kvm-x86 tree.

Non-merge commits (relative to Linus' tree): 11825
 12058 files changed, 601400 insertions(+), 189320 deletions(-)
...
Merging origin/master (e69c7c175115 Merge tag 'timers_urgent_for_v6.18_rc8'=
...
es)
Merging erofs/dev (80d0c27a0a4a erofs: get rid of raw bi_end_io() usage)
Merging exfat/dev (2ee6b07dc795 exfat: fix remount failure in different pro=
cess environments)
Merging exportfs/exportfs-next (adc218676eef Linux 6.12)
Merging ext3/for_next (25554ea0b42b Pull udf extent block verification.)
Merging ext4/dev (1e366d088866 ext4: don't zero the entire extent if EXT4_E=
XT_DATA_PARTIAL_VALID1)
...
Merging ksmbd/ksmbd-for-next (84af72563cf5 cifs: Use netfs_alloc/free_folio=
q_buffer())
...
s)
Merging vfs-brauner/vfs.all (d6ea5537c1a6 Merge tag 'vfs-6.19-rc1.fd_prepar=
e' of gitolite.kernel.org:pub/scm/linux/kernel/git/vfs/vfs into vfs.all)
...
Merging mm-hotfixes/mm-hotfixes-unstable (90bc135154c8 um: disable KASAN_IN=
LINE when STATIC_LINK is selected)
Merging fs-current (cf46ed30bf9f Merge branch 'next-fixes' of https://git.k=
...
embly)
Merging net/main (e5235eb6cfe0 net: netpoll: initialize work queue before e=
rror checks)
...
ad mask values)
Merging mips-fixes/mips-fixes (841ecc979b18 MIPS: mm: kmalloc tlb_vpn array=
...
text)
Merging drm-fixes/drm-fixes (6dbcb801e1eb Merge tag 'drm-xe-fixes-2025-11-2=
...
Merging tip-fixes/tip/urgent (1d11c37e463c Merge branch into tip/master: 't=
imers/urgent')
...
der inclusion)
Merging mm-unstable/mm-unstable (2178727587e1 mm/huge_memory: fix folio spl=
it stats counting)
Merging mm-nonmm-unstable/mm-nonmm-unstable (ef7b2f46f63c ocfs2: validate i=
nline xattr size and entry count in ocfs2_xattr_ibody_list)
...
Merging fs-next (f8d93c0f7b5a Merge branch 'for-next' of https://git.kernel=
...
Merging i3c/i3c/next (de53ad6ca49e i3c: master: add WQ_PERCPU to alloc_work=
queue users)
Merging dmi/dmi-for-next (4d1b28a8119c firmware: dmi: Add info message for =
number of populated and total memory slots)
Merging hwmon-staging/hwmon-next (194ad0334ee1 hwmon: (dell-smm) Add Dell G=
...
Merging pm/linux-next (b8ed7c24b81a Merge branch 'thermal' into linux-next)
Merging cpufreq-arm/cpufreq/arm/linux-next (20ab00c83d2c rust: cpufreq: alw=
ays inline functions using build_assert with arguments)
...
Merging rdma/for-next (4022c7b6342a RDMA/mlx5: Add support for 1600_8x lane=
 speed)
Merging net-next/main (0177f0f07886 Merge tag 'linux-can-next-for-6.19-2025=
1129' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can-next)
...
600Gbps link mode)
Merging netfilter-next/main (ff736a286116 net: ipconfig: Replace strncpy wi=
th strscpy in ic_proto_name)
...
Merging mtd/mtd/next (2158890a1af1 mtd: sm_ftl: Fix typo in comment in sm_r=
ead_lba)
...
Merging drm/drm-next (62433efe0b06 Merge tag 'drm-misc-next-fixes-2025-11-2=
...
Merging drm-misc/for-linux-next (eec7e23d848d drm/panthor: Prevent potentia=
l UAF in group creation)
...
Merging drm-xe/drm-xe-next (2e38c50ae492 vfio/xe: Add device specific vfio_=
pci driver variant for Intel graphics)
...
Merging sound-asoc/for-next (326802feb68c Merge remote-tracking branch 'aso=
...
Merging block/for-next (9740d498a36f Merge branch 'for-6.19/block' into for=
-next)
...
Merging libata/for-next (6ce0dd9f54ea ata: libata-core: Disable LPM on Sili=
con Motion MD619{H,G}XCLDE3TC)
...
ery.c
Merging regulator/for-next (c4942771d16f Merge remote-tracking branch 'regu=
...
ing)
Merging tpmdd/next (6bd23dd7108d KEYS: trusted: Use tpm_ret_to_err() in tru=
sted_tpm2)
...
Merging spi/for-next (344a8d5cbfb7 Merge remote-tracking branch 'spi/for-6.=
19' into spi-next)
Merging tip/master (df0b466edcc5 Merge branch into tip/master: 'x86/sgx')
...
xt)
Merging ftrace/for-next (14ee8399690a Merge unused-tracepoints/for-next)
...
b-modules only)
Merging kvm-arm/next (7580855831fc Merge branch 'kvm-arm64/nv-xnx-haf' into=
 kvmarm/next)
...
Merging drivers-x86/for-next (0b39ce8f71c9 platform/x86/amd/pmf: Use devm_m=
utex_init() for mutex initialization)
...
PMI driver)
Merging driver-core/driver-core-next (f278809475f6 debugfs: Remove broken n=
o-mount mode)
...
Merging scsi-mkp/for-next (9086cac895c3 scsi: qla4xxx: Use time conversion =
macros)
...
Merging mhi/mhi-next (ac35e04f8000 bus: mhi: host: pci_generic: Add Foxconn=
 T99W760 modem)
Merging memblock/for-next (9f0a133cff27 memblock: only mark/clear KHO scrat=
ch memory when needed)
...
Merging bitmap/bitmap-for-next (00c5ce039598 rust: id_pool: fix broken intr=
a-doc link)
...
Merging turbostat/next (a3c68d2b55a7 tools/power turbostat: Allow run-time =
override to rapl_msrs)
...
Merging devsec-tsm/next (3532f6154971 crypto/ccp: Implement SEV-TIO PCIe ID=
E (phase1))
...

=mwQy
-----END PGP SIGNATURE-----
