...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 92520C46B1
	for <lists+linux-next@lfdr.de>; Wed,  2 Oct 2019 06:47:06 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726092AbfJBErF (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 2 Oct 2019 00:47:05 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:41999 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725851AbfJBErF (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 2 Oct 2019 00:47:05 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46jkBV44dPz9sPj;
        Wed,  2 Oct 2019 14:46:58 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1569991618;
        bh=2sBusMaWQuqKDBjKaNH2ejAILCK0TWIv+UPVHINO8lY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 2 Oct 2019 14:46:58 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 2
Message-ID: <20191002144658.6449b4b3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/HhU3+s0ch4L1mouJkdZH8N5";
...
Merging bpf/master (1bd63524593b libbpf: handle symbol versioning properly =
for libbpf.a)
...
Merging kselftest-fixes/fixes (a35667ceddc7 selftests: watchdog: Add comman=
...
Merging mips-fixes/mips-fixes (d345d9cad225 MIPS: cpu-bugs64: Mark inline f=
unctions as __always_inline)
...
Merging btrfs-fixes/next-fixes (31ea47b4c3f6 Merge branch 'misc-5.4' into n=
ext-fixes)
...
/rockchip.yaml
Merging samsung-krzk/for-next (adf22834e2da Merge branch 'for-v5.5/memory-s=
...
Merging rdma/for-next (54ecb8f7028c Linux 5.4-rc1)
Merging net-next/master (37a2fce09001 dt-bindings: sh_eth convert bindings =
to json-schema)
...
Merging wireless-drivers-next/master (0a3ce169476f mwifiex: use 'total_ie_l=
en' in mwifiex_update_bss_desc_with_ie())
...
Merging devicetree/for-next (5a58252fa37f dt-bindings: gpu: Convert Samsung=
 2D Graphics Accelerator to dt-schema)
...
Merging xen-tip/linux-next (04ccbdc390b1 xen/balloon: Clear PG_offline in b=
alloon_retrieve())
...
try at 0)
Merging hyperv/hyperv-next (48b72a2697d5 hv_netvsc: Add the support of hibe=
rnation)
...
rflow
Merging akpm/master (3c77e4ea45a8 drivers/media/platform/sti/delta/delta-ip=
...

=dcU0
-----END PGP SIGNATURE-----
