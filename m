...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B18FD444DDB
	for <lists+linux-next@lfdr.de>; Thu,  4 Nov 2021 05:02:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229824AbhKDEE6 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 4 Nov 2021 00:04:58 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:38887 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229477AbhKDEE6 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 4 Nov 2021 00:04:58 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Hl92M58nCz4xcJ;
        Thu,  4 Nov 2021 15:02:19 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1635998539;
        bh=3UZghy7Y4ZQ38TGvonewMeH1v1U0LTGu5jNtWS1ylws=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 4 Nov 2021 15:02:19 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 4
Message-ID: <20211104150219.65febe05@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/2JRt2esIxEiW/f3Sg5pAfxP";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/2JRt2esIxEiW/f3Sg5pAfxP
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211103:
...
Non-merge commits (relative to Linus' tree): 5095
 4870 files changed, 231022 insertions(+), 110253 deletions(-)
...
Merging origin/master (d4ec3d5535c7 Merge tag 'vfio-v5.16-rc1' of git://git=
...
Merging net/master (92f62485b371 net: dsa: felix: fix broken VLAN-tagged PT=
P under VLAN-aware bridge)
Merging bpf/master (c08455dec5ac selftests/bpf: Verifier test on refill fro=
m a smaller spill)
...
_qp on the GSI QP)
Merging sound-current/for-linus (1278cc5ac2f9 ALSA: hda/realtek: Headset fi=
xup for Clevo NH77HJQ)
Merging sound-asoc-fixes/for-linus (b017008c44f6 Merge remote-tracking bran=
...
Merging drm-misc-fixes/for-linux-next-fixes (8244a3bc27b3 drm/prime: Fix us=
e after free in mmap with drm_gem_ttm_mmap)
...
xt)
Merging clk/clk-next (e2ceaa867d26 Merge branches 'clk-composite-determine-=
fix', 'clk-allwinner', 'clk-amlogic' and 'clk-samsung' into clk-next)
...
inter dereference)
Merging parisc-hd/for-next (a1bd0b2ed2b7 parisc: Fix code/instruction patch=
...
tion)
Merging cifs/for-next (d8849ebcfd1c cifs: for compound requests, use open h=
andle if possible)
...
Merging nfs/linux-next (576acc259146 nfs4: take a reference on the nfs_clie=
nt when running FREE_STATEID)
...
Merging overlayfs/overlayfs-next (9a2544037600 ovl: fix use after free in s=
truct ovl_aio_req)
Merging ubifs/next (9aaa6cc099f6 ubifs: Document sysfs nodes)
Merging v9fs/9p-next (82f854eeef37 9p: fix a bunch of checkpatch warnings)
...
into for-next)
Merging pci/next (2f167b8a48d3 Merge branch 'remotes/lorenzo/pci/xgene')
...
used functions)
Merging pm/linux-next (464fddbba1df Merge tag 'pnp-5.16-rc1' of git://git.k=
...
Merging amdgpu/drm-next (555fa6653eba drm/amdgpu: bump driver version for I=
...
Merging sound/for-next (1278cc5ac2f9 ALSA: hda/realtek: Headset fixup for C=
levo NH77HJQ)
Merging sound-asoc/for-next (b017008c44f6 Merge remote-tracking branch 'aso=
...
Merging block/for-next (48dd8b1e4917 Merge branch 'for-5.16/drivers' into f=
or-next)
...
Merging security/next-testing (047843bdb316 Merge branch 'landlock_lsm_v34'=
 into next-testing)
Merging apparmor/apparmor-next (4d47fbbe54bf apparmor: fix zero-length comp=
iler warning in AA_BUG())
...
318 CPNC data)
Merging xen-tip/linux-next (eae446b7654f x86/xen: remove 32-bit awareness f=
rom startup_xen)
...
Merging akpm/master (fd5916b5bc39 kasan: add kasan mode messages when kasan=
 init)
...

=PRKY
-----END PGP SIGNATURE-----
