...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3C7A463FCF9
	for <lists+linux-next@lfdr.de>; Fri,  2 Dec 2022 01:25:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231402AbiLBAZ5 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 1 Dec 2022 19:25:57 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34412 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231395AbiLBAZH (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 1 Dec 2022 19:25:07 -0500
Received: from mail-pj1-x1029.google.com (mail-pj1-x1029.google.com [IPv6:2607:f8b0:4864:20::1029])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C6C68F27
        for <linux-next@vger.kernel.org>; Thu,  1 Dec 2022 16:20:29 -0800 (PST)
Received: by mail-pj1-x1029.google.com with SMTP id q15so2369706pja.0
        for <linux-next@vger.kernel.org>; Thu, 01 Dec 2022 16:20:29 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=IveddiECGgcSlriFBQ0hs3mZuhyiofNEhUqeMGOQjfQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=IveddiECGgcSlriFBQ0hs3mZuhyiofNEhUqeMGOQjfQ=;
        b=
X-Gm-Message-State: ANoB5plE8IsrUAKwuLh20hlBQnVmth3mfKJpOhISwlVsS3+pgaLG05to
        qNXJ96zlHzvwn1rRB8aeBC4zZSNhMX/KVrLT
X-Google-Smtp-Source: AA0mqf4RI/Ac1hDc2DRZ0WuYDEPc5xSt48DMGdwcg8/RbJsLtQojh7O/BqhL+U24nXdV+sWyJvyX8Q==
X-Received: by 2002:a17:902:e550:b0:184:dc59:cc9f with SMTP id n16-20020a170902e55000b00184dc59cc9fmr52457505plf.89.1669940427882;
        Thu, 01 Dec 2022 16:20:27 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id q5-20020a17090311c500b00178b6ccc8a0sm4256945plh.51.2022.12.01.16.20.26
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 01 Dec 2022 16:20:27 -0800 (PST)
Message-ID: <638944cb.170a0220.80eac.8bfe@mx.google.com>
Date:   Thu, 01 Dec 2022 16:20:27 -0800 (PST)
Content-Type: text/plain; charset="utf-8"
MIME-Version: 1.0
Content-Transfer-Encoding: quoted-printable
X-Kernelci-Branch: pending-fixes
X-Kernelci-Kernel: v6.1-rc7-241-g1ace8487757e
X-Kernelci-Report-Type: build
X-Kernelci-Tree: next
Subject: next/pending-fixes build: 206 builds: 4 failed, 202 passed, 12 errors,
 42 warnings (v6.1-rc7-241-g1ace8487757e)
...
next/pending-fixes build: 206 builds: 4 failed, 202 passed, 12 errors, 42 w=
arnings (v6.1-rc7-241-g1ace8487757e)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v6.1-rc7-241-g1ace8487757e/

Tree: next
Branch: pending-fixes
Git Describe: v6.1-rc7-241-g1ace8487757e
Git Commit: 1ace8487757e52f205591d915614472494e97d95
...
riscv:
    nommu_k210_defconfig (gcc-10): 3 errors, 1 warning
    nommu_k210_sdcard_defconfig (gcc-10): 3 errors, 1 warning
...
=80=98-mhard-float=E2=80=99
    2    drivers/gpio/gpiolib-cdev.c:1564:9: error: implicit declaration of=
 function =E2=80=98call_read_locked=E2=80=99; did you mean =E2=80=98xa_head=
_locked=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    2    drivers/gpio/gpiolib-cdev.c:1501:9: error: implicit declaration of=
 function =E2=80=98call_poll_locked=E2=80=99; did you mean =E2=80=98wake_up=
_all_locked=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    2    drivers/gpio/gpiolib-cdev.c:1466:9: error: implicit declaration of=
 function =E2=80=98call_ioctl_locked=E2=80=99 [-Werror=3Dimplicit-function-=
declaration]
...
---------------------------------------------------------------------------=
-----
nommu_k210_defconfig (riscv, gcc-10) =E2=80=94 FAIL, 3 errors, 1 warning, 0=
 section mismatches

Errors:
    drivers/gpio/gpiolib-cdev.c:1466:9: error: implicit declaration of func=
tion =E2=80=98call_ioctl_locked=E2=80=99 [-Werror=3Dimplicit-function-decla=
ration]
    drivers/gpio/gpiolib-cdev.c:1501:9: error: implicit declaration of func=
tion =E2=80=98call_poll_locked=E2=80=99; did you mean =E2=80=98wake_up_all_=
locked=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    drivers/gpio/gpiolib-cdev.c:1564:9: error: implicit declaration of func=
tion =E2=80=98call_read_locked=E2=80=99; did you mean =E2=80=98xa_head_lock=
ed=E2=80=99? [-Werror=3Dimplicit-function-declaration]
...
---------------------------------------------------------------------------=
-----
nommu_k210_sdcard_defconfig (riscv, gcc-10) =E2=80=94 FAIL, 3 errors, 1 war=
