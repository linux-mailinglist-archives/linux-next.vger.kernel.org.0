...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 950E4525D28
	for <lists+linux-next@lfdr.de>; Fri, 13 May 2022 10:24:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1378147AbiEMITo (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 13 May 2022 04:19:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53416 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1378134AbiEMITm (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 13 May 2022 04:19:42 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8DE93254728;
        Fri, 13 May 2022 01:19:37 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4L01lT243Bz4xY2;
        Fri, 13 May 2022 18:19:33 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1652429973;
        bh=rI8nTrKso89Gxs3sGI5LPG7pDcB7CadoWOit165v4E0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 13 May 2022 18:19:31 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 13
Message-ID: <20220513181931.2e9230cf@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ON=yny81IHOR3tNPEu=7t=/";
...
--Sig_/ON=yny81IHOR3tNPEu=7t=/
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220512:

The kvm tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 10551
 10962 files changed, 968535 insertions(+), 224903 deletions(-)
...
Merging origin/master (f3f19f939c11 Merge tag 'net-5.18-rc7' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/netdev/net)
Merging fixes/fixes (d06c942efea4 Merge tag 'for_linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/mst/vhost)
Merging mm-hotfixes/mm-hotfixes-unstable (5cf53e9ca501 Revert "mm/cma.c: re=
...
Merging net/master (f3f19f939c11 Merge tag 'net-5.18-rc7' of git://git.kern=
el.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (a48ab883c4a9 Merge tag 'for-net-2022-05-11' of git://gi=
...
Merging sound-current/for-linus (309d7363ca3d ALSA: hda/realtek: Add quirk =
...
Merging pci-current/for-linus (3b0b6e2182ff Revert "PCI: brcmstb: Split brc=
m_pcie_setup() into two funcs")
Merging driver-core.current/driver-core-linus (575f00edea0a Documentation/p=
rocess: Update ARM contact for embargoed hardware issues)
Merging tty.current/tty-linus (401fb66a355e fsl_lpuart: Don't enable interr=
upts too early)
Merging usb.current/usb-linus (1645eee0d7f6 usb: xhci-mtk: remove bandwidth=
 budget table)
...
Merging zstd-fixes/zstd-linus (88a309465b3f lib: zstd: clean up double word=
 in comment.)
Merging drm-misc-fixes/for-linux-next-fixes (6fed53de5607 drm/vc4: hdmi: Fi=
x build error for implicit function declaration)
Merging kbuild/for-next (2a66c3124afd modpost: change the license of EXPORT=
_SYMBOL to bool type)
Merging perf/perf/core (cad10ce36671 perf annotate: Add --percent-limit opt=
ion)
Merging compiler-attributes/compiler-attributes (7c00621dcaee compiler_type=
s: mark __compiletime_assert failure as __noreturn)
Merging dma-mapping/for-next (84bc4f1dbbbb dma-debug: change allocation mod=
e from GFP_NOWAIT to GFP_ATIOMIC)
Merging asm-generic/master (03a679a1a4ec Merge tag 'generic-ticket-spinlock=
s-v6' of git://git.kernel.org/pub/scm/linux/kernel/git/palmer/linux into as=
m-generic)
...
Merging arm64/for-next/core (6cade1247724 Merge branch 'for-next/misc' into=
 for-next/core)
Merging arm-perf/for-next/perf (c5781212985a perf/arm-cmn: Decode CAL devic=
es properly in debugfs)
Merging arm-soc/for-next (5759012ef3d7 Merge branch 'arm/fixes' into for-ne=
xt)
CONFLICT (content): Merge conflict in arch/arm/Kconfig
...
: Convert to yaml)
Merging rockchip/for-next (c0af4e49cc9a Merge branch 'v5.19-armsoc/dts64' i=
nto for-next)
...
tdowns)
Merging parisc-hd/for-next (590a4ea39d23 parisc: Implement flush_cache_vmap=
_vunmap)
...
ma)
Merging s390/for-next (c4fb15578802 Merge branch 'features' into for-next)
...
Merging xtensa/xtensa-for-next (b011946d039d xtensa/simdisk: fix proc_read_=
simdisk())
...
Merging ceph/master (f2e90ff2f81e fs: change test in inode_insert5 for addi=
ng to the sb list)
...
Merging erofs/dev (4ed212dddbde erofs: change to use asynchronous io for fs=
cache readpage/readahead)
...
Merging gfs2/for-next (833ab609b94f gfs2: Use container_of() for gfs2_glock=
(aspace))
...
Merging hwmon-staging/hwmon-next (07d762982fb9 hwmon: (sl28cpld-hwmon) Use =
...
MAT_H265)
Merging pm/linux-next (84d13b694ebb Merge branches 'thermal-intel-tcc' and =
'thermal-int340x-fixes' into linux-next)
...
Merging devfreq/devfreq-next (d84df1e3a782 PM / devfreq: passive: Keep cpuf=
req_policy for possible cpus)
...
Merging net-next/master (b67fd3d9d942 Merge branch 'net-inet-retire-port-on=
ly-listening_hash')
Merging bpf-next/for-next (a2aa95b71c9b bpf: Fix potential array overflow i=
n bpf_trampoline_get_progs())
...
Merging bluetooth/master (29aff7408263 Bluetooth: Fix the creation of hdev-=
>name)
Merging wireless-next/main (2c33360bce6a wfx: use container_of() to get vif)
Merging mtd/mtd/next (9a7459fd9be4 mtd: phram: Allow cached mappings)
Merging nand/nand/next (7363d3efa9da mtd: rawnand: renesas: Use runtime PM =
instead of the raw clock API)
Merging spi-nor/spi-nor/next (c47452194641 mtd: spi-nor: debugfs: fix forma=
t specifier)
Merging crypto/master (e4d1293cb19b crypto: vmx - Fix build error)
...
Merging drm-misc/for-linux-next (6071c4c2a319 drm/qxl: add drm_gem_plane_he=
lper_prepare_fb)
Merging amdgpu/drm-next (81c5495910e8 drm/amdgpu: Remove duplicated argumen=
t in vcn_v4_0)
...
Merging sound/for-next (542350509499 ALSA: Add generic serial MIDI driver u=
sing serial bus API)
...
R329 and D1)
Merging block/for-next (0c982ddc7d20 Merge branch 'for-5.19/io_uring-passth=
rough' into for-next)
...
S_DB1XXX boards)
Merging mmc/next (f7b6fc327327 mmc: core: Support zeroout using TRIM for eM=
MC)
...
Merging integrity/next-integrity (c46d541a00e0 Merge branch 'next-integrity=
...
finition for mt8186)
Merging spi/for-next (75d6fe48a21a spi: Doc fix - Describe add_lock and dma=
_map_dev in spi_controller)
...
Merging kvm-arm/next (75bcde935074 Merge branch kvm-arm64/misc-5.19 into kv=
marm-master/next)
...
Merging chrome-platform/for-next (7464ff8bf2d7 platform/chrome: cros_ec_typ=
ec: Check for EC driver)
...
Merging usb/usb-next (f9d76d15072c USB: gadget: Add ID numbers to gadget na=
mes)
...
Merging vfio/next (ff806cbd90bd vfio/pci: Remove vfio_device_get_from_dev())
...
bh() to spin_lock())
Merging cgroup/for-next (67158d17fdd4 Merge branch 'for-5.19' into for-next)
Merging scsi/for-next (1e25cde67d55 Merge branch 'misc' into for-next)
Merging scsi-mkp/for-next (0873fe44e780 scsi: target: iscsi: Rename iscsi_s=
ession to iscsit_session)
Merging vhost/linux-next (7ff960a6fe39 virtio: fix virtio transitional ids)
...
Merging pinctrl-intel/for-next (f68cd356d0ac pinctrl: broxton: Add module a=
lias for Intel Apollo Lake)
...
Merging hyperv/hyperv-next (a2bad844a67b PCI: hv: Fix interrupt mapping for=
 multi-MSI)
...
Merging kunit-next/kunit (9660209d9418 kunit: tool: print clearer error mes=
sage when there's no TAP output)
...
Merging random/master (ac6a19492a38 random: use static branch for crng_read=
y())
...
s_get())
Merging kspp/for-next/kspp (0a76d4c331b4 mm: usercopy: move the virt_addr_v=
alid() below the is_vmalloc_addr())
...
Merging mm-stable/mm-stable (996927eebdae mm/memory-failure.c: simplify num=
_poisoned_pages_inc/dec)
CONFLICT (content): Merge conflict in arch/x86/mm/Makefile
CONFLICT (content): Merge conflict in fs/nfs/file.c
CONFLICT (content): Merge conflict in include/linux/slab.h
CONFLICT (content): Merge conflict in mm/page_io.c
Merging mm-nonmm-stable/mm-nonmm-stable (25d9767831d3 ia64: mca: drop redun=
dant spinlock initialization)
CONFLICT (content): Merge conflict in include/linux/ptrace.h
Merging mm/mm-everything (4973d2cb6f87 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: fixup for "mm: change huge_ptep_clear_flush() to return the origi=
nal pte"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (47117b91e2dd mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=wHn4
-----END PGP SIGNATURE-----
