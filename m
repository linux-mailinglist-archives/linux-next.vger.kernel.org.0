Return-Path: <linux-next+bounces-9223-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 98453C87DEA
	for <lists+linux-next@lfdr.de>; Wed, 26 Nov 2025 03:52:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 482F84E1028
	for <lists+linux-next@lfdr.de>; Wed, 26 Nov 2025 02:52:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3E9B62F60B2;
	Wed, 26 Nov 2025 02:52:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="GkdS60OB"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E845E189F20;
	Wed, 26 Nov 2025 02:52:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764125565; cv=none; b=V1NKIVW685haWvmN7m6g1h6rcW7wZKUUBFvKwHQrUAoejjdlcytwC4x3gA6JEZO+q3HxiFG2eKmUwj8kwaNvobh9f4uKKOystCeU/isRN0ZdQlYyGj8QBaD76zR39n5W/2HuHAylp9HPYXtO1zTzvekKQ2R3b78ZdFFtyHaUT5s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764125565; c=relaxed/simple;
	bh=dTrZ8NQ3Wmq8EcS5LYKbMfnX/S66ldmymvTHxHLvLWk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=HWKuy+0VSdSZ7EdP57lUa5bwBw1hCqs52O9sBowqa2ZQxfORuHRI25znxfdLNMwLgxOqjRAw+DmYCMWTatg5d4aTBmqfhtktTYFj2tk4AE7OdNo2PccRXM4x6HjBRy+1OIQG1pC59n9XtD5fwcrs59o6qhBUK/mXtHPltV8B3qA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=GkdS60OB; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1764125556;
	bh=CTnGKiu579n5toRKLMI7dG1g6FgRNDmmkIpt475HqaU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dGPHS6X5mz4wDT;
	Wed, 26 Nov 2025 13:52:36 +1100 (AEDT)
Date: Wed, 26 Nov 2025 13:52:36 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 26
Message-ID: <20251126135236.66c72e58@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_p7ZYwhFeXZ+ZAqcb8_JDYM";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/_p7ZYwhFeXZ+ZAqcb8_JDYM
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20251125:

This kernel produces a warning at boot time.

The risc-v tree gained conflicts against the arm-soc and mm-stable trees.
...
Non-merge commits (relative to Linus' tree): 11019
 11345 files changed, 573988 insertions(+), 179424 deletions(-)
...
Merging origin/master (30f09200cc4a Merge tag 'arm64-fixes' of git://git.ke=
...
_open_session())
Merging cifs/for-next (33fc7a0ee827 cifs: Use netfs_alloc/free_folioq_buffe=
r())
...
es)
Merging erofs/dev (d53cd891f0e4 erofs: limit the level of fs stacking for f=
ile-backed mounts)
...
Merging fuse/for-next (28fec8b95e67 fuse: signal that a fuse inode should e=
xhibit local fs behaviors)
...
Merging ksmbd/ksmbd-for-next (f9fd35675dbd ksmbd: Replace strcpy + strcat t=
...
Merging xfs/for-next (68880072d89c xfs: factor out a xlog_write_space_advan=
ce helper)
Merging zonefs/for-next (a42938e80357 zonefs: correct some spelling mistake=
s)
Merging vfs-brauner/vfs.all (64a45be15dbe Merge branch 'vfs-6.19.fd_prepare=
' into vfs.all)
...
Merging mm-hotfixes/mm-hotfixes-unstable (1e7b10d47d6f MAINTAINERS: add Mik=
e Rapoport as maintainer for userfaultfd)
Merging fs-current (89ee7d4955f1 Merge branch 'fixes' of https://git.kernel=
...
embly)
Merging net/main (9780f535f8e0 net: lan966x: Fix the initialization of tapr=
io)
...
Merging sound-current/for-linus (d26e9f669cc0 ALSA: usb-audio: fix uac2 clo=
ck source at terminal parser)
Merging sound-asoc-fixes/for-linus (950167a99dfd ASoC: tas2781: correct the=
 wrong period)
Merging regmap-fixes/for-linus (6146a0f1dfae Linux 6.18-rc4)
Merging regulator-fixes/for-linus (6a23ae0a96a6 Linux 6.18-rc6)
Merging spi-fixes/for-linus (a90903c2a3c3 spi: amlogic-spifc-a1: Handle dev=
m_pm_runtime_enable() errors)
...
Merging dma-mapping-fixes/dma-mapping-fixes (1a96f3a22fd8 iommu/dma: add mi=
ssing support for DMA_ATTR_MMIO for dma_iova_unlink())
...
Merging tip-fixes/tip/urgent (ac3fd01e4c1e Linux 6.18-rc7)
...
Merging mm-unstable/mm-unstable (7acd60c24b3b mm: fix DEBUG_RODATA_TEST ind=
entation in Kconfig)
Merging mm-nonmm-unstable/mm-nonmm-unstable (c26edadff676 oid_registry: all=
ow arbitrary size OIDs)
Merging kbuild/kbuild-next (deab487e0f9b kbuild: allow architectures to ove=
rride CC_CAN_LINK)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (5accdaec526e perf docs: arm-spe: Document new=
 SPE filtering features)
...
or-next)
Merging arm64/for-next/core (2d4f8aad4a52 Merge branches 'for-next/misc', '=
...
/local-tlbi-page-reused', 'for-next/mpam', 'for-next/topology', 'for-next/a=
cpi' and 'for-next/documentation', remote-tracking branch 'arm64/for-next/p=
erf' into for-next/core)
...
Merging arm-soc/for-next (e7dea0bf8e22 soc: document merges)
Merging amlogic/for-next (9f4176d3309a Merge branch 'v6.19/arm64-dt' into f=
or-next)
...
for-next)
Merging samsung-krzk/for-next (715636d5bf7d Merge branches 'next/clk', 'nex=
t/drivers' and 'next/dt64' into for-next)
...
y cmdline param)
Merging risc-v/for-next (832fd6c2e55c MAINTAINERS: refer to intended files =
in RISC-V SSE DRIVER)
CONFLICT (content): Merge conflict in MAINTAINERS
CONFLICT (content): Merge conflict in arch/riscv/include/asm/hwcap.h
Merging riscv-dt/riscv-dt-for-next (5b70764e1019 riscv: dts: starfive: add =
Orange Pi RV)
Merging riscv-soc/riscv-soc-for-next (719362b8a972 Merge branch 'riscv-cach=
e-for-next' into riscv-soc-for-next)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging s390/for-next (276d86f70d3d Merge branch 'features' into for-next)
...
Merging fs-next (d0f1a1fb721b Merge branch 'for-next' of https://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs.git)
CONFLICT (content): Merge conflict in arch/s390/kernel/syscalls/syscall.tbl
CONFLICT (content): Merge conflict in mm/secretmem.c
Merging printk/for-next (714159ee0f07 Merge branch 'for-6.19' into for-next)
...
Merging pm/linux-next (ea99b491c33e Merge branch 'pm-tools' into linux-next)
...
Merging devfreq/devfreq-next (25cee0b9a509 PM: devfreq: Fix typo in DFSO_DO=
...
Merging rdma/for-next (4022c7b6342a RDMA/mlx5: Add support for 1600_8x lane=
 speed)
Merging net-next/main (61e628023d79 Merge branch 'net_sched-speedup-qdisc-d=
equeue')
...
Merging wireless-next/for-next (1c6a92a5a5de wifi: nl80211: vendor-cmd: int=
el: fix a blank kernel-doc line warning)
...
Merging amdgpu/drm-next (5de8ce0f3709 drm/amd/pm: adjust the visibility of =
pp_table sysfs node)
...
Merging drm-xe/drm-xe-next (07cf4b864f52 drm/xe: Protect against unset LRC =
when pausing submissions)
...
Merging sound/for-next (c58f520e6acf ALSA: ctxfi: Add support for Onkyo SE-=
300PCIE (OK0010))
Merging ieee1394/for-next (036176d9dba7 firewire: core: abort pending trans=
actions at card removal)
Merging sound-asoc/for-next (b424a8e1da6a Merge remote-tracking branch 'aso=
...
Merging block/for-next (fbc18e09c3f0 Merge branch 'for-6.19/block' into for=
-next)
CONFLICT (content): Merge conflict in io_uring/rw.c
Merging device-mapper/for-next (aaf7df4c589a dm-mpath: Simplify the setup_s=
csi_dh code)
...
Merging mmc/next (e2bbd950eb72 mmc: Merge branch fixes into next)
Merging mfd/for-mfd-next (0e056211b8c9 mfd: qnap-mcu: Hook up the EEPROM su=
b-device)
Merging backlight/for-backlight-next (2d45db63260c backlight: lp855x: Fix l=
...
ing)
Merging tpmdd/next (91e7148e4357 drivers/char/tpm: use min() instead of min=
_t())
Merging watchdog/master (5bcc5786a0cf watchdog: starfive: Fix resource leak=
 in probe error path)
Merging iommu/next (a9f426a5fe48 Merge branches 'arm/smmu/updates', 'arm/sm=
...
Merging spi/for-next (78a9597dd32a Merge remote-tracking branch 'spi/for-6.=
19' into spi-next)
Merging tip/master (2fd71c874ac6 Merge branch into tip/master: 'x86/sgx')
...
b-modules only)
Merging kvm-arm/next (81410a2ac378 Merge branch 'kvm-arm64/nv-xnx-haf' into=
 kvmarm/next)
...
Merging drivers-x86/for-next (2643187ccb86 platform/x86: ayaneo-ec: Add sus=
pend hook)
...
Merging usb-serial/usb-next (7970b4969c4c USB: serial: option: add Foxconn =
T99W760)
Merging tty/tty-next (da218406dd50 serial: 8250_platform: simplify IRQF_SHA=
RED handling)
Merging char-misc/char-misc-next (3e92fdae7fa4 Merge tag 'icc-6.19-rc1' of =
...
Merging rpmsg/for-next (38ede97b6d1e Merge branch 'rproc-next' into for-nex=
t)
Merging gpio-brgl/gpio/for-next (23ac52a4a2dc gpio: zynq: Use modern PM mac=
ros)
...
Merging bitmap/bitmap-for-next (4bd68e475300 cpumask: Don't use "proxy" hea=
ders)
...
Merging nolibc/for-next (1d573464749c selftests/nolibc: error out on linker=
 warnings)
Merging iommufd/for-next (800b311b5afb Merge branch 'iommufd_dmabuf' into k=
.o-iommufd/for-next)
...

=VZmE
-----END PGP SIGNATURE-----
