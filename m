...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0FB1733CCB9
	for <lists+linux-next@lfdr.de>; Tue, 16 Mar 2021 05:51:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235087AbhCPEu3 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 16 Mar 2021 00:50:29 -0400
Received: from ozlabs.org ([203.11.71.1]:47885 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235076AbhCPEuI (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 16 Mar 2021 00:50:08 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4F01701pk7z9sWV;
        Tue, 16 Mar 2021 15:50:04 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1615870204;
        bh=MRYpzHwkr5/EmdeQMW9LtHrsensi1Oh3Yp1f7rap3/0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 16 Mar 2021 15:50:01 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 16
Message-ID: <20210316155001.699efbb4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/IVu0I1NuHpu9WZJHERbn_W4";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/IVu0I1NuHpu9WZJHERbn_W4
...
Merging origin/master (1e28eed17697 Linux 5.12-rc3)
...
Merging net/master (7233da86697e tcp: relookup sock for RST+ACK packets han=
dled by obsolete req sock)
...
Merging rdma-fixes/for-rc (22053df0a364 RDMA/mlx5: Fix typo in destroy_mkey=
 inbox)
Merging sound-current/for-linus (b95bc12e0412 ALSA: hda/realtek: apply pin =
quirk for XiaomiNotebook Pro)
Merging sound-asoc-fixes/for-linus (f7d3d0e3a345 Merge remote-tracking bran=
...
Merging usb.current/usb-linus (132da018fa32 Merge tag 'thunderbolt-for-v5.1=
2-rc4' of git://git.kernel.org/pub/scm/linux/kernel/git/westeri/thunderbolt=
 into usb-linus)
...
_probe())
Merging staging.current/staging-linus (12ec5408d213 Merge tag 'iio-fixes-fo=
r-5.12a' of https://git.kernel.org/pub/scm/linux/kernel/git/jic23/iio into =
staging-linus)
...
Merging opp/opp/linux-next (4c279ccfb320 memory: samsung: exynos5422-dmc: C=
...
mem)
Merging net-next/master (0f13b5e6bf28 net: ipa: make ipa_table_hash_support=
() inline)
Merging bpf-next/for-next (6503b9f29a47 bpf: Add getter and setter for SO_R=
EUSEPORT through bpf_{g,s}etsockopt)
...
Merging bluetooth/master (7cf3b1dd6aa6 Bluetooth: L2CAP: Fix not checking f=
or maximum number of DCID)
...
ice.c
Merging drm-intel/for-linux-next (41ed4005aa0a drm/i915/dp_link_training: C=
onvert DRM_DEBUG_KMS to drm_dbg_kms)
...
mment)
Merging sound-asoc/for-next (8b97204b2896 Merge remote-tracking branch 'aso=
...
RY deprecation)
Merging devicetree/for-next (b08bc692ad34 of: unittest: Statically apply ov=
...
13' into spi-next)
Merging tip/auto-latest (298e9335e1fa Merge branch 'irq/core')
...
Merging staging/staging-next (b828324bba8f Merge 5.12-rc3 into staging-next)
...
Merging mhi/mhi-next (70f7025c854c bus: mhi: core: remove redundant initial=
ization of variables state and ee)
...
Merging akpm/master (c9b3d943844e Merge branch 'akpm-current/current')
...

=Kn2r
-----END PGP SIGNATURE-----
