...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C9B3E22AC3A
	for <lists+linux-next@lfdr.de>; Thu, 23 Jul 2020 12:11:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728246AbgGWKLr (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 23 Jul 2020 06:11:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37446 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725846AbgGWKLq (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 23 Jul 2020 06:11:46 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 28BDCC0619DC;
        Thu, 23 Jul 2020 03:11:46 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BC7R11BhCz9sR4;
        Thu, 23 Jul 2020 20:11:41 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1595499101;
        bh=L+UVq1mniL9wTQe8bLMlujJWzUwUZHoYdqfHqzy/dS0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 23 Jul 2020 20:11:38 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 23
Message-ID: <20200723201138.6070e317@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/nSQ/M=+wG2rdVGswQNb6PYj";
...
--Sig_/nSQ/M=+wG2rdVGswQNb6PYj
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200722:
...
Non-merge commits (relative to Linus' tree): 9597
 10273 files changed, 506779 insertions(+), 194204 deletions(-)
...
Merging origin/master (8c26c87b0532 Merge tag 'sound-5.8-rc7' of git://git.=
kernel.org/pub/scm/linux/kernel/git/tiwai/sound into master)
Merging fixes/master (dbf24e30ce2e device_cgroup: Fix RCU list debugging wa=
rning)
Merging kbuild-current/fixes (5987cd8120da Makefile: Fix GCC_TOOLCHAIN_DIR =
...
Merging net/master (2c4dc3148603 net: ethernet: ti: add NETIF_F_HW_TC hw fe=
ature flag for taprio offload)
...
Merging sound-asoc-fixes/for-linus (4630a1968df4 Merge remote-tracking bran=
...
or-next)
Merging arm64/for-next/core (238be99af118 Merge branch 'for-next/mte' into =
for-next/core)
Merging arm-perf/for-next/perf (55fdc1f44cd6 arm64: perf: Expose some new e=
vents via sysfs)
Merging arm-soc/for-next (a956819df96a soc: document merges)
...
Merging btrfs/for-next (f339e73c87ef Merge branch 'for-next-next-v5.8-20200=
722' into for-next-20200722)
...
-next)
Merging pci/next (ee8ffa45ed3f Merge branch 'remotes/lorenzo/pci/xilinx')
...
ed word + clarify)
Merging net-next/master (4b1debbe63f4 ionic: fix memory leak of object 'lid=
')
...
ge
Merging bpf-next/master (a6c0d0934f0d net: explicitly include <linux/compat=
.h> in net/core/sock.c)
...
.c
Merging amdgpu/drm-next (2d31a6e98cde drm/amdgpu/powerplay: add some docume=
...
Merging drm-misc/for-linux-next (9fadd6d1e297 drm/ttm: remove TTM_MEMTYPE_F=
LAG_MAPPABLE)
...
ter API)
Merging sound-asoc/for-next (eec2904d98a1 Merge remote-tracking branch 'aso=
...
Merging block/for-next (569ec0b75760 Merge branch 'for-5.9/drivers' into fo=
r-next)
...
Merging char-misc/char-misc-next (342c8a1d1d9e coresight: etm4x: Fix save/r=
estore during cpu idle)
...
Merging staging/staging-next (70476feb62ce staging: dpaa2-ethsw: check if t=
here is space for a new VLAN)
...
Merging akpm/master (7639542d5934 sh: add missing EXPORT_SYMBOL() for __del=
ay)
...

=fRpn
-----END PGP SIGNATURE-----
