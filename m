...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1B93355CAD8
	for <lists+linux-next@lfdr.de>; Tue, 28 Jun 2022 14:59:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243954AbiF1IHu (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 28 Jun 2022 04:07:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59654 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236799AbiF1IHt (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 28 Jun 2022 04:07:49 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C8B4E1A3B2;
        Tue, 28 Jun 2022 01:07:45 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LXHJc1wlYz4xD8;
        Tue, 28 Jun 2022 18:07:44 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1656403664;
        bh=tyj981L4KxlyHc0rum96qrnrRTULOKKoVQa/j6Y+bpM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 28 Jun 2022 18:07:43 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 28
Message-ID: <20220628180743.37a2143a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/2pEZsKAynUqVE4Krt8FqMKV";
...
Merging mm-hotfixes/mm-hotfixes-unstable (e2d407440437 Revert "ocfs2: mount=
 shared volume without ha stack")
...
Merging net/master (cb8092d70a6f tipc: move bc link creation back to tipc_n=
ode_create)
...
Merging sound-asoc-fixes/for-linus (8f6b05d04969 Merge remote-tracking bran=
...
Merging drivers-x86-fixes/fixes (8853e8ce9b57 platform/x86: ideapad-laptop:=
...
small)
Merging asm-generic/master (8327b9f472a8 Merge branch 'asm-generic-virt_to_=
bus' into asm-generic)
...
Merging broadcom/next (24d299720176 Merge branch 'devicetree/next' into nex=
t)
$ git reset --hard HEAD^
...
or-next)
Merging qcom/for-next (84c1f807d2a8 Merge branches 'arm64-fixes-for-5.19', =
'arm64-for-5.20', 'clk-for-5.20' and 'drivers-for-5.20' into for-next)
...
nto for-next)
Merging samsung-krzk/for-next (58c7c8f73c01 Merge branch 'for-v5.20/qcom-dt=
s64-cleanup' into for-next)
Merging scmi/for-linux-next (bca443d7600a Merge branch 'for-next/scmi' of g=
...
Merging pm/linux-next (41fae20e89e3 Merge branch 'thermal-core' into linux-=
next)
...
for-next)
Merging net-next/master (0fcae3c8b1b3 ipmr: fix a lockdep splat in ipmr_rtm=
_dumplink())
...
.c
Merging drm-misc/for-linux-next (7d008eecb0cf drm/stm: ltdc: update hardwar=
e error management)
Merging amdgpu/drm-next (7b3baa65b17b drm/amdgpu/display: add missing FP_ST=
ART/END checks dcn32_clk_mgr.c)
Merging drm-intel/for-linux-next (f7fb92cd2e39 drm/i915: Move the color stu=
ff under INTEL_INFO->display)
...
ile draining output)
Merging sound-asoc/for-next (836deb03cab5 Merge remote-tracking branch 'aso=
...
Merging block/for-next (77e9a1a5d4c9 Merge branch 'for-5.20/io_uring-buffer=
...
Merging spi/for-next (32b507ef1e05 Merge remote-tracking branch 'spi/for-5.=
20' into spi-next)
...
Merging char-misc/char-misc-next (5d40b918fdf1 Merge 5.19-rc4 into char-mis=
c-next)
...
Merging kselftest/next (43fe0cc46b62 kselftests/damon: add support for case=
s where debugfs cannot be read)
...
Merging mm/mm-everything (84b494dcbcc0 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
CONFLICT (content): Merge conflict in include/linux/pagevec.h
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (5f9df76887bf Merge branch 'mm-everything' of git://git=
...

=awew
-----END PGP SIGNATURE-----
