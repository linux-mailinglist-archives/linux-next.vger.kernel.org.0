...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7EB4B2B5A7A
	for <lists+linux-next@lfdr.de>; Tue, 17 Nov 2020 08:46:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726685AbgKQHqc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 17 Nov 2020 02:46:32 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35994 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726295AbgKQHqb (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 17 Nov 2020 02:46:31 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C3FDFC0613CF;
        Mon, 16 Nov 2020 23:46:30 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CZygS4Bctz9sPB;
        Tue, 17 Nov 2020 18:46:28 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1605599188;
        bh=f/gjTZ64ktD3hlak5LwbTpEIikAu56j6simIyeL3X04=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 17 Nov 2020 18:46:27 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 17
Message-ID: <20201117184627.62a9b2f0@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/TvGmH1H9zDeqHWy/ZR+9J16";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/TvGmH1H9zDeqHWy/ZR+9J16
...
Merging powerpc-fixes/fixes (75b49620267c KVM: PPC: Book3S HV: XIVE: Fix po=
ssible oops when accessing ESB page)
...
Merging net/master (857524564eae MAINTAINERS: Add Martin Schiller as a main=
tainer for the X.25 stack)
...
fi1_init_dd())
Merging sound-current/for-linus (d78359b25f7c ALSA: hda: Add Alderlake-S PC=
...
Merging rockchip/for-next (db4d9df43533 Merge branch 'v5.11-armsoc/drivers'=
 into for-next)
Merging samsung-krzk/for-next (a43bfdb59aa2 Merge branch 'next/soc' into fo=
r-next)
...
djTree)
Merging nfs/linux-next (09162bc32c88 Linux 5.10-rc4)
...
Merging v4l-dvb/master (b064945517ee media: fix kernel-doc markups)
...
in imxfb_probe())
Merging pm/linux-next (4e4b3acab781 Merge branch 'acpi-apei' into linux-nex=
t)
...
Merging net-next/master (72308ecbf33b Merge branch 'mptcp-improve-multiple-=
xmit-streams-support')
...
Merging amdgpu/drm-next (25ecf81773f3 drm/amdgpu: Enable GPU reset for vang=
ogh)
...
.c
Merging drm-intel/for-linux-next (c9afbf586e4f drm/i915: Relocate cnl_get_d=
di_pll())
Merging drm-tegra/drm/tegra/for-next (123f01a0c989 drm/tegra: output: Do no=
t put OF node twice)
Merging drm-misc/for-linux-next (e9d2871f6921 drm: fix some kernel-doc mark=
ups)
...
Merging sound/for-next (8461352ddf07 ALSA: firewire: fix comparison to bool=
 warning)
Merging sound-asoc/for-next (3e8bbff3a614 Merge remote-tracking branch 'aso=
...
rom callback)
Merging spi/for-next (ddcf218786a8 Merge remote-tracking branch 'spi/for-5.=
11' into spi-next)
...
CONFLICT (content): Merge conflict in MAINTAINERS
[master 8cc497ab6bf3] next-20201116/phy-next
...
$ git reset --hard HEAD^
Merging next-20201116 version of mhi
...
Merging memblock/for-next (b5cf2d6c8148 mm: memblock: add more debug logs)
Merging init/init-user-pointers (38b082236e77 initramfs: use vfs_utimes in =
do_copy)
Merging counters/counters (3650b228f83a Linux 5.10-rc1)
Merging akpm-current/current (76e9eea400bf lib/lzo/lzo1x_compress.c: make l=
...
Merging akpm/master (0b8cc6f628e8 mm/gup: assert that the mmap lock is held=
 in __get_user_pages())
Applying: Revert "mm/shmem: use kmem_cache_zalloc in shmem_alloc_inode()"
...

=d0N+
-----END PGP SIGNATURE-----
