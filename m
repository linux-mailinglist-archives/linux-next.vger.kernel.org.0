...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 56EF4534AC2
	for <lists+linux-next@lfdr.de>; Thu, 26 May 2022 09:24:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1345310AbiEZHYx (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 26 May 2022 03:24:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38818 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235204AbiEZHYw (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 26 May 2022 03:24:52 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BDC468FFA7;
        Thu, 26 May 2022 00:24:48 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4L7zwH0dG6z4xD7;
        Thu, 26 May 2022 17:24:47 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1653549887;
        bh=B3ry1RHE/cI8uFT+ny020XO+wpk5Ej4S3pmz4PF+fM8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 26 May 2022 17:24:46 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 26
Message-ID: <20220526172446.12ecdfd3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/a=Rutrl_pQo3ImbKUTjYgdP";
...
Changes since 20220525:

The ceph tree gained a conflict against the fscache tree.

The tip tree gained a conflict against the risc-v tree.

The mm tree gained conflicts against Linus' tree.

Non-merge commits (relative to Linus' tree): 8396
 8550 files changed, 807517 insertions(+), 161105 deletions(-)
...
Merging origin/master (7e062cda7d90 Merge tag 'net-next-5.19' of git://git.=
kernel.org/pub/scm/linux/kernel/git/netdev/net-next)
Merging fixes/fixes (d06c942efea4 Merge tag 'for_linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/mst/vhost)
Merging mm-hotfixes/mm-hotfixes-unstable (404a14ec8f65 hugetlb: fix huge_pm=
d_unshare address update)
...
Merging net/master (7e062cda7d90 Merge tag 'net-next-5.19' of git://git.ker=
...
Merging drm-misc/for-linux-next (5ee8c8f930ba drm/rockchip: Change register=
 space names in vop2)
Merging amdgpu/drm-next (62ba2ab31f67 drm/amd/pm: Return auto perf level, i=
f unsupported)
...
Merging fbdev/for-next (9f56390f8c49 video: fbdev: xen: remove setting of '=
transp' parameter)
...
to spi-mem)
Merging tip/master (d092c10c647e Merge branch into tip/master: 'x86/cleanup=
s')
...
Merging mm/mm-everything (3fc24b0fa2b6 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging akpm/master (9a465c091e5d mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=RPrT
-----END PGP SIGNATURE-----
