...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D58FD48AB46
	for <lists+linux-next@lfdr.de>; Tue, 11 Jan 2022 11:22:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237611AbiAKKWp (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 11 Jan 2022 05:22:45 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56228 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233911AbiAKKWo (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 11 Jan 2022 05:22:44 -0500
Received: from mail-pj1-x1034.google.com (mail-pj1-x1034.google.com [IPv6:2607:f8b0:4864:20::1034])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75532C06173F
        for <linux-next@vger.kernel.org>; Tue, 11 Jan 2022 02:22:44 -0800 (PST)
Received: by mail-pj1-x1034.google.com with SMTP id l16-20020a17090a409000b001b2e9628c9cso4968311pjg.4
        for <linux-next@vger.kernel.org>; Tue, 11 Jan 2022 02:22:44 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=m/jyKjD6hXn/d8Y0C3qBBnTHflE8ZLLdl6wGfwsohM0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=m/jyKjD6hXn/d8Y0C3qBBnTHflE8ZLLdl6wGfwsohM0=;
        b=
X-Gm-Message-State: AOAM532k2hsyiut6pGLVVxpI3y935ZJogYtSUbWDV5AHfqh5t2SjTfBd
        xMbcZqXhRDRnYCnd2BFTc3Uphfaa92h4qe8w
X-Google-Smtp-Source: ABdhPJw1mzR6KpMNXpGfkw6mUP1pz6CLsmMewHVWNiUyNOGsISrtj1pOCzTakAqfWJtM9K47rx6IDA==
X-Received: by 2002:a62:8f87:0:b0:4ba:a2f0:5f88 with SMTP id n129-20020a628f87000000b004baa2f05f88mr3978248pfd.80.1641896562565;
        Tue, 11 Jan 2022 02:22:42 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id k3sm8062078pgq.54.2022.01.11.02.22.41
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 11 Jan 2022 02:22:41 -0800 (PST)
Message-ID: <61dd5a71.1c69fb81.d713d.47f3@mx.google.com>
Date:   Tue, 11 Jan 2022 02:22:41 -0800 (PST)
...
Subject: next/master build: 226 builds: 19 failed, 207 passed, 40 errors,
 71 warnings (next-20220111)
...
next/master build: 226 builds: 19 failed, 207 passed, 40 errors, 71 warning=
s (next-20220111)
...
Tree: next
Branch: master
Git Describe: next-20220111
Git Commit: a70bf4a85b43cb952bd39dd948b103b1b3eb2cf8
...
arm:
    allmodconfig (gcc-10): 1 error, 1 warning
    allmodconfig (clang-14): 4 errors, 16 warnings
...
i386:
    allmodconfig (clang-14): 9 errors
...
ml_rq_dlg_get_dlg_params' [-Werror,-Wframe-larger-than]  CC [M]  drivers/ne=
t/ethernet/mellanox/mlx5/core/steering/dr_matcher.o
...
---------------------------------------------------------------------------=
-----
allmodconfig (i386, clang-14) =E2=80=94 FAIL, 9 errors, 0 warnings, 0 secti=
on mismatches
...
_dlg_get_dlg_params' [-Werror,-Wframe-larger-than]  CC [M]  drivers/net/eth=
ernet/mellanox/mlx5/core/steering/dr_matcher.o
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-14) =E2=80=94 FAIL, 4 errors, 16 warnings, 0 secti=
on mismatches
