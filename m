Return-Path: <linux-next+bounces-2348-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 080CE8C8039
	for <lists+linux-next@lfdr.de>; Fri, 17 May 2024 05:39:45 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 45F511F2226B
	for <lists+linux-next@lfdr.de>; Fri, 17 May 2024 03:39:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EE785BE7F;
	Fri, 17 May 2024 03:39:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="fb059Vh4"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2FCAABE4E;
	Fri, 17 May 2024 03:39:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1715917179; cv=none; b=ju8LV5hr1fRkn0CeospNz/nf/UkIlzYSagWyAFRTWtgcfp2PDwTFGHNgfuGodW8hNdXyu0RPOK76J3nYjOQ5+AAcQtp0p4B2p4QHaAaHpwRlB1/R7+7sN2Ed7vgmyzuLFIeRDI7NEqpDtnoS9/HSZTYv+agfvdEYizeIUQ6L33Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1715917179; c=relaxed/simple;
	bh=7S0Fp/spd+O4RtgXxFcxdAs75qtfm51Ca8t00Nwj6l4=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=OVefHvyJLWq+0MGk1OM4qTidRdQ+lIFhCWeWhAdQNOrk1K5FwqDoyC7ybIC7lQLmBFJN2e8qfFIC5M4zA2Ckmpqczz+YAFMMRgW5PTbDWHrfJ2oDGvO6LBKHk/nHaZC3J55aRNs50+OHvFBBRD28bqDDzZYyhZ3qQqpYC4q2CyM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=fb059Vh4; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1715917170;
	bh=fMRhWsNeJNDY0OJj9AwZEXEmBQrdyaU1RkMT6Pv2MX0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VgXl65Zwqz4wx6;
	Fri, 17 May 2024 13:39:30 +1000 (AEST)
Date: Fri, 17 May 2024 13:39:27 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 17
Message-ID: <20240517133927.07576027@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/we_M27ON0tkDusuJMxLhkZd";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/we_M27ON0tkDusuJMxLhkZd
...
Merging origin/master (ea5f6ad9ad96 Merge tag 'platform-drivers-x86-v6.10-1=
...
Merging net/main (83e93942796d selftests/net/lib: no need to record ns name=
 if it already exist)
...
Merging s390/for-next (d890e6af50e4 s390/kprobes: Remove custom insn slot a=
llocator)
...
Merging crypto/master (13909a0c8897 crypto: atmel-sha204a - provide the otp=
 content)
Merging drm/drm-next (431c590c3ab0 drm/tests: Add a unit test for range bia=
s allocation)
...
Merging drm-xe/drm-xe-next (63d8cb8fe3dd drm/xe/vf: Expose SR-IOV VF attrib=
utes to GT debugfs)
...
Merging block/for-next (59ef81807482 Merge branch 'block-6.10' into for-nex=
t)
...
Merging tpmdd/next (3c999d1ae3c7 Merge tag 'wq-for-6.10' of git://git.kerne=
l.org/pub/scm/linux/kernel/git/tj/wq)
...

=7gZB
-----END PGP SIGNATURE-----
