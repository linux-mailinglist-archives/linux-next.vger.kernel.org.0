Return-Path: <linux-next+bounces-3271-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5CCE394C95A
	for <lists+linux-next@lfdr.de>; Fri,  9 Aug 2024 06:31:20 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B52301F267BF
	for <lists+linux-next@lfdr.de>; Fri,  9 Aug 2024 04:31:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DBA742628C;
	Fri,  9 Aug 2024 04:31:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="EkAt7/rQ"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2EC902F56;
	Fri,  9 Aug 2024 04:31:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723177875; cv=none; b=HytiYkXnkZk9fkofxd4EmpHjPlGvhDXtD8ghk04OpdYC9OfIcK3eIhPEy+KnuyOiIRe4jx54cMY0AFdFYqqdHzmUHGxRep4YUvEojBLk5s3XKuQzFpqeiUozifKU7IPPd/O1XaaXfX1VALWGNSE5mv86qKFPIdzfAzug3Tor7rg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723177875; c=relaxed/simple;
	bh=yZHg8GCVz5b735vkyOxUjFFaYmNQsLwltz+26KLKHpc=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=o1ZbY2qGZlGiWSwhkq9O+3Ywo8G/AKJYXfzC5pQtkm6utIArNWidZxCXnmhW24kjUYbO5p8wg+oDEBy3hGvAV5ew2vowmEIaPV+Y1kXczrYc0cEFWu1ZJ50zgq1j9T3nySwGlq9vynQDlCVSr9H22nSL5/Mzy2NuQsZBpt58a40=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=EkAt7/rQ; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1723177870;
	bh=CI3AwTTTPvGV4WRqj0d4c6pGmdJA9ye7wq4rpOQNttg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Wg9vy2Z4Vz4w2R;
	Fri,  9 Aug 2024 14:31:10 +1000 (AEST)
Date: Fri, 9 Aug 2024 14:31:09 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 9
Message-ID: <20240809143109.2d28bf61@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/FrFw=La_=V4_+eb5c/iORA2";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/FrFw=La_=V4_+eb5c/iORA2
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240808:
...
Non-merge commits (relative to Linus' tree): 3331
 3661 files changed, 129343 insertions(+), 64029 deletions(-)
...
Merging origin/master (ee9a43b7cfe2 Merge tag 'net-6.11-rc3' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/netdev/net)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (129bae385a76 mm: don't account me=
mmap per node)
...
erify_area())
Merging fs-current (a7587d0b1481 Merge branch 'nfsd-fixes' of git://git.ker=
...
v_alloc_device())
Merging net/main (ee9a43b7cfe2 Merge tag 'net-6.11-rc3' of git://git.kernel=
...
Merging sound-current/for-linus (03898691d42e ALSA: usb-audio: Re-add Scrat=
chAmp quirk entries)
Merging sound-asoc-fixes/for-linus (72776774b55b ASoC: cs35l56: Patch CS35L=
56_IRQ1_MASK_18 to the default value)
...
le)
Merging drm-fixes/drm-fixes (de9c2c66ad8e Linux 6.11-rc2)
...
Merging mm/mm-everything (b794b113320e foo)
...
Merging rockchip/for-next (e8054c08dada Merge branch 'v6.12-armsoc/dts64' i=
nto for-next)
Merging samsung-krzk/for-next (5daaedb06e47 Merge branch 'next/clk' into fo=
r-next)
...
Merging bcachefs/for-next (d9dded74b147 bcachefs: bch2_sb_nr_devices())
...
Merging cifs/for-next (4abf1728ec47 smb/client: avoid possible NULL derefer=
ence in cifs_free_subrequest())
...
Merging fs-next (67b2adb0f2ed Merge branch 'vfs.all' of git://git.kernel.or=
...
xt)
Merging i2c/i2c/for-next (74b0666f97f9 i2c: testunit: match HostNotify test=
 name with docs)
Merging i2c-host/i2c/i2c-host (b7eb88b9583d i2c: imx: Switch to RUNTIME_PM_=
OPS())
...
Merging rdma/for-next (2a777679b8cc RDMA/mad: Improve handling of timed out=
 WRs of mad agent)
Merging net-next/main (e47fd9beb1ce Merge git://git.kernel.org/pub/scm/linu=
...
Merging drm/drm-next (91dae758bdb8 Merge tag 'drm-misc-next-2024-08-01' of =
...
Merging drm-misc/for-linux-next (17419a5c8c75 drm/vkms: Fix cpu_to_le16()/l=
e16_to_cpu() warnings)
...
Merging drm-xe/drm-xe-next (e422c0bfd9e4 drm/xe: fix WA 14018094691)
...
ap-next)
Merging sound/for-next (c46fc83e3f3c ALSA: vxpocket: Fix a typo at conversi=
on to dev_*())
$ git reset --hard HEAD^
Merging next-20240808 version of sound
Merging ieee1394/for-next (56cc34a8c179 firewire: ohci: use guard macro to =
serialize operations for isochronous contexts)
Merging sound-asoc/for-next (ff387e3e7647 Merge remote-tracking branch 'aso=
...
12' into spi-next)
Merging tip/master (ad1b4b6ed19f Merge branch into tip/master: 'x86/timers')
...
Merging rcu/next (7a0c44933f72 Merge branches 'context_tracking.31.07.24a',=
 'csd.lock.29.07.24a', 'nocb.29.07.24a', 'rcutorture.07.08.24a', 'rcustall.=
31.07.24a', 'rcu.tasks.07.08.24b', 'srcu.07.08.24a', 'refscale.07.08.24a', =
'fixes.07.08.24a' and 'misc.07.08.24a' into next.07.08.24b)
...
cros)
Merging slab/slab/for-next (aefc252b1db9 slab: Warn on duplicate cache name=
s when DEBUG_VM=3Dy)
...

=EMbf
-----END PGP SIGNATURE-----
