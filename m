Return-Path: <linux-next+bounces-9374-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 976D2CABD4C
	for <lists+linux-next@lfdr.de>; Mon, 08 Dec 2025 03:20:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 9503E304F13F
	for <lists+linux-next@lfdr.de>; Mon,  8 Dec 2025 02:17:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9A36827FB1F;
	Mon,  8 Dec 2025 02:08:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="DFp5lDGI"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D765826ED3B;
	Mon,  8 Dec 2025 02:08:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765159713; cv=none; b=I96HvHPeaFXWKA/ooU5X1NQcLc9PLWXaAvCqwc2+c41+MerpSFqUUTa/l6XnMnQeLvrnBEAfjH+Jt3t10CD8mGNcr4Pm3b5rY8cfLkJOzdXLG4NU4Er9fBbY/JrKQbCGWmKQ6TOJR/AYI6pMCGbR5hOeGxoIAxl2pXJANAWzgYI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765159713; c=relaxed/simple;
	bh=GSBkvzsDWLpOoVfrg3GYjeqSpWCB1orsSZULo4WwTNk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=mozzDlq3iRKSBwFPQzFFMG6ooRhir1JVrifnp/iBPtLIZpALiV4sx/Wb9MKDgrQGhDuhX9r39DFZyHBrjHvOR289NriLlOuDhkyDrzbYiG0HNtu18pobba7biXhtAEjn1BZs9KyQ/HRS5OE3y0EKhDtDI9T6UEYKa4dZ7aepC/s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=DFp5lDGI; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1765159703;
	bh=plUKC40r2nynnJ0dWkBkS/P1tnEK9fEaj1Gr8Wu+Itg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dPlkv1QYyz4w0q;
	Mon, 08 Dec 2025 13:08:23 +1100 (AEDT)
Date: Mon, 8 Dec 2025 13:08:22 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 8
Message-ID: <20251208130822.2adb043e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/y0dPVKkF=P8O6jboXX=twJ=";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/y0dPVKkF=P8O6jboXX=twJ=
...
Changes since 20251205:

The mm-hotfixes tree gained a build failure for which I reverted
3 commits.

Non-merge commits (relative to Linus' tree): 1165
 1270 files changed, 57011 insertions(+), 12970 deletions(-)
...
Merging origin/master (67a454e6b1c6 Merge tag 'memblock-6.19-rc1' of git://=
git.kernel.org/pub/scm/linux/kernel/git/rppt/memblock)
...
[fs-current e86bcf5121bd] Merge branch 'next-fixes' of https://git.kernel.o=
rg/pub/scm/linux/kernel/git/kdave/linux.git
...
Merging fs-current (e86bcf5121bd Merge branch 'next-fixes' of https://git.k=
...
Merging sound-current/for-linus (74ac7558ea76 ALSA: Do not build obsolete A=
PI)
...
_* confusion)
Merging hwmon-fixes/hwmon (186e66ad4161 docs: hwmon: fix link to g762 devic=
etree binding)
...
Merging gpio-brgl-fixes/gpio/for-current (dd44d4d0c55a gpio: tb10x: fix OF_=
GPIO dependency)
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (979e2ec58de2 drm: nouveau: Rep=
lace sprintf() with sysfs_emit())
...
IG_SMP)
Merging loongarch/loongarch-next (f58946000272 LoongArch: Adjust default co=
...
Merging s390/for-next (f770950a4709 s390/pci: Migrate s390 IRQ logic to IRQ=
 domain API)
...
Merging fs-next (1d602483f953 Merge branch 'vfs.all' of https://git.kernel.=
...
Merging drm-xe/drm-xe-next (da33e457f680 drm/xe/guc_ct: Assert on credits m=
ismatch during runtime suspend)
...
Merging sound/for-next (74ac7558ea76 ALSA: Do not build obsolete API)
...
Merging kvm-x86/next (5d3e2d9ba9ed Merge branch 'fixes')
...
Merging turbostat/next (033c41888d81 tools/power turbostat: Dump hypervisor=
 name)
...

=TUrS
-----END PGP SIGNATURE-----
