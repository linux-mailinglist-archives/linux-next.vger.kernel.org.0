...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 84778F6FB9
	for <lists+linux-next@lfdr.de>; Mon, 11 Nov 2019 09:31:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726785AbfKKIbS (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 11 Nov 2019 03:31:18 -0500
Received: from ozlabs.org ([203.11.71.1]:54843 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726768AbfKKIbR (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 11 Nov 2019 03:31:17 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47BPGh6Lkmz9sPV;
        Mon, 11 Nov 2019 19:31:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1573461069;
        bh=wdgbGPdouafqsk2x4JLwR58nh2cwPOL8omKl1k9FnEI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 11 Nov 2019 19:31:06 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 11
Message-ID: <20191111193106.119b63e3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_iR4ISrythvaWxz3aoqPFGz";
...
--Sig_/_iR4ISrythvaWxz3aoqPFGz
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20191108:

The net-next tree gained a build failure for which I applied a patch.

The amdgpu tree lost its build failure.

The tip tree gained a conflict against the xtensa tree.

Non-merge commits (relative to Linus' tree): 9454
 8585 files changed, 375532 insertions(+), 158703 deletions(-)
...
Merging origin/master (44866956804e Merge tag 'armsoc-fixes' of git://git.k=
...
desc_size)
Merging sound-current/for-linus (167beb175679 ALSA: usb-audio: Fix missing =
error check at mixer resolution test)
Merging sound-asoc-fixes/for-linus (684a126deed6 Merge branch 'asoc-5.4' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (0ddae2efcc64 Merge branch 'spi-5.4' into spi-l=
inus)
...
Merging arm/for-next (cb73737ea1d2 ARM: 8928/1: ARM_ERRATA_775420: Spelling=
 s/date/data/)
Merging arm64/for-next/core (6be22809e5c8 Merge branches 'for-next/elf-hwca=
p-docs', 'for-next/smccc-conduit-cleanup', 'for-next/zone-dma', 'for-next/r=
elax-icc_pmr_el1-sync', 'for-next/double-page-fault', 'for-next/misc', 'for=
-next/kselftest-arm64-signal' and 'for-next/kaslr-diagnostics' into for-nex=
t/core)
...
Merging arm-soc/for-next (2bde960acd7b ARM: Document merges)
...
Merging cifs/for-next (c26de2e01263 cifs: update internal module version nu=
mber)
...
in imxfb_probe())
Merging pm/linux-next (341d02290c9a Merge branches 'pm-cpufreq' and 'pm-sle=
ep' into linux-next)
...
Merging net-next/master (7941af9b38fa Merge branch 'r8169-improve-PHY-confi=
guration')
...
Merging bpf-next/master (451d1dc886b5 samples: bpf: update map definition t=
o new syntax BTF-defined map)
...
Merging amdgpu/drm-next (2eca2d659ff1 drm/amdgpu/powerplay/smu7: fix AVFS h=
andling with custom powerplay table)
...
Merging sound/for-next (9cb7831384ce staging: most: Convert to the common v=
malloc memalloc)
Merging sound-asoc/for-next (3fdcb73c5750 Merge branch 'asoc-5.5' into asoc=
-next)
...
Merging input/next (d843304b22e8 Input: synaptics-rmi4 - simplify data read=
 in rmi_f54_work)
Merging block/for-next (db1bdcfe5f8b Merge branch 'for-5.5/io_uring' into f=
or-next)
...
iable 'keyhndl')
Merging watchdog/master (00aff6836241 Merge tag 'for-5.4-rc6-tag' of git://=
...
register value)
Merging spi/for-next (c24f5ea98879 Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
Merging tip/auto-latest (ccbe147b8881 Merge branch 'linus')
...
Merging irqchip/irq/irqchip-next (b8b0145f7d0e irqchip: Ingenic: Add proces=
s for more than one irq at the same time.)
...
Merging driver-core/driver-core-next (8e12257dead7 of: property: Add device=
 link support for iommus, mboxes and io-channels)
...
t from dma_map_sg)
Merging char-misc/char-misc-next (a61ead03a6f2 Merge tag 'soundwire-5.5-rc1=
...
Merging staging/staging-next (b79967a27f34 staging: vchiq: Have vchiu_queue=
_init() return 0 on success.)
CONFLICT (content): Merge conflict in drivers/staging/Makefile
CONFLICT (content): Merge conflict in drivers/staging/Kconfig
...
Merging devfreq/devfreq-next (abec3b5155be PM / devfreq: Introduce get_freq=
_range helper)
...
rflow
Merging akpm/master (c63a7473cbdf drivers/media/platform/sti/delta/delta-ip=
...

=qVI8
-----END PGP SIGNATURE-----
