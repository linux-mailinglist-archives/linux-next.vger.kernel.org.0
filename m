Return-Path: <linux-next+bounces-9575-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id D7EF1CFC30C
	for <lists+linux-next@lfdr.de>; Wed, 07 Jan 2026 07:34:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 988493011F89
	for <lists+linux-next@lfdr.de>; Wed,  7 Jan 2026 06:34:18 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3F9B822256F;
	Wed,  7 Jan 2026 06:34:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="Y6kCBcZG"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5849A225A38;
	Wed,  7 Jan 2026 06:34:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767767657; cv=none; b=UrQn/lhMj3tYIv6Rvwt8WGl3Bkl6sFdVZtBBS0O3oUV5nuYRC4v3KI9VI/ajQJwo07ww1x3IiNW8wxU1w7d6l+wYmQs5mqShGD2ws8SAQG8c00CoqwBfqSbGmu2pVjw1XTXM7515PB/6T2EwtdOLIrh6ySWJTvui++mkcgo+a20=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767767657; c=relaxed/simple;
	bh=zoXoab93EgcO4l90hF93XF8iM96jnqIB/j1T2yKhZ4U=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=Wvm4sXrlnA8USbLlcYauFrHKVFjhOuQpNyxmIChimouMlQ5mNSMYEsymyuXNbORwCjLYJLg61uVloiu2Xdle83FnOzSp+6b9ladxjiV2Ho/5UiV5OBkuT5pvTG9ATlhQY2VUSo8qIAR1RusK/6ukhDNalrApz0BkKLulZwv4jDg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=Y6kCBcZG; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1767767645;
	bh=7OdseSDxt8s/6lyJekOv0euTqNVmbJouPGn/Duj5VZ4=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dmJCc6hxKz4wCy;
	Wed, 07 Jan 2026 17:34:04 +1100 (AEDT)
Date: Wed, 7 Jan 2026 17:33:47 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 7
Message-ID: <20260107173347.182ebe02@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/cvXqY8nO5UEeByQ.kgkUUjx";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/cvXqY8nO5UEeByQ.kgkUUjx
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20260106:

The mm-unstable tree gained a build failure for which I applied a patch.

The v4l-dvb tree gained a conflict against the vfs-brauner-fixes tree.

The tip tree gained conflicts against the mm-nonmm-unstable and crypto
trees.  Also a build failure due to other linux-next changes for which
I reverted a commit.

The driver-core tree gained a conflict against the driver-core.current
tree.

Non-merge commits (relative to Linus' tree): 3945
 4076 files changed, 242619 insertions(+), 123599 deletions(-)
...
Merging btrfs-fixes/next-fixes (143a6d7f28a0 Merge branch 'misc-6.19' into =
next-fixes)
Merging vfs-fixes/fixes (e1b4c6a58304 shmem: fix recovery on rename failure=
s)
Merging erofs-fixes/fixes (4f0d4a1e4b91 erofs: don't bother with s_stack_de=
...
Merging fs-current (3e97cebd96f6 Merge branch 'fixes' of https://git.kernel=
...
Merging net/main (238e03d04662 net: fix memory leak in skb_segment_list for=
 GRO packets)
...
Merging sound-asoc-fixes/for-linus (f33db67d914a ASoC: codecs: wsa88xx: fix=
...
Merging v4l-dvb-fixes/fixes (63d957123092 media: rzg2l-cru: csi-2: Support =
RZ/V2H input sizes)
...
Merging rust-fixes/rust-fixes (609db7e73b3e rust: kbuild: Add -fdiagnostics=
-show-context to bindgen_skip_c_flags)
...
Merging tip-fixes/tip/urgent (9c6671b22e78 Merge branch into tip/master: 'x=
86/urgent')
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (d5bdf88d1f9d drm/fb-helper: Fi=
x vblank timeout during suspend/reset)
...
Merging qcom/for-next (7ce8f50d870c Merge branches 'arm32-fixes-for-6.19', =
...
Merging xtensa/xtensa-for-next (0d4b3ca115b5 xtensa: align: validate access=
 in fast_load_store)
Merging fs-next (3acc83db16cd Merge branch 'vfs.all' of https://git.kernel.=
...
S definition)
Merging net-next/main (3f049b653450 net: fec: Add stop mode support on i.MX=
8DX/i.MX8QP)
Merging bpf-next/for-next (ea180ffbd27c mm: drop mem_cgroup_usage() declara=
tion from memcontrol.h)
...
Merging bluetooth/master (030d2c0e9c1d Bluetooth: btqca: Add WCN6855 firmwa=
re priority selection feature)
...
handler_gfx12.asm
Merging drm-intel/for-linux-next (968290fa8a42 drm/i915/cdclk: Implement Wa=
_13012396614)
...
Merging drm-rust/drm-rust-next (4348796233e7 rust: drm: Improve safety comm=
ent when using `Pin::into_inner_unchecked`)
Merging drm-nova/nova-next (93296e9d9528 gpu: nova-core: vbios: store refer=
ence to Device where relevant)
Merging drm-xe/drm-xe-next (051114652b6b drm/xe/doc: Remove KEEP_ACTIVE fea=
ture)
...
Merging sound-asoc/for-next (cf3236508c5f Merge remote-tracking branch 'aso=
...
fsleep())
Merging block/for-next (5ee81d4ae52e Merge branch 'for-7.0/blk-pvec' into f=
or-next)
...
Merging security/next (2d38a4e3e208 rust: security: add __rust_helper to he=
lpers)
...
nused)
Merging tip/master (5d3b0106245d Merge branch into tip/master: 'x86/sev')
...
Merging bitmap/bitmap-for-next (58b0bd117472 rust: bitops: fix missing _fin=
...

=3ZKp
-----END PGP SIGNATURE-----
