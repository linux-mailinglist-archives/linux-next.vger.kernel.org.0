Return-Path: <linux-next+bounces-5322-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 3C322A1AF9D
	for <lists+linux-next@lfdr.de>; Fri, 24 Jan 2025 05:51:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E1AB13A8842
	for <lists+linux-next@lfdr.de>; Fri, 24 Jan 2025 04:51:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0F51A1D417C;
	Fri, 24 Jan 2025 04:51:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="dbqrVztf"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AE0F7155759;
	Fri, 24 Jan 2025 04:51:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737694308; cv=none; b=P6l48791Pe8NbMjPgGRfYk1EtV7qOrETFLD/2D2sorTclnsHNmU7434tTHl6yMFo6hUvFYwVbBRJf+VbB7dvTqcNFrbos7ZNIkLyXSa1LQGrVg+6cm23Zpy3wQ2MwH5JvazWA8w9FSBbIDbWHL+4UFJ9rMjPK27eaBKrOR/iHd4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737694308; c=relaxed/simple;
	bh=JlTrB/IEKGbJadaMuIbloAwY82gAr2AEEpQgSqV+73M=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=gWH3h/dxW0a3h5zf6Ss8KQfvLg9fq25PmpX1lgG8VIwdf2uZpVZsoEFDFHkoh8gOWv1UpfG3lh4wyOjiIz0mtMgafSBQoFq+/Hp27iED5CCegOxHhE1a6FjYnaVVDjYe7lZoQ4EluNjcsC0/jalAijhXGSG5D5llbEcMvANjkKg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=dbqrVztf; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1737694291;
	bh=h2qmykFlwcb7L3j/K4JsbDP7y816TUyMDPUuc+/H4sA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YfQPv0Hcwz4wcs;
	Fri, 24 Jan 2025 15:51:31 +1100 (AEDT)
Date: Fri, 24 Jan 2025 15:51:38 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 24
Message-ID: <20250124155138.42f70cea@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/SVUNhzYb_4ZUA3PTqsbXPO5";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/SVUNhzYb_4ZUA3PTqsbXPO5
...
Changes since 20250123:

The vfs tree gained a conflict against the fuse tree.

Non-merge commits (relative to Linus' tree): 4609
 4725 files changed, 221806 insertions(+), 78548 deletions(-)
...
Merging origin/master (d0d106a2bd21 Merge tag 'bpf-next-6.14' of git://git.=
...
Merging bcachefs/for-next (e130b1de4b85 bcachefs: fix trace_copygc)
...
tch())
Merging cifs/for-next (3681c74d342d smb: client: handle lack of EA support =
...
Merging f2fs/dev (edf3c0860060 f2fs: fix to avoid changing 'check only' beh=
aior of recovery)
Merging fsverity/for-next (8e929cb546ee Linux 6.12-rc3)
Merging fuse/for-next (698d70a3b1e5 fuse: add default_request_timeout and m=
ax_request_timeout sysctls)
Merging gfs2/for-next (d470a03180cd gfs2: Decode missing glock flags in tra=
cepoints)
...
vfs.all)
Merging vfs/for-next (5eda88e2b9bf Merge branch 'work.d_revalidate' into fo=
r-next)
...
Merging fs-current (c97e93ece600 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (15a901361ec3 ipmr: do not call mr_mfc_uses_dev() for unre=
s entries)
Merging bpf/master (d0d106a2bd21 Merge tag 'bpf-next-6.14' of git://git.ker=
...
reference)
Merging ath/for-current (146b6057e1fd wifi: cw1200: Fix potential NULL dere=
ference)
Merging wpan/master (8ce4f287524c net: libwx: fix firmware mailbox abnormal=
 return)
Merging rdma-fixes/for-rc (45d339fefaa3 RDMA/mlx5: Enable multiplane mode o=
nly when it is supported)
Merging sound-current/for-linus (6aa96f780204 ALSA: hda: tas2781-spi: Fix b=
ogus error handling in tas2781_hda_spi_probe())
Merging sound-asoc-fixes/for-linus (798ac17ac847 Merge remote-tracking bran=
...
Merging tip-fixes/tip/urgent (b7515e314124 Merge branch into tip/master: 's=
ched/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (5247a8b313cc drm/bochs: Do not=
 put DRM device in PCI remove callback)
...
abel support)
Merging powerpc/next (ae908b87b6bb powerpc: increase MIN RMA size for CAS n=
egotiation)
...
Merging fs-next (271ee9afcf55 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (9022df7f5e05 Merge branch 'for-6.14-cpu_sync-fixup=
' into for-next)
Merging pci/next (10ff5bbfd4b0 Merge branch 'pci/misc')
...
nto for-next)
Merging i2c/i2c/for-next (d0d106a2bd21 Merge tag 'bpf-next-6.14' of git://g=
...
Merging pm/linux-next (83c0e17f9af1 Merge branch 'pm-cpuidle' into linux-ne=
xt)
...
est)
Merging drm/drm-next (07c5b277208c Merge v6.13 into drm-next)
...
Merging drm-xe/drm-xe-next (dddc53806dd2 drm/xe/ptl: Apply Wa_13011645652)
...
Merging sound/for-next (6aa96f780204 ALSA: hda: tas2781-spi: Fix bogus erro=
r handling in tas2781_hda_spi_probe())
Merging ieee1394/for-next (352fafe97784 firewire: test: Fix potential null =
dereference in firewire kunit test)
Merging sound-asoc/for-next (798ac17ac847 Merge remote-tracking branch 'aso=
...
Merging input/next (08bd5b7c9a24 Input: synaptics - fix crash when enabling=
 pass-through port)
Merging block/for-next (f21c15d05f2c Merge branch 'io_uring-6.14' into for-=
next)
...
Merging tpmdd/next (a3a860bc0fd6 tpm: Change to kvalloc() in eventlog/acpi.=
c)
...
Merging devicetree/for-next (1f744135f996 docs: dt-bindings: Document prefe=
rred line wrapping)
...
13' into spi-linus)
Merging tip/master (b79d90e01858 Merge branch into tip/master: 'x86/tdx')
...
Merging ftrace/for-next (85f4160dbcf4 Merge tools/for-next)
...
.01a' into HEAD)
Merging kvm/next (86eb1aef7279 Merge branch 'kvm-mirror-page-tables' into H=
EAD)
...

=tWeJ
-----END PGP SIGNATURE-----
