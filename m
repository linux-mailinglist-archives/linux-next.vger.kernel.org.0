...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EB87260C3B1
	for <lists+linux-next@lfdr.de>; Tue, 25 Oct 2022 08:17:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231192AbiJYGRo (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 25 Oct 2022 02:17:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36106 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231184AbiJYGRn (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 25 Oct 2022 02:17:43 -0400
Received: from mail-pj1-x1029.google.com (mail-pj1-x1029.google.com [IPv6:2607:f8b0:4864:20::1029])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 97CDE520AE
        for <linux-next@vger.kernel.org>; Mon, 24 Oct 2022 23:17:40 -0700 (PDT)
Received: by mail-pj1-x1029.google.com with SMTP id v4-20020a17090a088400b00212cb0ed97eso10809579pjc.5
        for <linux-next@vger.kernel.org>; Mon, 24 Oct 2022 23:17:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=R9FVElniOoCTQJA8WOX03ASFondxyG9eFC5BOxHewzI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=R9FVElniOoCTQJA8WOX03ASFondxyG9eFC5BOxHewzI=;
        b=
X-Gm-Message-State: ACrzQf3UEyndApqej8tT2ZHKW5DoDIq2iHaVnEIuk1f6Rkuh3SoYMTjv
        K7eQDNGUUMHVHzMb8M7HWvhnkt6DNaOEGll1
X-Google-Smtp-Source: AMsMyM4RkFQB/C6yD8BY/UxgvAuGwfsgbVBMMpkurwuNhgfseT2Kbf1luU31XmF7dZ7LCI3pzerf/w==
X-Received: by 2002:a17:902:c407:b0:17f:8bec:e7f4 with SMTP id k7-20020a170902c40700b0017f8bece7f4mr37052989plk.156.1666678658722;
        Mon, 24 Oct 2022 23:17:38 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id z10-20020aa79e4a000000b0056ba138067fsm744417pfq.29.2022.10.24.23.17.37
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 24 Oct 2022 23:17:38 -0700 (PDT)
Message-ID: <63577f82.a70a0220.b61ea.1de6@mx.google.com>
Date:   Mon, 24 Oct 2022 23:17:38 -0700 (PDT)
...
Subject: next/master build: 220 builds: 9 failed, 211 passed, 25 errors,
 92 warnings (next-20221025)
...
next/master build: 220 builds: 9 failed, 211 passed, 25 errors, 92 warnings=
 (next-20221025)
...
ffset() leaves .noinstr.text section
 ...
 leaves .noinstr.text section
    1    mm/khugepaged.c:1729:7: warning: variable 'nr' is used uninitializ=
ed whenever 'if' condition is true [-Wsometimes-uninitialized]
    1    mm/khugepaged.c:1729:7: warning: variable 'index' is used uninitia=
lized whenever 'if' condition is true [-Wsometimes-uninitialized]
    1    mm/khugepaged.c:1716:6: warning: variable 'nr' is used uninitializ=
ed whenever 'if' condition is true [-Wsometimes-uninitialized]
    1    mm/khugepaged.c:1716:6: warning: variable 'index' is used uninitia=
lized whenever 'if' condition is true [-Wsometimes-uninitialized]
    1    mm/khugepaged.c:1710:8: note: initialize the variable 'nr' to sile=
nce this warning
    1    mm/khugepaged.c:1705:15: note: initialize the variable 'index' to =
...
t() falls through to next function __cfi_m5mols_enum_mbus_code()
    1    clang: warning:   CC      mm/fadvise.o
