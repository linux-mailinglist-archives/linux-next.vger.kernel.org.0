Return-Path: <linux-next+bounces-9540-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 0F736CF20C0
	for <lists+linux-next@lfdr.de>; Mon, 05 Jan 2026 07:04:29 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 2934130057F1
	for <lists+linux-next@lfdr.de>; Mon,  5 Jan 2026 06:04:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3AA9E23D7FC;
	Mon,  5 Jan 2026 06:04:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="J7Nvexy/"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 512631F3BAC;
	Mon,  5 Jan 2026 06:03:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1767593040; cv=none; b=scvMmafIaoqqjDMtjDqn3DGRg2sH7Z+X6AD5tlCbZp13Tjt5QpXz8UbsRcudYbQXpw3J0M12DZRY4cROpVL18KNQxUNc1aALEFwsNl+yc81FSYzgQW428EK8BPO7PIRMD1vmq4QlWnDxOx7R/LofGaaj33QmPOyiG674NyTBlQU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1767593040; c=relaxed/simple;
	bh=9qPEYciMkQI9a/1GTxSuI7mZciKyWQDflJ5E1ZoKaj4=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=srvhfmYiU9L0aa3SNCMETh5NVL47NAWst0/bI+T2R88lAguh6WpAI00PhWW3uj0kHqBUUwiZWO8ww4kXe7riaPxl7c+ApzEQHceNDwpepQ3tWOLRXUjcsT1SwumJm9/E2SetHE+BoBOcRiPsjD6AnV1+DHgGTaIAZt+F78IjPXY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=J7Nvexy/; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1767593030;
	bh=Psu949jHmtdqr5EIqYesnzs0SGgSZjlOYHGCLWyN6ps=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dl3dd6cCKz4wC1;
	Mon, 05 Jan 2026 17:03:49 +1100 (AEDT)
Date: Mon, 5 Jan 2026 17:03:49 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 5
Message-ID: <20260105170349.01d85e32@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/T6cAzc_4W39N=Mf3mhy1VsN";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/T6cAzc_4W39N=Mf3mhy1VsN
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20251219:

Removed tree: accel	not used in a long time

The mm-nonmm-unstable tree lost its build failure.

The pci tree gained a conflict against the pci-current tree.

The bpf-next tree gained a semantic conflict against the mm-unstable tree.

The drm tree gained conflicts against Linus' tree and the drm-misc-fixes
tree.

The tip tree lost its build failure.
The tip tree gained conflicts against the renesas tree.

The phy-next tree gained a conflict against the phy tree.

The soundwire tree gained a conflict against the sound-asoc tree.

The mhi tree gained a conflict against the ath-next tree.

Non-merge commits (relative to Linus' tree): 3287
 3419 files changed, 216111 insertions(+), 69949 deletions(-)
...
Merging origin/master (54e82e93ca93 Merge tag 'core_urgent_for_v6.19_rc4' o=
...
Merging btrfs/for-next (8eb403a96c53 Merge branch 'for-next-next-v6.19-2026=
0102' into for-next-20260102)
Merging ceph/master (2bf50e7900c8 libceph: return the handler error from mo=
n_handle_auth_done())
Merging cifs/for-next (e3a97ab1bbc3 Merge tag 'v6.19-rc3-smb3-server-fixes'=
...
ezable kthread)
Merging ksmbd/ksmbd-for-next (e3a97ab1bbc3 Merge tag 'v6.19-rc3-smb3-server=
...
Merging nfsd/nfsd-next (fbdd582b5176 xdrgen: Emit the program number defini=
tion)
...
Merging fs-current (22b25112be5e Merge branch 'nfsd-fixes' of https://git.k=
...
irect read)
Merging pci-current/for-linus (0cc13256b605 PCI: qcom: Remove ASPM L0s supp=
ort for MSM8996 SoC)
...
Merging thunderbolt-fixes/fixes (f8f9c1f4d0c7 Linux 6.19-rc3)
...
Merging drm-fixes/drm-fixes (7be19f9327d9 Merge tag 'drm-intel-fixes-2025-1=
2-31' of https://gitlab.freedesktop.org/drm/i915/kernel into drm-fixes)
Merging drm-intel-fixes/for-linux-next-fixes (4fe2bd195435 drm/i915/gem: Ze=
ro-initialize the eb.vma array in i915_gem_do_execbuffer)
...
Merging memblock-fixes/fixes (78e24eff572b memblock test: include <linux/si=
...
Merging tip-fixes/tip/urgent (04d727875a28 Merge branch into tip/master: 'c=
ore/urgent')
...
Merging qcom/for-next (2e7f445cb3d2 Merge branches 'arm32-fixes-for-6.19', =
'arm64-defconfig-for-6.20', 'arm64-fixes-for-6.19', 'arm64-for-6.20', 'clk-=
for-6.20' and 'drivers-for-6.20' into for-next)
...
v6.18-rc1)
Merging m68knommu/for-next (f8f9c1f4d0c7 Linux 6.19-rc3)
...
Merging xtensa/xtensa-for-next (0d4b3ca115b5 xtensa: align: validate access=
 in fast_load_store)
Merging fs-next (6fc3f78e4042 Merge branch 'vfs.all' of https://git.kernel.=
...
Merging pm/linux-next (2b95b1a7e31a Merge branches 'acpi-sysfs' and 'acpi-b=
us' into linux-next)
Merging cpufreq-arm/cpufreq/arm/linux-next (0702825fe1e2 cpufreq: Add Tegra=
186 and Tegra194 to cpufreq-dt-platdev blocklist)
...
Merging drm-misc/for-linux-next (a7c2f143f878 drm: pl111: fix build regress=
ion)
Merging amdgpu/drm-next (0a54edc19158 drm/radeon: Convert legacy DRM loggin=
g in evergreen.c to drm_* helpers)
Merging drm-intel/for-linux-next (65f329ff2347 drm/i915/gvt: include intel_=
display_limits.h where needed)
...
Merging drm-xe/drm-xe-next (0b075f82935e drm/xe: Improve rebar log messages)
...
fsleep())
Merging block/for-next (528478eac65b Merge branch 'block-6.19' into for-nex=
t)
...
s to NETFILTER_PKT)
Merging devicetree/for-next (842095d75323 of/platform: Simplify with scoped=
...
20' into spi-next)
Merging tip/master (fdebc6ca44cd Merge branch into tip/master: 'x86/sev')
...
Merging thunderbolt/next (0c90fd379bb5 docs: admin-guide: thunderbolt: Repl=
ace ifconfig with ip)
...
Merging coresight/next (51cd1fb70e08 dt-bindings: arm: add CTCU device for =
monaco)
...
Merging rpmsg/for-next (8467c1be0ed0 Merge branches 'rpmsg-next' and 'rproc=
-next' into for-next)
Merging gpio-brgl/gpio/for-next (9d8107579ce4 gpio: max77759: drop use of i=
rqd_get_trigger_type)
...
Merging kunit-next/kunit (a77b19b747c8 kunit: Protect KUNIT_BINARY_STR_ASSE=
RTION against ERR_PTR values)
...
n_is_scoped)
Merging sysctl/sysctl-next (8f0b4cce4481 Linux 6.19-rc1)
...
Merging nolibc/for-next (3ac0730caa05 selftests/nolibc: drop NOLIBC_SYSROOT=
=3D0 logic)
...

=yCTP
-----END PGP SIGNATURE-----
