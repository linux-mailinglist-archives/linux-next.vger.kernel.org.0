...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 373EC2C4FF5
	for <lists+linux-next@lfdr.de>; Thu, 26 Nov 2020 09:05:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728622AbgKZIFn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 26 Nov 2020 03:05:43 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34676 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727678AbgKZIFn (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 26 Nov 2020 03:05:43 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 28AFAC0613D4;
        Thu, 26 Nov 2020 00:05:42 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4ChVgQ42jyz9s1l;
        Thu, 26 Nov 2020 19:05:38 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1606377938;
        bh=j3CqsFblMWZ0+/AITgHeMqi0DC7pexs8Jkj5VyU22IU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 26 Nov 2020 19:05:37 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 26
Message-ID: <20201126190537.3a2c9e2e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=5kiHwbmAqrsja1mqwTePZP";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/=5kiHwbmAqrsja1mqwTePZP
...
The userns tree gained a conflict against the bpf-next tree.

The akpm tree gained a conflict against the arm64 tree.

Non-merge commits (relative to Linus' tree): 7970
 7677 files changed, 623133 insertions(+), 130445 deletions(-)
...
Merging origin/master (fa02fcd94b0c Merge tag 'media/v5.10-2' of git://git.=
...
Merging net/master (90cf87d16bd5 enetc: Let the hardware auto-advance the t=
aprio base-time of 0)
...
Merging sound-asoc-fixes/for-linus (b7c082d878f6 Merge remote-tracking bran=
...
Merging drm-fixes/drm-fixes (030c5b52d4c1 drm/amdgpu: Fix size calculation =
when init onchip memory)
...
t)
Merging arm64/for-next/core (de3510fc5885 Merge branch 'for-next/uaccess' i=
nto for-next/core)
...
take2' into for-next)
Merging qcom/for-next (a4e485d1a061 Merge branches 'arm64-for-5.11', 'arm64=
...
Merging ext3/for_next (bb5a5322a5ab Pull writeback tracepoint fix from Hui =
Su.)
...
ion)
Merging v4l-dvb/master (4863b93cfd2d media: camss: csiphy: Set rate on csiX=
_phy clock on SDM630/660)
...
in imxfb_probe())
Merging pm/linux-next (0a1829d7eb6a Merge branches 'pm-cpufreq', 'pm-tools'=
, 'pm-sleep', 'pm-domains' and 'powercap' into linux-next)
...
Merging net-next/master (b5094a3b535b soc: qcom: ipa: Constify static qmi s=
tructs)
...
Merging gfs2/for-next (bb3278af737e MAINTAINERS: Add gfs2 bug tracker link)
...
ing' into for-next)
Merging sound-asoc/for-next (cc3d4eb503f2 Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (d7bf537084f2 Merge remote-tracking branch 'regu=
...
Merging akpm/master (62be252d7cd2 mm/gup: assert that the mmap lock is held=
 in __get_user_pages())
...

=qY0p
-----END PGP SIGNATURE-----
