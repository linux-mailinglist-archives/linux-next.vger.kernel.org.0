Return-Path: <linux-next+bounces-9477-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E0DCCCE594
	for <lists+linux-next@lfdr.de>; Fri, 19 Dec 2025 04:15:21 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 5C89A3026299
	for <lists+linux-next@lfdr.de>; Fri, 19 Dec 2025 03:14:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6A0C52BDC03;
	Fri, 19 Dec 2025 03:14:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="bE25q20c"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8584A1F8BD6;
	Fri, 19 Dec 2025 03:14:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1766114060; cv=none; b=ey5GuwBd0oD4D98K8onwn1iMbGuPe/TpzXy3RSHTSSEou8Wv1BHDt3Xnu0shWgyKL8IXuz3Stl34AqTlagwfJ2k8OaneZ3uLKXiexZhrIcoT5JJa1XHdDDZJpOHd/rFt835z3FtfsoK9jARnTSQayyTRQoxKlta7rhrU1lYZdtc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1766114060; c=relaxed/simple;
	bh=LG3oj3gJl0QtDlRytJyERSDa56/Nq6qukZytVvBhstc=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=IuS6KYiJvUI0+8GIsPGE+rAiM5burRLjt6AcJemw7M7loNbQrwr/ELLKZnr5Z905hIjz11v2/iTKfdl/t5O1W6icTKoE34K5eilCTrZt5oGc+7YhQWWgTlJDHHx439M0QiZlcL2iWiadwofHq1r9c60tSmq3owFPcRKe4lA3sGc=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=bE25q20c; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1766114051;
	bh=VMxJiqOWU209tKrUCgreesbUeDElyFAbcsb2tCFk9vU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dXXgl5w2lz4wDB;
	Fri, 19 Dec 2025 14:14:11 +1100 (AEDT)
Date: Fri, 19 Dec 2025 14:14:10 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 19
Message-ID: <20251219141410.30769b58@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/LgOhqcI5zNGJsRkWGV8U.rf";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/LgOhqcI5zNGJsRkWGV8U.rf
...
Changes since 20251218:

The btrfs tree lost its build failure.

The mm-nonmm-unstable tree still had ts build failure for which I reverted
2 commits.
...
Non-merge commits (relative to Linus' tree): 2111
 2418 files changed, 169924 insertions(+), 50776 deletions(-)
...
Merging origin/master (dd9b004b7ff3 Merge tag 'trace-v6.19-rc1' of git://gi=
...
Merging nfsd-fixes/nfsd-fixes (913f7cf77bf1 NFSD: NFSv4 file creation negle=
cts setting ACL)
...
Merging btrfs/for-next (58d1993910c4 Merge branch 'for-next-next-v6.19-2025=
1218' into for-next-20251218)
Merging ceph/master (375068b6c206 libceph: prevent potential out-of-bounds =
reads in handle_auth_done())
Merging cifs/for-next (d8a4af8f3d9d cifs: update internal module version nu=
mber)
...
n-persistent dentry)
Merging mm-hotfixes/mm-hotfixes-unstable (201037a59604 mm/memremap: fix spu=
rious large folio warning for FS-DAX)
Merging fs-current (3bfe1da11c0d Merge branch 'nfsd-fixes' of https://git.k=
...
RA register)
Merging net/main (21a88f5d9ce0 Merge tag 'linux-can-fixes-for-6.19-20251218=
' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can)
Merging bpf/master (ea1013c15392 Merge tag 'bpf-fixes' of git://git.kernel.=
...
Merging netfilter/main (21a88f5d9ce0 Merge tag 'linux-can-fixes-for-6.19-20=
251218' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can)
...
Merging wpan/master (8ce4f287524c net: libwx: fix firmware mailbox abnormal=
 return)
Merging rdma-fixes/for-rc (85463eb6a46c RDMA/efa: Remove possible negative =
shift)
Merging sound-current/for-linus (f7cede182c96 ALSA: hda/realtek: Add Asus q=
uirk for TAS amplifiers)
Merging sound-asoc-fixes/for-linus (fa43ab13c59f ASoC: fsl-asoc-card: Use o=
f_property_present() for non-boolean properties)
...
Merging spi-fixes/for-linus (9d651a6c6283 spi: cadence-quadspi: Fix probe e=
rror path and logging)
Merging pci-current/for-linus (94bf74830a97 PCI: rzg3s-host: Initialize MSI=
 status bitmap before use)
Merging driver-core.current/driver-core-linus (e2f1081ca8f1 samples: rust: =
fix endianness issue in rust_driver_pci)
Merging tty.current/tty-linus (5edb7338d611 serial: 8250: longson: Fix NULL=
 vs IS_ERR() bug in probe)
Merging usb.current/usb-linus (3b4961313d31 usb: dwc3: of-simple: fix clock=
 resource leak in dwc3_of_simple_probe)
...
_* confusion)
Merging hwmon-fixes/hwmon (6cde588e6493 hwmon: (DS620) Update broken Datash=
eet URL in driver documentation)
...
Merging dma-mapping-fixes/dma-mapping-fixes (608bf0c7be29 parisc: Set valid=
...
Merging scsi-fixes/fixes (c9f36f04a8a2 scsi: ufs: core: Add ufshcd_update_e=
vt_hist() for UFS suspend error)
...
Merging mmc-fixes/fixes (d3ecb12e2e04 mmc: sdhci-esdhc-imx: add alternate A=
RCH_S32 dependency to Kconfig)
...
Merging gpio-brgl-fixes/gpio/for-current (a05543d6b05b gpio: it87: balance =
superio enter/exit calls in error path)
...
ile_smp_* alignment)
Merging perf-current/perf-tools (800ad1f0e277 perf tools: Disable BPF skele=
...
Merging iommufd-fixes/for-rc (e6a973af1113 iommufd/selftest: Check for over=
flow in IOMMU_TEST_OP_ADD_RESERVED)
...
NO_STAY_ON flag)
Merging i2c-host-fixes/i2c/i2c-host-fixes (880977fdc7f6 dt-bindings: i2c: q=
com-cci: Document SM8750 compatible)
...
Merging tip-fixes/tip/urgent (a51826582e8b Merge branch into tip/master: 'x=
86/urgent')
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (6b991ad8dc3a drm/imagination: =
...
Merging mm-unstable/mm-unstable (edeb51ec1667 mm/hugetlb: fix excessive IPI=
 broadcasts when unsharing PMD tables using mmu_gather)
Merging mm-nonmm-unstable/mm-nonmm-unstable (bda39f9485fb fork-comment-fix:=
...
Applying: Revert "atomic: add alignment check to instrumented atomic operat=
ions"
...
Merging qcom/for-next (689a433e9d6b Merge branches 'arm32-fixes-for-6.19', =
'arm64-defconfig-for-6.20', 'arm64-fixes-for-6.19', 'arm64-for-6.20', 'clk-=
fixes-for-6.19', 'clk-for-6.20' and 'drivers-for-6.20' into for-next)
...
or-next)
Merging scmi/for-linux-next (98675bc92a9e Merge branches 'for-next/juno/upd=
...
Merging tee/next (e8fd8a160bbb Merge branch 'tee_bus_callback_for_6.20' int=
o next)
...
Merging xtensa/xtensa-for-next (0d4b3ca115b5 xtensa: align: validate access=
 in fast_load_store)
Merging fs-next (e9fad83f1229 Merge branch 'vfs.all' of https://git.kernel.=
...
Merging hwmon-staging/hwmon-next (1d9d442ab179 hwmon: (fam15h_power) Use ge=
neric power management)
Merging jc_docs/docs-next (464257baf992 docs: makefile: move rustdoc check =
to the build wrapper)
Merging v4l-dvb/next (b70886ff5833 media: vb2: drop wait_prepare/finish cal=
lbacks)
...
kernel.org/pub/scm/linux/kernel/git/netdev/net-next)
Merging bpf-next/for-next (ec439c380135 Merge git://git.kernel.org/pub/scm/=
linux/kernel/git/bpf/bpf after 6.19-rc1)
...
Merging bluetooth/master (98246938a0e6 Bluetooth: L2CAP: Add support for se=
tting BT_PHY)
...
PU stream cleanup)
Merging libcrypto/libcrypto-next (325c29e7d11c lib/crypto: md5: Use rol32()=
 instead of open-coding it)
Merging drm/drm-next (8f0b4cce4481 Linux 6.19-rc1)
Merging drm-exynos/for-linux-next (3a8660878839 Linux 6.18-rc1)
Merging drm-misc/for-linux-next (332070795bd9 accel/amdxdna: Enable hardwar=
e context priority)
Merging amdgpu/drm-next (0a54edc19158 drm/radeon: Convert legacy DRM loggin=
g in evergreen.c to drm_* helpers)
Merging drm-intel/for-linux-next (0c8afa67aaa2 drm/i915: Add intel_gvt_driv=
er_remove() onto error cleanup path)
...
Merging drm-rust/drm-rust-next (97cf6bc0abd3 rust: drm: use `pin_init::zero=
ed()` for file operations initialization)
Merging drm-nova/nova-next (93296e9d9528 gpu: nova-core: vbios: store refer=
ence to Device where relevant)
Merging drm-xe/drm-xe-next (c7b83a916d62 drm/xe: Fix documentation heading =
levels in xe_guc_pc.c)
CONFLICT (content): Merge conflict in drivers/gpu/drm/xe/tests/xe_mocs.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/xe/xe_gt_sriov_pf_mig=
ration.c
...
ap-next)
Merging sound/for-next (03f705b9ca58 ALSA: usb-audio: Relax __free() variab=
le declarations)
Merging ieee1394/for-next (8f0b4cce4481 Linux 6.19-rc1)
Merging sound-asoc/for-next (fa41400e9b5c Merge remote-tracking branch 'aso=
...
Merging block/for-next (e68d68450f76 Merge branch 'block-6.19' into for-nex=
t)
...
bed)
Merging tomoyo/master (88fe48f74ec2 RDMA/core: check device status when man=
ipulating ib_gid_table_entry)
...
s to NETFILTER_PKT)
Merging devicetree/for-next (5530836fb914 of: replace strcmp_suffix() with =
strends())
Merging dt-krzk/for-next (b7fdd9926b22 Merge branch 'next/dt64' into for-ne=
xt)
Merging mailbox/for-next (1ec6e0e8c0dd mailbox: mtk-cmdq: Add driver data t=
o support for MT8196)
Merging spi/for-next (81e4a2ef2782 Merge remote-tracking branch 'spi/for-6.=
20' into spi-next)
...
PMI driver)
Merging driver-core/driver-core-next (e4b3118b61b6 rust: scatterlist: add _=
_rust_helper to helpers)
Merging usb/usb-next (dd1fbe324a54 usb: linux/usb.h: Correct the descriptio=
n of the usb_device_driver member)
Merging thunderbolt/next (8f0b4cce4481 Linux 6.19-rc1)
Merging usb-serial/usb-next (8f0b4cce4481 Linux 6.19-rc1)
Merging tty/tty-next (284da5de616a platform/surface: Migrate to serdev spec=
ific shutdown function)
Merging char-misc/char-misc-next (8f0b4cce4481 Linux 6.19-rc1)
Merging accel/habanalabs-next (f03eee5fc922 Merge tag 'drm-xe-next-fixes-20=
24-05-02' of https://gitlab.freedesktop.org/drm/xe/kernel into drm-next)
Merging coresight/next (7009646d937f dt-binding: Update oss email address f=
or Coresight documents)
...
erf_test)
Merging w1/for-next (761fcf46a1bd w1: therm: Fix off-by-one buffer overflow=
 in alarms_store)
...
Merging scsi-mkp/for-next (8334f93075dc Merge patch series "qla2xxx: Misc f=
eature and bug fixes")
Merging vhost/linux-next (1bac705c2ce7 vhost/vsock: improve RCU read sectio=
ns around vhost_vsock_get())
Merging rpmsg/for-next (8d201aac4d4c Merge branches 'rproc-next' and 'rpmsg=
-next' into for-next)
Merging gpio-brgl/gpio/for-next (47d8cb678081 gpio: realtek-otto: use large=
r type for dev_flags)
...

=LowV
-----END PGP SIGNATURE-----
