...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 652312AC9A3
	for <lists+linux-next@lfdr.de>; Tue, 10 Nov 2020 01:20:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729336AbgKJAU6 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 9 Nov 2020 19:20:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42300 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727311AbgKJAU5 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 9 Nov 2020 19:20:57 -0500
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 62108C0613CF
        for <linux-next@vger.kernel.org>; Mon,  9 Nov 2020 16:20:57 -0800 (PST)
Received: by mail-pg1-x529.google.com with SMTP id r10so8562691pgb.10
        for <linux-next@vger.kernel.org>; Mon, 09 Nov 2020 16:20:57 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=lB95Czy9/ZGewB9wvm/ZKkAeaZifMq01FTa1x19dtPo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=lB95Czy9/ZGewB9wvm/ZKkAeaZifMq01FTa1x19dtPo=;
        b=
X-Gm-Message-State: AOAM533wkLkW9VFZDtwbs8O7XzUwM0x0eYwXZG+EatX+IUfOwRnyKpL9
        RpAjWaLTW8OEeZwQ3VVNUgNgp3FVoptEfw==
X-Google-Smtp-Source: ABdhPJwxs9Eo6mGyhTvmXmkkei4RwznEmjwapXa2IQ47tqU1YK4qZd8pRXN7oa1JIJSyu3FxteOZYg==
X-Received: by 2002:a63:ba1d:: with SMTP id k29mr14647036pgf.179.1604967654631;
        Mon, 09 Nov 2020 16:20:54 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id u5sm11231457pgj.28.2020.11.09.16.20.52
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 09 Nov 2020 16:20:53 -0800 (PST)
Message-ID: <5fa9dce5.1c69fb81.194cb.8ced@mx.google.com>
Date:   Mon, 09 Nov 2020 16:20:53 -0800 (PST)
...
Subject: next/pending-fixes build: 212 builds: 1 failed, 211 passed, 807 errors,
 367 warnings (v5.10-rc3-245-gcb165dbb5aeb)
...
next/pending-fixes build: 212 builds: 1 failed, 211 passed, 807 errors, 367=
 warnings (v5.10-rc3-245-gcb165dbb5aeb)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.10-rc3-245-gcb165dbb5aeb/

Tree: next
Branch: pending-fixes
Git Describe: v5.10-rc3-245-gcb165dbb5aeb
Git Commit: cb165dbb5aeb97153d348ea3f26b04805e8aa22e
...
arc:
    haps_hs_smp_defconfig+kselftest (gcc-8): 141 errors, 22 warnings
...
u mean =E2=80=98MEMBARRIER_CMD_REGISTER_PRIVATE_EXPEDITED=E2=80=99?
    4    lib/kvm_util.c:326:22: error: =E2=80=98KVM_CLEAR_DIRTY_LOG=E2=80=
=99 undeclared (first use in this function); did you mean =E2=80=98KVM_GET_=
DIRTY_LOG=E2=80=99?
    4    lib/kvm_util.c:323:39: error: =E2=80=98struct kvm_clear_dirty_log=
=E2=80=99 has no member named =E2=80=98num_pages=E2=80=99
    4    lib/kvm_util.c:322:32: error: =E2=80=98struct kvm_clear_dirty_log=
=E2=80=99 has no member named =E2=80=98first_page=E2=80=99
    4    lib/kvm_util.c:321:9: error: variable =E2=80=98args=E2=80=99 has i=
nitializer but incomplete type
    4    lib/kvm_util.c:321:60: error: =E2=80=98struct kvm_clear_dirty_log=
=E2=80=99 has no member named =E2=80=98slot=E2=80=99
    4    lib/kvm_util.c:321:39: error: =E2=80=98struct kvm_clear_dirty_log=
=E2=80=99 has no member named =E2=80=98dirty_bitmap=E2=80=99
    4    lib/kvm_util.c:321:29: error: storage size of =E2=80=98args=E2=80=
=99 isn=E2=80=99t known
...
t-ll64.h: No such file or directory
    1    /bin/sh: 1: /bin/sh: 3: clang: not found
...
t-function-declaration]
    4    lib/kvm_util.c:323:51: warning: excess elements in struct initiali=
zer
    4    lib/kvm_util.c:322:45: warning: excess elements in struct initiali=
zer
    4    lib/kvm_util.c:321:67: warning: excess elements in struct initiali=
zer
    4    lib/kvm_util.c:321:54: warning: excess elements in struct initiali=
zer
    4    lib/kvm_util.c:321:29: warning: unused variable =E2=80=98args=E2=
...
[-Wimplicit-function-declaration]
    2    lib/kvm_util.c:249:14: warning: implicit declaration of function =
...
gument of type =E2=80=98long unsigned int=E2=80=99, but argument 7 has type=
 =E2=80=98vm_vaddr_t=E2=80=99 {aka =E2=80=98long long unsigned int=E2=80=99=
    ...
    1    /tmp/ccLvcEj9.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccLvcEj9.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccLvcEj9.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccLvcEj9.s:18192: Warning: using r15 results in unpredictable beha=
viour
...
ile or directory
    lib/kvm_util.c:321:9: error: variable =E2=80=98args=E2=80=99 has initia=
lizer but incomplete type
    lib/kvm_util.c:321:39: error: =E2=80=98struct kvm_clear_dirty_log=E2=80=
=99 has no member named =E2=80=98dirty_bitmap=E2=80=99
    lib/kvm_util.c:321:60: error: =E2=80=98struct kvm_clear_dirty_log=E2=80=
=99 has no member named =E2=80=98slot=E2=80=99
    lib/kvm_util.c:322:32: error: =E2=80=98struct kvm_clear_dirty_log=E2=80=
=99 has no member named =E2=80=98first_page=E2=80=99
    lib/kvm_util.c:323:39: error: =E2=80=98struct kvm_clear_dirty_log=E2=80=
=99 has no member named =E2=80=98num_pages=E2=80=99
    lib/kvm_util.c:321:29: error: storage size of =E2=80=98args=E2=80=99 is=
n=E2=80=99t known
    lib/kvm_util.c:326:22: error: =E2=80=98KVM_CLEAR_DIRTY_LOG=E2=80=99 und=
...
er
    lib/kvm_util.c:249:14: warning: implicit declaration of function =E2=80=
...
M_VGIC_ITS=E2=80=99? [-Wimplicit-function-declaration]
    lib/kvm_util.c:321:54: warning: excess elements in struct initializer
    lib/kvm_util.c:321:67: warning: excess elements in struct initializer
    lib/kvm_util.c:322:45: warning: excess elements in struct initializer
    lib/kvm_util.c:323:51: warning: excess elements in struct initializer
    lib/kvm_util.c:321:29: warning: unused variable =E2=80=98args=E2=80=99 =
[-Wunused-variable]
    install -m 0744 run.sh /root/build/kselftest/lkdtm/WARNING.sh
    install -m 0744 run.sh /root/build/kselftest/lkdtm/WARNING_MESSAGE.sh
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig+kselftest (arc, gcc-8) =E2=80=94 PASS, 141 errors, 22=
...
d=E2=80=99
    /bin/sh: 1: llc: not found
    /bin/sh: 1: /bin/sh: 3: clang: not found
    arc-elf32-gcc: error: unrecognized command line option =E2=80=98-pthrea=
d=E2=80=99
