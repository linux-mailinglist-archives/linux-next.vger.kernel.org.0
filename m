...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7576E104EB0
	for <lists+linux-next@lfdr.de>; Thu, 21 Nov 2019 10:06:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726620AbfKUJGA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 21 Nov 2019 04:06:00 -0500
Received: from ozlabs.org ([203.11.71.1]:59721 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726454AbfKUJGA (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 21 Nov 2019 04:06:00 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47JYZ85p3pz9s4Y;
        Thu, 21 Nov 2019 20:05:52 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1574327152;
        bh=O7rsAmqm9bZDAGY5QnybwpDqtMyW8FMo+U84SvyIeDk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 21 Nov 2019 20:05:49 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 21
Message-ID: <20191121200549.04122bbf@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/+yRB3uI+YUeuJl.anOV0Sy3";
...
Merging net/master (aee024f610cc Merge branch 'ibmvnic-regression')
...
Merging reset-fixes/reset/fixes (ba2c221a18d5 reset: Fix {of,devm}_reset_co=
ntrol_array_get kerneldoc return types)
...
Merging dma-mapping/for-next (68a33b179466 dma-direct: exclude dma_direct_m=
ap_resource from the min_low_pfn check)
...
or-next)
Merging omap/for-next (6f079d80ec0f Merge branch 'omap-for-v5.5/ti-sysc-lat=
e' into for-next)
...
Merging net-next/master (e2193c933429 Merge branch 'r8169-smaller-improveme=
nts-to-firmware-handling')
...
Merging bpf-next/master (196e8ca74886 bpf: Switch bpf_map_{area_alloc,area_=
mmapable_alloc}() to u64 size)
...
Merging wireless-drivers-next/master (924ea58dadea Merge tag 'mt76-for-kval=
o-2019-11-20' of https://github.com/nbd168/wireless)
...
-next)
Merging sound/for-next (94722e74272c ALSA: docs: Update about the new PCM s=
ync_stop ops)
...
Merging block/for-next (26a52a170dc5 Merge branch 'for-5.5/io_uring-post' i=
nto for-next)
...
Merging mmc/next (a5c8b2ae2e51 mmc: sdhci-of-arasan: Add support for ZynqMP=
...
Merging char-misc/char-misc-next (9a5d847c0bda coresight: replicator: Fix m=
issing spin_lock_init())
...
Merging xarray/xarray (6b81141deb73 XArray: Improve documentation of search=
 marks)
Merging hyperv/hyperv-next (664e8508dc28 hv_balloon: Add the support of hib=
ernation)
...
Merging devfreq/devfreq-next (806fdcc0304d PM / devfreq: Fix Kconfig indent=
ation)
...
rflow
Merging akpm/master (f62d90f5d56f drivers/media/platform/sti/delta/delta-ip=
...

=Gj4W
-----END PGP SIGNATURE-----
