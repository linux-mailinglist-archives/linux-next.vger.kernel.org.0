...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3CCAD443CDC
	for <lists+linux-next@lfdr.de>; Wed,  3 Nov 2021 06:48:19 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230478AbhKCFux (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 3 Nov 2021 01:50:53 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:47547 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230389AbhKCFux (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 3 Nov 2021 01:50:53 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HkbR36pZBz4xbc;
        Wed,  3 Nov 2021 16:48:15 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1635918496;
        bh=58m/QVE66HWcoH3+/vrEnkYqsDjV7iqn2eZ3WAQnnu4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 3 Nov 2021 16:48:14 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 3
Message-ID: <20211103164814.5cb28115@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bKDMb6Azjh=+Hvgx=6r+tqc";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/bKDMb6Azjh=+Hvgx=6r+tqc
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211102:

The drm-misc tree has reacquired a build failure so I applied te same patch.

The rust tree gained a conflict agsinst Linus' tree.

I have disabled the ntfs file system write capabaility for now as it
fails for builds with 64k pages.

Non-merge commits (relative to Linus' tree): 7327
 6629 files changed, 379053 insertions(+), 152489 deletions(-)
...
Merging origin/master (bba7d682277c Merge tag 'xfs-5.16-merge-4' of git://g=
...
Merging net/master (cc0356d6a02e Merge tag 'x86_core_for_v5.16_rc1' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging bpf/master (cc0356d6a02e Merge tag 'x86_core_for_v5.16_rc1' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
_qp on the GSI QP)
Merging sound-current/for-linus (df0380b9539b ALSA: usb-audio: Add quirk fo=
r Audient iD14)
...
erties)
Merging mips/mips-next (f69fa4c81b42 mips: fix HUGETLB function without THP=
 enabled)
...
UG_SIG macro)
Merging parisc-hd/for-next (81917c08bf4c parisc: Fix code/instruction patch=
...
Merging gfs2/for-next (78805cbe5d72 Merge tag 'gfs2-v5.15-rc5-fixes' of git=
...
Merging nfs/linux-next (edfa0b16bf9e NFS: Add offset to nfs_aop_readahead t=
racepoint)
...
Merging v9fs/9p-next (e7dac55b184e net/9p: autoload transport modules)
...
into for-next)
Merging pci/next (c1ecd53f9990 Merge branch 'remotes/lorenzo/pci/xgene')
...
to 'dma_' API)
Merging dlm/next (6c2e3bf68f3e fs: dlm: filter user dlm messages for kernel=
 locks)
...
Merging sound/for-next (df0380b9539b ALSA: usb-audio: Add quirk for Audient=
 iD14)
...
te support)
Merging block/for-next (26109ca2ed69 Merge branch 'for-5.16/drivers' into f=
or-next)
...
REEMPT_RT)
Merging ipmi/for-next (e120910c2408 ipmi: kcs_bmc_aspeed: add clock control=
 logic)
...
Merging akpm/master (a463483cae00 kasan: add kasan mode messages when kasan=
 init)
...

=a9ZT
-----END PGP SIGNATURE-----
