Return-Path: <linux-next+bounces-5001-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 07EB99F74EA
	for <lists+linux-next@lfdr.de>; Thu, 19 Dec 2024 07:37:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D9DE516DB52
	for <lists+linux-next@lfdr.de>; Thu, 19 Dec 2024 06:37:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1FB171FAC26;
	Thu, 19 Dec 2024 06:37:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="FqLg0DlD"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9AF9C7082A;
	Thu, 19 Dec 2024 06:37:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1734590234; cv=none; b=cMVgYjw+6Rqh+eTnNKEyjHBiKuB/rRJ9/PiLjZK+emvjdPMVPbORCp77y1qYdTMxhXBY4RPgxqbOnKADHY3at9VhghOGnsV+42uJRSIsdnHUsHfN3DtZoegX1vOqtLb0l0qLWym53jBzaXrWGNr48wDLdNkGMsN7ACCsACHLtKk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1734590234; c=relaxed/simple;
	bh=UXDIC0i3jkaICllDcR4KArtHv6npRg9G/B7/OylNZXU=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=JxFVycX5bSd4bXy5NAJkTlVZAB6BqiNQ6f00S+CckoAtMDWWuGigiv+3rBU5YEq90qFBD9f+uEnNfvTygJjit4sxeTsb/3Dz1IScsCqhHaBlPYe6EZZhiNxyZdjRegWVnJgKUmKFXcVtZWM5rRJY0Ki7fQOZCIroksISNh2qCaY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=FqLg0DlD; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1734590220;
	bh=T7Cwf+7EvmTE1xkr1I8sB1/bsx9yl9L81zl/4M1gGls=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YDLSD5dw7z4wbp;
	Thu, 19 Dec 2024 17:37:00 +1100 (AEDT)
Date: Thu, 19 Dec 2024 17:37:05 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 19
Message-ID: <20241219173705.0fd98beb@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/X2BgfG2=aubCASjAndcIBko";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/X2BgfG2=aubCASjAndcIBko
...
Changes since 20241218:

Linus' tree lost its build failure.

The edac tree gained a conflict against the tip tree.

Non-merge commits (relative to Linus' tree): 4198
 4677 files changed, 198616 insertions(+), 72055 deletions(-)
...
Merging origin/master (eabcdba3ad40 Merge tag 'for-6.13-rc3-tag' of git://g=
...
arse reads)
Merging cifs/for-next (61670dc38be4 smb: client: Deduplicate "select NETFS_=
SUPPORT" in Kconfig)
...
Merging vfs/for-next (5cc68af412a9 fs/overlayfs/namei.c: get rid of include=
 ../internal.h)
Merging mm-hotfixes/mm-hotfixes-unstable (9f36ae73a9c4 kcov: mark in_softir=
q_really() as __always_inline)
Merging fs-current (68a56c879e17 Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (954a2b40719a rtnetlink: Try the outer netns attribute in =
rtnl_get_peer_net().)
Merging bpf/master (23579010cf0a bpf: Fix bpf_get_smp_processor_id() on !CO=
NFIG_SMP)
...
-linus)
Merging sound-asoc-fixes/for-linus (c9e3ebdc52eb ASoC: rt722: add delay tim=
e to wait for the calibration procedure)
Merging regmap-fixes/for-linus (fac04efc5c79 Linux 6.13-rc2)
Merging regulator-fixes/for-linus (78d4f34e2115 Linux 6.13-rc3)
Merging spi-fixes/for-linus (7f9a1eed1ad8 spi: rockchip-sfc: Fix error in r=
emove progress)
Merging pci-current/for-linus (117a857baee7 PCI/bwctrl: Enable only if more=
...
Merging usb.current/usb-linus (b9252f80b807 usb: xhci: fix ring expansion r=
egression in 6.13-rc1)
...
Merging i2c-host-fixes/i2c/i2c-host-fixes (a64e53b0f27a i2c: imx: fix missi=
ng stop condition in single-master mode)
...
Merging tip-fixes/tip/urgent (f897fb5918b1 Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (2182e0f200d0 drm: rework FB_CO=
RE dependency)
...
Merging aspeed/for-next (2eff056a229e ARM: dts: aspeed: Blueridge and Fuji:=
 Fix LED node names)
Merging at91/at91-next (c462e3e08f29 Merge branch 'at91-defconfig' into at9=
1-next)
...
Merging qcom/for-next (c9eed0f32eb0 Merge branches 'arm64-defconfig-for-6.1=
...
Merging fs-next (bb66d6ce3c2e Merge branch 'for-next' of git://git.kernel.o=
...
xt)
Merging v4l-dvb/next (e90c9612ac39 media: rockchip: rga: Fix Copyright desc=
ription)
Merging v4l-dvb-next/master (b36c41c51e9d media: atomisp: set lock before c=
alling vb2_queue_init())
Merging pm/linux-next (221e26452a48 Merge branch 'fixes' into linux-next)
...
Merging rdma/for-next (1950af31dc66 RDMA/bnxt_re: Remove unnecessary header=
 file inclusion)
Merging net-next/main (4b252f2dab2e Merge branch 'selftests-net-packetdrill=
...
Merging drm/drm-next (301e2772295e Merge tag 'drm-intel-gt-next-2024-12-18'=
 of https://gitlab.freedesktop.org/drm/i915/kernel into drm-next)
  7ed047da59cf ("i915/guc: Accumulate active runtime on gt reset")
  abd318237fa6 ("i915/guc: Reset engine utilization buffer before registrat=
ion")
  cf907f6d2942 ("i915/guc: Ensure busyness counter increases motonically")
Merging drm-exynos/for-linux-next (a46b48810254 drm/exynos: Remove unnecess=
ary checking)
Merging drm-misc/for-linux-next (77b1ccb2a27c drm/rockchip: vop2: include r=
ockchip_drm_drv.h)
Merging amdgpu/drm-next (695c2c745e5d drm/amdgpu: Handle NULL bo->tbo.resou=
rce (again) in amdgpu_vm_bo_update)
...
Merging drm-xe/drm-xe-next (1460bb1fef9c drm/xe: Force write completion of =
MI_STORE_DATA_IMM)
...
anagement)
Merging sound-asoc/for-next (aaafb4d4471a Merge remote-tracking branch 'aso=
c/for-6.14' into asoc-next)
Merging modules/modules-next (f3fda0dfea98 module: Put known GPL offenders =
in an array)
Merging input/next (6d4a0f4ea723 Merge tag 'v6.13-rc3' into next)
Merging block/for-next (16796ecba786 Merge branch 'for-6.14/io_uring' into =
for-next)
...
TION() macros)
Merging mmc/next (6ee5233a4c91 mmc: mtk-sd: Limit getting top_base to SoCs =
that require it)
...
Merging battery/for-next (5972da73f75a power: supply: bq2415x_charger: repo=
rt charging state changes to userspace)
Merging regulator/for-next (4e86d350f24f Merge remote-tracking branch 'regu=
...
Merging spi/for-next (2326c1250caf Merge remote-tracking branch 'spi/for-6.=
14' into spi-next)
Merging tip/master (33193f21305e Merge branch into tip/master: 'x86/tdx')
...
Merging kvm-x86/next (dcab55cef6f2 Merge branches 'fixes', 'misc', 'mmu', '=
...
Merging leds-lj/for-leds-next (3d6976047922 MAINTAINERS: Add entry for AAEO=
N UP board FPGA drivers)
...
inux/prandom.h>)
Merging landlock/next (d294b3aee748 ima: instantiate the bprm_creds_for_exe=
c() hook)
...

=/D+X
-----END PGP SIGNATURE-----
