...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1D92E5681C7
	for <lists+linux-next@lfdr.de>; Wed,  6 Jul 2022 10:40:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230320AbiGFIhq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 6 Jul 2022 04:37:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50162 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229861AbiGFIhp (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 6 Jul 2022 04:37:45 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9460E24941;
        Wed,  6 Jul 2022 01:37:42 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LdCbQ5SFzz4xDB;
        Wed,  6 Jul 2022 18:37:38 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1657096658;
        bh=Mjp4ggEo90V+LM/iddIGSK03U5uLzvemMdsqGdKCemo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 6 Jul 2022 18:37:34 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 6
Message-ID: <20220706183734.276efade@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Y1pXfRO.T+ZwWbMX4aXtYEz";
...
--Sig_/Y1pXfRO.T+ZwWbMX4aXtYEz
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220705:
...
The vfio tree gained a conflict against the vfio-fixes tree.

Non-merge commits (relative to Linus' tree): 7381
 8168 files changed, 655977 insertions(+), 165132 deletions(-)
...
Merging origin/master (e35e5b6f695d Merge tag 'xsa-5.19-tag' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/xen/tip)
...
Merging net/master (26c12725b462 Merge tag 'for-net-2022-07-05' of git://gi=
...
Merging sound-asoc-fixes/for-linus (d874a64ff941 Merge remote-tracking bran=
...
Merging arm64/for-next/core (d8e68f68cd8f Merge branch 'for-next/boot' into=
 for-next/core)
...
nto for-next)
Merging samsung-krzk/for-next (97d180dedc98 Merge branch 'for-v5.20/dts-cle=
anup' into for-next)
...
e)
Merging cifs/for-next (a5f54054c6a8 cifs: remove redundant initialization t=
...
d_file immediately)
Merging ntfs3/master (cc83b0c7e306 fs/ntfs3: Remove duplicated assignment t=
o variable r)
...
or-next)
Merging pci/next (cc4c6f2810fc Merge branch 'pci/ctrl/vmd')
...
Merging pm/linux-next (3bc028d913bd Merge branch 'acpi-bus' into linux-next)
...
Merging opp/opp/linux-next (8e639af4cd22 OPP: Remove dev{m}_pm_opp_of_add_t=
able_noclk())
...
Merging net-next/master (f05643a0f60b eth: remove neterion/vxge)
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/rockchip/rk3568-b=
pi-r2-pro.dts
Merging bpf-next/for-next (cfb5a2dbf141 bpf, samples: Remove AF_XDP samples)
...
Merging drm-misc/for-linux-next (a204f9743b68 drm: Remove linux/i2c.h from =
drm_crtc.h)
...
Merging drm-msm/msm-next (1796c0255bae Merge tag 'drm-msm-fixes-2022-06-28'=
 into msm-next-staging)
...
tions)
Merging sound-asoc/for-next (4fbea41e3404 Merge remote-tracking branch 'aso=
c/for-5.20' into asoc-next)
$ git reset --hard HEAD^
Merging next-20220705 version of sound-asoc
...
Merging input/next (a6a87c36165e Input: i8042 - add TUXEDO devices to i8042=
 quirk tables)
Merging block/for-next (2f536e97e151 Merge branch 'for-5.20/io_uring' into =
for-next)
...
mpatible_node())
Merging mfd/for-mfd-next (ad7f984a6aa9 mfd: mt6397: Add basic support for M=
T6331+MT6332 PMIC)
...
libration)
Merging phy-next/next (2a56dc650e54 phy: amlogic: Add G12A Analog MIPI D-PH=
Y driver)
...
isting file)
Merging gpio-brgl/gpio/for-next (1fde565c5593 gpio: rockchip: add support f=
or rk3588)
...
Merging mm/mm-everything (a768c489255b Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...

=rpPw
-----END PGP SIGNATURE-----
