Return-Path: <linux-next+bounces-5276-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 58BD3A17886
	for <lists+linux-next@lfdr.de>; Tue, 21 Jan 2025 08:19:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 7B2D6165261
	for <lists+linux-next@lfdr.de>; Tue, 21 Jan 2025 07:19:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C37111A8F71;
	Tue, 21 Jan 2025 07:19:18 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="IkEbAo5T"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A2FB01AF0C0;
	Tue, 21 Jan 2025 07:19:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737443958; cv=none; b=NgdJjrO578Cco8eDa9XWAEWJMNgGj71vOk3lO+YJ8LsjQEYmCjmj8ZZfPSsO4NCrpPsaGEjzL/rJjH3pwTeP7drTGq5qid1fDR8y6YdlC0alpaqphqiqRaVy+Ku/8m4YQbcGiFbhvwm+4k0pgDODblphlHyWMrk+7WaycMhX5Uo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737443958; c=relaxed/simple;
	bh=fzDk/b12K7DmRjlAUOUFlBik+RGcw5qRE4VwVnAH7Bw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=j/0NMzBQq19asH3AC/vjUbl1XUYIeMdZf/TXZC2RAwRMGWdjWfFz1OXa2bmADdpSwCcoxIaNnQEVsWkphTa3mgCmsY+soowUdn8ah2jC2oVQk+wHZOfnC65acIWyRzviZ4v44U78ZvMOUtx5HjkStE92/u/3twnaQjhXJeu+7i4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=IkEbAo5T; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1737443942;
	bh=VT4x9Vx5DmhqtBTzjOAxEhuTH1eyLOQxYMS4mP9KS/U=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YcdqV1bvDz4x8h;
	Tue, 21 Jan 2025 18:19:02 +1100 (AEDT)
Date: Tue, 21 Jan 2025 18:19:09 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 21
Message-ID: <20250121181909.2a0a0109@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/xQtTeRgpye.E4UgZnuKvd3t";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/xQtTeRgpye.E4UgZnuKvd3t
...
Changes since 20250120:

The nand tree still had its build failure but I applied a supplied patch.

The sound tree lost its build failure.

The block tree gained a conflict against the bcachefs tree.

The crc tree lost its build failure when merged with the sound tree.

Non-merge commits (relative to Linus' tree): 8472
 8706 files changed, 397062 insertions(+), 136237 deletions(-)
...
Merging origin/master (3d3a9c8b89d4 Merge tag 'dlm-6.14' of git://git.kerne=
...
Merging bcachefs/for-next (1c7ed9ddcc76 bcachefs: fix trace_copygc)
...
tch())
Merging cifs/for-next (10e6fe53d90b cifs: Do not attempt to call CIFSGetSrv=
InodeNumber() without CAP_INFOLEVEL_PASSTHRU)
...
Merging fuse/for-next (308b74ac6dde fuse: enable fuse-over-io-uring)
...
Merging fs-current (33160480d742 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (25c1a9ca53db tcp_cubic: fix incorrect HyStart round start=
 detection)
...
Merging sound-current/for-linus (711aad3c43a9 ALSA: hda/realtek: Enable Mut=
e LED on HP Laptop 14s-fq1xxx)
Merging sound-asoc-fixes/for-linus (2367adc93167 Merge remote-tracking bran=
...
Merging tip-fixes/tip/urgent (b971424b6e3c Merge tag 'vfs-6.14-rc1.afs' of =
...
Merging fs-next (e8978e6aa9a7 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging net-next/main (b1754a69e7be net: phylink: fix regression when bindi=
ng a PHY)
...
Merging sound/for-next (711aad3c43a9 ALSA: hda/realtek: Enable Mute LED on =
...
Merging sound-asoc/for-next (2367adc93167 Merge remote-tracking branch 'aso=
...
Merging block/for-next (817d4332e8fb Merge branch 'for-6.14/io_uring-post' =
into for-next)
...
14' into spi-next)
Merging tip/master (6a64c6ed386c Merge branch into tip/master: 'x86/tdx')
...
ext)
Merging drivers-x86/for-next (ff44b1ca889f platform/mellanox: mlxreg-io: us=
e sysfs_emit() instead of sprintf())
...
Merging iommufd/for-next (3d49020a327c iommufd/fault: Use a separate spinlo=
ck to protect fault->deliver list)
...

=d6fM
-----END PGP SIGNATURE-----
