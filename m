...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 416DE6EF81B
	for <lists+linux-next@lfdr.de>; Wed, 26 Apr 2023 18:06:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241267AbjDZQGq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 26 Apr 2023 12:06:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60284 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240448AbjDZQGp (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 26 Apr 2023 12:06:45 -0400
Received: from mail-pl1-x629.google.com (mail-pl1-x629.google.com [IPv6:2607:f8b0:4864:20::629])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id F11007A8A
        for <linux-next@vger.kernel.org>; Wed, 26 Apr 2023 09:06:41 -0700 (PDT)
Received: by mail-pl1-x629.google.com with SMTP id d9443c01a7336-1a920d4842bso55421125ad.2
        for <linux-next@vger.kernel.org>; Wed, 26 Apr 2023 09:06:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1682525201; x=1685117201;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=FScibE92umUUxjnD8ki9dcv+VZjxGLrKNMxhELHDE24=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1682525201; x=1685117201;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=FScibE92umUUxjnD8ki9dcv+VZjxGLrKNMxhELHDE24=;
        b=
X-Gm-Message-State: AAQBX9d+XfFG0YJVdpLjszpNogAKUYA+ekAAJvH6cjgyNGImASQSQfG6
        dvJlM68k0J3eD6mnm9uRYt3c/RPStqIjedFFWQF3vA==
X-Google-Smtp-Source: AKy350ZyCcpbQKzw2va5Ys4bycrIfFIfgnmhfqDft0ebL5LH0BtNafNu5KY1SvHOADqYXKHWC3E+AQ==
X-Received: by 2002:a17:902:e943:b0:1a6:5fa2:3293 with SMTP id b3-20020a170902e94300b001a65fa23293mr22303014pll.56.1682525200208;
        Wed, 26 Apr 2023 09:06:40 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id iw2-20020a170903044200b0019a91895cdfsm10157543plb.50.2023.04.26.09.06.39
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 26 Apr 2023 09:06:39 -0700 (PDT)
Message-ID: <64494c0f.170a0220.bc4fa.4b29@mx.google.com>
Date:   Wed, 26 Apr 2023 09:06:39 -0700 (PDT)
...
Subject: next/pending-fixes build: 173 builds: 4 failed, 169 passed, 10 errors,
 37 warnings (v6.3-5614-gbe56a31d3d65)
...
next/pending-fixes build: 173 builds: 4 failed, 169 passed, 10 errors, 37 w=
arnings (v6.3-5614-gbe56a31d3d65)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v6.3-5614-gbe56a31d3d65/

Tree: next
Branch: pending-fixes
Git Describe: v6.3-5614-gbe56a31d3d65
Git Commit: be56a31d3d651e8eb263715e370a80fe59214889
...
vec_from_user.part.0() with UACCESS enabled
    7    vmlinux.o: warning: objtool: __import_iovec+0x1b2: call to copy_io=
vec_from_user.part.0() with UACCESS enabled
    6    vmlinux.o: warning: objtool: .altinstr_replacement+0x1af3: redunda=
nt UACCESS disable
    2    WARNING: modpost: EXPORT symbol "_mcount" [vmlinux] version genera=
tion failed, symbol will not be versioned.
    1    vmlinux.o: warning: objtool: .altinstr_replacement+0x1afd: redunda=
nt UACCESS disable
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1af3: redundant UA=
CCESS disable
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1afd: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x6d: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
    vmlinux.o: warning: objtool: __import_iovec+0x1b2: call to copy_iovec_f=
