...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 12A5C418ECA
	for <lists+linux-next@lfdr.de>; Mon, 27 Sep 2021 07:51:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232936AbhI0FxJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 27 Sep 2021 01:53:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51456 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232924AbhI0FxI (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 27 Sep 2021 01:53:08 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 411CDC061570;
        Sun, 26 Sep 2021 22:51:31 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HHsFr6dj3z4xbY;
        Mon, 27 Sep 2021 15:51:28 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1632721889;
        bh=XudxGkXZml9IzyM+MQ03Cp0YL/jsjFPIv5ua0QTPrPA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 27 Sep 2021 15:51:28 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 27
Message-ID: <20210927155128.3f4cdd54@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dOlcrq57_LuMFhSz=5ctSt/";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/dOlcrq57_LuMFhSz=5ctSt/
...
Merging net/master (b193e15ac69d net: prevent user from passing illegal sta=
b size)
Merging bpf/master (a3debf177f21 libbpf: Fix segfault in static linker for =
objects without BTF)
...
Merging tty.current/tty-linus (a3b397b4fffb Merge branch 'akpm' (patches fr=
om Andrew))
Merging usb.current/usb-linus (a3b397b4fffb Merge branch 'akpm' (patches fr=
om Andrew))
Merging usb-gadget-fixes/fixes (e49d033bddf5 Linux 5.12-rc6)
Merging usb-serial-fixes/usb-linus (9e3eed534f82 USB: serial: option: add d=
...
n frequency set)
Merging char-misc.current/char-misc-linus (a3b397b4fffb Merge branch 'akpm'=
 (patches from Andrew))
...
Merging kvm-fixes/master (50b078184604 Merge tag 'kvmarm-fixes-5.15-1' of g=
...
Merging qcom/for-next (e879cab78718 Merge branches 'arm64-for-5.16', 'drive=
...
r-next)
Merging scmi/for-linux-next (b5ec6a4da0b8 Merge branch 'for-next/scmi' of g=
...
nals())
Merging xtensa/xtensa-for-next (704ec99980cb xtensa: use CONFIG_USE_OF inst=
ead of CONFIG_OF)
...
Merging overlayfs/overlayfs-next (a295aef603e1 ovl: fix missing negative de=
ntry check in ovl_rename())
...
Merging bpf-next/for-next (e7d5184b24fb Merge branch 'bpf: Support <8-byte =
scalar spill and refill')
...
Merging bluetooth/master (47cb49448039 Bluetooth: Fix Advertisement Monitor=
 Suspend/Resume)
$ git reset --hard HEAD^
Merging next-20210924 version of bluetooth
Merging mac80211-next/master (37123c3baaee mac80211: use ieee802_11_parse_e=
lems() in ieee80211_prep_channel())
...
Merging drm-misc/for-linux-next (306589856399 drm/print: Add deprecation no=
tes to DRM_...() functions)
...
Merging drm-intel/for-linux-next (09bbdd8730dc drm/i915/fbc: Allow higher c=
ompression limits on FBC1)
...
Merging block/for-next (6fc11e93287c Merge branch 'for-5.16/io_uring' into =
for-next)
...
Merging battery/for-next (5d1f642aad69 docs: ABI: sysfs-class-power: Docume=
nted cycle_count property)
...
Merging rcu/rcu/next (de5f4668677e rcutorture: Suppress pi-lock-across read=
...
Merging rtc/rtc-next (be7d9c9161b9 rtc: Add support for the MSTAR MSC313 RT=
C)
$ git reset --hard HEAD^
...
Merging kspp/for-next/kspp (29b6166a9ead Merge branch 'kspp/hardening/optio=
ns' into for-next/kspp)
...

=itZg
-----END PGP SIGNATURE-----
