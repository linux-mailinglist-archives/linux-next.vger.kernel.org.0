...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 955FB7CF0D0
	for <lists+linux-next@lfdr.de>; Thu, 19 Oct 2023 09:13:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232825AbjJSHNC (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 19 Oct 2023 03:13:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33868 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232800AbjJSHM6 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 19 Oct 2023 03:12:58 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 07056123;
        Thu, 19 Oct 2023 00:12:51 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1697699570;
        bh=coWYmZQpEU/AFYr9x15bywNVKSwR643SC0B6chvpaRg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4S9zSf3nzWz4xcZ;
        Thu, 19 Oct 2023 18:12:50 +1100 (AEDT)
Date:   Thu, 19 Oct 2023 18:12:47 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 19
Message-ID: <20231019181247.3226efc2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/HpL2BqHcLuR6AajMYL/rEpe";
...
--Sig_/HpL2BqHcLuR6AajMYL/rEpe
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20231018:
...
The tip tree gained a conflict against the efi-fixes tree.
...
The bitmap tree gained a conflict against the net-next tree and a build
failure, so I used the version from next-20231018.

Non-merge commits (relative to Linus' tree): 12590
 10506 files changed, 698537 insertions(+), 239794 deletions(-)
...
Merging origin/master (dd72f9c7e512 Merge tag 'spi-fix-v6-6-rc4' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/broonie/spi)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (446d5e321008 mm/vmalloc: fix the =
unchecked dereference warning in vread_iter())
...
Merging net/main (2915240eddba neighbor: tracing: Move pin6 inside CONFIG_I=
PV6=3Dy section)
...
h_ifid())
Merging netfilter/main (2915240eddba neighbor: tracing: Move pin6 inside CO=
NFIG_IPV6=3Dy section)
...
Merging sound-current/for-linus (8e13caa2150b Merge tag 'asoc-fix-v6.6-rc6'=
...
Merging gpio-brgl-fixes/gpio/for-current (fc363413ef8e gpio: vf610: set val=
ue before the direction to avoid a glitch)
...
pending lowedirs)
Merging drm-misc-fixes/for-linux-next-fixes (fa8391ad68c1 gpu/drm: Eliminat=
e DRM_SCHED_PRIORITY_UNSET)
...
unneeded functions)
Merging mm/mm-everything (f9363c83ed1d Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
-next)
Merging ti/ti-next (36b6a2050470 Merge branch 'ti-drivers-soc-next' into ti=
-next)
...
Merging parisc-hd/for-next (5df83bdb46b9 drm/radeon: Add flushing code for =
parisc architecture)
...
riant)
Merging bcachefs/for-next (a1fea94f1270 bcachefs: KEY_TYPE_error now counts=
 towards i_sectors)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (bf41e4d8a2ae Merge branch 'vfs.super' into vfs=
.all)
...
$ git reset --hard HEAD^
Merging next-20231018 version of vfs-brauner
CONFLICT (content): Merge conflict in fs/ntfs3/inode.c
CONFLICT (content): Merge conflict in fs/ntfs3/namei.c
CONFLICT (content): Merge conflict in fs/xfs/xfs_buf.c
[master a73d71bdf56d] next-20231018/vfs-brauner
Applying: bcachefs: convert to new timestamp accessors
[master 0dc4f64e8e34] next-20231018/vfs-brauner
...
Merging net-next/main (c4eee56e14fe net: skb_find_text: Ignore patterns ext=
ending past 'to')
CONFLICT (content): Merge conflict in net/mac80211/key.c
Merging bpf-next/for-next (0e133a133703 bpf, docs: Define signed modulo as =
...
Merging netfilter-next/main (c4eee56e14fe net: skb_find_text: Ignore patter=
ns extending past 'to')
...
Merging wireless-next/for-next (ee2a35fedbc9 Merge tag 'mlx5-updates-2023-1=
0-10' of git://git.kernel.org/pub/scm/linux/kernel/git/saeed/linux)
...
set and get xqc)
Merging drm/drm-next (27442758e9b4 Merge tag 'amd-drm-next-6.7-2023-10-13' =
of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
  2af351d692dd ("Revert "drm/amdgpu: Report vbios version instead of PN"")
...
- add missing escape)
Merging drm-misc/for-linux-next (2d23e7d6bacb dt-bindings: display: Add SSD=
132x OLED controllers)
...
Merging fbdev/for-next (513421a2567c fbdev: omapfb: Replace custom memparse=
() implementation)
...
7' into spi-next)
Merging tip/master (823251ec1bf3 Merge branch into tip/master: 'x86/tdx')
CONFLICT (content): Merge conflict in arch/alpha/kernel/syscalls/syscall.tbl
...
Merging kvm-arm/next (2e7e5ebbd62c Merge branch kvm-arm64/writable-id-regs =
into kvmarm/next)
...
Merging char-misc/char-misc-next (f7572e93d5f6 parport: Drop unneeded NULL =
or 0 assignments)
...
Merging vhost/linux-next (1fcc6eaf5907 vdpa/mlx5: Update cvq iotlb mapping =
on ASID change)
...
mounts)
Merging bitmap/bitmap-for-next (e471961500f6 lib/bitmap: add compile-time t=
est for __assign_bit() optimization)
...
_PM_OPS())
Merging kspp/for-next/kspp (862c4ed787e7 string: Adjust strtomem_pad() logi=
c to allow for smaller sources)
...

=9IZI
-----END PGP SIGNATURE-----
