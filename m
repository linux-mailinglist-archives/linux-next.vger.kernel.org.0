Return-Path: <linux-next+bounces-233-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id C78CF805909
	for <lists+linux-next@lfdr.de>; Tue,  5 Dec 2023 16:44:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 05971B20F33
	for <lists+linux-next@lfdr.de>; Tue,  5 Dec 2023 15:44:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C016B5F1F0;
	Tue,  5 Dec 2023 15:44:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="ZjmLTD1R"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pl1-x633.google.com (mail-pl1-x633.google.com [IPv6:2607:f8b0:4864:20::633])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B851A83
	for <linux-next@vger.kernel.org>; Tue,  5 Dec 2023 07:43:54 -0800 (PST)
Received: by mail-pl1-x633.google.com with SMTP id d9443c01a7336-1d048c171d6so39483555ad.1
        for <linux-next@vger.kernel.org>; Tue, 05 Dec 2023 07:43:54 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1701791033; x=1702395833; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=sCoWwAh32yZwMnGQToCXriII8QnO4nrTXc9ZJaCNMWk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701791033; x=1702395833;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=sCoWwAh32yZwMnGQToCXriII8QnO4nrTXc9ZJaCNMWk=;
        b=
X-Gm-Message-State: AOJu0YzmwAQk4SFylLD4/E3nA5TMgcZnN38leNne1uJZeQ36YKs9dDEy
	V3/Nz94yG1J341/rJSIBzWkZ/j5tuP31raZCl63XEA==
X-Google-Smtp-Source: AGHT+IFnoGOjDIsUWJ+zEKiqbI9GiQkRJ2j1/AM0wxBo4VPk/wzsc0IfzIstxh230ZHQ4z1n8LlmmA==
X-Received: by 2002:a17:903:2285:b0:1d0:5531:ef8 with SMTP id b5-20020a170903228500b001d055310ef8mr6961852plh.22.1701791031955;
        Tue, 05 Dec 2023 07:43:51 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id h17-20020a170902f55100b001cfc50e5afesm7976266plf.23.2023.12.05.07.43.50
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 05 Dec 2023 07:43:50 -0800 (PST)
Message-ID: <656f4536.170a0220.6cedf.4e23@mx.google.com>
Date: Tue, 05 Dec 2023 07:43:50 -0800 (PST)
...
Subject: next/master build: 186 builds: 38 failed, 148 passed, 38 errors,
 373 warnings (next-20231205)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 186 builds: 38 failed, 148 passed, 38 errors, 373 warnin=
gs (next-20231205)
...
Tree: next
Branch: master
Git Describe: next-20231205
Git Commit: 0f5f12ac05f36f117e793656c3f560625e927f1b
...
e for =E2=80=98board_setup=E2=80=99 [-Wmissing-prototypes]
    1    .../arch/sparc/kernel/traps_64.c:253:6: warning: no previous proto=
...
ototypes]
    1    .../arch/sparc/kernel/traps_64.c:2035:6: warning: no previous prot=
...
for =E2=80=98__vdso_gettimeofday=E2=80=99 [-Wmissing-prototypes]
    arch/sparc/vdso/vclock_gettime.c:343:1: warning: no previous prototype =
for =E2=80=98__vdso_gettimeofday_stick=E2=80=99 [-Wmissing-prototypes]
    .../arch/sparc/kernel/traps_64.c:253:6: warning: no previous prototype =
for =E2=80=98is_no_fault_exception=E2=80=99 [-Wmissing-prototypes]
    .../arch/sparc/kernel/traps_64.c:2035:6: warning: no previous prototype=
 for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
