...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DB6EB4753AE
	for <lists+linux-next@lfdr.de>; Wed, 15 Dec 2021 08:30:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240556AbhLOHaW (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 15 Dec 2021 02:30:22 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38922 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240553AbhLOHaW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 15 Dec 2021 02:30:22 -0500
Received: from mail-pj1-x102e.google.com (mail-pj1-x102e.google.com [IPv6:2607:f8b0:4864:20::102e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4CB88C061574
        for <linux-next@vger.kernel.org>; Tue, 14 Dec 2021 23:30:22 -0800 (PST)
Received: by mail-pj1-x102e.google.com with SMTP id v23so16573534pjr.5
        for <linux-next@vger.kernel.org>; Tue, 14 Dec 2021 23:30:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=iWu1sFHh6FlWAdr9irkZds9ZCwvZPI5Dc0v70QFn7gk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=iWu1sFHh6FlWAdr9irkZds9ZCwvZPI5Dc0v70QFn7gk=;
        b=
X-Gm-Message-State: AOAM530lJnIIhay7xSn0KBeEJElElz44aETKgq1O/LRq0kYw9BXTxOYa
        tRnAFKK+BU/ppy2C5I/wpDsVvKLfnGEf7wOL
X-Google-Smtp-Source: ABdhPJy9C1FAg64YlM/9Ohzm8LNgGRonAD8tB84KvTIelTubcXCV1OddgFbJeUWMU4tLfEZ465RYHQ==
X-Received: by 2002:a17:90b:19ce:: with SMTP id nm14mr970024pjb.206.1639553420689;
        Tue, 14 Dec 2021 23:30:20 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id a3sm1375999pgj.2.2021.12.14.23.30.20
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 14 Dec 2021 23:30:20 -0800 (PST)
Message-ID: <61b9998c.1c69fb81.5edc0.3fb3@mx.google.com>
Date:   Tue, 14 Dec 2021 23:30:20 -0800 (PST)
...
Subject: next/master build: 212 builds: 15 failed, 197 passed, 29 errors,
 75 warnings (next-20211214)
...
next/master build: 212 builds: 15 failed, 197 passed, 29 errors, 75 warning=
s (next-20211214)
...
Git Commit: 0bafb8f3ebc84525d0ae0fcea22d12151b99312f
...
x86_64:
    ...
    allmodconfig (clang-13): 1 error, 2 warnings
...
read-only location =E2=80=98*(dev->dev_addr + (sizetype)i)=E2=80=99
    2    mm/migrate.c:347:14: error: variable 'ptl' is uninitialized when u=
...
e 'enum nl80211_reg_initiator' [-Wenum-conversion]
    4    mm/migrate.c:340:17: note: initialize the variable 'ptl' to silenc=
e this warning
...
s unknown, fallback to ''
    2    mm/migrate.c:347:14: warning: variable 'ptl' is uninitialized when=
...
map' defined but not used [-Wunused-const-variable=3D]
    1    WARNING: modpost: EXPORT symbol "xor_block_inner_neon" [arch/arm64=
/lib/xor-neon.ko] version ...
    1    WARNING: modpost: "xor_block_inner_neon" [crypto/xor.ko] has no CR=
C!
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-13) =E2=80=94 FAIL, 1 error, 2 warnings, 0 sect=
ion mismatches

Errors:
    mm/migrate.c:347:14: error: variable 'ptl' is uninitialized when used h=
...
h to next function startup_64_setup_env()
    mm/migrate.c:340:17: note: initialize the variable 'ptl' to silence thi=
s warning
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, gcc-10) =E2=80=94 PASS, 0 errors, 2 warnings, 0 sectio=
n mismatches

Warnings:
    WARNING: modpost: EXPORT symbol "xor_block_inner_neon" [arch/arm64/lib/=
xor-neon.ko] version ...
    WARNING: modpost: "xor_block_inner_neon" [crypto/xor.ko] has no CRC!
...
Warnings:
    mm/migrate.c:347:14: warning: variable 'ptl' is uninitialized when used=
 here [-Wuninitialized]
    mm/migrate.c:340:17: note: initialize the variable 'ptl' to silence thi=
s warning
    1 warning generated.
