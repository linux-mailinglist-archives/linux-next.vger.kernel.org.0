...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 851DD79A123
	for <lists+linux-next@lfdr.de>; Mon, 11 Sep 2023 04:11:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229845AbjIKCLq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 10 Sep 2023 22:11:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43744 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229522AbjIKCLq (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 10 Sep 2023 22:11:46 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4AE9A18F;
        Sun, 10 Sep 2023 19:11:38 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1694398293;
        bh=f4LKoSDDRwSiCXbRVLLUj9JTOL/+qPuhj0XkgA79RW8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RkVZY2w8rz4xQ4;
        Mon, 11 Sep 2023 12:11:33 +1000 (AEST)
Date:   Mon, 11 Sep 2023 12:11:31 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 11
Message-ID: <20230911121131.006d3fec@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/mNyuU4E+=OFUSEl3xTsdgne";
...
Merging bpf/master (7182e56411b9 selftests/bpf: Add kprobe_multi override t=
est)
...
Merging sound-current/for-linus (ecc8b4d0b6e1 Merge tag 'asoc-fix-v6.6-merg=
...
n in DMA mode)
Merging pci-current/for-linus (5260bd6d36c8 Revert "PCI: Mark NVIDIA T4 GPU=
s to avoid bus reset")
Merging driver-core.current/driver-core-linus (6b8bb5b8d9b3 Merge tag 'sh-f=
or-v6.6-tag1' of git://git.kernel.org/pub/scm/linux/kernel/git/glaubitz/sh-=
linux)
Merging tty.current/tty-linus (535a265d7f0d Merge tag 'perf-tools-for-v6.6-=
1-2023-09-05' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-to=
ols)
Merging usb.current/usb-linus (535a265d7f0d Merge tag 'perf-tools-for-v6.6-=
1-2023-09-05' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-to=
ols)
Merging usb-serial-fixes/usb-linus (706a74159504 Linux 6.5-rc7)
Merging phy/fixes (52a93d39b17d Linux 6.5-rc5)
Merging staging.current/staging-linus (6b8bb5b8d9b3 Merge tag 'sh-for-v6.6-=
tag1' of git://git.kernel.org/pub/scm/linux/kernel/git/glaubitz/sh-linux)
Merging iio-fixes/fixes-togreg (aefee19a6d9e iio: adc: imx8qxp: Fix address=
 for command buffer registers)
Merging counter-current/counter-current (df8fdd01c98b counter: microchip-tc=
b-capture: Fix the use of internal GCLK logic)
Merging char-misc.current/char-misc-linus (535a265d7f0d Merge tag 'perf-too=
ls-for-v6.6-1-2023-09-05' of git://git.kernel.org/pub/scm/linux/kernel/git/=
perf/perf-tools)
...
Merging btrfs-fixes/next-fixes (bfecc348c9ed Merge branch 'misc-6.6' into n=
ext-fixes)
...
Merging spdx/spdx-linus (6b8bb5b8d9b3 Merge tag 'sh-for-v6.6-tag1' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/glaubitz/sh-linux)
Merging gpio-brgl-fixes/gpio/for-current (180b10bd160b gpio: zynq: restore =
...
Merging mm-stable/mm-stable (6bc660278f11 Merge branch 'master' into mm-sta=
ble)
Merging mm-nonmm-stable/mm-nonmm-stable (1548b060d6f3 Merge tag 'topic/drm-=
ci-2023-08-31-1' of git://anongit.freedesktop.org/drm/drm)
...
ite-only variable)
Merging risc-v/for-next (c6a906cce61a soc: renesas: Kconfig: For ARCH_R9A07=
G043 select the required configs if dependencies are met)
...
Merging cifs/for-next (fd3a5940e66d Merge tag '6.6-rc-smb3-client-fixes-par=
...
e allocation.)
Merging ksmbd/ksmbd-for-next (a3c57ab79a06 iov_iter: Kunit tests for page e=
xtraction)
...
Merging crypto/master (85b9bf9a514d Revert "dt-bindings: crypto: qcom,prng:=
 Add SM8450")
Merging drm/drm-next (43ffcd6fa163 Merge tag 'amd-drm-fixes-6.6-2023-09-06'=
 of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
Merging drm-ci/topic/drm-ci (ad6bfe1b66a5 drm: ci: docs: fix build warning =
- add missing escape)
Merging drm-misc/for-linux-next (d20b484c674d drm/drm_exec: Work around a W=
W mutex lockdep oddity)
Merging amdgpu/drm-next (88ca2f8a962e drm/amd/display: clean up one inconsi=
stent indenting)
  63461ea3fb40 ("Revert "drm/amd/display: Remove v_startup workaround for d=
cn3+"")
...
Merging sound/for-next (ecc8b4d0b6e1 Merge tag 'asoc-fix-v6.6-merge-window'=
...
et-reg-list test)
Merging kvm-x86/next (ff6e6ded5472 Merge tag 'rtc-6.6' of git://git.kernel.=
...
Merging driver-core/driver-core-next (6b8bb5b8d9b3 Merge tag 'sh-for-v6.6-t=
ag1' of git://git.kernel.org/pub/scm/linux/kernel/git/glaubitz/sh-linux)
Merging usb/usb-next (535a265d7f0d Merge tag 'perf-tools-for-v6.6-1-2023-09=
-05' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-tools)
...
Merging tty/tty-next (535a265d7f0d Merge tag 'perf-tools-for-v6.6-1-2023-09=
-05' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-tools)
Merging char-misc/char-misc-next (535a265d7f0d Merge tag 'perf-tools-for-v6=
.6-1-2023-09-05' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf=
-tools)
...
Merging staging/staging-next (6b8bb5b8d9b3 Merge tag 'sh-for-v6.6-tag1' of =
...
o for-next)
Merging rtc/rtc-next (ce413486c9a0 dt-bindings: rtc: ds3231: Remove text bi=
nding)
...

=O1aW
-----END PGP SIGNATURE-----
