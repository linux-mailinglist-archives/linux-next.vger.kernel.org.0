Return-Path: <linux-next+bounces-5576-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id B3374A454E7
	for <lists+linux-next@lfdr.de>; Wed, 26 Feb 2025 06:31:59 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id DC6A4189B489
	for <lists+linux-next@lfdr.de>; Wed, 26 Feb 2025 05:32:05 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D6E8325E45B;
	Wed, 26 Feb 2025 05:31:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="dP6STGxO"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D75AA4430;
	Wed, 26 Feb 2025 05:31:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1740547909; cv=none; b=pZEQv+0aI5k9sPASeA8HCKxZF5beuzeOmO0lQ/x437hfCFqgb8bysf69Jril2rdWS/oE/KU6u1kG2VgGs1gvA/akJksjRK6vvljng7++p0h1E9S8rw2IWTwAD/hJ6AI0WHPy85IU7TJOp7hfJIjvzNK+oNET9x31xd9NEduswOo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1740547909; c=relaxed/simple;
	bh=Zdx7JAIca4aJaQtq2UdoJsvDfNiYUD2KqGy1FBzT79w=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=KzJIh/lsc7CYBl/SInTLX31nISiejUoIsGAaSbcHQxMEMy2zTXfEl0WXAUezXdoH+QDmxjsSHnGGBxEsnCYQT8lbpoyj1eYZOI5Q3mACiXATzA18+ONeird7jJ+49AGIit1k6hDLtpb6RAm5M3nt1KE34DGKgTJz01nbmLxW65U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=dP6STGxO; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1740547901;
	bh=MZynuK2/vT6LZZDdkilq8uDRg7Rx728m+KwTDCgryYs=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Z2jl14Sjsz4wcr;
	Wed, 26 Feb 2025 16:31:41 +1100 (AEDT)
Date: Wed, 26 Feb 2025 16:31:40 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 26
Message-ID: <20250226163140.2d3342c8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/zs/Idl0ZcayPU+N5v8x9pU2";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/zs/Idl0ZcayPU+N5v8x9pU2
...
Non-merge commits (relative to Linus' tree): 5854
 6515 files changed, 328931 insertions(+), 125175 deletions(-)
...
Merging origin/master (cc8a0934d099 Merge tag 'for-6.14-rc4-tag' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/kdave/linux)
Merging fixes/fixes (fac04efc5c79 Linux 6.13-rc2)
Merging ext4-fixes/fixes (4bbf9020becb Linux 6.13-rc4)
Merging vfs-brauner-fixes/vfs.fixes (425e3e3bd62c nsfs: remove d_op->d_dele=
te)
...
Merging ext3/for_next (98f18c76c2c3 ext2: create ext2_msg_fc for use during=
 parsing)
...
YSFSPATH)
Merging vfs-brauner/vfs.all (de048109361a Merge branch 'vfs-6.15.mount.name=
space' into vfs.all)
Merging vfs/for-next (2e72b1e0aac2 Merge branch 'work.d_revalidate' into fo=
r-next)
Merging mm-hotfixes/mm-hotfixes-unstable (c94fec86ecd0 mm: page_isolation: =
avoid calling folio_hstate() without hugetlb_lock)
Merging fs-current (df5c462dfa25 Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (bc50682128bd MAINTAINERS: socket timestamping: add Jason =
Xing as reviewer)
...
Merging sound-current/for-linus (9e7c6779e353 ALSA: hda/realtek: Fix wrong =
mic setup for ASUS VivoBook 15)
...
Merging tip-fixes/tip/urgent (34458e90620c Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (8ec43c58d3be drm/vkms: Round f=
ixp2int conversion in lerp_u16)
...
Merging mm/mm-everything (9048c156e790 foo)
...
t)
Merging mediatek/for-next (7c597239973b Merge branch 'v6.14-next/dts64' int=
o for-next)
...
Merging fs-next (04618462f1ff Merge branch 'for-next' of git://git.kernel.o=
...
Merging pm/linux-next (42bb5ab05934 Merge branch 'pm-sleep' into linux-next)
...
Merging net-next/main (287044abff82 sctp: Remove unused payload from sctp_i=
datahdr)
...
m ahash_alg)
Merging drm/drm-next (fb51bf025519 Merge tag 'v6.14-rc4' into drm-next)
Merging drm-exynos/for-linux-next (81a50378559b drm/exynos: Remove unnecess=
ary checking)
Merging drm-misc/for-linux-next (72d0af4accd9 drm/msm/dp: Add support for L=
TTPR handling)
Merging amdgpu/drm-next (dab993bf1513 drm/amdgpu: increase AMDGPU_MAX_RINGS)
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.c
Merging drm-intel/for-linux-next (0159e311772a drm/i915/dp_mst: Fix encoder=
 HW state readout for UHBR MST)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_dp=
.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_dp=
_mst.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/i915_reg.h
Merging drm-msm/msm-next (72d0af4accd9 drm/msm/dp: Add support for LTTPR ha=
ndling)
Merging drm-msm-lumag/msm-next-lumag (9262a1796935 drm/msm/dpu: rate limit =
snapshot capture for mmu faults)
Merging drm-xe/drm-xe-next (35359c36356a drm/xe: Stop ignoring errors from =
xe_ttm_sys_mgr_init())
...
Merging sound-asoc/for-next (0bd70b51f7a0 Merge remote-tracking branch 'aso=
...
Merging block/for-next (c77a2bf5fca6 Merge branch 'for-6.15/block' into for=
-next)
...
15' into spi-next)
Merging tip/master (0f966b199269 Merge branch into tip/master: 'x86/platfor=
m')
...
next)
Merging sched-ext/for-next (641e9dc2e05f Merge branch 'for-6.15' into for-n=
ext)
...
Merging coresight/next (b2d67616fcf9 coresight: etm4x: don't include '<linu=
x/pm_wakeup.h>' directly)
...
Merging cxl/next (0f5f03069721 Merge branch 'for-6.15/features' into cxl-fo=
r-next)
...

=WJLB
-----END PGP SIGNATURE-----
