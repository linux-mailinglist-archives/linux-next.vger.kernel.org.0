...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E552A14D59B
	for <lists+linux-next@lfdr.de>; Thu, 30 Jan 2020 05:29:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726833AbgA3E3C (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 29 Jan 2020 23:29:02 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:59711 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726771AbgA3E3C (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 29 Jan 2020 23:29:02 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 487S6F2N2Kz9sP6;
        Thu, 30 Jan 2020 15:28:53 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1580358533;
        bh=QcniLzjQlMz8ytKcTaNiagamf2sa/bHtXL//8L9cO7M=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 30 Jan 2020 15:28:52 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 30
Message-ID: <20200130152852.6056b5d8@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/fba6iliKfcYIq_RzOsVgVV6";
...
Non-merge commits (relative to Linus' tree): 5999
 5320 files changed, 229752 insertions(+), 102831 deletions(-)
...
Merging origin/master (3893c2025fec Merge tag 'erofs-for-5.6-rc1' of git://=
...
Merging net/master (ccd1f27368e4 Revert "MAINTAINERS: mptcp@ mailing list i=
s moderated")
Merging bpf/master (a2e6dd0911a9 bpf, verifier: do_refine_retval_range may =
clamp umin to 0 incorrectly)
Merging ipsec/master (793da4bfba7b sch_choke: Use kvcalloc)
Merging netfilter/master (44efc78d0e46 net: mvneta: fix XDP support if sw b=
m is used as fallback)
...
Merging sound-current/for-linus (66f2d19f8116 ALSA: pcm: Fix memory leak at=
 closing a stream without hw_free)
Merging sound-asoc-fixes/for-linus (e01614d612fd Merge branch 'asoc-5.6' in=
to asoc-linus)
...
Merging char-misc.current/char-misc-linus (15d663249653 Merge branch 'urgen=
t-for-mingo' of git://git.kernel.org/pub/scm/linux/kernel/git/paulmck/linux=
-rcu)
...
Merging pidfd-fixes/fixes (e9c8348441a7 fork: Use RCU_INIT_POINTER() instea=
d of rcu_access_pointer())
...
itch fall-throughs)
Merging kbuild/for-next (bae189577cbe Merge branch 'kconfig' into for-next)
...
Merging clk/clk-next (2d4afb068b88 Merge branch 'clk-qcom' into clk-next)
...
riable 'mm_gc')
Merging risc-v/for-next (61ffb9d27860 riscv: dts: Add DT support for SiFive=
 FU540 GPIO driver)
...
et')
Merging btrfs/for-next (8d47cf575d8d Merge branch 'for-next-next-v5.6-20200=
129' into for-next-20200129)
Merging ceph/master (3325322f773b rbd: set the 'device' link in sysfs)
Merging cifs/for-next (68353984d63d Merge tag '5.6-smb3-fixes-and-dfs-and-r=
eaddir-improvements' of git://git.samba.org/sfrench/cifs-2.6)
...
reporting)
Merging zonefs/for-next (3512c402e9a4 zonefs: Add documentation)
...
-next)
Merging i2c/i2c/for-next (682e38950e41 Merge branch 'i2c/for-5.6' into i2c/=
for-next)
...
Merging net-next/master (b3a608222336 Merge branch 'for-v5.6' of git://git.=
kernel.org:/pub/scm/linux/kernel/git/jmorris/linux-security)
...
Merging amdgpu/drm-next (9a5bf3221bd7 drm/amdgpu/smu10: fix smu10_get_clock=
_by_type_with_voltage)
Merging drm-intel/for-linux-next (f2221a504940 drm/i915: Update DRIVER_DATE=
 to 20200114)
...
-next)
Merging sound/for-next (66f2d19f8116 ALSA: pcm: Fix memory leak at closing =
a stream without hw_free)
Merging sound-asoc/for-next (e01614d612fd Merge branch 'asoc-5.6' into asoc=
-linus)
...
Merging block/for-next (b85f8b070de4 io_uring: epoll_ctl fixup)
...
p for C-SKY)
Merging ftrace/for-next (34f71a4a2de8 tracing: Add new testcases for hist t=
rigger parsing errors)
Merging rcu/rcu/next (59d8cc6b2e37 rcu: Forgive slow expedited grace period=
s at boot time)
Merging kvm/linux-next (3009afc6e39e KVM: x86: Use a typedef for fastop fun=
ctions)
...
Merging slave-dma/next (08607e8319c7 dmaengine: doc: Properly indent metada=
ta title)
...
CONFLICT (content): Merge conflict in arch/arm/tools/syscall.tbl
CONFLICT (content): Merge conflict in arch/alpha/kernel/syscalls/syscall.tbl
Merging devfreq/devfreq-next (c8597f3b61cc PM / devfreq: Use constant name =
of userspace governor)
...
eaks allmodconfig)
Merging akpm-current/current (fcbaa4d1a058 ipc/msg.c: Adjust indentation in=
 ksys_msgctl)
...
rflow
Merging akpm/master (70dde937e748 drivers/media/platform/sti/delta/delta-ip=
...

=14vJ
-----END PGP SIGNATURE-----
