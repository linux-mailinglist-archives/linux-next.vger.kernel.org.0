...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9D3812A775D
	for <lists+linux-next@lfdr.de>; Thu,  5 Nov 2020 07:06:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729441AbgKEGGN (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 5 Nov 2020 01:06:13 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:54369 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731017AbgKEGGK (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 5 Nov 2020 01:06:10 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CRY1930TTz9sTD;
        Thu,  5 Nov 2020 17:06:05 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1604556365;
        bh=tp0pvijZNoPW3aAU0UWh5bsCWNDpvzOPrbnhqUVBXZk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 5 Nov 2020 17:06:04 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 5
Message-ID: <20201105170604.6588a06e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/GIL6qbapic039LignREDTkH";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/GIL6qbapic039LignREDTkH
...
Merging origin/master (4ef8451b3326 Merge tag 'perf-tools-for-v5.10-2020-11=
-03' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
Merging arm64-fixes/for-next/fixes (7ee31a3aa8f4 arm64: kprobes: Use BRK in=
stead of single-step when executing instructions out-of-line)
...
Merging net/master (ac6f929d74ba Merge tag 'linux-can-fixes-for-5.10-202011=
03' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can)
...
ead spin time)
Merging mac80211/master (fea07a487c6d net: openvswitch: silence suspicious =
RCU usage warning)
...
Merging sound-asoc-fixes/for-linus (961ed2ad57fd Merge remote-tracking bran=
...
Merging scsi-fixes/fixes (5feed64f9199 scsi: mpt3sas: Fix timeouts observed=
 while reenabling IRQ)
...
nto for-next)
Merging samsung-krzk/for-next (59f129f534ca Merge branch 'next/drivers' int=
o for-next)
...
Merging csky/linux-next (afe14a3eb45d csky: Fixup show_regs doesn't contain=
 regs->usp)
...
Merging btrfs/for-next (e3f243e7ac2e Merge branch 'for-next-next-v5.10-2020=
1104' into for-next-20201104)
...
Merging xfs/for-next (c1f6b1ac0075 xfs: fix scrub flagging rtinherit even i=
f there is no rt device)
...
Merging hid/for-next (d0a19d03cbb8 Merge branch 'for-5.11/amd-sfh-hid' into=
 for-next)
...
able)
Merging net-next/master (3fb6928b56f6 net: ipa: restrict special reset to I=
PA v3.5.1)
...
Merging netfilter-next/master (117ca1f8920c netfilter: nft_reject_inet: all=
ow to use reject from inet ingress)
...
Merging mac80211-next/master (3fb6928b56f6 net: ipa: restrict special reset=
 to IPA v3.5.1)
...
Merging amdgpu/drm-next (57673be0a9f5 drm/amdgpu: Enable GPU reset for vang=
ogh)
...
nfo"
Merging drm-intel/for-linux-next (ba8a5cb234ba drm/i915/tgl: Fix typo durin=
g output setup)
Merging drm-tegra/drm/tegra/for-next (d9f980ebcd01 drm/tegra: output: rgb: =
Wrap directly-connected panel into DRM bridge)
Merging drm-misc/for-linux-next (24e146cdf9f5 drm: unify formatting for col=
or management documentation)
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.c
Applying: swiotlb: using SIZE_MAX needs limits.h included
Merging drm-msm/msm-next (cf11c1f89d52 drm/msm: Drop struct_mutex in shrink=
er path)
...
Merging sound-asoc/for-next (939b46f5a6bc Merge remote-tracking branch 'aso=
...
ouch input driver)
Merging block/for-next (bc2e353de6e8 Merge branch 'for-5.11/io_uring' into =
for-next)
...
or ring_buffer_wait)
Merging rcu/rcu/next (d77ef2684cbf rcu/tree: Make rcu_do_batch count how ma=
ny callbacks were executed)
...
DDMA mode.)
Merging usb-serial/usb-next (179dfb954790 USB: serial: remove write wait qu=
eue)
...
Merging akpm-current/current (abae383d7829 lib/lzo/lzo1x_compress.c: make l=
zogeneric1x_1_compress() static)
CONFLICT (content): Merge conflict in include/linux/sched.h
Applying: Revert "mm: fix phys_to_target_node() and memory_add_physaddr_to_=
nid() exports"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (a8489dae981f mm/gup: assert that the mmap lock is held=
 in __get_user_pages())
...

=3Vku
-----END PGP SIGNATURE-----
