...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 015834C8925
	for <lists+linux-next@lfdr.de>; Tue,  1 Mar 2022 11:21:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233501AbiCAKVl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 1 Mar 2022 05:21:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58416 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234126AbiCAKVk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 1 Mar 2022 05:21:40 -0500
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 67FFA4A91C;
        Tue,  1 Mar 2022 02:20:56 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4K7Cv66McRz4xZ5;
        Tue,  1 Mar 2022 21:20:50 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1646130051;
        bh=r0WXvSCLRrJhwiPrn4ukR7YGtq2OA4D1UuV+RvceL7w=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 1 Mar 2022 21:20:49 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 1
Message-ID: <20220301212049.51a35be2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/W8F4cBQVB..x/5vSQqnsoB6";
...
--Sig_/W8F4cBQVB..x/5vSQqnsoB6
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220228:
...
Merging origin/master (719fce7539cd Merge tag 'soc-fixes-5.17-2' of git://g=
...
Merging net/master (caef14b7530c net: ipa: fix a build dependency)
...
Merging staging.current/staging-linus (7e57714cd0ad Linux 5.17-rc6)
...
Merging input-current/for-linus (ba115adf61b3 Input: samsung-keypad - prope=
rly state IOMEM dependency)
...
Merging efi-fixes/urgent (258dd902022c efivars: Respect "block" flag in efi=
var_entry_set_safe())
Merging zstd-fixes/zstd-linus (88a309465b3f lib: zstd: clean up double word=
 in comment.)
Merging drm-misc-fixes/for-linux-next-fixes (cb1852783f79 drm/arm: arm hdlc=
d select DRM_GEM_CMA_HELPER)
...
ice())
Merging arm-soc/for-next (0aee14f3a1ff Merge branch 'arm/soc' into for-next)
...
o for-next)
Merging mvebu/for-next (6bc49a535840 Merge branch 'mvebu/arm' into mvebu/fo=
r-next)
...
Merging clk-imx/for-next (038a6208e339 clk: imx: off by one in imx_lpcg_par=
se_clks_from_dt())
...
Merging powerpc/next (8b91cee5eadd powerpc/64s/hash: Make hash faults work =
in NMI context)
...
Merging btrfs/for-next (16f986f72dfa Merge branch 'for-next-next-v5.17-2022=
0228' into for-next-20220228)
...
o header file)
Merging net-next/master (0b9e69e1a1e4 net: dm9051: Make remove() callback a=
 void function)
CONFLICT (content): Merge conflict in drivers/hwmon/adt7310.c
Merging bpf-next/for-next (b664e255ba3c bpf: Add some description about BPF=
_JIT_ALWAYS_ON in Kconfig)
...
Merging drm/drm-next (6c64ae228f08 Backmerge tag 'v5.17-rc6' into drm-next)
...
[master 67c5516a34f2] next-20220224/drm
...
tifier support (v2))
Merging drm-intel/for-linux-next (47f16fe53545 drm/i915: Move intel_display=
_power_well_is_enabled() to intel_display_power_well.c)
CONFLICT (content): Merge conflict in drivers/gpu/drm/dp/drm_dp.c
...
S_DB1XXX boards)
Merging mmc/next (8427577535ba Merge branch 'fixes' into next)
...
rules)
Merging devicetree/for-next (4eb7b1339c23 dt-bindings: timer: sifive,clint:=
...
ac-for-next)
Merging irqchip/irq/irqchip-next (af16d860a23b Merge branch irq/qcom-pdc-cl=
eanup into irq/irqchip-next)
...
Merging tty/tty-next (d4ab5487cc77 Merge 5.17-rc6 into tty-next)
...
Merging iio/togreg (66724c31c0a0 dt-bindings: iio: afe: add bindings for te=
mperature transducers)
...
r-next)
Merging random/master (c2a7de4feb6e random: do crng pre-init loading in wor=
ker rather than irq)
...
Merging execve/for-next/execve (decde1e679c6 binfmt_elf: Introduce KUnit te=
st)
...
Merging akpm/master (67563e836660 kselftest/vm: fix tests build with old li=
bc)
...

=MW0Z
-----END PGP SIGNATURE-----
