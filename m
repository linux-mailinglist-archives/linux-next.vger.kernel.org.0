...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0B8EF192352
	for <lists+linux-next@lfdr.de>; Wed, 25 Mar 2020 09:54:01 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727317AbgCYIyA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 25 Mar 2020 04:54:00 -0400
Received: from ozlabs.org ([203.11.71.1]:36639 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727299AbgCYIx7 (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 25 Mar 2020 04:53:59 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48nMNd3klyz9sRR;
        Wed, 25 Mar 2020 19:53:53 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1585126433;
        bh=N1i0UmdvbDdLP5rlQQpYUHnPwBQqpwgVB+uUE26QPMM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 25 Mar 2020 19:53:50 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 25
Message-ID: <20200325195350.7300fee9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/hw229IH=fH6fYDr5jlBxiCg";
...
The input tree gained a build failure for which I disabled a driver.

The tip tree gained a conflict against the thermal tree.
...
Non-merge commits (relative to Linus' tree): 10500
 8849 files changed, 405187 insertions(+), 200057 deletions(-)
...
Merging origin/master (76ccd234269b Merge branch 'perf-urgent-for-linus' of=
...
Merging net/master (81573b18f26d selftests/net/forwarding: add Makefile to =
install tests)
...
licy check fails)
Merging netfilter/master (a64d558d8cf9 selftests: netfilter: add nfqueue te=
st case)
...
Merging sound-asoc-fixes/for-linus (f013b4e2673d Merge branch 'asoc-5.6' in=
to asoc-linus)
...
Merging kbuild/for-next (b1112139a103 Makefile: disallow data races on gcc-=
10 as well)
...
t)
Merging arm64/for-next/core (8e31c20cb971 Merge branch 'for-next/kernel-ptr=
auth' into for-next/core)
...
quest_irq())
Merging mips/mips-next (63b4f312de70 docs: mips: remove no longer needed au=
1xxx_ide.rst documentation)
...
le' into for-next)
Merging pci/next (8121b38f0955 Merge branch 'remotes/lorenzo/pci/vmd')
...
Merging net-next/master (cd556e40fdf3 devlink: expand the devlink-info docu=
mentation)
...
Merging bluetooth/master (b48596d1dc25 Bluetooth: L2CAP: Add get_peer_pid c=
allback)
...
Merging mtd/mtd/next (4e4a9a828af2 mtd: Fix issue where write_cached_data()=
 fails but write() still returns success)
Merging nand/nand/next (798fcdd01000 mtd: spinand: toshiba: Support for new=
 Kioxia Serial NAND)
...
Merging amdgpu/drm-next (5ef45bbd11da drm/amdgpu/display: fix logic inversi=
...
Merging sound/for-next (c208a5335036 ALSA: core: Add snd_device_get_state()=
 helper)
Merging sound-asoc/for-next (992f8eac1b66 Merge branch 'asoc-5.7' into asoc=
-next)
...
06 to json-schema)
Merging block/for-next (2089a6aa8d09 Merge branch 'for-5.7/block' into for-=
next)
...
Merging mmc/next (fa0910107a9f mmc: sdhci: use FIELD_GET for preset value b=
it masks)
...
o rules present)
Merging devicetree/for-next (952c2ab61db2 dt-bindings: clk: fix example for=
 single-output provider)
...
Merging tip/auto-latest (55dd3d30e300 Merge branch 'perf/urgent')
...
ge tracepoint)
Merging rcu/rcu/next (73b26e71d01c rcutorture: Add TRACE02 scenario enablin=
g RCU Tasks Trace IPIs)
CONFLICT (content): Merge conflict in lib/Kconfig.kcsan
CONFLICT (content): Merge conflict in kernel/kcsan/report.c
CONFLICT (content): Merge conflict in kernel/kcsan/kcsan.h
CONFLICT (content): Merge conflict in kernel/kcsan/debugfs.c
CONFLICT (content): Merge conflict in kernel/kcsan/core.c
CONFLICT (content): Merge conflict in kernel/kcsan/atomic.h
CONFLICT (content): Merge conflict in include/linux/kcsan-checks.h
...
Merging kvm-ppc/kvm-ppc-next (377f02d487b5 KVM: PPC: Book3S HV: H_SVM_INIT_=
START must call UV_RETURN)
...
Merging char-misc/char-misc-next (bbde5709ee4f nvmem: mxs-ocotp: Use devm_a=
dd_action_or_reset() for cleanup)
...
Merging staging/staging-next (eb538ff02a56 staging: comedi: ni_labpc_common=
: Reformat multiple line dereference)
...
Merging gpio/for-next (b3e741a0f776 Merge branch 'devel' into for-next)
...
rflow
Merging akpm/master (0249cc3bb550 drivers/media/platform/sti/delta/delta-ip=
...

=Hs+f
-----END PGP SIGNATURE-----
