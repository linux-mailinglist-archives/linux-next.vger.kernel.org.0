...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 34DB7319D15
	for <lists+linux-next@lfdr.de>; Fri, 12 Feb 2021 12:08:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229650AbhBLLIl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 12 Feb 2021 06:08:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51274 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230471AbhBLLIV (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 12 Feb 2021 06:08:21 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D3C3EC06178A;
        Fri, 12 Feb 2021 03:07:30 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DcW1954BCz9sB4;
        Fri, 12 Feb 2021 22:07:25 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1613128046;
        bh=h94cImne4X15PKQ2FcvmBX6BLkLj0dx2b5FH/JzxKzg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 12 Feb 2021 22:07:22 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 12
Message-ID: <20210212220722.60bb01b4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dQ1aGiK7/ArEKCdmJ0/=Mpg";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/dQ1aGiK7/ArEKCdmJ0/=Mpg
...
Merging origin/master (c05263df6c1a Merge tag 'gpio-fixes-for-v5.11' of git=
://git.kernel.org/pub/scm/linux/kernel/git/brgl/linux)
Merging fixes/fixes (e71ba9452f0b Linux 5.11-rc2)
Merging kbuild-current/fixes (29500f15b54b kbuild: fix CONFIG_TRIM_UNUSED_K=
SYMS build for ppc64)
...
Merging net/master (f1d77b2efbe6 netdev-FAQ: answer some questions about th=
e patchwork checks)
Merging bpf/master (732fa3233066 selftests/bpf: Convert test_xdp_redirect.s=
h to bash)
...
Merging sound-current/for-linus (056a3da5d07f ALSA: hda/hdmi: Drop bogus ch=
eck at closing a stream)
Merging sound-asoc-fixes/for-linus (c8bca765c4ab Merge remote-tracking bran=
ch 'asoc/for-5.11' into asoc-linus)
Merging regmap-fixes/for-linus (19c329f68089 Linux 5.11-rc4)
Merging regulator-fixes/for-linus (95a5122b3139 Merge remote-tracking branc=
h 'regulator/for-5.11' into regulator-linus)
Merging spi-fixes/for-linus (eddaece2173b Merge remote-tracking branch 'spi=
...
t)
Merging arm64/for-next/core (61c4d082022f Merge branches 'for-next/cosmetic=
...
sc', 'for-next/perf', 'for-next/random', 'for-next/rng', 'for-next/selftest=
s', 'for-next/stacktrace', 'for-next/topology' and 'for-next/vdso' into for=
-next/core)
...
4)
Merging mips/mips-next (bde258bc651f MAINTAINERS: replace non-matching patt=
erns for loongson{2,3})
...
Merging fscache/fscache-next (235299002012 netfs: Hold a ref on a page when=
 PG_private_2 is set)
...
t into Kconfig)
Merging hid/for-next (2c94c284b859 Merge branch 'for-5.12/playstation' into=
 for-next)
...
Merging net-next/master (b4e18b29d02c Merge branch 'bcm4908_enet-post-revie=
w-fixes')
CONFLICT (content): Merge conflict in include/uapi/linux/pkt_cls.h
Merging bpf-next/for-next (0e1aa629f1ce kbuild: Do not clean resolve_btfids=
...
taprio-offloading')
Merging wireless-drivers-next/master (16ad7b4b4f4a Merge ath-next from git:=
...
Merging sound-asoc/for-next (729eda4f661c Merge remote-tracking branch 'aso=
...
d variable)
Merging block/for-next (5c0fc5a09175 Merge branch 'for-5.12/io_uring' into =
for-next)
CONFLICT (content): Merge conflict in lib/iov_iter.c
...
Merging regulator/for-next (58f351760033 Merge remote-tracking branch 'regu=
...
void)
Merging devicetree/for-next (7cbe89398a78 dt-bindings: usb: Change descibe =
to describe in usbmisc-imx.txt)
...
er)
Merging spi/for-next (e65e0385ff9a Merge remote-tracking branch 'spi/for-5.=
12' into spi-next)
...
Merging kvm/next (7137b7ae6f20 KVM: x86/xen: Explicitly pad struct compat_v=
cpu_info to 64 bytes)
...
Merging usb/usb-next (7a1e838d0cdc usb: misc: usb3503: Fix logic in usb3503=
_init())
...
Merging char-misc/char-misc-next (06c18e28c402 Documentation: coresight: Ad=
d PID tracing description)
...
5.12/vfio/next)
Merging staging/staging-next (5e911c3d9dbc staging: wfx: avoid defining arr=
ay of flexible struct)
...
Merging oprofile-removal/oprofile/removal (be65de6b03aa fs: Remove dcookies=
 support)
Merging akpm-current/current (dda8fe227129 initramfs-panic-with-memory-info=
rmation-fix)
...
Merging akpm/master (25730252dd6f MIPS: make userspace mapping young by def=
ault)
...

=pTIF
-----END PGP SIGNATURE-----
