Return-Path: <linux-next+bounces-5343-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 63A98A227CC
	for <lists+linux-next@lfdr.de>; Thu, 30 Jan 2025 04:11:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6F8D13A6687
	for <lists+linux-next@lfdr.de>; Thu, 30 Jan 2025 03:10:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8AF8D25634;
	Thu, 30 Jan 2025 03:10:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="bpCUxHOq"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 95A1A125D6;
	Thu, 30 Jan 2025 03:10:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738206652; cv=none; b=F5rnU8BmnAVlN7YqaQSAJP5hSgzdC9uOgxmkm39/fEdiMwAzGv5vblKXafu+ZP0hRMvREf4xqcg5zaSNuKfABYiVtrW+S2RgY/r+aNLYrKNFYc1+Z5NZi+U0mKdnEilHRarFRDTv+iLbZWYHtX3rmfENcn1VFFkQmBqmuo6MZ7Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738206652; c=relaxed/simple;
	bh=tD5SfLLY3XWrCGHkl6SviDAxgan3y4foE9wmWCz4NOs=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=FInngrM5OQ+b6XXIkNEWRoi37IBw9rEkHDUymOUb8BJnqpmHILIL4gKqLCzleXDZgo/8Ac0d90P5OIGPLT8mm+zEZlhX3O+/91F3iqeAx+9ffzdoUeCp9eVvV/0fxh1FLQIMQlFYsTHLNEb8O5nNxUr8cAc0r0JfyeDWeIHhSd8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=bpCUxHOq; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1738206632;
	bh=EHuuKJKjvYOb7Wa/OnMGei8scgh2yL9ZIa6IYJkq4Qo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Yk3tc0J83z4x5k;
	Thu, 30 Jan 2025 14:10:32 +1100 (AEDT)
Date: Thu, 30 Jan 2025 14:10:39 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 30
Message-ID: <20250130141039.06c88e11@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/X+GQW+QFV87chC+_4_RIa8G";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/X+GQW+QFV87chC+_4_RIa8G
...
Changes since 20250129:

The fuse tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 888
 1117 files changed, 30502 insertions(+), 12514 deletions(-)
...
Merging origin/master (ebbb8be421ee Merge tag 'regulator-fix-v6.14-merge-wi=
ndow' of git://git.kernel.org/pub/scm/linux/kernel/git/broonie/regulator)
...
X)
Merging cifs/for-next (ad40e4cfa5ad cifs: Simplify reparse point check in c=
ifs_query_path_info() function)
...
Merging mm-hotfixes/mm-hotfixes-unstable (c14f17c0988e mm/hugetlb: fix huge=
page allocation for interleaved memory nodes)
Merging fs-current (45581d908fc2 Merge branch 'fixes' of git://git.kernel.o=
...
ddr() for s390)
Merging net/main (9e6c4e6b605c bonding: Correctly support GSO ESP offload)
Merging bpf/master (9bf412d4d5b1 Merge branch 'bpf-fix-wrong-copied_seq-cal=
culation-and-add-tests')
...
Merging sound-current/for-linus (86d0d3ee07de Merge tag 'asoc-fix-v6.14-mer=
...
Merging driver-core.current/driver-core-linus (05dbaf8dd8bf Merge tag 'x86-=
urgent-2025-01-28' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging tty.current/tty-linus (5bc55a333a2f Linux 6.13-rc7)
Merging usb.current/usb-linus (6d61a53dd6f5 Merge tag 'f2fs-for-6.14-rc1' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs)
...
dependency)
Merging staging.current/staging-linus (6d61a53dd6f5 Merge tag 'f2fs-for-6.1=
4-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs)
Merging iio-fixes/fixes-togreg (71fa11c1bc6c iio: adc: ad7192: fix channel =
select)
...
Merging tip-fixes/tip/urgent (8b44debe7c5b Merge branch into tip/master: 't=
imers/urgent')
...
Merging mm-stable/mm-stable (805ba04cb7cc Merge tag 'mips_6.14' of git://gi=
t.kernel.org/pub/scm/linux/kernel/git/mips/linux)
Merging mm-nonmm-stable/mm-nonmm-stable (805ba04cb7cc Merge tag 'mips_6.14'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/mips/linux)
Merging mm/mm-everything (a36d1e4eda93 foo)
...
Merging fs-next (db8f623ecb93 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging pm/linux-next (da6843bb99a2 Merge branch 'pm-sleep' into linux-next)
...
Merging drm-xe/drm-xe-next (7748289df510 drm/xe/guc: Fix size_t print forma=
t)
...
Merging sound/for-next (86d0d3ee07de Merge tag 'asoc-fix-v6.14-merge-window=
...
Merging input/next (08bd5b7c9a24 Input: synaptics - fix crash when enabling=
 pass-through port)
Merging block/for-next (c49448d732af Merge branch 'block-6.14' into for-nex=
t)
...
sion)
Merging tomoyo/master (9e2b278b8572 tomoyo: use better patterns for procfs =
in learning mode)
...
13' into spi-linus)
Merging tip/master (25cb07b28aa8 Merge branch into tip/master: 'x86/mm')
...
Merging driver-core/driver-core-next (05dbaf8dd8bf Merge tag 'x86-urgent-20=
25-01-28' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging usb/usb-next (6d61a53dd6f5 Merge tag 'f2fs-for-6.14-rc1' of git://g=
...
Merging staging/staging-next (6d61a53dd6f5 Merge tag 'f2fs-for-6.14-rc1' of=
...
Merging dmaengine/next (98d187a98903 dmaengine: idxd: Enable Function Level=
 Reset (FLR) for halt)
Merging cgroup/for-next (ad6c08d8c104 cgroup/misc: Remove unused misc_cg_re=
s_total_usage)
...

=eaBp
-----END PGP SIGNATURE-----
