...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C9B107AF959
	for <lists+linux-next@lfdr.de>; Wed, 27 Sep 2023 06:28:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229663AbjI0E2L (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 27 Sep 2023 00:28:11 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58638 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229665AbjI0E1M (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 27 Sep 2023 00:27:12 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A809E4547A;
        Tue, 26 Sep 2023 20:51:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1695786693;
        bh=vI8/uI5QS48r+uzz9kFJZKWIE2Za03llslIEcUg5xBM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RwN2Y4nkdz4x3j;
        Wed, 27 Sep 2023 13:51:33 +1000 (AEST)
Date:   Wed, 27 Sep 2023 13:51:32 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 27
Message-ID: <20230927135132.4019bd9e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/udcm/jOOfopE_AO/TsRlFXx";
...
Merging origin/master (0e945134b680 Merge tag 'wq-for-6.6-rc3-fixes' of git=
...
Merging arm-soc-fixes/arm/fixes (aab8130550da Merge tag 'riscv-dt-fixes-for=
-v6.6-rc3' of https://git.kernel.org/pub/scm/linux/kernel/git/conor/linux i=
nto arm/fixes)
...
e())
Merging wireless/for-next (aaba3cd33fc9 wifi: mac80211: Create resources fo=
r disabled links)
Merging wpan/master (9a43827e876c net: dpaa2-mac: add 25gbase-r support)
Merging rdma-fixes/for-rc (d7f393430a17 IB/mlx4: Fix the size of a buffer i=
n add_port_entries())
...
Merging mmc-fixes/fixes (c7bb120c1c66 mmc: mtk-sd: Use readl_poll_timeout_a=
tomic in msdc_reset_hw)
...
Merging mm/mm-everything (d2373cac3d17 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging perf/perf-tools-next (eb9760cd8251 perf evlist: Avoid frequency mod=
...
Merging arm-soc/for-next (aab8130550da Merge tag 'riscv-dt-fixes-for-v6.6-r=
c3' of https://git.kernel.org/pub/scm/linux/kernel/git/conor/linux into arm=
/fixes)
...
Merging loongarch/loongarch-next (6465e260f487 Linux 6.6-rc3)
...
93 sensor driver)
Merging pm/linux-next (d1fc594eb435 Merge branch 'thermal-core' into linux-=
next)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (f067976e4939 drm/i915/cx0: prefer forward=
 declarations over includes)
...
ith __counted_by)
Merging sound-asoc/for-next (af08458988cb ASoC: Merge up fixes)
...
Merging mmc/next (40f59f212fc8 mmc: Merge branch fixes into next)
...
e in mm8013_probe())
Merging regulator/for-next (0833c7741d40 Merge remote-tracking branch 'regu=
...
Merging integrity/next-integrity (be210c6d3597 ima: Finish deprecation of I=
MA_TRUSTED_KEYRING Kconfig)
...
Merging pinctrl-intel/for-next (9419ae7e40d3 pinctrl: intel: Simplify code =
with cleanup helpers)
...
Merging nvdimm/libnvdimm-for-next (84528e1dc9c1 libnvdimm: Annotate struct =
nd_region with __counted_by)
CONFLICT (content): Merge conflict in drivers/acpi/nfit/core.c
...

=5HY+
-----END PGP SIGNATURE-----
