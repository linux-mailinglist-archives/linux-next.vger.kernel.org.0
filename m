Return-Path: <linux-next+bounces-3560-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 68A479693C0
	for <lists+linux-next@lfdr.de>; Tue,  3 Sep 2024 08:34:43 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 91D1E1F24626
	for <lists+linux-next@lfdr.de>; Tue,  3 Sep 2024 06:34:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A5F921D61BD;
	Tue,  3 Sep 2024 06:34:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="HNCn7XmA"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B7B614315D;
	Tue,  3 Sep 2024 06:33:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725345245; cv=none; b=KUwh9YywoL25FafGjtKxluKVxOhzgFChk7dc+p2QoC7oCd4xVJmBWDXy1sRnPNDqS623cucG1f70ZYfgfPv0y4kQGmA7oSoaH4x0TEZGfLZWl4+Y2wzO5KGc3CCLHHsuhC0eKxanwkdpl/Dtj2/axNGqu57W4wbP3Oao59jgmuk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725345245; c=relaxed/simple;
	bh=GutovSgqtb+82eaYN1uBsu3NTIj0Rn38V/MmADiE9qs=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=lmPmgsFJArg3kWgvzZMISspyMgjbsdxGSqwXFSL1Co7N1UyTh9+9KFXkBVpCmSAH1e2mFzXd+hhxlAoqHkGrNxwaNfKKkhSFMk3LECyeUF/Gw6EiDjS9XnlyJxm3pIdvhJ9ASB0mTu5Pkv5xoyy8yr6jtTEXqIHVxmX7a1lpR7A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=HNCn7XmA; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1725345237;
	bh=Ntawq3s3gfijhKQ15oSrWTbx6lv7cuBxVYGZHKbmYac=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WybS54Xhqz4x8F;
	Tue,  3 Sep 2024 16:33:57 +1000 (AEST)
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/N.QaEhj3dnWb5dV3fMUJNW9";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/N.QaEhj3dnWb5dV3fMUJNW9
...
Merging origin/master (67784a74e258 Merge tag 'ata-6.11-rc7' of git://git.k=
...
Merging btrfs-fixes/next-fixes (27a355ae6da9 Merge branch 'misc-6.11' into =
next-fixes)
...
Merging erofs/dev (92da11bddec8 erofs: mark experimental fscache backend de=
precated)
...
Merging nfsd/nfsd-next (e681699a17b3 NFSD: Add initial generated XDR defini=
...
Merging mm-hotfixes/mm-hotfixes-unstable (278e840b803f ocfs2: fix possible =
null-ptr-deref in ocfs2_set_buffer_uptodate)
Merging fs-current (d489af84b135 Merge branch 'fixes' of git://git.kernel.o=
...
Merging spi-fixes/for-linus (709df70a20e9 spi: bcm63xx: Enable module autol=
oading)
...
Merging drivers-x86-fixes/fixes (ffc17e1479e8 platform/x86: dell-smbios: Fi=
x error path in dell_smbios_init())
...
Merging drm-intel-fixes/for-linux-next-fixes (f99999536128 drm/i915/fence: =
...
Merging iommufd-fixes/for-rc (cf1e515c9a40 iommufd/selftest: Make dirty_ops=
 static)
Merging rust-fixes/rust-fixes (376174f5a49a MAINTAINERS: Remove Wedson as R=
ust maintainer)
...
Merging drm-misc-fixes/for-linux-next-fixes (3f6b2f60b463 drm/imagination: =
Free pvr_vm_gpuva after unlink)
...
Merging imx-mxs/for-next (82b36935828c Merge branch 'imx/defconfig' into fo=
r-next)
...
Merging renesas/next (e22d8075c0ba Merge branch 'renesas-dts-for-v6.12' int=
o renesas-next)
...
Merging net-next/main (55ddb6c5a3ae net: stmmac: drop the ethtool begin() c=
allback)
...
Merging drm/drm-next (b1aa0491fad2 drm/xe: Fix merge fails related to displ=
ay runtime PM)
...
Merging drm-misc/for-linux-next (ca097d4d94d8 drm/display: split DSC helper=
s from DP helpers)
CONFLICT (content): Merge conflict in drivers/gpu/drm/tegra/gr3d.c
Merging amdgpu/drm-next (ead60e9c4e29 drm/amdgpu/gfx10: use rlc safe mode f=
or soft recovery)
Merging drm-intel/for-linux-next (390fa93e6efe drm/xe/display: remove unuse=
d compat kdev_to_i915() and pdev_to_i915())
  5bf472058ffb ("drm/i915/fence: Mark debug_fence_init_onstack() with __may=
be_unused")
  8be4dce5ea6f ("drm/i915/fence: Mark debug_fence_free() with __maybe_unuse=
d")
...
eback on SM6350)
Merging drm-xe/drm-xe-next (da6ec7433977 drm/xe/pf: Reset thresholds when r=
eleasing a VF config)
...
Merging sound/for-next (40a024b81d1c ALSA: core: Drop superfluous no_free_p=
tr() for memdup_user() errors)
Merging ieee1394/for-next (e4262d321961 firewire: core: update fw_device ou=
tside of device_find_child())
Merging sound-asoc/for-next (e14a726b0e86 Merge remote-tracking branch 'aso=
...
Merging block/for-next (3033b18cda6f Merge branch 'for-6.12/io_uring' into =
for-next)
Merging device-mapper/for-next (26207c6332e8 dm: Make use of __assign_bit()=
 API)
...
Merging spi/for-next (42afa0cec405 Merge remote-tracking branch 'spi/for-6.=
12' into spi-next)
...

=YlwX
-----END PGP SIGNATURE-----
