...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D4F34E4305
	for <lists+linux-next@lfdr.de>; Fri, 25 Oct 2019 07:45:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2393127AbfJYFpU (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 25 Oct 2019 01:45:20 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:59463 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2390519AbfJYFpT (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 25 Oct 2019 01:45:19 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46ztP60B56z9sPL;
        Fri, 25 Oct 2019 16:45:14 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1571982314;
        bh=yb1M0xnWCt34fElkrMPvJC9nWFa2NRDwzilfnmabZ50=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 25 Oct 2019 16:45:13 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 25
Message-ID: <20191025164513.2ca40a6d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=.vip3C4HS7h3HC5TV3x+Sr";
...
--Sig_/=.vip3C4HS7h3HC5TV3x+Sr
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20191024:

The kvm tree gained a conflict against the kvm-arm tree.

The scsi-mkp tree gained a build failure so I used the version from
next-20191024.

Non-merge commits (relative to Linus' tree): 6018
 5671 files changed, 215668 insertions(+), 97401 deletions(-)
...
Merging origin/master (7f65d3541676 Merge tag 'acpi-5.4-rc5' of git://git.k=
...
Merging arm-soc-fixes/arm/fixes (116c05bfa17f Merge tag 'arm-soc/for-5.5/ma=
intainers' of https://github.com/Broadcom/stblinux into arm/fixes)
...
Merging net/master (76db2d466f6a net: phy: smsc: LAN8740: add PHY_RST_AFTER=
_CLK_EN flag)
...
Merging netfilter/master (085461c8976e netfilter: nf_tables_offload: restor=
e basechain deletion)
...
rflow)
Merging sound-current/for-linus (f0778871a138 ALSA: hda/realtek - Add suppo=
rt for ALC623)
Merging sound-asoc-fixes/for-linus (d18b44358a38 Merge branch 'asoc-5.4' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (b851714ffaf2 Merge branch 'spi-5.4' into spi-l=
inus)
...
Merging arm-soc/for-next (ef212ad3d1d9 ARM: Document merges)
...
Merging clk-samsung/for-next (c9f7567aff31 clk: samsung: exynos542x: Move G=
3D subsystem clocks to its sub-CMU)
...
errupted)
Merging cifs/for-next (1d4dff701fcb CIFS: Fix use after free of file info s=
tructures)
...
Merging net-next/master (503a64635d5e Merge branch 'DPAA-Ethernet-changes')
Merging bpf-next/master (58eeb2289ab9 libbpf: Fix strncat bounds error in l=
ibbpf_prog_type_by_name)
...
Merging netfilter-next/master (d54725cd11a5 netfilter: nf_tables: support f=
or multiple devices per netdev hook)
Merging nfc-next/master (1f008cfec5d5 NFC: fdp: Fix unused variable warning=
s)
CONFLICT (content): Merge conflict in drivers/nfc/st21nfca/se.c
Merging ipvs-next/master (d54725cd11a5 netfilter: nf_tables: support for mu=
ltiple devices per netdev hook)
Merging wireless-drivers-next/master (b298800dd8ee rtl8xxxu: fix warnings f=
or symbol not declared)
...
Merging crypto/master (e9fc36719b52 crypto: inside-secure - Made locally us=
...
Merging drm-misc/for-linux-next (3f4bb9f75090 drm: Spelling s/connet/connec=
t/)
...
Merging sound-asoc/for-next (e20c3ab704c7 Merge branch 'asoc-5.5' into asoc=
-next)
...
Merging input/next (cb3efd5a3885 Input: adp5589 - make keypad support optio=
nal)
Merging block/for-next (f015479bab2c Merge branch 'for-5.5/drivers' into fo=
r-next)
...
Merging devicetree/for-next (65b52935c534 Merge branch 'dt/linus' into dt/n=
ext)
...
register value)
Merging spi/for-next (e025ec2b58a5 Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
Merging edac/edac-for-next (5bbab3cf211b EDAC/aspeed: Use devm_platform_ior=
emap_resource() in aspeed_probe())
Merging irqchip/irq/irqchip-next (7c374670644a irqchip: Skip contexts excep=
t supervisor in plic_init())
...
Merging phy-next/next (4bd5ead82d4b phy: renesas: rcar-gen3-usb2: Fix sysfs=
 interface of "role")
...
symbols)
Merging cgroup/for-next (4ba3bdee4ee3 Merge branch 'for-5.5' into for-next)
...
5.5/scsi-next)
$ git reset --hard HEAD^
Merging next-20191024 version of scsi-mkp
...
Merging gpio-brgl/gpio/for-next (f3a93e087e87 gpio: bd70528: Add MODULE ALI=
AS to autoload module)
...
ame for irq chip")
Merging pinctrl-intel/for-next (2b80955d8451 pinctrl: intel: Add Intel Tige=
...
rflow
Merging akpm/master (28c4004ed53f drivers/media/platform/sti/delta/delta-ip=
...

=Uu3p
-----END PGP SIGNATURE-----
