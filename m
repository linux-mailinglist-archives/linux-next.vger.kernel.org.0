...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0ECD79D0E1
	for <lists+linux-next@lfdr.de>; Mon, 26 Aug 2019 15:45:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728295AbfHZNpC (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 26 Aug 2019 09:45:02 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:36481 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731796AbfHZNpB (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 26 Aug 2019 09:45:01 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46HCtC406Gz9sNf;
        Mon, 26 Aug 2019 23:44:51 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1566827091;
        bh=q/dJrhVnA3NJmnGukPvQk4E56B0K3aud6HuCW8ItvsQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 26 Aug 2019 23:44:49 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 26
Message-ID: <20190826234449.1526d145@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//gYSHWvkHM7DW0rGov3C5Xb";
...
Merging bpf/master (2c238177bd7f bpf: allow narrow loads of some sk_reusepo=
rt_md fields with offset > 0)
...
nsistency)
Merging sound-current/for-linus (75545304eba6 ALSA: seq: Fix potential conc=
urrent access to the deleted pool)
...
Merging renesas-geert/next (542934456db5 Merge branch 'renesas-drivers-for-=
...
Merging mips/mips-next (b4742e6682d5 MIPS: dts: mscc: describe the PTP read=
y interrupt)
...
ition)
Merging ext4/dev (c747f2a0aa5e ext4: fix potential use after free after rem=
...
ion)
Merging nfs/linux-next (aefb623c422e NFS: Fix writepage(s) error handling t=
...
Merging hid/for-next (04db301da38e Merge branch 'for-5.4/logitech' into for=
-next)
...
in imxfb_probe())
Merging pm/linux-next (563a965beb53 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
Merging rdma/for-next (868df536f5e8 Merge branch 'odp_fixes' into rdma.git =
for-next)
CONFLICT (content): Merge conflict in drivers/infiniband/hw/mlx5/mlx5_ib.h
Merging net-next/master (c1236979b4d2 net: phy: sfp: Add labels to hwmon se=
nsors)
...
v.c
Merging drm-intel/for-linux-next (529880098431 drm/i915: to make vgpu ppgtt=
...
Merging drm-misc/for-linux-next (6dbe0c4b0fc0 drm/panel: Initialise panel d=
ev and funcs through drm_panel_init())
...
-next)
Merging sound/for-next (e0ccdef92653 ALSA: usb-audio: Clean up check_input_=
term())
...
vices)
Merging block/for-next (fcf75acca7b3 Merge branch 'for-5.4/block' into for-=
next)
Merging device-mapper/for-next (88cd3e6cfac9 dm verity: add root hash pkcs#=
...
Merging kvm-ppc/kvm-ppc-next (d22deab6960a KVM: PPC: Book3S HV: Define usag=
e types for rmap array in guest memslot)
...
rm_get_irq())
Merging leds/for-next (192263c576ef leds: Allow to call led_classdev_unregi=
...
Merging pinctrl/for-next (7c772bed431c Merge tag 'sh-pfc-for-v5.4-tag2' of =
...
Merging devfreq/for-next (0ef7c7cce43f PM / devfreq: passive: Use non-devm =
notifiers)
...
rflow
Merging akpm/master (5ad8ab5eb246 drivers/media/platform/sti/delta/delta-ip=
...

=FNaB
-----END PGP SIGNATURE-----
