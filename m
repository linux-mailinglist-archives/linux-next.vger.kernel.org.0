...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 0977B10E4C4
	for <lists+linux-next@lfdr.de>; Mon,  2 Dec 2019 03:59:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727301AbfLBC72 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 1 Dec 2019 21:59:28 -0500
Received: from ozlabs.org ([203.11.71.1]:40969 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727298AbfLBC71 (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sun, 1 Dec 2019 21:59:27 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47R8w66VZBz9sNx;
        Mon,  2 Dec 2019 13:59:18 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1575255558;
        bh=y1/nbnJJzpRNLkOdhxzfmAEz73Sp/C8G0k/V13QTgXc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 2 Dec 2019 13:59:18 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 2
Message-ID: <20191202135918.566dd377@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/DSSv58WMD7.XANgrsLKo26p";
...
Non-merge commits (relative to Linus' tree): 4187
 3969 files changed, 137668 insertions(+), 61740 deletions(-)
...
Merging origin/master (b94ae8ad9fe7 Merge tag 'seccomp-v5.5-rc1' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/kees/linux)
...
Merging net/master (9bd19c63a4bc net: emulex: benet: indent a Kconfig depen=
ds continuation line)
Merging bpf/master (e1608f3fa857 bpf: Avoid setting bpf insns pages read-on=
ly when prog is jited)
Merging ipsec/master (a56dcc6b4558 net: cdc_ncm: Signedness bug in cdc_ncm_=
set_dgram_size())
Merging netfilter/master (d50264f1fef9 netfilter: nf_flow_table_offload: ad=
d IPv6 match description)
Merging ipvs/master (c24b75e0f923 ipvs: move old_secure_tcp into struct net=
ns_ipvs)
Merging wireless-drivers/master (22d0d5ae7a08 ath9k: use iowrite32 over __r=
aw_writel)
...
desc_size)
Merging sound-current/for-linus (d2cd795c4ece ALSA: hda - fixup for the bas=
s speaker on Lenovo Carbon X1 7th gen)
...
Merging driver-core.current/driver-core-linus (a6ed68d6468b Merge tag 'drm-=
next-2019-11-27' of git://anongit.freedesktop.org/drm/drm)
Merging tty.current/tty-linus (d6d5df1db6e9 Linux 5.4-rc5)
Merging usb.current/usb-linus (a6ed68d6468b Merge tag 'drm-next-2019-11-27'=
...
Merging staging.current/staging-linus (a6ed68d6468b Merge tag 'drm-next-201=
9-11-27' of git://anongit.freedesktop.org/drm/drm)
Merging char-misc.current/char-misc-linus (a6ed68d6468b Merge tag 'drm-next=
-2019-11-27' of git://anongit.freedesktop.org/drm/drm)
...
ead-only mappings)
Merging cifs/for-next (d1a6085c1f41 fs: cifs: Fix atime update check vs mti=
me)
...
in imxfb_probe())
Merging pm/linux-next (20e4181ee0a7 Merge branch 'acpi-sysfs' into linux-ne=
xt)
...
unctions for cq)
Merging net-next/master (81b6b96475ac Merge branch 'master' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/torvalds/linux; tag 'dma-mapping-5.5' of =
...
-next)
Merging sound/for-next (d2cd795c4ece ALSA: hda - fixup for the bass speaker=
...
Merging driver-core/driver-core-next (a6ed68d6468b Merge tag 'drm-next-2019=
-11-27' of git://anongit.freedesktop.org/drm/drm)
Merging usb/usb-next (a6ed68d6468b Merge tag 'drm-next-2019-11-27' of git:/=
...
Merging char-misc/char-misc-next (a6ed68d6468b Merge tag 'drm-next-2019-11-=
27' of git://anongit.freedesktop.org/drm/drm)
...
Merging staging/staging-next (a6ed68d6468b Merge tag 'drm-next-2019-11-27' =
of git://anongit.freedesktop.org/drm/drm)
...
CONFLICT (content): Merge conflict in include/linux/pagewalk.h
...
rflow
Merging akpm/master (8271151e47a7 drivers/media/platform/sti/delta/delta-ip=
...

=Fq5b
-----END PGP SIGNATURE-----
