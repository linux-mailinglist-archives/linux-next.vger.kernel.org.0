50
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 17 Mar 2024 21:02:51 -0700 (PDT)
Message-ID: <65f7bceb.170a0220.3a4c4.1f2b@mx.google.com>
Date: Sun, 17 Mar 2024 21:02:51 -0700 (PDT)
...
Subject: next/master build: 170 builds: 4 failed, 166 passed, 8 errors,
 274 warnings (next-20240318)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 170 builds: 4 failed, 166 passed, 8 errors, 274 warnings=
 (next-20240318)
...
Tree: next
Branch: master
Git Describe: next-20240318
Git Commit: 2e93f143ca010a5013528e1cfdc895f024fe8c21
...
arm:
    ...
    multi_v7_defconfig (clang-17): 5 warnings
    mxs_defconfig (gcc-10): 1 warning

i386:
    i386_defconfig (clang-17): 4 errors
...
x86_64:
    x86_64_defconfig (clang-17): 4 errors

Errors summary:

    4    include/trace/events/sunrpc.h:709:4: error: result of comparison a=
gainst a string literal is unspecified (use an explicit string comparison f=
unction instead) [-Werror,-Wstring-compare]
    4    include/trace/events/sunrpc.h:707:4: error: result of comparison a=
gainst a string literal is unspecified (use an explicit string comparison f=
unction instead) [-Werror,-Wstring-compare]
...
rovider): /fpga/pct: '#interrupt-cells' found, but node is not an interrupt=
 ...
 prerequisite 'interrupt_provider'
    2    include/trace/events/sunrpc.h:709:4: warning: result of comparison=
 against a string literal is unspecified (use an explicit string comparison=
 function instead) [-Wstring-compare]
    2    include/trace/events/sunrpc.h:707:4: warning: result of comparison=
 against a string literal is unspecified (use an explicit string comparison=
 function instead) [-Wstring-compare]
...
---------------------------------------------------------------------------=
-----
i386_defconfig (i386, clang-17) =E2=80=94 FAIL, 4 errors, 0 warnings, 0 sec=
tion mismatches

Errors:
    include/trace/events/sunrpc.h:707:4: error: result of comparison agains=
t a string literal is unspecified (use an explicit string comparison functi=
on instead) [-Werror,-Wstring-compare]
    include/trace/events/sunrpc.h:709:4: error: result of comparison agains=
t a string literal is unspecified (use an explicit string comparison functi=
on instead) [-Werror,-Wstring-compare]
    include/trace/events/sunrpc.h:707:4: error: result of comparison agains=
t a string literal is unspecified (use an explicit string comparison functi=
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig (arm, clang-17) =E2=80=94 PASS, 0 errors, 5 warnings, 0 =
section mismatches

Warnings:
    include/trace/events/sunrpc.h:707:4: warning: result of comparison agai=
nst a string literal is unspecified (use an explicit string comparison func=
tion instead) [-Wstring-compare]
    include/trace/events/sunrpc.h:709:4: warning: result of comparison agai=
nst a string literal is unspecified (use an explicit string comparison func=
tion instead) [-Wstring-compare]
    include/trace/events/sunrpc.h:707:4: warning: result of comparison agai=
nst a string literal is unspecified (use an explicit string comparison func=
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig (x86_64, clang-17) =E2=80=94 FAIL, 4 errors, 0 warnings, 0=
 section mismatches
