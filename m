...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3F3692DAA20
	for <lists+linux-next@lfdr.de>; Tue, 15 Dec 2020 10:32:21 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727724AbgLOJcF (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 15 Dec 2020 04:32:05 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:48371 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727844AbgLOJcE (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 15 Dec 2020 04:32:04 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CwCgV6Bsmz9s0b;
        Tue, 15 Dec 2020 20:31:18 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1608024679;
        bh=qERNOoJtbrdNwNMvUEM2GYUHb5P9MAcGGs4hPdQDfjM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 15 Dec 2020 20:31:17 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 15
Message-ID: <20201215203117.461f50e9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/4dZv_5iIV90djx7Xsdm4G69";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/4dZv_5iIV90djx7Xsdm4G69
...
Merging origin/master (9e4b0d55d84a Merge branch 'linus' of git://git.kerne=
...
Merging powerpc/next (44b4c4450f8d powerpc/64s: Mark the kuap/kuep function=
s non __init)
...
Merging cifs/for-next (5c4b642141eb cifs: fix uninitialized variable in smb=
3_fs_context_parse_param)
...
-next)
Merging pci/next (752b370726cc Merge branch 'remotes/lorenzo/pci/misc')
...
linux-next)
Merging thermal/thermal/linux-next (d7203eedf4f6 thermal/core: Add critical=
 and hot ops)
$ git reset --hard HEAD^
Merging next-20201214 version of thermal
...
Merging net-next/master (5bb0c4b5eb61 ice, xsk: Move Rx allocation out of w=
hile-loop)
Applying: fixup for "treewide: rename nla_strlcpy to nla_strscpy."
Merging bpf-next/for-next (0e12c0271887 selftests: test_vxlan_under_vrf: mu=
te unnecessary error message)
...
Merging amdgpu/drm-next (59d3ffced4ef drm/radeon: fix check order in radeon=
_bo_move)
...
Merging drm-misc/for-linux-next (95e3d610d35c drm/radeon: fix check order i=
n radeon_bo_move)
...
Merging input/next (92f0a3a22c7a Input: da7280 - fix spelling mistake "sequ=
emce" -> "sequence")
...
ts in kvm_stat)
Merging xen-tip/linux-next (2c85ebc57b3e Linux 5.10)
...
US GPIO validity)
Merging usb-chipidea-next/for-usb-next (c4cd6acd2870 usb: cdnsp: Fixes for =
sparse warnings)
...
Merging gpio/for-next (a2e5f9277f66 MAINTAINERS: Remove reference to non-ex=
isting file)
CONFLICT (content): Merge conflict in MAINTAINERS
...
Merging akpm/master (390b446739fd secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=crEw
-----END PGP SIGNATURE-----
