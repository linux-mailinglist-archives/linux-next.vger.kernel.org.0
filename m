...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6F59141BF02
	for <lists+linux-next@lfdr.de>; Wed, 29 Sep 2021 08:12:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244391AbhI2GOJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 29 Sep 2021 02:14:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42212 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244370AbhI2GOG (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 29 Sep 2021 02:14:06 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 64120C061760;
        Tue, 28 Sep 2021 23:12:23 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HK5d11T5sz4xbQ;
        Wed, 29 Sep 2021 16:12:21 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1632895941;
        bh=gcUd8xBrCpHVwc/kSSK3A3pi9bMduwRJItqAovwIP48=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 29 Sep 2021 16:12:20 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 29
Message-ID: <20210929161220.35cb25f3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/tuoB_JeKgb6RiaZ4upLFiY+";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/tuoB_JeKgb6RiaZ4upLFiY+
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210928:
...
Non-merge commits (relative to Linus' tree): 4145
 4104 files changed, 186592 insertions(+), 86689 deletions(-)
...
Merging origin/master (e7bd807e8c9e Merge tag 'm68k-for-v5.15-tag3' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/geert/linux-m68k)
...
Merging net/master (4ccb9f03fee7 Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/bpf/bpf)
Merging bpf/master (4ccb9f03fee7 Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/bpf/bpf)
...
ubtraction warning)
Merging mac80211/master (3b1b6e82fb5e net: phy: enhance GPY115 loopback dis=
able function)
...
arding more robust)
Merging sound-asoc-fixes/for-linus (4d0a52b28efb Merge remote-tracking bran=
...
Applying: kconfig: restore sym_escape_string_value()
...
Merging cifsd/cifsd-for-next (b8cf5584ec5b MAINTAINERS: rename cifs_common =
to smbfs_common in cifs and ksmbd entry)
...
Merging pm/linux-next (5264d800ffd5 Merge branch 'pm-pci' into linux-next)
...
ropriate MRs)
Merging net-next/master (3d5f12d4ff78 net: ipv4: remove superfluous header =
files from fib_notifier.c)
Merging bpf-next/for-next (72e1781a5de9 Merge branch 'bpf: Build with -Wcas=
t-function-type')
...
Merging bluetooth/master (0eb10c0c6d61 Bluetooth: btrsi: remove superfluous=
...
Merging drm-misc/for-linux-next (93ee1a2c0f08 drm/panel: support for BOE an=
d INX video mode panel)
Merging amdgpu/drm-next (ad9fd163e33d drm/radeon: Add HD-audio component no=
tifier support (v2))
$ git reset --hard HEAD^
Merging next-20210928 version of amdgpu
Merging drm-intel/for-linux-next (2a764b7c708a drm/i915/display: Fix the ds=
c check while selecting min_cdclk)
...
al locking issue)
Merging sound-asoc/for-next (987358bb2df6 Merge remote-tracking branch 'aso=
...
Merging rcu/rcu/next (6f45070ea1b7 rcu: Fix rcu_dynticks_curr_cpu_in_eqs() =
vs noinstr)
...
Merging drivers-x86/for-next (5fbd827eb9c2 platform/x86: dell-wmi: Recognis=
e or support new switches)
...
Merging staging/staging-next (c090666ba9b5 staging: r8188eu: remove mutex '=
...
Merging akpm/master (b38c82b64a0a mm: unexport {,un}lock_page_memcg)
...

=54OZ
-----END PGP SIGNATURE-----
