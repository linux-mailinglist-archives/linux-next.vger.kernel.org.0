Return-Path: <linux-next+bounces-9655-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 5734CD1C894
	for <lists+linux-next@lfdr.de>; Wed, 14 Jan 2026 06:05:39 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 37E1230B23AC
	for <lists+linux-next@lfdr.de>; Wed, 14 Jan 2026 04:51:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F05C932D43C;
	Wed, 14 Jan 2026 04:51:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="F7ASTbpd"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 61E2A239E9D;
	Wed, 14 Jan 2026 04:51:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1768366294; cv=none; b=fYHsIZMBg9E7WxlMa2eF0LEY45VSJKAI1yjYl3gsJwtNegaodL6q+R+n1rLNjJo9hjmMHMKVbCdyK9Opwl7zXiRs4xEro06yHH4IvKr9c1Jr/nQII4yd64kk0Uv1mVw9rhdWHN0ZfBt26dGpbdFPSv2RLGljXDr/4As3CzgTExk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1768366294; c=relaxed/simple;
	bh=2Pm68OqhfF6O0tRye3t0he4iwOvkeOtLTggDdMIy1lw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=B1UV7xWtw2gjgIo/5NcZMuafLPkqeSsP88/S65jwX9zp2G7sjrHS+i2o0SUpZzP27qsFIj7WavZs08AndCpnEIbCK86uEaNWYFe7C75+wH07HXxbf8oavFzWuzHna6gc4bPAANVCHik7/nzxLd6OcRxBKMqhIrXHUzas45XO/2s=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=F7ASTbpd; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1768366275;
	bh=tOKxaN4HA5EFw3JkYYEDdGm0oPPxmBpnzJs/ayHOmTA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4drYbl01GRz4wB9;
	Wed, 14 Jan 2026 15:51:14 +1100 (AEDT)
Date: Wed, 14 Jan 2026 15:51:14 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 14
Message-ID: <20260114155114.08661496@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//PAGsMUn6qH1Wt/8d35OVOo";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_//PAGsMUn6qH1Wt/8d35OVOo
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20260113:

The net-next tree still had it build failure for which I applied a hack.
It also gained a conflict against the ath tree.

The leds-lj tree still had it build failure so I used the version from
next-20260108.

Non-merge commits (relative to Linus' tree): 5536
 5600 files changed, 309462 insertions(+), 148920 deletions(-)
...
Merging origin/master (b54345928fa1 Merge tag 'gfs2-for-6.19-rc6' of git://=
...
Merging mm-hotfixes/mm-hotfixes-unstable (5b6e8d5736f8 mm/vma: do not leak =
memory when .mmap_prepare swaps the file)
Merging fs-current (15fe03e7cb30 Merge branch 'next-fixes' of https://git.k=
...
Merging net/main (ffe4ccd359d0 net: add net.core.qdisc_max_burst)
Merging bpf/master (ec69daabe452 bpf: Fix reference count leak in bpf_prog_=
test_run_xdp())
...
Merging sound-asoc-fixes/for-linus (bc5a847a80d4 ASoC: dt-bindings: realtek=
,rt5640: Various fixes)
...
Merging tip-fixes/tip/urgent (b71e635feefc Merge tag 'cgroup-for-6.19-rc5-f=
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (dc2d5ddb193e drm/gud: fix NULL=
 fb and crtc dereferences on USB disconnect)
...
Merging mm-unstable/mm-unstable (b28fc66b5eb6 tsacct: skip all kernel threa=
ds)
Merging mm-nonmm-unstable/mm-nonmm-unstable (01c8de771f4a init-mainc-check-=
if-rdinit-was-explicitly-set-before-printing-warning-fix)
...
Merging amlogic/for-next (79f125ddf331 Merge branch 'v6.20/drivers' into fo=
r-next)
...
Merging xtensa/xtensa-for-next (0d4b3ca115b5 xtensa: align: validate access=
 in fast_load_store)
Merging fs-next (90243e0de4ca Merge branch 'for-next' of https://git.kernel=
...
Merging pci/next (044e5dabea37 Merge branch 'pci/misc')
...
xt)
Merging i2c/i2c/for-next (c3eea094ab76 Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
...
")
Merging i3c/i3c/next (de28e002df2e i3c: dw: Preserve DAT entry bits when re=
storing addresses)
...
next)
Merging v4l-dvb/next (1c1b79f40ee4 media: verisilicon: AV1: Set IDR flag fo=
r intra_only frame type)
CONFLICT (content): Merge conflict in drivers/media/mc/mc-request.c
Merging v4l-dvb-next/master (adc218676eef Linux 6.12)
Merging pm/linux-next (fa4777c54c68 Merge branches 'thermal-core', 'thermal=
-intel' and 'thermal-tools' into linux-next)
...
S definition)
Merging net-next/main (c65182ef9df6 selftests: net: reduce txtimestamp desc=
hedule flakes)
...
Applying: fix up for "wifi: ath12k: Move ieee80211_ops callback to the arch=
 specific module"
Merging bpf-next/for-next (da4ab5dcc975 Merge branch 'bpf-recognize-special=
-arithmetic-shift-in-the-verifier')
...
Merging drm-misc/for-linux-next (cea6e6e8717e drm/atomic: verify that gamma=
/degamma LUTs are not too big)
...
Merging sound-asoc/for-next (1c608070428c Merge remote-tracking branch 'aso=
...
IG_OF)
Merging block/for-next (43120a6b3201 Merge branch 'for-7.0/io_uring' into f=
or-next)
...
Merging devicetree/for-next (1627d65f9c61 dt-bindings: Add IEI vendor prefi=
x and IEI WT61P803 PUZZLE driver bindings)
...
20' into spi-next)
Merging tip/master (00e5cb2307ae Merge branch into tip/master: 'x86/sev')
...
Merging xen-tip/linux-next (6ae41558ab9b x86/xen: Drop xen_mmu_ops)
...
PMI driver)
Merging driver-core/driver-core-next (585e8a26abfd rust: platform: fix remo=
ve_callback invariant comment)
...
roup macros)
Merging rpmsg/for-next (8d002b3a59cd Merge branches 'rpmsg-next' and 'rproc=
-next' into for-next)
...
Merging slab/slab/for-next (22b166b482a1 Merge branch 'slab/for-7.0/obj_met=
...
Merging kspp/for-next/kspp (a71a95ac693c Fortify: Use C arithmetic not FIEL=
D_xxx() in FORTIFY_REASON defines)
  574d944d2ff3 ("ecryptfs: Annotate struct ecryptfs_message with __counted_=
by")
...

=onnv
-----END PGP SIGNATURE-----
