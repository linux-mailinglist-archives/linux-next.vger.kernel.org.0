Return-Path: <linux-next+bounces-1356-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 3FA858671F7
	for <lists+linux-next@lfdr.de>; Mon, 26 Feb 2024 11:51:34 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6C09B1F258B2
	for <lists+linux-next@lfdr.de>; Mon, 26 Feb 2024 10:51:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A9DD21CD09;
	Mon, 26 Feb 2024 10:46:53 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="acLiddU6"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pl1-f182.google.com (mail-pl1-f182.google.com [209.85.214.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E87D51CABF
	for <linux-next@vger.kernel.org>; Mon, 26 Feb 2024 10:46:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708944413; cv=none; b=eqWdw/1XyDHs6JjiOGAVggplvGrgfNeeOqg+Yy+O0//KHGmFB1nj/LfhL1VHhJtT7OccCD2mFav7+QD3tTQtfbM0+JS1Y7z+BqD2uAoYF2saGsVwhl8jLfyDzR1E/Td8KsUfR24+OI8Y24FUrJR/mmiuu6qHRkPcd5IDQJMbptw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708944413; c=relaxed/simple;
	bh=EBM8FUoS8f8ccNaOgqcbyTpIrYLKgu3vx7uNumsB2Bo=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=pMFUSSCpbq59fNk/XY0ondz+NfJ+ldg5NnyGz8GgpdHDQ89Qq/r9Q8GnBy+JhMIZqkARoD/8Ubt2OxYrtPfN6QBM1XPTSGfYKfg0b3ldw/WfdV2E066S8l994tQ1MKAxq1mWFdYSG2MphSkKcGF13FA3RRoyhKGj85hbH2dk8/g=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=acLiddU6; arc=none smtp.client-ip=209.85.214.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pl1-f182.google.com with SMTP id d9443c01a7336-1dc29f1956cso18226295ad.0
        for <linux-next@vger.kernel.org>; Mon, 26 Feb 2024 02:46:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1708944406; x=1709549206; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=yevR+N2kEL/l39d8tgU4CJisrhrCPudyZogfbtvuyaM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708944406; x=1709549206;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=yevR+N2kEL/l39d8tgU4CJisrhrCPudyZogfbtvuyaM=;
        b=
X-Gm-Message-State: AOJu0YzZrQsSlGGGxHoICFPp2GoBDpX0RbccpbWSoDPI72gdhGgLvYL8
	sKCIwpvQaUcIMB3LBY5ADnXuMdfyOVYvaHlgpK7yQbZT8qeZS5cWtaRMMR6bWWhA2+cQ+dwXm43
	X
X-Google-Smtp-Source: AGHT+IGykALaZ8PJImG897ImudzTL2slKoq4slOmIGvzdVzC2H9KOa5slC6nt1D4ncB/lMvSEoCdLA==
X-Received: by 2002:a17:903:1111:b0:1dc:139:8488 with SMTP id n17-20020a170903111100b001dc01398488mr6101261plh.5.1708944405141;
        Mon, 26 Feb 2024 02:46:45 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id kt14-20020a170903088e00b001db88946f81sm3680630plb.230.2024.02.26.02.46.44
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 26 Feb 2024 02:46:44 -0800 (PST)
Message-ID: <65dc6c14.170a0220.f4a3f.91dd@mx.google.com>
Date: Mon, 26 Feb 2024 02:46:44 -0800 (PST)
...
Subject: next/master build: 172 builds: 13 failed, 159 passed, 223 errors,
 346 warnings (next-20240226)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 172 builds: 13 failed, 159 passed, 223 errors, 346 warni=
ngs (next-20240226)
...
Tree: next
Branch: master
Git Describe: next-20240226
Git Commit: 8552c902efe7ef670b6961fb8885b67961aeb629
...
Errors summary:
    ...
    14   arch/arm64/include/asm/cmpxchg.h:135:21: error: unknown type name =
=E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/cmpxchg.h:135:11: error: unknown type name =
=E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/cmpxchg.h:134:48: error: unknown type name =
=E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/cmpxchg.h:134:15: error: unknown type name =
=E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_lse.h:286:55: error: unknown type na=
me =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_lse.h:286:45: error: unknown type na=
me =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_lse.h:286:34: error: unknown type na=
me =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_lse.h:285:24: error: unknown type na=
me =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_ll_sc.h:306:57: error: unknown type =
name =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_ll_sc.h:306:47: error: unknown type =
name =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_ll_sc.h:306:36: error: unknown type =
name =E2=80=98u128=E2=80=99
    14   arch/arm64/include/asm/atomic_ll_sc.h:305:24: error: unknown type =
name =E2=80=98u128=E2=80=99
    7    arch/arm64/include/asm/atomic_ll_sc.h:298:2: error: unknown type n=
...
-Wcpp]
    7    arch/arm64/include/asm/memory.h:300:15: warning: cast from pointer=
 to integer of different size [-Wpointer-to-int-cast]
    7    arch/arm64/include/asm/memory.h:243:9: warning: cast from pointer =
to integer of different size [-Wpointer-to-int-cast]
...
erequisite 'interrupt_provider'
    1    arch/arc/boot/dts/vdk_axs10x_mb.dtsi:36.18-47.5: Warning (interrup=
...
rototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    1    ........................................../arch/sparc/kernel/traps=
_64.c:253:6: warning: no previous prototype for =E2=80=98is_no_fault_except=
ion=E2=80=99 [-Wmissing-prototypes]
...
:253:6: warning: no previous prototype for =E2=80=98is_no_fault_exception=
=E2=80=99 [-Wmissing-prototypes]
