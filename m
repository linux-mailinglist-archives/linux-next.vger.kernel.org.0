...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B9D1957DA95
	for <lists+linux-next@lfdr.de>; Fri, 22 Jul 2022 09:04:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230089AbiGVHEk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 22 Jul 2022 03:04:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59124 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229505AbiGVHEj (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 22 Jul 2022 03:04:39 -0400
Received: from mx0a-001b2d01.pphosted.com (mx0a-001b2d01.pphosted.com [148.163.156.1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1BA628D5C5;
        Fri, 22 Jul 2022 00:04:38 -0700 (PDT)
Received: from pps.filterd (m0098404.ppops.net [127.0.0.1])
        by mx0a-001b2d01.pphosted.com (8.17.1.5/8.17.1.5) with ESMTP id 26M6k0n7028370;
        Fri, 22 Jul 2022 07:04:24 GMT
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from : content-type :
 mime-version : subject : message-id : date : cc : to; s=pp1;
 bh=3pHs0bM4FbkCRN2rGPFeut83OnuLsPZcNWXVUW0/K5I=;
 b= FQ== 
Received: from ppma01fra.de.ibm.com (46.49.7a9f.ip4.static.sl-reverse.com [159.122.73.70])
        by mx0a-001b2d01.pphosted.com (PPS) with ESMTPS id 3hfpws0e10-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 22 Jul 2022 07:04:23 +0000
Received: from pps.filterd (ppma01fra.de.ibm.com [127.0.0.1])
        by ppma01fra.de.ibm.com (8.16.1.2/8.16.1.2) with SMTP id 26M6oq7C012643;
        Fri, 22 Jul 2022 07:04:20 GMT
Received: from b06cxnps4076.portsmouth.uk.ibm.com (d06relay13.portsmouth.uk.ibm.com [9.149.109.198])
        by ppma01fra.de.ibm.com with ESMTP id 3hbmy900q7-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Fri, 22 Jul 2022 07:04:20 +0000
Received: from d06av23.portsmouth.uk.ibm.com (d06av23.portsmouth.uk.ibm.com [9.149.105.59])
        by b06cxnps4076.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 26M74HMi20709812
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Fri, 22 Jul 2022 07:04:17 GMT
Received: from d06av23.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id A33ECA4055;
        Fri, 22 Jul 2022 07:04:17 +0000 (GMT)
Received: from d06av23.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id E7F0CA4053;
        Fri, 22 Jul 2022 07:04:15 +0000 (GMT)
Received: from smtpclient.apple (unknown [9.43.2.239])
        by d06av23.portsmouth.uk.ibm.com (Postfix) with ESMTP;
        Fri, 22 Jul 2022 07:04:15 +0000 (GMT)
From:   Sachin Sant <sachinp@linux.ibm.com>
Content-Type: multipart/mixed;
        boundary="Apple-Mail=_F1E7E019-0FCD-4F3B-933D-05050B752459"
Mime-Version: 1.0 (Mac OS X Mail 16.0 \(3696.100.31\))
Subject: [next-20220721] Build failure powerpc (tools/bpf)
Message-Id: <4A5CBF60-9590-417D-ADE7-7C6FDA8520DB@linux.ibm.com>
Date:   Fri, 22 Jul 2022 12:34:14 +0530
Cc:     linux-next@vger.kernel.org,
        open list <linux-kernel@vger.kernel.org>
To:     linuxppc-dev@lists.ozlabs.org, andrii@kernel.org
X-Mailer: Apple Mail (2.3696.100.31)
X-TM-AS-GCONF: 00
X-Proofpoint-GUID: JrBtskFe8P12yUvEu5c2ljiQkJGAOjQU
X-Proofpoint-ORIG-GUID: JrBtskFe8P12yUvEu5c2ljiQkJGAOjQU
X-Proofpoint-Virus-Version: vendor=baseguard
 engine=ICAP:2.0.205,Aquarius:18.0.883,Hydra:6.0.517,FMLib:17.11.122.1
 definitions=2022-07-21_28,2022-07-21_02,2022-06-22_01
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 mlxscore=0 phishscore=0
 priorityscore=1501 impostorscore=0 malwarescore=0 suspectscore=0
 lowpriorityscore=0 bulkscore=0 spamscore=0 clxscore=1011 mlxlogscore=776
...
--Apple-Mail=_F1E7E019-0FCD-4F3B-933D-05050B752459
...
make[4]: *** [/home/linux-next/tools/build/Makefile.build:96: =
/home/linux-next/tools/bpf/resolve_btfids/libbpf/staticobjs/libbpf.o] =
Error 1
make[3]: *** [Makefile:157: =
/home/linux-next/tools/bpf/resolve_btfids/libbpf/staticobjs/libbpf-in.o] =
Error 2
make[2]: *** [Makefile:55: =
/home/linux-next/tools/bpf/resolve_btfids//libbpf/libbpf.a] Error 2
...
# Linux/powerpc 5.19.0-rc7 Kernel Configuration
#
