Return-Path: <linux-next+bounces-378-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E1E0810B7E
	for <lists+linux-next@lfdr.de>; Wed, 13 Dec 2023 08:30:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 2C968B212BE
	for <lists+linux-next@lfdr.de>; Wed, 13 Dec 2023 07:30:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 501311C693;
	Wed, 13 Dec 2023 07:29:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="ZLuYBMdS"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-oi1-x22f.google.com (mail-oi1-x22f.google.com [IPv6:2607:f8b0:4864:20::22f])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 42312AD
	for <linux-next@vger.kernel.org>; Tue, 12 Dec 2023 23:29:47 -0800 (PST)
Received: by mail-oi1-x22f.google.com with SMTP id 5614622812f47-3b9dd6886e2so2650641b6e.3
        for <linux-next@vger.kernel.org>; Tue, 12 Dec 2023 23:29:47 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1702452586; x=1703057386; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=0yByrUbIXXzZ/tD0h6IKoJ10LyB170IlrTcF7dx3c38=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702452586; x=1703057386;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=0yByrUbIXXzZ/tD0h6IKoJ10LyB170IlrTcF7dx3c38=;
        b=
X-Gm-Message-State: AOJu0YzWnOfBbVr7Yli9yY3kScf4/kjfNzbj8UXA0UXQwwVFY7+k9R1/
	rHFjxwSQY54pKlwx3Sn+um5JB6cVGsAYYx7P9Y9C/g==
X-Google-Smtp-Source: AGHT+IE/P0WZnwoRxIYhqLZLRB7br7LOIOb7cn2O+1mtyrKc/Hqmnu615BSS2DnN0K1ew84Zby2xMQ==
X-Received: by 2002:a05:6808:f91:b0:3b8:b13b:8aea with SMTP id o17-20020a0568080f9100b003b8b13b8aeamr5916711oiw.14.1702452584352;
        Tue, 12 Dec 2023 23:29:44 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id l2-20020a6542c2000000b005c621e0de25sm7988575pgp.71.2023.12.12.23.29.43
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 12 Dec 2023 23:29:43 -0800 (PST)
Message-ID: <65795d67.650a0220.feca6.7472@mx.google.com>
Date: Tue, 12 Dec 2023 23:29:43 -0800 (PST)
...
Subject: next/master build: 186 builds: 38 failed, 148 passed, 38 errors,
 374 warnings (next-20231213)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 186 builds: 38 failed, 148 passed, 38 errors, 374 warnin=
gs (next-20231213)
...
Tree: next
Branch: master
Git Describe: next-20231213
Git Commit: 48e8992e33abf054bcc0bb2e77b2d43bb899212e
...
_cache_init'
    1    fs/proc/task_mmu.c:2131:21: error: 'HPAGE_SIZE' undeclared (first =
...
_cache_init'
    1    arch/mips/include/asm/cmpxchg.h:83:11: error: call to =E2=80=98__x=
...
us prototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    1    .........../arch/sparc/kernel/traps_64.c:253:6: warning: no previo=
us prototype for =E2=80=98is_no_fault_exception=E2=80=99 [-Wmissing-prototy=
pes]
    1    ............................................./arch/sparc/prom/misc=
_64.c:165:5: warning: no previous prototype for =E2=80=98prom_get_mmu_ihand=
...
Errors:
    fs/proc/task_mmu.c:2131:21: error: 'HPAGE_SIZE' undeclared (first use i=
...
Warnings:
    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    .........../arch/sparc/kernel/traps_64.c:253:6: warning: no previous pr=
...
:165:5: warning: no previous prototype for =E2=80=98prom_get_mmu_ihandle=E2=
