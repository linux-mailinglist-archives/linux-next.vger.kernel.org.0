...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 213C144A508
	for <lists+linux-next@lfdr.de>; Tue,  9 Nov 2021 03:55:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242007AbhKIC6i (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 8 Nov 2021 21:58:38 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:59711 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241851AbhKIC6b (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 8 Nov 2021 21:58:31 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HpCKD37L7z4xcM;
        Tue,  9 Nov 2021 13:55:44 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1636426544;
        bh=VoFNk8fPfKdLH+evH46DB/D4npdz01Q7UknpTc61M7c=;
        h=Date:From:To:Cc:Subject:In-Reply-To:References:From;
        b=
Date:   Tue, 9 Nov 2021 13:55:43 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: Re: linux-next: Tree for Nov 9
Message-ID: <20211109135543.00b9f6a4@canb.auug.org.au>
In-Reply-To: <20211109135449.7850eac3@canb.auug.org.au>
References: <20211109135449.7850eac3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/wrLAGA0N_71SzER3.5v0Ac7";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/wrLAGA0N_71SzER3.5v0Ac7
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

On Tue, 9 Nov 2021 13:54:49 +1100 Stephen Rothwell <sfr@canb.auug.org.au> w=
rote:
>
...
Merging origin/master (d2f38a3c6507 Merge tag 'backlight-next-5.16' of git:=
...
Merging net/master (c45231a7668d litex_liteeth: Fix a double free in the re=
move function)
...
_qp on the GSI QP)
Merging sound-current/for-linus (43d35ccc36da ALSA: pci: rme: Fix unaligned=
 buffer addresses)
...
emote object copies)
Merging cifs/for-next (49bd49f983b5 cifs: send workstation name during ntlm=
ssp session setup)
...
Merging gfs2/for-next (a7ac203d8fd3 gfs2: Fix "Introduce flag for glock hol=
der auto-demotion")
...
Merging drm-misc/for-linux-next (d89c0c8322ec drm/virtio: Fix NULL derefere=
nce error in virtio_gpu_poll)
...
Merging sound/for-next (411ac2982cb6 ALSA: firewire-motu: add support for M=
OTU Track 16)
...
Merging block/for-next (7466c30966dd Merge branch 'io_uring-5.16' into for-=
next)
...
Merging akpm-current/current (96b35b40f5c2 kernel.h: split out instruction =
pointer accessors)
...
Merging akpm/master (a397b4485fea kasan: add kasan mode messages when kasan=
 init)
...

=uMP/
-----END PGP SIGNATURE-----
