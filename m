...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2622842A159
	for <lists+linux-next@lfdr.de>; Tue, 12 Oct 2021 11:46:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235774AbhJLJsM (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 12 Oct 2021 05:48:12 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:60221 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235581AbhJLJsL (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 12 Oct 2021 05:48:11 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HT9lh5rQNz4xbT;
        Tue, 12 Oct 2021 20:46:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1634031969;
        bh=bpr492L3Sfq4dVc3LQx7o6/QOX4s79w38b6Re/RIJlg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 12 Oct 2021 20:46:06 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 12
Message-ID: <20211012204606.1dd72037@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/a9PmaN1uE4i=4O/I07mKCIz";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/a9PmaN1uE4i=4O/I07mKCIz
...
The arm-soc tree gained a build failure for which I added a patch.
...
The amdgpu tree regained its build failure so I used the version from
next-20211007 again.

The iommu tree gained a semantic conflict against the pci tree.

The rcu tree gained a conflict against the tip tree.

Non-merge commits (relative to Linus' tree): 6890
 6740 files changed, 388355 insertions(+), 159464 deletions(-)
...
T)
Merging sound-current/for-linus (228af5a4fa3a ALSA: pcm: Workaround for a w=
rong offset in SYNC_PTR compat ioctl)
Merging sound-asoc-fixes/for-linus (2a242b54080b Merge remote-tracking bran=
...
Merging drm-misc-fixes/for-linux-next-fixes (55ec085ce470 drm/r128: fix bui=
ld for UML)
...
nto for-next)
Merging samsung-krzk/for-next (6c44b39e8b12 Merge branch 'for-v5.16/dts-ris=
cv' into for-next)
...
Merging hwmon-staging/hwmon-next (c3361ee93a64 hwmon: (adt7x10) Make adt7x1=
...
Merging net-next/master (ff7f0e4e7930 Merge branch 'nfc-minor-printk-cleanu=
p')
...
e.c
Merging drm-misc/for-linux-next (ee30840ba3ba drm/v3d: fix copy_from_user()=
 error codes)
$ git reset --hard HEAD^
Merging next-20211011 version of drm-misc
Merging amdgpu/drm-next (b75c0a544e86 drm/amdgpu: drop navi reg init functi=
ons)
$ git reset --hard HEAD^
...
Merging sound-asoc/for-next (0fc05b310185 Merge remote-tracking branch 'aso=
...
Merging block/for-next (bc421898241a Merge branch 'for-5.16/cdrom' into for=
-next)
Merging device-mapper/for-next (012a67c67932 dm: fix mempool NULL pointer r=
ace when completing IO)
Merging libata/for-next (8c0ff6af6823 Add AHCI support for ASM1062+JBM575 c=
ards)
...
Merging selinux/next (0550e9155dfb Current code contains a lot of racy patt=
erns when converting an ocontext's context structure to an SID. This is bei=
ng done in a "lazy" fashion, such that the SID is looked up in the SID tabl=
e only when it's first needed and then cached in the "sid" field of the oco=
ntext structure. However, this is done without any locking or memory barrie=
rs and is thus unsafe.)
...
Merging kvm-arm/next (1eb07f4b6853 Merge branch kvm-arm64/raz-sysregs into =
kvmarm-master/next)
...
Merging vfio/next (052493d5534a Merge branch 'v5.16/vfio/diana-fsl-reset-v2=
' into v5.16/vfio/next)
...

=Ea/E
-----END PGP SIGNATURE-----
