...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1280D23C790
	for <lists+linux-next@lfdr.de>; Wed,  5 Aug 2020 10:16:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725920AbgHEIOJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 5 Aug 2020 04:14:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51608 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728032AbgHEIN3 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 5 Aug 2020 04:13:29 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9885BC06174A;
        Wed,  5 Aug 2020 01:13:28 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BM4BX4l8Hz9sTH;
        Wed,  5 Aug 2020 18:13:24 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1596615204;
        bh=WYiCBgMjK2i/saQhbAanfJ8gHKCL2Uk7+RnGZZ5av40=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 5 Aug 2020 18:13:21 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 5
Message-ID: <20200805181321.3c004d34@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/G6ZhU4DwzuQIz_FqCi43=q1";
...
The fsinfo tree gained a conflict against the kbuid tree.

Non-merge commits (relative to Linus' tree): 10226
 10594 files changed, 541010 insertions(+), 185519 deletions(-)
...
Merging origin/master (4f30a60aa784 Merge tag 'close-range-v5.9' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/brauner/linux)
...
Merging sound-current/for-linus (cd72c317a0a1 ALSA: hda/hdmi: Add quirk to =
force connectivity)
...
Merging mips/mips-next (82ad03db0505 MAINTAINERS: Update KVM/MIPS maintaine=
rs)
Merging nds32/next (0a2e478902c7 nds32: use get_kernel_nofault in dump_mem)
Merging nios2/for-next (6b57fa4d374b nios2: signal: Mark expected switch fa=
ll-through)
Merging openrisc/for-next (8739418cb569 openrisc: uaccess: Add user address=
 space check to access_ok)
Merging parisc-hd/for-next (e2693ec1e0a1 parisc: make the log level string =
for register dumps const)
Merging powerpc/next (0c83b277ada7 powerpc: Fix circular dependency between=
 percpu.h and mmu.h)
...
Merging ceph/master (5458b77ba8af ceph: handle zero-length feature mask in =
session messages)
...
ible-array member)
Merging nfs/linux-next (b66577b91a9b SUNRPC dont update timeout value on co=
nnection reset)
...
Merging pci/next (7cf74e177ccb Merge branch 'pci/irq-error')
...
in imxfb_probe())
Merging pm/linux-next (2baa85d6927d Merge tag 'acpi-5.9-rc1' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
...
Merging net-next/master (4c900a6b4e05 farsync: switch from 'pci_' to 'dma_'=
 API)
...
Merging mac80211-next/master (da7955405fb2 sfc: Fix build with CONFIG_RFS_A=
CCEL disabled.)
...
Merging sound/for-next (cd72c317a0a1 ALSA: hda/hdmi: Add quirk to force con=
nectivity)
...
Merging watchdog/master (dc8782b3e5da watchdog: rti-wdt: balance pm runtime=
 enable calls)
...
12.8.0.3)
Merging vhost/linux-next (d4b79c9e637d virtio_pci_modern: Fix the comment o=
f virtio_pci_find_capability())
...
Merging fpga/for-next (e9738f2d66bb fpga: stratix10-soc: make FPGA task un-=
interruptible)
...
Merging fsinfo/fsinfo-core (a78f7bb785ca fsinfo: Fix a couple of warnings)
...
Merging akpm/master (1e05a16edc09 virtio: pci: constify ioreadX() iomem arg=
...

=62Wf
-----END PGP SIGNATURE-----
