Return-Path: <linux-next+bounces-758-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id D80EC8311D8
	for <lists+linux-next@lfdr.de>; Thu, 18 Jan 2024 04:32:06 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 080FA1C21D3E
	for <lists+linux-next@lfdr.de>; Thu, 18 Jan 2024 03:32:06 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B5AED6104;
	Thu, 18 Jan 2024 03:32:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="TR/Dmt0m"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5EE36612E;
	Thu, 18 Jan 2024 03:31:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705548723; cv=none; b=uAnC8f4RCCp062GS1uCLTsVhUCJOQ/6PiriGl63ukArJZSIXCLKztxmRu2Oox0wbEmDPt/OGdUpwCj7nBoWI6RnkElUOcivjvwPM+VlBt6873YDDClncwhDbSn8zCok9chSSNCBWsLbrn2AKwzUf4/uPeT2cFS23yTsPwf3G5Sg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705548723; c=relaxed/simple;
	bh=/1c4hqT4ICqxpK6hLfN683VSg3Zm0HpHuNIH+gMA5UI=;
	h=DKIM-Signature:Received:Date:From:To:Cc:Subject:Message-ID:
	 MIME-Version:Content-Type; b=JB1GG2ev3m4pERIC6ssECftDy9H5hP3wn0uPgqhSjLTOLvS9KBx3OgGMTGIC9AMoQwZKlwVd91sGrGraOa+vueB2OGgu/e0RbJ02lEYQoevSx35kayVrO+Sr6QLxlYN6TmuPixh9RNXF2W0RctNJbWl0ZYnUU+r3XWrieWR3fgM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=TR/Dmt0m; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1705548714;
	bh=jN/un3LQ+hIBQPi4iwhYizO7s5hCbwrksR+2K/UToDU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TFpFk2tYcz4xPY;
	Thu, 18 Jan 2024 14:31:54 +1100 (AEDT)
Date: Thu, 18 Jan 2024 14:31:52 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 18
Message-ID: <20240118143152.3c34b117@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/m=u7AZlFSibHTH4R7=QRyFO";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/m=u7AZlFSibHTH4R7=QRyFO
...
Non-merge commits (relative to Linus' tree): 2939
 2904 files changed, 98749 insertions(+), 60242 deletions(-)
...
Merging origin/master (82fd5ee9d8a5 Merge tag 'for-linus-6.8-rc1-tag' of gi=
...
Merging net/main (ea937f772083 net: netdevsim: don't try to destroy PHC on =
VFs)
...
Merging netfilter/main (080898f8e782 netfilter: ipset: fix performance regr=
ession in swap operation)
...
Merging ceph/master (c44f04bff405 rbd: don't move requests to the running l=
ist on errors)
Merging cifs/for-next (a1ac095871e6 Update MAINTAINERS email address)
...
Merging block/for-next (baec4e4d14be Merge branch 'for-6.8/block' into for-=
next)
...

=CYJZ
-----END PGP SIGNATURE-----
