19
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 24 Mar 2024 21:05:19 -0700 (PDT)
Message-ID: <6600f7ff.050a0220.4eb74.8523@mx.google.com>
Date: Sun, 24 Mar 2024 21:05:19 -0700 (PDT)
...
Subject: next/master build: 173 builds: 12 failed, 161 passed, 13 errors,
 331 warnings (next-20240325)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 173 builds: 12 failed, 161 passed, 13 errors, 331 warnin=
gs (next-20240325)
...
Tree: next
Branch: master
Git Describe: next-20240325
Git Commit: 1fdad13606e104ff103ca19d2d660830cb36d43e
...
arc:
    ...
    axs103_defconfig (gcc-10): 1 error, 5 warnings
    axs103_smp_defconfig (gcc-10): 2 errors, 6 warnings
    haps_hs_defconfig (gcc-10): 1 error, 4 warnings
    haps_hs_smp_defconfig (gcc-10): 1 error, 5 warnings
    haps_hs_smp_defconfig+debug (gcc-10): 1 error, 5 warnings
    haps_hs_smp_defconfig+kselftest (gcc-10): 2 errors, 6 warnings
    hsdk_defconfig (gcc-10): 1 error, 4 warnings
    nsimosci_hs_defconfig (gcc-10): 1 error, 5 warnings
    nsimosci_hs_smp_defconfig (gcc-10): 1 error, 5 warnings
    tinyconfig (gcc-10): 1 warning
    vdk_hs38_defconfig (gcc-10): 1 error, 4 warnings
    vdk_hs38_smp_defconfig (gcc-10): 1 error, 4 warnings
...
Errors summary:
    ...
    13   arch/arc/include/asm/mmu-arcv2.h:82:2: error: implicit declaration=
 of function 'write_aux_reg' [-Werror=3Dimplicit-function-declaration]
...
ype for =E2=80=98ath79_cpu_irq_init=E2=80=99 [-Wmissing-prototypes]
    1    drivers/gpu/drm/imagination/pvr_vm_mips.c:106:49: warning: implici=
...
t an interrupt provider
    ...
    1    ............./arch/sparc/kernel/traps_64.c:2035:6: warning: no pre=
vious prototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
...
---------------------------------------------------------------------------=
-----
axs103_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnings, 0 secti=
on mismatches

Errors:
    arch/arc/include/asm/mmu-arcv2.h:82:2: error: implicit declaration of f=
unction 'write_aux_reg' [-Werror=3Dimplicit-function-declaration]
...
---------------------------------------------------------------------------=
-----
axs103_smp_defconfig (arc, gcc-10) =E2=80=94 FAIL, 2 errors, 6 warnings, 0 =
section mismatches
...
Warnings:
    drivers/gpu/drm/imagination/pvr_vm_mips.c:106:49: warning: implicit con=
...
---------------------------------------------------------------------------=
-----
haps_hs_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 4 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig+debug (arc, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnin=
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig+kselftest (arc, gcc-10) =E2=80=94 FAIL, 2 errors, 6 w=
...
---------------------------------------------------------------------------=
-----
hsdk_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 4 warnings, 0 section=
 mismatches
...
---------------------------------------------------------------------------=
-----
nsimosci_hs_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
nsimosci_hs_smp_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnings=
, 0 section mismatches
...
Warnings:
    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    ...................................../arch/sparc/kernel/traps_64.c:253:=
6: warning: no previous prototype for =E2=80=98is_no_fault_exception=E2=80=
...
---------------------------------------------------------------------------=
-----
vdk_hs38_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 4 warnings, 0 sec=
tion mismatches
...
---------------------------------------------------------------------------=
-----
vdk_hs38_smp_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 4 warnings, 0=
 section mismatches
