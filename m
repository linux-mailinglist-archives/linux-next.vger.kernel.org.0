...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 416E42D4041
	for <lists+linux-next@lfdr.de>; Wed,  9 Dec 2020 11:47:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730071AbgLIKpf (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 9 Dec 2020 05:45:35 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58344 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730084AbgLIKpd (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 9 Dec 2020 05:45:33 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 24EA3C061794;
        Wed,  9 Dec 2020 02:44:53 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CrYb60nCpz9sWK;
        Wed,  9 Dec 2020 21:44:50 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1607510690;
        bh=qC0y+rr9HnEg7Z2dONvsojHL3kJcNnsPlMDjhk/9kM0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 9 Dec 2020 21:44:47 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 9
Message-ID: <20201209214447.3bfdeb87@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/eeS3cOcjVKgVLz.aBhmktxI";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/eeS3cOcjVKgVLz.aBhmktxI
...
Merging origin/master (7d8761ba27fc Merge branch 'fixes' of git://git.kerne=
...
Merging arm-soc-fixes/arm/fixes (db2082700a0c MAINTAINERS: add a limited AR=
M and ARM64 SoC entry)
...
Merging net/master (007ab5345545 bonding: fix feature flag setting at init =
time)
Merging bpf/master (932c60558109 tools/bpftool: Fix PID fetching with a lot=
 of results)
Merging ipsec/master (48f486e13ffd net: xfrm: fix memory leak in xfrm_user_=
policy())
Merging netfilter/master (cc00bcaa5899 netfilter: x_tables: Switch synchron=
ization to RCU)
...
Merging mac80211/master (bdeca45a0cc5 mac80211: set SDATA_STATE_RUNNING for=
 monitor interfaces)
Merging rdma-fixes/for-rc (e432c04c1799 RDMA/core: Fix empty gid table for =
non IB/RoCE devices)
Merging sound-current/for-linus (5cfca59604e4 ALSA: hda/realtek - Enable he=
adset mic of ASUS X430UN with ALC256)
Merging sound-asoc-fixes/for-linus (d867203b1bb8 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (cea96c618d09 Merge remote-tracking branch 'spi=
...
t)
Merging arm64/for-next/core (84944efaa859 Merge remote-tracking branch 'arm=
...
Merging arm-soc/for-next (ddfbed60c560 Merge branch 'arm/defconfig' into fo=
r-next)
...
ession->s_seq)
Merging cifs/for-next (2494367d9d48 cifs: Fix fall-through warnings for Cla=
ng)
...
ag())
Merging f2fs/dev (104405f8936c f2fs: fix to account inline xattr correctly =
during recovery)
...
rkqueue.)
Merging nfs-anna/linux-next (a411eec816bd SUNRPC: Check if the buffer has f=
ewer bytes than requested)
...
Merging jc_docs/docs-next (547f574fd9d5 docs: Update documentation to refle=
ct what TAINT_CPU_OUT_OF_SPEC means)
...
in imxfb_probe())
Merging pm/linux-next (717f8fce803b Merge branches 'acpi-scan', 'acpi-resou=
rces', 'acpi-video' and 'acpi-platform' into linux-next)
...
Merging net-next/master (afae3cc2da10 net: atheros: simplify the return exp=
ression of atl2_phy_setup_autoneg_adv())
Applying: fix up for "xdp: Handle MEM_TYPE_XSK_BUFF_POOL correctly in xdp_r=
eturn_buff()"
Merging bpf-next/for-next (8bdd8e275ede bpf: Return -ENOTSUPP when attachin=
g to non-kernel BTF)
...
REJECT action)
Merging wireless-drivers-next/master (18572b0b5493 zd1201: Fix fall-through=
 warnings for Clang)
...
Merging sound/for-next (ac2250ab723c ALSA: hda/ca0132 - Unmute surround whe=
n speaker output is selected.)
Merging sound-asoc/for-next (08687fbd8ffd Merge remote-tracking branch 'aso=
...
ake)
Merging block/for-next (3e57b31485c6 Merge branch 'for-5.11/drivers' into f=
or-next)
...
Merging devicetree/for-next (e5dddbedfe09 dt-bindings: add ADP5585/ADP5589 =
entries to trivial-devices)
Merging mailbox/mailbox-for-next (017909281eb0 mailbox: stm32-ipcc: cast vo=
id pointers to unsigned long)
Merging spi/for-next (37e85f1309a7 Merge remote-tracking branch 'spi/for-5.=
11' into spi-next)
...
y 'kvm_run' cleanup)
Merging kvm-arm/next (94d79b0b3ac1 Merge remote-tracking branch 'origin/kvm=
...
Merging usb/usb-next (08a02f954b0d USB: add RESET_RESUME quirk for Snapscan=
 1212)
...
_rts())
Merging usb-chipidea-next/for-usb-next (94e0623337a6 usb: cdns3: fix warnin=
g when USB_CDNS_HOST is not set)
...
Merging staging/staging-next (19cf9d7afc2e staging: rtl8723bs: remove LIST_=
CONTAINOR)
...
Merging scsi-mkp/for-next (b320fa4cb3bf scsi: ufs-pci: Enable UFSHCD_CAP_RP=
M_AUTOSUSPEND for Intel controllers)
...
Applying: powerpc: Add .data..Lubsan_data*/.data..Lubsan_type* sections exp=
licitly
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (fbbf228537d1 secretmem: test: add basic selftest for m=
emfd_secret(2))
...

=+Hve
-----END PGP SIGNATURE-----
