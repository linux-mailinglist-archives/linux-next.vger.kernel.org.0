...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F12AB3779D1
	for <lists+linux-next@lfdr.de>; Mon, 10 May 2021 03:35:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230114AbhEJBgF (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 9 May 2021 21:36:05 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:50999 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230034AbhEJBgE (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sun, 9 May 2021 21:36:04 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FdkBW2x2rz9tl2;
        Mon, 10 May 2021 11:34:59 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1620610499;
        bh=tnSr1K1LFmrqe2JoFWqmxwfEw7nA5oI13XImxN9lrOI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 10 May 2021 11:34:57 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 10
Message-ID: <20210510113457.614ea1d7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=i4RZ0IAFmONPCpNAcZhtAl";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/=i4RZ0IAFmONPCpNAcZhtAl
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210507:

The amdgpu tree still had its build failure so I used the version from
next-20210504.

Non-merge commits (relative to Linus' tree): 628
 667 files changed, 58767 insertions(+), 3051 deletions(-)
...
Merging s390-fixes/fixes (a48b0872e694 Merge branch 'akpm' (patches from An=
drew))
Merging sparc/master (05a59d79793d Merge git://git.kernel.org:/pub/scm/linu=
x/kernel/git/netdev/net)
Merging fscrypt-current/for-stable (d19d8d345eec fscrypt: fix inline encryp=
tion not used on new files)
Merging net/master (b741596468b0 Merge tag 'riscv-for-linus-5.13-mw1' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
...
Merging mac80211/master (a6f8ee58a8e3 tcp: Specify cmsgbuf is user pointer =
for receive zerocopy.)
Merging rdma-fixes/for-rc (d434405aaab7 Linux 5.12-rc7)
Merging sound-current/for-linus (c1b550294938 ALSA: hda: fixup headset for =
ASUS GU502 laptop)
...
vulnerability)
Merging driver-core.current/driver-core-linus (dd860052c99b Merge tag 'tag-=
chrome-platform-for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git=
/chrome-platform/linux)
Merging tty.current/tty-linus (dd860052c99b Merge tag 'tag-chrome-platform-=
for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform=
/linux)
Merging usb.current/usb-linus (dd860052c99b Merge tag 'tag-chrome-platform-=
for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform=
/linux)
...
Merging staging.current/staging-linus (dd860052c99b Merge tag 'tag-chrome-p=
latform-for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-=
platform/linux)
Merging iio-fixes/fixes-togreg (ca7cb955f315 iio: tsl2583: Fix division by =
a zero lux_val)
Merging char-misc.current/char-misc-linus (dd860052c99b Merge tag 'tag-chro=
me-platform-for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chr=
ome-platform/linux)
...
Merging spdx/spdx-linus (dd860052c99b Merge tag 'tag-chrome-platform-for-v5=
.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/linux)
...
Merging risc-v/for-next (beaf5ae15a13 riscv: remove unused handle_exception=
 symbol)
Merging s390/for-next (a48b0872e694 Merge branch 'akpm' (patches from Andre=
w))
...
ret)
Merging net-next/master (b741596468b0 Merge tag 'riscv-for-linus-5.13-mw1' =
of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
...
Merging sound/for-next (c1b550294938 ALSA: hda: fixup headset for ASUS GU50=
2 laptop)
...
rite functions)
Merging tomoyo/master (a48b0872e694 Merge branch 'akpm' (patches from Andre=
w))
...
Merging driver-core/driver-core-next (dd860052c99b Merge tag 'tag-chrome-pl=
atform-for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-p=
latform/linux)
Merging usb/usb-next (dd860052c99b Merge tag 'tag-chrome-platform-for-v5.13=
' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/linux)
...
Merging tty/tty-next (dd860052c99b Merge tag 'tag-chrome-platform-for-v5.13=
' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/linux)
Merging char-misc/char-misc-next (dd860052c99b Merge tag 'tag-chrome-platfo=
rm-for-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platf=
orm/linux)
...
IO_MDEV)
Merging staging/staging-next (dd860052c99b Merge tag 'tag-chrome-platform-f=
or-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/chrome-platform/=
linux)
...
Merging akpm/master (076f4112bf61 memfd_secret: use unsigned int rather tha=
...

=IZ+B
-----END PGP SIGNATURE-----
