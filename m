...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3E55C2956E2
	for <lists+linux-next@lfdr.de>; Thu, 22 Oct 2020 05:41:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2895505AbgJVDlb (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 21 Oct 2020 23:41:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46296 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2895501AbgJVDla (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 21 Oct 2020 23:41:30 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 40D5EC0613CE;
        Wed, 21 Oct 2020 20:41:30 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CGtSl50m9z9sT6;
        Thu, 22 Oct 2020 14:41:27 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1603338087;
        bh=tMOkltGfcnPWsb1rfqvbCbcWITFkZq0i0LSMyfcBhwI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 22 Oct 2020 14:41:26 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 22
Message-ID: <20201022144126.67d0cad9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/0rVoKYmIaz.gIxmn==8YzOo";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/0rVoKYmIaz.gIxmn==8YzOo
...
Merging bpf/master (c5eb48e89286 bpf, doc: Fix patchwork URL to point to ke=
rnel.org instance)
...
probe())
Merging staging.current/staging-linus (c4d6fe731176 Merge tag 'xarray-5.9' =
of git://git.infradead.org/users/willy/xarray)
...
Merging cifs/for-next (c0208642bc18 cifs: move smb version mount options in=
to fs_context.c)
...
ible-array member)
Merging nfs/linux-next (c4d6fe731176 Merge tag 'xarray-5.9' of git://git.in=
fradead.org/users/willy/xarray)
...
Merging xfs/for-next (0e301d40d267 xfs: cancel intents immediately if proce=
ss_intents fails)
...
Merging file-locks/locks-next (c4d6fe731176 Merge tag 'xarray-5.9' of git:/=
/git.infradead.org/users/willy/xarray)
...
Merging jc_docs/docs-next (030f066f677f docs: submitting-patches: describe =
preserving review/test tags)
Merging v4l-dvb/master (c386e0797d26 media: dvb-frontends/drxk_hard.c: fix =
uninitialized variable warning)
Merging v4l-dvb-next/master (264d4b6e6589 docs: fs: api-summary.rst: get ri=
d of kernel-doc include)
Merging fbdev/fbdev-for-next (732146a3f1dc video: fbdev: imxfb: fix a typo =
in imxfb_probe())
Merging pm/linux-next (3b1afc4e84bf Merge branch 'pm-core' into linux-next)
...
sm2)
Merging drm/drm-next (fea456d82c19 drm/ttm: fix eviction valuable range che=
ck.)
...
Merging xen-tip/linux-next (4553350ffe53 xen-blkfront: Apply changed parame=
ter name to the document)
...
Merging staging/staging-next (c4d6fe731176 Merge tag 'xarray-5.9' of git://=
git.infradead.org/users/willy/xarray)
...
Merging vhost/linux-next (88a0d60c6445 MAINTAINERS: add URL for virtio-mem)
...
Merging akpm/master (7667abe50b3c selftests/vm: fix an improper dependency =
...

=4Gve
-----END PGP SIGNATURE-----
