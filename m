...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E800A20EFD3
	for <lists+linux-next@lfdr.de>; Tue, 30 Jun 2020 09:50:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731139AbgF3Hum (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 30 Jun 2020 03:50:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48588 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731033AbgF3Huk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 30 Jun 2020 03:50:40 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 20697C061755;
        Tue, 30 Jun 2020 00:50:40 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49wxNr752wz9sDX;
        Tue, 30 Jun 2020 17:50:36 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1593503437;
        bh=WuWBavabYwoZn6K7qhQxIA9DCKBp9q5b1oFt4xYUktA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 30 Jun 2020 17:50:34 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 30
Message-ID: <20200630175034.6160472d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/TRdrNl/GqotsfHGshHakxMc";
...
The thunderbolt tree gained a semantic conflict against the kunit-next
tree.

Non-merge commits (relative to Linus' tree): 3729
 4213 files changed, 298207 insertions(+), 76227 deletions(-)
...
Merging net/master (a9b111016235 llc: make sure applications use ARPHRD_ETH=
ER)
...
Merging devicetree-fixes/dt/linus (16c20bf754c9 dt-bindings: copy process-s=
chema-examples.yaml to process-schema.yaml)
...
r-next)
Merging scmi/for-linux-next (f9b6b20e1470 Merge branch 'for-next/scmi' of g=
...
Merging f2fs/dev (f4fc6cfb57b6 f2fs: avoid readahead race condition)
...
in imxfb_probe())
Merging pm/linux-next (4ebdb176f4ab Merge branch 'pm-em' into linux-next)
...
able function)
Merging net-next/master (5fb62372a020 Merge branch 'dpaa2-eth-send-a-scatte=
r-gather-FD-instead-of-realloc-ing')
Merging bpf-next/master (274217c08ede Merge branch 'bpf-multi-prog-prep')
...
ifi/iwlwifi-next)
Merging bluetooth/master (b10697350448 dt-bindings: net: bluetooth: realtek=
: Fix uart-has-rtscts example)
...
Merging drm-intel/for-linux-next (4003dac180d0 drm/i915: Clamp linetime wm =
to <64usec)
...
Merging drm-misc/for-linux-next (7e4e589db76a drm: pl111: Absorb the extern=
al register header)
...
y)
Merging block/for-next (0fd626b8b89d Merge branch 'for-5.9/io_uring' into f=
or-next)
...
Merging usb-gadget/next (1c11e74e9079 usb: dwc3: keystone: Turn on USB3 PHY=
 before controller)
Merging usb-serial/usb-next (9cf6ffae3800 Merge 5.8-rc3 into usb-next)
...
ts)
Merging thunderbolt/next (40c14d9f4f6d thunderbolt: Add KUnit tests for tun=
neling)
...
Merging akpm/master (907d7f1dbbb7 sh: add missing EXPORT_SYMBOL() for __del=
ay)
...

=v7W/
-----END PGP SIGNATURE-----
