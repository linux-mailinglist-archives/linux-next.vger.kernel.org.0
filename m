...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8354847C24A
	for <lists+linux-next@lfdr.de>; Tue, 21 Dec 2021 16:11:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234814AbhLUPLE (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 21 Dec 2021 10:11:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55642 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234171AbhLUPLD (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 21 Dec 2021 10:11:03 -0500
Received: from mail-pl1-x635.google.com (mail-pl1-x635.google.com [IPv6:2607:f8b0:4864:20::635])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 04D30C061574
        for <linux-next@vger.kernel.org>; Tue, 21 Dec 2021 07:11:03 -0800 (PST)
Received: by mail-pl1-x635.google.com with SMTP id x15so10583669plg.1
        for <linux-next@vger.kernel.org>; Tue, 21 Dec 2021 07:11:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=k1byl5p8KXgb2GQGn7kfSSaH3G8eyKhyotFL9UH/nrw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=k1byl5p8KXgb2GQGn7kfSSaH3G8eyKhyotFL9UH/nrw=;
        b=
X-Gm-Message-State: AOAM531scGKuiDEM+rRSxKeSEzexqCWmFv1fKacLzrfoc4dRlZDVjaW7
        OIVL//hc6UKuS4uyjJ9sGWUrYE+sH9BcPeKZ
X-Google-Smtp-Source: ABdhPJwaeDxKxjuUgcIzI7a0+g1FHFyUHXNfOWWJor6Pfg/hQ3cIUFa5UdvMdYHjQbnsQaWwxYVI3Q==
X-Received: by 2002:a17:902:9343:b0:148:a2e7:fb5f with SMTP id g3-20020a170902934300b00148a2e7fb5fmr3976044plp.160.1640099461365;
        Tue, 21 Dec 2021 07:11:01 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id w2sm18608809pgt.93.2021.12.21.07.11.00
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 21 Dec 2021 07:11:00 -0800 (PST)
Message-ID: <61c1ee84.1c69fb81.b7f39.277b@mx.google.com>
Date:   Tue, 21 Dec 2021 07:11:00 -0800 (PST)
...
Subject: next/master build: 204 builds: 15 failed, 189 passed, 59 errors,
 70 warnings (next-20211221)
...
next/master build: 204 builds: 15 failed, 189 passed, 59 errors, 70 warning=
s (next-20211221)
...
arm:
    allmodconfig (clang-13): 21 errors, 13 warnings
    aspeed_g5_defconfig (clang-13): 10 warnings
    at91_dt_defconfig (gcc-10): 1 warning
    multi_v5_defconfig (clang-13): 22 errors
...
Errors summary:
    ...
    21   arch/arm/include/asm/current.h:53:6: error: out of range pc-relati=
ve fixup value
    14   arch/arm/include/asm/percpu.h:40:28: error: out of range pc-relati=
ve fixup value
    5    arch/arm/include/asm/current.h:39:28: error: out of range pc-relat=
ive fixup value
...
ent of read-only location =E2=80=98*(dev->dev_addr + (sizetype)i)=E2=80=99
    1    drivers/firmware/arm_scmi/driver.c:869:6: error: variable 'i_' is =
...
7-a' [-Wunused-command-line-argument]
 ...
 to silence this warning
    3    drivers/firmware/arm_scmi/driver.c:869:6: warning: variable 'i_' i=
...
7-a' [-Wunused-command-line-argument]  AS      arch/arm/mm/l2c-l2x0-resume.o
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-13) =E2=80=94 FAIL, 21 errors, 13 warnings, 0 sect=
ion mismatches
...
xup value
    ...
    drivers/firmware/arm_scmi/driver.c:869:6: error: variable 'i_' is unini=
tialized when used within its own initialization [-Werror,-Wuninitialized]
...
Warnings:
    drivers/firmware/arm_scmi/driver.c:869:6: warning: variable 'i_' is uni=
...
---------------------------------------------------------------------------=
-----
multi_v5_defconfig (arm, clang-13) =E2=80=94 FAIL, 22 errors, 0 warnings, 0=
 section mismatches
...
[-Wunused-command-line-argument]
    clang: warning: argument unused during compilation: '-march=3Darmv7-a' =
[-Wunused-command-line-argument]  AS      arch/arm/mm/l2c-l2x0-resume.o
    clang: warning: argument unused during compilation: '-march=3Darmv7-a' =
[-Wunused-command-line-argument]
    clang: warning: argument unused during compilation: '-march=3Darmv7-a' =
[-Wunused-command-line-argument]
