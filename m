...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D0C4C58D204
	for <lists+linux-next@lfdr.de>; Tue,  9 Aug 2022 04:27:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229600AbiHIC1F (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 8 Aug 2022 22:27:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35076 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234488AbiHIC05 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 8 Aug 2022 22:26:57 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 54F321DA7A;
        Mon,  8 Aug 2022 19:26:53 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4M1xlr3HM7z4x1W;
        Tue,  9 Aug 2022 12:26:48 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1660012008;
        bh=nqiNGMgIQkkyt4SVUXdzm9LCLVBPqUijmEQKw+IG6YM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 9 Aug 2022 12:26:43 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 9
Message-ID: <20220809122643.4d13e811@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bf8h..6Qlc=l2zYcX6KQSos";
...
Changes since 20220808:

The loongarch tree lost its build failure.

Non-merge commits (relative to Linus' tree): 1135
 997 files changed, 56640 insertions(+), 11594 deletions(-)
...
Merging origin/master (5d5d353bed32 Merge tag 'rproc-v5.20' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/remoteproc/linux)
...
Merging net/master (f574f7f839fc net: bpf: Use the protocol's set_rcvlowat =
...
context BUG)
Merging sound-current/for-linus (f83bb2592482 ALSA: hda/conexant: Add quirk=
 for LENOVO 20149 Notebook model)
...
Merging usb.current/usb-linus (4e23eeebb2e5 Merge tag 'bitmap-6.0-rc1' of h=
ttps://github.com/norov/linux)
...
Merging hwmon-fixes/hwmon (da519304c1ad hwmon: (lm90) Fix error return valu=
e from detect function)
...
Merging irqchip-fixes/irq/irqchip-fixes (fda7409a8fcf irqchip/loongson-pch-=
pic: Move find_pch_pic() into CONFIG_ACPI)
...
Merging drm-misc-fixes/for-linux-next-fixes (91b3c8dbe898 drm/meson: Fix re=
fcount bugs in meson_vpu_has_available_connectors())
...
Merging loongarch/loongarch-next (77ddc4aab526 LoongArch: Add efistub booti=
ng support)
...
Merging hwmon-staging/hwmon-next (da519304c1ad hwmon: (lm90) Fix error retu=
rn value from detect function)
...
Merging sound/for-next (f83bb2592482 ALSA: hda/conexant: Add quirk for LENO=
VO 20149 Notebook model)
...
Merging usb/usb-next (4e23eeebb2e5 Merge tag 'bitmap-6.0-rc1' of https://gi=
thub.com/norov/linux)
...
Merging ntb/ntb-next (025963f08f3a PCI: endpoint: pci-epf-vntb: fix error h=
andle in epf_ntb_mw_bar_init())
...

=IeUZ
-----END PGP SIGNATURE-----
