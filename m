Return-Path: <linux-next+bounces-2539-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5448C906320
	for <lists+linux-next@lfdr.de>; Thu, 13 Jun 2024 06:45:35 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 7EDD31F21ABB
	for <lists+linux-next@lfdr.de>; Thu, 13 Jun 2024 04:45:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2AAA712C544;
	Thu, 13 Jun 2024 04:45:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="gv+jIb3i"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DF9393CF74;
	Thu, 13 Jun 2024 04:45:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1718253930; cv=none; b=J3u80K0aOV8q+azFn6zX+qzsxTA6PFTdvWD4TLgV8EeG9rIJRp33zGWvjFMEHXJBa/RMNfQOy+eyempQSMCK8rLR4vfjm8yXJO79xn9ohcR+KDzjKaTybr2R/+r8Z1fUh8HA75iPaKI8IGx6LFZX29jORLWe4awKdOpth/Tb62E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1718253930; c=relaxed/simple;
	bh=RRaraNILOqZ8k5wMVhpx4/BHuKXkxwspSoCDRAHPwY0=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=dwh9mOWoTyfYIZ1uJ/+ey88PFQfmiBsoMFLyUu+LqgCkiXOycdWitLwUDHRgG8ZkUQH2f21ewDgZtksCysPASPBVRIropMYWVsgd6CtaX4udA7LwfEnO2U2EmyWpU/FO03omqGFaf2pk2FPhH1ORleOeib6oTQMufJxBMZ0oC0I=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=gv+jIb3i; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1718253925;
	bh=dhsN0leqNa29U4STX13V4N41mYY0Rh/Zq5BIV+zU6vM=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4W08wj2TXvz4wbp;
	Thu, 13 Jun 2024 14:45:25 +1000 (AEST)
Date: Thu, 13 Jun 2024 14:45:24 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 13
Message-ID: <20240613144524.22abd1a0@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/WytIBnJvy3KKw3PQ5jSwUm7";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/WytIBnJvy3KKw3PQ5jSwUm7
...
Changes since 20240612:

The drm-intel tree still had its build failure for which I reverted
a commit.

The ftrace tree gained a conflict against the vfs-brauner tree.

Non-merge commits (relative to Linus' tree): 4851
 5271 files changed, 470132 insertions(+), 94964 deletions(-)
...
Merging origin/master (cea2a26553ac mailmap: Add my outdated addresses to t=
he map file)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (b6fd1a10ec22 selftests: mm: make =
map_fixed_noreplace test names stable)
...
erify_area())
Merging fs-current (210cc5d3759f Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (be27b8965297 net: stmmac: replace priv->speed with the po=
rtTransmitRate from the tc-cbs parameters)
...
Merging wireless/for-next (7d09e17c0415 wifi: mac80211: Recalc offload when=
 monitor stop)
...
Merging sound-asoc-fixes/for-linus (37a2c94c68ce Fixes for McASP and dmaeng=
ine_pcm)
Merging regmap-fixes/for-linus (76f19626bd35 regmap: add missing MODULE_DES=
CRIPTION() macros)
Merging regulator-fixes/for-linus (4cac29b846f3 regulator: bd71815: fix ram=
p values)
...
Merging usb.current/usb-linus (5ceac4402f5d xhci: Handle TD clearing for mu=
ltiple streams case)
...
Merging scsi-fixes/fixes (90e6f08915ec scsi: mpi3mr: Fix ATA NCQ priority s=
upport)
Merging drm-fixes/drm-fixes (83a7eefedc9b Linux 6.10-rc3)
Merging drm-intel-fixes/for-linux-next-fixes (83a7eefedc9b Linux 6.10-rc3)
...
Merging i2c-host-fixes/i2c/i2c-host-fixes (cbf3fb5b29e9 i2c: designware: Fi=
...
Merging drm-misc-fixes/for-linux-next-fixes (c38896ca6318 drm/mediatek: Cal=
l drm_atomic_helper_shutdown() at shutdown time)
...
Merging mm/mm-everything (18fbdd0c3587 foo)
...
sc' into for-next)
Merging arm64/for-next/core (71a096f1ec28 Merge branches 'for-next/cpufeatu=
re', 'for-next/misc', 'for-next/kselftest', 'for-next/mte' and 'for-next/er=
rata' into for-next/core)
...
Merging drivers-memory/for-next (9ba0cae3cac0 memory: fsl_ifc: Make FSL_IFC=
 config visible and selectable)
...
Merging scmi/for-linux-next (3824f841f0bc Merge branch 'for-next/ffa/update=
...
into for-next)
Merging ti/ti-next (d524a4960826 Merge branch 'ti-k3-dts-next' into ti-next)
...
regs)
Merging parisc-hd/for-next (72d95924ee35 parisc: Try to fix random segmenta=
...
Merging riscv-soc/riscv-soc-for-next (3ab910a7e979 Merge branch 'riscv-conf=
...
formance)
Merging dlm/next (79ced51e2e56 dlm: remove DLM_LSFL_SOFTIRQ from exflags)
Merging erofs/dev (83a7eefedc9b Linux 6.10-rc3)
...
Merging ext4/dev (83a7eefedc9b Linux 6.10-rc3)
Merging f2fs/dev (298b1e4182d6 f2fs: fix to truncate preallocated blocks in=
 f2fs_file_open())
...
Merging ksmbd/ksmbd-for-next (2bfc4214c69c ksmbd: fix missing use of get_wr=
ite in in smb2_set_ea())
Merging nfs/linux-next (99bc9f2eb3f7 NFS: add barriers when testing for NFS=
_FSDATA_BLOCKED)
Merging nfs-anna/linux-next (57331a59ac0d NFSv4.1: Use the nfs_client's rpc=
 timeouts for backchannel)
Merging nfsd/nfsd-next (50f73efbc1da NFSD: Support write delegations in LAY=
OUTGET)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (22c963c98065 Merge branch 'vfs.fixes' into vfs=
.all)
CONFLICT (content): Merge conflict in fs/nfs/symlink.c
[fs-next 3c94454b6852] Merge branch 'vfs.all' of git://git.kernel.org/pub/s=
cm/linux/kernel/git/vfs/vfs.git
Merging vfs/for-next (a38297e3fb01 Linux 6.9)
Merging fs-next (3c94454b6852 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging i2c-host/i2c/i2c-host (1131179f9f4d i2c: add missing MODULE_DESCRIP=
TION() macros)
Merging i3c/i3c/next (1d08326020fb i3c: dw: Add hot-join support.)
Merging dmi/dmi-for-next (4d1b28a8119c firmware: dmi: Add info message for =
number of populated and total memory slots)
Merging hwmon-staging/hwmon-next (c16fa6967781 hwmon: add MP9941 driver)
Merging jc_docs/docs-next (68f1174e2a8d Merge branch 'docs-mw' into docs-ne=
xt)
...
: avoid_externs)
Merging pm/linux-next (0a2c035b1e6d Merge branch 'pm-cpufreq-fixes' into li=
nux-next)
...
Merging net-next/main (32b06603f879 net: xilinx: axienet: Use NL_SET_ERR_MS=
G instead of netdev_err)
Merging bpf-next/for-next (4ff5747158f3 Merge branch 'bpf-support-dumping-k=
func-prototypes-from-btf')
...
Merging wireless-next/for-next (a2ead3445a63 wifi: zd1211rw: use 'time_left=
...
Merging drm-exynos/for-linux-next (9347028bfcfc drm/exynos/vidi: convert to=
 struct drm_edid)
Merging drm-misc/for-linux-next (dfc1209ed5a3 arm/komeda: Remove all CONFIG=
_DEBUG_FS conditional compilations)
Merging amdgpu/drm-next (b95fa494d6b7 drm/amdgpu: add RAS is_rma flag)
Merging drm-intel/for-linux-next (da8c3cdb016c drm/i915: Rename bigjoiner m=
aster/slave to bigjoiner primary/secondary)
...
integer overflow)
Merging drm-msm/msm-next (aeacc39e2088 drm/msm/dp: fix runtime_pm handling =
in dp_wait_hpd_asserted)
Merging drm-msm-lumag/msm-next-lumag (104e548a7c97 drm/msm/mdp4: use drmm-m=
anaged allocation for mdp4_plane)
Merging drm-xe/drm-xe-next (e54700f7d6aa drm/xe/bmg: Add PCI IDs)
...
Merging sound-asoc/for-next (65f6c8a9c63e Merge remote-tracking branch 'aso=
...
Merging block/for-next (90beb03cc7bb Merge branch 'for-6.11/block' into for=
-next)
...
r power sensors)
Merging regulator/for-next (c1cbbacb112a Merge remote-tracking branch 'regu=
lator/for-6.11' into regulator-next)
Merging security/next (087a57d68f61 Automated merge of 'dev' into 'next')
...
Merging devicetree/for-next (4f42882bb9e4 PCI: of_property: Add interrupt-c=
ontroller property in PCI device nodes)
Merging dt-krzk/for-next (88ae85dc70fe Merge branch 'next/dt' into for-next)
...
11' into spi-next)
Merging tip/master (f87c20c019e2 Merge branch into tip/master: 'x86/percpu')
...
xt)
Merging ftrace/for-next (b7967ac6b815 Merge probes/for-next)
...
Merging chrome-platform/for-next (c2a28647bbb4 platform/chrome: cros_ec_deb=
ugfs: fix wrong EC message version)
...
Merging fastrpc/for-next (0ff3de430627 misc: fastrpc: use coherent pool for=
 untranslated Compute Banks)
...
Merging phy-next/next (8e97ddd58614 dt-bindings: phy: g12a-usb2-phy: add op=
tional power-domains)
...
Merging scsi/for-next (626b8d03266f Merge branch 'fixes' into for-next)
...
Merging gpio-brgl/gpio/for-next (08d94c742868 Documentation: gpio: Clarify =
effect of active low flag on line edges)
...
Merging efi/next (83a7eefedc9b Linux 6.10-rc3)
...

=y03Z
-----END PGP SIGNATURE-----
