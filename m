...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8C85A32CA80
	for <lists+linux-next@lfdr.de>; Thu,  4 Mar 2021 03:34:36 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231330AbhCDCeE (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 3 Mar 2021 21:34:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49356 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231180AbhCDCdc (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 3 Mar 2021 21:33:32 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A7246C061756;
        Wed,  3 Mar 2021 18:32:51 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DrZf95Qh0z9sRf;
        Thu,  4 Mar 2021 13:32:49 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1614825169;
        bh=aPxiC5/sZ3+TROn6IR0E9AB37d95T+P3wfAThnlG5ds=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 4 Mar 2021 13:32:48 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 4
Message-ID: <20210304133248.4ebde52d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/C=S4_4oBxO0YRjE=DvJ7h=j";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/C=S4_4oBxO0YRjE=DvJ7h=j
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210303:

The ipsec tree gained a conflict against the net tree.
...
Non-merge commits (relative to Linus' tree): 1419
 1507 files changed, 35931 insertions(+), 13733 deletions(-)
...
Merging origin/master (f69d02e37a85 Merge tag 'misc-5.12-2021-03-02' of git=
...
Merging net/master (dbbe7c962c3a docs: networking: drop special stable hand=
ling)
Merging bpf/master (6185266c5a85 selftests/bpf: Mask bpf_csum_diff() return=
 value to 16 bits in test_verifier)
Merging ipsec/master (4c38255892c0 vti6: fix ipv4 pmtu check to honor ip he=
ader df)
...
Q)
Merging rdma-fixes/for-rc (3a9b3d4536e0 IB/mlx5: Add missing error code)
Merging sound-current/for-linus (26af17722a07 ALSA: hda/realtek: Apply dual=
 codec quirks for MSI Godlike X570 board)
...
Merging char-misc.current/char-misc-linus (62cde0ebfa5d Merge tag 'misc-hab=
analabs-fixes-2021-03-03' of https://git.kernel.org/pub/scm/linux/kernel/gi=
...
Merging cel-fixes/for-rc (76f3011fc516 rpc: fix NULL dereference on kmalloc=
 failure)
Merging drm-misc-fixes/for-linux-next-fixes (bde649441366 fbdev: atyfb: use=
 LCD management functions for PPC_PMAC also)
...
Merging fscache/fscache-next (58e7ffc82f41 afs: Use the fscache_write_begin=
() helper)
...
t4-specific tests)
Merging f2fs/dev (c11aa54f38ff f2fs: fix error handling in f2fs_end_enable_=
verity())
...
Merging i3c/i3c/next (fe07bfda2fb9 Linux 5.12-rc1)
...
Merging v4l-dvb/master (f3ea6a19f413 media: vbi_hsync.svg: fix the viewport=
s)
...
Merging block/for-next (0fcab68db7db Merge branch 'io_uring-5.12' into for-=
next)
...
Merging rcu/rcu/next (08804dc76ea2 rcu/tree: Add a trace event for RCU CPU =
stall warnings)
...
Merging tty/tty-next (1f8a51ee3242 tty: serial: pch_uart.c: remove debugfs =
dentry pointer)
...
Merging pinctrl/for-next (292bdd2cf719 Merge branch 'devel' into for-next)
$ git reset --hard HEAD^
Merging next-20210303 version of pinctrl
...
Merging akpm/master (9ce8c05f0c26 Merge branch 'akpm-current/current')
...

=TztA
-----END PGP SIGNATURE-----
