Return-Path: <linux-next+bounces-665-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D4408826851
	for <lists+linux-next@lfdr.de>; Mon,  8 Jan 2024 07:55:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id ADA80B20CCD
	for <lists+linux-next@lfdr.de>; Mon,  8 Jan 2024 06:55:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id F36E38BF9;
	Mon,  8 Jan 2024 06:55:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="eQqx4RXD"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-f175.google.com (mail-pf1-f175.google.com [209.85.210.175])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 0A0578BE7
	for <linux-next@vger.kernel.org>; Mon,  8 Jan 2024 06:55:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pf1-f175.google.com with SMTP id d2e1a72fcca58-6daf694b439so166631b3a.1
        for <linux-next@vger.kernel.org>; Sun, 07 Jan 2024 22:55:10 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1704696910; x=1705301710; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=CwUKVpTIydT9cphq3EsiRlwT/17YhtKwzkZt8PUgBQs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704696910; x=1705301710;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=CwUKVpTIydT9cphq3EsiRlwT/17YhtKwzkZt8PUgBQs=;
        b=
X-Gm-Message-State: AOJu0YwFE1sjxiFdHrWcOSy1cZu3jdxtrA4f7KfhE3oEo/Kq80HrPIzt
	c8QcKZdGO85dSSzhWzqYci72il3TtykNGI+5iU8qInCK3YI=
X-Google-Smtp-Source: AGHT+IFJrWEcMIN7OzOCNiPbQmrXvAaPE9KLWIwh0c50szaQUKE9G2CtboxIEvgtp5s+Y/NbEGWnTQ==
X-Received: by 2002:a05:6a00:816:b0:6d9:b6db:3412 with SMTP id m22-20020a056a00081600b006d9b6db3412mr1003033pfk.54.1704696908902;
        Sun, 07 Jan 2024 22:55:08 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id ld18-20020a056a004f9200b006d99c6c0f1fsm5252721pfb.100.2024.01.07.22.55.07
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 07 Jan 2024 22:55:08 -0800 (PST)
Message-ID: <659b9c4c.050a0220.952fa.b5c7@mx.google.com>
Date: Sun, 07 Jan 2024 22:55:08 -0800 (PST)
...
Tree: next
Branch: master
Git Describe: next-20240108
Git Commit: bffdfd2e7e63175ae261131a620f809d946cf9a7
...
e for =E2=80=98board_setup=E2=80=99 [-Wmissing-prototypes]
    1    ................................................./arch/sparc/kerne=
l/traps_64.c:253:6: warning: no previous prototype for =E2=80=98is_no_fault=
_exception=E2=80=99 [-Wmissing-prototypes]
...
Warnings:
    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    ................................................./arch/sparc/kernel/tra=
ps_64.c:253:6: warning: no previous prototype for =E2=80=98is_no_fault_exce=
ption=E2=80=99 [-Wmissing-prototypes]
    arch/sparc/kernel/traps_64.c:2035:6: warning: no previous prototype for=
 =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    arch/sparc/kernel/traps_64.c:2153:6: warning: no previous prototype for=
 =E2=80=98sun4v_nonresum_error_user_handled=E2=80=99 [-Wmissing-prototypes]
