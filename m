...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 864153EFE93
	for <lists+linux-next@lfdr.de>; Wed, 18 Aug 2021 10:05:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239371AbhHRIFi (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 18 Aug 2021 04:05:38 -0400
Received: from ozlabs.org ([203.11.71.1]:36423 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S239499AbhHRIFY (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 18 Aug 2021 04:05:24 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GqL635JHZz9sX2;
        Wed, 18 Aug 2021 18:04:43 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1629273883;
        bh=KQNcIruitjxiWij4MuHx9SzgIgm8RwcLXU4841/4A4U=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 18 Aug 2021 18:04:42 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 18
Message-ID: <20210818180442.5eec549f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_KgbvjF7gk5r45COOMwsLb+";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/_KgbvjF7gk5r45COOMwsLb+
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210817:

The i2c tree gained a conflict against the arm-soc tree.

The net-next tree still had its build failure for which I applied a patch.

The scsi-mkp tree lost its build failure.

The akpm-current tree gained a conflict against the i2c tree.

Non-merge commits (relative to Linus' tree): 7916
 7796 files changed, 469428 insertions(+), 187291 deletions(-)
...
Merging origin/master (614cb2751d31 Merge tag 'trace-v5.14-rc6' of git://gi=
...
Merging net/master (e5e487a2ec8a Merge tag 'wireless-drivers-2021-08-17' of=
...
Merging sound-asoc-fixes/for-linus (70dfac19d96e Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (a317d3ada96a Merge remote-tracking branch 'spi=
...
Merging cifs/for-next (d3986619ac1e cifs: move functions that depend on DES=
 to smp1ops.c)
...
Merging overlayfs/overlayfs-next (52d5a0c6bd8a ovl: fix BUG_ON() in may_del=
ete() when called from ovl_cleanup())
...
terface for uverbs)
Merging net-next/master (3349d3625d62 Merge branch '40GbE' of git://git.ker=
...
Merging bpf-next/for-next (8cacfc85b615 bpf: Remove redundant initializatio=
n of variable allow)
...
Merging mac80211-next/master (f50d2ff8f016 mac80211: Fix insufficient headr=
oom issue for AMSDU)
...
Merging sound/for-next (8fc8e903156f ALSA: hda: Drop workaround for a hang =
at shutdown again)
Merging sound-asoc/for-next (cd13b7eafd92 Merge remote-tracking branch 'aso=
...
Merging block/for-next (0a9248648b62 Merge branch 'io_uring-5.14' into for-=
next)
...
it.h)
Merging devicetree/for-next (18c585c7d742 of: property: fw_devlink: Add sup=
port for "leds" and "backlight")
...
Merging spi/for-next (1407e9ea8f8e Merge remote-tracking branch 'spi/for-5.=
15' into spi-next)
...
COLOR)
Merging drivers-x86/for-next (ca42c119fc67 platform/x86: acer-wmi: Add Turb=
o Mode support for Acer PH315-53)
...
lease)
Merging staging/staging-next (9caf92ab573f staging: r8188eu: Remove unused =
nat25_handle_frame())
...
Merging akpm/master (2df9dc4a2d64 arch: remove compat_alloc_user_space)
...

=7axL
-----END PGP SIGNATURE-----
