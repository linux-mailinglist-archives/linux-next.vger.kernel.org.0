...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BC79B372495
	for <lists+linux-next@lfdr.de>; Tue,  4 May 2021 05:01:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229658AbhEDDCg (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 3 May 2021 23:02:36 -0400
Received: from ozlabs.org ([203.11.71.1]:32911 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229499AbhEDDCf (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 3 May 2021 23:02:35 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FZ4PJ1DhXz9sCD;
        Tue,  4 May 2021 13:01:40 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1620097300;
        bh=0QwM2DjiT9OOECcDf04eAlVZekB4W32/njxsGhkzgKE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 4 May 2021 13:01:38 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 4
Message-ID: <20210504130138.5547c2d1@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/__zb9_YKo94eXpYFx5NrQPB";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/__zb9_YKo94eXpYFx5NrQPB
...
Merging origin/master (5e321ded302d Merge tag 'for-5.13/parisc' of git://gi=
...
Merging net/master (bd1af6b5fffd Documentation: ABI: sysfs-class-net-qmi: d=
ocument pass-through file)
Merging bpf/master (2a30f9440640 libbpf: Fix signed overflow in ringbuf_pro=
cess_ring)
...
Merging sound-current/for-linus (ab2165e2e6ed ALSA: usb-audio: Add dB range=
 mapping for Sennheiser Communications Headset PC 8)
...
Merging devicetree-fixes/dt/linus (5cd1a85a6c3f of: overlay: Remove redunda=
nt assignment to ret)
...
Merging powerpc/next (562d1e207d32 powerpc/powernv: remove the nvlink suppo=
rt)
...
Merging ceph/master (3388156ed580 Merge commit 'ed94f87c2b123241ae5644cf823=
27e2da653adb6')
Merging cifs/for-next (5f28229f7c49 Cifs: Fix kernel oops caused by deferre=
d close for files.)
...
Merging pci/next (19e1547b448c Merge branch 'pci/tegra')
...
Merging drm-misc/for-linux-next (a712b307cfde drm/msm/dpu: Delete bonkers c=
ode)
...
Merging sound/for-next (ab2165e2e6ed ALSA: usb-audio: Add dB range mapping =
for Sennheiser Communications Headset PC 8)
...
n making htmldocs)
Merging vhost/linux-next (75195c8d1458 virtio_net: disable cb aggressively)
...
Merging akpm/master (930a60521778 memfd_secret: use unsigned int rather tha=
...

=NyyM
-----END PGP SIGNATURE-----
