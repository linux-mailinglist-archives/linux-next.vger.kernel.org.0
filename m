Return-Path: <linux-next+bounces-9083-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [142.0.200.124])
	by mail.lfdr.de (Postfix) with ESMTPS id 3CFBFC6CA50
	for <lists+linux-next@lfdr.de>; Wed, 19 Nov 2025 04:44:28 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 42D464EDC12
	for <lists+linux-next@lfdr.de>; Wed, 19 Nov 2025 03:41:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 65FB42D9491;
	Wed, 19 Nov 2025 03:41:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="DHYxHkVe"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AB6D222D4DD;
	Wed, 19 Nov 2025 03:41:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763523701; cv=none; b=S2wt6bhO5t+HkuxTv1Ovl6+wLUgaYwBWW+jAEINn4WFFxwd3qPBuK1PGqaKr3tfe1mDClbBunPmV83MHrWZ1qNLZmZY7wtJLMoPpnFQUI9gxBRU71mWqranmq2IsTiIBK8SrureNqXvqJHbwvC/Ijj4mLfQZjmvye0DYf/F94qE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763523701; c=relaxed/simple;
	bh=Stb0+5suxEZGFHjoaq76lFJfPn4JjVd94a44t/rHRnw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=J2AIdDgkKA1+8Nna9xrdvz1RQyh8KtoAKvznQkFs20dQlC0aaqhPRvWh+x8ip8q/Il6n7i31AtKg7ZIl8CJKkAtKBEZ6JJxsFpHa7gPcGPGZ4t/uCoGiD9Q5W6+33xCfiIJqGzfZnUE4PnZGMVeuocmdOGlRsTe2xmAcLQeBn7c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=DHYxHkVe; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1763523691;
	bh=DlJ09TiCcgINUtLsTd3JZlDYG4J0GHTovlHZy/+Vt08=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dB6j75z7Lz4w2R;
	Wed, 19 Nov 2025 14:41:31 +1100 (AEDT)
Date: Wed, 19 Nov 2025 14:41:30 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 19
Message-ID: <20251119144130.2e3d42ae@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/jz8crrdAF5SS_F1Hj8xPtan";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/jz8crrdAF5SS_F1Hj8xPtan
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20251118:
...
Non-merge commits (relative to Linus' tree): 9260
 9621 files changed, 427263 insertions(+), 143728 deletions(-)
...
Merging origin/master (8b690556d8fe Merge tag 'for-linus' of git://git.kern=
...
_open_session())
Merging cifs/for-next (b6f36130314c smb: client: show smb lease key in open=
_dirs output)
...
into for-next)
Merging mm-hotfixes/mm-hotfixes-unstable (7abaf0cccd35 selftests/mm: fix di=
vision-by-zero in uffd-unit-tests)
Merging fs-current (91f48f471c97 Merge branch 'fixes' of https://git.kernel=
...
embly)
Merging net/main (0f08f0b0fb5e net: ps3_gelic_net: handle skb allocation fa=
ilures)
...
Merging tip-fixes/tip/urgent (e7c375b18160 Merge tag 'vfs-6.18-rc7.fixes' o=
f gitolite.kernel.org:pub/scm/linux/kernel/git/vfs/vfs)
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (949f1fd2225b nouveau/firmware:=
 Add missing kfree() of nvkm_falcon_fw::boot)
...
Merging mm-unstable/mm-unstable (ffac53cdb231 zram: drop wb_limit_lock)
Merging mm-nonmm-unstable/mm-nonmm-unstable (f0bfdc2b69f5 Documentation/ABI=
...
Merging perf/perf-tools-next (d8d8a0b3603a perf tool_pmu: More accurately s=
et the cpus for tool events)
...
sk)
Merging risc-v/for-next (2a06478d37be raid6: test: Add support for RISC-V)
...
Merging fs-next (b21ee9d30fd4 Merge branch 'for-next' of https://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging pm/linux-next (cf6cad7bd296 Merge branch 'fixes' into linux-next)
...
Merging net-next/main (a057e8e4ac5b Merge branch 'gve-implement-xdp-hw-rx-t=
imestamping-support-for-dq')
...
Merging bluetooth/master (5a7903c04269 Bluetooth: HCI: Add support for LL E=
xtended Feature Set)
...
Merging drm/drm-next (f3a1d69f9b38 Merge tag 'amd-drm-next-6.19-2025-11-14'=
 of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
  ...
  4dfaae643e59 ("drm/i915/display: Add definition for wcl as subplatform")
  8147f7a1c083 ("drm/i915/xe3: Restrict PTL intel_encoder_is_c10phy() to on=
ly PHY A")
...
Merging amdgpu/drm-next (42408773ffcf drm/amd/display: Move analog check to=
 dce110_hwseq)
Merging drm-intel/for-linux-next (de72d9df4f45 drm/i915/fbc: Apply Wa_15018=
326506)
...
Merging sound-asoc/for-next (97c2f7e320db Merge remote-tracking branch 'aso=
...
Merging block/for-next (ca289ffd261b Merge branch 'for-6.19/block' into for=
-next)
CONFLICT (content): Merge conflict in io_uring/rw.c
Merging device-mapper/for-next (f687e1f23acd dm-crypt: enable DM_TARGET_ATO=
MIC_WRITES)
...
Merging spi/for-next (58c797ae24ee Merge remote-tracking branch 'spi/for-6.=
19' into spi-next)
Merging tip/master (c2ef745151b2 Merge branch into tip/master: 'x86/sgx')
...
Merging edac/edac-for-next (3a67ba430c1d Merge ras/edac-drivers into for-ne=
xt)
...
b-modules only)
Merging kvm-arm/next (a0af896ca688 Merge branch 'kvm-arm64/vgic-lr-overflow=
' into kvmarm/next)
...
Merging icc/icc-next (d32e1c2dccb9 Merge branch 'icc-kaanapali' into icc-ne=
xt)
...
-next' into for-next)
Merging gpio-brgl/gpio/for-next (bb7c963d0008 dt-bindings: gpio: mpfs-gpio:=
 Add pic64gx GPIO compatibility)
...
Merging landlock/next (1d80ca4ab4b2 selftests/landlock: Fix makefile header=
 list)
Merging rust/rust-next (1aaa5cfbd489 MAINTAINERS: add entry for the Rust `n=
um` module)
...

=jKvF
-----END PGP SIGNATURE-----
