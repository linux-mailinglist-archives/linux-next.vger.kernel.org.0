...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2116F3AB135
	for <lists+linux-next@lfdr.de>; Thu, 17 Jun 2021 12:19:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230242AbhFQKVd (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 17 Jun 2021 06:21:33 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:59617 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230500AbhFQKVc (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 17 Jun 2021 06:21:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4G5J2251Nlz9s5R;
        Thu, 17 Jun 2021 20:19:22 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1623925162;
        bh=eQxtykHAUePAd4I1bgfnzSkcM9vEwZBqCZmSHevOxAw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 17 Jun 2021 20:19:21 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 17
Message-ID: <20210617201921.355b680e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/txm_XpoJZ9VrFnfWcP5qv_S";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/txm_XpoJZ9VrFnfWcP5qv_S
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210616:
...
The usb tree gained conflicts against the arm-soc tree.

The usb-serial tree gained a conflict against Linus' tree.

The akpm tree still had its build failure and gained another for which
I reverted a commit.

Non-merge commits (relative to Linus' tree): 9937
 9426 files changed, 657501 insertions(+), 255599 deletions(-)
...
Merging origin/master (70585216fe77 Merge branch 'akpm' (patches from Andre=
w))
...
emicolon)
Merging powerpc-fixes/fixes (478036c4cd1a powerpc: Fix initrd corruption wi=
th relative jump labels)
Merging s390-fixes/fixes (b815c215c9b1 s390/vfio-ap: clean up mdev resource=
s when remove callback invoked)
Merging sparc/master (05a59d79793d Merge git://git.kernel.org:/pub/scm/linu=
x/kernel/git/netdev/net)
Merging fscrypt-current/for-stable (d19d8d345eec fscrypt: fix inline encryp=
tion not used on new files)
Merging net/master (da5ac772cfe2 r8169: Avoid memcpy() over-reading of ETH_=
SS_STATS)
Merging bpf/master (da5ac772cfe2 r8169: Avoid memcpy() over-reading of ETH_=
SS_STATS)
...
q_timer_open())
Merging sound-asoc-fixes/for-linus (f672c9ebf36b Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (2c85d6b61109 Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (60ed39db6e86 Merge tag 'usb-v5.13-rc7' of gi=
...
Merging drm-misc-fixes/for-linux-next-fixes (9984d6664ce9 drm/vc4: hdmi: Ma=
ke sure the controller is powered in detect)
Merging kspp-gustavo/for-next/kspp (90b74633e0f3 Merge branch 'for-next/War=
...
or-next)
Merging arm64/for-next/core (ad3dc0b85b9a Merge branch 'for-next/sve' into =
for-next/core)
...
Merging arm-soc/for-next (ddec95a66430 ARM: Document merges)
...
or-next)
Merging qcom/for-next (9d975050781c Merge branches 'arm64-defconfig-for-5.1=
...
Merging powerpc/next (ddf4a7bcd094 powerpc/tau: Remove superfluous paramete=
r in alloc_workqueue() call)
Merging soc-fsl/next (242b0b398ccd soc: fsl: enable acpi support in RCPM dr=
iver)
Merging risc-v/for-next (514e9eea5269 riscv: add ASID-based tlbflushing met=
hods)
CONFLICT (content): Merge conflict in arch/riscv/Kconfig
Merging s390/for-next (ce421e652060 Merge branch 'features' into for-next)
...
")
Merging btrfs/for-next (afc4c4394d81 Merge branch 'for-next-next-v5.13-2021=
0616' into for-next-20210616)
Merging ceph/master (1b269bcade7c libceph: fix doc warnings in cls_lock_cli=
ent.c)
Merging cifs/for-next (d7a1f668e5a8 cifs: retry lookup and readdir when EAG=
AIN is returned.)
...
Merging pstore/for-next/pstore (1bc909e63ba1 pstore/blk: Include zone in ps=
tore_device_info)
...
G2/HEVC codec)
Merging v4l-dvb-next/master (6ef43d273e85 media: admin-guide: avoid using R=
eST :doc:`foo` markup)
Merging pm/linux-next (b7fd255fd200 Merge branches 'acpi-processor', 'acpi-=
pm', 'acpi-video' and 'acpi-sysfs' into linux-next)
...
Merging opp/opp/linux-next (5736929761d1 opp: Allow required-opps to be use=
...
inter type)
Merging net-next/master (0c33795231bf Merge tag 'wireless-drivers-next-2021=
-06-16' of git://git.kernel.org/pub/scm/linux/kernel/git/kvalo/wireless-dri=
vers-next)
CONFLICT (content): Merge conflict in net/can/isotp.c
CONFLICT (content): Merge conflict in include/linux/ptp_clock_kernel.h
CONFLICT (content): Merge conflict in drivers/ptp/ptp_clock.c
Merging bpf-next/for-next (809ed84de8b3 selftests/bpf: Whitelist test_progs=
.h from .gitignore)
...
lated bits)
Merging netfilter-next/master (c7654495916e net: chelsio: cxgb4: use eth_ze=
ro_addr() to assign zero address)
Merging ipvs-next/master (a212d9f33ed0 Merge branch 'iosm-driver')
Merging wireless-drivers-next/master (f39c2d1a188d Merge ath-next from git:=
...
Merging amdgpu/drm-next (9e507ce63e22 drm/radeon: Add HD-audio component no=
tifier support (v2))
...
Merging sound/for-next (36d1a6729be5 ALSA: bebob: Fix bit flag quirk consta=
nts)
Merging sound-asoc/for-next (c4fee0e615dc Merge remote-tracking branch 'aso=
...
od API)
Merging block/for-next (33d5bbc5460d Merge branch 'for-5.14/block' into for=
-next)
...
tion)
Merging devicetree/for-next (0e407a9a29ff of: Remove superfluous casts when=
 printing u64 values)
...
Merging spi/for-next (7e6bf92553ae Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
...
to trace/for-next)
Merging rcu/rcu/next (e133f14a2c54 torture: Log more kvm-remote.sh informat=
ion)
...
nts)
Merging usb/usb-next (1da8116eb0c5 arm64: dts: qcom: sc7180-trogdor: Add no=
des for onboard USB hub)
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/qcom/sc7180-trogd=
or-lazor-r1.dts
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/qcom/sc7180-trogd=
or-lazor-r0.dts
...
Merging tty/tty-next (d495dd743d5e serial_cs: Add Option International GSM-=
Ready 56K/ISDN modem)
Merging char-misc/char-misc-next (60f86b9a1c0d mcb: Remove trailing semicol=
on in macros)
...
IO_MDEV)
Merging staging/staging-next (5b4f167ef355 staging: mt7621-dts: fix pci add=
ress for PCI memory range)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging iio/togreg (7cd04c863f9e iio: light: tcs3472: do not free unallocat=
ed IRQ)
...
Merging scsi-mkp/for-next (ebc076b3eddc scsi: elx: efct: Tie into kernel Kc=
onfig and build process)
...
Merging akpm/master (33307a64dddf afs: fix tracepoint string placement with=
 built-in AFS)
...

=Zglo
-----END PGP SIGNATURE-----
