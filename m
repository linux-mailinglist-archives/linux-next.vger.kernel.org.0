Return-Path: <linux-next+bounces-5436-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 1226EA33757
	for <lists+linux-next@lfdr.de>; Thu, 13 Feb 2025 06:34:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4D5C9188BE77
	for <lists+linux-next@lfdr.de>; Thu, 13 Feb 2025 05:34:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B0BE886325;
	Thu, 13 Feb 2025 05:33:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="G7x1/60g"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E5B2D206F0E;
	Thu, 13 Feb 2025 05:33:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1739424804; cv=none; b=TYo1BqSJu85G2I2Ls0yka86hzx7djTEKQVMqAqv9CqhisDrM4lJk31R02aIyjFp+7KnQdTYj19niatdimzmyXz5+AqMSRbvuVB9mzc6P6XWVLhXqLDS+WkPP0YKpflB+hqdad1ED8GSzWU1QI4LIgRrc+juE3xnxwxbKiMZ1KKU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1739424804; c=relaxed/simple;
	bh=rZhD7X/iekX/TwmXAHxXMHYKFevrKg88qwQR3dixS3Q=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=jKrPsiuYExltl4d1LDXp6CnCcCchXrPOSzo7rYKKveiSQsSQwIpLaTQ2T4BziZlh7zEgVBwYtjSLiXHu9qcfyBgw/rNDGgR3wHjG/lUK8LRXGKU7yG2XTIVkKX9SDWsXwnSBYmKWIMrlPmpNT08eDQmszFV4s600cIVoB+PqAJo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=G7x1/60g; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1739424789;
	bh=o/Z8Fow4CMmpQt6kvLiScriflKC8Qat42PDhdyfXWHg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YtkNj4pVTz4x2J;
	Thu, 13 Feb 2025 16:33:09 +1100 (AEDT)
Date: Thu, 13 Feb 2025 16:33:08 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 13
Message-ID: <20250213163308.1800c3eb@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/uBOp.ax8aR7hOVQT+_fC9Jo";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/uBOp.ax8aR7hOVQT+_fC9Jo
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250212:
...
Non-merge commits (relative to Linus' tree): 2915
 3437 files changed, 139145 insertions(+), 65783 deletions(-)
...
Merging vfs-brauner-fixes/vfs.fixes (240189294fbc Merge patch series "acct:=
...
Merging bcachefs/for-next (feb87244f1a7 bcachefs: bcachefs_metadata_version=
_stripe_lru)
...
Merging vfs-brauner/vfs.all (24561727a071 Merge branch 'vfs-6.15.async.dir'=
 into vfs.all)
...
Merging fs-current (0b0d09b8f134 Merge branch 'next-fixes' of git://git.ker=
...
Fs)
Merging net/main (e589adf5b70c iavf: Fix a locking bug in an error path)
...
Merging gpio-brgl-fixes/gpio/for-current (b9644fbfbcab gpio: stmpe: Check r=
eturn value of stmpe_reg_read in stmpe_gpio_irq_sync_unlock)
...
Merging tip-fixes/tip/urgent (b001591f33b8 Merge branch into tip/master: 's=
ched/urgent')
...
Merging uml-fixes/fixes (fb4cc5f19d36 um: convert irq_lock to raw spinlock)
...
Merging perf/perf-tools-next (ee8aef2d2321 perf tools: Add skip check in to=
ol_pmu__event_to_str())
...
r-next)
Merging mediatek/for-next (fe11de3cc941 arm64: dts: mediatek: mt8188: Add t=
...
or-next)
Merging scmi/for-linux-next (66cc1e5f3065 Merge branches 'for-next/scmi/fix=
...
Merging fs-next (4e322ae108da Merge branch 'for-next' of git://git.kernel.o=
...
Merging v4l-dvb/next (c52643b24152 media: qcom: camss: add support for SDM6=
70 camss)
...
Merging net-next/main (fea5d562822b Merge branch 'use-phylib-for-reset-rand=
omization-and-adjustable-polling')
...
Merging bluetooth/master (a6b7c150b32a Bluetooth: L2CAP: Fix corrupted list=
 in hci_chan_del)
...
ary checking)
Merging drm-misc/for-linux-next (325ba852d148 drm/i2c: move TDA998x driver =
under drivers/gpu/drm/bridge)
$ git reset --hard HEAD^
Merging next-20250212 version of drm-misc
Merging amdgpu/drm-next (f245b400a223 Revert "drm/amd/display: Use HW lock =
mgr for PSR1")
Merging drm-intel/for-linux-next (f9f34d44c7d3 drm/i915/dsb: Decode DSB err=
or interrupts)
...
Merging drm-xe/drm-xe-next (b7446752e5d3 drm/xe/display: Add missing waterm=
ark ipc update at runtime resume)
...
15' into spi-next)
Merging tip/master (d6678139cd9d Merge branch into tip/master: 'x86/mm')
...
lock and friends)
Merging hyperv/hyperv-next (502b6d14188e hyperv: Move arch/x86/hyperv/hv_pr=
oc.c to drivers/hv)
$ git reset --hard HEAD^
Merging next-20250212 version of hyperv
...

=34Ul
-----END PGP SIGNATURE-----
