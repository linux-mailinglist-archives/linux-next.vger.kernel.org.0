...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8B9D44553C7
	for <lists+linux-next@lfdr.de>; Thu, 18 Nov 2021 05:24:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242946AbhKRE1Z (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 17 Nov 2021 23:27:25 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:48867 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242970AbhKRE1F (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 17 Nov 2021 23:27:05 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Hvms107Tzz4xdN;
        Thu, 18 Nov 2021 15:24:04 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1637209445;
        bh=FrclpETS9V6tXjoyZkNqmrmO6BD5mZoukx9bgKTtGlU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 18 Nov 2021 15:24:04 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 18
Message-ID: <20211118152404.40561423@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/puJSY41CWh7JJeYe1hHh3di";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/puJSY41CWh7JJeYe1hHh3di
...
Non-merge commits (relative to Linus' tree): 1860
 2128 files changed, 86068 insertions(+), 40418 deletions(-)
...
Merging origin/master (ee1703cda8dc Merge tag 'hyperv-fixes-signed-20211117=
...
figs for v5.15-rc1)
Merging powerpc-fixes/fixes (1e35eba40551 powerpc/8xx: Fix pinned TLBs with=
 CONFIG_STRICT_KERNEL_RWX)
Merging s390-fixes/fixes (6c122360cf2f s390: wire up sys_futex_waitv system=
 call)
Merging sparc/master (05a59d79793d Merge git://git.kernel.org:/pub/scm/linu=
x/kernel/git/netdev/net)
Merging fscrypt-current/for-stable (80f6e3080bfc fs-verity: fix signed inte=
ger overflow with i_size near S64_MAX)
Merging net/master (c366ce28750e net: ax88796c: use bit numbers insetad of =
bit masks)
Merging bpf/master (f45b2974cc0a bpf, x86: Fix "no previous prototype" warn=
ing)
...
able assignment)
Merging sound-asoc-fixes/for-linus (4e6118f860ee Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (1675f9b6a9d9 Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (d4d2e5329ae9 usb: chipidea: ci_hdrc_imx: fix=
 potential error pointer dereference in probe)
...
Merging iio-fixes/fixes-togreg (6661146427cb iio: ad7768-1: Call iio_trigge=
...
Merging mips-fixes/mips-fixes (fc1aabb08886 mips: lantiq: add support for c=
lk_get_parent())
...
ice node)
Merging kvm-fixes/master (761f976f39d8 KVM: x86: Cap KVM_CAP_NR_VCPUS by KV=
M_CAP_MAX_VCPUS)
...
Merging scsi-fixes/fixes (392006871bb2 scsi: qla2xxx: Fix mailbox direction=
 flags in qla2xxx_get_adapter_id())
Merging drm-fixes/drm-fixes (fa55b7dcdc43 Linux 5.16-rc1)
Merging amdgpu-fixes/drm-fixes (2c409ba81be2 drm/radeon: fix si_enable_smc_=
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (8b2abf777d8e drm/i915/guc: fi=
x NULL vs IS_ERR() checking)
Merging mmc-fixes/fixes (3d7c194b7c9a mmc: sdhci: Fix ADMA for PAGE_SIZE >=
=3D 64KiB)
...
Merging drm-misc-fixes/for-linux-next-fixes (fb561bf9abde fbdev: Prevent pr=
obing generic drivers if a FB is already registered)
...
Merging drivers-memory/for-next (60c8a1d8ed00 Merge branch 'mem-ctrl-next' =
into for-next)
...
nto for-next)
Merging samsung-krzk/for-next (f69590af7cbc Merge branch 'next/soc64' into =
for-next)
...
Merging sunxi/sunxi/for-next (ce0854e71726 Merge branch 'sunxi/fixes-for-5.=
...
inter dereference)
Merging parisc-hd/for-next (faddcd1a161a parisc: Enable CONFIG_PRINTK_TIME=
=3Dy in 32bit defconfig)
Merging powerpc/next (158ea2d2b2ff kbuild: Fix -Wimplicit-fallthrough=3D5 e=
rror for GCC 5.x and 6.x)
...
emote object copies)
Merging cifs/for-next (8ae87bbeb5d1 cifs: introduce cifs_ses_mark_for_recon=
nect() helper)
...
Merging cel/for-next (fa55b7dcdc43 Linux 5.16-rc1)
...
r-next)
Merging pci/next (45e8e14b6956 Merge branch 'pci/enumeration')
Merging pstore/for-next/pstore (2f46d7c99830 pstore/blk: Use "%lu" to forma=
t unsigned long)
...
Merging hwmon-staging/hwmon-next (ff88cfa3c315 hwmon: (f71882fg) Add F81966=
 support)
...
Merging v4l-dvb-next/master (999ed03518cb media: atomisp: cleanup qbuf logi=
c)
Merging pm/linux-next (3b8bfff0a7ef Merge branch 'acpi-thermal' into linux-=
next)
...
Merging net-next/master (75082e7f4680 net: add missing include in include/n=
et/gro.h)
Merging bpf-next/for-next (5931d9a3d052 bpf, docs: Fix ordering of bpf docu=
mentation)
...
ifi/iwlwifi-next)
Merging bluetooth/master (28491d7ef4af Bluetooth: btusb: enable Mediatek to=
...
Merging drm-misc/for-linux-next (37fe0cf5fb80 drm/i915: Clarify probing ord=
er in intel_dp_aux_init_backlight_funcs())
CONFLICT (content): Merge conflict in drivers/gpu/drm/scheduler/sched_main.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/nouveau/dispnv50/disp=
.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/kmb/kmb_drv.c
Merging amdgpu/drm-next (c9c835dfe862 drm/amdgpu: always reset the asic in =
suspend (v2))
$ git reset --hard HEAD^
Merging next-20211117 version of amdgpu
Merging drm-intel/for-linux-next (a59308a5fb23 drm/i915: Fix fastsets on Ty=
peC ports following a non-blocking modeset)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/gt/intel_ggtt.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_dp=
.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_di=
splay.c
Merging drm-intel-gt/for-linux-next-gt (fc12b70d12d0 drm/i915/guc: fix NULL=
 vs IS_ERR() checking)
...
Merging sound/for-next (37c4fd0db7c9 ALSA: hda: Do disconnect jacks at code=
c unbind)
Merging sound-asoc/for-next (b6a5f4f05592 ASoC: SOF: Platform updates for A=
MD and Mediatek)
...
rror code)
Merging libata/for-next (48bed755f434 ata: libahci: Adjust behavior when St=
orageD3Enable _DSD is set)
Merging pcmcia/pcmcia-next (e39cdacf2f66 pcmcia: i82092: fix a null pointer=
 dereference bug)
Merging mmc/next (58c57001addf Merge branch 'fixes' into next)
...
Merging battery/for-next (e0dbd7b0ed02 power: supply: core: Add kerneldoc t=
o battery struct)
Merging regulator/for-next (4950486cd86f regulator: da9121: Emit only one e=
...
LP S4 MU)
Merging spi/for-next (40fafc8eca3f spi: hisi-kunpeng: Fix the debugfs direc=
tory name incorrect)
...
318 CPNC data)
Merging xen-tip/linux-next (08f6c2b09ebd xen: don't continue xenstore initi=
alization in case of errors)
...
ated_iommu_dev())
Merging staging/staging-next (272958bf8ec3 staging: r8188eu: remove the efu=
se_hal structure)
...
Merging scsi-mkp/for-next (fa55b7dcdc43 Linux 5.16-rc1)
Merging vhost/linux-next (47ed04961471 virtio_gpio: drop packed attribute)
Merging rpmsg/for-next (876e0b26ccd2 remoteproc: coredump: Correct argument=
 2 type for memcpy_fromio)
...
Merging pinctrl/for-next (62209e805b5c pinctrl: qcom: sm8350: Correct UFS a=
nd SDC offsets)
...
Merging pinctrl-samsung/for-next (b0ef7b1a7a07 pinctrl: samsung: Add Exynos=
7885 SoC specific data)
...
lug' into for-next)
Merging coresight/next (934a5dc1546b coresight: Use devm_bitmap_zalloc when=
 applicable)
...
Merging kspp-gustavo/for-next/kspp (4fe2837511ef Merge branch 'testing/cast=
-function-type' into for-next/kspp)
...
te)
Merging folio/for-next (d11382dbef56 mm: Add functions to zero portions of =
a folio)
...
Merging zstd/zstd-1.4.10 (804f1a11149e lib: zstd: Don't add -O3 to cflags)
...
Merging akpm/master (951ef959473a lib/stackdepot: allow optional init and s=
...

=1Ze9
-----END PGP SIGNATURE-----
