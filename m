...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9406347D19D
	for <lists+linux-next@lfdr.de>; Wed, 22 Dec 2021 13:27:15 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236224AbhLVM1O (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 22 Dec 2021 07:27:14 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:37211 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229616AbhLVM1O (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 22 Dec 2021 07:27:14 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JJsym6Cjkz4xgt;
        Wed, 22 Dec 2021 23:27:12 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1640176033;
        bh=K2tfcjBTPgWZtugu6rc+PApUnzKnvnOGp7M3Aj5ir6Y=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 22 Dec 2021 23:27:12 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 22
Message-ID: <20211222232712.61337891@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Q7D4B2OT4W=Hs03qaAGzazo";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/Q7D4B2OT4W=Hs03qaAGzazo
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211221:

The runtime WARNING has been fixed.

New tree: folio-iomap

The uml tree gained a build failure so I used the version from
next-20211221.
...
The folio-iomap tree gained a conflict against the nvdimm tree.

The akpm-current tree lost its build failure.

Non-merge commits (relative to Linus' tree): 8299
 8618 files changed, 393161 insertions(+), 172404 deletions(-)
...
Merging origin/master (2f47a9a4dfa3 Merge tag 'pm-5.16-rc7' of git://git.ke=
...
Merging net/master (ac8c58f5b535 igb: fix deadlock caused by taking RTNL in=
 RPM resume path)
...
Merging sound-asoc-fixes/for-linus (1a082ed16e73 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (e20739381a3e Merge remote-tracking branch 'spi=
...
Merging devicetree-fixes/dt/linus (7ca964c3978d efi: apply memblock cap aft=
er memblock_add())
...
Merging arm-soc/for-next (73f70ef9363b soc: document merges)
...
Merging qcom/for-next (16c426fe573b Merge branches 'arm64-defconfig-for-5.1=
...
Merging parisc-hd/for-next (d3a5a68cff47 parisc: Fix mask used to select fu=
tex spinlock)
...
Merging uml/linux-next (5d0f822da145 um: remove set_fs)
$ git reset --hard HEAD^
Merging next-20211221 version of uml
...
Merging net-next/master (294e70c952b4 Merge tag 'mac80211-next-for-net-next=
-2021-12-21' of git://git.kernel.org/pub/scm/linux/kernel/git/jberg/mac8021=
1-next)
...
Merging wireless-drivers-next/master (8704d0befb59 rtw88: support SAR via k=
ernel common API)
Merging bluetooth/master (ef09050b2fb7 Bluetooth: btintel: Add missing quir=
...
Merging mtd/mtd/next (6420ac0af95d mtdchar: prevent unbounded allocation in=
 MEMWRITE ioctl)
Merging nand/nand/next (b90c42c74761 MAINTAINERS: Add an entry for Renesas =
NAND controller)
...
Merging sound-asoc/for-next (53778b8292b5 ASoC: Add AK4375 support)
...
LP S4 MU)
Merging spi/for-next (6008cb4c98d9 spi: spi-mtk-nor: add new clock name 'ax=
i' for spi nor)
...
on from dts)
Merging ipmi/for-next (140342bdc7c5 ipmi/watchdog: Constify ident)
...
Y/OVERRUN printouts)
Merging char-misc/char-misc-next (fdcee305c08a Merge tag 'coresight-next-v5=
.17' of gitolite.kernel.org:pub/scm/linux/kernel/git/coresight/linux into c=
har-misc-next)
...
isting file)
Merging gpio-brgl/gpio/for-next (a2d05fb73493 gpio: sim: add missing fwnode=
_handle_put() in gpio_sim_probe())
CONFLICT (content): Merge conflict in tools/testing/selftests/gpio/Makefile
$ git reset --hard HEAD^
Merging next-20211217 version of gpio-brgl
CONFLICT (content): Merge conflict in tools/testing/selftests/gpio/Makefile
[master 68b9e1532c98] next-20211217/gpio-brgl
Applying: Revert "gpio: bcm-kona: add const to of_device_id"
[master 78c17e1af741] next-20211217/gpio-brgl
...
Merging pwm/for-next (3f0565451cc0 dt-bindings: pwm: Avoid selecting schema=
 on node name match)
Merging userns/for-next (03207a4424b7 Merge of signal-for-v5.17, and ucount=
...
Merging akpm-current/current (c063fe33051c ubsan: remove CONFIG_UBSAN_OBJEC=
T_SIZE)
...
Merging akpm/master (c019332650a7 lib/stackdepot: always do filter_irq_stac=
...

=aTQR
-----END PGP SIGNATURE-----
