Return-Path: <linux-next+bounces-2386-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C43468CCA44
	for <lists+linux-next@lfdr.de>; Thu, 23 May 2024 03:10:48 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D7CDB1C20E4A
	for <lists+linux-next@lfdr.de>; Thu, 23 May 2024 01:10:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3C8936FC7;
	Thu, 23 May 2024 01:10:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="nt8q7CWh"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BE7284C9F;
	Thu, 23 May 2024 01:10:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1716426638; cv=none; b=cdsw5yl+wprJZWHcVLGJ0cNTK4sI1z/syi8co8z0kkUhrktyqb5ky4jz01Hlp3rKH60cTBeu8MHDU0XK4t5/x3KcGEi8lj1s1JYsZd67a/0U/hetcNsrISTYjkpJK+1GHDuAK6lU+Syq049VfQzrg3bPbjZ91XMUZZ6RCAkQRrA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1716426638; c=relaxed/simple;
	bh=CALJDQxEacxOA7++LmjbBdj7dRpSKdPyIzkMJH+mZ4E=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=uphlvNqKD40mYsRbLTt5VaW/hOM/2dK0FSQZxTEi0OZacoNBaUbcSMvMoFv0p9kDsH2MEzW9JLMihN5ZDpqyS8VYHijF+WXwx1cX03k/hoAjlq0O7qu3daz31EIeuRIZ7Yp7dweiT1tNGzSqq8NRtMo6FZ1Z8y5pRBSV/6aQPVE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=nt8q7CWh; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1716426624;
	bh=r4qODbnkK1MPv22kYsMbXum828JtggPzERDDquvskJo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Vl98J33mwz4wc1;
	Thu, 23 May 2024 11:10:24 +1000 (AEST)
Date: Thu, 23 May 2024 11:10:23 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 23
Message-ID: <20240523111023.7ade2aa4@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/q78ybvir2+W93lkT_drTk9R";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/q78ybvir2+W93lkT_drTk9R
...
Changes since 20240522:

The risc-v tree gained a conflict against Linus' tree.

The i2c-host tree still had its build failure so I used the version from
next-20240521.
...
Non-merge commits (relative to Linus' tree): 1368
 1507 files changed, 352320 insertions(+), 14363 deletions(-)
...
Merging origin/master (de7e71ef8bed mm: simplify and improve print_vma_addr=
() output)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (20141ebd2d7d lib-add-version-into=
-proc-allocinfo-output-fix)
Merging kbuild-current/fixes (0c7aac55fa5a kbuild: fix short log for AS in =
link-vmlinux.sh)
...
Merging s390-fixes/fixes (2a8120d7b482 Merge tag 's390-6.10-2' of git://git=
...
Merging net/main (9c91c7fadb17 net: mana: Fix the extra HZ in mana_hwc_send=
_request)
...
Merging sound-current/for-linus (c1a8d5f31b60 ALSA: core: Enable proc modul=
e when CONFIG_MODULES=3Dy)
...
Merging perf-current/perf-tools (29c73fc794c8 Merge tag 'perf-tools-for-v6.=
10-1-2024-05-21' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf=
-tools)
...
ite-only variable)
Merging risc-v/for-next (018b9d9874e7 Merge patch series "riscv: access_ok(=
) optimization")
...
Merging bcachefs/for-next (2ba24864d2f6 bcachefs: Fix stack oob in __bch2_e=
ncrypt_bio())
...
for Ceph)
Merging cifs/for-next (d475b1f422e1 cifs: Fix smb3_insert_range() to move t=
he zero_point)
...
-next)
Merging i2c/i2c/for-next (29c73fc794c8 Merge tag 'perf-tools-for-v6.10-1-20=
24-05-21' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-tools)
...
logy series)
Merging bluetooth/master (a3975db95fcd Bluetooth: L2CAP: Fix rejecting L2CA=
P_CONN_PARAM_UPDATE_REQ)
...
Merging crypto/master (13909a0c8897 crypto: atmel-sha204a - provide the otp=
 content)
Merging drm/drm-next (3e3eb55e2b5f Merge tag 'drm-misc-next-fixes-2024-05-1=
6' of https://gitlab.freedesktop.org/drm/misc/kernel into drm-next)
  959314c438ca ("drm/nouveau: use tile_mode and pte_kind for VM_BIND bo all=
ocations")
...
s_valid kerneldoc)
Merging drm-intel/for-linux-next (a9940ce97d1d drm/i915: Document which pla=
tforms use which sprite registers)
...
Merging drm-xe/drm-xe-next (40672b792a36 drm/xe: Properly handle alloc_guc_=
id() failure)
...
stride() test)
Merging sound/for-next (c1a8d5f31b60 ALSA: core: Enable proc module when CO=
NFIG_MODULES=3Dy)
...
Merging input/next (e7647cbaba0e Input: xpad - add support for Machenike G5=
 Pro Controller)
Merging block/for-next (7bc28be25ef3 Merge branch 'block-6.10' into for-nex=
t)
CONFLICT (content): Merge conflict in block/blk-core.c
Merging device-mapper/for-next (ee30ad132426 dm: retain stacked max_sectors=
 when setting queue_limits)
...
Merging tpmdd/next (cd579e546718 tpm_tis_spi: Account for SPI header when a=
...
10' into spi-next)
Merging tip/master (bdc42ded3ec7 Merge branch into tip/master: 'x86/percpu')
...
Merging efi/next (8dbb36e91215 efi/libstub: zboot.lds: Discard .discard sec=
tions)
...

=3z7j
-----END PGP SIGNATURE-----
