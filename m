Return-Path: <linux-next+bounces-4549-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 903EC9B7453
	for <lists+linux-next@lfdr.de>; Thu, 31 Oct 2024 07:10:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id A56DA1C21D3B
	for <lists+linux-next@lfdr.de>; Thu, 31 Oct 2024 06:10:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DA653142E78;
	Thu, 31 Oct 2024 06:09:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="L/N1dy6b"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B7BBF140E38;
	Thu, 31 Oct 2024 06:09:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1730354997; cv=none; b=UwguLPf94S27FIMUXzjYIgFeH/0PIkuGr9/JmPJGU7MhdYQ49/DawhkbGj29G/bL9Z4bSm7jYckevKeymdjdQ9u1lhLBgFYrBiV1VhQyPwPYTH1kLnQHDXEaW2+KLHtNz4rTrsgp0hzczxdFYzTp/jhe8EmUAuZyS5EbMFf0MOk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1730354997; c=relaxed/simple;
	bh=WkvVud084PX/t+GpxeDR8brrvfPpa+J/KrcSIx/I1tI=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=UItYB8G4AUCz77Sg+TAke+5Z2QPeuIrAnfZDTohWsr2iWln3OTK6hHaLONP2gOoK7DjwVRBz1kJr5TK5OrlLoum5eLORn5jK80XCMOQ9cKBwR6MI+MNCzaGBzNjNscA61se90MUF5z0B6cvZhEhLZhSUYgAtWVvRJkE3uyCqapw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=L/N1dy6b; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1730354983;
	bh=x5LRMiuTTerXTIq/ap4/4eY+MOf8djhwV1qZFcWYcX8=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XfD9M1hxdz4xGC;
	Thu, 31 Oct 2024 17:09:43 +1100 (AEDT)
Date: Thu, 31 Oct 2024 17:09:43 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 31
Message-ID: <20241031170943.33b0f313@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/GOlpB8=Y4YVxAlOGn3hbtP.";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/GOlpB8=Y4YVxAlOGn3hbtP.
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241030:

The arm64 tree gained a conflict against the mm-hotfixes tree.

The vfs-brauner tree lost its boot failure.

The tip tree still had its build failure for which I applied a patch.

The kvm-arm tree gained a conflict gainst the arm64 tree.

Non-merge commits (relative to Linus' tree): 7635
 9410 files changed, 332380 insertions(+), 246477 deletions(-)
...
Merging origin/master (4236f913808c Merge tag 'scsi-fixes' of git://git.ker=
...
ng server address)
Merging btrfs/for-next (77d602a2ad9a Merge branch 'for-next-next-v6.12-2024=
...
Merging nfsd/nfsd-next (6c8910ac1cd3 nfsd: allow for up to 32 callback sess=
ion slots)
...
Merging mm-hotfixes/mm-hotfixes-unstable (cb117bfc3dee objpool: fix to make=
 percpu slot allocation more robust)
Merging fs-current (9a46a7229dcc Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (c05c62850a8f Merge tag 'wireless-2024-10-29' of https://g=
it.kernel.org/pub/scm/linux/kernel/git/wireless/wireless)
Merging bpf/master (053b212b3a35 Merge branch 'fixes-for-bits-iterator')
...
ndle table array)
Merging sound-current/for-linus (e49370d769e7 ALSA: hda/realtek: Fix headse=
t mic on TUXEDO Stellaris 16 Gen6 mb1)
...
Merging drm-misc-fixes/for-linux-next-fixes (4700fd3e050d drm/panthor: Repo=
rt group as timedout when we fail to properly suspend)
...
Merging mm/mm-everything (a524169f2027 foo)
Merging kbuild/for-next (7e04fcfc6195 kconfig: qconf: simplify character re=
placement)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (54afc56db221 perf probe: Fix retrieval of sou=
rce files from a debuginfod server)
...
Merging fs-next (708a7453332c Merge branch 'vfs.all' of git://git.kernel.or=
...
operty_present())
Merging pmdomain/next (cc8eeff3e8b6 pmdomain: Merge branch fixes into next)
...
nd QP modify)
Merging net-next/main (4ddf7ccfdf70 gve: change to use page_pool_put_full_p=
age when recycling pages)
...
_elem_alloc helper)
Merging bluetooth/master (af524ed29eee Bluetooth: hci: fix null-ptr-deref i=
n hci_read_supported_codecs)
Merging wireless-next/for-next (2b1d193a5a57 Documentation: networking: Add=
 missing PHY_GET command in the message list)
...
Merging drm/drm-next (e7103f878550 Merge tag 'amd-drm-next-6.13-2024-10-25'=
 of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
  0654196d7ea2 ("dma-buf: Use atomic64_inc_return() in dma_buf_getfile()")
...
rototype for crtc)
Merging drm-misc/for-linux-next (904bc5479896 Documentation/gpu: Fix Pantho=
r documentation build warnings)
Merging amdgpu/drm-next (ecfe9b237687 drm/amdgpu/smu13: fix profile reporti=
ng)
Merging drm-intel/for-linux-next (5eb2e7855910 drm/i915/display: use x100 v=
ersion for full version and release)
Merging drm-msm/msm-next (4a6fd06643af Merge remote-tracking branch 'drm-mi=
sc/drm-misc-next' into msm-next)
Merging drm-msm-lumag/msm-next-lumag (d3604dff18e1 drm/msm/dp: tidy up plat=
form data names)
Merging drm-xe/drm-xe-next (0191fddf5374 Revert "drm/xe/xe_guc_ads: save/re=
store OA registers and allowlist regs")
...
Merging block/for-next (be856e188156 Merge branch 'for-6.13/io_uring' into =
for-next)
...
TION() macros)
Merging mmc/next (8a98e86a5a2c mmc: sdhci: Make MMC_SDHCI_UHS2 config symbo=
l invisible)
...
13' into spi-next)
Merging tip/master (9bfae8f5ca65 Merge branch into tip/master: 'x86/sev')
...
Merging ftrace/for-next (099a6cbe1fa1 Merge tools/for-next)
...
Merging kvm-arm/next (6e0667933ccf Merge branch kvm-arm64/nv-s1pie-s1poe in=
to kvmarm/next)
...

=e1v4
-----END PGP SIGNATURE-----
