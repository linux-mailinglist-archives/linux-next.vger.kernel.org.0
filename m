Return-Path: <linux-next+bounces-3313-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id BA9289513A8
	for <lists+linux-next@lfdr.de>; Wed, 14 Aug 2024 06:57:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 115D31F23DCB
	for <lists+linux-next@lfdr.de>; Wed, 14 Aug 2024 04:57:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AE365481C0;
	Wed, 14 Aug 2024 04:56:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="fgRPc4tP"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D9B28365;
	Wed, 14 Aug 2024 04:56:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723611418; cv=none; b=cqPJr7GysaQfMxUGVquKTNosfR9GnyzQ1C1GXhRrpimZeOSRSL+jKKtyiHDYEkIwbtD2zTGvMDQ4ZAg3XDVT/m5Sfj71+vH+kQ5Cui2NDQ+jtb9RbosG1s3f0ZR6MrNzAXCrNRa/VYi4HtX0MzJ9qX5OWJY6qa/5IrAv45LKHSs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723611418; c=relaxed/simple;
	bh=TCkE5CSWj7LVbBE1qJqTbsR5Kuov2eRjBwqgbNE2Wko=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=MWinaT6qeLiFSJv7PQRvz4A1jtEanthqCSM52/hEVkA6DPJ+h68F1OBXqu14J8j/WkcwtCtLPMVO63+WP0OYyXq0evHnu64D8KBcRBG1OEGC3poMgrFrlth47SzG1qRWJPHG7hvaDri9erlZ9JTIz+HmUE1ZxIvaENuHioM07X0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=fgRPc4tP; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1723611410;
	bh=HQl5FB3Ummr52j4RkQCK+mE1QKqvk0s8/KgQc1neTKQ=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WkGFG4YVmz4wp0;
	Wed, 14 Aug 2024 14:56:50 +1000 (AEST)
Date: Wed, 14 Aug 2024 14:56:50 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 14
Message-ID: <20240814145650.04cbaf16@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/nM45j9O5i5k7TvpX+aazfSD";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/nM45j9O5i5k7TvpX+aazfSD
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240813:

Removed trees:	djw-vfs, iomap	Finished with

The mm tree still had its build failure for which I applied a hack.

The bpf-next tree gained a conflict and 2 semantic conflicts against
the vfs-brauner tree.

Non-merge commits (relative to Linus' tree): 4112
 4564 files changed, 161528 insertions(+), 78290 deletions(-)
...
Merging origin/master (6b4aa469f049 Merge tag '6.11-rc3-ksmbd-fixes' of git=
://git.samba.org/ksmbd)
Merging vfs-brauner-fixes/vfs.fixes (810ee43d9cd2 Squashfs: sanity check sy=
mbolic link size)
...
ng server address)
Merging btrfs/for-next (243d34b77b87 Merge branch 'for-next-next-v6.11-2024=
0813' into for-next-20240813)
...
nt error output)
Merging nfsd/nfsd-next (4ddc6db12829 .mailmap: Add an entry for my work ema=
il address)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (53f195db51e2 Merge branch 'vfs.xattr' into vfs=
...
Merging fs-current (6c7f20ab7680 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (df934abb185c mlxbf_gige: disable RX filters until RX path=
 initialized)
Merging bpf/master (100bff23818e perf/bpf: Don't call bpf_overflow_handler(=
) for tracing events)
...
Merging sound-current/for-linus (8475a1d9bb7a ALSA: hda: cs35l41: Remove re=
dundant call to hda_cs_dsp_control_remove())
Merging sound-asoc-fixes/for-linus (b919a27fab37 ASoC: MAINTAINERS: Drop Ba=
najit Goswami from Qualcomm sound drivers)
...
Merging kvm-fixes/master (238d3d63d1e2 KVM: selftests: Add a testcase to ve=
rify x2APIC is fully readonly)
...
plicated clocks)
Merging i2c-host-fixes/i2c/i2c-host-fixes (4e91fa1ef3ce i2c: qcom-geni: Add=
...
1-next)
Merging broadcom/next (77087936ebf4 Merge branch 'drivers/next' into next)
...
or-next)
Merging scmi/for-linux-next (bdbb6265e7c5 Merge branches 'for-next/scmi/upd=
ates' and 'for-next/juno/updates' of ssh://gitolite.kernel.org/pub/scm/linu=
...
Merging fs-next (bb62fbd2b0e3 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging hwmon-staging/hwmon-next (38d0d3da8d07 hwmon: Add thermal sensor dr=
iver for Surface Aggregator Module)
...
Merging pm/linux-next (d974429c4bfc Merge branch 'thermal-core' into linux-=
next)
...
SFS_PATH ioctl)
Merging net-next/main (dd1bf9f9df15 net: hinic: use ethtool_sprintf/puts)
...
Merging drm-misc/for-linux-next (a884dde8d9b6 drm/ci: uprev mesa)
...
Merging drm-xe/drm-xe-next (1d734a3e5d6b drm/xe: Name and document Wa_14019=
789679)
...
rol interfaces)
Merging ieee1394/for-next (e7154dede9e9 firewire: core: use xarray instead =
of idr to maintain client resource)
Merging sound-asoc/for-next (0c08826b1269 Merge remote-tracking branch 'aso=
...
s)
Merging rpmsg/for-next (a53935f8153a Merge branches 'rproc-next', 'rpmsg-ne=
...
Merging rtc/rtc-next (8400291e289e Linux 6.11-rc1)
...

=GAB9
-----END PGP SIGNATURE-----
