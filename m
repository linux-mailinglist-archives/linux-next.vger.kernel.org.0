...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8D3915967CD
	for <lists+linux-next@lfdr.de>; Wed, 17 Aug 2022 05:46:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230244AbiHQDmk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 16 Aug 2022 23:42:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42548 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229656AbiHQDmj (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 16 Aug 2022 23:42:39 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E2E1786899;
        Tue, 16 Aug 2022 20:42:35 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4M6v3Y48mJz4x1d;
        Wed, 17 Aug 2022 13:42:33 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1660707753;
        bh=oUa7pN6EhVPkLAp9Wl26pR95W2QLD5t0QR1fNy3DH9M=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 17 Aug 2022 13:42:27 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 17
Message-ID: <20220817134227.0c3f96c2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ODxAOFezJ2z2IiX4m3q95yO";
...
--Sig_/ODxAOFezJ2z2IiX4m3q95yO
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220816:

The amdgpu tree (hopefully) lost its build failure.

The input tree gained a semantic conflict against the i2c tree.

The mfd tree gained a conflict against the i2c tree.

The vhost tree lost its build failure.

Non-merge commits (relative to Linus' tree): 1073
 1717 files changed, 43072 insertions(+), 14317 deletions(-)
...
Merging origin/master (3cc40a443a04 Merge tag 'nios2_fixes_v6.0' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/dinguyen/linux)
...
Merging net/master (ae806c780557 Merge branch '40GbE' of git://git.kernel.o=
...
Merging sound-current/for-linus (70cfdd0365ac ALSA: hda/realtek: Add quirk =
for Lenovo Yoga7 14IAL7)
Merging sound-asoc-fixes/for-linus (dcdfa3471f9c ASoC: fsl_sai: fix incorre=
ct mclk number in error message)
...
Merging risc-v-fixes/fixes (568035b01cfb Linux 6.0-rc1)
...
Merging drivers-memory/for-next (9f8fb8032feb dt-bindings: memory: mediatek=
,smi: Update condition for mt8195 smi node)
...
nto for-next)
Merging samsung-krzk/for-next (568035b01cfb Linux 6.0-rc1)
...
Merging vfs/for-next (d6da19c9cace locks: fix TOCTOU race when granting wri=
te lease)
...
Merging bpf-next/for-next (807662cac66a selftests/bpf: Fix attach point for=
 non-x86 arches in test_progs/lsm)
...
Merging regmap/for-next (77672e0387f9 regmap: mmio: Extending to support IO=
 ports)
Merging sound/for-next (70cfdd0365ac ALSA: hda/realtek: Add quirk for Lenov=
o Yoga7 14IAL7)
Merging sound-asoc/for-next (95aefb5c5225 Merge remote-tracking branch 'aso=
c/for-6.1' into asoc-next)
Merging modules/modules-next (554694ba120b module: Replace kmap() with kmap=
_local_page())
Merging input/next (900365814ee0 Input: adc-joystick - add polled input dev=
ice support)
Applying: Input: fix up for "i2c: Make remove callback return void"
...
1' into spi-next)
Merging tip/master (53ea03e020f4 Merge x86/urgent into tip/master)
...

=8nrf
-----END PGP SIGNATURE-----
