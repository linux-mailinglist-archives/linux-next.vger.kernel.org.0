...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4A8BD445FDB
	for <lists+linux-next@lfdr.de>; Fri,  5 Nov 2021 07:45:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232469AbhKEGsa (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 5 Nov 2021 02:48:30 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35786 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232455AbhKEGs2 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 5 Nov 2021 02:48:28 -0400
Received: from mail-pj1-x1032.google.com (mail-pj1-x1032.google.com [IPv6:2607:f8b0:4864:20::1032])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D29E2C061714
        for <linux-next@vger.kernel.org>; Thu,  4 Nov 2021 23:45:48 -0700 (PDT)
Received: by mail-pj1-x1032.google.com with SMTP id n11-20020a17090a2bcb00b001a1e7a0a6a6so2711347pje.0
        for <linux-next@vger.kernel.org>; Thu, 04 Nov 2021 23:45:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=aGpdCxK5DkF1pfckiEUEDMcfOinJQd28iwdldMxruWs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=aGpdCxK5DkF1pfckiEUEDMcfOinJQd28iwdldMxruWs=;
        b=
X-Gm-Message-State: AOAM532JsrZRUVmLIVf2ukHq7m+oJDMb0vqk+t9FJNYPTrN0lF1HTDcJ
        S3dZfKPa3vafGRUh5pc3eEh3e0LsJ/I/gaAD
X-Google-Smtp-Source: ABdhPJz80ySRm7cqWhnkBOhW0VRbN2NOd7kx4obFC3JTA8JtTdaYEiolT60UhePgMHCB1lfkV52okQ==
X-Received: by 2002:a17:90a:b795:: with SMTP id m21mr27672852pjr.143.1636094746404;
        Thu, 04 Nov 2021 23:45:46 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id z10sm5397697pfe.92.2021.11.04.23.45.45
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 04 Nov 2021 23:45:45 -0700 (PDT)
Message-ID: <6184d319.1c69fb81.709f6.243b@mx.google.com>
Date:   Thu, 04 Nov 2021 23:45:45 -0700 (PDT)
...
Subject: next/master build: 228 builds: 22 failed, 206 passed, 449 errors,
 275 warnings (next-20211105)
...
next/master build: 228 builds: 22 failed, 206 passed, 449 errors, 275 warni=
ngs (next-20211105)
...
Errors summary:
    ...
    4    fs/nfs/dir.c:1772:6: error: variable 'error' is used uninitialized=
...
=3D0x'
    1    :22:12: error: unknown relocation name

Warnings summary:

    142  <stdin>:1559:2: warning: #warning syscall futex_waitv not implemen=
ted [-Wcpp]
    28   clang: warning: argument unused during compilation: '-march=3Darmv=
6k' [-Wunused-command-line-argument]
    15   fs/nfs/dir.c:1754:11: note: initialize the variable 'error' to sil=
ence this warning
...
me
    :22:12: error: unknown relocation name
