...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1C68423093F
	for <lists+linux-next@lfdr.de>; Tue, 28 Jul 2020 13:57:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728199AbgG1L5m (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 28 Jul 2020 07:57:42 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:45265 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728129AbgG1L5l (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 28 Jul 2020 07:57:41 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BGFXv1QmQz9sSt;
        Tue, 28 Jul 2020 21:57:35 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1595937455;
        bh=pSlGANtFTyBFLYSFRvurClEUiHnqFYgUlGakTmfmLLI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 28 Jul 2020 21:57:31 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 28
Message-ID: <20200728215731.00cb56d3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/+3NKVcNOZCN_vZ3slJvpqML";
...
New tree: drivers-memory-fixes

My fixes tree contains:

  dbf24e30ce2e ("device_cgroup: Fix RCU list debugging warning")

The sh tree gained a conflict against the csky tree.

The xtensa tree gained a conflict against the sh tree.

The vfs tree lost its build failure but gained a changed conflict against
Linus' tree.
...
The char-misc tree still had its build failures so I used the version from
next-20200724.

The vhost tree gained a build failure so I used the version from
next-20200727.

The kspp tree gained a conflict against the rdma tree.

The drivers-memory tree lost its build failure.

Non-merge commits (relative to Linus' tree): 11064
 11685 files changed, 576628 insertions(+), 218657 deletions(-)
...
Merging net/master (181964e619b7 fix a braino in cmsghdr_from_user_compat_t=
o_kern())
...
Merging sound-current/for-linus (a6630529aecb ALSA: hda: Workaround for spu=
rious wakeups on some Intel platforms)
Merging sound-asoc-fixes/for-linus (b7a3a6adc253 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (3adeb4d144bf Merge remote-tracking branch 'spi=
...
Merging drm-misc-fixes/for-linux-next-fixes (8490d6a7e0a0 drm: hold gem ref=
erence until object is no longer accessed)
...
vents via sysfs)
Merging arm-soc/for-next (43eb00ace71c soc: document merges)
Merging amlogic/for-next (d0711b7252a7 Merge branch 'v5.9/soc' into tmp/aml=
-rebuild)
Merging aspeed/for-next (e6873087cce6 ARM: dts: aspeed: wedge40: Enable pwm=
_tacho device)
Merging at91/at91-next (ec539e70d882 Merge branches 'at91-soc', 'at91-dt' a=
nd 'at91-defconfig' into at91-next)
Merging drivers-memory/for-next (4cd87f5bfded MAINTAINERS: Add Git reposito=
...
Merging clk/clk-next (8fc7649fb04f Merge branch 'clk-bcm' into clk-next)
...
Merging ext3/for_next (971badfe4666 Pull fsnotify name event patches from A=
mir.)
...
Merging file-locks/locks-next (5ef159681309 locks: add locks_move_blocks in=
 posix_lock_inode)
Merging vfs/for-next (259bf01c1bd1 Merge branches 'work.misc', 'work.regset=
' and 'work.fdpic' into for-next)
...
w.c
Merging printk/for-next (129650e8519f Merge branch 'for-5.9' into for-next)
...
Merging net-next/master (5e619d73e679 net/mlx4: Use fallthrough pseudo-keyw=
ord)
...
ge
Merging bpf-next/master (9a97c9d2af5c tools, bpftool: Add LSM type to array=
 of prog names)
...
Merging spi-nor/spi-nor/next (99eae48fd4c5 mtd: spi-nor: update read capabi=
lities for w25q64 and s25fl064k)
...
registers (v7))
Merging drm-intel/for-linux-next (1e4fcd40445c drm/i915: Implement WA 14011=
294188)
...
Merging sound-asoc/for-next (096e73ac2ef9 Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (ad226835b250 Merge remote-tracking branch 'regu=
...
tatus reply)
Merging devicetree/for-next (70172d196947 dt-bindings: pci: convert QCOM pc=
i bindings to YAML)
CONFLICT (modify/delete): Documentation/devicetree/bindings/pci/qcom,pcie.t=
xt deleted in devicetree/for-next and modified in HEAD. Version HEAD of Doc=
umentation/devicetree/bindings/pci/qcom,pcie.txt left in tree.
...
xt
$ git rm -f Documentation/devicetree/bindings/pci/qcom,pcie.txt
...
pcs compatible)
Merging spi/for-next (8cd6c5b0d0b4 Merge remote-tracking branch 'spi/for-5.=
9' into spi-next)
...
Merging drivers-x86/for-next (50c8a002bfd4 platform/x86: ISST: drop a dupli=
cated word in isst_if.h)
...
Merging usb/usb-next (ca6377900974 Revert "usb: dwc2: override PHY input si=
gnals with usb role switch support")
...
Merging char-misc/char-misc-next (65a9bde6ed48 Merge 5.8-rc7 into char-misc=
-next)
$ git reset --hard HEAD^
...
Merging staging/staging-next (908e757daecf Merge 5.8-rc7 into staging-next)
...
Merging rpmsg/for-next (ddd1930d6e3e Merge branches 'hwspinlock-next', 'rpm=
...
Merging fsinfo/fsinfo-core (f0c652d3b991 samples: add error state informati=
on to test-fsinfo.c)
...
Merging akpm-current/current (c601dfa82f7e ipc/shm.c: Remove the superfluou=
s break)
...
Merging akpm/master (971f7f374cca virtio: pci: constify ioreadX() iomem arg=
...

=g/+/
-----END PGP SIGNATURE-----
