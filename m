...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EDE151EDDA5
	for <lists+linux-next@lfdr.de>; Thu,  4 Jun 2020 09:08:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726248AbgFDHIe (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 4 Jun 2020 03:08:34 -0400
Received: from ozlabs.org ([203.11.71.1]:54797 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726246AbgFDHIb (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 4 Jun 2020 03:08:31 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49cxh907qBz9sSc;
        Thu,  4 Jun 2020 17:08:24 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1591254505;
        bh=+6CKo8q+E3CGx4r0MhxqRWTDX86Uy22eOnGOJLAfZ1s=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 4 Jun 2020 17:08:24 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 4
Message-ID: <20200604170824.143311d1@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/C_4/QGT6GitSrYIOMUG./Dw";
...
The overlayfs tree lost its build failure.

The v4l-dvb-next tree lost its build failure.

The tip tree gained conflicts against the sparc-next tree.

The akpm tree gained a build failure for which I applied a patch.

Non-merge commits (relative to Linus' tree): 10238
 10675 files changed, 875263 insertions(+), 176758 deletions(-)
...
Merging origin/master (38696e33e2bd Merge tag 'xtensa-20200603' of git://gi=
...
Merging sound-current/for-linus (d9b8fbf15d05 ALSA: es1688: Add the missed =
snd_card_free())
...
Merging kbuild/for-next (e4a0d77d3323 Merge branch 'kconfig' into for-next)
...
2 policies)
Merging afs/afs-next (d3c575a1f223 afs: Adjust the fileserver rotation algo=
...
Merging cifs/for-next (4db2c422a491 cifs: update internal module version nu=
mber)
...
arning)
Merging exfat/dev (03b8f4ae2318 exfat: fix memory leak in exfat_parse_param=
())
...
--> pin_user_pages())
Merging overlayfs/overlayfs-next (eda618726c0b ovl: make oip->index bool)
...
Merging file-locks/locks-next (5ef159681309 locks: add locks_move_blocks in=
 posix_lock_inode)
Merging vfs/for-next (4192f6c1fd6d Merge branches 'uaccess.csum', 'uaccess.=
misc', 'uaccess.comedi' and 'uaccess.hpsa' into for-next)
...
nter dereference)
Merging mac80211-next/master (065fcfd49763 selftests: net: ip_defrag: ignor=
e EPERM)
...
Merging sound/for-next (d9b8fbf15d05 ALSA: es1688: Add the missed snd_card_=
free())
...
Merging device-mapper/for-next (00440e682814 dm zoned: check superblock loc=
ation)
...
Merging akpm-current/current (c78a122bbc68 linux-next-pre)
...
Merging akpm/master (2afd019002b6 sh: add missing EXPORT_SYMBOL() for __del=
ay)
...
table.h
Applying: fixup for powerpc ptdump.c
...

=lzJh
-----END PGP SIGNATURE-----
