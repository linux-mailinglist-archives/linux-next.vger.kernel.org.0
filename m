Return-Path: <linux-next+bounces-1557-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 43EFA875DFA
	for <lists+linux-next@lfdr.de>; Fri,  8 Mar 2024 07:28:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 4BA781C201EE
	for <lists+linux-next@lfdr.de>; Fri,  8 Mar 2024 06:28:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A6E4336129;
	Fri,  8 Mar 2024 06:28:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="wpeNqr+W"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pl1-f176.google.com (mail-pl1-f176.google.com [209.85.214.176])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CC996328B6
	for <linux-next@vger.kernel.org>; Fri,  8 Mar 2024 06:28:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709879317; cv=none; b=RrFdgRRVHE0oiqBkg2B7BOhsYf8KcAy/oWwjkZ8Fl0qzc2npxdMwZB66mScaHUdHEa69uqxaM79V1oaRlfD0nfB47ykpjYCEM+LGNzENBK88hOMQ9G6g1dRdaFC9sxwxLIdCY9rs92dG3Pxs175tx1NIX7D+fk8fk5osjSgF9z8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709879317; c=relaxed/simple;
	bh=/DtkQPn5b08BmKWwrRHJbxXlpv/H5Izrx4roIamuing=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=oLTyO5u3cMtX9Kd2jwh8J/n3PSmegK83MsDBN+MJaneBqVJdcKaOwfcUK6mnmqW1yfsXj1svUMSHOaa1XArJEVHVhLuvVU5ydbaM/m/AwImiEcWuOEl/XGU7lRXCe7+Fj80KLRa4d5dIFWGzXS1ABY9gL41rxw80qYZWBXbemAs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=wpeNqr+W; arc=none smtp.client-ip=209.85.214.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pl1-f176.google.com with SMTP id d9443c01a7336-1dd68d4cff1so2474055ad.2
        for <linux-next@vger.kernel.org>; Thu, 07 Mar 2024 22:28:32 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1709879312; x=1710484112; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=Ky6hlFDhRC+ogNta6JwA5oSFVoqIvyNXKo+TN8hseyE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1709879312; x=1710484112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Ky6hlFDhRC+ogNta6JwA5oSFVoqIvyNXKo+TN8hseyE=;
        b=
X-Gm-Message-State: AOJu0Yye9PNW/z2M0oIaxKxqdXdpiksRHAJdGcZ61TGG+IwY+unTqxXD
	hPJ098XbgxDgCcmha19xyX1M+SQQyp0dTVu283Mv2IrKEwS2+kKlsoCo0xcQWjJ7wwuPdb45KOK
	tg4s=
X-Google-Smtp-Source: AGHT+IFkoMIz01eXsrAPbltkqKdSfFJHh45yZK+FFrKLvU1RL63dnTN47qMuLRrvExokXAD4oF7Ezg==
X-Received: by 2002:a17:902:6b07:b0:1dc:f7cb:bbaf with SMTP id o7-20020a1709026b0700b001dcf7cbbbafmr9324608plk.22.1709879310361;
        Thu, 07 Mar 2024 22:28:30 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id q7-20020a17090311c700b001dcb7b28705sm15642062plh.26.2024.03.07.22.28.28
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 07 Mar 2024 22:28:29 -0800 (PST)
Message-ID: <65eab00d.170a0220.c8c30.ac73@mx.google.com>
Date: Thu, 07 Mar 2024 22:28:29 -0800 (PST)
...
Subject: next/master build: 170 builds: 13 failed, 157 passed, 12 errors,
 309 warnings (next-20240308)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 170 builds: 13 failed, 157 passed, 12 errors, 309 warnin=
gs (next-20240308)
...
Tree: next
Branch: master
Git Describe: next-20240308
Git Commit: 8ffc8b1bbd505e27e2c8439d326b6059c906c9dd
...
m-hdmi.ko] undefined!
    3    arch/mips/ralink/timer.c:136:34: error: array type has incomplete =
element type =E2=80=98struct of_device_id=E2=80=99
...
=E2=80=98__cmpdi2=E2=80=99 [-Wmissing-prototypes]
    3    arch/mips/ralink/timer.c:136:34: warning: =E2=80=98rt_timer_match=
...
t an interrupt provider
    ...
    1    ................/arch/arc/kernel/ptrace.c:342:16: warning: no prev=
ious prototype for 'syscall_trace_enter' [-Wmissing-prototypes]
...
ider
    arch/arc/boot/dts/haps_hs_idu.dtb: Warning (interrupt_map): Failed prer=
equisite 'interrupt_provider'
    ................/arch/arc/kernel/ptrace.c:342:16: warning: no previous =
prototype for 'syscall_trace_enter' [-Wmissing-prototypes]
    arch/arc/kernel/kprobes.c:193:15: warning: no previous prototype for 'a=
rc_kprobe_handler' [-Wmissing-prototypes]
...
Errors:
    arch/mips/ralink/timer.c:136:34: error: array type has incomplete eleme=
nt type =E2=80=98struct of_device_id=E2=80=99

Warnings:
    arch/mips/ralink/timer.c:136:34: warning: =E2=80=98rt_timer_match=E2=80=
