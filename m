...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6CBD11A060B
	for <lists+linux-next@lfdr.de>; Tue,  7 Apr 2020 07:07:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726708AbgDGFHI (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 7 Apr 2020 01:07:08 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:60917 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725802AbgDGFHI (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 7 Apr 2020 01:07:08 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48xFks0kYvz9sQt;
        Tue,  7 Apr 2020 15:07:01 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1586236021;
        bh=mm1cL3h5HpviINvDvdNGOr1rt0mDpCpNZ1FziVDp/zk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 7 Apr 2020 15:06:58 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 7
Message-ID: <20200407150658.581afbc5@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/V4KXrgSj+xuhL.I=FJ69Ro1";
...
Changes since 20200406:

The kbuild tree still had its build failure for which I reverted a commit.

The vhost tree gained a build failure due to an interaction with Linus'
tree for which I applied a merge fix patch.

Non-merge commits (relative to Linus' tree): 1668
 1685 files changed, 51819 insertions(+), 16791 deletions(-)
...
Merging origin/master (7e63420847ae Merge tag 'acpi-5.7-rc1-2' of git://git=
...
Merging netfilter/master (b135fc0801b6 netfilter: ipset: Pass lockdep expre=
ssion to RCU lists)
...
Merging sound-asoc-fixes/for-linus (3ea00fb102ad Merge branch 'asoc-5.7' in=
to asoc-linus)
...
Merging kvms390-fixes/master (e12e65de3084 KVM: s390: vsie: Fix possible ra=
...
_notify_op_lock())
Merging cifs/for-next (543931076d04 cifs: smbd: Do not schedule work to sen=
d immediate packet on every receive)
...
Merging orangefs/for-next (c472a4cbb3e8 orangefs: complete Christoph's "rem=
...
Merging sound-asoc/for-next (3ea00fb102ad Merge branch 'asoc-5.7' into asoc=
-linus)
...
rflow
Merging akpm/master (4fe13b118e81 drivers/media/platform/sti/delta/delta-ip=
...

=OtU6
-----END PGP SIGNATURE-----
