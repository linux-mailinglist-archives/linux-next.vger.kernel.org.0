...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2E17F7E7667
	for <lists+linux-next@lfdr.de>; Fri, 10 Nov 2023 02:08:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229572AbjKJBIQ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 9 Nov 2023 20:08:16 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51746 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229491AbjKJBIP (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 9 Nov 2023 20:08:15 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8D1961B5;
        Thu,  9 Nov 2023 17:08:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1699578489;
        bh=D46w2flLpOeh1el53+wbQqRMZEJ0PKiW00eSHHdv6Rw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SRLKj2Bw3z4wcM;
        Fri, 10 Nov 2023 12:08:09 +1100 (AEDT)
Date:   Fri, 10 Nov 2023 12:08:07 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 10
Message-ID: <20231110120807.6f5bfca0@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8GGn3_jLtRYs58lZIgZBd0Z";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/8GGn3_jLtRYs58lZIgZBd0Z
...
Changes since 20231109:

Non-merge commits (relative to Linus' tree): 872
 1103 files changed, 25344 insertions(+), 14673 deletions(-)
...
Merging origin/master (4bbdb725a36b Merge tag 'iommu-updates-v6.7' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/joro/iommu)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (bde639aaa25b kexec-fix-kexec_file=
-dependencies-fix)
...
Merging net/main (83b9dda8afa4 net: ti: icss-iep: fix setting counter value)
Merging bpf/master (83b9dda8afa4 net: ti: icss-iep: fix setting counter val=
ue)
...
Merging sound-current/for-linus (bce36aa682da OSS: dmasound/paula: Convert =
...
Merging driver-core.current/driver-core-linus (6bc986ab839c Merge tag 'nfs-=
for-6.7-1' of git://git.linux-nfs.org/projects/trondmy/linux-nfs)
Merging tty.current/tty-linus (6bc986ab839c Merge tag 'nfs-for-6.7-1' of gi=
...
Merging staging.current/staging-linus (6bc986ab839c Merge tag 'nfs-for-6.7-=
1' of git://git.linux-nfs.org/projects/trondmy/linux-nfs)
...
Merging char-misc.current/char-misc-linus (6bc986ab839c Merge tag 'nfs-for-=
6.7-1' of git://git.linux-nfs.org/projects/trondmy/linux-nfs)
...
Merging mm/mm-everything (4799ba2aaaa6 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
ite-only variable)
Merging risc-v/for-next (457926b25320 riscv: Optimize bitops with Zbb exten=
sion)
...
Merging cifs/for-next (54796a555a55 smb3: allow debugging session and tcon =
info to improve stats analysis and debugging)
...
Merging amdgpu/drm-next (197264284303 drm/amdgpu: Change WREG32_RLC to WREG=
32_SOC15_RLC where inst !=3D 0 (v2))
...
Merging fbdev/for-next (708a1e2a891e fbdev: hyperv_fb: fix uninitialized lo=
cal variable use)
Merging regmap/for-next (f33804f1597d Merge remote-tracking branch 'regmap/=
for-6.6' into regmap-linus)
Merging sound/for-next (bce36aa682da OSS: dmasound/paula: Convert to platfo=
rm remove callback returning void)
...
Merging driver-core/driver-core-next (6bc986ab839c Merge tag 'nfs-for-6.7-1=
' of git://git.linux-nfs.org/projects/trondmy/linux-nfs)
Merging usb/usb-next (6bc986ab839c Merge tag 'nfs-for-6.7-1' of git://git.l=
inux-nfs.org/projects/trondmy/linux-nfs)
...
Merging tty/tty-next (6bc986ab839c Merge tag 'nfs-for-6.7-1' of git://git.l=
inux-nfs.org/projects/trondmy/linux-nfs)
Merging char-misc/char-misc-next (6bc986ab839c Merge tag 'nfs-for-6.7-1' of=
...
Merging staging/staging-next (6bc986ab839c Merge tag 'nfs-for-6.7-1' of git=
...
Merging cgroup/for-next (aecd408b7e50 cgroup: Add a new helper for cgroup1 =
hierarchy)
...

=3X18
-----END PGP SIGNATURE-----
