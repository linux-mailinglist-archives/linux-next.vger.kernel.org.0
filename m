...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7CCAB412E58
	for <lists+linux-next@lfdr.de>; Tue, 21 Sep 2021 07:52:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229718AbhIUFxl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 21 Sep 2021 01:53:41 -0400
Received: from ozlabs.org ([203.11.71.1]:49687 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229767AbhIUFxj (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 21 Sep 2021 01:53:39 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1632203529;
        bh=Lcrk+5uEXqlbDv/4FVfJO1fzc+7Sffv/GYQZZLZUsUc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HD9YP1nhhz9t0p;
        Tue, 21 Sep 2021 15:52:09 +1000 (AEST)
Date:   Tue, 21 Sep 2021 15:52:07 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 21
Message-ID: <20210921155207.79bcecc5@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/FkvskT/OlW.o=6J5Od4aPAX";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/FkvskT/OlW.o=6J5Od4aPAX
...
Merging origin/master (4c17ca27923c Merge tag 'spi-fix-v5.15-rc2' of git://=
...
ze fragment offset)
Merging ipvs/master (310e2d43c3ad netfilter: ip6_tables: zero-initialize fr=
agment offset)
...
Merging sound-asoc-fixes/for-linus (556b59b0c680 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (d3055ce518a4 Merge tag 'v5.15-rc2' into spi-5.=
15)
...
Merging char-misc.current/char-misc-linus (50c7ad36e654 Merge tag 'fpga-fix=
es-5.15' of git://git.kernel.org/pub/scm/linux/kernel/git/mdf/linux-fpga in=
to char-misc-linus)
...
Merging qcom/for-next (886c0cd464ad Merge branches 'arm64-for-5.16', 'drive=
...
tions)
Merging fscache/fscache-next (86641885f99b Merge branch 'fscache-iter-3' in=
to fscache-next)
...
ock is set)
Merging cifsd/cifsd-for-next (8718af129e68 ksmbd: add default data stream n=
ame in FILE_STREAM_INFORMATION)
...
CB_PATH_DOWN)
Merging ntfs3/master (880301bb3132 fs/ntfs3: Fix a memory leak on object op=
ts)
...
le)
Merging net-next/master (85c698863c15 net/ipv4/tcp_minisocks.c: remove supe=
rfluous header files from tcp_minisocks.c)
...
Merging drm-misc/for-linux-next (5540cf8f3e8d drm/panel-edp: Implement gene=
ric "edp-panel"s probed by EDID)
...
Merging sound-asoc/for-next (cc908256886c Merge remote-tracking branch 'aso=
...
Merging libata/for-next (dd969380c6bd ahci: remove duplicated PCI device ID=
s)
...
it field)
Merging devicetree/for-next (6f4276ecc0f7 dt-bindings: arm,vexpress-juno: A=
dd missing motherboard properties)
Merging mailbox/mailbox-for-next (85dfdbfc13ea mailbox: cmdq: add multi-gce=
 clocks support for mt8195)
Merging spi/for-next (efe79efc21cf Merge remote-tracking branch 'spi/for-5.=
15' into spi-5.16)
...
vcpu_idx)
Merging xen-tip/linux-next (794d5b8a497f swiotlb-xen: this is PV-only on x8=
6)
...
Merging staging/staging-next (7b228bdf87c2 staging: rts5208: remove unneces=
sary parentheses in ms.c)
...

=C9Z5
-----END PGP SIGNATURE-----
