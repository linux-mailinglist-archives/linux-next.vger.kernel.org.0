...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5CFB234E320
	for <lists+linux-next@lfdr.de>; Tue, 30 Mar 2021 10:28:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231194AbhC3I1e (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 30 Mar 2021 04:27:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51546 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231359AbhC3I1d (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 30 Mar 2021 04:27:33 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 266CAC061762;
        Tue, 30 Mar 2021 01:27:33 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4F8jHQ0g0Gz9sVm;
        Tue, 30 Mar 2021 19:27:30 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1617092850;
        bh=51d7J3wJzMpM/romAhvAfEumSZp/A2j4GLVg02K/Jbg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 30 Mar 2021 19:27:29 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 30
Message-ID: <20210330192729.317ff70e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/JCaf_jp0fSjK223yH.3O2S=";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/JCaf_jp0fSjK223yH.3O2S=
...
Non-merge commits (relative to Linus' tree): 7665
 7592 files changed, 449869 insertions(+), 154144 deletions(-)
...
Merging origin/master (1e43c377a79f Merge tag 'xtensa-20210329' of git://gi=
...
Merging net/master (fb6ec87f7229 net: dsa: Fix type was not set for devlink=
 port)
...
Merging sound-asoc-fixes/for-linus (c5affe19d65f Merge remote-tracking bran=
...
d flag correctly)
Merging thunderbolt-fixes/fixes (a5e13c6df0e4 Linux 5.12-rc5)
...
g code with a lock)
Merging imx-mxs/for-next (a2db8d39cbcb Merge branch 'imx/defconfig' into fo=
r-next)
...
-next)
Merging scmi/for-linux-next (f7d6bd038a27 Merge branch 'for-next/scmi' of g=
...
Merging mips/mips-next (19f0e8cddf0f MIPS: Loongson64: enable CONFIG_USB_SE=
RIAL_PL2303)
...
Merging dmi/dmi-for-next (3cb4d29a2633 MAINTAINERS: The DMI/SMBIOS tree has=
 moved)
Merging hwmon-staging/hwmon-next (350bc0faa92b hwmon: (mlxreg-fan) Add supp=
...
in imxfb_probe())
Merging pm/linux-next (1d535f1c735a Merge branch 'pm-cpufreq-fixes' into li=
nux-next)
...
_connect_request)
Merging net-next/master (d0922bf79817 hv_netvsc: Add error handling while s=
witching data path)
...
Merging amdgpu/drm-next (a0c8b193bfe8 drm/ttm: switch back to static alloca=
tion limits for now)
CONFLICT (content): Merge conflict in drivers/gpu/drm/ttm/ttm_tt.c
$ git reset --hard HEAD^
Merging next-20210329 version of amdgpu
...
Merging sound-asoc/for-next (080e8232d61e Merge remote-tracking branch 'aso=
...
river)
Merging block/for-next (1a7839a6ff26 Merge branch 'for-5.13/io_uring' into =
for-next)
...
13' into spi-next)
Merging tip/auto-latest (11120ec67fb9 Merge branch 'irq/core')
...
Merging akpm/master (2fe8623a5095 secretmem: test: add basic selftest for m=
emfd_secret(2))
...

=XfyY
-----END PGP SIGNATURE-----
