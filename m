...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2173A3510EF
	for <lists+linux-next@lfdr.de>; Thu,  1 Apr 2021 10:36:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232565AbhDAIfn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 1 Apr 2021 04:35:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54248 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233504AbhDAIf1 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 1 Apr 2021 04:35:27 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3971AC0613E6;
        Thu,  1 Apr 2021 01:35:26 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4F9xMb0tVvz9sVq;
        Thu,  1 Apr 2021 19:35:23 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1617266123;
        bh=QWqjfYQz5JVSi2ylY9nBiWea1JhN1Jt36jNwHKVZaXY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 1 Apr 2021 19:35:22 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 1
Message-ID: <20210401193522.39e01a9b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/YSQk0R9H_O7kUZ7R.4ZLA/k";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/YSQk0R9H_O7kUZ7R.4ZLA/k
...
Non-merge commits (relative to Linus' tree): 8329
 8117 files changed, 470024 insertions(+), 209561 deletions(-)
...
Merging origin/master (d19cc4bfbff1 Merge tag 'trace-v5.12-rc5' of git://gi=
...
Merging net/master (bdc2ab5c61a5 net/rds: Fix a use after free in rds_messa=
ge_map_pages)
...
Merging usb-serial-fixes/usb-linus (c780b5466fef USB: serial: xr: fix CSIZE=
 handling)
...
for-next)
Merging amlogic/for-next (770c8e41c107 Merge branch 'v5.13/dt64' into tmp/a=
ml-rebuild)
...
o next)
Merging mediatek/for-next (5201a2cc1bd8 Merge branch 'v5.12-next/soc' into =
for-next)
...
' into sunxi/for-next)
Merging tegra/for-next (39583a708422 Merge branch for-5.13/arm64/dt into fo=
r-next)
...
stems)
Merging clk/clk-next (301119535c94 Merge branch 'clk-fixes' into clk-next)
...
Merging cifsd/cifsd-for-next (84db38a3cb63 cifsd: fix implicit declaration =
of function 'locks_alloc_lock')
...
lock)
Merging erofs/dev (14373711dd54 erofs: add on-disk compression configuratio=
ns)
...
ing)
Merging f2fs/dev (be1ee45d5138 f2fs: Fix a hungtask problem in atomic write)
...
ent class)
Merging cel/for-next (427ce3afe3da NFSv4.2: fix copy stateid copying for th=
e async copy)
...
Merging i2c/i2c/for-next (58da3e5095e8 Merge branch 'i2c/for-current' into =
i2c/for-next)
...
in imxfb_probe())
Merging pm/linux-next (f39adce9fae9 Merge branch 'acpi-scan' into linux-nex=
t)
...
_connect_request)
Merging net-next/master (917e2e6c5798 net: mediatek: add flow offload for m=
t7623)
CONFLICT (content): Merge conflict in include/linux/bpf.h
CONFLICT (content): Merge conflict in MAINTAINERS
Merging bpf-next/for-next (e27bfefb21f2 tools/resolve_btfids: Fix warnings)
...
Merging mlx5-next/mlx5-next (26bf30902c10 net/mlx5: Use order-0 allocations=
 for EQs)
Merging netfilter-next/master (19c28b1374fb netfilter: add helper function =
to set up the nfnetlink header and use it)
...
river)
Merging block/for-next (273159796e50 Merge branch 'for-5.13/io_uring' into =
for-next)
...
d for shadow paging)
Merging kvm-arm/next (9e3976a6036d Merge branch 'kvm-arm64/misc-5.13' into =
kvmarm-master/next)
...
Merging extcon/extcon-next (cf947ad92675 extcon: qcom-spmi: Add support for=
 VBUS detection)
Merging phy-next/next (aff188feb5e1 phy: qcom-qmp: add support for sm8250-u=
sb3-dp phy)
...
isting file)
Merging gpio-brgl/gpio/for-next (a769ae48fadd gpio: omap: Use device_get_ma=
tch_data() helper)
...
t follow_pfn)
Merging rust/rust-next (de77865c1ed4 Rust support)
CONFLICT (content): Merge conflict in Makefile
Merging akpm-current/current (6f7281b92b2c ipc/sem.c: mundane typo fixes)
...
Merging akpm/master (42183be5842d memfd_secret: use unsigned int rather tha=
...

=GIMi
-----END PGP SIGNATURE-----
