...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D425468B597
	for <lists+linux-next@lfdr.de>; Mon,  6 Feb 2023 07:32:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229557AbjBFGcF (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 6 Feb 2023 01:32:05 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:35756 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229479AbjBFGcE (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 6 Feb 2023 01:32:04 -0500
Received: from mail-pj1-x1033.google.com (mail-pj1-x1033.google.com [IPv6:2607:f8b0:4864:20::1033])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 8F31BA27E
        for <linux-next@vger.kernel.org>; Sun,  5 Feb 2023 22:32:00 -0800 (PST)
Received: by mail-pj1-x1033.google.com with SMTP id d2so7013413pjd.5
        for <linux-next@vger.kernel.org>; Sun, 05 Feb 2023 22:32:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=nmcvWGmSNWenU0y8Uhhz9u1Vtg9hlohca0pwwdfGE5o=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=nmcvWGmSNWenU0y8Uhhz9u1Vtg9hlohca0pwwdfGE5o=;
        b=
X-Gm-Message-State: AO0yUKVPHGt6795ToFn/GOe3H5nbIG6WItl8nfSd1xrgNK8LozRH09n9
        b91xcx2bNVDhKX6rl65mFDUreJDhMPg9B+LOy7zW8g==
X-Google-Smtp-Source: AK7set9JAtphWJpvcvPKn9VU0PpiyUfrd+9g2lnCefBV8q1yb6bPlWey4VUVpyUwEOKKqJi9+oAVVw==
X-Received: by 2002:a17:90b:38c5:b0:229:983:f3f9 with SMTP id nn5-20020a17090b38c500b002290983f3f9mr11034244pjb.40.1675665118920;
        Sun, 05 Feb 2023 22:31:58 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id e9-20020a17090a280900b002260cff0b2dsm5220356pjd.26.2023.02.05.22.31.58
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 05 Feb 2023 22:31:58 -0800 (PST)
Message-ID: <63e09ede.170a0220.a58e4.8626@mx.google.com>
Date:   Sun, 05 Feb 2023 22:31:58 -0800 (PST)
...
Subject: next/master build: 208 builds: 10 failed, 198 passed, 18 errors,
 23 warnings (next-20230206)
...
next/master build: 208 builds: 10 failed, 198 passed, 18 errors, 23 warning=
s (next-20230206)
...
Tree: next
Branch: master
Git Describe: next-20230206
Git Commit: 129af770823407ee115a56c69a04b440fd2fbe61
...
x86_64:
    allmodconfig (clang-16): 1 error, 3 warnings
...
=80=98-mhard-float=E2=80=99
    3    fs/udf/partition.c:86:28: error: variable 'loc' is uninitialized w=
hen used here [-Werror,-Wuninitialized]
    3    drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.h:62:10:=
 fatal error: 'mod_info_packet.h' file not found
...
=3D0x'
    1    ERROR: modpost: "__aeabi_uldivmod" [samples/ftrace/ftrace-ops.ko] =
undefined!
...
-Wcpp]
    3    fs/udf/partition.c:52:14: note: initialize the variable 'loc' to s=
ilence this warning
...
Errors:
    ERROR: modpost: "__aeabi_uldivmod" [samples/ftrace/ftrace-ops.ko] undef=
ined!
...
---------------------------------------------------------------------------=
-----
allmodconfig (i386, clang-16) =E2=80=94 FAIL, 5 errors, 1 warning, 0 sectio=
n mismatches

Errors:
    drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.h:62:10: fata=
l error: 'mod_info_packet.h' file not found
    drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.h:62:10: fata=
l error: 'mod_info_packet.h' file not found
    drivers/gpu/drm/amd/amdgpu/../display/amdgpu_dm/amdgpu_dm.h:62:10: fata=
l error: 'mod_info_packet.h' file not found
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-16) =E2=80=94 FAIL, 1 error, 3 warnings, 0 sect=
ion mismatches
