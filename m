...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4A5694A7EBA
	for <lists+linux-next@lfdr.de>; Thu,  3 Feb 2022 05:47:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1349297AbiBCErt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 2 Feb 2022 23:47:49 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40568 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229975AbiBCErt (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 2 Feb 2022 23:47:49 -0500
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 68B48C061714;
        Wed,  2 Feb 2022 20:47:48 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Jq5kl1W87z4xRB;
        Thu,  3 Feb 2022 15:47:43 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1643863663;
        bh=+Emr2ePimfxlWI6zPmKqfCaerpC0/kuIsSSKwntJMwk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 3 Feb 2022 15:47:42 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 3
Message-ID: <20220203154742.7e96b9fa@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/yd5jmGOnVd=V7Bh8STv/W7K";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/yd5jmGOnVd=V7Bh8STv/W7K
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220202:
...
Non-merge commits (relative to Linus' tree): 3387
 3803 files changed, 147283 insertions(+), 48894 deletions(-)
...
Merging origin/master (88808fbbead4 Merge tag 'nfsd-5.17-1' of git://git.ke=
...
Merging net/master (81eb8b0b1878 net: sparx5: do not refer to skb after pas=
sing it on)
Merging bpf/master (b7892f7d5cb2 tools: Ignore errors from `which' when sea=
rching a GCC toolchain)
...
Merging spi-fixes/for-linus (8e39ec98c198 Merge remote-tracking branch 'spi=
...
Merging zstd-fixes/zstd-linus (88a309465b3f lib: zstd: clean up double word=
 in comment.)
Merging drm-misc-fixes/for-linux-next-fixes (a3f781a9d611 fbcon: Add option=
 to enable legacy hardware acceleration)
...
rp_list)
Merging net-next/master (52dae93f3bad drivers: net: Replace acpi_bus_get_de=
vice())
Merging bpf-next/for-next (dd5152ab338c Merge branch 'bpf-btf-dwarf5')
Merging ipsec-next/master (000fe940e51f sfc: The size of the RX recycle rin=
...
Merging drm-intel/for-linux-next (22ba60f617bd drm/i915: Move [more] GT reg=
isters to their own header file)
...
Merging spi/for-next (8d37f2710f02 spi: mpc512x-psc: Fix compile errors)
...
Merging akpm/master (176a3166a825 Merge branch 'akpm-current/current')
...

=lS6q
-----END PGP SIGNATURE-----
