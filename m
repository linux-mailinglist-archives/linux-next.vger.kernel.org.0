Return-Path: <linux-next+bounces-4074-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B31F098E8EE
	for <lists+linux-next@lfdr.de>; Thu,  3 Oct 2024 05:53:38 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E1A79287394
	for <lists+linux-next@lfdr.de>; Thu,  3 Oct 2024 03:53:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8207027735;
	Thu,  3 Oct 2024 03:53:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="jxkL5UFy"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6977620328;
	Thu,  3 Oct 2024 03:53:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727927613; cv=none; b=Q+1Yb5fOXG07SmLGdp9hu2tcShXw+SdwDEwQnhWoYFsmT/bAaJNkcxX7AMHUwzQiIkVolD2UhD4o3ccREGaoBZuPYDqMQICo2d64AQEtqsuRFZhq2v6+6QLKB34AhDrBToBDt7SVTrYst7uQ5vq17tcftgD7a7js7pXflYvNu5Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727927613; c=relaxed/simple;
	bh=0+dS99n00SY7nRG9anMNkQ/1+Gb0HbPRJdjBVzolqGw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=XoaFGFNa4lrjjaDAjc/dIJWlGn+SIVWXOMyJRHtCNnRgQV9Soi/WdDCe9pagOX12jP1/Z/Jez67VBK3Iu0fwjXO6Vjr4YW0bxEaJ5hN5UoOjObZ6DYpaRKpgoaLYSIehjFKYZC5GdhxDLGJ/VsTu8/Q9DGFjiPTo0K1P4eymP80=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=jxkL5UFy; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1727927603;
	bh=VEzmv9wri0kP7wStTay/BaZbrVTyyAknZIOrRo1Sooo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XJySz26D4z4wcl;
	Thu,  3 Oct 2024 13:53:23 +1000 (AEST)
Date: Thu, 3 Oct 2024 13:53:22 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 3
Message-ID: <20241003135322.108682fd@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/DzUCqAUYJQoV0gDdtvhkFCJ";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/DzUCqAUYJQoV0gDdtvhkFCJ
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241002:
...
The auxdisplay tree gained a build failure so I used the version from
next-20241002.

Non-merge commits (relative to Linus' tree): 1730
 2336 files changed, 50821 insertions(+), 30454 deletions(-)
...
Merging origin/master (f23aa4c0761a Merge tag 'hid-for-linus-2024090201' of=
...
pool_perm_get())
Merging cifs/for-next (801b43bf0044 smb: client: stop flooding dmesg with a=
utomounts)
...
Merging fs-current (afcb22d01aeb Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging sound-current/for-linus (33027006ecf3 MAINTAINERS: ALSA: use linux-=
sound@vger.kernel.org list)
...
Merging gpio-brgl-fixes/gpio/for-current (5a431e50e9d4 gpio: davinci: Fix c=
ondition for irqchip registration)
...
Merging fs-next (b35bdf67b98c Merge branch 'for-next' of git://git.kernel.o=
...
Merging i2c-host/i2c/i2c-host (f3fe928c4d6a dt-bindings: i2c: microchip: co=
rei2c: Add PIC64GX as compatible with driver)
...
Merging pm/linux-next (7f8922773211 Merge branch 'acpi-video' into linux-ne=
xt)
...
Merging net-next/main (6b67e098c9c9 Merge branch 'net-pcs-xpcs-cleanups-bat=
ch-1')
...
Merging drm-misc/for-linux-next (6a797bdfde77 drm/panthor: add sysfs knob f=
or enabling job profiling)
...
post_soft_reset)
Merging drm-intel/for-linux-next (abc0742c79bd drm/i915/hdcp: fix connector=
 refcounting)
...
eback on SM6350)
Merging drm-xe/drm-xe-next (63e0695597a0 drm/xe: Fix memory leak when abort=
ing binds)
...
Merging sound/for-next (33027006ecf3 MAINTAINERS: ALSA: use linux-sound@vge=
r.kernel.org list)
Merging ieee1394/for-next (8f04019d71cb firewire: Correct some typos)
Merging sound-asoc/for-next (43b167ba99bf Merge remote-tracking branch 'aso=
...
across misc drivers)
Merging block/for-next (ccb1526dda70 Merge branch 'io_uring-poll-table' int=
o for-next)
...
Merging selinux/next (9852d85ec9d4 Linux 6.12-rc1)
...
Merging audit/next (9852d85ec9d4 Linux 6.12-rc1)
...
Merging pinctrl/for-next (c42e38992043 Merge branch 'devel' into for-next)
...
Merging auxdisplay/for-next (7f11dc1a9ca9 auxdisplay: ht16k33: Make use of =
i2c_get_match_data())
$ git reset --hard HEAD^
Merging next-20241002 version of auxdisplay
...
Merging slab/slab/for-next (8bcb4e9205c8 Merge branch 'slab/for-6.13/featur=
...

=XAzr
-----END PGP SIGNATURE-----
