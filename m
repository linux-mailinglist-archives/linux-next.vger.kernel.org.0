...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id ABF844DAE6C
	for <lists+linux-next@lfdr.de>; Wed, 16 Mar 2022 11:45:05 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235181AbiCPKqQ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 16 Mar 2022 06:46:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49504 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237140AbiCPKqP (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 16 Mar 2022 06:46:15 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B5EB53DA6A;
        Wed, 16 Mar 2022 03:44:58 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KJRjy2dLTz4xRB;
        Wed, 16 Mar 2022 21:44:54 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1647427494;
        bh=ucHbBXPiZbvXqEPfbL3UgJ0iDKtLtQ+V592TJwJU1zA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 16 Mar 2022 21:44:51 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 16
Message-ID: <20220316214451.7efd930e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/lvEVvU4UV.BfXACgc1mNj+s";
...
--Sig_/lvEVvU4UV.BfXACgc1mNj+s
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220315:

I switched to the master branch of the tip tree.

The net-next tree lost its build failure.

The tip tree lost its build failures.

The ftrace tree lost its build failure (which was actually a semantic
conflict against the tip tree).

The userns tree gained a build failure due to an interaction with the
tip tree for which I applied a patch.

The folio tree lost its build failure.

The kspp tree exposed a build failure in Linus' tree for which I applied
a patch.

Non-merge commits (relative to Linus' tree): 12084
 12259 files changed, 1010656 insertions(+), 272947 deletions(-)
...
Merging net/master (e9c14b59ea2e Add Paolo Abeni to networking maintainers)
...
Merging spi-fixes/for-linus (c0358dce538a Merge remote-tracking branch 'spi=
...
ction_or_reset())
Merging rockchip/for-next (e23868c628a0 Merge branch 'v5.18-armsoc/dts64' i=
nto for-next)
...
Merging f2fs/dev (bbbbbefe49a6 f2fs: remove redundant parameter judgment)
...
.h)
Merging v4l-dvb-next/master (7064723b9007 media: spi: Kconfig: Place SPI dr=
ivers on a single menu)
Merging pm/linux-next (4a73286a19a5 Merge branch 'thermal-hfi' into linux-n=
ext)
...
Merging net-next/master (c84d86a0295c Merge branch '100GbE' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/tnguy/next-queue)
CONFLICT (content): Merge conflict in drivers/hwmon/adt7310.c
Merging bpf-next/for-next (6585abea98ae bpftool: man: Add missing top level=
 docs)
...
me value)
Merging wireless-next/main (dde78aa52015 mac80211: update bssid_indicator i=
n ieee80211_assign_beacon)
...
Merging sound-asoc/for-next (b8425af9745e Merge remote-tracking branch 'aso=
...
el)
Merging block/for-next (46c0d9969d09 Merge branch 'for-5.18/io_uring' into =
for-next)
...
finition for mt8186)
Merging spi/for-next (1b0e8676c584 Merge remote-tracking branch 'spi/for-5.=
18' into spi-next)
...
ne error handler)
Merging staging/staging-next (721412ed3d81 staging: remove ashmem)
...
Merging folio/for-next (223ab4ed5449 Merge branch 'fs-folio' into for-next)
...
Merging akpm/master (4dc54d4903bb kselftest/vm: override TARGETS from argum=
ents)
...

=q01C
-----END PGP SIGNATURE-----
