...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F1BA23BF44F
	for <lists+linux-next@lfdr.de>; Thu,  8 Jul 2021 05:35:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230412AbhGHDiA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 7 Jul 2021 23:38:00 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45520 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230387AbhGHDiA (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 7 Jul 2021 23:38:00 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B639AC061574;
        Wed,  7 Jul 2021 20:35:18 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GL2433gWvz9sWc;
        Thu,  8 Jul 2021 13:35:15 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1625715315;
        bh=NF41N5pOxwBpNJ4Bb/oa/AQaKerjCqavXXs5spLFXRc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 8 Jul 2021 13:35:14 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 8
Message-ID: <20210708133514.3550e34d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/YVnO4bUIeImct2hLqF0Ck4q";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/YVnO4bUIeImct2hLqF0Ck4q
...
Changes since 20210707:

The net tree still had its build failure so I used the version from
next-20210706.

The vhost tree gained a build failure so I used the verison from
next-20210707.

Non-merge commits (relative to Linus' tree): 1933
 2094 files changed, 120126 insertions(+), 23116 deletions(-)
...
I am currently merging 329 trees (counting Linus' and 88 trees of bug
...
Merging origin/master (e9f1cbc0c411 Merge tag 'acpi-5.14-rc1-2' of git://gi=
...
Merging powerpc-fixes/fixes (1df3af6dc3cf powerpc/64e: Fix system call ille=
gal mtmsrd instruction)
Merging s390-fixes/fixes (62fb9874f5da Linux 5.13)
Merging sparc/master (05a59d79793d Merge git://git.kernel.org:/pub/scm/linu=
x/kernel/git/netdev/net)
Merging fscrypt-current/for-stable (d19d8d345eec fscrypt: fix inline encryp=
tion not used on new files)
Merging net/master (d7fba8ff3e50 Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/pablo/nf)
$ git reset --hard HEAD^
Merging next-20210706 version of net
Merging bpf/master (1d719254c139 tools: bpf: Fix error in 'make -C tools/ b=
pf_install')
Merging ipsec/master (2580d3f40022 xfrm: Fix RCU vs hash_resize_mutex lock =
inversion)
Merging netfilter/master (d322957ebfb9 netfilter: uapi: refer to nfnetlink_=
conntrack.h, not nf_conntrack_netlink.h)
...
Merging sound-current/for-linus (307cc9baac5c ALSA: usb-audio: Reduce laten=
cy at playback start, take#2)
...
Merging driver-core.current/driver-core-linus (77d34a4683b0 Merge tag 'for-=
linus' of git://git.armlinux.org.uk/~rmk/linux-arm)
Merging tty.current/tty-linus (77d34a4683b0 Merge tag 'for-linus' of git://=
git.armlinux.org.uk/~rmk/linux-arm)
Merging usb.current/usb-linus (77d34a4683b0 Merge tag 'for-linus' of git://=
git.armlinux.org.uk/~rmk/linux-arm)
...
Merging staging.current/staging-linus (77d34a4683b0 Merge tag 'for-linus' o=
...
Merging char-misc.current/char-misc-linus (77d34a4683b0 Merge tag 'for-linu=
s' of git://git.armlinux.org.uk/~rmk/linux-arm)
...
Merging mmc-fixes/fixes (d0244847f9fc mmc: sdhci: Fix warning message when =
accessing RPMB in HS400 mode)
...
rning for Clang)
Merging kbuild/for-next (a0e781a2a35a sparc: syscalls: use pattern rules to=
...
e "vesion" -> "version")
Merging mips/mips-next (97e488073cfc mips: disable branch profiling in boot=
/decompress.o)
...
Merging s390/for-next (bd39654a2282 s390/AP: support new dynamic AP bus siz=
e limit)
...
point of assignment)
Merging cifs/for-next (d4dc277c480c CIFS: Clarify SMB1 code for POSIX Lock)
Merging cifsd/cifsd-for-next (db0e04ad42bb Merge pull request #58 from namj=
...
Merging exfat/dev (1e5654de0f51 exfat: handle wrong stream entry size in ex=
fat_readdir())
Merging ext3/for_next (5fd541e3a933 Pull writeback memcg fix from Munchun S=
ong)
Merging ext4/dev (1a40ce3dd853 ext4: inline jbd2_journal_[un]register_shrin=
ker())
Merging f2fs/dev (28607bf3aa6f f2fs: drop dirty node pages when cp is in er=
ror status)
...
Merging nfs/linux-next (2512f47b8bd8 Merge part 2 of branch 'sysfs-devel')
...
Merging amdgpu/drm-next (6c1c27b52539 PCI: quirks: Quirk PCI d3hot delay fo=
r AMD xhci)
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/amdgpu/amdgpu_ttm=
.c
Merging drm-intel/for-linux-next (3dd6c11b60d2 drm/i915: Drop all reference=
s to DRM IRQ midlayer)
...
Merging sound/for-next (307cc9baac5c ALSA: usb-audio: Reduce latency at pla=
yback start, take#2)
...
Merging block/for-next (e12ca7286849 Merge branch 'block-5.14' into for-nex=
t)
...
Merging mmc/next (d0244847f9fc mmc: sdhci: Fix warning message when accessi=
ng RPMB in HS400 mode)
...
Merging ftrace/for-next (4030a6e6a6a4 tracing: Resize tgid_map to pid_max, =
not PID_MAX_DEFAULT)
...
Merging driver-core/driver-core-next (77d34a4683b0 Merge tag 'for-linus' of=
 git://git.armlinux.org.uk/~rmk/linux-arm)
Merging usb/usb-next (77d34a4683b0 Merge tag 'for-linus' of git://git.armli=
...
Merging tty/tty-next (77d34a4683b0 Merge tag 'for-linus' of git://git.armli=
nux.org.uk/~rmk/linux-arm)
Merging char-misc/char-misc-next (77d34a4683b0 Merge tag 'for-linus' of git=
://git.armlinux.org.uk/~rmk/linux-arm)
...
Merging staging/staging-next (77d34a4683b0 Merge tag 'for-linus' of git://g=
...
Merging vhost/linux-next (168a32fcc18a vdpa/mlx5: Clear vq ready indication=
 upon device reset)
$ git reset --hard HEAD^
Merging next-20210707 version of vhost
...
Merging pwm/for-next (bebedf2bb4a9 pwm: Remove redundant assignment to poin=
ter pwm)
...
Merging akpm/master (93df9eb3bf3d powerpc/mm: enable HAVE_MOVE_PMD support)
...

=s0kN
-----END PGP SIGNATURE-----
