...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4E9407BB0EC
	for <lists+linux-next@lfdr.de>; Fri,  6 Oct 2023 06:38:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229989AbjJFEiW (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 6 Oct 2023 00:38:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39004 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229918AbjJFEiU (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 6 Oct 2023 00:38:20 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7B5C1DB;
        Thu,  5 Oct 2023 21:38:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1696567091;
        bh=Mhp2GCQSurbD7cHqgfkt3Nltl950c7O6mHM3I4QGwC8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4S1wfC0B9Zz4xM7;
        Fri,  6 Oct 2023 15:38:10 +1100 (AEDT)
Date:   Fri, 6 Oct 2023 15:38:09 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 6
Message-ID: <20231006153809.2054a0f8@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ZVHcSjG=kColh6pJf5sc61v";
...
The drm-msm-lumag tree gained a conflict against the drm-misc tree.

The kvm-arm tree lost its build failure.

Non-merge commits (relative to Linus' tree): 9455
 7435 files changed, 569820 insertions(+), 168099 deletions(-)
...
Merging origin/master (f291209eca5e Merge tag 'net-6.6-rc5' of git://git.ke=
...
Merging net/main (f291209eca5e Merge tag 'net-6.6-rc5' of git://git.kernel.=
org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (4720852ed9af tcp: fix delayed ACKs for MSS boundary con=
dition)
Merging ipsec/master (cc9b364bb1d5 xfrm6: fix inet6_dev refcount underflow =
problem)
Merging netfilter/main (d0f95894fda7 netlink: annotate data-races around sk=
->sk_err)
Merging ipvs/main (d0f95894fda7 netlink: annotate data-races around sk->sk_=
err)
...
Merging char-misc.current/char-misc-linus (1aa3aaf8953c binder: fix memory =
leaks of spam and pending work)
...
Merging drivers-x86-fixes/fixes (aa7dcba3bae6 platform/x86: touchscreen_dmi=
...
Merging rockchip/for-next (fcd71ba3fccd Merge branch 'v6.6-armsoc/dtsfixes'=
 into for-next)
Merging samsung-krzk/for-next (f790ffa18285 Merge branch 'next/defconfig' i=
nto for-next)
Merging scmi/for-linux-next (8f8ac400ba34 Merge branches 'for-next/scmi/upd=
...
$ git reset --hard HEAD^
Merging next-20231005 version of scmi
...
n ceph_fname_to_usr())
Merging cifs/for-next (c6aae6949383 cifs: Add client version details to NTL=
...
Alloc)
Merging ksmbd/ksmbd-for-next (33b235a6e6eb ksmbd: fix race condition betwee=
n tree conn lookup and disconnect)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (8369137a2835 Merge branch 'vfs.super' into vfs=
.all)
...
Merging printk/for-next (5834f8e72b1b Merge branch 'rework/nbcon-base' into=
 for-next)
Merging pci/next (3a5e1a1efd3f Merge branch 'pci/misc')
$ git reset --hard HEAD^
Merging next-20231005 version of pci
Merging pstore/for-next/pstore (5ee1a4304799 docs: pstore-blk.rst: fix typo=
, s/console/ftrace)
Merging hid/for-next (b009aa38a380 HID: Add quirk to ignore the touchscreen=
 battery on HP ENVY 15-eu0556ng)
...
Merging net-next/main (98bdeae9502b net: cpmac: remove driver to prepare fo=
r platform removal)
...
Merging netfilter-next/main (93e7eca853ca Merge branch 'ynl-makefile-cleanu=
p')
Merging ipvs-next/main (93e7eca853ca Merge branch 'ynl-makefile-cleanup')
Merging bluetooth/master (6be21d987868 Bluetooth: Fix a refcnt underflow pr=
oblem for hci_conn)
Merging wireless-next/for-next (9418edf8ff01 wifi: rtlwifi: remove unreacha=
ble code in rtl92d_dm_check_edca_turbo())
...
- add missing escape)
Merging drm-misc/for-linux-next (9031e0013f81 drm/amd/display: Fix mst hub =
unplug warning)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (64909aa6ddd0 drm/i915/fbc: Remove pointle=
ss "stride is multiple of 64 bytes" check)
Merging drm-tegra/for-next (2429b3c529da drm/tegra: Avoid potential 32-bit =
integer overflow)
Merging drm-msm/msm-next (ce9ecca0238b Linux 6.6-rc2)
Merging drm-msm-lumag/msm-next-lumag (8d2d4c202266 drm/msm/dp: Inline dp_di=
splay_is_sink_count_zero())
...
Merging iommu/next (ed1abc0d175e Merge branches 'iommu/fixes', 'arm/tegra',=
...
7' into spi-next)
Merging tip/master (666305fc7ceb Merge branch into tip/master: 'x86/tdx')
...
Merging kvm-arm/next (0d1bed803128 Merge branch kvm-arm64/smccc-filter-clea=
nups into kvmarm/next)
...
Merging kvm-x86/next (bccb79ec2e66 Merge branches 'apic', 'docs', 'fpu', 'm=
...
failures)
Merging extcon/extcon-next (8b467b48e283 extcon: max77843: add device-tree =
compatible string)
...
Merging pinctrl-intel/for-next (f2bbe6f1f446 pinctrl: moorefield: Replace k=
ernel.h by what is actually being used)
...
n dodie)
Merging kselftest/next (0a6fa8f03e14 selftests: timers: Convert nsleep-lat =
test to generate KTAP output)
...

=ajna
-----END PGP SIGNATURE-----
