Return-Path: <linux-next+bounces-3098-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 5FB099398C5
	for <lists+linux-next@lfdr.de>; Tue, 23 Jul 2024 05:58:10 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B15A61F2264C
	for <lists+linux-next@lfdr.de>; Tue, 23 Jul 2024 03:58:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6DECB13B58D;
	Tue, 23 Jul 2024 03:58:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="m1gUXE/R"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2340B139D04;
	Tue, 23 Jul 2024 03:57:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721707083; cv=none; b=rgOWlDfXj7db3LznsyA2ZApOtLolVzeouZzMlRQbkYFdpLN7A7TtjdsqkKaWvlGUx6CyNd0rq1jp16YRWE4tfYovylLoKNaKFe5Ig1Mhca8Y8EmS8zYYNgdzzWuSYCh5E+lGL/kk0w6HPIHi0f8XjqO43M8HYHvSohtXGEIcCTA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721707083; c=relaxed/simple;
	bh=+9rR5ve8wrMpGSgL06TLFWsONT8Ov2RIYYSK+MlxDRw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=jtNdhWG2j4/1tmsmigcIOG+VkxSK9EcQREMHievG2k9QTOirM/ufW0SegRc7WaIhurn0JY42dZCDlkJaP8N7jfGDgYlvMpBJ+dWnjHqSLGc77DevMBGCDZfWb/S2m+wYf5/b7tmXSPi3nD6bi53aFx2wfVPnowgbK6a0nJfyuBk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=m1gUXE/R; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1721707074;
	bh=k4G/v+Z1nxGvMD8cGkw0cTVP4Ndwsud4/PBAvnZLtEk=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WSjzP71cbz4wcK;
	Tue, 23 Jul 2024 13:57:53 +1000 (AEST)
Date: Tue, 23 Jul 2024 13:57:52 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 23
Message-ID: <20240723135752.58a5a4c0@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8lKHVON5n8qtE08Eg2Fz.N2";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/8lKHVON5n8qtE08Eg2Fz.N2
...
Changes since 20240722:

Non-merge commits (relative to Linus' tree): 1052
 1338 files changed, 56016 insertions(+), 14953 deletions(-)
...
Merging origin/master (66ebbdfdeb09 Merge tag 'irq-msi-2024-07-22' of git:/=
...
Merging vfs-brauner-fixes/vfs.fixes (90b0658c5d3e pidfs: add selftests for =
new namespace ioctls)
...
erify_area())
Merging fs-current (ede9093e4797 Merge branch 'nfsd-fixes' of git://git.ker=
...
he)
Merging erofs/dev (63c65795291d erofs: fix race in z_erofs_get_gbuf())
...
Merging fs-next (33377a26da32 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging hid/for-next (b27cf25c6872 Merge branch 'for-6.11/upstream-fixes' i=
nto for-next)
...
Merging drm-xe/drm-xe-next (7e0fe233aa08 drm/xe: Fix warning on unreachable=
 statement)
  43a6faa6d9b5 ("drm/xe/exec: Fix minor bug related to xe_sync_entry_cleanu=
p")
  452bca0edbd0 ("drm/xe: Don't suspend device upon wedge")
  4c3fe5eae46b ("drm/xe/pf: Limit fair VF LMEM provisioning")
  7dbe8af13c18 ("drm/xe: Wedge the entire device")
...
10' into spi-linus)
Merging tip/master (f96d641fecb0 Merge branch into tip/master: 'x86/mm')
...

=EKeD
-----END PGP SIGNATURE-----
