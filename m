...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 03D4D78A512
	for <lists+linux-next@lfdr.de>; Mon, 28 Aug 2023 07:03:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229626AbjH1FDB (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 28 Aug 2023 01:03:01 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45138 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229628AbjH1FC3 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 28 Aug 2023 01:02:29 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3BFD5126;
        Sun, 27 Aug 2023 22:02:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1693198941;
        bh=/mbFkqh/eexWsc4rHSILclpIQ/fz5nD0OFGSL+u3zhc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RYz2566Pwz4x2Y;
        Mon, 28 Aug 2023 15:02:21 +1000 (AEST)
Date:   Mon, 28 Aug 2023 15:02:20 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 28
Message-ID: <20230828150220.31624576@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/REp7ISWVIJ4UYnfnysO5K/M";
...
Non-merge commits (relative to Linus' tree): 11958
 13383 files changed, 567504 insertions(+), 201671 deletions(-)
...
Merging origin/master (2dde18cd1d8f Linux 6.5)
...
Merging net/main (5c905279a1b7 Merge branch 'pds_core-error-handling-fixes')
Merging bpf/master (931abcdcad10 Merge branch 'mlxsw-fixes')
...
Merging sound-current/for-linus (37e44d60cb87 Merge tag 'asoc-fix-v6.5-rc7-=
...
Merging scsi-fixes/fixes (812fe6420a6e scsi: storvsc: Handle additional SRB=
 status values)
Merging drm-fixes/drm-fixes (59fe2029b9e0 Merge tag 'drm-intel-fixes-2023-0=
8-24' of git://anongit.freedesktop.org/drm/drm-intel into drm-fixes)
...
Merging loongarch/loongarch-next (780691dae173 LoongArch: Update Loongson-3=
 default config file)
...
Merging parisc-hd/for-next (7013edf6bf0d parisc: chassis: Do not overwrite =
string on LCD display)
Merging powerpc/next (c37b6908f7b2 powerpc/iommu: Fix notifiers being share=
d by PCI and VIO buses)
...
ert_extent())
Merging f2fs/dev (091a4dfbb1d3 f2fs: compress: fix to assign compress_level=
 for lz4 correctly)
...
Merging gfs2/for-next (46a7538f71ac gfs2: Fix quota data refcount after cle=
anup)
...
a reconnect)
Merging nfs-anna/linux-next (eb55dc06cee6 NFS: Guard against READDIR loop w=
hen entry names exceed MAXNAMELEN)
Merging nfsd/nfsd-next (fe6b30915e15 Documentation: Add missing documentati=
...
ng driver shut down)
Merging net-next/main (aa05346dad4b Merge branch 'iep-drver-timestamping-su=
pport')
CONFLICT (content): Merge conflict in drivers/net/ethernet/freescale/fs_ene=
t/fs_enet.h
Merging bpf-next/for-next (aa05346dad4b Merge branch 'iep-drver-timestampin=
g-support')
...
Merging sound/for-next (0982e519df6a ALSA: emu10k1: add separate documentat=
ion for E-MU cards)
...
Merging libata/for-next (db15538ba6a4 ata: pata_ep93xx: use soc_device_matc=
h for UDMA modes)
...
eak)
Merging kvm-arm/next (0b84c5d5764e Merge remote-tracking branch 'linux/mast=
er' into kvmarm-master/next)
Merging kvms390/next (fdf0eaf11452 Linux 6.5-rc2)
...
ext)
Merging drivers-x86/for-next (4dbd6e61adc7 platform/x86/amd/pmf: Fix a miss=
ing cleanup path)
...
Merging tty/tty-next (db726a2f3b4b Revert "tty: serial: meson: Add a earlyc=
on for the T7 SoC")
...

=s8Ez
-----END PGP SIGNATURE-----
