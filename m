Return-Path: <linux-next+bounces-9384-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 415DCCB1C4A
	for <lists+linux-next@lfdr.de>; Wed, 10 Dec 2025 04:03:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id F062230321D8
	for <lists+linux-next@lfdr.de>; Wed, 10 Dec 2025 03:03:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 62D491DE887;
	Wed, 10 Dec 2025 03:03:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="hI9zZ0Uy"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7DEB78C1F;
	Wed, 10 Dec 2025 03:03:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765335805; cv=none; b=RwHtK5JTZREMBjqNVdj3zC9SAfcOBagYEZFJiKKI2ns4OqN2F2HR/eFdHzy+gQiqnnxsx3zmrx5Z3+kkoSD0v/w1ILBJWauTqEVXUXyy0plHab9PA4cGyYVEDE8rWuGo6fszn4/MDZ8rZKTCz5mkeoLat7vXIFm8pdr343kpkXI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765335805; c=relaxed/simple;
	bh=leYqTRpjw64RzEPKQySSnQHkhLGH1WFBiK5JU4hq++U=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=OxI/35JRnfIJIZazq1pRc2BVRUtiTgrYlYF7jpNqZEnbd43hpZHSeK8dmgSaZAtKm0+VJpyMQ9Y9UA501EEeGNXMBvhu6ztgCKKBUbAcueY4Z+oyKXVuqKCYY9ZoC+D5FLLKwefdKam9q0NLi/sYIfsAyQE9ljNjBxZ4Ma4Htrs=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=hI9zZ0Uy; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1765335467;
	bh=Zih5SFMGDhfb74YLKU1vvQZJ6xSxjKLSz1g2fEJtpUQ=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dR0kz1Zd9z4wD0;
	Wed, 10 Dec 2025 13:57:47 +1100 (AEDT)
Date: Wed, 10 Dec 2025 13:57:45 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 10
Message-ID: <20251210135745.2ce01cc4@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/aKorzNUneMaMDqjP87BK.i6";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/aKorzNUneMaMDqjP87BK.i6
...
Changes since 20251209:

The mm-hotfixes tree lost its build failure.

Non-merge commits (relative to Linus' tree): 915
 1095 files changed, 110937 insertions(+), 12280 deletions(-)
...
Merging origin/master (c9b47175e913 Merge tag 'i2c-for-6.19-rc1' of git://g=
...
YPTO_AES)
Merging cifs/for-next (833f0f46368f smb/client: add 4 NT error code definit=
ions)
...
ezable kthread)
Merging ksmbd/ksmbd-for-next (3d99347a2e1a Merge tag 'v6.19-rc-part1-smb3-c=
lient-fixes' of git://git.samba.org/sfrench/cifs-2.6)
...
n-persistent dentry)
Merging mm-hotfixes/mm-hotfixes-unstable (c2ffa52a4745 kasan-unpoison-vms-a=
ddresses-with-a-common-tag-v4)
Merging fs-current (6529da535955 Merge branch 'nfsd-fixes' of https://git.k=
...
Merging net/main (186468c67fc6 Merge branch 'mptcp-misc-fixes-for-v6-19-rc1=
')
...
d.h comment)
Merging sound-asoc-fixes/for-linus (ab4efaa616fc Merge remote-tracking bran=
...
Merging libcrypto-fixes/libcrypto-fixes (6f7d9481920e crypto/arm64: sm4/xts=
 - Merge ksimd scopes to reduce stack bloat)
...
Merging devicetree-fixes/dt/linus (43ebaa3ea17a dt-bindings: clock: sprd,sc=
9860-clk: Allow "reg" for gate clocks)
...
Merging tip-fixes/tip/urgent (d5cbb2974fe8 Merge branch into tip/master: 'p=
erf/urgent')
...
der inclusion)
Merging mm-unstable/mm-unstable (1bb9335bdaf8 mm: avoid use of BIT() macro =
for initialising VMA flags)
Merging mm-nonmm-unstable/mm-nonmm-unstable (7b8fcb0b2445 mm: memfd_luo: ad=
...
Merging fs-next (6c2a32637599 Merge branch 'vfs.all' of https://git.kernel.=
...
Merging bluetooth/master (3d55304c6e43 Bluetooth: MGMT: report BIS capabili=
ty flags in supported settings)
...
Merging drm-xe/drm-xe-next (1987ea95ac37 drm/xe/xe_survivability: Add suppo=
rt for survivability mode v2)
...
Merging sound-asoc/for-next (676cb9e55b41 Merge remote-tracking branch 'aso=
...
Merging block/for-next (08a097f326d4 Merge branch 'io_uring-6.19' into for-=
next)
...
18' into spi-linus)
Merging tip/master (87cef06a665e Merge branch into tip/master: 'x86/boot')
...

=auP4
-----END PGP SIGNATURE-----
