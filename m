...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3CD023249D6
	for <lists+linux-next@lfdr.de>; Thu, 25 Feb 2021 05:45:23 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233070AbhBYEoK (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 24 Feb 2021 23:44:10 -0500
Received: from ozlabs.org ([203.11.71.1]:57733 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235258AbhBYEnz (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 24 Feb 2021 23:43:55 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DmKsm1F5kz9s1l;
        Thu, 25 Feb 2021 15:43:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1614228188;
        bh=P9MllzdfrXDiXoAK9R71P7LD/kSWz3e4wV+7vyXfkDU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 25 Feb 2021 15:43:04 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 25
Message-ID: <20210225154304.519863fb@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/byhW.x8lx=e9d6/=rZLgQqH";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/byhW.x8lx=e9d6/=rZLgQqH
...
Non-merge commits (relative to Linus' tree): 1426
 1399 files changed, 46136 insertions(+), 17159 deletions(-)
...
Merging origin/master (062c84fccc44 Merge tag 'rproc-v5.12' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/andersson/remoteproc)
...
invalidated)
Merging arm64-fixes/for-next/fixes (430251cc864b arm64: Add missing ISB aft=
er invalidating TLB in enter_vhe)
...
Merging net/master (88eee9b7b42e net: usb: qmi_wwan: support ZTE P685M mode=
m)
...
Merging sound-asoc-fixes/for-linus (886fbd78319f Merge remote-tracking bran=
...
Merging driver-core.current/driver-core-linus (719bbd4a509f Merge tag 'vfio=
-v5.12-rc1' of git://github.com/awilliam/linux-vfio)
...
BLE())
Merging staging.current/staging-linus (c03c21ba6f4e Merge tag 'keys-misc-20=
210126' of git://git.kernel.org/pub/scm/linux/kernel/git/dhowells/linux-fs)
Merging char-misc.current/char-misc-linus (719bbd4a509f Merge tag 'vfio-v5.=
12-rc1' of git://github.com/awilliam/linux-vfio)
...
ings for Clang)
Merging kbuild/for-next (481083ec0bfc initramfs: Remove redundant dependenc=
...
b is used)
Merging cifs/for-next (c494a7f5f29a cifs: update internal version number)
...
registration API)
Merging drm/drm-next (12458e351799 Merge tag 'drm-msm-next-2021-02-07' of h=
ttps://gitlab.freedesktop.org/drm/msm into drm-next)
Merging drm-misc/for-linux-next (583065c7aa23 drm/drm_vblank: set the dma-f=
ence timestamp during send_vblank_event)
...
Merging sound/for-next (c4294d7f057d ALSA: hda: intel-dsp-config: add Alder=
 Lake support)
Merging sound-asoc/for-next (886fbd78319f Merge remote-tracking branch 'aso=
...
Merging block/for-next (226fc5e811e1 Merge branch 'io_uring-worker.v3' into=
 for-next)
...
s block write)
Merging driver-core/driver-core-next (719bbd4a509f Merge tag 'vfio-v5.12-rc=
1' of git://github.com/awilliam/linux-vfio)
...
.kernel.org/pub/scm/linux/kernel/git/linusw/linux-pinctrl)
Merging char-misc/char-misc-next (719bbd4a509f Merge tag 'vfio-v5.12-rc1' o=
f git://github.com/awilliam/linux-vfio)
...
Merging staging/staging-next (c03c21ba6f4e Merge tag 'keys-misc-20210126' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/dhowells/linux-fs)
...
Merging akpm/master (c80e4b3413a6 MIPS: make userspace mapping young by def=
ault)
...

=K4oI
-----END PGP SIGNATURE-----
