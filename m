...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0DB154A55EE
	for <lists+linux-next@lfdr.de>; Tue,  1 Feb 2022 05:33:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233481AbiBAEdw (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 31 Jan 2022 23:33:52 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:34707 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233454AbiBAEdw (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 31 Jan 2022 23:33:52 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JnsWY6vFWz4xQp;
        Tue,  1 Feb 2022 15:33:45 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1643690026;
        bh=Do3mgWxQbQL4MWhTNOrFqqmrJ/O2WOvnxmOGZadLSB0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 1 Feb 2022 15:33:45 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 1
Message-ID: <20220201153345.3f457df3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/6aiKd.+b1t01MB2CGyAN87D";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/6aiKd.+b1t01MB2CGyAN87D
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220131:

The drm-intel-fixes tree gained a build failure for which I reverted
a commit.

The kspp tree lost one build failure.
...
Non-merge commits (relative to Linus' tree): 2744
 3239 files changed, 129249 insertions(+), 39349 deletions(-)
...
Merging net/master (341adeec9ada net/smc: Forward wakeup to smc socket wait=
queue after fallback)
...
Merging sound-current/for-linus (94db9cc8f8fa ALSA: hda/realtek: Add quirk =
for ASUS GU603)
...
Merging spi-fixes/for-linus (12d30d7f10e6 Merge remote-tracking branch 'spi=
...
Merging usb-serial-fixes/usb-linus (d48384c7ed6c USB: serial: option: add Z=
TE MF286D modem)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (ea33c6d63f87 drm/i915/pmu: Fi=
...
Merging zstd-fixes/zstd-linus (88a309465b3f lib: zstd: clean up double word=
 in comment.)
Merging drm-misc-fixes/for-linux-next-fixes (1b777d4d9e38 drm/nouveau: fix =
off by one in BIOS boundary checking)
Applying: Revert "drm/i915: delete shadow "ret" variable"
...
Merging qcom/for-next (ef5619a5c2df Merge branches 'arm64-for-5.18', 'dts-f=
...
rp_list)
Merging net-next/master (b43471cc1032 Merge branch 'mana-XDP-counters')
Merging bpf-next/for-next (0407a65f356e bpf: make bpf_copy_from_user_task()=
 gpl only)
...
r in kmalloc())
Merging bluetooth/master (b43471cc1032 Merge branch 'mana-XDP-counters')
Merging wireless-next/main (fe683faecc7a cw1200: wsm: make array queue_id_t=
o_wmm_aci static const)
...
Merging drm/drm-next (26291c54e111 Linux 5.17-rc2)
...
Merging drm-intel/for-linux-next (063565aca373 Merge drm/drm-next into drm-=
intel-next)
Merging drm-intel-gt/for-linux-next-gt (ef6e871af312 drm/i915/dg2: s/engine=
->i915/i915/ for engine workarounds)
...
Merging spi/for-next (6938e02f8658 spi: sp7201: Fix compiler warnings)
...
works for s390)
Merging rcu/rcu/next (42a3d5cc6367 rcutorture: Test SRCU size transitions)
...
s in kobj_type)
Merging usb/usb-next (60c250a98d4c Merge tag 'v5.17-rc2' into usb-next)
...
Merging akpm/master (783b0e97114a sysctl: documentation: fix table format w=
arning)
...

=oVyE
-----END PGP SIGNATURE-----
