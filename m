...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9BD42348AEA
	for <lists+linux-next@lfdr.de>; Thu, 25 Mar 2021 08:59:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229669AbhCYH6z (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 25 Mar 2021 03:58:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50850 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229695AbhCYH6u (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 25 Mar 2021 03:58:50 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 935EAC06174A;
        Thu, 25 Mar 2021 00:58:49 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4F5ctY6bSDz9sRR;
        Thu, 25 Mar 2021 18:58:45 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1616659126;
        bh=TS64p+/Ig+TAiLXr72/1E1+gOz+19SKzf6CJwOmYa64=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 25 Mar 2021 18:58:45 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 25
Message-ID: <20210325185845.089b14cd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/JCikKa1fP3VwuOZKYqc_B9w";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/JCikKa1fP3VwuOZKYqc_B9w
...
Merging origin/master (4ee998b0ef8b Merge tag 'clk-fixes-for-linus' of git:=
...
Merging net/master (6f235a69e594 ch_ktls: fix enum-conversion warning)
...
Merging mips/mips-next (05c4e2721d7a MIPS: fix local_irq_{disable,enable} i=
n asmmacro.h)
...
Merging s390/for-next (84fa3962d5ff s390/crc32-vx: couple of typo fixes)
...
I/O)
Merging exfat/dev (9a109e38e960 exfat: speed up iterate/lookup by fixing st=
...
ing)
Merging f2fs/dev (bd93ad85fea0 f2fs: fix to avoid touching checkpointed dat=
a in get_victim())
...
locating XRCDN)
Merging net-next/master (84c7f6c33f42 hinic: avoid gcc -Wrestrict warning)
...
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/en_tc.c
Merging bpf-next/for-next (e2c69f3a5b4e bpf: Avoid old-style declaration wa=
rnings)
...
Merging drm-misc/for-linux-next (a1f091f8ef2b drm/ttm: switch to per device=
 LRU lock)
...
ice.c
Merging drm-intel/for-linux-next (989634fb49ad drm/i915/audio: set HDA link=
...
s)
Merging sound-asoc/for-next (786286773d35 Merge remote-tracking branch 'aso=
...
t)
Merging block/for-next (3ddcfbf440cf Merge branch 'for-5.13/drivers' into f=
or-next)
...
Merging devicetree/for-next (c4d74f0f978e of: overlay: fix for_each_child.c=
occi warnings)
Merging mailbox/mailbox-for-next (6b50df2b8c20 mailbox: arm_mhuv2: Skip cal=
ling kfree() with invalid pointer)
Merging spi/for-next (f7fa9f64e91e Merge remote-tracking branch 'spi/for-5.=
13' into spi-next)
...
d for shadow paging)
Merging kvm-arm/next (5584029fd8c7 Merge branch 'kvm-arm64/vlpi-save-restor=
e' into kvmarm-master/next)
...
Merging akpm/master (8c233162c2ac secretmem: test: add basic selftest for m=
emfd_secret(2))
...

=alwS
-----END PGP SIGNATURE-----
