...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B3A92444F89
	for <lists+linux-next@lfdr.de>; Thu,  4 Nov 2021 08:15:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230390AbhKDHST (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 4 Nov 2021 03:18:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58270 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230383AbhKDHST (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 4 Nov 2021 03:18:19 -0400
Received: from mail-pf1-x432.google.com (mail-pf1-x432.google.com [IPv6:2607:f8b0:4864:20::432])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CE427C061203
        for <linux-next@vger.kernel.org>; Thu,  4 Nov 2021 00:15:41 -0700 (PDT)
Received: by mail-pf1-x432.google.com with SMTP id l3so3024256pfu.13
        for <linux-next@vger.kernel.org>; Thu, 04 Nov 2021 00:15:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=WDcZ5wrrN9zMN2IDXUfClRsW0EyAbTgdc3V4b3KHZnY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=WDcZ5wrrN9zMN2IDXUfClRsW0EyAbTgdc3V4b3KHZnY=;
        b=
X-Gm-Message-State: AOAM533HrUgZKlaA9T5luuGKjXh3ffVwnLwmGXexwWW8Nnpn9A03hApX
        +j0tkC7l4up3Z8Rfg3jttjcrAGWCcfs4lIk+
X-Google-Smtp-Source: ABdhPJxx9pkSLYGdehcdYIuMzWo4p8ZcRoXCv+VuqNRLCTfxoYjkpC9+q4YZTp8EaIHy3xs4Yl3FSQ==
X-Received: by 2002:a62:7f4a:0:b0:44d:292f:cc24 with SMTP id a71-20020a627f4a000000b0044d292fcc24mr50119954pfd.58.1636010139458;
        Thu, 04 Nov 2021 00:15:39 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id g5sm4546985pfj.188.2021.11.04.00.15.38
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 04 Nov 2021 00:15:38 -0700 (PDT)
Message-ID: <6183889a.1c69fb81.27726.f9d0@mx.google.com>
Date:   Thu, 04 Nov 2021 00:15:38 -0700 (PDT)
...
Subject: next/master build: 228 builds: 23 failed, 205 passed, 479 errors,
 223 warnings (next-20211104)
...
next/master build: 228 builds: 23 failed, 205 passed, 479 errors, 223 warni=
ngs (next-20211104)
...
arm:
    ...
    allmodconfig (clang-13): 2 errors, 14 warnings
...
i386:
    ...
    allmodconfig (clang-10): 3 errors
...
rriers
    ...
    2    ERROR: modpost: "this_cpu_has_cap" [drivers/hwtracing/coresight/co=
...
e size (1804) exceeds limit (1024) in function 'gbaudio_tplg_create_widget'=
 [-Werror,-Wframe-larger-than]
    1    drivers/soc/ti/wkup_m3_ipc.c:429:9: error: =E2=80=98return=E2=80=
...
rence to `__aeabi_uldivmod'
    1    arch/arm64/kvm/hyp/nvhe/hyp-reloc.S:22:12: error:   CC      securi=
ty/keys/keyctl_pkey.o
...
7-a' [-Wunused-command-line-argument]
    11   clang: warning: argument unused during compilation: '-Wa,-march=3D=
...
me
    arch/arm64/kvm/hyp/nvhe/hyp-reloc.S:22:12: error:   CC      security/ke=
ys/keyctl_pkey.o
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-13) =E2=80=94 FAIL, 2 errors, 14 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
allmodconfig (i386, clang-10) =E2=80=94 FAIL, 3 errors, 0 warnings, 0 secti=
on mismatches
