...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A79621F403A
	for <lists+linux-next@lfdr.de>; Tue,  9 Jun 2020 18:06:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730999AbgFIQGT (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 9 Jun 2020 12:06:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53584 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728888AbgFIQGQ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 9 Jun 2020 12:06:16 -0400
Received: from mail-pl1-x642.google.com (mail-pl1-x642.google.com [IPv6:2607:f8b0:4864:20::642])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 75561C05BD1E
        for <linux-next@vger.kernel.org>; Tue,  9 Jun 2020 09:06:16 -0700 (PDT)
Received: by mail-pl1-x642.google.com with SMTP id g12so8211665pll.10
        for <linux-next@vger.kernel.org>; Tue, 09 Jun 2020 09:06:16 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=1umYPcBtIJIV+GK7WAVbtvpOECheNjAhhseK8RASfa0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1umYPcBtIJIV+GK7WAVbtvpOECheNjAhhseK8RASfa0=;
        b=
X-Gm-Message-State: AOAM530zmCGmEs53wfxw5oYPviefXVQBrh7eJTh1FX7Dz7JXqyRP31l/
        1JolCeD+VYi6Ep+cfoklVefOcPxfR6o=
X-Google-Smtp-Source: ABdhPJz0OC5sNvAbLLjBhErw9JKCd7tDAtIi3QlD+p8gZ7ewEEvwwK9f3ykRvv953bw1pCBIC79abA==
X-Received: by 2002:a17:90a:7643:: with SMTP id s3mr5787947pjl.183.1591718773775;
        Tue, 09 Jun 2020 09:06:13 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id cm13sm2924516pjb.5.2020.06.09.09.06.12
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 09 Jun 2020 09:06:12 -0700 (PDT)
Message-ID: <5edfb374.1c69fb81.4ccbb.8e4b@mx.google.com>
Date:   Tue, 09 Jun 2020 09:06:12 -0700 (PDT)
...
Subject: next/pending-fixes build: 143 builds: 3 failed, 140 passed, 3 errors,
 129 warnings (v5.7-13207-g0a095ef39b5b)
...
next/pending-fixes build: 143 builds: 3 failed, 140 passed, 3 errors, 129 w=
arnings (v5.7-13207-g0a095ef39b5b)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.7-13207-g0a095ef39b5b/

Tree: next
Branch: pending-fixes
Git Describe: v5.7-13207-g0a095ef39b5b
Git Commit: 0a095ef39b5b9bb1a5d57155b7820786e2287aa9
...
time_assert_46=E2=80=99 declared with attribute error: BUILD_BUG_ON failed:=
...
Section mismatches summary:
    ...
    1    WARNING: modpost: vmlinux.o(.text.unlikely+0x2a50): Section mismat=
ch in reference from the function pmax_setup_memory_region() to the functio=
n .init.text:add_memory_region()
    1    WARNING: modpost: vmlinux.o(.text.unlikely+0x2814): Section mismat=
ch in reference from the function pmax_setup_memory_region() to the functio=
n .init.text:add_memory_region()
...
Errors:
    include/linux/compiler.h:403:38: error: call to =E2=80=98__compiletime_=
assert_46=E2=80=99 declared with attribute error: BUILD_BUG_ON failed: offs=
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text.unlikely+0x2a50): Section mismatch in=
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text.unlikely+0x2814): Section mismatch in=
 reference from the function pmax_setup_memory_region() to the function .in=
it.text:add_memory_region()
