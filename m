...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B3A8C49D91A
	for <lists+linux-next@lfdr.de>; Thu, 27 Jan 2022 04:19:50 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235576AbiA0DTt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 26 Jan 2022 22:19:49 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:40475 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235683AbiA0DTs (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 26 Jan 2022 22:19:48 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Jkm6W0qBbz4xhm;
        Thu, 27 Jan 2022 14:19:47 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1643253587;
        bh=an4P3wksNQ3SUPpVnvNcC7lmNVGLURTOaJC+RML5uyI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 27 Jan 2022 14:19:46 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 27
Message-ID: <20220127141946.2496e102@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/j/fUFN8fi2_k42Uv+hUDvoB";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/j/fUFN8fi2_k42Uv+hUDvoB
...
Merging origin/master (0280e3c58f92 Merge tag 'nfs-for-5.17-1' of git://git=
...
Merging sound-current/for-linus (549f8ffc7b2f ALSA: hda: Fix UAF of leds cl=
ass devs at unbinding)
...
Merging tty.current/tty-linus (2dd8a74fddd2 serial: core: Initialize rs485 =
RTS polarity already on probe)
...
Merging kselftest-fixes/fixes (92d25637a3a4 kselftest: signal all child pro=
cesses)
...
1-next)
Merging drivers-memory/for-next (86a010bfc739 memory: mtk-smi: mt8186: Add =
smi support)
Merging imx-mxs/for-next (df8c9444a992 Merge branch 'imx/dt64' into for-nex=
t)
...
' into for-next)
Merging samsung-krzk/for-next (b834afb2bc3e Merge branch 'for-v5.18/tesla-f=
sd-clk' into for-next)
...
Merging hwmon-staging/hwmon-next (8f98ebf01cda hwmon: (powr1220) Add suppor=
...
Merging net-next/master (40cd4f1550d0 nfp: flower: Use struct_size() helper=
 in kmalloc())
Merging bpf-next/for-next (e5465a9027e9 selftests/bpf: Fix a clang compilat=
ion error)
...
s)
Merging netfilter-next/master (ab14f1802cfb net: Adjust sk_gso_max_size onc=
e when set)
Merging ipvs-next/master (ab14f1802cfb net: Adjust sk_gso_max_size once whe=
n set)
Merging bluetooth/master (adce573b927a Bluetooth: hci_h5: Add power reset v=
ia gpio in h5_btrtl_open)
...
Merging amdgpu/drm-next (63e583c8843f drm/amdgpu: bump driver version for n=
...
Merging drm-intel/for-linux-next (62236df23d01 drm/i915: Clean up PIPESRC d=
efines)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/i915_reg.h
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/intel_pm.c
Merging drm-intel-gt/for-linux-next-gt (b229712b26b5 drm/i915/guc: Update g=
uc shim control programming on newer platforms)
...
Merging char-misc/char-misc-next (515a2f507491 mei: me: Use dma_set_mask_an=
d_coherent() and simplify code)
...
Merging staging/staging-next (39ddef568183 staging: fbtft: Deduplicate driv=
er registration macros)
...

=+4j8
-----END PGP SIGNATURE-----
