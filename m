...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E589E1C33B4
	for <lists+linux-next@lfdr.de>; Mon,  4 May 2020 09:35:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728092AbgEDHf4 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 4 May 2020 03:35:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44146 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1726411AbgEDHfx (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 4 May 2020 03:35:53 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B4A3AC061A0E;
        Mon,  4 May 2020 00:35:52 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49Fvm46pFjz9sSc;
        Mon,  4 May 2020 17:35:48 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1588577749;
        bh=de6u5FJlr6FPAWaeR+hbbTm47oofkTsfmjbJKE77bYU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 4 May 2020 17:35:47 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 4
Message-ID: <20200504173547.2cdd83bf@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/NAHn/T/L_Runtl=htdpLkpK";
...
--Sig_/NAHn/T/L_Runtl=htdpLkpK
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200501:
...
The keys tree gained a conflict against the kbuild tree.

The devicetree tree gained a conflict against the drm tree.

Non-merge commits (relative to Linus' tree): 5624
 6653 files changed, 208923 insertions(+), 88467 deletions(-)
...
Merging origin/master (0e698dfa2822 Linux 5.7-rc4)
...
Merging net/master (dc30b4059f6e drop_monitor: work around gcc-10 stringop-=
overflow warning)
...
Merging ipsec/master (c95c5f58b35e xfrm interface: fix oops when deleting a=
 x-netns interface)
Merging netfilter/master (8f34e53b60b3 ipv6: Use global sernum for dst vali=
dation with nexthop objects)
...
Merging sound-current/for-linus (52e4e36807ae ALSA: hda/realtek - Fix S3 po=
p noise on Dell Wyse)
Merging sound-asoc-fixes/for-linus (ba452324792d Merge remote-tracking bran=
...
Merging kspp-gustavo/for-next/kspp (a47020f3fc86 uapi: revert flexible-arra=
y conversions)
...
Merging net-next/master (60bcbc41ffb3 Merge branch 'net-smc-add-and-delete-=
link-processing')
...
Merging bpf-next/master (115506fea499 Merge git://git.kernel.org/pub/scm/li=
...
physical port)
Merging netfilter-next/master (a465fb1e2f27 Merge branch 'r8169-improve-use=
r-message-handling')
...
.c
Merging drm-intel/for-linux-next (389b7f00c739 drm/i915/gt: Sanitize RPS in=
terrupts upon resume)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_dd=
i.c
Merging drm-tegra/drm/tegra/for-next (757338371608 drm/tegra: Clean up GPIO=
 includes)
Merging drm-misc/for-linux-next (5e6ed29d72d2 dt-bindings: Add binding for =
IT6505.)
...
Merging sound/for-next (c55f5692748c ALSA: line6: Add poll callback for hwd=
ep)
Merging sound-asoc/for-next (a60fd3bd67b9 Merge remote-tracking branch 'aso=
...
Merging block/for-next (22118003f90f Merge branch 'for-5.8/block' into for-=
next)
...
Merging devicetree/for-next (2407fcb81b56 dt-bindings: arm: Add Calxeda sys=
tem registers json-schema binding)
...
Merging rcu/rcu/next (829960d8a31e rcu: Add callbacks-invoked counters)
...
Merging akpm/master (474443f674a3 drivers/media/platform/sti/delta/delta-ip=
...

=uMDN
-----END PGP SIGNATURE-----
