...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 700994ED2D5
	for <lists+linux-next@lfdr.de>; Thu, 31 Mar 2022 06:35:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229523AbiCaEM6 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 31 Mar 2022 00:12:58 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54306 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230031AbiCaEMG (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 31 Mar 2022 00:12:06 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4FA8714FFCF;
        Wed, 30 Mar 2022 20:45:20 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KTTWt21Ghz4x7X;
        Thu, 31 Mar 2022 14:37:30 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1648697850;
        bh=bOzvfpW4xxHOaP9SGqLtzTt8NI9Et10zsYfds73aPos=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 31 Mar 2022 14:37:29 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 31
Message-ID: <20220331143729.3f1bdaa8@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Mvv=yNj5eqhvRk0kXXoh68r";
...
Non-merge commits (relative to Linus' tree): 1115
 1245 files changed, 62290 insertions(+), 13793 deletions(-)
...
Merging origin/master (74164d284b29 Merge tag 'pwm/for-5.18-rc1' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/thierry.reding/linux-pwm)
...
Merging net/master (c9ad266bbef5 sfc: Avoid NULL pointer dereference on sys=
tems without numa awareness)
Merging bpf/master (2609f635a20d selftests/bpf: Fix warning comparing point=
er to 0)
...
Merging pci-current/for-linus (18146f25ac66 PCI: hv: Remove unused hv_set_m=
si_entry_from_desc())
Merging driver-core.current/driver-core-linus (d888c83fcec7 fs: fix fd tabl=
e size alignment properly)
...
pace)
Merging usb.current/usb-linus (d888c83fcec7 fs: fix fd table size alignment=
 properly)
...
Merging staging.current/staging-linus (d888c83fcec7 fs: fix fd table size a=
lignment properly)
...
Merging char-misc.current/char-misc-linus (1930a6e739c4 Merge tag 'ptrace-c=
leanups-for-v5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebieder=
m/user-namespace)
...
Merging devicetree-fixes/dt/linus (0b030dfe5b7c dt-bindings: extcon: maxim,=
max77843: fix ports type)
...
Merging dma-mapping/for-next (05b0ebd06ae6 PCI/doc: cleanup references to t=
he legacy PCI DMA API)
...
roller)
Merging clk/clk-next (cf683abd3913 Merge branches 'clk-sifive' and 'clk-vis=
conti' into clk-next)
...
Merging mips/mips-next (bf64f7fe151b MIPS: rb532: move GPIOD definition int=
o C-files)
Merging nios2/for-next (7f7bc20bc41a nios2: Don't use _end for calculating =
min_low_pfn)
Merging openrisc/for-next (862cf8d5fd98 openrisc/boot: Remove unnecessary i=
nitialisation in memcpy().)
Merging parisc-hd/for-next (a9fe7fa7d874 parisc: Fix patch code locking and=
 flushing)
...
lue)
Merging risc-v/for-next (60210a3d86dc riscv module: remove (NOLOAD))
...
Merging cifs/for-next (9f31fc7b78ec cifs: fix NULL ptr dereference in smb2_=
ioctl_query_info())
...
Merging net-next/master (d717e4cae0fe Merge tag 'net-5.18-rc0' of git://git=
.kernel.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf-next/for-next (d717e4cae0fe Merge tag 'net-5.18-rc0' of git://g=
...
ent match)
Merging bluetooth/master (300cf0bfb43e Bluetooth: fix dangling sco_conn and=
 use-after-free in sco_sock_timeout)
...
Merging block/for-next (672ac2b26928 Merge branch 'for-5.18/drivers' into f=
or-next)
Merging device-mapper/for-next (6f04f34f08ff dm: conditionally enable branc=
hing for less used features)
...
nto HEAD)
Merging kvm/next (ccc9646cd74e KVM: x86/mmu: Don't rebuild page when the pa=
ge is synced and no tlb flushing is required)
...
ing for SLAB)
Merging driver-core/driver-core-next (d888c83fcec7 fs: fix fd table size al=
ignment properly)
...
Merging char-misc/char-misc-next (1930a6e739c4 Merge tag 'ptrace-cleanups-f=
or-v5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebiederm/user-na=
mespace)
...
Merging staging/staging-next (d888c83fcec7 fs: fix fd table size alignment =
properly)
...
Merging xarray/main (3e3c658055c0 XArray: Fix xas_create_range() when multi=
-order entry present)
...
[master a2aa350397d4] next-20220329/sysctl
...
Merging akpm-current/current (03dc2f51ace9 ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
CONFLICT (content): Merge conflict in arch/arm64/Kconfig
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (f3f78b12b660 kselftest/vm: override TARGETS from argum=
ents)
Applying: Revert "kasan: use stack_trace_save_shadow"
Applying: Revert "arm64: implement stack_trace_save_shadow"
Applying: Revert "arm64, scs: save scs_sp values per-cpu when switching sta=
cks"
Applying: Revert "stacktrace: add interface based on shadow call stack"
...

=15Iy
-----END PGP SIGNATURE-----
