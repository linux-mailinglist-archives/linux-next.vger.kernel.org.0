...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9CFBE229919
	for <lists+linux-next@lfdr.de>; Wed, 22 Jul 2020 15:16:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728344AbgGVNQu (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 22 Jul 2020 09:16:50 -0400
Received: from ozlabs.org ([203.11.71.1]:48355 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732055AbgGVNQt (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 22 Jul 2020 09:16:49 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BBbZy49T6z9sSt;
        Wed, 22 Jul 2020 23:16:42 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1595423802;
        bh=8EwoyN+xQLHDJxlfiY3zI65Xc606YWBV4FCrtmlyLZE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 22 Jul 2020 23:16:40 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 22
Message-ID: <20200722231640.3dae04cd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//7o=xFBjFEq4ctl0YuqcSK3";
...
Merging s390-fixes/fixes (3d3af181d370 s390/cpum_cf,perf: change DFLT_CCERR=
OR counter name)
Merging sparc/master (37719576046b arch/sparc: Replace HTTP links with HTTP=
S ones)
Merging fscrypt-current/for-stable (2b4eae95c736 fscrypt: don't evict dirty=
 inodes after removing key)
Merging net/master (3506b2f42dff net: dsa: microchip: call phy_remove_link_=
mode during probe)
...
Merging sound-asoc-fixes/for-linus (70a5e6938d0b Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (1a1c1f764dbc Merge remote-tracking branch 'spi=
/for-5.8' into spi-linus)
Merging pci-current/for-linus (61e1f7df86bf Revert "PCI/PM: Assume ports wi=
thout DLL Link Active train links in 100 ms")
Merging driver-core.current/driver-core-linus (ba47d845d715 Linux 5.8-rc6)
Merging tty.current/tty-linus (551e553f0d4a serial: 8250_mtk: Fix high-spee=
d baud rates clamping)
Merging usb.current/usb-linus (dbb0897e805f usb: xhci: Fix ASM2142/ASM3142 =
DMA addressing)
...
Merging drm-fixes/drm-fixes (ba47d845d715 Linux 5.8-rc6)
...
Merging arm/for-next (7d10dbd543dc Merge branches 'fixes' and 'misc' into f=
or-next)
...
Merging clk/clk-next (54f3d4cb93ad Merge branch 'clk-actions' into clk-next)
...
Merging risc-v/for-next (27f8ff71cc52 riscv: Enable ARCH_HAS_FAST_MULTIPLIE=
R for RV64I)
...
with flexible-array)
Merging xtensa/xtensa-for-next (06e6ae8e7414 Merge branch 'xtensa-5.8-fixes=
...
-next)
Merging pci/next (3055eb90f2db Merge branch 'remotes/lorenzo/pci/xilinx')
$ git reset --hard HEAD^
Merging next-20200721 version of pci
...
ed word + clarify)
Merging net-next/master (fa56a987449b Merge branch 'ionic-updates')
...
ge
Merging bpf-next/master (9165e1d70fb3 bpftool: Use only nftw for file tree =
parsing)
...
.c
Merging amdgpu/drm-next (c5b72f9fc818 drm/amdgpu/powerplay: add some docume=
ntation about memory clock)
...
Merging drm-misc/for-linux-next (acc0c39a59cc dt-binding: display: Allow a =
single port node on rocktech, jh057n00900)
Merging drm-msm/msm-next (e79ea476f9df drm/msm/dpu: fix/enable 6bpc dither =
with split-lm)
...
ter API)
Merging sound-asoc/for-next (1027a308e41b Merge remote-tracking branch 'aso=
...
Merging input/next (9b031c86506c Merge branch 'elan-i2c' into next)
...
Merging regulator/for-next (472723424271 Merge remote-tracking branch 'regu=
...
pcs compatible)
Merging spi/for-next (59ca3dd5795b Merge remote-tracking branch 'spi/for-5.=
9' into spi-next)
...
enbus_map_ring_pv())
Merging percpu/for-next (33386c660cb9 Merge branch 'for-5.9' into for-next)
...
Merging leds/for-next (52031c8c3d4a leds: lp5521: Add multicolor framework =
...
Merging staging/staging-next (809a9308646a staging: Replace HTTP links with=
 HTTPS ones)
Merging mux/for-next (05f19f7f8944 mux: adgs1408: Add mod_devicetable.h and=
 remove of_match_ptr)
Merging icc/icc-next (5ed80ad08485 interconnect: Do not skip aggregation fo=
r disabled paths)
...
Merging scsi-mkp/for-next (6422e3c3b521 scsi: aic79xx: Restore modes when e=
xiting ahd_linux_queue_abort_cmd())
...
.h instead of stubs)
Merging rpmsg/for-next (b9f19cf74fc9 Merge branches 'hwspinlock-next', 'rpm=
...
Merging akpm/master (4ef16fdb2880 sh: add missing EXPORT_SYMBOL() for __del=
ay)
...

=4oXq
-----END PGP SIGNATURE-----
