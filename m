Return-Path: <linux-next+bounces-1969-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 568538A937F
	for <lists+linux-next@lfdr.de>; Thu, 18 Apr 2024 08:47:54 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 861FCB22143
	for <lists+linux-next@lfdr.de>; Thu, 18 Apr 2024 06:47:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 74CDA2CCC2;
	Thu, 18 Apr 2024 06:47:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="NbPJBYTv"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6B3162D057;
	Thu, 18 Apr 2024 06:47:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713422850; cv=none; b=b0/bmTfDsEyZA0UUS4/s6rMrCoXtqZJdK13g7jmCDM4MDBXSQ2gyDY9jautPwaiAdAq3R31IUTc+OgLuM1cooj42CjXYjJZJ7Ua+jvYaLd40uMKzdv1HkvtM40PYjNEGbaE8r7WVDV7JDrYZ96oQszgQr9mh2pCoSFh5LxOC2sI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713422850; c=relaxed/simple;
	bh=O4fT1lAk6TG8fHLGom5AZsvFHN1dsvgoHm+0B3phjuY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=iciwmikrKpSalWJ8fcuPvIK5C1kA0ehq6RMKdZoqitmUBYdreQMV+tHE7vQ7e2Ox3oWjyJfkUSr5KETG4hlouZ+ihfJw0xP+InnuahDIR4SO1p8YSN0Wtu0zYhSwPgTSTHn5yFn5GaTedi8gZFZcZXlY/SnsKWwrwE5UbYl/SSE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=NbPJBYTv; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1713422844;
	bh=n48NWz6Pwsg/FphUWG9MuTG/UCf1znxfJ79G8SV9Z+E=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VKpHJ1qffz4wyV;
	Thu, 18 Apr 2024 16:47:24 +1000 (AEST)
Date: Thu, 18 Apr 2024 16:47:23 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 18
Message-ID: <20240418164723.1217ef1e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/5DseTG5r0/4cpQ0Fo7VewW/";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/5DseTG5r0/4cpQ0Fo7VewW/
...
Merging origin/master (4b6b51322118 Merge tag 'pwm/for-6.9-rc5-fixes' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/ukleinek/linux)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (e5a5cd543574 mm/hugetlb: fix miss=
ing hugetlb_lock for resv uncharge)
...
Merging net/main (83781384a96b s390/ism: Properly fix receive message buffe=
r allocation)
...
into usb-linus)
Merging usb-serial-fixes/usb-linus (fb1f4584b121 USB: serial: option: add s=
upport for Fibocom FM650/FG650)
...
Merging mm/mm-everything (2c65903ca2d4 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging loongarch/loongarch-next (1f1d13414caa LoongArch: Fix access error =
...
Merging net-next/main (2bd99aef1b19 tcp: accept bare FIN packets under memo=
ry pressure)
CONFLICT (content): Merge conflict in drivers/of/property.c
CONFLICT (content): Merge conflict in include/trace/events/rpcgss.h
Merging bpf-next/for-next (e739e01d8df8 libbpf: Fix dump of subsequent char=
 arrays)
...
Merging drm-misc/for-linux-next (f7ad2ce5fd89 drm/panel: simple: Add Innolu=
x G121XCE-L01 LVDS display support)
Merging amdgpu/drm-next (efade6fe50e7 drm/radeon: silence UBSAN warning (v3=
))
Merging drm-intel/for-linux-next (4bbb89328fe3 drm/i915: Suck snps/cx0 PLL =
states into dpll_hw_state)
...
r)
Merging drm-xe/drm-xe-next (2817a1f1bfb1 drm/xe/lnl: Apply GuC Wa_130116456=
52)
...
Merging devicetree/for-next (ad366e350291 dt-bindings: kbuild: Add separate=
...
Merging tty/tty-next (35fad98ed25a serial: meson+qcom: don't advance the kf=
ifo twice)
...
Merging gpio-intel/for-next (57b60ec4b30d gpiolib: acpi: Pass con_id instea=
d of property into acpi_dev_gpio_irq_get_by())
...
Merging slab/slab/for-next (5b15f3fb89fc slub: Set __GFP_COMP in kmem_cache=
 by default)
Merging random/master (e871abcda3b6 random: handle creditable entropy from =
atomic process context)
...

=uv9S
-----END PGP SIGNATURE-----
