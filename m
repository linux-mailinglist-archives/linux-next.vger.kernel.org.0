Return-Path: <linux-next+bounces-3251-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id DA6BB949EF1
	for <lists+linux-next@lfdr.de>; Wed,  7 Aug 2024 06:58:12 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 2CB971F24531
	for <lists+linux-next@lfdr.de>; Wed,  7 Aug 2024 04:58:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D963C190078;
	Wed,  7 Aug 2024 04:58:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="nQ825yGu"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B24321C3D;
	Wed,  7 Aug 2024 04:58:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723006686; cv=none; b=oMlSsuw7PVbei/6WHZ2IBVVXnWFYji4d2zVRnDvczVZz9UUDAb19i7YOiCOw1KX4yI3vjH7geCAj5myOeqecFauK5ek2PBG544+NNJNLJnsH53aLtRyqg1h+5suQJLCRx2TZsFFF/fcdmvxSKnHpI+z75BUJ5CeF95Ixp/hZIrA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723006686; c=relaxed/simple;
	bh=bMhhZW8uvqL0ce8ox5M4fj/OfmDB5w/KzMMqxDC35tg=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=RSP1zXNK4NKu8KjYWHYNccvMlAunqNhQvrXZZNZs65IX1eh1JCXE87J/8oU2ZzhYc/JAKMKSmKYNHWqHzIZGBtUBofPEaKfETsWlz55yXZfAdXUcYWi2c4PwpLQrXtQtprrv86aVB+tOSA3JcoVsAwzgVE4njQfnviwXJPh15Rw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=nQ825yGu; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1723006678;
	bh=LyoIm7eXBHr9eG4sffhwJijBjjUq0wSBkmTns+Tm7Yc=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Wdybp49S8z4w2L;
	Wed,  7 Aug 2024 14:57:58 +1000 (AEST)
Date: Wed, 7 Aug 2024 14:57:57 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 7
Message-ID: <20240807145757.51aae8e6@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/YFw3cbmAPQZSUuEkUjSbGn+";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/YFw3cbmAPQZSUuEkUjSbGn+
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240806:

New trees:	ath, ath-next

The kunit-fixes tree lost its build failure.

The asm-generic tree lost its build failure.

the vfs-brauner tree gained a conflict against the vfs-fixes tree.

The execve tree gained a conflict against the tip tree.

The kspp tree still had its build failure for which I reverted a commit.

Non-merge commits (relative to Linus' tree): 3031
 3423 files changed, 127213 insertions(+), 62020 deletions(-)
...
Merging origin/master (d4560686726f Merge tag 'for_linus' of git://git.kern=
...
erify_area())
Merging fs-current (b1b8d5385d8a Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging arm-soc-fixes/arm/fixes (893738d2fc99 ARM: pxa/gumstix: fix attachi=
ng properties to vbus gpio device)
...
Merging net/main (3e7917c0cdad net: linkwatch: use system_unbound_wq)
...
U grace period)
Merging wireless/for-next (de9c2c66ad8e Linux 6.11-rc2)
...
Merging sound-current/for-linus (176fd1511dd9 ALSA: hda/hdmi: Yet more pin =
fix for HP EliteDesk 800 G4)
...
ce waits")
Merging drm-intel-fixes/for-linux-next-fixes (8bdd9ef7e9b1 drm/i915/gem: Fi=
x Virtual Memory mapping boundaries calculation)
...
IPTION() macros)
Merging arm-soc/for-next (893738d2fc99 ARM: pxa/gumstix: fix attaching prop=
erties to vbus gpio device)
...
Merging loongarch/loongarch-next (48a3de6cf4c9 LoongArch: KVM: Remove undef=
...
nge_test.c
[fs-next a9e5acab586f] Merge branch 'vfs.all' of git://git.kernel.org/pub/s=
cm/linux/kernel/git/vfs/vfs.git
Applying: fixup for "fs: Convert aops->write_end to take a folio"
[fs-next 6572ba54f33b] Merge branch 'vfs.all' of git://git.kernel.org/pub/s=
cm/linux/kernel/git/vfs/vfs.git
Merging vfs/for-next (a38297e3fb01 Linux 6.9)
Merging fs-next (6572ba54f33b Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging rdma/for-next (2a777679b8cc RDMA/mad: Improve handling of timed out=
 WRs of mad agent)
Merging net-next/main (45160cebd6ac net: veth: Disable netpoll support)
Merging bpf-next/for-next (6e083ab095ca Merge branch 'bpf-introduce-new-vfs=
-based-bpf-kfuncs')
...
Merging ath-next/for-next (3f66f2670309 wifi: ath9k: fix possible integer o=
verflow in ath9k_get_et_stats())
...
Merging drm-misc/for-linux-next (16c9898ac5ab drm/ci: rockchip: add tests f=
or rockchip display driver)
...
Merging drm-xe/drm-xe-next (9cc033e07d02 drm/xe/guc: Define GuC version v70=
.29.2 for BMG)
...
ap-next)
Merging sound/for-next (901e85677ec0 ALSA: usb-audio: Add input value sanit=
y checks for standard types)
...
Merging selinux/next (180cba7a0daf Automated merge of 'dev' into 'next')
...
12' into spi-next)
Merging tip/master (9ebdc7589cbb Merge branch into tip/master: 'x86/timers')
...
-next)
Merging workqueues/for-next (97dd94173253 Merge branch 'for-6.12' into for-=
next)
...
Merging kselftest/next (2c082b62aeb5 selftests: harness: rename __construct=
or_order for clarification)
...
element)
Merging execve/for-next/execve (fb97d2eb542f binfmt_elf, coredump: Log the =
reason of the failed core dumps)
...
IPTION() macro)
Merging kspp/for-next/kspp (d518b5f7f2d5 coccinelle: Add rules to find str_=
...

=pfxD
-----END PGP SIGNATURE-----
