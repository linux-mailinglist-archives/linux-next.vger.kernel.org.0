...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B1EB5DA4B9
	for <lists+linux-next@lfdr.de>; Thu, 17 Oct 2019 06:26:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2392352AbfJQE0x (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 17 Oct 2019 00:26:53 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:46735 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726149AbfJQE0x (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 17 Oct 2019 00:26:53 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46tx2F4g98z9sNx;
        Thu, 17 Oct 2019 15:26:45 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1571286405;
        bh=vU2KBnc5W/8arM2CjNyVEq86qExMUe7pvBFH1rTIUko=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 17 Oct 2019 15:26:45 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 17
Message-ID: <20191017152645.65892c78@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/9uyRNsgCQrXMg0kb1szu+l_";
...
Merging origin/master (bc88f85c6c09 kthread: make __kthread_queue_delayed_w=
ork static)
...
Merging arm64-fixes/for-next/fixes (597399d0cb91 arm64: tags: Preserve tags=
 for addresses translated via TTBR1)
...
Merging net/master (2ca4f6ca4562 rxrpc: use rcu protection while reading sk=
->sk_user_data)
...
Merging drm-fixes/drm-fixes (4f5cafb5cb84 Linux 5.4-rc3)
...
or-next)
Merging omap/for-next (546c5876bf0f Merge branch 'omap-for-v5.5/defconfig' =
into for-next)
...
into sunxi/for-next)
Merging tegra/for-next (802f9c55079d Merge branch for-5.5/arm64/dt into for=
-next)
...
in imxfb_probe())
Merging pm/linux-next (75137cd23b7c Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
Merging net-next/master (2203cbf2c8b5 net: sfp: move fwnode parsing into sf=
p-bus layer)
...
peer record"
Merging bpf-next/master (eac9153f2b58 bpf/stackmap: Fix deadlock with rq_lo=
ck in bpf_get_stack())
...
_packed)
Merging bluetooth/master (4c371bb95cf0 Bluetooth: Workaround directed adver=
tising bug in Broadcom controllers)
...
Merging drm-misc/for-linux-next (f86cf71944bc drm/i810: Refer to `PREEMPTIO=
N' in comment)
...
Merging driver-core/driver-core-next (0864c408fb1e debugfs: remove return v=
alue of debugfs_create_x64())
...
Merging pidfd/for-next (f418dddffc80 usercopy: Avoid soft lockups in test_c=
heck_nonzero_user())
...
rflow
Merging akpm/master (e8699f1729b5 drivers/media/platform/sti/delta/delta-ip=
...

=ZQJ7
-----END PGP SIGNATURE-----
