...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 850DF1F5F9C
	for <lists+linux-next@lfdr.de>; Thu, 11 Jun 2020 03:45:50 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726268AbgFKBpt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 10 Jun 2020 21:45:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55174 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726265AbgFKBpt (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 10 Jun 2020 21:45:49 -0400
Received: from mail-pj1-x1041.google.com (mail-pj1-x1041.google.com [IPv6:2607:f8b0:4864:20::1041])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D5165C08C5C1
        for <linux-next@vger.kernel.org>; Wed, 10 Jun 2020 18:45:48 -0700 (PDT)
Received: by mail-pj1-x1041.google.com with SMTP id jz3so1589199pjb.0
        for <linux-next@vger.kernel.org>; Wed, 10 Jun 2020 18:45:48 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=YISZ5G8W0dSSW9ByrtMHZHvEP6JHaTXLLvkKucaNt/Q=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YISZ5G8W0dSSW9ByrtMHZHvEP6JHaTXLLvkKucaNt/Q=;
        b=
X-Gm-Message-State: AOAM5317v4PntSpA4fkKa07EfcrEE+AAOTwkS1XHziFnb5NZIe2ItuGv
        csrfBPUR52t6eTQ4+f2aXAkoKgc4o6A=
X-Google-Smtp-Source: ABdhPJwXQ10h/Rv49Qgkr99B+2jaA7Ml4ryI29ZQ4C/F9swKxonvI0bSleCwfQHzOieNGWvOEGtl3w==
X-Received: by 2002:a17:90a:8a18:: with SMTP id w24mr5324238pjn.222.1591839946757;
        Wed, 10 Jun 2020 18:45:46 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id c15sm1013430pgb.4.2020.06.10.18.45.45
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 10 Jun 2020 18:45:45 -0700 (PDT)
Message-ID: <5ee18cc9.1c69fb81.1951c.3bde@mx.google.com>
Date:   Wed, 10 Jun 2020 18:45:45 -0700 (PDT)
...
Subject: next/pending-fixes build: 153 builds: 5 failed, 148 passed, 4 errors,
 122 warnings (v5.7-14137-g60392f4b277d)
...
next/pending-fixes build: 153 builds: 5 failed, 148 passed, 4 errors, 122 w=
arnings (v5.7-14137-g60392f4b277d)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.7-14137-g60392f4b277d/

Tree: next
Branch: pending-fixes
Git Describe: v5.7-14137-g60392f4b277d
Git Commit: 60392f4b277dd983893bda2a86cf9cb6f0a5c1b8
...
Errors summary:
    ...
    1    include/linux/compiler.h:383:38: error: call to =E2=80=98__compile=
time_assert_491=E2=80=99 declared with attribute error: BUILD_BUG_ON failed=
...
struct __call_single_data, llist)
    1    include/linux/compiler.h:383:38: error: call to =E2=80=98__compile=
time_assert_230=E2=80=99 declared with attribute error: BUILD_BUG_ON failed=
: offsetof(struct task_struct, wake_entry_type) - offsetof(struct task_stru=
ct, wake_entry) !=3D offsetof(struct __call_single_data, flags) - offsetof(=
struct __call_single_data, llist)
    1    include/linux/compiler.h:383:38: error: call to =E2=80=98__compile=
time_assert_151=E2=80=99 declared with attribute error: BUILD_BUG_ON failed=
: offsetof(struct task_struct, wake_entry_type) - offsetof(struct task_stru=
ct, wake_entry) !=3D offsetof(struct __call_single_data, flags) - offsetof(=
struct __call_single_data, llist)
...
Errors:
    include/linux/compiler.h:383:38: error: call to =E2=80=98__compiletime_=
assert_230=E2=80=99 declared with attribute error: BUILD_BUG_ON failed: off=
...
Errors:
    include/linux/compiler.h:383:38: error: call to =E2=80=98__compiletime_=
assert_491=E2=80=99 declared with attribute error: BUILD_BUG_ON failed: off=
setof(struct task_struct, wake_entry_type) - offsetof(struct task_struct, w=
ake_entry) !=3D offsetof(struct __call_single_data, flags) - offsetof(struc=
t __call_single_data, llist)
...
Errors:
    include/linux/compiler.h:383:38: error: call to =E2=80=98__compiletime_=
assert_151=E2=80=99 declared with attribute error: BUILD_BUG_ON failed: off=
setof(struct task_struct, wake_entry_type) - offsetof(struct task_struct, w=
ake_entry) !=3D offsetof(struct __call_single_data, flags) - offsetof(struc=
t __call_single_data, llist)
...
---------------------------------------------------------------------------=
-----
nlm_xlp_defconfig (mips, gcc-8) =E2=80=94 FAIL, 0 errors, 0 warnings, 0 sec=
tion mismatches
