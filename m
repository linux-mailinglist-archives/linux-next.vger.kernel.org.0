...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E7EB07D7B72
	for <lists+linux-next@lfdr.de>; Thu, 26 Oct 2023 06:22:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229705AbjJZEWY (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 26 Oct 2023 00:22:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40048 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229554AbjJZEWX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 26 Oct 2023 00:22:23 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 163E2182;
        Wed, 25 Oct 2023 21:22:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1698294135;
        bh=4qQ25pHT92n7kN9DU76dejFHtesuBfqXNJly5VPormk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SGCLb0vm7z4wd7;
        Thu, 26 Oct 2023 15:22:15 +1100 (AEDT)
Date:   Thu, 26 Oct 2023 15:22:13 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 26
Message-ID: <20231026152213.13c2382f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Yp4Ty4wtKLGjolVFyb8Ax6Z";
...
Merging origin/master (611da07b89fd Merge tag 'acpi-6.6-rc8' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (e2ed99b82ddb mm/damon/sysfs: remo=
...
h_ifid())
Merging netfilter/main (a63b6622120c net/sched: act_ct: additional checks f=
or outdated flows)
...
Merging hwmon-fixes/hwmon (920057ad521d hwmon: (nct6775) Fix incorrect vari=
able reuse in fan_div calculation)
...
pending lowedirs)
Merging drm-misc-fixes/for-linux-next-fixes (4e6c38c38723 drm/logicvc: Kcon=
fig: select REGMAP and REGMAP_MMIO)
...
a comment)
Merging mm/mm-everything (c6b4068cbd8a Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging arm-soc/for-next (a82cfa293bde Merge branch 'soc/drivers' into for-=
next)
...
s 0)
Merging v9fs/9p-next (25d50b014f14 9p/net: xen: fix false positive printf f=
...
Merging pstore/for-next/pstore (a19d48f7c5d5 pstore/platform: Add check for=
 kstrdup)
Merging hid/for-next (80eb9e65a687 Merge branch 'for-6.7/logitech' into for=
-next)
...
ength checks)
Merging hwmon-staging/hwmon-next (45e70fd40bce hwmon: (nct6683) Add another=
 customer ID for ASRock X670E Taichi)
...
Merging pm/linux-next (f9c7f9d537da Merge branch 'pm-devfreq' into linux-ne=
xt)
...
Merging net-next/main (8846f9a04b10 Merge branch 'mptcp-features-and-fixes-=
for-v6-7')
...
Merging netfilter-next/main (9cdee0634769 netfilter: nf_tables: Carry reset=
 boolean in nft_set_dump_ctx)
...
cy on hw_random)
Merging drm/drm-next (0ecf4aa32b78 Merge tag 'amd-drm-next-6.7-2023-10-20' =
...
- add missing escape)
Merging drm-misc/for-linux-next (b8644c4ae2b6 drm/doc: document DRM_IOCTL_M=
ODE_CREATE_DUMB)
Merging amdgpu/drm-next (edb423e91309 drm/amd: Explicitly disable ASPM when=
 dynamic switching disabled)
Merging drm-intel/for-linux-next (bc725dc1a831 drm/i915/display: debugfs en=
try to list display capabilities)
...
Merging sound/for-next (264aeb994ea8 ASoC: SOF: Make return of remove_late =
void, too)
...
et_match_data())
Merging regulator/for-next (1e04e1974449 Merge remote-tracking branch 'regu=
...
comments)
Merging integrity/next-integrity (b302f360831c certs: Only allow certs sign=
ed by keys on the builtin keyring)
...
Merging iommu/next (ae51251a36b6 Merge branches 'arm/tegra', 'arm/smmu', 'v=
...
counted_by)
Merging devicetree/for-next (460babc96c13 dt-bindings: irqchip: renesas,irq=
c: Add r8a779f0 support)
...
CONFLICT (content): Merge conflict in drivers/iommu/arm/arm-smmu-v3/arm-smm=
u-v3-sva.c
...

=0rMP
-----END PGP SIGNATURE-----
