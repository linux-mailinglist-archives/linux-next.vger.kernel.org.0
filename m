Return-Path: <linux-next+bounces-9315-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 21556C9DC7D
	for <lists+linux-next@lfdr.de>; Wed, 03 Dec 2025 05:58:45 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id C1C384E48EF
	for <lists+linux-next@lfdr.de>; Wed,  3 Dec 2025 04:58:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 37D6B277CA5;
	Wed,  3 Dec 2025 04:58:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="fgHQt8rK"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 40EE1242D84;
	Wed,  3 Dec 2025 04:58:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764737921; cv=none; b=iiV7o5xw3ZII6i2PfrYS6XlI8ffl0jxLc8MawVWU3jlA03dN7T4RfuTcgXI1NUhYENQKboSyNb9UXe8kYiVMUzAuFf7E0esZn7Dd2smrjLf33XaIxjRn+ZeJKaMkjjfl+1ItBmHUXNgaVEaoGIiTobGxICwAT48bw05Mn4Ee9+4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764737921; c=relaxed/simple;
	bh=+TIrxO5mP2fH4Y/Rvvu4lk0hincHj+1+lCTPgZNlNmE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=strmrTXZ5zgyjfTap8VjvDymMWp5sBUowvU9A3av57jrARnMhUtlB2D0iT79t0sSBBa6cRcT04pxo5HUWAtjdhrw/qOlzR/QfNSFcCNtitBPH35uZW0/7mtcPC0fOenh2zbX2+3sXwZ1BqMOTIghgJvmpRZcPBDKclHkq/qnMsw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=fgHQt8rK; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1764737912;
	bh=blSIGyL2tCjaWX5h8mwinLeCfi0ygs0Li2bxIzfUaxk=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dLllX0vJJz4w0p;
	Wed, 03 Dec 2025 15:58:32 +1100 (AEDT)
Date: Wed, 3 Dec 2025 15:58:29 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 3
Message-ID: <20251203155829.0c53e08e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/oucLW1npaGUax=0A3l12LF1";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/oucLW1npaGUax=0A3l12LF1
...
Changes since 20251202:

The regmap tree gained a conflict against the i3c tree.

Non-merge commits (relative to Linus' tree): 11084
 11613 files changed, 575941 insertions(+), 177017 deletions(-)
...
Merging origin/master (d7489818348e Merge tag 'x86_cleanups_for_v6.19_rc1' =
...
t_extent())
Merging f2fs/dev (a7982944b487 f2fs: optimize trace_f2fs_write_checkpoint w=
ith enums)
...
Merging ksmbd/ksmbd-for-next (078e40b892ec cifs: Don't need state locking i=
n smb2_get_mid_entry())
...
Merging fs-current (c7a2f1518e48 Merge branch 'next-fixes' of https://git.k=
...
Merging sound-asoc-fixes/for-linus (a8accafd480c Merge remote-tracking bran=
...
Merging tip-fixes/tip/urgent (47cf486357a1 Merge branch into tip/master: 'x=
86/urgent')
...
Merging perf/perf-tools-next (267c2e633af6 perf trace: Skip internal syscal=
l arguments)
...
Merging fs-next (f2d90bdf4267 Merge branch 'for-next' of https://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (322530a9c2ab Merge branch 'rework/nbcon-in-kdb' in=
to for-next)
Merging pci/next (830f1c5fb069 Merge branch 'pci/misc')
...
Merging drm-xe/drm-xe-next (43109e398d2d drm/xe/gt: Use scope-based forcewa=
ke)
...
Merging sound-asoc/for-next (a8accafd480c Merge remote-tracking branch 'aso=
...
Merging device-mapper/for-next (2dd56dff1c87 dm pcache: fix segment info in=
dexing)
...
ging)
Merging tpmdd/next (e3469fdc333b KEYS: trusted: Use tpm_ret_to_err() in tru=
sted_tpm2)
...
18' into spi-linus)
Merging tip/master (f6d19c0fe6ee Merge branch into tip/master: 'x86/sgx')
...
PMI driver)
Merging driver-core/driver-core-next (d3666c1f8a31 debugfs: Fix default acc=
ess mode config check)
...
Merging mhi/mhi-next (ac35e04f8000 bus: mhi: host: pci_generic: Add Foxconn=
 T99W760 modem)
Merging memblock/for-next (a29b922955aa mm/mm_init: Introduce a boot parame=
ter for check_pages)
...

=oA0S
-----END PGP SIGNATURE-----
