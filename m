...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 197107A5A0A
	for <lists+linux-next@lfdr.de>; Tue, 19 Sep 2023 08:37:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231556AbjISGhl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 19 Sep 2023 02:37:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36906 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231250AbjISGhj (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 19 Sep 2023 02:37:39 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 01B47115;
        Mon, 18 Sep 2023 23:37:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1695105449;
        bh=VSqPjJlIaN5siAT4VJjdRsXr9vryHE81VeBHNxHTogA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RqX5j4kgNz4xNs;
        Tue, 19 Sep 2023 16:37:29 +1000 (AEST)
Date:   Tue, 19 Sep 2023 16:37:28 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 19
Message-ID: <20230919163728.78432283@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/iyFHhE4g170t_EpaBC4SMw0";
...
Merging mm-hotfixes/mm-hotfixes-unstable (33e6d7d98b24 maple_tree: use mas_=
node_count_gfp() in mas_expected_entries())
...
Merging net/main (6dab9dd64907 Merge branch 'ax25-project-links')
Merging bpf/master (6dab9dd64907 Merge branch 'ax25-project-links')
...
e selection)
Merging spi-fixes/for-linus (5f66db08cbd3 spi: imx: Take in account bits pe=
r word instead of assuming 8-bits)
...
Merging efi-fixes/urgent (52c34f16245f efi/unaccepted: Make sure unaccepted=
 table is mapped in crashkernel case)
...
Merging mm/mm-everything (89cb390e86fd Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging parisc-hd/for-next (bff63aa59a95 parisc: Enable HAVE_ARCH_PREL32_RE=
LOCATIONS)
...
Merging cifs/for-next (ce9ecca0238b Linux 6.6-rc2)
...
Merging pm/linux-next (b34108fa27bd Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
ckspaces)
Merging rdma/for-next (e57b0eef6684 RDMA/core: Fix repeated words in commen=
ts)
Merging net-next/main (a5ea26536e89 Merge branch 'stmmac-devvm_stmmac_probe=
_config_dt-conversion')
Merging bpf-next/for-next (c720bf3a88f9 Merge branch 'fixes-for-exceptions')
...
- add missing escape)
Merging drm-misc/for-linux-next (0663e1da5ba8 drm/dp_mst: Tune down error m=
essage during payload addition)
...
Merging sound-asoc/for-next (41f156341385 Merge remote-tracking branch 'aso=
...
Merging spi/for-next (baaa2957b0c6 Merge remote-tracking branch 'spi/for-6.=
7' into spi-next)
Merging tip/master (1246f6d749ce Merge branch into tip/master: 'x86/tdx')
...
Merging xen-tip/linux-next (1e9b56f53f8a xen/efi: refactor deprecated strnc=
py)
...
Merging accel/habanalabs-next (e7377db93381 accel/habanalabs: update boot s=
tatus print)
...
Applying: Revert "bpf: remove CONFIG_BPF_JIT dependency on CONFIG_MODULES o=
f"
Applying: Revert "kprobes: remove dependency on CONFIG_MODULES"
Applying: Revert "x86/ftrace: enable dynamic ftrace without CONFIG_MODULES"
Applying: Revert "arch: make execmem setup available regardless of CONFIG_M=
ODULES"
Applying: Revert "powerpc: extend execmem_params for kprobes allocations"
...

=3Wxy
-----END PGP SIGNATURE-----
