Return-Path: <linux-next+bounces-4634-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id CB3779BDF00
	for <lists+linux-next@lfdr.de>; Wed,  6 Nov 2024 07:51:04 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 22C691F23BD9
	for <lists+linux-next@lfdr.de>; Wed,  6 Nov 2024 06:51:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3F61C1922D9;
	Wed,  6 Nov 2024 06:51:00 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="OwlCqTkv"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 05FE117995E;
	Wed,  6 Nov 2024 06:50:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1730875860; cv=none; b=YEDRQ08G0k3r6Hktod8CE2ITED1bPFCx6Sp4fuNf+pITm3f49eyrJuo2aYRuUAtOyoRoAYulw0jib1+oGQ6rMHq85mz8HBlK3sEHMzdCGAxMClDL4Zry/GbYOFTGsZUhMQCXVVbM9tcC//MqnCQPX+VjZNCrqbMWvXQccq53phc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1730875860; c=relaxed/simple;
	bh=bTfFOJ8tJLizC6IjRZHoGUR2/B1Y0bkOnOeimXhKWoA=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=L7CLovwr7CBBGkRu8N6t2YfAuZXPxGm+5sXFK+U5/pFFyWaqgbR8IxD5KBfSrWujPEQkf+C3+aQapkiPJxeGKP+t0ffqHW6ShDYANU4EbYx87lJW4qq2RUHrAJgoTIgGDHeWZMLk2RpKMXj9F6x9xOHFdgUYNS75EcsM1cC/RpU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=OwlCqTkv; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1730875848;
	bh=cSXXbdGq0Cum5K6TaoIS/mdzK0A0iOYeW46D8Ub9eLU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Xjwp031mzz4x11;
	Wed,  6 Nov 2024 17:50:48 +1100 (AEDT)
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/B9aB8v9m1=2u1WIM53EYtpf";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/B9aB8v9m1=2u1WIM53EYtpf
...
Merging origin/master (2e1b3cc9d7f7 Merge tag 'arm-fixes-6.12-2' of git://g=
...
Merging mm-hotfixes/mm-hotfixes-unstable (d576a0e1c227 mm/gup: avoid an unn=
ecessary allocation call for FOLL_LONGTERM cases)
Merging fs-current (a65f6ea9c631 Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (9eaff63bfb59 Merge branch 'net-ethernet-ti-am65-cpsw-fixe=
s-to-multi-queue-rx-feature')
...
r HP 320 FHD Webcam)
Merging sound-asoc-fixes/for-linus (9bb4af400c38 ASoC: stm32: spdifrx: fix =
dma channel release in stm32_spdifrx_remove)
...
Merging perf/perf-tools-next (29bf07bc9ad2 perf test: Fix ftrace test with =
regex patterns)
...
Merging sunxi/sunxi/for-next (cbfca2bd2a00 Merge branches 'sunxi/dt-for-6.1=
...
Merging fs-next (7671d2ddc9d7 Merge branch 'for-next' of git://git.kernel.o=
...
nto i2c/for-next)
Merging i2c-host/i2c/i2c-host (23ea7ef23014 i2c: qcom-cci: Remove unused st=
ruct member cci_clk_rate)
...
Merging pm/linux-next (4bce7a94aff1 Merge branch 'acpi-battery' into linux-=
next)
...
e rename events)
Merging net-next/main (0452a2d8b8b9 mlx5_en: use read sequence for gettimex=
64)
...
_elem_alloc helper)
Merging bluetooth/master (408ec48013da Bluetooth: btusb: Add 3 HWIDs for MT=
7925)
...
Merging drm/drm-next (086ed1d51544 Merge tag 'exynos-drm-next-for-v6.13' of=
...
nos into drm-next)
Merging drm-misc/for-linux-next (aadcf584583c drm/ci: remove update-xfails.=
py)
...
u_v13_0_0_ppt.c
Merging drm-intel/for-linux-next (3c1d5ced18db drm/i915/gsc: ARL-H and ARL-=
U need a newer GSC FW.)
...
mentation comments)
Merging drm-xe/drm-xe-next (20ade9c3f195 drm/xe: Reword exec_queue and vm l=
ock doc)
...
Merging sound/for-next (d6e6b9218ced ALSA: usb-audio: Make mic volume worka=
rounds globally applicable)
Merging ieee1394/for-next (b7688fcde3cf firewire: ohci: Replace deprecated =
PCI functions)
Merging sound-asoc/for-next (a18dadd1209a Merge remote-tracking branch 'aso=
...
Merging block/for-next (476c7f4cef6e Merge branch 'for-6.13/io_uring' into =
for-next)
...
ocv bitmask)
Merging mfd/for-mfd-next (76c6217c3126 dt-bindings: mfd: aspeed: Support fo=
r AST2700)
...
0x50666666)
Merging watchdog/master (bad201b2ac4e watchdog: rzg2l_wdt: Power on the wat=
chdog domain in the restart handler)
...
pile testing)
Merging spi/for-next (e38568da5f05 Merge remote-tracking branch 'spi/for-6.=
13' into spi-next)
...
Merging kvm-ppc/topic/ppc-kvm (1db6a4e8a3fc KVM: PPC: replace call_rcu by k=
free_rcu for simple kmem_cache_free callback)
...
Merging leds-lj/for-leds-next (64dd44a65806 MAINTAINERS: Replace Siemens IP=
C related bouncing maintainers)
Merging ipmi/for-next (2378bd0b264a ipmi: ipmb: Add check devm_kasprintf() =
returned value)
Merging driver-core/driver-core-next (09fbb82f9413 Merge 6.12-rc6 into driv=
er-core-next)
...
Merging tty/tty-next (7dcb7bf4a2ba tty: serial: samsung: Add Exynos8895 com=
patible)
Merging char-misc/char-misc-next (9365f0de4303 Merge 6.12-rc6 into char-mis=
c-next)
...
Merging staging/staging-next (1235b909d312 staging: rtl8723bs: Remove funct=
ion pointer hal_xmitframe_enqueue)
...

=yEZF
-----END PGP SIGNATURE-----
