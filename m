...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C52DE6278CB
	for <lists+linux-next@lfdr.de>; Mon, 14 Nov 2022 10:13:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235804AbiKNJNm (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 14 Nov 2022 04:13:42 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59336 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236192AbiKNJNk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 14 Nov 2022 04:13:40 -0500
Received: from mail-pf1-x42d.google.com (mail-pf1-x42d.google.com [IPv6:2607:f8b0:4864:20::42d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 66C2260FB
        for <linux-next@vger.kernel.org>; Mon, 14 Nov 2022 01:13:36 -0800 (PST)
Received: by mail-pf1-x42d.google.com with SMTP id k15so10445282pfg.2
        for <linux-next@vger.kernel.org>; Mon, 14 Nov 2022 01:13:36 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=CGjhF++mj+0yqqXRkJNak46zBAABH4P3LKesXh81IFU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=CGjhF++mj+0yqqXRkJNak46zBAABH4P3LKesXh81IFU=;
        b=
X-Gm-Message-State: ANoB5pm/o8ez7LU6jQIUIa63Akr6nSpE8MaL0zl6vdg6Vg99Ele8vAZF
        h0WrqdhTfNejbjwqXvaU+pc7W5YFcNZ1mKAl
X-Google-Smtp-Source: AA0mqf7XvPphty1uUJqTw91aS9QLdw+PU0a2lxfm1gUt/UwSaoDi4VvncLqCmFouXu1baUXbzTBW0g==
X-Received: by 2002:a63:eb14:0:b0:470:7886:e201 with SMTP id t20-20020a63eb14000000b004707886e201mr11411831pgh.93.1668417214090;
        Mon, 14 Nov 2022 01:13:34 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id x8-20020aa79ac8000000b0056befcd7958sm2248653pfp.84.2022.11.14.01.13.33
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 14 Nov 2022 01:13:33 -0800 (PST)
Message-ID: <637206bd.a70a0220.2a537.2e0d@mx.google.com>
Date:   Mon, 14 Nov 2022 01:13:33 -0800 (PST)
...
Subject: next/master build: 217 builds: 19 failed, 198 passed, 24 errors,
 640 warnings (next-20221114)
...
next/master build: 217 builds: 19 failed, 198 passed, 24 errors, 640 warnin=
gs (next-20221114)
...
Tree: next
Branch: master
Git Describe: next-20221114
Git Commit: 5c92ddca1053df02387e8006d06094e18cc8538a
...
error
    ...
    moxart_defconfig (gcc-10): 3 warnings
    mps2_defconfig (gcc-10): 52 warnings
...
Errors summary:
    ...
    9    drivers/cpufreq/acpi-cpufreq.c:970:24: error: variable 'ret' is un=
...
=3D0x'
    1    ..../arch/arm/mach-s3c/devs.c:32:10: fatal error: linux/platform_d=
ata/dma-s3c24xx.h: No such file or directory

Warnings summary:

    514  <command-line>: warning: "__thumb2__" redefined
    23   drivers/bus/simple-pm-bus.c:96:12: warning: =E2=80=98simple_pm_bus=
_runtime_resume=E2=80=99 defined but not used [-Wunused-function]
    23   drivers/bus/simple-pm-bus.c:87:12: warning: =E2=80=98simple_pm_bus=
_runtime_suspend=E2=80=99 defined but not used [-Wunused-function]
    13   drivers/bus/simple-pm-bus.c:96:12: warning: 'simple_pm_bus_runtime=
_resume' defined but not used [-Wunused-function]
    13   drivers/bus/simple-pm-bus.c:87:12: warning: 'simple_pm_bus_runtime=
_suspend' defined but not used [-Wunused-function]
    10   <stdin>:1517:2: warning: #warning syscall clone3 not implemented [=
-Wcpp]
    9    drivers/cpufreq/acpi-cpufreq.c:960:9: note: initialize the variabl=
...
fined but not used [-Wunused-function]
    6    drivers/pwm/pwm-tegra.c:148:53: warning: result of =E2=80=98100000=
...
Errors:
    ..../arch/arm/mach-s3c/devs.c:32:10: fatal error: linux/platform_data/d=
ma-s3c24xx.h: No such file or directory
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, clang-16) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 sect=
ion mismatches
...
Warnings:
    drivers/bus/simple-pm-bus.c:96:12: warning: 'simple_pm_bus_runtime_resu=
me' defined but not used [-Wunused-function]
    drivers/bus/simple-pm-bus.c:87:12: warning: 'simple_pm_bus_runtime_susp=
end' defined but not used [-Wunused-function]
...
---------------------------------------------------------------------------=
-----
allnoconfig (sparc, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 section=
 mismatches

Warnings:
    <stdin>:1517:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    drivers/bus/simple-pm-bus.c:96:12: warning: =E2=80=98simple_pm_bus_runt=
ime_resume=E2=80=99 defined but not used [-Wunused-function]
    drivers/bus/simple-pm-bus.c:87:12: warning: =E2=80=98simple_pm_bus_runt=
ime_suspend=E2=80=99 defined but not used [-Wunused-function]
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig+kselftest (arc, gcc-10) =E2=80=94 PASS, 0 errors, 2 w=
...
---------------------------------------------------------------------------=
-----
moxart_defconfig (arm, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
mps2_defconfig (arm, gcc-10) =E2=80=94 PASS, 0 errors, 52 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
tinyconfig (sparc, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 section =
mismatches
