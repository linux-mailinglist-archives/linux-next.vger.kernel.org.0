Return-Path: <linux-next+bounces-102-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C0C67FBEE9
	for <lists+linux-next@lfdr.de>; Tue, 28 Nov 2023 17:04:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 10A02B20C8A
	for <lists+linux-next@lfdr.de>; Tue, 28 Nov 2023 16:04:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6919C35277;
	Tue, 28 Nov 2023 16:04:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="vCort4LK"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-x433.google.com (mail-pf1-x433.google.com [IPv6:2607:f8b0:4864:20::433])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A81F12A
	for <linux-next@vger.kernel.org>; Tue, 28 Nov 2023 08:04:18 -0800 (PST)
Received: by mail-pf1-x433.google.com with SMTP id d2e1a72fcca58-6b7f0170d7bso5255239b3a.2
        for <linux-next@vger.kernel.org>; Tue, 28 Nov 2023 08:04:18 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1701187457; x=1701792257; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=sc6m1i9a58UkpR5qiqscWREoJ/dc/VCE3lN46Ith3vw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1701187457; x=1701792257;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=sc6m1i9a58UkpR5qiqscWREoJ/dc/VCE3lN46Ith3vw=;
        b=
X-Gm-Message-State: AOJu0YyaLJ954lyzLJYZ8P6QMoznzzyUnYQ8exdDkHQmK4qv2NG51yef
	dnT0jM45vPxl+HCNotGhsEANRxTL9mv3LnART7g=
X-Google-Smtp-Source: AGHT+IGC03Merna7UIFnZes+3gsORt002SJcebkgLrUeGgbA7LJFA8+UDVs+ZtwU+ty6MsdsybnyTQ==
X-Received: by 2002:a05:6a21:328a:b0:187:a75d:29dd with SMTP id yt10-20020a056a21328a00b00187a75d29ddmr21258579pzb.40.1701187455259;
        Tue, 28 Nov 2023 08:04:15 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id r16-20020a62e410000000b006933f504111sm9395379pfh.145.2023.11.28.08.04.14
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 28 Nov 2023 08:04:14 -0800 (PST)
Message-ID: <65660f7e.620a0220.9999b.7471@mx.google.com>
Date: Tue, 28 Nov 2023 08:04:14 -0800 (PST)
...
Subject: next/master build: 189 builds: 79 failed, 110 passed, 317 errors,
 228 warnings (next-20231128)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 189 builds: 79 failed, 110 passed, 317 errors, 228 warni=
ngs (next-20231128)
...
Tree: next
Branch: master
Git Describe: next-20231128
Git Commit: 8c87404c76c1911a7ec5b61bf3b2c3858cb95de1
...
arm64:
    ...
    defconfig+arm64-chromebook+kselftest (gcc-10): 2 errors
    defconfig+arm64-chromebook+videodec (gcc-10): 2 errors
    defconfig+debug (gcc-10): 2 errors
    defconfig+videodec (gcc-10): 2 errors
...
mips:
    ...
    32r2el_defconfig+kselftest (gcc-10): 8 errors, 2 warnings
    allnoconfig (gcc-10): 5 errors, 1 warning
    ath25_defconfig (gcc-10): 7 errors, 3 warnings
    ath79_defconfig (gcc-10): 6 errors, 2 warnings
    bcm47xx_defconfig (gcc-10): 6 errors, 2 warnings
    bcm63xx_defconfig (gcc-10): 7 errors, 3 warnings
    bigsur_defconfig (gcc-10): 6 errors, 3 warnings
    ...
    ci20_defconfig (gcc-10): 7 errors, 3 warnings
    cobalt_defconfig (gcc-10): 8 errors, 3 warnings
    cu1000-neo_defconfig (gcc-10): 5 errors, 1 warning
    cu1830-neo_defconfig (gcc-10): 6 errors, 2 warnings
    db1xxx_defconfig (gcc-10): 8 errors, 3 warnings
    decstation_64_defconfig (gcc-10): 4 errors, 1 warning
    decstation_defconfig (gcc-10): 4 errors, 1 warning
    decstation_r4k_defconfig (gcc-10): 4 errors, 1 warning
    fuloong2e_defconfig (gcc-10): 1 error, 1 warning
    gcw0_defconfig (gcc-10): 5 errors, 1 warning
    gpr_defconfig (gcc-10): 10 errors, 4 warnings
    ip22_defconfig (gcc-10): 6 errors, 2 warnings
    ip27_defconfig (gcc-10): 7 errors, 3 warnings
    ...
    loongson2k_defconfig (gcc-10): 5 errors, 2 warnings
    loongson3_defconfig (gcc-10): 5 errors, 2 warnings
    malta_defconfig (gcc-10): 8 errors, 4 warnings
    malta_kvm_defconfig (gcc-10): 5 errors, 1 warning
    malta_qemu_32r6_defconfig (gcc-10): 5 errors, 1 warning
    maltaaprp_defconfig (gcc-10): 7 errors, 3 warnings
    maltasmvp_defconfig (gcc-10): 7 errors, 3 warnings
    maltasmvp_eva_defconfig (gcc-10): 6 errors, 2 warnings
    maltaup_defconfig (gcc-10): 5 errors, 1 warning
    maltaup_xpa_defconfig (gcc-10): 6 errors, 2 warnings
    ...
    rb532_defconfig (gcc-10): 8 errors, 4 warnings
    rbtx49xx_defconfig (gcc-10): 6 errors, 2 warnings
    rm200_defconfig (gcc-10): 7 errors, 2 warnings
    rs90_defconfig (gcc-10): 6 errors, 2 warnings
    rt305x_defconfig (gcc-10): 7 errors, 2 warnings
    sb1250_swarm_defconfig (gcc-10): 2 errors, 1 warning
    tinyconfig (gcc-10): 5 errors, 1 warning
    vocore2_defconfig (gcc-10): 9 errors, 4 warnings
    xway_defconfig (gcc-10): 6 errors, 2 warnings
...
Errors summary:
    ...
    39   arch/mips/kernel/signal.c:903:17: error: no previous prototype for=
 =E2=80=98do_notify_resume=E2=80=99 [-Werror=3Dmissing-prototypes]
    39   arch/mips/kernel/signal.c:673:17: error: no previous prototype for=
 =E2=80=98sys_rt_sigreturn=E2=80=99 [-Werror=3Dmissing-prototypes]
    39   arch/mips/kernel/signal.c:515:5: error: no previous prototype for =
=E2=80=98restore_sigcontext=E2=80=99 [-Werror=3Dmissing-prototypes]
    39   arch/mips/kernel/signal.c:438:5: error: no previous prototype for =
=E2=80=98setup_sigcontext=E2=80=99 [-Werror=3Dmissing-prototypes]
    35   arch/mips/kernel/signal.c:636:17: error: no previous prototype for=
 =E2=80=98sys_sigreturn=E2=80=99 [-Werror=3Dmissing-prototypes]
    14   arch/mips/kernel/syscall.c:51:16: error: no previous prototype for=
 =E2=80=98sysm_pipe=E2=80=99 [-Werror=3Dmissing-prototypes]
    12   arch/mips/mm/fault.c:323:17: error: no previous prototype for =E2=
=80=98do_page_fault=E2=80=99 [-Werror=3Dmissing-prototypes]
    7    arch/arm64/kernel/vdso32/vgettimeofday.c:28:5: error: conflicting =
types for =E2=80=98__vdso_clock_getres=E2=80=99
    7    arch/arm64/kernel/vdso32/vgettimeofday.c:10:5: error: conflicting =
types for =E2=80=98__vdso_clock_gettime=E2=80=99
    5    ld.lld: error: undefined symbol: __muloti4
...
e for =E2=80=98indy_8254timer_irq=E2=80=99 [-Werror=3Dmissing-prototypes]
    2    arch/mips/mm/init.c:60:6: error: no previous prototype for =E2=80=
...
es]
    2    arch/mips/alchemy/common/prom.c:59:7: error: no previous prototype=
 for =E2=80=98prom_getenv=E2=80=99 [-Werror=3Dmissing-prototypes]
    2    arch/mips/alchemy/common/prom.c:48:13: error: no previous prototyp=
e for =E2=80=98prom_init_cmdline=E2=80=99 [-Werror=3Dmissing-prototypes]
    2    arch/mips/alchemy/common/prom.c:127:12: error: no previous prototy=
...
ype for =E2=80=98bcm1480_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
    1    arch/mips/sibyte/bcm1480/irq.c:200:13: error: no previous prototyp=
e for =E2=80=98init_bcm1480_irqs=E2=80=99 [-Werror=3Dmissing-prototypes]
...
sing-prototypes]
    1    arch/mips/alchemy/devboards/platform.c:68:12: error: no previous p=
rototype for =E2=80=98db1x_register_pcmcia_socket=E2=80=99 [-Werror=3Dmissi=
ng-prototypes]
    1    arch/mips/alchemy/devboards/platform.c:152:12: error: no previous =
prototype for =E2=80=98db1x_register_norflash=E2=80=99 [-Werror=3Dmissing-p=
rototypes]
    1    arch/mips/alchemy/devboards/db1000.c:93:12: error: no previous pro=
totype for =E2=80=98db1500_pci_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
    1    arch/mips/alchemy/devboards/db1000.c:451:12: error: no previous pr=
ototype for =E2=80=98db1000_dev_setup=E2=80=99 [-Werror=3Dmissing-prototype=
s]
    1    arch/mips/alchemy/devboards/db1000.c:35:12: error: no previous pro=
totype for =E2=80=98db1000_board_setup=E2=80=99 [-Werror=3Dmissing-prototyp=
es]
...
for =E2=80=98board_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
    1    arch/arm64/kernel/vdso32/vgettimeofday.c:28:5: error: conflicting =
types for '__vdso_clock_getres'
    1    arch/arm64/kernel/vdso32/vgettimeofday.c:10:5: error: conflicting =
types for '__vdso_clock_gettime'
...
Warnings summary:
    ...
    107  cc1: all warnings being treated as errors
...
-Wcpp]
    7    security/security.c:810:2: warning: =E2=80=98memcpy=E2=80=99 offse=
...
memcpy=E2=80=99 offset 32 is out of the bounds [0, 0] [-Warray-bounds]
    1    include/linux/fortify-string.h:402:12: warning: writing 1 byte int=
...
_memcpy=E2=80=99 offset 32 is out of the bounds [0, 0] [-Warray-bounds]
    1    .........../arch/sparc/kernel/traps_64.c:2035:6: warning: no previ=
ous prototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    1    ........................./arch/sparc/kernel/traps_64.c:253:6: warn=
ing: no previous prototype for =E2=80=98is_no_fault_exception=E2=80=99 [-Wm=
issing-prototypes]
...
---------------------------------------------------------------------------=
-----
32r2el_defconfig+kselftest (mips, gcc-10) =E2=80=94 FAIL, 8 errors, 2 warni=
...
---------------------------------------------------------------------------=
-----
allnoconfig (mips, gcc-10) =E2=80=94 FAIL, 5 errors, 1 warning, 0 section m=
ismatches
...
---------------------------------------------------------------------------=
-----
ath25_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 3 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
bcm63xx_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 3 warnings, 0 se=
ction mismatches
...
---------------------------------------------------------------------------=
-----
bigsur_defconfig (mips, gcc-10) =E2=80=94 FAIL, 6 errors, 3 warnings, 0 sec=
tion mismatches
...
or =E2=80=98bcm1480_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
    arch/mips/sibyte/bcm1480/irq.c:200:13: error: no previous prototype for=
 =E2=80=98init_bcm1480_irqs=E2=80=99 [-Werror=3Dmissing-prototypes]
    arch/mips/kernel/signal.c:438:5: error: no previous prototype for =E2=
=80=98setup_sigcontext=E2=80=99 [-Werror=3Dmissing-prototypes]
    arch/mips/kernel/signal.c:515:5: error: no previous prototype for =E2=
=80=98restore_sigcontext=E2=80=99 [-Werror=3Dmissing-prototypes]
...
---------------------------------------------------------------------------=
-----
ci20_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 3 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
cobalt_defconfig (mips, gcc-10) =E2=80=94 FAIL, 8 errors, 3 warnings, 0 sec=
tion mismatches
...
---------------------------------------------------------------------------=
-----
cu1000-neo_defconfig (mips, gcc-10) =E2=80=94 FAIL, 5 errors, 1 warning, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
db1xxx_defconfig (mips, gcc-10) =E2=80=94 FAIL, 8 errors, 3 warnings, 0 sec=
tion mismatches
...
r =E2=80=98prom_get_ethernet_addr=E2=80=99 [-Werror=3Dmissing-prototypes]
    arch/mips/alchemy/devboards/platform.c:68:12: error: no previous protot=
ype for =E2=80=98db1x_register_pcmcia_socket=E2=80=99 [-Werror=3Dmissing-pr=
ototypes]
    arch/mips/alchemy/devboards/platform.c:152:12: error: no previous proto=
type for =E2=80=98db1x_register_norflash=E2=80=99 [-Werror=3Dmissing-protot=
ypes]
    arch/mips/alchemy/devboards/db1000.c:35:12: error: no previous prototyp=
e for =E2=80=98db1000_board_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
    arch/mips/alchemy/devboards/db1000.c:93:12: error: no previous prototyp=
e for =E2=80=98db1500_pci_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
    arch/mips/alchemy/devboards/db1000.c:451:12: error: no previous prototy=
pe for =E2=80=98db1000_dev_setup=E2=80=99 [-Werror=3Dmissing-prototypes]
...
---------------------------------------------------------------------------=
-----
decstation_defconfig (mips, gcc-10) =E2=80=94 FAIL, 4 errors, 1 warning, 0 =
section mismatches
...
Errors:
    arch/arm64/kernel/vdso32/vgettimeofday.c:10:5: error: conflicting types=
 for =E2=80=98__vdso_clock_gettime=E2=80=99
    arch/arm64/kernel/vdso32/vgettimeofday.c:28:5: error: conflicting types=
 for =E2=80=98__vdso_clock_getres=E2=80=99
...
---------------------------------------------------------------------------=
-----
defconfig (arm64, clang-17) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 section=
 mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+debug (arm64, gcc-10) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 sec=
tion mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+videodec (arm64, gcc-10) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
gcw0_defconfig (mips, gcc-10) =E2=80=94 FAIL, 5 errors, 1 warning, 0 sectio=
n mismatches
...
---------------------------------------------------------------------------=
-----
gpr_defconfig (mips, gcc-10) =E2=80=94 FAIL, 10 errors, 4 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
ip22_defconfig (mips, gcc-10) =E2=80=94 FAIL, 6 errors, 2 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
ip27_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 3 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
loongson2k_defconfig (mips, gcc-10) =E2=80=94 FAIL, 5 errors, 2 warnings, 0=
 section mismatches
...
---------------------------------------------------------------------------=
-----
malta_defconfig (mips, gcc-10) =E2=80=94 FAIL, 8 errors, 4 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
maltaaprp_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 3 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
maltasmvp_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 3 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
maltaup_defconfig (mips, gcc-10) =E2=80=94 FAIL, 5 errors, 1 warning, 0 sec=
tion mismatches
...
---------------------------------------------------------------------------=
-----
maltaup_xpa_defconfig (mips, gcc-10) =E2=80=94 FAIL, 6 errors, 2 warnings, =
0 section mismatches
...
---------------------------------------------------------------------------=
-----
rb532_defconfig (mips, gcc-10) =E2=80=94 FAIL, 8 errors, 4 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
rs90_defconfig (mips, gcc-10) =E2=80=94 FAIL, 6 errors, 2 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
rt305x_defconfig (mips, gcc-10) =E2=80=94 FAIL, 7 errors, 2 warnings, 0 sec=
tion mismatches
...
no previous prototype for =E2=80=98is_no_fault_exception=E2=80=99 [-Wmissin=
g-prototypes]
    .........../arch/sparc/kernel/traps_64.c:2035:6: warning: no previous p=
...
---------------------------------------------------------------------------=
-----
tinyconfig (mips, gcc-10) =E2=80=94 FAIL, 5 errors, 1 warning, 0 section mi=
smatches
...
---------------------------------------------------------------------------=
-----
xway_defconfig (mips, gcc-10) =E2=80=94 FAIL, 6 errors, 2 warnings, 0 secti=
on mismatches
