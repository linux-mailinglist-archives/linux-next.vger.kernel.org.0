...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B15F67D47AE
	for <lists+linux-next@lfdr.de>; Tue, 24 Oct 2023 08:48:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232627AbjJXGs2 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 24 Oct 2023 02:48:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50694 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232594AbjJXGs1 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 24 Oct 2023 02:48:27 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 394C910C;
        Mon, 23 Oct 2023 23:48:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1698130100;
        bh=2iwmaN8l2cYL0/3pQC/HaNHS3pAE20DNHmvezBvqazg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SF2h433P8z4wdC;
        Tue, 24 Oct 2023 17:48:20 +1100 (AEDT)
Date:   Tue, 24 Oct 2023 17:48:18 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 24
Message-ID: <20231024174818.1137914a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/gncOLyQD=T/Svd38qpxL4.g";
...
Merging origin/master (e017769f4ce2 Merge tag 'for-6.6-rc7-tag' of git://gi=
...
Merging net/main (7798b59409c3 net/handshake: fix file ref count in handsha=
ke_nl_accept_doit())
...
-contained for ARM)
Merging arm64/for-next/core (c4f3076a2cf4 Merge branch 'for-next/lpa2-stage=
1' into for-next/core)
CONFLICT (content): Merge conflict in arch/arm64/include/asm/tlb.h
Merging arm-perf/for-next/perf (ab33c66fd8f1 perf/arm-cmn: Enable per-DTC c=
ounter allocation)
...
Merging powerpc/next (f2ec24ca5062 powerpc/vmcore: Add MMU information to v=
mcoreinfo)
...
ums)
Merging btrfs/for-next (1a4dc97c883a btrfs: make the logic from btrfs_block=
_can_be_shared() easier to read)
...
ECT_IO_ALLOW_MMAP)
Merging gfs2/for-next (ec6e8472a6a7 gfs2: No longer use 'extern' in functio=
n declarations)
...
Merging net-next/main (f4dbc2bb7a54 Merge tag 'for-net-next-2023-10-23' of =
...
tending past 'to')
Merging bluetooth/master (530886897c78 Bluetooth: hci_sync: Fix Opcode prin=
...
cy on hw_random)
Merging drm/drm-next (3f5ba636d698 Merge tag 'drm-msm-next-2023-10-17' of h=
...
- add missing escape)
Merging drm-misc/for-linux-next (f70a6691751c drm/doc: use cross-references=
 for macros)
...
et_match_data())
Merging regulator/for-next (7192afcc2eb8 Merge remote-tracking branch 'regu=
...
Merging kvm-arm/next (84d49bda6571 Merge branch kvm-arm64/stage2-vhe-load i=
nto kvmarm/next)
...
Merging driver-core/driver-core-next (2e84dc379200 driver core: Release all=
 resources during unbind before updating device links)
...
Merging tty/tty-next (936323f8de41 dt-bindings: serial: drop unsupported sa=
msung bindings)
...
upport)
Merging rust/rust-next (6a5c032c4b7e x86: Enable IBT in Rust if enabled in =
C)
...

=AToT
-----END PGP SIGNATURE-----
