...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A7D51402301
	for <lists+linux-next@lfdr.de>; Tue,  7 Sep 2021 07:40:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237100AbhIGFJJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 7 Sep 2021 01:09:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56560 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236883AbhIGFJI (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 7 Sep 2021 01:09:08 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5829DC061575;
        Mon,  6 Sep 2021 22:08:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1630991278;
        bh=eJn2kOXh1OozDfXw2NAHD5iauHRAK4GQISd/1J48ywg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4H3YDt4QsKz9sW4;
        Tue,  7 Sep 2021 15:07:58 +1000 (AEST)
Date:   Tue, 7 Sep 2021 15:07:54 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 7
Message-ID: <20210907150754.6a110237@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/J5TVghXJG__F0RHImiWZzkw";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/J5TVghXJG__F0RHImiWZzkw
...
Changes since 20210906:

The cxl tree still had its build failure.

Non-merge commits (relative to Linus' tree): 1878
 1970 files changed, 96854 insertions(+), 21557 deletions(-)
...
Merging origin/master (4b93c544e90e thunderbolt: test: split up test cases =
in tb_test_credit_alloc_all)
...
Merging net/master (b539c44df067 net: wwan: iosm: Unify IO accessors used i=
n the driver)
...
Merging driver-core.current/driver-core-linus (27151f177827 Merge tag 'perf=
-tools-for-v5.15-2021-09-04' of git://git.kernel.org/pub/scm/linux/kernel/g=
it/acme/linux)
Merging tty.current/tty-linus (49624efa65ac Merge tag 'denywrite-for-5.15' =
of git://github.com/davidhildenbrand/linux)
Merging usb.current/usb-linus (27151f177827 Merge tag 'perf-tools-for-v5.15=
-2021-09-04' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
Merging staging.current/staging-linus (27151f177827 Merge tag 'perf-tools-f=
or-v5.15-2021-09-04' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/=
linux)
...
Merging input-current/for-linus (146ea9b679c9 Input: edt-ft5x06 - added cas=
e for EDT EP0110M09)
...
Merging v4l-dvb-fixes/fixes (132c88614f2b media: cedrus: Fix SUNXI tile siz=
e calculation)
...
Merging parisc-hd/for-next (e9e7d5744de7 parisc: Drop useless debug info fr=
om signal.c)
...
or-next)
Merging net-next/master (27151f177827 Merge tag 'perf-tools-for-v5.15-2021-=
09-04' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
reset on old SDHIs)
Merging mfd/for-mfd-next (90b122d0ad16 mfd: syscon: Use of_iomap() instead =
of ioremap())
...
o)
Merging driver-core/driver-core-next (27151f177827 Merge tag 'perf-tools-fo=
r-v5.15-2021-09-04' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/l=
inux)
Merging usb/usb-next (27151f177827 Merge tag 'perf-tools-for-v5.15-2021-09-=
...
Merging staging/staging-next (27151f177827 Merge tag 'perf-tools-for-v5.15-=
2021-09-04' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...

=LNjj
-----END PGP SIGNATURE-----
