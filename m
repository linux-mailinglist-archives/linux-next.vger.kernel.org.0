...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B986736F490
	for <lists+linux-next@lfdr.de>; Fri, 30 Apr 2021 05:33:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229590AbhD3DeC (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 29 Apr 2021 23:34:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43994 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229577AbhD3DeC (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 29 Apr 2021 23:34:02 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A4A3C06138B;
        Thu, 29 Apr 2021 20:33:14 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FWdHW1BK2z9sWP;
        Fri, 30 Apr 2021 13:33:11 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1619753591;
        bh=z1WmMY1fQsbZRN05F8N8RVDud3JfPxNif+UZ8qEzZwI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 30 Apr 2021 13:33:10 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 30
Message-ID: <20210430133310.1085c5cb@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/qCE1lOI2eNzhaK+YHI6Qawy";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/qCE1lOI2eNzhaK+YHI6Qawy
...
Merging origin/master (8ca5297e7e38 Merge tag 'kconfig-v5.13' of git://git.=
...
Merging net/master (9d31d2338950 Merge tag 'net-next-5.13' of git://git.ker=
...
Merging sound-current/for-linus (2e6a731296be ALSA: hda/conexant: Re-order =
CX5066 quirk table entries)
...
vulnerability)
Merging driver-core.current/driver-core-linus (d72cd4ad4174 Merge tag 'scsi=
...
removal)
Merging char-misc.current/char-misc-linus (f1ce3986baa6 nitro_enclaves: Fix=
...
o not link ".*,nr-gpios")
Merging scsi-fixes/fixes (ce4f62f9dd8c scsi: ufs: core: Narrow down fast pa=
th in system suspend path)
...
c syscallhdr.sh)
Merging powerpc/next (525642624783 powerpc/signal32: Fix erroneous SIGSEGV =
on RT signal return)
Merging fsl/next (a76bea0287ce powerpc/kmcent2: add ranges to the pci bridg=
es)
Merging soc-fsl/next (242b0b398ccd soc: fsl: enable acpi support in RCPM dr=
iver)
Merging risc-v/for-next (ce268b2d6513 riscv: Fix 32b kernel build with CONF=
IG_DEBUG_VIRTUAL=3Dy)
...
27e2da653adb6')
Merging cifs/for-next (30475cc46fde cifs: detect dead connections only when=
 echoes are enabled.)
...
Merging nfs/linux-next (d9092b4bb210 NFSv4.2: Remove ifdef CONFIG_NFSD from=
 NFSv4.2 client SSC code.)
...
Merging v9fs/9p-next (f8b139e2f241 fs: 9p: fix v9fs_file_open writeback fid=
 error check)
Merging xfs/for-next (d4f74e162d23 xfs: fix xfs_reflink_unshare usage of fi=
lemap_write_and_wait_range)
...
in imxfb_probe())
Merging pm/linux-next (eebece9da63e Merge branches 'acpi-misc' and 'acpi-do=
cs' into linux-next)
...
fore using it)
Merging amdgpu/drm-next (85021fe9d800 drm/amdgpu/display: fix dal_allocatio=
n documentation)
...
Merging sound/for-next (2e6a731296be ALSA: hda/conexant: Re-order CX5066 qu=
irk table entries)
...
Merging block/for-next (58e591b40efc Merge branch 'io_uring-5.13' into for-=
next)
...
Merging driver-core/driver-core-next (d72cd4ad4174 Merge tag 'scsi-misc' of=
...
Merging akpm/master (014a8f74eb35 memfd_secret: use unsigned int rather tha=
...

=E1ta
-----END PGP SIGNATURE-----
