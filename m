...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0919E3F2912
	for <lists+linux-next@lfdr.de>; Fri, 20 Aug 2021 11:26:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232991AbhHTJ1D (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 20 Aug 2021 05:27:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49078 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234754AbhHTJ1C (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 20 Aug 2021 05:27:02 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D6BD9C061575;
        Fri, 20 Aug 2021 02:26:19 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GrbqD25Q8z9sWw;
        Fri, 20 Aug 2021 19:26:16 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1629451576;
        bh=JlRXspJQ8S4SCsRZTrCSaRgK7fRSG52EpRPkbU30ZLw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 20 Aug 2021 19:26:15 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 20
Message-ID: <20210820192615.23e2e617@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/9Pft8LSZCJ2G+J8L6gC7czR";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/9Pft8LSZCJ2G+J8L6gC7czR
...
The drm tree gained a semantic conflict against the kbuild tree.
...
The driver-core tree gained a conflict against the pci-current tree.

Non-merge commits (relative to Linus' tree): 8514
 8252 files changed, 481311 insertions(+), 196532 deletions(-)
...
Merging origin/master (f87d64319e6f Merge tag 'net-5.14-rc7' of git://git.k=
...
ATA_PLATFORM)
Merging powerpc-fixes/fixes (9f7853d7609d powerpc/mm: Fix set_memory_*() ag=
ainst concurrent accesses)
...
Merging net/master (f87d64319e6f Merge tag 'net-5.14-rc7' of git://git.kern=
...
Merging rdma-fixes/for-rc (17f2569dce18 RDMA/bnxt_re: Add missing spin lock=
 initialization)
Merging sound-current/for-linus (65ca89c2b12c ASoC: intel: atom: Fix breaka=
ge for PCM buffer address setup)
Merging sound-asoc-fixes/for-linus (70212c4c657f Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (80b3a9808557 Merge remote-tracking branch 'spi=
...
ntrol driver)
Merging rockchip/for-next (abfe14de9197 Merge branch 'v5.15-armsoc/drivers'=
 into for-next)
...
unc)
Merging gfs2/for-next (98fd6514d37b gfs2: Remove redundant check from gfs2_=
glock_dq)
...
encode_getaclres)
Merging cel/for-next (729580ddc53e svcrdma: xpt_bc_xprt is already clear in=
 __svc_rdma_free())
...
or_each_entry)
Merging xfs/for-next (a437b9b488e3 xfs: remove support for untagged lookups=
 in xfs_icwalk*)
...
terface for uverbs)
Merging net-next/master (9e5f10fe577b octeontx2-af: remove redudant second =
error check on variable err)
...
tifier support (v2))
Merging drm-intel/for-linux-next (c00e14cd4d3f drm/i915/adl_p: Also disable=
 underrun recovery with MSO)
...
Merging sound-asoc/for-next (dc392f00eb58 Merge remote-tracking branch 'aso=
...
Merging block/for-next (39916d4054e7 Merge branch 'for-5.15/io_uring' into =
for-next)
...
tead of pr_err())
Merging iommu/next (cf1f65a86d45 Merge branches 'apple/dart', 'arm/smmu', '=
...
Merging spi/for-next (5d14499b5016 Merge remote-tracking branch 'spi/for-5.=
15' into spi-next)
...
.h
Merging clockevents/timers/drivers/next (631c7c0df0ef dt-bindings: timer: A=
...
Merging ftrace/for-next (db396be6ddc4 MAINTAINERS: Add an entry for os nois=
e/latency)
CONFLICT (content): Merge conflict in MAINTAINERS
...
Merging kvm/next (5a4bfabcc865 KVM: SVM: Add 5-level page table support for=
 SVM)
Merging kvm-arm/next (f2267b87ecd5 Merge branch kvm-arm64/misc-5.15 into kv=
marm-master/next)
...
COLOR)
Merging drivers-x86/for-next (c58259bc83a2 asus-wmi: Add support for platfo=
rm_profile)
$ git reset --hard HEAD^
Merging next-20210819 version of drivers-x86
...
de)
Merging phy-next/next (34633219b894 phy: qmp: Provide unique clock names fo=
r DP clocks)
...
Merging akpm-current/current (2832d098abfd ipc: replace costly bailout chec=
...
Merging akpm/master (652afd45cf13 arch: remove compat_alloc_user_space)
...

=HFVC
-----END PGP SIGNATURE-----
