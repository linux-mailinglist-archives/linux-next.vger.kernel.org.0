...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CC84E44A5FD
	for <lists+linux-next@lfdr.de>; Tue,  9 Nov 2021 06:00:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231336AbhKIFCv (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 9 Nov 2021 00:02:51 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40788 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230238AbhKIFCu (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 9 Nov 2021 00:02:50 -0500
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9B544C061764
        for <linux-next@vger.kernel.org>; Mon,  8 Nov 2021 21:00:04 -0800 (PST)
Received: by mail-pg1-x529.google.com with SMTP id p8so16035921pgh.11
        for <linux-next@vger.kernel.org>; Mon, 08 Nov 2021 21:00:04 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=1WPcLzF0/4JFkd2TpYBtIUfNuV6XHaq0ZBKNhqTcbvQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1WPcLzF0/4JFkd2TpYBtIUfNuV6XHaq0ZBKNhqTcbvQ=;
        b=
X-Gm-Message-State: AOAM533QCyk7T1j5vK5FlD8SWQmcugRTfntJTEtIYfPDslRFlYN4+jMe
        BEOLAmsDlk/qvXrHB0M4Xa/hpqCDWn+wM4aN
X-Google-Smtp-Source: ABdhPJxWggaB4mVuYDYvquNtmFkNj9+tiF2yYRG1APCY70q95WJbmNx+/jGGZxje0i3fp7vXKSLZUw==
X-Received: by 2002:a63:f044:: with SMTP id s4mr3801800pgj.301.1636434001049;
        Mon, 08 Nov 2021 21:00:01 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id h128sm477895pfg.212.2021.11.08.21.00.00
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 08 Nov 2021 21:00:00 -0800 (PST)
Message-ID: <618a0050.1c69fb81.ea193.1d47@mx.google.com>
Date:   Mon, 08 Nov 2021 21:00:00 -0800 (PST)
...
Subject: next/master build: 226 builds: 19 failed, 207 passed, 323 errors,
 246 warnings (next-20211109)
...
next/master build: 226 builds: 19 failed, 207 passed, 323 errors, 246 warni=
ngs (next-20211109)
...
mips:
    ...
    gpr_defconfig (gcc-10): 4 warnings
    ip22_defconfig (gcc-10): 4 warnings
    ip32_defconfig (gcc-10): 6 warnings
    jazz_defconfig (gcc-10): 4 warnings
    ...
    malta_defconfig (gcc-10): 4 warnings
    malta_kvm_defconfig (gcc-10): 4 warnings
...
od'
    1    fs/udf/dir.c:78:18: error: cast from pointer to integer of differe=
nt size [-Werror=3Dpointer-to-int-cast]
    1    fs/udf/dir.c:211:23: error: cast to pointer from integer of differ=
...
6k' [-Wunused-command-line-argument]
    18   fs/udf/dir.c:78:18: warning: cast from pointer to integer of diffe=
rent size [-Wpointer-to-int-cast]
    18   fs/udf/dir.c:211:23: warning: cast to pointer from integer of diff=
...
Errors:
    fs/udf/dir.c:78:18: error: cast from pointer to integer of different si=
ze [-Werror=3Dpointer-to-int-cast]
    fs/udf/dir.c:211:23: error: cast to pointer from integer of different s=
ize [-Werror=3Dint-to-pointer-cast]
...
Warnings:
    fs/udf/dir.c:78:18: warning: cast from pointer to integer of different =
size [-Wpointer-to-int-cast]
    fs/udf/dir.c:211:23: warning: cast to pointer from integer of different=
...
---------------------------------------------------------------------------=
-----
gpr_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, 0 sectio=
n mismatches
...
---------------------------------------------------------------------------=
-----
ip22_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
jazz_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, 0 secti=
on mismatches
...
---------------------------------------------------------------------------=
-----
malta_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
malta_kvm_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
maltaup_xpa_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, =
0 section mismatches
...
---------------------------------------------------------------------------=
-----
pic32mzda_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 4 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
rm200_defconfig (mips, gcc-10) =E2=80=94 PASS, 0 errors, 5 warnings, 0 sect=
ion mismatches
