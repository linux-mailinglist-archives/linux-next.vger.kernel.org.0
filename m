...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CCAB930EF73
	for <lists+linux-next@lfdr.de>; Thu,  4 Feb 2021 10:17:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234627AbhBDJQG (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 4 Feb 2021 04:16:06 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:41651 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235181AbhBDJOq (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 4 Feb 2021 04:14:46 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DWXsy4YHVz9sWF;
        Thu,  4 Feb 2021 20:13:58 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1612430038;
        bh=qwFn681RrbJPyKGZfYiTdVr02f0pG642YZjIpc9pADs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 4 Feb 2021 20:13:55 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 4
Message-ID: <20210204201355.5d158366@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/oB8gd4YOdEo2a0ke0U2OjQf";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/oB8gd4YOdEo2a0ke0U2OjQf
...
Non-merge commits (relative to Linus' tree): 7615
 7960 files changed, 298401 insertions(+), 226420 deletions(-)
...
Merging origin/master (61556703b610 Merge tag 'for-linus-5.11-rc7' of git:/=
...
Merging net/master (3aaf0a27ffc2 Merge tag 'clang-format-for-linux-v5.11-rc=
7' of git://github.com/ojeda/linux)
...
D in the ALC886)
Merging sound-asoc-fixes/for-linus (c5ea12b798b0 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (04aa85475c4c Merge remote-tracking branch 'spi=
...
Merging kvm-fixes/master (943dea8af21b KVM: x86: Update emulator context mo=
de if SYSENTER xfers to 64-bit mode)
...
s with NVMe traffic)
Merging drm-fixes/drm-fixes (f295c8cfec83 drm/nouveau: fix dma syncing warn=
ing with debugging on.)
...
PORT directly)
Merging mips/mips-next (a056aacd2df2 arch: mips: kernel: Fix two spelling i=
n smp.c)
...
Merging btrfs/for-next (43478dc637a8 Merge branch 'for-next-next-v5.11-2021=
0203' into for-next-20210203)
Merging ceph/master (9d5ae6f3c50a libceph: fix "Boolean result is used in b=
itwise operation" warning)
Merging cifs/for-next (18431ec12dda smb3: negotiate current dialect (SMB3.1=
...
Merging net-next/master (2d912da016a7 Merge branch 'net-use-indirect_call-i=
n-some-dst_ops')
$ git reset --hard HEAD^
Merging next-20210203 version of net-next
Merging bpf-next/for-next (5f10c1aac8b2 libbpf: Stop using feature-detectio=
n Makefiles)
...
Merging bluetooth/master (a297f565f299 Bluetooth: btusb: Fix typo and corre=
ct the log print)
...
Merging drm-misc/for-linux-next (b91907a62411 drm/qxl: do not run release i=
f qxl failed to init)
...
Merging sound/for-next (3c4ab49ec59b ALSA: core: Fix the debugfs removal at=
 snd_card_free())
Merging sound-asoc/for-next (2557c711b87c Merge remote-tracking branch 'aso=
...
er)
Merging spi/for-next (590788929d50 Merge remote-tracking branch 'spi/for-5.=
12' into spi-next)
...
tion name)
Merging drivers-x86/for-next (60accc011af0 platform/x86/intel-uncore-freq: =
...
Merging usb/usb-next (64eaa0fa66ac platform/chrome: cros_ec_typec: Fix call=
 to typec_partner_set_pd_revision)
...
Merging akpm/master (de9f5447ceb9 secretmem: test: add basic selftest for m=
emfd_secret(2))
...

=tK5z
-----END PGP SIGNATURE-----
