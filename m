...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 78DEB27F696
	for <lists+linux-next@lfdr.de>; Thu,  1 Oct 2020 02:20:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731631AbgJAAUG (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 30 Sep 2020 20:20:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40034 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730268AbgJAAUG (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 30 Sep 2020 20:20:06 -0400
Received: from mail-pj1-x102a.google.com (mail-pj1-x102a.google.com [IPv6:2607:f8b0:4864:20::102a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 66B10C061755
        for <linux-next@vger.kernel.org>; Wed, 30 Sep 2020 17:20:04 -0700 (PDT)
Received: by mail-pj1-x102a.google.com with SMTP id kk9so838769pjb.2
        for <linux-next@vger.kernel.org>; Wed, 30 Sep 2020 17:20:04 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=Z4tDpTgAjqV7pRRxBeM0fiUaa880Hj+YbvuKwfYo564=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Z4tDpTgAjqV7pRRxBeM0fiUaa880Hj+YbvuKwfYo564=;
        b=
X-Gm-Message-State: AOAM532PvOIvFpVmYdVtkJLRlVGuym6S1YPoUimOiBqsmQw2mNZF5rr1
        el2szIvg8FM7bnbMwF5KuykygrLar1wlQg==
X-Google-Smtp-Source: ABdhPJxxPDe2EoKmXCf9TFpl4ZuLCFzx9Jw3X1aSGYhEr7uLMbqk4XjyczSU+wjCb2IFx/G4fZhjtA==
X-Received: by 2002:a17:90a:d504:: with SMTP id t4mr4489937pju.161.1601511601009;
        Wed, 30 Sep 2020 17:20:01 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id h8sm3901235pfk.19.2020.09.30.17.19.59
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 30 Sep 2020 17:19:59 -0700 (PDT)
Message-ID: <5f7520af.1c69fb81.13db5.8512@mx.google.com>
Date:   Wed, 30 Sep 2020 17:19:59 -0700 (PDT)
...
Subject: next/pending-fixes build: 212 builds: 1 failed, 211 passed, 710 errors,
 294 warnings (v5.9-rc7-297-gd069a655f589)
...
next/pending-fixes build: 212 builds: 1 failed, 211 passed, 710 errors, 294=
 warnings (v5.9-rc7-297-gd069a655f589)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.9-rc7-297-gd069a655f589/

Tree: next
Branch: pending-fixes
Git Describe: v5.9-rc7-297-gd069a655f589
Git Commit: d069a655f5891c241683eca4c45aad9f977ed5f0
...
Errors summary:
    ...
    143  /usr/include/features.h:424:12: fatal error: sys/cdefs.h: No such =
file or directory
    133  /scratch/linux/tools/testing/selftests/kselftest_harness.h:56:10: =
fatal error: asm/types.h: No such file or directory
    28   /usr/include/stdio.h:27:10: fatal error: bits/libc-header-start.h:=
...
r directory
    4    /usr/include/stdlib.h:25:10: fatal error: bits/libc-header-start.h=
: No such file or directory
    4    /bin/sh: 1: /root/build/kselftest/bpf/tools/sbin/bpftool: Exec for=
mat error
    4    ../../../include/uapi/linux/fcntl.h:5:10: fatal error: asm/fcntl.h=
: No such file or directory
    3    test_execve.c:4:10: fatal error: cap-ng.h: No such file or directo=
ry
...
ry
    ...
    3    get_size.c:29:10: fatal error: sys/sysinfo.h: No such file or dire=
ctory
    3    execveat.c:11:10: fatal error: sys/sendfile.h: No such file or dir=
ectory
    2    seccomp_bpf.c:9:10: fatal error: sys/types.h: No such file or dire=
ctory
 ...
 or directory
    2    posix_timers.c:10:10: fatal error: sys/time.h: No such file or dir=
ectory
...
tory
    2    kselftest_harness.h:56:10: fatal error: asm/types.h: No such file =
or directory
    2    helpers.c:12:10: fatal error: syscall.h: No such file or directory
    2    /usr/include/syscall.h:1:10: fatal error: sys/syscall.h: No such f=
ile or directory
    2    /usr/include/poll.h:1:10: fatal error: sys/poll.h: No such file or=
 directory
    2    /usr/include/linux/ioctl.h:5:10: fatal error: asm/ioctl.h: No such=
 file or directory
...
e =E2=80=98DIR=E2=80=99
    1    ../kselftest_harness.h:56:10: fatal error: asm/types.h: No such fi=
le or directory
...
Warnings summary:
    ...
    16   cc1: warning: -fsanitize=3Daddress not supported for this target
...
=99? [-Wimplicit-function-declaration]
    1    /tmp/ccn01u9a.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccn01u9a.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccn01u9a.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccn01u9a.s:18192: Warning: using r15 results in unpredictable beha=
viour
