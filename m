...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4443C97557
	for <lists+linux-next@lfdr.de>; Wed, 21 Aug 2019 10:51:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726388AbfHUIuF (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 21 Aug 2019 04:50:05 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:33633 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726386AbfHUIuE (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 21 Aug 2019 04:50:04 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46D1ZF6DkRz9sBp;
        Wed, 21 Aug 2019 18:49:57 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1566377397;
        bh=0EZ6Xwz7KoJYQecXylWbJ5Zkrr8/PW/eBzhhvHGLZtk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 21 Aug 2019 18:49:56 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 21
Message-ID: <20190821184956.49e828e8@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/nYfQhuTd6h=93Xs5RNqnCYS";
...
The integrity tree gained a conflict against the security tree.

The iommu tree gained a conflict against the drm-misc tree.

The irqchip tree gained a conflict against the pci tree.

The gpio tree gained a conflict against the irqchip tree.

The pinctrl tree gained a build failure so I used the version from
next-20190820.

I remerged the kspp-gustavo tree to get more warning suppressing patches.

The akpm-current tree gained a conflict against the dma-mapping tree.

Non-merge commits (relative to Linus' tree): 7159
 7649 files changed, 376796 insertions(+), 224132 deletions(-)
...
Merging origin/master (15d90b242290 Merge branch 'for-linus' of git://git.k=
...
Merging net/master (a1c4cd67840e net: fix __ip_mc_inc_group usage)
Merging bpf/master (fb89c39455e4 xdp: unpin xdp umem pages in error path)
...
Merging sound-current/for-linus (2ca371d84751 ALSA: hda/ca0132 - Add new SB=
Z quirk)
Merging sound-asoc-fixes/for-linus (aae1aa00ef3e Merge branch 'asoc-5.3' in=
to asoc-linus)
...
Merging kspp-gustavo/for-next/kspp (4af02934b8dc watchdog: wdt285: Mark exp=
ected switch fall-through)
...
Merging dma-mapping/for-next (936376f88ff1 arm: select the dma-noncoherent =
symbols for all swiotlb builds)
...
Merging csky/linux-next (c7e6f0e99227 csky: Support kernel non-aligned acce=
ss)
...
olicy version)
Merging afs/afs-next (183c0f68b9f7 afs: Use afs_extract_discard() rather th=
an iov_iter_discard())
...
Merging net-next/master (ac2eb56e7504 Merge branch '100GbE' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/jkirsher/next-queue)
CONFLICT (content): Merge conflict in scripts/link-vmlinux.sh
Merging bpf-next/master (51746f94865a Merge branch 'btf_get_next_id')
Merging ipsec-next/master (c7b37c769d2a xfrm: remove get_mtu indirection fr=
om xfrm_type)
Merging mlx5-next/mlx5-next (1eba383f4e36 net/mlx5: Add lag_tx_port_affinit=
y capability bit)
...
ent to variable ret)
Merging spi-nor/spi-nor/next (e7023898034e mtd: spi-nor : Remove SPI_NOR_HA=
S_TB flag on s25fl512s)
...
v.c
Merging drm-intel/for-linux-next (4eaceea3a00f drm/i915: Fix DP-MST crtc_ma=
sk)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (343bbb1a7f88 dt-bindings: display: rockchi=
p: update DSI controller)
...
Merging sound-asoc/for-next (71e1e248d18d Merge branch 'asoc-5.4' into asoc=
-next)
...
Merging devicetree/for-next (ece644858c25 dt-bindings: arm: Add kryo485 com=
patible)
...
Merging ipmi/for-next (a168e444d854 ipmi: move message error checking to av=
oid deadlock)
...
Merging pinctrl/for-next (2295f64645cb pinctrl: rk805: Make structures cons=
tant)
$ git reset --hard HEAD^
Merging next-20190820 version of pinctrl
...
Merging rtc/rtc-next (3e2398146a59 rtc: rv3029: revert error handling patch=
...
K dependency)
Merging hmm/hmm (8402ce61bec2 mm/mmu_notifiers: check if mmu notifier callb=
...
rflow
Merging akpm/master (1509990fd7db drivers/media/platform/sti/delta/delta-ip=
...

=x1km
-----END PGP SIGNATURE-----
