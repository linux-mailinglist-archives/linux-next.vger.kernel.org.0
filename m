...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6D96A7AFAC8
	for <lists+linux-next@lfdr.de>; Wed, 27 Sep 2023 08:12:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229550AbjI0GMH (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 27 Sep 2023 02:12:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41134 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229504AbjI0GME (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 27 Sep 2023 02:12:04 -0400
Received: from mail-qk1-x734.google.com (mail-qk1-x734.google.com [IPv6:2607:f8b0:4864:20::734])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5418911D
        for <linux-next@vger.kernel.org>; Tue, 26 Sep 2023 23:11:59 -0700 (PDT)
Received: by mail-qk1-x734.google.com with SMTP id af79cd13be357-77574dec71bso30510885a.2
        for <linux-next@vger.kernel.org>; Tue, 26 Sep 2023 23:11:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1695795118; x=1696399918; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=eSwp48+PLp7Oa4yA62re6XJiwS/YlRc7LCdbbVytNVA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1695795118; x=1696399918;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=eSwp48+PLp7Oa4yA62re6XJiwS/YlRc7LCdbbVytNVA=;
        b=
X-Gm-Message-State: AOJu0YxJ1CiVbDSMlGqHjUABvkZwmqOrKTySKF2oyHFx+B215kj0KXC7
        kL2rjocWSxoMWmZMlbGp80kEHM4mn11p7W0yyTpKsw==
X-Google-Smtp-Source: AGHT+IFOf7sKOjZF84Jis1dD0viR+56YKRHqXn/cFpdvXqQYMB7pvhNpGraje80FnnOeBqCmYpVDzg==
X-Received: by 2002:a05:620a:25c6:b0:76e:f804:1532 with SMTP id y6-20020a05620a25c600b0076ef8041532mr1136960qko.33.1695795117742;
        Tue, 26 Sep 2023 23:11:57 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id ff11-20020a056a002f4b00b006879493aca0sm10914241pfb.26.2023.09.26.23.11.56
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 26 Sep 2023 23:11:57 -0700 (PDT)
Message-ID: <6513c7ad.050a0220.bf83b.dc5e@mx.google.com>
Date:   Tue, 26 Sep 2023 23:11:57 -0700 (PDT)
...
Subject: next/master build: 182 builds: 15 failed, 167 passed, 29 errors,
 16 warnings (next-20230927)
...
next/master build: 182 builds: 15 failed, 167 passed, 29 errors, 16 warning=
s (next-20230927)
...
nce to `crypto_has_aead'
    ...
    1    fs/proc/task_mmu.c:2105:3: error: implicit declaration of function=
 'pagemap_scan_backout_range'; did you mean 'pagemap_scan_push_range'? [-We=
...
n this function); did you mean 'PAGE_SIZE'?
    fs/proc/task_mmu.c:2105:3: error: implicit declaration of function 'pag=
emap_scan_backout_range'; did you mean 'pagemap_scan_push_range'? [-Werror=
