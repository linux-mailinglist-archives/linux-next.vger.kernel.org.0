...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 52D7C262151
	for <lists+linux-next@lfdr.de>; Tue,  8 Sep 2020 22:48:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729305AbgIHUsJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 8 Sep 2020 16:48:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43936 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728631AbgIHUsD (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 8 Sep 2020 16:48:03 -0400
Received: from mail-pf1-x436.google.com (mail-pf1-x436.google.com [IPv6:2607:f8b0:4864:20::436])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B27BDC061573
        for <linux-next@vger.kernel.org>; Tue,  8 Sep 2020 13:48:02 -0700 (PDT)
Received: by mail-pf1-x436.google.com with SMTP id n14so158913pff.6
        for <linux-next@vger.kernel.org>; Tue, 08 Sep 2020 13:48:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=z6WsHUGqkGJdPDgUJwAKcaxI+K6GctYNWWG5SD2H57M=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=z6WsHUGqkGJdPDgUJwAKcaxI+K6GctYNWWG5SD2H57M=;
        b=
X-Gm-Message-State: AOAM532QMCGDuSvaMM4rLi2MSHCEYhdXV8/irStR38xDFxhdaFpbqN7h
        pG9Ce12oAcz3qHyuHG34TJyMjtFLuxsvzQ==
X-Google-Smtp-Source: ABdhPJzapLp0UGFCGN656AfCBqjWWmTkINET7kL/82W10qlkVDOlSd065J0mN+i29duOVLtNF7Wnxw==
X-Received: by 2002:a63:7845:: with SMTP id t66mr456222pgc.60.1599598079702;
        Tue, 08 Sep 2020 13:47:59 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id j6sm286641pfi.129.2020.09.08.13.47.58
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 08 Sep 2020 13:47:58 -0700 (PDT)
Message-ID: <5f57edfe.1c69fb81.4c3c8.10a8@mx.google.com>
Date:   Tue, 08 Sep 2020 13:47:58 -0700 (PDT)
...
Subject: next/pending-fixes build: 213 builds: 0 failed, 213 passed,
 1438 errors, 244 warnings (v5.9-rc4-284-g72e0a6a27fe8)
...
next/pending-fixes build: 213 builds: 0 failed, 213 passed, 1438 errors, 24=
4 warnings (v5.9-rc4-284-g72e0a6a27fe8)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.9-rc4-284-g72e0a6a27fe8/

Tree: next
Branch: pending-fixes
Git Describe: v5.9-rc4-284-g72e0a6a27fe8
Git Commit: 72e0a6a27fe84b976bceb5f3a2898eb64b52cc81
...
gs
    ...
    multi_v7_defconfig+kselftest (gcc-8): 280 errors, 7 warnings
...
mips:
    32r2el_defconfig+kselftest (gcc-8): 280 errors, 21 warnings
...
x86_64:
    ...
    x86_64_defconfig+kselftest (gcc-8): 71 errors, 40 warnings
...
Warnings summary:
    ...
    21   /scratch/linux/include/linux/kern_levels.h:5:18: warning: format =
=E2=80=98%s=E2=80=99 expects a matching =E2=80=98char *=E2=80=99 argument [=
-Wformat=3D]
...
Wimplicit-function-declaration]
    1    /tmp/cccdDTQP.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/cccdDTQP.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
---------------------------------------------------------------------------=
-----
32r2el_defconfig+kselftest (mips, gcc-8) =E2=80=94 PASS, 280 errors, 21 war=
...
=98%s=E2=80=99 expects a matching =E2=80=98char *=E2=80=99 argument [-Wform=
at=3D]
    /scratch/linux/include/linux/kern_levels.h:5:18: warning: format =E2=80=
=98%s=E2=80=99 expects a matching =E2=80=98char *=E2=80=99 argument [-Wform=
at=3D]
...
=98%s=E2=80=99 expects a matching =E2=80=98char *=E2=80=99 argument [-Wform=
at=3D]
    /tmp/cccdDTQP.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/cccdDTQP.s:18192: Warning: using r15 results in unpredictable beha=
viour
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+kselftest (arm, gcc-8) =E2=80=94 PASS, 280 errors, 7 war=
nings, 0 section mismatches
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig+kselftest (x86_64, gcc-8) =E2=80=94 PASS, 71 errors, 40 wa=
