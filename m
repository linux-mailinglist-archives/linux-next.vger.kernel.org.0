...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B747918C9F4
	for <lists+linux-next@lfdr.de>; Fri, 20 Mar 2020 10:15:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727194AbgCTJPr (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 20 Mar 2020 05:15:47 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:50845 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727133AbgCTJPr (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 20 Mar 2020 05:15:47 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48kJ651Myvz9sSR;
        Fri, 20 Mar 2020 20:15:41 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1584695741;
        bh=LN4L8I+D6L+J/R7nxKI0qvURLHarLbGRXXVoiqdRbXg=;
        h=Date:From:To:Cc:Subject:From;
        b=
...
Message-ID: <20200320201539.3a3a8640@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/.H1aXs48KZH2A4JQs5rL7.s";
...
Merging origin/master (6c90b86a745a Merge tag 'mmc-v5.6-rc6' of git://git.k=
...
ux into arm/fixes)
Merging arm64-fixes/for-next/fixes (3568b88944fe arm64: compat: Fix syscall=
 number of compat_clock_getres)
...
licy check fails)
Merging netfilter/master (2de9780f7507 net: core: dev.c: fix a documentatio=
n warning)
...
Merging sound-asoc-fixes/for-linus (8ec52a654dc5 Merge branch 'asoc-5.6' in=
to asoc-linus)
...
Merging drm-fixes/drm-fixes (0f08b3156d28 Merge tag 'drm-misc-fixes-2020-03=
-18-1' of git://anongit.freedesktop.org/drm/drm-misc into drm-fixes)
...
t)
Merging arm64/for-next/core (d28a26aafd88 Merge branch 'for-next/bti' into =
for-next/core)
...
Merging hid/for-next (0503b5ad9d95 Merge branch 'for-5.7/glorious' into for=
-next)
...
Merging jc_docs/docs-next (58ad30cf91f0 docs: fix reference to core-api/nam=
espaces.rst)
...
Merging net-next/master (79e28519ac78 Merge tag 'mlx5-updates-2020-03-17' o=
...
etdev.c
Merging bpf-next/master (90ceddcb4950 bpf: Support llvm-objcopy for vmlinux=
 BTF)
...
Merging netfilter-next/master (a58741ef1e4a Merge git://git.kernel.org/pub/=
...
ifi/iwlwifi-next)
Merging bluetooth/master (ba7c1b47c11b Bluetooth: Do not cancel advertising=
...
Merging crypto/master (0eae14a067c5 crypto: ccree - refactor AEAD IV in AAD=
 handling)
Merging drm/drm-next (7c2cb99fe7d5 Merge tag 'exynos-drm-next-for-v5.7' of =
...
Merging amdgpu/drm-next (c0a1d6472f7d drm/amdgpu/display: fix logic inversi=
on in program_timing_sync())
Merging drm-intel/for-linux-next (8e37d6991391 drm/i915/gt: Cancel a hung c=
ontext if already closed)
...
Merging drm-msm/msm-next (00d9220ec5ed dt-bindings: display: msm: gmu: move=
 sram property to gpu bindings)
...
Merging sound-asoc/for-next (b086451a49c7 Merge branch 'asoc-5.7' into asoc=
-next)
...
Merging block/for-next (1657042abe4e Merge branch 'for-5.7/block' into for-=
next)
...
Merging driver-core/driver-core-next (99917e37b9e7 Revert "drivers: base: p=
ower: wakeup.c: Use built-in RCU list checking")
Merging usb/usb-next (ca9e742b5c27 USB: c67x00: Use the correct style for S=
...
Merging char-misc/char-misc-next (8f522bae2394 MAINTAINERS: Add entry for M=
HI bus)
Merging extcon/extcon-next (acfa505ca1c3 extcon: Mark extcon_get_edev_name(=
) function as exported symbol)
Merging soundwire/next (b468a785bd3e soundwire: cadence: clear FIFO to avoi=
d pop noise issue on playback start)
Merging thunderbolt/next (3010518964dc thunderbolt: Use scnprintf() for avo=
iding potential buffer overflow)
Merging staging/staging-next (281d90e24f13 Merge tag 'iio-5.7a' of git://gi=
t.kernel.org/pub/scm/linux/kernel/git/jic23/iio into staging-next)
...
Merging hmm/hmm (ede58c05bec9 mm: merge hmm_vma_do_fault into into hmm_vma_=
walk_hole_)
...
rflow
Merging akpm/master (521a6bed853b drivers/media/platform/sti/delta/delta-ip=
...

=I4Df
-----END PGP SIGNATURE-----
