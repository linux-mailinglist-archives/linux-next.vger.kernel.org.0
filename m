...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C29B89AB4C
	for <lists+linux-next@lfdr.de>; Fri, 23 Aug 2019 11:27:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727388AbfHWJ1N (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 23 Aug 2019 05:27:13 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:42103 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727382AbfHWJ1N (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 23 Aug 2019 05:27:13 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46FGJ746tyz9sNk;
        Fri, 23 Aug 2019 19:27:03 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1566552423;
        bh=MzToIVdhhjVZ2IwsQ3IQuAdUHEaUp8HgKuraye6jWCg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 23 Aug 2019 19:26:58 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 23
Message-ID: <20190823192658.49e6f68d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/zlbUYz74=LkBZyM4g2Qv0Bz";
...
Non-merge commits (relative to Linus' tree): 7895
 8174 files changed, 397940 insertions(+), 232328 deletions(-)
...
Merging origin/master (59c36bc8d377 Merge tag 'pci-v5.3-fixes-1' of git://g=
...
Merging net/master (cc07db5a5b10 gve: Copy and paste bug in gve_get_stats())
...
Merging rdma-fixes/for-rc (2323d7baab2b infiniband: hfi1: fix memory leaks)
Merging sound-current/for-linus (f9f0e9ed350e ALSA: usb-audio: Check mixer =
unit bitmap yet more strictly)
Merging sound-asoc-fixes/for-linus (539dc6dc322b Merge branch 'asoc-5.3' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (c85faac995d4 Merge branch 'spi-5.3' into spi-l=
inus)
...
Merging drm-fixes/drm-fixes (1e85e6cad2d1 Merge tag 'drm-fixes-5.3-2019-08-=
21' of git://people.freedesktop.org/~agd5f/linux into drm-fixes)
Merging amdgpu-fixes/drm-fixes (ec6e491353b9 drm/amd/display: Calculate bpc=
 based on max_requested_bpc)
...
Merging arm64/for-next/core (239ab658bea3 Merge branches 'for-next/error-in=
...
Merging sunxi/sunxi/for-next (59d3b0d0bb04 Merge remote-tracking branch 'ko=
rg/sunxi/sunxi/fixes-for-5.3' into sunxi/for-next)
...
v5.3-rc2)
Merging m68knommu/for-next (25585842f0ab m68k: coldfire: Include the GPIO d=
river header)
...
d sysfs directories"
Merging ceph/master (a561372405cf libceph: fix PG split vs OSD (re)connect =
race)
...
ion)
Merging nfs/linux-next (a5f91c561825 SUNRPC: Handle connection breakages co=
rrectly in call_status())
...
Merging hid/for-next (f92fe6c5456c Merge branch 'for-5.4/multitouch' into f=
or-next)
...
in imxfb_probe())
Merging pm/linux-next (b73c9c0c8b67 Merge branch 'pm-s2idle-rework' into li=
nux-next)
Merging cpufreq-arm/cpufreq/arm/linux-next (793d1adff3b7 Merge branch 'cpuf=
...
Merging rdma/for-next (b2299e83815c RDMA: Delete DEBUG code)
CONFLICT (content): Merge conflict in drivers/infiniband/hw/mlx5/mlx5_ib.h
Merging net-next/master (399e06a517b6 ethernet: Delete unnecessary checks b=
efore the macro call =E2=80=9Cdev_kfree_skb=E2=80=9D)
...
Merging drm/drm-next (ae4530062620 Merge branch 'etnaviv/next' of https://g=
...
.h
Merging amdgpu/drm-next (edda99f5e4e7 drm/amdgpu/display: add flag for mult=
i-display mclk switching)
...
v.c
Merging drm-intel/for-linux-next (d4c61c4a16de drm/i915/dp: Fix DSC enable =
code to use cpu_transcoder instead of encoder->type)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (0a9a4b611a03 drm/panfrost: Fix sleeping wh=
ile atomic in panfrost_gem_open)
...
-next)
Merging sound/for-next (744f51e86346 Merge branch 'topic/usb-validation' in=
to for-next)
Merging sound-asoc/for-next (3993f980afb3 Merge branch 'asoc-5.4' into asoc=
-next)
...
vices)
Merging block/for-next (41ec294c808a Merge branch 'for-5.4/block' into for-=
next)
Merging device-mapper/for-next (691fdcbe82ea dm verity: add root hash pkcs#=
...
Merging spi/for-next (31fa8a7c09f9 Merge branch 'spi-5.4' into spi-next)
...
Merging usb/usb-next (bd5defaee872 dma-mapping: remove is_device_dma_capabl=
e)
...
Merging phy-next/next (24673db15999 phy-rockchip-inno-hdmi: Fix RK3328_TERM=
_RESISTOR_CALIB_SPEED_7_0's third value)
...
Merging thunderbolt/next (04f7745300ed thunderbolt: Show key using %*pE not=
 %*pEp)
Merging staging/staging-next (f401441deda6 staging: rtl8192u: fix spacing i=
n ieee80211)
...
k)
Merging rtc/rtc-next (df837779ae2f rtc: pcf2127: add tamper detection suppo=
rt)
...
rflow
Merging akpm/master (6cec62711202 drivers/media/platform/sti/delta/delta-ip=
...

=4uQu
-----END PGP SIGNATURE-----
