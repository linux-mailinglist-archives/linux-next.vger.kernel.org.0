...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5A0E0462DE1
	for <lists+linux-next@lfdr.de>; Tue, 30 Nov 2021 08:51:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235275AbhK3Hy0 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 30 Nov 2021 02:54:26 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:50929 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239158AbhK3HyY (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 30 Nov 2021 02:54:24 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4J3DtH3JFCz4xR5;
        Tue, 30 Nov 2021 18:51:03 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1638258663;
        bh=3/oiFIxULBbQSCzLLqk84ym1hVVgp9XtNJ/1FOwGjqI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 30 Nov 2021 18:51:02 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 30
Message-ID: <20211130185102.2c280cab@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/TndE.w.FpntMYRU0Kvn+MO6";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/TndE.w.FpntMYRU0Kvn+MO6
...
Merging net/master (cdef485217d3 ipv6: fix memory leak in fib6_rule_suppres=
s)
...
Merging sound-current/for-linus (65cc4ad62a9e ALSA: hda/cs8409: Set PMSG_ON=
 earlier inside cs8409 driver)
...
Merging cel/for-next (8a064c5acd6f NFS: switch the callback service back to=
 non-pooled.)
...
Merging v4l-dvb-next/master (f7702322ec7f media: mxl5005s: drop some dead c=
ode)
...
Merging net-next/master (09ae03e2fc9d stmmac: remove ethtool driver version=
 info)
Merging bpf-next/for-next (43174f0d4597 libbpf: Silence uninitialized warni=
ng/error in btf_dump_dump_type_data)
...
Merging drm-misc/for-linux-next (3d0ccae6f22f drm/tidss: Fix warning: unuse=
d variable 'tidss_pm_ops')
...
Merging sound/for-next (6dd21ad81bf9 ALSA: hda: Make proper use of timecoun=
ter)
...
Merging akpm/master (5c978b008aaf lib/stackdepot: allow optional init and s=
...

=j46f
-----END PGP SIGNATURE-----
