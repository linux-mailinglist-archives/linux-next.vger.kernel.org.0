...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0CF2C54C199
	for <lists+linux-next@lfdr.de>; Wed, 15 Jun 2022 08:06:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239848AbiFOGBX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 15 Jun 2022 02:01:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49126 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233741AbiFOGBX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 15 Jun 2022 02:01:23 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9C02A40A1C;
        Tue, 14 Jun 2022 23:01:19 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LNF6j4HGbz4xYX;
        Wed, 15 Jun 2022 16:01:17 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1655272877;
        bh=zaLE0icVeEDGMK5ERtwRwXSbxxb857T+Jc+oOjCknao=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 15 Jun 2022 16:01:16 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 15
Message-ID: <20220615160116.528c324b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=D10u8/CAJaKUZktSxev1Cf";
...
The amdgpu tree lost one build failure but gained another for which I
reverted a commit.
The amdgpu tree still had its build failures, so I used the
version from next-20220601 again.

Non-merge commits (relative to Linus' tree): 3189
 3802 files changed, 207631 insertions(+), 61513 deletions(-)
...
Merging origin/master (018ab4fabddd netfs: fix up netfs_inode_init() docboo=
k comment)
Merging fixes/fixes (d06c942efea4 Merge tag 'for_linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/mst/vhost)
Merging mm-hotfixes/mm-hotfixes-unstable (042d7e275ec8 hugetlbfs: zero part=
ial pages during fallocate hole punch)
...
Merging net/master (4b7a632ac4e7 mlxsw: spectrum_cnt: Reorder counter pools)
Merging bpf/master (a6e944f25cdb xsk: Fix generic transmit when completion =
queue reservation fails)
...
adset MIC no sound)
Merging sound-asoc-fixes/for-linus (9b1d7d881721 Merge remote-tracking bran=
...
Merging kselftest-fixes/fixes (795285ef2425 selftests: Fix clang cross comp=
ilation)
...
Merging mmc-fixes/fixes (e591fcf6b4e3 mmc: sdhci-pci-o2micro: Fix card dete=
...
Merging drm-misc-fixes/for-linux-next-fixes (0f9cd1ea10d3 drm/ttm: fix bulk=
 move handling v2)
...
Merging btrfs/for-next (5af204664954 Merge branch 'for-next-next-v5.19-2022=
0614' into for-next-20220614)
Merging ceph/master (39be3f3c2896 fscrypt: add fscrypt_context_for_new_inod=
e)
...
ing renaming)
Merging ext3/for_next (46b6418e26c7 writeback: Avoid grabbing the wb if the=
 we don't add it to dirty list)
Merging ext4/dev (5f41fdaea63d ext4: only allow test_dummy_encryption when =
supported)
Merging f2fs/dev (c2e919d20e80 f2fs: optimize error handling in redirty_blo=
cks)
...
Merging v9fs/9p-next (b3b1fb913cec 9p fid refcount: cleanup p9_fid_put call=
s)
...
nto for-next)
Merging i2c/i2c/for-next (8c8636f50eb2 Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
...
Merging opp/opp/linux-next (ff64cce8a7cf OPP: Provide a simple implementati=
...
Merging net-next/master (7e5e8ec7dbd8 docs: tls: document the TLS_TX_ZEROCO=
PY_RO)
Merging bpf-next/for-next (3831cd1f9ff6 selftests/bpf: Avoid skipping certa=
in subtests)
...
Merging drm-intel/for-linux-next (c9ae7b866f32 drm/i915: Skip FDI vs. dotcl=
ock sanity check during readout)
...
Merging sound/for-next (fe6900bd8156 ALSA: hda/realtek - ALC897 headset MIC=
 no sound)
Merging sound-asoc/for-next (44afd147a71c Merge remote-tracking branch 'aso=
...
Merging block/for-next (325d3a14c424 Merge branch 'for-5.20/io_uring' into =
for-next)
...
get the interrupt)
Merging mmc/next (1d85e9a71c7b Merge branch 'fixes' into next)
...
Merging spi/for-next (7094a5c3f99e Merge remote-tracking branch 'spi/for-5.=
20' into spi-next)
...
to trace/for-next)
Merging rcu/rcu/next (950e6b1fb9be MAINTAINERS: Add Paul as context trackin=
g maintainer)
...
Merging chrome-platform/for-next (203b2aff4786 platform/chrome: cros_ec_pro=
to: Fix spelling mistake "unknwon" -> "unknown")
...
Merging slab/for-next (eeaa345e1285 mm/slub: add missing TID updates on sla=
b deactivation)
...
Merging mm/mm-everything (9d27f2f1487a Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Merging amdgpu/drm-next (2595fe04a44d drm/amdgpu/display: make FP handling =
in Makefiles consistent)
Applying: Revert "Revert "drm/amdgpu/display: Protect some functions with C=
ONFIG_DRM_AMD_DC_DCN""
$ git reset --hard HEAD^
...
/dccg.h
[master 0c9dd1b01e74] next-20220601/amdgpu
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (0c9dd1b01e74 next-20220601/amdgpu)
...

=e0DZ
-----END PGP SIGNATURE-----
