...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 855F648F4A9
	for <lists+linux-next@lfdr.de>; Sat, 15 Jan 2022 05:12:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232332AbiAOEM1 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 14 Jan 2022 23:12:27 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:41351 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232311AbiAOEM1 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 14 Jan 2022 23:12:27 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JbPrn1vzXz4y4h;
        Sat, 15 Jan 2022 15:12:25 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1642219945;
        bh=YLbqZ0xIW74JZR38u6zWcD5ugZ3UbhbMQZ7Rg83H3H8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Sat, 15 Jan 2022 15:12:23 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 15
Message-ID: <20220115151223.121f6c36@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/H.jBaebrfLgoim4HgIomg4u";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/H.jBaebrfLgoim4HgIomg4u
...
Changes since 20220114:

Replaced the wireless-drivers{,-next} and mac80211{,-next} trees with
the wireless{,-next} trees.
...
The ftrace tree build failure was from a bad merge resoltuion on my part,
so I fixed that up today.

Non-merge commits (relative to Linus' tree): 2189
 2356 files changed, 91387 insertions(+), 27643 deletions(-)
...
Merging origin/master (112450df61b7 Merge branch 'i2c/for-mergewindow' of g=
...
Merging net/master (d90d0c175cf2 net: stmmac: Fix "Unbalanced pm_runtime_en=
able!" warning)
...
Merging sound-current/for-linus (91502a9a0b0d ALSA: hda/realtek: fix speake=
rs and micmute on HP 855 G8)
...
mon clk)
Merging parisc-hd/for-next (f03daed7cc78 parisc: Autodetect default output =
...
ible-array member)
Merging devicetree/for-next (23a839d22f5f scripts/dtc: dtx_diff: remove bro=
...
Merging akpm/master (e4e41148bde5 mm: hide the FRONTSWAP Kconfig symbol)
...

=+4NG
-----END PGP SIGNATURE-----
