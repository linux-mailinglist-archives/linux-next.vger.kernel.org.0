...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 252AD3AC920
	for <lists+linux-next@lfdr.de>; Fri, 18 Jun 2021 12:48:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233147AbhFRKvA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 18 Jun 2021 06:51:00 -0400
Received: from ozlabs.org ([203.11.71.1]:42251 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S233014AbhFRKvA (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 18 Jun 2021 06:51:00 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4G5wdY4QzQz9sRK;
        Fri, 18 Jun 2021 20:48:49 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1624013329;
        bh=ZjQw9sPy4g3OLFEotIXuEthjFBdpkzufWg+TziGz7/k=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 18 Jun 2021 20:48:48 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 18
Message-ID: <20210618204848.482a4c68@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/7JevoZ7YK=S.cZd/kuD0kIn";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/7JevoZ7YK=S.cZd/kuD0kIn
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210617:
...
The akpm tree still had its build failuresi.

Non-merge commits (relative to Linus' tree): 10275
 9825 files changed, 670313 insertions(+), 262698 deletions(-)
...
Merging origin/master (fd0aa1a4567d Merge tag 'for-linus' of git://git.kern=
...
Merging net/master (1c200f832e14 net: qed: Fix memcpy() overflow of qed_dcb=
x_params())
...
q_timer_open())
Merging sound-asoc-fixes/for-linus (2825d1194714 Merge remote-tracking bran=
...
Merging pci-current/for-linus (15ac366c3d20 PCI: aardvark: Fix kernel panic=
 during PIO transfer)
...
o ti-k3-next)
Merging ti-k3-new/ti-k3-next (3de27ef12ccb arm64: dts: ti: k3-am64-main: Up=
date TF-A load address to workaround USB DFU limitation)
...
Merging powerpc/next (07d8ad6fd8a3 powerpc/mm/book3s64: Fix possible build =
error)
...
Merging uml/linux-next (80f9733114e8 um: Remove the repeated declaration)
...
Merging hwmon-staging/hwmon-next (8e6f6d9d0e9e hwmon: (ntc_thermistor) Drop=
 unused headers.)
Merging jc_docs/docs-next (102caec1075f docs: Take a little noise out of th=
e build process)
...
635 reset)
Merging pm/linux-next (0b73405aa81a Merge branch 'pm-domains' into linux-ne=
xt)
...
inter type)
Merging net-next/master (8fe088bd4fd1 Merge branch '100GbE' of git://git.ke=
...
ink-trap.rst
Merging bpf-next/for-next (0c38740c0896 selftests/bpf: Fix ringbuf test fet=
ching map FD)
...
Merging wireless-drivers-next/master (0c33795231bf Merge tag 'wireless-driv=
ers-next-2021-06-16' of git://git.kernel.org/pub/scm/linux/kernel/git/kvalo=
...
ain.c
Merging drm/drm-next (43ccc7831fc4 Merge tag 'mediatek-drm-next-5.14' of ht=
...
Merging sound/for-next (37d122c5768b ALSA: aoa: remove unnecessary oom mess=
age)
Merging sound-asoc/for-next (fa724802a872 Merge remote-tracking branch 'aso=
...
od API)
Merging block/for-next (1d4a6f5a0bd2 Merge branch 'for-5.14/drivers-late' i=
nto for-next)
...
Merging iommu/next (d8e62790dfed Merge branches 'iommu/fixes', 'arm/rockchi=
p', 'arm/smmu', 'x86/vt-d', 'x86/amd' and 'core' into next)
Merging audit/next (0ecc617858fc audit: remove unnecessary 'ret' initializa=
tion)
Merging devicetree/for-next (cfe34bb7a770 dt-bindings: drm: bridge: adi,adv=
7511.txt: convert to yaml)
...
Merging edac/edac-for-next (f0a029fff4a5 EDAC/Intel: Do not load EDAC drive=
r when running as a guest)
...
at validation)
Merging drivers-x86/for-next (de5db8ebe7de tools/power/x86/intel-speed-sele=
ct: v1.10 release)
...
IO_MDEV)
Merging staging/staging-next (d78f4549d35b staging: rtl8188eu: remove _dbg_=
dump_tx_info function)
...
Merging akpm/master (cf1a2c63cb60 afs: fix tracepoint string placement with=
 built-in AFS)
...

=yr0n
-----END PGP SIGNATURE-----
