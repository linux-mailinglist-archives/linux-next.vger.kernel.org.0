...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 91BA01A2EB8
	for <lists+linux-next@lfdr.de>; Thu,  9 Apr 2020 07:10:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726534AbgDIFKO (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 9 Apr 2020 01:10:14 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:44505 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725271AbgDIFKN (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 9 Apr 2020 01:10:13 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48yTjV4v6Vz9sRN;
        Thu,  9 Apr 2020 15:10:06 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1586409006;
        bh=3gGV6qhLvzC3uIkXx6dRnmA1WErZIRhOxnXWeVo7vmA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 9 Apr 2020 15:10:04 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 9
Message-ID: <20200409151004.25b333d3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ZZF.qrUlNBG5Ug/FcID=vUu";
...
Changes since 20200408:

The orangefs tree gained a conflict against Linus' tree.

The v9fs tree gained a conflict against Linus' tree.

The leds tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 1318
 1421 files changed, 47277 insertions(+), 17864 deletions(-)
...
Merging origin/master (ae46d2aa6a7f mm/gup: Let __get_user_pages_locked() r=
eturn -EINTR for fatal signal)
...
Merging net/master (f691a25ce5e5 net/tls: fix const assignment warning)
Merging bpf/master (eb203f4b89c1 selftests/bpf: Add test for bpf_get_link_x=
dp_id)
Merging ipsec/master (0452800f6db4 net: dsa: mt7530: fix null pointer deref=
erencing in port5 setup)
Merging netfilter/master (b93cfb9cd3af net: icmp6: do not select saddr from=
 iif when route has prefsrc set)
...
Merging hwmon-fixes/hwmon (533123c81e34 hwmon: (drivetemp) Use drivetemp's =
true module name in Kconfig section)
Merging nvdimm-fixes/libnvdimm-fixes (f84afbdd3a9e libnvdimm: Out of bounds=
 read in __nd_ioctl())
Merging btrfs-fixes/next-fixes (c7d1808caabf Merge branch 'misc-5.7' into n=
ext-fixes)
...
_NONBLOCK)
CONFLICT (content): Merge conflict in Documentation/filesystems/9p.rst
...
in imxfb_probe())
Merging pm/linux-next (c5f2c96114cc Merge branch 'acpi-ec' into linux-next)
...
ifi/iwlwifi-next)
Merging bluetooth/master (ffee202a78c2 Bluetooth: Always request for user c=
onfirmation for Just Works (LE SC))
...
Merging drm/drm-next (12ab316ced2c Merge tag 'amd-drm-next-5.7-2020-04-01' =
of git://people.freedesktop.org/~agd5f/linux into drm-next)
Merging amdgpu/drm-next (3223001625d6 PCI/P2PDMA: Add additional AMD ZEN ro=
...
-next)
Merging sound/for-next (ddd5609fe8b6 Merge tag 'asoc-fix-v5.7' of https://g=
...
es.h)
Merging block/for-next (2b897dffcd5e Merge branch 'io_uring-5.7' into for-n=
ext)
...
rflow
Merging akpm/master (c0f5ce8074e2 drivers/media/platform/sti/delta/delta-ip=
...

=rzdA
-----END PGP SIGNATURE-----
