Return-Path: <linux-next+bounces-5075-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E865DA03784
	for <lists+linux-next@lfdr.de>; Tue,  7 Jan 2025 06:54:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 505A03A4548
	for <lists+linux-next@lfdr.de>; Tue,  7 Jan 2025 05:54:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AE67D198E78;
	Tue,  7 Jan 2025 05:54:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="cynMtQ4q"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DF91A197A92;
	Tue,  7 Jan 2025 05:53:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1736229245; cv=none; b=Kxpi26eyyNPw70qaEfgaKVbFj5wbLWnv32PqTCglXQ5ESRAMk551pAHEjw77YzteGL3yEdE25qGTSXLiIN6IUcCc6TWqS6P5IRPXpDZwjvg1IJKbvE1xebIdT2BpZOCYantzKHgcR8va5qgifLBOE9VtnzUbmHt+cLhPx32KdPs=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1736229245; c=relaxed/simple;
	bh=PwfSKoqZot8UCROlrLkDpaVUPPv++NBPOrWvx5+X/NY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=FtKZ81/lIy6SwAqWQ71FDFQLD8Yl8Y2jq4OB67MrTbpBJAUeCLE9GWLgJtytJg4kL2PpZQZi2psq2tT5yUikmayf4W9szaGY0Hr35wmXila9bJfgl5O0G64cGT1ucCYSGByWooWP7ixz0IaxjxJaQhSYYAsKa5wRcGI3h0Mephg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=cynMtQ4q; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1736229227;
	bh=F4wkcO1QuV2vQ9CvC2K8DqhwU94vqzV1dy38h9LFn3E=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YS0bb3HHTz4w2L;
	Tue,  7 Jan 2025 16:53:47 +1100 (AEDT)
Date: Tue, 7 Jan 2025 16:53:53 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 7
Message-ID: <20250107165353.5e44d8c8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/b0342RT.GBS/qM70R.WXqBQ";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/b0342RT.GBS/qM70R.WXqBQ
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250106:

The nand tree still had its build failure so I applied a supplied patch.

The block tree gained a conflict against the btrfs-fixes tree.
...
Non-merge commits (relative to Linus' tree): 6076
 6460 files changed, 288143 insertions(+), 104852 deletions(-)
...
Merging btrfs-fixes/next-fixes (3a73a300ca76 Merge branch 'misc-6.13' into =
next-fixes)
...
ng server address)
Merging btrfs/for-next (261152b2bd1a Merge branch 'for-next-next-v6.13-2025=
0106' into for-next-20250106)
...
Merging ksmbd/ksmbd-for-next (a4576758ed06 ksmbd: fix unexpectedly changed =
path in ksmbd_vfs_kern_path_locked)
...
Merging fs-current (4046708a0db8 Merge branch 'next-fixes' of git://git.ker=
...
Merging tip-fixes/tip/urgent (b309925418c9 Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (b9097e4c8bf3 drm/tests: helper=
s: Fix compiler warning)
...
Merging qcom/for-next (e8b6d257d219 Merge branches 'arm32-for-6.14', 'arm64=
...
Merging xilinx/for-next (ecb8c854281a Merge branch 'zynq/dt' into for-next)
...
Merging fs-next (a0023d60cf7e Merge branch 'for-next' of git://git.kernel.o=
...
Merging v4l-dvb/next (210afa1598de media: venus: Remove unused hfi_core_pin=
g())
...
Merging net-next/main (49afc040f4d7 octeontx2-pf: mcs: Remove dead code and=
 semi-colon from rsrc_name())
...
heck)
Merging drm-intel/for-linux-next (173876aa5d4b drm/i915/ddi: Optimize mtl_p=
ort_buf_ctl_program)
...
anagement)
Merging sound-asoc/for-next (b55c30f7f9db Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (35610342e9f6 Merge remote-tracking branch 'regu=
...
omm IPQ5424)
Merging iommu/next (33232111484e Merge branches 'arm/smmu/updates', 'arm/sm=
mu/bindings', 'qualcomm/msm', 'rockchip', 'riscv', 'core' and 'amd/amd-vi' =
into next)
Merging audit/next (8bea8f86f7a1 Automated merge of 'dev' into 'next')
Merging devicetree/for-next (2de5dbedb6bc dt-bindings: sram: qcom,imem: Doc=
ument MSM8976)
...
14' into spi-next)
Merging tip/master (1e661cb01f9c Merge branch into tip/master: 'x86/tdx')
...
o __alloc_workqueue())
Merging sched-ext/for-next (b93031164d5c Merge branch 'for-6.14' into for-n=
ext)
...
Merging efi/next (159ec6de007d efi/libstub: Use __free() helper for pool de=
allocations)
...

=uSxV
-----END PGP SIGNATURE-----
