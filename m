Return-Path: <linux-next+bounces-5341-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 4DA3DA21700
	for <lists+linux-next@lfdr.de>; Wed, 29 Jan 2025 05:02:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 713473A5905
	for <lists+linux-next@lfdr.de>; Wed, 29 Jan 2025 04:02:32 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0FD6218801A;
	Wed, 29 Jan 2025 04:02:36 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="AAxH1O2/"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D433F1DA4E;
	Wed, 29 Jan 2025 04:02:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738123356; cv=none; b=A5M1OGrJ0OaeOmYmtBPiqXLlk4mL7xGessVDpQ/Coo/8XSiPqyubQb8P+jMzbRIpwRwnWOK8dRTOkm4JdFGLQvMrm8o+45j0v6uGTAUv3trwL0siWPXlSZ7BToI/HTmI8B+CWx9M6g4DRIMyk/Cpoy5XthApAUbnXfgDVpHkEUg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738123356; c=relaxed/simple;
	bh=NFmECIoSWHy3dvzJCUTDoSPNxymcXrB5bXOfx9VkXXE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=Ntecwxy8jQE2ZbFGr3+60sLUx71OsIXYm3sSSQMjf9tYwMmZmGgQ1RN9wDbDAKJ15Tzpgv9U0z7+kBqjNHONZOSSjFI/pNKmoMVlmoSonXFBp4JYWtTgEy/CLhjcKCCtHy3WqRFM1TAD9uSrfilULFvAo4okkIVm9c4x4p2772o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=AAxH1O2/; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1738123332;
	bh=3BFZGwdHL5OkCyTOkK7N4ZpQKFM1DCNzSALPz0fTiv0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YjT4h69DSz4wc4;
	Wed, 29 Jan 2025 15:02:12 +1100 (AEDT)
Date: Wed, 29 Jan 2025 15:02:20 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 29
Message-ID: <20250129150220.258969bc@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/lCoZwWbVjinOeRE0zhX.xj4";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/lCoZwWbVjinOeRE0zhX.xj4
...
Changes since 20250128:

The s390 tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 877
 1084 files changed, 31876 insertions(+), 12852 deletions(-)
...
Merging origin/master (05dbaf8dd8bf Merge tag 'x86-urgent-2025-01-28' of gi=
...
Merging mm-hotfixes/mm-hotfixes-unstable (c6df6266c516 mm-gup-fix-infinite-=
loop-within-__get_longterm_locked-v3)
Merging fs-current (0fa35b232799 Merge branch 'fixes' of git://git.kernel.o=
...
Merging sound-current/for-linus (3b4309546b48 ALSA: hda: Fix headset detect=
ion failure due to unstable sort)
...
Merging devicetree-fixes/dt/linus (e0c3ac8f39cd dt-bindings: clock: qcom: A=
dd QCS8300 video clock controller)
...
Merging tip-fixes/tip/urgent (aace6b957cd9 Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (fd39c41bcd82 drm/ast: astdp: F=
ix timeout for enabling video signal)
...
Merging mm/mm-everything (adda98056604 foo)
...
Merging s390/for-next (3bcc8a1af581 s390/sclp: Initialize sclp subsystem vi=
a arch_cpu_finalize_init())
...
Merging fs-next (ba18ca633c5f Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
ate-tps23881-driver')
Merging bluetooth/master (55b8d4c01dde Bluetooth: MGMT: Remove unused mgmt_=
*_discovery_complete)
...
Merging drm-xe/drm-xe-next (16016ade13f6 drm/xe/ptl: Update the PTL pci id =
table)
...
Merging sound/for-next (3b4309546b48 ALSA: hda: Fix headset detection failu=
re due to unstable sort)
...
Merging input/next (08bd5b7c9a24 Input: synaptics - fix crash when enabling=
 pass-through port)
Merging block/for-next (dfd67b75fcdd Merge branch 'io_uring-6.14' into for-=
next)
...
13' into spi-linus)
Merging tip/master (99cb3062a161 Merge branch into tip/master: 'x86/mm')
...

=gfim
-----END PGP SIGNATURE-----
