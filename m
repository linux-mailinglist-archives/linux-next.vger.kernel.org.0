...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 8098B762AC9
	for <lists+linux-next@lfdr.de>; Wed, 26 Jul 2023 07:27:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229870AbjGZF1e (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 26 Jul 2023 01:27:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33002 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231560AbjGZF1a (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 26 Jul 2023 01:27:30 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EF1D926A8;
        Tue, 25 Jul 2023 22:27:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1690349237;
        bh=Ghu1M6puhHIBVpr06JZzBJWpvqKhL8F2vX/VD6gp+Jo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4R9j854sGQz4wZs;
        Wed, 26 Jul 2023 15:27:17 +1000 (AEST)
Date:   Wed, 26 Jul 2023 15:27:16 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 26
Message-ID: <20230726152716.52a6bcc2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/3Dxj/V8zWfZC+6FTvAS0R8P";
...
The mm tree gained 2 build failures for which I reverted 8 commits.
...
Non-merge commits (relative to Linus' tree): 4070
 5471 files changed, 149877 insertions(+), 60811 deletions(-)
...
Merging origin/master (18b44bc5a672 ovl: Always reevaluate the file signatu=
re for IMA)
Merging fixes/fixes (d528014517f2 Revert ".gitignore: ignore *.cover and *.=
mbx")
Merging mm-hotfixes/mm-hotfixes-unstable (db1a90d4ed14 mm-shmem-fix-race-in=
...
Merging net/main (284779dbf4e9 net: stmmac: Apply redundant write work arou=
nd on 4.xx too)
...
h in rxe_bind_mw())
Merging sound-current/for-linus (3da435063777 ALSA: usb-audio: Add quirk fo=
r Microsoft Modern Wireless Headset)
Merging sound-asoc-fixes/for-linus (614f3c0e685d Merge remote-tracking bran=
ch 'asoc/for-6.4' into asoc-linus)
Merging regmap-fixes/for-linus (6eaae1980760 Linux 6.5-rc3)
Merging regulator-fixes/for-linus (0d781594b933 Merge remote-tracking branc=
h 'regulator/for-6.4' into regulator-linus)
Merging spi-fixes/for-linus (535350d39ddc Merge remote-tracking branch 'spi=
/for-6.4' into spi-linus)
Merging pci-current/for-linus (f3b827a92f7d Revert "PCI: acpiphp: Reassign =
...
12G macro)
Merging btrfs-fixes/next-fixes (73db08ee5022 Merge branch 'misc-6.5' into n=
ext-fixes)
...
Merging mm/mm-everything (f6ce2d45b168 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
t of sigreturn)
Merging riscv-dt/riscv-dt-for-next (f2b539af5718 riscv: dts: starfive: jh71=
...
CONFLICT (content): Merge conflict in fs/btrfs/block-group.h
...
metrics is set)
Merging cifs/for-next (19826558210b smb3: do not set NTLMSSP_VERSION flag f=
or negotiate not auth request)
...
'cpumask_setall()')
Merging vfs-brauner/vfs.all (adef173e1153 Merge branches 'vfs.readdir', 'vf=
...
ength checks)
Merging hwmon-staging/hwmon-next (ad0f768007f4 hwmon: (hp-wmi-sensors) Init=
ialize pevents in hp_wmi_sensors_init())
...
Merging rdma/for-next (44725a873813 RDMA/qedr: Remove duplicate assignments=
 of va)
Merging net-next/main (a5a91f546444 Merge branch 'support-udp-encapsulation=
...
Merging drm-misc/for-linux-next (9af8cd1a1c04 drm/ast: Do not enable PCI re=
...
n314/dcn314_fpu.c
Merging drm-intel/for-linux-next (b364f3cd8798 drm/i915: Simplify expressio=
n &to_i915(dev)->drm)
...
Merging sound-asoc/for-next (ba5f755467ea Merge remote-tracking branch 'aso=
c/for-6.6' into asoc-next)
Merging modules/modules-next (b9080468caed samples/hw_breakpoint: fix build=
ing without module unloading)
Merging input/next (8362bf82fb54 Input: mcs-touchkey - fix uninitialized us=
e of error in mcs_touchkey_probe())
Merging block/for-next (739d8d8d31b6 Merge branch 'for-6.6/block' into for-=
next)
...
Merging regulator/for-next (9b037907924a Merge remote-tracking branch 'regu=
...
Merging spi/for-next (f89cf3035649 Merge remote-tracking branch 'spi/for-6.=
6' into spi-next)
...
Merging rcu/rcu/next (1f91f6bcde22 rcu: Eliminate check_cpu_stall() duplica=
te code)
...
Merging xen-tip/linux-next (0d8f7cc80578 xenbus: check xen_domain in xenbus=
_probe_initcall)
...
Merging usb/usb-next (6eaae1980760 Linux 6.5-rc3)
...
Merging tty/tty-next (6eaae1980760 Linux 6.5-rc3)
...
nel 7 mux inputs)
Merging phy-next/next (ec6beb82587c phy: starfive: make phys depend on HAS_=
IOMEM)
...
Applying: Revert "powerpc/book3s64/radix: add debug message to give more de=
tails of vmemmap allocation"
Applying: Revert "powerpc/book3s64/radix: remove mmu_vmemmap_psize"
Applying: Revert "powerpc/book3s64/radix: add support for vmemmap optimizat=
ion for radix"
Applying: Revert "scripts/gdb/vmalloc: add vmallocinfo support"
Applying: Revert "scripts/gdb/slab: add slab support"
Applying: Revert "scripts/gdb/page_owner: add page owner support"
Applying: Revert "scripts/gdb/stackdepot: add stackdepot support"
Applying: Revert "scripts/gdb/aarch64: add aarch64 page operation helper co=
mmands and configs"
...

=ZYW5
-----END PGP SIGNATURE-----
