...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 33DBA24344A
	for <lists+linux-next@lfdr.de>; Thu, 13 Aug 2020 08:58:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726042AbgHMG6y (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 13 Aug 2020 02:58:54 -0400
Received: from ozlabs.org ([203.11.71.1]:54301 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725978AbgHMG6x (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 13 Aug 2020 02:58:53 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BRy8l3Tlzz9sTM;
        Thu, 13 Aug 2020 16:58:47 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1597301927;
        bh=DixRvtgZ6RK2e3Z+OhaSFU5EhhQVCPfkQR+c0dm/N1w=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 13 Aug 2020 16:58:46 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 13
Message-ID: <20200813165846.27887669@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/u4NsA4n+EtAPM=ZZ=RvhwRx";
...
Merging origin/master (7c2a69f610e6 Merge tag 'ceph-for-5.9-rc1' of git://g=
...
Merging net/master (9643609423c7 Revert "ipv4: tunnel: fix compilation on A=
RCH=3Dum")
...
Merging sound-current/for-linus (d96f27c80b65 ALSA: hda/hdmi: Use force con=
nectivity quirk on another HP desktop)
...
bound wq's)
Merging exfat/dev (7018ec68f082 exfat: retain 'VolumeFlags' properly)
...
ible-array member)
Merging nfs/linux-next (a5032910c5e5 fs: nfs: delete repeated words in comm=
ents)
...
Merging sound/for-next (d96f27c80b65 ALSA: hda/hdmi: Use force connectivity=
...
do_copy)
Merging akpm-current/current (af9df017e4ba aio: simplify read_events())
Applying: fix up "mm: replace hpage_nr_pages with thp_nr_pages"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (4958a44955cc virtio: pci: constify ioreadX() iomem arg=
...

=CoSG
-----END PGP SIGNATURE-----
