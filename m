...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5C65C49001B
	for <lists+linux-next@lfdr.de>; Mon, 17 Jan 2022 03:04:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236739AbiAQCEO (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 16 Jan 2022 21:04:14 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:43085 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234040AbiAQCEN (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 16 Jan 2022 21:04:13 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JcZvv63s1z4y4k;
        Mon, 17 Jan 2022 13:04:11 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1642385051;
        bh=Ovb62aZs3/Nhhpxjg6emADK7M7vyulgHRJlYzgip79c=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 17 Jan 2022 13:04:11 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 17
Message-ID: <20220117130411.710d8877@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/h6.r3a+aRtE_CmUB+hngN/8";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/h6.r3a+aRtE_CmUB+hngN/8
...
Non-merge commits (relative to Linus' tree): 1478
 1770 files changed, 68428 insertions(+), 20170 deletions(-)
...
Merging origin/master (79e06c4c4950 Merge tag 'for-linus' of git://git.kern=
...
Merging net/master (56d99e81ecbc net/smc: Fix hung_task when removing SMC-R=
 devices)
...
Merging sound-current/for-linus (5762f980ca10 ALSA: usb-audio: add mapping =
for MSI MPG X570S Carbon Max Wifi.)
...
Merging driver-core.current/driver-core-linus (4d66020dcef8 Merge tag 'trac=
e-v5.17' of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-tra=
ce)
...
Merging char-misc.current/char-misc-linus (4d66020dcef8 Merge tag 'trace-v5=
.17' of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
Merging sound/for-next (5762f980ca10 ALSA: usb-audio: add mapping for MSI M=
PG X570S Carbon Max Wifi.)
...
y)
Merging driver-core/driver-core-next (4d66020dcef8 Merge tag 'trace-v5.17' =
of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
Merging char-misc/char-misc-next (4d66020dcef8 Merge tag 'trace-v5.17' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
Merging rtc/rtc-next (84aa0b8554ce rtc: sunplus: fix return value in sp_rtc=
_probe())
...
Merging random/master (073e4baba153 lib/crypto: add prompts back to crypto =
libraries)
...
Merging akpm/master (f5c8fc5c602d mm: hide the FRONTSWAP Kconfig symbol)
...

=NdUA
-----END PGP SIGNATURE-----
