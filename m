...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 53E3D95074
	for <lists+linux-next@lfdr.de>; Tue, 20 Aug 2019 00:07:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728409AbfHSWHJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 19 Aug 2019 18:07:09 -0400
Received: from merlin.infradead.org ([205.233.59.134]:59018 "EHLO
        merlin.infradead.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728352AbfHSWHJ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 19 Aug 2019 18:07:09 -0400
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
        ...
        List-Help:List-Unsubscribe:List-Subscribe:List-Post:List-Owner:List-Archive;
         bh=ZjgbyS7H2XAfk2P6c+G1nGLhervzHyBDojjP9g3Xt8k=; b=R04L3U08a/MbrftzHXJy7uNjY
        ;
Received: from static-50-53-52-16.bvtn.or.frontiernet.net ([50.53.52.16] helo=[192.168.1.17])
        by merlin.infradead.org with esmtpsa (Exim 4.92 #3 (Red Hat Linux))
        id 1hzpne-0006a4-IL; Mon, 19 Aug 2019 22:06:51 +0000
...
Message-ID: <ebcc8c55-3e77-bd3e-fa39-fed48d129250@infradead.org>
Date:   Mon, 19 Aug 2019 15:06:49 -0700
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:60.0) Gecko/20100101
 Thunderbird/60.8.0
MIME-Version: 1.0
In-Reply-To: <20190819191832.03f1a579@canb.auug.org.au>
Content-Type: multipart/mixed;
 boundary="------------36FA043B8F89E9D67CFBAB0C"
...
ld: drivers/irqchip/irq-ingenic-tcu.o: in function `ingenic_tcu_intc_cascade':
irq-ingenic-tcu.c:(.text+0xb1): undefined reference to `irq_get_domain_generic_chip'
ld: drivers/irqchip/irq-ingenic-tcu.o: in function `ingenic_tcu_irq_init':
irq-ingenic-tcu.c:(.init.text+0x91): undefined reference to `irq_generic_chip_ops'
ld: irq-ingenic-tcu.c:(.init.text+0xd2): undefined reference to `__irq_alloc_domain_generic_chips'
ld: irq-ingenic-tcu.c:(.init.text+0xfb): undefined reference to `irq_get_domain_generic_chip'
