...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E5180144C85
	for <lists+linux-next@lfdr.de>; Wed, 22 Jan 2020 08:38:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726049AbgAVHiL (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 22 Jan 2020 02:38:11 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:33791 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725883AbgAVHiK (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 22 Jan 2020 02:38:10 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 482ch907zXz9sNF;
        Wed, 22 Jan 2020 18:38:00 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1579678681;
        bh=bhvetG6qvIE28L+MVsJZS2HtqRJuIGGBuDOGfFI+HR0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 22 Jan 2020 18:37:59 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 22
Message-ID: <20200122183759.4d7520b1@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8tz316PGXVZMgplncfMOGqS";
...
Merging hwmon-staging/hwmon-next (96e5718a48b7 hwmon: (k10temp) Don't show =
...
or flow)
Merging net-next/master (4f2c17e0f332 Merge branch 'master' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/klassert/ipsec-next)
Applying: Revert "pktgen: Allow configuration of IPv6 source address range"
Merging bpf-next/master (43a825afc91e xsk, net: Make sock_def_readable() ha=
ve external linkage)
...
Merging drm-intel/for-linux-next (29baf3ae8daa drm/i915: Don't show the bla=
nk process name for internal/simulated errors)
Merging drm-tegra/drm/tegra/for-next (033ccdb7f6b1 gpu: host1x: Remove dev_=
err() on platform_get_irq() failure)
Merging drm-misc/for-linux-next (73896f60d486 drm/panfrost: Prefix interrup=
t handlers' names)
...
Merging input/next (0dfed6dc2457 Input: ads7846 - use new `delay` structure=
 for SPI transfer delays)
...
Merging scsi-mkp/for-next (7563f60d8a65 Merge branch '5.5/scsi-fixes' into =
5.6/scsi-next)
...
rflow
Merging akpm/master (f10154a4d5f5 drivers/media/platform/sti/delta/delta-ip=
...

=IJfr
-----END PGP SIGNATURE-----
