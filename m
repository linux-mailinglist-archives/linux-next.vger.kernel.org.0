Return-Path: <linux-next+bounces-750-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 9B05082FEFB
	for <lists+linux-next@lfdr.de>; Wed, 17 Jan 2024 03:53:48 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id CC68B2882A3
	for <lists+linux-next@lfdr.de>; Wed, 17 Jan 2024 02:53:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8AE171C0F;
	Wed, 17 Jan 2024 02:53:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="FT4WSmCE"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 30BC51C05;
	Wed, 17 Jan 2024 02:53:38 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705460023; cv=none; b=CkOQyFfNaJ1h3s57o54C5XvSfmfvfmuQtlAy773WpWbPE3m3uQPLjmA6NhPmyveX39L/zZKTtce87efuoDJqslwLkBP7AJrZferJWnXHgXacJEFYBh+DYEru1eWTsUh1q6ecKPpaNbDmUPaKjkdRSH2iINtwZG7BNHMwPt+BC5s=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705460023; c=relaxed/simple;
	bh=dUBvxq0Re7TF31XIu077jN2PIPPYdnp+wL6el9AiMfU=;
	h=DKIM-Signature:Received:Date:From:To:Cc:Subject:Message-ID:
	 MIME-Version:Content-Type; b=ooVua5h+rYBvdVzHX4REvJYFq0EJzxMNFoyXS5xgPQ7g3aKE04MAk9DGILci6IJCVNje5Hh0ZOzw1j38Vsr7O7uzUe1jfu7UnipNt7K1apiBoHmgYYQ1/K/4gqVsuSiD6XG7qXrR58fSiVNOrud4DIarABSs7uKPq8K/xwafWgU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=FT4WSmCE; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1705460017;
	bh=ABVEDa+CvwJSx1BpPkx5rAtiYBNpaORsbr/iD+5l8HU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TF9S06r9Hz4wxZ;
	Wed, 17 Jan 2024 13:53:36 +1100 (AEDT)
Date: Wed, 17 Jan 2024 13:53:35 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 17
Message-ID: <20240117135335.5be8b6ca@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ItKcSct8AQOoy/TYP+X2.ps";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/ItKcSct8AQOoy/TYP+X2.ps
...
Changes since 20240112:

The mm tree gained a build failure for which I applied a patch.

Non-merge commits (relative to Linus' tree): 3203
 3250 files changed, 106951 insertions(+), 64850 deletions(-)
...
Merging origin/master (052d534373b7 Merge tag 'exfat-for-6.8-rc1' of git://=
git.kernel.org/pub/scm/linux/kernel/git/linkinjeon/exfat)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (4f6c871160c3 uprobes: use pagesiz=
e-aligned virtual address when replacing pages)
...
Merging net/main (03fb8565c880 selftests: bonding: add missing build config=
s)
Merging bpf/master (33772ff3b887 selftests/bpf: Add test for alu on PTR_TO_=
FLOW_KEYS)
Merging ipsec/master (e327b2372bc0 net: ravb: Fix dma_addr_t truncation in =
error case)
Merging netfilter/main (ac631873c9e7 net: ethernet: cortina: Drop TSO suppo=
rt)
Merging ipvs/main (b29be0ca8e81 netfilter: nft_immediate: drop chain refere=
nce counter on error)
Merging wireless/for-next (989cd9fd1ffe wifi: p54: fix GCC format truncatio=
n warning with wiphy->fw_version)
Merging wpan/master (b85ea95d0864 Linux 6.7-rc1)
Merging rdma-fixes/for-rc (a39b6ac3781d Linux 6.7-rc5)
Merging sound-current/for-linus (e06964205920 Merge tag 'asoc-fix-v6.8-merg=
...
Merging gpio-brgl-fixes/gpio/for-current (62b38f30a00f gpio: EN7523: fix ke=
rnel-doc warnings)
...
Merging drm-misc-fixes/for-linux-next-fixes (3fc6c76a8d20 drm/bridge: sii90=
2x: Fix audio codec unregistration)
Merging mm-stable/mm-stable (ab27740f7665 Merge tag 'linux_kselftest-next-6=
.8-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/shuah/linux-kselft=
est)
Merging mm-nonmm-stable/mm-nonmm-stable (ab27740f7665 Merge tag 'linux_ksel=
ftest-next-6.8-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/shuah/=
linux-kselftest)
Merging mm/mm-everything (0663232d9441 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: fix up for "lib/group_cpus: fix initialization section in group_c=
pus_evenly()"
...
or-next)
Merging arm64/for-next/core (f827bcdafa2a arm64: errata: Add Cortex-A510 sp=
eculative unprivileged load workaround)
...
or-next)
Merging scmi/for-linux-next (27345a7b7bba Merge branches 'for-next/ffa/fixe=
...
Merging loongarch/loongarch-next (b93fcedebede Merge branch 'loongarch-kvm'=
 into loongarch-next)
...
Merging parisc-hd/for-next (098e94adcdca parisc; Make RO_DATA page aligned =
in vmlinux.lds.S)
Merging powerpc/next (44a1aad2fe6c Merge branch 'topic/ppc-kvm' into next)
Merging soc-fsl/next (fb9c384625dd bus: fsl-mc: fsl-mc-allocator: Drop a wr=
ite-only variable)
Merging risc-v/for-next (d4abde52b4b1 Merge patch series "riscv: mm: Fixup =
& Optimize COMPAT code")
...
Merging s390/for-next (da2108181c92 Merge branch 'features' into for-next)
...
Merging bcachefs/for-next (6a1bb52d2c8c bcachefs: opts->compression can now=
...
Merging ceph/master (0d6c693ba20a rbd: remove usage of the deprecated ida_s=
imple_*() API)
Merging cifs/for-next (84e9a2d5517b Merge tag 'v6.8-rc-part1-smb-client' of=
...
Merging gfs2/for-next (dc33003bffec gfs2: Fix gfs2_drevalidate NULL pointer=
 dereference)
...
Merging hid/for-next (80d5a73edcfb Merge branch 'for-6.8/upstream-fixes' in=
to for-next)
Merging i2c/i2c/for-next (ee8becf944f5 Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
...
G_FW_LOADER)
Merging pm/linux-next (15f5ad190ec0 Merge branch 'thermal-core' into linux-=
next)
...
- add missing escape)
Merging drm-exynos/for-linux-next (10faae933f2b drm/exynos: gsc: minor fix =
...
Merging amdgpu/drm-next (762343f79e43 drm/amdgpu: Clean up errors in amdgpu=
.h)
Merging drm-intel/for-linux-next (d505a16e00c3 drm/i915/perf: reconcile Exc=
ess struct member kernel-doc warnings)
...
Merging sound/for-next (e06964205920 Merge tag 'asoc-fix-v6.8-merge-window'=
...
Merging block/for-next (970f2479273a Merge branch 'for-6.8/block' into for-=
next)
...
8' into spi-next)
Merging tip/master (1ac6b49423e8 Merge branch into tip/master: 'x86/tdx')
...
Merging scsi-mkp/for-next (83ab68168a3d scsi: target: core: Add TMF to tmr_=
list handling)
...
-next)
Merging rtc/rtc-next (dedaf03b99d6 rtc: max31335: add driver support)
...

=vhHK
-----END PGP SIGNATURE-----
