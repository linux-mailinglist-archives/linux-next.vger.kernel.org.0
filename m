...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 29EAA510ECD
	for <lists+linux-next@lfdr.de>; Wed, 27 Apr 2022 04:30:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235777AbiD0Ccn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 26 Apr 2022 22:32:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39764 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233276AbiD0Ccl (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 26 Apr 2022 22:32:41 -0400
Received: from mail-pj1-x102a.google.com (mail-pj1-x102a.google.com [IPv6:2607:f8b0:4864:20::102a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CED76158F80
        for <linux-next@vger.kernel.org>; Tue, 26 Apr 2022 19:29:29 -0700 (PDT)
Received: by mail-pj1-x102a.google.com with SMTP id bd19-20020a17090b0b9300b001d98af6dcd1so3778664pjb.4
        for <linux-next@vger.kernel.org>; Tue, 26 Apr 2022 19:29:29 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=YXj9FUxGclY3YlrIJ9e3axgUeKxU2KnkWipdlMT1O4E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=YXj9FUxGclY3YlrIJ9e3axgUeKxU2KnkWipdlMT1O4E=;
        b=
X-Gm-Message-State: AOAM531jnbgAsk0ba38x/R0zvwsbbH0g3UuWi9mzgSV/JXEAUW5UQBUx
        6n23lYYGGhjTOhDIBbYELZcjqYoSNKjT/3NaXv8=
X-Google-Smtp-Source: ABdhPJzwv5KaNQ3pKOWb6/NTXjGPco2UIszghaA0y7zCtV1IfTKVkGUeQwySL+Ais5MkbVqUSL0IhA==
X-Received: by 2002:a17:902:ab56:b0:15a:ccc7:a311 with SMTP id ij22-20020a170902ab5600b0015accc7a311mr26678339plb.22.1651026567602;
        Tue, 26 Apr 2022 19:29:27 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id t1-20020a628101000000b0050d47199857sm7332083pfd.73.2022.04.26.19.29.27
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 26 Apr 2022 19:29:27 -0700 (PDT)
Message-ID: <6268aa87.1c69fb81.19dad.151f@mx.google.com>
Date:   Tue, 26 Apr 2022 19:29:27 -0700 (PDT)
...
Subject: next/master build: 220 builds: 10 failed, 210 passed, 38 errors,
 84 warnings (next-20220426)
...
next/master build: 220 builds: 10 failed, 210 passed, 38 errors, 84 warning=
s (next-20220426)
...
Tree: next
Branch: master
Git Describe: next-20220426
Git Commit: 088fb7eff3496e0f61fdf68bda89b81a4d0a4434
...
UG_ON failed: sizeof(*edid) !=3D EDID_LENGTH
    4    drivers/tty/n_gsm.c:940:13: error: variable 'size' is used uniniti=
...
ger of different size [-Wpointer-to-int-cast]
    4    drivers/tty/n_gsm.c:935:10: note: initialize the variable 'size' t=
...
Section mismatches summary:
    ...
    1    WARNING: modpost: vmlinux.o(.text+0x15d417): Section mismatch in r=
...
24) in 'wp512_process_buffer' [-Werror,-Wframe-larger-than]
    drivers/tty/n_gsm.c:940:13: error: variable 'size' is used uninitialize=
...
-Wunused-command-line-argument]
    clang: warning: argument unused during compilation: '-march=3Darmv6k' [=
-Wunused-command-line-argument]
    drivers/tty/n_gsm.c:935:10: note: initialize the variable 'size' to sil=
ence this warning
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text+0x15d417): Section mismatch in refere=
