...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0C00D3BC62B
	for <lists+linux-next@lfdr.de>; Tue,  6 Jul 2021 07:44:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230050AbhGFFrI (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 6 Jul 2021 01:47:08 -0400
Received: from ozlabs.org ([203.11.71.1]:43975 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230048AbhGFFrI (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 6 Jul 2021 01:47:08 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GJs245fdDz9sX2;
        Tue,  6 Jul 2021 15:44:28 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1625550268;
        bh=bTExsYhp7P6d+CwDBuAnxki+DCBXQ9QF13Z26P+G2MI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 6 Jul 2021 15:44:27 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 6
Message-ID: <20210706154427.7f1328db@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/3AmENjaQWT0jXM=W/CySanG";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/3AmENjaQWT0jXM=W/CySanG
...
Changes since 20210701:

The risc-v tree gained conflicts against Linus' tree.

The amdgpu tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 2224
 2263 files changed, 126214 insertions(+), 28695 deletions(-)
...
Merging origin/master (79160a603bdb Merge tag 'usb-5.14-rc1' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/gregkh/usb)
...
Merging net/master (c6c205ed442e Merge branch 'stmmac-ptp')
Merging bpf/master (2620e92ae6ed bpf, samples: Fix xdpsock with '-M' parame=
ter missing unload process)
Merging ipsec/master (2580d3f40022 xfrm: Fix RCU vs hash_resize_mutex lock =
inversion)
Merging netfilter/master (c23a9fd209bc netfilter: ctnetlink: suspicious RCU=
 usage in ctnetlink_dump_helpinfo)
...
Merging sound-current/for-linus (ced7c2877523 ALSA: emux: fix spelling mist=
akes)
...
Merging regulator-fixes/for-linus (bfcce8502691 Merge remote-tracking branc=
...
Merging kvms390-fixes/master (fb4b0dc67581 KVM: selftests: do not require 6=
...
robing)
Merging btrfs-fixes/next-fixes (058bd9684e4f Merge branch 'misc-5.14' into =
next-fixes)
...
Merging memblock-fixes/fixes (24caecffab46 arm: ioremap: don't abuse pfn_va=
...
Merging powerpc/next (4ebbbaa4ce85 powerpc: Only build restart_table.c for =
64s)
Merging soc-fsl/next (242b0b398ccd soc: fsl: enable acpi support in RCPM dr=
iver)
Merging risc-v/for-next (01112e5e20f5 Merge branch 'riscv-wx-mappings' into=
 for-next)
...
point of assignment)
Merging cifs/for-next (90810c25cf02 smb3: fix typo in header file)
Merging cifsd/cifsd-for-next (52f7af644386 Merge pull request #57 from namj=
...
ong)
Merging ext4/dev (ef3130d1b0b8 ext4: inline jbd2_journal_[un]register_shrin=
ker())
Merging f2fs/dev (4781e6b1ca14 f2fs: initialize page->private when using fo=
r our internal use)
...
stem.nfs4_acl)
Merging nfsd/nfsd-next (efb34029d23b nfsd: fix NULL dereference in nfs3svc_=
encode_getaclres)
...
-next)
Merging pci/next (e7e1458ecc18 Merge branch 'remotes/lorenzo/pci/xgene')
...
onfig checks)
Merging pm/linux-next (e67827a62415 Merge branch 'acpi-prm' into linux-next)
...
es')
Merging bpf-next/for-next (dbe69e433722 Merge tag 'net-next-5.14' of git://=
...
.c
Merging drm-intel/for-linux-next (c127491e223d drm/i915/display: Do not zer=
o past infoframes.vsc)
...
Merging sound/for-next (ced7c2877523 ALSA: emux: fix spelling mistakes)
...
Merging block/for-next (43ba3a2248cb Merge branch 'block-5.14' into for-nex=
t)
...
g)
Merging regulator/for-next (bfcce8502691 Merge remote-tracking branch 'regu=
...
not PID_MAX_DEFAULT)
Merging rcu/rcu/next (a030f2673849 Merge branch 'urgent.2021.07.01a' into H=
EAD)
...
Merging vhost/linux-next (b3634a892df4 virtio_net: disable cb aggressively)
...
Merging akpm/master (a3cafa97d01c powerpc/mm: enable HAVE_MOVE_PMD support)
...

=hJiZ
-----END PGP SIGNATURE-----
