...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9B368314E3E
	for <lists+linux-next@lfdr.de>; Tue,  9 Feb 2021 12:30:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229935AbhBIL3w (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 9 Feb 2021 06:29:52 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59000 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229646AbhBIL3F (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 9 Feb 2021 06:29:05 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B58F5C061793;
        Tue,  9 Feb 2021 03:28:24 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DZgcj0XChz9sTD;
        Tue,  9 Feb 2021 22:28:21 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1612870101;
        bh=b7uMxFi7v6KvgRyOm2OtXE1ZWua2IX+nQTCiNVf3/BQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 9 Feb 2021 22:28:19 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 9
Message-ID: <20210209222819.54e96c08@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/P6AT9JaQewiR9/7.P4V781a";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/P6AT9JaQewiR9/7.P4V781a
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210208:

N.B. the powerpc allyesconfig build is broken by this release.

The powerpc tree gained a build failure in the allyesconfig build which
I left broken for now.
...
The modules tree gained a build failure for which I reverted a commit.
...
It lost its second build failure.

Non-merge commits (relative to Linus' tree): 8940
 9068 files changed, 350115 insertions(+), 250488 deletions(-)
...
Merging net/master (af8085f3a471 net: fix iteration for sctp transport seq_=
files)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (92bf22614b21 Linux 5.11-rc7)
...
Merging cifs/for-next (fca63496b900 cifs: fix dfs-links)
...
in imxfb_probe())
Merging pm/linux-next (4084a778320d Merge branch 'pm-tools' into linux-next)
...
Merging net-next/master (08cbabb77e90 Merge tag 'mlx5-updates-2021-02-04' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/saeed/linux)
Merging bpf-next/for-next (215cb7d3823e bpf/benchs/bench_ringbufs: Remove u=
nneeded semicolon)
...
taprio-offloading')
Merging wireless-drivers-next/master (1299616023a0 Merge tag 'mt76-for-kval=
o-2021-01-29' of https://github.com/nbd168/wireless)
...
Merging drm-misc/for-linux-next (5ceeb328637a drm/udl: Move vmap out of com=
mit tail)
...
d variable)
Merging block/for-next (503e9fdab273 Merge branch 'for-5.12/block' into for=
-next)
...
sh kvfree testing)
Merging kvm/next (897218ff7cf1 KVM: x86: compile out TDP MMU on 32-bit syst=
ems)
...
tion name)
Merging drivers-x86/for-next (0f1f7f22f384 Platform: OLPC: Constify static =
...
Merging usb/usb-next (d8c849037d93 Merge 5.11-rc7 into usb-next)
...
DDMA mode.)
Merging usb-serial/usb-next (d2271c2b540a USB: serial: make remove callback=
 return void)
...
Merging char-misc/char-misc-next (369aea845951 mei: implement client dma se=
tup.)
...
5.12/vfio/next)
Merging staging/staging-next (eac859b84ed9 staging: emxx_udc: Make incorrec=
tly defined global static)
...
ilds)
Merging kselftest/next (1602a31d71d3 selftests/timens: add futex binary to =
.gitignore)
...
Merging akpm/master (18e07da812e7 MIPS: make userspace mapping young by def=
ault)
...

=sGX1
-----END PGP SIGNATURE-----
