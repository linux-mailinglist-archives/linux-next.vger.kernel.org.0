...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8FD3A21ED8D
	for <lists+linux-next@lfdr.de>; Tue, 14 Jul 2020 12:03:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726947AbgGNKDW (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 14 Jul 2020 06:03:22 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:58741 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726375AbgGNKDP (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 14 Jul 2020 06:03:15 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4B5bgH5Spzz9sQt;
        Tue, 14 Jul 2020 20:03:07 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1594720987;
        bh=z8xSfUMLtaJMDCtbgExTwNQWhLQ5NcFBeEgg0zCa8o0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 14 Jul 2020 20:03:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 14
Message-ID: <20200714200306.04db120f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/DSQ4VSWteB+VoOm4AebcpWb";
...
Non-merge commits (relative to Linus' tree): 6893
 7838 files changed, 395816 insertions(+), 152436 deletions(-)
...
Merging origin/master (11ba468877bb Linux 5.8-rc5)
...
Merging sound-asoc-fixes/for-linus (77af518654f1 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (ac9b7bbd19d0 Merge remote-tracking branch 'spi=
...
Merging omap-fixes/fixes (35094c15d41e ARM: OMAP2+: Fix possible memory lea=
k in omap_hwmod_allocate_module)
...
or-next)
Merging arm64/for-next/core (da560565bca0 Merge branch 'for-next/mte' into =
for-next/core)
...
or-next)
Merging omap/for-next (a2d0cccb741f Merge branch 'omap-for-v5.9/soc' into f=
or-next)
Merging qcom/for-next (1b04f883161e Merge branches 'arm64-defconfig-for-5.9=
...
Merging renesas/next (bf8bdc50a1cd Merge branches 'renesas-arm-dt-for-v5.9'=
, 'renesas-drivers-for-v5.9' and 'renesas-dt-bindings-for-v5.9' into renesa=
s-next)
...
Merging tegra/for-next (e572e286a997 Merge branch for-5.9/arm64/dt into for=
-next)
...
Merging risc-v/for-next (41e8333123e2 riscv: Add kmemleak support)
...
in imxfb_probe())
Merging pm/linux-next (f2eae871177c Merge branches 'pm-cpuidle', 'pm-cpufre=
q' and 'powercap' into linux-next)
...
ns)
Merging net-next/master (bfe4c4033306 wan: Replace HTTP links with HTTPS on=
es)
...
ge
Merging bpf-next/master (8afb259a9840 Merge branch 'strip-mods-from-global-=
vars')
$ git reset --hard HEAD^
Merging next-20200713 version of bpf-next
...
r"
Merging drm-intel/for-linux-next (a133c6988f70 drm/i915: WARN if max vswing=
/pre-emphasis violates the DP spec)
...
Merging drm-misc/for-linux-next (02cd2d314465 drm/bridge: sil_sii8620: init=
ialize return of sii8620_readb)
...
Merging sound/for-next (b91c9cb9d4b3 ALSA: echoaudio: re-enable IRQs on fai=
lure path)
Merging sound-asoc/for-next (88697c0e2112 Merge remote-tracking branch 'aso=
...
Merging block/for-next (863c8716cd44 Merge branch 'for-5.9/io_uring' into f=
or-next)
...
pcs compatible)
Merging spi/for-next (102fb3904fd6 Merge remote-tracking branch 'spi/for-5.=
9' into spi-next)
...
.h instead of stubs)
Merging rpmsg/for-next (2b2d2ecd23af Merge branches 'hwspinlock-next', 'rpm=
...
Merging seccomp/for-next/seccomp (b8048b5ad648 selftests/seccomp: Test SECC=
...
Merging akpm-current/current (40c9e92ea137 ipc: uninline functions)
...
Merging akpm/master (8b00e0acfcc7 sh: add missing EXPORT_SYMBOL() for __del=
ay)
...

=I+Qi
-----END PGP SIGNATURE-----
