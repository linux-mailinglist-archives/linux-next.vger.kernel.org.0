...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 43F2A511731
	for <lists+linux-next@lfdr.de>; Wed, 27 Apr 2022 14:46:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234306AbiD0Mge (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 27 Apr 2022 08:36:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59078 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234278AbiD0Mgc (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 27 Apr 2022 08:36:32 -0400
Received: from mail-pl1-x62b.google.com (mail-pl1-x62b.google.com [IPv6:2607:f8b0:4864:20::62b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E01F24CD40
        for <linux-next@vger.kernel.org>; Wed, 27 Apr 2022 05:33:18 -0700 (PDT)
Received: by mail-pl1-x62b.google.com with SMTP id s14so1407013plk.8
        for <linux-next@vger.kernel.org>; Wed, 27 Apr 2022 05:33:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=qbgNZ1xlirJoi2rkO+M/OT3aF23/6WM2tpQvb/j6URA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=qbgNZ1xlirJoi2rkO+M/OT3aF23/6WM2tpQvb/j6URA=;
        b=
X-Gm-Message-State: AOAM532xo9Y4JbJHvzKZo4UaAdBF7xmZzIaqLRjWo44J2+oNR0HY17zL
        s7xPE2RTnF0KZUQqqXeqOmuRo+HzG2LjIoUeJQg=
X-Google-Smtp-Source: ABdhPJyM/LCc+8wklgOvDcGT3vn24yU1fJjU89X+eEO8hlD/aqXOIbA/myZjcjbkyu9crIPnxmq6Bw==
X-Received: by 2002:a17:902:f605:b0:14d:bd53:e2cd with SMTP id n5-20020a170902f60500b0014dbd53e2cdmr27949731plg.164.1651062797116;
        Wed, 27 Apr 2022 05:33:17 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id i4-20020a628704000000b0050d36b6e22bsm12342443pfe.131.2022.04.27.05.33.16
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 27 Apr 2022 05:33:16 -0700 (PDT)
Message-ID: <6269380c.1c69fb81.c29c.bc1e@mx.google.com>
Date:   Wed, 27 Apr 2022 05:33:16 -0700 (PDT)
...
Subject: next/master build: 228 builds: 11 failed, 217 passed, 28 errors,
 96 warnings (next-20220427)
...
next/master build: 228 builds: 11 failed, 217 passed, 28 errors, 96 warning=
s (next-20220427)
...
=98__compiletime_assert_257=E2=80=99 declared with attribute error: BUILD_B=
...
=80=98-mhard-float=E2=80=99
    2    lib/maple_tree.c:4207:20: error: stack frame size (1096) exceeds l=
...
ng]  AR [M]  drivers/media/platform/qcom/camss/qcom-camss.o
    1    include/linux/fortify-string.h:328:4: error: call to __write_overf=
low_field declared with 'warning' attribute: detected write beyond size of =
field (1st parameter); maybe use struct_group()? [-Werror,-Wattribute-warni=
ng]
...
6k' [-Wunused-command-line-argument]  AR      arch/arm/mach-meson/built-in.a
...
Section mismatches summary:
    ...
    1    WARNING: modpost: vmlinux.o(.text+0x15d457): Section mismatch in r=
...
-Wunused-command-line-argument]
    clang: warning: argument unused during compilation: '-march=3Darmv6k' [=
-Wunused-command-line-argument]  AR      arch/arm/mach-meson/built-in.a
    clang: warning: argument unused during compilation: '-march=3Darmv6k' [=
-Wunused-command-line-argument]
    clang: warning: argument unused during compilation: '-march=3Darmv6k' [=
-Wunused-command-line-argument]
...
AR [M]  drivers/media/platform/qcom/camss/qcom-camss.o
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text+0x15d457): Section mismatch in refere=
...
Errors:
    lib/maple_tree.c:4207:20: error: stack frame size (1096) exceeds limit =
...
ompiletime_assert_257=E2=80=99 declared with attribute error: BUILD_BUG_ON =
