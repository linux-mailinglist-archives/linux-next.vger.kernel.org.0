...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 37881215361
	for <lists+linux-next@lfdr.de>; Mon,  6 Jul 2020 09:40:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728908AbgGFHkI (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 6 Jul 2020 03:40:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49044 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728652AbgGFHkH (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 6 Jul 2020 03:40:07 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4B929C061794;
        Mon,  6 Jul 2020 00:40:06 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4B0cst6K0Wz9sRK;
        Mon,  6 Jul 2020 17:40:02 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1594021202;
        bh=IVwBAe5mnrG9jhbZvnXJjWRcabniLOyTQwPK1K+EHPA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 6 Jul 2020 17:40:01 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 6
Message-ID: <20200706174001.2d316826@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/kW=wrb.Tz7NW/TRQ5zS0IrN";
...
The pidfd tree gained conflicts against the csky tree.

The memblock tree gained a conflict against the pidfd tree.

The akpm-current tree gained a conflict against the s390 tree.

Non-merge commits (relative to Linus' tree): 4921
 5747 files changed, 333426 insertions(+), 120936 deletions(-)
...
Merging origin/master (bb5a93aaf252 x86/ldt: use "pr_info_once()" instead o=
f open-coding it badly)
...
Merging net/master (0f57a1e522f4 Merge branch 'net-rmnet-fix-interface-leak=
-for-rmnet-module')
...
Merging netfilter/master (d005fbb855d3 netfilter: conntrack: refetch conntr=
ack after nf_conntrack_update())
...
linus)
Merging sound-asoc-fixes/for-linus (05977aabae41 Merge remote-tracking bran=
...
Merging regulator-fixes/for-linus (d70a788d6561 Merge remote-tracking branc=
...
Merging dmaengine-fixes/fixes (e3122822a740 dmaengine: idxd: fix misc inter=
rupt handler thread unmasking)
...
ins to 1)
Merging hwmon-fixes/hwmon (835a6470db5a hwmon: (aspeed-pwm-tacho) Avoid pos=
...
BRM_status_show)
Merging drm-fixes/drm-fixes (1298a549e22a Merge tag 'drm-misc-fixes-2020-07=
...
nux-next)
Merging sunxi/sunxi/for-next (177990419fb3 Merge branch 'sunxi/dt-for-5.9' =
into sunxi/for-next)
...
t_copy())
Merging cifs/for-next (bd65b5b8e520 cifs: remove the retry in cifs_poxis_lo=
ck_set)
...
e release)
Merging hwmon-staging/hwmon-next (44536b3b3366 Documentation: hwmon/w83l786=
ng: drop duplicate words)
Merging jc_docs/docs-next (8286de7c9951 Documentation: filesystems: vfs: dr=
op doubled words)
...
in imxfb_probe())
Merging pm/linux-next (941eabdd7fe5 Merge branch 'acpi-mm' into linux-next)
...
Merging thermal/thermal/linux-next (5df786e46560 thermal: core: Add notific=
ations call in the framework)
...
b_reap_ah())
Merging net-next/master (5bd6ff0c6fe6 net: dsa: vitesse-vsc73xx: Convert to=
 plain comments to avoid kerneldoc warnings)
CONFLICT (content): Merge conflict in tools/testing/selftests/bpf/progs/bpf=
_iter_netlink.c
Merging bpf-next/master (9ff79af33312 selftests/bpf: Fix compilation error =
of bpf_iter_task_stack.c)
...
r"
Merging drm-intel/for-linux-next (12b07256c223 drm/i915: Export ppgtt_bind_=
vma)
Merging drm-tegra/drm/tegra/for-next (513776e0c3fb drm/tegra: sor: Use corr=
ect power supply names for HDMI)
Merging drm-misc/for-linux-next (bc84ee948124 drm/meson: crtc: handle commi=
t of Amlogic FBC frames)
...
Merging sound-asoc/for-next (a6f8f1f6596f Merge remote-tracking branch 'aso=
...
y)
Merging block/for-next (593c0f3c162c Merge branch 'for-5.9/block' into for-=
next)
...
Merging regulator/for-next (4d3d2196da94 Merge remote-tracking branch 'regu=
...
Merging icc/icc-next (65461e26b1fe interconnect: Allow inter-provider pairs=
 to be configured)
Merging dmaengine/next (3592633e52d2 dmaengine: idxd: move idxd interrupt h=
andling to mask instead of ignore)
...
Merging seccomp/for-next/seccomp (9c8e5b130746 selftests/seccomp: Check ENO=
SYS under tracing)
Merging kspp/for-next/kspp (f8aafdbdfc58 Merge branch 'fix/modules/exposure=
...
Applying: extra merge fix up for dmaengine tree
Merging akpm-current/current (8ec5ae41620c kcov: make some symbols static)
CONFLICT (content): Merge conflict in kernel/rcu/tree.c
CONFLICT (content): Merge conflict in drivers/s390/crypto/ap_bus.h
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (db43dd9467ad sh: add missing EXPORT_SYMBOL() for __del=
ay)
...

=VF6A
-----END PGP SIGNATURE-----
