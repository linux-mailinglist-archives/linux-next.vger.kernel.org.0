...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4C365242487
	for <lists+linux-next@lfdr.de>; Wed, 12 Aug 2020 06:22:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725944AbgHLEWR (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 12 Aug 2020 00:22:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37902 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725874AbgHLEWR (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 12 Aug 2020 00:22:17 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id EF87EC06174A;
        Tue, 11 Aug 2020 21:22:16 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BRGkY5X8Fz9sTH;
        Wed, 12 Aug 2020 14:22:13 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1597206133;
        bh=nsjfBXbWBAg+ddGA2K3Sw+OEVXgNInqTcU8O+9yQhms=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 12 Aug 2020 14:22:11 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 12
Message-ID: <20200812142211.1fde2a46@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/IoPRov_TbngPuR+RSNfiHis";
...
Merging origin/master (bb5baaa9238e Merge tag 'arm64-fixes' of git://git.ke=
...
Merging net/master (1b8ef1423dbf net: phy: marvell10g: fix null pointer der=
eference)
...
Merging sound-current/for-linus (404690649e6a ALSA: hda - reverse the setti=
ng value in the micmute_led_set)
...
Merging driver-core.current/driver-core-linus (00e4db51259a Merge tag 'perf=
-tools-2020-08-10' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/li=
nux)
...
Merging btrfs-fixes/next-fixes (fecb023d5ea8 Merge branch 'misc-5.9' into n=
ext-fixes)
...
Merging parisc-hd/for-next (861042f2eb6c parisc: mask out enable and reserv=
ed bits from sba imask)
...
n remount fails)
Merging f2fs/dev (00e4db51259a Merge tag 'perf-tools-2020-08-10' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
Merging jc_docs/docs-next (e176b7a3054e doc/zh_CN: resolve undefined label =
warning in admin-guide index)
...
Merging crypto/master (3cbfe80737c1 crypto: sa2ul - Fix inconsistent IS_ERR=
 and PTR_ERR)
Merging drm/drm-next (16e6eea29d7b Merge tag 'amd-drm-fixes-5.9-2020-08-07'=
...
Merging sound/for-next (404690649e6a ALSA: hda - reverse the setting value =
in the micmute_led_set)
...
Merging xen-tip/linux-next (f2e39e8c4f0c x86/xen: drop tests for highmem in=
 pv code)
...
Merging driver-core/driver-core-next (00e4db51259a Merge tag 'perf-tools-20=
20-08-10' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
Merging akpm/master (984e15062e79 virtio: pci: constify ioreadX() iomem arg=
...

aIxWLO3/VDWXrmlYG3v1Q8Vzxvxv
=x1+P
-----END PGP SIGNATURE-----
