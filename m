...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 06D156C4137
	for <lists+linux-next@lfdr.de>; Wed, 22 Mar 2023 04:42:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229842AbjCVDmG (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 21 Mar 2023 23:42:06 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55308 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230270AbjCVDlv (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 21 Mar 2023 23:41:51 -0400
Received: from mail-pj1-x102b.google.com (mail-pj1-x102b.google.com [IPv6:2607:f8b0:4864:20::102b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5C9915ADE8
        for <linux-next@vger.kernel.org>; Tue, 21 Mar 2023 20:41:47 -0700 (PDT)
Received: by mail-pj1-x102b.google.com with SMTP id x15so7034440pjk.2
        for <linux-next@vger.kernel.org>; Tue, 21 Mar 2023 20:41:47 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112; t=1679456506;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=IiRKswv3kaQpKyDKTS68wTGXuNGYwCJQDwI1XYK61uE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20210112; t=1679456506;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=IiRKswv3kaQpKyDKTS68wTGXuNGYwCJQDwI1XYK61uE=;
        b=
X-Gm-Message-State: AO0yUKWYhbUt5OUkhSDZPBhDCi/HIwTVSrbG5DQWNk9zfRxcxPuzXWea
        hM2EmoLqV/3fXBxNvY3OTE00o/EHNhDvOdKcvudDGw==
X-Google-Smtp-Source: AK7set+7j1OWV4X7obodj4Jbp3DrFbYS9tbwYvDPIMXuvBmklKiOx80wZyIAOBgImpDhjVXr/PrE4A==
X-Received: by 2002:a05:6a20:4a25:b0:da:49fb:a620 with SMTP id fr37-20020a056a204a2500b000da49fba620mr756265pzb.28.1679456505901;
        Tue, 21 Mar 2023 20:41:45 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id c4-20020aa78804000000b005907716bf8bsm8990046pfo.60.2023.03.21.20.41.45
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 21 Mar 2023 20:41:45 -0700 (PDT)
Message-ID: <641a78f9.a70a0220.de007.000c@mx.google.com>
Date:   Tue, 21 Mar 2023 20:41:45 -0700 (PDT)
...
X-Kernelci-Kernel: next-20230322
Subject: next/master build: 198 builds: 7 failed, 191 passed, 10 errors,
 22 warnings (next-20230322)
...
next/master build: 198 builds: 7 failed, 191 passed, 10 errors, 22 warnings=
 (next-20230322)
...
Tree: next
Branch: master
Git Describe: next-20230322
Git Commit: 0aa250ce67a2697327415132a0aa4e9f1f0fe000
...
x86_64:
    allmodconfig (clang-17): 1 error, 3 warnings
...
!ENDBR: native_write_cr4+0x4
    1    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x760c: sta=
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-17) =E2=80=94 FAIL, 1 error, 3 warnings, 0 sect=
ion mismatches
...
BR: machine_kexec_prepare+0x27d
    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x760c: stack st=
