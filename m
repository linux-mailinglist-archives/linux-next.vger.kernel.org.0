...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A8C982A3ACF
	for <lists+linux-next@lfdr.de>; Tue,  3 Nov 2020 04:04:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725940AbgKCDEs (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 2 Nov 2020 22:04:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53876 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725913AbgKCDEr (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 2 Nov 2020 22:04:47 -0500
Received: from mail-pg1-x535.google.com (mail-pg1-x535.google.com [IPv6:2607:f8b0:4864:20::535])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E256BC0617A6
        for <linux-next@vger.kernel.org>; Mon,  2 Nov 2020 19:04:45 -0800 (PST)
Received: by mail-pg1-x535.google.com with SMTP id f38so12557063pgm.2
        for <linux-next@vger.kernel.org>; Mon, 02 Nov 2020 19:04:45 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=7Wl2Whvvfnjx5O2wEdOFG2J95qqAcU5tTy3wigyNhWE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=7Wl2Whvvfnjx5O2wEdOFG2J95qqAcU5tTy3wigyNhWE=;
        b=
X-Gm-Message-State: AOAM530kzz92e/bEu4G+yf18J763zkHocuepyFZIF2flHVIsjbf3xw5P
        2IrrcRXEzt4d1IoYGtmcBPIs+54ZZzXoNQ==
X-Google-Smtp-Source: ABdhPJyWJQbe8jARZdc6vXHGWLGobD5ykswzm6kO+p/iCTWe9p6EYiaOK0Nj41dsmOWdmIBn/QN36g==
X-Received: by 2002:a63:78c3:: with SMTP id t186mr15679875pgc.12.1604372682942;
        Mon, 02 Nov 2020 19:04:42 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id t9sm909280pjo.4.2020.11.02.19.04.41
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 02 Nov 2020 19:04:41 -0800 (PST)
Message-ID: <5fa0c8c9.1c69fb81.9932f.3a65@mx.google.com>
Date:   Mon, 02 Nov 2020 19:04:41 -0800 (PST)
...
Subject: next/pending-fixes build: 208 builds: 2 failed, 206 passed, 807 errors,
 371 warnings (v5.10-rc2-238-g6462cab89467)
...
next/pending-fixes build: 208 builds: 2 failed, 206 passed, 807 errors, 371=
 warnings (v5.10-rc2-238-g6462cab89467)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.10-rc2-238-g6462cab89467/

Tree: next
Branch: pending-fixes
Git Describe: v5.10-rc2-238-g6462cab89467
Git Commit: 6462cab89467882a7723521df206328c7d47223e
...
arm64:
    ...
    defconfig+kselftest (gcc-8): 125 errors, 80 warnings
...
gs
    ...
    multi_v7_defconfig+kselftest (gcc-8): 95 errors, 63 warnings
...
x86_64:
    ...
    x86_64_defconfig+kselftest (gcc-8): 108 errors, 60 warnings
...
t-ll64.h: No such file or directory
    1    /bin/sh: 1: /bin/sh: 3: clang: not foundllc: not found
...
s" property but its #address-cells (1) differs from / (2)
    11   /scratch/linux/drivers/gpu/drm/vc4/vc4_drv.c:322:18: warning: unus=
ed variable =E2=80=98vc4=E2=80=99 [-Wunused-variable]
...
gument of type =E2=80=98long unsigned int=E2=80=99, but argument 7 has type=
 =E2=80=98vm_vaddr_t=E2=80=99 {aka =E2=80=98long long unsigned int=E2=80=99=
    ...
    1    /tmp/cctYOIdr.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/cctYOIdr.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/cctYOIdr.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/cctYOIdr.s:18192: Warning: using r15 results in unpredictable beha=
viour
...
ast]
    /scratch/linux/drivers/gpu/drm/vc4/vc4_drv.c:322:18: warning: unused va=
riable =E2=80=98vc4=E2=80=99 [-Wunused-variable]
...
---------------------------------------------------------------------------=
-----
defconfig+kselftest (arm64, gcc-8) =E2=80=94 PASS, 125 errors, 80 warnings,=
 0 section mismatches
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+kselftest (arm, gcc-8) =E2=80=94 PASS, 95 errors, 63 war=
nings, 0 section mismatches
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig+kselftest (x86_64, gcc-8) =E2=80=94 PASS, 108 errors, 60 w=
...
n =E2=80=98MEMBARRIER_CMD_REGISTER_PRIVATE_EXPEDITED=E2=80=99?
    /bin/sh: 1: llc: not found
    /bin/sh: 1: /bin/sh: 3: clang: not foundllc: not found
    hmm-tests.c:24:10: fatal error: hugetlbfs.h: No such file or directory
    ionmap_test.c:14:10: fatal error: drm/drm.h: No such file or directory
    ionmap_test.c:14:10: fatal error: drm/drm.h: No such file or directory
    cgroup_util.c:340:9: error: variable =E2=80=98args=E2=80=99 has initial=
