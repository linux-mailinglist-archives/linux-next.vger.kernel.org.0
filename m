...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BBB7928FDD4
	for <lists+linux-next@lfdr.de>; Fri, 16 Oct 2020 07:53:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732990AbgJPFxC (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 16 Oct 2020 01:53:02 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:33417 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1732552AbgJPFxC (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 16 Oct 2020 01:53:02 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CCFgB46p4z9sTq;
        Fri, 16 Oct 2020 16:52:54 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1602827574;
        bh=L99epb48jjxgBlFlY4RvwpYnbxYV5S2s0wNpLQGKhPg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 16 Oct 2020 16:52:53 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 16
Message-ID: <20201016165253.332dcc60@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/f_DXW=Ao9EinHOcIvzV7ZtT";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/f_DXW=Ao9EinHOcIvzV7ZtT
...
Merging origin/master (c48b75b7271d Merge tag 'sound-5.10-rc1' of git://git=
...
Merging net/master (2ecbc1f68448 Revert "bpfilter: Fix build error with CON=
FIG_BPFILTER_UMH")
...
Merging driver-core.current/driver-core-linus (726eb70e0d34 Merge tag 'char=
-misc-5.10-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/cha=
r-misc)
Merging tty.current/tty-linus (726eb70e0d34 Merge tag 'char-misc-5.10-rc1' =
of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc)
Merging usb.current/usb-linus (726eb70e0d34 Merge tag 'char-misc-5.10-rc1' =
of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc)
...
probe())
Merging staging.current/staging-linus (726eb70e0d34 Merge tag 'char-misc-5.=
10-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc)
Merging char-misc.current/char-misc-linus (726eb70e0d34 Merge tag 'char-mis=
c-5.10-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-mi=
sc)
...
Merging btrfs-fixes/next-fixes (549738f15da0 Linux 5.9-rc8)
...
ec size structure)
Merging arm64/for-next/core (45544eee9606 arm64: mremap speedup - Enable HA=
VE_MOVE_PMD)
...
Merging parisc-hd/for-next (7ff3f14ddc35 parisc/sticon: Add user font suppo=
rt)
...
Merging cifs/for-next (9160a56cd184 smb3.1.1: set gcm256 when requested)
...
r-next)
Merging pci/next (30eec02c942d Merge branch 'remotes/lorenzo/pci/xilinx')
...
ist size."
Merging net-next/master (105faa874243 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/bpf/bpf-next)
CONFLICT (content): Merge conflict in net/mptcp/protocol.h
Merging bpf-next/for-next (105faa874243 Merge git://git.kernel.org/pub/scm/=
...
pability)
Merging netfilter-next/master (d25e2e9388ed netfilter: restore NF_INET_NUMH=
OOKS)
...
Merging mac80211-next/master (ba6ff70a3bb7 mac80211: copy configured beacon=
 tx rate to driver)
Merging gfs2/for-next (e147c6b4f2a5 gfs2: Only access gl_delete for iopen g=
locks)
...
dor-prefixes.yaml
Merging block/for-next (4e3b5b3ad9fb Merge branch 'io_uring-5.10-next' into=
 for-next)
...
-for-next)
Merging irqchip/irq/irqchip-next (893a7cfb6b0b irqchip/mst: Make mst_intc_o=
f_init static)
Merging ftrace/for-next (6107742d1583 tracing: support "bool" type in synth=
etic trace events)
...
smi_init())
Merging driver-core/driver-core-next (726eb70e0d34 Merge tag 'char-misc-5.1=
0-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc)
Merging usb/usb-next (726eb70e0d34 Merge tag 'char-misc-5.10-rc1' of git://=
...
o NULL)
Merging tty/tty-next (726eb70e0d34 Merge tag 'char-misc-5.10-rc1' of git://=
git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-misc)
Merging char-misc/char-misc-next (726eb70e0d34 Merge tag 'char-misc-5.10-rc=
...
Merging staging/staging-next (726eb70e0d34 Merge tag 'char-misc-5.10-rc1' o=
...
Merging rtc/rtc-next (024e6f3dce9e rtc: rv3028: ensure ram configuration re=
gisters are saved)
...
g-memory.c
Applying: mm/readahead: fix up for "readahead: use limited read-ahead to sa=
tisfy read"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (d82a990a57cc mm: remove duplicate include statement in=
 mmu.c)
...

=0qft
-----END PGP SIGNATURE-----
