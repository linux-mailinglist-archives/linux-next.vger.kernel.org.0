...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4F5CF91FDB
	for <lists+linux-next@lfdr.de>; Mon, 19 Aug 2019 11:18:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727376AbfHSJSk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 19 Aug 2019 05:18:40 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:36203 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727377AbfHSJSk (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 19 Aug 2019 05:18:40 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46BpJ9629sz9s7T;
        Mon, 19 Aug 2019 19:18:33 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1566206314;
        bh=5xVqb8OuqH897g6bczuFWbtAeddDrddo+bpJOCKJXbw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 19 Aug 2019 19:18:32 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 19
Message-ID: <20190819191832.03f1a579@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ZOy2ebOW_f0j79gDjyqLGIw";
...
Merging netfilter/master (480fd998bdcd Merge tag 'rxrpc-fixes-20190814' of =
...
Merging usb.current/usb-linus (6a5f43d1d8bd Merge tag 'usb-serial-5.3-rc5' =
...
ging-linus)
Merging char-misc.current/char-misc-linus (9cd02b09a0f4 Merge tag 'soundwir=
e-5.3-rc5' of git://git.kernel.org/pub/scm/linux/kernel/git/vkoul/soundwire=
...
Merging drm-fixes/drm-fixes (a85abd5d45ad Merge tag 'drm-intel-fixes-2019-0=
8-15' of git://anongit.freedesktop.org/drm/drm-intel into drm-fixes)
...
simple reset)
Merging rockchip/for-next (83e5a938eb99 Merge branch 'v5.4-armsoc/dts64' in=
to for-next)
Merging samsung-krzk/for-next (1992b548e982 Merge branch 'next/drivers' int=
o for-next)
Merging scmi/for-linux-next (a69e90512d9d Merge tag 'xfs-5.3-fixes-2' of gi=
t://git.kernel.org/pub/scm/fs/xfs/xfs-linux)
...
Merging f2fs/dev (0d75d151509f f2fs: add missing authorization check in FS_=
IOC_SETFSLABEL)
...
ion)
Merging nfs/linux-next (05c525326957 Merge branch 'i2c/for-current' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/wsa/linux)
Merging nfs-anna/linux-next (68f461593f76 NFS/flexfiles: Use the correct TC=
P timeout for flexfiles I/O)
Merging nfsd/nfsd-next (29d793f8dd38 svcrdma: Use llist for managing cache =
of recv_ctxts)
...
in imxfb_probe())
Merging pm/linux-next (92f74956122e Merge branches 'acpi-apei', 'acpi-proce=
...
Merging net-next/master (20e79a0a2cfd net: hns: add phy_attached_info() to =
the hns driver)
...
v.c
Merging drm-intel/for-linux-next (ef4688497512 drm/i915: Propagate fence er=
rors)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (596cb85218d7 drm/vboxvideo: Make structure=
 vbox_fb_helper_funcs constant)
...
Merging gpio-intel/for-next (1bd231538c21 pinctrl: intel: Allow to request =
locked pads)
...
rflow
Merging akpm/master (a2382d4d322a drivers/media/platform/sti/delta/delta-ip=
...

=axh0
-----END PGP SIGNATURE-----
