Return-Path: <linux-next+bounces-1047-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 2B38384C454
	for <lists+linux-next@lfdr.de>; Wed,  7 Feb 2024 06:13:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id C7636286919
	for <lists+linux-next@lfdr.de>; Wed,  7 Feb 2024 05:13:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B24951CD1E;
	Wed,  7 Feb 2024 05:13:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="Y0lqn5mc"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pl1-f182.google.com (mail-pl1-f182.google.com [209.85.214.182])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id EEA591CD1B
	for <linux-next@vger.kernel.org>; Wed,  7 Feb 2024 05:13:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.182
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707282804; cv=none; b=eDX56k29Rcn/Q7FSPsXcJwUPwHxgCLNBIiUSY3M/GqO9U6mqh4EBr5t032ZiMD01N2gxc+wNJxOTJujM8hyt/JLEZ3Dhck8oaG5k6cMs1p+coD2AdsU9LXXf3tKZG65/NLt6RH6JAA2gmBavSbZt5TKQH5k6GHeqz4OV/sI0dyY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707282804; c=relaxed/simple;
	bh=weEv98FNvkvXGuR3FjEsv7MRa1lv0bpOVDn/PtokfMo=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=cCgA++GIm5ph+mzxPxp+KjgZc9BNS3f3I6CPUYS3f6Y0mgxzDykwKoltRHnrMpRS4mcHtmdDvcHezQqnHla+hMs74LFv9V2/gYTBu3ZMp6Phcs3sYj1lJpR3UP94GnwZ3M/nuXzs6FoQwCLXSRk/KoLp6yTYr3cGqO4C6N1NJco=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=Y0lqn5mc; arc=none smtp.client-ip=209.85.214.182
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pl1-f182.google.com with SMTP id d9443c01a7336-1d731314e67so1939415ad.1
        for <linux-next@vger.kernel.org>; Tue, 06 Feb 2024 21:13:19 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1707282799; x=1707887599; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=C4e9YttHNT0jRT1saHbpwR920ovj/QQFfgZZZ4fBw3E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707282799; x=1707887599;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=C4e9YttHNT0jRT1saHbpwR920ovj/QQFfgZZZ4fBw3E=;
        b=
X-Gm-Message-State: AOJu0YzORaIr42A3Ho1OVjjJ5b0ptm8aKHnmjBt21WdjJQp/SsUD094U
	mw9LKJpVrZIX3bRqg63dGDlncM92s9Un4LtZPOJOanmECGDBOhSVGJ7Av9+miu98r16gB79yO8l
	5
X-Google-Smtp-Source: AGHT+IF8CwvvfGGDtcUxAQ4OhoSK5rMIzQYefDPWU3TjMaqKnubOi/ssAp6SqMIrhniX90zmgMUx5g==
X-Received: by 2002:a17:902:f80d:b0:1d9:73b2:4d3a with SMTP id ix13-20020a170902f80d00b001d973b24d3amr3378917plb.49.1707282797304;
        Tue, 06 Feb 2024 21:13:17 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id lo12-20020a170903434c00b001d8f4b57c01sm437477plb.297.2024.02.06.21.13.16
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 06 Feb 2024 21:13:16 -0800 (PST)
Message-ID: <65c3116c.170a0220.7f393.14a0@mx.google.com>
Date: Tue, 06 Feb 2024 21:13:16 -0800 (PST)
...
Subject: next/master build: 177 builds: 11 failed, 166 passed, 44 errors,
 298 warnings (next-20240206)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 177 builds: 11 failed, 166 passed, 44 errors, 298 warnin=
gs (next-20240206)
...
Tree: next
Branch: master
Git Describe: next-20240206
Git Commit: ac139fc7db67968e5061715508b5fc4aa7c40c56
...
mips:
    ...
    loongson3_defconfig (gcc-10): 1 error, 5 warnings
...
ck_gettime.c:160: undefined reference to `__ubsan_handle_type_mismatch_v1'
    1    ERROR: modpost: "init_mm" [arch/mips/kvm/kvm.ko] undefined!
...
prototype for =E2=80=98au1000_ReleaseDB=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/rm200.c:428:6: warning: no previous prototype for =
=E2=80=98disable_rm200_irq=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/rm200.c:387:13: warning: no previous prototype for =
=E2=80=98sni_rm200_i8259_irqs=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/rm200.c:331:6: warning: no previous prototype for =
=E2=80=98sni_rm200_init_8259A=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/rm200.c:211:6: warning: no previous prototype for =
=E2=80=98sni_rm200_mask_and_ack_8259A=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/reset.c:45:6: warning: no previous prototype for =E2=
=80=98sni_machine_power_off=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/reset.c:28:6: warning: no previous prototype for =E2=
=80=98sni_machine_restart=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/pcit.c:168:6: warning: no previous prototype for =E2=
=80=98disable_pcit_irq=E2=80=99 [-Wmissing-prototypes]
    2    arch/mips/sni/pcimt.c:206:6: warning: no previous prototype for =
...
---------------------------------------------------------------------------=
-----
loongson3_defconfig (mips, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnings, 0 s=
ection mismatches

Errors:
    ERROR: modpost: "init_mm" [arch/mips/kvm/kvm.ko] undefined!
