...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AAC9D2F72FF
	for <lists+linux-next@lfdr.de>; Fri, 15 Jan 2021 07:44:56 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726004AbhAOGo4 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 15 Jan 2021 01:44:56 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48872 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725880AbhAOGox (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 15 Jan 2021 01:44:53 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3A226C061757;
        Thu, 14 Jan 2021 22:44:12 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DHBVJ4zNfz9sRK;
        Fri, 15 Jan 2021 17:44:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1610693048;
        bh=dlUFhO2Q3WrXRsMXjqOP71brd7039+78DbXLAn1n+h4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 15 Jan 2021 17:44:07 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 15
Message-ID: <20210115174407.1d42c5aa@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/yZuM_ImqgI1.tgcBnk28uhD";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/yZuM_ImqgI1.tgcBnk28uhD
...
Merging origin/master (65f0d2414b70 Merge tag 'sound-5.11-rc4' of git://git=
...
Merging arm64-fixes/for-next/fixes (73a7c155a2b2 arm64: selftests: Fix spel=
ling of 'Mismatch')
...
Merging bpf/master (4237e9f4a962 selftests/bpf: Add verifier test for PTR_T=
O_MEM spill)
...
init)
Merging wireless-drivers/master (a6616bc9a0af iwlwifi: dbg: Don't touch the=
 tlv data)
Merging mac80211/master (51d62f2f2c50 cfg80211: Save the regulatory domain =
with a lock)
Merging rdma-fixes/for-rc (7c7b3e5d9aee RDMA/cma: Fix error flow in default=
_roce_mode_store)
Merging sound-current/for-linus (67ea698c3950 ALSA: hda/via: Add minimum mu=
te flag)
Merging sound-asoc-fixes/for-linus (530aef25e6ad Merge remote-tracking bran=
ch 'asoc/for-5.11' into asoc-linus)
Merging regmap-fixes/for-linus (7c53f6b671f4 Linux 5.11-rc3)
Merging regulator-fixes/for-linus (17f953176384 Merge remote-tracking branc=
h 'regulator/for-5.11' into regulator-linus)
Merging spi-fixes/for-linus (7a2da5d7960a spi: fsl: Fix driver breakage whe=
n SPI_CS_HIGH is not set in spi->mode)
...
Merging usb.current/usb-linus (6e6aa61d8119 USB: gadget: dummy-hcd: Fix err=
ors in port-reset handling)
...
Merging drivers-x86-fixes/fixes (f419e5940f1d platform/x86: ideapad-laptop:=
...
Merging scsi-fixes/fixes (d6e3ae76728c scsi: fnic: Fix memleak in vnic_dev_=
init_devcmd2)
...
Merging mmc-fixes/fixes (5b191dcba719 mmc: sdhci-brcmstb: Fix mmc timeout e=
rrors on S5 suspend)
...
ough cpumask_of(cpu))
Merging risc-v-fixes/fixes (0983834a8393 riscv: defconfig: enable gpio supp=
ort for HiFive Unleashed)
...
Merging renesas/next (f1477673cb5a Merge branch 'renesas-arm-dt-for-v5.12' =
into renesas-next)
...
Merging sunxi/sunxi/for-next (0950109f1bd7 Merge branch 'sunxi/dt-for-5.12'=
 into sunxi/for-next)
...
PORT directly)
Merging mips/mips-next (e91fd6ddb72b MIPS: lantiq: irq: register the interr=
upt controllers with irqchip_init)
Merging nds32/next (54bde873682b nds32: Fix bogus reference to <asm/procinf=
o.h>)
Merging nios2/for-next (6b57fa4d374b nios2: signal: Mark expected switch fa=
ll-through)
Merging openrisc/for-next (4f70d150294b drivers/soc/litex: make 'litex_[set=
|get]_reg()' methods private)
...
Merging soc-fsl/next (e95f287deed2 soc: fsl: handle RCPM errata A-008646 on=
 SoC LS1021A)
Merging risc-v/for-next (96257ae71b91 riscv/stacktrace: Fix stack output wi=
...
Merging cifs/for-next (e54fd0716c3d cifs: style: replace one-element array =
with flexible-array)
...
Merging f2fs/dev (0e2bd4229b2a f2fs: remove unused stat_{inc, dec}_atomic_w=
rite)
...
ixup' into for-next)
Merging pci/next (91327d9b3add Merge branch 'pci/resource')
Merging pstore/for-next/pstore (26fecbf7602d pstore: Move kmsg_bytes defaul=
t into Kconfig)
Merging hid/for-next (cbc14d19271a Merge branch 'for-5.11/upstream-fixes' i=
nto for-next)
...
Merging jc_docs/docs-next (f302589b2d2a doc/zh_CN: mips: use doc references=
 instead)
...
in imxfb_probe())
Merging pm/linux-next (9f0b1e583eac Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
Merging net-next/master (0ae5b43d6dde tcp: assign skb hash after tcp_event_=
data_sent)
Merging bpf-next/for-next (bade5c554f1a tools/bpftool: Add -Wall when build=
ing BPF programs)
...
Merging amdgpu/drm-next (df56ccaf9f7f ALSA: hda/hdmi - enable runtime pm fo=
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.c
Merging drm-intel/for-linux-next (ba8ef8c0b958 drm/i915: Drop one more usel=
ess master_transcoder assignment)
$ git reset --hard HEAD^
...
Merging drm-misc/for-linux-next (5b34ab52401f drm/modes: Switch to 64bit ma=
ths to avoid integer overflow)
...
Merging sound-asoc/for-next (eb424de4c588 Merge remote-tracking branch 'aso=
...
I kobj_to_dev())
Merging mmc/next (ea085d5f0188 mmc: core: remove needless err =3D 0 in mmc_=
init_card())
...
nterpolation)
Merging battery/for-next (284448495860 power: supply: cpcap-battery: Fix ty=
po)
Merging regulator/for-next (f60ee08c3c2d Merge remote-tracking branch 'regu=
...
Merging selinux/next (b537900f1598 userfaultfd: use secure anon inodes for =
userfaultfd)
...
er)
Merging spi/for-next (63212212b3d5 Merge remote-tracking branch 'spi/for-5.=
12' into spi-next)
Merging tip/auto-latest (ed7518a99413 Merge branch 'irq/urgent')
Applying: Revert "x86/cpu/amd: Set __max_die_per_package on AMD"
...
ts in kvm_stat)
Merging xen-tip/linux-next (3d7746bea925 x86/xen: Fix xen_hvm_smp_init() wh=
en vector callback not available)
...
Merging drivers-x86/for-next (e94a26504f41 platform/surface: aggregator_cde=
v: Add comments regarding unchecked allocation size)
...
Merging usb/usb-next (67004e130aaf ARM: tegra_defconfig: Enable USB_CHIPIDE=
A_HOST and remove USB_EHCI_TEGRA)
...
Merging phy-next/next (5b1af71280ab phy: stm32: rework PLL Lock detection)
Merging tty/tty-next (9335e23ddc33 tty: serial: owl: Add support for kernel=
 debugger)
Merging char-misc/char-misc-next (4540b9fbd8eb misc: eeprom_93xx46: Add mod=
ule alias to avoid breaking support for non device tree users)
...
Merging dmaengine/next (035b73b2b3b2 dmaengine: hsu: disable spurious inter=
rupt)
Merging cgroup/for-next (2d18e54dd866 cgroup: Fix memory leak when parsing =
multiple source parameters)
Merging scsi/for-next (c590cd9ac8f2 Merge branch 'misc' into for-next)
Merging scsi-mkp/for-next (e8e5df5edd34 scsi: MAINTAINERS: Remove intel-lin=
ux-scu@intel.com for INTEL C600 SAS DRIVER)
...
Applying: disable CONFIG_DRM_AMDGPU for now
Merging akpm-current/current (27c287b41659 ubsan: disable unsigned-overflow=
 check for i386)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (eced28294a04 secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=p/Gf
-----END PGP SIGNATURE-----
