Return-Path: <linux-next+bounces-5380-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 39DA4A2A018
	for <lists+linux-next@lfdr.de>; Thu,  6 Feb 2025 06:24:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id BD7471883656
	for <lists+linux-next@lfdr.de>; Thu,  6 Feb 2025 05:24:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DFE9A223324;
	Thu,  6 Feb 2025 05:24:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="TevpGWEF"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BFAB322331B;
	Thu,  6 Feb 2025 05:24:24 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738819472; cv=none; b=u9OAGsO3seP+jIS+nS3TcbU5dOyBf28p29xCou+8bY97psFj7Rzq2/3u/2n0Xq8xBVZzZlnNUuMPPyBQXyaD+yQ9LAzrbbHStFGDK95fhuCKC9CSWg5JhqBU3RxPIO0JnEIJxL7lwpxRnpbrPF2SNEueZHBkM8KjgJ6H5+3hbVo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738819472; c=relaxed/simple;
	bh=ofLNpfpcWWBsVyMeJi4mAme7CNhbRnrPUzgPlCWK7Xk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=awq4bMipzWoyOkDsFVvxKt9xQ/HV8KWGoZzgpLxV9KzWVBqTU2Jvo9AXDxugd6V6MiyN7YgFu+IoTDtQNSY8ZFcVYimgvNOclQ8YPc2yTQFNRS23mbLy1/fL0WiJjBLRgo9oIOEx8OIW5JyhP9TMREA/ARo64MNOgeyhck6sfYg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=TevpGWEF; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1738819447;
	bh=7KkWVi7cb7fcPoyNhN6W2OilEFRIhrbjH8HoWNxd5Tw=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YpQWW6XN0z4wj2;
	Thu,  6 Feb 2025 16:24:07 +1100 (AEDT)
Date: Thu, 6 Feb 2025 16:24:16 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 6
Message-ID: <20250206162416.46ecc356@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/jUcaUrVQdm8wymoZjPa8iD8";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/jUcaUrVQdm8wymoZjPa8iD8
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250205:

Linus' tree still has its build failure but the patch is in the block
tree.

The cpufreq-arm tree gained a conflict against the pm tree.

The drivers-x86 tree gained a build failure so I used the version from
next-20250205.

Non-merge commits (relative to Linus' tree): 1393
 1779 files changed, 52475 insertions(+), 34322 deletions(-)
...
X)
Merging cifs/for-next (8b2deeb88a19 smb: client: get rid of kstrdup() in ge=
t_ses_refpath())
...
Merging vfs-brauner/vfs.all (b9ef82bf2deb Merge branch 'vfs-6.15.pidfs' int=
o vfs.all)
Merging vfs/for-next (2e72b1e0aac2 Merge branch 'work.d_revalidate' into fo=
r-next)
Merging mm-hotfixes/mm-hotfixes-unstable (c6bf24b9549c mm: page_isolation: =
avoid calling folio_hstate() without hugetlb_lock)
Merging fs-current (81467e710ede Merge branch 'nfsd-fixes' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/cel/linux)
Merging kbuild-current/fixes (efc96be55fb7 kbuild: fix misspelling in scrip=
ts/Makefile.lib)
...
Merging sound-asoc-fixes/for-linus (98fcb50a9842 ASoC: Intel: soc-acpi-inte=
l-tgl/mtl-match: declare adr)
...
Merging spi-fixes/for-linus (aff2355d260e spi: pxa2xx: Fix regression when =
toggling chip select on LPSS devices)
Merging pci-current/for-linus (9e2211c9425f PCI/TPH: Restore TPH Requester =
Enable correctly)
...
Merging mm/mm-everything (fbeb2fd16248 foo)
Merging kbuild/for-next (2014c95afece Linux 6.14-rc1)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (357b965deba9 perf stat: Changes to event name=
 uniquification)
...
Merging fs-next (ba62d88e8480 Merge branch 'for-next' of git://git.kernel.o=
...
Merging pm/linux-next (2322d3577350 Merge branch 'acpi-prm' into fixes)
...
Merging net-next/main (0bea93fdbaf8 net: phy: realtek: use string choices h=
elpers)
...
mgr for PSR1")
Merging drm-intel/for-linux-next (d0fcbf81fc79 drm/i915/backlight: convert =
to use struct intel_display)
...
Merging sound-asoc/for-next (29e271a205c8 Merge remote-tracking branch 'aso=
...
Merging block/for-next (204176cc570f Merge branch 'for-6.15/io_uring' into =
for-next)
...
Merging regulator/for-next (8f1fa9a173a9 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (2377f68a14cb Merge remote-tracking branch 'spi/for-6.=
15' into spi-next)
...
ext)
Merging drivers-x86/for-next (f97634611408 platform/x86: samsung-galaxybook=
: Add samsung-galaxybook driver)
$ git reset --hard HEAD^
Merging next-20250205 version of drivers-x86
...
Merging cxl/next (43ca2463df9d cxl: Refactor user ioctl command path from m=
ds to mailbox)
...
Merging crc/crc-next (5b793bbee96c lib/crc32: remove "_le" from crc32c base=
 and arch functions)
...

=trAp
-----END PGP SIGNATURE-----
