...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0781F445EC9
	for <lists+linux-next@lfdr.de>; Fri,  5 Nov 2021 04:40:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229934AbhKEDlu (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 4 Nov 2021 23:41:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51800 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229587AbhKEDlu (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 4 Nov 2021 23:41:50 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 04024C061714;
        Thu,  4 Nov 2021 20:39:10 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HlmT86zY1z4xdK;
        Fri,  5 Nov 2021 14:39:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1636083549;
        bh=j3bswYQP0gSJsDPci6BdhCV9EbzYxMDstmAvAIyyeR4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 5 Nov 2021 14:39:08 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 5
Message-ID: <20211105143908.1ddd9061@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/R=KG/Uqk9odIFcyc0kQxMTa";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/R=KG/Uqk9odIFcyc0kQxMTa
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211104:

The pci tree gained a build failure for which I applied a merge fix patch.

The drm-misc tree has reacquired a build failure so I applied the same patc=
h.

I have disabled the ntfs file system write capabaility for now as it
fails for builds with 64k pages.

Non-merge commits (relative to Linus' tree): 2622
 2961 files changed, 127711 insertions(+), 58870 deletions(-)
...
Merging origin/master (d4439a1189f9 Merge tag 'hsi-for-5.16' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/sre/linux-hsi)
...
Merging net/master (d00c8ee31729 net: fix possible NULL deref in sock_reser=
ve_memory)
Merging bpf/master (a38bc45a08e9 selftests/net: Fix reuseport_bpf_numa by s=
kipping unavailable nodes)
...
_qp on the GSI QP)
Merging sound-current/for-linus (7599acb7b9a1 Revert "ALSA: memalloc: Conve=
rt x86 SG-buffer handling with non-contiguous type")
Merging sound-asoc-fixes/for-linus (e3ac76270734 Merge remote-tracking bran=
...
Merging driver-core.current/driver-core-linus (abfecb390920 Merge tag 'tty-=
5.16-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/tty)
Merging tty.current/tty-linus (abfecb390920 Merge tag 'tty-5.16-rc1' of git=
://git.kernel.org/pub/scm/linux/kernel/git/gregkh/tty)
Merging usb.current/usb-linus (048ff8629e11 Merge tag 'usb-5.16-rc1' of git=
...
Merging staging.current/staging-linus (abfecb390920 Merge tag 'tty-5.16-rc1=
...
Merging char-misc.current/char-misc-linus (abfecb390920 Merge tag 'tty-5.16=
...
Merging crypto-current/master (39ef08517082 crypto: testmgr - fix wrong key=
 length for pkcs1pad)
...
Merging erofs-fixes/fixes (1eceffaec88b erofs: fix unsafe pagevec reuse of =
hooked pclusters)
...
t)
Merging arm64/for-next/core (b0f364414a23 arm64: arm64_ftr_reg->name may no=
t be a human-readable string)
CONFLICT (content): Merge conflict in arch/arm64/kernel/stacktrace.c
CONFLICT (content): Merge conflict in arch/arm64/include/asm/stacktrace.h
...
xt)
Merging clk/clk-next (f45c5b1c2729 clk/ast2600: Fix soc revision for AHB)
...
erties)
Merging mips/mips-next (36de23a4c5f0 MIPS: Cobalt: Explain GT64111 early PC=
I fixup)
...
inter dereference)
Merging parisc-hd/for-next (5df5ac6a39f2 parisc: Fix code/instruction patch=
ing on PA1.x machines)
...
tion)
Merging cifs/for-next (95fc095e1f47 smb3: add dynamic trace points for sock=
et connection)
...
Merging f2fs/dev (261f6940554a F2FS: invalidate META_MAPPING before IPU/DIO=
 write)
Merging fsverity/fsverity (07c99001312c fs-verity: support reading signatur=
e with ioctl)
Merging fuse/for-next (712a951025c0 fuse: fix page stealing)
Merging gfs2/for-next (a5a8ea8f94e8 gfs2: Fix atomic_t bug in gfs2_instanti=
ate)
Merging jfs/jfs-next (c48a14dca2cb JFS: fix memleak in jfs_mount)
Merging ksmbd/ksmbd-for-next (af8861f9f2fa ksmbd: change LeaseKey data type=
 to u8 array)
Merging nfs/linux-next (4db6e8b61ad6 NFS: Always initialise fattr->label in=
 nfs_fattr_init())
...
into for-next)
Merging pci/next (a8f2d49bf757 Merge branch 'remotes/lorenzo/pci/xgene')
Applying: iommu/dart: restore include of linux/dma-iommu.h
...
used functions)
Merging pm/linux-next (81793ce487e9 Merge branches 'acpi-dsc', 'acpi-ec', '=
acpi-pmic' and 'acpi-video' into linux-next)
...
for pkcs1pad)
Merging drm/drm-next (d9bd054177fb Merge tag 'amd-drm-next-5.16-2021-10-29'=
 of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
Merging drm-misc/for-linux-next (ff2d23843f7f dma-buf/poll: Get a file refe=
rence for outstanding fence callbacks)
Merging amdgpu/drm-next (3b97d0e952b8 drm/amdgpu/powerplay: fix sysfs_emit/=
sysfs_emit_at handling)
...
Merging sound/for-next (7599acb7b9a1 Revert "ALSA: memalloc: Convert x86 SG=
-buffer handling with non-contiguous type")
Merging sound-asoc/for-next (e3ac76270734 Merge remote-tracking branch 'aso=
...
Merging block/for-next (d57f4161d966 Merge remote-tracking branch 'origin/f=
or-5.16/drivers' into for-next)
...
Merging mfd/for-mfd-next (52a68ae9662e mfd: simple-mfd-i2c: Select MFD_CORE=
 to fix build error)
...
318 CPNC data)
Merging xen-tip/linux-next (121f2faca2c0 xen/balloon: rename alloc/free_xen=
ballooned_pages)
...
Merging driver-core/driver-core-next (abfecb390920 Merge tag 'tty-5.16-rc1'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/tty)
...
Merging tty/tty-next (abfecb390920 Merge tag 'tty-5.16-rc1' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/gregkh/tty)
Merging char-misc/char-misc-next (abfecb390920 Merge tag 'tty-5.16-rc1' of =
...
ated_iommu_dev())
Merging staging/staging-next (abfecb390920 Merge tag 'tty-5.16-rc1' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/gregkh/tty)
...
Merging scsi-mkp/for-next (559a5d048ec3 scsi: core: Remove command size ded=
uction from scsi_setup_scsi_cmnd())
...
Merging akpm/master (2476049ddba1 kasan: add kasan mode messages when kasan=
 init)
...

=muOg
-----END PGP SIGNATURE-----
