...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9BAE8389CC5
	for <lists+linux-next@lfdr.de>; Thu, 20 May 2021 06:42:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229545AbhETEne (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 20 May 2021 00:43:34 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36338 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229449AbhETEne (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 20 May 2021 00:43:34 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9A195C061574;
        Wed, 19 May 2021 21:42:13 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Flxss5bT3z9sPf;
        Thu, 20 May 2021 14:42:09 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1621485729;
        bh=YYh7Bkm3HfZiJ19AMdgClpNjewVv3/fGTKFYVSpAIPg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 20 May 2021 14:42:07 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 20
Message-ID: <20210520144207.5bd18eee@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/XYaBuqG/pWltH12UePfDG8_";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/XYaBuqG/pWltH12UePfDG8_
...
Merging origin/master (c3d0e3fd41b7 Merge tag 'fs.idmapped.mount_setattr.v5=
.13-rc3' of gitolite.kernel.org:pub/scm/linux/kernel/git/brauner/linux)
...
Merging net/master (4d52ebc7ace4 net: hso: bail out on interrupt URB alloca=
tion failure)
...
Merging sound-asoc-fixes/for-linus (de26dfc4fc0c Merge remote-tracking bran=
ch 'asoc/for-5.13' into asoc-linus)
Merging regmap-fixes/for-linus (d07f6ca923ea Linux 5.13-rc2)
Merging regulator-fixes/for-linus (cd6004768edf Merge remote-tracking branc=
h 'regulator/for-5.13' into regulator-linus)
Merging spi-fixes/for-linus (6981cd2ba910 Merge remote-tracking branch 'spi=
...
Merging drivers-x86-fixes/fixes (39a6172ea88b platform/x86: touchscreen_dmi=
...
Merging v4l-dvb-next/master (c4fb2697f420 Merge branch 'media_stage' into t=
o_next)
$ git reset --hard HEAD^
...
Merging net-next/master (a49e72b3bda7 net: qrtr: ns: Fix error return code =
in qrtr_ns_init())
...
n hash_hw_final())
Merging drm/drm-next (3a3ca7265316 Merge tag 'drm-misc-next-2021-05-12' of =
git://anongit.freedesktop.org/drm/drm-misc into drm-next)
Merging drm-misc/for-linux-next (e52e4a3132a6 gpu: drm: replace occurrences=
 of invalid character)
Merging amdgpu/drm-next (c1c4d8efddde drm/amdgpu/acpi: unify ATCS handling =
(v2))
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/amdgpu/amdgpu_vra=
m_mgr.c
Merging drm-intel/for-linux-next (ec279384c6a0 drm/i915: Initialize err in =
remap_io_sg())
...
Merging regmap/for-next (68b7a038c5ff Merge remote-tracking branch 'regmap/=
for-5.14' into regmap-next)
Merging sound/for-next (e878e8c53e5b Merge branch 'topic/firewire' into for=
-next)
Merging sound-asoc/for-next (1f762e65d7f6 Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (aed86e3d5b17 Merge remote-tracking branch 'regu=
...
rations)
Merging devicetree/for-next (bb63744b02e9 dt-bindings: pwm: brcm,iproc-pwm:=
...
Merging spi/for-next (2141ab0b019a Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
...

=5+we
-----END PGP SIGNATURE-----
