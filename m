...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6B0AB4945AC
	for <lists+linux-next@lfdr.de>; Thu, 20 Jan 2022 03:01:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1358142AbiATCBL (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 19 Jan 2022 21:01:11 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:57783 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244434AbiATCBK (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 19 Jan 2022 21:01:10 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JfQhz5LRKz4y4Z;
        Thu, 20 Jan 2022 13:01:07 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1642644067;
        bh=GwQCLccar3kBe5+tMMmXYV0/fUc2lgGzf0H/J+XhBGk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 20 Jan 2022 13:01:05 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 20
Message-ID: <20220120130105.2b2a60d9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dS7upetRwSSfeWhD1un6C8D";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/dS7upetRwSSfeWhD1un6C8D
...
Merging origin/master (1d1df41c5a33 Merge tag 'f2fs-for-5.17-rc1' of git://=
...
Merging net/master (ff9fc0a31d85 Merge branch 'ipv4-avoid-pathological-hash=
-tables')
...
Merging sound-current/for-linus (8c0ae778e287 ALSA: core: Simplify snd_powe=
r_ref_and_wait() with the standard macro)
...
ice node)
Merging kvm-fixes/master (5f02ef741a78 KVM: VMX: switch blocked_vcpu_on_cpu=
_lock to raw spinlock)
...
robing)
Merging btrfs-fixes/next-fixes (0acb1c428b71 Merge branch 'misc-5.17' into =
next-fixes)
...
Merging kbuild/for-next (1d1df41c5a33 Merge tag 'f2fs-for-5.17-rc1' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/jaegeuk/f2fs)
...
lue)
Merging risc-v/for-next (fc839c6d33c8 riscv: bpf: Fix eBPF's exception tabl=
es)
...
Merging ksmbd/ksmbd-for-next (ac090d9c90b0 ksmbd: fix guest connection fail=
ure with nautilus)
...
Merging amdgpu/drm-next (e23fcf632883 drm/amdgpu: bump driver version for n=
...
Merging sound/for-next (8c0ae778e287 ALSA: core: Simplify snd_power_ref_and=
_wait() with the standard macro)
...
Merging block/for-next (e561ba38a9b7 Merge branch 'io_uring-5.17' into for-=
next)
...
Merging random/master (72cd592ac072 lib/crypto: blake2s: avoid indirect cal=
...

=YCW8
-----END PGP SIGNATURE-----
