...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AF38039B4A9
	for <lists+linux-next@lfdr.de>; Fri,  4 Jun 2021 10:13:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230044AbhFDIPH (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 4 Jun 2021 04:15:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49986 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229953AbhFDIPH (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 4 Jun 2021 04:15:07 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5D8C7C06174A;
        Fri,  4 Jun 2021 01:13:21 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FxFrY3VZYz9sRf;
        Fri,  4 Jun 2021 18:13:17 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1622794397;
        bh=FjCPAzBCCvY4IMyu2AE9udNGeMLDxt7+yW/ylDHuEoU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 4 Jun 2021 18:13:15 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 4
Message-ID: <20210604181315.31483176@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/JBk4=LTLuyB/I861KU_+8hr";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/JBk4=LTLuyB/I861KU_+8hr
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210603:

The net-next tree gained conflicts against the net tree.

The iio tree gained a conflict against the rdma tree.

Non-merge commits (relative to Linus' tree): 6709
 6668 files changed, 352927 insertions(+), 141851 deletions(-)
...
Merging origin/master (f88cd3fb9df2 Merge tag 'vfio-v5.13-rc5' of git://git=
hub.com/awilliam/linux-vfio)
...
Merging net/master (1a8024239dac virtio-net: fix for skb_over_panic inside =
big mode)
...
cted rate info)
Merging rdma-fixes/for-rc (a3e74fb9247c RDMA/ipoib: Fix warning caused by d=
estroying non-initial netns)
Merging sound-current/for-linus (b8b90c176026 ALSA: hda: update the power_s=
tate during the direct-complete)
Merging sound-asoc-fixes/for-linus (5ad906c936dd Merge remote-tracking bran=
ch 'asoc/for-5.13' into asoc-linus)
Merging regmap-fixes/for-linus (8124c8a6b353 Linux 5.13-rc4)
Merging regulator-fixes/for-linus (c3c945a3b6a9 Merge remote-tracking branc=
h 'regulator/for-5.13' into regulator-linus)
Merging spi-fixes/for-linus (3fdda0a2ec2b Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (8d396bb0a5b6 usb: dwc3: debugfs: Add and rem=
ove endpoint dirs dynamically)
...
Merging iio-fixes/fixes-togreg (1ace234ba938 iio: accel: bma180: Fix BMA25x=
...
M/s390)
Merging hwmon-fixes/hwmon (1603eb86c6fb hwmon: (corsair-psu) fix suspend be=
havior)
...
Merging drivers-x86-fixes/fixes (b430e1d65ef6 platform/surface: aggregator:=
 Fix event disable function)
...
for-next/core)
Merging arm-perf/for-next/perf (281e44f5fd4f arm64: perf: Add more support =
on caps under sysfs)
...
Merging cifs/for-next (69f98828728f cifs: get rid of binding_chan and use c=
hans_need_reconnect instead)
...
Merging ext4/dev (7bbbf7c385ed ext4: Only advertise encrypted_casefold when=
 encryption and unicode are enabled)
Merging f2fs/dev (82a4bde500f7 f2fs: clean up /sys/fs/f2fs/<disk>/features)
...
Merging dmi/dmi-for-next (3cb4d29a2633 MAINTAINERS: The DMI/SMBIOS tree has=
 moved)
Merging hwmon-staging/hwmon-next (a145de31242c hwmon: (max31790) Detect and=
 report zero fan speed)
...
Merging rdma/for-next (50971e39154d Merge branch 'irdma' into rdma.git for-=
next)
Merging net-next/master (ebbf5fcb94a7 netdevsim: Fix unsigned being compare=
d to less than zero)
...
in.c
Merging bpf-next/for-next (56b8b7f9533b selftests/bpf: Add xdp_redirect_mul=
ti into .gitignore)
...
tion update)
Merging bluetooth/master (e62473c516b6 Bluetooth: smp: Use the correct prin=
t format)
...
em.c
Merging drm-misc/for-linux-next (610d9c311b13 drm/panel: add rotation suppo=
rt for Elida KD35T133 panels)
...
.c
Merging amdgpu/drm-next (07c4045ec95b drm/radeon: Add HD-audio component no=
tifier support (v2))
Merging drm-intel/for-linux-next (514d83cb673f drm/i915/adlp: Fix AUX power=
 well -> PHY mapping)
...
yback start)
Merging sound-asoc/for-next (61cd091d9226 Merge remote-tracking branch 'aso=
...
-next)
Merging device-mapper/for-next (18a20f4aed64 dm crypt: Fix zoned block devi=
ce support)
...
Merging battery/for-next (b49a81d0fd02 power: supply: sbs-battery: cache co=
nstant string properties)
Merging regulator/for-next (55ef1590c894 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (e7cacae458b5 Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
Merging tip/auto-latest (24c50168409a Merge branch 'efi/core')
...
Merging workqueues/for-next (940d71c6462e wq: handle VM suspension in stall=
 detection)
Merging drivers-x86/for-next (fd9f10567ace platform/surface: aggregator: Fi=
x event disable function)
...
er-core-next)
Merging usb/usb-next (5ff90af9da8f usb: dwc3: debugfs: Add and remove endpo=
int dirs dynamically)
...
Merging iio/togreg (eb4e91f42fc9 iio: accel: bma180: Add missing 500 Hz / 1=
000 Hz bandwidth)
...
into tpmdd-for-next)
Merging akpm-current/current (3f160eb715f9 linux-next-pre)
CONFLICT (content): Merge conflict in drivers/block/zram/zram_drv.h
CONFLICT (content): Merge conflict in arch/riscv/Kconfig
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (05de096cb377 kdump: use vmlinux_build_id to simplify)
...

=CgE5
-----END PGP SIGNATURE-----
