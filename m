Return-Path: <linux-next+bounces-3511-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C31BE96579D
	for <lists+linux-next@lfdr.de>; Fri, 30 Aug 2024 08:29:22 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id BF02EB22E8A
	for <lists+linux-next@lfdr.de>; Fri, 30 Aug 2024 06:29:19 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9FC0914A0B6;
	Fri, 30 Aug 2024 06:29:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="m5Bg3tA+"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 13FDE44C7C;
	Fri, 30 Aug 2024 06:29:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724999354; cv=none; b=eUZkeK0I52NrbfRkIWfnfFjuRWeP677iesIbF1/kaHja9c3OJUUVasjOQvpkBOByf+LCbF0pLDcaG6+ehCVklbyAdpKSgBe6YIaeTiJyguk2WUhrp9jUu0MMiB4TYGmHxLZ/ydx4sdTG0IKl93gfhzyhsDRlxFDK+mY4teLImGE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724999354; c=relaxed/simple;
	bh=y8uIkcgdQ3SidbmhFoKph4A7CIlhsOdJanwbWXhklhI=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=D1D0b4VgK8OdNEHZyyre7xkkd+worAQbyiTmmls3vI8jLMzydnud8sv/XPnj0tOYlPWZi0qBbIM0c7/oduJpKp1NRiQ/hfQShHDsrM2trNF0AdFaTu0hupZ7B26E8TVlbsHhyy1psQpaFbomwJKD2SM0lFiUi54ehGN+ipFkZKY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=m5Bg3tA+; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1724999347;
	bh=TUPl3oHKUQg9OPrzv1+cz8N/N+XIL0WTui2IfEotbnc=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Ww7XM075Pz4wb5;
	Fri, 30 Aug 2024 16:29:06 +1000 (AEST)
Date: Fri, 30 Aug 2024 16:29:06 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 30
Message-ID: <20240830162906.6cc2a492@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/CyfJxPVdnal3lhgGNzWZTN2";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/CyfJxPVdnal3lhgGNzWZTN2
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240829:
...
Non-merge commits (relative to Linus' tree): 7204
 7530 files changed, 288224 insertions(+), 146726 deletions(-)
...
Merging origin/master (3b9dfd9e5936 Merge tag 'hwmon-for-v6.11-rc6' of git:=
...
Merging nfsd-fixes/nfsd-fixes (1271e30308ff nfsd: fix nfsd4_deleg_getattr_c=
...
ph_dns_resolve_name())
Merging cifs/for-next (c3a0c4909836 netfs, cifs: Improve some debugging bit=
s)
...
Merging nfsd/nfsd-next (a9dc1f4011ae NFSD: Create an initial nfs4_1.x file)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (70f023a608ea Merge branch 'vfs.fallocate' into=
...
Merging mm-hotfixes/mm-hotfixes-unstable (8bd9445ee511 codetag: debug: mark=
 codetags for poisoned page as empty)
Merging fs-current (f2e901b35b71 Merge branch 'nfsd-fixes' of git://git.ker=
...
or-next/fixes)
Merging arm-soc-fixes/arm/fixes (3536c01d6577 Merge tag 'riscv-soc-fixes-fo=
r-v6.11-rc6' of https://git.kernel.org/pub/scm/linux/kernel/git/conor/linux=
 into arm/fixes)
...
Merging net/main (b57d643a673c MAINTAINERS: exclude bluetooth and wireless =
DT bindings from netdev ML)
...
Merging sound-current/for-linus (4178d78cd7a8 ALSA: hda/conexant: Add pincf=
g quirk to enable top speakers on Sirius devices)
Merging sound-asoc-fixes/for-linus (3e83957e8dd7 ASoC: sunxi: sun4i-i2s: fi=
x LRCLK polarity in i2s mode)
Merging regmap-fixes/for-linus (60f90cdf816c Merge remote-tracking branch '=
regmap/for-6.10' into regmap-linus)
Merging regulator-fixes/for-linus (5be63fc19fca Linux 6.11-rc5)
Merging spi-fixes/for-linus (5f3eee1eef5d spi: spidev: Add an entry for elg=
in,jg10309-01)
...
Merging drm-fixes/drm-fixes (bd3755c1cf2a Merge tag 'amd-drm-fixes-6.11-202=
4-08-28' of https://gitlab.freedesktop.org/agd5f/linux into drm-fixes)
...
Merging clk-fixes/clk-fixes (0f6eaf125e73 Merge tag 'qcom-clk-fixes-for-6.1=
1' of https://git.kernel.org/pub/scm/linux/kernel/git/qcom/linux into clk-f=
ixes)
...
Merging drm-misc-fixes/for-linux-next-fixes (9d824c7fce58 drm/v3d: Disable =
preemption while updating GPU stats)
...
Merging mm/mm-everything (647f44b0a12b foo)
Merging kbuild/for-next (184a282d540c kbuild: remove *.symversions left-ove=
r)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (47b3b6435e4b tools build: Remove leftover lib=
cap tests that prevents fast path feature detection from working)
...
Merging rockchip/for-next (4d208f1b840c Merge branch 'v6.12-armsoc/dts64' i=
nto for-next)
Merging samsung-krzk/for-next (6a8afff2166f Merge branch 'next/drivers' int=
o for-next)
Merging scmi/for-linux-next (639facfa87ef Merge branches 'for-next/juno/upd=
...
Merging sophgo/for-next (e8b4716e68ba riscv: dts: sophgo: Add mcu device fo=
r Milk-V Pioneer)
...
Merging ti/ti-next (a5701819198f Merge branches 'ti-drivers-soc-next', 'ti-=
...
Merging clk/clk-next (f0e992956eb6 Merge branch 'clk-cleanup' into clk-next)
...
Merging fs-next (6c3fb8b62d7d Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging hwmon-staging/hwmon-next (2f0d9872beca dt-bindings: hwmon: Convert =
ltc2978.txt to yaml)
...
Merging pm/linux-next (e793a0d5bd6d Merge branch 'thermal' into linux-next)
...
Merging net-next/main (670726a8262e Merge branch 'bnxt_en-update-for-net-ne=
xt')
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlxsw/c=
ore_thermal.c
Merging bpf-next/for-next (738cae941a79 Merge branch 'bpf-next/master' into=
 bpf-next/for-next)
...
t)
Merging bluetooth/master (c858dc985d70 Bluetooth: MGMT: Ignore keys being l=
oaded with invalid type)
$ git reset --hard HEAD^
Merging next-20240829 version of bluetooth
...
Merging drm/drm-next (e55ef65510a4 Merge tag 'amd-drm-next-6.12-2024-08-26'=
 of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
  010cc730ace8 ("drm/amd/pm: Add support for new P2S table revision")
  01bfabc2d1d8 ("drm/amd/pm: update message interface for smu v14.0.2/3")
  3376f922bfe0 ("drm/amd/pm: Drop unsupported features on smu v14_0_2")
  40318a2406bd ("drm/amdgpu/gfx12: set UNORD_DISPATCH in compute MQDs")
  73dd0ad9e5da ("drm/amd/display: avoid using null object of framebuffer")
  875ff9a7ee88 ("drm/amdgpu: support for gc_info table v1.3")
...
Merging drm-misc/for-linux-next (e75356ef5bae drm/tegra: hdmi: Make read-on=
ly const array freqs static)
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.c
Merging amdgpu/drm-next (6c0a7c3c693a drm/amdgpu: always allocate cleared V=
RAM for GEM allocations)
  b86a6a57b8ad ("drm/amdgpu/smu13.0.7: print index for profiles")
  bbb05f8a9cd8 ("drm/amdgpu: align pp_power_profile_mode with kernel docs")
  c50fe289ed72 ("drm/amdgpu/swsmu: always force a state reprogram on init")
Merging drm-intel/for-linux-next (70c33a2710cd drm/i915/bios: Update new en=
tries in VBT BDB block definitions)
Applying: fix up for "drm/i915/dp_mst: Fix MST state after a sink reset"
...
Merging drm-xe/drm-xe-next (02a416afbe12 drm/xe/gsc: Wedge the device if th=
e GSCCS reset fails)
...
Merging fbdev/for-next (c3830f793236 fbdev: omapfb: Use sysfs_emit_at() to =
simplify code)
Merging regmap/for-next (f4985b5500d2 Merge remote-tracking branch 'regmap/=
for-6.12' into regmap-next)
Merging sound/for-next (2186fe21e57a ALSA: hda/realtek: Autodetect Cirrus L=
ogic companion amplifier bindings)
Merging ieee1394/for-next (c652a6d7e10a firewire: core: update fw_device ou=
tside of device_find_child())
Merging sound-asoc/for-next (c76d5dfbfc97 Merge remote-tracking branch 'aso=
c/for-6.12' into asoc-next)
Merging modules/modules-next (907fa79d787f MAINTAINERS: scale modules with =
more reviewers)
Merging input/next (b9401c658d2c MAINTAINERS: add gameport.h, serio.h and u=
input.h to INPUT section)
...
Merging block/for-next (81c0619ef256 Merge branch 'for-6.12/block' into for=
-next)
Merging device-mapper/for-next (02c0207ecdcc dm bufio: Remove NULL check of=
 list_entry())
Merging libata/for-next (9526dec226f0 ata: libata: Add helper ata_eh_decide=
_disposition())
...
d_ops)
Merging regulator/for-next (e3f5738ec13c Merge remote-tracking branch 'regu=
...
Merging spi/for-next (c555a75b3b86 Merge remote-tracking branch 'spi/for-6.=
12' into spi-next)
Merging tip/master (a85536e1bce7 Merge branch into tip/master: 'x86/timers')
...
Merging kvm-arm/next (4b851ed48f05 Merge branch kvm-arm64/vgic-sre-traps in=
...
Merging phy-next/next (b48baf69db97 phy: nuvoton: add new driver for the Nu=
voton MA35 SoC USB 2.0 PHY)
...
Merging dmaengine/next (3f92ee7c4a4e dmaengine: dw: Unify ret-val local var=
iables naming)
...
cros)
Merging slab/slab/for-next (4cfa533601a6 Merge branch 'slab/for-6.12/rcu_ba=
rriers' into slab/for-next)
CONFLICT (content): Merge conflict in kernel/rcu/tree.c
Merging random/master (0c7e00e22c21 random: vDSO: minimize and simplify hea=
der includes)
...

=gbbQ
-----END PGP SIGNATURE-----
