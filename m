...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A0D4651780D
	for <lists+linux-next@lfdr.de>; Mon,  2 May 2022 22:24:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1378920AbiEBU1O (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 2 May 2022 16:27:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54028 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1387483AbiEBU1C (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 2 May 2022 16:27:02 -0400
Received: from mail-pl1-x62d.google.com (mail-pl1-x62d.google.com [IPv6:2607:f8b0:4864:20::62d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A2F2D101D3
        for <linux-next@vger.kernel.org>; Mon,  2 May 2022 13:23:01 -0700 (PDT)
Received: by mail-pl1-x62d.google.com with SMTP id x18so2171974plg.6
        for <linux-next@vger.kernel.org>; Mon, 02 May 2022 13:23:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=T74aNDP/KFOOEz9+C7nrRyYeFwNOEONb7xXw9a+SHas=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=T74aNDP/KFOOEz9+C7nrRyYeFwNOEONb7xXw9a+SHas=;
        b=
X-Gm-Message-State: AOAM531oROgLPDJxaLYauFS42U2eXeTWGXt/zJ24XOF4/aVfEMGrPOob
        X/VS3xWadnkbQ3C9a2dJ3DLYpFzH0PivgLna/Yg=
X-Google-Smtp-Source: ABdhPJz9b0j+lAMZ0/L+NYxa1cnhCVbTYYFsNvzU9CMnu1oJuiyddnPJXIh3trtN8vKNQ1tUCkDQTg==
X-Received: by 2002:a17:902:e889:b0:15e:9ff2:aad with SMTP id w9-20020a170902e88900b0015e9ff20aadmr7862029plg.75.1651522979500;
        Mon, 02 May 2022 13:22:59 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id x22-20020a62fb16000000b0050dc7628167sm5074949pfm.65.2022.05.02.13.22.58
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 02 May 2022 13:22:59 -0700 (PDT)
Message-ID: <62703da3.1c69fb81.eb66a.c33c@mx.google.com>
Date:   Mon, 02 May 2022 13:22:59 -0700 (PDT)
...
Subject: next/master build: 219 builds: 14 failed, 205 passed, 42 errors,
 81 warnings (next-20220502)
...
next/master build: 219 builds: 14 failed, 205 passed, 42 errors, 81 warning=
s (next-20220502)
...
Tree: next
Branch: master
Git Describe: next-20220502
Git Commit: 9f9b9a2972eb8dcaad09d826c5c6d7488eaca3e6
...
7-a' [-Wunused-command-line-argument]
    9    drivers/pci/pci-driver.c:534:12: warning: =E2=80=98pci_restore_sta=
...
request_post() falls through to next function mpi3mr_check_rh_fault_ioc()
    1    drivers/pci/pci-driver.c:534:12: warning: unused function 'pci_res=
...
Section mismatches summary:
    ...
    1    WARNING: modpost: vmlinux.o(.text+0x15c157): Section mismatch in r=
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text+0x15c157): Section mismatch in refere=
...
Warnings:
    drivers/pci/pci-driver.c:534:12: warning: =E2=80=98pci_restore_standard=
...
Warnings:
    drivers/pci/pci-driver.c:534:12: warning: unused function 'pci_restore_=
