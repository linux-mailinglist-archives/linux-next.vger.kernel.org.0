Return-Path: <linux-next+bounces-3907-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 410E097B78D
	for <lists+linux-next@lfdr.de>; Wed, 18 Sep 2024 07:56:13 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 52F831C21293
	for <lists+linux-next@lfdr.de>; Wed, 18 Sep 2024 05:56:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1C33E14A086;
	Wed, 18 Sep 2024 05:56:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="RJbPhR2g"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 97C6F320B;
	Wed, 18 Sep 2024 05:56:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1726638968; cv=none; b=HjBa7e+RyImU1Lvh4M0uqTFvIgsZ0sM5xZPdmbNJfTI9FVs3AnKBPyQMou1uz3vBnjqCuCvL+G62bmXQdN41lq/yCHvaj82J0ccf3/TaLuCTyROyF9/NTKslz6Y50p3U0nRMPbgXNYoGXX4bNJUtXUJIsLn/REXBB1NTU7BLOUo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1726638968; c=relaxed/simple;
	bh=nMyxo72snqgfOKy2372HgYYyiN3N17PQzsnFeOun6/g=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=LMXh2y43LqL3HbRdHDvKLSM7FPnJ97hLcVNCdhVspAVB35K3owbE7S/4Ok+pPV7Zv01NV72I6abmFiY4K/STfx+8g8v+iv4McgnMhCGJgQN8Vk51f+xlm7g8TrBi579kMk5SHUjTq2+IHbC4Xc6cbA9jolMWmOIO2oevv8/+XBk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=RJbPhR2g; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1726638960;
	bh=rIxY593/BwlC90SnVvqLX+74UvMHE+WrrAlqCs7zTCE=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4X7nvN5ZdXz4xQg;
	Wed, 18 Sep 2024 15:56:00 +1000 (AEST)
Date: Wed, 18 Sep 2024 15:56:00 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 18
Message-ID: <20240918155600.148a1190@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//YBBMrPEh459BkpsP8TYWTI";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_//YBBMrPEh459BkpsP8TYWTI
...
The exfat tree gained a build failure so I used the version from
next-20240917.

The risc-v tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 7044
 6906 files changed, 266957 insertions(+), 115963 deletions(-)
...
Merging origin/master (2f27fce67173 Merge tag 'sound-6.12-rc1' of git://git=
...
ph_dns_resolve_name())
Merging cifs/for-next (5ac1f99fdd09 smb: client: fix compression heuristic =
functions)
...
d mounts)
Merging exfat/dev (d70a477a063e exfat: resolve memory leak from exfat_creat=
e_upcase_table())
$ git reset --hard HEAD^
Merging next-20240917 version of exfat
CONFLICT (content): Merge conflict in fs/exfat/inode.c
[fs-next 6a0b48a7a56b] next-20240917/exfat
...
Merging fs-current (65ca1300d8e1 Merge branch 'fixes' of git://git.kernel.o=
...
Merging wireless/for-next (9410645520e9 Merge tag 'net-next-6.12' of git://=
...
Merging kbuild/for-next (c589902e95d4 kbuild: remove append operation on cm=
d_ld_ko_o)
...
S-form instructions)
  39190ac7cff1 ("powerpc/atomic: Use YZ constraints for DS-form instruction=
s")
...
Merging fs-next (a44000f2b0d8 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging amdgpu/drm-next (9d00d05e7579 drm/amd/display: handle nulled pipe c=
ontext in DCE110's set_drr())
...
eback on SM6350)
Merging drm-xe/drm-xe-next (8a677d5b0a20 drm/xe/display: Remove i915_drv.h =
include)
  1c129ed07de4 ("drm/xe: fix build warning with CONFIG_PM=3Dn")
  249df8cbecf0 ("drm/xe: fix missing 'xe_vm_put'")
  474f64cb988a ("drm/xe: Fix missing conversion to xe_display_pm_runtime_re=
sume")
  89076b5a8b4e ("drm/xe: prevent potential UAF in pf_provision_vf_ggtt()")
  9db969b36b2f ("drm/xe/xe2hpg: Add Wa_15016589081")
  cb85e39dc5d1 ("drm/xe: Suppress missing outer rpm protection warning")
  f2710d95724e ("drm/xe: Don't keep stale pointer to bo->ggtt_node")
...
Merging block/for-next (3685ba991cef Merge branch 'for-6.12/block' into for=
-next)
...
12' into spi-next)
Merging tip/master (154470612df5 Merge branch into tip/master: 'x86/timers')
...

=OPHD
-----END PGP SIGNATURE-----
