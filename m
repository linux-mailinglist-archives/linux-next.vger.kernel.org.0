...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A668E2FE3F7
	for <lists+linux-next@lfdr.de>; Thu, 21 Jan 2021 08:30:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727519AbhAUH37 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 21 Jan 2021 02:29:59 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:34893 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727637AbhAUH3h (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 21 Jan 2021 02:29:37 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DLvC45KSlz9sVF;
        Thu, 21 Jan 2021 18:28:48 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1611214128;
        bh=Fy1jcMHvX8uXxOQwZE70bS6vKguyu5pM7N77Qs8KddU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 21 Jan 2021 18:28:47 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 21
Message-ID: <20210121182847.04ee4e32@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/b+NN0fHblXXcVW1HakfG.nC";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/b+NN0fHblXXcVW1HakfG.nC
...
The drm-intel tree still had its build failure so I have used the version
from next-20210119.
...
Non-merge commits (relative to Linus' tree): 4450
 4859 files changed, 171464 insertions(+), 106097 deletions(-)
...
Merging origin/master (75439bc439e0 Merge tag 'net-5.11-rc5' of git://git.k=
...
ntry)
Merging powerpc-fixes/fixes (dd3a44c06f7b selftests/powerpc: Only test lwm/=
stmw on big endian)
...
Merging net/master (75439bc439e0 Merge tag 'net-5.11-rc5' of git://git.kern=
...
Merging tegra/for-next (818d95227f3f Merge branch for-5.12/arm64/defconfig =
into for-next)
...
Merging csky/linux-next (d44d44019287 csky: Using set_max_mapnr api)
...
ll-through)
Merging openrisc/for-next (ff28dae0bc90 drivers/soc/litex: Add restart hand=
ler)
...
in imxfb_probe())
Merging pm/linux-next (a31400ec480e Merge branch 'pm-clk' into linux-next)
...
Merging opp/opp/linux-next (08c0c8415156 opp: Prepare for ->set_opp() helpe=
...
ds bug)
Merging net-next/master (0fe2f273ab89 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/netdev/net)
Merging bpf-next/for-next (636d549f9133 Merge branch 'bpf: misc performance=
 improvements for cgroup')
...
Merging mac80211-next/master (0fe2f273ab89 Merge git://git.kernel.org/pub/s=
...
Merging drm/drm-next (a6b8720c2f85 Merge tag 'amd-drm-next-5.12-2021-01-20'=
...
$ git reset --hard HEAD^
Merging next-20210119 version of drm-intel
Merging drm-tegra/drm/tegra/for-next (dcdfe2712b68 drm/tegra: Fix reference=
 leak when pm_runtime_get_sync() fails)
Merging drm-misc/for-linux-next (d1a73c641afd drm/vmwgfx: Make sure we unpi=
n no longer needed buffers)
...
er DJM-750)
Merging sound-asoc/for-next (fe718b5f0db9 Merge remote-tracking branch 'aso=
...
, needs REGMAP_I2C)
Merging regulator/for-next (5b1b3b96eb7a Merge remote-tracking branch 'regu=
...
er)
Merging spi/for-next (408e7b920737 Merge remote-tracking branch 'spi/for-5.=
12' into spi-next)
...
a work queue)
Merging rcu/rcu/next (d36101e9c3d6 kcsan: Add missing license and copyright=
 headers)
...
Merging vhost/linux-next (84d899528f77 virtio-mem: Assign boolean values to=
 a bool variable)
...
rmation-fix)
Applying: mm: Fix ZONE_DEVICE usage in move_pfn_range_to_zone()
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (6d9ded83f38e secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=7Wf3
-----END PGP SIGNATURE-----
