Return-Path: <linux-next+bounces-2108-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D860B8B6B13
	for <lists+linux-next@lfdr.de>; Tue, 30 Apr 2024 09:04:37 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B20A0B21884
	for <lists+linux-next@lfdr.de>; Tue, 30 Apr 2024 07:04:34 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 63B4A1EF12;
	Tue, 30 Apr 2024 07:04:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="CP6VVujp"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DF4D71BF20;
	Tue, 30 Apr 2024 07:04:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1714460670; cv=none; b=mLMHRXJ9rWxWESg64okhvpNiew8FbaAa0qi7Yk2tn7el2WVxDg/giWEVh+pBVfDIGi5u21cR/lWqivqXqh45kVN8mRWpknbf+2t3Cxwg3H8E9hV3rcvNANbDhSxy5mheo/rc6M1L1JaLKtCMnldbbBeS1I3bbEJIWIfp/hV7ZbU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1714460670; c=relaxed/simple;
	bh=1xLxx2YZXApPHccC2TiTLlHs/bCqh9waEPdA27Pvsuo=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=AdHrqsFgouXqH3dRjhooMzrN5DqSqz7VyZuK3d3dj7rL0gTXtrGsWS3PGwzttipV8DMhKECQTYWcO49Pmj3Y+h7TknR70g2JvbbEGsG01skihCABJYdpVcKdo2ThxZxH3hjK/lGwlYnF+C5ncp198F22qhZihDy3X8yLtw5EFHE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=CP6VVujp; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1714460664;
	bh=k1v8y8n9i7nBsFoc5EARjuhZv20169IpEXbC2TMecxA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VTB5N0HH8z4wcd;
	Tue, 30 Apr 2024 17:04:24 +1000 (AEST)
Date: Tue, 30 Apr 2024 17:04:23 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 30
Message-ID: <20240430170423.45b66242@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/gj7pfEnvaAGgHvHqZT4hbXt";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/gj7pfEnvaAGgHvHqZT4hbXt
...
Merging origin/master (98369dccd2f8 Merge tag 'wq-for-6.9-rc6-fixes' of git=
...
Merging ipsec/master (58fbfecab965 xfrm: Preserve vlan tags for transport m=
ode software GRO)
...
Merging sound-current/for-linus (c158cf914713 ALSA: hda: intel-sdw-acpi: fi=
x usage of device_get_named_child_node())
...
Merging char-misc.current/char-misc-linus (ee59be35d7a8 misc/pvpanic-pci: r=
egister attributes via pci_driver)
...
xes)
Merging drm-misc-fixes/for-linux-next-fixes (e4236b14fe32 drm/imagination: =
...
nto for-next)
Merging samsung-krzk/for-next (87e058864108 Merge branch 'fixes' into for-n=
ext)
...
Merging bcachefs/for-next (59fa5f9ea20f bcachefs: Change destroy_inode to f=
ree_inode)
...
Merging v4l-dvb-next/master (4a7d735191de media: dw2102: fix coding style i=
ssues)
...
Merging net-next/main (89de2db19317 Merge tag 'for-netdev' of https://git.k=
...
Merging bpf-next/for-next (1bba3b3d373d selftests/bpf: validate nulled-out =
...
Merging bluetooth/master (b4208ba1661e Bluetooth: hci_conn: Use __counted_b=
y() to avoid -Wfamnae warning)
...
ux into drm-next)
Merging drm-misc/for-linux-next (75b68f22e39a drm: ci: fix the xfails for a=
pq8016)
Merging amdgpu/drm-next (aa463cc850c4 drm/amd/display: Fix CFLAGS for dml2_=
core_dcn4_calcs.o)
Merging drm-intel/for-linux-next (41b088a26803 drm/i915/display: split out =
intel_sprite_regs.h from i915_reg.h)
...
Merging drm-xe/drm-xe-next (4caf410766ad drm/xe: Merge 16021540221 and 1803=
4896535 WAs)
...
for-next)
Merging ieee1394/for-next (b66fde5b9bc2 firewire: core: add tracepoints eve=
nts for asynchronous outbound response)
Merging sound-asoc/for-next (8b56e4bd1abe Merge remote-tracking branch 'aso=
...
Merging char-misc/char-misc-next (0b6896838d6a Merge tag 'w1-drv-6.10' of h=
ttps://git.kernel.org/pub/scm/linux/kernel/git/krzk/linux-w1 into char-misc=
-next)
...
Merging pinctrl-samsung/for-next (f9c744747973 pinctrl: samsung: support a =
bus clock)
...

=0nha
-----END PGP SIGNATURE-----
