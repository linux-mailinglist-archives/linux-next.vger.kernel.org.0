...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5FDF44B6732
	for <lists+linux-next@lfdr.de>; Tue, 15 Feb 2022 10:14:16 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232376AbiBOJNd (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 15 Feb 2022 04:13:33 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:35046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232125AbiBOJNc (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 15 Feb 2022 04:13:32 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 598B424BFE;
        Tue, 15 Feb 2022 01:13:20 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Jyb3f49Yyz4xsm;
        Tue, 15 Feb 2022 20:13:18 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1644916398;
        bh=hskPQYuHJc/GEPR4X8MV14bqG37o1IZuLfxQYrmccPY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 15 Feb 2022 20:13:14 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 15
Message-ID: <20220215201314.04247aac@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=UBL_5GF8XXDygHYZrJ7KOg";
...
--Sig_/=UBL_5GF8XXDygHYZrJ7KOg
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220214:
...
The spi tree gained a semantic conflict against the net-next tree.

The folio tree lost its build failure but gained another for which I
applied a patch. It also had a large complex conflict agains the
akpm-current tree, so I used the version from next-20220204 again.

The akpm-current tree lost its build failure.

Non-merge commits (relative to Linus' tree): 5347
 5802 files changed, 227739 insertions(+), 87823 deletions(-)
...
Merging origin/master (d567f5db412e Merge tag 'regulator-fix-v5.17-rc4' of =
...
Merging net/master (6605cc67ca18 USB: zaurus: support another broken Zaurus)
...
Merging usb.current/usb-linus (754e0b0e3560 Linux 5.17-rc4)
...
Merging staging.current/staging-linus (754e0b0e3560 Linux 5.17-rc4)
...
Merging kspp-gustavo/for-next/kspp (eb29c492def3 tpm: xen-tpmfront: Use str=
uct_size() helper)
Merging kbuild/for-next (a9bed2a9f967 kbuild: replace $(if A,A,B) with $(or=
 A,B))
Merging perf/perf/core (59835f55ce02 perf map: Make map__contains_symbol() =
args const)
...
Merging parisc-hd/for-next (6e8793674bb0 serial: parisc: GSC: fix build whe=
n IOSAPIC is not set)
...
Merging btrfs/for-next (e8c41b2cf1d9 Merge branch 'for-next-next-v5.17-2022=
0214' into for-next-20220214)
Merging ceph/master (038b8d1d1ab1 libceph: optionally use bounce buffer on =
recv path in crc mode)
Merging cifs/for-next (0c6f4ebf8835 cifs: modefromsids must add an ACE for =
authenticated users)
...
with symlinks)
Merging nfsd/for-next (e6bdccf29c3c arch: Remove references to CONFIG_NFSD_=
V3 in the default configs)
...
a bit)
Merging printk/for-next (8e3ed297995c Merge branch 'for-5.18-panic-deadlock=
s' into for-next)
...
Merging pm/linux-next (d4e043a4af96 Merge branch 'devprop' into linux-next)
...
Merging rdma/for-next (2f1b2820b546 Merge branch 'irdma_dscp' into rdma.git=
 for-next)
Merging net-next/master (12d8c11198af selftests: net: cmsg_sender: Fix spel=
ling mistake "MONOTINIC" -> "MONOTONIC")
...
Merging drm-intel/for-linux-next (4feb2e9eb95f drm/i915: fix drm_i915.h inc=
lude grouping and sorting)
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/dp/drm_dp.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/i915_module.c
[master eec0f6a37559] next-20220214/drm-intel
...
Merging sound-asoc/for-next (0191899db468 ASoC: Add Euro Headset support fo=
r wcd938x codec)
...
Applying: fix up for "pi: make remove callback a void function"
Merging tip/auto-latest (8a3d8d8a3c55 Merge locking/core into tip/master)
...
m-master/next)
Merging kvms390/next (5e35d0eb472b KVM: s390: Update api documentation for =
memop ioctl)
...
Merging usb/usb-next (fbd533e90d23 Merge 5.17-rc4 into usb-next)
...
der_alloc())
Merging folio/for-next (f7d1273caebb selftests/vm/transhuge-stress: Support=
...
Merging akpm-current/current (1a5c924aca2d ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
...
Merging akpm/master (10a64d66e319 Merge branch 'akpm-current/current')
...

=I6aA
-----END PGP SIGNATURE-----
