...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E91E048D1A2
	for <lists+linux-next@lfdr.de>; Thu, 13 Jan 2022 05:24:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229743AbiAMEXD (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 12 Jan 2022 23:23:03 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39694 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229926AbiAMEXC (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 12 Jan 2022 23:23:02 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 852BCC06173F;
        Wed, 12 Jan 2022 20:22:54 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JZB9h2Mprz4y4c;
        Thu, 13 Jan 2022 15:22:48 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1642047768;
        bh=FwJ6e75sNj6S2rBpxZvG3cB5VoYp7hpjGiGgbjTkhLk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 13 Jan 2022 15:22:47 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 13
Message-ID: <20220113152247.3f7c6c49@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/oF/tCNqrj1v=KgduYoKYLy+";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/oF/tCNqrj1v=KgduYoKYLy+
...
Non-merge commits (relative to Linus' tree): 4076
 4615 files changed, 178086 insertions(+), 81390 deletions(-)
...
Merging origin/master (81ff0be4b9e3 Merge tag 'spdx-5.17-rc1' of git://git.=
...
Merging net/master (2716a5271d54 Merge branch 'arm-ox810se-add-ethernet-sup=
port')
...
Merging drm-misc-fixes/for-linux-next-fixes (0499f419b76f video: vga16fb: O=
nly probe for EGA and VGA 16 color graphic cards)
...
ATC2603C PMIC)
Merging amlogic/for-next (1c1475389af0 arm64: dts: add support for S4 based=
 Amlogic AQ222)
...
mon clk)
Merging parisc-hd/for-next (df0cc57e057f Linux 5.16)
...
Merging pci/next (455be0fcacff Merge branch 'pci/driver-cleanup')
...
B-C Annex C)
Merging pm/linux-next (3b30545fac39 Merge branches 'acpi-x86', 'acpi-tables=
...
Merging amdgpu/drm-next (b4646327617f drm/amdgpu: bump driver version for n=
...
Merging modules/modules-next (ca321ec74322 module.h: allow #define strings =
to work with MODULE_IMPORT_NS)
...
n kobj_type)
Merging libata/for-next (7914e9624dd7 ata: ahci: Add support for AMD A85 FC=
H (Hudson D4))
...
Merging akpm/master (b8498d54b3bd mm: hide the FRONTSWAP Kconfig symbol)
...

=e1Tm
-----END PGP SIGNATURE-----
