Return-Path: <linux-next+bounces-4822-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 8CD3D9D3377
	for <lists+linux-next@lfdr.de>; Wed, 20 Nov 2024 07:15:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id E67AD1F2386A
	for <lists+linux-next@lfdr.de>; Wed, 20 Nov 2024 06:15:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6CA0815A85A;
	Wed, 20 Nov 2024 06:15:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="JLC/n8Fj"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4E579158208;
	Wed, 20 Nov 2024 06:15:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1732083309; cv=none; b=oDv00S/frFHMAFXYx/uxIfVMbtZZlSnaxfIS5ZkJc/oOP6R+BOujm/T7ondnP0bN974p1GyKdscNxtNSASvOFgrIzlTdo3MNup5MONI9W+TiqcC29W4iJAXrGemmJyQmmld8di8jbHYUEDtK9D6Bb1q4zJqLuo2u0PtLd8nLZnM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1732083309; c=relaxed/simple;
	bh=sX3v63d6iTu8NbamSYVIpfIxd6SOJqPiqiPXFcNoUTk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=Uz8WRVDkITVJEzhDAtvPs//C9/22HulY2mOcE4AHsNE5QvSkZYIPnCsycHqnck/yR1MefyOzvA0J0gcsPV3T+nzIyTT6cFH20P9mjpbokMdy2s6BbMOK02Tiq9eCX0WuGBnQsbt9ofI4yNTvhfShSZjuEDUbG+8E3r4yzXGFgVI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=JLC/n8Fj; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1732083300;
	bh=FYgVK6OdeG3PS238/lKl1kpZQjG4aJ7n6GQcVjMTk+A=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XtWLD4lyYz4x2J;
	Wed, 20 Nov 2024 17:15:00 +1100 (AEDT)
Date: Wed, 20 Nov 2024 17:15:03 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 20
Message-ID: <20241120171503.355ed2ab@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/FSN230DkVHbwkRfRyEvQmWA";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/FSN230DkVHbwkRfRyEvQmWA
...
Changes since 20241119:

The ceph tree gained a conflict against the net tree.

Non-merge commits (relative to Linus' tree): 9947
 12375 files changed, 459653 insertions(+), 325478 deletions(-)
...
Merging origin/master (d8d78a90e7fc Merge tag 'x86_cpu_for_v6.13' of git://=
...
Merging cifs/for-next (3bb216c527e4 smb: During unmount, ensure all cached =
...
Merging fs-current (fb10a97cf34a Merge branch 'next-fixes' of git://git.ker=
...
Merging s390-fixes/fixes (0338cd9c22d1 Merge tag 's390-6.13-1' of git://git=
.kernel.org/pub/scm/linux/kernel/git/s390/linux)
Merging net/main (66418447d27b Merge branch 'bpf-fix-recursive-lock-and-add=
-test')
...
-linus)
Merging sound-asoc-fixes/for-linus (0109ee00788e ASoC: amd: Fix build depen=
dencies for `SND_SOC_AMD_PS`)
Merging regmap-fixes/for-linus (8cf0b93919e1 Linux 6.12-rc2)
Merging regulator-fixes/for-linus (98eb9e0ac375 Merge remote-tracking branc=
h 'regulator/for-6.12' into regulator-linus)
Merging spi-fixes/for-linus (4191381fdc10 Merge remote-tracking branch 'spi=
...
Merging s390/for-next (0338cd9c22d1 Merge tag 's390-6.13-1' of git://git.ke=
...
Merging fs-next (72f346d487b0 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging printk/for-next (4022ef25504d Merge branch 'for-6.13-force-console'=
 into for-next)
Merging pci/next (0042c0592384 Merge branch 'pci/typos')
...
Merging pm/linux-next (112d2e1ef536 Merge branch 'thermal' into linux-next)
...
evice suspend)
Merging net-next/main (dd7207838d38 Merge git://git.kernel.org/pub/scm/linu=
...
rammar)
Merging mtd/mtd/next (34267d3c26fe Merge tag 'spi-nor/for-6.13' of git://gi=
...
Merging sound-asoc/for-next (0109ee00788e ASoC: amd: Fix build dependencies=
 for `SND_SOC_AMD_PS`)
Merging modules/modules-next (2466b3120142 tests/module/gen_test_kallsyms.s=
h: use 0 value for variables)
Merging input/next (470a271627e8 Input: ads7846 - increase xfer array size =
in 'struct ser_req')
Merging block/for-next (6910abe3ea68 Merge branch 'for-6.13/block' into for=
-next)
...
Merging regulator/for-next (98eb9e0ac375 Merge remote-tracking branch 'regu=
...
pile testing)
Merging spi/for-next (4191381fdc10 Merge remote-tracking branch 'spi/for-6.=
12' into spi-linus)
Merging tip/master (d5546ad1b9b1 Merge branch into tip/master: 'x86/tdx')
...
dac-for-next)
Merging ftrace/for-next (42388da3d3bd Merge tools/for-next)
...
.01a' into HEAD)
Merging kvm/next (9ee62c33c0fe KVM: x86: Break CONFIG_KVM_X86's direct depe=
ndency on KVM_INTEL || KVM_AMD)
...

=M89z
-----END PGP SIGNATURE-----
