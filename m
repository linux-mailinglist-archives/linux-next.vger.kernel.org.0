Return-Path: <linux-next+bounces-9062-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 26552C669F3
	for <lists+linux-next@lfdr.de>; Tue, 18 Nov 2025 01:10:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 078A935DB54
	for <lists+linux-next@lfdr.de>; Tue, 18 Nov 2025 00:08:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E442A3FF1;
	Tue, 18 Nov 2025 00:08:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="Nt1G3Bbc"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 05D06A41;
	Tue, 18 Nov 2025 00:08:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763424512; cv=none; b=b3aY+KtyydRU+E1vgVdVp/bUlGa4fmZnxuwRDgsyuzzYt8zG7nmdGen7PVFywE9PLNwaqGuQ2oDu3UU5avZrTkKQeCXi+YOIe+Z5y9XvZNhzm2eBf5ZFkvys2rLxXJhDv0XBuDDh8bhEMOr/wgzkLHzfA7nWj6puGqCWM3kT8Mk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763424512; c=relaxed/simple;
	bh=JEFzxhHMlV/DrFAwj7d9mHF3zGh9/jEaFJ9+WaFdhNI=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=dtAbw984OSlAVz+rlfm8WOEAQ/h1rlM3poIvb2Uy5LRerl4jnV7KIvi3AprD8hPP5xuJG8wstk8T963otRK2w7uyNybOqSomjT1FZOK/LYZCgZ1vDT3KO32G5CB56D0/5d7jNtuI5KJM8nGxolloQaYsS2SkDKdTyo2EX+QAs9E=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=Nt1G3Bbc; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1763424503;
	bh=WZPNQUCXzVypryHMt7ikmiac18x3SwlOdzCXXj6ignQ=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4d9Q1g2SNSz4wCZ;
	Tue, 18 Nov 2025 11:08:23 +1100 (AEDT)
Date: Tue, 18 Nov 2025 11:08:22 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Christian Brauner <brauner@kernel.org>, Heiko Carstens
 <hca@linux.ibm.com>, Vasily Gorbik <gor@linux.ibm.com>, Christian
 Borntraeger <borntraeger@de.ibm.com>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>, Linux Next
 Mailing List <linux-next@vger.kernel.org>
Subject: linux-next: manual merge of the vfs-brauner tree with the s390 tree
Message-ID: <20251118110822.72e36c15@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/09=LvoIqtFNA=7+m/f8uYdu";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/09=LvoIqtFNA=7+m/f8uYdu
...
between commit:
  ...
  4ac286c4a8d9 ("s390/syscalls: Switch to generic system call table generat=
ion")
...
@@@ -3,396 -3,473 +3,397 @@@
 ...
 -156  common	sched_setscheduler	sys_sched_setscheduler		sys_sched_setsched=
uler
 -157  common	sched_getscheduler	sys_sched_getscheduler		sys_sched_getsched=
uler
 -158  common	sched_yield		sys_sched_yield			sys_sched_yield
 -159  common	sched_get_priority_max	sys_sched_get_priority_max	sys_sched_g=
et_priority_max
 -160  common	sched_get_priority_min	sys_sched_get_priority_min	sys_sched_g=
et_priority_min
 -161  common	sched_rr_get_interval	sys_sched_rr_get_interval	sys_sched_rr_=
get_interval_time32
 ...
 -177  common	rt_sigtimedwait		sys_rt_sigtimedwait		compat_sys_rt_sigtimedw=
ait_time32
 -178  common	rt_sigqueueinfo		sys_rt_sigqueueinfo		compat_sys_rt_sigqueuei=
nfo
 ...
 -239  common	sched_setaffinity	sys_sched_setaffinity		compat_sys_sched_set=
affinity
 -240  common	sched_getaffinity	sys_sched_getaffinity		compat_sys_sched_get=
affinity
 ...
 -262  common	clock_nanosleep		sys_clock_nanosleep		sys_clock_nanosleep_tim=
e32
 ...
 -274  common	mq_timedreceive		sys_mq_timedreceive		sys_mq_timedreceive_tim=
e32
 ...
 -304  common	set_robust_list		sys_set_robust_list		compat_sys_set_robust_l=
ist
 -305  common	get_robust_list		sys_get_robust_list		compat_sys_get_robust_l=
ist
 -306  common	splice			sys_splice			sys_splice
 -307  common	sync_file_range		sys_sync_file_range		compat_sys_s390_sync_fi=
le_range
 ...
 -330  common	rt_tgsigqueueinfo	sys_rt_tgsigqueueinfo		compat_sys_rt_tgsigq=
ueueinfo
 ...
 -336  common	open_by_handle_at	sys_open_by_handle_at		compat_sys_open_by_h=
andle_at
 ...
 -342  common	s390_runtime_instr	sys_s390_runtime_instr		sys_s390_runtime_i=
nstr
 ...
 -352  common	s390_pci_mmio_write	sys_s390_pci_mmio_write		sys_s390_pci_mmi=
o_write
 -353  common	s390_pci_mmio_read	sys_s390_pci_mmio_read		sys_s390_pci_mmio_=
read
 ...
 -378  common	s390_guarded_storage	sys_s390_guarded_storage	sys_s390_guarde=
d_storage
 ...
 -425  common	io_uring_setup		sys_io_uring_setup              sys_io_uring_=
setup
 -426  common	io_uring_enter		sys_io_uring_enter              sys_io_uring_=
enter
 -427  common	io_uring_register	sys_io_uring_register           sys_io_urin=
g_register
...

=MI7D
-----END PGP SIGNATURE-----
