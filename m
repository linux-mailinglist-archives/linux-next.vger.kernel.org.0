...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 36E3A7D0805
	for <lists+linux-next@lfdr.de>; Fri, 20 Oct 2023 07:59:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346945AbjJTF7Q (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 20 Oct 2023 01:59:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38914 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1346955AbjJTF7P (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 20 Oct 2023 01:59:15 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9231CCA;
        Thu, 19 Oct 2023 22:59:10 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1697781548;
        bh=DDGgbDW0wvN6bQ3ADm10XkHl4KmeJBJnlF288JDFlBE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SBYn85lFcz4xc0;
        Fri, 20 Oct 2023 16:59:08 +1100 (AEDT)
Date:   Fri, 20 Oct 2023 16:59:06 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 20
Message-ID: <20231020165906.23fae35a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dG8ur6Hk+IdJJjmUX3QrtFT";
...
Merging origin/master (ce55c22ec8b2 Merge tag 'net-6.6-rc7' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/netdev/net)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (b303d64414d4 mm/vmalloc: fix the =
...
Merging net/main (ce55c22ec8b2 Merge tag 'net-6.6-rc7' of git://git.kernel.=
...
h_ifid())
Merging netfilter/main (9b9ac46c6cb5 Merge tag 'nf-23-10-18' of https://git=
...
pending lowedirs)
Merging drm-misc-fixes/for-linux-next-fixes (3d887d512494 drm/dp_mst: Fix N=
ULL deref in get_mst_branch_device_by_guid_helper())
...
a comment)
Merging mm/mm-everything (9b8866cb3a10 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging parisc-hd/for-next (9e41b787139b parisc: Add nop instructions after=
 TLB inserts)
...
riant)
Merging bcachefs/for-next (4cab3327d19e bcachefs: Refactor memcpy into dire=
ct assignment)
...
Merging cpufreq-arm/cpufreq/arm/linux-next (734499581610 dt-bindings: cpufr=
eq: qcom-cpufreq-nvmem: Document krait-cpu)
...
age)
Merging rdma/for-next (45cfa8864cd3 RDMA/bnxt_re: Do not report SRQ error i=
n srq notification)
CONFLICT (content): Merge conflict in drivers/infiniband/hw/mlx5/mr.c
Merging net-next/main (7ce6936045ba Merge branch 'tools-ynl-gen-support-ful=
l-range-of-min-max-checks')
Merging bpf-next/for-next (bab8ac3c5339 Merge branch 'add-open-coded-task-c=
ss_task-and-css-iters')
...
()"
Merging amdgpu/drm-next (2263ad57d570 drm/amd/display: Fix stack size issue=
 on DML2)
...
Merging sound/for-next (e6d0c13e9f46 ALSA: hda: i915: Remove extra argument=
 from snd_hdac_i915_init)
...
Applying: fix for bad merge of "ASoC: SOF: Intel: Move binding to display d=
river outside of deferred probe"
...
ta())
Merging block/for-next (e04e1c14ca40 Merge branch 'for-6.7/io_uring-sockopt=
' into for-next)
...
Merging kvm-arm/next (0a3a1665cbc5 Merge branch kvm-arm64/stage2-vhe-load i=
nto kvmarm/next)
...
Merging vhost/linux-next (dc9f4dd7eb5d virtio_pci: add check for common cfg=
 size)
...
mounts)
Merging bitmap/bitmap-for-next (d7db0ddfaf5c lib/bitmap: add compile-time t=
...

=mVlF
-----END PGP SIGNATURE-----
