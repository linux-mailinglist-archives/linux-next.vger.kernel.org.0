Return-Path: <linux-next+bounces-788-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 8291C835914
	for <lists+linux-next@lfdr.de>; Mon, 22 Jan 2024 02:03:13 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 2A6D328243D
	for <lists+linux-next@lfdr.de>; Mon, 22 Jan 2024 01:03:12 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7B28EFBF2;
	Mon, 22 Jan 2024 01:01:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="RTXsmsBb"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4E6F5FBED;
	Mon, 22 Jan 2024 01:01:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1705885295; cv=none; b=tlBMG6VySufIk9x1+GKE/Y7HNy8q3qQqjE5UOMYWlMuwuHkhWlvmvTDag5zekImNUIaDZ4mOD9xzUyp61k2TAdoosYjkMMDsbMQTJV50DsR61h69Wzi8IC1/fNnoZJx96i8waxpYcAmcNPJkmT+yD43RxVYbenTSzd7C+FChEt0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1705885295; c=relaxed/simple;
	bh=g/rtdffFVNmsZGrSqpXrUApfqiAfoC6s3zE1hGyG8aY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=nXIj3Z0igR8GKNTchMz2OYf3w2eRFwr6JcuSg9acIqMF5/RMx/Ml+FfHcKR3MyaQBqIEPKHEeEQW0A3KgbHLATNu2vAcZuhLP0LfATwNBk2m5csYvMFu4M6JRFS8ECVd8pVj+P9kUhlU0YlWWFQF9Lzss4x28YqoAKcSEt/XALQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=RTXsmsBb; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1705885287;
	bh=ppRoZ9H+GTfD1V8oDqHdFmmaNyRWHr+tEBn9sOgH1iA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TJBkH3bfMz4wqN;
	Mon, 22 Jan 2024 12:01:27 +1100 (AEDT)
Date: Mon, 22 Jan 2024 12:01:26 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 22
Message-ID: <20240122120126.19a57ff5@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/q3cDLXC63upJj0DjB4coXjY";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/q3cDLXC63upJj0DjB4coXjY
...
Merging origin/master (4fbbed787267 Merge tag 'timers-core-2024-01-21' of g=
...
Merging net/main (359724fa3ab7 idpf: distinguish vports by the dev_port att=
ribute)
Merging bpf/master (736b5545d39c Merge tag 'net-6.8-rc1' of git://git.kerne=
...
e IP)
Merging driver-core.current/driver-core-linus (7a396820222d Merge tag 'v6.8=
-rc-part2-smb-client' of git://git.samba.org/sfrench/cifs-2.6)
Merging tty.current/tty-linus (7a396820222d Merge tag 'v6.8-rc-part2-smb-cl=
ient' of git://git.samba.org/sfrench/cifs-2.6)
Merging usb.current/usb-linus (7a396820222d Merge tag 'v6.8-rc-part2-smb-cl=
ient' of git://git.samba.org/sfrench/cifs-2.6)
...
Merging phy/fixes (2a9c713825b3 phy: sunplus: return negative error code in=
 sp_usb_phy_probe)
Merging staging.current/staging-linus (7a396820222d Merge tag 'v6.8-rc-part=
2-smb-client' of git://git.samba.org/sfrench/cifs-2.6)
Merging iio-fixes/fixes-togreg (456159bdfb8c iio: adc: ad7091r8: Fix error =
code in ad7091r8_gpio_setup())
Merging counter-current/counter-current (a39b6ac3781d Linux 6.7-rc5)
Merging char-misc.current/char-misc-linus (7a396820222d Merge tag 'v6.8-rc-=
part2-smb-client' of git://git.samba.org/sfrench/cifs-2.6)
...
Merging dmaengine-fixes/fixes (cb95a4fa50bb dmaengine: dw-edma: increase si=
ze of 'name' in debugfs code)
...
Merging risc-v-fixes/fixes (e5075d8ec564 Merge tag 'riscv-for-linus-6.8-mw4=
...
Merging spdx/spdx-linus (7a396820222d Merge tag 'v6.8-rc-part2-smb-client' =
...
Merging pmdomain-fixes/fixes (0cb19e50a911 pmdomain: arm: Avoid polling for=
 scmi_perf_domain)
Merging overlayfs-fixes/ovl-fixes (6f853d7185f5 ovl: require xwhiteout feat=
ure flag on layer roots)
...
o mm-everything)
Merging kbuild/for-next (e5075d8ec564 Merge tag 'riscv-for-linus-6.8-mw4' o=
...
Merging parisc-hd/for-next (f2a86d0add3d parisc: Fix random data corruption=
 from exception handler)
Merging powerpc/next (44a1aad2fe6c Merge branch 'topic/ppc-kvm' into next)
Merging soc-fsl/next (fb9c384625dd bus: fsl-mc: fsl-mc-allocator: Drop a wr=
ite-only variable)
Merging risc-v/for-next (e5075d8ec564 Merge tag 'riscv-for-linus-6.8-mw4' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
...
Merging sh/for-next (99fe83ab3bb0 sh: vsyscall: Remove unnecessary $(foreac=
h ...))
...
ist on errors)
Merging cifs/for-next (251bfe557e2e cifs: set replay flag for retries of wr=
ite command)
...
ezable kthread)
Merging ksmbd/ksmbd-for-next (0b6fabcaf1c1 smb: Fix some kernel-doc comment=
s)
...
Merging crypto/master (b8910630c967 crypto: iaa - Account for cpu-less numa=
 nodes)
Merging drm/drm-next (009f0a64f9cc Merge tag 'drm-xe-next-fixes-2024-01-16'=
...
Merging fbdev/for-next (e421946be7d9 fbdev: sis: Error out if pixclock equa=
ls zero)
...
Merging input/next (d259f137461b dt-bindings: input: touchscreen: goodix: c=
larify irq-gpios misleading text)
...
Merging driver-core/driver-core-next (7a396820222d Merge tag 'v6.8-rc-part2=
-smb-client' of git://git.samba.org/sfrench/cifs-2.6)
Merging usb/usb-next (7a396820222d Merge tag 'v6.8-rc-part2-smb-client' of =
...
Merging tty/tty-next (7a396820222d Merge tag 'v6.8-rc-part2-smb-client' of =
git://git.samba.org/sfrench/cifs-2.6)
Merging char-misc/char-misc-next (7a396820222d Merge tag 'v6.8-rc-part2-smb=
-client' of git://git.samba.org/sfrench/cifs-2.6)
...
Merging staging/staging-next (7a396820222d Merge tag 'v6.8-rc-part2-smb-cli=
ent' of git://git.samba.org/sfrench/cifs-2.6)
...

=Raf5
-----END PGP SIGNATURE-----
