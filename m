Return-Path: <linux-next+bounces-3988-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CACAD987D75
	for <lists+linux-next@lfdr.de>; Fri, 27 Sep 2024 06:07:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 71E05284AF6
	for <lists+linux-next@lfdr.de>; Fri, 27 Sep 2024 04:07:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BDBC5170854;
	Fri, 27 Sep 2024 04:07:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="VDa/RA7p"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1B1851684A8;
	Fri, 27 Sep 2024 04:06:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727410023; cv=none; b=S2EfUVJ0vSq0he0sNNzRfcSsuT2Qxjb+WrM5XnytrH49p4+CVsO/i7X/xnNrHN50xksseoXmoM/TnslkshiHuzXCHlt6d0BSwys6xcnkNAPncHfmR9aUI5ahQIcoZYmWnie1NrqxGZorTglqDq9YgstDsRA9lMkHvEvhcKLzypk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727410023; c=relaxed/simple;
	bh=EqjJP8NoBzdT5GkzwntdEqxN9qj9jvYEz0qfUck+nGA=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=N9U1g/TiOG4eWV+p41Gd1bRVsesnfO81m179srPxdgyRZ0Uywml9gqnTfu4LiAUHUn3HfhNZV5dMRfYnb2VkcRIUnNpyLPEInvXQPUI1WcQf6R5BIcbFXll7fKxpyQXFAlsd8xpNVwVfpUCQZGiuA2WJsFiU7ARpGU8ZRgNFfxU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=VDa/RA7p; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1727410010;
	bh=FGDxZ8RgZpm8lTp+vFPd5eF1mi3MA0QeoEsYSDPE4Uc=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XFH3F6hQLz4xRB;
	Fri, 27 Sep 2024 14:06:49 +1000 (AEST)
Date: Fri, 27 Sep 2024 14:06:49 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 27
Message-ID: <20240927140649.616500b8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=KX3C42+tpO8AwLksC3i6q9";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/=KX3C42+tpO8AwLksC3i6q9
...
The bcachefs tree gained a semantic conflict against the mm-hotfixes tree.

The ftrace tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 874
 961 files changed, 22059 insertions(+), 10311 deletions(-)
...
Merging origin/master (075dbe9f6e3c Merge tag 'soc-ep93xx-dt-6.12' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/soc/soc)
Merging fixes/fixes (3441845808aa rust: cfi: fix `patchable-function-entry`=
 starting version)
...
Merging cifs/for-next (3d6d647388f5 smb: client: make SHA-512 TFM ephemeral)
...
_to_fd())
Merging mm-hotfixes/mm-hotfixes-unstable (e29c073545d6 kthread: Unpark only=
 parked kthread)
Merging fs-current (f15191200f47 Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (aef3a58b06fa Merge tag 'nf-24-09-26' of git://git.kernel.=
...
rnet inexact list)
Merging netfilter/main (76f1ed087b56 netfilter: uapi: NFTA_FLOWTABLE_HOOK i=
s NLA_NESTED)
...
Merging hwmon-fixes/hwmon (dc4766de906c hwmon: (adt7475) Fix memory leak in=
...
stc 1.83.0)
  af6017b6a315 ("rust: cfi: fix `patchable-function-entry` starting version=
")
...
Merging perf/perf-tools-next (77b004f4c5c3 perf symbol: Do not fixup end ad=
dress of labels)
...
ent)
Merging sh/for-next (51de2ae5fc59 sh: intc: Replace simple_strtoul() with k=
strtoul())
...
Merging fs-next (7495509d052c Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging bluetooth/master (394cf44ded5e Bluetooth: btnxpuart: Rename IW615 t=
o IW610)
...
ntf fails for hmac)
Merging drm/drm-next (22512c3ee0f4 Merge tag 'drm-intel-next-fixes-2024-09-=
26' of https://gitlab.freedesktop.org/drm/i915/kernel into drm-next)
...
eback on SM6350)
Merging drm-xe/drm-xe-next (ee615c2bac4c drm/xe: Move IRQ-related registers=
 to dedicated header)
...
Merging fbdev/for-next (2555906fd53e fbcon: break earlier in search_fb_in_m=
ap and search_for_mapped_con)
...
11' into spi-linus)
Merging tip/master (33a082493a69 Merge branch into tip/master: 'x86/splitlo=
ck')
...
CONFLICT (content): Merge conflict in kernel/trace/trace_uprobe.c
...
o for-next)
Merging sched-ext/for-next (6f34d8d382d6 sched_ext: Use shorter slice while=
 bypassing)
...

=T0SI
-----END PGP SIGNATURE-----
