...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id F422110D0C2
	for <lists+linux-next@lfdr.de>; Fri, 29 Nov 2019 05:20:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726856AbfK2EUc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 28 Nov 2019 23:20:32 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:36575 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726764AbfK2EUb (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 28 Nov 2019 23:20:31 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47PLs16DSBz9sPj;
        Fri, 29 Nov 2019 15:20:21 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1575001221;
        bh=oEMUMT8K2sw3/7nJn1lxlMUn1tu/2eA1wN3dqS/hd2g=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 29 Nov 2019 15:20:20 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 29
Message-ID: <20191129152020.47767479@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/xqYw88Y2TpEB8RKjCk9ylDG";
...
Non-merge commits (relative to Linus' tree): 4529
 4362 files changed, 149913 insertions(+), 69780 deletions(-)
...
Merging origin/master (81b6b96475ac Merge branch 'master' of git://git.kern=
el.org/pub/scm/linux/kernel/git/torvalds/linux; tag 'dma-mapping-5.5' of gi=
t://git.infradead.org/users/hch/dma-mapping)
...
Merging net/master (a6ed68d6468b Merge tag 'drm-next-2019-11-27' of git://a=
nongit.freedesktop.org/drm/drm)
Merging bpf/master (7c3977d1e804 libbpf: Fix sym->st_value print on 32-bit =
arches)
...
desc_size)
Merging sound-current/for-linus (336820c4374b ALSA: hda/realtek - Fix inver=
ted bass GPIO pin on Acer 8951G)
...
Merging iomap/iomap-for-next (fb05013b88a9 iomap: Fix page_mkwrite off-by-o=
ne errors)
...
unctions for cq)
Merging net-next/master (a6ed68d6468b Merge tag 'drm-next-2019-11-27' of gi=
...
ing)
Merging bluetooth/master (22cc6b7a1dbb Bluetooth: btusb: fix non-atomic all=
ocation in completion handler)
...
-next)
Merging sound/for-next (336820c4374b ALSA: hda/realtek - Fix inverted bass =
GPIO pin on Acer 8951G)
...
rflow
Merging akpm/master (ab645f71ede0 drivers/media/platform/sti/delta/delta-ip=
...

=j6ZS
-----END PGP SIGNATURE-----
