Return-Path: <linux-next+bounces-1943-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id EFF5F8A657F
	for <lists+linux-next@lfdr.de>; Tue, 16 Apr 2024 09:55:55 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 110A41C223D1
	for <lists+linux-next@lfdr.de>; Tue, 16 Apr 2024 07:55:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 21F5984FD8;
	Tue, 16 Apr 2024 07:55:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="LIGixwQ9"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9EBF87FBBA;
	Tue, 16 Apr 2024 07:55:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1713254140; cv=none; b=D4P0yj2xhG56q0FStlsJOBuv6qw1j8D+ucyAp9zCNo6TJfEukpQbr8UqXsL3iACWVV7oS3aOTDoqvK4zLkRVv03mU84R5h2ICytqijMftmdV1aWtan3XMxJk2sAFKhMulnkTZcMd9zIXwxIW74CjoFquc/B/kDsU1ikOOgHAJ7E=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1713254140; c=relaxed/simple;
	bh=HbNUei9yNKsmpf286AGh7VfznUtRkJnnWNhJpoPVao4=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=RGKGcD5Jqxwj9dmsRuLaVvfzoB33m4+fxxbvD9T/CNfapcTy+d1NjjvCJEeqkWafmhF2rVD7OOVYVSCcBtM0PrVF1kgFbSc6jXEw3mN1B9sGTCgD3lrVNVPm9h7OBTDkePX+SXO/y9YN1fY9uhCY8kHPINSbZCyjuuuG+xm3csA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=LIGixwQ9; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1713254133;
	bh=UL3G2JapSz+SeMhs4KZIlyjU/cSrim6u8r9phi4fDz0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VJbts4WVDz4x1P;
	Tue, 16 Apr 2024 17:55:33 +1000 (AEST)
Date: Tue, 16 Apr 2024 17:55:32 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 16
Message-ID: <20240416175532.5c17390d@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/xJMFM5/SjWM3DH_QXzSZezI";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/xJMFM5/SjWM3DH_QXzSZezI
...
Merging mm-hotfixes/mm-hotfixes-unstable (aaeda6237dec bootconfig: use memb=
lock_free_late to free xbc memory to buddy)
...
Merging net/main (75ce9506ee3d octeontx2-pf: fix FLOW_DIS_IS_FRAGMENT imple=
mentation)
...
erify_area())
Merging i2c-host-fixes/i2c/i2c-host-fixes (525c07969201 MAINTAINERS: adjust=
...
Merging drm-misc-fixes/for-linux-next-fixes (bf52d7f9b206 drm/nouveau/dp: D=
on't probe eDP ports twice harder)
...
Merging mm/mm-everything (1755f72d5a85 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging nfsd/nfsd-next (964b1571f8b0 nfsd: optimise recalculate_deny_mode()=
 for a common case)
...
or-current)
Merging i2c-host/i2c/i2c-host (32204e57f3fb dt-bindings: i2c: qcom-cci: Doc=
ument sc8280xp compatible)
...
Merging net-next/main (bb72159c0ad1 Merge branch 'selftests-net-exercise-pa=
ge-pool-reporting-via-netlink')
...
Merging drm-misc/for-linux-next (7b0062036c3b drm/vmwgfx: Implement virtual=
 crc generation)
...
r)
Merging drm-xe/drm-xe-next (5f36d1ce4df2 drm/xe/gt: Add L3 bank mask to GT =
topology)
...
Merging sound-asoc/for-next (bb85a27856fd Merge remote-tracking branch 'aso=
...
Merging device-mapper/for-next (4f0eecb15f2b dm-crypt: don't set WQ_CPU_INT=
...
Merging devicetree/for-next (a5737b210574 of: Use scope based of_node_put()=
 cleanups)
...
/ELE/V2X MU)
Merging spi/for-next (e0fa51d2ab0b Merge remote-tracking branch 'spi/for-6.=
10' into spi-next)
...
`Work`)
Merging sysctl/sysctl-next (c2e128726bdd security: Remove the now superfluo=
us sentinel element from ctl_table array)
  c2e128726bdd ("security: Remove the now superfluous sentinel element from=
 ctl_table array")
...

=IWzf
-----END PGP SIGNATURE-----
