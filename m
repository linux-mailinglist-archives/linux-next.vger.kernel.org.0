Return-Path: <linux-next+bounces-1311-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id EA8618609F4
	for <lists+linux-next@lfdr.de>; Fri, 23 Feb 2024 05:40:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 37853B22148
	for <lists+linux-next@lfdr.de>; Fri, 23 Feb 2024 04:40:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1B1CF10A31;
	Fri, 23 Feb 2024 04:40:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="SdFjDtwv"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BEC81101CA;
	Fri, 23 Feb 2024 04:40:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708663237; cv=none; b=nmxqdxQXgVKO1Lc1iSm74aURpUEEh2XWCDocWnlZwEli64dHmZkfuSdmdYqUuWCVyBIEPYmn2WwOGXqL297BQC8/WSGzPPIoScgmBXjADufk7tUaRiEt7J4A9km1GnzsZuSz1lxsWtYihNL8ep05fDNlkPdeSOx7cn/70FVR+Fg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708663237; c=relaxed/simple;
	bh=qTYo0Ioo8m/S5ocDn3IV0bB51jeHpgcqTku8SZxMhCM=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=nlZbKI7FhkTziA9sGwRD+8D8Y4bsFXZLc80s9VH5jQ7KaIhKHNg3Z56+7ecw0Y1IoisG3z+JBmUyiTZHUsJPN62WAApysoxil0BF6b0HfLLUtGM8zMHup4wLEuLlaXUVdFHSBOPCbAO1V3lJCqvHzyAN6t+Yec8B0wcKuKpQ5hU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=SdFjDtwv; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1708663230;
	bh=vqPln1YEjAit/UlAOpdqi7UHOYakiHb4bgR90Xlf7wc=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Tgy4G60P9z4wc4;
	Fri, 23 Feb 2024 15:40:30 +1100 (AEDT)
Date: Fri, 23 Feb 2024 15:40:29 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 23
Message-ID: <20240223154029.18368677@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/XkBCWMGpkP3LMsOLtSOvQPB";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/XkBCWMGpkP3LMsOLtSOvQPB
...
The drm-xe tree lost its build failure.

The security tree gained a conflict against the net-next tree.

The vfio tree gained a conflict against the jc_docs tree.

The gpio-brgl tree gained a build failure so I used the version from
next-20240222.

Non-merge commits (relative to Linus' tree): 8576
 7973 files changed, 379233 insertions(+), 155639 deletions(-)
...
Merging origin/master (ffd2cb6b718e Merge tag 'block-6.8-2024-02-22' of git=
://git.kernel.dk/linux)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (a0fbfbfedee7 mm, mmap: fix vma_me=
rge() case 7 with vma_ops->close)
...
Merging net/main (359e54a93ab4 l2tp: pass correct message length to ip6_app=
end_data)
...
Merging risc-v-fixes/fixes (58506612bf02 Merge patch series "RISC-V: Fix CO=
...
Merging drm-misc-fixes/for-linux-next-fixes (1fa8d07ae1a5 gpu: host1x: Skip=
 reset assert on Tegra186)
CONFLICT (content): Merge conflict in drivers/gpu/drm/tests/drm_buddy_test.c
Merging mm-stable/mm-stable (45866e0e214f zram: do not allocate physically =
contiguous strm buffers)
Merging mm-nonmm-stable/mm-nonmm-stable (b401b621758e Linux 6.8-rc5)
Merging mm/mm-everything (3430d1a2121e Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Merging kbuild/for-next (ba3b759fb688 kconfig: lxdialog: fix cursor render =
in checklist)
Merging clang-format/clang-format (5a205c6a9f79 clang-format: Update with v=
6.7-rc4's `for_each` macro list)
Merging perf/perf-tools-next (659663f0bccc perf: script: prefer capstone to=
 XED)
$ git reset --hard HEAD^
...
Merging renesas/next (eb8362db9d70 Merge branches 'renesas-arm-defconfig-fo=
...
to for-next)
Merging samsung-krzk/for-next (0e724e9e6442 Merge branch 'next/drivers' int=
o for-next)
Merging scmi/for-linux-next (06fb2727a1d6 Merge branches 'for-next/vexpress=
/updates', 'for-next/scmi/updates' and 'for-next/ffa/updates' of git://git.=
...
xt)
Merging tegra/for-next (0e09c588b2f1 Merge branch for-6.9/arm64/dt into for=
-next)
...
Merging s390/for-next (97403b0ad3f8 Merge branch 'features' into for-next)
...
Merging net-next/main (fecc51559a84 Merge git://git.kernel.org/pub/scm/linu=
x/kernel/git/netdev/net)
CONFLICT (content): Merge conflict in drivers/net/wireless/intel/iwlwifi/mv=
m/mvm.h
Merging bpf-next/for-next (63c7049ef9d6 Merge branch 'Check cfi_stubs befor=
e registering a struct_ops type.')
...
Merging wireless-next/for-next (1c33f0ffacfd Merge tag 'ath-next-20240222' =
...
ointer dereference after drm_dbg_printer conversion)
  8c44ea81634a ("drm/syncobj: call drm_syncobj_fence_add_wait when WAIT_AVA=
ILABLE flag is set")
...
0 support)
Merging drm-xe/drm-xe-next (7a975748d4dc drm/xe: Use pointers in trace even=
ts)
...
Merging sound/for-next (ec89fc1b7176 ALSA: seq: prioq: Unify cell removal f=
unctions)
Merging ieee1394/for-next (41ebb53b1bff firewire: core: fix build failure d=
ue to the caller of fw_csr_string())
Merging sound-asoc/for-next (1952c3c526cf Merge remote-tracking branch 'aso=
...
Merging block/for-next (b636f9479139 Merge branch 'for-6.9/block' into for-=
next)
CONFLICT (content): Merge conflict in block/blk.h
CONFLICT (content): Merge conflict in include/linux/sched.h
Merging device-mapper/for-next (f943a77f5077 Merge branch 'dm-6.9-bh-wq' in=
to for-next)
...
Merging security/next (f89d47833d28 Automated merge of 'dev' into 'next')
...
9' into spi-next)
Merging tip/master (966376beb57b Merge branch into tip/master: 'x86/mtrr')
...
Merging kvm-arm/next (370cb8ba7da1 Merge branch kvm-arm64/vm-configuration =
into kvmarm/next)
...
Merging kvms390/next (85a19b305427 KVM: s390: only deliver the set service =
event bits)
Merging kvm-ppc/topic/ppc-kvm (41bccc98fb79 Linux 6.8-rc2)
Merging kvm-riscv/riscv_kvm_next (f072b272aa27 RISC-V: KVM: Use correct res=
tricted types)
Merging kvm-x86/next (ec1e3d33557b Merge branch 'xen')
...
Merging soundwire/next (81a7d0c4d059 soundwire: bus_type: make sdw_bus_type=
 const)
Merging extcon/extcon-next (3535319b5a19 extcon: max8997: select IRQ_DOMAIN=
...
ter casts)
Merging vhost/linux-next (2b3fd606c662 Documentation: Add reconnect process=
 for VDUSE)
...
Merging gpio-brgl/gpio/for-next (36e44186e0ba gpio: mmio: Support 64-bit BE=
 access)
CONFLICT (content): Merge conflict in Documentation/userspace-api/index.rst
$ git reset --hard HEAD^
Merging next-20240222 version of gpio-brgl
CONFLICT (content): Merge conflict in Documentation/userspace-api/index.rst
[master 92e72396c89b] next-20240222/gpio-brgl
...
Merging kspp/for-next/kspp (e62f2b86f90d leaking_addresses: Provide mechani=
...

=g/Ml
-----END PGP SIGNATURE-----
