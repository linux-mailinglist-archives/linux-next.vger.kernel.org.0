Return-Path: <linux-next+bounces-1818-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id BFEFA899A1D
	for <lists+linux-next@lfdr.de>; Fri,  5 Apr 2024 12:00:04 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6A41928413B
	for <lists+linux-next@lfdr.de>; Fri,  5 Apr 2024 10:00:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id DE82D27447;
	Fri,  5 Apr 2024 09:59:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="WOOjvWve"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-oo1-f54.google.com (mail-oo1-f54.google.com [209.85.161.54])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6C0EC160781
	for <linux-next@vger.kernel.org>; Fri,  5 Apr 2024 09:59:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.161.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712311198; cv=none; b=Fwqv51CYPwc5EvcG7a0D+Ke4Onb1zbf4CvVUw3ePHNJgEHX064tUB/9/H0qcgJWR2D3W7Pp6jKcF9bJ/O6IlXfEz4siH9ocyJw8PNomz4KMUUGefBAWLtWrVpaA5pB2zP8mgThq9fxSRzKiJKCTNvRBppEdzfKuZgUIBq+NkgMw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712311198; c=relaxed/simple;
	bh=N8zpbs3QjzU68bgpaGbLEoLRFcpcdZCCF9Y4dAMeceo=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=NmvMSD3xn+v74aCxAR+YiQ2Hc7wO1b0P0zonue2dY8tYLcnRMWShe0c1qKL5k4SExngpov/Fq6pC1W4VWZblem73GvtCbegD4rJnYdo8kHUCz10d+8Ac5RAY2aozrwN1VqppK9tobv+X4+O9k6Yx7VYR1V+rKu4k0+ZqIHQhClg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=WOOjvWve; arc=none smtp.client-ip=209.85.161.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-oo1-f54.google.com with SMTP id 006d021491bc7-5a56710cdccso827027eaf.3
        for <linux-next@vger.kernel.org>; Fri, 05 Apr 2024 02:59:54 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1712311193; x=1712915993; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=gtgPddwFK2RBaU52Do+5eylDnVS7VgNfjWaJYe5xRHg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712311193; x=1712915993;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=gtgPddwFK2RBaU52Do+5eylDnVS7VgNfjWaJYe5xRHg=;
        b=
X-Gm-Message-State: AOJu0Yx2oEuvcOUjavB266WOs2dCkXmdEP3D02s87kesW6abWLAYglXD
	KcUvEbjcuXuFcMm5qasy9JvyFY1YLLKigPUeKhvJMwG2UWVqUPcmsO3yZ3vz44G7nOGTdQifRih
	9lAA=
X-Google-Smtp-Source: AGHT+IF/DRDj7RaDODPZskWiO9Re8RvJ9UoT0ErFOxRyKpUqUUbScvmsQ6X5gMpOdKrVtLzB4mr5aA==
X-Received: by 2002:a05:6358:5bd6:b0:17f:5a04:13e with SMTP id i22-20020a0563585bd600b0017f5a04013emr1042756rwf.32.1712311191580;
        Fri, 05 Apr 2024 02:59:51 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id w9-20020a63fb49000000b005bd980cca56sm1073426pgj.29.2024.04.05.02.59.50
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 05 Apr 2024 02:59:50 -0700 (PDT)
Message-ID: <660fcb96.630a0220.dd245.2f53@mx.google.com>
Date: Fri, 05 Apr 2024 02:59:50 -0700 (PDT)
...
Subject: next/master build: 157 builds: 16 failed, 141 passed, 26 errors,
 286 warnings (next-20240405)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 157 builds: 16 failed, 141 passed, 26 errors, 286 warnin=
gs (next-20240405)
...
Tree: next
Branch: master
Git Describe: next-20240405
Git Commit: 8568bb2ccc278f344e6ac44af6ed010a90aa88dc
...
arc:
    ...
    vdk_hs38_smp_defconfig (gcc-10): 1 error, 3 warnings
...
mips:
    ...
    decstation_64_defconfig (gcc-10): 2 errors, 9 warnings
    decstation_defconfig (gcc-10): 9 warnings
    decstation_r4k_defconfig (gcc-10): 9 warnings
    eyeq5_defconfig (gcc-10): 4 errors
...
Errors summary:
    ...
    10   arch/arc/include/asm/mmu-arcv2.h:82:2: error: implicit declaration=
...
RS=E2=80=99?
    1    verifier.c:(.text+0x8da4): undefined reference to `__SCK__perf_sna=
pshot_branch_stack'
    1    verifier.c:(.text+0x8ac4): undefined reference to `__SCK__perf_sna=
pshot_branch_stack'
    1    mips-linux-gnu-ld: verifier.c:(.text+0x8e04): undefined reference =
to `__SCK__perf_snapshot_branch_stack'
    1    mips-linux-gnu-ld: verifier.c:(.text+0x8dc0): undefined reference =
to `__SCK__perf_snapshot_branch_stack'
    1    mips-linux-gnu-ld: verifier.c:(.text+0x8dbc): undefined reference =
to `__SCK__perf_snapshot_branch_stack'
    1    mips-linux-gnu-ld: verifier.c:(.text+0x8acc): undefined reference =
to `__SCK__perf_snapshot_branch_stack'
...
=E2=80=98disable_pcimt_irq=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/setup.c:59:5: warning: no previous prototyp=
e for =E2=80=98swarm_be_handler=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/rtc_xicor1241.c:203:5: warning: no previous=
 prototype for =E2=80=98xicor_probe=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/rtc_xicor1241.c:167:10: warning: no previou=
s prototype for =E2=80=98xicor_get_time=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/rtc_xicor1241.c:108:5: warning: no previous=
 prototype for =E2=80=98xicor_set_time=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/rtc_m41t81.c:219:5: warning: no previous pr=
ototype for =E2=80=98m41t81_probe=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/rtc_m41t81.c:186:10: warning: no previous p=
rototype for =E2=80=98m41t81_get_time=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/sibyte/swarm/rtc_m41t81.c:139:5: warning: no previous pr=
...
for =E2=80=98octeon_msi_initialize=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/mm/cerr-sb1.c:165:17: warning: no previous prototype for=
...
---------------------------------------------------------------------------=
-----
decstation_64_defconfig (mips, gcc-10) =E2=80=94 FAIL, 2 errors, 9 warnings=
, 0 section mismatches

Errors:
    verifier.c:(.text+0x8ac4): undefined reference to `__SCK__perf_snapshot=
_branch_stack'
    mips-linux-gnu-ld: verifier.c:(.text+0x8acc): undefined reference to `_=
_SCK__perf_snapshot_branch_stack'
...
---------------------------------------------------------------------------=
-----
eyeq5_defconfig (mips, gcc-10) =E2=80=94 FAIL, 4 errors, 0 warnings, 0 sect=
ion mismatches

Errors:
    verifier.c:(.text+0x8da4): undefined reference to `__SCK__perf_snapshot=
_branch_stack'
    mips-linux-gnu-ld: verifier.c:(.text+0x8dbc): undefined reference to `_=
_SCK__perf_snapshot_branch_stack'
    mips-linux-gnu-ld: verifier.c:(.text+0x8dc0): undefined reference to `_=
_SCK__perf_snapshot_branch_stack'
    mips-linux-gnu-ld: verifier.c:(.text+0x8e04): undefined reference to `_=
_SCK__perf_snapshot_branch_stack'
...
---------------------------------------------------------------------------=
-----
vdk_hs38_smp_defconfig (arc, gcc-10) =E2=80=94 FAIL, 1 error, 3 warnings, 0=
 section mismatches
