Return-Path: <linux-next+bounces-3012-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id F1E9E930E74
	for <lists+linux-next@lfdr.de>; Mon, 15 Jul 2024 09:11:33 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 12AA71C209FE
	for <lists+linux-next@lfdr.de>; Mon, 15 Jul 2024 07:11:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1BDBC1448EA;
	Mon, 15 Jul 2024 07:11:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="UpfEL1TM"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 212F813A252;
	Mon, 15 Jul 2024 07:11:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721027490; cv=none; b=OSbSriDsWJGWj/0Ot7EK7xoWAKwUiTj/I2eln9kpKGlvaYUvrSUgLhr8cRmSIkYrxvioGKsZOv3NTbpbZyyBkp00rHOcO2b77KGTN/S9Jm1AFOxwBaQbBnCHZslZQLHRE9032UBOoo9aFQvgJQ43H7oY7xbWcwS/aT0lM8Rk+MQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721027490; c=relaxed/simple;
	bh=hVlWVctU+kEVDuLP02yndhZS+J43SH7zvw5IB4eUCYc=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=gJ52rhgBcQHbn2Nrz3mntPBdi69bYz8GMqkpzTdHhJ4nsRVWBnBFJb+7CtnpTGFU2wlpELYqTZMChQAjY1br8oVcc/CLhYQckB7bZS/DD9AYcdc+fZ9RqkaGOfUiRIX//c1+2d7OBfe7uEA4T2gP0m7nvrsCkUV/0HsgVn5VY6c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=UpfEL1TM; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1721027484;
	bh=mVStfbfzBbBExcyerDgNqHfXm76LSx3c4R3goJKOuWA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WMtfN3YjCz4w2Q;
	Mon, 15 Jul 2024 17:11:24 +1000 (AEST)
Date: Mon, 15 Jul 2024 17:11:23 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 15
Message-ID: <20240715171123.3c8962c6@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/5AGxQlDTQlKR/ovgq+fxz_d";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/5AGxQlDTQlKR/ovgq+fxz_d
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240712:

New trees:	thead-dt, thead-dt-fixes

The mm-stable tree gained a conflict against Linus' tree.

The ksmbd tree gained a build failure for which I applied a patch.

The nfs-anna tree gained a conflict against the mm-stable tree.
...
The phy-next tree gained a conflict against the net-next tree.

The cgroup tree lost its build failure.

The vhost tree gained a conflict against the char-misc tree.

The iommufd tree lost its build failure.

Non-merge commits (relative to Linus' tree): 11782
 12114 files changed, 850487 insertions(+), 226256 deletions(-)
...
Merging origin/master (4d145e3f830b Merge tag 'i2c-for-6.10-rc8' of git://g=
...
erify_area())
Merging fs-current (bec1971e3154 Merge branch 'fixes' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging kbuild-current/fixes (84679f04ceaf fortify: fix warnings in fortify=
 tests with KASAN)
...
Merging net/main (97d9fba9a812 net: netconsole: Disable target before netpo=
ll cleanup)
...
Merging sound-current/for-linus (8fc1e8b23077 ALSA: hda/realtek: Enable hea=
dset mic on Positivo SU C1400)
...
Merging kbuild/for-next (e33979cbcdad kbuild: Create INSTALL_PATH directory=
...
IPTION() macros)
Merging arm-soc/for-next (e58acf5125c1 soc: document merges)
...
Merging mips/mips-next (74beefb5935a mips: dts: realtek: Add RTL9302C board)
...
Merging bcachefs/for-next (4d1d53862afb bcachefs: show none if label is not=
 set)
...
Merging ksmbd/ksmbd-for-next (e70f0abc77e8 ksmbd: add durable scavenger tim=
er)
Applying: fixup for "ksmbd: add durable scavenger timer"
[fs-next 467ade2f2369] Merge branch 'ksmbd-for-next' of https://github.com/=
smfrench/smb3-kernel.git
...
[fs-next 7aa4fbcca5aa] Merge branch 'vfs.all' of git://git.kernel.org/pub/s=
cm/linux/kernel/git/vfs/vfs.git
Merging vfs/for-next (a38297e3fb01 Linux 6.9)
Merging fs-next (7aa4fbcca5aa Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging pci/next (69f2196af4a3 Merge branch 'pci/misc')
...
ove_new)
Merging pm/linux-next (ea35b5c5cf97 Merge branch 'thermal-core' into linux-=
next)
...
Merging rdma/for-next (95b087f87b78 bnxt_re: Fix imm_data endianness)
Merging net-next/main (ecb1e1dcb7b5 Merge branch 'introduce-en7581-ethernet=
-support')
CONFLICT (content): Merge conflict in arch/riscv/net/bpf_jit_comp64.c
CONFLICT (content): Merge conflict in net/ethtool/pse-pd.c
...
iver-fails-to-probe')
Merging bluetooth/master (f624ec7b1d32 Bluetooth: btmtk: Mark all stub func=
tions as inline)
...
Merging amdgpu/drm-next (1cff1010bef6 drm/amdgpu/mes12: add missing opcode =
string)
  320debca1ba3 ("drm/amdgpu: reject gang submit on reserved VMIDs")
  7ed58b68ac5c ("Revert "drm/amd/display: Reset freesync config before upda=
te new state"")
...
Merging drm-xe/drm-xe-next (86c5b70a9c0c drm/xe/xe2: Add Wa_15015404425)
  33891539f9d6 ("drm/xe/display/xe_hdcp_gsc: Free arbiter on driver removal=
")
  8169b2097d88 ("drm/xe/uapi: Rename xe perf layer as xe observation layer")
  caaf1f44a6a2 ("drm/xe: Drop trace_xe_hw_fence_free")
...
Merging input/next (8c98dddc233c Input: exc3000 - add EXC81W32 support)
CONFLICT (content): Merge conflict in include/linux/interrupt.h
Merging block/for-next (7cc67fde2086 Merge branch 'for-6.11/block' into for=
-next)
CONFLICT (content): Merge conflict in fs/stat.c
CONFLICT (content): Merge conflict in include/linux/fs.h
Merging device-mapper/for-next (b40cdccafe29 dm-integrity: introduce the In=
line mode)
...
Merging devicetree/for-next (ea9e315cccd5 dt-bindings: incomplete-devices: =
document devices without bindings)
...
11' into spi-next)
Merging tip/master (c1ef42a985f0 Merge branch into tip/master: 'x86/vmware')
...
-next)
Merging workqueues/for-next (837b6f58c651 Merge branch 'for-6.11' into for-=
next)
Merging sched-ext/for-next (8bb30798fd6e sched_ext: Fixes incorrect type in=
 bpf_scx_init())
Merging drivers-x86/for-next (2fd66f7d3b0d platform/x86/amd/pmf: Remove upd=
ate system state document)
...
cros)
Merging slab/slab/for-next (8256b529492a Merge branch 'slab/for-6.11/bucket=
...
Merging iommufd/for-next (595572aae3d0 iommufd: Fix error pointer checking)
...

=hwXW
-----END PGP SIGNATURE-----
