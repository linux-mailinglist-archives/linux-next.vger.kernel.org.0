Return-Path: <linux-next+bounces-4834-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id F2A219D595D
	for <lists+linux-next@lfdr.de>; Fri, 22 Nov 2024 07:23:24 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id ADD04280BDA
	for <lists+linux-next@lfdr.de>; Fri, 22 Nov 2024 06:23:23 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A6B7115688C;
	Fri, 22 Nov 2024 06:23:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="nHE/0bBV"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id DB7BC230982;
	Fri, 22 Nov 2024 06:23:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1732256599; cv=none; b=Fbn6SwBbJCxb564NyKIXBcTM4ri8p9j2DmXeq83LyJOhZwJAjXmQVDpGH0Ok1fvGOQgq1RIxBrp3RB9yNspXvAj/fDIToq0B3kevZd0r8VbIIfATaTcWUOr0P1sbZ0xk5AjTMSuySn/t2Kv6N4/nw8bEL93nmu/XC24aMBzFbZw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1732256599; c=relaxed/simple;
	bh=4PkEUzhzBc020S6NfXf6pKmmK4kJ5Dzpfb0ME1KTEbg=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=HhpQ05ZQ2NssYDbSOGJ5YOx5mthec6x5+8/ylhjdCsn8YHqPK9ueHuM8Z6b0dvMbCqz8yDTmIQVp3Pm4NDSJ5BLwGwIHXZI2TOAX/SGQmNrZ5AKAKDsaSHTF/ToP1Y2GdGjTZ1WwEcH4PMaap2cytB5h43ZrCJObo493Vtgw8/4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=nHE/0bBV; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1732256587;
	bh=lLqYW+GOKwU0nkn1fJLjge9Vp+ibaXroNlebEBwNP3Q=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XvlQg1cq2z4wcn;
	Fri, 22 Nov 2024 17:23:07 +1100 (AEDT)
Date: Fri, 22 Nov 2024 17:23:09 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 22
Message-ID: <20241122172309.7f038f6c@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Z3omDf4D9lzgLe=UBvYOPiz";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/Z3omDf4D9lzgLe=UBvYOPiz
...
Changes since 20241121:

The kvm-riscv tree gained conflicts against the risc-v tree.

Non-merge commits (relative to Linus' tree): 6111
 6973 files changed, 262019 insertions(+), 178941 deletions(-)
...
Merging origin/master (341d041daae5 Merge tag 'for-linus-iommufd' of git://=
...
Merging ceph/master (8ea412e18131 ceph: improve caps debugging output)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging cifs/for-next (17961c457022 cifs: update internal version number)
...
mmon())
Merging f2fs/dev (f88c7904b5c7 f2fs: clear SBI_POR_DOING before initing inm=
em curseg)
...
Merging nfs/linux-next (e482e8b252ed sunrpc: fix one UAF issue caused by su=
...
fs_jnl_write_inode())
Merging v9fs/9p-next (7ef3ae82a6eb 9p/xen: fix init sequence)
...
Merging fs-current (92073cfdae86 Merge branch 'next-fixes' of git://git.ker=
...
Merging arm64-fixes/for-next/fixes (a63d7408afbd arm64: disable ARCH_CORREC=
T_STACKTRACE_ON_KRETPROBE tests)
...
Merging net/main (fcc79e1714e8 Merge tag 'net-next-6.13' of git://git.kerne=
l.org/pub/scm/linux/kernel/git/netdev/net-next)
Merging bpf/master (fc39fb56917b Merge tag 'jfs-6.13' of github.com:kleikam=
p/linux-shaggy)
...
Merging sound-current/for-linus (d2913a07d903 ALSA: pcm: Add sanity NULL ch=
eck for the default mmap fault handler)
Merging sound-asoc-fixes/for-linus (f32c3f01c21c ASoC: apple: Fix the wrong=
 format specifier)
...
Merging spi-fixes/for-linus (eb1053bf8a85 Merge remote-tracking branch 'spi=
...
Merging hwmon-fixes/hwmon (3020c5219935 hwmon: (tps23861) Fix reporting of =
...
Merging gpio-brgl-fixes/gpio/for-current (72cef64180de gpio: exar: set valu=
e when external pull-up or pull-down is present)
...
Merging s390/for-next (45c9f2b856a0 s390/entry: Mark IRQ entries to fix sta=
ck depot warnings)
...
Merging fs-next (0d95084546d9 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (4022ef25504d Merge branch 'for-6.13-force-console'=
 into for-next)
Merging pci/next (0f3d0b32cf72 Merge branch 'pci/typos')
...
nto i2c/for-next)
Merging i2c-host/i2c/i2c-host (8bba86687c0b i2c: xiic: Add atomic transfer =
support)
...
Merging pm/linux-next (f758bb9e2ac0 Merge branches 'acpi-processor' and 'pm=
-cpuidle' into linux-next)
Merging cpufreq-arm/cpufreq/arm/linux-next (48b0fb263f38 cpufreq: scmi: Reg=
ister for limit change notifications)
...
mentation comments)
Merging drm-xe/drm-xe-next (22c205276673 drm/xe: Sort again the info flags)
...
Merging sound/for-next (d2913a07d903 ALSA: pcm: Add sanity NULL check for t=
he default mmap fault handler)
Merging ieee1394/for-next (4752e8cde834 tools/firewire: Fix several incorre=
ct format specifiers)
Merging sound-asoc/for-next (f32c3f01c21c ASoC: apple: Fix the wrong format=
 specifier)
...
ble_read_voltage())
Merging block/for-next (12ab2c13ca77 Merge branch 'for-6.13/block' into for=
-next)
...
pile testing)
Merging spi/for-next (eb1053bf8a85 Merge remote-tracking branch 'spi/for-6.=
12' into spi-linus)
Merging tip/master (25f324dbc68c Merge branch into tip/master: 'x86/tdx')
...

=cvqb
-----END PGP SIGNATURE-----
