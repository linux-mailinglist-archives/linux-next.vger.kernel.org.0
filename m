...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 80ACB7DFDE5
	for <lists+linux-next@lfdr.de>; Fri,  3 Nov 2023 03:11:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229492AbjKCB4X (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 2 Nov 2023 21:56:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37282 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229447AbjKCB4W (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 2 Nov 2023 21:56:22 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA21219D;
        Thu,  2 Nov 2023 18:56:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1698976569;
        bh=OY0M4uGC2fSXHXK8aM+hCVqJmV/HI8OXBtNCZEk8BCU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SM3kK0WlTz4xRx;
        Fri,  3 Nov 2023 12:56:09 +1100 (AEDT)
Date:   Fri, 3 Nov 2023 12:55:56 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 3
Message-ID: <20231103125556.7855d391@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/h8=UkmG8zKPHFTQ7lS3LYo+";
...
Changes since 20231102:

The risc-v tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 5220
 5555 files changed, 191501 insertions(+), 126282 deletions(-)
...
Merging origin/master (4652b8e4f3ff Merge tag '6.7-rc-ksmbd-server-fixes' o=
f git://git.samba.org/ksmbd)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (586b9dcd583b kexec-fix-kexec_file=
-dependencies-fix)
...
Merging net/main (efa5f1311c49 net: r8169: Disable multicast filter for RTL=
8168H and RTL8107E)
...
h_ifid())
Merging netfilter/main (61e4a8660002 rxrpc: Fix two connection reaping bugs)
...
Merging sound-asoc-fixes/for-linus (5c81f752c953 ASoC: codecs: Modify some =
error codes)
...
fied in mm-nonmm-stable/mm-nonmm-stable.  Version mm-nonmm-stable/mm-nonmm-=
stable of arch/ia64/kernel/setup.c left in tree.
$ git rm -f arch/ia64/kernel/setup.c
Merging mm/mm-everything (15ad901d17f1 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
riant)
Merging bcachefs/for-next (dff7863d5f78 bcachefs: fix odebug warn and lockd=
ep splat due to on-stack rhashtable)
...
tems)
Merging cifs/for-next (8a6488fc4cc3 cifs: update internal module version nu=
mber for cifs.ko)
...
ith __counted_by)
Merging sound-asoc/for-next (5c81f752c953 ASoC: codecs: Modify some error c=
odes)
...
bi_test.c
Merging rcu/rcu/next (2656821f1f20 Merge tag 'rcu-next-v6.7' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/frederic/linux-dynticks)
...
Merging gpio-brgl/gpio/for-next (c9c3219aa84c gpiolib: remove gpiochip_find=
())
...

=n/+q
-----END PGP SIGNATURE-----
