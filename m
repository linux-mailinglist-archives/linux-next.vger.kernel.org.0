...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C5C10E2A2B
	for <lists+linux-next@lfdr.de>; Thu, 24 Oct 2019 07:55:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2437617AbfJXFzk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 24 Oct 2019 01:55:40 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:46069 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2437581AbfJXFzk (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 24 Oct 2019 01:55:40 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46zGgR1yKpz9sPp;
        Thu, 24 Oct 2019 16:55:31 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1571896531;
        bh=a7DgG7Vc/dBkpA52NjC0bQ875xCOp9XyJMYLpOVwU+A=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 24 Oct 2019 16:55:30 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 24
Message-ID: <20191024165530.38ad0c77@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/L5+7If5K0ojfKZ9uBFjVFGN";
...
Merging origin/master (13b86bc4cd64 Merge tag 'for-linus' of git://git.arml=
...
Merging arm-soc-fixes/arm/fixes (f82bc1354077 Merge tag 'omap-for-v5.4/fixe=
s-rc4-signed' of git://git.kernel.org/pub/scm/linux/kernel/git/tmlind/linux=
-omap into arm/fixes)
...
Merging net/master (6c5d9c2a6bed ipv6: include <net/addrconf.h> for missing=
 declarations)
Merging bpf/master (3b4d9eb2ee74 bpf: Fix use after free in bpf_get_prog_na=
me)
...
rflow)
Merging sound-current/for-linus (4750c2121748 ALSA: hda: Add Tigerlake/Jasp=
erlake PCI ID)
Merging sound-asoc-fixes/for-linus (9c54014cbc7c Merge branch 'asoc-5.4' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (df315288f6a3 Merge branch 'spi-5.4' into spi-l=
inus)
...
errupted)
Merging cifs/for-next (85b711d8867a CIFS: Fix retry mid list corruption on =
reconnects)
...
Merging cpufreq-arm/cpufreq/arm/linux-next (e458eb97df7a cpufreq: s3c64xx: =
Remove pointless NULL check in s3c64xx_cpufreq_driver_init)
...
Merging net-next/master (406715df933a fq_codel: do not include <linux/jhash=
.h>)
...
n.c
Merging drm-tegra/drm/tegra/for-next (150741a96ba4 drm/tegra: dpaux: Parame=
terize CMH, DRVZ and DRVI)
Merging drm-misc/for-linux-next (9a42c7c647a9 drm/tegra: Move drm_dp_link h=
elpers to Tegra DRM)
...
Merging sound-asoc/for-next (19e1b62ab529 Merge branch 'asoc-5.5' into asoc=
-next)
...
register value)
Merging spi/for-next (8bbbe972b73f Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
rflow
Merging akpm/master (e71f6fb616da drivers/media/platform/sti/delta/delta-ip=
...

=hhSA
-----END PGP SIGNATURE-----
