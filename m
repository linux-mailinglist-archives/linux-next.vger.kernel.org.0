...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CFAC9263A74
	for <lists+linux-next@lfdr.de>; Thu, 10 Sep 2020 04:29:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730449AbgIJC3m (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 9 Sep 2020 22:29:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56444 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730700AbgIJC1a (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 9 Sep 2020 22:27:30 -0400
Received: from mail-pf1-x432.google.com (mail-pf1-x432.google.com [IPv6:2607:f8b0:4864:20::432])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BC37FC06138F
        for <linux-next@vger.kernel.org>; Wed,  9 Sep 2020 17:00:23 -0700 (PDT)
Received: by mail-pf1-x432.google.com with SMTP id x123so3573246pfc.7
        for <linux-next@vger.kernel.org>; Wed, 09 Sep 2020 17:00:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=TTlweN1HoFpTvVE+mtE/bE6MhNWPzCPZQuDMu+TTXUk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=TTlweN1HoFpTvVE+mtE/bE6MhNWPzCPZQuDMu+TTXUk=;
        b=
X-Gm-Message-State: AOAM533ILoxqcZsEart64jeaJttoj2DHfZfXWiy2q4HcBCLKfXQ3cMnE
        q6fGyzr7DtETF25YeZaf9+x2R+ObNg/W7g==
X-Google-Smtp-Source: ABdhPJwJyf6LjDl/E4TRXIkeqZvIoD68XH+o226z+U6vIFK0zacHL0y7KOODtv6h4bUp20bTfSglhg==
X-Received: by 2002:a62:38ce:0:b029:138:838f:dd53 with SMTP id f197-20020a6238ce0000b0290138838fdd53mr2781783pfa.2.1599696020693;
        Wed, 09 Sep 2020 17:00:20 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id 137sm3689108pfu.149.2020.09.09.17.00.19
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 09 Sep 2020 17:00:19 -0700 (PDT)
Message-ID: <5f596c93.1c69fb81.2e55b.a6c9@mx.google.com>
Date:   Wed, 09 Sep 2020 17:00:19 -0700 (PDT)
...
Subject: next/pending-fixes build: 213 builds: 0 failed, 213 passed,
 1438 errors, 223 warnings (v5.9-rc4-363-g1dfc67596dbb)
...
3 warnings (v5.9-rc4-363-g1dfc67596dbb)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.9-rc4-363-g1dfc67596dbb/

Tree: next
Branch: pending-fixes
Git Describe: v5.9-rc4-363-g1dfc67596dbb
Git Commit: 1dfc67596dbbc7bab78376ebb1afdce355f3fdca
...
Errors summary:
    ...
    725  /usr/include/features.h:424:12: fatal error: sys/cdefs.h: No such =
file or directory
    455  /scratch/linux/tools/testing/selftests/kselftest_harness.h:56:10: =
fatal error: asm/types.h: No such file or directory
    148  /usr/include/stdio.h:27:10: fatal error: bits/libc-header-start.h:=
 No such file or directory
    20   /usr/include/stdlib.h:25:10: fatal error: bits/libc-header-start.h=
: No such file or directory
    16   /bin/sh: 3: llc: not found
    16   /bin/sh: 1: llc: not found
    16   /bin/sh: 1: clang: not found
    15   arc-elf32-gcc: error: unrecognized command line option =E2=80=98-p=
thread=E2=80=99
    13   test_execve.c:4:10: fatal error: cap-ng.h: No such file or directo=
ry
    11   get_size.c:29:10: fatal error: sys/sysinfo.h: No such file or dire=
ctory
    11   execveat.c:11:10: fatal error: sys/sendfile.h: No such file or dir=
ectory
    10   seccomp_bpf.c:9:10: fatal error: sys/types.h: No such file or dire=
ctory
    10   posix_timers.c:10:10: fatal error: sys/time.h: No such file or dir=
ectory
    10   kselftest_harness.h:56:10: fatal error: asm/types.h: No such file =
or directory
    10   /usr/include/syscall.h:1:10: fatal error: sys/syscall.h: No such f=
ile or directory
    10   /usr/include/poll.h:1:10: fatal error: sys/poll.h: No such file or=
 directory
    10   /usr/include/linux/ioctl.h:5:10: fatal error: asm/ioctl.h: No such=
 file or directory
    8    collect2: error: ld returned 1 exit status
    6    ionmap_test.c:14:10: fatal error: drm/drm.h: No such file or direc=
tory
    5    ../kselftest_harness.h:56:10: fatal error: asm/types.h: No such fi=
le or directory
...
or SPI bus
    8    rsync -a /root/build/kselftest/lkdtm/PANIC.sh /root/build/kselftes=
...
ot/build/kselftest/lkdtm/CFI_FORWARD_PROTO.sh /root/build/_kselftest_/lkdtm/
    ...
    8    install -m 0744 run.sh /root/build/kselftest/lkdtm/WARNING_MESSAGE=
.sh
    8    install -m 0744 run.sh /root/build/kselftest/lkdtm/WARNING.sh
...
Wimplicit-function-declaration]
    1    /tmp/cc7Ll6gk.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/cc7Ll6gk.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/cc7Ll6gk.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/cc7Ll6gk.s:18192: Warning: using r15 results in unpredictable beha=
viour
