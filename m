...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B0972459BEC
	for <lists+linux-next@lfdr.de>; Tue, 23 Nov 2021 06:47:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232196AbhKWFuJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 23 Nov 2021 00:50:09 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:41677 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229471AbhKWFuJ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 23 Nov 2021 00:50:09 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HytSN36s4z4xZ5;
        Tue, 23 Nov 2021 16:47:00 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1637646420;
        bh=OAAVCaHmbihLuFezqQnBlXUVxm85MHg8lRmShUfoWR0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 23 Nov 2021 16:46:59 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 23
Message-ID: <20211123164659.00c72dab@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/m_YuHHPdlfHG2wGez_feQj/";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/m_YuHHPdlfHG2wGez_feQj/
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211118:

Removed tree: ti-k3-new

New trees: zstd-fixes
	ti
...
The bitmap tree gained a conflict against the dmaengine tree.

Non-merge commits (relative to Linus' tree): 2663
 3118 files changed, 126176 insertions(+), 50825 deletions(-)
...
Merging net/master (03a000bfd719 Merge branch 'nh-group-refcnt')
...
Merging rdma-fixes/for-rc (df4e6faaafe2 MAINTAINERS: Update for VMware PVRD=
MA driver)
Merging sound-current/for-linus (fa9730b4f28b ALSA: intel-dsp-config: add q=
uirk for JSL devices based on ES8336 codec)
Merging sound-asoc-fixes/for-linus (31c08aa5c1ea Merge remote-tracking bran=
...
n IRQ helper docs)
Merging spi-fixes/for-linus (fbf03ca6c53e Merge remote-tracking branch 'spi=
...
Merging usb-serial-fixes/usb-linus (e353f3e88720 USB: serial: option: add T=
elit LE910S1 0x9200 composition)
Merging usb-chipidea-fixes/for-usb-fixes (f130d08a8d79 usb: chipidea: ci_hd=
rc_imx: Also search for 'phys' phandle)
CONFLICT (content): Merge conflict in drivers/usb/chipidea/ci_hdrc_imx.c
Merging phy/fixes (466b1516e74f phy: ti: tusb1210: Fix the kernel-doc warn)
...
Merging scsi-fixes/fixes (9c6603e1faf8 scsi: target: configfs: Delete unnec=
essary checks for NULL)
...
ags)
Merging drm-misc-fixes/for-linux-next-fixes (b4a6aaeaf4aa drm/aspeed: Fix v=
ga_pw sysfs output)
...
Merging imx-mxs/for-next (4c96dd8f890f Merge branch 'imx/dt64' into for-nex=
t)
...
Merging sunxi/sunxi/for-next (280341a05f63 Merge branches 'sunxi/clk-for-5.=
17', 'sunxi/drivers-for-5.17' and 'sunxi/dt-for-5.17' into sunxi/for-next)
$ git reset --hard HEAD^
Merging next-20211118 version of sunxi
...
into for-next)
Merging ti/ti-next (fa55b7dcdc43 Linux 5.16-rc1)
...
emote object copies)
Merging cifs/for-next (d9ab554297b3 cifs: populate server_hostname for extr=
a channels)
...
Merging rdma/for-next (2a67fcfa0db6 RDMA/hns: Validate the pkey index)
Merging net-next/master (3b0e04140bc3 Merge branch 'qca8k-next')
Merging bpf-next/for-next (8cccee9e91e1 libbpf: Change bpf_program__set_ext=
ra_flags to bpf_program__set_flags)
...
tics to 0)
Merging drm/drm-next (136057256686 Linux 5.16-rc2)
...
suspend (v2))
Merging drm-intel/for-linux-next (448cc2fb3a7b Merge drm/drm-next into drm-=
intel-next)
Merging drm-intel-gt/for-linux-next-gt (6164807dd298 drm/i915/ttm: Fix erro=
r code in i915_ttm_eviction_valuable())
...
Merging sound/for-next (de2f29c4394e ALSA: hda: Remove redundant runtime PM=
 calls)
Merging sound-asoc/for-next (626a3dfbdb5d ASoC: SOF: Add support for Mediat=
ek MT8195)
...
t)
Merging block/for-next (e4193b2b06d4 Merge branch 'for-5.17/block' into for=
-next)
...
apacity lookup)
Merging regulator/for-next (92b1348277f8 regulator: Add units to limit docu=
mentation)
...
LP S4 MU)
Merging spi/for-next (49cd1eb37b48 spi: fsl-lpspi: Add imx8ulp compatible s=
tring)
...
318 CPNC data)
Merging xen-tip/linux-next (239d2bf20906 xen: detect uninitialized xenbus i=
n xenbus_init)
...
Merging scsi/for-next (9c6603e1faf8 scsi: target: configfs: Delete unnecess=
ary checks for NULL)
...
Merging akpm-current/current (f9747bfd785f configs: introduce debug.config =
for CI-like setup)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (094cc4329999 lib/stackdepot: allow optional init and s=
...

=Oek2
-----END PGP SIGNATURE-----
