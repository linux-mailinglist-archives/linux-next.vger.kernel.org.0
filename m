Return-Path: <linux-next+bounces-5364-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 0323EA26AFA
	for <lists+linux-next@lfdr.de>; Tue,  4 Feb 2025 05:20:47 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 5199B188731E
	for <lists+linux-next@lfdr.de>; Tue,  4 Feb 2025 04:20:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B72C21552FA;
	Tue,  4 Feb 2025 04:20:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="cif+hRCK"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2F79E35947;
	Tue,  4 Feb 2025 04:20:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738642842; cv=none; b=VhkceKvVIjFziMfs7EHmgc5uGKM0BWeV19ZcUwXa46JeU6UEGo8yoGbqm7HU1+CiRxzTYPXVWILhkyuhQHeceYggS7kBqQAzhK1wvsBlSqbGf5G9/UxBKODrbqLFnBHsMpS7MnqBmGKLN/7ygbRZEvn7AzcT6JKrcTmRZDPgxh8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738642842; c=relaxed/simple;
	bh=vvzYhDF1F+YZmYDnQYu4sBBxTx52/SXfVis10EHx2S4=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=txZBb+RAFxdiukNzL7fTtN8C1RwW+IGB6EFdZy1lUP/IPFZnzUZ//ZwQmoHNFJFNq3Z1zrSAv5DSOn1v4+aGM9GOU1S6m87FdSFBv4TvYXvFyUsVPseetXVhKRDlyK9wfInJd11FtGLjqyVXHNQhPo7FtcfPaBsdmAXH6VzBZJ0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=cif+hRCK; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1738642406;
	bh=0/sn2b5+inuJD5shcOKHB2zp48LEHcNSQky0szAv0Jg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Yn92t2lmsz4wcD;
	Tue,  4 Feb 2025 15:13:26 +1100 (AEDT)
Date: Tue, 4 Feb 2025 15:13:34 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 4
Message-ID: <20250204151334.44bf6d25@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/0391opJqmZQhcEw3Kxvr7LL";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/0391opJqmZQhcEw3Kxvr7LL
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250203:
...
Non-merge commits (relative to Linus' tree): 1046
 1241 files changed, 37503 insertions(+), 15951 deletions(-)
...
Merging origin/master (0de63bb7d919 Merge tag 'pull-fix' of git://git.kerne=
...
Merging fs-current (fa0dbd9de6bc Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (0e6dc66b5c5f Merge branch 'maintainers-recognize-kuniyuki=
-iwashima-as-a-maintainer')
...
Merging sound-asoc-fixes/for-linus (a8c9a4533876 ASoC: fsl_micfil: Enable d=
efault case in micfil_set_quality())
Merging regmap-fixes/for-linus (2014c95afece Linux 6.14-rc1)
Merging regulator-fixes/for-linus (2014c95afece Linux 6.14-rc1)
Merging spi-fixes/for-linus (2014c95afece Linux 6.14-rc1)
...
Merging tty.current/tty-linus (2014c95afece Linux 6.14-rc1)
...
Merging input-current/for-linus (c9ccb88f534c Input: ads7846 - fix gpiod al=
location)
...
Merging drivers-x86-fixes/fixes (583ef25bb2a0 platform/x86/intel: pmc: fix =
...
Merging devicetree-fixes/dt/linus (d275a5e0c5f5 dt-bindings: display: ti: F=
ix compatible for am62a7 dss)
...
Merging drm-intel-fixes/for-linux-next-fixes (3cf3ec911d70 drm/i915/backlig=
ht: Return immediately when scale() finds invalid parameters)
...
Merging gpio-brgl-fixes/gpio/for-current (2014c95afece Linux 6.14-rc1)
...
ter IDs)
Merging efi-fixes/urgent (2014c95afece Linux 6.14-rc1)
...
Merging tip-fixes/tip/urgent (68c149079f15 Merge branch into tip/master: 'x=
86/urgent')
...
Merging perf/perf-tools-next (4c4c0724d652 perf: Always feature test reallo=
carray)
...
nto for-next)
Merging samsung-krzk/for-next (e3a9c321273d Merge branch 'next/drivers' int=
o for-next)
...
Merging xilinx/for-next (40c31f99f29a Merge branch 'zynqmp/dt' into for-nex=
t)
...
Merging fs-next (41609d5888d1 Merge branch 'for-next' of git://git.kernel.o=
...
Merging hid/for-next (3713dfc30e9c Merge branches 'for-6.14/upstream-fixes'=
 and 'for-6.15/usb-hidbp' into for-next)
...
Merging cpufreq-arm/cpufreq/arm/linux-next (a5a904d00635 cpufreq: Remove cp=
...
Merging ath-next/for-next (9d13950acb2a wifi: ath11k: fix wrong overriding =
for VHT Beamformee STS Capability)
...
Merging amdgpu/drm-next (e01f07cb9251 drm/amd/display: Fix seamless boot se=
quence)
Merging drm-intel/for-linux-next (67782bf6e8a6 drm/i915/mst: Convert intel_=
dp_mtp_tu_compute_config() to .4 format)
  2499212e2160 ("drm/i915/hdcp: Use correct function to check if encoder is=
 HDMI")
  35e1aacfe536 ("drm/i915: Drop 64bpp YUV formats from ICL+ SDR planes")
  605a33e76589 ("drm/i915/hdcp: Fix Repeater authentication during topology=
 change")
  6f7150741584 ("drm/i915/backlight: Return immediately when scale() finds =
invalid parameters")
  a67221b5eb8d ("drm/i915/dp: Return min bpc supported by source instead of=
 0")
  c5806862543f ("drm/i915/dp: fix the Adaptive sync Operation mode for SDP")
...
Merging drm-xe/drm-xe-next (206fa53fe1f1 drm/xe: Refactor max_remote_tiles)
...
Merging sound-asoc/for-next (a8c9a4533876 ASoC: fsl_micfil: Enable default =
case in micfil_set_quality())
...
Merging input/next (08bd5b7c9a24 Input: synaptics - fix crash when enabling=
 pass-through port)
Merging block/for-next (ef6b10807de7 Merge branch 'block-6.14' into for-nex=
t)
...
Merging spi/for-next (26a756fc10fa spi: zynqmp-gqspi: Clean up the driver a=
 bit)
Merging tip/master (68c149079f15 Merge branch into tip/master: 'x86/urgent')
...
Merging usb/usb-next (2014c95afece Linux 6.14-rc1)
Merging thunderbolt/next (ecf9272e87f4 thunderbolt: Disable Gen 4 Recovery =
on Asymmetric Transitions)
...
Merging staging/staging-next (2014c95afece Linux 6.14-rc1)
...
Merging pinctrl/for-next (0a7404fc5399 pinctrl: cy8c95x0: Rename PWMSEL to =
SELPWM)
...
Merging cxl/next (0fd158c1ea0c cxl/pci: Support Global Persistent Flush (GP=
F))
...

=3avG
-----END PGP SIGNATURE-----
