...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BE2DB4CA25A
	for <lists+linux-next@lfdr.de>; Wed,  2 Mar 2022 11:39:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235681AbiCBKki (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 2 Mar 2022 05:40:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59402 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235031AbiCBKki (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 2 Mar 2022 05:40:38 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 780CD21832;
        Wed,  2 Mar 2022 02:39:52 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4K7rGZ1w5fz4xZ5;
        Wed,  2 Mar 2022 21:39:50 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1646217590;
        bh=GZeW2nv22FddSRqKI01cWuib4pip+G8Bqgv+8rc2/C0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 2 Mar 2022 21:39:49 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 2
Message-ID: <20220302213949.7a9984b9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Q1tjqXOJlImQOT/OGuX_Z.A";
...
--Sig_/Q1tjqXOJlImQOT/OGuX_Z.A
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220301:
...
failure so I used the version from next-20220301.
...
Non-merge commits (relative to Linus' tree): 9108
 9192 files changed, 863395 insertions(+), 205775 deletions(-)
...
Merging origin/master (fb184c4af9b9 Merge tag 'for-linus' of git://git.kern=
...
Merging arm-soc-fixes/arm/fixes (8fcc54796bdf arm64: dts: armada-3720-turri=
...
Merging net/master (b8d06ce712e3 Merge tag 'wireless-for-net-2022-03-01' of=
 git://git.kernel.org/pub/scm/linux/kernel/git/wireless/wireless)
Merging bpf/master (18b1ab7aa76b xsk: Fix race at socket teardown)
Merging ipsec/master (519ca6fa9605 Merge branch '40GbE' of git://git.kernel=
.org/pub/scm/linux/kernel/git/tnguy/net-queue)
Merging netfilter/master (db6140e5e35a net/sched: act_ct: Fix flow table lo=
okup failure with no originating ifindex)
...
Merging spi-fixes/for-linus (59a450a32e19 Merge remote-tracking branch 'spi=
...
Merging staging.current/staging-linus (fc7f750dc9d1 staging: gdm724x: fix u=
se after free in gdm_lte_rx())
...
Merging input-current/for-linus (d98299266973 Input: goodix - workaround Ch=
erry Trail devices with a bogus ACPI Interrupt() resource)
...
ice())
Merging arm-soc/for-next (89fe6fa20637 Merge branch 'arm/fixes' into for-ne=
xt)
CONFLICT (content): Merge conflict in arch/arm/Kconfig
$ git reset --hard HEAD^
Merging next-20220301 version of arm-soc
CONFLICT (content): Merge conflict in arch/arm/Kconfig
[master 7a04e148a546] next-20220301/arm-soc
...
o for-next)
Merging mvebu/for-next (8e1bc02d9dd7 Merge branch 'mvebu/dt64' into mvebu/f=
or-next)
...
Merging sunxi/sunxi/for-next (f25c47c67629 Merge branch 'sunxi/dt-for-5.18'=
 into sunxi/for-next)
Merging tee/next (b95c18100ed5 Merge tag 'tee-shm-for-v5.18' into next)
...
Merging ceph/master (4a392c0308fb ceph: fix memory leakage in ceph_readdir)
...
nto for-next)
Merging i2c/i2c/for-next (406826932fdb Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
...
ere it fits)
Merging pm/linux-next (ac62facbd440 Merge branch 'acpi-fan' into linux-next)
...
o header file)
Merging net-next/master (7282c126f768 Merge branch 'smc-datapath-opts')
CONFLICT (content): Merge conflict in drivers/hwmon/adt7310.c
CONFLICT (content): Merge conflict in net/smc/af_smc.c
$ git reset --hard HEAD^
Merging next-20220301 version of net-next
CONFLICT (content): Merge conflict in drivers/hwmon/adt7310.c
[master a1afb4db969a] next-20220301/net-next
Merging bpf-next/for-next (530e214c5b5a bpf, test_run: Fix overflow in XDP =
frags bpf_test_finish)
...
tifier support (v2))
Merging drm-intel/for-linux-next (17003d109e6c drm/i915: make a handful of =
...
Merging sound-asoc/for-next (560b539f15af Merge remote-tracking branch 'aso=
...
S_DB1XXX boards)
Merging mmc/next (a4ee79063f44 dt-bindings: mmc: renesas,sdhi: Document RZ/=
V2L SoC)
...
Merging selinux/next (70868c6b8fd8 docs: fix 'make htmldocs' warning in SCT=
P.rst)
...
rules)
Merging devicetree/for-next (53157759f56b dt-bindings: usb: renesas,usbhs: =
Document RZ/V2L bindings)
Merging mailbox/mailbox-for-next (869b6ca39c08 dt-bindings: mailbox: Add mo=
re protocol and client ID)
Merging spi/for-next (ee60db9e1738 Merge remote-tracking branch 'spi/for-5.=
18' into spi-next)
...
ac-for-next)
Merging irqchip/irq/irqchip-next (6a3e2ef71238 Merge branch irq/misc-5.18 i=
...
Merging drivers-x86/for-next (555a28b9ab1c platform/x86: x86-android-tablet=
...
Merging tty/tty-next (16b3ac9041a3 Revert "tty: serial: meson: *")
...
Merging iio/togreg (f568cbd9aef2 dt-bindings: iio: Add ltc2688 documentatio=
n)
...
Merging mhi/mhi-next (6f5744ca0d90 bus: mhi: ep: Add uevent support for mod=
ule autoloading)
$ git reset --hard HEAD^
Merging next-20220301 version of mhi
...
r-next)
Merging random/master (cdb1ac81d104 random: do not export add_vmfork_random=
ness() unless needed)
...
into for-next/kspp)
$ git reset --hard HEAD^
Merging next-20220228 version of kspp
CONFLICT (content): Merge conflict in drivers/gpu/drm/dp/drm_dp.c
[master 6ef20bebe2b6] next-20220228/kspp
...
Merging akpm-current/current (54f072c48a98 ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
...
Merging akpm/master (0c65ecacb294 kselftest/vm: fix tests build with old li=
bc)
...

=i9F1
-----END PGP SIGNATURE-----
