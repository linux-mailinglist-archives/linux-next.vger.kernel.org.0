...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BF6C97A9112
	for <lists+linux-next@lfdr.de>; Thu, 21 Sep 2023 04:49:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229736AbjIUCtJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 20 Sep 2023 22:49:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49642 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229713AbjIUCtG (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 20 Sep 2023 22:49:06 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B0B99E6;
        Wed, 20 Sep 2023 19:48:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1695264521;
        bh=64AbKoDANUS+6VDvUcbDS7e6lT4OSUhLnMcA3w3MzDA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Rrfwn2Rp0z4x2Y;
        Thu, 21 Sep 2023 12:48:41 +1000 (AEST)
Date:   Thu, 21 Sep 2023 12:48:39 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 21
Message-ID: <20230921124839.77046797@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/XyYlL1YSpOg1DIzg1B3c6EI";
...
Merging origin/master (42dc814987c1 Merge tag 'media/v6.6-2' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (de6e0381819e mm: abstract moving =
to the next PFN)
...
Merging net/main (4a0f07d71b04 net/handshake: Fix memory leak in __sock_cre=
ate() and sock_alloc_file())
...
Merging netfilter/main (4e4b1798cc90 vxlan: Add missing entries to vxlan_ge=
t_size())
...
ument)
Merging sound-current/for-linus (0eb0e272e4bb Merge tag 'asoc-fix-v6.6-rc2'=
...
Merging drm-intel-fixes/for-linux-next-fixes (c524cd40e8a2 i915/pmu: Move e=
xeclist stats initialization to execlist specific setup)
...
Merging risc-v-fixes/fixes (b06fab003ae1 riscv: kselftests: Fix mm build by=
 removing testcases subdirectory)
...
Merging gpio-brgl-fixes/gpio/for-current (b547b5e52a05 gpio: tb10x: Fix an =
error handling path in tb10x_gpio_probe())
...
stem to pmdomain)
Merging drm-misc-fixes/for-linux-next-fixes (4556b93f6c02 drm/virtio: clean=
 out_fence on complete_submit)
Merging mm-stable/mm-stable (ce9ecca0238b Linux 6.6-rc2)
Merging mm-nonmm-stable/mm-nonmm-stable (ce9ecca0238b Linux 6.6-rc2)
Merging mm/mm-everything (f43616df7b8e Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
to for-next)
Merging qcom/for-next (a35461d47fe3 Merge branches 'arm64-defconfig-for-6.7=
...
or-next)
Merging scmi/for-linux-next (102b3f252c53 Merge branches 'for-next/scmi/fix=
...
ums)
Merging btrfs/for-next (ee7c0ec09810 Merge branch 'for-next-next-v6.6-20230=
920' into for-next-20230920)
...
Merging cifs/for-next (7fb77d9c87b8 smb: client: handle STATUS_IO_REPARSE_T=
AG_NOT_HANDLED)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (076cdd98c2c3 Merge tag 'v6.6-rc3.vfs.ctime.rev=
ert' into vfs.all)
...
Merging rdma/for-next (4ececeb83986 IB/hfi1: Remove open coded reference to=
 skb frag offset)
Merging net-next/main (b3af9c0e89ca Merge git://git.kernel.org/pub/scm/linu=
x/kernel/git/bpf/bpf-next)
...
ng vhci device)
Merging wireless-next/for-next (74f7957c9b1b wifi: rtw88: debug: Fix the NU=
LL vs IS_ERR() bug for debugfs_create_file())
...
- add missing escape)
Merging drm-misc/for-linux-next (887878014534 drm/bridge: panel: Fix device=
 link for DRM_BRIDGE_ATTACH_NO_CONNECTOR)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (16a9359401ed drm/i915: Implement transcod=
er LRR for TGL+)
...
k after snprintf())
Merging sound/for-next (72f6a13022f3 kselftest/alsa: pcm-test: Report cards=
 declared in config but missing)
...
Merging regulator/for-next (a644f6edc3ab Merge remote-tracking branch 'regu=
...
counted_by)
Merging devicetree/for-next (14571ab1ad21 kselftest: Add new test for detec=
ting unprobed Devicetree devices)
...
Merging rpmsg/for-next (461c2df89e36 Merge branches 'hwspinlock-next' and '=
...
Merging slab/slab/for-next (70ff246387ee Merge branch 'slab/for-6.7/orders-=
...

=gmqW
-----END PGP SIGNATURE-----
