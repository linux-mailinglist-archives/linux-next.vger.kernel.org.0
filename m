...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AE9613F5BFE
	for <lists+linux-next@lfdr.de>; Tue, 24 Aug 2021 12:23:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236068AbhHXKYl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 24 Aug 2021 06:24:41 -0400
Received: from ozlabs.org ([203.11.71.1]:47035 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235829AbhHXKYk (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 24 Aug 2021 06:24:40 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Gv4vt5QcKz9sW8;
        Tue, 24 Aug 2021 20:23:54 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1629800634;
        bh=IWXDgPfKCVq7iuuq6HzIQTo7Tnc23e8jTiDti1TDhWE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 24 Aug 2021 20:23:53 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 24
Message-ID: <20210824202353.66c1d460@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/poM_XsyfiTWGr_cqR0G+ZmA";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/poM_XsyfiTWGr_cqR0G+ZmA
...
Merging origin/master (d5ae8d7f85b7 Revert "media: dvb header files: move s=
ome headers to staging")
...
struct rxe_queue)
Merging sound-current/for-linus (13d9c6b998aa ALSA: hda/realtek: Workaround=
 for conflicting SSID on ASUS ROG Strix G17)
...
or-next)
Merging arm64/for-next/core (1fa297625ed7 Merge branch 'for-next/entry' int=
o for-next/core)
...
Merging f2fs/dev (80edc614b5c7 f2fs: Don't create discard thread when devic=
e doesn't support realtime discard)
...
Merging file-locks/locks-next (f7e33bdbd6d1 fs: remove mandatory file locki=
ng support)
...
Merging cpufreq-arm/cpufreq/arm/linux-next (07c2fc64e0f9 cpufreq: qcom-hw: =
...
q struct to irqn)
Merging net-next/master (f6a4e0e8a00f via-velocity: Use of_device_get_match=
_data to simplify code)
CONFLICT (content): Merge conflict in MAINTAINERS
Applying: NET_VENDOR_CIRRUS is not ready for COMPILE_TEST
Merging bpf-next/for-next (4ed589a27893 Merge branch 'Refactor cgroup_bpf i=
nternals to use more specific attach_type')
...
tifier support (v2))
Merging drm-intel/for-linux-next (c79b846f892d drm/i915/adl_s: Update ADL-S=
 PCI IDs)
...
Merging sound/for-next (e28ac04a705e ASoC: intel: atom: Revert PCM buffer a=
ddress setup workaround again)
...
Merging block/for-next (9d09cba59515 Merge branch 'io_uring-bio-cache.5' in=
to for-next)
...
it.h)
Merging devicetree/for-next (1ee7943c3343 kbuild: Enable dtc 'pci_device_re=
g' warning by default)
...
Merging scsi-mkp/for-next (d09224115cf6 scsi: lpfc: Copyright updates for 1=
4.0.0.1 patches)
...

=tj/t
-----END PGP SIGNATURE-----
