Return-Path: <linux-next+bounces-4739-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 505449C3C7F
	for <lists+linux-next@lfdr.de>; Mon, 11 Nov 2024 11:57:36 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 0CCDE1F21AE4
	for <lists+linux-next@lfdr.de>; Mon, 11 Nov 2024 10:57:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 586B216F0EC;
	Mon, 11 Nov 2024 10:57:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="U6Ai95sl"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-f181.google.com (mail-pf1-f181.google.com [209.85.210.181])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1ECD016EBED
	for <linux-next@vger.kernel.org>; Mon, 11 Nov 2024 10:57:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.181
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731322649; cv=none; b=i4S2ySVpbn5I18gJ/XsK7Q4+C9HddL1pMRFA5lFvfihjexEYjk68ncqn6yod/vSjqxlz00z90e8IOR4x//dmvnr1fW1dDnh85Ia1n1M/ic0a3lwQG8KU1qURkrqMbDOLWg25pBe5pqEXW6mFbrSTQZoDrLpgByvURDObp4cK7J8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731322649; c=relaxed/simple;
	bh=2VR9Y862Rno6O92+gh3rJ5mEA3x+QoVg0FL1MKSbb94=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=mu/VD1uOPysCBATfiJFXB2WBJXDXhX9ye/HIA7Ne5m+4q2OgR2geAUcIKKRHHTO4f4afPbyalho+BzMzC2i5dolSaRw6/idr/2yxiBzWo73yRCHNVBrcEwfUh+inVWivJNMWZhXQe1Ir+cswel2JMnMObKx3sbc3veXI5D27iRQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=U6Ai95sl; arc=none smtp.client-ip=209.85.210.181
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pf1-f181.google.com with SMTP id d2e1a72fcca58-71e4e481692so4323125b3a.1
        for <linux-next@vger.kernel.org>; Mon, 11 Nov 2024 02:57:02 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1731322622; x=1731927422; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=NTtzCVyG1SLS19Q2745pFKaM5ruizHZT0WGiow31rhs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1731322622; x=1731927422;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=NTtzCVyG1SLS19Q2745pFKaM5ruizHZT0WGiow31rhs=;
        b=
X-Gm-Message-State: AOJu0YyIGBa3e5CECqpOa2uEu2LnaXJ7Wsywz9OhCqRyCHLrrJOnUnGh
	Lxt9VWO4k4SetPF0euqfJnA7OY5aOL+RRpg3Q9rdphoXKQgZbqnYvrtyRDrpfYO8SjP6D4hL4Jd
	l
X-Google-Smtp-Source: AGHT+IHIMFIhrcUpOg+pK9Bmy3A3XXJ1JJN4usMzqzm8Vk8wUQgax8Q8RG8h/YQiLvh4iZkrvMNPjw==
X-Received: by 2002:a05:6a00:188d:b0:71e:4655:59ce with SMTP id d2e1a72fcca58-7241314261fmr18139640b3a.0.1731322620434;
        Mon, 11 Nov 2024 02:57:00 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id d2e1a72fcca58-72407863defsm9098516b3a.24.2024.11.11.02.56.58
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 11 Nov 2024 02:56:59 -0800 (PST)
Message-ID: <6731e2fb.050a0220.24b30d.43e1@mx.google.com>
Date: Mon, 11 Nov 2024 02:56:59 -0800 (PST)
...
Subject: next/master build: 185 builds: 5 failed, 180 passed, 4 errors,
 5904 warnings (next-20241111)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 185 builds: 5 failed, 180 passed, 4 errors, 5904 warning=
s (next-20241111)
...
Tree: next
Branch: master
Git Describe: next-20241111
Git Commit: 6d59cab07b8d74d0f0422b750038123334f6ecc2
...
arm:
    ...
    multi_v5_defconfig (clang-17): 7 warnings
...
riscv:
    defconfig (clang-17): 4 errors, 2 warnings
    nommu_k210_defconfig (clang-17): 2527 warnings
...
Errors summary:
    ...
    1    security/apparmor/domain.c:704:11: error: use of undeclared identi=
fier 'new_profile'
    1    security/apparmor/domain.c:699:8: error: use of undeclared identif=
ier 'new_profile'
    1    security/apparmor/domain.c:697:3: error: use of undeclared identif=
ier 'new_profile'
    1    security/apparmor/domain.c:695:3: error: expected expression
...
hmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    700  include/asm-generic/io.h:847:2: warning: performing pointer arithm=
...
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    700  include/asm-generic/io.h:812:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    699  include/asm-generic/io.h:838:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    699  include/asm-generic/io.h:804:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    696  include/asm-generic/io.h:829:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
efined behavior [-Wnull-pointer-arithmetic]
    1    warning118 | #define outsb(addr, buffer, count) __outsb(PCI_IOBASE=
 + (addr), buffer, count)
    1    vmlinux.o: warning: objtool: set_ftrace_ops_ro+0x23: relocation to=
 !ENDBR: .text+0x14edc9
    1    o../include/asm-generic/io.hu:t829s:b2(:a dwarning: dperforming po=
...
NAMIC dynamic table is invalid: SHT_DYNAMIC will be used
    1    include/asm-generic/io.ha:d829d:r2):,  bwarning: uperforming point=
er arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arit=
hmetic]ff
    1    include/asm-generic/io.h:838:2:   warning: 120 | performing pointe=
r arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arith=
metic]#
    1    include/asm-generic/io.h:838 :11752 | :         rwarning: etperfor=
ming pointer arithmetic on a null pointer has undefined behavior [-Wnull-po=
inter-arithmetic]u
    1    include/asm-generic/io.h:829:2: warning:   CC      lib/bcd.o
    1    include/asm-generic/io.h:8297 warnings generated.
    1    include/asm-generic/io.h:804:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]..=
/drivers/base/cpu.c:20:
    1    include/asm-generic/io.h:804:2: warning:   CC      mm/percpu.o
    1    include/asm-generic/io.h  :812812 | :        2i:n swarning: wperfo=
...
ype for =E2=80=98ath79_cpu_irq_init=E2=80=99 [-Wmissing-prototypes]
    1    drivers/input/touchscreen/ads7846.c:419:24: warning: array index 7=
 is past the end of the array (that has type 'struct spi_transfer[6]') [-Wa=
rray-bounds]
    1    drivers/input/touchscreen/ads7846.c:418:12: warning: array index 7=
 is past the end of the array (that has type 'struct spi_transfer[6]') [-Wa=
rray-bounds]
    1    drivers/input/touchscreen/ads7846.c:417:2: warning: array index 7 =
is past the end of the array (that has type 'struct spi_transfer[6]') [-War=
ray-bounds]
    1    drivers/input/touchscreen/ads7846.c:416:2: warning: array index 7 =
is past the end of the array (that has type 'struct spi_transfer[6]') [-War=
ray-bounds]
    1    drivers/input/touchscreen/ads7846.c:413:2: warning: array index 6 =
is past the end of the array (that has type 'struct spi_transfer[6]') [-War=
ray-bounds]
    1    drivers/input/touchscreen/ads7846.c:412:2: warning: array index 6 =
is past the end of the array (that has type 'struct spi_transfer[6]') [-War=
ray-bounds]
    1    arch/riscv/include/asm/io.h:1047 warnings generated.
    1    arch/riscv/include/asm/io.h../include/asm-generic/io.h::106820::53=
:2 :note:  expanded from macro 'insl'warning:
...
t an interrupt provider
    1    a../include/asm-generic/io.hd:d820r:)2,: b warning: uperforming po=
inter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-a=
rithmetic]f
    1    In file included from warning: ../include/linux/io.hperforming poi=
nter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-ar=
ithmetic]:
    1    In file included from ../include/linux/interrupt.h:117 warnings ge=
nerated.
    1    In file included from ../include/linux/hardirq.h: warnings generat=
ed.
    1    In file included from ../include/linux/clocksource.h7 warnings gen=
erated.
    1    In file included from ../include/asm-generic/hardirq.h7 warnings: =
generated17:
    1    In file included from ../arch/riscv/include/asm/io.h:7 warnings ge=
nerated.
    1    I../include/asm-generic/io.hOB:A838SE: 2+: ( awarning: ddperformin=
g pointer arithmetic on a null pointer has undefined behavior [-Wnull-point=
er-arithmetic]r)
    1    A../include/asm-generic/io.hS:E829 :+2 :( awarning: dperforming po=
inter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-a=
rithmetic]d
    1    :In file included from 55../include/linux/irq.h:: 20warning: :
    1    :In file included from  ../include/linux/memcontrol.h:warning: 13p=
erforming pointer arithmetic on a null pointer has undefined behavior [-Wnu=
ll-pointer-arithmetic]:
    1    :847:2:../arch/riscv/include/asm/io.h :warning: 105performing poin=
ter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-ari=
thmetic]:
    1    :829:2: warning: performing pointer arithmetic on a null pointer h=
as undefined behavior [-Wnull-pointer-arithmetic]
    1    :804:2: warning: performing pointer arithmetic on a null pointer h=
as undefined behavior [-Wnull-pointer-arithmetic]
    1    :2: warning: performing pointer arithmetic on a null pointer has u=
ndefined behavior [-Wnull-pointer-arithmetic]
    1    :../include/asm-generic/io.h829::8472::2 :warning:  performing poi=
nter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-ar=
ithmetic]warning:
    1    :../include/asm-generic/io.h119::84755::2 :note:  expanded from ma=
cro 'outsw'warning:
    1    847:2: warning: performing pointer arithmetic on a null pointer ha=
s undefined behavior [-Wnull-pointer-arithmetic]
    1    829 |         outsb(add7 warnings generated.
    1    6 warnings generated.
    1    120 | #define outsl(addr, buffer, count) __out7 warnings generated.
    1    120 | #define outsl(ad7 warnings generated.
    1    120 | #d7ef warningisn generatede.
    1    1175 |         return (port > MMIO_UP7 warnings generated.
    1    1175 |         re7 warnings generated.
    1    105 | #define7 warnings generated.
    1    )../include/asm-generic/io.h :_838_:o2ut:s wwarning: (performing p=
...
---------------------------------------------------------------------------=
-----
defconfig (riscv, clang-17) =E2=80=94 FAIL, 4 errors, 2 warnings, 0 section=
 mismatches

Errors:
    security/apparmor/domain.c:695:3: error: expected expression
    security/apparmor/domain.c:697:3: error: use of undeclared identifier '=
new_profile'
    security/apparmor/domain.c:699:8: error: use of undeclared identifier '=
new_profile'
    security/apparmor/domain.c:704:11: error: use of undeclared identifier =
'new_profile'
...
---------------------------------------------------------------------------=
-----
multi_v5_defconfig (arm, clang-17) =E2=80=94 PASS, 0 errors, 7 warnings, 0 =
section mismatches

Warnings:
    drivers/input/touchscreen/ads7846.c:412:2: warning: array index 6 is pa=
st the end of the array (that has type 'struct spi_transfer[6]') [-Warray-b=
ounds]
    drivers/input/touchscreen/ads7846.c:413:2: warning: array index 6 is pa=
st the end of the array (that has type 'struct spi_transfer[6]') [-Warray-b=
ounds]
    drivers/input/touchscreen/ads7846.c:416:2: warning: array index 7 is pa=
st the end of the array (that has type 'struct spi_transfer[6]') [-Warray-b=
ounds]
    drivers/input/touchscreen/ads7846.c:417:2: warning: array index 7 is pa=
st the end of the array (that has type 'struct spi_transfer[6]') [-Warray-b=
ounds]
    drivers/input/touchscreen/ads7846.c:418:12: warning: array index 7 is p=
ast the end of the array (that has type 'struct spi_transfer[6]') [-Warray-=
bounds]
    drivers/input/touchscreen/ads7846.c:419:24: warning: array index 7 is p=
ast the end of the array (that has type 'struct spi_transfer[6]') [-Warray-=
bounds]
...
---------------------------------------------------------------------------=
-----
nommu_k210_defconfig (riscv, clang-17) =E2=80=94 PASS, 0 errors, 2527 warni=
ngs, 0 section mismatches
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    warning118 | #define outsb(addr, buffer, count) __outsb(PCI_IOBASE + (a=
ddr), buffer, count)
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    :../include/asm-generic/io.h829::8472::2 :warning:  performing pointer =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.ha:d829d:r2):,  bwarning: uperforming pointer ar=
ithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmeti=
c]ff
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2:   warning: 120 | performing pointer ari=
thmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic=
]#
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7 warnings generated.
    7 warnings generated.
    include/asm-generic/io.h:804:2: warning:   CC      mm/percpu.o
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    I../include/asm-generic/io.hOB:A838SE: 2+: ( awarning: ddperforming poi=
nter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-ar=
ithmetic]r)
    :In file included from  ../include/linux/memcontrol.h:warning: 13perfor=
ming pointer arithmetic on a null pointer has undefined behavior [-Wnull-po=
inter-arithmetic]:
    :847:2:../arch/riscv/include/asm/io.h :warning: 105performing pointer a=
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    1175 |         return (port > MMIO_UP7 warnings generated.
    7 warnings generated.
    7 warnings generated.
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:8297 warnings generated.
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    847:2: warning: performing pointer arithmetic on a null pointer has und=
efined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7 warnings generated.
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    120 | #define outsl(ad7 warnings generated.
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    120 | #define outsl(addr, buffer, count) __out7 warnings generated.
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7 warnings generated.
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    105 | #define7 warnings generated.
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    In file included from ../include/linux/clocksource.h7 warnings generate=
d.
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    829 |         outsb(add7 warnings generated.
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    120 | #d7ef warningisn generatede.
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7 warnings generated.
    7 warnings generated.
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    :In file included from 55../include/linux/irq.h:: 20warning: :
    include/asm-generic/io.h:838 :11752 | :         rwarning: etperforming =
...
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    arch/riscv/include/asm/io.h:1047 warnings generated.
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    :804:2: warning: performing pointer arithmetic on a null pointer has un=
defined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    a../include/asm-generic/io.hd:d820r:)2,: b warning: uperforming pointer=
 arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithm=
etic]f
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    A../include/asm-generic/io.hS:E829 :+2 :( awarning: dperforming pointer=
 arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithm=
etic]d
    warning: performing pointer arithmetic on a null pointer has undefined =
behavior [-Wnull-pointer-arithmetic]
    :../include/asm-generic/io.h119::84755::2 :note:  expanded from macro '=
outsw'warning:
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning:   CC      lib/bcd.o
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    In file included from ../include/asm-generic/hardirq.h7 warnings: gener=
ated17:
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
...
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    warning: |         ^~~~~~~~~~~~~~~~~~~~~~~~~performing pointer arithmet=
ic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    In file included from warning: ../include/linux/io.hperforming pointer =
arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithme=
tic]:
    include/asm-generic/io.h  :812812 | :        2i:n swarning: wperforming=
...
cgroup.h
    arch/riscv/include/asm/io.h../include/asm-generic/io.h::106820::53:2 :n=
ote:  expanded from macro 'insl'warning:
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    o../include/asm-generic/io.hu:t829s:b2(:a dwarning: dperforming pointer=
 arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithm=
etic]r,
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    )../include/asm-generic/io.h :_838_:o2ut:s wwarning: (performing pointe=
r arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arith=
metic]P
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    ...
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    In file included from ../include/linux/interrupt.h:117 warnings generat=
ed.
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
...
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    ...
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    In file included from ../include/linux/hardirq.h: warnings generated.
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]../driv=
ers/base/cpu.c:20:
    :829:2: warning: performing pointer arithmetic on a null pointer has un=
defined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
