...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CABF23E4503
	for <lists+linux-next@lfdr.de>; Mon,  9 Aug 2021 13:39:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235061AbhHILjx (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 9 Aug 2021 07:39:53 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:40065 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S235027AbhHILjx (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 9 Aug 2021 07:39:53 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GjvJ24xnSz9s24;
        Mon,  9 Aug 2021 21:39:30 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1628509171;
        bh=mSu1tinclt1osHjMcw9m+2fcRF/K+17f1SD8jT/B38M=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 9 Aug 2021 21:39:29 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 9
Message-ID: <20210809213929.0c66ff8c@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/4WOOKgHLBdOJ1OQ+XXrltZC";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/4WOOKgHLBdOJ1OQ+XXrltZC
...
Merging net/master (3125f26c5148 ppp: Fix generating ppp unit id when ifnam=
e is not specified)
Merging bpf/master (c4eb1f403243 bpf: Fix integer overflow involving bucket=
_size)
Merging ipsec/master (480e93e12aa0 net: xfrm: Fix end of loop tests for lis=
t_for_each_entry)
Merging netfilter/master (cc4e5eecd43b Merge git://git.kernel.org/pub/scm/l=
...
Merging mac80211/master (f9a5c358c8d2 cfg80211: Fix possible memory leak in=
...
Merging sound-current/for-linus (739d0959fbed ALSA: hda: Add quirk for ASUS=
 Flow x13)
Merging sound-asoc-fixes/for-linus (b7b9d3e8649d Merge remote-tracking bran=
ch 'asoc/for-5.14' into asoc-linus)
Merging regmap-fixes/for-linus (ff1176468d36 Linux 5.14-rc3)
Merging regulator-fixes/for-linus (742c28e7bb66 Merge remote-tracking branc=
h 'regulator/for-5.14' into regulator-linus)
Merging spi-fixes/for-linus (37610bcbf59c Merge remote-tracking branch 'spi=
/for-5.14' into spi-linus)
Merging pci-current/for-linus (d5450c42cbc3 PCI: Increase D3 delay for AMD =
Renoir/Cezanne XHCI)
Merging driver-core.current/driver-core-linus (75d95e2e39b2 firmware_loader=
: fix use-after-free in firmware_fallback_sysfs)
Merging tty.current/tty-linus (341abd693d10 serial: 8250_pci: Avoid irq sha=
ring for MSI(-X) interrupts.)
Merging usb.current/usb-linus (43ad944cd73f usb: typec: tcpm: Keep other ev=
ents when receiving FRS and Sourcing_vbus events)
...
Merging staging.current/staging-linus (c7b65650c7f4 staging: mt7621-pci: av=
oid to re-disable clock for those pcies not in use)
Merging iio-fixes/fixes-togreg (5afc1540f138 iio: adc: Fix incorrect exit o=
f for-loop)
Merging char-misc.current/char-misc-linus (6bfc5272904a Merge tag 'icc-5.14=
...
Merging drm-fixes/drm-fixes (d186f9c28008 Merge tag 'amd-drm-fixes-5.14-202=
1-08-05' of https://gitlab.freedesktop.org/agd5f/linux into drm-fixes)
Merging amdgpu-fixes/drm-fixes (2c409ba81be2 drm/radeon: fix si_enable_smc_=
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (1354d830cb8f drm/i915: Call i=
915_globals_exit() if pci_register_device() fails)
...
gpmc' into for-next)
Merging imx-mxs/for-next (bfec305eccea Merge branch 'imx/dt64' into for-nex=
t)
...
ss for BCM2711)
Merging renesas/next (b1f6bead1fb4 Merge branches 'renesas-arm-dt-for-v5.15=
', 'renesas-drivers-for-v5.15' and 'renesas-dt-bindings-for-v5.15' into ren=
esas-next)
...
for-next)
Merging samsung-krzk/for-next (c6caf0e9c1bf Merge branch 'next/dt64' into f=
or-next)
Merging scmi/for-linux-next (1bf7117e6105 Merge branch 'for-next/juno' of g=
...
v5.14-rc1:)
Merging m68knommu/for-next (1d5aff424ff9 m68k: coldfire: return success for=
 clk_enable(NULL))
...
Merging cifs/for-next (662935318ef6 cifs: Handle race conditions during ren=
ame)
...
Merging erofs/dev (6805789f5092 erofs: convert all uncompressed cases to io=
map)
...
encode_getaclres)
Merging cel/for-next (66036bb0b396 SUNRPC: Fix a NULL pointer deref in trac=
e_svc_stats_latency())
Merging orangefs/for-next (0fdec1b3c9fb orangefs: fix orangefs df output.)
Merging overlayfs/overlayfs-next (89741437981a ovl: fix uninitialized point=
er read in ovl_lookup_real_one())
...
Merging cpufreq-arm/cpufreq/arm/linux-next (5d79e5ce5489 cpufreq: blocklist=
 Qualcomm sm8150 in cpufreq-dt-platdev)
...
xt_ptp.h
Merging bpf-next/for-next (c83ae15dc947 Merge branch 'samples/bpf: xdpsock:=
 Minor enhancements')
...
ssion on svga3)
CONFLICT (content): Merge conflict in drivers/gpu/drm/vmwgfx/vmwgfx_drv.h
Merging amdgpu/drm-next (f339f3363abb drm/radeon: Add HD-audio component no=
tifier support (v2))
...
ed functions)
Merging drm-msm/msm-next (840d10b64dad drm: msm: Add 680 gpu to the adreno =
gpu list)
...
Merging sound/for-next (9732c148d0ce ALSA: memalloc: Fix mmap of SG-buffer =
with WC pages)
Merging sound-asoc/for-next (b215d22ba05b Merge remote-tracking branch 'aso=
...
Merging block/for-next (18905e9e316a Merge branch 'for-5.15/io_uring' into =
for-next)
...
Merging regulator/for-next (c4ca33f6610d Merge remote-tracking branch 'regu=
...
tead of pr_err())
Merging iommu/next (848512413696 Merge branches 'iommu/fixes', 'x86/amd' an=
d 'core' into next)
...
Merging spi/for-next (14b55b207625 Merge remote-tracking branch 'spi/for-5.=
15' into spi-next)
...
r-next)
Merging workqueues/for-next (f728c4a9e840 workqueue: Fix possible memory le=
aks in wq_numa_init())
...
from_user() fails)
Merging driver-core/driver-core-next (96ba6c6e8922 Merge tag 'sysfs_defferr=
ed_iomem_get_mapping-5.15' of git://git.kernel.org/pub/scm/linux/kernel/git=
/gregkh/driver-core driver-core-next)
...
Merging tty/tty-next (1fe0e1fa3209 serial: 8250_omap: Handle optional overr=
un-throttle-ms property)
...
Merging thunderbolt/next (1651d9e7810e thunderbolt: Add authorized value to=
 the KOBJ_CHANGE uevent)
...
Merging icc/icc-next (85b1ebfea2b0 interconnect: Fix undersized devress_all=
oc allocation)
Merging dmaengine/next (9760383b22ed Merge tag 'v5.14-rc5' into next)
Merging cgroup/for-next (c3df5fb57fe8 cgroup: rstat: fix A-A deadlock on 32=
bit around u64_stats_sync)
...
Merging userns/for-next (ebc56ddcebbc Merge of ucount-fixes-for-5.14, and s=
...
Merging akpm-current/current (83d4664b1d93 selftests/memfd: remove unused v=
ariable)
...

=P4h5
-----END PGP SIGNATURE-----
