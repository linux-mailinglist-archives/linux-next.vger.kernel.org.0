Return-Path: <linux-next+bounces-722-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A16282A69B
	for <lists+linux-next@lfdr.de>; Thu, 11 Jan 2024 04:49:02 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 00C6F282361
	for <lists+linux-next@lfdr.de>; Thu, 11 Jan 2024 03:49:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BF530ECD;
	Thu, 11 Jan 2024 03:48:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="cKOQsCch"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3F31CEC0;
	Thu, 11 Jan 2024 03:48:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1704944927;
	bh=NZUyjiu8vjHnm38dXGWeX/Zs3upC95sVVSWOng7vkw0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4T9VyR1sw0z4wc3;
	Thu, 11 Jan 2024 14:48:47 +1100 (AEDT)
Date: Thu, 11 Jan 2024 14:48:46 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 11
Message-ID: <20240111144846.74e443a7@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Q4duRJXIen64=ZdTuLWE/Gg";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/Q4duRJXIen64=ZdTuLWE/Gg
...
The cxl tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 9932
 9197 files changed, 475501 insertions(+), 220742 deletions(-)
...
Merging origin/master (0cb552aa9784 Merge tag 'v6.8-p1' of git://git.kernel=
...
Merging sound-asoc-fixes/for-linus (715d499e3eec Merge remote-tracking bran=
...
d with GCC)
Merging arm-soc/for-next (5fedbec0c6f6 soc: document merges)
...
Merging loongarch/loongarch-next (aa504e7b7ab2 Merge branch 'loongarch-kvm'=
 into loongarch-next)
...
RYPTION)
Merging cifs/for-next (26ba1bf310f0 cifs: update internal module version nu=
mber for cifs.ko)
...
Merging pci/next (fbfdb71c8c79 Merge branch 'pci/misc')
...
Merging v4l-dvb-next/master (02d4e62ae245 media: i2c: mt9m114: use fsleep()=
 in place of udelay())
Merging pm/linux-next (442229299a15 Merge branches 'pnp', 'acpi-resource' a=
nd 'acpica' into linux-next)
...
_create_cq())
Merging net-next/main (a7fe0881d9b7 Merge git://git.kernel.org/pub/scm/linu=
...
Merging drm-misc/for-linux-next (89fe46019a62 drm/v3d: Fix support for regi=
ster debugging on the RPi 4)
...
Merging sound-asoc/for-next (715d499e3eec Merge remote-tracking branch 'aso=
...
Merging block/for-next (25c863bf8a6f Merge branch 'for-6.8/block' into for-=
next)
...
8' into spi-next)
Merging tip/master (30389e86e7f6 Merge branch into tip/master: 'x86/tdx')
...
Merging iommufd/for-next (453586c6035e iommufd/selftest: Check the bus type=
 during probe)
Merging devicetree/for-next (c80d96febb31 Merge branch 'dt/header-fixes-for=
-next' into for-next)
...

=Kg3V
-----END PGP SIGNATURE-----
