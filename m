...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 54B1A1A5C6C
	for <lists+linux-next@lfdr.de>; Sun, 12 Apr 2020 05:54:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726708AbgDLDyP (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sat, 11 Apr 2020 23:54:15 -0400
Received: from ozlabs.org ([203.11.71.1]:45221 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726155AbgDLDyO (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sat, 11 Apr 2020 23:54:14 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 490HtT6WLZz9sSk;
        Sun, 12 Apr 2020 13:54:09 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1586663650;
        bh=nRIEiV/CtRgqAakUlbfdVQL+eXvEi0ELrdZ3eCQQiWw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Sun, 12 Apr 2020 13:54:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 12
Message-ID: <20200412135406.2fb4b342@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/SIU=zBPjtFSmgwpr0OPMJe_";
...
Merging origin/master (b032227c6293 Merge tag 'nios2-v5.7-rc1' of git://git=
.kernel.org/pub/scm/linux/kernel/git/lftan/nios2)
...
Merging net/master (9d8592896fd9 docs: networking: add full DIM API)
...
Merging sound-current/for-linus (4963d66b8a26 ALSA: hda/realtek - Enable th=
e headset mic on Asus FX505DT)
...
ng wake-up handling)
Merging staging.current/staging-linus (5b8b9d0c6d0e Merge branch 'akpm' (pa=
tches from Andrew))
...
Merging kbuild/for-next (00d76a0c1943 kbuild: fix comment about missing inc=
lude guard detection)
...
ible-array member)
Merging nfs/linux-next (27d231c0c63b pNFS: Fix RCU lock leakage)
...
-next)
Merging sound/for-next (4963d66b8a26 ALSA: hda/realtek - Enable the headset=
 mic on Asus FX505DT)
...
Merging staging/staging-next (5b8b9d0c6d0e Merge branch 'akpm' (patches fro=
m Andrew))
...
rflow
Merging akpm/master (dd88897a1363 drivers/media/platform/sti/delta/delta-ip=
...

=Dx/v
-----END PGP SIGNATURE-----
