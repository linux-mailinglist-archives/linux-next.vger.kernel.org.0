...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6A91D5927C5
	for <lists+linux-next@lfdr.de>; Mon, 15 Aug 2022 04:29:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229979AbiHOC3g (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 14 Aug 2022 22:29:36 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56420 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229450AbiHOC3f (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 14 Aug 2022 22:29:35 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 40A01202;
        Sun, 14 Aug 2022 19:29:32 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4M5dX70xxwz4x1V;
        Mon, 15 Aug 2022 12:29:27 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1660530567;
        bh=34ThrTax8lviAbTp7BnsW46ZDu/89TNsp6ILIUfvsSE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 15 Aug 2022 12:29:26 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 15
Message-ID: <20220815122926.7fd3ac58@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/PGhkMGVefj65lFYJurTc1I.";
...
The thermal tree gained conflicts against Linus' tree.

The amdgpu tree still had its build failures for which I have reverted
a commit.

Non-merge commits (relative to Linus' tree): 645
 661 files changed, 29787 insertions(+), 6939 deletions(-)
...
Merging origin/master (9f162193d6e4 radix-tree: replace gfp.h inclusion wit=
h gfp_types.h)
Merging fixes/fixes (4a57a8400075 vf/remap: return the amount of bytes actu=
ally deduplicated)
Merging mm-hotfixes/mm-hotfixes-unstable (8a2d7e19d459 radix-tree: replace =
gfp.h inclusion with gfp_types.h)
...
Merging net/master (777885673122 ip6_tunnel: Fix the type of functions)
Merging bpf/master (27e23836ce22 selftests/bpf: Add lru_bug to s390x deny l=
ist)
...
Merging spi-fixes/for-linus (c03094cbad20 Merge remote-tracking branch 'spi=
...
Merging iio-fixes/fixes-togreg (92ffb2335d06 dt-bindings: iio: gyroscope: b=
...
er for_each macros)
Merging perf/perf/core (7391db645938 perf test: Refactor shell tests allowi=
ng subdirs)
...
ine-names)
Merging risc-v-mc/dt-for-next (69dac8e431af Merge tag 'riscv-for-linus-5.20=
-mw2' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
...
Merging ceph/master (a8af0d682ae0 libceph: clean up ceph_osdc_start_request=
 prototype)
Merging cifs/for-next (fc67d86bb4d9 cifs: missing directory in MAINTAINERS =
file)
...
OPP during probe)
Merging thermal/thermal/linux-next (9b5e2c897cd1 Revert "mlxsw: core: Add t=
...
interrupts)
Merging spi/for-next (c03094cbad20 Merge remote-tracking branch 'spi/for-5.=
19' into spi-linus)
Merging tip/master (cf020a9648c5 Merge branch into tip/master: 'x86/platfor=
m')
CONFLICT (content): Merge conflict in arch/x86/um/Makefile
CONFLICT (content): Merge conflict in arch/x86/um/Makefile
CONFLICT (content): Merge conflict in arch/x86/um/Makefile
...
Merging ntb/ntb-next (e4fe2a2fc423 MAINTAINERS: add PCI Endpoint NTB driver=
s to NTB files)
...
ux-staging)
Merging mm/mm-everything (668d95998a53 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...

=o3qa
-----END PGP SIGNATURE-----
