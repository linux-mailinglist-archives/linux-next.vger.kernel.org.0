...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BF66433340F
	for <lists+linux-next@lfdr.de>; Wed, 10 Mar 2021 05:03:10 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229584AbhCJECf (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 9 Mar 2021 23:02:35 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36854 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229521AbhCJECW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 9 Mar 2021 23:02:22 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0C308C06174A;
        Tue,  9 Mar 2021 20:02:21 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DwJLf37l7z9sS8;
        Wed, 10 Mar 2021 15:02:18 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1615348938;
        bh=KDgFMPhuVEYRa8Tz1lFSiHR3bEfhObOBRwQMyK9UJFs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 10 Mar 2021 15:02:17 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 10
Message-ID: <20210310150217.046fef19@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/KuxvQn4MZl0CRXBVHdFsEzw";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/KuxvQn4MZl0CRXBVHdFsEzw
...
Changes since 20210309:

Removed tree: oprofile-removal (finished with)

The akpm-current tree gained build failures for which I reverted
5 commits and added a patch.

Non-merge commits (relative to Linus' tree): 2594
 2474 files changed, 72415 insertions(+), 43122 deletions(-)
...
Merging origin/master (4b3d9f9cf108 Merge tag 'gpio-fixes-for-v5.12-rc3' of=
 git://git.kernel.org/pub/scm/linux/kernel/git/brgl/linux)
Merging fixes/fixes (e71ba9452f0b Linux 5.11-rc2)
Merging kbuild-current/fixes (4fb90e13d159 kbuild: Allow LTO to be selected=
 with KASAN_HW_TAGS)
Merging arc-current/for-curr (7c53f6b671f4 Linux 5.11-rc3)
Merging arm-current/fixes (a38fd8748464 Linux 5.12-rc2)
Merging arm64-fixes/for-next/fixes (86c83365ab76 arm64: kasan: fix page_all=
oc tagging with DEBUG_VIRTUAL)
...
Merging net/master (4416e98594dc atm: idt77252: fix null-ptr-dereference)
Merging bpf/master (05a68ce5fa51 bpf: Don't do bpf_cgroup_storage_set() for=
 kuprobe/tp programs)
...
Merging sound-current/for-linus (c5aa956eaeb0 ALSA: usb-audio: fix use afte=
r free in usb_audio_disconnect)
Merging sound-asoc-fixes/for-linus (2a93b8881906 Merge remote-tracking bran=
ch 'asoc/for-5.12' into asoc-linus)
Merging regmap-fixes/for-linus (72800e6d59d1 Merge remote-tracking branch '=
...
Merging usb.current/usb-linus (58f3367b2359 usb: dwc3: qcom: Add missing DW=
C3 OF node refcount decrement)
...
node_put())
Merging staging.current/staging-linus (102ac9067dce Revert "staging: wfx: r=
...
Merging drm-misc-fixes/for-linux-next-fixes (adcbb6f5113c drm: meson_drv ad=
d shutdown function)
...
Merging qcom/for-next (ab054d004d43 Merge branches 'arm64-defconfig-for-5.1=
...
o ti-k3-next)
Merging ti-k3-new/ti-k3-next (4c842af36839 arm64: dts: ti: k3-j721e-main: A=
dd ICSSG nodes)
...
b is used)
Merging cifs/for-next (04ad69c342fc cifs: do not send close in compound cre=
ate+close requests)
...
Merging printk/for-next (c74f7f042af3 Merge branch 'for-5.13-vsprintf-pgp' =
into for-next)
...
Merging devfreq/devfreq-next (2faf58c0a9f4 PM / devfreq: Check get_dev_stat=
...
Merging regmap/for-next (72800e6d59d1 Merge remote-tracking branch 'regmap/=
for-5.12' into regmap-linus)
Merging sound/for-next (b9dd23bb03fe ALSA: hda/cirrus: Add Headphone and He=
adset MIC Volume Control)
Merging sound-asoc/for-next (1f4782e17ecf Merge remote-tracking branch 'aso=
...
I kobj_to_dev())
Merging mmc/next (a592fb89354c Merge branch 'fixes' into next)
...
Merging usb/usb-next (bebccc4bc658 Merge v5.12-rc2 into usb-next)
...
Merging tty/tty-next (ead791522faf Merge v5.12-rc2 into tty-next)
CONFLICT (content): Merge conflict in drivers/tty/hvc/hvcs.c
Merging char-misc/char-misc-next (080951f99de1 Merge v5.12-rc2 into char-mi=
sc-next)
...
Merging staging/staging-next (e44ad3f18158 Merge v5.12-rc1 into staging-nex=
t)
...
rc1)
Merging akpm-current/current (c15bdc83ef0c gdb: lx-symbols: store the abspa=
th())
...
Merging akpm/master (620e981d0da6 Revert "userfaultfd: support minor fault =
handling for shmem")
Applying: fix for "mm: memory_hotplug: factor out bootmem core functions to=
 bootmem_info.c"
...

=dfWg
-----END PGP SIGNATURE-----
