...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9CA44530FE8
	for <lists+linux-next@lfdr.de>; Mon, 23 May 2022 15:19:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234936AbiEWLcH (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 23 May 2022 07:32:07 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37624 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234935AbiEWLcG (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 23 May 2022 07:32:06 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1C18A4D62E;
        Mon, 23 May 2022 04:32:02 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4L6FXw45Z0z4xD3;
        Mon, 23 May 2022 21:32:00 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1653305520;
        bh=5qsiaFxCtGc0z+Fn+F9NKvkwavBqVTrW3M2qtaSjY0s=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 23 May 2022 21:31:59 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 23
Message-ID: <20220523213159.68972b7a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/2AktubaspPQjun+qn.DdKzW";
...
Merging net/master (0a3ad7d32368 net: dsa: restrict SMSC_LAN9303_I2C kconfi=
g)
...
Merging sound-current/for-linus (7b0efea4baf0 ALSA: usb-audio: Add missing =
ep_idx in fixed EP quirks)
Merging sound-asoc-fixes/for-linus (cf4dd0d459ec Merge remote-tracking bran=
...
Merging kbuild/for-next (73d41750824b kbuild: rebuild multi-object modules =
...
Merging dma-mapping/for-next (d6612cb5c202 dma-direct: don't over-decrypt m=
emory)
...
ng to the sb list)
Merging cifs/for-next (35a2b533a261 smb3: add trace point for oplock not fo=
und)
...
Merging nfsd/for-next (6e2a6ac60c39 nfsd: Fix null-ptr-deref in nfsd_fill_s=
uper())
...
re/main.c
Merging net-next/master (17155d5db7ee dt-bindings: net: toshiba,visconti-dw=
mac: Update the common clock properties)
CONFLICT (content): Merge conflict in drivers/net/ethernet/cadence/macb_mai=
n.c
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/main.c
Merging bpf-next/for-next (c272e2591169 Merge branch 'bpf: refine kernel.un=
privileged_bpf_disabled behaviour')
...
Merging sound-asoc/for-next (ab0f81aece67 Merge remote-tracking branch 'aso=
...
Merging block/for-next (2ea8179ecde4 Merge branch 'for-5.19/drivers' into f=
or-next)
...
Merging tomoyo/master (84baad17cb82 workqueue: Wrap flush_workqueue() using=
 a macro)
...
Merging mailbox/mailbox-for-next (c25f77899753 mailbox: qcom-ipcc: Log the =
pending interrupt during resume)
...
_polled_gp() loops)
Merging kvm/next (7ad144b4ee5f KVM: x86/pmu: Use PERF_TYPE_RAW to merge rep=
rogram_{gp,fixed}counter())
...
rary support)
Merging bitmap/bitmap-for-next (5f5227d9f0f8 nodemask: Fix return values to=
 be unsigned)
...
nal pte"
Applying: Revert "kbuild: check static EXPORT_SYMBOL* by script instead of =
modpost"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (dcdf1ff41e46 mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=36cI
-----END PGP SIGNATURE-----
