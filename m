...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 44BCF3D1E6A
	for <lists+linux-next@lfdr.de>; Thu, 22 Jul 2021 08:42:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230397AbhGVGBt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 22 Jul 2021 02:01:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51600 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229573AbhGVGBq (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 22 Jul 2021 02:01:46 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6FDA4C061575;
        Wed, 21 Jul 2021 23:42:21 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GVjYP75hfz9s1l;
        Thu, 22 Jul 2021 16:42:17 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1626936138;
        bh=427/OYoDgdTRtjG19UllpBXuBxCZiyI3gg8S1lpcgCc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 22 Jul 2021 16:42:16 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 22
Message-ID: <20210722164216.48507acd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/WhZ+GLgvs3hHjg5YQP2wo4d";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/WhZ+GLgvs3hHjg5YQP2wo4d
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

News: I will be on vacation for 2 week from Saturday, so the next
linux-next release after tomorrow will be August 2.

Changes since 20210721:
...
Non-merge commits (relative to Linus' tree): 2463
 2512 files changed, 148908 insertions(+), 44820 deletions(-)
...
Merging origin/master (3d5895cd3517 Merge tag 's390-5.14-3' of git://git.ke=
...
Merging net/master (161dcc024288 net: ixp46x: fix ptp build failure)
...
Merging sound-current/for-linus (234d8f2726f7 Merge tag 'asoc-fix-v5.14-rc2=
...
Merging usb.current/usb-linus (f3a1a937f7b2 Revert "USB: quirks: ignore rem=
ote wake-up on Fibocom L850-GL LTE modem")
...
Merging renesas-fixes/fixes (432b52eea3dc ARM: shmobile: defconfig: Restore=
 graphical consoles)
Merging drm-misc-fixes/for-linux-next-fixes (2dbd9c27eda5 drm/ttm: add miss=
ing NULL checks)
...
Merging overlayfs/overlayfs-next (97f7de13a76b ovl: update ctime when chang=
ing fileattr)
...
Merging net-next/master (c2255ff47768 ionic: cleanly release devlink instan=
ce)
...
rom.h left in tree.
Merging drm-intel/for-linux-next (46b0d7091cb9 drm/i915: Make display worka=
round upper bounds exclusive)
...
Merging folio/for-next (ce7a31350e44 mm/filemap: Add FGP_STABLE)
...
Merging akpm/master (d651260ca117 Merge branch 'akpm-current/current')
...

=dIjG
-----END PGP SIGNATURE-----
