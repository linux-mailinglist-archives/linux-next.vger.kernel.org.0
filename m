...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D6EF8101E57
	for <lists+linux-next@lfdr.de>; Tue, 19 Nov 2019 09:47:11 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727047AbfKSIrL (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 19 Nov 2019 03:47:11 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:43481 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725798AbfKSIrK (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 19 Nov 2019 03:47:10 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47HKFK2XQTz9sPW;
        Tue, 19 Nov 2019 19:47:00 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1574153221;
        bh=hnLaVtKgRgCCxHAvSdn8A6RN/BQx9v2+doT/2tNzjRk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 19 Nov 2019 19:46:58 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 19
Message-ID: <20191119194658.39af50d0@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/CTCQ1RFF9Wx28jMLVmtZuY=";
...
The akpm tree gained a conflict against the rcu tree.

Non-merge commits (relative to Linus' tree): 11409
 10185 files changed, 493434 insertions(+), 219720 deletions(-)
...
Merging origin/master (af42d3466bdc Linux 5.4-rc8)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (2d691aeca4ae drm/i915/userptr=
: Try to acquire the page lock around set_page_dirty())
...
er driver)
Merging rockchip/for-next (0570b8dd156f Merge branch 'v5.5-armsoc/dts64' in=
to for-next)
...
Merging btrfs/for-next (97f6e846e9cf Merge branch 'misc-5.5' into for-next-=
20191118)
...
e pmbus driver)
Merging jc_docs/docs-next (5ca470a0c388 docs: Add request_irq() documentati=
on)
...
Merging bpf-next/master (2ea2612b987a selftests, bpf: Workaround an alu32 s=
ub-register spilling issue)
...
Merging gfs2/for-next (d99724c3c36a gfs2: Close timing window with GLF_INVA=
LIDATE_IN_PROGRESS)
...
Merging block/for-next (86ce34b03568 Merge branch 'for-5.5/block' into for-=
next)
...
Merging usb/usb-next (65cc8bf99349 USB: documentation: flags on usb-storage=
 versus UAS)
...
rflow
Merging akpm/master (507341d8a605 drivers/media/platform/sti/delta/delta-ip=
...

=8qPt
-----END PGP SIGNATURE-----
