Return-Path: <linux-next+bounces-606-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 7B094823BB6
	for <lists+linux-next@lfdr.de>; Thu,  4 Jan 2024 06:15:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id CE7C31F25E9A
	for <lists+linux-next@lfdr.de>; Thu,  4 Jan 2024 05:15:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 23EB01D68E;
	Thu,  4 Jan 2024 05:15:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="MUBfVEri"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 32D191D689;
	Thu,  4 Jan 2024 05:15:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1704345328;
	bh=mZ5QoHaAZMlnbZ1zHIAXSo8qTkAaQgIzo4aLvjagTak=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4T5FCh255Pz4wcc;
	Thu,  4 Jan 2024 16:15:28 +1100 (AEDT)
Date: Thu, 4 Jan 2024 16:15:26 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 4
Message-ID: <20240104161526.384c7f7a@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/kPYUgAHKzp8u7ZiZvtcrO.C";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/kPYUgAHKzp8u7ZiZvtcrO.C
...
Merging net/main (01b2885d9415 net: Save and restore msg_namelen in sock_se=
ndmsg)
...
Merging sound-current/for-linus (c344ef36dbc2 ASoC: SOF: Intel: hda-codec: =
Delay the codec device registration)
...
Merging drm-fixes/drm-fixes (bc2fdea00652 Merge tag 'drm-intel-fixes-2023-1=
2-28' of git://anongit.freedesktop.org/drm/drm-intel into drm-fixes)
...
soc' into for-next)
Merging clk/clk-next (8a4cc77fd7cd Merge branch 'clk-mediatek' into clk-nex=
t)
$ git reset --hard HEAD^
...
lio)
Merging nfs-anna/linux-next (37e91272c8de rpc_pipefs: Replace one label in =
bl_resolve_deviceid())
...
Merging v4l-dvb-next/master (02d4e62ae245 media: i2c: mt9m114: use fsleep()=
 in place of udelay())
Merging pm/linux-next (3d6055242846 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
port)
Merging net-next/main (2ab1efad60ad net/sched: cls_api: complement tcf_tfil=
ter_dump_policy)
...
Merging drm-intel/for-linux-next (93cbc1accbce drm/i915/mtl: Add fake PCH f=
or Meteor Lake)
...
Merging gpio-brgl/gpio/for-next (c4f8457d17ce gpio: nuvoton: Add Nuvoton NP=
CM sgpio driver)
...

=WCqf
-----END PGP SIGNATURE-----
