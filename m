...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 22C77276E11
	for <lists+linux-next@lfdr.de>; Thu, 24 Sep 2020 12:00:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726597AbgIXKAa (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 24 Sep 2020 06:00:30 -0400
Received: from ozlabs.org ([203.11.71.1]:42967 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726380AbgIXKAa (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 24 Sep 2020 06:00:30 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BxrBv5jY5z9sTM;
        Thu, 24 Sep 2020 20:00:23 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1600941623;
        bh=gxQtb942LJHp7ErDuqfL1Uueu1EC6Ilhkrk6NhQQNEY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 24 Sep 2020 20:00:22 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 24
Message-ID: <20200924200022.4bcd7403@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/sZ56jyD305pbMDXQerR5p5Z";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/sZ56jyD305pbMDXQerR5p5Z
...
Merging origin/master (c9c9e6a49f89 Merge tag 'trace-v5.9-rc5-2' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
Merging net/master (805c6d3c1921 Merge branch 'fixes' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs)
...
Merging spi-fixes/for-linus (3254f14a25bd Merge remote-tracking branch 'spi=
...
or-next)
Merging mvebu/for-next (21a02cbf1d37 Merge branch 'mvebu/dt64' into mvebu/f=
or-next)
...
o ti-k3-next)
Merging ti-k3-new/ti-k3-next (f5ab78f84841 Merge branch 'ti-k3-dts-next' in=
to ti-k3-next)
...
Merging vfs/for-next (87b7181b28be Merge branches 'work.misc' and 'compat.m=
ount' into for-next)
...
DMI/SMBIOS SUPPORT)
Merging hwmon-staging/hwmon-next (55163a1c00fc hwmon: (k10temp) Add support=
 for Zen3 CPUs)
...
in imxfb_probe())
Merging pm/linux-next (5dee22f9d504 Merge branches 'pm-cpuidle-next' and 'p=
m-avs' into linux-next)
...
ersion string)
Merging devfreq/devfreq-next (c120294c2a3f PM / devfreq: event: Change prot=
...
Merging net-next/master (3fc826f121d8 Merge branch 'net-dsa-bcm_sf2-Additio=
nal-DT-changes')
...
Merging sound/for-next (2759caad2600 ALSA: seq: oss: Avoid mutex lock for a=
 long-time ioctl)
...
m_get_irq() error)
Merging block/for-next (687b971cbabb Merge branch 'for-5.10/block' into for=
-next)
...
Merging spi/for-next (8950ba17fbb6 Merge remote-tracking branch 'spi/for-5.=
10' into spi-next)
...
vdimm") into tty-next)
Merging char-misc/char-misc-next (26ed5146bd17 misc: hisi_hikey_usb: delete=
 a stray tab)
...
Merging pwm/for-next (5e36666518db dt-bindings: pwm: renesas,pwm-rcar: Add =
r8a774e1 support)
...
Merging akpm/master (848c9892e571 mm: secretmem: use PMD-size pages to amor=
...

=QlJ+
-----END PGP SIGNATURE-----
