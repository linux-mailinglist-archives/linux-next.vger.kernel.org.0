...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A9904796E74
	for <lists+linux-next@lfdr.de>; Thu,  7 Sep 2023 03:12:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234077AbjIGBMQ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 6 Sep 2023 21:12:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33664 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231970AbjIGBMP (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 6 Sep 2023 21:12:15 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A2F2D11B;
        Wed,  6 Sep 2023 18:12:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1694049124;
        bh=tG3VAxR148WpJ7HZ2aFkv6mZboefADog2lX30J0z+js=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Rh1Rm16r3z4xGM;
        Thu,  7 Sep 2023 11:12:04 +1000 (AEST)
Date:   Thu, 7 Sep 2023 11:12:01 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 7
Message-ID: <20230907111112.02c64e37@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/2FH5Z6L17HB+.dx++rstPm3";
...
Merging origin/master (7ba2090ca64e Merge tag 'ceph-for-6.6-rc1' of https:/=
...
Merging net/main (1a961e74d5ab net: phylink: fix sphinx complaint about inv=
alid literal)
Merging bpf/master (a96d1cfb2da0 selftests/bpf: Check bpf_sk_storage has un=
charged sk_omem_alloc)
Merging ipsec/master (d3287e4038ca Revert "net: macsec: preserve ingress fr=
ame ordering")
Merging netfilter/main (1a961e74d5ab net: phylink: fix sphinx complaint abo=
ut invalid literal)
...
Merging loongarch/loongarch-next (6026085c45a0 LoongArch: Update Loongson-3=
 default config file)
...
ite-only variable)
Merging risc-v/for-next (cedf393669c6 Merge patch series "riscv: tlb flush =
improvements")
...
do_statx())
Merging gfs2/for-next (65d6e954e378 Merge tag 'gfs2-v6.5-rc5-fixes' of git:=
...

=7nDM
-----END PGP SIGNATURE-----
