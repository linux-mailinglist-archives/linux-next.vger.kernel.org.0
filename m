...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BEDB63B7057
	for <lists+linux-next@lfdr.de>; Tue, 29 Jun 2021 12:00:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232444AbhF2KDV (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 29 Jun 2021 06:03:21 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:42403 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232420AbhF2KDU (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 29 Jun 2021 06:03:20 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GDg360xS8z9sWD;
        Tue, 29 Jun 2021 20:00:50 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1624960850;
        bh=xQvqR8lOfVgoKqHZ/yzwhnM0vgKAW3UeN8NcD1kRyDU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 29 Jun 2021 20:00:47 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 29
Message-ID: <20210629200047.3532e0da@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/4b3yLkhWSGTnVzc/wHi=9f3";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/4b3yLkhWSGTnVzc/wHi=9f3
...
Changes since 20210628:

The tip tree lost its build failure.

Non-merge commits (relative to Linus' tree): 12230
 11029 files changed, 759106 insertions(+), 291560 deletions(-)
...
Merging origin/master (9840cfcb97fc Merge tag 'arm64-upstream' of git://git=
...
Merging net/master (9ea3e52c5bc8 flow_offload: action should not be NULL wh=
en it is referenced)
...
Merging sound-asoc-fixes/for-linus (666dbf787983 Merge remote-tracking bran=
ch 'asoc/for-5.14' into asoc-linus)
Merging regmap-fixes/for-linus (614124bea77e Linux 5.13-rc5)
Merging regulator-fixes/for-linus (5bbfe80ad966 Merge remote-tracking branc=
h 'regulator/for-5.14' into regulator-linus)
Merging spi-fixes/for-linus (edf978a5a17d Merge remote-tracking branch 'spi=
...
CONFLICT (modify/delete): include/linux/ide.h deleted in HEAD and modified =
in ide/master. Version ide/master of include/linux/ide.h left in tree.
CONFLICT (modify/delete): drivers/ide/via82cxxx.c deleted in HEAD and modif=
ied in ide/master. Version ide/master of drivers/ide/via82cxxx.c left in tr=
ee.
CONFLICT (modify/delete): drivers/ide/triflex.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/triflex.c left in tree.
CONFLICT (modify/delete): drivers/ide/slc90e66.c deleted in HEAD and modifi=
ed in ide/master. Version ide/master of drivers/ide/slc90e66.c left in tree.
CONFLICT (modify/delete): drivers/ide/sl82c105.c deleted in HEAD and modifi=
ed in ide/master. Version ide/master of drivers/ide/sl82c105.c left in tree.
CONFLICT (modify/delete): drivers/ide/sis5513.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/sis5513.c left in tree.
CONFLICT (modify/delete): drivers/ide/siimage.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/siimage.c left in tree.
CONFLICT (modify/delete): drivers/ide/setup-pci.c deleted in HEAD and modif=
ied in ide/master. Version ide/master of drivers/ide/setup-pci.c left in tr=
ee.
CONFLICT (modify/delete): drivers/ide/serverworks.c deleted in HEAD and mod=
ified in ide/master. Version ide/master of drivers/ide/serverworks.c left i=
n tree.
CONFLICT (modify/delete): drivers/ide/sc1200.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/sc1200.c left in tree.
CONFLICT (modify/delete): drivers/ide/piix.c deleted in HEAD and modified i=
n ide/master. Version ide/master of drivers/ide/piix.c left in tree.
CONFLICT (modify/delete): drivers/ide/pdc202xx_old.c deleted in HEAD and mo=
dified in ide/master. Version ide/master of drivers/ide/pdc202xx_old.c left=
 in tree.
CONFLICT (modify/delete): drivers/ide/pdc202xx_new.c deleted in HEAD and mo=
dified in ide/master. Version ide/master of drivers/ide/pdc202xx_new.c left=
 in tree.
CONFLICT (modify/delete): drivers/ide/opti621.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/opti621.c left in tree.
CONFLICT (modify/delete): drivers/ide/ns87415.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/ns87415.c left in tree.
CONFLICT (modify/delete): drivers/ide/jmicron.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/jmicron.c left in tree.
CONFLICT (modify/delete): drivers/ide/it821x.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/it821x.c left in tree.
CONFLICT (modify/delete): drivers/ide/it8213.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/it8213.c left in tree.
CONFLICT (modify/delete): drivers/ide/it8172.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/it8172.c left in tree.
CONFLICT (modify/delete): drivers/ide/ide-pci-generic.c deleted in HEAD and=
 modified in ide/master. Version ide/master of drivers/ide/ide-pci-generic.=
c left in tree.
CONFLICT (modify/delete): drivers/ide/ide-acpi.c deleted in HEAD and modifi=
ed in ide/master. Version ide/master of drivers/ide/ide-acpi.c left in tree.
CONFLICT (modify/delete): drivers/ide/hpt366.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/hpt366.c left in tree.
CONFLICT (modify/delete): drivers/ide/delkin_cb.c deleted in HEAD and modif=
ied in ide/master. Version ide/master of drivers/ide/delkin_cb.c left in tr=
ee.
CONFLICT (modify/delete): drivers/ide/cy82c693.c deleted in HEAD and modifi=
ed in ide/master. Version ide/master of drivers/ide/cy82c693.c left in tree.
CONFLICT (modify/delete): drivers/ide/cs5536.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/cs5536.c left in tree.
CONFLICT (modify/delete): drivers/ide/cs5535.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/cs5535.c left in tree.
CONFLICT (modify/delete): drivers/ide/cs5530.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/cs5530.c left in tree.
CONFLICT (modify/delete): drivers/ide/cs5520.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/cs5520.c left in tree.
CONFLICT (modify/delete): drivers/ide/cmd64x.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/cmd64x.c left in tree.
CONFLICT (modify/delete): drivers/ide/atiixp.c deleted in HEAD and modified=
 in ide/master. Version ide/master of drivers/ide/atiixp.c left in tree.
CONFLICT (modify/delete): drivers/ide/amd74xx.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/amd74xx.c left in tree.
CONFLICT (modify/delete): drivers/ide/alim15x3.c deleted in HEAD and modifi=
ed in ide/master. Version ide/master of drivers/ide/alim15x3.c left in tree.
CONFLICT (modify/delete): drivers/ide/aec62xx.c deleted in HEAD and modifie=
d in ide/master. Version ide/master of drivers/ide/aec62xx.c left in tree.
CONFLICT (modify/delete): drivers/ide/Kconfig deleted in HEAD and modified =
in ide/master. Version ide/master of drivers/ide/Kconfig left in tree.
...
for ioctl(BLKRRPART))
Merging drm-fixes/drm-fixes (5e0e7a407675 Merge tag 'drm-misc-fixes-2021-06=
...
CONFLICT (modify/delete): drivers/ide/siimage.c deleted in HEAD and modifie=
d in kspp-gustavo/for-next/kspp. Version kspp-gustavo/for-next/kspp of driv=
ers/ide/siimage.c left in tree.
$ git rm -f drivers/ide/siimage.c
...
Merging clk/clk-next (35cf7b430888 Merge branch 'clk-hisilicon' into clk-ne=
xt)
...
Merging powerpc/next (b064037ea410 powerpc/interrupt: Use names in check_re=
turn_regs_valid())
...
Merging nfs/linux-next (691b78287ba3 Merge branch 'sysfs-devel')
...
Merging dmi/dmi-for-next (3cb4d29a2633 MAINTAINERS: The DMI/SMBIOS tree has=
 moved)
Merging hwmon-staging/hwmon-next (a5f6c0f85a09 hwmon: Support set_trips() o=
f thermal device ops)
...
onfig checks)
Merging pm/linux-next (33842e66a789 Merge branch 'pm-devfreq' into linux-ne=
xt)
Merging cpufreq-arm/cpufreq/arm/linux-next (11ea6e307318 Merge branch 'cpuf=
...
Merging thermal/thermal/linux-next (a4c233c9abbe thermal/drivers/int340x/pr=
...
A pool)
Merging rdma/for-next (1f700757224e RDMA/irdma: Fix potential overflow expr=
ession in irdma_prm_get_pbles)
Merging net-next/master (84fe73996c2e Merge branch 'do_once_lite')
...
Merging bluetooth/master (1f0536139cb8 Bluetooth: hci_uart: Remove redundan=
t assignment to fw_ptr)
...
Merging sound-asoc/for-next (666dbf787983 Merge remote-tracking branch 'aso=
...
Merging block/for-next (c18b9003d847 Merge branch 'for-5.14/drivers-late' i=
nto for-next)
...
Merging regulator/for-next (5bbfe80ad966 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (1bee1ecf232c Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
Merging tip/auto-latest (05333d72e9fb Merge branch 'irq/core')
...
Merging ftrace/for-next (6a2cbc58d6c9 seq_buf: Make trace_seq_putmem_hex() =
support data longer than 8)
...
SB4 DROM)
Merging vfio/next (742b4c0d1efe vfio: use the new pci_dev_trylock() helper =
to simplify try lock)
...
Merging scsi-mkp/for-next (df99446d5c2a scsi: qedf: Add check to synchroniz=
e abort and flush)
...
Merging pwm/for-next (be74131c662e pwm: ep93xx: Prepare clock before using =
it)
...
Merging akpm/master (842f8f1113ef powerpc/mm: enable HAVE_MOVE_PMD support)
...

=U1he
-----END PGP SIGNATURE-----
