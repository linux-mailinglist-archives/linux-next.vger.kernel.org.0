...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 13569453EAF
	for <lists+linux-next@lfdr.de>; Wed, 17 Nov 2021 03:58:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229958AbhKQDBA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 16 Nov 2021 22:01:00 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:58293 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231214AbhKQDBA (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 16 Nov 2021 22:01:00 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Hv708682sz4xbs;
        Wed, 17 Nov 2021 13:58:00 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1637117880;
        bh=/RaWeAKJqy138lhhPVY8ULYKSXWToSqnwreU2fJ13fI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 17 Nov 2021 13:58:00 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 17
Message-ID: <20211117135800.0b7072cd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/YfmY/1IatFejwUXR4cyeHfi";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/YfmY/1IatFejwUXR4cyeHfi
...
The drm-intel-gt tree gained a semantic conflict against Linus' tree.
...
Non-merge commits (relative to Linus' tree): 1545
 1816 files changed, 79381 insertions(+), 36140 deletions(-)
...
figs for v5.15-rc1)
Merging powerpc-fixes/fixes (302039466f6a powerpc/pseries: Fix numa FORM2 p=
arsing fallback code)
...
Merging net/master (848e5d66fa31 Merge branch '40GbE' of git://git.kernel.o=
...
Merging drm-misc-fixes/for-linux-next-fixes (467dd91e2f78 Merge drm/drm-fix=
...
Merging drivers-memory/for-next (fac1319be07b Merge branch 'for-v5.17/renes=
...
Merging sunxi/sunxi/for-next (98b38e443550 Merge branch 'sunxi/dt-for-5.17'=
 into sunxi/for-next)
...
inter dereference)
Merging parisc-hd/for-next (aeb357979bdd parisc: Revert "parisc: Reduce sig=
return trampoline to 3 instructions")
...
Merging hwmon-staging/hwmon-next (d20638935cec hwmon: (adm1021) Improve det=
ection of LM84, MAX1617, and MAX1617A)
...
Merging v4l-dvb-next/master (96977c97e2c7 media: atomisp: get rid of #ifdef=
 ISP_VEC_NELEMS)
Merging pm/linux-next (273b3dc3453c Merge branch 'thermal-core' into linux-=
next)
...
Merging bpf-next/for-next (d41bc48bfab2 selftests/bpf: Add uprobe triggerin=
g overhead benchmarks)
...
Merging drm-misc/for-linux-next (a193f3b4e050 drm/shmem-helper: Pass GEM sh=
mem object in public interfaces)
...
e_immediate for DC)
Merging drm-intel/for-linux-next (1a085e23411d drm/i915: Disable D3Cold in =
s2idle and runtime pm)
...
Merging sound/for-next (2c95b92ecd92 ALSA: memalloc: Unify x86 SG-buffer ha=
ndling (take#3))
...
Merging battery/for-next (715ecbc10d6a power: supply: max77976: add Maxim M=
AX77976 charger driver)
...
LP S4 MU)
Merging spi/for-next (44ebcb44584f spi: dw: Define the capabilities in a co=
ntinuous bit-flags set)
...
Merging akpm/master (b96712434106 lib/stackdepot: allow optional init and s=
...

=nq7x
-----END PGP SIGNATURE-----
