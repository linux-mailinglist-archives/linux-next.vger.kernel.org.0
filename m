Return-Path: <linux-next+bounces-2242-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 995878C0B98
	for <lists+linux-next@lfdr.de>; Thu,  9 May 2024 08:38:05 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 4C03E283780
	for <lists+linux-next@lfdr.de>; Thu,  9 May 2024 06:38:04 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 194AE1D688;
	Thu,  9 May 2024 06:38:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="cF2wjnGm"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 017042CA9;
	Thu,  9 May 2024 06:37:54 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1715236681; cv=none; b=Iw9hxPVzo3xhnGuO+iMnghTpeCkcN1il9CBCg9UyUKfrG+Y5Cz7ntSRPH8rBfSEXrD9rcuuqWVXSD0ELmgEPNPk1HaIjxFCRNxI8oe+i/8pMISehONDASAmqiS+3Jg9fQtJxKcj1ClQRWy0upU+h7QTEL57Oqr7AN4k+sFUpLd0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1715236681; c=relaxed/simple;
	bh=/98xbrdJgl3v5bt4OBXlQWu0fFEb9UOqeuV0ycIWGXY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=WgNlooLv/HMvoccVaQDacuWGj8YqpgOe0o698UoxhW57NUvY0fHred9Tl58zLpW1IXMYnugveP9PulTlN4sxvBslRDm9gURsiGjgRScv4C9GFOsnKUfSKiNWDopTEIXzKAQeNDasgGbvChq8zoZsO1Afv63rXd4cvUg1WXGCjWg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=cF2wjnGm; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1715236672;
	bh=pePc+gmhdReeFChmImTyR9cHjMX9l5pTRPmx4s7rBU0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VZj4c5bBZz4x0x;
	Thu,  9 May 2024 16:37:52 +1000 (AEST)
Date: Thu, 9 May 2024 16:37:50 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 9
Message-ID: <20240509163750.0a2d54b3@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/+XOCjr4ZeE9Hb6jNJ/LWKTS";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/+XOCjr4ZeE9Hb6jNJ/LWKTS
...
Merging origin/master (45db3ab70092 Merge tag '6.9-rc7-ksmbd-fixes' of git:=
//git.samba.org/ksmbd)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (ea3b7b27db4f mailmap: add entry f=
or Barry Song)
...
Merging dma-mapping/for-next (163943ac00cb xsk: use generic DMA sync shortc=
...
Merging bcachefs/for-next (a74979689d4a bcachefs: Invalid devices are now c=
hecked for by fsck, not .invalid methods)
...
Merging rdma/for-next (f483f6a29d4d IB/hfi1: Remove generic .ndo_get_stats6=
4)
Merging net-next/main (252aa6d53931 test: hsr: Call cleanup_all_ns when hsr=
_redbox.sh script exits)
...
Merging bpf-next/for-next (009367099eb6 bpf: Avoid uninitialized value in B=
PF_CORE_READ_BITFIELD)
...
Merging drm-intel/for-linux-next (0097ecd06d9d drm/i915: Use drm_crtc_vblan=
k_crtc())
...
Merging drm-xe/drm-xe-next (fe0154cf8222 drm/xe/xe2: Enable Indirect Ring S=
tate support for Xe2)
...
Merging sound/for-next (d344873c4cbd ALSA: hda: cs35l56: Fix lifetime of cs=
_dsp instance)
Merging ieee1394/for-next (21151fd8f0ea firewire: obsolete usage of *-objs =
in Makefile for KUnit test)
Merging sound-asoc/for-next (0849ef17fbfb Merge remote-tracking branch 'aso=
...
Merging block/for-next (1fcf6c69ab54 Merge branch 'for-6.10/block' into for=
-next)
...
Merging spi/for-next (a2890dc5d13c Merge remote-tracking branch 'spi/for-6.=
10' into spi-next)
...
code"
Merging kvm-arm/next (e28157060cdd Merge branch kvm-arm64/misc-6.10 into kv=
marm-master/next)
...
Merging bitmap/bitmap-for-next (892e4e01f7da usercopy: Don't use "proxy" he=
aders)
...

=0H16
-----END PGP SIGNATURE-----
