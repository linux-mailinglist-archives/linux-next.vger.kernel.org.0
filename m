...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C8C603655B3
	for <lists+linux-next@lfdr.de>; Tue, 20 Apr 2021 11:47:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231444AbhDTJsE (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 20 Apr 2021 05:48:04 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45354 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231430AbhDTJr5 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 20 Apr 2021 05:47:57 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 84928C06174A;
        Tue, 20 Apr 2021 02:47:23 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FPf3r5QJPz9vDV;
        Tue, 20 Apr 2021 19:47:20 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1618912040;
        bh=bKEuUiTpovyFOL8HpfKHAUzyv7UIfBCtE8f/fETobsQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 20 Apr 2021 19:47:18 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 20
Message-ID: <20210420194718.4a4a0e8f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/m489MSiC9bDu7gp5IohjveY";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/m489MSiC9bDu7gp5IohjveY
...
Merging origin/master (7af08140979a Revert "gcov: clang: fix clang-11+ buil=
d")
...
Merging net/master (8d892d60941b net: ethernet: ixp4xx: Set the DMA masks e=
xplicitly)
Merging bpf/master (b02265429681 Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/bpf/bpf)
Merging ipsec/master (88a5af943985 Merge tag 'net-5.12-rc8' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/netdev/net)
Merging netfilter/master (88a5af943985 Merge tag 'net-5.12-rc8' of git://gi=
...
Merging sound-asoc-fixes/for-linus (d28addbcaf3f Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (088a84700d27 Merge remote-tracking branch 'spi=
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (d2b9935d65da drm/i915: Fix mo=
desetting in case of unexpected AUX timeouts)
...
Merging arm-soc/for-next (68738a74f4c7 soc: document merges)
Merging actions/for-next (444d018d8d38 ARM: dts: owl-s500-roseapplepi: Add =
ATC2603C PMIC)
Merging amlogic/for-next (3547c0797259 Merge branch 'v5.13/dt64' into tmp/a=
ml-rebuild)
...
Merging btrfs/for-next (9749b576369c Merge branch 'for-next-next-v5.13-2021=
0419' into for-next-20210419)
Merging ceph/master (558b4510f622 ceph: defer flushing the capsnap if the F=
b is used)
Merging cifs/for-next (e2e4a72f1a98 Cifs: Fix kernel oops caused by deferre=
d close for files.)
...
ent class)
Merging cel/for-next (aba2072f4523 nfsd: grant read delegations to clients =
holding writes)
...
Merging dmi/dmi-for-next (3cb4d29a2633 MAINTAINERS: The DMI/SMBIOS tree has=
 moved)
Merging hwmon-staging/hwmon-next (789a4623bb12 hwmon: (sch5627) Remove unne=
cessary error path)
...
Merging net-next/master (e9377a911d77 ethtool: add missing EEPROM to list o=
f messages)
CONFLICT (content): Merge conflict in net/nfc/nci/uart.c
Merging bpf-next/for-next (900367b208ee Merge branch 'Add a snprintf eBPF h=
elper')
Merging ipsec-next/master (392c36e5be1d Merge branch 'ehtool-fec-stats')
...
che information)
Merging drm-intel/for-linux-next (3def10f297f1 Merge tag 'topic/intel-gen-t=
o-ver-2021-04-19' of git://anongit.freedesktop.org/drm/drm-intel into drm-i=
ntel-next)
...
Merging sound/for-next (e7df7df5a380 ALSA: usb-audio: DJM-750: ensure forma=
t is set)
Merging sound-asoc/for-next (d3f81db95731 Merge remote-tracking branch 'aso=
...
chpanel series)
Merging block/for-next (b2304a25e05d Merge branch 'for-5.13/io_uring' into =
for-next)
Merging device-mapper/for-next (3fac45d0c075 Merge branch 'nvme-error-handl=
ing-fixes/for-5.13-v4' into for-next)
...
Merging spi/for-next (28044e8a4b9a Merge remote-tracking branch 'spi/for-5.=
13' into spi-next)
Merging tip/auto-latest (e48f64fea89e Merge branch 'core/entry')
...
Merging drivers-x86/for-next (8d01cf643b3f platform/x86: touchscreen_dmi: A=
dd info for the Teclast Tbook 11 tablet)
...
Merging akpm/master (f9799dab1a7c memfd_secret: use unsigned int rather tha=
...

=kSKE
-----END PGP SIGNATURE-----
