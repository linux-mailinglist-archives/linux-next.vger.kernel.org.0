Return-Path: <linux-next+bounces-4801-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E0739D0B3B
	for <lists+linux-next@lfdr.de>; Mon, 18 Nov 2024 09:54:12 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id BC28CB21B39
	for <lists+linux-next@lfdr.de>; Mon, 18 Nov 2024 08:54:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1F3BB161302;
	Mon, 18 Nov 2024 08:54:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="ln6ArarX"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5A90B15445D;
	Mon, 18 Nov 2024 08:53:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731920045; cv=none; b=BcJPK/LqodS8teDRNhSpFAIhZbNeoCNUITiqm6Fwt3LZ9+ooH3hVSmQ4Gxx4Ev6py011bprk3nhx3tCmjG1xxjyxEK6dDwj7IQTCtOyv1NKHyN2qfHGr+vlrNns602V/s6IHv5Uy+GAxujFAAOyrB1L+EZ6aIDLLMmtxPzAKdFI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731920045; c=relaxed/simple;
	bh=iytoP6yGBWYJL2K1E1aQSUNrVDsCSFimepmRoJIvOgc=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=XD3wY+yVi1KmAvauexA1rKs2Mvt0a7PQ0serHgQZwUjSbv1E0DFtH8XhSk5dxO645ZrWkPw+EmPndvgrGD8nIVwdvkgrmRz0MdWAifjAYAJTvMn8jG1sbcn+IjHZ9nGGe+k100mI3zJcpZbzn88NlsW6ya19pHmg9tC472iq0z4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=ln6ArarX; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1731920035;
	bh=ZXGAmHdbL1a1qw028FxhhZlv8mc/pn1J6q+WRoyfMD0=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XsLyW4GKpz4xfp;
	Mon, 18 Nov 2024 19:53:55 +1100 (AEDT)
Date: Mon, 18 Nov 2024 19:53:57 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 18
Message-ID: <20241118195357.0038a789@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bzm_yJdGZLYPVcYdn.+2Fxm";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/bzm_yJdGZLYPVcYdn.+2Fxm
...
Changes since 20241115:

The pci tree gained a confict against Linus' tree.

The net-next tree gained a confict against the net tree.

The vhost tree gained a confict against the net_next tree.

Non-merge commits (relative to Linus' tree): 11044
 13497 files changed, 496916 insertions(+), 340969 deletions(-)
...
Merging origin/master (adc218676eef Linux 6.12)
...
ptfs_fill_zeros())
Merging dlm/next (f74dacb4c811 dlm: fix recovery of middle conversions)
Merging erofs/dev (557de15f73b3 erofs: clarify direct I/O support)
...
Merging fs-current (3411b60e3168 Merge branch 'next-fixes' of git://git.ker=
...
Merging netfilter/main (41ffcd95015f net: phy: fix phylib's dual eee_enable=
d)
...
e work later)
Merging drm-fixes/drm-fixes (f48ab0a39f12 Merge tag 'amd-drm-fixes-6.12-202=
4-11-16' of https://gitlab.freedesktop.org/agd5f/linux into drm-fixes)
...
Merging tip-fixes/tip/urgent (468fbe038f2f Merge branch into tip/master: 'x=
86/urgent')
...
Merging sparc/for-next (8467d8b282b5 sparc: Replace one-element array with =
...
Merging fs-next (a048d47fe907 Merge branch 'for-next' of git://git.kernel.o=
...
evice suspend)
Merging net-next/main (38f83a57aa8e Merge branch 'virtio-net-support-af_xdp=
-zero-copy-tx')
...
t ordering bits)
Merging netfilter-next/main (6bbdb903db08 dt-bindings: net: dsa: microchip,=
ksz: Drop undocumented "id")
...
nos into drm-next)
Merging drm-misc/for-linux-next (7d2faa8dbb70 drm/fbdev-client: Unexport dr=
m_fbdev_client_setup())
...
mentation comments)
Merging drm-xe/drm-xe-next (2d4993e16340 drm/xe: Split xe_gt_stat.h)
...
cate)
Merging block/for-next (f8908548261a Merge branch 'for-6.13/io_uring' into =
for-next)
...
13' into spi-next)
Merging tip/master (a552e02c0af8 Merge branch into tip/master: 'x86/tdx')
...
Merging gpio-brgl/gpio/for-next (1b81e73e3bab gpio: tegra186: Allow to enab=
le driver on Tegra234)
Merging gpio-intel/for-next (12b0e305f509 gpio: acpi: switch to device_for_=
each_child_node_scoped())
Merging pinctrl/for-next (9eb198b4be44 Merge fixup)
CONFLICT (content): Merge conflict in MAINTAINERS
...

=Kagc
-----END PGP SIGNATURE-----
