...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6D37B5F635D
	for <lists+linux-next@lfdr.de>; Thu,  6 Oct 2022 11:15:05 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230286AbiJFJPD (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 6 Oct 2022 05:15:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60346 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229630AbiJFJPC (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 6 Oct 2022 05:15:02 -0400
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B5CDD16591
        for <linux-next@vger.kernel.org>; Thu,  6 Oct 2022 02:14:58 -0700 (PDT)
Received: by mail-pg1-x529.google.com with SMTP id j71so1376550pge.2
        for <linux-next@vger.kernel.org>; Thu, 06 Oct 2022 02:14:58 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date;
        bh=2GNtOo6XpslH3omlAMH4H2fZqWRxGfm8pjfUto1KAos=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=2GNtOo6XpslH3omlAMH4H2fZqWRxGfm8pjfUto1KAos=;
        b=
X-Gm-Message-State: ACrzQf1E8QbusrtpjFuAqw1H+KRmR37EeEnigR+U+QNRDw0YSZa5ZFg/
        tiWk+ekqlO+JX//K111tfdO2dYJ8F4PcUoA2mw0=
X-Google-Smtp-Source: AMsMyM4WJMZf7qznYeZElGnIySpu1naBQpKA43JMduhetMPEVtyNAZ+8CMWzMj2uvanRp7O4kcKWIA==
X-Received: by 2002:a05:6a00:1342:b0:545:4d30:eecb with SMTP id k2-20020a056a00134200b005454d30eecbmr3951502pfu.69.1665047696969;
        Thu, 06 Oct 2022 02:14:56 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id a3-20020a170902ecc300b00176a5767fb0sm11991192plh.94.2022.10.06.02.14.55
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 06 Oct 2022 02:14:56 -0700 (PDT)
Message-ID: <633e9c90.170a0220.69e28.4fcf@mx.google.com>
Date:   Thu, 06 Oct 2022 02:14:56 -0700 (PDT)
...
Subject: next/master build: 211 builds: 12 failed, 199 passed, 31 errors,
 95 warnings (next-20221006)
...
next/master build: 211 builds: 12 failed, 199 passed, 31 errors, 95 warning=
s (next-20221006)
...
Tree: next
Branch: master
Git Describe: next-20221006
Git Commit: 7da9fed0474b4cd46055dd92d55c42faf32c19ac
...
=80=98-mhard-float=E2=80=99
    3    fs/ntfs3/namei.c:445:7: error: variable 'uni1' is used uninitializ=
ed whenever 'if' condition is true [-Werror,-Wsometimes-uninitialized]
    3    fs/ntfs3/namei.c:434:7: error: variable 'uni1' is used uninitializ=
ed whenever 'if' condition is true [-Werror,-Wsometimes-uninitialized]
    3    ERROR: modpost: "riscv_cbom_block_size" [arch/riscv/kvm/kvm.ko] un=
defined!
...
fined but not used [-Wunused-function]
    3    fs/ntfs3/namei.c:430:22: note: initialize the variable 'uni1' to s=
ilence this warning
...
csiphy_lanes_enable() falls through to next function __cfi_csiphy_isr()
    1    drivers/media/i2c/m5mols/m5mols.o: warning: objtool: m5mols_set_fm=
t() falls through to next function __cfi_m5mols_open()
...
alls through to next function __cfi_m5mols_open()
    drivers/media/platform/qcom/camss/qcom-camss.o: warning: objtool: csiph=
y_lanes_enable() falls through to next function __cfi_csiphy_isr()
