Return-Path: <linux-next+bounces-9468-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 6B342CCB8FE
	for <lists+linux-next@lfdr.de>; Thu, 18 Dec 2025 12:13:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 379413014B51
	for <lists+linux-next@lfdr.de>; Thu, 18 Dec 2025 11:13:10 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C84DA3128A2;
	Thu, 18 Dec 2025 11:13:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="fCYy0pem"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B14DD3009F2;
	Thu, 18 Dec 2025 11:13:02 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1766056388; cv=none; b=Z0nqk3gVaCRbJKkludDaesp/rRJ3vwCRgcNygJNBtx1crfX9psgzai8mxlQPrr1HRA0RxK91wbnjig6BGg5hOD1xtYkuy/q8udMSxfC7eS2AtqM6Znk69egBk5PyP7UiM5F8G6i8T+jE2tVFpjaElrUaCIPjmHYSmijSKeg9zC8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1766056388; c=relaxed/simple;
	bh=/vFzUMiW9ZYBQ7DzAZN6kvstlSuBoKj26DPOm692KuE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=FBTQIXqGotIm6cyfPAfZUu9YuAHS/xeaAjnGzCaK/yEjFTPRG8GF2Oc0bH5Po2nl9F6dXQPyShByRei1k3VaVpSx8LzoG9reB1ph/QzBNlKiZB1rF90jq5APUMORnPhxbXjoBdFjJHAJATzd1BFKcNQQCrZJgdLOLZTYVnVbwHg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=fCYy0pem; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1766056380;
	bh=ItooExumGdRRNJ2cgEZVNKqhS5t6D0RzB1OQ/jx5GUw=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dX7Lh4gx3z4w1g;
	Thu, 18 Dec 2025 22:13:00 +1100 (AEDT)
Date: Thu, 18 Dec 2025 22:12:59 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 18
Message-ID: <20251218221259.5a3eec2f@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/iwbjndF6Z.GJSZoL1Wqez_q";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/iwbjndF6Z.GJSZoL1Wqez_q
...
Changes since 20251217:

Restored tree:	i2c-host-fixes

The btrfs tree gained a build failure due to duplicated commits with
the btrfs-fixes tree for which I applied a merge fix patch.

The mm-nonmm-unstable tree gained a build failure for which I reverted
2 commits.

The vfs-brauner tree gained a conflict against the mm-nonmm-unstable
tree.
...
Non-merge commits (relative to Linus' tree): 1901
 2220 files changed, 138971 insertions(+), 26004 deletions(-)
...
Merging origin/master (ea1013c15392 Merge tag 'bpf-fixes' of git://git.kern=
...
Merging btrfs-fixes/next-fixes (520946cf2f51 Merge branch 'misc-6.19' into =
next-fixes)
...
Applying: fix up for "btrfs: shrink the size of btrfs_bio"
...
Merging fs-current (78fe8dae759b Merge branch 'nfsd-fixes' of https://git.k=
...
Merging sound-asoc-fixes/for-linus (9a068c4a7717 ASoC: SOF: ipc4-topology: =
fixes for 'exotic' format)
...
Merging iommufd-fixes/for-rc (e171a1f3271b iommufd: Check for overflow in I=
OMMU_TEST_OP_ADD_RESERVED)
...
Merging qcom/for-next (ac566fba5e21 Merge branches 'arm32-fixes-for-6.19', =
'arm64-fixes-for-6.19', 'arm64-for-6.20', 'clk-fixes-for-6.19', 'clk-for-6.=
20' and 'drivers-for-6.20' into for-next)
...
Merging xtensa/xtensa-for-next (0d4b3ca115b5 xtensa: align: validate access=
 in fast_load_store)
Merging fs-next (bc791c9ea0ff Merge branch 'vfs.all' of https://git.kernel.=
...
Merging bluetooth/master (afa20d8099dd Bluetooth: mgmt: Add idle_timeout to=
...
Merging drm-misc/for-linux-next (e8c28e16c3eb accel/amdxdna: Remove amdxdna=
_flush())
...
Merging drm-xe/drm-xe-next (5bf763e908bf drm/xe/eustall: Disallow 0 EU stal=
l property values)
...
Merging sound-asoc/for-next (4a0abde23ad6 Merge remote-tracking branch 'aso=
...
Merging block/for-next (127d63bc9442 Merge branch 'block-6.19' into for-nex=
t)
...
-next' into for-next)
Merging gpio-brgl/gpio/for-next (3203d8f573af gpio: realtek-otto: add COMPI=
LE_TEST)
$ git reset --hard HEAD^
Merging next-20251217 version of gpio-brgl
...
Merging iommufd/for-next (e171a1f3271b iommufd: Check for overflow in IOMMU=
...
name to match code)
Applying: Revert "Bluetooth: mgmt: Add idle_timeout to configurable system =
parameters"
...

=MWXu
-----END PGP SIGNATURE-----
