...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1460C402331
	for <lists+linux-next@lfdr.de>; Tue,  7 Sep 2021 08:01:00 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230226AbhIGGAl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 7 Sep 2021 02:00:41 -0400
Received: from mx0b-001b2d01.pphosted.com ([148.163.158.5]:5786 "EHLO
        mx0b-001b2d01.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S231189AbhIGGAf (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 7 Sep 2021 02:00:35 -0400
Received: from pps.filterd (m0098417.ppops.net [127.0.0.1])
        by mx0a-001b2d01.pphosted.com (8.16.0.43/8.16.0.43) with SMTP id 1875YCmX105061;
        Tue, 7 Sep 2021 01:59:28 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ibm.com; h=from : content-type :
 mime-version : subject : message-id : date : cc : to; s=pp1;
 bh=zEnQWuQapIQVqO5yXFudhJ+7hrfbFDGDF5emyGTUdSQ=;
 b= tQ== 
Received: from pps.reinject (localhost [127.0.0.1])
        by mx0a-001b2d01.pphosted.com with ESMTP id 3awmsywjbq-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 07 Sep 2021 01:59:27 -0400
Received: from m0098417.ppops.net (m0098417.ppops.net [127.0.0.1])
        by pps.reinject (8.16.0.43/8.16.0.43) with SMTP id 1875lJ9w145990;
        Tue, 7 Sep 2021 01:59:27 -0400
Received: from ppma06ams.nl.ibm.com (66.31.33a9.ip4.static.sl-reverse.com [169.51.49.102])
        by mx0a-001b2d01.pphosted.com with ESMTP id 3awmsywjbb-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 07 Sep 2021 01:59:26 -0400
Received: from pps.filterd (ppma06ams.nl.ibm.com [127.0.0.1])
        by ppma06ams.nl.ibm.com (8.16.1.2/8.16.1.2) with SMTP id 1875fUej018902;
        Tue, 7 Sep 2021 05:59:25 GMT
Received: from b06cxnps4076.portsmouth.uk.ibm.com (d06relay13.portsmouth.uk.ibm.com [9.149.109.198])
        by ppma06ams.nl.ibm.com with ESMTP id 3av02jjpnr-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Tue, 07 Sep 2021 05:59:24 +0000
Received: from d06av25.portsmouth.uk.ibm.com (d06av25.portsmouth.uk.ibm.com [9.149.105.61])
        by b06cxnps4076.portsmouth.uk.ibm.com (8.14.9/8.14.9/NCO v10.0) with ESMTP id 1875xKgo52625738
        (version=TLSv1/SSLv3 cipher=DHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK);
        Tue, 7 Sep 2021 05:59:20 GMT
Received: from d06av25.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id E81C211C06E;
        Tue,  7 Sep 2021 05:59:19 +0000 (GMT)
Received: from d06av25.portsmouth.uk.ibm.com (unknown [127.0.0.1])
        by IMSVA (Postfix) with ESMTP id 13BCE11C050;
        Tue,  7 Sep 2021 05:59:18 +0000 (GMT)
Received: from smtpclient.apple (unknown [9.43.55.120])
        by d06av25.portsmouth.uk.ibm.com (Postfix) with ESMTP;
        Tue,  7 Sep 2021 05:59:17 +0000 (GMT)
From:   Sachin Sant <sachinp@linux.vnet.ibm.com>
Content-Type: multipart/mixed;
        boundary="Apple-Mail=_ECDC5B57-ED22-4D4A-82CA-6D04EB9D68F5"
Mime-Version: 1.0 (Mac OS X Mail 14.0 \(3654.100.0.2.22\))
Subject: [next-20210907][powerpc] Build failure
 drivers/net/ethernet/intel/ixgbe
Message-Id: <CF66E9AF-E161-44FD-A2E1-16E0E1DC257F@linux.vnet.ibm.com>
Date:   Tue, 7 Sep 2021 11:29:16 +0530
Cc:     open list <linux-kernel@vger.kernel.org>, keescook@chromium.org,
        danielmicay@gmail.com
To:     linux-next@vger.kernel.org
X-Mailer: Apple Mail (2.3654.100.0.2.22)
X-TM-AS-GCONF: 00
X-Proofpoint-GUID: 4ywaUZZo5Xs10Pf6IZ_vvO_IKr0LPVaz
X-Proofpoint-ORIG-GUID: Wz3bouLYQtyrS-nago5eOC1ksK2OQuaK
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 suspectscore=0 adultscore=0
 ...
 bulkscore=0 clxscore=1011 lowpriorityscore=0 impostorscore=0 phishscore=0
 classifier=spam adjust=0 reason=mlx scancount=1 engine=8.12.0-2108310000
 definitions=main-2109070038
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org


--Apple-Mail=_ECDC5B57-ED22-4D4A-82CA-6D04EB9D68F5
Content-Transfer-Encoding: quoted-printable
Content-Type: text/plain;
	charset=utf-8

Today=E2=80=99s next [commit b2bb710d34d5] 5.14.0-next-20210907 fails
...
In function 'kmalloc_node',
    inlined from 'kzalloc_node.constprop' at =
./include/linux/slab.h:743:9,
    inlined from 'ixgbe_alloc_q_vector' at =
drivers/net/ethernet/intel/ixgbe/ixgbe_lib.c:855:13:
...
./include/linux/slab.h:455:7: note: in a call to allocation function =
'__kmalloc_node' declared here
 void *__kmalloc_node(size_t size, gfp_t flags, int node) =
__assume_slab_alignment __malloc;
       ^~~~~~~~~~~~~~
cc1: all warnings being treated as errors

If I revert following commit the error goes away.=20
...
Content-Disposition: attachment;
	filename=next-20210907-config.txt
Content-Type: text/plain;
	x-unix-mode=0644;
	name="next-20210907-config.txt"
Content-Transfer-Encoding: quoted-printable

#
# Automatically generated file; DO NOT EDIT.
# Linux/powerpc 5.14.0 Kernel Configuration
#
