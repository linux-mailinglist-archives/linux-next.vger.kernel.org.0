...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 9BDFB4B9C7A
	for <lists+linux-next@lfdr.de>; Thu, 17 Feb 2022 10:51:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238847AbiBQJv4 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 17 Feb 2022 04:51:56 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:40788 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235934AbiBQJvz (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 17 Feb 2022 04:51:55 -0500
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 956BF11A2A;
        Thu, 17 Feb 2022 01:51:38 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Jzqpt0lkrz4xZ2;
        Thu, 17 Feb 2022 20:51:34 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1645091494;
        bh=DQiURwy+F3Z4Kl+JPmQ3vETIwvvKajJlk41FOeesdPc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 17 Feb 2022 20:51:33 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 17
Message-ID: <20220217205133.6c4d9ebb@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Ho3/3VP8imv2L.iQ2t_ZY0a";
...
Changes since 20220216:

New tree: maple

The vfs tree gained a conflict against the arm64 tree.

The wireless-next tree gained a conflict against the net tree.
...
The staging tree gained a conflict against the kspp-gustavo tree.

The maple tree gained conflicts against the memblock and parisc-hd trees.
It also gained a semantic conflict against the arm64 tree and a build
failure, so I dropped it for today.

The folio tree gained conflicts against the maple tree.  Unfortunately I
missed something in the resolution and the build broke, so I have used
the folio tree from next-20220204 again.

The akpm-current tree lost its boot time warning.

Non-merge commits (relative to Linus' tree): 5852
 6440 files changed, 303687 insertions(+), 146883 deletions(-)
...
Merging origin/master (359303076163 tty: n_tty: do not look ahead for EOL c=
haracter past the end of the buffer)
...
Merging bpf/master (45ce4b4f9009 bpf: Fix crash due to out of bounds access=
 into reg2btf_ids.)
...
-linus)
Merging sound-asoc-fixes/for-linus (c5487b9cdea5 ASoC: cs4265: Fix the dupl=
icated control name)
...
Merging spi-fixes/for-linus (2dc8bc5a6a4e Merge remote-tracking branch 'spi=
...
Merging input-current/for-linus (de8aa31ac7c2 Input: zinitix - add new comp=
atible strings)
...
M usage)
Merging mips-fixes/mips-fixes (f2703def339c MIPS: smp: fill in sibling and =
core maps earlier)
...
Merging gpio-brgl-fixes/gpio/for-current (7920af5c826c gpio: rockchip: Rese=
t int_bothedge when changing trigger)
...
Merging arm64/for-next/core (451ec4ae7dc7 Merge branches 'for-next/docs', '=
for-next/insn', 'for-next/kselftest', 'for-next/misc', 'for-next/mm', 'for-=
next/mte', 'for-next/perf' and 'for-next/rng' into for-next/core)
...
Merging tegra/for-next (0aeee7376181 Merge branch for-5.18/arm64/defconfig =
into for-next)
Merging ti/ti-next (141c3dc8fb47 Merge branch 'ti-k3-dts-next' into ti-next)
...
Merging parisc-hd/for-next (5357b0dd55e6 parisc: Always use the self-extrac=
ting kernel feature)
...
Merging cifs/for-next (6c688ae872db cifs: use a different reconnect helper =
...
rs in nfs_getattr())
Merging nfsd/for-next (07a9d5002d10 fs/lock: only call lm_breaker_owns_leas=
...
Merging pstore/for-next/pstore (a5d05b07961a pstore/ftrace: Allow immediate=
 recording)
Merging hid/for-next (5c9d54d2c2bd Merge branch 'for-5.18/razer' into for-n=
ext)
...
Merging hwmon-staging/hwmon-next (572dfaf0bc2d hwmon: (asus-ec-sensors) mer=
ge setup functions)
Merging jc_docs/docs-next (4fbe7b19a948 docs: Fix wording in optional zram =
feature docs)
...
Merging rdma/for-next (2f1b2820b546 Merge branch 'irdma_dscp' into rdma.git=
 for-next)
Merging net-next/master (f0ead99e623b Merge branch 'Replay-and-offload-host=
-VLAN-entries-in-DSA')
Merging bpf-next/for-next (f76d8507d238 bpftool: Fix pretty print dump for =
maps without BTF loaded)
...
ent match)
Merging bluetooth/master (55442fc23d66 Bluetooth: make array bt_uuid_any st=
atic const)
Merging wireless-next/main (ea0de861374b mac80211_hwsim: Advertise support =
for EHT capabilities)
...
Merging amdgpu/drm-next (5bbebaae1491 drm/amdgpu/smu11.5: restore cclks in =
vangogh_set_performance_level)
Merging drm-intel/for-linux-next (5f1d00420f46 drm/i915: Add missing intel_=
mchbar_regs.h)
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/dp/drm_dp.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/i915_module.c
[master 7e0af1f9c095] next-20220214/drm-intel
Merging drm-tegra/drm/tegra/for-next (184b58fa816f gpu: host1x: Always retu=
rn syncpoint value when waiting)
...
Merging fbdev/for-next (0714ea330b99 video: fbdev: au1100fb: Spelling s/pal=
ette/palette/)
...
Merging input/next (e511fc58071a Input: tsc200x - add axis inversion and sw=
apping support)
...
Merging device-mapper/for-next (3a0d2dd604f8 dm delay: use dm_submit_bio_re=
map)
Merging libata/for-next (7bd202b0f3ad ata: Kconfig: fix sata gemini compile=
 test condition)
...
Merging devicetree/for-next (54eb8dc8f338 of: unittest: print pass messages=
 at PR_INFO level)
Merging mailbox/mailbox-for-next (869b6ca39c08 dt-bindings: mailbox: Add mo=
re protocol and client ID)
Merging spi/for-next (54d0fd06e2bd spi: pxa2xx: Add support for Intel Rapto=
r Lake PCH-S)
...
Merging usb/usb-next (9902951f536c usb: host: ehci-platform: Update brcm, x=
gs-iproc-ehci workaround)
...
Merging phy-next/next (4a4c3cc146b1 phy: qcom: Program SSC only if supporte=
d by sink)
...
Merging staging/staging-next (e9685834b1db staging: r8188eu: remove uncondi=
tional if statement)
CONFLICT (content): Merge conflict in drivers/staging/fbtft/fbtft.h
CONFLICT (content): Merge conflict in drivers/staging/r8188eu/include/ieee8=
0211.h
...
Merging random/master (6b696fb45345 random: pull add_hwgenerator_randomness=
...
Merging maple/maple/mainline (f8a9958770de mm/mmap.c: Pass in mapping to __=
vma_link_file())
...
Applying: fix up for "arm64: mte: Dump the MTE tags in the core file"
$ git reset --hard HEAD^
Merging akpm-current/current (ab94bd5db44d ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
...
Merging akpm/master (479e353d1823 Merge branch 'akpm-current/current')
...

=+nfu
-----END PGP SIGNATURE-----
