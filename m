...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 65B5842201F
	for <lists+linux-next@lfdr.de>; Tue,  5 Oct 2021 10:06:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232985AbhJEIIX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 5 Oct 2021 04:08:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38760 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230286AbhJEIIV (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 5 Oct 2021 04:08:21 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4FDD6C061745;
        Tue,  5 Oct 2021 01:06:31 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HNqsx48Skz4xb7;
        Tue,  5 Oct 2021 19:06:29 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1633421189;
        bh=lNXWbuf/lUSaXUiRexa7esU+h/1eOxfJuh9Wd45FfCE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 5 Oct 2021 19:06:28 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 5
Message-ID: <20211005190628.1f26b13d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_nzA68kcnFQyV0rM/4oLa26";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/_nzA68kcnFQyV0rM/4oLa26
...
The selinux tree gained a semantic conflict against the block tree.
...
Non-merge commits (relative to Linus' tree): 5110
 4859 files changed, 255590 insertions(+), 100481 deletions(-)
...
Merging origin/master (f6274b06e326 Merge tag 'linux-kselftest-fixes-5.15-r=
c5' of git://git.kernel.org/pub/scm/linux/kernel/git/shuah/linux-kselftest)
...
Merging powerpc-fixes/fixes (23c216b335d1 powerpc/iommu: Report the correct=
 most efficient DMA mask for PCI devices)
...
Merging net/master (b44d52a50bc6 dsa: tag_dsa: Fix mask for trunked packets)
Merging bpf/master (b0e875bac0fa libbpf: Fix memory leak in strset)
Merging ipsec/master (93ec1320b017 xfrm: fix rcu lock in xfrm_notify_userpo=
licy())
Merging netfilter/master (7cd8b1542a7b ptp_pch: Load module automatically i=
f ID matches)
Merging ipvs/master (3d3b30175a51 netfilter: nf_tables: honor NLM_F_CREATE =
and NLM_F_EXCL in event notification)
...
Merging sound-current/for-linus (cc03069a3970 ALSA: hda/realtek: Add quirk =
for Clevo X170KM-G)
Merging sound-asoc-fixes/for-linus (c417c32a473e Merge remote-tracking bran=
ch 'asoc/for-5.15' into asoc-linus)
Merging regmap-fixes/for-linus (6880fa6c5660 Linux 5.15-rc1)
Merging regulator-fixes/for-linus (9e1ff307c779 Linux 5.15-rc4)
Merging spi-fixes/for-linus (fa382a0f96cf Merge remote-tracking branch 'spi=
/for-5.15' into spi-linus)
Merging pci-current/for-linus (e4e737bb5c17 Linux 5.15-rc2)
Merging driver-core.current/driver-core-linus (410d591a1954 kernfs: don't c=
reate a negative dentry if inactive node exists)
...
Merging iio-fixes/fixes-togreg (26d90b559057 iio: light: opt3001: Fixed tim=
eout error when 0 lux)
Merging char-misc.current/char-misc-linus (ad2b502bc5e6 Merge tag 'misc-hab=
analabs-fixes-2021-09-29' of https://git.kernel.org/pub/scm/linux/kernel/gi=
...
n cxgb4)
Merging drm-fixes/drm-fixes (78ea81417944 Merge tag 'exynos-drm-fixes-for-v=
5.15-rc4' of git://git.kernel.org/pub/scm/linux/kernel/git/daeinki/drm-exyn=
os into drm-fixes)
Merging amdgpu-fixes/drm-fixes (2c409ba81be2 drm/radeon: fix si_enable_smc_=
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (9e1ff307c779 Linux 5.15-rc4)
Merging mmc-fixes/fixes (e2845b1d92d7 mmc: meson-gx: do not use memcpy_to/f=
...
rning)
Merging risc-v-fixes/fixes (5155cf7b6aae Merge remote-tracking branch 'palm=
er/riscv-vdso-cleanup' into fixes)
...
Merging gpio-brgl-fixes/gpio/for-current (1649b8376694 gpio: pca953x: Impro=
ve bias setting)
...
esc())
Merging kunit-fixes/kunit-fixes (f62314b1ced2 kunit: fix reference count le=
ak in kfree_at_end)
...
/linux)
Merging drm-misc-fixes/for-linux-next-fixes (f86e9e383a71 video: fbdev: gbe=
fb: Only instantiate device when built for IP32)
...
or-next)
Merging arm64/for-next/core (e45ac92bcc92 Merge branches 'for-next/kexec', =
'for-next/kselftest', 'for-next/misc', 'for-next/mm', 'for-next/mte', 'for-=
next/pfn-valid' and 'for-next/scs' into for-next/core)
...
Merging drivers-memory/for-next (bf7cf1ccbccc Merge branch 'mem-ctrl-next' =
into for-next)
...
or-next)
Merging omap/for-next (7fd4d99072ce Merge branch 'omap-for-v5.16/ti-sysc' i=
nto for-next)
...
Merging tegra/for-next (e7ed16ca46b5 Merge branch for-5.16/arm64/dt into fo=
r-next)
$ git reset --hard HEAD^
Merging next-20211001 version of tegra
...
t)
Merging clk-imx/for-next (d1012253a2d3 clk: imx: imx6ul: Fix csi clk gate r=
egister)
...
iver)
Merging risc-v/for-next (21ccdccd21e4 riscv: mm: don't advertise 1 num_asid=
 for 0 asid bits)
...
nals())
Merging xtensa/xtensa-for-next (ddc33155115a xtensa: xtfpga: Try software r=
...
ror)
Merging ext4/dev (f2c77973507f ext4: recheck buffer uptodate bit under buff=
er lock)
...
Merging ksmbd/ksmbd-for-next (9e1ff307c779 Linux 5.15-rc4)
...
_base)
Merging cel/for-next (2ba5acfb3495 SUNRPC: fix sign error causing rpcsec_gs=
s drops)
Merging ntfs3/master (35afb70dcfe4 fs/ntfs3: Check for NULL if ATTR_EA_INFO=
 is incorrect)
...
Merging v4l-dvb-next/master (c52e7b855b33 Merge tag 'v5.15-rc4' into media_=
tree)
Merging pm/linux-next (d91db9b878c3 Merge branch 'pm-pci' into linux-next)
Merging cpufreq-arm/cpufreq/arm/linux-next (c2ace21f937a cpufreq: tegra186/=
tegra194: Handle errors in BPMP response)
...
or freq_table)
Merging opp/opp/linux-next (e69709f6861a opp: Add more resource-managed var=
iants of dev_pm_opp_of_add_table())
...
Merging net-next/master (166003436190 Merge branch 'phy-10g-mode-helper')
$ git reset --hard HEAD^
Merging next-20211001 version of net-next
Applying: fix up for "net: add new socket option SO_RESERVE_MEM"
[master 96958d6c3597] next-20211001/net-next
Merging bpf-next/for-next (0693b27644f0 Merge branch 'mctp-kunit-tests')
CONFLICT (content): Merge conflict in arch/sparc/include/uapi/asm/socket.h
$ git reset --hard HEAD^
Merging next-20211001 version of bpf-next
...
Merging bluetooth/master (43f51bd946da Bluetooth: Rename driver .prevent_wa=
ke to .wakeup)
CONFLICT (content): Merge conflict in arch/sparc/include/uapi/asm/socket.h
$ git reset --hard HEAD^
Merging next-20211001 version of bluetooth
...
Merging spi-nor/spi-nor/next (5816b3e6577e Linux 5.15-rc3)
...
Merging drm-misc/for-linux-next (61bae132030a Revert "drm: cleanup: drm_mod=
eset_lock_all_ctx() --> DRM_MODESET_LOCK_ALL_BEGIN()")
Merging amdgpu/drm-next (4e45069010e5 drm/amdgpu/pm: properly handle sclk f=
or profiling modes on vangogh)
Merging drm-intel/for-linux-next (7d396cacaea6 drm/i195: Make the async fli=
p VT-d workaround dynamic)
Merging drm-tegra/drm/tegra/for-next (c3dbfb9c49ee gpu: host1x: Plug potent=
ial memory leak)
Merging drm-msm/msm-next (bc80747eb681 drm/msm: Do not run snapshot on non-=
DPU devices)
...
Merging sound/for-next (23939115be18 ALSA: usb-audio: Fix packet size calcu=
lation regression)
Merging sound-asoc/for-next (6de669e88076 Merge remote-tracking branch 'aso=
...
Merging input/next (5c4c2c8e6fac Input: ariel-pwrbutton - add SPI device ID=
 table)
Merging block/for-next (1b2d1439fc25 Merge branch 'for-5.16/io_uring' into =
for-next)
...
Merging pcmcia/pcmcia-next (e39cdacf2f66 pcmcia: i82092: fix a null pointer=
 dereference bug)
Merging mmc/next (fb99597d255a mmc: slot-gpio: Update default label when no=
 con_id provided)
...
Merging battery/for-next (0668281d329d power: supply: cpcap-battery: use de=
vice_get_match_data() to simplify code)
Merging regulator/for-next (d17e70999e4a Merge remote-tracking branch 'regu=
...
Merging devicetree/for-next (37ef2c34e437 docs: dt: Fix a few grammar nits =
in the binding/schema docs)
Merging mailbox/mailbox-for-next (85dfdbfc13ea mailbox: cmdq: add multi-gce=
 clocks support for mt8195)
Merging spi/for-next (8886d5c77f83 Merge remote-tracking branch 'spi/for-5.=
16' into spi-next)
...
iescent states)
Merging kvm/next (deae4a10f166 KVM: x86: only allocate gfn_track when neces=
sary)
...
ed_cdevs list)
Merging ipmi/for-next (bc7b6871360e ipmi: Add docs for the IPMI IPMB driver)
Merging driver-core/driver-core-next (bb76c823585b Merge 5.15-rc4 into driv=
er-core-next)
...
Merging char-misc/char-misc-next (8bf7a12c628d Merge 5.15-rc4 into char-mis=
c-next)
Merging extcon/extcon-next (f83d7033d4ec dt-bindings: extcon: usbc-tusb320:=
 Add TUSB320L compatible string)
Merging phy-next/next (717e04fba4fa phy: rockchip-inno-usb2: Make use of th=
e helper function devm_add_action_or_reset())
...
Merging kspp/for-next/kspp (e6f21e8a3c4f Merge branch 'for-next/overflow' i=
nto for-next/kspp)
...
t_string)
Merging akpm-current/current (dd22e0752770 ipc/ipc_sysctl.c: remove fallbac=
k for !CONFIG_PROC_SYSCTL)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (506ac22b3b7e mm: unexport {,un}lock_page_memcg)
...

=mVAU
-----END PGP SIGNATURE-----
