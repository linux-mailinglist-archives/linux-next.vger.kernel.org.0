...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9DDF124F205
	for <lists+linux-next@lfdr.de>; Mon, 24 Aug 2020 06:51:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725440AbgHXEvd (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 24 Aug 2020 00:51:33 -0400
Received: from ozlabs.org ([203.11.71.1]:53055 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725355AbgHXEvb (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 24 Aug 2020 00:51:31 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BZfpj02FCz9sPB;
        Mon, 24 Aug 2020 14:51:24 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1598244685;
        bh=mAt5x+5IMD6XffZDe8IdnnahikgB9RXoTwh/lNdqPl8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 24 Aug 2020 14:51:23 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 24
Message-ID: <20200824145123.4b8dd42b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/SbyU28aE_pTOTL850XnozsO";
...
Merging arm-soc-fixes/arm/fixes (cabe3a137148 Merge tag 'zynqmp-dt-for-v5.9=
...
Merging net/master (cb95712138ec Merge tag 'powerpc-5.9-3' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging bpf/master (4af7b32f84aa Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/bpf/bpf)
Merging ipsec/master (4eb2e1341575 espintcp: restore IP CB before handing t=
he packet to xfrm)
Merging netfilter/master (1e105e6afa6c netfilter: nf_tables: fix destinatio=
n register zeroing)
...
ABILITY usage)
Merging rdma-fixes/for-rc (f6da70d99c96 MAINTAINERS: Update Mellanox and Cu=
mulus Network addresses to new domain)
Merging sound-current/for-linus (acd46a6b6de8 ALSA: firewire-digi00x: exclu=
de Avid Adrenaline from detection)
Merging sound-asoc-fixes/for-linus (c26a160782d9 Merge remote-tracking bran=
ch 'asoc/for-5.9' into asoc-linus)
Merging regmap-fixes/for-linus (9123e3a74ec7 Linux 5.9-rc1)
Merging regulator-fixes/for-linus (8d2335989a02 Merge remote-tracking branc=
...
Merging drm-fixes/drm-fixes (0790e63f58f2 Merge tag 'drm-intel-fixes-2020-0=
8-20' of git://anongit.freedesktop.org/drm/drm-intel into drm-fixes)
...
Merging mmc-fixes/fixes (df57d73276b8 mmc: sdhci-pci: Fix SDHCI_RESET_ALL f=
or CQHCI for Intel GLK-based controllers)
...
Merging risc-v-fixes/fixes (c57e8df184fe riscv/mm: Simplify retry logic in =
do_page_fault())
...
Merging imx-mxs/for-next (7018f11ace42 Merge branch 'imx/defconfig' into fo=
r-next)
...
Merging ceph/master (61983786c95b libceph: add __maybe_unused to DEFINE_CEP=
H_FEATURE)
...
DMI/SMBIOS SUPPORT)
Merging hwmon-staging/hwmon-next (caf074d22f8f dt-bindings: hwmon: Add bind=
ings for ADM1266)
$ git reset --hard HEAD^
...
Merging net-next/master (7611cbb900b4 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/netdev/net)
Merging bpf-next/master (9c0f8cbdc0e9 libbpf: Normalize and improve logging=
 across few functions)
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.c
Merging drm-intel/for-linux-next (3b4efa148da3 drm/i915: Fix cmd parser des=
c matching with masks)
...
Merging sound-asoc/for-next (15a9700c2965 Merge remote-tracking branch 'aso=
...
Merging mfd/for-mfd-next (c1ab22a28680 mfd: core: Fix double-free in mfd_re=
move_devices_fn())
...
fe charging mode)
Merging regulator/for-next (24f5902c36ab Merge remote-tracking branch 'regu=
...
Merging selinux/next (30969bc8e075 selinux: add basic filtering for audit t=
race events)
...
do_copy)
Merging akpm-current/current (0528c0651bcd ROMFS: support inode blocks calc=
ulation)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (07cdf06274c7 mm/mmap: add inline munmap_vma_range() fo=
r code readability)
...

=6FEN
-----END PGP SIGNATURE-----
