...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2E27C7C4CFA
	for <lists+linux-next@lfdr.de>; Wed, 11 Oct 2023 10:23:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230106AbjJKIXf (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 11 Oct 2023 04:23:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34200 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229846AbjJKIXe (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 11 Oct 2023 04:23:34 -0400
Received: from mail-oo1-xc33.google.com (mail-oo1-xc33.google.com [IPv6:2607:f8b0:4864:20::c33])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C802792
        for <linux-next@vger.kernel.org>; Wed, 11 Oct 2023 01:23:30 -0700 (PDT)
Received: by mail-oo1-xc33.google.com with SMTP id 006d021491bc7-57b8cebf57dso3647987eaf.0
        for <linux-next@vger.kernel.org>; Wed, 11 Oct 2023 01:23:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1697012609; x=1697617409; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=Ikok5PdEh6j6hhStr2RAdWIHI4eI2o59m4rPXXl48G8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1697012609; x=1697617409;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Ikok5PdEh6j6hhStr2RAdWIHI4eI2o59m4rPXXl48G8=;
        b=
X-Gm-Message-State: AOJu0YwlsJpH1FAlqhS918u24EKv8TEPBvfBDKoh1Chllm2pl7U9Bk8Z
        CdORbrzcpR1EubfoqEl8V0SWL/sLz5+dzufAtu1OZg==
X-Google-Smtp-Source: AGHT+IHSBvE84iguNmJ7AS2nUfv9UIMePcvOOdfIvVUw/FszIIfyfIrshf0ZJPs++SGYJm+fLj/TYA==
X-Received: by 2002:a05:6358:7e49:b0:135:5ede:f352 with SMTP id p9-20020a0563587e4900b001355edef352mr22775436rwm.8.1697012608748;
        Wed, 11 Oct 2023 01:23:28 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id o4-20020a056a001b4400b006884549adc8sm9531707pfv.29.2023.10.11.01.23.27
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 11 Oct 2023 01:23:28 -0700 (PDT)
Message-ID: <65265b80.050a0220.801e2.9db7@mx.google.com>
Date:   Wed, 11 Oct 2023 01:23:28 -0700 (PDT)
...
Subject: next/master build: 180 builds: 3 failed, 177 passed, 7 errors,
 21 warnings (next-20231011)
...
next/master build: 180 builds: 3 failed, 177 passed, 7 errors, 21 warnings =
(next-20231011)
...
Tree: next
Branch: master
Git Describe: next-20231011
Git Commit: 2933a1156742d8c47550493a77af8e2d81cf3c84
...
tion failed, symbol will not be versioned.
    1    sound/soc/tegra/tegra210_amx.c:553:10: warning: variable 'soc_data=
' is uninitialized when used here [-Wuninitialized]
    1    sound/soc/tegra/tegra210_amx.c:538:40: note: initialize the variab=
le 'soc_data' to silence this warning
...
Warnings:
    sound/soc/tegra/tegra210_amx.c:553:10: warning: variable 'soc_data' is =
uninitialized when used here [-Wuninitialized]
    sound/soc/tegra/tegra210_amx.c:538:40: note: initialize the variable 's=
oc_data' to silence this warning
    1 warning generated.
