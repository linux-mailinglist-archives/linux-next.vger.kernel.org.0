...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B6B8749B031
	for <lists+linux-next@lfdr.de>; Tue, 25 Jan 2022 10:42:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1455594AbiAYJ2c (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 25 Jan 2022 04:28:32 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50098 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1457912AbiAYJRX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 25 Jan 2022 04:17:23 -0500
Received: from mail-pf1-x430.google.com (mail-pf1-x430.google.com [IPv6:2607:f8b0:4864:20::430])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E1A60C06136F
        for <linux-next@vger.kernel.org>; Tue, 25 Jan 2022 01:10:29 -0800 (PST)
Received: by mail-pf1-x430.google.com with SMTP id u10so14583389pfg.10
        for <linux-next@vger.kernel.org>; Tue, 25 Jan 2022 01:10:29 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=Kp7aRqgBF7S/V635rYmrEAPVoFByBilivjEGNZ3iEVs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Kp7aRqgBF7S/V635rYmrEAPVoFByBilivjEGNZ3iEVs=;
        b=
X-Gm-Message-State: AOAM5321FHqe0YceRmixBM27g58vNvMcK79trvbPDGh0PY+lcY7S8fc8
        Q2bK18jgw0iKvtK4vqkBQHykt7w5e6dnPTfO
X-Google-Smtp-Source: ABdhPJzR1QxR597n5hqjEd7F9i7mObovgIBim1Z3kjMCIZ/XgbfRrpsEUDJR6v8I1QCgHnFtRzHNRQ==
X-Received: by 2002:a63:f962:: with SMTP id q34mr8931331pgk.86.1643101827452;
        Tue, 25 Jan 2022 01:10:27 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id 69sm14333024pgc.61.2022.01.25.01.10.26
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 25 Jan 2022 01:10:26 -0800 (PST)
Message-ID: <61efbe82.1c69fb81.132cf.802f@mx.google.com>
Date:   Tue, 25 Jan 2022 01:10:26 -0800 (PST)
...
Subject: next/master build: 209 builds: 13 failed, 196 passed, 20 errors,
 336 warnings (next-20220125)
...
next/master build: 209 builds: 13 failed, 196 passed, 20 errors, 336 warnin=
gs (next-20220125)
...
Git Commit: d25ee88530253138d0b20d43511ca5acbda4e9f7
...
Errors summary:
    ...
    3    include/linux/fortify-string.h:316:4: error: call to __write_overf=
...
s not constant
    2    include/linux/fortify-string.h:230:4: error: call to __write_overf=
low_field declared with 'warning' attribute: detected write beyond size of =
field (1st parameter); maybe use struct_group()? [-Werror,-Wattribute-warni=
ng]
