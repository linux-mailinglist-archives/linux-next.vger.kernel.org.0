...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 8F7893BE224
	for <lists+linux-next@lfdr.de>; Wed,  7 Jul 2021 06:38:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230038AbhGGEkq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 7 Jul 2021 00:40:46 -0400
Received: from ozlabs.org ([203.11.71.1]:34365 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230024AbhGGEkq (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 7 Jul 2021 00:40:46 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GKRW06Qx7z9srX;
        Wed,  7 Jul 2021 14:38:04 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1625632685;
        bh=uKc2/CvHTuYw2f3nsrJO909/8SjLzyoC++eAEMPr6LM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 7 Jul 2021 14:38:02 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 7
Message-ID: <20210707143802.447a5274@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/27vyvct3U_Gzg_Pss4sMsNc";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/27vyvct3U_Gzg_Pss4sMsNc
...
Changes since 20210706:

Removed tree: tpmdd-jejb (finished with)

The net tree gained a build failure so I used the version from
next-20210706.

Non-merge commits (relative to Linus' tree): 2216
 2284 files changed, 126600 insertions(+), 28680 deletions(-)
...
Merging origin/master (77d34a4683b0 Merge tag 'for-linus' of git://git.arml=
...
Merging net/master (ccd27f05ae7b ipv6: fix 'disable_policy' for fwd packets)
$ git reset --hard HEAD^
Merging next-20210706 version of net
Merging bpf/master (bc832065b60f bpftool: Properly close va_list 'ap' by va=
_end() on error)
Merging ipsec/master (2580d3f40022 xfrm: Fix RCU vs hash_resize_mutex lock =
inversion)
Merging netfilter/master (d1b5b80da705 netfilter: nft_last: incorrect arith=
metics when restoring last used)
...
register option)
Merging parisc-hd/for-next (20921e7eaf7b parisc: Replace symbolic permissio=
ns with octal permissions)
...
ker())
Merging f2fs/dev (c9ebd3df43c0 f2fs: initialize page->private when using fo=
r our internal use)
...
Merging akpm/master (35cd1c8eddab powerpc/mm: enable HAVE_MOVE_PMD support)
...

=nrSJ
-----END PGP SIGNATURE-----
