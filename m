...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2B7D743AEB8
	for <lists+linux-next@lfdr.de>; Tue, 26 Oct 2021 11:09:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233005AbhJZJMA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 26 Oct 2021 05:12:00 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:57669 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234703AbhJZJLp (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 26 Oct 2021 05:11:45 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HdmGl2SVFz4xbM;
        Tue, 26 Oct 2021 20:09:19 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1635239359;
        bh=jBu7QWOLqPCIVSPnEesa0pTWsuy+2r8CA7v6y2BngDo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 26 Oct 2021 20:09:18 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 26
Message-ID: <20211026200918.1d03ce2d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Kc4/mnVqLKfnDnTsHz6b06m";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/Kc4/mnVqLKfnDnTsHz6b06m
...
Merging net/master (f7a1e76d0f60 net-sysfs: initialize uid and gid before c=
alling net_ns_get_ownership)
...
Merging sound-asoc-fixes/for-linus (07f816e8ce04 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (82e93d81796e Merge remote-tracking branch 'spi=
...
Merging arm/for-next (1857ca7ea033 Merge branch 'devel-stable' into for-nex=
t)
...
o asm/sections.h)
Applying: Revert "ARM: 9149/1: add BUILD_BUG_ON to check if fixmap range sp=
ans multiple pmds"
...
Merging rdma/for-next (911a81c9c709 RDMA/core: Use kvzalloc when allocating=
 the struct ib_port)
Merging net-next/master (dcd63d432680 Merge branch 'bluetooth-don-t-write-d=
irectly-to-netdev-dev_addr')
CONFLICT (content): Merge conflict in include/linux/mlx5/fs.h
Merging bpf-next/for-next (57c8d362cefe Merge branch 'Parallelize verif_sca=
le selftests')
...
uetooth support)
Merging mac80211-next/master (dcd63d432680 Merge branch 'bluetooth-don-t-wr=
ite-directly-to-netdev-dev_addr')
...
e.c
Merging drm-misc/for-linux-next (44653c400615 drm/panel: novatek-nt35950: r=
emove unneeded semicolon)
Merging amdgpu/drm-next (519fc0a14c81 drm/amdgpu/display: add quirk handlin=
g for stutter mode)
Merging drm-intel/for-linux-next (c4ae82a0e922 drm: Small optimization to i=
ntel_dp_mst_atomic_master_trans_check)
Merging drm-tegra/drm/tegra/for-next (5dccbc9de8f0 drm/tegra: dc: rgb: Allo=
w changing PLLD rate on Tegra30+)
Merging drm-msm/msm-next (00326bfa4e63 drm/msm/dpu: Remove dynamic allocati=
on from atomic context)
...
Merging sound-asoc/for-next (6d724ad32e15 Merge remote-tracking branch 'aso=
...
te support)
Merging block/for-next (9b3b463f3955 Merge branch 'for-5.16/block' into for=
-next)
...
Merging devicetree/for-next (e76187b9792e scripts/dtc: Update to upstream v=
ersion v1.6.1-19-g0a3a9d3449c8)
Merging mailbox/mailbox-for-next (0a5ad4322927 mailbox: mtk-cmdq: Fix local=
 clock ID usage)
Merging spi/for-next (4c7971ccce3b Merge remote-tracking branch 'spi/for-5.=
16' into spi-next)
...
ac-for-next)
Merging irqchip/irq/irqchip-next (5ea83e2096fe Merge branch irq/misc-5.16 i=
...
Merging kvms390/next (67cf68b6a5cc KVM: s390: Add a routine for setting use=
rspace CPU state)
Merging xen-tip/linux-next (71489efcf98e xen: fix wrong SPDX headers of Xen=
 related headers)
...
Merging phy-next/next (d04a85d54945 phy: Sparx5 Eth SerDes: Fix return valu=
e check in sparx5_serdes_probe())
CONFLICT (modify/delete): arch/arm64/boot/dts/qcom/apq8096-db820c.dtsi dele=
ted in HEAD and modified in phy-next/next. Version phy-next/next of arch/ar=
m64/boot/dts/qcom/apq8096-db820c.dtsi left in tree.
...
ce_create())
Merging staging/staging-next (7e4c7947b42c staging: r8188eu: Use a Mutex in=
stead of a binary Semaphore)
...
Merging dmaengine/next (981b43434b28 message: fusion: switch from 'pci_' to=
 'dma_' API)
$ git reset --hard HEAD^
...
ng)
Merging pinctrl/for-next (d2388172389e pinctrl: intel: Kconfig: Add configu=
ration menu to Intel pin control)
$ git reset --hard HEAD^
...
Merging kspp-gustavo/for-next/kspp (b132859800ec Merge branch 'for-next/ksp=
p-misc-fixes' into for-next/kspp)
...
Merging akpm/master (0857f262d257 lib/stackdepot: allow optional init and s=
...

=9rcW
-----END PGP SIGNATURE-----
