...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id D8AF3125BE3
	for <lists+linux-next@lfdr.de>; Thu, 19 Dec 2019 08:11:31 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726303AbfLSHLb (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 19 Dec 2019 02:11:31 -0500
Received: from ozlabs.org ([203.11.71.1]:40637 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726294AbfLSHLa (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 19 Dec 2019 02:11:30 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47djjC0WZYz9sPJ;
        Thu, 19 Dec 2019 18:11:27 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1576739487;
        bh=34FU8khAUcOk7t2EA3nFO4UBWgGTR3Kv8n+8IB6TfIk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 19 Dec 2019 18:11:25 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 19
Message-ID: <20191219181125.273d62b3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/NEgXswznKnuAo6wMRQWksIv";
...
The y2038 tree  gained a conflict againstthe crypto tree.

Non-merge commits (relative to Linus' tree): 3980
 4423 files changed, 173696 insertions(+), 96138 deletions(-)
...
Merging origin/master (80a0c2e511a9 Merge tag 'sound-5.5-rc3' of git://git.=
...
Merging net/master (b7ac893652ca net: nfc: nci: fix a possible sleep-in-ato=
mic-context bug in nci_uart_tty_receive())
Merging bpf/master (e47304232b37 bpf: Fix cgroup local storage prog trackin=
g)
...
ns_ipvs)
Merging wireless-drivers/master (e5e884b42639 libertas: Fix two buffer over=
flows at parsing bss descriptor)
...
Merging staging.current/staging-linus (c05c403b1d12 staging: wfx: fix wrong=
 error message)
Merging char-misc.current/char-misc-linus (05b686b573cf intel_th: msu: Fix =
window switching without windows)
...
Merging mmc-fixes/fixes (75d27ea1abf7 mmc: sdhci: Add a quirk for broken co=
mmand queuing)
...
Merging qcom/for-next (a1f42ee49fef Merge branches 'arm64-for-5.5-fixes', '=
...
Merging sunxi/sunxi/for-next (48cb3cf3beff Merge branch 'sunxi/fixes-for-5.=
5' into sunxi/for-next)
...
Merging f2fs/dev (25d18e19a91e f2fs: support data compression)
...
pression() static)
Merging hid/for-next (2951839895b6 Merge branch 'for-5.6/logitech' into for=
-next)
...
in imxfb_probe())
Merging pm/linux-next (3397ff4beb3c Merge branches 'acpi-battery', 'acpi-vi=
deo' and 'acpi-tools' into linux-next)
...
Merging net-next/master (cbd22f172df7 sch_cake: drop unused variable tin_qu=
antum_prio)
...
etdev.c
$ git reset --hard HEAD^
Merging next-20191218 version of net-next
CONFLICT (content): Merge conflict in drivers/net/phy/phylink.c
CONFLICT (content): Merge conflict in drivers/net/ethernet/amazon/ena/ena_n=
etdev.c
[master 65cb6cb80d29] next-20191218/net-next
Merging bpf-next/master (58d8dc2a98f5 Merge branch 'skel-fixes')
...
Merging wireless-drivers-next/master (c705f9fc6a17 orinoco: avoid assertion=
...
terface)
Merging drm/drm-next (66af4a9ddac6 Merge tag 'du-next-20191218' of git://li=
nuxtv.org/pinchartl/media into drm-next)
Merging amdgpu/drm-next (c2cbb6901b8d drm/amdgpu/display: use msleep rather=
 than udelay for HDCP)
Merging drm-intel/for-linux-next (01f624f01845 drm/i915: Ratelimit i915_glo=
bals_park)
...
up on ->remove())
Merging drm-misc/for-linux-next (cad8c44a9ff0 dt-bindings: display: bridge:=
...
Merging mmc/next (2253ed4b36dc mmc: mmci: Support any block sizes for ux500=
v2 and qcom variant)
...
Merging battery/for-next (4cf35d2140bb power: supply: max17042: add MAX1705=
5 support)
$ git reset --hard HEAD^
Merging next-20191218 version of battery
...
CONFLICT (content): Merge conflict in arch/arm/tools/syscall.tbl
CONFLICT (content): Merge conflict in arch/alpha/kernel/syscalls/syscall.tbl
[master 83111bfbd4c8] next-20191211/keys
...
r_each_entry_rcu().)
Merging tpmdd/next (d88a2a62e2a3 tpm/tpm_ftpm_tee: add shutdown call back)
...
Merging tip/auto-latest (9e26469dcde2 Merge branch 'linus')
...
r-core-next)
Merging usb/usb-next (10e5e6c24963 usb: gadget: move choice ... endchoice t=
o legacy/Kconfig)
...
Merging tty/tty-next (c3a4e5527351 Revert "serdev: simplify Makefile")
...
Merging staging/staging-next (92ee2034696c staging: rtl8188eu: add spaces a=
round operators in rtw_mlme_ext.c)
...
Merging rpmsg/for-next (b75aae0d7e7c Merge branches 'hwspinlock-next', 'rpm=
...
Merging y2038/y2038 (77ede9011355 Merge tags 'y2038-drivers-for-v5.6-signed=
' and 'block-ioctl-cleanup-5.6' into y2038-for-v5.6)
...
lues)
Merging slimbus/for-next (e466bd8c2a29 dt-bindings: SLIMBus: add slim devic=
...
Merging devfreq/devfreq-next (d96e4944007e PM / devfreq: exynos-bus: Reduce=
...
Merging akpm-current/current (2ecbc2b297bb ipc/msg.c: consolidate all xxxct=
l_down() functions)
...
rflow
Merging akpm/master (b2debeec902e drivers/media/platform/sti/delta/delta-ip=
...

=DPuC
-----END PGP SIGNATURE-----
