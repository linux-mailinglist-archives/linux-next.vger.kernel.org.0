Return-Path: <linux-next+bounces-5263-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4A03EA16841
	for <lists+linux-next@lfdr.de>; Mon, 20 Jan 2025 09:34:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 671E9161A95
	for <lists+linux-next@lfdr.de>; Mon, 20 Jan 2025 08:34:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 6C2DC18FDDF;
	Mon, 20 Jan 2025 08:34:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="ArOcUGLq"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 09433149DF0;
	Mon, 20 Jan 2025 08:34:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737362057; cv=none; b=ehXS/BUGECMKzJIHCyW9Ae00ndV8VVDb8prhhu0icvIM9ouWpKU3fKRUWj+YPoFwkM7DjGCrF7/LJzsgaY43/pZyv+EhAt1qdYervrDmVqcH3TN4ht5jEIXoGN9pn82QDiGxAZuyzQf0RivJf63ZztBGoiDLWQzNuu97+qHBkog=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737362057; c=relaxed/simple;
	bh=qabpmvuBhB8nm1kiAT0y+Xx6w7ZFiPDUp4oZQc265c8=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=cnLtIw0DfvKr9wu8wBvKWJCPwvlcuaUMgRs9uhtYzh5OSjwQ1qIH6tj4U7GnBemuyOxpcJDaICLgW/IG/nGoeEG3SHr6Q9562q3mJAUg1vll3knQ0HBkFi3JAFhosLEvp09faUTZ5VITWNdZ9QxfWkuLdFTnjLc8gUo9GaPM7Q8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=ArOcUGLq; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1737362043;
	bh=sunu/oZTPnMlHlby0UbLR+7EulTpXzrDOODm2A2VtYo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Yc3XV6bWbz4x8P;
	Mon, 20 Jan 2025 19:34:02 +1100 (AEDT)
Date: Mon, 20 Jan 2025 19:34:10 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 20
Message-ID: <20250120193410.79faf9ff@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Bs4t7WUFaxiWn.u3LGcrmwo";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/Bs4t7WUFaxiWn.u3LGcrmwo
...
The nand tree still had its build failure but I applied a supplied patch.

The crc tree gained a build failure when merged with the sound tree for
which I reverted a commit from the sound tree.

Non-merge commits (relative to Linus' tree): 8874
 8948 files changed, 407822 insertions(+), 144253 deletions(-)
...
Merging origin/master (9528d418de4d Merge tag 'x86_urgent_for_v6.13' of git=
...
tch())
Merging cifs/for-next (d93fde3696ed cifs: Fix endian types in struct rfc100=
2_session_packet)
...
Merging f2fs/dev (5c1768b67250 f2fs: fix to do sanity check correctly on i_=
inline_xattr_size)
...
Merging nfs-anna/linux-next (b3344839a7f1 nfs: use wait_var_event_spinlock(=
...
Merging ubifs/next (01099f635a4c ubi: Implement ioctl for detailed erase co=
unters)
...
Merging mm-hotfixes/mm-hotfixes-unstable (f48d515b0c49 mailmap, docs: updat=
e email to carlos.bilbao@kernel.org)
Merging fs-current (4a68c5997586 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (bc50835e83f6 net: sched: Disallow replacing of child qdis=
c from one parent to another)
...
Merging sound-current/for-linus (1a0f59b04c8c Merge tag 'asoc-fix-v6.13-rc7=
...
Merging hwmon-fixes/hwmon (595523945be0 Merge tag 'devicetree-fixes-for-6.1=
3-2' of git://git.kernel.org/pub/scm/linux/kernel/git/robh/linux)
...
Merging tip-fixes/tip/urgent (3b71af21407a Merge branch into tip/master: 'x=
86/urgent')
...
-numeric formats)
Merging mm-stable/mm-stable (2877a83e4a0a mm/hugetlb: use folio->lru int de=
mote_free_hugetlb_folios())
Merging mm-nonmm-stable/mm-nonmm-stable (55b21f5c73a9 Xarray: use xa_mark_t=
 in xas_squash_marks() to keep code consistent)
Merging mm/mm-everything (6cb10d50cba3 foo)
Merging kbuild/for-next (0939156bc07c genksyms: fix syntax error for attrib=
ute before init-declarator)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (ac22d75377a0 perf lock: Rename fields in lock=
_type_table)
...
Merging clk/clk-next (47b32b50ee28 Merge branch 'clk-cleanup' into clk-next)
...
nRISC)
Merging parisc-hd/for-next (f5959f9ec658 parisc: add vdso linker script to =
'targets' instead of extra-y)
Merging powerpc/next (7fee0217538a MAINTAINERS: powerpc: Update my status)
...
Merging fs-next (b26690adc8e8 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (9022df7f5e05 Merge branch 'for-6.14-cpu_sync-fixup=
' into for-next)
Merging pci/next (c3016b84d065 Merge branch 'pci/misc')
...
Merging pm/linux-next (49d5ece0cb0f Merge branch 'pm-tools' into linux-next)
...
Merging pmdomain/next (c2d7aa308ecf pmdomain: arm: scmi_pm_domain: Send an =
explicit request to set the current state)
...
Merging rdma/for-next (f5f01c5c409e RDMA/qib: Constify 'struct bin_attribut=
e')
...
Merging net-next/main (59372af69d4d Merge tag 'batadv-next-pullrequest-2025=
0117' of git://git.open-mesh.org/linux-merge)
Merging bpf-next/for-next (1a2367d92dfc Merge branch 'bpf-next/master' into=
 for-next)
...
Merging nand/nand/next (be7a05db4252 mtd: spinand: winbond: Add support for=
 DTR operations)
Applying: mtd: spinand: skyhigh: Align with recent read from cache variant =
changes
...
u_dma_buf_free_obj())
Merging amdgpu/drm-next (97e5c9e41390 drm/amd/display: fix CEC DC_DEBUG_MAS=
K documentation)
Merging drm-intel/for-linux-next (24c61d553302 Merge tag 'drm-msm-next-2025=
-01-07' of gitlab.freedesktop.org:drm/msm into drm-next)
...
Merging drm-xe/drm-xe-next (173baa1b2dc4 drm/xe: Suppress printing of mode =
when running in non-sriov mode)
Merging etnaviv/etnaviv/next (6bde14ba5f7e drm/etnaviv: add optional reset =
support)
Merging fbdev/for-next (c542a56aad1f fbdev: vga16fb: fix orig_video_isVGA c=
onfusion)
Merging regmap/for-next (78798d887531 Merge remote-tracking branch 'regmap/=
for-6.14' into regmap-next)
Merging sound/for-next (dd85bbb7fc48 ALSA: usb: fcp: Fix hwdep read ops arg=
ument)
Applying: fixup for "ALSA: FCP: Add Focusrite Control Protocol driver"
Merging ieee1394/for-next (352fafe97784 firewire: test: Fix potential null =
dereference in firewire kunit test)
Merging sound-asoc/for-next (c2ff66aefa98 Merge remote-tracking branch 'aso=
c/for-6.14' into asoc-next)
Merging modules/modules-next (0217859ce172 module: sign with sha512 instead=
 of sha1 by default)
Merging input/next (92600f3295ff Input: xpad - add QH Electronics VID/PID)
Merging block/for-next (e8153972dea5 Merge branch 'for-6.14/io_uring' into =
for-next)
Applying: fix up for "io_uring/memmap: implement kernel allocated regions"
Merging device-mapper/for-next (6845de78ae37 dm-mirror: Support atomic writ=
es)
...
Merging tpmdd/next (e8988ff01353 tpm: Change to kvalloc() in eventlog/acpi.=
c)
...
Merging mailbox/for-next (db049866943a mailbox: th1520: Fix memory corrupti=
on due to incorrect array size)
Merging spi/for-next (f3e44cc2ee37 Merge remote-tracking branch 'spi/for-6.=
14' into spi-next)
Merging tip/master (2c13dabd8d8d Merge branch into tip/master: 'x86/tdx')
...
Merging ftrace/for-next (9f3ccaeedbe0 Merge branch 'trace/fix-for-next' int=
o trace/for-next)
...
ext)
Merging drivers-x86/for-next (4055e18bfbb7 ACPI: platform_profile: Add a pr=
efix to log messages)
...
Merging efi/next (374ac8cdcbf1 selftests/efivarfs: add concurrent update te=
sts)
...
Merging iommufd/for-next (3f4818ec1390 iommufd/fault: Destroy response and =
mutex in iommufd_fault_destroy())
...
uild for PREEMPT_RT)
Applying: Revert "ALSA: hda/tas2781: Add tas2781 hda SPI driver"
...

=rGw6
-----END PGP SIGNATURE-----
