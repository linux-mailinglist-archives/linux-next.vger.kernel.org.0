...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 37CB51EB9B2
	for <lists+linux-next@lfdr.de>; Tue,  2 Jun 2020 12:38:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726139AbgFBKht (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 2 Jun 2020 06:37:49 -0400
Received: from ozlabs.org ([203.11.71.1]:57901 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726110AbgFBKhs (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 2 Jun 2020 06:37:48 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49bpQV41cGz9sSy;
        Tue,  2 Jun 2020 20:37:38 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1591094258;
        bh=9kSbgTuZWu16sl0y6b86NbBqMAbLzmT7sK+27sKc/3o=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 2 Jun 2020 20:37:37 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 2
Message-ID: <20200602203737.6eec243f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/hn3jwmuxoZETDl.ocWFXu=i";
...
The net-next tree gained a conflict against the clk tree.

The drm-msm tree still had its build failure so I applied a patch.

The block tree gained conflicts against the rdma tree.

The mmc tree gained a semantic conflict against the net-next tree.
...
The hyperv tree gained a conflict against the kvm tree.

The akpm tree gained a conflict against the net-next tree and a build
failure for which I applied a patch.

Non-merge commits (relative to Linus' tree): 13258
 13208 files changed, 761190 insertions(+), 229902 deletions(-)
...
Merging origin/master (9bf9511e3d9f Merge tag 'x86_cache_updates_for_5.8' o=
...
mn warning)
Merging ipsec/master (f6a23d85d078 xfrm: fix a NULL-ptr deref in xfrm_local=
_error)
Merging netfilter/master (45ebf73ebcec sctp: check assoc before SCTP_ADDR_{=
MADE_PRIM, ADDED} event)
...
Merging spi-fixes/for-linus (0c0c5b8fabe5 Merge remote-tracking branch 'spi=
...
tmr processing)
Merging drm-fixes/drm-fixes (ed9244bd0b26 Merge tag 'drm-misc-fixes-2020-05=
...
Merging cifs/for-next (0804cd01f125 cifs: multichannel: try to rebind when =
...
arning)
Merging exfat/dev (cdc9b981b144 exfat: replace 'time_ms' with 'time_cs')
...
Merging pci/next (1f420e4dcf00 Merge branch 'remotes/lorenzo/pci/vmd')
...
Merging v4l-dvb-next/master (83fac9617e22 media: atomisp comment an unused =
code)
...
Merging rdma/for-next (70ae39555033 RDMA/hns: Uninitialized variable in mod=
ify_qp_init_to_rtr())
Merging net-next/master (9a25c1df24a6 Merge git://git.kernel.org/pub/scm/li=
...
Merging bpf-next/master (9a25c1df24a6 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/bpf/bpf-next)
...
Merging mlx5-next/mlx5-next (6b646a7e4af6 net/mlx5: Add ability to read and=
 write ECE options)
Merging netfilter-next/master (eae9d3c0167d net: dsa: sja1105: suppress -Wm=
issing-prototypes in sja1105_vl.c)
...
.c
Merging amdgpu/drm-next (dd7260b0a216 drm/amdgpu/display: drop the reductio=
n loop when setting the sync groups)
Merging drm-intel/for-linux-next (0e386959272e drm/i915: Check for awaits o=
n still currently executing requests)
...
CONFLICT (content): Merge conflict in drivers/nvme/host/rdma.c
CONFLICT (content): Merge conflict in drivers/block/loop.c
Applying: fix up for merge conflict with rdma tree
Merging device-mapper/for-next (99ca08aebf11 dm mpath: enhance queue_if_no_=
path debugging)
...
Merging iommu/next (290b3a52b334 Merge branches 'iommu/fixes', 'arm/msm', '=
arm/allwinner', 'arm/smmu', 'x86/vt-d', 'hyper-v', 'core' and 'x86/amd' int=
o next)
CONFLICT (content): Merge conflict in drivers/iommu/s390-iommu.c
Merging vfio/next (ea20868c7197 Merge branch 'qiushi-wu-mdev-ref-v1' into v=
5.8/vfio/next)
...
ualcomm IPCC driver)
Merging spi/for-next (fb02b9eb4e33 Merge remote-tracking branch 'spi/for-5.=
8' into spi-next)
Merging tip/auto-latest (88e97a302abe Merge branch 'core/core')
...
Merging akpm-current/current (5f1b7a0f9e00 linux-next-pre)
...
Merging akpm/master (cffaeabf2a6f drivers/media/platform/sti/delta/delta-ip=
c.c: fix read buffer overflow)
Applying: fix up for strncpy_from_unsafe_strict rename
Applying: turns out that probe_user_write is used in modular code
...

=Bz7w
-----END PGP SIGNATURE-----
