Return-Path: <linux-next+bounces-4386-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 52BFD9ABE30
	for <lists+linux-next@lfdr.de>; Wed, 23 Oct 2024 07:53:13 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id F41C328543A
	for <lists+linux-next@lfdr.de>; Wed, 23 Oct 2024 05:53:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 14F4313BC0D;
	Wed, 23 Oct 2024 05:52:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="bbZiwXBn"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AE4557482;
	Wed, 23 Oct 2024 05:52:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1729662739; cv=none; b=Bf8jitSSq9VgsT8bqqxKsaOhGKg4eQJKxNmtWdXSnq72ZoLgvRV8+YiELxq2hPmSnNd4bGwLQpmfb7/Zsu2TV+An6Mtm0A1msunp8Iw5ImyoZnDYcu1/MQUdz31oFLyGyl4c7u2ju24nM0T205uE7SsoWCa5JID4TPyzkJBQccc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1729662739; c=relaxed/simple;
	bh=RUlVARDXjcD2zrH3KlZw8Wh+fyrpYRkPaol5wTZOYLQ=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=qhDUdw6YtRmTqXPYX2V/hxGhxeSON0rU/UQscFLv3ag9mlB0agh345EpADVpPUXguRuVIjRGbeMhTcFyNeJmy99siTfNp+W8M5LoIlBXHbS1xRV1VifRzKRfBw2KgSy6q9xfAx5cV5EPGqCg8XFlcur/5t3lcGXpr/wu563EMAU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=bbZiwXBn; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1729662729;
	bh=IgPQ4KV+PYM1hsbcbMg1/mNK1/9kKjzEQYze6KD8Eiw=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XYJ8n5rQzz4x11;
	Wed, 23 Oct 2024 16:52:09 +1100 (AEDT)
Date: Wed, 23 Oct 2024 16:52:10 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 23
Message-ID: <20241023165210.42d6547e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/JYnXebwgOg.Kx3hszGmUls.";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/JYnXebwgOg.Kx3hszGmUls.
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241022:

The security tree gained a conflict against the mm tree.

The char-misc tree gained a conflict against the iio-fixes tree.

The phy-next tree gained a conflict against the phy tree.

The memblock tree still has its boot failure for which I have reverted
a commit.

Non-merge commits (relative to Linus' tree): 5752
 7792 files changed, 259880 insertions(+), 214722 deletions(-)
...
Merging btrfs-fixes/next-fixes (9982c1421e6b Merge branch 'misc-6.12' into =
next-fixes)
...
ng server address)
Merging btrfs/for-next (6ea4c0839d6f Merge branch 'for-next-next-v6.12-2024=
1022' into for-next-20241022)
...
Merging fs-current (7458de9f323a Merge branch 'nfsd-fixes' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/cel/linux)
Merging kbuild-current/fixes (42f7652d3eb5 Linux 6.12-rc4)
...
Merging net/main (8a7d12d674ac net: usb: usbnet: fix name regression)
Merging bpf/master (1f97c03f43fa bpf: Preserve param->string when parsing m=
ount options)
...
Merging sound-asoc-fixes/for-linus (b9a8ecf81066 ASoC: fsl_micfil: Add samp=
le rate constraint)
...
' into for-next)
Merging arm64/for-next/core (a05265b8f135 Merge branch 'for-next/mops' into=
 for-next/core)
...
Merging clk/clk-next (019caf7b5cc7 Merge branch 'clk-bindings' into clk-nex=
t)
...
Merging fs-next (6ce0669dbc0c Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging pm/linux-next (7f31183fa1d5 Merge branch 'acpi-battery' into linux-=
next)
...
ic)
Merging net-next/main (73840ca5ef36 net: mv643xx: use ethtool_puts)
...
es/net_device.rst
Merging ath-next/for-next (ca68ce0d9f4b wifi: ath12k: fix warning when unbi=
nding)
...
rototype for crtc)
Merging drm-misc/for-linux-next (2320c9e6a768 drm/sched: memset() 'job' in =
drm_sched_job_init())
...
mu.c
Merging drm-intel/for-linux-next (5367156172a5 drm/i915/display: Remove kst=
rdup_const() and kfree_const() usage)
...
Merging drm-xe/drm-xe-next (b982cba5cebd drm/xe/pf: Show VFs LMEM provision=
ing summary over debugfs)
...
Merging sound-asoc/for-next (a7e1244497a1 Merge remote-tracking branch 'aso=
...
Merging block/for-next (d16576884783 Merge branch 'for-6.13/block' into for=
-next)
...
m_driver::remove())
Merging regulator/for-next (5ddc236d094d regulator: init_data handling upda=
te)
Merging security/next (e4c3c257e0f8 Automated merge of 'dev' into 'next')
...
Merging edac/edac-for-next (233679b58c0b RAS/AMD/ATL: Add debug prints for =
DF register reads)
...
rom 512 to 2048)
Merging sched-ext/for-next (2a5ae9828850 Merge branch 'for-6.12-fixes' into=
 for-next)
Merging drivers-x86/for-next (90a7d7486004 platform/x86: classmate-laptop: =
...
Merging dmaengine/next (73d03c615b9d dmaengine: loongson2-apb: Rename the p=
...
Merging pinctrl/for-next (712a7891b8b6 Merge fixup)
...

=i9gN
-----END PGP SIGNATURE-----
