...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5887C1C8487
	for <lists+linux-next@lfdr.de>; Thu,  7 May 2020 10:15:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726222AbgEGIPi (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 7 May 2020 04:15:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47092 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-FAIL-OK-FAIL)
        by vger.kernel.org with ESMTP id S1727812AbgEGIPb (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 7 May 2020 04:15:31 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7EA6EC061A10;
        Thu,  7 May 2020 01:15:30 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49HmVQ4VY0z9sSW;
        Thu,  7 May 2020 18:15:26 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1588839326;
        bh=LQodx+Huqm8hdnvoziwrOpOU9opnjyBw2SNfnv97IX0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 7 May 2020 18:15:24 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 7
Message-ID: <20200507181524.728b6b10@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/CR+Ktwhji6GyPBLKsjf8QPI";
...
Merging origin/master (3c40cdb0e93e Merge branch 'linus' of git://git.kerne=
...
Merging arm64-fixes/for-next/fixes (20bf6ebaec5f arm64: hugetlb: avoid pote=
...
Merging rdma-fixes/for-rc (221e97d6fb66 IB/i40iw: Remove bogus call to netd=
ev_master_upper_dev_get())
Merging sound-current/for-linus (da7a8f1a8fc3 ALSA: usb-audio: add mapping =
for ASRock TRX40 Creator)
Merging sound-asoc-fixes/for-linus (f92cc2772ce0 Merge remote-tracking bran=
...
Merging usb.current/usb-linus (084d7e784675 Merge tag 'usb-serial-5.7-rc5' =
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (4457a9db2bde drm/i915/tgl+: F=
ix interrupt handling for DP AUX transactions)
Merging mmc-fixes/fixes (215a89d75b79 mmc: sdhci-pci-gli: Fix can not acces=
...
Merging arm64/for-next/core (34d016c38dca Merge branch 'for-next/bti' into =
for-next/core)
...
or-next)
Merging omap/for-next (cfc831e37cff Merge branch 'omap-for-v5.8/dt' into fo=
r-next)
...
Merging mips/mips-next (3a06c204fbc8 MIPS: tools: Move "returns" after "loo=
ngson3-llsc-check")
...
_NONBLOCK)
Merging xfs/for-next (840d493dff1a fs/xfs: Combine xfs_diflags_to_linux() a=
nd xfs_diflags_to_iflags())
...
lock optimization)
Merging vfs/for-next (ce2f04fd15cc Merge branch 'work.set_fs-exec' into for=
-next)
Applying: eventfd: include uio.h
Merging printk/for-next (d34f14ae521f Merge branch 'for-5.7-preferred-conso=
le' into for-next)
Merging pci/next (caf76ec7adb0 Merge branch 'remotes/lorenzo/pci/v3-semi')
Merging pstore/for-next/pstore (7fdaefe82722 pstore/ram: Adjust module para=
m permissions to reflect reality)
Merging hid/for-next (6065235d5479 Merge branch 'for-5.8/asus' into for-nex=
t)
...
Merging rdma/for-next (f86e34374a05 RDMA/efa: Count admin commands errors)
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/steering/dr_send.c
Merging net-next/master (ae1804de93f6 dsa: sja1105: dynamically allocate st=
ats structure)
CONFLICT (content): Merge conflict in include/net/mptcp.h
CONFLICT (content): Merge conflict in drivers/net/ipa/ipa_endpoint.c
Merging bpf-next/master (f87b87a1c969 Merge tag 'perf-for-bpf-2020-05-06' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip into bpf-next)
...
Merging wireless-drivers-next/master (7f65f6118a53 Merge ath-next from git:=
...
c.c
Merging amdgpu/drm-next (959be0df4b72 drm/amdgpu: implement soft_recovery f=
or gfx10)
...
.c
Merging drm-intel/for-linux-next (24fe5f2ab247 drm/i915: Propagate error fr=
om completed fences)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_fb=
c.c
...
Merging drm-tegra/drm/tegra/for-next (757338371608 drm/tegra: Clean up GPIO=
 includes)
Merging drm-misc/for-linux-next (0ea2ea42b31a drm/vkms: Hold gem object whi=
le still in-use)
...
Merging sound/for-next (79263c3bceb7 ALSA: hda: Return true,false for retur=
n type bool)
Merging sound-asoc/for-next (b746d8768d34 Merge remote-tracking branch 'aso=
...
haracters)
Merging mmc/next (250815b08bc5 mmc: sdhci-msm: Fix error handling for dev_p=
m_opp_of_add_table())
...
Merging rcu/rcu/next (ad49dba5db65 torture: Add --allcpus argument to the k=
vm.sh script)
...
Merging drivers-x86/for-next (65fce35f73d2 platform/x86: touchscreen_dmi: D=
rop comma in terminator line)
...
er)
Merging tty/tty-next (8508f4cba308 serial: amba-pl011: Make sure we initial=
ize the port.lock spinlock)
...
Merging scsi-mkp/for-next (64e14ece0700 scsi: scsi_debug: Implement ZBC hos=
t-aware emulation)
Merging vhost/linux-next (2d7ae7f9ea1b vdpasim: remove unused variable 'ret=
')
$ git reset --hard HEAD^
Merging next-20200505 version of vhost
Merging rpmsg/for-next (6373dee052e2 Merge branches 'hwspinlock-next', 'rpm=
...
gression test)
Merging devfreq/devfreq-next (9d9006ec4d81 PM / devfreq: Replace strncpy wi=
th strscpy)
...
conflict)
Merging akpm-current/current (7bf9e74cab02 ipc-convert-ipcs_idr-to-xarray-u=
pdate)
...
bort".
CONFLICT (content): Merge conflict in arch/powerpc/platforms/cell/spufs/fil=
e.c
$ git rebase --skip
dropping 6ad1b99e57e60c1dc17aec2a5b94eb4e69a053e0 powerpc/spufs: stop using=
 access_ok -- patch contents already upstream
dropping 8c55111a63785215fe06f356c9ab307c68282c25 powerpc/spufs: simplify s=
pufs core dumping -- patch contents already upstream
dropping 205a5fe19d696725f883c2d382868171041c0a8f signal: refactor copy_sig=
info_to_user32 -- patch contents already upstream
dropping 7c663b45197f4a7470f341051ce18e273e50d77f binfmt_elf: remove the se=
t_fs in fill_siginfo_note -- patch contents already upstream
dropping f20bcf7c1b31eb756cd51214b848ccf8a50da0a4 binfmt_elf: remove the se=
t_fs(KERNEL_DS) in elf_core_dump -- patch contents already upstream
dropping 71ec357a9fa8884d32003b79f7c82be233cc2532 binfmt_elf_fdpic: remove =
the set_fs(KERNEL_DS) in elf_fdpic_core_dump -- patch contents already upst=
ream
dropping 25ed66a4f083600508a8b51ba37e813f0af70e90 kernel/sysctl.c: fix unus=
ed function warning -- patch contents already upstream
Merging akpm/master (d0f3f6070c3a drivers/media/platform/sti/delta/delta-ip=
...

=wbw9
-----END PGP SIGNATURE-----
