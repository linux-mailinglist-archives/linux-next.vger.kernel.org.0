...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 3320D5230C5
	for <lists+linux-next@lfdr.de>; Wed, 11 May 2022 12:38:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233009AbiEKKiM (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 11 May 2022 06:38:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33966 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232029AbiEKKiJ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 11 May 2022 06:38:09 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B6E61994D8;
        Wed, 11 May 2022 03:38:05 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KyrwC5Mvxz4xXS;
        Wed, 11 May 2022 20:38:03 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1652265483;
        bh=NztlEguNFMOIEauztkIlAjtrg1YA4ImLm2VKgVsh5zw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 11 May 2022 20:38:02 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 11
Message-ID: <20220511203802.08e03027@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/25r/VBTJhQPLVkhSPgsbC.+";
...
--Sig_/25r/VBTJhQPLVkhSPgsbC.+
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220510:
...
The sysctl tree gained a conflict against the bpf-next tree.

The mm tree lost its build failures but gained another for which I
applied a hack.

Non-merge commits (relative to Linus' tree): 10128
 10371 files changed, 952732 insertions(+), 214223 deletions(-)
...
Merging mm-hotfixes/mm-hotfixes-unstable (767439579d42 Revert "mm/cma.c: re=
...
Merging net/master (12a4d677b1c3 net: phy: micrel: Fix incorrect variable t=
ype in micrel)
...
Merging sound-current/for-linus (a34ae6c0660d ALSA: wavefront: Proper check=
 of get_user() error)
Merging sound-asoc-fixes/for-linus (a2cf0f7dba92 Merge remote-tracking bran=
...
Merging pci-current/for-linus (b4ceb3697166 Revert "PCI: brcmstb: Split brc=
...
Merging zstd-fixes/zstd-linus (88a309465b3f lib: zstd: clean up double word=
 in comment.)
Merging drm-misc-fixes/for-linux-next-fixes (ef3a6b70507a dma-buf: call dma=
_buf_stats_setup after dmabuf is in valid list)
Merging kbuild/for-next (a24e06a3db44 kbuild: record symbol versions in *.c=
md files)
Merging perf/perf/core (8586d2744ff3 perf metrics: Don't add all tool event=
s for sharing)
Merging compiler-attributes/compiler-attributes (7c00621dcaee compiler_type=
s: mark __compiletime_assert failure as __noreturn)
Merging dma-mapping/for-next (3cb4503a3301 x86: remove cruft from <asm/dma-=
mapping.h>)
Merging asm-generic/master (ca78247c9c10 Merge tag 'generic-ticket-spinlock=
s-v5' of git://git.kernel.org/pub/scm/linux/kernel/git/palmer/linux into as=
m-generic)
...
Merging arm-perf/for-next/perf (33835e8dfb3c perf/marvell_cn10k: Fix tad_pm=
u_event_init() to check pmu type first)
...
Merging powerpc/next (5f8fefe087a2 powerpc/rtas: Keep MSR[RI] set when call=
ing RTAS)
...
Merging ceph/master (a6a8e1b35ab9 fs: change test in inode_insert5 for addi=
ng to the sb list)
...
Merging hwmon-staging/hwmon-next (36ef0e8924b8 hwmon: (acpi_power_meter) Fi=
x style issues)
...
Merging net-next/master (bca56ea6849f Merge branch 'move-siena-into-a-separ=
ate-subdirectory')
Applying: fix up for "net: sfc: fix memory leak due to ptp channel"
Merging bpf-next/for-next (cb411545309e Merge branch 'bpf: Speed up symbol =
resolving in kprobe multi link')
...
Merging drm-misc/for-linux-next (e090532246fe drm/bridge: simplify the retu=
rn expression of ps8640_bridge_host_attach)
Merging amdgpu/drm-next (81c5495910e8 drm/amdgpu: Remove duplicated argumen=
t in vcn_v4_0)
Merging drm-intel/for-linux-next (e9794c88cd6c drm/i915: remove single-use =
GEM_DEBUG_EXEC())
...
Merging sound-asoc/for-next (7667cd1274ca Merge remote-tracking branch 'aso=
...
R329 and D1)
Merging block/for-next (a2f45cd3eff6 Merge branch 'for-5.19/drivers' into f=
or-next)
...
finition for mt8186)
Merging spi/for-next (96674ac22f96 Merge remote-tracking branch 'spi/for-5.=
19' into spi-next)
...
Merging random/master (ce32afff5422 random: use proper jiffies comparison m=
acro)
...
Merging mm/mm-everything (558740f4f3f0 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: fix up for "mm: change huge_ptep_clear_flush() to return the orig=
inal pte"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (72ac7819cfdc mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=wxw/
-----END PGP SIGNATURE-----
