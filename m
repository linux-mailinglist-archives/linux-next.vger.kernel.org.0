...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 93CF129679A
	for <lists+linux-next@lfdr.de>; Fri, 23 Oct 2020 01:19:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S373336AbgJVXTU (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 22 Oct 2020 19:19:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58820 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S373334AbgJVXTU (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 22 Oct 2020 19:19:20 -0400
Received: from mail-pf1-x42b.google.com (mail-pf1-x42b.google.com [IPv6:2607:f8b0:4864:20::42b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 400C9C0613CE
        for <linux-next@vger.kernel.org>; Thu, 22 Oct 2020 16:19:18 -0700 (PDT)
Received: by mail-pf1-x42b.google.com with SMTP id y14so2252146pfp.13
        for <linux-next@vger.kernel.org>; Thu, 22 Oct 2020 16:19:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=hZ5vB2Db/+tt4th24aRyAnPziOTxyBwo2viE7Ei13h4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=hZ5vB2Db/+tt4th24aRyAnPziOTxyBwo2viE7Ei13h4=;
        b=
X-Gm-Message-State: AOAM5339g4QfsweoMXD7VMgehUkv05AOBo6UBGP7qypfpyUp2sPxyzcQ
        kUpO53Eqn9elbMSzuJq1hayO3PHZ6l56dw==
X-Google-Smtp-Source: ABdhPJxjmQiMgzcB55ff4JdlPMr7CxxTg37BRQGtNqyGAG4yvCr6cAxvkhoiqBOx3I+bl2hoLz6oHA==
X-Received: by 2002:a17:90b:4b90:: with SMTP id lr16mr4688969pjb.0.1603408755576;
        Thu, 22 Oct 2020 16:19:15 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id w19sm3299596pfn.174.2020.10.22.16.19.14
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 22 Oct 2020 16:19:14 -0700 (PDT)
Message-ID: <5f921372.1c69fb81.b46a1.69f9@mx.google.com>
Date:   Thu, 22 Oct 2020 16:19:14 -0700 (PDT)
...
Subject: next/pending-fixes build: 208 builds: 7 failed, 201 passed,
 1068 errors, 360 warnings (v5.9-13195-g0281c5220c40)
...
next/pending-fixes build: 208 builds: 7 failed, 201 passed, 1068 errors, 36=
0 warnings (v5.9-13195-g0281c5220c40)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.9-13195-g0281c5220c40/

Tree: next
Branch: pending-fixes
Git Describe: v5.9-13195-g0281c5220c40
Git Commit: 0281c5220c40dd77262916430036b62e4a52e685
...
arc:
    haps_hs_smp_defconfig+kselftest (gcc-8): 165 errors, 23 warnings
...
i386:
    ...
    i386_defconfig+kselftest (gcc-8): 76 errors, 43 warnings
...
file or directory
    212  /scratch/linux/tools/testing/selftests/kselftest_harness.h:56:10: =
...
ry
    ...
    3    /scratch/linux/arch/arm/common/sa1111.c:1445:4: error: implicit de=
claration of function =E2=80=98dmabounce_unregister_dev=E2=80=99; did you m=
ean =E2=80=98device_unregister=E2=80=99? [-Werror=3Dimplicit-function-decla=
ration]
    3    /scratch/linux/arch/arm/common/sa1111.c:1436:14: error: implicit d=
eclaration of function =E2=80=98dmabounce_register_dev=E2=80=99; did you me=
an =E2=80=98device_register=E2=80=99? [-Werror=3Dimplicit-function-declarat=
ion]
...
.h: No such file or directory
    1    mach-mx21ads.c:(.init.text+0xf4): undefined reference to `mx21_clo=
cks_init'
...
e =E2=80=98DIR=E2=80=99
    1    /scratch/linux/arch/arm/mach-imx/mach-mx21ads.c:325: undefined ref=
erence to `mx21_clocks_init'
...
d [-Wcpp]
    2    /scratch/linux/drivers/usb/dwc2/platform.c:611:1: warning: label =
...
=99? [-Wimplicit-function-declaration]
    1    /tmp/ccmIfM81.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccmIfM81.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccmIfM81.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccmIfM81.s:18192: Warning: using r15 results in unpredictable beha=
viour
...
Errors:
    /scratch/linux/arch/arm/common/sa1111.c:1436:14: error: implicit declar=
ation of function =E2=80=98dmabounce_register_dev=E2=80=99; did you mean =
=E2=80=98device_register=E2=80=99? [-Werror=3Dimplicit-function-declaration]
    /scratch/linux/arch/arm/common/sa1111.c:1445:4: error: implicit declara=
tion of function =E2=80=98dmabounce_unregister_dev=E2=80=99; did you mean =
=E2=80=98device_unregister=E2=80=99? [-Werror=3Dimplicit-function-declarati=
on]
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig+kselftest (arc, gcc-8) =E2=80=94 PASS, 165 errors, 23=
...
---------------------------------------------------------------------------=
-----
i386_defconfig+kselftest (i386, gcc-8) =E2=80=94 PASS, 76 errors, 43 warnin=
...
Errors:
    mach-mx21ads.c:(.init.text+0xf4): undefined reference to `mx21_clocks_i=
nit'
...
Errors:
    /scratch/linux/arch/arm/mach-imx/mach-mx21ads.c:325: undefined referenc=
e to `mx21_clocks_init'
