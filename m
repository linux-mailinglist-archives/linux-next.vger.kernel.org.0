...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2DF7F19BBB9
	for <lists+linux-next@lfdr.de>; Thu,  2 Apr 2020 08:32:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726453AbgDBGcV (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 2 Apr 2020 02:32:21 -0400
Received: from ozlabs.org ([203.11.71.1]:50467 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726214AbgDBGcU (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 2 Apr 2020 02:32:20 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48tCsQ2mCRz9sRN;
        Thu,  2 Apr 2020 17:32:10 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1585809130;
        bh=sJt8/29+BpUhuDbwL6ez7BNBAHeOJyc/0tiwvkFeGiY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 2 Apr 2020 17:32:03 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 2
Message-ID: <20200402173203.7f4c2d73@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Dq0bz1ptep4pdeis8fbO9As";
...
Non-merge commits (relative to Linus' tree): 7027
 6251 files changed, 282385 insertions(+), 126169 deletions(-)
...
Merging origin/master (1a323ea5356e x86: get rid of 'errret' argument to __=
get_user_xyz() macross)
...
Merging net/master (d61f4d61ff7f dt-bindings: net: mvusb: Fix example error=
s)
Merging bpf/master (b9258a2cece4 slcan: Don't transmit uninitialized stack =
data in padding)
Merging ipsec/master (0141317611ab Merge branch 'hns3-fixes')
Merging netfilter/master (d61f4d61ff7f dt-bindings: net: mvusb: Fix example=
 errors)
...
Merging sound-current/for-linus (5c6cd7021a05 ALSA: usb-audio: Fix case whe=
n USB MIDI interface has more than one extra endpoint descriptor)
Merging sound-asoc-fixes/for-linus (52ac54e1de31 Merge branch 'asoc-5.7' in=
to asoc-linus)
...
I driver path)
Merging driver-core.current/driver-core-linus (1a323ea5356e x86: get rid of=
 'errret' argument to __get_user_xyz() macross)
Merging tty.current/tty-linus (1a323ea5356e x86: get rid of 'errret' argume=
nt to __get_user_xyz() macross)
Merging usb.current/usb-linus (1a323ea5356e x86: get rid of 'errret' argume=
nt to __get_user_xyz() macross)
...
ng wake-up handling)
Merging staging.current/staging-linus (1a323ea5356e x86: get rid of 'errret=
...
Merging crypto-current/master (fcb90d51c375 crypto: af_alg - bool type cosm=
etics)
...
gitignore deleted in HEAD and modified in spdx/spdx-linus. Version spdx/spd=
x-linus of tools/testing/selftests/networking/timestamping/.gitignore left =
in tree.
...
Merging kbuild/for-next (4f6d08609bb6 crypto: x86 - clean up poly1305-x86_6=
4-cryptogams.S by 'make clean')
...
t)
Merging arm64/for-next/core (15cd0e675f3f arm64: Kconfig: ptrauth: Add binu=
tils version check to fix mismatch)
...
c_slow.c)
Merging risc-v/for-next (f1e58583b9c7 RISC-V: Support cpu hotplug)
...
_notify_op_lock())
Merging cifs/for-next (c037725d043e cifs: ignore cached share root handle c=
losing errors)
...
Merging f2fs/dev (8a1ca11a95e2 f2fs: keep inline_data when compression conv=
ersion)
...
Merging xfs/for-next (d8fcb6f1346c xfs: remove redundant variable assignmen=
t in xfs_symlink())
...
le' into for-next)
Merging pci/next (505d60df2623 Merge branch 'remotes/lorenzo/pci/vmd')
...
in imxfb_probe())
Merging pm/linux-next (e2402957dd37 Merge branch 'acpi-cppc' into linux-nex=
t)
...
Merging netfilter-next/master (5a470b1a63ac Merge git://git.kernel.org/pub/=
...
Merging drm/drm-next (59e7a8cc2dcf Merge tag 'drm-msm-next-2020-03-22' of h=
ttps://gitlab.freedesktop.org/drm/msm into drm-next)
CONFLICT (content): Merge conflict in arch/arm/configs/omap2plus_defconfig
Merging amdgpu/drm-next (03eab26d6a9a drm/amdgpu/display: fix logic inversi=
...
-next)
Merging sound/for-next (5c6cd7021a05 ALSA: usb-audio: Fix case when USB MID=
I interface has more than one extra endpoint descriptor)
Merging sound-asoc/for-next (52ac54e1de31 Merge branch 'asoc-5.7' into asoc=
-linus)
Merging modules/modules-next (0f74226649fb kernel: module: Replace zero-len=
gth array with flexible-array member)
Merging input/next (c9c20ee3cfce Input: goodix - fix compilation when ACPI =
support is disabled)
...
Merging tip/auto-latest (e5ff49d1dfba Merge branch 'locking/kcsan')
CONFLICT (content): Merge conflict in arch/x86/include/asm/sighandling.h
...
gnore
Merging kvm/linux-next (32bd3422a90a KVM: SVM: Split svm_vcpu_run inline as=
sembly to separate file)
...
Merging driver-core/driver-core-next (1a323ea5356e x86: get rid of 'errret'=
 argument to __get_user_xyz() macross)
Merging usb/usb-next (1a323ea5356e x86: get rid of 'errret' argument to __g=
et_user_xyz() macross)
...
Merging tty/tty-next (1a323ea5356e x86: get rid of 'errret' argument to __g=
et_user_xyz() macross)
...
Merging staging/staging-next (1a323ea5356e x86: get rid of 'errret' argumen=
t to __get_user_xyz() macross)
...
CONFLICT (content): Merge conflict in drivers/scsi/bnx2fc/bnx2fc_hwi.c
Merging vhost/linux-next (09880f689ab3 vdpa: move to drivers/vdpa)
...
Merging gpio/for-next (33dd88826319 gpio: export of_pinctrl_get to modules)
...
build warning)
Merging rtc/rtc-next (04b3f5186e8b rtc: remove rtc_time_to_tm and rtc_tm_to=
_time)
...
Merging xarray/xarray (ba44af6f2609 XArray: Handle retry entries within xas=
_find_marked)
...
Merging akpm-current/current (588c2d2fdd18 ipc/mqueue.c: fix a brace coding=
 style issue)
CONFLICT (content): Merge conflict in arch/x86/Kconfig
...
rflow
Merging akpm/master (cd36aa879b73 drivers/media/platform/sti/delta/delta-ip=
...

=Hva2
-----END PGP SIGNATURE-----
