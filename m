...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E16754044FE
	for <lists+linux-next@lfdr.de>; Thu,  9 Sep 2021 07:30:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1350685AbhIIFbG (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 9 Sep 2021 01:31:06 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:43159 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1350735AbhIIFbG (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 9 Sep 2021 01:31:06 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1631165395;
        bh=Rkjy3i2s5+SmkvxUVOot2RHYVIm1y0xW0HwdZcUd+Bk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4H4ndG6Zpsz9sXV;
        Thu,  9 Sep 2021 15:29:54 +1000 (AEST)
Date:   Thu, 9 Sep 2021 15:29:49 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 9
Message-ID: <20210909152949.200afbb1@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Q2y6RidPJgLqjqepyNyC8wF";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/Q2y6RidPJgLqjqepyNyC8wF
...
Changes since 20210908:

The nds32 tree gained a conflict against Linus' tree.

I remerged a later version of Linus' tree to make Andrew's patch queues
shorter.

Non-merge commits (relative to Linus' tree): 1380
 1615 files changed, 83721 insertions(+), 18106 deletions(-)
...
Merging origin/master (2d338201d531 Merge branch 'akpm' (patches from Andre=
w))
...
Merging net/master (276aae377206 net: stmmac: fix system hang caused by eee=
_ctrl_timer during suspend/resume)
...
Merging staging.current/staging-linus (4b93c544e90e thunderbolt: test: spli=
t up test cases in tb_test_credit_alloc_all)
...
Merging input-current/for-linus (ab108678195f Input: mms114 - support MMS13=
4S)
...
Merging kbuild/for-next (c5360ef847fb gen_compile_commands: fix missing 'sy=
s' package)
...
Merging parisc-hd/for-next (fab8860d0a37 parisc: Mark sched_clock unstable =
only if clocks are not syncronized)
...
st_wait())
Merging cifs/for-next (2ece36473280 cifs: Move SMB2_Create definitions to t=
he shared area)
...
Merging pm/linux-next (860c843bfe92 Merge branches 'pm-cpufreq', 'pm-sleep'=
, 'pm-em' and 'acpi-scan' into linux-next)
...
Merging drm/drm-next (1645cca9da91 drm/i915: use linux/stddef.h due to "isy=
stem: trim/fixup stdarg.h and other headers")
...
Merging block/for-next (b46a2b21701b Merge branch 'io_uring-5.15' into for-=
next)
...
Merging ftrace/for-next (04178ea130a6 selftests/ftrace: Exclude "(fault)" i=
n testing add/remove eprobe events)
...
Merging staging/staging-next (4b93c544e90e thunderbolt: test: split up test=
 cases in tb_test_credit_alloc_all)
...
Merging scsi-mkp/for-next (f592ab77c9b9 scsi: ufs: ufs-pci: Fix Intel LKF l=
ink stability)
...
Merging Linus' tree again (a3fa7a101dcf Merge branches 'akpm' and 'akpm-hot=
fixes' (patches from Andrew))
Merging akpm-current/current (1ee31a7d5844 hfsplus: fix out-of-bounds warni=
ngs in __hfsplus_setxattr)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
dropping 94197328a67320082da33424cae1b6f68065170f mm/workingset: correct ke=
rnel-doc notations -- patch contents already upstream
dropping b38ef4f458015e6200020a6692d5dc5c4d6b681a scripts: check_extable: f=
ix typo in user error message -- patch contents already upstream
Merging akpm/master (2855862e49c0 mm/vmalloc: add __alloc_size attributes f=
...

=urPe
-----END PGP SIGNATURE-----
