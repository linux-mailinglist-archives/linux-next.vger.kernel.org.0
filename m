...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A895A53E0D5
	for <lists+linux-next@lfdr.de>; Mon,  6 Jun 2022 08:03:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229747AbiFFF30 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 6 Jun 2022 01:29:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50194 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229744AbiFFF25 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 6 Jun 2022 01:28:57 -0400
Received: from mail-pf1-x42c.google.com (mail-pf1-x42c.google.com [IPv6:2607:f8b0:4864:20::42c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4A45D14E2DF
        for <linux-next@vger.kernel.org>; Sun,  5 Jun 2022 22:23:41 -0700 (PDT)
Received: by mail-pf1-x42c.google.com with SMTP id u2so11870089pfc.2
        for <linux-next@vger.kernel.org>; Sun, 05 Jun 2022 22:23:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=+VhTnvVQZX/fxzSCFS0FmNwbdNQe04g3RCZNjWxs60o=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=+VhTnvVQZX/fxzSCFS0FmNwbdNQe04g3RCZNjWxs60o=;
        b=
X-Gm-Message-State: AOAM530ryYU2HJKEv12JnrPor8Vh0EFcrWAulJaqrQpnBQHQ/H4bsrXy
        HT2wInrvWRK6zxVkLyYurcS0dmz9Sj65ZW4T
X-Google-Smtp-Source: ABdhPJwU/NjDhQZUPT1uai6sr5JBLgY695/9PVYB5aCmzwm5EMCzUNihNzIsFS7RAY/XXZeCCcH2FQ==
X-Received: by 2002:a63:2c91:0:b0:3fd:3737:2803 with SMTP id s139-20020a632c91000000b003fd37372803mr11661460pgs.271.1654493019863;
        Sun, 05 Jun 2022 22:23:39 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id x17-20020a056a000bd100b0051be1b4cfb5sm5656196pfu.5.2022.06.05.22.23.36
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 05 Jun 2022 22:23:37 -0700 (PDT)
Message-ID: <629d8f59.1c69fb81.6c9fe.d12a@mx.google.com>
Date:   Sun, 05 Jun 2022 22:23:37 -0700 (PDT)
...
Subject: next/master build: 198 builds: 10 failed, 188 passed, 12 errors,
 60 warnings (next-20220606)
...
next/master build: 198 builds: 10 failed, 188 passed, 12 errors, 60 warning=
s (next-20220606)
...
Tree: next
Branch: master
Git Describe: next-20220606
Git Commit: 40b58e42584bf5bd9230481dc8946f714fb387de
...
ts+0x452: call to __ubsan_handle_load_invalid_value() with UACCESS enabled
    1    arch/x86/kvm/kvm.o: warning: objtool: emulator_cmpxchg_emulated+0x=
70a: call to __ubsan_handle_load_invalid_value() with UACCESS enabled
...
es .noinstr.text section
    arch/x86/kvm/kvm.o: warning: objtool: emulator_cmpxchg_emulated+0x70a: =
...
452: call to __ubsan_handle_load_invalid_value() with UACCESS enabled
