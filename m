...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 69ABC31C966
	for <lists+linux-next@lfdr.de>; Tue, 16 Feb 2021 12:10:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230122AbhBPLJz (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 16 Feb 2021 06:09:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36946 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230097AbhBPLIv (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 16 Feb 2021 06:08:51 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 01EE2C06174A;
        Tue, 16 Feb 2021 03:08:09 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Dfyr53phzz9sBJ;
        Tue, 16 Feb 2021 22:08:05 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1613473685;
        bh=ACToWl/mLFFXUwPjUDRS3SmvKR3JiNGUsDrlc8s8DXE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 16 Feb 2021 22:08:03 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 16
Message-ID: <20210216220803.2962447d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/JGEZDzVzdi1XABAYc8TtLgi";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/JGEZDzVzdi1XABAYc8TtLgi
...
Merging net/master (62e69bc41977 net: wan/lmc: unregister device when no ma=
tching device is found)
...
Merging cel-fixes/for-rc (0ac24c320c4d svcrdma: Hold private mutex while in=
voking rdma_accept())
...
Merging thermal/thermal/linux-next (ca66dca5eda6 thermal: qcom: add support=
 for adc-tm5 PMIC thermal monitor)
...
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/toshiba/tmpv7708-=
rm-mbrc.dts
Merging bpf-next/for-next (45159b27637b bpf: Clear subreg_def for global fu=
nction return values)
...
d variable)
Merging block/for-next (9f40d53a08d3 Merge branch 'for-5.12/io_uring' into =
for-next)
CONFLICT (content): Merge conflict in lib/iov_iter.c
...
Merging nvdimm/libnvdimm-for-next (2afffa101f07 cxl/mem: Remove redundant i=
nitialization of variable rc)
...
Merging akpm/master (fa58486ff542 MIPS: make userspace mapping young by def=
ault)
...

=y26P
-----END PGP SIGNATURE-----
