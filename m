...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 420DB3EB30D
	for <lists+linux-next@lfdr.de>; Fri, 13 Aug 2021 10:59:30 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235413AbhHMI7y (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 13 Aug 2021 04:59:54 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46164 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231582AbhHMI7x (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 13 Aug 2021 04:59:53 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C0089C061756;
        Fri, 13 Aug 2021 01:59:26 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GmHYR0Rh1z9sRK;
        Fri, 13 Aug 2021 18:59:23 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1628845163;
        bh=bh4iF74H0wCAZS/YU7nDSBYhyTBAS0PNMmrU0UT1qco=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 13 Aug 2021 18:59:22 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 13
Message-ID: <20210813185922.44de6d4e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/VkZM+g8rBLAfCTMLL+mhnj.";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/VkZM+g8rBLAfCTMLL+mhnj.
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210812:

The net-next tree gained a conflict against the net tree and still had
its build failure for which I applied a patch.

The irqchip tree gained a conflict against the tip tree.

The rcu tree gained a conflict against the irqchip tree.

Non-merge commits (relative to Linus' tree): 7121
 7079 files changed, 402441 insertions(+), 158618 deletions(-)
...
Merging origin/master (f8fbb47c6e86 Merge branch 'for-v5.14' of git://git.k=
...
Merging net/master (a9a507013a6f Merge tag 'ieee802154-for-davem-2021-08-12=
...
Merging sound-asoc-fixes/for-linus (66479edf46aa Merge remote-tracking bran=
...
Merging asm-generic/master (fc062ad8e406 asm-generic: ffs: Drop bogus refer=
ence to ffz location)
...
Merging tegra/for-next (2138510cb6e1 Merge branch for-5.15/arm64/dt into fo=
r-next)
...
Merging clk-renesas/renesas-clk (a2c45a0d3772 clk: renesas: Make CLK_R9A06G=
032 invisible)
...
iver)
Merging risc-v/for-next (fe45ffa4c505 riscv: Move early fdt mapping creatio=
n in its own function)
...
Merging cifs/for-next (7ad998234c23 cifs: avoid signed integer overflow in =
calculating blocks)
...
Merging dmi/dmi-for-next (3cb4d29a2633 MAINTAINERS: The DMI/SMBIOS tree has=
 moved)
Merging hwmon-staging/hwmon-next (84fdde0385d4 hwmon: (pmbus/bpa-rs600) Add=
 workaround for incorrect Pin max)
...
terface for uverbs)
Merging net-next/master (b769cf44ed55 dt-bindings: net: qcom,ipa: make imem=
...
tifier support (v2))
Merging drm-intel/for-linux-next (8b46cc6577f4 drm/i915: Tweaked Wa_1401068=
5332 for all PCHs)
...
Merging sound-asoc/for-next (98ed18e10de5 Merge remote-tracking branch 'aso=
...
Merging block/for-next (f433e4b10235 Merge branch 'io_uring-bio-cache.5' in=
to for-next)
...
15' into spi-next)
Merging tip/auto-latest (607a4143d9a4 Merge branch 'x86/urgent')
...
Merging irqchip/irq/irqchip-next (3725280b5dcb Merge branch irq/gic-strict-=
flow into irq/irqchip-next)
...
Merging rcu/rcu/next (4e32644d45e0 rcu-tasks: Move RTGS_WAIT_CBS to beginni=
...
-hotplug functions.)
Merging drivers-x86/for-next (636a1e697555 platform/x86: add meraki-mx100 p=
latform driver)
...
Merging iio/togreg (94a853eca720 counter: 104-quad-8: Describe member 'lock=
' in 'quad8')
...
atform data)
Merging pinctrl/for-next (1f3ab079db2f Merge branch 'devel' into for-next)
...
Merging folio/for-next (02f07e4b10d3 mm/writeback: Add folio_write_one)
CONFLICT (content): Merge conflict in mm/util.c
CONFLICT (content): Merge conflict in mm/rmap.c
CONFLICT (content): Merge conflict in mm/filemap.c
Merging akpm-current/current (b0a47f3b3a68 ipc: replace costly bailout chec=
...
Merging akpm/master (0bcf3a704d57 arch: remove compat_alloc_user_space)
...

=RKl8
-----END PGP SIGNATURE-----
