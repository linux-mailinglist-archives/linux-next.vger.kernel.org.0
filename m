...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 76D3F11383F
	for <lists+linux-next@lfdr.de>; Thu,  5 Dec 2019 00:33:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728053AbfLDXdM (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 4 Dec 2019 18:33:12 -0500
Received: from mail-wr1-f65.google.com ([209.85.221.65]:40034 "EHLO
        mail-wr1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727989AbfLDXdM (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 4 Dec 2019 18:33:12 -0500
Received: by mail-wr1-f65.google.com with SMTP id c14so1247168wrn.7
        for <linux-next@vger.kernel.org>; Wed, 04 Dec 2019 15:33:06 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=DzKMwtIswkFsWKE4+EiZvIUCh1G8re3ecEf9AMyj1tY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=DzKMwtIswkFsWKE4+EiZvIUCh1G8re3ecEf9AMyj1tY=;
        b=
X-Gm-Message-State: APjAAAVQVBQgg/TjtmykAX8pwONDM9RSzMKJh+aLf5lvm0WLQpdXON1I
        8lA7EC/rq3LhCBk6rflnXLdyapHLki0=
X-Google-Smtp-Source: APXvYqx0zzKPnB5BdgL47MubvudS6jGfi1iIOF5Wk4T+DRcbMvpLq5Px4FlJ0g0I7Uyv6VR2Ly6nSQ==
X-Received: by 2002:adf:d850:: with SMTP id k16mr6419515wrl.96.1575502384104;
        Wed, 04 Dec 2019 15:33:04 -0800 (PST)
Received: from [148.251.42.114] ([2a01:4f8:201:9271::2])
        by smtp.gmail.com with ESMTPSA id w22sm8500688wmk.34.2019.12.04.15.33.02
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 04 Dec 2019 15:33:03 -0800 (PST)
Message-ID: <5de8422f.1c69fb81.cd5fe.b022@mx.google.com>
Date:   Wed, 04 Dec 2019 15:33:03 -0800 (PST)
...
Subject: next/pending-fixes build: 217 builds: 2 failed, 215 passed, 5 errors,
 93 warnings (v5.4-11853-gdfc133a6fea9)
...
next/pending-fixes build: 217 builds: 2 failed, 215 passed, 5 errors, 93 wa=
rnings (v5.4-11853-gdfc133a6fea9)
...
m integer of different size [-Wint-to-pointer-cast]
    6    fs/btrfs/tree-checker.c:230:43: warning: format =E2=80=98%lu=E2=80=
...
=98short unsigned int=E2=80=99} changes value from =E2=80=98327680=E2=80=99=
 to =E2=80=980=E2=80=99 [-Woverflow]
    1    include/linux/kernel.h:835:29: warning: comparison of distinct poi=
...
integer of different size [-Wpointer-to-int-cast]
    1    /tmp/ccXH0Lya.s:18191: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccXH0Lya.s:18119: Warning: using r15 results in unpredictable=
 behaviour
    1    .config:1141:warning: override: UNWINDER_GUESS changes choice state
...
rence from the function free_memmap() to the function .meminit.text:membloc=
k_free()
    1    WARNING: vmlinux.o(.text.unlikely+0x38ec): Section mismatch in ref=
erence from the function pmax_setup_memory_region() to the function .init.t=
ext:add_memory_region()
    1    WARNING: vmlinux.o(.text.unlikely+0x35dc): Section mismatch in ref=
erence from the function pmax_setup_memory_region() to the function .init.t=
ext:add_memory_region()
...
types lacks a cast
    /tmp/ccXH0Lya.s:18119: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccXH0Lya.s:18191: Warning: using r15 results in unpredictable beha=
viour
    fs/btrfs/tree-checker.c:230:43: warning: format =E2=80=98%lu=E2=80=99 e=
xpects argument of type =E2=80=98long unsigned int=E2=80=99, but argument 5=
 has type =E2=80=98unsigned int=E2=80=99 [-Wformat=3D]
...
Section mismatches:
    WARNING: vmlinux.o(.text.unlikely+0x38ec): Section mismatch in referenc=
...
Section mismatches:
    WARNING: vmlinux.o(.text.unlikely+0x35dc): Section mismatch in referenc=
e from the function pmax_setup_memory_region() to the function .init.text:a=
dd_memory_region()
...
Warnings:
    .config:1141:warning: override: UNWINDER_GUESS changes choice state
