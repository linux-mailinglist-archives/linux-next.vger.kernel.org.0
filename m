...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1ECE6325BD3
	for <lists+linux-next@lfdr.de>; Fri, 26 Feb 2021 04:06:25 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229491AbhBZDGX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 25 Feb 2021 22:06:23 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46516 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229460AbhBZDGW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 25 Feb 2021 22:06:22 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9E787C061574;
        Thu, 25 Feb 2021 19:05:41 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Dmvfp1MmRz9sTD;
        Fri, 26 Feb 2021 14:05:38 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1614308738;
        bh=6MClDGmb6ffVncUyedPmFOLOx8Xc38wzjynWfIE06TU=;
        h=Date:From:To:Cc:Subject:From;
        b=
...
Message-ID: <20210226140537.6420b3bc@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/KU2X=Qk3+q.1dgzDkNfrQKX";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/KU2X=Qk3+q.1dgzDkNfrQKX
...
Merging origin/master (2c87f7a38f93 Merge tag 'pwm/for-5.12-rc1' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/thierry.reding/linux-pwm)
Merging fixes/fixes (e71ba9452f0b Linux 5.11-rc2)
Merging kbuild-current/fixes (a95d33c81987 kbuild: lto: add _mcount to list=
 of used symbols)
...
Merging sparc/master (062c84fccc44 Merge tag 'rproc-v5.12' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/andersson/remoteproc)
Merging fscrypt-current/for-stable (d19d8d345eec fscrypt: fix inline encryp=
tion not used on new files)
Merging net/master (6cf739131a15 r8169: fix jumbo packet handling on RTL816=
8e)
...
Merging sound-current/for-linus (c88fb897c1fb ALSA: n64: Fix return value c=
heck in n64audio_probe())
...
Merging driver-core.current/driver-core-linus (29c395c77a9a Merge tag 'x86-=
entry-2021-02-24' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging tty.current/tty-linus (29c395c77a9a Merge tag 'x86-entry-2021-02-24=
' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging usb.current/usb-linus (29c395c77a9a Merge tag 'x86-entry-2021-02-24=
' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
BLE())
Merging staging.current/staging-linus (29c395c77a9a Merge tag 'x86-entry-20=
21-02-24' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging char-misc.current/char-misc-linus (29c395c77a9a Merge tag 'x86-entr=
y-2021-02-24' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
Merging cel-fixes/for-rc (135d48d516bd nfsd: don't abort copies early)
...
b is used)
Merging cifs/for-next (eb5d480d5b0c cifs: update internal version number)
...
enet-updates')
Merging bluetooth/master (d310ec03a34e Merge tag 'perf-core-2021-02-17' of =
git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
Merging drm-misc/for-linux-next (d922d58fedcd drm/panel: kd35t133: allow us=
ing non-continuous dsi clock)
Merging amdgpu/drm-next (0de5c1dcd380 drm/amdgpu: always reset the asic in =
suspend)
...
Merging sound/for-next (c88fb897c1fb ALSA: n64: Fix return value check in n=
64audio_probe())
...
Merging block/for-next (c1943df0832f Merge branch 'io_uring-worker.v3' into=
 for-next)
...
s block write)
Merging driver-core/driver-core-next (29c395c77a9a Merge tag 'x86-entry-202=
1-02-24' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging usb/usb-next (29c395c77a9a Merge tag 'x86-entry-2021-02-24' of git:=
...
Merging tty/tty-next (29c395c77a9a Merge tag 'x86-entry-2021-02-24' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging char-misc/char-misc-next (29c395c77a9a Merge tag 'x86-entry-2021-02=
-24' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging extcon/extcon-next (bb512233bffe extcon: qcom-spmi: Add support for=
 VBUS detection)
...
Merging staging/staging-next (29c395c77a9a Merge tag 'x86-entry-2021-02-24'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
Merging oprofile-removal/oprofile/removal (be65de6b03aa fs: Remove dcookies=
 support)
Merging akpm-current/current (2e862ce7025b initramfs-panic-with-memory-info=
rmation-fix)
CONFLICT (content): Merge conflict in include/linux/pagemap.h
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (10fdfd2ba5d8 MIPS: make userspace mapping young by def=
ault)
...

=8XgB
-----END PGP SIGNATURE-----
