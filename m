Return-Path: <linux-next+bounces-5634-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A066A4D92F
	for <lists+linux-next@lfdr.de>; Tue,  4 Mar 2025 10:49:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 896043B3ADC
	for <lists+linux-next@lfdr.de>; Tue,  4 Mar 2025 09:42:57 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 584A21F666B;
	Tue,  4 Mar 2025 09:42:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="DOOZe7Zt"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A68D21FAC56;
	Tue,  4 Mar 2025 09:42:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1741081353; cv=none; b=BClbqftrIuVsxl4mW+x3pG70Nh5Ub5HVTeNHMkDkhf/R1fz1yVDL7oCtL752IGsbYtfciS+i6QWl4fFtsfglWFVI8dHUBy+anjOkCctiGT+ll8gOSuL5ZNE4uxXo/MFb6MyKY5W98uHLfNEHl4DDSvAAVaxC8KH9gaJgSh6hCSA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1741081353; c=relaxed/simple;
	bh=OpPn4at2yeyap9MeUr96PYJ4B/LBgGFj6XnetFp7YCw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=L01QCucQCIPRczIsaCVp3xpC4rVrmBvUbx8EHci5pbkr+L4R/yn9qoRGi4x2KSc5lZBjo4gMVLOxpoTY+ixJhaOsg4qv58aQ/Req90WCiXj+/GquUBqHRKgzvzxKt3PCjOfqOm3EWTzj7lnRXCJq3vnkUF6rEiHz0zXgEqvlTB4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=DOOZe7Zt; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1741081345;
	bh=u5iWzwQsJbwzoEaU1c3n+JJzwkC9mGG3YV/xLOgobZs=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Z6W1Y25LMz4wcQ;
	Tue,  4 Mar 2025 20:42:25 +1100 (AEDT)
Date: Tue, 4 Mar 2025 20:42:23 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 4
Message-ID: <20250304204223.40be57b2@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/mndwXepn55bg5P.uhIgGSP1";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/mndwXepn55bg5P.uhIgGSP1
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250303:
...
Non-merge commits (relative to Linus' tree): 7139
 7675 files changed, 386119 insertions(+), 157502 deletions(-)
...
Merging origin/master (99fa936e8e4f Merge tag 'affs-6.14-rc5-tag' of git://=
...
Merging fuse/for-next (6e010028d3ff fuse: add kernel-enforced timeout optio=
n for requests)
Merging gfs2/for-next (8094523d7304 gfs2: remove redundant warnings)
...
Merging fs-current (92267d78925a Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (64e6a754d33d llc: do not use skb_get() before dev_queue_x=
mit())
...
())
Merging wireless/for-next (59b348be7597 wifi: cfg80211: regulatory: improve=
 invalid hints checking)
...
Merging sound-current/for-linus (172a0f509723 ALSA: usx2y: validate nrpacks=
 module parameter on probe)
...
Merging usb.current/usb-linus (2b66ef84d0d2 usb: hub: lack of clearing xHC =
resources)
...
Merging tip-fixes/tip/urgent (8d5c67b7541b Merge branch into tip/master: 'x=
86/urgent')
...
Merging perf/perf-tools-next (7788ad59d1d9 perf tools: Skip BPF sideband ev=
ent for userspace profiling)
...
econdary flash name)
Merging at91/at91-next (1ca46cf9849f Merge branch 'at91-dt' into at91-next)
...
Merging rockchip/for-next (178ddc375dbe Merge branch 'v6.14-armsoc/dtsfixes=
' into for-next)
Merging samsung-krzk/for-next (e57b17c06ae5 Merge branch 'next/clk' into fo=
r-next)
Merging scmi/for-linux-next (83d0167ddb6f Merge branches 'for-next/juno/upd=
ates', 'for-next/scmi/updates', 'for-next/ffa/updates' and 'for-next/smccc/=
updates' of ssh://gitolite.kernel.org/pub/scm/linux/kernel/git/sudeep.holla=
/linux into for-linux-next)
...
Merging fs-next (ef4e952a3d40 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (9022df7f5e05 Merge branch 'for-6.14-cpu_sync-fixup=
' into for-next)
Merging pci/next (12c8c1363538 Merge branch 'pci/misc')
...
Merging v4l-dvb/next (f4b211714bcc media: venus: hfi: add a check to handle=
 OOB in sfr region)
Merging v4l-dvb-next/master (b36c41c51e9d media: atomisp: set lock before c=
alling vb2_queue_init())
Merging pm/linux-next (278069a44621 Merge branch 'thermal-misc' into linux-=
next)
...
for-next)
Merging net-next/main (3424291dd242 Merge branch 'ipv4-fib-convert-rtm_newr=
oute-and-rtm_delroute-to-per-netns-rtnl')
CONFLICT (content): Merge conflict in fs/eventpoll.c
Merging bpf-next/for-next (8067411f65c9 Merge branch 'bpf-next/master' into=
 for-next)
...
Merging mtd/mtd/next (3f930a52d715 mtd: capture device name setting failure=
 when adding mtd)
Merging nand/nand/next (288573e43712 mtd: rawnand: brcmnand: fix PM resume =
warning)
$ git reset --hard HEAD^
Merging next-20250303 version of nand
...
ary checking)
Merging drm-misc/for-linux-next (95a5c9d197bb drm/rockchip: vop2: add missi=
ng bitfield.h include)
...
ssing property)
Merging block/for-next (e8ae507e94a9 Merge branch 'for-6.15/io_uring-rx-zc'=
 into for-next)
...
15' into spi-next)
Merging tip/master (59907b1daf14 Merge branch into tip/master: 'x86/cpu')
...
CONFLICT (content): Merge conflict in drivers/mailbox/mailbox.c
CONFLICT (content): Merge conflict in net/core/dev.c
[master 57e5244c368b] next-20250303/tip
...
next)
Merging sched-ext/for-next (a01e053b05c1 Merge branch 'for-6.15' into for-n=
ext)
...
omem)
Merging gpio-brgl/gpio/for-next (9778568dede2 gpiolib: update kerneldocs fo=
r value setters)
...
IPTION() macro)
Merging kspp/for-next/kspp (19664681692a Merge branch 'for-next/hardening' =
into for-next/kspp)
...

=qtzy
-----END PGP SIGNATURE-----
