...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 588592A5DFE
	for <lists+linux-next@lfdr.de>; Wed,  4 Nov 2020 07:01:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725825AbgKDGBq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 4 Nov 2020 01:01:46 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51022 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725535AbgKDGBq (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 4 Nov 2020 01:01:46 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3E2D5C061A4D;
        Tue,  3 Nov 2020 22:01:45 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CQwyY5Xx9z9sPB;
        Wed,  4 Nov 2020 17:01:41 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1604469701;
        bh=5h/ABbgHB1xBvSdFR5fe+KDRW1xHEXi45dMKpnY64cE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 4 Nov 2020 17:01:38 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 4
Message-ID: <20201104170138.21f5f9b0@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/IYs9rHFcWkhfn.1x04OTmZo";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/IYs9rHFcWkhfn.1x04OTmZo
...
The drm-intel-fixes tree gained a build failure for which I reverted a comm=
it.
...
Merging sound-current/for-linus (ef9ce66fab95 ALSA: hda/realtek - Enable he=
adphone for ASUS TM420)
Merging sound-asoc-fixes/for-linus (15961bc475e0 Merge remote-tracking bran=
...
Merging char-misc.current/char-misc-linus (bcbc0b2e275f mei: protect mei_cl=
_mtu from null dereference)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (45a83eaa7e6c drm/i915: Hold o=
...
Merging erofs-fixes/fixes (89210981f374 erofs: fix setting up pcluster for =
temporary pages)
...
n build errors)
Merging drm-misc-fixes/for-linux-next-fixes (077aa5c8dd6e drm/vc4: drv: Rem=
ove unused variable)
Applying: Revert "drm/i915/gt: Flush xcs before tgl breadcrumbs"
...
Merging btrfs/for-next (95949eafec5c Merge branch 'for-next-next-v5.10-2020=
1103' into for-next-20201103)
...
able)
Merging net-next/master (626d667b1960 vxlan: Use a per-namespace nexthop li=
stener instead of a global one)
...
ice.c
Merging drm-intel/for-linux-next (0e8e272f1368 drm/i915/ehl: Remove invalid=
 PCI ID)
...
Merging drm-misc/for-linux-next (d74252bb8f0e drm: Use the state pointer di=
rectly in atomic_check)
...
Merging sound-asoc/for-next (f1c4a6b37cdd Merge remote-tracking branch 'aso=
...
ouch input driver)
Merging block/for-next (a8ad22992051 Merge branch 'tif-task_work.arch' into=
 for-next)
...
Merging coresight/next (457c731a901e coresight: Remove unnecessary THIS_MOD=
ULE of funnel and replicator driver)
...
Merging akpm/master (abbb4879a620 mm/gup: assert that the mmap lock is held=
 in __get_user_pages())
...

=Oq72
-----END PGP SIGNATURE-----
