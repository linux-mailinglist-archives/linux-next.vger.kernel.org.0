Return-Path: <linux-next+bounces-1212-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 07B07859BAB
	for <lists+linux-next@lfdr.de>; Mon, 19 Feb 2024 06:25:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 3EAE6B20B04
	for <lists+linux-next@lfdr.de>; Mon, 19 Feb 2024 05:25:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 855511CD15;
	Mon, 19 Feb 2024 05:25:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="kQXpqdP3"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A12518BEF;
	Mon, 19 Feb 2024 05:25:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708320312; cv=none; b=MbgzQRkt8D2M3jhMV/snJ8CM5egZH3kh79oz52xbMlPyAKL+pwTiP+v3P5lhOnRhrTc2tIOV4RoUuG9IwryKjmhSxX7/8g6C/2ZCQ9ipaOVjBVc2NX1SGNhnOSrYf49E5zkQ3pojUF6gV11YhUplVPJJO27rVcp04XCJ5IuVh8c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708320312; c=relaxed/simple;
	bh=qPiGD6L9NiGwr/zGMVc+rDDQ0vbsUi0K/BfadpOGYLo=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=HRzSwxFgsTtfxSCRyfdJLminCA4muCBLz8OnmXhEhPtTC0sFo0i89kkR77/fYtSazOWkA5mHur5cZg1EoZ46X1lPCQf28xU48FgeqJFf146Rq/t0QPK25NGpf/YFhr2a3JLLtBJqizJGRNFFdI8Aak8iNFIlQ19WCHn0379W2UU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=kQXpqdP3; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1708320306;
	bh=b6+Kj75WsARk+a/nvMkv7OVh3EDLO2ZIippFZOs2n9s=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TdWFZ48czz4wcw;
	Mon, 19 Feb 2024 16:25:06 +1100 (AEDT)
Date: Mon, 19 Feb 2024 16:25:05 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 19
Message-ID: <20240219162505.5007c075@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/6nsqun3O9HehCjnVmAIwq1M";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/6nsqun3O9HehCjnVmAIwq1M
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240216:

The cxl-fixes tree gained a conflict against Linus' tree.

The vfs-brauner tree gained a semantic conflict against the nfsd tree.

The kvm-arm tree gained a conflict against the arm64 tree.

The iio tree gained a conflict against Linus' tree.

Tthe phy-next tree gained a conflict against the phy tree.

Non-merge commits (relative to Linus' tree): 7225
 7041 files changed, 328271 insertions(+), 136833 deletions(-)
...
Merging kbuild-current/fixes (a951884d8288 kallsyms: ignore ARMv4 thunks al=
ong with others)
...
Merging net/main (ee710bbcad48 Merge branch 'bcmasp-fixes')
Merging bpf/master (54d46c9f581d Merge branch 'fix-the-read-of-vsyscall-pag=
e-through-bpf')
Merging ipsec/master (983a73da1f99 xfrm: Pass UDP encapsulation in TX packe=
t offload)
Merging netfilter/main (84443741faab netfilter: nf_tables: fix bidirectiona=
l offload regression)
...
error flow)
Merging sound-current/for-linus (41c25e193b2b ALSA: usb-audio: More relaxed=
 check of MIDI jack names)
...
Merging driver-core.current/driver-core-linus (c02197fc9076 Merge tag 'powe=
rpc-6.8-3' of git://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging tty.current/tty-linus (c02197fc9076 Merge tag 'powerpc-6.8-3' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging usb.current/usb-linus (c02197fc9076 Merge tag 'powerpc-6.8-3' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
...
Applying: Revert "cxl/cper: Fix errant CPER prints for CXL events"
Merging cxl-fixes/fixes (6cb604ed24a1 acpi/ghes: Remove CXL CPER notificati=
ons)
...
ore is builtin)
Merging drm-fixes/drm-fixes (ea69f782d0e3 Merge tag 'drm-msm-fixes-2024-02-=
15' of https://gitlab.freedesktop.org/drm/msm into drm-fixes)
...
Merging drm-misc-fixes/for-linux-next-fixes (65323796debe drm/nouveau/mmu/r=
535: uninitialized variable in r535_bar_new_())
...
Merging kbuild/for-next (ccc8c4a3df25 kconfig: use generic macros to implem=
ent symbol hashtable)
...
or-next)
Merging arm64/for-next/core (11a1b3cc50df Merge branch 'for-next/stage1-lpa=
...
r-next)
Merging mediatek/for-next (5b6df373ec95 arm64: dts: mediatek: Replace depre=
cated extcon-usb-gpio id-gpio/vbus-gpio properties)
...
Merging parisc-hd/for-next (3721ccda3cbf parisc: Fix stack unwinder)
...
cond argument)
Merging bcachefs/for-next (c843b6b867f6 thread_with_file: add f_ops.flush)
...
Merging i3c/i3c/next (10201396ef64 i3c: dw: Disable IBI IRQ depends on hot-=
join and SIR enabling)
...
Merging pm/linux-next (833dbcc88dd9 Merge branches 'acpi-property', 'acpi-r=
esource' and 'acpi-processor' into linux-next)
...
Merging net-next/main (78e886ba2b54 net: ena: Remove ena_select_queue)
...
Merging wireless-next/for-next (e1ea6db35fc3 wifi: brcmsmac: avoid function=
 pointer casts)
...
Merging drm-misc/for-linux-next (239cce651ea6 drm/panel: ltk500hd1829: add =
panel type for ltk101b4029w)
Applying: drm/ttm: initialise places
Merging amdgpu/drm-next (2bb2ad58f6b7 drm/amd: Change `jpeg_v4_0_5_start_dp=
g_mode()` to void)
  10cd2bf92b4c ("drm/amd/display: Fix possible NULL dereference on device r=
emove/driver unload")
  172781696176 ("drm/amdkfd: Fix L2 cache size reporting in GFX9.4.3")
  194bef0cc1f5 ("Revert "drm/amd/display: increased min_dcfclk_mhz and min_=
fclk_mhz"")
  ...
  5869b32bbeb7 ("drm/amdkfd: update SIMD distribution algo for GFXIP 9.4.2 =
onwards")
  615fb058726d ("drm/amdgpu/display: Initialize gamma correction mode varia=
ble in dcn30_get_gamcor_current()")
  616b39467e81 ("drm/amd/display: fixed integer types and null check locati=
ons")
  79f3e38f60e5 ("drm/amd/display: Preserve original aspect ratio in create =
stream")
  8abf2636f68c ("drm/amd/display: Initialize 'wait_time_microsec' variable =
in link_dp_training_dpia.c")
  9ab1a996dc7f ("drm/amd/display: Fix possible buffer overflow in 'find_dcf=
clk_for_voltage()'")
  a8edc9cc0b14 ("drm/amd/display: Fix array-index-out-of-bounds in dcn35_cl=
kmgr")
  bbaf9ed33965 ("drm/amd/display: Fix possible use of uninitialized 'max_ch=
unks_fbc_mode' in 'calculate_bandwidth()'")
...
"")
  ...
  fc2d4230e50b ("drm/amdgpu/soc21: update VCN 4 max HEVC encoding resolutio=
n")
...
Merging sound/for-next (ba00e413fa15 ALSA: virtio: Fix "Coverity: virtsnd_k=
ctl_tlv_op(): Uninitialized variables" warning.)
...
Merging block/for-next (8a717f2af0ee Merge branch 'for-6.9/block' into for-=
next)
...
Merging regulator/for-next (536049ddc7dc Merge remote-tracking branch 'regu=
...
upport for mt8188)
Merging spi/for-next (0f99484fc9d2 Merge remote-tracking branch 'spi/for-6.=
9' into spi-next)
Merging tip/master (e302d127a333 Merge branch into tip/master: 'x86/vdso')
...
Merging kvm-arm/next (7ee13cb72c70 Merge branch kvm-arm64/feat_e2h0 into kv=
marm/next)
...
tricted types)
Merging kvm-x86/next (c0f8b0752b09 Merge branches 'asyncpf', 'asyncpf_abi',=
 'fixes', 'generic', 'misc', 'mmu', 'pmu', 'svm' and 'vmx')
...
Merging driver-core/driver-core-next (5c0941c55e5f kobject: reduce uevent_s=
ock_mutex scope)
  5df9197edd73 ("workqueue: make wq_subsys const")
Merging usb/usb-next (cf92b9df3dcf usb: typec: qcom-pmic-typec: add support=
 for PMI632 PMIC)
  7ad818eef647 ("arm64: dts: qcom: qcm6490-fairphone-fp5: Add PMIC GLINK")
...
Merging tty/tty-next (548fcf037b3f tty: Don't include tty_buffer.h in tty.h)
...
Merging iio/togreg (650e23991a5b iio: adc: ti-ads1298: Add driver)
...
Merging gpio-brgl/gpio/for-next (4a92857d6e83 gpio: constify opaque pointer=
 "data" in gpio_device_find())
...
Merging pwm/pwm/for-next (191fba33d814 pwm: Ensure that pwm_chips are alloc=
...
Merging landlock/next (b97ef9cef4f0 landlock: Document IOCTL support)
...
Merging kspp/for-next/kspp (88224081a5cb cocci: Add rules to find str_plura=
l() replacements)
...

=RR/v
-----END PGP SIGNATURE-----
