Return-Path: <linux-next+bounces-3933-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 0A82A97D09A
	for <lists+linux-next@lfdr.de>; Fri, 20 Sep 2024 06:33:15 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id B56D9286FC7
	for <lists+linux-next@lfdr.de>; Fri, 20 Sep 2024 04:33:13 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5785922309;
	Fri, 20 Sep 2024 04:33:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="N3gKGlRn"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id ECE5879C2;
	Fri, 20 Sep 2024 04:33:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1726806791; cv=none; b=WsjR91cA8Frjdr/Mv0lyjo5fnt7rr+T2GkDqAg+9oF+TtnwQYDKrPfzjA3N6FcERj6gptLF4bXiotkLZ4JrkviWB5Mi3Sk/I/eSH3waI8lLO9MbGMQl7ZQ3JkyOl9BU/WJT1x+Bq85Idp5VGVFGfZlBwDuuIwzYZfo3ADE/+ZUk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1726806791; c=relaxed/simple;
	bh=pjrK2ZWhLwT/Ux9HkNxTjrT1vrvS6mEMwUCrlLbJJao=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=La1tlTvkizaWFQpRMZ2GpcJQizNTeU8RXMtt7OfbtV+llCro32bk6iLNuMMerRP3H2yqFgfKus3VtUeY6ILUioPlJTW3A9RD8uacAYjtIju3Ze0jwr6z/Q7YTEU1vdMeY8yU1sn5rj6AtPDBB5JPCb/GsJpDIsuvqMgK6632d3c=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=N3gKGlRn; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1726806783;
	bh=FAlKVyBhORFkl9W5nA1kbcpuNXrXPAyVQN/fytl4AWk=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4X8zyl46Jtz4wj1;
	Fri, 20 Sep 2024 14:33:03 +1000 (AEST)
Date: Fri, 20 Sep 2024 14:33:03 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 20
Message-ID: <20240920143303.22c7bae4@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/czNczaK6WQHVYlq2vdsQ5vf";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/czNczaK6WQHVYlq2vdsQ5vf
...
Non-merge commits (relative to Linus' tree): 4468
 4610 files changed, 189259 insertions(+), 73993 deletions(-)
...
Merging origin/master (2004cef11ea0 Merge tag 'sched-core-2024-09-19' of gi=
t://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging fixes/fixes (76ce9f3bd4c4 mm: fix PHYSMEM_END build error on m68k)
...
ph_dns_resolve_name())
Merging cifs/for-next (46be8b08f9f6 cifs: update internal version number)
...
n ea_buffer)
Merging ksmbd/ksmbd-for-next (4e0373f1f920 Merge tag 'v6.12-rc-smb3-client-=
fixes-part1' of git://git.samba.org/sfrench/cifs-2.6)
...
Merging fs-current (c2999f391166 Merge branch 'fixes' of git://git.kernel.o=
...
figs for v6.11-rc1)
Merging powerpc-fixes/fixes (3a7101e9b27f Merge tag 'powerpc-6.12-1' of git=
...
Merging net/main (b5109b60ee4f net: seeq: Fix use after free vulnerability =
...
Merging sound-current/for-linus (49f5ee951f11 ALSA: hda/tas2781: Add new qu=
irk for Lenovo Y990 Laptop)
Merging sound-asoc-fixes/for-linus (8ffecb09fb98 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (973a78f9a6fa Merge remote-tracking branch 'spi=
...
xt)
Merging clk/clk-next (497f7c30f184 Merge branch 'clk-qcom' into clk-next)
...
Merging fs-next (223f4a5a09aa Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
eback on SM6350)
Merging drm-xe/drm-xe-next (dc0dce6d63d2 drm/xe: Use helper for ASID -> VM =
in GPU faults and access counters)
...
f tracepoints event)
Merging sound-asoc/for-next (8ffecb09fb98 Merge remote-tracking branch 'aso=
...
Merging block/for-next (7f6e32a7646f Merge branch 'for-6.12/block' into for=
-next)
...
Merging spi/for-next (973a78f9a6fa Merge remote-tracking branch 'spi/for-6.=
11' into spi-linus)
...

=g6LJ
-----END PGP SIGNATURE-----
