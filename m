Return-Path: <linux-next+bounces-1194-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D8CB8573FB
	for <lists+linux-next@lfdr.de>; Fri, 16 Feb 2024 04:32:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id A6F851F22F29
	for <lists+linux-next@lfdr.de>; Fri, 16 Feb 2024 03:32:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B4C64101C4;
	Fri, 16 Feb 2024 03:32:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="pmKEoQ4P"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C49F6DF58;
	Fri, 16 Feb 2024 03:32:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708054340; cv=none; b=bkhTMPc8DCD/qskgvcvegyTMfy1U1QAMwz5G+HSdGkpd9TCkyU8QUBcbgcEkOwDZVQRRxARahUQEcyEt/oCwk28eQMab80pMdhFFzKeJ/VuaR3f6lJfOq7/F90hh0oJbRyTof4L+J9nEEUrBG4To+fQv5cOOdVU3b6vM3T+p93c=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708054340; c=relaxed/simple;
	bh=mIxdQqDE9S7LkxTj60IlDdLrqFyeAkYE9GSg+RvCofk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=akOJhn0YC915Na5zyYliZrD1VIC3d/iWebA4L3a3Ms1x35npFQILZgmlofFbaHnhIp2YJSftCB5BuSntwJIatXGufU3NXopkPmNdQPJzYpHWlmjoJY1QUh2DkNZOpS+Vo1bYWhsIJOov504vm8N2g7rKJkv0Wv3tjnbV6GOnsmk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=pmKEoQ4P; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1708054333;
	bh=Wtbu9EQIOCT6iEquxM96K3KhcXGqcbdbp8ndSbOTzIU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Tbctj3TBNz4wys;
	Fri, 16 Feb 2024 14:32:13 +1100 (AEDT)
Date: Fri, 16 Feb 2024 14:32:11 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 16
Message-ID: <20240216143211.4e64f3a0@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dV1iCyYpEG9M3dE7xSNkFH.";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/dV1iCyYpEG9M3dE7xSNkFH.
...
Merging origin/master (4f5e5092fdbf Merge tag 'net-6.8-rc5' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/netdev/net)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (3004524ad6c5 mm/damon/sysfs-schem=
...
Merging net/main (c40c0d3a768c Merge branch '1GbE' of git://git.kernel.org/=
...
Merging cifs/for-next (34323d510524 cifs: allow changing password during re=
mount)
...
Merging nfsd/nfsd-next (1dc3c314af65 nfsd: Fix NFSv3 atomicity bugs in nfsd=
_setattr())
...
Merging net-next/main (dfe7f12788f5 Merge branch 'net-ipv6-addrconf-ensure-=
that-temporary-addresses-preferred-lifetimes-are-long-enough')
Merging bpf-next/for-next (682158ab532a bpf: Fix test verif_scale_strobemet=
a_subprogs failure due to llvm19)
...
Merging wireless-next/for-next (42ffccd0a36e wifi: rtlwifi: rtl_usb: Store =
...
Merging drm-misc/for-linux-next (1a5e81de180e Revert "drm/panel-edp: Add au=
o_b116xa3_mode")
...
Merging block/for-next (953104f83a31 Merge branch 'for-6.9/io_uring' into f=
or-next)
...
-next)
Merging workqueues/for-next (9d6efa8d0dd0 workqueue, irq_work: Build fix fo=
r !CONFIG_IRQ_WORK)
...
Merging gpio-brgl/gpio/for-next (8ff0d55ba3fb gpio: uapi: clarify default_v=
alues being logical)
...

=n7My
-----END PGP SIGNATURE-----
