...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EA02C169CF8
	for <lists+linux-next@lfdr.de>; Mon, 24 Feb 2020 05:32:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727189AbgBXEcd (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 23 Feb 2020 23:32:33 -0500
Received: from ozlabs.org ([203.11.71.1]:46145 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727186AbgBXEcc (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sun, 23 Feb 2020 23:32:32 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48Qq0n0hpwz9sR4;
        Mon, 24 Feb 2020 15:32:25 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1582518745;
        bh=I2QZsRUSlpRcEnB2zXDD/QNjkz1GllvmJ8ebXcNM8jo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 24 Feb 2020 15:32:23 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 24
Message-ID: <20200224153223.74d18a20@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/VIhhVvuddv4bq.i/ML1M4O4";
...
Non-merge commits (relative to Linus' tree): 3139
 2996 files changed, 120000 insertions(+), 74176 deletions(-)
...
Merging origin/master (d2eee25858f2 Merge tag 'for-5.6-rc2-tag' of git://gi=
...
Merging net/master (39f3b41aa7ca net: genetlink: return the error code when=
...
Merging mac80211/master (0daa63ed4c6c mac80211: Remove a redundant mutex un=
lock)
...
Merging tty.current/tty-linus (dca132a60f22 Merge tag 'ras-urgent-2020-02-2=
2' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging usb.current/usb-linus (dca132a60f22 Merge tag 'ras-urgent-2020-02-2=
2' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
Merging phy/fixes (0ed41b33882c phy: brcm-sata: Correct MDIO operations for=
 40nm platforms)
Merging staging.current/staging-linus (dca132a60f22 Merge tag 'ras-urgent-2=
020-02-22' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging char-misc.current/char-misc-linus (dca132a60f22 Merge tag 'ras-urge=
nt-2020-02-22' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
P fixups)
Merging hwmon-fixes/hwmon (675c7c3258d6 docs: adm1177: fix a broken referen=
ce)
...
Merging renesas/next (7d21c0efac2a Merge branch 'renesas-drivers-for-v5.7' =
into renesas-next)
...
Merging csky/linux-next (99db590b083f csky: Replace <linux/clk-provider.h> =
by <linux/of_clk.h>)
...
et')
Merging btrfs/for-next (f62e2374c142 Merge branch 'for-next-next-v5.6-20200=
221' into for-next-20200221)
Merging ceph/master (3b20bc2fe4c0 ceph: noacl mount option is effectively i=
gnored)
Merging cifs/for-next (617ba0c0ac57 cifs: handle prefix paths in reconnect)
...
e release)
Merging hwmon-staging/hwmon-next (5c8507ffe058 hwmon: (lm73) Add support fo=
r of_match_table)
...
o dma mapping)
Merging net-next/master (2045e158fc7f r8169: remove RTL_EVENT_NAPI constant=
s)
...
Merging bluetooth/master (eed467b517e8 Bluetooth: fix passkey uninitialized=
 when used)
Merging mac80211-next/master (7bb106eb6891 cfg80211: remove support for adj=
acent channel compensation)
...
.c
Merging drm-intel/for-linux-next (bb393dc56e9a drm/i915/display/hdcp: Make =
WARN* drm specific where drm_priv ptr is available)
...
it' into for-next)
Merging sound-asoc/for-next (dcdf428d1e18 Merge branch 'asoc-5.7' into asoc=
-next)
...
r imx v1 mu)
Merging spi/for-next (5c7867000487 Merge branch 'spi-5.7' into spi-next)
...
Merging usb/usb-next (2f41c8a25feb usb: musb: core: remove useless cast for=
 driver.name)
...
Merging tty/tty-next (e587e8f17433 vt: ioctl, switch VT_IS_IN_USE and VT_BU=
SY to inlines)
...
rflow
Merging akpm/master (46fcdb47d1f9 drivers/media/platform/sti/delta/delta-ip=
...

=hbcQ
-----END PGP SIGNATURE-----
