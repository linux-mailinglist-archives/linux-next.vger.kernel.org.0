...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 60F7B58E4B7
	for <lists+linux-next@lfdr.de>; Wed, 10 Aug 2022 03:53:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229736AbiHJBxo (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 9 Aug 2022 21:53:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44228 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230136AbiHJBxk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 9 Aug 2022 21:53:40 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 318E47B786;
        Tue,  9 Aug 2022 18:53:37 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4M2Xyz4K9Tz4x1V;
        Wed, 10 Aug 2022 11:53:31 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1660096411;
        bh=vXx8A/O7rnP7BoWAFq6AIU/TiDp5j1NGnwwJZ/w5M18=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 10 Aug 2022 11:53:27 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 10
Message-ID: <20220810115327.6b73538d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_oVcb9Qs_o8UHcM2x9.YSBY";
...
Changes since 20220809:

Dropped tree: mfd (temporarily, at the maintainers request)

Non-merge commits (relative to Linus' tree): 1196
 1010 files changed, 57490 insertions(+), 12537 deletions(-)
...
Merging origin/master (15205c2829ca Merge tag 'fscache-fixes-20220809' of g=
...
ally deduplicated)
Merging mm-hotfixes/mm-hotfixes-unstable (fc16f88e2029 vmcoreinfo: add kall=
syms_num_syms symbol)
...
Merging net/master (bc3c8fe3c79b plip: avoid rcu debug splat)
Merging bpf/master (19f68ed6dc90 bpf, arm64: Allocate program buffer using =
kvcalloc instead of kcalloc)
...
Merging wireless/for-next (f01272ee3856 wifi: wilc1000: fix spurious inline=
 in wilc_handle_disconnect())
Merging rdma-fixes/for-rc (cc0315564d6e RDMA/irdma: Fix sleep from invalid =
context BUG)
Merging sound-current/for-linus (30267718fe2d ALSA: hda/realtek: Add a quir=
k for HP OMEN 15 (8786) mute LED)
Merging sound-asoc-fixes/for-linus (5d8971867332 Merge remote-tracking bran=
...
Merging driver-core.current/driver-core-linus (4e23eeebb2e5 Merge tag 'bitm=
ap-6.0-rc1' of https://github.com/norov/linux)
Merging tty.current/tty-linus (eb555cb5b794 Merge tag '5.20-rc-ksmbd-server=
-fixes' of git://git.samba.org/ksmbd)
Merging usb.current/usb-linus (eb555cb5b794 Merge tag '5.20-rc-ksmbd-server=
-fixes' of git://git.samba.org/ksmbd)
Merging usb-gadget-fixes/fixes (e49d033bddf5 Linux 5.12-rc6)
Merging usb-serial-fixes/usb-linus (ff6992735ade Linux 5.19-rc7)
Merging phy/fixes (f2906aa86338 Linux 5.19-rc1)
Merging staging.current/staging-linus (4e23eeebb2e5 Merge tag 'bitmap-6.0-r=
c1' of https://github.com/norov/linux)
...
Merging char-misc.current/char-misc-linus (4e23eeebb2e5 Merge tag 'bitmap-6=
.0-rc1' of https://github.com/norov/linux)
...
Merging hwmon-fixes/hwmon (06bfee84a1c1 dt-bindings: hwmon: sparx5: use cor=
rect clock)
...
Merging devicetree-fixes/dt/linus (331753ff3292 dt-bindings: mmc: sdhci-msm=
: Fix 'operating-points-v2 was unexpected' issue)
...
Merging spdx/spdx-linus (4e23eeebb2e5 Merge tag 'bitmap-6.0-rc1' of https:/=
...
Merging loongarch/loongarch-next (e71c25da3a3b LoongArch: Add efistub booti=
ng support)
...
Merging ceph/master (a8af0d682ae0 libceph: clean up ceph_osdc_start_request=
 prototype)
Merging cifs/for-next (15c8eab401d3 cifs: fix lock length calculation)
...
fixes' of git://git.samba.org/ksmbd)
Merging nfs/linux-next (3c59366c207e NFS: don't unhash dentry during unlink=
/rename)
...
Merging hwmon-staging/hwmon-next (06bfee84a1c1 dt-bindings: hwmon: sparx5: =
use correct clock)
...
OPP during probe)
Merging thermal/thermal/linux-next (ef971e0c8e10 thermal/of: Fix free after=
...
Merging bluetooth/master (9ec46ac996f5 Bluetooth: convert hci_update_adv_da=
ta to hci_sync)
...
Merging sound/for-next (30267718fe2d ALSA: hda/realtek: Add a quirk for HP =
OMEN 15 (8786) mute LED)
Merging sound-asoc/for-next (5d8971867332 Merge remote-tracking branch 'aso=
c/for-5.19' into asoc-linus)
Merging modules/modules-next (554694ba120b module: Replace kmap() with kmap=
_local_page())
Merging input/next (938db76cf8c8 Input: elan_i2c - convert to use dev_group=
s)
...
45 compatible)
Merging driver-core/driver-core-next (4e23eeebb2e5 Merge tag 'bitmap-6.0-rc=
1' of https://github.com/norov/linux)
Merging usb/usb-next (eb555cb5b794 Merge tag '5.20-rc-ksmbd-server-fixes' o=
...
ized comments)
Merging tty/tty-next (eb555cb5b794 Merge tag '5.20-rc-ksmbd-server-fixes' o=
f git://git.samba.org/ksmbd)
Merging char-misc/char-misc-next (4e23eeebb2e5 Merge tag 'bitmap-6.0-rc1' o=
f https://github.com/norov/linux)
...
Merging staging/staging-next (4e23eeebb2e5 Merge tag 'bitmap-6.0-rc1' of ht=
tps://github.com/norov/linux)
...
Merging scsi-mkp/for-next (c6380f992427 scsi: pm8001: Fix typo 'the the' in=
 comment)
Merging vhost/linux-next (fdaed2bd3c09 vhost-vdpa: Call ida_simple_remove()=
 when failed)
Merging rpmsg/for-next (3d9688c734a7 Merge branches 'rproc-next' and 'hwspi=
...
Merging ntb/ntb-next (1736be2729a0 pcie: endpoint: pci-epf-vntb: add endpoi=
nt msi support)
...
Merging mm/mm-everything (73eaede68a87 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...

=GB0x
-----END PGP SIGNATURE-----
