...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D03492DF7FC
	for <lists+linux-next@lfdr.de>; Mon, 21 Dec 2020 04:19:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726730AbgLUDTH (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 20 Dec 2020 22:19:07 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:59973 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725927AbgLUDTF (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sun, 20 Dec 2020 22:19:05 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Czl6D4Bgxz9sVm;
        Mon, 21 Dec 2020 14:18:12 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1608520692;
        bh=Gx2XTMyAfBJle8h3ZX9zaEqBTLqD6jmc4F8g5C+Jb+4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 21 Dec 2020 14:18:11 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 21
Message-ID: <20201221141811.33dedcbe@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//WR6w_LRWLc1qmlSNv388C9";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_//WR6w_LRWLc1qmlSNv388C9
...
New trees: clk-renesas and pinctrl-renesas

The notifications tree gained conflicts against Linus' tree.

The akpm-current tree regained a build failure for which I reverted
a commit.

Non-merge commits (relative to Linus' tree): 1025
 1033 files changed, 37764 insertions(+), 10885 deletions(-)
...
Merging origin/master (48342fc07272 Merge tag 'perf-tools-2020-12-19' of gi=
...
Merging ipvs/master (5c8193f568ae netfilter: ipset: fix shift-out-of-bounds=
 in htable_bits())
Merging wireless-drivers/master (0bd157fa2aaa mt76: mt7915: fix MESH ifdef =
block)
...
Merging sound-current/for-linus (09926202e939 ALSA: hda/realtek: Add quirk =
for MSI-GP73)
...
Merging spi-fixes/for-linus (d85108d878c9 Merge remote-tracking branch 'spi=
...
Merging dmaengine-fixes/fixes (6daa90439e91 Merge tag 'dmaengine-5.11-rc1' =
...
ings for Clang)
Merging kbuild/for-next (6861025cd04f Merge branch 'kbuild' into for-next)
...
to ti-k3-next)
Merging clk/clk-next (83b6ec23fbe7 Merge branch 'clk-cleanup' into clk-next)
...
Merging sound/for-next (09926202e939 ALSA: hda/realtek: Add quirk for MSI-G=
P73)
...
er)
Merging spi/for-next (d85108d878c9 Merge remote-tracking branch 'spi/for-5.=
11' into spi-linus)
...
Applying: kasan: fix memory leak of kasan quarantine fix
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (06ab010bd282 secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
Applying: Revert "kasan: fix memory leak of kasan quarantine fix"
...

=I0CB
-----END PGP SIGNATURE-----
