...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id DE1E6E81D5
	for <lists+linux-next@lfdr.de>; Tue, 29 Oct 2019 08:07:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726654AbfJ2HHm (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 29 Oct 2019 03:07:42 -0400
Received: from ozlabs.org ([203.11.71.1]:41659 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726222AbfJ2HHl (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 29 Oct 2019 03:07:41 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 472N2G0cC8z9sPj;
        Tue, 29 Oct 2019 18:07:34 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1572332854;
        bh=eoFOKOiEpPBb0Yh+BoJ+Xi724qCmwroExwnDzIFYTQs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 29 Oct 2019 18:07:31 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 29
Message-ID: <20191029180731.2153b90c@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/MsIU5db7XuhuTr_16f9mUJy";
...
Merging origin/master (8005803a2ca0 Merge tag 'arc-5.4-rc6' of git://git.ke=
...
())
Merging powerpc-fixes/fixes (a8a30219ba78 powerpc/powernv/eeh: Fix oops whe=
n probing cxl devices)
...
ernel/git/pablo/nf)
Merging bpf/master (fc11078dd351 Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/pablo/nf)
...
rrupts on disabling")
Merging sound-asoc-fixes/for-linus (791bfe29e5be Merge branch 'asoc-5.4' in=
to asoc-linus)
Merging regmap-fixes/for-linus (da0c9ea146cb Linux 5.4-rc2)
Merging regulator-fixes/for-linus (064447433b69 Merge branch 'regulator-5.4=
' into regulator-linus)
Merging spi-fixes/for-linus (67400a0f443b Merge branch 'spi-5.4' into spi-l=
inus)
...
Merging usb.current/usb-linus (1186f86a7113 UAS: Revert commit 3ae62a42090f=
...
_pin_request())
Merging risc-v-fixes/fixes (f307307992bf riscv: for C functions called only=
...
xt' into for-next)
Merging imx-mxs/for-next (a233d04cd8ef Merge branch 'imx/defconfig' into fo=
r-next)
...
r-next)
Merging scmi/for-linux-next (db2f481805a9 Merge tag 'juno-update-5.5' of gi=
...
Merging xfs/for-next (da1faf13deb0 xfs: consolidate preallocation in xfs_fi=
le_fallocate)
$ git reset --hard HEAD^
...
Merging bpf-next/master (e93d99180abd selftests/bpf: Restore $(OUTPUT)/test=
_stub.o rule)
...
Merging netfilter-next/master (5b7fe93db008 Merge git://git.kernel.org/pub/=
...
n.c
Merging drm-tegra/drm/tegra/for-next (048bd70876ea drm/tegra: Optionally at=
tach clients to the IOMMU)
Merging drm-misc/for-linux-next (a39414716ca0 drm/amdgpu: add independent D=
MA-buf import v9)
...
e gracefully)
Merging sound-asoc/for-next (50484b6a523a Merge branch 'asoc-5.5' into asoc=
-next)
...
header file)
Merging block/for-next (8e3b4a8c82ed Merge branch 'for-5.5/io_uring-test' i=
nto for-next)
...
Merging regulator/for-next (996163b40330 Merge branch 'regulator-5.5' into =
regulator-next)
...
register value)
Merging spi/for-next (847680d0151a Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
r test)
Merging rcu/rcu/next (a48e49e63a72 Merge branches 'replace.2019.10.28a', 'd=
oc.2019.10.05a', 'fixes.2019.10.05a', 'nohz.2019.10.28a', 'torture.2019.10.=
...
rflow
Merging akpm/master (b24f99062c29 drivers/media/platform/sti/delta/delta-ip=
...

=fyXq
-----END PGP SIGNATURE-----
