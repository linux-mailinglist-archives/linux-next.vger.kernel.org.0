...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 47A4A2D739F
	for <lists+linux-next@lfdr.de>; Fri, 11 Dec 2020 11:14:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388431AbgLKKMs (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 11 Dec 2020 05:12:48 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33250 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730087AbgLKKMe (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 11 Dec 2020 05:12:34 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 92E53C0613D6;
        Fri, 11 Dec 2020 02:11:53 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Csmm53kptz9sTL;
        Fri, 11 Dec 2020 21:11:49 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1607681509;
        bh=rkPaoNqY+Oxejik03qMI+1t2uEXNVTmHv/E4PREiOrc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 11 Dec 2020 21:11:47 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 11
Message-ID: <20201211211147.465ecfa6@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/qH6RxH1HHQ1Y0jYoRZ/5KGl";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/qH6RxH1HHQ1Y0jYoRZ/5KGl
...
Merging origin/master (9fca90cf2892 Merge tag 'for-linus' of git://git.kern=
...
Merging bpf/master (3615bdf6d9b1 selftests/bpf: Fix "dubious pointer arithm=
etic" test)
...
Merging input-current/for-linus (ce6520b0eafa Input: i8042 - add Acer lapto=
ps to the i8042 reset list)
...
Merging powerpc/next (0be47634db0b powerpc/cacheinfo: Print correct cache-s=
ibling map/list for L2 cache)
...
Merging uml/linux-next (507b642b3c20 um: support suspend to RAM)
...
ession->s_seq)
Merging cifs/for-next (217acba599c2 cifs: get rid of cifs_sb->mountdata)
Merging configfs/for-next (65cdb4a214c0 configfs: fix kernel-doc markup iss=
ue)
Merging ecryptfs/next (8b614cb8f1dc Merge tag '5.6-rc4-smb3-fixes' of git:/=
/git.samba.org/sfrench/cifs-2.6)
Merging erofs/dev (1825c8d7ce93 erofs: force inplace I/O under low memory s=
cenario)
...
nto for-next)
Merging i2c/i2c/for-next (aac085f0884e Merge branch 'i2c/for-5.11' into i2c=
/for-next)
...
in imxfb_probe())
Merging pm/linux-next (58dfa0fa290b Merge branch 'pm-domains' into linux-ne=
xt)
...
Merging swiotlb/linux-next (79f748d1bdb6 x86,swiotlb: Adjust SWIOTLB bounce=
...
Merging net-next/master (91163f821436 Merge branch 'add-ppp_generic-ioctls-=
to-bridge-channels')
...
eturn_buff()"
Merging bpf-next/for-next (092fde0f863b samples/bpf: Fix possible hang in x=
dpsock with multiple threads)
...
REJECT action)
Merging wireless-drivers-next/master (c42d492c672a cw1200: txrx: convert co=
mma to semicolon)
...
Merging drm-intel/for-linux-next (3a9ec563a4ff drm/i915/icl: Fix initing th=
e DSI DSC power refcount during HW readout)
Merging drm-tegra/drm/tegra/for-next (bf3a3cdcad40 drm/tegra: sor: Disable =
clocks on error in tegra_sor_init())
Merging drm-misc/for-linux-next (c365d304d69a drm/sched: Add missing struct=
ure comment)
...
Merging sound/for-next (b1a5039759cb ALSA: hda/hdmi: fix silent stream for =
first playback to DP)
...
Merging input/next (7002932325ef Input: tm2-touchkey - add vddio regulator)
...
11' into spi-next)
Merging tip/auto-latest (33eae21d327c Merge branch 'core/entry')
...
CU usage warning)
Merging driver-core/driver-core-next (2a0387e8128a misc: pvpanic: Replace O=
F headers by mod_devicetable.h)
Merging usb/usb-next (8704fd73bf56 USB: gadget: f_fs: remove likely/unlikel=
y)
...
CONFLICT (content): Merge conflict in MAINTAINERS
Merging tty/tty-next (d96f04d347e4 serial: 8250_omap: Avoid FIFO corruption=
 caused by MDR1 access)
Merging char-misc/char-misc-next (428bb001143c slimbus: qcom: fix potential=
 NULL dereference in qcom_slim_prg_slew())
...
Applying: swiotlb.h: add "inline" to swiotlb_adjust_size
...
Merging akpm/master (a6a3b89586b1 secretmem: test: add basic selftest for m=
emfd_secret(2))
...

=y8f3
-----END PGP SIGNATURE-----
