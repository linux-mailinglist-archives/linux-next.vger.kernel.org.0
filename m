...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 97AD4367E19
	for <lists+linux-next@lfdr.de>; Thu, 22 Apr 2021 11:48:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235712AbhDVJsn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 22 Apr 2021 05:48:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59164 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235583AbhDVJsm (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 22 Apr 2021 05:48:42 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7C794C06174A;
        Thu, 22 Apr 2021 02:48:07 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FQszl553Wz9sW5;
        Thu, 22 Apr 2021 19:48:03 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1619084883;
        bh=OCAexKd0akRgB8GHFxELOr9bVzjSSr1y9Vwc4bbXuMY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 22 Apr 2021 19:48:02 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 22
Message-ID: <20210422194802.593273a7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/RRLmoOIyqTU1zFtzSU+YMKD";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/RRLmoOIyqTU1zFtzSU+YMKD
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210421:

New tree: tpmdd-jejb

The vfs tree gained a conflict against the csky tree.

The rcu tree gained a build failure so I used the version from
next-20210421.

The kvm tree gained conficts against Linus` tree, the mips tree and the
tip tree.

The kvm-arm tree gained conficts against the kvm tree.

The cgroup tree gained conficts and a semantic conflict against the
kvm tree.

Non-merge commits (relative to Linus' tree): 13431
 11540 files changed, 642373 insertions(+), 282802 deletions(-)
...
Merging origin/master (16fc44d6387e Merge tag 'mmc-v5.12-rc5' of git://git.=
...
Merging net/master (eefb45eef5c4 neighbour: Prevent Race condition in neigh=
bour subsytem)
...
Merging sound-asoc-fixes/for-linus (a5a7236ac6db Merge remote-tracking bran=
...
Merging regulator-fixes/for-linus (1ac6259a2306 Merge remote-tracking branc=
h 'regulator/for-5.12' into regulator-linus)
Merging spi-fixes/for-linus (d6c5a76eece6 Merge remote-tracking branch 'spi=
...
c syscallhdr.sh)
Merging powerpc/next (39352430aaa0 powerpc: Move copy_inst_from_kernel_nofa=
ult())
...
form no allocation)
Merging rdma/for-next (45062f441590 RDMA/rxe: Fix a bug in rxe_fill_ip_info=
())
CONFLICT (content): Merge conflict in drivers/infiniband/hw/hfi1/hfi.h
Merging net-next/master (5d869070569a net: phy: marvell: don't use empty sw=
itch default case)
...
e offload support)
Merging wireless-drivers-next/master (afda33499bea rtlwifi: implement set_t=
im by update beacon content)
...
Merging sound-asoc/for-next (80e0ab429149 Merge remote-tracking branch 'aso=
...
chpanel series)
Merging block/for-next (2981e9778a70 Merge branch 'for-5.13/drivers' into f=
or-next)
...
Merging regulator/for-next (dcf0e405bba0 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (037dc6160a83 Merge remote-tracking branch 'spi/for-5.=
13' into spi-next)
Merging tip/auto-latest (c1d2a603724a Merge branch 'linus')
...
Merging rcu/rcu/next (bbc440a9296b rcu/tree_plugin: Don't handle the case o=
f 'all' CPU range)
$ git reset --hard HEAD^
Merging next-20210421 version of rcu
Merging kvm/next (238eca821cee KVM: SVM: Allocate SEV command structures on=
 local stack)
...
CONFLICT (content): Merge conflict in arch/x86/kvm/svm/svm.h
CONFLICT (content): Merge conflict in arch/x86/kvm/svm/sev.c
Applying: fixup for "KVM: SVM: Do not set sev->es_active until KVM_SEV_ES_I=
NIT completes"
...
Merging gpio-intel/for-next (058459043e71 gpio: ich: Switch to be dependent=
 on LPC_ICH)
Merging pinctrl/for-next (1f9da868b04e Merge branch 'devel' into for-next)
...
Merging akpm/master (4cd4ba9e5ad4 memfd_secret: use unsigned int rather tha=
...

=YCdp
-----END PGP SIGNATURE-----
