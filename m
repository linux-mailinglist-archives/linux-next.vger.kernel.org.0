...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 94826143745
	for <lists+linux-next@lfdr.de>; Tue, 21 Jan 2020 07:52:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725890AbgAUGwc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 21 Jan 2020 01:52:32 -0500
Received: from ozlabs.org ([203.11.71.1]:51415 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725789AbgAUGwc (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 21 Jan 2020 01:52:32 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 481zk227LKz9sRK;
        Tue, 21 Jan 2020 17:52:26 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1579589546;
        bh=CellslJQPIBqOcAjC3m/+xuyErUX1vVfcpiPAvwdRj8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 21 Jan 2020 17:52:20 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 21
Message-ID: <20200121175220.4ef481f9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8v5SllyYkK9SAb.d0IvUxXF";
...
--Sig_/8v5SllyYkK9SAb.d0IvUxXF
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200120:
...
Non-merge commits (relative to Linus' tree): 9165
 9167 files changed, 432859 insertions(+), 194046 deletions(-)
...
Merging origin/master (d96d875ef5dd Merge tag 'fixes_for_v5.5-rc8' of git:/=
...
pu state)
Merging arm-current/fixes (927d780ee371 ARM: 8950/1: ftrace/recordmcount: f=
ilter relocation types)
...
Merging net/master (80892772c4ed hsr: Fix a compilation error)
...
P packets)
Merging netfilter/master (7eaecf7963c1 netfilter: nft_osf: add missing chec=
k for DREG attribute)
Merging ipvs/master (c24b75e0f923 ipvs: move old_secure_tcp into struct net=
ns_ipvs)
Merging wireless-drivers/master (21bdee92c6f8 Merge tag 'iwlwifi-for-kalle-=
2020-01-11' of git://git.kernel.org/pub/scm/linux/kernel/git/iwlwifi/iwlwif=
i-fixes)
...
Merging sound-current/for-linus (4d024fe8f806 ALSA: hda: Apply aligned MMIO=
 access only conditionally)
Merging sound-asoc-fixes/for-linus (6aa01182e773 Merge branch 'asoc-5.5' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (7c4074a0488b Merge branch 'spi-5.5' into spi-l=
inus)
...
Merging usb.current/usb-linus (453495d4e791 Merge tag 'usb-serial-5.5-rc7' =
...
Merging input-current/for-linus (ba9a103f40fc Input: keyspan-remote - fix c=
ontrol-message timeouts)
...
Merging mtd-fixes/mtd/fixes (d70486668cdf mtd: rawnand: gpmi: Restore nfc t=
iming setup after suspend/resume)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (d8fcca47e195 drm/i915/userptr=
...
Merging drm-misc-fixes/for-linux-next-fixes (db1a07956968 drm/dp_mst: Handl=
e SST-only branch device case)
Applying: Revert "drm/i915/userptr: fix size calculation"
...
Merging arm/for-next (6d04408bc52a Merge branches 'fixes' and 'misc' into f=
or-next)
Merging arm64/for-next/core (9e06daa256c9 Merge branch 'for-next/errata' in=
to for-next/core)
...
mp/aml-rebuild)
Merging aspeed/for-next (39be9e84f65b ARM: dts: aspeed: rainier: Add UCD903=
20 power sequencer)
...
to for-next)
Merging samsung-krzk/for-next (93c45bb9b7cb Merge branch 'next/defconfig' i=
nto for-next)
...
et')
Merging btrfs/for-next (aa5640279a9f Merge branch 'for-next-next-v5.5-20200=
117' into for-next-20200117)
Merging ceph/master (da08e1e1d7c3 ceph: add more debug info when decoding m=
dsmap)
Merging cifs/for-next (912df31d67b9 cifs: add support for fallocate mode 0 =
...
Merging nfs-anna/linux-next (4b6b872bddb3 nfs: Return EINVAL rather than ER=
ANGE for mount parse errors)
...
roc/locks)
Merging vfs/for-next (053666f7e8b5 Merge branches 'work.recursive_removal',=
 'imm.timestamp' and 'work.misc' into for-next)
...
Merging hwmon-staging/hwmon-next (6d3fdc7d038c hwmon: (k10temp) Don't show =
temperature limits on Ryzen (Zen) CPUs)
...
in imxfb_probe())
Merging pm/linux-next (d5fa8437171c Merge branch 'pnp' into linux-next)
...
Merging net-next/master (17e10a15a796 Merge branch 'mlxsw-SPAN-egress-mirro=
ring-buffer-size')
Applying: Revert "pktgen: Allow configuration of IPv6 source address range"
Merging bpf-next/master (f1c3656c6d9c selftests/bpf: Skip perf hw events te=
st if the setup disabled it)
...
Merging mlx5-next/mlx5-next (a880a6dd8537 net/mlx5: Expose relaxed ordering=
 bits)
Merging netfilter-next/master (4262c38dc42e net: dsa: mv88e6xxx: Add SERDES=
 stats counters to all 6390 family members)
...
ullfunc())
Merging gfs2/for-next (f7be987b8254 gfs2: Remove GFS2_MIN_LVB_SIZE define)
...
Merging drm-intel/for-linux-next (786555987207 drm/i915/gem: Store mmap_off=
sets in an rbtree rather than a plain list)
Merging drm-tegra/drm/tegra/for-next (033ccdb7f6b1 gpu: host1x: Remove dev_=
err() on platform_get_irq() failure)
Merging drm-misc/for-linux-next (77d1a6dbe8a4 drm/syncobj: Add documentatio=
n for timeline syncobj)
...
-next)
Merging sound/for-next (15c0d83ef9db ALSA: hda/hdmi - add retry logic to pa=
rse_intel_hdmi())
Merging sound-asoc/for-next (0fd3a3583436 Merge branch 'asoc-5.6' into asoc=
-next)
...
Merging block/for-next (0651082cc302 Merge branch 'for-5.6/io_uring-vfs' in=
to for-next)
...
r imx v1 mu)
Merging spi/for-next (20ad62e87d33 Merge branch 'spi-5.6' into spi-next)
Merging tip/auto-latest (5343da396584 Merge branch 'sched/core')
...
ing instances)
Merging irqchip/irq/irqchip-next (d04bd6589ac0 irqchip/gic-v4.1: Allow dire=
...
Merging kvm-arm/next (0c40e706ffc6 arm64: KVM: Annotate guest entry/exit as=
 a single function)
...
Merging usb/usb-next (42bbdd99221b phy: ti: j721e-wiz: Fix build error with=
out CONFIG_OF_ADDRESS)
...
t_port)
Merging char-misc/char-misc-next (1660557bd7cf Merge tag 'extcon-next-for-5=
.6' of git://git.kernel.org/pub/scm/linux/kernel/git/chanwoo/extcon into ch=
ar-misc-next)
...
Merging staging/staging-next (7b2d7faa09fc Merge tag 'iio-for-5.6b' of git:=
...
rflow
Merging akpm/master (55992a236e9e drivers/media/platform/sti/delta/delta-ip=
...

=BM49
-----END PGP SIGNATURE-----
