...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4966B47BFB1
	for <lists+linux-next@lfdr.de>; Tue, 21 Dec 2021 13:27:43 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234410AbhLUM1m (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 21 Dec 2021 07:27:42 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:37239 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229779AbhLUM1l (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 21 Dec 2021 07:27:41 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JJG1j6VPbz4xgt;
        Tue, 21 Dec 2021 23:27:37 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1640089658;
        bh=Af9qPoFNWwtl6XW+aGzWJMTjSBZZdG4agPbOIAuoNu8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 21 Dec 2021 23:27:37 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 21
Message-ID: <20211221232737.2286c520@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/BFTr=PdgiXxuztA6S4RmcEU";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/BFTr=PdgiXxuztA6S4RmcEU
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211220:

This kernel produces a WARNING at boot time (at least for my tests).

The mac80211-next tree gained a conflict against Linus' tree and a
semantic conflict against the net-next tree.

The gpio-brgl tree still had its build failure so I used the version
from next-20211217 (with the revert).
...
Non-merge commits (relative to Linus' tree): 7973
 8373 files changed, 384994 insertions(+), 167534 deletions(-)
...
Merging origin/master (86085fe79e3c Merge tag 'spi-fix-v5.16-rc6' of git://=
...
Merging net/master (75a2f3152009 phonet/pep: refuse to enable an unbound pi=
pe)
...
Merging usb.current/usb-linus (a7904a538933 Linux 5.16-rc6)
...
ice node)
Merging kvm-fixes/master (ab1ef34416a6 KVM: selftests: Add test to verify T=
RIPLE_FAULT on invalid L2 guest state)
...
Merging mmc-fixes/fixes (f89b548ca66b mmc: meson-mx-sdhc: Set MANUAL_STOP f=
or multi-block SDIO commands)
...
Merging arm-soc/for-next (7fcae3717755 Merge branch 'arm/dt' into for-next)
...
nto for-next)
Merging samsung-krzk/for-next (268eee20365d Merge branch 'next/dt64' into f=
or-next)
Merging scmi/for-linux-next (d0b376fdc042 Merge branch 'for-next/scmi' of g=
...
Merging parisc-hd/for-next (484730e5862f parisc: Clear stale IIR value on i=
...
ocumentation)
Merging cel/for-next (c84d8235e64a nfs: block notification on fs with its o=
wn ->lock)
...
Merging hwmon-staging/hwmon-next (dbefb9ac3a3a hwmon: (nct6775) Additional =
check for ChipID before ASUS WMI usage)
...
Merging net-next/master (4b430f5c9680 Merge branch 'lan966x-switchdev-and-v=
lan')
Merging bpf-next/for-next (426b87b111b0 selftests/bpf: Correct the INDEX ad=
dress in vmtest.sh)
...
Merging wireless-drivers-next/master (8b144dedb928 rtlwifi: rtl8192cu: Fix =
WARNING when calling local_irq_restore() with interrupts enabled)
Merging bluetooth/master (a33d805b3225 Bluetooth: btintel: Add missing quir=
ks and msft ext for legacy bootloader)
Merging mac80211-next/master (701fdfe348f7 cfg80211: Enable regulatory enfo=
rcement checks for drivers supporting mesh iface)
CONFLICT (content): Merge conflict in net/wireless/reg.c
Applying: fixup for "cfg80211: Use the HE operation IE to determine a 6GHz =
BSS channel"
...
Merging block/for-next (ec8e3a591bb3 Merge branch 'for-5.17/block' into for=
-next)
...
of htmldoc warning)
Merging usb/usb-next (236c9ad1f870 Merge 5.16-rc6 into usb-next)
Merging usb-gadget/next (e49d033bddf5 Linux 5.12-rc6)
Merging usb-serial/usb-next (2585cf9dfaad Linux 5.16-rc5)
Merging usb-chipidea-next/for-usb-next (78665f57c3fa usb: chipidea: udc: ma=
ke controller hardware endpoint primed)
Merging tty/tty-next (35eaa42c4a10 Merge 5.16-rc6 into tty-next)
...
Merging iio/togreg (d37e6bb10a08 iio:addac:ad74413r: Fix uninitialized ret =
in a path that won't be hit.)
Merging mux/for-next (fba5a543c06d mux: fix grammar, missing "is".)
...
Merging pwm/for-next (3f0565451cc0 dt-bindings: pwm: Avoid selecting schema=
 on node name match)
Merging userns/for-next (d6c8e5e6f0d1 Merge of signal-for-v5.17, and ucount=
...
Merging akpm/master (cd902beba0f1 lib/stackdepot: always do filter_irq_stac=
...

=Dpxp
-----END PGP SIGNATURE-----
