...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7DAD3187C21
	for <lists+linux-next@lfdr.de>; Tue, 17 Mar 2020 10:38:12 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725906AbgCQJiL (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 17 Mar 2020 05:38:11 -0400
Received: from ozlabs.org ([203.11.71.1]:41239 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725730AbgCQJiL (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 17 Mar 2020 05:38:11 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48hSlG5Dhgz9sPR;
        Tue, 17 Mar 2020 20:38:02 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1584437882;
        bh=8A+F0BYU4jqGOmi90EwQMbu/rpicIwiOFGWnWyphXwE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 17 Mar 2020 20:37:57 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 17
Message-ID: <20200317203757.2a91c535@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/zP1o6K0nw2uOXhm6LGFfsGW";
...
The imx-mxs tree gained conflicts against Linus' tree.

The qcom tree gained a conflict against the imx-mxs tree.

The renesas tree gained conflicts against the imx-mxs and qcom trees.

The pm tree gained a build failure for which I reverted a commit.

The v4l-dvb tree lost its build failure.

The selinux tree gained a conflict against the nfs tree.

The rtc tree lost its build failure.

Non-merge commits (relative to Linus' tree): 8502
 7367 files changed, 334229 insertions(+), 161074 deletions(-)
...
Merging net/master (ef299cc3fa1a net_sched: cls_route: remove the right fil=
ter from hashtable)
...
Merging sound-current/for-linus (6c3171ef76a0 ALSA: seq: oss: Fix running s=
tatus after receiving sysex)
...
xt)
Merging amlogic/for-next (ccfec964e800 Merge branch 'v5.7/drivers' into tmp=
/aml-rebuild)
...
ible-array member)
Merging nfs/linux-next (f50cd5730008 nfs: Fix up documentation in nfs_follo=
...
Merging hid/for-next (a2bb8292b193 Merge branch 'for-5.6/upstream-fixes' in=
to for-next)
...
Merging net-next/master (1963507e6233 net: kcm: kcmproc.c: Fix RCU list sus=
picious usage warning)
...
Merging drm-intel/for-linux-next (220a6704ff43 drm/i915/gt: Restore check f=
or invalid vma for fencing)
...
Merging block/for-next (ee225bfd98a6 Merge branch 'for-5.7/drivers' into fo=
r-next)
...
Merging mmc/next (64b3637cdb88 mmc: sdhci-of-at91: Display clock changes fo=
...
Merging clockevents/timers/drivers/next (f7867cffff7b Merge branch 'timers/=
drivers/timer-ti-dm' into timers/drivers/next)
...
Merging usb/usb-next (df8df5e4bc37 usb: get rid of 'choice' for legacy gadg=
et drivers)
...
Merging gpio-brgl/gpio/for-next (6b3a81c722f8 gpiolib: gpio_name_to_desc: f=
actor out !name check)
...
Merging rtc/rtc-next (7995c88f8d32 rtc: 88pm860x: remove platform data supp=
ort)
...
rflow
Merging akpm/master (38966e717aa6 drivers/media/platform/sti/delta/delta-ip=
...

=ZazI
-----END PGP SIGNATURE-----
