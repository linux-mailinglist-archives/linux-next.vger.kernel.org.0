...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D0C0F5B590F
	for <lists+linux-next@lfdr.de>; Mon, 12 Sep 2022 13:12:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230186AbiILLMQ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 12 Sep 2022 07:12:16 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54546 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230224AbiILLMP (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 12 Sep 2022 07:12:15 -0400
Received: from mail-pg1-x536.google.com (mail-pg1-x536.google.com [IPv6:2607:f8b0:4864:20::536])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9AE5925EB8
        for <linux-next@vger.kernel.org>; Mon, 12 Sep 2022 04:12:12 -0700 (PDT)
Received: by mail-pg1-x536.google.com with SMTP id g4so7983892pgc.0
        for <linux-next@vger.kernel.org>; Mon, 12 Sep 2022 04:12:12 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date;
        bh=Gs8gvYG7OfC96/e1x+G4BWN4fOrbSgxvoqv0GIsqRV4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Gs8gvYG7OfC96/e1x+G4BWN4fOrbSgxvoqv0GIsqRV4=;
        b=
X-Gm-Message-State: ACgBeo20WoVFlhr4CDtWR/EFYsr666kgEQLvzkXgbJ3oOxrXHMQy3Vvj
        IN9unSmYHNAy8fj3FPFqD4JC5twQFEkzgulEvRg=
X-Google-Smtp-Source: AA6agR4cz9U1AEj/Tr+1ixMShN7zleJGf+avOq5tuAIn7v9uRCyIj1UPINkq/UNKz8Pq82WWPi9phw==
X-Received: by 2002:a05:6a00:1a14:b0:52d:3e35:5b38 with SMTP id g20-20020a056a001a1400b0052d3e355b38mr27095305pfv.11.1662981130482;
        Mon, 12 Sep 2022 04:12:10 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id f2-20020a170902e98200b00176ca533ea0sm5703830plb.90.2022.09.12.04.12.09
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 12 Sep 2022 04:12:09 -0700 (PDT)
Message-ID: <631f1409.170a0220.32311.98b7@mx.google.com>
Date:   Mon, 12 Sep 2022 04:12:09 -0700 (PDT)
...
Subject: next/master build: 223 builds: 9 failed, 214 passed, 32 errors,
 78 warnings (next-20220912)
...
next/master build: 223 builds: 9 failed, 214 passed, 32 errors, 78 warnings=
 (next-20220912)
...
Tree: next
Branch: master
Git Describe: next-20220912
Git Commit: 044b771be9c5de9d817dfafb829d2f049c71c3b4
...
x86_64:
    allmodconfig (clang-16): 7 errors, 9 warnings
    allnoconfig (clang-16): 1 error
    cros://chromeos-5.10/x86_64/chromiumos-x86_64.flavour.config (clang-13)=
: 1 error
    cros://chromeos-5.10/x86_64/chromiumos-x86_64.flavour.config+x86-chrome=
...
es .noinstr.text section
 ...
 leaves .noinstr.text section
    ...
    1    drivers/power/supply/bq25890_charger.c:625:40: warning: implicit c=
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-16) =E2=80=94 FAIL, 7 errors, 9 warnings, 0 sec=
tion mismatches
