>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">&nbsp;[&nbsp;&nbsp;&nbsp;
      2.294722] smp: Bringing up secondary CPUs ...<br>
      [&nbsp;&nbsp;&nbsp; 2.295211] smpboot: Parallel CPU startup disabled by the
      platform<br>
      [&nbsp;&nbsp;&nbsp; 2.309687] smpboot: x86: Booting SMP configuration:<br>
      [&nbsp;&nbsp;&nbsp; 2.310214] .... node&nbsp; #0, CPUs:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; #1&nbsp;&nbsp; #2&nbsp;&nbsp; #3&nbsp;&nbsp; #4&nbsp;&nbsp;
      ...
      --&gt; The guest hangs forever at this point.<br>
      <br>
      &nbsp;<br>
    </p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">I
      have observed that certain vCPU and memory combinations work,
      while others do not. The VM configuration I am using does not have
      any NUMA nodes.</p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">vcpus&nbsp;&nbsp;&nbsp;
      &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; Mem&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; SNP guest boot<br>
      &lt;=240&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 19456M&nbsp;&nbsp;&nbsp; Boots fine<br>
      &gt;=241,&lt;255&nbsp;&nbsp; 19456M&nbsp;&nbsp;&nbsp; Hangs<br>
      1-255&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 2048M&nbsp;&nbsp;&nbsp; Boots fine<br>
      1-255&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp; 4096M&nbsp;&nbsp;&nbsp; Boots fine<br>
      &gt;71&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 8192M&nbsp;&nbsp;&nbsp; Hangs<br>
      &gt;41&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; 6144M&nbsp;&nbsp;&nbsp; Hangs<br>
      <br>
      &nbsp;</p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">When
      I bisected this issue, it pointed to the following commit :</p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">&nbsp;<br>
      <b>commit 800f1059c99e2b39899bdc67a7593a7bea6375d8</b><br>
      Author: Kirill A. Shutemov <a class="moz-txt-link-rfc2396E" href="mailto:kirill.shutemov@linux.intel.com">&lt;kirill.shutemov@linux.intel.com&gt;</a><br>
      Date:&nbsp;&nbsp; Mon Mar 10 10:28:55 2025 +0200<br>
      <br>
      &nbsp;&nbsp;&nbsp; mm/page_alloc: fix memory accept before watermarks gets
      initialized<br>
      <br>
      &nbsp;&nbsp;&nbsp; Watermarks are initialized during the postcore initcall.&nbsp;
      Until then, all<br>
      &nbsp;&nbsp;&nbsp; watermarks are set to zero.&nbsp; This causes cond_accept_memory()
      to<br>
      &nbsp;&nbsp;&nbsp; incorrectly skip memory acceptance because a watermark of 0 is
      always met.<br>
      <br>
      &nbsp;&nbsp;&nbsp; This can lead to a premature OOM on boot.<br>
      <br>
      &nbsp;&nbsp;&nbsp; To ensure progress, accept one MAX_ORDER page if the watermark
      is zero.<br>
      <br>
      &nbsp;&nbsp;&nbsp; Link:
<a class="moz-txt-link-freetext" href="https://lkml.kernel.org/r/20250310082855.2587122-1-kirill.shutemov@linux.intel.com">https://lkml.kernel.org/r/20250310082855.2587122-1-kirill.shutemov@linux.intel.com</a><br>
      &nbsp;&nbsp;&nbsp; Fixes: dcdfdd40fa82 (&quot;mm: Add support for unaccepted memory&quot;)<br>
      &nbsp;&nbsp;&nbsp; Signed-off-by: Kirill A. Shutemov
      <a class="moz-txt-link-rfc2396E" href="mailto:kirill.shutemov@linux.intel.com">&lt;kirill.shutemov@linux.intel.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Tested-by: Farrah Chen <a class="moz-txt-link-rfc2396E" href="mailto:farrah.chen@intel.com">&lt;farrah.chen@intel.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Reported-by: Farrah Chen <a class="moz-txt-link-rfc2396E" href="mailto:farrah.chen@intel.com">&lt;farrah.chen@intel.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Acked-by: Vlastimil Babka <a class="moz-txt-link-rfc2396E" href="mailto:vbabka@suse.cz">&lt;vbabka@suse.cz&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Reviewed-by: Pankaj Gupta <a class="moz-txt-link-rfc2396E" href="mailto:pankaj.gupta@amd.com">&lt;pankaj.gupta@amd.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: Ashish Kalra <a class="moz-txt-link-rfc2396E" href="mailto:ashish.kalra@amd.com">&lt;ashish.kalra@amd.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: David Hildenbrand <a class="moz-txt-link-rfc2396E" href="mailto:david@redhat.com">&lt;david@redhat.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: &quot;Edgecombe, Rick P&quot; <a class="moz-txt-link-rfc2396E" href="mailto:rick.p.edgecombe@intel.com">&lt;rick.p.edgecombe@intel.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: Mel Gorman <a class="moz-txt-link-rfc2396E" href="mailto:mgorman@techsingularity.net">&lt;mgorman@techsingularity.net&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: &quot;Mike Rapoport (IBM)&quot; <a class="moz-txt-link-rfc2396E" href="mailto:rppt@kernel.org">&lt;rppt@kernel.org&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: Thomas Lendacky <a class="moz-txt-link-rfc2396E" href="mailto:thomas.lendacky@amd.com">&lt;thomas.lendacky@amd.com&gt;</a><br>
      &nbsp;&nbsp;&nbsp; Cc: <a class="moz-txt-link-rfc2396E" href="mailto:stable@vger.kernel.org">&lt;stable@vger.kernel.org&gt;</a>&nbsp;&nbsp;&nbsp; [6.5+]<br>
    ...
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">Reproduction
      Steps:</p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">Build
      the guest kernel with linux-next [starting next-20250324] using
      the attached guest config.</p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;">Try
      booting the SNP guest using the following sample QEMU command
      line:</p>
    &nbsp;<br>
    <br>
    &nbsp;qemu-system-x86_64 \<br>
    -machine
    q35,confidential-guest-support=sev0,memory-backend=mem-upmsev0 \<br>
    -object
memory-backend-memfd,size=19456M,prealloc=false,share=true,reserve=false,id=mem-upmsev0
    \<br>
    -object
sev-snp-guest,id=sev0,cbitpos=51,reduced-phys-bits=1,kernel-hashes=off,policy=0x30000
    ...
    -bios OVMF_X64/OVMF.fd \<br>
    -cpu EPYC-v4 \<br>
    -smp 255,maxcpus=255,cores=255,threads=1,dies=1,sockets=1 \<br>
    -kernel bzImage_0321 \<br>
    -append &quot;root=/dev/vda rw console=ttyS0,115200n8
    earlyprintk=ttyS0,115200 net.ifnames=0 biosdevname=0 movable_node
    swiotlb=65536 &quot; \<br>
    -device
...
node-name=file_image1,driver=file,filename=/home/VT_BUILD/22.04-server.qcow2
    \<br>
    -blockdev node-name=drive_image1,driver=qcow2,file=file_image1 \<br>
    --enable-kvm \<br>
    --nographic \<br>
    -qmp tcp:localhost:4444,server,wait=off<br>
    <br>
    &nbsp;<br>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><b>Issue
        goes away if I build the guest kernel by reverting the
        aforementioned commit or boot the guest with <span style="color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; letter-spacing: normal; text-align: start; text-indent: 0px; text-transform: none; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">accept_memory=eager.</span></b></p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><span style="color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-c
 aps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">Note
        that once you revert </span>aforementioned commit or boot the
      guest with <span style="color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">accept_memory=eager
        the guest boots and ends up with another issue which is already
        reported [2].</span></p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><span style="color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-c
...
<a class="moz-txt-link-freetext" href="https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git">https://git.kernel.org/pub/scm/linux/kernel/git/next/linux-next.git</a>,
        next-20250324<br>
      </span></p>
    <p dir="auto" style="margin: 10px 0px 0px; padding: 0px; color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial;"><span style="color: rgb(23, 43, 77); font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; font-style: normal; font-variant-ligatures: normal; font-variant-c
 aps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; background-color: rgb(255, 255, 255); text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; display: inline !important; float: none;">[2]
      </span><a href="https://lore.kernel.org/all/423b87d8-2ae3-48af-b368-657f1fbab88d@amd.com/">Re:
        [syzbot] [pci?] linux-next test error: general protection fault
        in msix_capability_init - Aithal, Srikanth</a></p>
    <p></p>
  </body>
</html>
