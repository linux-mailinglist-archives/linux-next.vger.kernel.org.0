...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 9352F1A3EBB
	for <lists+linux-next@lfdr.de>; Fri, 10 Apr 2020 05:27:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726082AbgDJD1P (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 9 Apr 2020 23:27:15 -0400
Received: from ozlabs.org ([203.11.71.1]:53369 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726663AbgDJD1O (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 9 Apr 2020 23:27:14 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48z3ND3VGXz9sSg;
        Fri, 10 Apr 2020 13:27:08 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1586489228;
        bh=z4VXovwnC2wuBsEuvPFts4M0ovgVzELFbIVw6K5c1NA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 10 Apr 2020 13:27:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 10
Message-ID: <20200410132706.170811b7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/u/PfTgPgpNbBc0Ry3J7jYkq";
...
Merging origin/master (c0cc271173b2 Merge tag 'modules-for-v5.7' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/jeyu/linux)
...
Merging net/master (690cc86321eb net: ipv4: devinet: Fix crash when add/del=
 multicast IP with autojoin)
Merging bpf/master (bb9562cf5c67 arm, bpf: Fix bugs with ALU64 {RSH, ARSH} =
BPF_K shift by 0)
...
Merging hyperv-fixes/hyperv-fixes (97d9f1c43bed x86: hyperv: report value o=
f misc_features)
...
_notify_op_lock())
Merging cifs/for-next (1dc94b7381bd smb3: change noisy error message to FYI)
...
_find_marked)
Merging hyperv/hyperv-next (1503af176a20 Drivers: hv: check VMBus messages =
lengths)
...
rflow
Merging akpm/master (eac15cf85ac6 drivers/media/platform/sti/delta/delta-ip=
...

=t/Nr
-----END PGP SIGNATURE-----
