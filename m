...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D56705AE6EA
	for <lists+linux-next@lfdr.de>; Tue,  6 Sep 2022 13:53:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233571AbiIFLxY (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 6 Sep 2022 07:53:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45646 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230215AbiIFLxX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 6 Sep 2022 07:53:23 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4250857219;
        Tue,  6 Sep 2022 04:53:20 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4MMP0Z4fhLz4xP6;
        Tue,  6 Sep 2022 21:53:18 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1662465198;
        bh=32/JyMf1rSPmFShPtw0vu0dHcwq2U55titUggu7GagQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 6 Sep 2022 21:53:17 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 6
Message-ID: <20220906215317.0295fe9d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/zHpH4mvp61bj37AomUH=sxa";
...
--Sig_/zHpH4mvp61bj37AomUH=sxa
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220901:
...
The kselftest tree gained a conflict against the pm tree.

The slab tree gained a semantic conflict against the bpf-next tree.

The kspp tree gained a conflict against the tip tree.

The mm tree gained conflicts against Linus' tree and the slab and
crypto trees and a semantic conflict against the drm-msm tree.

Non-merge commits (relative to Linus' tree): 5000
 6831 files changed, 343843 insertions(+), 104329 deletions(-)
...
Merging origin/master (53e99dcff61e Merge tag 'soc-fixes-6.0-rc4' of git://=
git.kernel.org/pub/scm/linux/kernel/git/soc/soc)
Merging fixes/fixes (1c23f9e627a7 Linux 6.0-rc2)
Merging mm-hotfixes/mm-hotfixes-unstable (785d5da983e5 mm: fix dereferencin=
g possible ERR_PTR)
...
Merging arm64-fixes/for-next/fixes (5fbc49cef919 arm64: mm: Reserve enough =
pages for the initial ID map)
...
Merging net/master (beb432528c79 Merge tag 'for-net-2022-09-02' of git://gi=
...
esses)
Merging rdma-fixes/for-rc (0d1b756acf60 RDMA/siw: Pass a pointer to virt_to=
_page())
Merging sound-current/for-linus (51bdc8bb8252 ALSA: hda/sigmatel: Fix unuse=
d variable warning for beep power change)
...
Merging drm-misc-fixes/for-linux-next-fixes (c7943bb324e5 drm/edid: Handle =
EDID 1.4 range descriptor h/vfreq offsets)
...
ek' into for-next)
Merging imx-mxs/for-next (2655becb4ac3 Merge branch 'imx/dt64' into for-nex=
t)
...
Merging clk-imx/for-next (f6f6ada524a9 clk: imx93: add SAI IPG clk)
$ git reset --hard HEAD^
Merging next-20220901 version of clk-imx
...
Merging vfs-idmapping/for-next (6344e66970c6 xattr: constify value argument=
 in vfs_setxattr())
Merging fscrypt/master (6e9b8f6a882d fscrypt: work on block_devices instead=
 of request_queues)
...
Merging nfsd/for-next (ba567c33a728 NFSD: Protect against send buffer overf=
low in NFSv3 READ)
...
Merging rdma/for-next (fc5e1acf6ade RDMA/siw: Add missing Kconfig selection=
s)
Merging net-next/master (96efd6d01461 r8169: remove not needed net_ratelimi=
t() check)
...
Merging bluetooth/master (b1c013419bde Bluetooth: hci_sync: Fix hci_read_bu=
ffer_size_sync)
Merging wireless-next/for-next (9837ec955b46 Merge tag 'wireless-next-2022-=
09-03' of git://git.kernel.org/pub/scm/linux/kernel/git/wireless/wireless-n=
ext)
...
Merging crypto/master (fa2bf6e35091 crypto: hisilicon/qm - return failure i=
f vfs_num exceeds total VFs)
$ git reset --hard HEAD^
...
Merging drm-misc/for-linux-next (396369d67549 drm: vkms: Add support to the=
 RGB565 format)
...
n32/dcn32_fpu.c
Merging drm-intel/for-linux-next (f1ee74afc1e3 drm/i915/fbdev: do not creat=
e fbdev if HPD is suspended)
...
Merging sound/for-next (32eeeed963ad ALSA: usb-audio: Clean up endpoint set=
ups at PCM prepare)
...
_local_page())
Merging input/next (f4e7a254299b Input: aiptek - switch to using dev_groups=
 for driver-specific attributes)
...
1' into spi-next)
Merging tip/master (4ad861bb89e0 Merge branch into tip/master: 'x86/timers')
...
Merging drivers-x86/for-next (f98d67ac427d platform/x86: p2sb: Fix UAF when=
 caller uses resource name)
...
e alloc_dr())
Merging usb/usb-next (a956f91247da Merge 6.0-rc4 into usb-next)
...
Merging cgroup/for-next (0fcfe377e5c8 Merge branch 'for-6.1' into for-next)
Merging scsi/for-next (eb7f9ca137e3 Merge branch 'fixes' into for-next)
Merging scsi-mkp/for-next (e699bb9765cd scsi: target: pscsi: Remove repeate=
d word "calling")
...
Merging slab/for-next (9d65b201b5f5 Merge branch 'slab/for-6.1/fit_rcu_head=
' into slab/for-next)
Applying: Revert "mm/slab_common: move declaration of __ksize() to mm/slab.=
h"
...
Merging bitmap/bitmap-for-next (ca5dce772da2 tools: sync find_bit() impleme=
ntation)
...

=VV18
-----END PGP SIGNATURE-----
