...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D5BE2516F07
	for <lists+linux-next@lfdr.de>; Mon,  2 May 2022 13:45:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1384774AbiEBLtX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 2 May 2022 07:49:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38668 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1355474AbiEBLtX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 2 May 2022 07:49:23 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 73DA815839;
        Mon,  2 May 2022 04:45:51 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KsLrZ0f6Lz4yST;
        Mon,  2 May 2022 21:45:50 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1651491950;
        bh=9TIzUpwm+U1sVHJDwJsUV1H/PW/m2HpTZD69Q7L4Dig=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 2 May 2022 21:45:49 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 2
Message-ID: <20220502214549.78ab02cd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/C+3mBzCQt709U_012EN/Zrh";
...
--Sig_/C+3mBzCQt709U_012EN/Zrh
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220429:

Trees added: mm-stable, mm-nonmm-stable
...
The iommu tree gained a confict against the dma-mapping tree.

The kvm tree lost its build failure.

The usb tree gained a build failure for which I reverted a commit.

The pinctrl tree gained a confict against the gpio-intel tree.

The folio tree gained a conflict against the btrfs tree and a semantic
conflict against the erofs tree.

The bitmap tree gained a build failure so I used the version from
next-20220429.

The mm tree gained conficts against the folio and slab trees and build
failures for which I reverted 14 commits.

Non-merge commits (relative to Linus' tree): 7315
 8088 files changed, 403991 insertions(+), 166098 deletions(-)
...
Merging origin/master (672c0c517342 Linux 5.18-rc5)
...
Ie Ports in D3cold)
Merging driver-core.current/driver-core-linus (57ae8a492116 Merge tag 'driv=
er-core-5.18-rc5' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/d=
river-core)
Merging tty.current/tty-linus (57ae8a492116 Merge tag 'driver-core-5.18-rc5=
' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/driver-core)
Merging usb.current/usb-linus (57ae8a492116 Merge tag 'driver-core-5.18-rc5=
' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/driver-core)
...
Merging char-misc.current/char-misc-linus (57ae8a492116 Merge tag 'driver-c=
ore-5.18-rc5' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/drive=
r-core)
...
_unbound_wq) usage)
Merging net-next/master (6e28f56c0d1d Merge branch 'adin1100-industrial-PHY=
-support')
...
Merging wireless-next/main (5b3fd8fd7ceb rtw88: fix hw scan may cause disco=
nnect issue)
...
Merging drm-misc/for-linux-next (9ff9236394dd drm/panel: simple: Add Starte=
k KD070WVFPA043-C069A panel support)
...
Merging drm-intel/for-linux-next (119125d96b8b Merge tag 'gvt-next-2022-04-=
29' of https://github.com/intel/gvt-linux into drm-intel-next)
...
Merging block/for-next (14465fa75c5d Merge branch 'for-5.19/drivers' into f=
or-next)
...
Merging tomoyo/master (c806998d6e2c workqueue: Wrap flush_workqueue() using=
 a macro)
...
Merging edac/edac-for-next (5b5d65978dc3 Merge edac-misc into for-next)
...
Merging driver-core/driver-core-next (f8ae07f4b8bf firmware_loader: Move de=
finitions from sysfs_upload.h to sysfs.h)
...
perties)
Merging char-misc/char-misc-next (e918c10265ef misc/pvpanic: Convert regula=
r spinlock into trylock on panic path)
...
Merging slab/for-next (609fae61ffea Merge branches 'slab/for-5.19/stackdepo=
t' and 'slab/for-5.19/refactor' into slab/for-next)
Merging random/master (387342375435 random: mix in timestamps and reseed on=
 system restore)
...
Merging folio/for-next (00da6d4b7219 mm,fs: Remove stray references to ->re=
adpage)
...
rary support)
Merging bitmap/bitmap-for-next (d6407cd9a53c include/linux/find: Fix docume=
ntation)
$ git reset --hard HEAD^
Merging next-20220429 version of bitmap
...
Applying: Revert "mm/shmem: convert shmem_swapin_page() to shmem_swapin_fol=
io()"
Applying: Revert "mm/shmem: convert shmem_getpage_gfp to use a folio"
Applying: Revert "mm/shmem: convert shmem_alloc_and_acct_page to use a foli=
o"
Applying: Revert "mm/shmem: turn shmem_alloc_page() into shmem_alloc_folio(=
)"
Applying: Revert "mm/shmem: turn shmem_should_replace_page into shmem_shoul=
d_replace_folio"
Applying: Revert "mm/shmem: convert shmem_add_to_page_cache to take a folio"
Applying: Revert "mm/swap: add folio_throttle_swaprate"
Applying: Revert "mm/shmem: use a folio in shmem_unused_huge_shrink"
Applying: Revert "vmscan: remove remaining uses of page in shrink_page_list"
Applying: Revert "vmscan: convert the activate_locked portion of shrink_pag=
e_list to folios"
Applying: Revert "vmscan: move initialisation of mapping down"
Applying: Revert "vmscan: convert lazy freeing to folios"
Applying: Revert "vmscan: convert page buffer handling to use folios"
Applying: Revert "vmscan: convert dirty page handling to folios"
Applying: Revert "usb: core: hcd: Create platform devices for onboard hubs =
in probe()"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (e94e0f2f0f1f kselftest/vm: override TARGETS from argum=
ents)
...

=G3R0
-----END PGP SIGNATURE-----
