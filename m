...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 25E7713BA10
	for <lists+linux-next@lfdr.de>; Wed, 15 Jan 2020 08:04:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726045AbgAOHE0 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 15 Jan 2020 02:04:26 -0500
Received: from ozlabs.org ([203.11.71.1]:38509 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726018AbgAOHEZ (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 15 Jan 2020 02:04:25 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47yJGY28c1z9sQp;
        Wed, 15 Jan 2020 18:04:21 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1579071861;
        bh=dwBZtSte2nbN7G3PMvrgNFFTx2sLCLGclh4uenl1zBA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 15 Jan 2020 18:04:18 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 15
Message-ID: <20200115180418.3002c988@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/EQkmSB98o/SOgs1DPcIlFbS";
...
--Sig_/EQkmSB98o/SOgs1DPcIlFbS
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200114:
...
The usb-gadget tree still had its conflict against Linus' tree but I
used a supplied resolution instead of dropping the tree.

The akpm-current tree gained a conflict against the ftrace tree.

Non-merge commits (relative to Linus' tree): 7738
 8015 files changed, 370464 insertions(+), 169417 deletions(-)
...
Merging origin/master (452424cdcbca Merge branch 'parisc-5.5-3' of git://gi=
...
Merging net/master (c742c59e1fbd hv_sock: Remove the accept port restrictio=
n)
...
Merging sound-asoc-fixes/for-linus (23cfd8f73773 Merge branch 'asoc-5.5' in=
to asoc-linus)
...
itch fall-throughs)
Merging kbuild/for-next (94a78ed9a622 Merge branch 'kconfig' into for-next)
...
nin)
Merging at91/at91-next (f7c275493d28 Merge branches 'at91-soc', 'at91-dt' a=
...
Merging parisc-hd/for-next (8b7f938e0a03 parisc: fix map_pages() to actuall=
...
et')
Merging btrfs/for-next (04d582759641 Merge branch 'for-next-next-v5.5-20200=
114' into for-next-20200114)
...
in imxfb_probe())
Merging pm/linux-next (12e3b3cc0354 Merge branches 'acpica' and 'acpi-apei'=
 into linux-next)
...
pages)
Merging net-next/master (169af34684b2 Merge branch 'netns-Optimise-netns-ID=
-lookups')
Merging bpf-next/master (0a29275b6300 bpf: Return -EBADRQC for invalid map =
type in __bpf_tx_xdp_map)
...
Merging bluetooth/master (5e6d8401ade9 Bluetooth: hci_qca: Add qca_power_on=
() API to support both wcn399x and Rome power up)
...
v2))
Merging drm-intel/for-linux-next (f22fd334890e drm/i915/gen11: Add addition=
al pcode status values)
...
Merging drm-misc/for-linux-next (455e00f1412f drm: Add getfb2 ioctl)
...
-next)
Merging sound/for-next (75663c093d0b ALSA: hda: patch_hdmi: remove warnings=
 with empty body)
Merging sound-asoc/for-next (55a9993ec01a Merge branch 'asoc-5.6' into asoc=
-next)
Applying: fix for "regulator: core: Add regulator_is_equal() helper"
...
Merging regulator/for-next (67f55e81edba Merge remote-tracking branch 'regu=
...
CONFLICT (content): Merge conflict in arch/arm/tools/syscall.tbl
CONFLICT (content): Merge conflict in arch/alpha/kernel/syscalls/syscall.tbl
[master 474ab4c895e0] next-20191211/keys
...
rflow
Merging akpm/master (e9d5f40796be drivers/media/platform/sti/delta/delta-ip=
...

=eY62
-----END PGP SIGNATURE-----
