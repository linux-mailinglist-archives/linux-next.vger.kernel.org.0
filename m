...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 49461114B40
	for <lists+linux-next@lfdr.de>; Fri,  6 Dec 2019 03:54:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726150AbfLFCyN (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 5 Dec 2019 21:54:13 -0500
Received: from ozlabs.org ([203.11.71.1]:34963 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726233AbfLFCyM (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 5 Dec 2019 21:54:12 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47TccH4Ffdz9sP3;
        Fri,  6 Dec 2019 13:54:07 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1575600847;
        bh=xR4PdPg6Zc9oC294AWzhRykIbH7GD0zOKRDEvIkvMFI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 6 Dec 2019 13:54:06 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 6
Message-ID: <20191206135406.563336e7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/th=jeKBc=w=TGNDPETNIP+L";
...
Merging origin/master (0f137416247f Merge tag 'modules-for-v5.5' of git://g=
...
Merging arm-soc-fixes/arm/fixes (336bab731be7 ARM: pxa: Fix resource proper=
ties)
...
Merging net/master (a350d2e7adbb net: thunderx: start phy before starting a=
utonegotiation)
Merging bpf/master (8f9081c92523 selftests/bpf: Add a fexit/bpf2bpf test wi=
th target bpf prog no callees)
...
Merging driver-core.current/driver-core-linus (2f13437b8917 Merge tag 'trac=
e-v5.5-2' of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-tr=
ace)
...
Merging staging.current/staging-linus (2f13437b8917 Merge tag 'trace-v5.5-2=
' of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
Merging char-misc.current/char-misc-linus (2f13437b8917 Merge tag 'trace-v5=
.5-2' of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
base)
Merging kselftest-fixes/fixes (456c96289fcd selftests/ftrace: Fix multiple =
kprobe testcase)
...
Merging nfsd/nfsd-next (82b578daf1dc nfsd: unlock on error in manage_cpntf_=
state())
...
val' into for-next)
Applying: fix up for "printk: Drop pr_warning definition"
...
ltages at runtime)
Merging thermal/thermal/linux-next (ee7cdfab32d1 thermal: power_allocator: =
Fix Kconfig warning)
...
s)
Merging drm/drm-next (b53bd16fec3d Merge tag 'drm-misc-next-fixes-2019-12-0=
...
Merging device-mapper/for-next (00b387a433b1 dm thin: Flush data device bef=
...
ptp' into spi-next)
Merging tip/auto-latest (462ca02d04c3 Merge branch 'WIP.x86/mm')
...
Merging driver-core/driver-core-next (2f13437b8917 Merge tag 'trace-v5.5-2'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
rnel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
Merging char-misc/char-misc-next (2f13437b8917 Merge tag 'trace-v5.5-2' of =
...
Merging staging/staging-next (2f13437b8917 Merge tag 'trace-v5.5-2' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/rostedt/linux-trace)
...
Merging akpm-current/current (27f002ac0e66 ipc/msg.c: consolidate all xxxct=
l_down() functions)
...
rflow
Merging akpm/master (8676743f27c9 drivers/media/platform/sti/delta/delta-ip=
...

=WurV
-----END PGP SIGNATURE-----
