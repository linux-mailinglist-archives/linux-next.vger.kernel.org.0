...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5ABA0193C47
	for <lists+linux-next@lfdr.de>; Thu, 26 Mar 2020 10:50:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727833AbgCZJue (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 26 Mar 2020 05:50:34 -0400
Received: from ozlabs.org ([203.11.71.1]:59705 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727699AbgCZJue (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 26 Mar 2020 05:50:34 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48p0bQ5Fc9z9sSG;
        Thu, 26 Mar 2020 20:50:26 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1585216226;
        bh=KklhSyphP51SF8lWYlDmd2vIxkg26TWad1Y1nsgwP6g=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 26 Mar 2020 20:50:25 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 26
Message-ID: <20200326205025.7cdf0d4e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/gk8=p+U9_Lg/AH36utxVMB7";
...
Merging origin/master (e2cf67f6689a Merge tag 'zonefs-5.6-rc7' of git://git=
.kernel.org/pub/scm/linux/kernel/git/dlemoal/zonefs)
...
Merging net/master (2910594fd38d Merge tag 'wireless-drivers-2020-03-25' of=
...
licy_timer)
Merging netfilter/master (2c64605b590e net: Fix CONFIG_NET_CLS_ACT=3Dn and =
CONFIG_NFT_FWD_NETDEV=3D{y, m} build)
...
Merging mac80211/master (575a97acc3b7 ieee80211: fix HE SPR size calculatio=
n)
...
Merging kbuild/for-next (51e406417950 sparc: revive __HAVE_ARCH_STRLEN for =
32bit sparc)
...
t)
Merging arm64/for-next/core (44ca0e00b6a0 Merge branch 'for-next/kernel-ptr=
...
Merging arm-soc/for-next (ce2427259b0e soc: document merges)
...
Merging ext3/for_next (150ac0b05099 Pull fanotify named events patches from=
 Amir)
...
ible-array member)
Merging nfs/linux-next (aa3367c91d36 NFS: Don't specify NFS version in "UDP=
 not supported" error)
...
in imxfb_probe())
Merging pm/linux-next (a4c3e5efdcaf Merge branch 'pm-devfreq' into linux-ne=
xt)
...
Merging net-next/master (29f3490ba9d2 net: use indirect call wrappers for s=
...
etdev.c
Merging bpf-next/master (8395f320b407 libbpf: Don't allocate 16M for log bu=
ffer by default)
...
Merging wireless-drivers-next/master (cd556e40fdf3 devlink: expand the devl=
ink-info documentation)
...
Merging amdgpu/drm-next (466c6bfe2a58 drm/amdgpu/display: fix logic inversi=
...
Merging drm-misc/for-linux-next (d021d751c147 drm/panel-simple: drop use of=
...
Merging sound/for-next (c208a5335036 ALSA: core: Add snd_device_get_state()=
 helper)
Merging sound-asoc/for-next (2c16d70b5856 Merge branch 'asoc-5.7' into asoc=
-next)
...
Merging block/for-next (c0d0d9be9802 Merge branch 'for-5.7/drivers' into fo=
r-next)
...
o rules present)
Merging devicetree/for-next (2dccf6945499 dt-bindings: mfd: Convert stpmic1=
...
ge tracepoint)
Merging rcu/rcu/next (f03939c425e2 rcutorture: Add TRACE02 scenario enablin=
...
ext)
Merging drivers-x86/for-next (c61b693c9a03 platform/x86: intel_pmc_core: Ma=
ke pmc_core_substate_res_show() generic)
...
or aspeed usb-vhub)
Merging usb-serial/usb-next (dfee7e2f4783 USB: serial: option: add Wistron =
Neweb D19Q1)
...
e with ns16550a)
Merging char-misc/char-misc-next (f60442ddc40c nvmem: core: use device_regi=
ster and device_unregister)
...
Merging staging/staging-next (4a1a3e9bf565 staging: most: Documentation: mo=
ve ABI description files out of staging area)
...
Merging kunit-next/kunit (0d5792c9bc45 Documentation: kunit: Make the KUnit=
 documentation less UML-specific)
...
rflow
Merging akpm/master (e303be84a9bc drivers/media/platform/sti/delta/delta-ip=
...

=86F8
-----END PGP SIGNATURE-----
