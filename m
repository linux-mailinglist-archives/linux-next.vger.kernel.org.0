        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 15 Feb 2024 00:20:55 -0800 (PST)
Message-ID: <65cdc967.170a0220.6f5e3.186b@mx.google.com>
Date: Thu, 15 Feb 2024 00:20:55 -0800 (PST)
...
Subject: next/master build: 181 builds: 16 failed, 165 passed, 50 errors,
 296 warnings (next-20240215)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 181 builds: 16 failed, 165 passed, 50 errors, 296 warnin=
gs (next-20240215)
...
Tree: next
Branch: master
Git Describe: next-20240215
Git Commit: 26d7d52b6253574d5b6fec16a93e1110d1489cef
...
sparc:
    ...
    tinyconfig (gcc-10): 1 error, 5 warnings
...
fined reference to `__ubsan_handle_type_mismatch_v1'
    1    workqueue.c:(.text+0xd74): undefined reference to `irq_work_queue_=
on'
    1    workqueue.c:(.text+0xd68): undefined reference to `irq_work_queue_=
on'
    1    workqueue.c:(.text+0xc34): undefined reference to `irq_work_queue_=
on'
    1    workqueue.c:(.text+0x86a): undefined reference to `irq_work_queue_=
on'
    1    workqueue.c:(.text+0x726): undefined reference to `irq_work_queue_=
on'
    1    workqueue.c:(.text+0x6fe): undefined reference to `irq_work_queue_=
on'
...
ck_gettime.c:160: undefined reference to `__ubsan_handle_type_mismatch_v1'
    1    arc-elf32-ld: workqueue.c:(.text+0x6fe): undefined reference to `i=
rq_work_queue_on'
...
r 'syscall_trace_enter' [-Wmissing-prototypes]
    9    security/security.c:811:2: warning: =E2=80=98memcpy=E2=80=99 offse=
...
=E2=80=98register_co_cache_error_notifier=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/loongson64/pm.c:67:13: warning: no previous prototype fo=
r =E2=80=98mach_resume=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/loongson64/pm.c:63:13: warning: no previous prototype fo=
r =E2=80=98mach_suspend=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/loongson64/pm.c:59:13: warning: no previous prototype fo=
r =E2=80=98setup_wakeup_events=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/loongson64/dma.c:25:13: warning: no previous prototype f=
...
Errors:
    workqueue.c:(.text+0xd74): undefined reference to `irq_work_queue_on'
...
Errors:
    workqueue.c:(.text+0xc34): undefined reference to `irq_work_queue_on'

---------------------------------------------------------------------------=
-----
tinyconfig (sparc, gcc-10) =E2=80=94 FAIL, 1 error, 5 warnings, 0 section m=
ismatches

Errors:
    workqueue.c:(.text+0xd68): undefined reference to `irq_work_queue_on'
...
Errors:
    workqueue.c:(.text+0x726): undefined reference to `irq_work_queue_on'
...
Errors:
    workqueue.c:(.text+0x6fe): undefined reference to `irq_work_queue_on'
    arc-elf32-ld: workqueue.c:(.text+0x6fe): undefined reference to `irq_wo=
rk_queue_on'
...
Errors:
    workqueue.c:(.text+0x86a): undefined reference to `irq_work_queue_on'
