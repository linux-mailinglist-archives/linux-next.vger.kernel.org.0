...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 6199C873B3
	for <lists+linux-next@lfdr.de>; Fri,  9 Aug 2019 10:04:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2405617AbfHIIEA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 9 Aug 2019 04:04:00 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:39223 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2405395AbfHIID7 (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 9 Aug 2019 04:03:59 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 464d6d6tR6z9s3Z;
        Fri,  9 Aug 2019 18:03:53 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1565337834;
        bh=qRwUAoOdaqzGMskXJn8hOTpHmN0N2RXPJ4qtMvdNhAs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 9 Aug 2019 18:03:50 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 9
Message-ID: <20190809180350.5cf09351@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/nmX9VQNicGM0t42tPTJqBjm";
...
Merging origin/master (ecb095bff5d4 Merge tag 'hwmon-for-v5.3-rc4' of git:/=
/git.kernel.org/pub/scm/linux/kernel/git/groeck/linux-staging)
Merging fixes/master (609488bc979f Linux 5.3-rc2)
Merging kbuild-current/fixes (258e2ed6c44a kbuild: show hint if subdir-y/m =
...
lure on PPC32)
Merging s390-fixes/fixes (739bacbf7aa2 s390/build: use size command to perf=
orm empty .bss check)
Merging sparc/master (038029c03e21 sparc: remove unneeded uapi/asm/statfs.h)
Merging fscrypt-current/for-stable (ae64f9bd1d36 Linux 4.15-rc2)
Merging net/master (f6649feb264e Merge tag 'batadv-net-for-davem-20190808' =
...
leak bug)
Merging sound-asoc-fixes/for-linus (8cbd5eb1a884 Merge branch 'asoc-5.3' in=
to asoc-linus)
...
Merging driver-core.current/driver-core-linus (8097c43bcbec Revert "kernfs:=
 fix memleak in kernel_ops_readdir()")
Merging tty.current/tty-linus (81eaadcae81b kgdboc: disable the console loc=
k when in kgdb)
Merging usb.current/usb-linus (27709ae4e2fe usb: setup authorized_default a=
ttributes using usb_bus_notify)
...
Merging slave-dma-fixes/fixes (39c71a5b8212 dmaengine: stm32-mdma: Fix a po=
ssible null-pointer dereference in stm32_mdma_irq_handler())
...
Merging hwmon-fixes/hwmon (3cfa5c97f41f hwmon: pmbus: ucd9000: remove unnee=
ded include)
...
symlink())
Merging dma-mapping-fixes/for-linus (8e9d01dcef6b dma-direct: don't truncat=
...
Merging drm-fixes/drm-fixes (f536579c1482 Merge tag 'drm-fixes-5.3-2019-08-=
07' of git://people.freedesktop.org/~agd5f/linux into drm-fixes)
...
pend DP late)
Merging kspp-gustavo/for-next/kspp (09995c8ababa ARM: ep93xx: Mark expected=
 switch fall-through)
...
Merging s390/features (56accf7fd7bf s390/pci: PCI_IOV_RESOURCES loop refact=
oring in zpci_map_resources)
...
ion)
Merging nfs/linux-next (67e7b52d44e3 NFSv4: Ensure state recovery handles E=
TIMEDOUT correctly)
...
in imxfb_probe())
Merging pm/linux-next (c07e4dc1af49 Merge branch 'acpi-apei' into linux-nex=
t)
...
prints)
Merging net-next/master (61552d2ce861 Merge branch 'net-batched-receive-in-=
GRO-path')
...
Merging gfs2/for-next (0edfa8b7fb57 gfs2: Always mark inode dirty in falloc=
ate)
...
.c
Merging drm-intel/for-linux-next (5b5efdf79abf drm/i915: Make debugfs/per_f=
ile_stats scale better)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (013b65101315 drm/panfrost: Add madvise and=
 shrinker support)
...
-next)
Merging sound/for-next (3a76a41ffbf9 Merge branch 'topic/hda-bus-ops-cleanu=
p' into for-next)
Applying: ALSA: hda: readl/writel need linux/io.h
Merging sound-asoc/for-next (5351215cc229 Merge branch 'asoc-5.4' into asoc=
-next)
$ git reset --hard HEAD^
...
Merging block/for-next (7e18f2715875 Merge branch 'for-5.4/block' into for-=
next)
...
Merging regulator/for-next (1a4405d68862 Merge branch 'regulator-5.4' into =
regulator-next)
...
Merging edac/edac-for-next (82413e562ea6 EDAC, mellanox: Add ECC support fo=
r BlueField DDR4)
...
Merging driver-core/driver-core-next (5adf5781019d of/platform: Fix device_=
links_supplier_sync_state_resume() warning)
Merging usb/usb-next (b6fd94883249 MAINTAINERS: mark wusbcore and UWB as ob=
solete)
...
rflow
Merging akpm/master (85617d74d23e drivers/media/platform/sti/delta/delta-ip=
...

=p+gQ
-----END PGP SIGNATURE-----
