...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 298053B5CCD
	for <lists+linux-next@lfdr.de>; Mon, 28 Jun 2021 12:57:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232740AbhF1LAD (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 28 Jun 2021 07:00:03 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:33623 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S232614AbhF1LAD (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 28 Jun 2021 07:00:03 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GD4M15YySz9sV8;
        Mon, 28 Jun 2021 20:57:33 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1624877853;
        bh=4YiqF5ZLEvlHRYKz1hHIrGe1DaPsRccC6ONl6C0e0NU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 28 Jun 2021 20:57:32 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 28
Message-ID: <20210628205732.4c2a0abf@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/CIOcg5NsgTv5DiL5Wx7TW_1";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/CIOcg5NsgTv5DiL5Wx7TW_1
...
Merging origin/master (b4b27b9eed8e Revert "signal: Allow tasks to cache on=
e sigqueue struct")
...
Merging net/master (d6765985a42a Revert "be2net: disable bh with spin_lock =
in be_process_mcc")
...
Merging sound-asoc-fixes/for-linus (c073a58a7ec5 Merge remote-tracking bran=
...
Merging net-next/master (ff8744b5eb11 Merge branch '100GbE' of git://git.ke=
...
ink-trap.rst
Merging bpf-next/for-next (a196fa78a265 bpfilter: Specify the log level for=
 the kmsg message)
...
Merging sound-asoc/for-next (192664528154 Merge remote-tracking branch 'aso=
...
Merging block/for-next (91913cfc85ee Merge branch 'for-5.14/block' into for=
-next)
...
Merging device-mapper/for-next (95b88f4d71cb dm writecache: pause writeback=
 if cache full and origin being written directly)
...

=B8fA
-----END PGP SIGNATURE-----
