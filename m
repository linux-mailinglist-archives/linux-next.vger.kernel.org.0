...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C2010552E76
	for <lists+linux-next@lfdr.de>; Tue, 21 Jun 2022 11:35:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1348951AbiFUJfY (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 21 Jun 2022 05:35:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46862 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1348906AbiFUJfW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 21 Jun 2022 05:35:22 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ADA6327159;
        Tue, 21 Jun 2022 02:35:18 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LS1Zp22tHz4xLT;
        Tue, 21 Jun 2022 19:35:14 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1655804114;
        bh=dqFal+8xkTwrEmpf2RW4U6QREkmbZsCl9aXS3wBFb88=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 21 Jun 2022 19:35:12 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 21
Message-ID: <20220621193512.56d203c9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/90v1mO2CM_7yRK7QKMEZjDf";
...
Merging origin/master (78ca55889a54 Merge tag 'scsi-fixes' of git://git.ker=
...
Merging rdma-fixes/for-rc (118f767413ad RDMA/qedr: Fix reporting QP timeout=
 attribute)
Merging sound-current/for-linus (c7807b27d510 ALSA: hda/via: Fix missing be=
ep setup)
Merging sound-asoc-fixes/for-linus (d0ce4533afe6 Merge remote-tracking bran=
...
nux-next)
Merging stm32/stm32-next (1570e66b14dc ARM: dts: stm32: add fake interrupt =
...
e)
Merging cifs/for-next (6e28e1b96c06 smb3: fix empty netname context on seco=
ndary channels)
...
for-next)
Merging net-next/master (4336487e30c3 Merge branch 'mlxsw-unified-bridge-co=
nversion-part-1')
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/rockchip/rk3568-b=
pi-r2-pro.dts
Merging bpf-next/for-next (aca80dd95e20 uprobe: gate bpf call behind BPF_EV=
ENTS)
...
eaks)
Merging wireless-next/for-next (efbabc116500 cfg80211: Indicate MLO connect=
ion info in connect and roam callbacks)
...
Merging drm-misc/for-linux-next (f16a716621a6 drm/amdgpu/display: drop set =
but unused variable)
$ git reset --hard HEAD^
...
ile draining output)
Merging sound-asoc/for-next (715b30581dea Merge remote-tracking branch 'aso=
...
Merging block/for-next (0815f42d4c39 Merge branch 'for-5.20/io_uring' into =
for-next)
...
Applying: Revert "mm: memory_hotplug: make hugetlb_optimize_vmemmap compati=
ble with memmap_on_memory"
...
Applying: Revert "mm: convert destroy_compound_page() to destroy_large_foli=
o()"
...

=EsTf
-----END PGP SIGNATURE-----
