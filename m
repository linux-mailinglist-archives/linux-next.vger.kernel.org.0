...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3C599221F05
	for <lists+linux-next@lfdr.de>; Thu, 16 Jul 2020 10:55:12 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726837AbgGPIxs (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 16 Jul 2020 04:53:48 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:48673 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726547AbgGPIxn (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 16 Jul 2020 04:53:43 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4B6p272pBJz9sDX;
        Thu, 16 Jul 2020 18:53:35 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1594889615;
        bh=qKbojtEE90dNi5UrCfzdMXlaHkO9sR8J5de1fxUf/14=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 16 Jul 2020 18:53:34 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 16
Message-ID: <20200716185334.40569f20@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/rnE7w.UvAv5KrZ4zDYGlLgi";
...
Non-merge commits (relative to Linus' tree): 7574
 8303 files changed, 422223 insertions(+), 159724 deletions(-)
...
Merging drivers-x86-fixes/fixes (9a33e375d98e platform/x86: asus-wmi: allow=
 BAT1 battery name)
...
Merging drm-fixes/drm-fixes (11ba468877bb Linux 5.8-rc5)
...
Merging qcom/for-next (4f78533cf01a Merge branches 'arm64-defconfig-for-5.9=
...
Merging tegra/for-next (04a109a09e06 Merge branch for-5.9/arm64/dt into for=
-next)
...
mic.h)
Merging powerpc/next (f88223979044 powerpc: re-initialise lazy FPU/VEC coun=
ters on every fault)
...
t_copy())
Merging cifs/for-next (d8fb361b8e16 cifs: Remove the superfluous break)
...
--> pin_user_pages())
Merging overlayfs/overlayfs-next (f0e1266ed24b ovl: fix mount option checks=
 for nfs_export with no upperdir)
...
in imxfb_probe())
Merging pm/linux-next (8d0151344351 Merge branches 'pm-cpufreq', 'pm-cpuidl=
...
ns)
Merging net-next/master (404fc93d4a01 drivers: net: wan: Fix trivial spelli=
ng)
...
ge
Merging bpf-next/master (4ff91fa0a3ac Merge branch 'udp_tunnel-NIC-RX-port-=
...
elling)
Merging bluetooth/master (37adf701dd87 Bluetooth: Add per-instance adv disa=
ble/remove)
...
r"
Merging drm-intel/for-linux-next (715423870b17 drm/i915/ddi: Don't rewrite =
DDI_BUF_CTL reg during DP link training)
...
Merging drm-misc/for-linux-next (947fcfeac329 drm: drm_rect.h: delete dupli=
cated word in comment)
...
Merging block/for-next (b42122d6cc3a Merge branch 'for-5.9/drivers' into fo=
r-next)
...
Merging regulator/for-next (62bb3d223205 Merge remote-tracking branch 'regu=
...
pcs compatible)
Merging spi/for-next (a15a245e3b83 Merge remote-tracking branch 'spi/for-5.=
9' into spi-next)
...
Merging drivers-x86/for-next (f9e1104367c5 platform/x86: mlx-platform: Exte=
nd FAN platform data description)
...
Merging icc/icc-next (65461e26b1fe interconnect: Allow inter-provider pairs=
 to be configured)
Merging dmaengine/next (32a3952a61c7 Merge branch 'for-linus' into next)
...
Merging akpm/master (5ff9fa87385e sh: add missing EXPORT_SYMBOL() for __del=
ay)
...

=8VzL
-----END PGP SIGNATURE-----
