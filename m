Return-Path: <linux-next+bounces-1879-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 504168A12C8
	for <lists+linux-next@lfdr.de>; Thu, 11 Apr 2024 13:15:21 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 6DB551F21309
	for <lists+linux-next@lfdr.de>; Thu, 11 Apr 2024 11:15:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 598831474A8;
	Thu, 11 Apr 2024 11:15:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="Gf132+fj"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pg1-f172.google.com (mail-pg1-f172.google.com [209.85.215.172])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E215C147C7E
	for <linux-next@vger.kernel.org>; Thu, 11 Apr 2024 11:15:06 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.215.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1712834111; cv=none; b=fnjmgK9NYrawD3QoiH68N0tDrIDkuoo/GV/FsqwrcVGvnkIaYBfO8gdVVVU8s7aMFtp4I7Ii1NL15BLdVIfI5I10sUpC2nmBLe40s5pueHDL+o/Ix2XbA7lIO86qM8r3kb0TpqX3g1cPauy9uR5hfwti9m04RdV3a/SbGUn35aA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1712834111; c=relaxed/simple;
	bh=+pWk72bH045o+n14WqLDsRtcsvGWaoLviaH/+b9Tw0Y=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=HuBxau+WTmjGaFSNN+JBqTbP3cLoRycubcvUTKFTqEb3WUnSoxUnTTot1A793hEA5Q7CD6qIWj4kV7EV6eKoYAnaIzl2C3vvlGo6Ez2KTNYL9XqtdLVochRG/AP6PUUJXzTYNk/CzeRkisfcFRtVOaL+OzPiDSn8dyFfvUMHQSo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=Gf132+fj; arc=none smtp.client-ip=209.85.215.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pg1-f172.google.com with SMTP id 41be03b00d2f7-5cedfc32250so5324011a12.0
        for <linux-next@vger.kernel.org>; Thu, 11 Apr 2024 04:15:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1712834105; x=1713438905; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=3U/9LUScXwQnsp6Z7WasEhkd7Q1c4vtpe9JsidKu6mg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1712834105; x=1713438905;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=3U/9LUScXwQnsp6Z7WasEhkd7Q1c4vtpe9JsidKu6mg=;
        b=
X-Gm-Message-State: AOJu0YyQSWTicPKkV/+m9yVDNhStnWh8NUF6ryw2PpS4G+znpNU5jc4l
	6b2Kg1nsMKAh7Vor+v+7elmhaf7/0WdPARl17Zcu7qpt24OeDHBh3/x4E2TpvDJwQXVR6N/L4H/
	ganI=
X-Google-Smtp-Source: AGHT+IEh/ZFBoSDIrBA/rpwQJ8fkdv62IX8jlus7lfq6PuIsdqcQYix1B4nTIBYNIoLyjiStInNrOQ==
X-Received: by 2002:a05:6a20:ce48:b0:1a7:56d2:66c1 with SMTP id id8-20020a056a20ce4800b001a756d266c1mr4832497pzb.29.1712834104358;
        Thu, 11 Apr 2024 04:15:04 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id o8-20020a656148000000b005f07f34eb59sm750831pgv.27.2024.04.11.04.15.03
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 11 Apr 2024 04:15:03 -0700 (PDT)
Message-ID: <6617c637.650a0220.18a30.1959@mx.google.com>
Date: Thu, 11 Apr 2024 04:15:03 -0700 (PDT)
...
Subject: next/master build: 163 builds: 4 failed, 159 passed, 2 errors,
 274 warnings (next-20240411)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 163 builds: 4 failed, 159 passed, 2 errors, 274 warnings=
 (next-20240411)
...
Tree: next
Branch: master
Git Describe: next-20240411
Git Commit: 4118d9533ff3a5d16efb476a0d00afceecd92cf5
...
arc:
    axs103_defconfig (gcc-10): 3 warnings
    axs103_smp_defconfig (gcc-10): 3 warnings
...
Errors summary:
    ...
    2    kernel/time/timekeeping.c:286:1: error: no return statement in fun=
ction returning non-void [-Werror=3Dreturn-type]

Warnings summary:

    9    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [=
-Wcpp]
...
ypes]
    2    arch/mips/boot/dts/loongson/ls7a-pch.dtsi:68.16-416.5: Warning (in=
...
_order_cdr=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/boot/dts/loongson/loongson64g_4core_ls7a.dts:32.31-40.4:=
 Warning (interrupt_provider): /bus@10000000/msi-controller@2ff00000: Missi=
ng '#interrupt-cells' in interrupt provider
    1    arch/mips/boot/dts/loongson/loongson64g_4core_ls7a.dtb: Warning (i=
nterrupt_map): Failed prerequisite 'interrupt_provider'
    1    arch/mips/boot/dts/loongson/loongson64c_4core_ls7a.dts:28.31-36.4:=
 Warning (interrupt_provider): /bus@10000000/msi-controller@2ff00000: Missi=
ng '#interrupt-cells' in interrupt provider
    1    arch/mips/boot/dts/loongson/loongson64c_4core_ls7a.dtb: Warning (i=
nterrupt_map): Failed prerequisite 'interrupt_provider'
    1    arch/mips/boot/dts/loongson/loongson64_2core_2k1000.dtb: Warning (=
interrupt_map): Failed prerequisite 'interrupt_provider'
    1    arch/mips/boot/dts/loongson/loongson64-2k1000.dtsi:116.16-297.5: W=
...
---------------------------------------------------------------------------=
-----
axs103_defconfig (arc, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
axs103_smp_defconfig (arc, gcc-10) =E2=80=94 PASS, 0 errors, 3 warnings, 0 =
section mismatches
...
---------------------------------------------------------------------------=
-----
tinyconfig (sparc, gcc-10) =E2=80=94 FAIL, 1 error, 2 warnings, 0 section m=
ismatches
