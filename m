...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B6A39563388
	for <lists+linux-next@lfdr.de>; Fri,  1 Jul 2022 14:39:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234866AbiGAMjk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 1 Jul 2022 08:39:40 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38632 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229565AbiGAMjj (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 1 Jul 2022 08:39:39 -0400
Received: from mail-pj1-x102a.google.com (mail-pj1-x102a.google.com [IPv6:2607:f8b0:4864:20::102a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C1C873B2B3
        for <linux-next@vger.kernel.org>; Fri,  1 Jul 2022 05:39:36 -0700 (PDT)
Received: by mail-pj1-x102a.google.com with SMTP id d14so2507587pjs.3
        for <linux-next@vger.kernel.org>; Fri, 01 Jul 2022 05:39:36 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=GV/GI+zKVLJ8oQU2sYCo8r9Mzec/mvZMxUHAijneddE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=GV/GI+zKVLJ8oQU2sYCo8r9Mzec/mvZMxUHAijneddE=;
        b=
X-Gm-Message-State: AJIora9A26R6Z4P6cHDARf5u14eiYkbOf1WiufRt3kj96+kqFMm9jyJB
        Aot7d1W3W2Q+yv6so2cqhF0GU6Oijtv+z11t
X-Google-Smtp-Source: AGRyM1sO5QBperjvxbvm/cz9gZiZIXu7KDql4o5qAXTRuvYWPMlMV1rmdcOuDp1HOEE0yaN96/+1cg==
X-Received: by 2002:a17:90b:4c0a:b0:1ec:d3b2:ed22 with SMTP id na10-20020a17090b4c0a00b001ecd3b2ed22mr16752014pjb.2.1656679175110;
        Fri, 01 Jul 2022 05:39:35 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id r17-20020a170902e3d100b001617541c94fsm15318217ple.60.2022.07.01.05.39.34
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 01 Jul 2022 05:39:34 -0700 (PDT)
Message-ID: <62beeb06.1c69fb81.4515c.6764@mx.google.com>
Date:   Fri, 01 Jul 2022 05:39:34 -0700 (PDT)
...
Subject: next/master build: 211 builds: 7 failed, 204 passed, 11 errors,
 113 warnings (next-20220701)
...
next/master build: 211 builds: 7 failed, 204 passed, 11 errors, 113 warning=
s (next-20220701)
...
Tree: next
Branch: master
Git Describe: next-20220701
Git Commit: c4185b16aba73929aa76f0d030efbe79ae867808
...
arm64:
    allmodconfig (clang-15): 2 errors
...
x86_64:
    allmodconfig (clang-15): 1 error, 19 warnings

Errors summary:

    3    cc1: error: =E2=80=98-mloongson-mmi=E2=80=99 must be used with =E2=
=80=98-mhard-float=E2=80=99
    2    sound/soc/codecs/wsa883x.c:1207:3: error: unannotated fall-through=
...
function startup_64_setup_env()
 ...
 limit (1024) in 'mas_wr_modify' [-Wframe-larger-than]
    1    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x7e5b: sta=
...
post() falls through to next function mpi3mr_check_rh_fault_ioc()
    1    drivers/gpu/drm/savage/savage.o: warning: objtool: savage_dispatch=
_draw() falls through to next function savage_dispatch_state()
...
wer_state() falls through to next function sumo_dpm_post_set_power_state()
    1    drivers/fpga/intel-m10-bmc-sec-update.o: warning: objtool: show_ro=
ot_entry_hash() falls through to next function sr_root_entry_hash_show()
    1    drivers/fpga/intel-m10-bmc-sec-update.o: warning: objtool: flash_c=
ount_show() falls through to next function bmc_root_entry_hash_show()
...
ts+0x453: call to __ubsan_handle_load_invalid_value() with UACCESS enabled
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, clang-15) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 sect=
ion mismatches
...
ds limit (2048) in 'avs_path_create' [-Werror,-Wframe-larger-than]
    sound/soc/codecs/wsa883x.c:1207:3: error: unannotated fall-through betw=
een switch labels [-Werror,-Wimplicit-fallthrough]

---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-15) =E2=80=94 FAIL, 1 error, 19 warnings, 0 sec=
tion mismatches
...
453: call to __ubsan_handle_load_invalid_value() with UACCESS enabled
    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x7e5b: stack st=
...
a() falls through to next function trace_raw_output_rpmh_tx_done()
    ...
    drivers/gpu/drm/savage/savage.o: warning: objtool: savage_dispatch_draw=
() falls through to next function savage_dispatch_state()
...
tate() falls through to next function sumo_dpm_post_set_power_state()
    drivers/fpga/intel-m10-bmc-sec-update.o: warning: objtool: flash_count_=
show() falls through to next function bmc_root_entry_hash_show()
    drivers/fpga/intel-m10-bmc-sec-update.o: warning: objtool: show_root_en=
try_hash() falls through to next function sr_root_entry_hash_show()
