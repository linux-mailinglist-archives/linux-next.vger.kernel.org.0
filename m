...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E34607E328F
	for <lists+linux-next@lfdr.de>; Tue,  7 Nov 2023 02:17:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233330AbjKGBR6 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 6 Nov 2023 20:17:58 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38150 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233318AbjKGBR6 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 6 Nov 2023 20:17:58 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 27436103;
        Mon,  6 Nov 2023 17:17:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1699319869;
        bh=WGpnH1MJ9tXvj38Wh5iS2B5HmPQmpMcGdb9krolok7M=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SPVhF326Lz4x5M;
        Tue,  7 Nov 2023 12:17:49 +1100 (AEDT)
Date:   Tue, 7 Nov 2023 12:17:48 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 7
Message-ID: <20231107121748.512f2e18@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/qaMUjQquIsAzh+RNn89mt38";
...
Merging origin/master (d2f51b3516da Merge tag 'rtc-6.7' of git://git.kernel=
.org/pub/scm/linux/kernel/git/abelloni/linux)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (27969c8df896 kexec-fix-kexec_file=
-dependencies-fix)
...
Merging sound-asoc-fixes/for-linus (4bdcbc31ad21 ASoC: dapm: fix clock get =
name)
...
Merging usb.current/usb-linus (d2f51b3516da Merge tag 'rtc-6.7' of git://gi=
t.kernel.org/pub/scm/linux/kernel/git/abelloni/linux)
...
Merging staging.current/staging-linus (d2f51b3516da Merge tag 'rtc-6.7' of =
...
Merging char-misc.current/char-misc-linus (d2f51b3516da Merge tag 'rtc-6.7'=
...
Merging mm/mm-everything (4f5e05649c22 mm: zswap: fix the lack of page lru =
flag in zswap_writeback_entry)
...
ite-only variable)
Merging risc-v/for-next (dbfbda3bd6bf riscv: mm: update T-Head memory type =
definitions)
...
Merging cifs/for-next (bc05fd25483b smb3: minor cleanup of session handling=
 code)
...
org/pub/scm/linux/kernel/git/abelloni/linux)
Merging char-misc/char-misc-next (d2f51b3516da Merge tag 'rtc-6.7' of git:/=
...
Merging staging/staging-next (d2f51b3516da Merge tag 'rtc-6.7' of git://git=
...

=fwu4
-----END PGP SIGNATURE-----
