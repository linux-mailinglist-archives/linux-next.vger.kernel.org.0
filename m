...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id AC2354157CA
	for <lists+linux-next@lfdr.de>; Thu, 23 Sep 2021 07:17:17 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231214AbhIWFSq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 23 Sep 2021 01:18:46 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33654 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229504AbhIWFSp (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 23 Sep 2021 01:18:45 -0400
X-Greylist: delayed 483 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Wed, 22 Sep 2021 22:17:14 PDT
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 76B8BC061574;
        Wed, 22 Sep 2021 22:17:14 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HFNVl6VY7z4xZJ;
        Thu, 23 Sep 2021 15:09:03 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1632373744;
        bh=Y7oK1BWdOa/cdMG/WwVqShUdVLCD4hLOb6s/qA/zN30=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 23 Sep 2021 15:09:02 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 23
Message-ID: <20210923150902.41f6b346@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8=pvCW76swmOYHg3mV58P+r";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/8=pvCW76swmOYHg3mV58P+r
...
Merging origin/master (58e2cf5d7946 init: Revert accidental changes to prin=
t irqs_disabled())
...
Merging net/master (977d293e23b4 mptcp: ensure tx skbs always have the MPTC=
P ext)
...
Merging rdma-fixes/for-rc (9f7fa37a6bd9 RDMA/irdma: Report correct WC error=
 when there are MW bind errors)
...
Merging qcom/for-next (97ba6e8f4279 Merge branches 'arm64-for-5.16', 'drive=
...
Merging cifsd/cifsd-for-next (e6201b4a0bac ksmbd: add request buffer valida=
tion in smb2_set_info)
...
g.c
Merging drm-intel/for-linux-next (52913626cf9a drm/i915: Apply WaUse32BppFo=
rSRWM to elk as well as ctg)
...
s without flash)
Merging block/for-next (4c6354a03d69 Merge branch 'for-5.16/cdrom' into for=
-next)
...
16' into spi-next)
Merging tip/auto-latest (dcb7b66df80d Merge branch 'tip-x86-misc' into tip-=
auto-latest)
...
isting file)
Merging gpio-brgl/gpio/for-next (03e2080defd2 gpio: tps65218: drop unneeded=
 MODULE_ALIAS)
...

=rV6p
-----END PGP SIGNATURE-----
