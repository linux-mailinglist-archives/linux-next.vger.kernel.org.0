...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 71548153DCB
	for <lists+linux-next@lfdr.de>; Thu,  6 Feb 2020 05:09:13 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727572AbgBFEJM (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 5 Feb 2020 23:09:12 -0500
Received: from ozlabs.org ([203.11.71.1]:59423 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727415AbgBFEJM (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 5 Feb 2020 23:09:12 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48ClL611N0z9sRK;
        Thu,  6 Feb 2020 15:09:02 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1580962142;
        bh=sHshrjfzGZYJU0egXGMjqMjhkIiawTOLIMCuHczisZA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 6 Feb 2020 15:09:01 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 6
Message-ID: <20200206150901.6f9f792e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ppgJnsdazrvAVNDTW+qdUNR";
...
The clk tree gained a conflict against the devicetree-fixes tree.

The vfs tree gained a conflict against the nfs-anna tree.

Non-merge commits (relative to Linus' tree): 2195
 1976 files changed, 81134 insertions(+), 33479 deletions(-)
...
Merging origin/master (4c7d00ccf40d Merge tag 'pwm/for-5.6-rc1' of git://gi=
...
Merging net/master (0202d293c2fa qed: Fix timestamping issue for L2 unicast=
 ptp packets.)
...
Merging sound-current/for-linus (9db028827315 Merge tag 'asoc-v5.6-2' of ht=
tps://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-linus)
Merging sound-asoc-fixes/for-linus (cc9211b01860 Merge branch 'asoc-5.6' in=
to asoc-linus)
...
Merging staging.current/staging-linus (6992ca0dd017 Merge branch 'parisc-5.=
6-1' of git://git.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux)
Merging char-misc.current/char-misc-linus (6992ca0dd017 Merge branch 'paris=
c-5.6-1' of git://git.kernel.org/pub/scm/linux/kernel/git/deller/parisc-lin=
ux)
...
itch fall-throughs)
Merging kbuild/for-next (089b7d890f97 kconfig: Invalidate all symbols after=
 changing to y or m.)
...
Merging cifs/for-next (b0dd940e582b cifs: fail i/o on soft mounts if sessio=
nsetup errors out)
...
in imxfb_probe())
Merging pm/linux-next (c8ebedc1c2f7 Merge branches 'pm-cpufreq' and 'pm-cpu=
...
Merging amdgpu/drm-next (84f62c380fa4 drm/amdgpu: drop legacy drm load and =
unload callbacks)
...
-next)
Merging sound/for-next (9db028827315 Merge tag 'asoc-v5.6-2' of https://git=
.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-linus)
Merging sound-asoc/for-next (cc9211b01860 Merge branch 'asoc-5.6' into asoc=
-linus)
...
er reference)
Merging driver-core/driver-core-next (6992ca0dd017 Merge branch 'parisc-5.6=
-1' of git://git.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux)
Merging usb/usb-next (6992ca0dd017 Merge branch 'parisc-5.6-1' of git://git=
.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux)
...
Merging tty/tty-next (6992ca0dd017 Merge branch 'parisc-5.6-1' of git://git=
.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux)
Merging char-misc/char-misc-next (6992ca0dd017 Merge branch 'parisc-5.6-1' =
...
Merging staging/staging-next (6992ca0dd017 Merge branch 'parisc-5.6-1' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/deller/parisc-linux)
...
rflow
Merging akpm/master (7746c03b5717 drivers/media/platform/sti/delta/delta-ip=
...

=MALr
-----END PGP SIGNATURE-----
