...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 215A3F28BB
	for <lists+linux-next@lfdr.de>; Thu,  7 Nov 2019 09:07:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727558AbfKGIHh (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 7 Nov 2019 03:07:37 -0500
Received: from ozlabs.org ([203.11.71.1]:33257 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727517AbfKGIHh (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 7 Nov 2019 03:07:37 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 477wxF3rvnz9sNx;
        Thu,  7 Nov 2019 19:07:29 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1573114049;
        bh=lbqapvltiZ3cFxcaCNM7h018lqR/CXUNkltShtA7bFA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 7 Nov 2019 19:07:26 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 7
Message-ID: <20191107190726.18798e8a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//Y_SoEZ9OyZrDYpdWw80n2I";
...
Merging net/master (cc59dbcc5ddd Merge branch 'net-bcmgenet-restore-interna=
l-EPHY-support')
Merging bpf/master (2836654a2735 Documentation: TLS: Add missing counter de=
scription)
...
q->buf_list)
Merging sound-current/for-linus (e7af6307a8a5 ALSA: timer: Fix incorrectly =
assigned timer instance)
Merging sound-asoc-fixes/for-linus (bf038dc61844 Merge branch 'asoc-5.4' in=
to asoc-linus)
Merging regmap-fixes/for-linus (da0c9ea146cb Linux 5.4-rc2)
Merging regulator-fixes/for-linus (3e68d0b7dd0d Merge branch 'regulator-5.4=
' into regulator-linus)
Merging spi-fixes/for-linus (105df12dfc17 Merge branch 'spi-5.4' into spi-l=
inus)
...
Merging drm-misc-fixes/for-linux-next-fixes (86de88cfeb7c drm/atomic: fix s=
elf-refresh helpers crtc state dereference)
Merging kspp-gustavo/for-next/kspp (da0c9ea146cb Linux 5.4-rc2)
Merging kbuild/for-next (12bbeb70afd5 kconfig: be more helpful if pkg-confi=
g is missing)
...
Merging arm/for-next (cb73737ea1d2 ARM: 8928/1: ARM_ERRATA_775420: Spelling=
 s/date/data/)
Merging arm64/for-next/core (8017874136b2 Merge branch 'for-next/misc' into=
 for-next/core)
...
ripe_count !=3D 1)
Merging cifs/for-next (525479c9cc92 cifs: update internal module version nu=
mber)
...
Merging bpf-next/master (ed578021210e libbpf: Simplify BPF_CORE_READ_BITFIE=
LD_PROBED usage)
...
Merging amdgpu/drm-next (2b55cbb683a4 drm/amdgpu: work around llvm bug #425=
76)
$ git reset --hard HEAD^
...
Merging sound/for-next (fdea53fe5de5 ALSA: timer: Limit max amount of slave=
 instances)
Merging sound-asoc/for-next (c446f6e92ad5 Merge branch 'asoc-5.5' into asoc=
-next)
...
Merging input/next (d843304b22e8 Input: synaptics-rmi4 - simplify data read=
 in rmi_f54_work)
Merging block/for-next (6cb45494b140 Merge branch 'for-5.5/io_uring' into f=
or-next)
Merging device-mapper/for-next (72d7df4c8079 dm dust: add limited write fai=
lure mode)
...
Merging regulator/for-next (d93e0c3c4686 Merge branch 'regulator-5.5' into =
regulator-next)
...
register value)
Merging spi/for-next (c2341e17a7c6 Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
Merging pinctrl-intel/for-next (624eeebdcf1e pinctrl: cherryview: Missed ty=
...
Merging akpm-current/current (4e7c0599c893 ipc/msg.c: consolidate all xxxct=
l_down() functions)
...
rflow
Merging akpm/master (67fcf1deed7d drivers/media/platform/sti/delta/delta-ip=
...

=OmlF
-----END PGP SIGNATURE-----
