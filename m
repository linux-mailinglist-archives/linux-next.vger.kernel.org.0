...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E2C1B739811
	for <lists+linux-next@lfdr.de>; Thu, 22 Jun 2023 09:28:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229676AbjFVH2X (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 22 Jun 2023 03:28:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42346 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229468AbjFVH2W (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 22 Jun 2023 03:28:22 -0400
Received: from mail-ot1-x32e.google.com (mail-ot1-x32e.google.com [IPv6:2607:f8b0:4864:20::32e])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AA5941730
        for <linux-next@vger.kernel.org>; Thu, 22 Jun 2023 00:28:18 -0700 (PDT)
Received: by mail-ot1-x32e.google.com with SMTP id 46e09a7af769-6b5d57d7db9so1011609a34.3
        for <linux-next@vger.kernel.org>; Thu, 22 Jun 2023 00:28:18 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1687418897; x=1690010897;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=zaME+x/B8klDWrze7KwiZ7Eil9dMyryq86hEcVozO0c=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1687418897; x=1690010897;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=zaME+x/B8klDWrze7KwiZ7Eil9dMyryq86hEcVozO0c=;
        b=
X-Gm-Message-State: AC+VfDy+NOovHNJWoye4GJYsKzEv9uOPaOX/zlVbDSvHz1twf3BjkEz1
        Q6L1k46cZJ4p8JZm9HpJiNbjgzRnUpvOSPMIxI/U8A==
X-Google-Smtp-Source: ACHHUZ4uoRCSHooy4YZxRjAHvhyn4teaIJqgwXeEKUAtGf+7pPLz3EEBIDdo3tq5kiSB/0pG0U4lJg==
X-Received: by 2002:a05:6359:21a:b0:132:d44e:4401 with SMTP id ej26-20020a056359021a00b00132d44e4401mr459115rwb.27.1687418896159;
        Thu, 22 Jun 2023 00:28:16 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id s4-20020a63d044000000b0053f5ff753e2sm4224193pgi.23.2023.06.22.00.28.15
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 22 Jun 2023 00:28:15 -0700 (PDT)
Message-ID: <6493f80f.630a0220.1c1bf.96be@mx.google.com>
Date:   Thu, 22 Jun 2023 00:28:15 -0700 (PDT)
...
Subject: next/master build: 201 builds: 8 failed, 193 passed, 18 errors,
 58 warnings (next-20230622)
...
next/master build: 201 builds: 8 failed, 193 passed, 18 errors, 58 warnings=
 (next-20230622)
...
Tree: next
Branch: master
Git Describe: next-20230622
Git Commit: c87d46a9e8ebd2f2c3960927b1d21687096d1109
...
Errors summary:
    ...
    4    drivers/clk/ralink/clk-mtmips.c:359:9: error: variable 'ret' is un=
initialized when used here [-Werror,-Wuninitialized]
    4    drivers/clk/ralink/clk-mtmips.c:309:9: error: variable 'ret' is un=
initialized when used here [-Werror,-Wuninitialized]
...
vec_from_user.part.0() with UACCESS enabled
    4    vmlinux.o: warning: objtool: .altinstr_replacement+0x18f3: redunda=
nt UACCESS disable
    4    drivers/clk/ralink/clk-mtmips.c:335:9: note: initialize the variab=
le 'ret' to silence this warning
    4    drivers/clk/ralink/clk-mtmips.c:285:9: note: initialize the variab=
le 'ret' to silence this warning
    3    kernel/umh.c:497:12: warning: =E2=80=98proc_cap_handler=E2=80=99 d=
efined but not used [-Wunused-function]
    2    vmlinux.o: warning: objtool: .altinstr_replacement+0x1f30: redunda=
nt UACCESS disable
    2    vmlinux.o: warning: objtool: .altinstr_replacement+0x18fd: redunda=
nt UACCESS disable
    2    WARNING: modpost: EXPORT symbol "_mcount" [vmlinux] version genera=
tion failed, symbol will not be versioned.
    1    vmlinux.o: warning: objtool: __import_iovec+0x342: call to copy_io=
vec_from_user.part.0() with UACCESS enabled
    1    vmlinux.o: warning: objtool: .altinstr_replacement+0x1aae: redunda=
nt UACCESS disable
    1    vmlinux.o: warning: objtool: .altinstr_replacement+0x1907: redunda=
nt UACCESS disable
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-17) =E2=80=94 FAIL, 2 errors, 2 warnings, 0 sectio=
n mismatches
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x18f3: redundant UA=
CCESS disable
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x18fd: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
    vmlinux.o: warning: objtool: __import_iovec+0x147: call to copy_iovec_f=
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1907: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
    vmlinux.o: warning: objtool: __import_iovec+0x147: call to copy_iovec_f=
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1aae: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1f30: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
    vmlinux.o: warning: objtool: __import_iovec+0x147: call to copy_iovec_f=
