...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5FE0E29FCA2
	for <lists+linux-next@lfdr.de>; Fri, 30 Oct 2020 05:13:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725806AbgJ3ENV (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 30 Oct 2020 00:13:21 -0400
Received: from ozlabs.org ([203.11.71.1]:51633 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725797AbgJ3ENU (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 30 Oct 2020 00:13:20 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CMpnj0vsJz9sSG;
        Fri, 30 Oct 2020 15:13:13 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1604031193;
        bh=p30D08rXAYAzK9DUdnqAAgN6GRXW4e07SzxNVv2NF0M=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 30 Oct 2020 15:13:09 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 30
Message-ID: <20201030151309.67ba5e3a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Oo3XJIeVmZidQJ4r=YNkdx=";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/Oo3XJIeVmZidQJ4r=YNkdx=
...
Merging origin/master (07e088730245 Merge tag 'fallthrough-fixes-clang-5.10=
-rc2' of git://git.kernel.org/pub/scm/linux/kernel/git/gustavoars/linux)
...
Merging arm64-fixes/for-next/fixes (96d389ca1011 arm64: Add workaround for =
Arm Cortex-A77 erratum 1508412)
Merging arm-soc-fixes/arm/fixes (deaafe8edde7 Merge tag 'sunxi-fixes-for-5.=
...
Merging net/master (07e088730245 Merge tag 'fallthrough-fixes-clang-5.10-rc=
2' of git://git.kernel.org/pub/scm/linux/kernel/git/gustavoars/linux)
Merging bpf/master (0698ac66e010 tools, bpftool: Remove two unused variable=
s.)
...
Merging sound-asoc-fixes/for-linus (838c70799b04 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (9b3a2f2e8a67 Merge remote-tracking branch 'spi=
...
sion)
Merging usb.current/usb-linus (712da5fc4a66 xhci: Don't create stream debug=
fs files with spinlock held.)
...
Merging usb-chipidea-fixes/for-usb-fixes (8c354998ff88 usb: cdns3: Fix on-c=
hip memory overflow issue)
...
Merging char-misc.current/char-misc-linus (80624263fa28 coresight: cti: Ini=
tialize dynamic sysfs attributes)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (55fc0bc9d97b lockdep: Fix nr_=
unused_locks)
...
Merging kspp-gustavo/for-next/kspp (080bd2ae9a6c printk: ringbuffer: Replac=
...
Merging net-next/master (1c29d9899081 Merge git://git.kernel.org/pub/scm/li=
...
ice.c
Merging drm-intel/for-linux-next (96eaeb3dfa40 drm/i915: Use _MMIO_PIPE3() =
for ilk+ WM0_PIPE registers)
...
Merging drm-misc/for-linux-next (fa3bfa3527b3 drm: Quieten [zero] EDID carp=
ing)
...
Merging sound-asoc/for-next (715235e5162d Merge remote-tracking branch 'aso=
...
ouch input driver)
Merging block/for-next (0dae148b7cfa Merge branch 'for-5.11/io_uring' into =
for-next)
...
rning)
Merging tpmdd/next (fb342e8868ed tpm: efi: Don't create binary_bios_measure=
...
rom callback)
Merging spi/for-next (3d9e5d3bd229 Merge remote-tracking branch 'spi/for-5.=
11' into spi-next)
...
y 'kvm_run' cleanup)
Merging kvm-arm/next (91a2c34b7d6f KVM: arm64: Force PTE mapping on fault r=
esulting in a device mapping)
...
Merging staging/staging-next (c2ec4a6e5410 staging: vc04_services: fix quot=
ed string split across lines)
...
Merging vhost/linux-next (f12da77e3aac vdpa: handle irq bypass register fai=
lure case)
...
Merging gpio-brgl/gpio/for-next (43ddebdd0966 gpio: mockup: Allow probing f=
rom device tree)
...
Merging akpm/master (4ed854ff97e9 mm/gup: assert that the mmap lock is held=
 in __get_user_pages())
...

=lyiE
-----END PGP SIGNATURE-----
