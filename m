Return-Path: <linux-next+bounces-3888-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 9A1F297AB2F
	for <lists+linux-next@lfdr.de>; Tue, 17 Sep 2024 07:57:03 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 34C24285788
	for <lists+linux-next@lfdr.de>; Tue, 17 Sep 2024 05:57:02 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E229E45C0B;
	Tue, 17 Sep 2024 05:56:58 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="uEaCNE+0"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 14489EACD;
	Tue, 17 Sep 2024 05:56:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1726552618; cv=none; b=LPIctXHeJRzE1+Otx7rC/5bbTpGnSujlptDGqAEVI29PtIDL4psLpIlbly55OKGuNXip48MGWbo+2iCzcERSc6WOc9Cy8Wt9+o2e97Ufjt8uqQe3kG/sPisSdb4uWLhTl2uiyAdHZ5nEbQc5e6tIO6rFiaj6PaylSWyHWdtblNQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1726552618; c=relaxed/simple;
	bh=G9KH3iEPFSquqJ8uo0VYeiDTprxGt1pHaKaEadQpFDo=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=QJq1nusJK1GCcFzXw5k7cw0ELmS0Lhj0Th+3KyMTmH8k/xCWWspps3Id0IKF4JVH9LGPMQb6BuwBaVhKspvsHJr7v3VaSGSpVhn/7ipYxULJoyAoNCReQ4W0z5jgARA4okbYROXYqijgdMezNHMi74qCxgqTfI10YUXhFRj3JDw=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=uEaCNE+0; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1726552611;
	bh=VMhehFlZ9Vfl+Ys8l0itIoviPu3wrwAplw7VZWzUlvc=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4X79yq0MtTz4x8X;
	Tue, 17 Sep 2024 15:56:51 +1000 (AEST)
Date: Tue, 17 Sep 2024 15:56:50 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 17
Message-ID: <20240917155650.591c47a7@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/f2A1h78zDXTo5lPLu0ai6J4";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/f2A1h78zDXTo5lPLu0ai6J4
...
Changes since 20240916:

I added a supplied patch to fix the net-next tree's build failure (this
failure is now in Linus' tree).
...
Non-merge commits (relative to Linus' tree): 8758
 8734 files changed, 342405 insertions(+), 166036 deletions(-)
...
Merging origin/master (a430d95c5efa Merge tag 'lsm-pr-20240911' of git://gi=
t.kernel.org/pub/scm/linux/kernel/git/pcmoore/lsm)
Merging fixes/fixes (4a614c4d8e81 powerpc/atomic: Use YZ constraints for DS=
-form instructions)
...
ph_dns_resolve_name())
Merging cifs/for-next (e6de7c7445bf smb: client: fix compression heuristic =
functions)
...
etup times out)
Merging nfsd/nfsd-next (bc20581cfdd7 xdrgen: Prevent reordering of encoder =
...
Merging mm-hotfixes/mm-hotfixes-unstable (e2e465b039ee mm/madvise: process_=
madvise() drop capability check if same mm)
Merging fs-current (da36ee529b11 Merge branch 'fixes' of git://git.kernel.o=
...
Merging mm-nonmm-stable/mm-nonmm-stable (dab2214fec60 treewide: correct the=
 typo 'retun')
Merging mm/mm-everything (3a1435035b77 foo)
...
Merging fs-next (8639f637fc71 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
CONFLICT (content): Merge conflict in fs/bcachefs/fs.c
...
eback on SM6350)
Merging drm-xe/drm-xe-next (bc6763187270 drm/xe/rtp: Remove unneeded semico=
lon)
...
Merging block/for-next (a46c4336b17a Merge branch 'for-6.12/io_uring' into =
for-next)
...
Merging watchdog/master (7890d81abe66 watchdog: Convert comma to semicolon)
...
Merging drivers-x86/for-next (df40a23cc34c platform/x86: x86-android-tablet=
s: Adjust Xiaomi Pad 2 bottom bezel touch buttons LED)
...
Merging random/master (210860e7f733 selftests: vDSO: check cpu caps before =
running chacha test)
...

=fZ2k
-----END PGP SIGNATURE-----
