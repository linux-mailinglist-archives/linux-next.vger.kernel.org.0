Return-Path: <linux-next+bounces-5352-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id AED6AA23920
	for <lists+linux-next@lfdr.de>; Fri, 31 Jan 2025 05:17:11 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id B10C61889ADD
	for <lists+linux-next@lfdr.de>; Fri, 31 Jan 2025 04:17:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 26B60381B9;
	Fri, 31 Jan 2025 04:17:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="vFyOzAzO"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 632C120EB;
	Fri, 31 Jan 2025 04:16:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1738297025; cv=none; b=fg8d1nuHXoBVy52uj27EJfoS9q2V3Vk5PNLutvcMQzBXta3BJJnnI4oXnVSVI3bC5rMFwEDnpeBUMAUWhYGUXMrmuDXaj2VRIQ/WVlf2WhGQmAMeXaew6oSeLs+3L1ZinERjgcKhlYtgcOvluUdk3YdZaoG1vwnpIvA/cpFdL14=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1738297025; c=relaxed/simple;
	bh=XfshhuIQxdiLxJZCAXQq8B4KJiRoig9xbUbuDKzA53E=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=sgz/H27iBRAJHji3TmoPD6vD2vnoSyhFihWZJt6YhCk2TGWMemK2qCSyokwGfP5yt6/HLo7A0qEiGZK92pO/g9NHF2S7EZVkr6oUTkxAS0H8PYQanLnl9XrEquvR7d4AQZPyUANdeLD0xF63jsbN013fe835S1N+7CAYdacfkU0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=vFyOzAzO; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1738297004;
	bh=gpIgLfcmhNYp2t113NqItfwvbAHmzYXVqN+yDoWdV4o=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YkjJX5YLzz4x21;
	Fri, 31 Jan 2025 15:16:44 +1100 (AEDT)
Date: Fri, 31 Jan 2025 15:16:52 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 31
Message-ID: <20250131151652.4d4bd8ec@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/QYxS6kfkHmO+QSnA6puZOnn";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/QYxS6kfkHmO+QSnA6puZOnn
...
Non-merge commits (relative to Linus' tree): 738
 953 files changed, 26652 insertions(+), 9115 deletions(-)
...
I am currently merging 389 trees (counting Linus' and 148 trees of bug
...
Merging origin/master (b4b0881156fb Merge tag 'docs-6.14-2' of git://git.lw=
n.net/linux)
...
X)
Merging cifs/for-next (7746596c2f35 cifs: update internal version number)
...
Merging mm-hotfixes/mm-hotfixes-unstable (84dbf53d56e5 mm/hugetlb: fix huge=
page allocation for interleaved memory nodes)
Merging fs-current (e103ea35f700 Merge branch 'fixes' of git://git.kernel.o=
...
ddr() for s390)
Merging net/main (dfffaccffc53 Merge tag 'nf-25-01-30' of git://git.kernel.=
...
Merging kbuild/for-next (a409fc1463d6 kconfig: fix memory leak in sym_warn_=
unmet_dep())
...
CONFLICT (modify/delete): tools/testing/selftests/riscv/vector/v_initval_no=
libc.c deleted in risc-v/for-next and modified in HEAD.  Version HEAD of to=
ols/testing/selftests/riscv/vector/v_initval_nolibc.c left in tree.
CONFLICT (content): Merge conflict in tools/testing/selftests/riscv/vector/=
vstate_prctl.c
$ git rm -f tools/testing/selftests/riscv/vector/v_initval_nolibc.c
...
Merging fs-next (9180210f9984 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging drm-xe/drm-xe-next (220ed690436e Merge drm/drm-next into drm-xe-nex=
t)
...
gFields)
Merging kvms390/next (8bc53739bc8f KVM: s390: selftests: Streamline uc_skey=
...

=KviV
-----END PGP SIGNATURE-----
