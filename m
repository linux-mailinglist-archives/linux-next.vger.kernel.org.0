...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 5E764757297
	for <lists+linux-next@lfdr.de>; Tue, 18 Jul 2023 05:57:44 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230096AbjGRD5m (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 17 Jul 2023 23:57:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47356 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229732AbjGRD5m (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 17 Jul 2023 23:57:42 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 5666C194;
        Mon, 17 Jul 2023 20:57:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1689652655;
        bh=jncEft/44krdMg3Gp8GPMN03csMGPwPdW5+99t0OefY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4R4lXH5SMTz4wb8;
        Tue, 18 Jul 2023 13:57:35 +1000 (AEST)
Date:   Tue, 18 Jul 2023 13:57:33 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 18
Message-ID: <20230718135733.0f1789a4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/.GlqsDzzENE/VqAAb21_xIc";
...
The mm tree gained 2 build failures so I used the version from
next-20230717.

The bluetooth tree still had its build failure for which I reverted a commi=
t.

Non-merge commits (relative to Linus' tree): 2634
...
Merging origin/master (fdf0eaf11452 Linux 6.5-rc2)
Merging fixes/fixes (d528014517f2 Revert ".gitignore: ignore *.cover and *.=
mbx")
Merging mm-hotfixes/mm-hotfixes-unstable (8eaa85c02717 mm-shmem-fix-race-in=
...
Merging net/main (162d626f3013 r8169: fix ASPM-related problem for chip ver=
sion 42 and 43)
...
r unload)
Merging sound-current/for-linus (057849ccc3d8 ALSA: seq: Fix memory leak at=
 error path in snd_seq_create_port())
Merging sound-asoc-fixes/for-linus (44cebde45a8b Merge remote-tracking bran=
ch 'asoc/for-6.4' into asoc-linus)
Merging regmap-fixes/for-linus (fdf0eaf11452 Linux 6.5-rc2)
Merging regulator-fixes/for-linus (2423ca6dd7ca Merge remote-tracking branc=
h 'regulator/for-6.4' into regulator-linus)
Merging spi-fixes/for-linus (e6d4c24fce0f Merge remote-tracking branch 'spi=
...
Merging char-misc.current/char-misc-linus (fdf0eaf11452 Linux 6.5-rc2)
...
Merging drm-intel-fixes/for-linux-next-fixes (fdf0eaf11452 Linux 6.5-rc2)
...
Merging mm/mm-everything (64b17ddeb675 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: Revert "mm/mmap: change detached vma locking scheme"
$ git reset --hard HEAD^
Merging next-20230717 version of mm
...
Merging qcom/for-next (92291bb48c63 Merge branches 'arm64-defconfig-for-6.6=
...
ength checks)
Merging hwmon-staging/hwmon-next (e2cc1f04da73 hwmon: Remove smm665 driver)
...
Merging pm/linux-next (540792999344 Merge branch 'acpi-video' into linux-ne=
xt)
...
ity)
Merging net-next/main (60cc1f7d0605 Merge branch 'phy-at803x-support')
...
Merging regmap/for-next (1c004e45fffb Merge remote-tracking branch 'regmap/=
for-6.6' into regmap-next)
Merging sound/for-next (6d68d9cba1d0 ALSA: emu10k1: rework copyright statem=
ents)
Merging ieee1394/for-next (06c2afb862f9 Linux 6.5-rc1)
Merging sound-asoc/for-next (78b31c16983b Merge remote-tracking branch 'aso=
...
Merging tpmdd/next (481c2d14627d tpm,tpm_tis: Disable interrupts after 1000=
 unhandled IRQs)
...
Merging spi/for-next (f75e9322ebf4 Merge remote-tracking branch 'spi/for-6.=
6' into spi-next)
Merging tip/master (8d262a1f1c12 Merge branch into tip/master: 'sched/core')
...
ludes)
Merging icc/icc-next (9deb9651b40f Merge branch 'icc-fixes' into icc-next)
Merging iio/togreg (d9b431026523 dt-bindings: iio: adc: qcom,spmi-adc7: use=
 predefined channel ids)
Merging phy-next/next (7559e7572c03 phy: Explicitly include correct DT incl=
udes)
...
pendency)
Merging cgroup/for-next (c25ff4b911a1 cgroup: remove cgrp->kn check in css_=
populate_dir())
...
Merging bitmap/bitmap-for-next (f789b0eb6106 lib: test for_each_numa_cpus())
...

=penW
-----END PGP SIGNATURE-----
