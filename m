...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 7E9CA193E0E
	for <lists+linux-next@lfdr.de>; Thu, 26 Mar 2020 12:40:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727948AbgCZLkH (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 26 Mar 2020 07:40:07 -0400
Received: from ozlabs.org ([203.11.71.1]:33729 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727560AbgCZLkG (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 26 Mar 2020 07:40:06 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48p31s4Xggz9sQx;
        Thu, 26 Mar 2020 22:40:01 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=ellerman.id.au;
        s=201909; t=1585222802;
        bh=3cgH+7o0AnHVdzJ12xXo4FzKzgbKt96W7hCpGyqsKB0=;
        h=From:To:Cc:Subject:In-Reply-To:References:Date:From;
        b=
...
Date:   Thu, 26 Mar 2020 22:40:06 +1100
Message-ID: <87h7ybwdih.fsf@mpe.ellerman.id.au>
MIME-Version: 1.0
...
> I am running into intermittent crashes with linux-next on POWER 9 PowerVM=
 LPAR
> First it was against next-20200324 while running LTP tests. With next-202=
00325
...
udp_diag inet_diag unix_diag af_packet_diag netlink_diag binfmt_misc overla=
y dm_mod nf_conntrack nf_defrag_ipv6 nf_defrag_ipv4 libcrc32c ip6_tables nf=
t_compat ip_set rfkill nf_tables nfnetlink sunrpc sg pseries_rng uio_pdrv_g=
enirq uio sch_fq_codel ip_tables ext4 mbcache jbd2 sr_mod sd_mod cdrom t10_=
pi ibmvscsi scsi_transport_srp ibmveth
> CPU: 26 PID: 7771 Comm: avocado Not tainted 5.6.0-rc7-next-20200324-autot=
est #1
> NIP:  c00000000043f278 LR: c00000000043f330 CTR: 00000000000001fb
> REGS: c00000082802f830 TRAP: 0300   Not tainted  (5.6.0-rc7-next-20200324=
-autotest)
...
> GPR00: c00000000043f330 c00000082802fac0 c00000000155e900 000000000000000=
0=20
> GPR04: 0000000000000002 0000000000000000 0000000000000002 c0000008b340000=
0=20
> GPR08: 0000000000031419 0000000000000000 0000000000000000 ffffffffffff000=
0=20
> GPR12: 0000000000008000 c00000001ec48600 00007fffa08a53f8 000000000000000=
1=20
> GPR16: 00007fff9faf9a63 00000100073bec00 00007fff9f2493b0 000000000000000=
0=20
> GPR20: 00007fffa1143bf8 00007fffa1103b18 c00000087f547cb3 2f2f2f2f2f2f2f2=
f=20
> GPR24: 0000000000000003 0000000000000000 c00000082802fbc8 fffffffffffff00=
0=20
> GPR28: 0000000000200000 ffffffffffffffff 61c8864680b583eb 000000000000000=
0=20
...
>     6dc4:       20 00 c9 ea     ld      r22,32(r9)
>                         link =3D walk_component(nd, 0);
>     6dc8:       01 00 00 48     bl      6dc8 <link_path_walk.part.49+0x21=
8>
>                 if (unlikely(link)) {
>     6dcc:       00 00 a3 2f     cmpdi   cr7,r3,0
>     6dd0:       c8 00 9e 40     bne     cr7,6e98 <link_path_walk.part.49+=
0x2e8>
>         return dentry->d_flags & DCACHE_ENTRY_TYPE;
>     6dd4:       08 00 3a e9     ld      r9,8(r26)
>     6dd8:       00 00 29 81     lwz     r9,0(r9)  <<=3D=3D=3D crashes her=
e ??
...
>
> The code in question (link_path_walk() in fs/namei.c ) was recently chang=
ed by
> following commit:
>
> commit 881386f7e46a:=20
>   link_path_walk(): sample parent's i_uid and i_mode for the last compone=
nt
...
> [ 1917.926136] LE PAGE_SIZE=3D64K MMU=3DHash SMP NR_CPUS=3D2048 NUMA pSer=
ies
...
> [ 1917.926161] Modules linked in: iscsi_target_mod target_core_mod macsec=
 tcp_diag udp_diag inet_diag unix_diag af_packet_diag netlink_diag binfmt_m=
isc overlay dm_mod nf_conntrack nf_defrag_ipv6 nf_defrag_ipv4 libcrc32c ip6=
_tables nft_compat ip_set rfkill nf_tables nfnetlink sunrpc sg pseries_rng =
uio_pdrv_genirq uio sch_fq_codel ip_tables ext4 mbcache jbd2 sr_mod cdrom s=
d_mod t10_pi ibmvscsi scsi_transport_srp ibmveth
> [ 1917.926198] CPU: 12 PID: 20734 Comm: busctl Not tainted 5.6.0-rc7-next=
-20200325-autotest #1
> [ 1917.926203] NIP:  c00000000043f638 LR: c00000000043f6f0 CTR: 000000000=
0000000
> [ 1917.926209] REGS: c00000082bc1f720 TRAP: 0300   Not tainted  (5.6.0-rc=
7-next-20200325-autotest)
> [ 1917.926215] MSR:  8000000000009033 <SF,EE,ME,IR,DR,RI,LE>  CR: 2802242=
2  XER: 20040000
> [ 1917.926222] CFAR: c00000000000dec4 DAR: 0000000000000000 DSISR: 400000=
00 IRQMASK: 0=20
> [ 1917.926222] GPR00: c00000000043f6f0 c00000082bc1f9b0 c00000000155e800 =
0000000000000000=20
> [ 1917.926222] GPR04: 0000000000000002 0000000000000000 0000000000000002 =
c0000008b3400000=20
> [ 1917.926222] GPR08: 000000000000febb 0000000000000000 0000000000000000 =
ffffffffffff0000=20
> [ 1917.926222] GPR12: 0000000000002000 c00000001ec5d600 0000000135ed11e0 =
c0000008879046d0=20
> [ 1917.926222] GPR16: 7fffffffffffffff fffffffffffffe00 fffffffffffffffc =
fffffffffffffff5=20
> [ 1917.926222] GPR20: c00000089fa27200 0000000000000000 c00000008609bf33 =
2f2f2f2f2f2f2f2f=20
> [ 1917.926222] GPR24: 0000000000000003 0000000000000000 c00000082bc1fab8 =
fffffffffffff000=20
> [ 1917.926222] GPR28: 0000000000200000 ffffffffffffffff 61c8864680b583eb =
0000000000000001=20
...
> [ 1917.926284] [c00000082bc1f9b0] [c00000000043f6f0] link_path_walk.part.=
49+0x2e0/0x400 (unreliable)
> [ 1917.926291] [c00000082bc1fa40] [c00000000043f964] path_lookupat.isra.5=
1+0x64/0x1f0
> [ 1917.926296] [c00000082bc1fa90] [c000000000441fc0] filename_lookup.part=
.69+0xa0/0x1b0
> [ 1917.926303] [c00000082bc1fbd0] [c000000000ae0784] unix_find_other+0x64=
/0x3f0
> [ 1917.926309] [c00000082bc1fc60] [c000000000ae1b78] unix_stream_connect+=
0x148/0x930
> [ 1917.926316] [c00000082bc1fd30] [c000000000933010] __sys_connect+0x140/=
0x170
...
> [ 1917.926336] 3bffffff e93a0058 38800000 7f43d378 7fff07b4 1d5f0030 7d29=
5214 eac90020=20
> [ 1917.926343] 4bfffb21 2fa30000 409e00c8 e93a0008 <81290000> 55290256 7f=
89e000 419efecc=20
...
>  */
> unsigned int full_name_hash(const void *salt, const char *name, unsigned =
int len)
> {
>        0:	a6 02 08 7c 	mflr    r0
>        4:	01 00 00 48 	bl      4 <full_name_hash+0x4>
> 	unsigned long a, x =3D 0, y =3D (unsigned long)salt;
>
> 	for (;;) {
> 		if (!len)
> .........
...
> 		hash_len =3D hash_name(nd->path.dentry, name);
...
> 		if (name[0] =3D=3D '.') switch (hashlen_len(hash_len)) {
...
> 		nd->last.hash_len =3D hash_len;
>     6d88:	10 00 3a f9 	std     r9,16(r26)
> 		nd->last.name =3D name;
>     6d8c:	18 00 da fa 	std     r22,24(r26)
> 		nd->last_type =3D type;
...
> 			link =3D walk_component(nd, WALK_MORE);
...
> 				err =3D parent->d_op->d_hash(parent, &this);
>     6ef0:	60 00 43 e9 	ld      r10,96(r3)
> 				struct qstr this =3D { { .hash_len =3D hash_len }, .name =3D name };
...
> 				nd->dir_mode =3D nd->inode->i_mode;
