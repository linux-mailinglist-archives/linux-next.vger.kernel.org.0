...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3EE758B3F7
	for <lists+linux-next@lfdr.de>; Tue, 13 Aug 2019 11:19:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726811AbfHMJTc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 13 Aug 2019 05:19:32 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:56791 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726282AbfHMJTc (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 13 Aug 2019 05:19:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4676bx4jWDz9s7T;
        Tue, 13 Aug 2019 19:19:25 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1565687965;
        bh=OAARQcftDzVGxxU32VA1SNAcKYYPmOxjcD6qnAZyW70=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 13 Aug 2019 19:19:24 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 13
Message-ID: <20190813191924.7c5310dd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/a=BCKORpvcPsusviz4i07GD";
...
v.c
Merging drm-intel-fixes/for-linux-next-fixes (d45331b00ddb Linux 5.3-rc4)
...
Merging arm64/for-next/core (f964cbd07098 Merge branch 'for-next/psci-cpuid=
le' into for-next/core)
...
st
Merging v4l-dvb/master (ae27c563a618 Merge tag 'v5.3-rc4' into patchwork)
...
prints)
Merging net-next/master (53f6f391786e caif: no need to check return value o=
f debugfs_create functions)
...
re/en_tc.c
Merging bpf-next/master (a664a834579a tools: bpftool: fix reading from /pro=
c/config.gz)
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/amdkfd/kfd_charde=
v.c
Merging drm-intel/for-linux-next (a21ce8ad12d2 drm/i915/overlay: Switch to =
using i915_active tracking)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (1c2b93902faf drm/panfrost: Bump driver ver=
sion to 1.1)
...
[master 441af7b7056b] next-20190808/sound-asoc
Applying: ASoc: SOF: Intel: hda: merge fix up for "ALSA: hda: Direct MMIO a=
ccesses"
[master f7d1d52245ae] next-20190808/sound-asoc
...
tput)
Merging rcu/rcu/next (eee850b8c265 Merge LKMM and RCU commits)
Applying: rcu: use the correct includes
...
Merging thunderbolt/next (04f7745300ed thunderbolt: Show key using %*pE not=
 %*pEp)
Merging staging/staging-next (1aee09b8fa5b staging: rtl8192u: fix spacing e=
rrors)
...
w location)
Applying: Revert "driver/core: Convert to use built-in RCU list checking"
...
rflow
Merging akpm/master (e8c9f1457095 drivers/media/platform/sti/delta/delta-ip=
...

=qVUT
-----END PGP SIGNATURE-----
