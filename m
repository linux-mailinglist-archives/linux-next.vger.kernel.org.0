Return-Path: <linux-next+bounces-9298-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id 8AACAC9A1A3
	for <lists+linux-next@lfdr.de>; Tue, 02 Dec 2025 06:36:18 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 06CC54E18FD
	for <lists+linux-next@lfdr.de>; Tue,  2 Dec 2025 05:36:17 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AA1D4245019;
	Tue,  2 Dec 2025 05:36:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="LUSavFBb"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5539515746F;
	Tue,  2 Dec 2025 05:36:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764653774; cv=none; b=BinS7/ONg18HYlU5R0rJkPJL1lLy7/FsWP3BzCB/ir9bo/USN8/nPvM1zhbzwSLOnTm1ITGE0XSI6drOIUf8SjiwGGbV/END6DHJHoAUFjg+0lbT8TioixB1xI7MkKF5Pv46t2gQcvlR/tF0yjWmVJslgXoqtLxnrzWBEkSTg/Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764653774; c=relaxed/simple;
	bh=u9V7uYOtm9HcaitA26KqLtPq+Ns387CVS07/NmlBihQ=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=Q03kmvTN2aEKkPi7QDl2FMzEcSB0xiJhPcL2Z6UTPCwo3fdGW+9XpkHesxpxgrBr3+1eWW9DpLxT5/MJS9ThsV5dXRb2YRd3jE6hP9qAecSiJnBfKEaiCCwW+6NJJP/htITz55qgmzMYmAwXJd4x/LGZa1xGRr1/bXoGXH5zl5o=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=LUSavFBb; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1764653761;
	bh=lsNomYYOTIbIrS4dd1RCAEE64no8wSJCXpCoRqKxyQ4=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dL8dF2DkCz4wD0;
	Tue, 02 Dec 2025 16:36:01 +1100 (AEDT)
Date: Tue, 2 Dec 2025 16:36:00 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 2
Message-ID: <20251202163600.2a02958c@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/3c9CFpSuc4.6W.z1pfR0baA";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/3c9CFpSuc4.6W.z1pfR0baA
...
Changes since 20251201:

Non-merge commits (relative to Linus' tree): 11615
 11923 files changed, 588450 insertions(+), 184611 deletions(-)
...
Merging origin/master (4664fb427c8f Merge tag 'vfs-6.19-rc1.minix' of git:/=
...
t_extent())
Merging f2fs/dev (9fdd4719c9c8 docs: f2fs: wrap ASCII tables in literal blo=
...
och_work())
Merging gfs2/for-next (ede060436343 gfs2: Fix use of bio_chain)
Merging jfs/jfs-next (cafc6679824a jfs: replace hardcoded magic number with=
 DTPAGEMAXSLOT constant)
Merging ksmbd/ksmbd-for-next (3ade50c3fc73 cifs: client: allow changing mul=
tichannel mount options on remount)
...
Merging nfsd/nfsd-next (fa8d4e6784d1 NFSD: add Documentation/filesystems/nf=
s/nfsd-io-modes.rst)
...
Merging fs-current (e1f4b9b5083d Merge branch 'next-fixes' of https://git.k=
...
re error checks)
Merging netfilter/main (e5235eb6cfe0 net: netpoll: initialize work queue be=
fore error checks)
...
Merging sound-current/for-linus (ef5e0a02d842 ALSA: rawmidi: Fix inconsiste=
nt indenting warning reported by smatch)
...
Merging tip-fixes/tip/urgent (44ce3cf3e67b Merge branch into tip/master: 'x=
86/urgent')
...
for-next)
Merging clk/clk-next (6056c50534f8 Merge branch 'clk-cleanup' into clk-next)
...
Merging fs-next (773789712135 Merge branch 'for-next' of https://git.kernel=
...
to for-next)
Merging pci/next (d1d34a4064b4 Merge branch 'pci/misc')
...
Merging i3c/i3c/next (4e7263b87ca3 i3c: master: svc: Add basic HDR mode sup=
port)
...
Merging cpufreq-arm/cpufreq/arm/linux-next (f872db1f3297 rust: cpufreq: alw=
...
Merging rdma/for-next (4022c7b6342a RDMA/mlx5: Add support for 1600_8x lane=
 speed)
Merging net-next/main (cbc19b3229f1 Merge branch 'selftests-drv-net-fix-iss=
ues-in-devlink_rate_tc_bw-py')
...
600Gbps link mode)
Merging netfilter-next/main (0177f0f07886 Merge tag 'linux-can-next-for-6.1=
9-20251129' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can-=
next)
Merging ipvs-next/main (c9dfb92de073 Merge branch 'mlx5-next' of git://git.=
kernel.org/pub/scm/linux/kernel/git/mellanox/linux)
Merging bluetooth/master (525459da4bd6 Bluetooth: btusb: Add new VID/PID 13=
d3/3533 for RTL8821CE)
...
Merging drm-xe/drm-xe-next (aa8225d4ee87 MAINTAINERS: Remove myself from xe=
 maintainers)
...
Merging sound/for-next (ef5e0a02d842 ALSA: rawmidi: Fix inconsistent indent=
ing warning reported by smatch)
...
Merging block/for-next (01e449e11504 Merge branch 'for-6.19/block' into for=
-next)
CONFLICT (content): Merge conflict in io_uring/rw.c
Merging device-mapper/for-next (8f591d86bc0f dm-snapshot: fix 'scheduling w=
hile atomic' on real-time kernels)
...
bed)
Merging tomoyo/master (4386488bac26 net/can/j1939: add j1939_session debugg=
ing)
Merging tpmdd/next (b8b93e380604 KEYS: trusted: Use tpm_ret_to_err() in tru=
sted_tpm2)
...
Merging devicetree/for-next (7838c7a9e269 dt-bindings: interrupt-controller=
...
19' into spi-next)
Merging tip/master (318e20812174 Merge branch into tip/master: 'x86/sgx')
...
Merging drivers-x86/for-next (b169e1733cad platform/x86/intel/hid: Add Dell=
 Pro Rugged 10/12 tablet to VGBS DMI quirks)
...
Merging bitmap/bitmap-for-next (3513371f4425 rust: id_pool: fix example)
...
Merging turbostat/next (4b295ae45d3e tools/power turbostat: Validate that R=
APL MSRs really exist)
...

=rl8T
-----END PGP SIGNATURE-----
