...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E5E67484067
	for <lists+linux-next@lfdr.de>; Tue,  4 Jan 2022 12:01:39 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231153AbiADLBi (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 4 Jan 2022 06:01:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34256 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229486AbiADLBe (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 4 Jan 2022 06:01:34 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4F810C061761;
        Tue,  4 Jan 2022 03:01:33 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JSqRs2yL8z4xd4;
        Tue,  4 Jan 2022 22:01:29 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1641294089;
        bh=34Ka84wzkTIDWlOnFkKxvZPNSKB3IJLFjwoJUGIi5C8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 4 Jan 2022 22:01:28 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 4
Message-ID: <20220104220128.36b0db9c@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ysEC51WlB7YrKw+im+dntC9";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/ysEC51WlB7YrKw+im+dntC9
...
Merging net/master (95bdba23b5b4 ipv6: Do cleanup if attribute validation f=
ails in multipath route)
...
ssion)
Merging mac80211/master (1ef5e1d0dca5 net/fsl: Remove leftover definition i=
n xgmac_mdio)
...
Merging sound-asoc-fixes/for-linus (895fa346baaa Merge remote-tracking bran=
...
reate operations)
Merging btrfs/for-next (b442f6a855a9 Merge branch 'for-next-next-v5.16-2022=
0103' into for-next-20220103)
...
Merging pm/linux-next (3d72f8341423 Merge branches 'thermal' and 'thermal-i=
...
Merging net-next/master (3d694552fd8f net: vxge: Use dma_set_mask_and_coher=
ent() and simplify code)
...
Merging sound/for-next (c19330086795 ALSA: hda/realtek - Fix silent output =
on Gigabyte X570 Aorus Master after reboot from Windows)
Merging sound-asoc/for-next (a155b7526e65 ASoC: mediatek: mt8195: repair pc=
mif BE dai)
...
battery info)
Merging regulator/for-next (d27bb69dc83f regulator: qcom-labibb: OCP interr=
upts are not a failure while disabled)
...
Merging rcu/rcu/next (262d811276ae squash! rcu: Use a single ->barrier_lock=
 for all CPUs)
...
Merging kvm-arm/next (17b9cf1b8900 KVM: arm64: selftests: get-reg-list: Add=
 pauth configuration)
...
Merging usb/usb-next (e0d07ba76bd1 Merge tag 'thunderbolt-for-v5.17-rc1' of=
...
Merging staging/staging-next (12b31d07b0ce staging: vc04_services: update T=
ODO file)
...
Merging livepatching/for-next (c96465c7c581 Merge branch 'for-5.17/fixes' i=
nto for-next)
...
for the xa_state)
Merging hyperv/hyperv-next (e1878402ab2d x86/hyperv: Fix definition of hv_g=
hcb_pg variable)
...
te)
Merging folio/for-next (c45f47979800 mm: Use multi-index entries in the pag=
e cache)
...
Merging random/master (dd1cb19590c5 random: don't reset crng_init_cnt on ur=
andom_read())
...

=1prJ
-----END PGP SIGNATURE-----
