...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 446A72FB264
	for <lists+linux-next@lfdr.de>; Tue, 19 Jan 2021 08:06:53 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728366AbhASHFy (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 19 Jan 2021 02:05:54 -0500
Received: from ozlabs.org ([203.11.71.1]:46583 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726302AbhASHEX (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 19 Jan 2021 02:04:23 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DKfkn1tc2z9sW8;
        Tue, 19 Jan 2021 18:03:29 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1611039809;
        bh=LcPq3vOYoiQQVeeULSLuxdBAkW2mVFqBIQ9Z+11YGG8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 19 Jan 2021 18:03:28 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 19
Message-ID: <20210119180328.31e92760@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/y4a3ks74Zth0vp4ywUn_e_o";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/y4a3ks74Zth0vp4ywUn_e_o
...
Merging net/master (87fe04367d84 net: dsa: mv88e6xxx: also read STU state i=
n mv88e6250_g1_vtu_getnext)
...
Merging sound-current/for-linus (c23010ffb20a Merge tag 'asoc-fix-v5.11-rc4=
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (45db630e5f7e drm/i915: Check =
for rq->hwsp validity after acquiring RCU lock)
...
Merging gpio-brgl-fixes/gpio/for-current (1fc7c1ef37f8 tools: gpio: fix %ll=
...
Merging drm-misc-fixes/for-linux-next-fixes (33c74535b03e drm/vc4: Unify PC=
M card's driver_name)
...
in imxfb_probe())
Merging pm/linux-next (192963bcaa64 Merge branch 'acpi-scan' into linux-nex=
t)
...
Merging opp/opp/linux-next (f1b631864d84 opp: Print OPP level in debug mess=
age of _opp_add_static_v2())
...
ds bug)
Merging net-next/master (a98c0c474204 net: bridge: check vlan with eth_type=
_vlan() method)
Merging bpf-next/for-next (95204c9bfa48 docs, bpf: Add minimal markup to ad=
dress doc warning)
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.h
Merging drm-intel/for-linux-next (0aa5c3835c8a drm/i915: support two CSC mo=
dule on gen11 and later)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/i915_pmu.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/gt/intel_lrc.c
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/gt/intel_breadcr=
umbs.c
...
Merging drm-misc/for-linux-next (cec7638b8e79 drm/drm_agpsupport: Strip out=
 obviously wrong descriptions and demote to standard headers)
...
Merging modules/modules-next (46b93cf85455 module: harden ELF info handling)
...
Merging akpm/master (15da5a516af0 secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=NkuW
-----END PGP SIGNATURE-----
