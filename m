Return-Path: <linux-next+bounces-1296-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 80C5685FB39
	for <lists+linux-next@lfdr.de>; Thu, 22 Feb 2024 15:27:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 81F731C2220D
	for <lists+linux-next@lfdr.de>; Thu, 22 Feb 2024 14:27:24 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 37AD214690F;
	Thu, 22 Feb 2024 14:27:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="eucykpRr"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-f170.google.com (mail-pf1-f170.google.com [209.85.210.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BD5403F9EF
	for <linux-next@vger.kernel.org>; Thu, 22 Feb 2024 14:27:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708612042; cv=none; b=VQUHV0OfzW+wDpwQ4JdMAcIxDU5ITGYwSkdpSHPfPlsGboJTjlaLMA6mZLVX6qP1h3VX/CwQZbPq1udWfC5oOqzubjz7gmEqB8xju/gbO5iXi8n0yX9mYSTrZjLAI5odESbfm04WXpqqqrY+bY3JNbsHsK3oVfYu/VPldf+p6GI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708612042; c=relaxed/simple;
	bh=j1mYHFXcJhS8WhlusPddsC8yN0jm+IBpJV8gnZ5Ambc=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=baw7b0gIpIacOwnVNtvAfBKb9nHqFFyBU4WBHF6QEmPx7WmvfjT2d4NwFRhFKSlQ8O3cXr4z6Zwnke1Ru0BoV9w1bndr35jLGXm5qFyreobJ98jTom1XZPNpScIeCJ5WGE96RFSBsGi16BXi6uVOx35/dQACRBA4cNlp+wrLyRk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=eucykpRr; arc=none smtp.client-ip=209.85.210.170
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pf1-f170.google.com with SMTP id d2e1a72fcca58-6e47c503fb5so2573280b3a.2
        for <linux-next@vger.kernel.org>; Thu, 22 Feb 2024 06:27:16 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1708612035; x=1709216835; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=CePq0X/5UlEWw2lfHadDNUCXBctuBW7sO6zMtWmCZc4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708612035; x=1709216835;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=CePq0X/5UlEWw2lfHadDNUCXBctuBW7sO6zMtWmCZc4=;
        b=
X-Gm-Message-State: AOJu0YyTi1QjvlGZHAknZmVCZc38WNFOuG3XmzNAbc1YuvuKXnAZ8Vam
	UFRZKyWIfpBatcRS67VnX1QyzDEX49DpXQam9p9JL5Wd8zgrlFE1DGBq/PkqNz2bh64AIRNpSgy
	VgCc=
X-Google-Smtp-Source: AGHT+IEl4ofr6RuETZLW7mVGzIonw/P4w6Z87Va3LWMZrqEUm3s0+nV+3QBOZ6UFl1zuqGeeqI8Ycg==
X-Received: by 2002:a05:6a20:939b:b0:19e:a9e6:bfa with SMTP id x27-20020a056a20939b00b0019ea9e60bfamr28566538pzh.0.1708612034079;
        Thu, 22 Feb 2024 06:27:14 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id su3-20020a17090b534300b0029724370ea9sm3973696pjb.47.2024.02.22.06.27.13
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 22 Feb 2024 06:27:13 -0800 (PST)
Message-ID: <65d759c1.170a0220.3ed37.e298@mx.google.com>
Date: Thu, 22 Feb 2024 06:27:13 -0800 (PST)
...
Subject: next/master build: 162 builds: 16 failed, 146 passed, 28 errors,
 405 warnings (next-20240222)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 162 builds: 16 failed, 146 passed, 28 errors, 405 warnin=
gs (next-20240222)
...
Tree: next
Branch: master
Git Describe: next-20240222
Git Commit: e31185ce00a96232308300008db193416ceb9769
...
arm:
    ...
    aspeed_g5_defconfig (clang-17): 2 errors, 2 warnings
    ...
    multi_v7_defconfig+kselftest (gcc-10): 2 errors, 2 warnings
    ...
    wpcm450_defconfig (gcc-10): 1 error, 1 warning
...
sparc:
    ...
    sparc64_defconfig+kselftest (gcc-10): 6 errors, 23 warnings
...
Errors summary:
    ...
    5    arch/arm/boot/compressed/misc.h:13:36: error: macro "fortify_panic=
" requires 5 arguments, but only 1 given
...
ck_gettime.c:247: undefined reference to `__ubsan_handle_type_mismatch_v1'
    1    arch/arm/boot/compressed/misc.h:13:6: error: variable has incomple=
te type 'void'
    1    arch/arm/boot/compressed/misc.h:13:36: error: too few arguments pr=
ovided to function-like macro invocation
    1    /tmp/kci/linux/build/../drivers/leds/rgb/leds-qcom-lpg.c:289: unde=
fined reference to `qcom_pbs_trigger_event'
    1    /tmp/kci/linux/build/../drivers/leds/rgb/leds-qcom-lpg.c:1561: und=
...
Warnings summary:
    ...
    63   arch/arm/boot/compressed/misc.c:157:6: warning: no previous protot=
ype for =E2=80=98__fortify_panic=E2=80=99 [-Wmissing-prototypes]
    13   arch/arc/kernel/ptrace.c:342:16: warning: no previous prototype fo=
r 'syscall_trace_enter' [-Wmissing-prototypes]
    7    security/security.c:811:2: warning: =E2=80=98memcpy=E2=80=99 offse=
t 32 is out of the bounds [0, 0] [-Warray-bounds]
    7    cc1: all warnings being treated as errors
    6    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [=
-Wcpp]
...
r =E2=80=98which_prom=E2=80=99 [-Wmissing-prototypes]
    3    arch/arm/boot/compressed/misc.c:157:6: warning: no previous protot=
ype for function '__fortify_panic' [-Wmissing-prototypes]
...
rovider): /fpga/pct: '#interrupt-cells' found, but node is not an interrupt=
 ...
 prerequisite 'interrupt_provider'
    ...
    2    sound/arm/aaci.c:742:15: warning: unused variable =E2=80=98aaci=E2=
=80=99 [-Wunused-variable]
    2    kernel/dma.c:88:6: warning: no previous prototype for =E2=80=98fre=
e_dma=E2=80=99 [-Wmissing-prototypes]
    2    kernel/dma.c:70:5: warning: no previous prototype for =E2=80=98req=
uest_dma=E2=80=99 [-Wmissing-prototypes]
    2    include/linux/fortify-string.h:97:29: warning: =E2=80=98__builtin_=
...
r =E2=80=98prom_get_mmu_ihandle=E2=80=99 [-Wmissing-prototypes]
    2    arch/sparc/lib/ucmpdi2.c:5:11: warning: no previous prototype for =
=E2=80=98__ucmpdi2=E2=80=99 [-Wmissing-prototypes]
    2    arch/sparc/lib/cmpdi2.c:6:11: warning: no previous prototype for =
...
totype for =E2=80=98mach_suspend=E2=80=99 [-Wmissing-prototypes]
    1    arch/mips/loongson2ef/common/machtype.c:34:20: warning: no previou=
...
s prototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    1    ............................../arch/sparc/kernel/traps_64.c:253:6:=
 warning: no previous prototype for =E2=80=98is_no_fault_exception=E2=80=99=
 [-Wmissing-prototypes]
...
Warnings:
    arch/arm/boot/compressed/misc.c:157:6: warning: no previous prototype f=
or =E2=80=98__fortify_panic=E2=80=99 [-Wmissing-prototypes]
...
Errors:
    arch/arm/boot/compressed/misc.h:13:36: error: macro "fortify_panic" req=
uires 5 arguments, but only 1 given
...
---------------------------------------------------------------------------=
-----
aspeed_g5_defconfig (arm, clang-17) =E2=80=94 FAIL, 2 errors, 2 warnings, 0=
 section mismatches

Errors:
    arch/arm/boot/compressed/misc.h:13:36: error: too few arguments provide=
d to function-like macro invocation
    arch/arm/boot/compressed/misc.h:13:6: error: variable has incomplete ty=
pe 'void'
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+kselftest (arm, gcc-10) =E2=80=94 FAIL, 2 errors, 2 warn=
...
---------------------------------------------------------------------------=
-----
sparc64_defconfig+kselftest (sparc, gcc-10) =E2=80=94 FAIL, 6 errors, 23 wa=
...
Warnings:
    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    ............................../arch/sparc/kernel/traps_64.c:253:6: warn=
...
---------------------------------------------------------------------------=
-----
wpcm450_defconfig (arm, gcc-10) =E2=80=94 FAIL, 1 error, 1 warning, 0 secti=
on mismatches
