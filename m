...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 2A8421036B2
	for <lists+linux-next@lfdr.de>; Wed, 20 Nov 2019 10:34:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727465AbfKTJeq (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 20 Nov 2019 04:34:46 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:42579 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725956AbfKTJeq (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 20 Nov 2019 04:34:46 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47HyFn1yrBz9sPW;
        Wed, 20 Nov 2019 20:34:37 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1574242477;
        bh=TA3aB5UNanTLSWyMViibZjtEfJVSJzlw1K0KmIwFeh8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 20 Nov 2019 20:34:34 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 20
Message-ID: <20191120203434.2a0727b3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/pdzo9nBKI/8cp9coxH6Yfow";
...
Merging origin/master (fd8f64df9520 mdio_bus: Fix init if CONFIG_RESET_CONT=
ROLLER=3Dn)
...
Merging net/master (075e238d12c2 mdio_bus: fix mdio_register_device when RE=
SET_CONTROLLER is disabled)
...
Merging sound-asoc-fixes/for-linus (221ef5dbea09 Merge branch 'asoc-5.4' in=
to asoc-linus)
Merging regmap-fixes/for-linus (af42d3466bdc Linux 5.4-rc8)
Merging regulator-fixes/for-linus (2f417d8d5b42 Merge branch 'regulator-5.4=
' into regulator-linus)
Merging spi-fixes/for-linus (86b2a45215a3 Merge branch 'spi-5.4' into spi-l=
inus)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (d43e24533dc2 drm/i915: make p=
ool objects read-only)
...
Merging cifs/for-next (037d9bef0189 cifs: update internal module version nu=
mber)
...
in imxfb_probe())
Merging pm/linux-next (8752bdb5f55b Merge branch 'pm-devfreq' into linux-ne=
xt)
...
Merging net-next/master (b8fc7177d8ae net: dsa: felix: Fix CPU port assignm=
ent when not last port)
Applying: powerpc: local_read() should take a const local_t argument
Merging bpf-next/master (a0d7da26ce86 libbpf: Fix call relocation offset ca=
lculation bug)
...
Merging netfilter-next/master (c21709e744b4 net: phy: dp83869: fix return o=
f uninitialized variable ret)
Merging nfc-next/master (1f008cfec5d5 NFC: fdp: Fix unused variable warning=
s)
CONFLICT (content): Merge conflict in drivers/nfc/st21nfca/se.c
Merging ipvs-next/master (d54725cd11a5 netfilter: nf_tables: support for mu=
ltiple devices per netdev hook)
Merging wireless-drivers-next/master (19b7e21c55c8 Merge git://git.kernel.o=
...
Merging gfs2/for-next (7d6d48fd4cae gfs2: Further gfs2_create_inode cleanup=
s)
...
Merging drm-intel/for-linux-next (fa039b936cf5 drm/i915: fix accidental sta=
tic variable use)
...
-next)
Merging sound/for-next (5398e94fb753 ALSA: hda - Add DP-MST support for NVI=
DIA codecs)
Merging sound-asoc/for-next (a0233a6ef390 Merge branch 'asoc-5.5' into asoc=
-next)
...
Merging block/for-next (9ebfeb6005be Merge branch 'for-5.5/io_uring-post' i=
nto for-next)
...
$ git rm -f include/Kbuild
Merging device-mapper/for-next (d256d796279d dm thin: wakeup worker only wh=
en deferred bios exist)
Merging mmc/next (f3d7c2292d10 mmc: core: Fix size overflow for mmc partiti=
ons)
...
Merging regulator/for-next (3698039adc50 Merge branch 'regulator-5.5' into =
regulator-next)
...
Merging audit/next (c34c78dfc1fc audit: remove redundant condition check in=
 kauditd_thread())
Merging devicetree/for-next (d8c313d75abf dt-bindings: pwm: Convert Samsung=
...
register value)
Merging spi/for-next (41881cec37ba Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
Merging drivers-x86/for-next (5c14aba77874 tools/power/x86/intel-speed-sele=
ct: Increment version)
Merging chrome-platform/for-next (30ddfa7ad00f Revert "Input: cros_ec_keyb:=
...
Merging driver-core/driver-core-next (553671b76859 firmware_loader: Fix lab=
els with comma for builtin firmware)
CONFLICT (content): Merge conflict in Documentation/filesystems/debugfs.txt
Merging usb/usb-next (bc3bdb12bbb3 usb-storage: Disable UAS on JMicron SATA=
 enclosure)
...
scription for px30)
Merging tty/tty-next (55ed51fff224 {tty: serial, nand: onenand}: samsung: r=
ename to fix build warning)
...
Merging staging/staging-next (7da8abcf482a staging: rtl8723bs: remove set b=
ut not used variable 'change', 'pos')
...
Merging scsi-mkp/for-next (c0bf9a264e10 scsi: iscsi: Don't send data to unb=
ound connection)
Merging vhost/linux-next (ff7033331560 vhost: last descriptor must have NEX=
T clear)
...
Merging devfreq/devfreq-next (5e517dbf1818 PM / devfreq: Add missing lockin=
g while setting suspend_freq)
...
rflow
Merging akpm/master (10ab33481c0b drivers/media/platform/sti/delta/delta-ip=
...

=dwsB
-----END PGP SIGNATURE-----
