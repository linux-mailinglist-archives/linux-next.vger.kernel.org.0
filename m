...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0EE892415DB
	for <lists+linux-next@lfdr.de>; Tue, 11 Aug 2020 06:52:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726178AbgHKEwf (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 11 Aug 2020 00:52:35 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46618 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726170AbgHKEwe (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 11 Aug 2020 00:52:34 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 087B9C06174A;
        Mon, 10 Aug 2020 21:52:33 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BQgS00YnJz9sTR;
        Tue, 11 Aug 2020 14:52:32 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1597121552;
        bh=Nw0MwPB7Ex7P8+2EYzETV101Nw+r30PGsp/DixO/zYc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 11 Aug 2020 14:52:31 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 11
Message-ID: <20200811145231.3dee4136@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/WT7BNbXSnp5YHVVjlv3Rprq";
...
Non-merge commits (relative to Linus' tree): 1674
 1851 files changed, 53494 insertions(+), 17185 deletions(-)
...
Merging origin/master (fc80c51fd4b2 Merge tag 'kbuild-v5.9' of git://git.ke=
...
Merging net/master (444da3f52407 bitfield.h: don't compile-time validate _v=
al in FIELD_FIT)
Merging bpf/master (7c7ab580db49 net: Convert to use the fallthrough macro)
Merging ipsec/master (61ee4137b574 ip_vti: Fix unused variable warning)
Merging netfilter/master (7c7ab580db49 net: Convert to use the fallthrough =
macro)
...
Merging sound-current/for-linus (34dedd2a83b2 ALSA: usb-audio: Disable Leno=
vo P620 Rear line-in volume control)
Merging sound-asoc-fixes/for-linus (b6448e0359f1 Merge remote-tracking bran=
...
Merging driver-core.current/driver-core-linus (fc80c51fd4b2 Merge tag 'kbui=
ld-v5.9' of git://git.kernel.org/pub/scm/linux/kernel/git/masahiroy/linux-k=
build)
...
Merging char-misc.current/char-misc-linus (fc80c51fd4b2 Merge tag 'kbuild-v=
5.9' of git://git.kernel.org/pub/scm/linux/kernel/git/masahiroy/linux-kbuil=
d)
...
Merging btrfs-fixes/next-fixes (48d8b546d7ba Merge branch 'misc-5.9' into n=
ext-fixes)
...
Merging hyperv-fixes/hyperv-fixes (608a973bd52e Drivers: hv: vmbus: Only no=
tify Hyper-V for die events that are oops)
...
Merging parisc-hd/for-next (f70f346189c1 sections.h: dereference_function_d=
escriptor() should return void pointer)
...
session messages)
Merging cifs/for-next (30b5ae21b9a5 cifs: Convert to use the fallthrough ma=
cro)
...
to for-next)
Merging i2c/i2c/for-next (42d0d186916d Merge branch 'i2c/for-5.9' into i2c/=
for-next)
...
in imxfb_probe())
Merging pm/linux-next (7cd29e47553a Merge branches 'pm-cpufreq' and 'acpi-s=
oc' into linux-next)
...
Merging sound/for-next (34dedd2a83b2 ALSA: usb-audio: Disable Lenovo P620 R=
ear line-in volume control)
Merging sound-asoc/for-next (b6448e0359f1 Merge remote-tracking branch 'aso=
...
AD)
Merging kvm/linux-next (99b48ecc8e80 x86/kvm/hyper-v: Synic default SCONTRO=
L MSR needs to be enabled)
...
rnel.org/pub/scm/linux/kernel/git/masahiroy/linux-kbuild)
Merging driver-core/driver-core-next (fc80c51fd4b2 Merge tag 'kbuild-v5.9' =
of git://git.kernel.org/pub/scm/linux/kernel/git/masahiroy/linux-kbuild)
...
Merging char-misc/char-misc-next (fc80c51fd4b2 Merge tag 'kbuild-v5.9' of g=
...
Merging kspp/for-next/kspp (a713a33e7b77 Merge branch 'fix/module-bin-attr'=
 into for-next/kspp)
...
do_copy)
Merging akpm-current/current (1d8a8f4a9fea ipc/shm.c: Remove the superfluou=
s break)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (f7d2eac14257 virtio: pci: constify ioreadX() iomem arg=
...

=Oxf6
-----END PGP SIGNATURE-----
