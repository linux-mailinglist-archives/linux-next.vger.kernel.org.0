...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4B936166E01
	for <lists+linux-next@lfdr.de>; Fri, 21 Feb 2020 04:45:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729664AbgBUDpn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 20 Feb 2020 22:45:43 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:43395 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729539AbgBUDpn (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 20 Feb 2020 22:45:43 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48Ny666Mf4z9sRl;
        Fri, 21 Feb 2020 14:45:34 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1582256734;
        bh=63vAmLRPAIgVjaIj5Q12YdOLTfIf6pvkgt/dHvu5E9U=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 21 Feb 2020 14:45:34 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 21
Message-ID: <20200221144534.2175ea56@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/lzYcf7H=3FWMd=qe9+MZgdz";
...
--Sig_/lzYcf7H=3FWMd=qe9+MZgdz
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200220:
...
Non-merge commits (relative to Linus' tree): 3009
 2822 files changed, 101744 insertions(+), 71752 deletions(-)
...
Merging origin/master (ca7e1fd1026c Merge tag 'linux-kselftest-5.6-rc3' of =
...
Merging net/master (0d5b8d705565 Merge branch 's390-fixes')
...
Merging sound-asoc-fixes/for-linus (46091ad6c531 Merge branch 'asoc-5.6' in=
to asoc-linus)
...
Merging phy/fixes (b063826de7f1 phy: brcm-sata: Correct MDIO operations for=
 40nm platforms)
...
Merging slave-dma-fixes/fixes (2d0b1919457a dmaengine: idxd: correct reserv=
ed token calculation)
...
P fixups)
Merging hwmon-fixes/hwmon (5953f5055633 hwmon: (w83627ehf) Fix crash seen w=
ith W83627DHG-P)
...
Merging drm-fixes/drm-fixes (7c42545cad10 Merge branch 'linux-5.6' of git:/=
/github.com/skeggsb/linux into drm-fixes)
Merging amdgpu-fixes/drm-fixes (2c409ba81be2 drm/radeon: fix si_enable_smc_=
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (15de9cb5c9c8 drm/i915/gt: Avo=
id resetting ring->head outside of its timeline mutex)
...
Merging kspp-gustavo/for-next/kspp (11a48a5a18c6 Linux 5.6-rc2)
Merging kbuild/for-next (987d352aee30 kbuild: remove wrong documentation ab=
out mandatory-y)
...
for-next)
Merging samsung-krzk/for-next (b938b6b13da8 Merge branch 'next/dt' into for=
-next)
Merging scmi/for-linux-next (11a48a5a18c6 Linux 5.6-rc2)
Merging sunxi/sunxi/for-next (766f0641aba8 Merge branch 'sunxi/dt-for-5.7' =
into sunxi/for-next)
...
es)
Merging soc-fsl/next (3b2abda7d28c soc: fsl: dpio: Replace QMAN array mode =
with ring mode enqueue)
...
gnored)
Merging cifs/for-next (93fc7de81fe9 cifs: plumb smb2 POSIX dir enumeration)
...
Merging ext4/dev (c20bac9bf82c ext4: fix potential race between s_flex_grou=
ps online resizing and access)
...
e release)
Merging hwmon-staging/hwmon-next (bb139e2d83b0 hwmon: (lm73) Add support fo=
r of_match_table)
...
in imxfb_probe())
Merging pm/linux-next (c6cef55cdff7 Merge branch 'pm-sleep' into linux-next)
...
o dma mapping)
Merging net-next/master (2e92a2d0e450 net: use netif_is_bridge_port() to ch=
eck for IFF_BRIDGE_PORT)
CONFLICT (content): Merge conflict in drivers/net/ethernet/intel/ice/ice_vi=
rtchnl_pf.c
Merging bpf-next/master (5327644614a1 libbpf: Relax check whether BTF is ma=
ndatory)
...
Merging crypto/master (7f19380b2cfd crypto: qce - handle AES-XTS cases that=
 qce fails)
Merging drm/drm-next (11a48a5a18c6 Linux 5.6-rc2)
Merging amdgpu/drm-next (67ceb5261709 drm/amdgpu: add sysfs interface to se=
t arbitrary sclk value for navi14)
Merging drm-intel/for-linux-next (1042b2b93dac drm/i915/tgl: Program MBUS_A=
BOX{1,2}_CTL during display init)
...
it' into for-next)
Merging sound-asoc/for-next (6a50629988a9 Merge branch 'asoc-5.7' into asoc=
-next)
...
regulator-next)
Merging security/next-testing (bd1a5a53d7c1 security: <linux/lsm_hooks.h>: =
...
Merging devicetree/for-next (faf8e30acb21 dt-bindings: arm: Add kryo260 com=
patible)
...
Merging tip/auto-latest (3e3095503286 Merge branch 'core/objtool')
...
s)
Merging rcu/rcu/next (1228aca56f2a fork: Annotate a data race in vm_area_du=
p())
...
Merging tty/tty-next (c50704bdef9b n_gsm: switch escape to bool)
...
Merging slave-dma/next (35e032462bf8 dmanegine: ioat/dca: Replace zero-leng=
...
Merging fpga/for-next (1418bf8c8ed8 fpga: dfl: support multiple opens on fe=
ature device node.)
...
tory)
Merging akpm-current/current (a4a3493a4a67 init/Kconfig: clean up ANON_INOD=
...
rflow
Merging akpm/master (37bb959a4304 drivers/media/platform/sti/delta/delta-ip=
...

=M7OH
-----END PGP SIGNATURE-----
