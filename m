Return-Path: <linux-next+bounces-5196-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 5F253A100B9
	for <lists+linux-next@lfdr.de>; Tue, 14 Jan 2025 07:03:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 1A4F71882621
	for <lists+linux-next@lfdr.de>; Tue, 14 Jan 2025 06:03:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B51B91FBBE5;
	Tue, 14 Jan 2025 06:03:34 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="ZMo0seWm"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7489B24022E;
	Tue, 14 Jan 2025 06:03:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1736834614; cv=none; b=b/R5u1L2O7KgMe8uBk2bf3XcEE3CjWCTgasR0paQNHrK8K4w9tyD6dcvARqGyHnO8IkiS7e9EelMMp9NjXE+yDyYlIIejO/1jQhzweat6tltntgn0DVHcrlkijugHnJ9jxgwjE2884/WyTX/h38psylRG8FKk53NkZGc8g9ICoQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1736834614; c=relaxed/simple;
	bh=tbshp+tV6PMPmz3pbTYFSlPkJpHtjJcl0HnFukALg94=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=iFdV8pFvyxr9DBxE3N8Y9/BPXZb0qLSYISrL9DldHmkNmp0DYgLtMc3yo8uag8GN9F/AdfGbHIy5Ndx4/c1TmaX+2FA+4totLcv3+JblfSM2NoFpEPKrpnmpk1MqtdvNfd9XHVTqhMTHMiN9eLrlvOoFjJF5b/JAitHxNJtWAcU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=ZMo0seWm; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1736834599;
	bh=u6z/uPhoXzjd04dZOoq9UHHMdoeNqrU4SG5pkHMAcrg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YXJTM1lqBz4x1w;
	Tue, 14 Jan 2025 17:03:19 +1100 (AEDT)
Date: Tue, 14 Jan 2025 17:03:25 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 14
Message-ID: <20250114170325.7155b71b@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/uVx26_eRJWooOD13X6fDxoK";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/uVx26_eRJWooOD13X6fDxoK
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250113:
...
Non-merge commits (relative to Linus' tree): 7708
 7850 files changed, 355254 insertions(+), 125996 deletions(-)
...
Merging origin/master (c45323b7560e Merge tag 'mm-hotfixes-stable-2025-01-1=
3-00-03' of git://git.kernel.org/pub/scm/linux/kernel/git/akpm/mm)
...
Merging bcachefs/for-next (c72deb03ff04 bcachefs: bcachefs_metadata_version=
_directory_size)
...
arse reads)
Merging cifs/for-next (b8ed9da102be cifs: support reconnect with alternate =
password for SMB1)
...
Merging vfs/for-next (5cc68af412a9 fs/overlayfs/namei.c: get rid of include=
 ../internal.h)
Merging mm-hotfixes/mm-hotfixes-unstable (6e7fae8e66fc mm: khugepaged: fix =
call hpage_collapse_scan_file() for anonymous vma)
Merging fs-current (6198c2c59721 Merge branch 'fixes' of git://git.kernel.o=
...
entation)
Merging net/main (76201b597976 pktgen: Avoid out-of-bounds access in get_im=
ix_entries)
...
x into drm-fixes)
Merging drm-intel-fixes/for-linux-next-fixes (5bc55a333a2f Linux 6.13-rc7)
...
Merging gpio-brgl-fixes/gpio/for-current (5bc55a333a2f Linux 6.13-rc7)
...
Merging tip-fixes/tip/urgent (b58b85011681 Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (1f9910b41c85 nouveau/fence: ha=
ndle cross device fences properly)
...
Merging mm/mm-everything (c4c00fc21f78 foo)
...
Merging clk/clk-next (58ad39edcabc Merge branch 'clk-allwinner' into clk-ne=
xt)
...
Merging fs-next (b986487046b0 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Merging printk/for-next (9022df7f5e05 Merge branch 'for-6.14-cpu_sync-fixup=
' into for-next)
Merging pci/next (9c6be0556c6b Merge branch 'pci/misc')
Merging pstore/for-next/pstore (067cdf020329 pstore/zone: avoid dereferenci=
ng zero sized ptr after init zones)
Merging hid/for-next (ef413a968468 Merge branch 'for-6.14/intel-thc' into f=
or-next)
...
Merging pm/linux-next (54332ae3064a Merge branch 'fixes' into linux-next)
...
Merging drm-xe/drm-xe-next (c26f22dac344 drm/xe/oa: Add missing VISACTL mux=
 registers)
...
Merging sound-asoc/for-next (c3a4a6936372 Merge remote-tracking branch 'aso=
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/bridge/lontium-lt9611=
.c
...
Merging block/for-next (2b122597b78e Merge branch 'for-6.14/io_uring' into =
for-next)
...
Merging spi/for-next (2b638560feb8 Merge remote-tracking branch 'spi/for-6.=
14' into spi-next)
Merging tip/master (cfb1181c3b90 Merge branch into tip/master: 'x86/tdx')
...
Merging ftrace/for-next (a0f5a8426da4 Merge tools/for-next)
...
Merging kvm-arm/next (a1caf40a7a2c Merge branch kvm-arm64/coresight-6.14 in=
...
Merging chrome-platform/for-next (15fa0621d7b3 platform/chrome: cros_usbpd_=
logger: Use str_enabled_disabled() helper)
...
Merging usb/usb-next (2919c4a3d883 Merge 6.13-rc7 into usb-next)
...
Merging staging/staging-next (b37333c8657c Merge 6.13-rc7 into staging next)
...
rub2 skip regex)
Merging kselftest/next (a69a3bad0aba selftests/rseq: Fix rseq for cases wit=
hout glibc support)
...
Merging efi/next (aaa61d8b2a49 Merge branch 'efivarfs' into next)
...
Merging rust/rust-next (c80dd3fc45d5 rust: uaccess: generalize userSliceRea=
der to support any Vec)
...

=K9K2
-----END PGP SIGNATURE-----
