...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 90C54345848
	for <lists+linux-next@lfdr.de>; Tue, 23 Mar 2021 08:04:58 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230319AbhCWHES (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 23 Mar 2021 03:04:18 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:52757 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230241AbhCWHD7 (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 23 Mar 2021 03:03:59 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4F4MmF0qWnz9sTD;
        Tue, 23 Mar 2021 18:03:57 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1616483037;
        bh=mYn+ixSh0WuSYylWReH4pIhn3/YtLZ4CDp7HZZbn0Qc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 23 Mar 2021 18:03:56 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 23
Message-ID: <20210323180356.7b424c55@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/iadJuOCJCnLNFdsMY6Me+=2";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/iadJuOCJCnLNFdsMY6Me+=2
...
Non-merge commits (relative to Linus' tree): 5787
 5640 files changed, 375045 insertions(+), 122903 deletions(-)
...
Merging origin/master (84196390620a Merge tag 'selinux-pr-20210322' of git:=
...
Merging net/master (6debc0fd71b9 MAINTAINERS: Combine "QLOGIC QLGE 10Gb ETH=
ERNET DRIVER" sections into one)
...
Merging sound-asoc-fixes/for-linus (0d02ec6b3136 Linux 5.12-rc4)
...
Merging driver-core.current/driver-core-linus (0d02ec6b3136 Linux 5.12-rc4)
Merging tty.current/tty-linus (1e28eed17697 Linux 5.12-rc3)
Merging usb.current/usb-linus (0d02ec6b3136 Linux 5.12-rc4)
...
Merging staging.current/staging-linus (0d02ec6b3136 Linux 5.12-rc4)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (0d02ec6b3136 Linux 5.12-rc4)
...
Merging v4l-dvb/master (bf9a40ae8d72 media: dvbdev: Fix memory leak in dvb_=
media_device_free())
CONFLICT (content): Merge conflict in MAINTAINERS
Merging v4l-dvb-next/master (1e28eed17697 Linux 5.12-rc3)
Merging fbdev/fbdev-for-next (732146a3f1dc video: fbdev: imxfb: fix a typo =
in imxfb_probe())
Merging pm/linux-next (0fc4b6feae23 Merge branch 'devprop' into linux-next)
...
mem)
Merging net-next/master (9a255a0635fe Merge git://git.kernel.org/pub/scm/li=
...
Merging bluetooth/master (8ff0278d1067 Bluetooth: fix set_ecdh_privkey() pr=
ototype)
...
Merging drm-misc/for-linux-next (458025f6c161 vgaarb: avoid -Wempty-body wa=
rnings)
Merging amdgpu/drm-next (4b3ec5ba08f3 Revert "amd/amdgpu: Disable VCN DPG m=
ode for Picasso")
...
ice.c
Merging drm-intel/for-linux-next (97bc7ffa1b1e drm/i915: Fix enabled_planes=
 bitmask)
...
s)
Merging sound-asoc/for-next (ca108ca13d7b Merge remote-tracking branch 'aso=
...
Merging input/next (484a6c4b9272 Input: Add support for Azoteq IQS626A)
Merging block/for-next (d6a78272cdd6 Merge branch 'for-5.13/libata' into fo=
r-next)
Merging device-mapper/for-next (c962a55c4bcd dm persistent data: remove unu=
sed return from exit_shadow_spine())
...
Merging battery/for-next (bd3689a64ecd power: supply: max1721x: Correct spe=
lling)
...
Merging devicetree/for-next (7dd5887243b0 dt-bindings: i2c: xiic: Fix a typ=
o)
...
13' into spi-next)
Merging tip/auto-latest (e46a58809165 Merge branch 'locking/core')
...
ver)
Merging soundwire/next (bb877bebae0f soundwire: intel: add master quirks fo=
r bus clash and parity)
...
Merging staging/staging-next (c7f57fd6b7f0 Merge v5.12-rc4 into staging-nex=
t)
...
Merging akpm/master (acf0c6f4a1ed secretmem: test: add basic selftest for m=
emfd_secret(2))
...

=gRPD
-----END PGP SIGNATURE-----
