...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ECBD32AFEF5
	for <lists+linux-next@lfdr.de>; Thu, 12 Nov 2020 06:42:38 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726854AbgKLFmJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 12 Nov 2020 00:42:09 -0500
Received: from ozlabs.org ([203.11.71.1]:53819 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729616AbgKLFjw (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 12 Nov 2020 00:39:52 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CWr5Z0gTgz9sTL;
        Thu, 12 Nov 2020 16:39:46 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1605159586;
        bh=7KV+SNGGpWBNNCvXnsIHRxytVJD+N3BHGTxN7hmaZQU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 12 Nov 2020 16:39:45 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 12
Message-ID: <20201112163945.37396f94@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_quLRdozgM7pHZxV.sGa40o";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/_quLRdozgM7pHZxV.sGa40o
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20201111:
...
Merging bpf/master (f16e631333a8 bpf: Fix unsigned 'datasec_id' compared wi=
th zero in check_pseudo_btf_id)
...
Merging sound-asoc-fixes/for-linus (3317433d5091 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (8e2ba731d153 Merge remote-tracking branch 'spi=
...
Merging drm-misc-fixes/for-linux-next-fixes (a6c40b8032b8 drm/mcde: Fix unb=
alanced regulator)
...
Merging arm64/for-next/core (6d4acefb357a Merge branch 'for-next/va-refacto=
...
Merging net-next/master (214c798ba1a4 net: phy: aquantia: do not return an =
error on clearing pending IRQs)
Merging bpf-next/for-next (8378788cfe74 Merge branch 'tools/bpftool: Some b=
uild fixes')
...
ogh)
Merging drm-intel/for-linux-next (9a450b68fef7 drm/i915: Do not setup hpd w=
ithout display)
Merging drm-tegra/drm/tegra/for-next (41f71629b4c4 drm/tegra: replace idr_i=
nit() by idr_init_base())
Merging drm-misc/for-linux-next (05481f072787 drm/kmb: fix spelling mistake=
s in drm_info and drm_dbg messages)
...
Merging sound/for-next (8461352ddf07 ALSA: firewire: fix comparison to bool=
 warning)
Merging sound-asoc/for-next (f263258b67ab Merge remote-tracking branch 'aso=
...
ings)
Merging block/for-next (6b7bdda4f2d5 Merge branch 'for-5.11/drivers' into f=
or-next)
...
rom callback)
Merging spi/for-next (cf79d22dc7e9 Merge remote-tracking branch 'spi/for-5.=
11' into spi-next)
...
or ring_buffer_wait)
Merging rcu/rcu/next (e78cd85dc606 doc: Remove obsolete RCU-bh and RCU-sche=
d update-side API members)
...
Applying: merge fix for "s390/pci: remove races against pte updates"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (f6b3e599e39a mm/gup: assert that the mmap lock is held=
 in __get_user_pages())
...

=0WyA
-----END PGP SIGNATURE-----
