...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5139339F5C7
	for <lists+linux-next@lfdr.de>; Tue,  8 Jun 2021 13:55:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232320AbhFHL5d (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 8 Jun 2021 07:57:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53666 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232322AbhFHL53 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 8 Jun 2021 07:57:29 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 74CF6C061574;
        Tue,  8 Jun 2021 04:55:33 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Fzpb50NBPz9sSn;
        Tue,  8 Jun 2021 21:55:29 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1623153329;
        bh=8cPi+FCfDAJerCJcvihbvsKiG1w2xFyeOaSstggW+PQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 8 Jun 2021 21:55:28 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 8
Message-ID: <20210608215528.50db7bbe@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/4=4DUD0PtQGkIRxFOyFFsU9";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/4=4DUD0PtQGkIRxFOyFFsU9
...
The cifs tree gained a build failure due to an interaction with the
cifsd tree for which I reverted a commit.

The drm-misc tree lost its build failure, but gained another due to an
interaction with the drm tree for which I added a hack fix.

Non-merge commits (relative to Linus' tree): 7337
 7324 files changed, 577913 insertions(+), 157080 deletions(-)
...
Merging net/master (7a6b1ab7475f neighbour: allow NUD_NOARP entries to be f=
orced GCed)
...
Merging sound-asoc-fixes/for-linus (5430e703c43c Merge remote-tracking bran=
ch 'asoc/for-5.13' into asoc-linus)
Merging regmap-fixes/for-linus (614124bea77e Linux 5.13-rc5)
Merging regulator-fixes/for-linus (fabbbfa8c586 Merge remote-tracking branc=
h 'regulator/for-5.13' into regulator-linus)
Merging spi-fixes/for-linus (dd65704e0725 Merge remote-tracking branch 'spi=
...
Merging drm-misc-fixes/for-linux-next-fixes (9bf3797796f5 drm/sun4i: dw-hdm=
i: Make HDMI PHY into a platform device)
...
or-next)
Merging arm64/for-next/core (5aede8a7cff6 Merge branch 'for-next/entry' int=
o for-next/core)
...
o ti-k3-next)
Merging ti-k3-new/ti-k3-next (7ce11d4704c0 arm64: dts: ti: k3-j721e-main: A=
dd ICSSG MDIO nodes)
...
Merging cifs/for-next (4a957ba6daf6 cifs: decoding negTokenInit with generi=
c ASN1 decoder)
...
f some characters)
Merging pm/linux-next (fcbef3bdf3a8 Merge branches 'pm-cpufreq', 'pm-core' =
and 'pm-sleep' into linux-next)
...
irdma_modify_qp)
Merging net-next/master (dc8cf7550a70 Merge branch 'page_pool-recycling')
...
.c
Merging drm-misc/for-linux-next (72db41c9336d drm/ttm: fix warning after mo=
ving resource to ghost obj)
...
Merging amdgpu/drm-next (5a7e9d7ec7b8 drm/radeon: Add HD-audio component no=
tifier support (v2))
Merging drm-intel/for-linux-next (3f409e4cd579 drm/i915/display: Drop FIXME=
 about turn off infoframes)
...
Merging regmap/for-next (330401cb75be Merge remote-tracking branch 'regmap/=
for-5.14' into regmap-next)
Merging sound/for-next (5fe8f0a0a83a ALSA: firewire-lib: delete unused kern=
el API)
Merging sound-asoc/for-next (c43d0c86999b Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (93f6b6e8c0b8 Merge remote-tracking branch 'regu=
...
Merging iommu/next (d7b0f0c6a479 Merge branches 'iommu/fixes', 'arm/rockchi=
...
Merging spi/for-next (39dc764c30d0 Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
...
into tpmdd-for-next)
Applying: Revert "cifs: decoding negTokenInit with generic ASN1 decoder"
...
Merging akpm/master (4fee7caec1d1 kdump: use vmlinux_build_id to simplify)
...

=JXir
-----END PGP SIGNATURE-----
