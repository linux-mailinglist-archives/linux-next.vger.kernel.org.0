...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 4DBA5163A87
	for <lists+linux-next@lfdr.de>; Wed, 19 Feb 2020 03:50:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728175AbgBSCuk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 18 Feb 2020 21:50:40 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:49849 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728027AbgBSCuk (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 18 Feb 2020 21:50:40 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48MhzX70yLz9sR4;
        Wed, 19 Feb 2020 13:50:32 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1582080633;
        bh=/3DKtdyycQZMtMhJvkmNxFCZ+FeoP6FnQEGz9KQ9ZFg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 19 Feb 2020 13:50:32 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 19
Message-ID: <20200219135032.34076125@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/mSJrNmJwceYvWu/LU3pJdU=";
...
--Sig_/mSJrNmJwceYvWu/LU3pJdU=
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200218:

Replaced the bcm2835 tree with the raspberrypi tree.
...
Non-merge commits (relative to Linus' tree): 2582
 2382 files changed, 87863 insertions(+), 67348 deletions(-)
...
Merging origin/master (b1da3acc781c Merge tag 'ecryptfs-5.6-rc3-fixes' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/tyhicks/ecryptfs)
...
Merging net/master (9facfdb54673 netlabel_domainhash.c: Use built-in RCU li=
st checking)
...
Merging netfilter/master (6a757c07e51f netfilter: conntrack: allow insertio=
n of clashing entries)
...
Merging sound-current/for-linus (385536090b18 Merge tag 'asoc-fix-v5.6-rc2'=
 of https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-=
linus)
Merging sound-asoc-fixes/for-linus (38daddb39e25 Merge branch 'asoc-5.6' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (afe7b46f7121 Merge branch 'spi-5.6' into spi-l=
inus)
...
Merging raspberrypi/for-next (bb6d3fb354c5 Linux 5.6-rc1)
...
riable 'mm_gc')
Merging risc-v/for-next (a72faafcdd6f riscv: force hart_lottery to put in .=
sdata section)
...
ute)
Merging net-next/master (00796b929ce8 sfc: elide assignment of skb)
Merging bpf-next/master (b80b033bedae bpf: Allow bpf_perf_event_read_value =
in all BPF programs)
Merging ipsec-next/master (92df9f8a745e Merge branch 'mvneta-xdp-ethtool-st=
ats')
Merging mlx5-next/mlx5-next (d8fab4815a37 net/mlx5: fix spelling mistake "r=
eserverd" -> "reserved")
...
unload callbacks)
Merging drm-intel/for-linux-next (489645d522df drm/i915/gt: Show the cumula=
tive context runtime in engine debug)
...
Merging edac/edac-for-next (3f47fb9a4420 Merge branch 'edac-misc' into edac=
-for-next)
...
s)
Merging rcu/rcu/next (756b5aea6df6 rcu: Don't use negative nesting depth in=
 __rcu_read_unlock())
...
Merging extcon/extcon-next (29c98e31bd9b extcon: palmas: Hide error message=
...
rflow
Merging akpm/master (ac0a08ae5122 drivers/media/platform/sti/delta/delta-ip=
...

=J3CG
-----END PGP SIGNATURE-----
