Return-Path: <linux-next+bounces-9422-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 65834CC07C2
	for <lists+linux-next@lfdr.de>; Tue, 16 Dec 2025 02:47:31 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 22EF53012BEB
	for <lists+linux-next@lfdr.de>; Tue, 16 Dec 2025 01:47:30 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 234F923FC54;
	Tue, 16 Dec 2025 01:47:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="jcnHzoU1"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A2989C8E6;
	Tue, 16 Dec 2025 01:47:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765849649; cv=none; b=l1GtvxRkK2Bkp9RvmYvJIw+RyHVNmJyXWRKU9nh72WeRIljfEkIfQh+UMgpO+B92KWPnz5xmsgVS9XQueS1pq9uRsZjujc1R5fiSK+zQSkFw4ztqLuErXhr3r41kNQataCR1i+neBiXootNwY/6qehupapJ+aCchhtUEJucatLk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765849649; c=relaxed/simple;
	bh=ceLJrZVIayt2BepoBDWhJ2cm/4s8Mp1HHS72SSliceE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=G7W/2uRCyANwG+8NbRmyEmnYZUrkqGA4CjOCz6o7yvxsN8hMSdW/lV0nG/DMfajuSrjaOWLIF/WuV8IrhnW7UYpNOyzomk0TEwlx/puXfJgzdvKAyFMH4Mq9F+qegmE2v3cbxW+O4T5MC59YyyfQFO1ODoFOLwewtPuxN903C5Y=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=jcnHzoU1; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1765849640;
	bh=jmj3A0C5nJrshBITrj3orqZXCczJW2dbrfKrUJr7u0o=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dVftw6P1Nz4wCm;
	Tue, 16 Dec 2025 12:47:20 +1100 (AEDT)
Date: Tue, 16 Dec 2025 12:47:20 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 16
Message-ID: <20251216124720.21c8f082@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/3O7Hd7htzC4yLKfM2OVLFKL";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/3O7Hd7htzC4yLKfM2OVLFKL
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20251215:

Removed tree:	exportfs	it has not bee updated in a long time

Non-merge commits (relative to Linus' tree): 1520
 1511 files changed, 140187 insertions(+), 39289 deletions(-)
...
Merging origin/master (8f0b4cce4481 Linux 6.19-rc1)
...
next-fixes)
Merging vfs-fixes/fixes (db961296e022 shmem: fix recovery on rename failure=
s)
...
Merging btrfs/for-next (04da6eeaf3d1 Merge branch 'for-next-next-v6.19-2025=
1215' into for-next-20251215)
Merging ceph/master (375068b6c206 libceph: prevent potential out-of-bounds =
reads in handle_auth_done())
Merging cifs/for-next (593f214f5e14 cifs: update internal module version nu=
mber)
...
ezable kthread)
Merging ksmbd/ksmbd-for-next (95d7a890e4b0 ksmbd: fix buffer validation by =
...
n-persistent dentry)
Merging mm-hotfixes/mm-hotfixes-unstable (eced7b86cd6b kasan-unpoison-vms-a=
ddresses-with-a-common-tag-v4)
Merging fs-current (694189b7e131 Merge branch 'nfsd-fixes' of https://git.k=
...
oweron_rdr())
Merging bpf/master (ba34388912b5 bpf: Disable false positive -Wsuggest-attr=
ibute=3Dformat warning)
...
Merging sound-asoc-fixes/for-linus (cb0ae6f22790 ASoC: sdw_utils: subtract =
the endpoint that is not present)
...
Merging driver-core.current/driver-core-linus (8f0b4cce4481 Linux 6.19-rc1)
...
Merging input-current/for-linus (e58c88f0cb2d Input: lkkbd - disable pendin=
g work before freeing device)
...
Merging dmaengine-fixes/fixes (430f7803b69c dmaengine: ti: k3-udma: fix dev=
...
Merging drivers-x86-fixes/fixes (8f0b4cce4481 Linux 6.19-rc1)
...
Merging tip-fixes/tip/urgent (c3e82c80487b Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-rust-fixes/drm-rust-fixes (8f0b4cce4481 Linux 6.19-rc1)
Merging tenstorrent-dt-fixes/tenstorrent-dt-fixes (3a8660878839 Linux 6.18-=
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (7bbf6d15e935 accel/amdxdna: Bl=
ock running under a hypervisor)
...
Merging mm-unstable/mm-unstable (042ff77fdd18 mm: fixup pfnmap memory failu=
re handling to use pgoff)
Merging mm-nonmm-unstable/mm-nonmm-unstable (735be8c5b5ba .mailmap: remove =
one of the entries for WangYuli)
...
Merging drivers-memory/for-next (8f0b4cce4481 Linux 6.19-rc1)
...
nto for-next)
Merging samsung-krzk/for-next (ce39d255dea5 dt-bindings: samsung: exynos-pm=
u: Add compatible for ARTPEC-9 SoC)
Merging scmi/for-linux-next (334c3c2d5f66 Merge branches 'for-next/juno/upd=
...
Merging ti/ti-next (35d822aa1faf Merge branches 'ti-k3-dts-next' and 'ti-dr=
...
Merging xtensa/xtensa-for-next (0d4b3ca115b5 xtensa: align: validate access=
 in fast_load_store)
Merging fs-next (e9e86ea52163 Merge branch 'vfs.all' of https://git.kernel.=
...
Merging pm/linux-next (31aaa151cda5 Merge branch 'fixes' into linux-next)
...
Merging drm-misc/for-linux-next (97f27573837e accel/amdxdna: Fix potential =
NULL pointer dereference in context cleanup)
Merging amdgpu/drm-next (f24e96d69f5b drm/amdgpu: Set xcp id for mes ring)
Merging drm-intel/for-linux-next (b8304863a399 Merge drm/drm-next into drm-=
intel-next)
...
Merging sound-asoc/for-next (522a323f41f5 Merge remote-tracking branch 'aso=
c/for-6.20' into asoc-next)
Merging modules/modules-next (1ddac5cd7f27 MAINTAINERS: Add myself as revie=
wer for module support)
Merging input/next (686c64557be4 MAINTAINERS: adjust file entry in HIMAX HX=
83112B TOUCHSCREEN SUPPORT)
...
Merging security/next (8f0b4cce4481 Linux 6.19-rc1)
...
bed)
Merging tomoyo/master (9575ce3f015e RDMA/core: add device registration debu=
gging)
...
ore' into next)
Merging audit/next (8f0b4cce4481 Linux 6.19-rc1)
Merging devicetree/for-next (954c55c658e1 dt-bindings: kbuild: Skip validat=
ing empty examples)
Merging dt-krzk/for-next (8f0b4cce4481 Linux 6.19-rc1)
Merging mailbox/for-next (1ec6e0e8c0dd mailbox: mtk-cmdq: Add driver data t=
o support for MT8196)
Merging spi/for-next (f470d80b1fc3 Merge remote-tracking branch 'spi/for-6.=
20' into spi-next)
Merging tip/master (52aac28c48c4 Merge branch into tip/master: 'x86/cpu')
...
Merging sched-ext/for-next (bb27226f0d00 sched_ext: Remove unused code in t=
he do_pick_task_scx())
...
Merging soundwire/next (8f0b4cce4481 Linux 6.19-rc1)
...
Merging dmaengine/next (8f0b4cce4481 Linux 6.19-rc1)
...
Merging rpmsg/for-next (6a95c70e60a0 Merge branches 'rproc-next' and 'rpmsg=
-next' into for-next)
...

=8jjp
-----END PGP SIGNATURE-----
