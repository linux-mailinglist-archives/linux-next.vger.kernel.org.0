Return-Path: <linux-next+bounces-4755-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 0E4589C4E53
	for <lists+linux-next@lfdr.de>; Tue, 12 Nov 2024 06:38:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 494F6B257D5
	for <lists+linux-next@lfdr.de>; Tue, 12 Nov 2024 05:38:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 471B1189F37;
	Tue, 12 Nov 2024 05:37:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="CIioIkFx"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8C2BD17333A;
	Tue, 12 Nov 2024 05:37:39 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731389868; cv=none; b=kmVNMCrN30BpyY3VmJ+Z8DdEBp7W+jdgsclRQJTsJGSYU3e96X7QX2UCNwEfv70sZsRg7F9Cy8XzSo6uaJ2khWIE1HJHRoxm8I61ZEsVeZ2xqdktESvv3zL6ww6KXyHiEdlrn3QQXlqRJt75xRJ1q3BzlIh6dWoJD+cX6Ktav5Y=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731389868; c=relaxed/simple;
	bh=MYTKCH+iiIRwPZYy7WhvyN7RmecQLS9GqxMtlSwljG8=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=jG8nYXcxhl6XcVVb4B23amqkjxJATnwdxAuLPr7yc/DMrJYr1XZMRQlueflC8CCXvSFBLBTCROu0/K8Ln0unvMWZdC12zU9n1VfYXjTHWrv62Hv2KYYJ2PVXoPChY1swNoUToBlM9swBcPp9yQGeMP9rd2+0xJWe8sRmhABbZGA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=CIioIkFx; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1731389854;
	bh=w4CzE6njzavaqTCG+AZ/ItkosLHlACeVK7rlPcqZSYU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XnZtj70MYz4wxx;
	Tue, 12 Nov 2024 16:37:33 +1100 (AEDT)
Date: Tue, 12 Nov 2024 16:37:35 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 12
Message-ID: <20241112163735.3522e39f@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/jbnkCjoOKO3PHjWFIxBuOH+";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/jbnkCjoOKO3PHjWFIxBuOH+
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241111:

The bcachefs tree lost its build failure.

The tip tree lost its build failure and gained a confict against the
kbuild tree.

The rust tree lost its build failures.

Non-merge commits (relative to Linus' tree): 10016
 12544 files changed, 454633 insertions(+), 327009 deletions(-)
...
Merging origin/master (2d5404caa8c7 Linux 6.12-rc7)
...
erify_area())
Merging bcachefs/for-next (e6aeb4a1331f bcachefs: Fix shutdown message)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (e1a17369c4d4 Merge branch 'vfs.untorn.writes' =
...
Merging mm-hotfixes/mm-hotfixes-unstable (4cb9cfadd9ad selftests: hugetlb_d=
io: fixup check for initial conditions to skip in the start)
Merging fs-current (ddc0fdb554fd Merge branch 'fixes' of git://git.kernel.o=
...
Merging drm-intel-fixes/for-linux-next-fixes (2d5404caa8c7 Linux 6.12-rc7)
...
Merging tip-fixes/tip/urgent (3311cd903ab3 Merge branch into tip/master: 'x=
86/urgent')
...
Merging mm-stable/mm-stable (2b000f56f1d7 kasan: change kasan_atomics kunit=
 test as KUNIT_CASE_SLOW)
Merging mm-nonmm-stable/mm-nonmm-stable (777620b890d7 dma-buf: use atomic64=
_inc_return() in dma_buf_getfile())
Merging mm/mm-everything (724d0f8c8276 foo)
...
Merging qcom/for-next (981012f5c6f0 Merge branches 'arm32-for-6.13', 'arm64=
...
ing)
Merging loongarch/loongarch-next (561b5e81a052 irqchip/loongson-eiointc: Ad=
d virt extension support)
...
Merging fs-next (73a838777d37 Merge branch 'for-next' of git://git.kernel.o=
...
raw_spinlock_t)
Merging hid/for-next (20747e48c824 Merge branch 'for-6.12/upstream-fixes' i=
nto for-next)
...
Merging pm/linux-next (7b04a3bdf53e Merge branches 'acpi-processor' and 'ac=
pi-misc' into linux-next)
...
e rename events)
Merging net-next/main (c4e39b895a5c Merge branch 'knobs-for-npc-default-rul=
e-counters')
...
Merging bluetooth/master (42e8e5c1092b Bluetooth: hci_bcm: Use the devm_clk=
_get_optional() helper)
CONFLICT (content): Merge conflict in net/bluetooth/iso.c
CONFLICT (content): Merge conflict in net/bluetooth/sco.c
Merging wireless-next/for-next (857282b819cb wifi: brcmfmac: Fix oops due t=
o NULL pointer dereference in brcmf_sdiod_sglist_rw())
...
_engine_ops)
Merging spi-nor/spi-nor/next (f8f6224948d8 mtd: spi-nor: winbond: add "w/ a=
nd w/o SFDP" comment)
...
nos into drm-next)
Merging drm-misc/for-linux-next (d84927a4ad92 drm/bridge: cdns-mhdp8546: Re=
move unused functions)
Merging amdgpu/drm-next (377dda2cff59 drm/fourcc: add AMD_FMT_MOD_TILE_GFX9=
_4K_D_X)
Merging drm-intel/for-linux-next (ecf2afc59c1e drm/i915/scaler: Extract int=
el_allocate_scaler())
...
PCI functions)
Merging sound-asoc/for-next (52cf5128e13e Merge remote-tracking branch 'aso=
...
cate)
Merging block/for-next (c9af98a7e8af Merge branch 'for-6.13/block' into for=
-next)
...
13' into spi-next)
Merging tip/master (fb7300a68dfd Merge branch into tip/master: 'x86/tdx')
...
Merging kvm-arm/next (9d0bee66f739 Merge branch kvm-arm64/vgic-its-fixes in=
to kvmarm/next)
...
bin_is_visible()"
Merging usb/usb-next (de9df030ccb5 usb: typec: ucsi: glink: be more precise=
 on orientation-aware ports)
...
Merging kunit-next/kunit (91798814152b kunit: string-stream: Fix a UAF bug =
in kunit_init_suite())
Merging livepatching/for-next (9c66f50477e2 Merge branch 'for-6.13/selftest=
s-kprobe' into for-next)
Merging rtc/rtc-next (82ee16cfb290 rtc: add driver for Marvell 88PM886 PMIC=
 RTC)
...
Merging rust/rust-next (d072acda4862 rust: use custom FFI integer types)
...

=Yb0M
-----END PGP SIGNATURE-----
