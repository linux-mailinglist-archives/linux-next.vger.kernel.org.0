...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A19865A0885
	for <lists+linux-next@lfdr.de>; Thu, 25 Aug 2022 07:44:39 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231133AbiHYFoh (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 25 Aug 2022 01:44:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39420 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230127AbiHYFog (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 25 Aug 2022 01:44:36 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA2479F188;
        Wed, 24 Aug 2022 22:44:32 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4MCsNb0Ggjz4x1G;
        Thu, 25 Aug 2022 15:44:31 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1661406271;
        bh=idBbCUKGr5pl+fcZEgYeVTGi1nIJYk7TtdodfiZ3Vbg=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 25 Aug 2022 15:44:29 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 25
Message-ID: <20220825154429.6169b270@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Br=KN0Wp7pLk/bpPor.XQ/1";
...
The bpf-next tree gained conflicts against the bpf and net trees.

The scsi-mkp tree still had its build failure so I used the version from
next-20220823.

Non-merge commits (relative to Linus' tree): 2703
 3737 files changed, 152359 insertions(+), 62481 deletions(-)
...
Merging origin/master (c40e8341e3b3 Merge tag 'cgroup-for-6.0-rc2-fixes' of=
...
Merging net/master (0c4a95417ee4 Merge branch 'sysctl-data-races')
Merging bpf/master (0947ae112108 bpf: Fix a data-race around bpf_jit_limit.)
...
o next)
Merging mediatek/for-next (f98c90bd1678 arm64: dts: mediatek: mt8183-pumpki=
n: add keypad support)
...
to for-next)
Merging samsung-krzk/for-next (66a40a905a57 Merge branch 'next/clk' into fo=
r-next)
...
Merging xilinx/for-next (568035b01cfb Linux 6.0-rc1)
...
Merging ceph/master (a8af0d682ae0 libceph: clean up ceph_osdc_start_request=
 prototype)
Merging cifs/for-next (df5ab7d154c2 smb3: fix temporary data corruption in =
insert range)
...
Merging pm/linux-next (13acf71a530b Merge branch 'thermal-intel' into linux=
-next)
...
l to strscpy)
Merging net-next/master (8357d67f5ec0 Merge branch 'r8169-next')
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/en_fs.c
Merging bpf-next/for-next (6fc2838b148f selftests/bpf: Fix wrong size passe=
d to bpf_setsockopt())
...
Merging drm-intel/for-linux-next (11c7faa61d13 drm/i915/dg2: Add additional=
 HDMI pixel clock frequencies)
...
into for-next)
Merging sound-asoc/for-next (b2681ccbd203 Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (b8a9f5a03ad6 Merge remote-tracking branch 'regu=
...
to trace/for-next)
Merging rcu/rcu/next (b417c40b3996 rcu: Exclude outgoing CPU when it is the=
 last to leave)
...
Merging staging/staging-next (24e18c8e985e staging: r8188eu: always update =
...
Merging slab/for-next (27bc5cbbaa73 Merge branch 'slab/for-6.1/common_kmall=
...
Merging mm/mm-everything (e75a966d3a94 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...

=3WAg
-----END PGP SIGNATURE-----
