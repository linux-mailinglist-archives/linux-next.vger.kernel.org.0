...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 93A464EB87B
	for <lists+linux-next@lfdr.de>; Wed, 30 Mar 2022 04:48:52 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242116AbiC3CuX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 29 Mar 2022 22:50:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56428 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242113AbiC3CuQ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 29 Mar 2022 22:50:16 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA570E04;
        Tue, 29 Mar 2022 19:48:28 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KSrTk1VGvz4xNm;
        Wed, 30 Mar 2022 13:48:26 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1648608506;
        bh=gPSC9pP250StgQB7EtecAtyc3Ndsu/8R8JXS6D/GzrA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 30 Mar 2022 13:48:25 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 30
Message-ID: <20220330134825.56fe6cee@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ssO/zQ8BCBwyGZwMc0ycDHo";
...
Non-merge commits (relative to Linus' tree): 1330
 1482 files changed, 74109 insertions(+), 19628 deletions(-)
...
Merging origin/master (13776ebb9964 Merge tag 'devprop-5.18-rc1' of git://g=
...
Merging net/master (ad7da1ce5749 net: lan966x: fix kernel oops on ioctl whe=
n I/F is down)
Merging bpf/master (ccaff3d56acc selftests/bpf: Fix clang compilation error=
s)
...
Merging driver-core.current/driver-core-linus (1930a6e739c4 Merge tag 'ptra=
ce-cleanups-for-v5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebi=
ederm/user-namespace)
...
pace)
Merging usb.current/usb-linus (1930a6e739c4 Merge tag 'ptrace-cleanups-for-=
v5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebiederm/user-names=
pace)
...
Merging staging.current/staging-linus (1930a6e739c4 Merge tag 'ptrace-clean=
ups-for-v5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebiederm/us=
er-namespace)
...
Merging devicetree-fixes/dt/linus (22a41e9a5044 dt-bindings: Fix missing '/=
schemas' in $ref paths)
...
Merging dma-mapping/for-next (ca8f6ed43e35 PCI: Remove the deprecated "pci-=
dma-compat.h" API)
...
Merging cifs/for-next (b2a94175fa26 cifs: fix NULL ptr dereference in smb2_=
ioctl_query_info())
...
Merging jc_docs/docs-next (d8bd67a48930 docs: sphinx/requirements: Limit ji=
nja2<3.1)
...
Merging drm/drm-next (2a81dba4b577 fbdev: Fix cfb_imageblit() for arbitrary=
 image widths)
Merging drm-misc/for-linux-next (c42ee39c1e78 dma-buf: handle empty dma_fen=
ce_arrays gracefully)
...
Merging block/for-next (c02b67509585 Merge branch 'for-5.18/drivers' into f=
or-next)
Merging device-mapper/for-next (41a2c7829baa dm: conditionally enable branc=
...
nto HEAD)
Merging kvm/next (b1e34d325397 KVM: x86: Forbid VMM to set SYNIC/STIMER MSR=
s when SynIC wasn't activated)
...
ing for SLAB)
Merging driver-core/driver-core-next (1930a6e739c4 Merge tag 'ptrace-cleanu=
ps-for-v5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebiederm/use=
r-namespace)
Merging usb/usb-next (1930a6e739c4 Merge tag 'ptrace-cleanups-for-v5.18' of=
...
Merging staging/staging-next (1930a6e739c4 Merge tag 'ptrace-cleanups-for-v=
5.18' of git://git.kernel.org/pub/scm/linux/kernel/git/ebiederm/user-namesp=
ace)
...
[master e05279b7501a] next-20220329/sysctl
...
Merging akpm/master (187508da4be1 kselftest/vm: override TARGETS from argum=
ents)
...

=DOm2
-----END PGP SIGNATURE-----
