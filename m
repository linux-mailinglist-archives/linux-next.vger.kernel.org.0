Return-Path: <linux-next+bounces-5587-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4B427A47671
	for <lists+linux-next@lfdr.de>; Thu, 27 Feb 2025 08:25:32 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 400C73AF751
	for <lists+linux-next@lfdr.de>; Thu, 27 Feb 2025 07:25:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0259021D3EB;
	Thu, 27 Feb 2025 07:25:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="EtLlud4k"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C326821C9F4;
	Thu, 27 Feb 2025 07:25:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1740641128; cv=none; b=k6Qvx0kfUhcv66/UEUXKqbLmt1X8D3pIlMkOmO+Xnc/U35Cxy2nTYUe9FBczWKXby/E+7tBHwdJMzCzza/xdmwWMVlsrfYN17Jv2g5qKut9KUyMgSTb5RhDh1td+jSDkqPLS8sujpRTi0rN5LbGUR55We84PCQ2X4aiUIXmOXYk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1740641128; c=relaxed/simple;
	bh=F4Y+p0KL4Tsn2nf+weit5tRRiRV0ecoVsAD3qVaaYDQ=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=ZdLwItm+tBqs7Jhp4yPa0aDRH08gDBGXWGz3sclty9Fw/P0JLhGka6LHycdv2NSVAPFh0PKCv6Y2nIq4c9mpON83gWxqtdO87epYAF1xC8OXFzTkJNZ5zrQ5XHCsvJEAFTXno1qScE6Xrw72KZHJj98n1ifqaXjKn2+/HGOcqls=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=EtLlud4k; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1740641119;
	bh=9CuSAu/DAuhfH54JQNO8yh6d4dcyy8yLAwpiNQlxgnA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Z3NCg4YbKz4wbx;
	Thu, 27 Feb 2025 18:25:19 +1100 (AEDT)
Date: Thu, 27 Feb 2025 18:25:17 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 27
Message-ID: <20250227182517.156d55d3@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ndEk6pMEG2MjwlZNfRrlOZ/";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/ndEk6pMEG2MjwlZNfRrlOZ/
...
Merging origin/master (5394eea10651 Merge tag 'nfs-for-6.14-2' of git://git=
.linux-nfs.org/projects/anna/linux-nfs)
Merging fixes/fixes (fac04efc5c79 Linux 6.13-rc2)
Merging ext4-fixes/fixes (4bbf9020becb Linux 6.13-rc4)
Merging vfs-brauner-fixes/vfs.fixes (b5799106b44e iomap: Minor code simplif=
ication in iomap_dio_bio_iter())
...
Merging btrfs/for-next (931e9bd7d513 Merge branch 'for-next-next-v6.14-2025=
0226' into for-next-20250226)
$ git reset --hard HEAD^
Merging next-20250226 version of btrfs
Merging ceph/master (3981be13ec1b ceph: exchange hardcoded value on NAME_MA=
X)
Merging cifs/for-next (4a4c18f863d8 smb: client: Fix netns refcount imbalan=
...
king and fragments)
Merging exfat/dev (f3b71bba7baa exfat: make flag mount options unsetable vi=
a negative param)
...
YSFSPATH)
Merging vfs-brauner/vfs.all (f56e1a3fb6ad Merge branch 'vfs-6.15.mount.name=
space' into vfs.all)
Merging vfs/for-next (2e72b1e0aac2 Merge branch 'work.d_revalidate' into fo=
r-next)
Merging mm-hotfixes/mm-hotfixes-unstable (a88b5ef577dd mm: page_isolation: =
avoid calling folio_hstate() without hugetlb_lock)
Merging fs-current (c3ee531a70b8 Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (8d52da23b6c6 tcp: Defer ts_recent changes until req is ow=
ned)
...
Merging tip-fixes/tip/urgent (1ce83af848cf Merge branch into tip/master: 'x=
86/urgent')
...
Merging drm-misc-fixes/for-linux-next-fixes (01f1d77a2630 drm/nouveau: Do n=
ot override forced connector status)
...
Merging perf/perf-tools-next (c40aa8d98db6 perf report: Fix sample number s=
tats for branch entry mode)
...
Merging rockchip/for-next (379518d74049 Merge branch 'v6.15-armsoc/dts64' i=
nto for-next)
Merging samsung-krzk/for-next (db9af58db84e Merge branch 'next/dt64' into f=
or-next)
Merging scmi/for-linux-next (5040b9b79da2 Merge branches 'for-next/scmi/upd=
...
Merging stm32/stm32-next (80c7ee9c2094 ARM: dts: stm32: Add Priva E-Measuri=
ngbox devicetree)
...
Merging fs-next (8e5243537774 Merge branch 'for-next' of git://git.kernel.o=
...
Merging bluetooth/master (978777bfa2d8 Bluetooth: btintel_pcie: Read hardwa=
re exception data)
Merging wireless-next/for-next (95da92e7c6ff wifi: iwlwifi: add Debug Host =
Command APIs)
Merging ath-next/for-next (27d38bdfd416 wifi: ath12k: Improve BSS discovery=
 with hidden SSID in 6 GHz band)
...
m ahash_alg)
Merging drm/drm-next (16893dd23f6d Merge tag 'drm-intel-next-2025-02-24' of=
 https://gitlab.freedesktop.org/drm/i915/kernel into drm-next)
Merging drm-exynos/for-linux-next (81a50378559b drm/exynos: Remove unnecess=
ary checking)
Merging drm-misc/for-linux-next (099b79f94366 drm/doc: Document KUnit expec=
tations)
Merging amdgpu/drm-next (dab993bf1513 drm/amdgpu: increase AMDGPU_MAX_RINGS)
Merging drm-intel/for-linux-next (db0d2d757215 drm/i915: Fix pipeDMC and AT=
S fault handling)
...
Merging drm-xe/drm-xe-next (18778b5fdd01 drm/xe: Eliminate usage of TIMESTA=
MP_OVERRIDE)
...
Merging sound-asoc/for-next (32adeb9806ac Merge remote-tracking branch 'aso=
...
Merging input/next (7f7573bd4f37 Input: pm8941-pwrkey - fix dev_dbg() outpu=
t in pm8941_pwrkey_irq())
Merging block/for-next (9eacd7d46acb Merge branch 'for-6.15/io_uring' into =
for-next)
...
Merging spi/for-next (e788253702ea Merge remote-tracking branch 'spi/for-6.=
15' into spi-next)
...
Merging tip/master (574024b154d9 Merge branch into tip/master: 'x86/platfor=
m')
...
Merging ftrace/for-next (dc208c69c033 scripts/sorttable: Allow matches to f=
unctions before function entry)
Merging rcu/next (c52f04dbdef4 Merge branches 'docs.2025.02.04a', 'lazypree=
mpt.2025.02.24a', 'misc.2025.02.06a', 'srcu.2025.02.05a' and 'torture.2025.=
02.05a')
...
omem)
Merging gpio-brgl/gpio/for-next (087f8a6b8ce9 gpio: pcf857x: add support fo=
r reset-gpios on (most) PCA967x)
...
Merging cxl/next (22eea823f69a Merge branch 'for-6.15/extended-linear-cache=
' into cxl-for-next)
...

=Va/A
-----END PGP SIGNATURE-----
