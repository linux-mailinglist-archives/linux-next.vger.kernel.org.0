...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3B39A11224E
	for <lists+linux-next@lfdr.de>; Wed,  4 Dec 2019 06:07:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725791AbfLDFHH (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 4 Dec 2019 00:07:07 -0500
Received: from ozlabs.org ([203.11.71.1]:41057 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725776AbfLDFHG (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 4 Dec 2019 00:07:06 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47SRfV6kvTz9sPV;
        Wed,  4 Dec 2019 16:06:58 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1575436018;
        bh=5mmjcUQilzYfrkcUhNSXhx3xDvSIQxwT06lU5MHkVXw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 4 Dec 2019 16:06:58 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 4
Message-ID: <20191204160658.64a3dd1c@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/o_Wlr5=d578JyfkY_9=mUp8";
...
The vhost tree gained a conflict against Linus' tree and 2 build failures
so I used the version frome next-20191203.

Non-merge commits (relative to Linus' tree): 2591
 2544 files changed, 88305 insertions(+), 34896 deletions(-)
...
Merging origin/master (2dff2a1c9b7c Merge branch 'dmi-for-linus' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/jdelvare/staging)
...
Merging net/master (2f23cd42e19c net: sched: fix dump qlen for sch_mq/sch_m=
qprio with NOLOCK subqueues)
...
desc_size)
Merging sound-current/for-linus (643a2cc99b53 ALSA: hda: hdmi - Keep old sl=
ot assignment behavior for Intel platforms)
Merging sound-asoc-fixes/for-linus (073130b5fe01 Merge branch 'asoc-5.5' in=
to asoc-linus)
Merging regmap-fixes/for-linus (af42d3466bdc Linux 5.4-rc8)
Merging regulator-fixes/for-linus (88c888614e8f Merge branch 'regulator-5.5=
' into regulator-linus)
Merging spi-fixes/for-linus (3d5e7b9c73b3 Merge branch 'spi-5.5' into spi-l=
inus)
Merging pci-current/for-linus (54ecb8f7028c Linux 5.4-rc1)
Merging driver-core.current/driver-core-linus (937d6eefc716 Merge tag 'docs=
-5.5a' of git://git.lwn.net/linux)
Merging tty.current/tty-linus (d6d5df1db6e9 Linux 5.4-rc5)
Merging usb.current/usb-linus (937d6eefc716 Merge tag 'docs-5.5a' of git://=
git.lwn.net/linux)
...
Merging staging.current/staging-linus (937d6eefc716 Merge tag 'docs-5.5a' o=
f git://git.lwn.net/linux)
Merging char-misc.current/char-misc-linus (937d6eefc716 Merge tag 'docs-5.5=
a' of git://git.lwn.net/linux)
...
Merging erofs-fixes/fixes (1aaad89e4acf erofs: zero out when listxattr is c=
alled with no xattr)
...
w mount API)
Merging cifs/for-next (faa719cf95eb smb3: query attributes on file close)
...
Merging drm-misc/for-linux-next (d6d07ca19c04 drm/dp_mst: Fix build on syst=
ems with STACKTRACE_SUPPORT=3Dn)
...
-next)
Merging sound/for-next (643a2cc99b53 ALSA: hda: hdmi - Keep old slot assign=
ment behavior for Intel platforms)
Merging sound-asoc/for-next (073130b5fe01 Merge branch 'asoc-5.5' into asoc=
-linus)
...
.MX6 S, DL and Q)
Merging block/for-next (39c1f82685b4 Merge branch 'for-linus' into for-next)
...
Merging regulator/for-next (88c888614e8f Merge branch 'regulator-5.5' into =
regulator-linus)
...
r imx v1 mu)
Merging spi/for-next (2835ce6b10bd Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
Merging edac/edac-for-next (5781823fd0d3 EDAC/altera: Use the Altera System=
 Manager driver)
Merging irqchip/irq/irqchip-next (090adda307bb irqchip/aspeed-i2c-ic: Fix i=
...
rflow
Merging akpm/master (adabf5b0490f drivers/media/platform/sti/delta/delta-ip=
...

=+5Yu
-----END PGP SIGNATURE-----
