Return-Path: <linux-next+bounces-1119-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 0667F850DB5
	for <lists+linux-next@lfdr.de>; Mon, 12 Feb 2024 08:02:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id F177B1C20933
	for <lists+linux-next@lfdr.de>; Mon, 12 Feb 2024 07:02:36 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5F5863D65;
	Mon, 12 Feb 2024 07:02:32 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="p/iU9LOI"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-f173.google.com (mail-pf1-f173.google.com [209.85.210.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8FDB73C15
	for <linux-next@vger.kernel.org>; Mon, 12 Feb 2024 07:02:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707721352; cv=none; b=aX5qVrzbHNGJRA+CpeCA1I/AdKszsoZOZwZInr1VxlCEp89Gqi4IXc48g4Z+kytQ1K73UobwUGZ1D32FaFxbJOr9RNpZjhH7dT3l1t4k95sfDGpAlAJ0nqsAqukWCjOJgK2mQLc7GuuPQwO7BhOTN0D8c4EWEVeHKjQ3hXroxIQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707721352; c=relaxed/simple;
	bh=w/kIGVtAE6zGiMDaaZA+28xNyCFrA+sM3UmpfI0ig28=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=KnT1+QoKBpDRXXfCnhW0my4xdDZxDP5viuFt6qBnUTBONBpxnPP1yu+I99llFKP9n3twdLE7N5N7n+p3qVjoQNlIzLDgCdbO+z9xuY49mMQhKMpgSEt7QQLGRa+9YOYwHl3tG2iBEoGAkPEwqsZ6Lxrrvuxjc88FcFZMjuLmRbg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=p/iU9LOI; arc=none smtp.client-ip=209.85.210.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pf1-f173.google.com with SMTP id d2e1a72fcca58-6e08dd0fa0bso1817741b3a.1
        for <linux-next@vger.kernel.org>; Sun, 11 Feb 2024 23:02:27 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1707721346; x=1708326146; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=b/CIcnu/C415BS+XFCyyaINlyMTScB4u1MmSLGo1bLo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707721346; x=1708326146;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=b/CIcnu/C415BS+XFCyyaINlyMTScB4u1MmSLGo1bLo=;
        b=
X-Gm-Message-State: AOJu0Yx7yCOxorQ6j3RagnOwzdk7Eaa/F9z1Uov9j0Tss93vJn9Vr+VZ
	AyGFV35q9asymrroDhF/YC77XHlhS6UV4l2vxIGQksKq6Ql1mWGb6nUzscv4GAiw2/uUxnOD0GO
	zDNQ=
X-Google-Smtp-Source: AGHT+IELb+Ct6OXRf0VmgERtCd4Uy6OYJL4occ4Xv4nJAwJRcJ+6G6zf1b5amDmjW0A+picwyTy4wg==
X-Received: by 2002:a05:6a00:189d:b0:6db:cf4c:d836 with SMTP id x29-20020a056a00189d00b006dbcf4cd836mr10436649pfh.4.1707721344833;
        Sun, 11 Feb 2024 23:02:24 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id z5-20020aa79e45000000b006dd6c439996sm4734928pfq.161.2024.02.11.23.02.23
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 11 Feb 2024 23:02:24 -0800 (PST)
Message-ID: <65c9c280.a70a0220.b3345.c7f3@mx.google.com>
Date: Sun, 11 Feb 2024 23:02:24 -0800 (PST)
...
Subject: next/master build: 182 builds: 15 failed, 167 passed, 48 errors,
 304 warnings (next-20240212)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 182 builds: 15 failed, 167 passed, 48 errors, 304 warnin=
gs (next-20240212)
...
Tree: next
Branch: master
Git Describe: next-20240212
Git Commit: ae00c445390b349e070a64dc62f08aa878db7248
...
x86_64:
    ...
    x86_64_defconfig: (rustc-1.74) FAIL
    x86_64_defconfig+kselftest: (rustc-1.74) FAIL
    x86_64_defconfig+rust: (rustc-1.74) FAIL
    x86_64_defconfig+rust-samples: (rustc-1.74) FAIL
...
i386:
    ...
    i386_defconfig (clang-17): 1 error, 1 warning
...
x86_64:
    x86_64_defconfig (rustc-1.74): 1 error, 1 warning
    x86_64_defconfig (gcc-10): 1 error, 1 warning
    x86_64_defconfig (clang-17): 1 error, 1 warning
    x86_64_defconfig+kselftest (rustc-1.74): 1 error, 1 warning
    x86_64_defconfig+rust (rustc-1.74): 1 error, 1 warning
    x86_64_defconfig+rust-samples (rustc-1.74): 1 error, 1 warning
    x86_64_defconfig+x86-board (gcc-10): 1 error, 1 warning
    x86_64_defconfig+x86-board+kselftest (gcc-10): 1 error, 1 warning

Errors summary:

    6    fs/quota/quota_tree.c:674:8: error: variable 'blk' is uninitialize=
...
-Wcpp]
    6    fs/quota/quota_tree.c:666:10: note: initialize the variable 'blk' =
...
---------------------------------------------------------------------------=
-----
i386_defconfig (i386, clang-17) =E2=80=94 FAIL, 1 error, 1 warning, 0 secti=
on mismatches

Errors:
    fs/quota/quota_tree.c:674:8: error: variable 'blk' is uninitialized whe=
n used here [-Werror,-Wuninitialized]

Warnings:
    fs/quota/quota_tree.c:666:10: note: initialize the variable 'blk' to si=
lence this warning
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig (x86_64, rustc-1.74) =E2=80=94 FAIL, 1 error, 1 warning, 0=
 section mismatches
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig (x86_64, clang-17) =E2=80=94 FAIL, 1 error, 1 warning, 0 s=
ection mismatches
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig+rust (x86_64, rustc-1.74) =E2=80=94 FAIL, 1 error, 1 warni=
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig+rust-samples (x86_64, rustc-1.74) =E2=80=94 FAIL, 1 error,=
