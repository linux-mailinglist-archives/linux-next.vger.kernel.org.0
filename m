Return-Path: <linux-next+bounces-9209-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id A27D7C84227
	for <lists+linux-next@lfdr.de>; Tue, 25 Nov 2025 10:05:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id CD90534C0BA
	for <lists+linux-next@lfdr.de>; Tue, 25 Nov 2025 09:05:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EE7B3296BBA;
	Tue, 25 Nov 2025 09:05:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="PlFW6RSZ"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 876D728726D;
	Tue, 25 Nov 2025 09:05:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764061548; cv=none; b=e0054E8MwdrO08ek5id3Aia36Vn8mt0UcGMFGH4bWf6KW1FYIwTkvqXZpJBjOZ5uwvXykd7bqvBdDpC9bPP0hckmn8PciuIeh3+2nyTvP/iP8unLFMaLAtJMLVlolUnzX0LwX2QmFvj9LBI7woIkm2uGVEClUZCfzfHluIEK2j8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764061548; c=relaxed/simple;
	bh=L/oUweMC2BOmCDvvcDmLPhk9UVdUX5tKJMSQnohITxk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=k7heb+LbbQuVoDXJPHpZGHFtemHB/H4c2WT7zTpSWaZbL5Pm0Hsc2QaBrWS5Sc+P5TV6HCZNzlTu4ZcmochKsF4KTKOJ3PwQzuMt8dZiAWACt0zA+60V/gYMPv6IGPLlRN1E7jmhG+Nzw5M9ZECAtjygJ+eAZFqOlPaAtZLxKb8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=PlFW6RSZ; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1764061540;
	bh=MVSQ2TS+2nNk6bn+RZhPYPw6tNOXc5+EYPULU2VfwDM=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4dFxcN0D25z4w1j;
	Tue, 25 Nov 2025 20:05:39 +1100 (AEDT)
Date: Tue, 25 Nov 2025 20:05:38 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 25
Message-ID: <20251125200538.492d6887@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/eutBp9Rwl3zhQ=Njq_Qd+IG";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/eutBp9Rwl3zhQ=Njq_Qd+IG
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20251124:

This kernel produces a warning at boot time.

The vfs-brauner tree still had its build failure so I used a supplied
patch.
The vfs_brauner tree gained a conflict against the mm-stable tree.
...
The kvm-x86 tree gained conflicts against the vfs-brauner and tip trees.

The cgroup tree gained a conflict against the tip tree.

The hyperv tree gained a conflict against the vfs-brauner tree.

Non-merge commits (relative to Linus' tree): 10762
 10974 files changed, 568060 insertions(+), 176736 deletions(-)
...
Merging origin/master (ac3fd01e4c1e Linux 6.18-rc7)
...
Merging btrfs/for-next (3accfb18cc90 Merge branch 'for-next-next-v6.18-2025=
1124' into for-next-20251124)
...
_open_session())
Merging cifs/for-next (384118ff7421 cifs: Use netfs_alloc/free_folioq_buffe=
r())
...
s)
Merging vfs-brauner/vfs.all (4d8cb2518d6f Merge branch 'vfs-6.19.fd_prepare=
' into vfs.all)
...
Merging mm-hotfixes/mm-hotfixes-unstable (7413111c67ea mm/huge_memory: Fix =
initialization of huge zero folio)
Merging fs-current (8b227add5248 Merge branch 'fixes' of https://git.kernel=
...
Merging drm-intel-fixes/for-linux-next-fixes (ac3fd01e4c1e Linux 6.18-rc7)
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (620a8f131154 drm: sti: fix dev=
ice leaks at component probe)
Merging mm-stable/mm-stable (84a8d467cc42 pagemap: update BUDDY flag docume=
ntation)
  270065f514c5 ("mm/mmap_lock: reset maple state on lock_vma_under_rcu() re=
try")
  52ac3f5829ee ("mailmap: add entry for Sam Protsenko")
  6c96c6bd2c71 ("MAINTAINERS: add test_kho to KHO's entry")
  7c9580f44f90 ("mm/filemap: fix logic around SIGBUS in filemap_map_pages()=
")
  cff47b9e39a6 ("mm/huge_memory: fix NULL pointer deference when splitting =
folio")
  de8798965fd0 ("mm/memfd: fix information leak in hugetlb folios")
  f0bb6dba3df3 ("selftests/mm: fix division-by-zero in uffd-unit-tests")
  f5e31a196edc ("mm: swap: remove duplicate nr_swap_pages decrement in get_=
swap_page_of_type()")
...
Merging mm-unstable/mm-unstable (32508c43a260 mm/huge_memory: fix folio spl=
it stats counting)
  0bda9b7dcbea ("kernel/kexec: fix IMA when allocation happens in CMA area")
  46442d285f2c ("kernel/kexec: change the prototype of kimage_map_segment()=
")
Merging mm-nonmm-unstable/mm-nonmm-unstable (78b9cda433d7 init: replace sim=
...
CONFLICT (content): Merge conflict in MAINTAINERS
Merging s390/for-next (bd46534c5026 Merge branch 'features' into for-next)
...
Merging fs-next (043293ba48c2 Merge branch 'for-next' of https://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs.git)
CONFLICT (content): Merge conflict in arch/s390/kernel/syscalls/syscall.tbl
CONFLICT (content): Merge conflict in mm/secretmem.c
Merging printk/for-next (75e016bba20a Merge branch 'rework/suspend-fixes' i=
nto for-next)
...
Merging hwmon-staging/hwmon-next (fe598ab37e47 hwmon: (vt8231) Convert macr=
os to functions to avoid TOCTOU)
...
Merging pm/linux-next (7992bcfd4c12 Merge branch 'thermal-intel' into linux=
-next)
...
Merging wireless-next/for-next (a8e5a110c0c3 wifi: brcmfmac: Add DMI nvram =
filename quirk for Acer A1 840 tablet)
...
Merging drm-xe/drm-xe-next (69ef30d6c903 drm/xe/uc: Change assertion to err=
or on huc authentication failure)
...
Merging sound-asoc/for-next (9f674565058b Merge remote-tracking branch 'aso=
...
Merging spi/for-next (3e4ddbfeb0dc Merge remote-tracking branch 'spi/for-6.=
19' into spi-next)
Merging tip/master (aecda73c2b25 Merge branch into tip/master: 'x86/sgx')
CONFLICT (content): Merge conflict in kernel/bpf/stackmap.c
Applying: fix up for "sched/mmcid: Use proper data structures"
Applying: fix up for "x86/bug: Add BUG_FORMAT basics"
...
b-modules only)
Merging kvm-arm/next (b5e3afe91cfa Merge branch 'kvm-arm64/nv-xnx-haf' into=
 kvmarm/next)
...

=dDu/
-----END PGP SIGNATURE-----
