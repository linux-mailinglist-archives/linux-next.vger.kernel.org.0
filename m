Return-Path: <linux-next+bounces-6019-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A7496A71044
	for <lists+linux-next@lfdr.de>; Wed, 26 Mar 2025 06:56:33 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 1E3E617475F
	for <lists+linux-next@lfdr.de>; Wed, 26 Mar 2025 05:56:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 71E402AF0A;
	Wed, 26 Mar 2025 05:56:29 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="uycmIZd0"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C96E0C8FE;
	Wed, 26 Mar 2025 05:56:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1742968589; cv=none; b=VssjIEtFQmPB18VJ708xisVMLcoZxLKjVjvdvHyKIhyTsmxBKW7IBIDT+8DR7v/mDPixEAzcRvhXf5WEQtxygKg1Ce5jwNBWrS09f8YCFL/r8uDfX79mMO8OAH5ToHXj1MRPtgsc6hg6V4AFhmYEAx6irOobmDebdVC5oXL6Rr4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1742968589; c=relaxed/simple;
	bh=+hCD8uW8ZwPkREGXjVGHBcI8BfYKRVT1X3TfzWrbHZw=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=qXCYxf7ULsDEUwYIZWvTiuhRaCcUw0Fgck8VuvMvWxkW0yeQDR8hzOLHUOep7b9YrhJ4G1vBzR6NtE0VOe9kz9PNYSuW2K2vMD6lx25QRjHdqTqUtZW21ZzAj6uqewf9BxHvgFJYRgEnHff+gf21aRhVM2KuQCLDDgrRnhcxElY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=uycmIZd0; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1742968580;
	bh=D0NcSSBiQonF6xnDBSPdVorjOllvG+vMZZVc2SgFDPE=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4ZMwyX3dB6z4x2g;
	Wed, 26 Mar 2025 16:56:20 +1100 (AEDT)
Date: Wed, 26 Mar 2025 16:56:19 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 26
Message-ID: <20250326165619.58d443f8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/LUW23GscscfvrW2lDNEwlJb";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/LUW23GscscfvrW2lDNEwlJb
...
The tip-fixes tree gained a build failure so I used the version from
next-20250325.

The kbuild tree still had its build failure for which I reverted a commit.

The bcachefs tree gained a semantic conflict against the mm-stable tree.

The apparmor tree gained a semantic conflict against the net-next tree.

Non-merge commits (relative to Linus' tree): 10939
 10540 files changed, 614921 insertions(+), 240028 deletions(-)
...
Merging origin/master (a5b3d8660b04 Merge tag 'hyperv-next-signed-20250324'=
...
Merging bcachefs/for-next (c9a1e7f6c37f bcachefs: Don't unnecessarily decry=
pt data when moving)
...
X)
Merging cifs/for-next (3d84ddb8f042 cifs: Check if server supports reparse =
...
TPAGE())
Merging ksmbd/ksmbd-for-next (aac22260238b ksmbd: fix r_count dec/increment=
 mismatch)
...
Merging fs-current (a4e3daa398c8 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (c7d82913d5f9 net: libwx: fix Tx L4 checksum)
...
e_rd)
Merging sound-current/for-linus (3a949fc08103 ALSA: hda: tas2781-i2c: Remov=
e unnecessary NULL check before release_firmware())
CONFLICT (modify/delete): arch/x86/entry/common.c deleted in HEAD and modif=
ied in sound-current/for-linus.  Version sound-current/for-linus of arch/x8=
6/entry/common.c left in tree.
$ git rm -f arch/x86/entry/common.c
Merging sound-asoc-fixes/for-linus (4ea3fff52fee Merge remote-tracking bran=
...
Merging tip-fixes/tip/urgent (00eb5437914b Merge branch into tip/master: 'x=
86/urgent')
$ git reset --hard HEAD^
Merging next-20250325 version of tip-fixes
...
Merging drm-misc-fixes/for-linux-next-fixes (a5b230e7f3a5 drm/imagination: =
...
Merging asm-generic/master (ece69af2ede1 rwonce: handle KCSAN like KASAN in=
 read_word_at_a_time())
...
t)
Merging clk/clk-next (45678d791e54 Merge branch 'clk-qcom' into clk-next)
...
Merging fs-next (30550a739f85 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
Applying: fix up for "bcachefs: bch2_time_stats_init_no_pcpu()"
...
Merging net-next/main (a19f40d919ca Merge branch 'net-usb-asix-ax88772-fix-=
potential-string-cut')
...
ntation)
Merging drm-xe/drm-xe-next (bf6cb06c0e05 drm/xe/pf: Enable per-function eng=
ine activity stats)
...
Merging sound/for-next (3a949fc08103 ALSA: hda: tas2781-i2c: Remove unneces=
sary NULL check before release_firmware())
Merging ieee1394/for-next (ca2c736554c1 firewire: core: avoid -Wflex-array-=
member-not-at-end warning)
Merging sound-asoc/for-next (4ea3fff52fee Merge remote-tracking branch 'aso=
...
lin-A series)
Merging block/for-next (60f2cb44c238 Merge branch 'for-6.15/block' into for=
-next)
...
Applying: fix up for "apparmor: add fine grained af_unix mediation"
...
15' into spi-next)
Merging tip/master (6ae01ffd0767 Merge branch into tip/master: 'x86/kconfig=
')
Applying: objtool: Fix NULL printf() '%s' argument
...
Merging bitmap/bitmap-for-next (16fa9b16a420 cpumask: drop cpumask_assign_c=
pu())
...

=3D0H
-----END PGP SIGNATURE-----
