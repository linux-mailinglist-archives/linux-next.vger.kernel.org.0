Return-Path: <linux-next+bounces-1631-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id E587687B6D1
	for <lists+linux-next@lfdr.de>; Thu, 14 Mar 2024 04:23:03 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 320DCB225D9
	for <lists+linux-next@lfdr.de>; Thu, 14 Mar 2024 03:23:01 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4CD15FBFC;
	Thu, 14 Mar 2024 03:22:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="SsWGT0IJ"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A719AFC09;
	Thu, 14 Mar 2024 03:22:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1710386576; cv=none; b=gSo+jmpBzNLLpaLQ9NLB8HiZLQxHG/0BE9GKr9ngJWggOZmWSRWp22Lll43/dOPyDxWoCkzV9JDVsTX26qenpcx7lB/ouQVkUEoyWjY76uZDs7bqfd8+c6itEMoEtgLXcYEaTPwgSUC2EgqJyakYhZWjR0jQo+YyDNRahVIlTIY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1710386576; c=relaxed/simple;
	bh=k8lnkmIUkEQTPGFLZ9C689mwgEYiRj5HUrSAfIck3c0=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=dSapnftvqGeQHCm4rqs7BQBivFNdQO8e/KkhIBkZI1g3idZiHYegGaTXDBZTmYrAEo31/QGw5Gris039s2WkEEoWFzFn6R2z560dSGRklzNeDyAbSKbY2TFE94GPuTRL7DlUXKPIiIhC22VAx/X4XA3XdIZ2HX3elg4+tzDYLv0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=SsWGT0IJ; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1710386569;
	bh=CEfvFKhPjBCfFY2l0jMknNrHnJaqPQKBW0lqmnNIErs=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TwCPP5YFjz4wb2;
	Thu, 14 Mar 2024 14:22:49 +1100 (AEDT)
Date: Thu, 14 Mar 2024 14:22:49 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 14
Message-ID: <20240314142249.2a28a205@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/+LmQoDZJB3azsHr2o9kP7TO";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/+LmQoDZJB3azsHr2o9kP7TO
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240313:

The sound-current tree lost its build failure.

Non-merge commits (relative to Linus' tree): 6289
 5899 files changed, 282614 insertions(+), 119877 deletions(-)
...
Merging origin/master (e5e038b7ae9d Merge tag 'fs_for_v6.9-rc1' of git://gi=
...
Merging net/main (d7d75124965a devlink: Fix devlink parallel commands proce=
ssing)
Merging bpf/master (d7d75124965a devlink: Fix devlink parallel commands pro=
cessing)
...
Merging wireless/for-next (67072c314f5f Merge branch 'tcp-rds-fix-use-after=
-free-around-kernel-tcp-reqsk')
...
Merging f2fs/dev (c644af133283 f2fs: prevent atomic write on pinned file)
...
of devices)
Merging pm/linux-next (394fee758b64 Merge branch 'thermal' into linux-next)
...
t)
Merging drm-misc/for-linux-next (9dd81b2e1ec7 drm/exynos: simplify the retu=
rn value handling in exynos_dp_get_modes())
Merging amdgpu/drm-next (7ea808d77cf3 drm/amd/display: Lock all enabled otg=
 pipes even with no planes)
  1bb3c35fff7c ("drm/amd/display: Add monitor patch for specific eDP")
Merging drm-intel/for-linux-next (71b218771426 drm/i915/hwmon: Fix locking =
inversion in sysfs getter)
...
Merging drm-xe/drm-xe-next (58480c1c912f drm/xe: Skip VMAs pin when request=
ing signal to the last XE_EXEC)
...
8' into spi-linus)
Merging tip/master (b5ff5e3af69f Merge branch into tip/master: 'x86/build')
...
Merging iio/togreg (f9d49338744b Merge branch 'togreg-cleanup' into togreg)
  05f91017c82a ("of: unittest: Use for_each_child_of_node_scoped()")
  58bc4d84a711 ("of: Introduce for_each_*_child_of_node_scoped() to automat=
e of_node_put() handling")
  76314e63407d ("of: Add cleanup.h based auto release via __free(device_nod=
e) markings.")
...

=fa6B
-----END PGP SIGNATURE-----
