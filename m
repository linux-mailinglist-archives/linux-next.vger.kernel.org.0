Return-Path: <linux-next+bounces-2362-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 054FA8CA66C
	for <lists+linux-next@lfdr.de>; Tue, 21 May 2024 04:54:54 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id AAB4A281AEF
	for <lists+linux-next@lfdr.de>; Tue, 21 May 2024 02:54:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0083717556;
	Tue, 21 May 2024 02:54:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="cmHIHuXC"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 251A817545;
	Tue, 21 May 2024 02:54:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1716260088; cv=none; b=LPviG8qZIwTHyPFZosLnuAkQQZe/zzcukEfK1TSI44p/bYsp2ruqyUrnfRq3w27JvwyZQW50lcXkfcRN8HsrZZX5PhlV813jqGLOrKkYTsboYqzDvSyQId2aneA8vE707jXTmREh6R/ska/AM4Sb4WdcwqAftdChYJWu+ZgGP7I=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1716260088; c=relaxed/simple;
	bh=1eSi615OW/RWYIhPQpcEtaa/SUVEswQqiizpXK1Avyc=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=hFnhlfwzoDbwRr+uom4stwCNM5IQr5j7BFaeSiwt3jSNHzkRbiswB/k/WU4+GmLNtCv2kfH9o8DxO7/4rq2fqB0hPQSbGbUhBJK8x3itMzUXCKLb4iqLSJ/oxw1Hq6T/hcx8bHOpH6X3r5cMaasLxl7h8yrQOC9BJ9awx1aRquQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=cmHIHuXC; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1716260082;
	bh=GKqge74R0etaTN2rtPkIpCpCpGxeaR1R3uCEn9t+vMA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VjzYZ1HTPz4wyQ;
	Tue, 21 May 2024 12:54:42 +1000 (AEST)
Date: Tue, 21 May 2024 12:54:41 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 21
Message-ID: <20240521125441.36589685@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/mxdU=e98q1KapU/pht1RqnK";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/mxdU=e98q1KapU/pht1RqnK
...
Merging origin/master (3eb3c33c1d87 Merge tag 'asm-generic-6.10' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/arnd/asm-generic)
...
Merging sound-asoc-fixes/for-linus (810296e34a29 Merge remote-tracking bran=
ch 'asoc/for-6.9' into asoc-linus)
Merging regmap-fixes/for-linus (7ba822189e60 regmap: kunit: Fix array overf=
low in stride() test)
Merging regulator-fixes/for-linus (5b6f7c40958b Merge remote-tracking branc=
...
Merging kbuild/for-next (eb6a9339efeb Merge tag 'mm-nonmm-stable-2024-05-19=
-11-56' of git://git.kernel.org/pub/scm/linux/kernel/git/akpm/mm)
...
s_valid kerneldoc)
Merging drm-intel/for-linux-next (d370a9dba5c4 drm/i915/psr: PSR2_CTL[Block=
 Count Number] not needed for LunarLake)
...
Merging sound-asoc/for-next (810296e34a29 Merge remote-tracking branch 'aso=
...
Merging input/next (e7647cbaba0e Input: xpad - add support for Machenike G5=
 Pro Controller)
Merging block/for-next (7f431a6b115c Merge branch 'block-6.10' into for-nex=
t)
...
Merging regulator/for-next (5b6f7c40958b Merge remote-tracking branch 'regu=
...
Merging tpmdd/next (6bd944d25368 KEYS: trusted: Do not use WARN when encode=
 fails)
...

=naLF
-----END PGP SIGNATURE-----
