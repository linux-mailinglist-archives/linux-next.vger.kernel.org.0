...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3F0FA36C04A
	for <lists+linux-next@lfdr.de>; Tue, 27 Apr 2021 09:41:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234964AbhD0Hk6 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 27 Apr 2021 03:40:58 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:57767 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231951AbhD0Hkx (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 27 Apr 2021 03:40:53 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FTtvq0nqYz9sXL;
        Tue, 27 Apr 2021 17:40:07 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1619509207;
        bh=sx25I4/AtezNe+QC0EYh1aVGPTI0NoH6pIsuYSmO4Jk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 27 Apr 2021 17:40:04 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 27
Message-ID: <20210427174004.767b488a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/OB1NNDrBx7aSMhjGAQH/A3o";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/OB1NNDrBx7aSMhjGAQH/A3o
...
The reset tree gained a conflict against the sound-current tree.

The risc-v tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 10389
 8883 files changed, 552574 insertions(+), 209635 deletions(-)
...
Merging origin/master (55ba0fe059a5 Merge tag 'for-5.13-tag' of git://git.k=
...
Merging arm-soc-fixes/arm/fixes (a1768dad775b Merge branch 'tegra/dt64' int=
o arm/fixes)
...
Merging sound-current/for-linus (45b14fe200ba ALSA: hda/cirrus: Use CS8409 =
filter to fix abnormal sounds on Bullseye)
Merging sound-asoc-fixes/for-linus (d143a69fd452 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (cc4e1ea50bba Merge remote-tracking branch 'spi=
...
Merging ceph/master (6f0a47fdbc26 libceph: bump CephXAuthenticate encoding =
version)
Merging cifs/for-next (a8a6082d4ae2 cifs: update internal version number)
...
in imxfb_probe())
Merging pm/linux-next (3c44d15e5ffd Merge branch 'pm-sleep' into linux-next)
...
pt_from_sock())
Merging swiotlb/linux-next (8d4df6f4f09c swiotlb: Fix the type of index)
...
Merging net-next/master (6d72e7c767ac net:emac/emac-mac: Fix a use after fr=
ee in emac_mac_tx_buf_send)
...
Merging bpf-next/for-next (87bd9e602e39 Merge branch 'bpf: Tracing and lsm =
programs re-attach')
...
lated bits)
Merging netfilter-next/master (47a6959fa331 netfilter: allow to turn off xt=
ables compat layer)
...
Merging sound/for-next (4fb44dd2c1dd ALSA: sb: Fix two use after free in sn=
d_sb_qsound_build)
Merging sound-asoc/for-next (ffc9841d5200 Merge remote-tracking branch 'aso=
...
Merging block/for-next (7a44c41a9797 Merge branch 'for-5.13/drivers' into f=
or-next)
...
Merging spi/for-next (cc4e1ea50bba Merge remote-tracking branch 'spi/for-5.=
13' into spi-linus)
...
Merging driver-core/driver-core-next (a943d76352db devm-helpers: Fix devm_d=
elayed_work_autocancel() kerneldoc)
Merging usb/usb-next (caa93d9bd2d7 usb: Fix up movement of USB core kerneld=
oc location)
...
Merging tty/tty-next (8720037d55db serial: extend compile-test coverage)
Merging char-misc/char-misc-next (e2cb6b891ad2 bluetooth: eliminate the pot=
ential race condition when removing the HCI controller)
...
Merging staging/staging-next (c295d3007ff6 staging: octeon: Use 'for_each_c=
hild_of_node')
...
isting file)
Merging gpio-brgl/gpio/for-next (a49d14276ac4 gpio: sim: allocate IDA numbe=
rs earlier)
...
Merging akpm/master (8d720838880f memfd_secret: use unsigned int rather tha=
...

=nfSo
-----END PGP SIGNATURE-----
