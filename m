...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 377A335DC1E
	for <lists+linux-next@lfdr.de>; Tue, 13 Apr 2021 12:04:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240470AbhDMKEg (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 13 Apr 2021 06:04:36 -0400
Received: from ozlabs.org ([203.11.71.1]:50987 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S239682AbhDMKEf (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 13 Apr 2021 06:04:35 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FKLmY5yxnz9sVv;
        Tue, 13 Apr 2021 20:04:13 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1618308253;
        bh=hye5zOEanxzOb3DY8CwAzQ6gRckyRg5FpZT2frQm3mI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 13 Apr 2021 20:04:12 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 13
Message-ID: <20210413200412.1b54021b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/r/r2uOOeaKJN5JOKyyWlov9";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/r/r2uOOeaKJN5JOKyyWlov9
...
mapping)
Merging arm64-fixes/for-next/fixes (2decad92f473 arm64: mte: Ensure TIF_MTE=
_ASYNC_FAULT is set atomically)
...
Merging sound-asoc-fixes/for-linus (49065ed5ad5b Merge remote-tracking bran=
...
b is used)
Merging cifs/for-next (e0347c4d5ea9 cifs: update internal version number)
...
e with ioctl)
Merging fuse/for-next (52a438c9e7c6 fuse: don't zero pages twice)
...
Merging dmi/dmi-for-next (3cb4d29a2633 MAINTAINERS: The DMI/SMBIOS tree has=
 moved)
Merging hwmon-staging/hwmon-next (37c8f621125f hwmon: (dell-smm) Add Dell L=
...
in imxfb_probe())
Merging pm/linux-next (3bf8ef9db350 Merge branch 'devprop' into linux-next)
...
ssage clearer)
Merging net-next/master (8ef7adc6beb2 net: ethernet: ravb: Enable optional =
refclk)
...
Applying: merger fix for "netfilter: bridge: add pre_exit hooks for ebtable=
 unregistration"
Merging bpf-next/for-next (aadb2bb83ff7 sock_map: Fix a potential use-after=
-free in sock_map_close())
...
body warning)
Merging bluetooth/master (13e66a52f780 Bluetooth: btusb: Add support for Li=
te-On Mediatek Chip)
...
_led_init())
Merging sound-asoc/for-next (00ed80f00d1d Merge remote-tracking branch 'aso=
...
Merging block/for-next (ccd36b4959b5 Merge branch 'for-5.13/io_uring' into =
for-next)
...
13' into spi-next)
Merging tip/auto-latest (298511e29d7c Merge branch 'core/entry')
...
Merging usb/usb-next (5bdb080f9603 Revert "usb: Link the ports to the conne=
ctors they are attached to")
Merging usb-gadget/next (e49d033bddf5 Linux 5.12-rc6)
Merging usb-serial/usb-next (d07082277f55 USB: serial: cp210x: add gpio-con=
figuration debug printk)
...
Merging akpm/master (74a3bdaf2091 memfd_secret: use unsigned int rather tha=
...

=Kx9s
-----END PGP SIGNATURE-----
