...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C6DBBD2096
	for <lists+linux-next@lfdr.de>; Thu, 10 Oct 2019 08:01:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728822AbfJJGBD (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 10 Oct 2019 02:01:03 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:33539 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727041AbfJJGBD (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 10 Oct 2019 02:01:03 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46pgS83Zj0z9sPd;
        Thu, 10 Oct 2019 17:00:56 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1570687256;
        bh=6kHTpUDxd875L6R/ETCM99JuFR4MsTai6w6Wd+XWjKE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 10 Oct 2019 17:00:56 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 10
Message-ID: <20191010170056.37f078a7@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/RGh./7d4+/UOhOTNL+vDeHo";
...
Merging origin/master (8a8c600de5dc Merge tag 'for-linus' of git://git.kern=
...
Merging net/master (4123f637a512 ip6erspan: remove the incorrect mtu limit =
for ip6erspan)
...
Merging sound-current/for-linus (130bce3afbbb ALSA: hdac: clear link output=
 stream mapping)
Merging sound-asoc-fixes/for-linus (89dfae218794 Merge branch 'asoc-5.4' in=
to asoc-linus)
...
Merging drivers-x86-fixes/fixes (da0c9ea146cb Linux 5.4-rc2)
...
efile for clang)
Merging drm-intel-fixes/for-linux-next-fixes (9a932201b720 drm/i915/gt: exe=
...
ed_resched() loop)
Merging mips/mips-next (c0de00b286ed MIPS: SGI-IP22/28: Use PROM for memory=
 detection)
...
_fs_client)
Merging cifs/for-next (0b3d0ef9840f CIFS: Force reval dentry if LOOKUP_REVA=
L flag is set)
...
Merging nfs-anna/linux-next (9a36e8cb8798 NFSv4: Fix leak of clp->cl_accept=
or string)
...
pecast)
Merging net-next/master (757926247836 net: stmmac: add flexible PPS to dwma=
c 4.10a)
Applying: rxrpc: fix up for "rxrpc: Fix trace-after-put looking at the put =
peer record"
Merging bpf-next/master (25bfef430e96 libbpf: Fix passing uninitialized byt=
es to setsockopt)
...
of cleanup code)
Merging drm-misc/for-linux-next (64292b3336e4 Documentation: Fix warning in=
 drm-kms-helpers.rst)
...
Merging sound-asoc/for-next (b9a7298ca495 Merge branch 'asoc-5.5' into asoc=
-next)
...
ath)
Merging xen-tip/linux-next (e848cc8166d7 xen: Stop abusing DT of_dma_config=
ure API)
...
rflow
Merging akpm/master (ef9498506af0 drivers/media/platform/sti/delta/delta-ip=
...

=ojzI
-----END PGP SIGNATURE-----
