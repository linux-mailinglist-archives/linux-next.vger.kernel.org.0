Return-Path: <linux-next+bounces-396-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id ADA8381330A
	for <lists+linux-next@lfdr.de>; Thu, 14 Dec 2023 15:26:56 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 82D101C21215
	for <lists+linux-next@lfdr.de>; Thu, 14 Dec 2023 14:26:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2324A55778;
	Thu, 14 Dec 2023 14:26:51 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="cmAQKmub"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pl1-x62a.google.com (mail-pl1-x62a.google.com [IPv6:2607:f8b0:4864:20::62a])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 56E729C
	for <linux-next@vger.kernel.org>; Thu, 14 Dec 2023 06:26:41 -0800 (PST)
Received: by mail-pl1-x62a.google.com with SMTP id d9443c01a7336-1d35a721340so9495285ad.2
        for <linux-next@vger.kernel.org>; Thu, 14 Dec 2023 06:26:41 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1702564000; x=1703168800; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=Qw69mv3RumDcsNRbJkkepDppw45+JyLRs5IJ61FmJ+Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1702564000; x=1703168800;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Qw69mv3RumDcsNRbJkkepDppw45+JyLRs5IJ61FmJ+Y=;
        b=
X-Gm-Message-State: AOJu0Yw4R/ZGEQFjefSPL5LFAm3GUZLvnc4UT2hSQjVxEM532RX84eXz
	t1q3KHqSZiye2akMhR4gdvGoYENwZ5Ipy5XvQDLeqw==
X-Google-Smtp-Source: AGHT+IFG42/9T/lAOMNodtfmMZHVhviQLGANdm7ss+EOStRlJucngo470MnOTFOt+P9D8Vumr5nRsQ==
X-Received: by 2002:a17:903:1251:b0:1d3:3680:101a with SMTP id u17-20020a170903125100b001d33680101amr3239655plh.25.1702563998355;
        Thu, 14 Dec 2023 06:26:38 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id h9-20020a170902748900b001d33e6521c1sm4982103pll.102.2023.12.14.06.26.36
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 14 Dec 2023 06:26:37 -0800 (PST)
Message-ID: <657b109d.170a0220.3dba9.0336@mx.google.com>
Date: Thu, 14 Dec 2023 06:26:37 -0800 (PST)
...
Subject: next/master build: 183 builds: 40 failed, 143 passed, 40 errors,
 376 warnings (next-20231214)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 183 builds: 40 failed, 143 passed, 40 errors, 376 warnin=
gs (next-20231214)
...
Tree: next
Branch: master
Git Describe: next-20231214
Git Commit: 11651f8cb2e88372d4ed523d909514dc9a613ea3
...
x86_64:
    ...
    x86_64_defconfig+rust: (rustc-1.73) FAIL
...
x86_64:
    ...
    x86_64_defconfig+rust (rustc-1.73): 1 error
...
use in this function); did you mean 'PAGE_SIZE'?
    1    error: aborting due to 5 previous errors
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig+rust (x86_64, rustc-1.73) =E2=80=94 FAIL, 1 error, 0 warni=
ngs, 0 section mismatches
