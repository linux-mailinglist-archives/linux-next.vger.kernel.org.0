...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 41FA64EE666
	for <lists+linux-next@lfdr.de>; Fri,  1 Apr 2022 05:04:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S244352AbiDADG3 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 31 Mar 2022 23:06:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43538 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S244350AbiDADGX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 31 Mar 2022 23:06:23 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 41C1B193B74;
        Thu, 31 Mar 2022 20:04:32 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KV4lL1vGGz4x7Y;
        Fri,  1 Apr 2022 14:04:30 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1648782270;
        bh=cLYpIL8ynAuQzyuTQtBp3tfs2tXwfh+tPpRKfCt3R7A=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 1 Apr 2022 14:04:29 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 1
Message-ID: <20220401140429.17dcffa4@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ZmuQI/c7Mh2ic807ZKntVBZ";
...
Changes since 20220331:

The sysctl tree still had its build failure so I used the version from
next-20220329.

Non-merge commits (relative to Linus' tree): 993
 1138 files changed, 60432 insertions(+), 12601 deletions(-)
...
Merging origin/master (354b8bf222ee Merge tag 'linux-watchdog-5.18-rc1' of =
...
Merging arm-current/fixes (8b2360c7157b ARM: 9187/1: JIVE: fix return value=
 of __setup handler)
...
Merging net/master (2975dbdc3989 Merge tag 'net-5.18-rc1' of git://git.kern=
...
Merging pci-current/for-linus (1c6cec4ab487 x86/PCI: Log host bridge window=
 clipping for E820 regions)
Merging driver-core.current/driver-core-linus (787af64d05cd mm: page_alloc:=
 validate buddy before check its migratetype.)
...
Merging staging.current/staging-linus (787af64d05cd mm: page_alloc: validat=
e buddy before check its migratetype.)
...
Merging char-misc.current/char-misc-linus (787af64d05cd mm: page_alloc: val=
idate buddy before check its migratetype.)
Merging soundwire-fixes/fixes (e783362eb54c Linux 5.17-rc1)
Merging thunderbolt-fixes/fixes (f443e374ae13 Linux 5.17)
Merging input-current/for-linus (5710faba8a2a Merge branch 'next' into for-=
linus)
...
Merging dma-mapping/for-next (bc29832b74e0 dma-mapping: move pgprot_decrypt=
ed out of dma_pgprot)
Merging asm-generic/master (aec499c75cf8 nds32: Remove the architecture)
Merging arc/for-next (6880fa6c5660 Linux 5.15-rc1)
Merging arm/for-next (8caec335e08b Merge branch 'devel-stable' into for-nex=
t)
...
Merging parisc-hd/for-next (67eab0c07703 parisc: Don't enforce DMA completi=
...
Merging cifs/for-next (d6f5e3584524 cifs: fix NULL ptr dereference in smb2_=
ioctl_query_info())
...
Merging pci/next (148a65047695 Merge tag 'pci-v5.18-changes' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/helgaas/pci)
...
Merging bpf-next/for-next (2975dbdc3989 Merge tag 'net-5.18-rc1' of git://g=
...
Merging block/for-next (20658b141b8f Merge branch 'for-5.18/io_uring' into =
for-next)
Merging device-mapper/for-next (f65a4bb1d7e2 dm: conditionally enable BIOSE=
T_PERCPU_CACHE for dm_io bioset)
...
nto HEAD)
Merging kvm/next (81d50efcff6c x86, kvm: fix compilation for !CONFIG_PARAVI=
RT_SPINLOCKS or !CONFIG_SMP)
...
Merging chrome-platform/for-next (a9e896f70fbe platform/chrome: cros_ec_deb=
...
ing for SLAB)
Merging driver-core/driver-core-next (787af64d05cd mm: page_alloc: validate=
 buddy before check its migratetype.)
...
Merging char-misc/char-misc-next (787af64d05cd mm: page_alloc: validate bud=
dy before check its migratetype.)
...
Merging staging/staging-next (787af64d05cd mm: page_alloc: validate buddy b=
efore check its migratetype.)
...
nto slab/for-next)
Merging random/master (1754abb3e758 random: mix build-time latent entropy i=
nto pool at init)
...
Merging akpm-current/current (1042bbddcb23 ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
CONFLICT (content): Merge conflict in arch/arm64/Kconfig
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (adefb3650cfb kselftest/vm: override TARGETS from argum=
ents)
...

=p8Tz
-----END PGP SIGNATURE-----
