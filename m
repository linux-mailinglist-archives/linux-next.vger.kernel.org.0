...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2C34A4E5F9D
	for <lists+linux-next@lfdr.de>; Thu, 24 Mar 2022 08:42:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242413AbiCXHoU (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 24 Mar 2022 03:44:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38256 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237386AbiCXHoT (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 24 Mar 2022 03:44:19 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 125C66D1A1;
        Thu, 24 Mar 2022 00:42:46 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KPHJ44ZMkz4xQv;
        Thu, 24 Mar 2022 18:42:44 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1648107764;
        bh=i2hmCt4UNFkr3l5++KhyZCFCRe/UbpZC/9tMFnE06aA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 24 Mar 2022 18:42:43 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 24
Message-ID: <20220324184243.25440f73@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/LfiwqDHYf9OIJeJ60uWIIyz";
...
Merging origin/master (d51b1b33c51d Merge tag 'linux-kselftest-kunit-5.18-r=
...
Merging net/master (f92fcb5c00dc Merge branch 'ice-avoid-sleeping-schedulin=
g-in-atomic-contexts')
...
Merging sound-current/for-linus (ef248d9bd616 ALSA: hda/realtek: Add alc256=
-samsung-headphone fixup)
...
CONFLICT (modify/delete): arch/nds32/include/asm/pgtable.h deleted in asm-g=
eneric/master and modified in HEAD.  Version HEAD of arch/nds32/include/asm=
/pgtable.h left in tree.
CONFLICT (modify/delete): arch/nds32/mm/init.c deleted in asm-generic/maste=
r and modified in HEAD.  Version HEAD of arch/nds32/mm/init.c left in tree.
...
CONFLICT (modify/delete): arch/arm/mach-pxa/stargate2.c deleted in arm-soc/=
for-next and modified in HEAD.  Version HEAD of arch/arm/mach-pxa/stargate2=
.c left in tree.
...
Merging parisc-hd/for-next (1573b3d64137 parisc: Convert parisc_requires_co=
...
Merging ksmbd/ksmbd-for-next (2bf4f33f68bc MAINTAINERS: ksmbd: switch Serge=
y to reviewer)
...
Merging xfs/for-next (77646dcad4d5 xfs: rename "alloc_set_aside" to be more=
 descriptive)
...
Merging net-next/master (89695196f0ba Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/netdev/net)
Merging bpf-next/for-next (2af7e566a861 net/mlx5e: Fix build warning, detec=
ted write beyond size of field)
...
Merging sound/for-next (ef248d9bd616 ALSA: hda/realtek: Add alc256-samsung-=
headphone fixup)
...
Merging block/for-next (7f813daa416d Merge branch 'for-5.18/io_uring' into =
for-next)
...
Merging pinctrl/for-next (5c032526a5b4 pinctrl: nuvoton: Fix return value c=
heck in wpcm450_gpio_register())
...
nto slab/for-next)
Merging random/master (4dd07af12b86 random: re-add removed comment about ge=
t_random_{u32,u64} reseeding)
...
Merging akpm-current/current (460cd5123124 ipc/mqueue: use get_tree_nodev()=
 in mqueue_get_tree())
...
Merging akpm/master (c31e69c8982a kselftest/vm: override TARGETS from argum=
ents)
...

=SWh1
-----END PGP SIGNATURE-----
