...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C964E2443DC
	for <lists+linux-next@lfdr.de>; Fri, 14 Aug 2020 05:08:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726627AbgHNDIl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 13 Aug 2020 23:08:41 -0400
Received: from ozlabs.org ([203.11.71.1]:38747 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726604AbgHNDIl (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 13 Aug 2020 23:08:41 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BST0g694Lz9sTH;
        Fri, 14 Aug 2020 13:08:35 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1597374515;
        bh=yX8/9GcuqSiA4SYQToqsntjg2nplMirnGKFgpEUvxl4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 14 Aug 2020 13:08:35 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 14
Message-ID: <20200814130835.707e8d3e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/TFqLhZYuhTsw8JKTNmxFMkh";
...
Merging origin/master (dddcbc139e96 Merge tag 'docs-5.9-2' of git://git.lwn=
.net/linux)
...
Merging sound-current/for-linus (5a25de6df789 ALSA: echoaudio: Fix potentia=
l Oops in snd_echo_resume())
...
Merging risc-v-fixes/fixes (dbf83817315d Merge tag 'riscv-for-linus-5.9-mw0=
...
Merging risc-v/for-next (dbf83817315d Merge tag 'riscv-for-linus-5.9-mw0' o=
...
session messages)
Merging cifs/for-next (5f953159db3e SMB3: Fix mkdir when idsfromsid configu=
red on mount)
...
Merging sound/for-next (5a25de6df789 ALSA: echoaudio: Fix potential Oops in=
 snd_echo_resume())
...
tatus reply)
Merging devicetree/for-next (e0fe7fc6f2ca dt-bindings: Whitespace clean-ups=
 in schema files)
...
9' into spi-linus)
Merging tip/auto-latest (979c323f950d Merge branch 'irq/urgent')
...
Merging akpm/master (4eb3c2a0509d virtio: pci: constify ioreadX() iomem arg=
...

=9ZEz
-----END PGP SIGNATURE-----
