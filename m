...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B63B3D87F9
	for <lists+linux-next@lfdr.de>; Wed, 16 Oct 2019 07:17:22 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726648AbfJPFRK (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 16 Oct 2019 01:17:10 -0400
Received: from ozlabs.org ([203.11.71.1]:54613 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725980AbfJPFRJ (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 16 Oct 2019 01:17:09 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46tLBn1FG5z9sCJ;
        Wed, 16 Oct 2019 16:17:05 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1571203025;
        bh=l1ksdIvybEY2DZNFRLGl5/deIe/let9qRwrPx1vMI7I=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 16 Oct 2019 16:17:04 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 16
Message-ID: <20191016161704.33d03087@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/MgsB6EJFdCntZ/ERdYwdjUT";
...
Merging origin/master (8e0d0ad206f0 sparc64: disable fast-GUP due to unexpl=
ained oopses)
...
Merging arm64-fixes/for-next/fixes (8c551f919a73 arm64: hibernate: check pg=
d table allocation)
...
Merging net/master (ddc790e92b3a net: ethernet: broadcom: have drivers sele=
ct DIMLIB as needed)
...
Merging sound-current/for-linus (130bce3afbbb ALSA: hdac: clear link output=
 stream mapping)
Merging sound-asoc-fixes/for-linus (8a5ed7fb8253 Merge branch 'asoc-5.4' in=
to asoc-linus)
...
Merging btrfs-fixes/next-fixes (460df0bc7940 Merge branch 'misc-5.4' into n=
ext-fixes)
...
_pin_request())
Merging risc-v-fixes/fixes (4c8eb19cf9dc riscv: tlbflush: remove confusing =
comment on local_flush_tlb_all())
...
or-next)
Merging arm64/for-next/core (054992eced47 Merge branches 'for-next/elf-hwca=
...
into sunxi/for-next)
Merging tegra/for-next (e989ea9980ea Merge branch for-5.5/arm64/dt into for=
-next)
...
Q())
Merging xtensa/xtensa-for-next (e1669e8b5647 Merge branch 'xtensa-5.4-fixes=
...
lkstat to signed)
Merging iomap/iomap-for-next (c9acd3aee077 xfs: Use iomap_dio_rw_wait())
...
in imxfb_probe())
Merging pm/linux-next (3c44c1419842 Merge branch 'acpi-utils' into linux-ne=
xt)
...
Merging net-next/master (14f2cf607ccd net: Update address for vrf and l3mde=
v in MAINTAINERS)
...
peer record"
Merging bpf-next/master (da927466a152 Merge branch 'libbpf-field-existence')
...
l test case)
Merging wireless-drivers-next/master (868ad2149602 net/wireless: Delete unn=
ecessary checks before the macro call =E2=80=9Cdev_kfree_skb=E2=80=9D)
...
register()"
Merging amdgpu/drm-next (d919d9823a48 drm/amdgpu: work around llvm bug #425=
76)
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/gem/i915_gem_mma=
n.c
Merging drm-tegra/drm/tegra/for-next (1dc0769c4c43 drm/tegra: gem: Use sg_a=
lloc_table_from_pages())
Merging drm-misc/for-linux-next (1ccd5417dbfa drm: Add LT-tunable PHY repea=
ter mode operations)
CONFLICT (content): Merge conflict in drivers/gpu/drm/panfrost/panfrost_job=
.c
Applying: drm/amdgpu: fix up for amdgpu_tmz.c and removal of drm/drmP.h
...
Merging sound-asoc/for-next (c02f36e92f5d Merge branch 'asoc-5.5' into asoc=
-next)
...
port)
Merging iommu/next (751b71a2a559 Merge branches 'iommu/fixes', 'arm/qcom', =
'arm/renesas', 'arm/mediatek', 'x86/amd', 'x86/vt-d' and 'core' into next)
...
Merging devicetree/for-next (d4999f1cc747 dt-bindings: display: Convert sha=
rp, ld-d5116z01b panel to DT schema)
...
ute for devices)
Merging staging/staging-next (88d0facf186c staging: wfx: fix potential vuln=
erability to spectre)
...
Merging icc/icc-next (44223a8b45d7 interconnect: qcom: Fix icc_onecell_data=
 allocation)
Merging slave-dma/next (9d2bbbc21772 dt-bindings: dmaengine: rcar-dmac: Doc=
ument R8A774B1 bindings)
...
rflow
Merging akpm/master (a1f1aa5b550e drivers/media/platform/sti/delta/delta-ip=
...

=X+dz
-----END PGP SIGNATURE-----
