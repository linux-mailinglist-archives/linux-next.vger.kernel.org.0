Return-Path: <linux-next+bounces-1313-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 6648B860B23
	for <lists+linux-next@lfdr.de>; Fri, 23 Feb 2024 08:07:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 797451F22099
	for <lists+linux-next@lfdr.de>; Fri, 23 Feb 2024 07:07:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C75E612B68;
	Fri, 23 Feb 2024 07:07:45 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="n3wyUInY"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-f176.google.com (mail-pf1-f176.google.com [209.85.210.176])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 34821BA2B
	for <linux-next@vger.kernel.org>; Fri, 23 Feb 2024 07:07:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.176
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1708672065; cv=none; b=I/oKDSj+z1xRtmvxb0PjWnUO3G+/0/ZoS+AelVQ9bMvy6eS3U+MgAyvtrrtgOyOtJu8wrKsFbcN2pAQoMziz20AKbLuSgTgWX06dA9TXUPb9ZYieez2pxCYnpzt/MqhLg7VFdl/oDqtLjK1VpG8K2sKO0ZfCKQ9uQx1sh6aQKLM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1708672065; c=relaxed/simple;
	bh=b7pDnUM9LFlhJHZphI1YMpgrjKSLaYfEbPE9yQ6z1OQ=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=Zd+B9hCXAf0RCgjwsUwEUBQcBgIr0amiBN7GET7jyxLgAYGzx83EYe9c20jGNW4sHFfUUWthue7bl7plK0LqZrmd4oQ8MKby3kDGEG8HKId1rZonhOko2oNCLO2Adayz83YquBuzhbObp/m8KMTeMhzIDBaBatr1ACGuytZo9t0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=n3wyUInY; arc=none smtp.client-ip=209.85.210.176
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pf1-f176.google.com with SMTP id d2e1a72fcca58-6de3141f041so303998b3a.0
        for <linux-next@vger.kernel.org>; Thu, 22 Feb 2024 23:07:39 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1708672059; x=1709276859; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=Zvomdo+1z24LY6sbba9ewprYNZR5TF3VdTwb4pqfSns=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1708672059; x=1709276859;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=Zvomdo+1z24LY6sbba9ewprYNZR5TF3VdTwb4pqfSns=;
        b=
X-Gm-Message-State: AOJu0Yy/NlnEYTU1mLQPmbIuprF02lsLaP6n6hm0i8rVz/765tc+Emw/
	aeOlJ6Dlqvp6Z8VO5sqogrc2PVev3yQK3Xl7e7Qdijs8ZFi7hCumyJ/IjlLvB07vFPNm6ySY5Ua
	5yow=
X-Google-Smtp-Source: AGHT+IHaaGEnGHMZt3ATmWVkL7Hge4W2Ft84O7pse+jJHxhTCTdlthtlBoUeQoMlhBy/k2V0CWStvQ==
X-Received: by 2002:a05:6a00:18aa:b0:6e1:dbc:d05f with SMTP id x42-20020a056a0018aa00b006e10dbcd05fmr1451004pfh.1.1708672057805;
        Thu, 22 Feb 2024 23:07:37 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id z19-20020a62d113000000b006e0436e08edsm11304729pfg.11.2024.02.22.23.07.35
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 22 Feb 2024 23:07:36 -0800 (PST)
Message-ID: <65d84438.620a0220.7d171.81a7@mx.google.com>
Date: Thu, 22 Feb 2024 23:07:36 -0800 (PST)
...
Subject: next/master build: 163 builds: 17 failed, 146 passed, 237 errors,
 345 warnings (next-20240223)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 163 builds: 17 failed, 146 passed, 237 errors, 345 warni=
ngs (next-20240223)
...
Tree: next
Branch: master
Git Describe: next-20240223
Git Commit: 33e1d31873f87d119e5120b88cd350efa68ef276
...
arm64:
    ...
    defconfig+videodec: (gcc-10) FAIL
...
arm64:
    defconfig (clang-17): 20 errors
    defconfig (gcc-10): 25 errors, 2 warnings
    ...
    defconfig+CONFIG_RANDOMIZE_BASE=3Dy (gcc-10): 25 errors, 2 warnings
    defconfig+arm64-chromebook (gcc-10): 25 errors, 2 warnings
    defconfig+arm64-chromebook+kselftest (gcc-10): 25 errors, 2 warnings
    defconfig+arm64-chromebook+videodec (gcc-10): 25 errors, 2 warnings
    defconfig+debug (gcc-10): 25 errors, 2 warnings
    defconfig+kselftest (gcc-10): 25 errors, 2 warnings
    defconfig+videodec (gcc-10): 25 errors, 2 warnings
...
sparc:
    ...
    sparc64_defconfig+kselftest (gcc-10): 6 errors, 21 warnings
...
Errors summary:
    ...
    16   arch/arm64/include/asm/cmpxchg.h:135:21: error: unknown type name =
=E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/cmpxchg.h:135:11: error: unknown type name =
=E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/cmpxchg.h:134:48: error: unknown type name =
=E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/cmpxchg.h:134:15: error: unknown type name =
=E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_lse.h:286:55: error: unknown type na=
me =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_lse.h:286:45: error: unknown type na=
me =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_lse.h:286:34: error: unknown type na=
me =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_lse.h:285:24: error: unknown type na=
me =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_ll_sc.h:306:57: error: unknown type =
name =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_ll_sc.h:306:47: error: unknown type =
name =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_ll_sc.h:306:36: error: unknown type =
name =E2=80=98u128=E2=80=99
    16   arch/arm64/include/asm/atomic_ll_sc.h:305:24: error: unknown type =
name =E2=80=98u128=E2=80=99
    8    arch/arm64/include/asm/atomic_ll_sc.h:298:2: error: unknown type n=
ame =E2=80=98u128=E2=80=99
    4    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: unknown type n=
ame 'u128'
    4    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: unknown type n=
ame 'u128'
    3    include/linux/fortify-string.h:97:29: error: =E2=80=98__builtin_me=
...
nds]
    2    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:157: unde=
fined reference to `__ubsan_handle_shift_out_of_bounds'
    1    sparc64-linux-gnu-ld: arch/sparc/vdso/vclock_gettime.o:/tmp/kci/li=
nux/build/../arch/sparc/vdso/vclock_gettime.c:233: more undefined reference=
...
ck_gettime.c:247: undefined reference to `__ubsan_handle_type_mismatch_v1'
    1    fatal error: too many errors emitted, stopping now [-ferror-limit=
=3D]
    1    arch/arm64/include/asm/atomic_lse.h:268:1: error: invalid input co=
nstraint 'rZ' in asm
    1    arch/arm64/include/asm/atomic_lse.h:267:1: error: invalid input co=
nstraint 'rZ' in asm
    1    arch/arm64/include/asm/atomic_lse.h:266:1: error: invalid input co=
nstraint 'rZ' in asm
    1    arch/arm64/include/asm/atomic_lse.h:265:1: error: invalid input co=
nstraint 'rZ' in asm
    1    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: use of undecla=
red identifier 'u128'
    1    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: expected expre=
ssion
    1    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: expected ')'
    1    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: use of undecla=
red identifier 'u128'
    1    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: expected expre=
ssion
    1    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: expected ')'
    1    arch/arm64/include/asm/atomic_ll_sc.h:298:2: error: unknown type n=
ame 'u128'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:246: unde=
fined reference to `__ubsan_handle_type_mismatch_v1'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:217: unde=
fined reference to `__ubsan_handle_shift_out_of_bounds'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:201: unde=
fined reference to `__ubsan_handle_type_mismatch_v1'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:197: unde=
fined reference to `__ubsan_handle_shift_out_of_bounds'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:177: unde=
fined reference to `__ubsan_handle_shift_out_of_bounds'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:161: unde=
fined reference to `__ubsan_handle_type_mismatch_v1'
    1    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:154: unde=
fined reference to `__ubsan_handle_type_mismatch_v1'

Warnings summary:

    11   arch/arc/kernel/ptrace.c:342:16: warning: no previous prototype fo=
r 'syscall_trace_enter' [-Wmissing-prototypes]
    8    arch/arm64/include/asm/memory.h:300:15: warning: cast from pointer=
 to integer of different size [-Wpointer-to-int-cast]
    8    arch/arm64/include/asm/memory.h:243:9: warning: cast from pointer =
to integer of different size [-Wpointer-to-int-cast]
    8    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [=
-Wcpp]
    5    security/security.c:811:2: warning: =E2=80=98memcpy=E2=80=99 offse=
...
tion failed, symbol will not be versioned.
    1    include/linux/fortify-string.h:97:29: warning: =E2=80=98__builtin_=
...
us prototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    1    ............./arch/sparc/kernel/traps_64.c:253:6: warning: no prev=
ious prototype for =E2=80=98is_no_fault_exception=E2=80=99 [-Wmissing-proto=
types]
...
---------------------------------------------------------------------------=
-----
defconfig (arm64, clang-17) =E2=80=94 FAIL, 20 errors, 0 warnings, 0 sectio=
n mismatches

Errors:
    arch/arm64/include/asm/atomic_ll_sc.h:298:2: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: expected expression
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: use of undeclared i=
dentifier 'u128'
    arch/arm64/include/asm/atomic_ll_sc.h:332:1: error: expected ')'
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: unknown type name '=
u128'
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: expected expression
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: use of undeclared i=
dentifier 'u128'
    arch/arm64/include/asm/atomic_ll_sc.h:333:1: error: expected ')'
    arch/arm64/include/asm/atomic_lse.h:265:1: error: invalid input constra=
int 'rZ' in asm
    arch/arm64/include/asm/atomic_lse.h:266:1: error: invalid input constra=
int 'rZ' in asm
    arch/arm64/include/asm/atomic_lse.h:267:1: error: invalid input constra=
int 'rZ' in asm
    arch/arm64/include/asm/atomic_lse.h:268:1: error: invalid input constra=
int 'rZ' in asm
    fatal error: too many errors emitted, stopping now [-ferror-limit=3D]

---------------------------------------------------------------------------=
-----
defconfig (arm64, gcc-10) =E2=80=94 FAIL, 25 errors, 2 warnings, 0 section =
mismatches

Errors:
    arch/arm64/include/asm/atomic_ll_sc.h:298:2: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:305:24: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:306:36: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:306:47: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:306:57: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:305:24: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:306:36: error: unknown type name =
...
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_ll_sc.h:306:57: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:285:24: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:286:34: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:286:45: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:286:55: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:285:24: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:286:34: error: unknown type name =
...
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/atomic_lse.h:286:55: error: unknown type name =
=E2=80=98u128=E2=80=99
    arch/arm64/include/asm/cmpxchg.h:134:15: error: unknown type name =E2=
=80=98u128=E2=80=99
    arch/arm64/include/asm/cmpxchg.h:134:48: error: unknown type name =E2=
=80=98u128=E2=80=99
    arch/arm64/include/asm/cmpxchg.h:135:11: error: unknown type name =E2=
=80=98u128=E2=80=99
    arch/arm64/include/asm/cmpxchg.h:135:21: error: unknown type name =E2=
=80=98u128=E2=80=99
    arch/arm64/include/asm/cmpxchg.h:134:15: error: unknown type name =E2=
=80=98u128=E2=80=99
    arch/arm64/include/asm/cmpxchg.h:134:48: error: unknown type name =E2=
...
Warnings:
    arch/arm64/include/asm/memory.h:243:9: warning: cast from pointer to in=
teger of different size [-Wpointer-to-int-cast]
    arch/arm64/include/asm/memory.h:300:15: warning: cast from pointer to i=
...
---------------------------------------------------------------------------=
-----
defconfig+CONFIG_RANDOMIZE_BASE=3Dy (arm64, gcc-10) =E2=80=94 FAIL, 25 erro=
...
---------------------------------------------------------------------------=
-----
defconfig+arm64-chromebook (arm64, gcc-10) =E2=80=94 FAIL, 25 errors, 2 war=
...
---------------------------------------------------------------------------=
-----
defconfig+arm64-chromebook+kselftest (arm64, gcc-10) =E2=80=94 FAIL, 25 err=
...
---------------------------------------------------------------------------=
-----
defconfig+arm64-chromebook+videodec (arm64, gcc-10) =E2=80=94 FAIL, 25 erro=
rs, 2 warnings, 0 section mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+debug (arm64, gcc-10) =E2=80=94 FAIL, 25 errors, 2 warnings, 0 se=
ction mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+kselftest (arm64, gcc-10) =E2=80=94 FAIL, 25 errors, 2 warnings, =
0 section mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+videodec (arm64, gcc-10) =E2=80=94 FAIL, 25 errors, 2 warnings, 0=
 section mismatches
...
Errors:
    include/linux/fortify-string.h:97:29: error: =E2=80=98__builtin_memcpy=
...
Warnings:
    include/linux/fortify-string.h:97:29: warning: =E2=80=98__builtin_memcp=
...
---------------------------------------------------------------------------=
-----
sparc64_defconfig+kselftest (sparc, gcc-10) =E2=80=94 FAIL, 6 errors, 21 wa=
...
Errors:
 ...
 reference to `__ubsan_handle_type_mismatch_v1'
    /tmp/kci/linux/build/../arch/sparc/vdso/vclock_gettime.c:246: undefined=
 reference to `__ubsan_handle_type_mismatch_v1'
    sparc64-linux-gnu-ld: /tmp/kci/linux/build/../arch/sparc/vdso/vclock_ge=
ttime.c:247: undefined reference to `__ubsan_handle_type_mismatch_v1'
    sparc64-linux-gnu-ld: arch/sparc/vdso/vclock_gettime.o:/tmp/kci/linux/b=
uild/../arch/sparc/vdso/vclock_gettime.c:233: more undefined references to =
`__ubsan_handle_type_mismatch_v1' follow

Warnings:
    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    ............./arch/sparc/kernel/traps_64.c:253:6: warning: no previous =
