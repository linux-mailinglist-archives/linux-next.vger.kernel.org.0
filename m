Return-Path: <linux-next+bounces-1411-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 2E1CB86C05D
	for <lists+linux-next@lfdr.de>; Thu, 29 Feb 2024 06:41:35 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 808DE285393
	for <lists+linux-next@lfdr.de>; Thu, 29 Feb 2024 05:41:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 81536446CF;
	Thu, 29 Feb 2024 05:40:14 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="LmKyyMuy"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 1E7DA3B19C;
	Thu, 29 Feb 2024 05:40:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709185214; cv=none; b=MQi3Z6Re7qewnJqeKep7p3B8hwIljakMRzkUllu3Aib/SQhxp6hLwrA4tpmuS0Nb5B603fJa/I/xNaJ8wEL7iutW7hZJVdZdHb5tp9LlpOj2RJXAj9MBcJ7SHhf+7dqTGNbwfIBjHVIHDmw2qCoWLNaoXKhpbrKS3T4OpZLFap4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709185214; c=relaxed/simple;
	bh=c3FdVwdLhua/UNnKqVudieD+902jTetYvrm3w6wJZDU=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=q1SaBO2RDoCUXhbgeJHrxRavZKTR0NfmkM9/gUO+59cq4cyoBR7/w8vpYeEzVxES/OfSrK2ojVOl2gEjNtr8G3K5VuV6WdnYcjJkpm6fehiNO31GayW8PpEN9RAb1CELCNp8Eb1vhTGLADja1lbqdouiT1U4132LBkQBm+UiOQY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=LmKyyMuy; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1709185203;
	bh=4B42hUgLig6f+HSmS0WwHqXwhqVnDUhUUhl42dIKODw=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Tlg6C0w5Qz4wyh;
	Thu, 29 Feb 2024 16:40:03 +1100 (AEDT)
Date: Thu, 29 Feb 2024 16:39:59 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 29
Message-ID: <20240229163959.11d05d9e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/SU4mYn6hj5tUxWVOyxfLB=5";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/SU4mYn6hj5tUxWVOyxfLB=5
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240228:
...
The vhost tree gained a build failure so I used the version form
next-20240228.

The kunit-next tree lost its build failure but gained a semantic conflict
against the drm-miscr-fixes tree.

Non-merge commits (relative to Linus' tree): 10163
 9323 files changed, 462312 insertions(+), 181013 deletions(-)
...
Merging origin/master (805d849d7c3c Merge tag 'acpi-6.8-rc7' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/rafael/linux-pm)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (f1c6b8d3f905 init/Kconfig: lower =
...
Merging net/main (4adfc94d4aec Documentations: correct net_cachelines title=
 for struct inet_sock)
...
Merging sound-asoc-fixes/for-linus (ed00a6945dc3 ASoC: amd: yc: Fix non-fun=
ctional mic on Lenovo 21J2)
...
Merging risc-v-fixes/fixes (325731481cea Merge patch series "drivers: perf:=
 fix crash with the legacy riscv driver")
...
Merging mm/mm-everything (bd09f6e3b8ab Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
ut bigalloc)
Merging f2fs/dev (38fcb47642ae f2fs: allow to mount if cap is 100)
...
ncached mode)
Merging xfs/for-next (56ac4314cfe9 Merge tag 'xfs-6.8-fixes-4' into xfs-for=
-next)
...
m struct *_filter)
Merging net-next/main (a68c0320fdef Merge branch 'tools-ynl-stop-using-libm=
nl')
...
Merging bpf-next/for-next (b9a62998482f Merge branch 'bpf-arm64-use-bpf-pro=
g-pack-allocator-in-bpf-jit')
...
Merging drm-intel/for-linux-next (f6e4fe152dc6 drm/i915/cdclk: Document CDC=
LK components)
...
0 support)
Merging drm-xe/drm-xe-next (4c47049d93b7 drm/xe/guc: Fix missing topology i=
nit)
...
Merging sound-asoc/for-next (4db33679e48d Merge remote-tracking branch 'aso=
...
Merging block/for-next (3ea00a22c4a3 Merge branch 'for-6.9/io_uring' into f=
or-next)
...
Merging battery/for-next (ea4367c40c79 power: supply: core: move power_supp=
ly_attr_group into #ifdef block)
...
upport for mt8188)
Merging spi/for-next (cb3ec1ac30b3 Merge remote-tracking branch 'spi/for-6.=
9' into spi-next)
Merging tip/master (58ab5993c9f3 Merge branch into tip/master: 'x86/tdx')
...
Merging cgroup/for-next (96ea92731d4d Merge branch 'for-6.8-fixes' into for=
-next)
...
Merging vhost/linux-next (3f8ab8394ac5 virtio-net: add cond_resched() to th=
e command waiting loop)
$ git reset --hard HEAD^
Merging next-20240228 version of vhost
...
Applying: fix up for "drm/tests/drm_buddy: add alloc_range_bias test"
...
Merging kspp/for-next/kspp (1eaa726662f4 x86, relocs: Ignore relocations in=
 .notes section)
...

=aVu4
-----END PGP SIGNATURE-----
