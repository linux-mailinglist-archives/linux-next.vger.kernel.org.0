...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 49BFF14C56B
	for <lists+linux-next@lfdr.de>; Wed, 29 Jan 2020 05:54:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726590AbgA2Eyl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 28 Jan 2020 23:54:41 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:33579 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726466AbgA2Eyk (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 28 Jan 2020 23:54:40 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 486rkN308Rz9s29;
        Wed, 29 Jan 2020 15:54:36 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1580273676;
        bh=8PR4YaUViaJSlsgJ8fwvWiHGwpo8TMoobH24i6tjbyk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 29 Jan 2020 15:54:31 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 29
Message-ID: <20200129155431.76bd7f25@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/2VhRNdqeraAuPT1G5e07xtj";
...
My boot failures yesterday were due to a failure because I upgraded qemu.

Non-merge commits (relative to Linus' tree): 9452
 8975 files changed, 465222 insertions(+), 204642 deletions(-)
...
Merging origin/master (c677124e631d Merge branch 'sched-core-for-linus' of =
...
Merging sound-current/for-linus (7faa26c1bbe3 ALSA: hda: Reset stream if DM=
A RUN bit not cleared)
...
Merging pidfd-fixes/fixes (94f7a817ad29 fork.c: Use RCU_INIT_POINTER() inst=
ead of rcu_access_pointer())
...
Merging cifs/for-next (f1f27ad74557 CIFS: Fix task struct use-after-free on=
 reconnect)
...
in imxfb_probe())
Merging pm/linux-next (09d016c67de6 Merge branch 'pm-tools' into linux-next)
...
Merging net-next/master (f76e4c167ea2 net: phy: add default ARCH_BCM_IPROC =
for MDIO_BCM_IPROC)
Applying: fix up for "sfc: move struct init and fini code"
...
Merging bluetooth/master (151129df2f4a Bluetooth: SMP: Fix SALT value in so=
me comments)
...
Merging amdgpu/drm-next (d3e914458dc5 drm/amdgpu/smu10: fix smu10_get_clock=
_by_type_with_latency)
...
-next)
Merging sound/for-next (7faa26c1bbe3 ALSA: hda: Reset stream if DMA RUN bit=
 not cleared)
...
Merging block/for-next (b883b4694dfc Merge branch 'for-5.6/io_uring-vfs' in=
to for-next)
...
ing instances)
Merging irqchip/irq/irqchip-next (926b5dfa6b8d irqchip/gic-v3: Only provisi=
on redistributors that are enabled in ACPI)
...
lready running)
Merging xen-tip/linux-next (9293724192a7 xen/gntdev: Do not use mm notifier=
s with autotranslating guests)
...
rflow
Merging akpm/master (fdc3ca0bb16f drivers/media/platform/sti/delta/delta-ip=
...

=eg6c
-----END PGP SIGNATURE-----
