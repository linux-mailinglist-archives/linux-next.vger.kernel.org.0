...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 29CD744E0E1
	for <lists+linux-next@lfdr.de>; Fri, 12 Nov 2021 04:41:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233920AbhKLDop (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 11 Nov 2021 22:44:45 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36992 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229698AbhKLDop (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 11 Nov 2021 22:44:45 -0500
Received: from mail-pl1-x630.google.com (mail-pl1-x630.google.com [IPv6:2607:f8b0:4864:20::630])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E3E44C061766
        for <linux-next@vger.kernel.org>; Thu, 11 Nov 2021 19:41:54 -0800 (PST)
Received: by mail-pl1-x630.google.com with SMTP id t21so7374120plr.6
        for <linux-next@vger.kernel.org>; Thu, 11 Nov 2021 19:41:54 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=lBVBET5FAdF6A3G5704HM0jWeQkaAlprpMO4A1PXCA4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=lBVBET5FAdF6A3G5704HM0jWeQkaAlprpMO4A1PXCA4=;
        b=
X-Gm-Message-State: AOAM531eFJFzv0ZpuDVimpspvZfcXqGWBIt0n4cz/TgfeZ4y6LMasavh
        vjSWZLcPh0kqUiPPAghY2XIvNUZHjvhf6vrn
X-Google-Smtp-Source: ABdhPJx6wj8zweIIKw0h+NTQsCBbx7xQ9X0Hr/kLWxypytdRH6RDhwd/ZNHxMmO2MRanqpuuRg3cJA==
X-Received: by 2002:a17:902:c78a:b0:142:1b7a:930 with SMTP id w10-20020a170902c78a00b001421b7a0930mr4658270pla.8.1636688511481;
        Thu, 11 Nov 2021 19:41:51 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id f21sm5176083pfc.85.2021.11.11.19.41.51
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 11 Nov 2021 19:41:51 -0800 (PST)
Message-ID: <618de27f.1c69fb81.32913.fa69@mx.google.com>
Date:   Thu, 11 Nov 2021 19:41:51 -0800 (PST)
...
Subject: next/master build: 222 builds: 18 failed, 204 passed, 456 errors,
 197 warnings (next-20211112)
...
next/master build: 222 builds: 18 failed, 204 passed, 456 errors, 197 warni=
ngs (next-20211112)
...
arm:
    allmodconfig (clang-13): 3 errors, 14 warnings
...
ted [-Wcpp]
    25   clang: warning: argument unused during compilation: '-march=3Darmv=
6k' [-Wunused-command-line-argument]
    5    clang: warning: argument unused during compilation: '-Wa,-march=3D=
...
=3Darmv6k' [-Wunused-command-line-argument]
    1    clang: warning: clang: warning: argument unused during compilation=
: '-march=3Darmv6k' [-Wunused-command-line-argument]
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-13) =E2=80=94 FAIL, 3 errors, 14 warnings, 0 secti=
on mismatches
...
d-command-line-argument]
    clang: warning: clang: warning: argument unused during compilation: '-m=
arch=3Darmv6k' [-Wunused-command-line-argument]
