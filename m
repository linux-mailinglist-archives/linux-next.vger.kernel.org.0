Return-Path: <linux-next+bounces-1692-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id B2F028864F7
	for <lists+linux-next@lfdr.de>; Fri, 22 Mar 2024 03:00:53 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 17611282470
	for <lists+linux-next@lfdr.de>; Fri, 22 Mar 2024 02:00:52 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 65C4B138C;
	Fri, 22 Mar 2024 02:00:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="a5Dsjf0K"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E235310F2;
	Fri, 22 Mar 2024 02:00:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711072848; cv=none; b=HA5pohLBBhPTn6V3nZXQdzax0rjGs6tzROMmr4qL5UBlDqHolnjdWpJVx/qArktG9+UnRc1MUR6h+tdT1bXdYb7sA+uuZsKiuONX2AOcuwfchUPfcnoodxb6qmiZzsrIzzm111Rcf4dnQrIBvMCj1c38q5kZxcn9eeOIziXBCtY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711072848; c=relaxed/simple;
	bh=kCiNPLBWpMcqe2150CbyeXRuzpA4ltghFQbKAZJDGhk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=HOfH6+O8pPsrENKixbaJIErz+0FcrWMo9VMnVaBrM3vqJlsVZ+6gcJDT0EYp22WlGJGQ4UyIZBgLeNbCT0YP84ZSWXIDeY8LQMqKE0g+tx0zs2K9FdoQHN5PgSXS3sLDUjbB9QhKvRvebLyNMBW5K6Yz4Ql53Vc2blkRbO9ycEI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=a5Dsjf0K; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1711072834;
	bh=DsOCp/6+Mez7ucaPLFmcOgx4o/KctQPrhbb0rUvcRt4=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4V15Bp4vMlz4wcv;
	Fri, 22 Mar 2024 13:00:34 +1100 (AEDT)
Date: Fri, 22 Mar 2024 13:00:32 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 22
Message-ID: <20240322130032.1285ca46@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/SQW33gTHJ4i8GNNuAq4vcYB";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/SQW33gTHJ4i8GNNuAq4vcYB
...
Changes since 20240321:

The perf tree gained a build failure so I used the version from
next-20240321.

Non-merge commits (relative to Linus' tree): 1112
 1214 files changed, 33027 insertions(+), 12254 deletions(-)
...
Merging origin/master (241590e5a1d1 Merge tag 'driver-core-6.9-rc1' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/gregkh/driver-core)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (7f9033c9d8de ARM: prctl: reject P=
R_SET_MDWE on pre-ARMv6)
...
Merging net/main (f99c5f563c17 Merge tag 'nf-24-03-21' of git://git.kernel.=
org/pub/scm/linux/kernel/git/netfilter/nf)
Merging bpf/master (ddb2ffdc474a libbpf: Define MFD_CLOEXEC if not availabl=
e)
...
t warnings)
Merging sound-current/for-linus (9f2347842b52 Merge tag 'asoc-fix-v6.9-merg=
...
Merging counter-current/counter-current (c83ccdc9586b counter: fix privdata=
 alignment)
Merging char-misc.current/char-misc-linus (23956900041d Merge tag 'v6.9-rc-=
...
Merging nfsd-fixes/nfsd-fixes (fab2464f22df SUNRPC: Revert 561141dd49438221=
...
Merging kbuild/for-next (f2fd2aad1908 kconfig: tests: test dependency after=
 shuffling choices)
CONFLICT (content): Merge conflict in arch/hexagon/Kconfig
CONFLICT (content): Merge conflict in scripts/Makefile.lib
Merging clang-format/clang-format (5a205c6a9f79 clang-format: Update with v=
6.7-rc4's `for_each` macro list)
Merging perf/perf-tools-next (af34a16d3090 perf vendor events intel: Remove=
 info metrics erroneously in TopdownL1)
$ git reset --hard HEAD^
Merging next-20240321 version of perf
...
cond argument)
Merging bcachefs/for-next (2e92d26b2543 bcachefs: Fix lost wakeup on journa=
l shutdown)
...
Merging cifs/for-next (e56bc745fa1d smb311: additional compression flag def=
ined in updated protocol spec)
...
ATS")
Merging drm/drm-next (02ac43711111 Merge tag 'drm-misc-next-fixes-2024-03-1=
...
nit disable on GSP.)
Merging amdgpu/drm-next (ca384bae7770 drm/amdgpu: sync page table freeing w=
ith tlb flush)
Merging drm-intel/for-linux-next (d437099ab21c drm/i915: Do not print 'pxp =
init failed with 0' when it succeed)
...
Merging drm-xe/drm-xe-next (cdf287ce7bd3 drm/xe: Add debug messages for MMU=
 notifier and VMA invalidate)
CONFLICT (content): Merge conflict in drivers/gpu/drm/xe/xe_vm.c
Merging etnaviv/etnaviv/next (b735ee173f84 drm/etnaviv: Restore some id val=
ues)
Merging fbdev/for-next (763865fed864 fbdev: panel-tpo-td043mtea1: Convert s=
printf() to sysfs_emit())
Merging regmap/for-next (62861ddcb27e Merge remote-tracking branch 'regmap/=
for-6.9' into regmap-next)
Merging sound/for-next (9f2347842b52 Merge tag 'asoc-fix-v6.9-merge-window'=
...
Merging tpmdd/next (1156e9541dc2 keys: Fix overwrite of key expiration on i=
nstantiation)
...
Merging tip/master (93387dba36cc Merge branch into tip/master: 'x86/percpu')
...
Merging usb/usb-next (a788e53c05ae usb: usb-acpi: Fix oops due to freeing u=
ninitialized pld pointer)
...
Merging execve/for-next/execve (2aea94ac14d1 exec: Fix NOMMU linux_binprm::=
exec in transfer_args_to_stack())
...

=YAbT
-----END PGP SIGNATURE-----
