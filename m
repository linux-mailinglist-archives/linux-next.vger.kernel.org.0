...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 648994EA2FB
	for <lists+linux-next@lfdr.de>; Tue, 29 Mar 2022 00:31:53 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229840AbiC1WT3 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 28 Mar 2022 18:19:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58920 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229846AbiC1WTK (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 28 Mar 2022 18:19:10 -0400
Received: from mail-qv1-xf2d.google.com (mail-qv1-xf2d.google.com [IPv6:2607:f8b0:4864:20::f2d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CB67C44776
        for <linux-next@vger.kernel.org>; Mon, 28 Mar 2022 15:15:49 -0700 (PDT)
Received: by mail-qv1-xf2d.google.com with SMTP id b17so3368909qvf.12
        for <linux-next@vger.kernel.org>; Mon, 28 Mar 2022 15:15:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=blLnoeVdI4b2MuF2oJtGicbVu52SERRQnYp4Q4K8MBg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=blLnoeVdI4b2MuF2oJtGicbVu52SERRQnYp4Q4K8MBg=;
        b=
X-Gm-Message-State: AOAM530nXde3lTTYZWB4PXqkVu8JexeemCZ3Xloun/bUyTnlRVJnf7tV
        90x1Tmv9Wl2VETSXFI1A0fMWZvIOcGiAHsfhDmg=
X-Google-Smtp-Source: ABdhPJwyo9UBXjvC/GNbDgFYJg7e60IPvRIy9XkfEbxNbArSEMp6gzwzWX3kGXlCsGGiifc4mL8uAw==
X-Received: by 2002:a05:6a00:982:b0:4fb:806f:4833 with SMTP id u2-20020a056a00098200b004fb806f4833mr1307790pfg.30.1648503748222;
        Mon, 28 Mar 2022 14:42:28 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id u18-20020a056a00125200b004fb112ee9b7sm12378053pfi.75.2022.03.28.14.42.27
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 28 Mar 2022 14:42:27 -0700 (PDT)
Message-ID: <62422bc3.1c69fb81.3177c.f99c@mx.google.com>
Date:   Mon, 28 Mar 2022 14:42:27 -0700 (PDT)
...
Subject: next/master build: 223 builds: 8 failed, 215 passed, 23 errors,
 56 warnings (next-20220328)
...
next/master build: 223 builds: 8 failed, 215 passed, 23 errors, 56 warnings=
 (next-20220328)
...
Tree: next
Branch: master
Git Describe: next-20220328
Git Commit: 8515d05bf6bcdc8873c576ae6a721985389a3bd1
...
=80=98-mhard-float=E2=80=99
    3    fs/cifs/cifsfs.c:709:18: error: implicit conversion from enumerati=
on type 'enum statusEnum' to different enumeration type 'enum tid_status_en=
um' [-Werror,-Wenum-conversion]
...
24) in 'wp512_process_buffer' [-Werror,-Wframe-larger-than]
    fs/cifs/cifsfs.c:709:18: error: implicit conversion from enumeration ty=
pe 'enum statusEnum' to different enumeration type 'enum tid_status_enum' [=
