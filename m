Return-Path: <linux-next+bounces-3723-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 43A5E972AD8
	for <lists+linux-next@lfdr.de>; Tue, 10 Sep 2024 09:33:01 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 59E6B1C21919
	for <lists+linux-next@lfdr.de>; Tue, 10 Sep 2024 07:33:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D544B17CA1A;
	Tue, 10 Sep 2024 07:32:57 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="mMXeUaJw"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 7701E17C231;
	Tue, 10 Sep 2024 07:32:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1725953577; cv=none; b=d6ge60ReZvXJx1T61SPzWAjuW63WiBpj0xUdD0xyRJVZd7P1bWoV60ZX1YkrK7dwdRPwIbfI5HJvpQSI8zjKxX2eGoe0aEsV1xPhug46003OyyLvRUkbpYLEgTvQZvrZPQncu22CR8LUul8jtsW5PdFqvG628j4w0SBPjcAvrGw=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1725953577; c=relaxed/simple;
	bh=AJFjNwi2tVq/oc/FChiEbmcUjRDUC21zjspP+D+pFu4=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=a09xfLtlsyuR9Fbp6b10ooayoF4xnpwfQhcob66hYbTOCssy82wyvltBSfG0JW7ddzP60g3kUDBdlxBr8yVSdYxSBz2QJ8iejdwXpd0oT7GFxzwDrNeSPFd2e453lpo/vbIRoyyQCr/reWDM7GRxWZ8RvIDYl5OGPBlz4p6+I5g=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=mMXeUaJw; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1725953568;
	bh=y/XG3hC5tFzHfk/R2nBNNH2zh+L/fXmPtZbCO3Lt4sI=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4X2wQm1fZ4z4x0K;
	Tue, 10 Sep 2024 17:32:48 +1000 (AEST)
Date: Tue, 10 Sep 2024 17:32:47 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 10
Message-ID: <20240910173247.4d6fb35e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/e977Rd2WukPyKUl=U1Rn.QM";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/e977Rd2WukPyKUl=U1Rn.QM
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240909:

The powerpc ppc44x_defconfig build is working again.
...
Non-merge commits (relative to Linus' tree): 9777
 9894 files changed, 378137 insertions(+), 177646 deletions(-)
...
Merging origin/master (bc83b4d1f086 Merge tag 'bcachefs-2024-09-09' of git:=
...
erify_area())
Merging bcachefs/for-next (b58e70fc4125 bcachefs: Remove duplicated include=
 in backpointers.c)
...
ph_dns_resolve_name())
Merging cifs/for-next (c5430c9d46ba smb3: mark compression as CONFIG_EXPERI=
...
Merging erofs/dev (32df7999af49 erofs: sunset unneeded NOFAILs)
...
Merging mm-hotfixes/mm-hotfixes-unstable (d32ca4cce17f resource: fix region=
_intersects() vs add_memory_driver_managed())
Merging fs-current (195cca87bf3e Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (b3c9e65eb227 net: hsr: remove seqnr_lock)
...
-linus)
Merging sound-asoc-fixes/for-linus (af5e31717585 ASoC: tas2781: fix to save=
 the dsp bin file name into the correct array in case name_prefix is not NU=
LL)
...
Merging drm-intel-fixes/for-linux-next-fixes (da3ea35007d0 Linux 6.11-rc7)
...
Merging drm-misc-fixes/for-linux-next-fixes (ea5ff5d351b5 dma-buf: heaps: F=
ix off-by-one in CMA heap fault handler)
...
s_segctor_thread())
Merging mm/mm-everything (3f3c5e0fef55 foo)
CONFLICT (content): Merge conflict in kernel/events/uprobes.c
CONFLICT (content): Merge conflict in kernel/resource.c
Merging kbuild/for-next (e3bf4ec9d54e scripts: subarch.include: fix SUBARCH=
 on macOS hosts)
...
' into for-next)
Merging arm64/for-next/core (c5ca7a8e9b46 Merge branch 'for-next/perf' into=
 for-next/core)
...
Merging sophgo/for-next (fa1823d4e2eb dt-bindings: riscv: Add Sipeed Lichee=
...
regs)
Merging parisc-hd/for-next (a67e2b3c18ce parisc: Allow mmap(MAP_STACK) memo=
...
Merging fs-next (afedd64fb718 Merge branch 'vfs.all' of git://git.kernel.or=
...
nto i2c/for-next)
Merging i2c-host/i2c/i2c-host (43457ada98c8 i2c: i801: Use a different adap=
ter-name for IDF adapters)
...
Merging pm/linux-next (71a48eb329bb Merge branch 'pm-devfreq' into linux-ne=
xt)
...
static WQE support)
Merging net-next/main (760664b72c41 Merge branch 'rx-software-timestamp-for=
-all-round-3')
...
Merging ipsec-next/master (69716a3babe1 Revert "xfrm: add SA information to=
 the offloaded packet")
...
out update support)
Merging bluetooth/master (6efcec8031c4 Bluetooth: hci_core: Fix sending MGM=
T_EV_CONNECT_FAILED)
...
Merging sound/for-next (28fbfaf6bd1d ALSA: hda: Use non-SG allocation for t=
he communication buffers)
Merging ieee1394/for-next (b5ff50aae6f9 firewire: core: fulfill documentati=
on of fw_iso_context_flush_completions())
Merging sound-asoc/for-next (f213ec06a294 Merge remote-tracking branch 'aso=
...
onous probing)
Merging block/for-next (dbb52f82f5f4 Merge branch 'for-6.12/block' into for=
-next)
...
ct kobj_type)
Merging regulator/for-next (c8fbd52cb071 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (071c885c8a88 Merge remote-tracking branch 'spi/for-6.=
12' into spi-next)
Merging tip/master (3bf5dbc45e65 Merge branch into tip/master: 'x86/timers')
...
Merging xen-tip/linux-next (da3ea35007d0 Linux 6.11-rc7)
Merging percpu/for-next (2d9ad81ef935 Merge branch 'for-6.8-fixes' into for=
-next)
Merging workqueues/for-next (82e29ca33e36 Merge branch 'for-6.12' into for-=
next)
Merging sched-ext/for-next (2d285d561543 scx_qmap: Implement highpri boosti=
ng)
...

=Rbyt
-----END PGP SIGNATURE-----
