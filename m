...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 489865FAB08
	for <lists+linux-next@lfdr.de>; Tue, 11 Oct 2022 05:15:11 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229741AbiJKDPI (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 10 Oct 2022 23:15:08 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59214 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229665AbiJKDPG (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 10 Oct 2022 23:15:06 -0400
Received: from mail-pg1-x52a.google.com (mail-pg1-x52a.google.com [IPv6:2607:f8b0:4864:20::52a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1F80BDFF7
        for <linux-next@vger.kernel.org>; Mon, 10 Oct 2022 20:15:03 -0700 (PDT)
Received: by mail-pg1-x52a.google.com with SMTP id e129so11738818pgc.9
        for <linux-next@vger.kernel.org>; Mon, 10 Oct 2022 20:15:03 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=QpFsXihFyHVqz6uG3tzwTYx9FUm68NtaAKD1Az75vXg=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=QpFsXihFyHVqz6uG3tzwTYx9FUm68NtaAKD1Az75vXg=;
        b=
X-Gm-Message-State: ACrzQf0+mrasIWIlICyOvtU+w+XneZG7BfnIK8i80cTRVi5cYCT8YFGJ
        9NPmNAbts5ToPewPpQrU6dvKhxzYdtem8U4V0fQ=
X-Google-Smtp-Source: AMsMyM4hHOh9MTArnLFeD4CPOzF9GYQ+DVPzEf9HQG+uGeW8ou9eTajbePGMNl7pgXshLMaIhkRpOg==
X-Received: by 2002:a05:6a00:1493:b0:546:2856:6d08 with SMTP id v19-20020a056a00149300b0054628566d08mr22919567pfu.84.1665458102537;
        Mon, 10 Oct 2022 20:15:02 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id q5-20020a170902a3c500b00170d34cf7f3sm7261703plb.257.2022.10.10.20.15.01
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 10 Oct 2022 20:15:01 -0700 (PDT)
Message-ID: <6344dfb5.170a0220.97a3.cc8c@mx.google.com>
Date:   Mon, 10 Oct 2022 20:15:01 -0700 (PDT)
...
Subject: next/pending-fixes build: 90 builds: 2 failed, 88 passed, 4 errors,
 22 warnings (v6.0-10339-g565da9e84d8f)
...
next/pending-fixes build: 90 builds: 2 failed, 88 passed, 4 errors, 22 warn=
ings (v6.0-10339-g565da9e84d8f)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v6.0-10339-g565da9e84d8f/

Tree: next
Branch: pending-fixes
Git Describe: v6.0-10339-g565da9e84d8f
Git Commit: 565da9e84d8fabf932ab32032fc8100b7a917173
...
-Wcpp]
    2    fs/coredump.c:834:12: warning: =E2=80=98dump_emit_page=E2=80=99 de=
...
8 bytes) (#address-cells =3D=3D 2, #size-cells =3D=3D 1)
    1    arch/mips/boot/dts/brcm/bcm63268.dtsi:113.21-121.6: Warning (avoid=
