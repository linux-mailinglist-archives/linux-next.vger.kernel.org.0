...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E2FFE3B42C0
	for <lists+linux-next@lfdr.de>; Fri, 25 Jun 2021 13:54:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230031AbhFYL4z (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 25 Jun 2021 07:56:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50816 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229498AbhFYL4y (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 25 Jun 2021 07:56:54 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 423FDC061574;
        Fri, 25 Jun 2021 04:54:29 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GBFm15ffvz9sX5;
        Fri, 25 Jun 2021 21:54:25 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1624622065;
        bh=Ry4ZPzSQvJGCVfVq02XjDcKQvfGR52m7+XWFyRYi3So=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 25 Jun 2021 21:54:24 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 25
Message-ID: <20210625215424.6a708d5d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ggJnAY0_39W_Z7gtMbjJQDz";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/ggJnAY0_39W_Z7gtMbjJQDz
...
I have still reverted a topic branch from net-next to solve the
modules_install failure.

The kunit-fixes tree gained build failures for which I reverted 2 commits.

The kvm-arm tree gained conflicts against the kvm tree.

The userns tree gained conflicts against Linus' tree.

The akpm-current tree lost its a build failure and gained a conflict
against the kspp tree.

Non-merge commits (relative to Linus' tree): 12426
 11428 files changed, 751192 insertions(+), 338823 deletions(-)
...
Merging origin/master (44db63d1ad8d Merge tag 'drm-fixes-2021-06-25' of git=
...
Merging net/master (be7f62eebaff net: dsa: sja1105: fix NULL pointer derefe=
rence in sja1105_reload_cbs())
...
esc())
Merging kunit-fixes/kunit-fixes (c1610aae495b kunit: tool: internal refacto=
r of parser input handling)
...
Merging drm-misc-fixes/for-linux-next-fixes (d33009911559 drm/nouveau: fix =
dma_address check for CPU/GPU sync)
...
Merging powerpc/next (0e8554b5d780 powerpc/papr_scm: Properly handle UUID t=
ypes and API)
...
Merging ceph/master (bbd77dc78e21 libceph: fix doc warnings in cls_lock_cli=
ent.c)
Merging cifs/for-next (0060a4f28a9e cifs: fix missing spinlock around updat=
e to ses->status)
...
stem.nfs4_acl)
Merging nfsd/nfsd-next (8419d3eab833 nfsd: Reduce contention for the nfsd_f=
ile nf_rwsem)
...
tore_device_info)
Merging hid/for-next (8090738aa52f Merge branch 'for-5.14/core' into for-ne=
xt)
Merging i2c/i2c/for-next (ed9588410c28 Merge branch 'i2c/for-mergewindow' i=
nto i2c/for-next)
...
onfig checks)
Merging pm/linux-next (3304616e985f Merge branch 'pm-cpufreq' into linux-ne=
xt)
Merging cpufreq-arm/cpufreq/arm/linux-next (3a43a0d955d6 Merge branch 'cpuf=
...
Merging thermal/thermal/linux-next (92a926806ce1 thermal/drives/int340x/pro=
cessor_thermal: Add PCI MMIO based thermal driver)
...
Merging rdma/for-next (e7c07d5e0750 RDMA/hns: Fix incorrect vlan enable bit=
 in QPC)
Merging net-next/master (19938bafa7ae net: bcmgenet: Add mdio-bcm-unimac so=
ft dependency)
...
CONFLICT (content): Merge conflict in include/linux/fwnode_mdio.h
Patch failed at 0001 Revert "Merge branch 'marvell-mdio-ACPI'"
Merging bpf-next/for-next (0cc84b9a6003 ti: Remove rcu_read_lock() around X=
DP program invocation)
...
Merging wireless-drivers-next/master (c2a3823dad49 iwlwifi: acpi: remove un=
used function iwl_acpi_eval_dsm_func())
...
Merging sound/for-next (5c89c2c7fbfa Merge tag 'asoc-fix-v5.13-rc7' of http=
s://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-next)
...
Merging block/for-next (0cc0cb70f0ff Merge branch 'for-5.14/libata' into fo=
r-next)
...
14' into spi-next)
Merging tip/auto-latest (6394023b85c1 Merge branch 'locking/core')
...
to trace/for-next)
Merging rcu/rcu/next (af3578b0614e scftorture: Add RPC-like IPI tests)
...
Merging kvm-arm/next (4eb5be10a4f5 Merge branch kvm-arm64/mmu/mte into kvma=
rm-master/next)
...
nts)
Merging usb/usb-next (8e9910c5ad97 Merge tag 'usb-serial-5.14-rc1' of https=
...
Merging tty/tty-next (cddd53e8aa4f Revert "tty: serial: Add UART driver for=
 Cortina-Access platform")
Merging char-misc/char-misc-next (d4e1406618a1 Merge tag 'extcon-next-for-5=
.14' of git://git.kernel.org/pub/scm/linux/kernel/git/chanwoo/extcon into c=
har-misc-next)
...
to vfio_iommu_group)
Merging staging/staging-next (fcc84fe12fd8 staging: hisi-spmi-controller: r=
ename spmi-channel property)
...
Merging kspp/for-next/kspp (e7abbafcb176 Merge branch 'for-next/clang/featu=
...
Merging mhi/mhi-next (fe86b88d64ec bus: mhi: core: Add range checks for BHI=
 and BHIe)
...
into tpmdd-for-next)
Applying: Revert "kunit: add unit test for filtering suites by names"
Applying: Revert "thunderbolt: test: Remove some casts which are no longer =
required"
Merging akpm-current/current (0d7fc7536d97 linux-next-pre)
...
Merging akpm/master (2e46b371a0ed powerpc/mm: enable HAVE_MOVE_PMD support)
...

=v0bB
-----END PGP SIGNATURE-----
