Return-Path: <linux-next+bounces-4267-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id E0C0B99DDE5
	for <lists+linux-next@lfdr.de>; Tue, 15 Oct 2024 08:02:52 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 6CEED285592
	for <lists+linux-next@lfdr.de>; Tue, 15 Oct 2024 06:02:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5AA2817A58C;
	Tue, 15 Oct 2024 06:02:48 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="odHCfL1b"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 2DFFF16B75C;
	Tue, 15 Oct 2024 06:02:42 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1728972168; cv=none; b=kIiv03qr00HjttAxt1xlMW7JCt39Vt2ojnhp0zE7rAhKMijBtDDkp7UC7n10Ku9eqavSfyvqFkQ4sGSXQ9HDiu/gcL6KIbja+FLvkUxK7WTLzKSAYDpq2wU+tvXGiY6qh0ngbpxgEiuGZSB9iPAkIg11F/nEOr3IW0azZN7/mt0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1728972168; c=relaxed/simple;
	bh=ANjGV4V6y4DvIBumDISCqGVQdZePoMFAtt2OwvlrqgA=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=EVffqMfLGksss4YLyxg3xIpjuroSZX2OxPNVrpQVu88i2G8KwRLvmRZPWi2k6lQHLB+BxXdfx26m47cF2tjqGhXt38pXCmZjIDhXctaD1xDElw3dGa7OOl0uejxl/c5X84S81K4RbW2keC3MxTZg4RlebPRjkKnJ8GX/jTiacZg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=odHCfL1b; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1728972160;
	bh=VEZbQwJd5yx4VdzhnVOH8nL1BgS1pj0x/bJ6fhKGK8U=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XSNmc3WKmz4x8Q;
	Tue, 15 Oct 2024 17:02:40 +1100 (AEDT)
Date: Tue, 15 Oct 2024 17:02:40 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 15
Message-ID: <20241015170240.6dcd0d86@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/cEEOVr5+MNcZWf+/B1jCJ2R";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/cEEOVr5+MNcZWf+/B1jCJ2R
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241014:
...
The staging tree lost its build failure but gained another for which I
marked a driver BROKEN.

Non-merge commits (relative to Linus' tree): 3919
 5323 files changed, 178123 insertions(+), 133004 deletions(-)
...
Merging origin/master (eca631b8fe80 Merge tag 'f2fs-6.12-rc4' of git://git.=
...
erify_area())
Merging bcachefs/for-next (8044a9c8d354 bcachefs: Fix bitwise math on 32 bi=
t systems)
...
Merging nfsd/nfsd-next (cf272c04c08a NFSD: Replace use of NFSD_MAY_LOCK in =
nfsd4_lock())
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (11abd515cfe3 Merge branch 'vfs.exportfs' into =
...
Merging mm-hotfixes/mm-hotfixes-unstable (00c5e66c934c MAINTAINERS: kasan, =
kcov: add bugzilla links)
Merging fs-current (7b3199cb6962 Merge branch 'next-fixes' of git://git.ker=
...
Merging arm64-fixes/for-next/fixes (f56d8d2389ba Documentation/protection-k=
eys: add AArch64 to documentation)
...
Merging net/main (0b84db5d8f25 MAINTAINERS: add Andrew Lunn as a co-maintai=
ner of all networking drivers)
...
gth)
Merging sound-current/for-linus (1e9c708dc3ae ALSA: hda/tas2781: Add new qu=
irk for Lenovo, ASUS, Dell projects)
...
Merging mm/mm-everything (fca224cd568e foo)
Merging kbuild/for-next (f8746e3712be kconfig: remove zconfprint())
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (1a3d6a9723d4 perf tools: Fix compiler error i=
n util/tool_pmu.c)
...
into for-next)
Merging thead-dt/thead-dt-for-next (de6b4d373038 riscv: dts: thead: remove =
...
Merging fs-next (a9a900aceba7 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging net-next/main (01b6b9315f15 Merge branch 'net-ti-ethernet-warnings')
...
Merging netfilter-next/main (9539446cc659 netfilter: replace call_rcu by kf=
...
es.h
Merging drm-intel/for-linux-next (4e75c3e208a0 drm/i915/dp_mst: Don't requi=
re DSC hblank quirk for a non-DSC compatible mode)
...
eback on SM6350)
Merging drm-xe/drm-xe-next (b0228a337de8 drm/xe/display: align framebuffers=
...
Merging fbdev/for-next (1d90a82d6e28 fbdev: Constify struct sbus_mmap_map)
$ git reset --hard HEAD^
Merging next-20241014 version of fbdev
...
s)
Merging devicetree/for-next (7ae5eff46d61 of/address: Constify of_busses[] =
array and pointers)
...
13' into spi-next)
Merging tip/master (4587b6326696 Merge branch into tip/master: 'x86/misc')
...
returned value)
Merging driver-core/driver-core-next (8e929cb546ee Linux 6.12-rc3)
...
Merging iio/togreg (c3e9df514041 iio: light: rpr0521: Use generic iio_pollf=
unc_store_time())
...
Merging rust/rust-next (8d8f785ceb21 MAINTAINERS: add entry for the Rust `a=
lloc` module)
...

=4P/4
-----END PGP SIGNATURE-----
