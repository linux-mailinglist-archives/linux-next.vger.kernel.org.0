...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 15BBB72DE02
	for <lists+linux-next@lfdr.de>; Tue, 13 Jun 2023 11:44:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240022AbjFMJoi (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 13 Jun 2023 05:44:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58208 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239299AbjFMJoh (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 13 Jun 2023 05:44:37 -0400
Received: from mail-pl1-x629.google.com (mail-pl1-x629.google.com [IPv6:2607:f8b0:4864:20::629])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 62B4310DF
        for <linux-next@vger.kernel.org>; Tue, 13 Jun 2023 02:44:32 -0700 (PDT)
Received: by mail-pl1-x629.google.com with SMTP id d9443c01a7336-1b3c0c47675so20174815ad.1
        for <linux-next@vger.kernel.org>; Tue, 13 Jun 2023 02:44:32 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1686649471; x=1689241471;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=rHaqLLfmKHaGGCNWXrsv3H5d5cIKdKVIzKLhkwIcoK4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1686649471; x=1689241471;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=rHaqLLfmKHaGGCNWXrsv3H5d5cIKdKVIzKLhkwIcoK4=;
        b=
X-Gm-Message-State: AC+VfDz21ysnpYxUkavnJ/wNPeRk4pjt37XbTdtjeDWM/zK/btQUfphI
        Gm4m84FwH7yWPTaefms5VutRo2/no6cYaqcgdIJnng==
X-Google-Smtp-Source: ACHHUZ5SbHZUhw+XfIKgeia4WJGhx6Ah/ZUa2wXH50pwOJci+NlCoUxnKa+g3jBbg1EpZia1na7nPg==
X-Received: by 2002:a17:902:c40a:b0:1a9:b8c3:c2c2 with SMTP id k10-20020a170902c40a00b001a9b8c3c2c2mr11226968plk.37.1686649469381;
        Tue, 13 Jun 2023 02:44:29 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id l21-20020a170902d35500b001ae7fad1598sm4468623plk.29.2023.06.13.02.44.27
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 13 Jun 2023 02:44:28 -0700 (PDT)
Message-ID: <64883a7c.170a0220.b3b4d.85a3@mx.google.com>
Date:   Tue, 13 Jun 2023 02:44:28 -0700 (PDT)
...
X-Kernelci-Kernel: next-20230613
Subject: next/master build: 186 builds: 7 failed, 179 passed, 37 errors,
 46 warnings (next-20230613)
...
next/master build: 186 builds: 7 failed, 179 passed, 37 errors, 46 warnings=
 (next-20230613)
...
Tree: next
Branch: master
Git Describe: next-20230613
Git Commit: 1f6ce8392d6ff486af5ca96df9ded5882c4b6977
...
=80=98-mhard-float=E2=80=99
    2    drivers/scsi/aacraid/commsup.c:1786:15: error: array index 3 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1785:15: error: array index 2 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1784:15: error: array index 1 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1347:18: error: array index 4 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1346:18: error: array index 6 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1345:18: error: array index 1 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1330:19: error: array index 4 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1329:50: error: array index 5 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1329:19: error: array index 6 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1328:18: error: array index 1 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1288:21: error: array index 3 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1286:20: error: array index 3 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
    2    drivers/scsi/aacraid/commsup.c:1166:17: error: array index 1 is pa=
st the end of the array (that has type 'u8[1]' (aka 'unsigned char[1]'), ca=
st to '__le32 *' (aka 'unsigned int *')) [-Werror,-Warray-bounds]
...
vec_from_user.part.0() with UACCESS enabled
    5    vmlinux.o: warning: objtool: .altinstr_replacement+0x1899: redunda=
nt UACCESS disable
...
vec_from_user.part.0() with UACCESS enabled
    1    vmlinux.o: warning: objtool: .altinstr_replacement+0x1e72: redunda=
nt UACCESS disable
