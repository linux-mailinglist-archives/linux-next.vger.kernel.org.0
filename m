Return-Path: <linux-next+bounces-5307-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 707D7A19E47
	for <lists+linux-next@lfdr.de>; Thu, 23 Jan 2025 06:57:17 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 9718616055D
	for <lists+linux-next@lfdr.de>; Thu, 23 Jan 2025 05:57:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B5CEB1428F3;
	Thu, 23 Jan 2025 05:57:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="hs+hOPnU"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id F132074C08;
	Thu, 23 Jan 2025 05:57:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737611832; cv=none; b=S6jjm4FZwyhK+8+26J2a7Ul4EBAmovuyG70Oru+pfqvxjPIuDS1SIA+mi491EsSkzEBJqXBPOOYqH9aQfdFL1qpr33vqpxwh81ylLtju9vYXZD+thPWGZ2HCU+nQjHRuPmqnSptni43Q5P4HPEHi287Z8h2dOCOpOyOBKkn3830=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737611832; c=relaxed/simple;
	bh=u7JHh3083X34tHSSlIkq+1g06GX/IPOok6pgwia97+Q=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=eYV1Vs/S3EfEqTQ9PxhKCqgFxOqnnfCJ+MdxAFCkHIRUZIs0VZ+3M/Q6M6RzUJh27+w8BqJjKLvkDKFVW5xaCL9qBCFHF2yg+u4p9jOeOSe80dBkyjefnM3E2jFCimzOX4NYYYCg6Gn7oHsEcA3EYD2djcgjr/dilccYLQfRUp4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=hs+hOPnU; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1737611815;
	bh=Bw9zeGobIGKi3uHBYOH7i/DZNbPXrGiLtEOH0x6qLgQ=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Ydqvq090Nz4wvg;
	Thu, 23 Jan 2025 16:56:54 +1100 (AEDT)
Date: Thu, 23 Jan 2025 16:57:01 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 23
Message-ID: <20250123165701.23c6afab@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/kln5Rejxn1TU.5oz0uto+nt";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/kln5Rejxn1TU.5oz0uto+nt
...
Changes since 20250122:

The v4l-dvb tree gained a conflict against the jc_docs tree.

Non-merge commits (relative to Linus' tree): 4728
 4957 files changed, 229649 insertions(+), 84451 deletions(-)
...
Merging origin/master (7004a2e46d16 Merge tag 'linux_kselftest-nolibc-6.14-=
rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/shuah/linux-kselftest)
...
Merging fs-current (ab5891c414de Merge branch 'fixes' of git://git.kernel.o=
...
Merging sound-asoc-fixes/for-linus (aba93815f270 Merge remote-tracking bran=
ch 'asoc/for-6.13' into asoc-linus)
Merging regmap-fixes/for-linus (5bc55a333a2f Linux 6.13-rc7)
Merging regulator-fixes/for-linus (710ca08676d8 Merge remote-tracking branc=
...
Merging drm-misc-fixes/for-linux-next-fixes (c40ca9ef7c5c drm: select DRM_K=
MS_HELPER from DRM_GEM_SHMEM_HELPER)
...
Merging fs-next (93b2aaae2ba1 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging sound-asoc/for-next (aba93815f270 Merge remote-tracking branch 'aso=
...
Merging regulator/for-next (710ca08676d8 Merge remote-tracking branch 'regu=
...
Merging ftrace/for-next (0b63b149462e Merge tools/for-next)
...
Merging efi/next (b5d1e6ee761a efivarfs: add variable resync after hibernat=
ion)
...

=jW+t
-----END PGP SIGNATURE-----
