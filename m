...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2477F1C63E4
	for <lists+linux-next@lfdr.de>; Wed,  6 May 2020 00:29:27 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728853AbgEEW30 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 5 May 2020 18:29:26 -0400
Received: from mail.kernel.org ([198.145.29.99]:54508 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727089AbgEEW3Z (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 5 May 2020 18:29:25 -0400
Received: from localhost.localdomain (c-73-231-172-41.hsd1.ca.comcast.net [73.231.172.41])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 3C182206FA;
        Tue,  5 May 2020 22:29:23 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1588717763;
        bh=pgfPVeHmkPeIfXX3r/Bk/WkrNcmm4xAd2SEnDvTSqeY=;
        h=Date:From:To:Subject:From;
        b=h7K4STEFmh65B5GzzsqNNwiVc1o4ZiYYtE5pZ8a4pvwVBN2NtNqy4sBLzr6X7KSE1
         oRjDMjH+sruhZE7LEGwLVXewySHy+9hcaJFMaxqcobZ/oCym7ATwonj6FrboMwgObf
         UvMix4OpOp8wiy+CsoQy6wkxkO090MHIutSpfErc=
Date:   Tue, 05 May 2020 15:29:22 -0700
From:   akpm@linux-foundation.org
To:     broonie@kernel.org, linux-fsdevel@vger.kernel.org,
        linux-kernel@vger.kernel.org, linux-mm@kvack.org,
        linux-next@vger.kernel.org, mhocko@suse.cz,
        mm-commits@vger.kernel.org, sfr@canb.auug.org.au
Subject:  mmotm 2020-05-05-15-28 uploaded
Message-ID: <20200505222922.jajHT3b4j%akpm@linux-foundation.org>
...
This mmotm tree contains the following patches against 5.7-rc4:
...
* mm-slub-fix-incorrect-interpretation-of-s-offset.patch
* percpu-make-pcpu_alloc-aware-of-current-gfp-context.patch
...
* ubsan-disable-ubsan_alignment-under-compile_test.patch
...
* binfmt_elf-remove-the-set_fs-in-fill_siginfo_note.patch
...
* sysctl-fix-unused-function-warning.patch
