...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C655438868D
	for <lists+linux-next@lfdr.de>; Wed, 19 May 2021 07:33:40 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233034AbhESFez (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 19 May 2021 01:34:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59896 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238071AbhESFev (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 19 May 2021 01:34:51 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6B3A2C061761;
        Tue, 18 May 2021 22:32:46 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FlM2d2Fhqz9sTD;
        Wed, 19 May 2021 15:32:41 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1621402361;
        bh=l720AWVgie+83fupV1WxZ3BsTw4dY88hDVqq7tFy09Q=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 19 May 2021 15:32:40 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 19
Message-ID: <20210519153240.6764db91@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/BWd_16VxL95z4sW5C3I2HJK";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/BWd_16VxL95z4sW5C3I2HJK
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210518:

The netfilter-next tree gained a conflict against the net tree.

Non-merge commits (relative to Linus' tree): 3287
 3383 files changed, 175829 insertions(+), 49298 deletions(-)
...
Merging net/master (c9fd37a9450b Merge branch 'hns3-fixes')
...
eation failed)
Merging sound-current/for-linus (4c6fe8c547e3 ALSA: dice: fix stream format=
 for TC Electronic Konnekt Live at high sampling transfer frequency)
Merging sound-asoc-fixes/for-linus (b64a8148d78e Merge remote-tracking bran=
ch 'asoc/for-5.13' into asoc-linus)
Merging regmap-fixes/for-linus (6efb943b8616 Linux 5.13-rc1)
Merging regulator-fixes/for-linus (7c333b2bc5a0 Merge remote-tracking branc=
...
Merging v4l-dvb-next/master (b9f33f574986 Merge branch 'media_stage' into t=
o_next)
...
Merging net-next/master (86544c3de6a2 net: mdio: provide shim implementatio=
n of devm_of_mdiobus_register)
Applying: usb: class: cdc-wdm: fix for kill_urbs() removal
Merging bpf-next/for-next (1a532eb28df3 selftests/bpf: Convert test trace_p=
rintk to lskel.)
...
Merging drm-misc/for-linux-next (f7f525030854 drm: log errors in drm_gem_fb=
_init_with_funcs)
...
om quirks)
Merging sound/for-next (3fda230b3ef8 Merge branch 'topic/firewire' into for=
-next)
Merging sound-asoc/for-next (a0cfcfd0d2ac Merge remote-tracking branch 'aso=
...
Merging block/for-next (83e9ffca0e74 Merge branch 'for-5.14/libata' into fo=
r-next)
...
Merging regulator/for-next (a61286575304 Merge remote-tracking branch 'regu=
...
Merging pinctrl/for-next (6fc5a68d23b7 Merge branch 'devel' into for-next)
...
Merging akpm/master (ef2768cf6d84 kdump: use vmlinux_build_id to simplify)
...

=IvZ1
-----END PGP SIGNATURE-----
