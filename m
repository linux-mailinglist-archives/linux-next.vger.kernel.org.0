...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F09C8356A56
	for <lists+linux-next@lfdr.de>; Wed,  7 Apr 2021 12:53:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1351559AbhDGKwL (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 7 Apr 2021 06:52:11 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:42699 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S234957AbhDGKwK (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 7 Apr 2021 06:52:10 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FFh6R4VpKz9sVb;
        Wed,  7 Apr 2021 20:51:59 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1617792719;
        bh=veiT12UjKBw4UPjnGxWhGK41tsKs9TihT+Wj7y/gxoE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 7 Apr 2021 20:51:58 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 7
Message-ID: <20210407205158.30a82de3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/j0Kf9J7E3b+5Sa7L0abfPSV";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/j0Kf9J7E3b+5Sa7L0abfPSV
...
Merging origin/master (2d743660786e Merge branch 'fixes' of git://git.kerne=
...
Merging sound-current/for-linus (c6423ed2da62 ALSA: hda/conexant: Apply qui=
rk for another HP ZBook G5 model)
Merging sound-asoc-fixes/for-linus (c08d69ae474a Merge remote-tracking bran=
...
next-fixes)
Merging vfs-fixes/fixes (7d01ef7585c0 Make sure nd->path.mnt and nd->path.d=
entry are always valid pointers)
...
Merging qcom/for-next (243860c38c7e Merge branches 'arm64-defconfig-for-5.1=
...
Merging mips/mips-next (7f028bff8a8e MIPS: ralink: rt288x: select MIPS_AUTO=
_PFN_OFFSET)
...
r file inclusion)
Merging parisc-hd/for-next (0aa2ddc9af44 parisc: math-emu: Few spelling fix=
es in the file fpu.h)
...
ary: add namespace.c)
Merging v4l-dvb/master (7acc54ed6061 media: s5p-mfc: Fix kernel-doc entries=
 in s5p_mfc_common.h)
CONFLICT (content): Merge conflict in MAINTAINERS
Merging v4l-dvb-next/master (1e28eed17697 Linux 5.12-rc3)
Merging fbdev/fbdev-for-next (732146a3f1dc video: fbdev: imxfb: fix a typo =
in imxfb_probe())
Merging pm/linux-next (cf66fa75745a Merge branch 'devprop' into linux-next)
...
Merging net-next/master (0b35e0deb5be docs: ethtool: correct quotes)
...
Merging bluetooth/master (8ce85ada0a05 Bluetooth: LL privacy allow RPA)
...
Merging drm-intel/for-linux-next (11cda4967a33 drm/i915/sysfs: convert snpr=
intf to sysfs_emit)
...
Merging sound/for-next (53cc2643c149 ALSA: control - off by one in store_mo=
de())
Merging sound-asoc/for-next (0aa5056addf6 Merge remote-tracking branch 'aso=
...
river)
Merging block/for-next (ce035fc4fc50 Merge branch 'for-5.13/io_uring' into =
for-next)
...
Merging kvm-arm/next (b7e0528be9ac Merge branch 'kvm-arm64/vgic-5.13' into =
kvmarm-master/next)
Merging kvm-ppc/kvm-ppc-next (72476aaa4691 KVM: PPC: Book3S HV: Fix host ra=
dix SLB optimisation with hash guests)
Merging kvms390/next (c3171e94cc1c KVM: s390: VSIE: fix MVPG handling for p=
refixing and MSO)
Merging xen-tip/linux-next (66bc13252090 xen/evtchn: Change irq_info lock t=
o raw_spinlock_t)
...
Merging staging/staging-next (e91cafdf3c18 staging: rtl8712: Remove extra b=
lank lines)
...
Merging kunit-next/kunit (f65968ac191b kunit: fix -Wunused-function warning=
 for __kunit_fail_current_test)
Merging trivial/for-next (9ff9b0d392ea Merge tag 'net-next-5.10' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/netdev/net-next)
Merging zx2c4/for-next (16fbf79b0f83 Linux 5.6-rc7)
Merging mhi/mhi-next (6731fefd9567 bus: mhi: Improve documentation on chann=
el transfer setup APIs)
...
Merging akpm/master (b5bf0eb83948 memfd_secret: use unsigned int rather tha=
...

=txJk
-----END PGP SIGNATURE-----
