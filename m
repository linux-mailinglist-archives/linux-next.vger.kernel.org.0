...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5EFCA255402
	for <lists+linux-next@lfdr.de>; Fri, 28 Aug 2020 07:23:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726465AbgH1FXx (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 28 Aug 2020 01:23:53 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:55809 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725849AbgH1FXw (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 28 Aug 2020 01:23:52 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Bd7LC44fHz9sR4;
        Fri, 28 Aug 2020 15:23:47 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1598592227;
        bh=z7T3JUtwcG98k2mamqURNpiLfTo72s8C+zUk/ETMZdE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 28 Aug 2020 15:23:46 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 28
Message-ID: <20200828152346.36e36e04@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/QHtDziX+hojvFkXhQTAx8Rc";
...
Merging arc-current/for-curr (89d29997f103 irqchip/eznps: Fix build error f=
or !ARC700 builds)
...
figs for v5.8-rc3)
Merging powerpc-fixes/fixes (16d83a540ca4 Revert "powerpc/powernv/idle: Rep=
lace CPU feature check with PVR check")
...
Merging net/master (b43c75abfd08 rxrpc: Fix memory leak in rxkad_verify_res=
ponse())
...
Merging mac80211/master (2d9b55508556 cfg80211: Adjust 6 GHz frequency to c=
hannel conversion)
...
Merging usb.current/usb-linus (9aa37788e7eb USB: Ignore UAS for JMicron JMS=
567 ATA/ATAPI Bridge)
...
ins to 1)
Merging hwmon-fixes/hwmon (c1ae18d313e2 hwmon: (gsc-hwmon) Scale temperatur=
e to millidegrees)
...
Merging drm-fixes/drm-fixes (60a10650e7e5 Merge tag 'drm-msm-fixes-2020-08-=
24' of https://gitlab.freedesktop.org/drm/msm into drm-fixes)
...
Merging drm-misc-fixes/for-linux-next-fixes (07b5b12d97dc drm/sun4i: add mi=
ssing put_device() call in sun8i_r40_tcon_tv_set_mux())
Merging kspp-gustavo/for-next/kspp (c165a08d2b28 arm64/cpuinfo: Remove unne=
cessary fallthrough annotation)
Merging kbuild/for-next (6ad7cbc01527 Makefile: Add clang-tidy and static a=
nalyzer support to makefile)
Merging compiler-attributes/compiler-attributes (5861af92ff2a Compiler Attr=
ibutes: fix comment concerning GCC 4.6)
...
Merging drivers-memory/for-next (fd2278164808 memory: emif: Remove bogus de=
bugfs error handling)
...
Merging cifs/for-next (68d7a2eb103d cifs: fix check of tcon dfs in smb1)
...
DMI/SMBIOS SUPPORT)
Merging hwmon-staging/hwmon-next (97568defeee1 hwmon: (k10temp) Define SVI =
telemetry and current factors for Zen2 CPUs)
Merging jc_docs/docs-next (92001bc0365a Documentation: laptops: thinkpad-ac=
pi: fix underline length build warning)
Merging v4l-dvb/master (d84eca28c807 media: MAINTAINERS: add Dafna Hirschfe=
ld for rkisp1)
Merging v4l-dvb-next/master (0d6db85131e0 Revert "media: atomisp: keep the =
ISP powered on when setting it")
Merging fbdev/fbdev-for-next (732146a3f1dc video: fbdev: imxfb: fix a typo =
in imxfb_probe())
Merging pm/linux-next (dc37b29f6d30 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
Merging opp/opp/linux-next (9b53e9891081 opp: Allow opp-supported-hw to con=
...
Merging net-next/master (50aba46c234e gtp: add notification mechanism)
CONFLICT (content): Merge conflict in net/ipv4/raw.c
CONFLICT (content): Merge conflict in drivers/net/ethernet/ibm/ibmvnic.c
Merging bpf-next/master (2e80be60c465 libbpf: Fix compilation warnings for =
64-bit printf args)
...
Merging wireless-drivers-next/master (26721b02466e zd1211rw: convert taskle=
ts to use new tasklet_setup() API)
Merging bluetooth/master (3b799254cf6f Bluetooth: hci_uart: Cancel init wor=
k before unregistering)
Merging mac80211-next/master (2831a631022e nl80211: support SAE authenticat=
ion offload in AP mode)
...
Merging amdgpu/drm-next (ebf375830bfc drm/amdgpu/swsmu: add handle manual f=
an readback on SMU11)
...
ice.c
Merging drm-intel/for-linux-next (caab25dc9e36 drm/i915/display: Fix DRRS d=
ebugfs)
Merging drm-tegra/drm/tegra/for-next (4fba6d22ca9a drm/tegra: plane: Suppor=
t 180=C2=B0 rotation)
Merging drm-misc/for-linux-next (3bc46a083fa9 drm/sun4i: lvds: Invert the L=
VDS polarity)
...
nds.)
Merging sound-asoc/for-next (f00bb4eb18c1 Merge remote-tracking branch 'aso=
...
Merging battery/for-next (c24b9a741b5f power: supply: pm2301_charger: fix s=
pelling mistake "chargind" -> "charging")
Merging regulator/for-next (1406da692942 Merge remote-tracking branch 'regu=
...
Merging selinux/next (9ff9abc4c6be selinux: move policy mutex to selinux_st=
ate, use in lockdep checks)
...
Merging edac/edac-for-next (efe5396fa1db Merge branch 'edac-urgent' into ed=
ac-for-next)
...
Merging rcu/rcu/next (417ea89c28ab refscale: Bounds-check module parameters)
...
frontend driver)
Merging extcon/extcon-next (70f8ef322829 extcon: ptn5150: Set the VBUS and =
POLARITY property capability)
...
fixes' into for-next)
Merging coresight/next (8aba79505eb3 coresight: etm4x: Ensure default perf =
settings filter user/kernel)
...
Merging akpm/master (93ec0960bea8 mm/mmap: add inline munmap_vma_range() fo=
r code readability)
...

=h97n
-----END PGP SIGNATURE-----
