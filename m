...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 365FE4691B5
	for <lists+linux-next@lfdr.de>; Mon,  6 Dec 2021 09:46:17 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239464AbhLFIto (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 6 Dec 2021 03:49:44 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:58183 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236377AbhLFIto (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 6 Dec 2021 03:49:44 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4J6xqB5c9tz4xgY;
        Mon,  6 Dec 2021 19:46:14 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1638780374;
        bh=Q3Ia8UFOBYeF674PgWOjj0FeAYa+63la+2d7NYYy8l8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 6 Dec 2021 19:46:14 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 6
Message-ID: <20211206194614.4bd57e15@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bTlOa7iwSbIf7aIS1.+5MEs";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/bTlOa7iwSbIf7aIS1.+5MEs
...
The bpf-next tree lost its failures, but gained another so I used the
version from next-20211202 again.
...
Non-merge commits (relative to Linus' tree): 4635
 5172 files changed, 200855 insertions(+), 97655 deletions(-)
...
Merging origin/master (944207047ca4 Merge tag 'usb-5.16-rc4' of git://git.k=
...
Merging tty.current/tty-linus (9cabe26e65a8 serial: 8250_bcm7271: UART erro=
rs after resuming from S2)
Merging usb.current/usb-linus (37307f7020ab usb: cdnsp: Fix a NULL pointer =
dereference in cdnsp_endpoint_init())
...
Merging omap/for-next (92d190433bd8 Merge branch 'omap-for-v5.16/gpmc' into=
 for-next)
Merging qcom/for-next (ef57a4ffa2e5 Merge branches 'arm64-for-5.17', 'clk-f=
...
Merging parisc-hd/for-next (afdb4a5b1d34 parisc: Mark cr16 CPU clocksource =
...
ID directories)
Merging cifs/for-next (23b55d673d75 Merge tag '5.16-rc3-smb3-fixes' of git:=
...
Merging ksmbd/ksmbd-for-next (23b55d673d75 Merge tag '5.16-rc3-smb3-fixes' =
...
Merging cel/for-next (60a7808a5c08 NFSD: Fix inconsistent indenting)
...
Merging bpf-next/for-next (942df4dc5ea1 bpftool: Add debug mode for gen_loa=
der.)
...
CONFLICT (content): Merge conflict in Documentation/bpf/index.rst
[master 5f41809898ff] next-20211202/bpf-next
...
Merging bluetooth/master (aeb8b133415a Bluetooth: hci_sync: Set Privacy Mod=
e when updating the resolving list)
$ git reset --hard HEAD^
...
ce fields)
Merging block/for-next (779d83b81f10 Merge branch 'for-5.17/io_uring' into =
for-next)
...
Merging tip/auto-latest (9d8c5461d363 Merge x86/urgent into tip/master)
...
Merging usb/usb-next (e1c72d907f4c usb: bdc: fix error handling code in bdc=
_resume)
Merging usb-gadget/next (e49d033bddf5 Linux 5.12-rc6)
Merging usb-serial/usb-next (d58071a8a76d Linux 5.16-rc3)
Merging usb-chipidea-next/for-usb-next (78665f57c3fa usb: chipidea: udc: ma=
ke controller hardware endpoint primed)
Merging tty/tty-next (13a5fad39a7b tty: mips_ejtag_fdc: Make use of the hel=
per function kthread_run_on_cpu())
Merging char-misc/char-misc-next (70602b37c4af driver: soc: xilinx: registe=
r for power events in zynqmp power driver)
...
isting file)
Merging gpio-brgl/gpio/for-next (e320d9c2e900 gpio: xlp: Fix build errors f=
rom Netlogic XLP removal)
...
Merging akpm-current/current (9bd91a86f234 lib/Kconfig.debug: make TEST_KMO=
D depend on PAGE_SIZE_LESS_THAN_256KB)
CONFLICT (content): Merge conflict in mm/zsmalloc.c
CONFLICT (content): Merge conflict in mm/memcontrol.c
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (4a6df865acad lib/stackdepot: always do filter_irq_stac=
...

=7Nim
-----END PGP SIGNATURE-----
