...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3C73E43F8C9
	for <lists+linux-next@lfdr.de>; Fri, 29 Oct 2021 10:25:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232351AbhJ2I2V (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 29 Oct 2021 04:28:21 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:59797 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232305AbhJ2I2U (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 29 Oct 2021 04:28:20 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Hgb9C0Gyqz4xbr;
        Fri, 29 Oct 2021 19:25:51 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1635495951;
        bh=1l6gvAOd5R0k9fznCOWtUZonuGOwpmB0PxUfdzKyu3E=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 29 Oct 2021 19:25:49 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 29
Message-ID: <20211029192549.26f072f2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/hBE+fW8P3vi2.xxfJHd96H.";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/hBE+fW8P3vi2.xxfJHd96H.
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211028:

The btrfs tree still had its build failure so I marked BTRFS_FS as BROKEN.

The drm tree gained a conflict against Linus' tree.

The devicetree tree gained a conflict against the iommu tree.

The tip tree lost its bulid failure.

I have disabled the ntfs file system for now as it fails a powerpc
allyesconfig build.

Non-merge commits (relative to Linus' tree): 11616
 10805 files changed, 654152 insertions(+), 237880 deletions(-)
...
Merging origin/master (f31531e55495 Merge tag 'drm-fixes-2021-10-29' of git=
...
Merging net/master (411a44c24a56 Merge tag 'net-5.15-rc8' of git://git.kern=
...
Merging sound-asoc-fixes/for-linus (1f57906ee2de Merge remote-tracking bran=
...
t)
Merging arm64/for-next/core (e3f3b8e1c6fb Merge branch 'for-next/misc' into=
 for-next/core)
...
om asm-offsets.c)
Merging powerpc/next (5b9f69ffa6b4 Merge branch 'topic/ppc-kvm' into next)
...
Merging hwmon-staging/hwmon-next (38d9f06c5740 hwmon: (tmp401) Drop support=
 for TMP461)
...
used functions)
Merging pm/linux-next (1eb4f10091ca Merge branches 'pm-devfreq' and 'pm-sle=
ep' into linux-next)
...
ze_cq callback)
Merging net-next/master (7df621a3eea6 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/netdev/net)
Merging bpf-next/for-next (2895f48f98db Merge branch 'Implement bloom filte=
r map')
...
ifi/iwlwifi-next)
Merging bluetooth/master (2128939fe2e7 Bluetooth: Fix removing adv when pro=
cessing cmd complete)
...
_quirks.c
Merging drm-misc/for-linux-next (2b3374306b31 drm/bridge: sn65dsi86: ti_sn6=
5dsi86_read_u16() __maybe_unused)
...
Merging sound/for-next (cddcd5472abb ALSA: oxfw: fix functional regression =
for Mackie Onyx 1640i in v5.14 or later)
Merging sound-asoc/for-next (3a99d60e0b66 Merge remote-tracking branch 'aso=
...
te support)
Merging block/for-next (2a0698906455 Merge branch 'for-5.16/io_uring' into =
for-next)
...
Merging audit/next (d9516f346e8b audit: return early if the filter rule has=
 a lower priority)
CONFLICT (content): Merge conflict in include/uapi/linux/audit.h
Merging devicetree/for-next (c60a9debf3c7 of/unittest: Disable new dtc node=
_name_vs_property_name and interrupt_map warnings)
CONFLICT (add/add): Merge conflict in Documentation/devicetree/bindings/pci=
/rockchip-dw-pcie.yaml
CONFLICT (content): Merge conflict in Documentation/devicetree/bindings/iom=
mu/arm,smmu.yaml
...
Merging tip/auto-latest (1760a259bbdb Merge x86/fpu into tip/master)
...
Merging akpm-current/current (a3b36fccd9f9 kernel.h: split out instruction =
pointer accessors)
...
Merging akpm/master (74ce716cd87b kasan: add kasan mode messages when kasan=
 init)
...

=v6y9
-----END PGP SIGNATURE-----
