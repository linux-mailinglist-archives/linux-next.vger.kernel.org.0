Return-Path: <linux-next+bounces-4708-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 83E339C1C12
	for <lists+linux-next@lfdr.de>; Fri,  8 Nov 2024 12:22:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 05558B20C9F
	for <lists+linux-next@lfdr.de>; Fri,  8 Nov 2024 11:22:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E7AA21E0E0F;
	Fri,  8 Nov 2024 11:22:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="eVihTtPk"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-pf1-f170.google.com (mail-pf1-f170.google.com [209.85.210.170])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 33FDB1DE8A8
	for <linux-next@vger.kernel.org>; Fri,  8 Nov 2024 11:22:13 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.210.170
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1731064960; cv=none; b=CjTjz308iLoKu9MMcRTG9h6yoAf6xqTboN62a1mz2YxHCAIf/aMN4xbqiK+rboap5dm0Ys6iie7oB+f0RX0Qs4/WmNwefxysU3iCRuAjAxR/R1SY3bfbOUhdC6ArzXUstWQWEuoNluoja5EIu4C6G/XLmJQ43jIRQ6Hyub5zctY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1731064960; c=relaxed/simple;
	bh=bGTKR+t5tDPkQhKreOsgO9Xu6pFrKpMMYX2i+av/uhE=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=FTQpKgDDsKFE/6i96QYTp6TOt8ABmdk/h3NkcTEcC4yE02fVRfsQpcPVHkerqQD8ITX5y0qTPzD6ZxsipXD2hQ9d075HV1i+tuOr/7Vd+N6HCymfv28oRtETt9SGez0HQQ+h/cKa44NnXZC5qh2FjOefPbtypI/SSTu7rOj7cqA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=eVihTtPk; arc=none smtp.client-ip=209.85.210.170
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-pf1-f170.google.com with SMTP id d2e1a72fcca58-720c2db824eso2059683b3a.0
        for <linux-next@vger.kernel.org>; Fri, 08 Nov 2024 03:22:13 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1731064933; x=1731669733; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=ACC0m7bfodfg8bZQE2t0Pu2dJy2aRqiIY0P9wOwy1ss=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1731064933; x=1731669733;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=ACC0m7bfodfg8bZQE2t0Pu2dJy2aRqiIY0P9wOwy1ss=;
        b=
X-Gm-Message-State: AOJu0YyFBieBCiYUq9zbaiIsFC4s/v/SRX8SKIsFEi6lM9mKW8B22u2Q
	svx+DeV81z3dX0cvQcyj6bxYqah+6ZU8tqHz1XjYFd+aopZJQMklfHYfScqYqf2vMWgET49sqi+
	c
X-Google-Smtp-Source: AGHT+IGga6uvdy+oDuqOam31u2fJSKQnrL+QHYwOnCnjgpNueu0c0IjGflZ7fqfroPAU7NjbgR0ELA==
X-Received: by 2002:a05:6a00:a28:b0:71e:4bfb:a1f9 with SMTP id d2e1a72fcca58-72413368a18mr3062966b3a.22.1731064931117;
        Fri, 08 Nov 2024 03:22:11 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id d2e1a72fcca58-724079aa862sm3367149b3a.115.2024.11.08.03.22.09
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 08 Nov 2024 03:22:10 -0800 (PST)
Message-ID: <672df462.a70a0220.294ccf.d3c8@mx.google.com>
Date: Fri, 08 Nov 2024 03:22:10 -0800 (PST)
...
Subject: next/master build: 182 builds: 5 failed, 177 passed, 1 error,
 5898 warnings (next-20241108)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 182 builds: 5 failed, 177 passed, 1 error, 5898 warnings=
 (next-20241108)
...
Tree: next
Branch: master
Git Describe: next-20241108
Git Commit: 929beafbe7acce3267c06115e13e03ff6e50548a
...
x86_64:
    x86_64_defconfig+kselftest (rustc-1.75): 1 error, 1 warning

Errors summary:

    1    kernel/sched/ext.c:3252:6: error: use of bitwise '&' with boolean =
operands [-Werror,-Wbitwise-instead-of-logical]

Warnings summary:

    702  include/asm-generic/io.h:838:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    702  include/asm-generic/io.h:820:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
ined behavior [-Wnull-pointer-arithmetic]
    1    warning  804 |         insb(addr, buffer, count);
    1    u../include/asm-generic/io.hf:f812e:r2,:  cwarning: operforming po=
...
NAMIC dynamic table is invalid: SHT_DYNAMIC will be used
    1    kernel/sched/ext.c:3252:6: note: cast one or both operands to int =
to silence this warning
    1    include/asm-generic/io.hc:o820u:n2t:)  warning: __performing point=
er arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arit=
hmetic]o
    1    include/asm-generic/io.h:847:r2,:  bwarning: ufperforming pointer =
arithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithme=
tic]f
    1    include/asm-generic/io.h:847:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]In=
 file included from ../init/init_task.c:2:
    1    include/asm-generic/io.h:847:2: warning: performing pointer arithm=
etic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]  =
CC      drivers/clocksource/dummy_timer.o
    1    include/asm-generic/io.h:838:  2812: |          warning: iperformi=
...
t an interrupt provider
    1    :In file included from 2../include/linux/highmem.h:: 12warning: :
    1    :838:2: warning: performing pointer arithmetic on a null pointer h=
as undefined behavior [-Wnull-pointer-arithmetic]
    1    :804:2:../arch/riscv/include/asm/io.h :warning: 118performing poin=
...
efined behavior [-Wnull-pointer-arithmetic]In file included from ../fs/sysf=
s/symlink.c:16:
    1    :       | warning:                                            ~~~~=
~~~~~~ ^performing pointer arithmetic on a null pointer has undefined behav=
ior [-Wnull-pointer-arithmetic]
    1    838 | 7 warnings generated.
    1    829:2: warning: performing pointer arithmetic on a null pointer ha=
s undefined behavior [-Wnull-pointer-arithmetic]In file included from
    1    7In file included from  warnings generated.
    1    7 warnings generatedIn file included from ../drivers/base/syscore.=
c:11:
    1    2In file included from :../include/linux/hardirq.h :warning: 11per=
...
defined behavior [-Wnull-pointer-arithmetic]
    1    119 | #define outsw(addr, buffer, count) __outsw(PCI_IOBASE + (add=
r), buffer, count7 warnings generated.
    1    119 | #define outsw(addr, buffer, count) __outsw(PCI_IOBASE + (add=
r), 7 warnings generated.
    1    118 | #define outsb(addr, buffer, count) __outsb(PCI7 warnings gen=
erated.
    1    106 | #define in7 warnings generated.
    1    105 | #define insw(addr, buffer, 7 warnings generated.
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]In file=
 included from ../init/init_task.c:2:
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]In fi=
le included from ../fs/kernfs/dir.c:15:
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7In file included from  warnings generated.
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    119 | #define outsw(addr, buffer, count) __outsw(PCI_IOBASE + (addr), b=
uffer, count7 warnings generated.
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    119 | #define outsw(addr, buffer, count) __outsw(PCI_IOBASE + (addr), 7=
 warnings generated.
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    118 | #define outsb(addr, buffer, count) __outsb(PCI7 warnings generate=
d.
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]  CC   =
   drivers/clocksource/dummy_timer.o
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7 warnings generated.
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:1175:55: warning: performing pointer arithmeti=
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    7 warnings generatedIn file included from ../drivers/base/syscore.c:11:
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    829:2: warning: performing pointer arithmetic on a null pointer has und=
efined behavior [-Wnull-pointer-arithmetic]In file included from
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    105 | #define insw(addr, buffer, 7 warnings generated.
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    :In file included from 2../include/linux/highmem.h:: 12warning: :
    :804:2:../arch/riscv/include/asm/io.h :warning: 118performing pointer a=
rithmetic on a null pointer has undefined behavior [-Wnull-pointer-arithmet=
ic]:55
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:  2812: |          warning: iperforming po=
inter arithmetic on a null pointer has undefined behavior [-Wnull-pointer-a=
rithmetic]n
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:847:r2,:  bwarning: ufperforming pointer arith=
metic on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]f
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    106 | #define in7 warnings generated.
    include/asm-generic/io.h:829:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
d behavior [-Wnull-pointer-arithmetic]In file included from ../fs/sysfs/sym=
link.c:16:
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
...
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    2In file included from :../include/linux/hardirq.h :warning: 11performi=
ng pointer arithmetic on a null pointer has undefined behavior [-Wnull-poin=
ter-arithmetic]:
    u../include/asm-generic/io.hf:f812e:r2,:  cwarning: operforming pointer=
...
c on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    ...
    include/asm-generic/io.h:804:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    warning  804 |         insb(addr, buffer, count);
    include/asm-generic/io.h:812:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:820:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
...
-Wnull-pointer-arithmetic]
    include/asm-generic/io.h:838:2: warning: performing pointer arithmetic =
on a null pointer has undefined behavior [-Wnull-pointer-arithmetic]
    include/asm-generic/io.hc:o820u:n2t:)  warning: __performing pointer ar=
...
---------------------------------------------------------------------------=
-----
x86_64_defconfig+kselftest (x86_64, rustc-1.75) =E2=80=94 FAIL, 1 error, 1 =
warning, 0 section mismatches

Errors:
    kernel/sched/ext.c:3252:6: error: use of bitwise '&' with boolean opera=
nds [-Werror,-Wbitwise-instead-of-logical]

Warnings:
    kernel/sched/ext.c:3252:6: note: cast one or both operands to int to si=
lence this warning
