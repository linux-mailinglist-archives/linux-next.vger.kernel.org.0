Return-Path: <linux-next+bounces-3340-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 84F3895401E
	for <lists+linux-next@lfdr.de>; Fri, 16 Aug 2024 05:48:23 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 26EE82855DF
	for <lists+linux-next@lfdr.de>; Fri, 16 Aug 2024 03:48:22 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 2D87A43687;
	Fri, 16 Aug 2024 03:48:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="k3uh5XvZ"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B76F92F46;
	Fri, 16 Aug 2024 03:48:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1723780099; cv=none; b=KqyWmpycSJj0lsFDOksZ8ZQCK9IfPHdy0LkoLKF72Q4IaMs3TF96DBvh5eu/X4dmxeTH93zhW8Xoz2r4UxYmXInuxhuTLtMrocuePLOQuxNzsPt59KxVFpWmPaVN4ieCkmpfcI4YehaTcSZsieuB5g9hloHr0UPsSDDyvLWaPM4=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1723780099; c=relaxed/simple;
	bh=2BSHkaPPiwr2nOX95Djjuc/oyZTt6A9MTsMusQnlAsE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=VyXyFQndVgBFUJMl9NsJ9vVl4J9a/hb8VHF9qYk2Hur73DrrVYcegbUJ4ktm+1PHLC6TH/d9uTgKCuj7EQfExraEgvp6qp0iiHDJUNgDNSMOgypn/Auhq4FFBCeH+W3Uin/pVc2x9UmbnKYbTURMWNqXgajJ9bd/Np3sHZsu6HE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=k3uh5XvZ; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1723780089;
	bh=7syr/XuvMEXXv5GNUVfhoY2daquVSSLXmIbBpwMFXUs=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WlSd509hPz4wnx;
	Fri, 16 Aug 2024 13:48:08 +1000 (AEST)
Date: Fri, 16 Aug 2024 13:48:08 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 16
Message-ID: <20240816134808.58bfef8e@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/vbqghAACoYUAz8dT414F4Am";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/vbqghAACoYUAz8dT414F4Am
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240815:

The mm tree lost its build failures.

The iommufd tree gained a conflict against the mm tree.

Non-merge commits (relative to Linus' tree): 4477
 4892 files changed, 179421 insertions(+), 85262 deletions(-)
...
Merging origin/master (e724918b3786 Merge tag 'hardening-v6.11-rc4' of git:=
...
Merging btrfs-fixes/next-fixes (b9d6f23c8bf3 Merge branch 'misc-6.11' into =
next-fixes)
...
Merging cifs/for-next (5b4f3af39b65 smb: smb2pdu.h: Use static_assert() to =
check struct sizes)
...
Merging ksmbd/ksmbd-for-next (a43e55a5d9b1 ksmbd: Use unsafe_memcpy() for n=
tlm_negotiate)
...
Merging mm-hotfixes/mm-hotfixes-unstable (bfe91ba28063 nilfs2: fix state ma=
nagement in error path of log writing function)
Merging fs-current (ac3baca764a4 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (9c5af2d7dfe1 Merge tag 'nf-24-08-15' of git://git.kernel.=
...
t endian conversion)
Merging sound-asoc-fixes/for-linus (164199615ae2 ASoC: amd: acp: fix module=
 autoloading)
...
Merging char-misc.current/char-misc-linus (9bb5e74b2bf8 Revert "misc: fastr=
pc: Restrict untrusted app to attach to privileged PD")
...
Merging drm-misc-fixes/for-linux-next-fixes (fd45cc614b8a drm/rockchip: inn=
o-hdmi: Fix infoframe upload)
...
Merging mm/mm-everything (cbaf19e941bc foo)
...
Merging rockchip/for-next (313608ccc8c1 Merge branch 'v6.12-armsoc/dts64' i=
nto for-next)
...
Merging fs-next (acdbedbc8dbc Merge branch 'vfs.all' of git://git.kernel.or=
...
SFS_PATH ioctl)
Merging net-next/main (a9c60712d71f Merge branch 'uapi-net-sched-cxgb4-fix-=
...
Merging ath-next/for-next (6274df2530e3 wifi: ath12k: fix the stack frame s=
ize warning in ath12k_mac_op_hw_scan)
...
Merging drm-misc/for-linux-next (5f5f657a9c3e drm/rockchip: dw_hdmi: Add ma=
x_tmds_clock validation)
...
u_v14_0_2_ppt.c
Merging drm-intel/for-linux-next (c7085d08c7e5 drm/i915/pps: Disable DPLS_G=
ATING around pps sequence)
...
Merging drm-xe/drm-xe-next (8d3a2d3d766a drm/xe: use devm instead of drmm f=
or managed bo)
...
Merging sound-asoc/for-next (1b0c53bf26fa Merge remote-tracking branch 'aso=
...
Merging devicetree/for-next (d2a97be34548 scripts/dtc: Update to upstream v=
ersion v1.7.0-95-gbcd02b523429)
...
Merging rcu/next (a8f45a6508b9 Merge branches 'context_tracking.14.08.24a',=
 'csd.lock.15.08.24a', 'nocb.29.07.24a', 'rcutorture.14.08.24a', 'rcustall.=
15.08.24a', 'srcu.12.08.24a', 'rcu.tasks.14.08.24a', 'rcu_scaling_tests.15.=
08.24a', 'fixes.12.08.24a' and 'misc.11.08.24a' into next.15.08.24a)
...
s)
Merging rpmsg/for-next (213557d0f72d Merge branches 'hwspinlock-next', 'rpm=
...

=uLnz
-----END PGP SIGNATURE-----
