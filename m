...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id F1F4832A990
	for <lists+linux-next@lfdr.de>; Tue,  2 Mar 2021 19:43:32 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1577218AbhCBSdt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 2 Mar 2021 13:33:49 -0500
Received: from ozlabs.org ([203.11.71.1]:39955 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1378929AbhCBBLP (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 1 Mar 2021 20:11:15 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4DqJvt1cCLz9sWH;
        Tue,  2 Mar 2021 12:10:18 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1614647418;
        bh=7MblzsDjmG+f9Ukl7skHpxfqb7+N/Z2eulOloEJZdxs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 2 Mar 2021 12:10:17 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 2
Message-ID: <20210302121017.27928849@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/uJk6sQ05LlisHkd22QthZp_";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/uJk6sQ05LlisHkd22QthZp_
...
Merging powerpc-fixes/fixes (e3d773ddb5a1 powerpc/sstep: Fix VSX instructio=
n emulation)
...
Merging net/master (a2bd45834e83 atm: lanai: dont run lanai_dev_close if no=
t open)
...
e' variable)
Merging mac80211/master (826d82170b53 xen-netback: use local var in xenvif_=
tx_check_gop() instead of re-calculating)
Merging rdma-fixes/for-rc (fe07bfda2fb9 Linux 5.12-rc1)
Merging sound-current/for-linus (2c9119001dcb ALSA: usb-audio: Fix Pioneer =
DJM devices URB_CONTROL request direction to set samplerate)
...
Merging phy/fixes (fe07bfda2fb9 Linux 5.12-rc1)
Merging staging.current/staging-linus (fe07bfda2fb9 Linux 5.12-rc1)
...
esc())
Merging kunit-fixes/kunit-fixes (fe07bfda2fb9 Linux 5.12-rc1)
...
th modules)
Merging drm-misc-fixes/for-linux-next-fixes (fe07bfda2fb9 Linux 5.12-rc1)
...
Merging sunxi/sunxi/for-next (2b8770215620 arm64: dts: allwinner: Move wake=
up-capable IRQs to r_intc)
...
ler warnings)
Merging m68knommu/for-next (fe07bfda2fb9 Linux 5.12-rc1)
Merging microblaze/next (fe07bfda2fb9 Linux 5.12-rc1)
...
Merging sound/for-next (eb596e0fd13c ALSA: usb-audio: generate midi streami=
ng substream names from jack names)
...
Merging block/for-next (52f0463ad3f5 Merge branch 'io_uring-5.12' into for-=
next)
...
Merging battery/for-next (fe07bfda2fb9 Linux 5.12-rc1)
...
12' into spi-linus)
Merging tip/auto-latest (87246c319da5 Merge branch 'locking/core')
...
Merging usb/usb-next (fe07bfda2fb9 Linux 5.12-rc1)
...
Merging extcon/extcon-next (b906ab549836 extcon: qcom-spmi: Add support for=
 VBUS detection)
Merging phy-next/next (1516db7d612b MAINTAINERS: Add linux-phy list and pat=
chwork)
...
Merging oprofile-removal/oprofile/removal (be65de6b03aa fs: Remove dcookies=
 support)
Applying: vio: fix for make remove callback return void
Merging akpm-current/current (a2c9f62c837e aio: simplify read_events())
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (e8d961826c21 Merge branch 'akpm-current/current')
...

=MXB5
-----END PGP SIGNATURE-----
