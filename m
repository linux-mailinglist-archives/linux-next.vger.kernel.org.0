...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 371523FE931
	for <lists+linux-next@lfdr.de>; Thu,  2 Sep 2021 08:23:19 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236573AbhIBGYP (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 2 Sep 2021 02:24:15 -0400
Received: from ozlabs.org ([203.11.71.1]:56239 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230215AbhIBGYO (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 2 Sep 2021 02:24:14 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1630563794;
        bh=34HUbVMzOK3XHnD49T9BczAWCVR1GsHwzy7jIxFG1ZE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4H0W824j4Mz9sSs;
        Thu,  2 Sep 2021 16:23:14 +1000 (AEST)
Date:   Thu, 2 Sep 2021 16:23:13 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 2
Message-ID: <20210902162313.5587c298@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dZ_sEDRHoHEwom7Ie7zPFBC";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/dZ_sEDRHoHEwom7Ie7zPFBC
...
Non-merge commits (relative to Linus' tree): 4122
 4457 files changed, 245375 insertions(+), 69865 deletions(-)
...
Merging origin/master (477f70cd2a67 Merge tag 'drm-next-2021-08-31-1' of gi=
...
Merging net/master (780aa1209f88 mptcp: Fix duplicated argument in protocol=
.h)
Merging bpf/master (9e9fb7655ed5 Merge tag 'net-next-5.15' of git://git.ker=
...
Merging sound-asoc-fixes/for-linus (14c72128792a Merge remote-tracking bran=
...
Merging driver-core.current/driver-core-linus (835d31d319d9 Merge tag 'medi=
a/v5.15-1' of git://git.kernel.org/pub/scm/linux/kernel/git/mchehab/linux-m=
edia)
Merging tty.current/tty-linus (835d31d319d9 Merge tag 'media/v5.15-1' of gi=
...
Merging staging.current/staging-linus (ebf435d3b51b Merge tag 'staging-5.15=
...
Merging parisc-hd/for-next (6f1fce595b78 parisc: math-emu: Fix fall-through=
 warnings)
...
tion)
Merging ntfs3/master (d3624466b56d fs/ntfs3: Restyle comments to better ali=
gn with kernel-doc)
...
Merging pm/linux-next (103d2fac60d0 Merge branches 'pm-opp' and 'pm-cpufreq=
' into linux-next)
...
Merging bluetooth/master (9bba12860fc7 Bluetooth: btusb: Add the new suppor=
t ID for Realtek RTL8852A)
...
Merging amdgpu/drm-next (b8430770b55c drm/sched: fix the bug of time out ca=
lculation(v4))
...
Merging sound-asoc/for-next (14c72128792a Merge remote-tracking branch 'aso=
...
ML schema)
Merging block/for-next (0fedff25ca5a Merge branch 'for-5.15/io_uring' into =
for-next)
...
o)
Merging driver-core/driver-core-next (835d31d319d9 Merge tag 'media/v5.15-1=
...
Merging tty/tty-next (835d31d319d9 Merge tag 'media/v5.15-1' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/mchehab/linux-media)
Merging char-misc/char-misc-next (ba1dc7f273c7 Merge tag 'char-misc-5.15-rc=
...
Merging staging/staging-next (ebf435d3b51b Merge tag 'staging-5.15-rc1' of =
...
Merging akpm/master (13002430b9e1 arch: remove compat_alloc_user_space)
...

=vRJb
-----END PGP SIGNATURE-----
