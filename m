...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 281247DC657
	for <lists+linux-next@lfdr.de>; Tue, 31 Oct 2023 07:15:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235874AbjJaGPX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 31 Oct 2023 02:15:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54930 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235866AbjJaGPW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 31 Oct 2023 02:15:22 -0400
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        ...
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4SKK9S5zJZz4xPf;
        Tue, 31 Oct 2023 16:55:08 +1100 (AEDT)
Date:   Tue, 31 Oct 2023 16:55:08 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 31
Message-ID: <20231031165508.46cf753f@canb.auug.org.au>
MIME-Version: 1.0
...
Changes since 20231030:

The btrfs tree gained conflicts against Linus' tree.

The exfat tree gained conflicts against Linus' tree.

The xfs tree gained conflicts against Linus' tree.

The vfs-brauner tree gained a semantic conflict against the bcachefs tree.

Non-merge commits (relative to Linus' tree): 14717
 11952 files changed, 791080 insertions(+), 283380 deletions(-)
...
Merging origin/master (14ab6d425e80 Merge tag 'vfs-6.7.ctime' of gitolite.k=
...
Merging sound-asoc-fixes/for-linus (cba459003685 ASoC: codecs: aw88399: Fix=
 -Wuninitialized in aw_dev_set_vcalb())
...
tems)
Merging cifs/for-next (f1830d17e1b7 cifs: update internal module version nu=
mber for cifs.ko)
Merging configfs/for-next (4425c1d9b44d configfs: improve item creation per=
formance)
Merging ecryptfs/next (a3d78fe3e1ae fs: ecryptfs: comment typo fix)
Merging erofs/dev (f5deddce60b5 erofs: tidy up redundant includes)
Merging exfat/dev (a250325a551e exfat: support create zero-size directory)
...
Merging overlayfs/overlayfs-next (763539fe93f5 ovl: add support for appendi=
...
Merging xfs/for-next (22c2699cb068 mm, pmem, xfs: Introduce MF_MEM_PRE_REMO=
VE for unbind)
...
age)
Merging rdma/for-next (d4b2d165714c RDMA/hfi1: Workaround truncation compil=
ation error)
...
Merging amdgpu/drm-next (1b62b14afd1a drm/amdgpu: add unmap latency when gf=
x11 set kiq resources)
...
ith __counted_by)
Merging sound-asoc/for-next (cba459003685 ASoC: codecs: aw88399: Fix -Wunin=
itialized in aw_dev_set_vcalb())
...
Merging device-mapper/for-next (e398f5816627 dm integrity: use crypto_shash=
_digest() in sb_mac())
...
Merging iommufd/for-next (9b35cbadea3e iommufd: Organize the mock domain al=
...

=P/Tj
-----END PGP SIGNATURE-----
