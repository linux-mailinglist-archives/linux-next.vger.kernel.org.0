...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id B027A14E7C4
	for <lists+linux-next@lfdr.de>; Fri, 31 Jan 2020 05:06:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727924AbgAaEGN (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 30 Jan 2020 23:06:13 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:37859 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727448AbgAaEGN (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 30 Jan 2020 23:06:13 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4883YV5DdJz9sPJ;
        Fri, 31 Jan 2020 15:06:06 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1580443566;
        bh=JW59wUctXHV8cP/vv6RiLoj8M1GlfblDfLHT+wECsEc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 31 Jan 2020 15:06:06 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 31
Message-ID: <20200131150606.34caeb7c@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/6WQ0pmtj1NM18X9=d8Ntseu";
...
ling.rst:95: (SEVERE/4) Unexpected section title.
...
Merging origin/master (9f68e3655aae Merge tag 'drm-next-2020-01-30' of git:=
...
Merging sparc/master (d68712ee3506 y2038: sparc: remove use of struct timex)
Merging fscrypt-current/for-stable (ae64f9bd1d36 Linux 4.15-rc2)
Merging net/master (9fbf082f5699 net/core: Do not clear VF index for node/p=
ort GUIDs query)
Merging bpf/master (d3e42bb0a329 bpf: Reuse log from btf_prase_vmlinux() in=
 btf_struct_ops_init())
Merging ipsec/master (72d62c4e422e net: drop_monitor: Use kstrdup)
Merging netfilter/master (5038517119d5 netfilter: ipset: fix suspicious RCU=
 usage in find_set_and_id)
...
Merging ide/master (2fd3c5c61793 ide: make drive->dn read only)
...
Merging clk/clk-next (8544dcdadb91 Merge branch 'clk-freescale' into clk-ne=
xt)
...
Merging powerpc/next (41196224883a powerpc/32s: Fix kasan_early_hash_table(=
...
Merging cifs/for-next (03c02d531540 cifs: fix soft mounts hanging in the re=
connect code)
...
-next)
Merging i2c/i2c/for-next (abb49954dd66 Merge branch 'i2c/for-5.6' into i2c/=
for-next)
...
Merging drm/drm-next (d47c7f062680 Merge branch 'linux-5.6' of git://github=
...
Merging block/for-next (a6aed3aa015d Merge branch 'io_uring-5.6' into for-n=
ext)
...
p for C-SKY)
Merging ftrace/for-next (1e837945a885 tracing: Move tracing selftests to bo=
ttom of menu)
...
rflow
Merging akpm/master (1eee2961b389 drivers/media/platform/sti/delta/delta-ip=
...

=GcVo
-----END PGP SIGNATURE-----
