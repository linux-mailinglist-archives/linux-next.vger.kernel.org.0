...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 92459775277
	for <lists+linux-next@lfdr.de>; Wed,  9 Aug 2023 08:02:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230074AbjHIGCs (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 9 Aug 2023 02:02:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53660 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229493AbjHIGCs (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 9 Aug 2023 02:02:48 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4A8EA1BF1;
        Tue,  8 Aug 2023 23:02:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1691560960;
        bh=/4u0rQErbWmQ5Bfg59gy8qP+6tZkKXJEQre0h+uNo3M=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RLKGR5zbDz4wy5;
        Wed,  9 Aug 2023 16:02:39 +1000 (AEST)
Date:   Wed, 9 Aug 2023 16:02:37 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 9
Message-ID: <20230809160237.5eee5a2b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/zK8_LVcLdSYbbXxRJMJxvwI";
...
--Sig_/zK8_LVcLdSYbbXxRJMJxvwI
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

News: there will be no linux-next release until next Tuesday.

Changes since 20230808:

The mm tree still had its build failure for which I reverted 8 commits.

The drm-misc tree lost its build failure.

The fbdev tree gained a conflict against the drm-misc tree.

The block tree gained a conflict against the nfsd tree.

The tip tree gained conflicts against Linus' tree.

The tty tree gained conflicts against the net-next tree.

The bitmap tree gained a conflict against the net-next tree.

Non-merge commits (relative to Linus' tree): 7569
 9113 files changed, 264039 insertions(+), 113561 deletions(-)
...
Merging origin/master (02aee814d37c Merge tag 'gfs2-v6.4-fixes' of git://gi=
t.kernel.org/pub/scm/linux/kernel/git/gfs2/linux-gfs2)
Merging fixes/fixes (d528014517f2 Revert ".gitignore: ignore *.cover and *.=
mbx")
Merging mm-hotfixes/mm-hotfixes-unstable (534ff82f6040 selftests/mm: FOLL_L=
ONGTERM need to be updated to 0x100)
...
Merging net/main (fa40ea27ede3 MAINTAINERS: update Claudiu Beznea's email a=
ddress)
...
Merging rdma-fixes/for-rc (8e7b295da1ed MAINTAINERS: Remove maintainer of H=
iSilicon RoCE)
Merging sound-current/for-linus (4d84f763f7e1 Merge tag 'asoc-fix-v6.5-rc4'=
 of https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-=
linus)
Merging sound-asoc-fixes/for-linus (2ac1e7bad953 Merge remote-tracking bran=
ch 'asoc/for-6.4' into asoc-linus)
Merging regmap-fixes/for-linus (52a93d39b17d Linux 6.5-rc5)
Merging regulator-fixes/for-linus (dc554ace8dc1 Merge remote-tracking branc=
h 'regulator/for-6.4' into regulator-linus)
Merging spi-fixes/for-linus (bab0d83369d4 Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (f48585c468f5 Merge tag 'thunderbolt-for-v6.5=
...
Merging mmc-fixes/fixes (4b430d4ac997 mmc: block: Fix in_flight[issue_type]=
 value error)
...
Merging risc-v-fixes/fixes (c3bcc65d4d2e riscv: Start of DRAM should at lea=
...
Merging perf-current/perf-tools (487ae3b42d10 perf stat: Don't display zero=
 tool counts)
...
Merging i2c-host-fixes/i2c/andi-for-current (fc9a464f3d9a This patch fixes =
the Tegra DMA config option processing in the i2c-tegra driver.)
Merging drm-misc-fixes/for-linux-next-fixes (1963546390ed accel/ivpu: Add s=
et_pages_array_wc/uc for internal buffers)
Merging mm-stable/mm-stable (5d0c230f1de8 Linux 6.5-rc4)
Merging mm-nonmm-stable/mm-nonmm-stable (5d0c230f1de8 Linux 6.5-rc4)
Merging mm/mm-everything (458623e87caf Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
-next)
Merging ti/ti-next (d0455d3f1d43 Merge branch 'ti-k3-dts-next' into ti-next)
...
ree with READ_PLUS)
Merging nfsd/nfsd-next (9e8eedee0188 SUNRPC: Clean up svc_set_num_threads)
...
'cpumask_setall()')
Merging vfs-brauner/vfs.all (4c53ba653417 Merge branch 'vfs.autofs' into vf=
s.all)
...
Merging i2c-host/i2c/andi-for-next (0c89b3257b04 i2c: mux: ltc4306: Remove =
...
quest)
Merging rdma/for-next (849b1955ade1 RDMA: Remove unnecessary NULL values)
Merging net-next/main (1c2c8c3517b3 Merge branch '100GbE' of git://git.kern=
el.org/pub/scm/linux/kernel/git/tnguy/next-queue)
Merging bpf-next/for-next (e546a119801f bpf, docs: Fix small typo and defin=
e semantics of sign extension)
...
n314/dcn314_fpu.c
Merging drm-misc/for-linux-next (e05f3938c5a7 drm/nouveau/sched: Don't pass=
 user flags to drm_syncobj_find_fence())
Merging amdgpu/drm-next (7748ce5b6958 drm/amdgpu: Report vbios version inst=
ead of PN)
Merging drm-intel/for-linux-next (757b90bbfa14 drm/i915/display: pre-initia=
lize some values in probe_gmdid_display())
...
Merging sound/for-next (3d28c466317b ALSA: hda/tegra: refactor deprecated s=
trncpy)
Merging ieee1394/for-next (06c2afb862f9 Linux 6.5-rc1)
Merging sound-asoc/for-next (010bbfffa663 Merge remote-tracking branch 'aso=
...
Merging block/for-next (7acaef405683 Merge branch 'for-6.6/block' into for-=
next)
...
Flash driver)
Merging mmc/next (41448f7e1dd6 mmc: Merge branch fixes into next)
...
Merging battery/for-next (7e6311f04b41 power: supply: qcom_pmi8998_charger:=
 fix charger status)
Merging regulator/for-next (8a663ffe2931 Merge remote-tracking branch 'regu=
...
Merging selinux/next (2b86e04bce14 selinux: use GFP_KERNEL while reading bi=
nary policy)
...
Merging iommu/next (8d3740021d5d Merge branches 'apple/dart', 'arm/mediatek=
...
Merging spi/for-next (3a838bb5ab0d Merge remote-tracking branch 'spi/for-6.=
6' into spi-next)
Merging tip/master (904831033a6d Merge x86/urgent into tip/master)
...
CONFLICT (content): Merge conflict in arch/x86/lib/retpoline.S
...
ingle-stepping)
Merging kvm-riscv/riscv_kvm_next (630b4cee9c37 RISC-V: KVM: Improve vector =
...
ext)
Merging drivers-x86/for-next (6f8972a02a6c platform/x86: hp-bioscfg: Use km=
emdup() to replace kmalloc + memcpy)
Merging chrome-platform/for-next (703e77134ebf platform/chrome: chromeos_ac=
pi: support official HID GOOG0016)
...
Merging char-misc/char-misc-next (f90bebb36a08 Merge tag 'peci-next-6.6-rc1=
' of git://git.kernel.org/pub/scm/linux/kernel/git/iwi/linux into char-misc=
-next)
...
Merging pinctrl/for-next (dc428c247065 Merge branch 'devel' into for-next)
...
Merging kunit-next/kunit (b67abaad4d25 kunit: Allow kunit test modules to u=
se test filtering)
...
Merging mhi/mhi-next (7b672d703e76 bus: mhi: host: pci_generic: Add support=
 for Quectel RM520N-GL Lenovo variant)
...

=r5lG
-----END PGP SIGNATURE-----
