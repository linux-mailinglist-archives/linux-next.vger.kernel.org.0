Return-Path: <linux-next+bounces-3875-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id D9974979E82
	for <lists+linux-next@lfdr.de>; Mon, 16 Sep 2024 11:30:47 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id D77E91C20CA1
	for <lists+linux-next@lfdr.de>; Mon, 16 Sep 2024 09:30:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 3606813DDD3;
	Mon, 16 Sep 2024 09:30:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="mAnArl3m"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id CE0DA28F7;
	Mon, 16 Sep 2024 09:30:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1726479043; cv=none; b=HTlfDDYfCJtPrqJavDKTwP/eRHNU9VR8JHK+VlN+8+zmop0LRwOASkjcEMZ2wEe6yFHXSyMHPAZrDVCGeerKTWfLj4Hey3EjmWTACRSEujbgx2NmgA3uPY8r/sOlA7ukkNrxrF81m6fDNWhanUiBSgK+8xfPRKBpBEjFRh9oxPc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1726479043; c=relaxed/simple;
	bh=SeeH44MAgFHw7dbIlZOuW3hLGA34EaX8KrWedInLdS4=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=XZ1rU/du4pm08ncDGRKikvK0lNghB01HhALCKWMq10EqqI3gc6hcXQEFRmu79HzZeZt/KWUNFiTg63A70Ld+imxqSg4gaiCajwuLZbyrXYs7yWCWy6QroP/Qr1q0TNQoT0ENXbMDxICUUjLIaqhfz49fNgj+ZJnn5WZ/dLP/ZCQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=mAnArl3m; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1726479035;
	bh=i+fYSaUYJCgtcCTK3I5ZLc/l/qPMXcVzwiM3FVJmeIs=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4X6flv4Jv5z4x7G;
	Mon, 16 Sep 2024 19:30:35 +1000 (AEST)
Date: Mon, 16 Sep 2024 19:30:34 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 16
Message-ID: <20240916193034.053f157f@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//vC0MJhRW2vq+6C21KJOXE8";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_//vC0MJhRW2vq+6C21KJOXE8
...
The vfs tree inherited the bpf-next tree's semantic conflicts against
the vfs-brauner and xfs trees.

I added a supplied patch to fix the net-next tree's build failure.
...
Non-merge commits (relative to Linus' tree): 11026
 10969 files changed, 441780 insertions(+), 197227 deletions(-)
...
Merging origin/master (98f7e32f20d2 Linux 6.11)
...
ph_dns_resolve_name())
Merging cifs/for-next (2716e3ac61b5 cifs: Fix creating of SFU socket specia=
l files)
...
etup times out)
Merging nfsd/nfsd-next (e8821910a862 xdrgen: Prevent reordering of encoder =
...
Merging fixes/fixes (48a539c50bcc page_pool: fix build on powerpc with GCC =
14)
Merging mm-hotfixes/mm-hotfixes-unstable (4dcf20c99340 resource: fix region=
_intersects() vs add_memory_driver_managed())
Merging fs-current (5cb95db31741 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (7052622fccb1 netfilter: nft_socket: Fix a NULL vs IS_ERR(=
) bug in nft_socket_cgroup_subtree_level())
...
Merging sound-current/for-linus (134536c21275 Merge tag 'asoc-fix-v6.11-rc7=
...
driver::remove())
Merging risc-v/for-next (9ea7b92b77df Merge patch series "remove size limit=
 on XIP kernel")
...
Merging fs-next (7a13b00d0e96 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
CONFLICT (content): Merge conflict in fs/bcachefs/fs.c
...
r-next)
Merging pci/next (2374573159ed Merge branch 'pci/tools')
...
Merging rdma/for-next (cc5b9b48d447 RDMA/bnxt_re: Recover the device when F=
W error is detected)
Merging net-next/main (3561373114c8 Merge git://git.kernel.org/pub/scm/linu=
...
ntf fails for hmac)
Merging drm/drm-next (bf05aeac230e Merge tag 'drm-intel-next-fixes-2024-09-=
...
eback on SM6350)
Merging drm-xe/drm-xe-next (cdb389a4c9bc drm/xe/irq: Remove unneeded semico=
lon)
...
Merging sound/for-next (64c0ce555ad2 Merge branch 'for-linus' into for-next)
CONFLICT (modify/delete): sound/soc/cirrus/edb93xx.c deleted in HEAD and mo=
dified in sound/for-next.  Version sound/for-next of sound/soc/cirrus/edb93=
xx.c left in tree.
$ git rm -f sound/soc/cirrus/edb93xx.c
Merging ieee1394/for-next (5e02cdd53478 firewire: core: rename cause flag o=
f tracepoints event)
Merging sound-asoc/for-next (6fcf05c805ff Merge remote-tracking branch 'aso=
c/for-6.12' into asoc-next)
Merging modules/modules-next (b319cea80539 module: Refine kmemleak scanned =
areas)
Merging input/next (c7c878ff3292 Input: tegra-kbc - use of_property_read_va=
riable_u32_array() and of_property_present())
Merging block/for-next (371c468f4db6 Merge branch 'for-6.12/io_uring' into =
for-next)
Merging device-mapper/for-next (c8691cd0fc11 Revert "dm: requeue IO if mapp=
ing table not yet available")
...
Merging watchdog/master (99554ceac09d watchdog: Convert comma to semicolon)
...
helper)
Merging devicetree/for-next (8887042373e2 dt-bindings: cpu: Drop duplicate =
...
12' into spi-next)
Merging tip/master (e26a543cdd84 Merge branch into tip/master: 'x86/timers')
...
Merging xen-tip/linux-next (a8d0b5eb3f9f xen/pci: Avoid -Wflex-array-member=
-not-at-end warning)
...
Merging pwm/pwm/for-next (0fb429cd7383 pwm: stm32: Fix a typo)
...
Merging random/master (5ad9d91baacc selftests: vDSO: check cpu caps before =
running chacha test)
...
Merging landlock/next (b530ec46a0db landlock: Document LANDLOCK_SCOPE_SIGNA=
L)
Merging rust/rust-next (53bd83d95bb0 rust: cfi: add support for CFI_CLANG w=
ith Rust)
...

=nxyL
-----END PGP SIGNATURE-----
