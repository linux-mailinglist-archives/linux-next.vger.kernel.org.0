...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B624F4E26BB
	for <lists+linux-next@lfdr.de>; Mon, 21 Mar 2022 13:39:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239543AbiCUMlJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 21 Mar 2022 08:41:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59166 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234493AbiCUMlI (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 21 Mar 2022 08:41:08 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7EF9A2D1D9;
        Mon, 21 Mar 2022 05:39:40 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KMZ230rn7z4xNq;
        Mon, 21 Mar 2022 23:39:39 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1647866379;
        bh=KksctPLfG740ZMcgm4rwHPrTfUJyzqIw0U3Tm04aZvo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 21 Mar 2022 23:39:38 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 21
Message-ID: <20220321233938.669ac2e1@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/avPQcQFSP2543Yt_usvjNC=";
...
Merging net/master (0caf6d992219 af_netlink: Fix shift out of bounds in gro=
up mask calculation)
...
Merging sound-current/for-linus (efb6402c3c4a ALSA: oss: Fix PCM OSS buffer=
 allocation overflow)
...
Merging drm-fixes/drm-fixes (ca5a5761ac54 Merge tag 'drm-misc-fixes-2022-03=
...
Merging renesas-fixes/fixes (432b52eea3dc ARM: shmobile: defconfig: Restore=
 graphical consoles)
Merging perf-current/perf/urgent (7bd1da15d211 perf parse-events: Ignore ca=
se in topdown.slots check)
...
Merging parisc-hd/for-next (1cfef2c0a97a parisc: Fix invalidate/flush vmap =
routines)
CONFLICT (content): Merge conflict in arch/parisc/lib/memcpy.c
Merging powerpc/next (35de589cb879 powerpc/time: improve decrementer clocke=
vent processing)
...
Merging f2fs/dev (98e92867b997 f2fs: use aggressive GC policy during f2fs_d=
isable_checkpoint())
...
Merging v4l-dvb-next/master (47aa866f248c media: amphion: cleanup media dev=
ice if register it fail)
...
ode connects)
Merging rdma/for-next (3197706abd05 RDMA/rxe: Use standard names for ref co=
unting)
Merging net-next/master (092d992b76ed Merge tag 'mlx5-updates-2022-03-18' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/saeed/linux)
CONFLICT (content): Merge conflict in drivers/hwmon/adt7310.c
Merging bpf-next/for-next (9492450fd287 bpf: Always raise reference in btf_=
get_module_btf)
...
ent match)
Merging bluetooth/master (092d992b76ed Merge tag 'mlx5-updates-2022-03-18' =
...
Merging drm/drm-next (f11de8611fd6 Merge tag 'drm-intel-next-fixes-2022-03-=
...
Merging sound/for-next (8a580a26760c ALSA: oss: Release temporary buffers u=
pon errors)
Merging sound-asoc/for-next (e708dfc5e526 Merge remote-tracking branch 'aso=
...
el)
Merging block/for-next (a66eb2f378b8 Merge branch 'for-5.18/io_uring' into =
for-next)
...
Merging kvm/next (85f013070639 Revert "KVM: x86/mmu: Zap only TDP MMU leafs=
 in kvm_zap_gfn_range()")
...
Merging akpm/master (6938bfa1fbe8 kselftest/vm: override TARGETS from argum=
ents)
...

=Of6N
-----END PGP SIGNATURE-----
