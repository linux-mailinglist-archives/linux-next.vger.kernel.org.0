Return-Path: <linux-next+bounces-3134-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 8219D93CCD9
	for <lists+linux-next@lfdr.de>; Fri, 26 Jul 2024 05:06:44 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B56A6B21A99
	for <lists+linux-next@lfdr.de>; Fri, 26 Jul 2024 03:06:41 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B1D031BC5C;
	Fri, 26 Jul 2024 03:06:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="PHyeRl56"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 88ADE442F;
	Fri, 26 Jul 2024 03:06:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721963197; cv=none; b=kbi99C3eUvsyapf7U/C0l49O0vya7RO2Zx6YaP1IT7fBoI8frapZFVTIv7NmDN8nI2oiHerQJA1KXQBLJ/tb+AXcZwjwOs5Zy+04kBdRynXwhOIBoRyaSPTC1+/7QhLLj6JBsM5XMb62b2W7mILxvvQvk+EvXYUKOD9ulwaTfHU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721963197; c=relaxed/simple;
	bh=7Lh+tAFYtlK6UHERMcLEk901BX/ZJUvE71VApp5DLZY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=GylbXAihvHEc1JyFxuHwrx9rkch28FMXTsJ/Obdhd+b1x0iOrQWAhZVkISq34ooMtYocm2fP02yny+uUljyJfBY5gHczutyEhWymKw7qelgvb+cOhcVyjliHzHclun5gAi+iNNQP3n36Stwr0mgstJBqMttr+zzfQy+gpKDWslI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=PHyeRl56; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1721963186;
	bh=T0B4kuCdRc+Co8CV0+iwHAWxs8nJKCbHQGqpYe9CePY=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WVXhf5LF1z4wcK;
	Fri, 26 Jul 2024 13:06:26 +1000 (AEST)
Date: Fri, 26 Jul 2024 13:06:24 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 26
Message-ID: <20240726130624.2e2275be@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/K=AAnnhx+jkJ7Kvr5kl8J5O";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/K=AAnnhx+jkJ7Kvr5kl8J5O
...
Merging origin/master (1722389b0d86 Merge tag 'net-6.11-rc1' of git://git.k=
...
Merging vfs-brauner-fixes/vfs.fixes (f7c589ccd630 fs: don't allow non-init =
...
erify_area())
Merging fs-current (ce99b1f5c2ae Merge branch 'nfsd-fixes' of git://git.ker=
nel.org/pub/scm/linux/kernel/git/cel/linux)
Merging kbuild-current/fixes (ba6c664081af kbuild: rpm-pkg: Fix C locale se=
tup)
...
Merging net/main (1722389b0d86 Merge tag 'net-6.11-rc1' of git://git.kernel=
.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (36e3b949e359 gve: Fix an edge case for TSO skb validity=
 check)
...
Merging sound-current/for-linus (e8b96a66ae01 Merge tag 'asoc-fix-v6.11-mer=
...
Merging pci-current/for-linus (3a81f0cb9fc9 PCI: pciehp: Retain Power Indic=
...
Merging staging.current/staging-linus (c33ffdb70cc6 Merge tag 'phy-for-6.11=
...
Merging devicetree-fixes/dt/linus (9722c3b66e21 of: remove internal argumen=
ts from of_property_for_each_u32())
...
Merging drm-misc-fixes/for-linux-next-fixes (cb372a505a99 drm/vmwgfx: Fix o=
verlay when using Screen Targets)
...
Merging kbuild/for-next (5ad7ff8738b8 Merge tag 'f2fs-for-6.11-rc1' of git:=
...
into for-next)
Merging thead-dt/thead-dt-for-next (0c3836482481 Linux 6.10)
...
regs)
Merging parisc-hd/for-next (cbade823342c parisc: Add support for CONFIG_SYS=
CTL_ARCH_UNALIGN_NO_WARN)
Merging powerpc/next (9ff0251b2eb5 Merge branch 'topic/ppc-kvm' into next)
Merging soc-fsl/next (fb9c384625dd bus: fsl-mc: fsl-mc-allocator: Drop a wr=
ite-only variable)
Merging risc-v/for-next (32c4df3f3c5a Merge patch series "riscv: Add suppor=
t for xtheadvector")
...
Merging ceph/master (3ceccb14f557 rbd: don't assume rbd_is_lock_owner() for=
 exclusive mappings)
Merging cifs/for-next (66bf82cc583c smb3: add four dynamic tracepoints for =
copy_file_range and reflink)
Merging configfs/for-next (4425c1d9b44d configfs: improve item creation per=
formance)
Merging dlm/next (89b01913dc73 dlm: add rcu_barrier before destroy kmem cac=
he)
Merging erofs/dev (227ed3562a9a erofs: convert comma to semicolon)
...
[fs-next 23d05df056ad] next-20240725/vfs-brauner
Merging vfs/for-next (a38297e3fb01 Linux 6.9)
Merging fs-next (23d05df056ad next-20240725/vfs-brauner)
...
Merging i3c/i3c/next (3564d9eb607d dt-bindings: i3c: add header for generic=
 I3C flags)
...
Merging amdgpu/drm-next (644e49d582fd drm/radeon/evergreen_cs: fix int over=
flow errors in cs track offsets)
...
Merging drm-xe/drm-xe-next (be8f9f4c866f drm/xe/mmio: Use single logic for =
waiting functions)
...
Merging sound/for-next (e8b96a66ae01 Merge tag 'asoc-fix-v6.11-merge-window=
...
Merging block/for-next (e2516401f805 Merge branch 'for-6.12/block' into for=
-next)
...
10' into spi-linus)
Merging tip/master (e0cb1177c5f7 Merge branch into tip/master: 'x86/mm')
...
Merging staging/staging-next (c33ffdb70cc6 Merge tag 'phy-for-6.11' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/phy/linux-phy)
...

=xI2I
-----END PGP SIGNATURE-----
