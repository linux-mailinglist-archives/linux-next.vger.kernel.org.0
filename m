...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 71A966F6F3D
	for <lists+linux-next@lfdr.de>; Thu,  4 May 2023 17:40:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229778AbjEDPks (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 4 May 2023 11:40:48 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53404 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229768AbjEDPkr (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 4 May 2023 11:40:47 -0400
Received: from mail-pg1-x529.google.com (mail-pg1-x529.google.com [IPv6:2607:f8b0:4864:20::529])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7CD92135
        for <linux-next@vger.kernel.org>; Thu,  4 May 2023 08:40:43 -0700 (PDT)
Received: by mail-pg1-x529.google.com with SMTP id 41be03b00d2f7-51f597c975fso544822a12.0
        for <linux-next@vger.kernel.org>; Thu, 04 May 2023 08:40:43 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1683214842; x=1685806842;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=N6GNofBcKY7BqROdb/fLfQivkaYvE0OISY/HqJq1+PM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1683214842; x=1685806842;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=N6GNofBcKY7BqROdb/fLfQivkaYvE0OISY/HqJq1+PM=;
        b=
X-Gm-Message-State: AC+VfDx2avlTSbX2QNiW429qSwG/dbc9MvgiarrB+1eP4eXCCJ8zkwzQ
        BCpXC+vRXKIhStznGHQVdz9WtAWFI7pMKJaU3fGZRw==
X-Google-Smtp-Source: ACHHUZ4mdpb6jy4kyxKruXDwW0ujHhaUuqiWag47w1iMOD3s0TQbX2RcgkpAwBTcbB251jucB1kSsg==
X-Received: by 2002:a05:6a20:9384:b0:f2:e4c1:af7a with SMTP id x4-20020a056a20938400b000f2e4c1af7amr3273686pzh.7.1683214841076;
        Thu, 04 May 2023 08:40:41 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id s9-20020a63e809000000b00476d1385265sm21744430pgh.25.2023.05.04.08.40.39
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 04 May 2023 08:40:39 -0700 (PDT)
Message-ID: <6453d1f7.630a0220.3cf0a.bd40@mx.google.com>
Date:   Thu, 04 May 2023 08:40:39 -0700 (PDT)
...
Subject: next/master build: 210 builds: 34 failed, 176 passed, 38 errors,
 363 warnings (next-20230504)
...
next/master build: 210 builds: 34 failed, 176 passed, 38 errors, 363 warnin=
gs (next-20230504)
...
Tree: next
Branch: master
Git Describe: next-20230504
Git Commit: 145e5cddfe8b4bf607510b2dcf630d95f4db420f
...
mips:
    ...
    ci20_defconfig (gcc-10): 1 error, 2 warnings
...
Errors summary:
    ...
    26   mm/gup.c:2813:7: error: implicit declaration of function =E2=80=98=
...
Warnings summary:
    ...
    256  <stdin>:1567:2: warning: #warning syscall cachestat not implemente=
d [-Wcpp]
...
-Wcpp]
    9    <stdin>:1567:2: warning: syscall cachestat not implemented [-W#war=
nings]
    9    #warning syscall cachestat not implemented
...
ndant UACCESS disable
    1    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x7678: sta=
...
Warnings:
    drivers/phy/mediatek/phy-mtk-hdmi-mt8195.c:216:12: note: initialize the=
 variable 'ret' to silence this warning
    fs/reiserfs/reiserfs.o: warning: objtool: balance_leaf+0x7678: stack st=
...
---------------------------------------------------------------------------=
-----
ci20_defconfig (mips, gcc-10) =E2=80=94 FAIL, 1 error, 2 warnings, 0 sectio=
n mismatches
