...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 4C48B3225F9
	for <lists+linux-next@lfdr.de>; Tue, 23 Feb 2021 07:37:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229996AbhBWGgn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 23 Feb 2021 01:36:43 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:47135 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S229991AbhBWGgf (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 23 Feb 2021 01:36:35 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Dl8SX1ytTz9sTD;
        Tue, 23 Feb 2021 17:35:40 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1614062140;
        bh=KBFQ4UBovwTbKZPT5gJLmtzE/S5TBbxqWbGmp7dDbNU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 23 Feb 2021 17:35:39 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 23
Message-ID: <20210223173539.049dd40d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/5Z8DdH8IGBV918YRB/T7_1G";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/5Z8DdH8IGBV918YRB/T7_1G
...
Merging origin/master (7c70f3a7488d Merge tag 'nfsd-5.12-1' of git://git.ke=
...
invalidated)
Merging arm64-fixes/for-next/fixes (2596b6ae412b kexec: move machine_kexec_=
post_load() to public interface)
...
Merging net/master (3a2eb515d136 octeontx2-af: Fix an off by one in rvu_dbg=
_qsize_write())
Merging bpf/master (53f523f3052a bpf: Clear percpu pointers in bpf_prog_clo=
ne_free())
Merging ipsec/master (3a2eb515d136 octeontx2-af: Fix an off by one in rvu_d=
bg_qsize_write())
...
Merging sound-asoc-fixes/for-linus (ceae5d20f386 Merge remote-tracking bran=
...
Merging tty.current/tty-linus (31caf8b2a847 Merge branch 'linus' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/herbert/crypto-2.6)
Merging usb.current/usb-linus (31caf8b2a847 Merge branch 'linus' of git://g=
it.kernel.org/pub/scm/linux/kernel/git/herbert/crypto-2.6)
...
BLE())
Merging staging.current/staging-linus (31caf8b2a847 Merge branch 'linus' of=
...
ings for Clang)
Merging kbuild/for-next (2f9dbf67b29a kbuild: remove deprecated 'always' an=
d 'hostprogs-y/m')
...
Merging mips/mips-next (13d41b537df7 n64: store dev instance into disk priv=
ate data)
...
b is used)
Merging cifs/for-next (094f4884b3e6 cifs: cleanup a few le16 vs. le32 uses =
in cifsacl.c)
...
Merging exfat/dev (f728760aa923 exfat: improve performance of exfat_free_cl=
...
rs' into for-next)
Merging pci/next (4cb431e82c25 Merge branch 'remotes/lorenzo/pci/misc')
...
ty_{ld,st}_lcd())
Merging amdgpu/drm-next (8d322a7046b8 drm/amdgpu: always reset the asic in =
suspend)
$ git reset --hard HEAD^
Merging next-20210222 version of amdgpu
...
Merging sound/for-next (c4294d7f057d ALSA: hda: intel-dsp-config: add Alder=
 Lake support)
Merging sound-asoc/for-next (ceae5d20f386 Merge remote-tracking branch 'aso=
...
s under load.)
Merging block/for-next (a52724b7fc22 Merge branch 'io_uring-worker.v3' into=
 for-next)
$ git reset --hard HEAD^
Merging next-20210222 version of block
...
ts in kvm_stat)
Merging xen-tip/linux-next (5df230a00991 xen: Replace lkml.org links with l=
ore)
...
Merging usb/usb-next (31caf8b2a847 Merge branch 'linus' of git://git.kernel=
...
Merging tty/tty-next (31caf8b2a847 Merge branch 'linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/herbert/crypto-2.6)
...
USB4 _OSC)
Merging vfio/next (07956b6269d3 vfio/type1: Use follow_pte())
Merging staging/staging-next (31caf8b2a847 Merge branch 'linus' of git://gi=
...
Merging akpm/master (42266a061ceb MIPS: make userspace mapping young by def=
ault)
...

=Jkjp
-----END PGP SIGNATURE-----
