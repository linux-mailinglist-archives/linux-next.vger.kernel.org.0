...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 96517538AC3
	for <lists+linux-next@lfdr.de>; Tue, 31 May 2022 06:55:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243068AbiEaEzJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 31 May 2022 00:55:09 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:40880 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229468AbiEaEzI (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 31 May 2022 00:55:08 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B970992D01;
        Mon, 30 May 2022 21:55:04 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LC0M81f3xz4xXJ;
        Tue, 31 May 2022 14:55:00 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1653972900;
        bh=zfSZ3l0UltFI6tMIu/d6ppxiD9Gh1ANbw+Wa5ttrVU4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 31 May 2022 14:54:58 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 31
Message-ID: <20220531145458.39c00988@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bnLEOOQ+EMv6mlAy1go.vPo";
...
Non-merge commits (relative to Linus' tree): 2494
 2752 files changed, 121539 insertions(+), 40829 deletions(-)
...
Merging origin/master (8ab2afa23bd1 Merge tag 'for-5.19/fbdev-1' of git://g=
...
Merging net/master (90343f573252 Merge branch 'sfc-fixes')
Merging bpf/master (90343f573252 Merge branch 'sfc-fixes')
...
Merging sound-current/for-linus (9bfa7b36343c ALSA: hda/realtek - Fix micro=
phone noise on ASUS TUF B550M-PLUS)
Merging sound-asoc-fixes/for-linus (f552be904ac1 Merge remote-tracking bran=
...
Merging pci-current/for-linus (4194a7401484 PCI/PM: Fix bridge_d3_blacklist=
[] Elo i2 overwrite of Gigabyte X299)
...
build)
Merging loongarch/loongarch-next (b88a778a9ce9 PCI: Add quirk for multifunc=
tion devices of LS7A)
...
Merging cifs/for-next (bf272460d744 Merge tag '5.19-rc-smb3-client-fixes-up=
dated' of git://git.samba.org/sfrench/cifs-2.6)
Merging configfs/for-next (84ec758fb2da configfs: fix a race in configfs_{,=
un}register_subsystem())
Merging ecryptfs/next (682a8e2b41ef Merge tag 'ecryptfs-5.13-rc1-updates' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/tyhicks/ecryptfs)
Merging erofs/dev (6e95d0a01899 erofs: update documentation)
...
Merging sound/for-next (9bfa7b36343c ALSA: hda/realtek - Fix microphone noi=
se on ASUS TUF B550M-PLUS)
Merging sound-asoc/for-next (f552be904ac1 Merge remote-tracking branch 'aso=
...
Merging block/for-next (76e898f02978 Merge branch 'io_uring-5.19' into for-=
next)
...
rc/rrc delivery)
Merging xen-tip/linux-next (0c293fbd7b1b xen/netback: fix incorrect usage o=
f RING_HAS_UNCONSUMED_REQUESTS())
...
ess on myrb_cleanup())
Merging vhost/linux-next (22923567873f vhost-vdpa: return -EFAULT on copy_t=
o_user() failure)
...
2022-05-27' of git://git.kernel.org/pub/scm/linux/kernel/git/akpm/mm)
Merging mm/mm-everything (dee992745dc1 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (6b6bcefc0617 mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=nhJA
-----END PGP SIGNATURE-----
