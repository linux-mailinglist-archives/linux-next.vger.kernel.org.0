...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id CC000398162
	for <lists+linux-next@lfdr.de>; Wed,  2 Jun 2021 08:49:55 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229753AbhFBGvh (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 2 Jun 2021 02:51:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46480 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229737AbhFBGvg (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 2 Jun 2021 02:51:36 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BBA03C061574;
        Tue,  1 Jun 2021 23:49:53 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Fw05B3Mqdz9sRK;
        Wed,  2 Jun 2021 16:49:50 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1622616590;
        bh=uXl/rO6oQ9Jlq+VxApxkNEo+/F2oJfRksLmt9IOXe0s=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 2 Jun 2021 16:49:48 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 2
Message-ID: <20210602164948.286ec70e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/f3XrqqWUbEYxeAvYp7x9rfx";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/f3XrqqWUbEYxeAvYp7x9rfx
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210601:

The akpm-current tree gained a conflict against the block tree.

Non-merge commits (relative to Linus' tree): 5758
 5676 files changed, 264405 insertions(+), 90050 deletions(-)
...
Merging net/master (4ef8d857b5f4 net: dsa: tag_8021q: fix the VLAN IDs used=
 for encoding sub-VLANs)
...
Merging sound-current/for-linus (901be145a46e ALSA: hda: Fix for mute key L=
ED for HP Pavilion 15-CK0xx)
Merging sound-asoc-fixes/for-linus (904f0a1de378 Merge remote-tracking bran=
ch 'asoc/for-5.13' into asoc-linus)
Merging regmap-fixes/for-linus (8124c8a6b353 Linux 5.13-rc4)
Merging regulator-fixes/for-linus (6c746375a2a5 Merge remote-tracking branc=
h 'regulator/for-5.13' into regulator-linus)
Merging spi-fixes/for-linus (05fd8cacd8b5 Merge remote-tracking branch 'spi=
...
Merging scsi-fixes/fixes (696770e72f2b scsi: lpfc: Fix failure to transmit =
ABTS on FC link)
...
Merging arm64/for-next/core (0b2f421eb52e Revert "arm64: smccc: Support SMC=
CC v1.3 SVE register saving hint")
Merging arm-perf/for-next/perf (f9e36b388a32 perf: arm_spe: use DEVICE_ATTR=
_RO macro)
...
stem.nfs4_acl)
Merging nfsd/nfsd-next (84b62b9479de xprtrdma: Fix spelling mistakes)
...
Merging net-next/master (e0ae757c3235 Merge branch 'iwl-next' of git://git.=
kernel.org/pub/scm/linux/kernel/git/tnguy/linux)
...
lated bits)
Merging netfilter-next/master (8a1c08ad19b6 netfilter: fix clang-12 fmt str=
ing warnings)
...
Merging drm-misc/for-linux-next (9450129ed944 drm: Fix misleading documenta=
tion of drm_gem_cma_create())
...
Merging sound/for-next (1bd1b3be8655 ALSA: bebob: perform sequence replay f=
or media clock recovery)
Merging sound-asoc/for-next (741802d679bb Merge remote-tracking branch 'aso=
...
Merging input/next (08729298c4ee Input: resistive-adc-touch - replace OF he=
aders with proper ones)
Merging block/for-next (314e07c78aef Merge branch 'for-5.14/block' into for=
-next)
Merging device-mapper/for-next (2de432b84c21 dm table: Constify static stru=
ct blk_ksm_ll_ops)
...
op)
Merging mfd/for-mfd-next (3723e0e03f7d mfd: si476x-i2c: Fix incorrectly doc=
...
Merging regulator/for-next (5c0a2236c860 Merge remote-tracking branch 'regu=
...
rations)
Merging devicetree/for-next (37522393d6d7 dt-bindings: net: Convert MDIO mu=
x bindings to DT schema)
Merging mailbox/mailbox-for-next (2335f556b3af dt-bindings: mailbox: qcom-i=
pcc: Add compatible for SC7280)
Merging spi/for-next (4a1260aef565 Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
...
r-next)
Merging scsi/for-next (1a8d8498cb2d Merge branch 'misc' into for-next)
...
Merging akpm/master (7f23e04fc10d kdump: use vmlinux_build_id to simplify)
...

=5JVj
-----END PGP SIGNATURE-----
