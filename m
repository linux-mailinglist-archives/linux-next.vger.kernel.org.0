...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 136281514E8
	for <lists+linux-next@lfdr.de>; Tue,  4 Feb 2020 05:19:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726992AbgBDETc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 3 Feb 2020 23:19:32 -0500
Received: from ozlabs.org ([203.11.71.1]:46681 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726984AbgBDETb (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 3 Feb 2020 23:19:31 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48BWg04YdCz9shl;
        Tue,  4 Feb 2020 15:19:24 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1580789964;
        bh=1UXAxqbFDvFxnbakaGA5BNw7eUId8/ALt7SwvX5CFvs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 4 Feb 2020 15:19:21 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 4
Message-ID: <20200204151921.41faf275@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/M+MVpEpzdP3EqSUE0LzZiJ8";
...
Merging origin/master (d4e9056daedc initramfs: do not show compression mode=
...
Merging net/master (83d0585f91da Merge branch 'Fix-reconnection-latency-cau=
sed-by-FIN-ACK-handling-race')
...
inus)
Merging pci-current/for-linus (d4e9056daedc initramfs: do not show compress=
...
Merging drivers-x86-fixes/fixes (46d6b7becb1d Merge git://git.kernel.org/pu=
b/scm/linux/kernel/git/davem/sparc)
...
Merging clk/clk-next (fc6a15c85308 dt/bindings: clk: fsl,plldig: Drop 'bind=
ings' from schema id)
...
/raid6)
Merging xtensa/xtensa-for-next (be75021843ba Merge branch 'xtensa-5.6-fixes=
...
Merging amdgpu/drm-next (6833dfca0f38 drm/amdgpu: fetch default VDDC curve =
voltages (v2))
...
reporting mode)
Merging block/for-next (3f8c409e3666 Merge branch 'io_uring-5.6' into for-n=
ext)
...
event class)
Merging drivers-x86/for-next (46d6b7becb1d Merge git://git.kernel.org/pub/s=
cm/linux/kernel/git/davem/sparc)
...
rflow
Merging akpm/master (4467f3d3981c drivers/media/platform/sti/delta/delta-ip=
...

=5pf4
-----END PGP SIGNATURE-----
