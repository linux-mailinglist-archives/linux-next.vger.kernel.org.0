...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3F41C9FF0C
	for <lists+linux-next@lfdr.de>; Wed, 28 Aug 2019 12:02:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726328AbfH1KCz (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 28 Aug 2019 06:02:55 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:48299 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726326AbfH1KCz (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 28 Aug 2019 06:02:55 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46JLrz3xbMz9sBp;
        Wed, 28 Aug 2019 20:02:43 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1566986563;
        bh=vPD83Gan6Z4Dpn2p9YkLqjLXcYZ//XdsKDUiWxMAnVA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 28 Aug 2019 20:02:41 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 28
Message-ID: <20190828200241.5a182d44@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/z=Vrg+pFkxNYtChi0Yw1VGj";
...
Merging origin/master (9e8312f5e160 Merge tag 'nfs-for-5.3-3' of git://git.=
...
m/fixes)
Merging arm64-fixes/for-next/fixes (d4a8061a7c5f KVM: arm/arm64: vgic: Fix =
potential deadlock when ap_list is long)
...
Merging net/master (9e8312f5e160 Merge tag 'nfs-for-5.3-3' of git://git.lin=
ux-nfs.org/projects/trondmy/linux-nfs)
...
Merging sound-asoc-fixes/for-linus (9920f3a1e141 Merge branch 'asoc-5.3' in=
to asoc-linus)
Merging regmap-fixes/for-linus (0161b8716465 Merge branch 'regmap-5.3' into=
 regmap-linus)
Merging regulator-fixes/for-linus (4dcaf5a81e36 Merge branch 'regulator-5.3=
...
Merging kspp-gustavo/for-next/kspp (080de4921ee3 nds32: Mark expected switc=
h fall-throughs)
...
ng right shift)
Merging arm64/for-next/core (daceaf5415cb Merge branches 'for-next/52-bit-k=
...
Merging qcom/for-next (e7f4902c8077 Merge branches 'arm64-for-5.4', 'arm64-=
...
Merging net-next/master (68aaf4459556 Merge git://git.kernel.org/pub/scm/li=
...
om xfrm_type)
Merging mlx5-next/mlx5-next (bb487d29ce00 net/mlx5: fix a -Wstringop-trunca=
tion warning)
...
v.c
Merging drm-intel/for-linux-next (45e9c829ebea drm/i915/tgl/perf: use the s=
ame oa ctx_id format as icl)
Merging drm-tegra/drm/tegra/for-next (2a6fc3cb5cb6 drm/tegra: Fix gpiod_get=
_from_of_node() regression)
Merging drm-misc/for-linux-next (66c2dee4ae10 drm/vc4/vc4_hdmi: fill in con=
nector info)
...
Merging sound-asoc/for-next (0c667bcc603a Merge branch 'asoc-5.4' into asoc=
-next)
...
vices)
Merging block/for-next (53fc55c817c3 Merge branch 'for-5.4/block' into for-=
next)
...
Merging mmc/next (04f718389ab1 mmc: sdhci-of-arasan: Add Support for Intel =
LGM eMMC)
...
Merging regulator/for-next (218baccb76f9 Merge branch 'regulator-5.4' into =
regulator-next)
...
Merging devicetree/for-next (a45dddad3e2b dt-bindings: irq: Convert Allwinn=
er NMI Controller to a schema)
...
rm_get_irq())
Merging leds/for-next (5add28d2f357 leds: syscon: Use resource managed vari=
ant of device register)
Merging ipmi/for-next (383035211c79 ipmi: move message error checking to av=
oid deadlock)
Merging driver-core/driver-core-next (bfb3943bed67 Revert "driver core: Add=
 support for linking devices during device addition")
...
Merging staging/staging-next (c10bf3921e74 staging: greybus: add missing in=
cludes)
...
pport)
Applying: drm/virtio: module_param_named() requires linux/moduleparam.h
...
rflow
Merging akpm/master (947b52dc79a4 drivers/media/platform/sti/delta/delta-ip=
...

=vYwO
-----END PGP SIGNATURE-----
