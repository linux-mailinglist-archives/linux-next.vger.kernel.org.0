...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5EA3A442BE5
	for <lists+linux-next@lfdr.de>; Tue,  2 Nov 2021 11:54:55 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229931AbhKBK52 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 2 Nov 2021 06:57:28 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49174 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229850AbhKBK52 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 2 Nov 2021 06:57:28 -0400
Received: from mail-pl1-x62a.google.com (mail-pl1-x62a.google.com [IPv6:2607:f8b0:4864:20::62a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B2575C061714
        for <linux-next@vger.kernel.org>; Tue,  2 Nov 2021 03:54:53 -0700 (PDT)
Received: by mail-pl1-x62a.google.com with SMTP id f8so15439890plo.12
        for <linux-next@vger.kernel.org>; Tue, 02 Nov 2021 03:54:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=zlHE399qPh4qxiZsOjCwqP37wWE8wZvgpt84ZuPAFjU=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=zlHE399qPh4qxiZsOjCwqP37wWE8wZvgpt84ZuPAFjU=;
        b=
X-Gm-Message-State: AOAM531Mu/B4hgpzLESEih8xU/FZtalnfijfpB4eBUaPFu1cZkwXQdU2
        dPK1JBT4+H1wN93KUg3dRLS1asK6B9Fv84bo
X-Google-Smtp-Source: ABdhPJz7x05pqZWnYvXlqHbbxgiWxguj0IEe7FsMqIymVZ5skZ8rWAQndr2+UsyXujJmilm7uG9EZQ==
X-Received: by 2002:a17:90b:3717:: with SMTP id mg23mr5759841pjb.107.1635850491082;
        Tue, 02 Nov 2021 03:54:51 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id s30sm20913682pfg.17.2021.11.02.03.54.50
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 02 Nov 2021 03:54:50 -0700 (PDT)
Message-ID: <618118fa.1c69fb81.151e1.8cf9@mx.google.com>
Date:   Tue, 02 Nov 2021 03:54:50 -0700 (PDT)
...
Subject: next/master build: 229 builds: 24 failed, 205 passed, 486 errors,
 223 warnings (next-20211102)
...
next/master build: 229 builds: 24 failed, 205 passed, 486 errors, 223 warni=
ngs (next-20211102)
...
arm:
    allmodconfig (clang-10): 38 errors, 18 warnings
...
=3D0x'
    1    45:2: error: instruction requires: armv6t2

Warnings summary:

    142  <stdin>:1559:2: warning: #warning syscall futex_waitv not implemen=
ted [-Wcpp]
    37   clang: warning: argument unused during compilation: '-march=3Darmv=
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm, clang-10) =E2=80=94 FAIL, 38 errors, 18 warnings, 0 sect=
ion mismatches
...
Errors:
 ...
 of the following would fix this:
    arch/arm/mm/cache-v7.S:42:2: error: instruction requires: data-barriers
    45:2: error: instruction requires: armv6t2
    arch/arm/mm/cache-v7.S:56:4: error: instruction requires: armv6t2
    arch/arm/mm/cache-v7.S:68:4: error: invalid instruction
    arch/arm/mm/cache-v7.S:69:2: error: instruction requires: data-barriers
    arch/arm/mm/cache-v7.S:97:2: error: instruction requires: data-barriers
