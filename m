...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 98E75371098
	for <lists+linux-next@lfdr.de>; Mon,  3 May 2021 04:59:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232463AbhECDAc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 2 May 2021 23:00:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:39756 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230368AbhECDAb (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 2 May 2021 23:00:31 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C18E5C06174A;
        Sun,  2 May 2021 19:59:38 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FYSPL5f1Zz9rx6;
        Mon,  3 May 2021 12:59:34 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1620010774;
        bh=A8Q8EtTiGOhr8XZZSU+LeJe3WEfZWzyFczi7InfoEas=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 3 May 2021 12:59:32 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 3
Message-ID: <20210503125932.739f9dcd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/XQQEqEM3O17wE5GRDl5oeVw";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/XQQEqEM3O17wE5GRDl5oeVw
...
Non-merge commits (relative to Linus' tree): 1658
 1837 files changed, 89732 insertions(+), 15552 deletions(-)
...
Merging origin/master (9ccce092fc64 Merge tag 'for-linus-5.13-ofs-1' of git=
...
Merging net/master (f18c51b6513c net: stmmac: Remove duplicate declaration =
of stmmac_priv)
Merging bpf/master (f80f88f0e2f2 selftests/bpf: Fix the snprintf test)
...
vulnerability)
Merging driver-core.current/driver-core-linus (17ae69aba89d Merge tag 'land=
lock_v34' of git://git.kernel.org/pub/scm/linux/kernel/git/jmorris/linux-se=
curity)
...
Merging devicetree-fixes/dt/linus (ae95928f274c dt-bindings: Remove unused =
Sigma Designs Tango bindings)
...
Merging s390/for-next (bae1cd368c45 s390/entry: add support for syscall sta=
ck randomization)
...
27e2da653adb6')
Merging cifs/for-next (c40b8fc0c6fe cifs: fix regression when mounting shar=
es with prefix paths)
...
Merging pci/next (191f214ad36a Merge branch 'pci/tegra')
...
Merging block/for-next (b1ef997bec4d Merge branch 'io_uring-5.13' into for-=
next)
...
Merging rcu/rcu/next (ad1f357157aa Merge branch 'clocksource.2021.04.30b' i=
nto HEAD)
$ git reset --hard HEAD^
Merging next-20210430 version of rcu
...
Merging driver-core/driver-core-next (17ae69aba89d Merge tag 'landlock_v34'=
...
Merging akpm/master (61e9958f34e8 memfd_secret: use unsigned int rather tha=
...

=gB33
-----END PGP SIGNATURE-----
