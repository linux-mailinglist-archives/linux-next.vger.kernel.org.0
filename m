...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A78594E8D69
	for <lists+linux-next@lfdr.de>; Mon, 28 Mar 2022 06:54:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S236258AbiC1E4S (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 28 Mar 2022 00:56:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54724 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S236178AbiC1E4Q (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 28 Mar 2022 00:56:16 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A6101E0B9;
        Sun, 27 Mar 2022 21:54:31 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KRgN23blfz4xLS;
        Mon, 28 Mar 2022 15:54:26 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1648443266;
        bh=vn9HE2TvFQeNSKN+5YehnwxdJ3jJswpjlNFcJf8vb8I=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 28 Mar 2022 15:54:25 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 28
Message-ID: <20220328155425.67e9b00e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/IwB0ZCv3xWHP5l2emR+8VUU";
...
Non-merge commits (relative to Linus' tree): 2657
 2579 files changed, 126287 insertions(+), 42985 deletions(-)
...
Merging origin/master (50d602d81f35 Merge tag 'mailbox-v5.18' of git://git.=
linaro.org/landing-teams/working/fujitsu/integration)
Merging fixes/fixes (d06c942efea4 Merge tag 'for_linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/mst/vhost)
Applying: powerpc: restore removed #endif
...
Merging net/master (bcb74e132a76 net/sched: act_ct: fix ref leak when switc=
hing zones)
...
Merging sound-current/for-linus (0112f822f8a6 ALSA: cs4236: fix an incorrec=
t NULL check on list iterator)
...
Merging parisc-hd/for-next (01734b642740 parisc: Find a new timesync master=
...
equences)
Merging s390/for-next (559e162a09cd selftests: drivers/s390x: Add uvdevice =
tests)
...
Merging cifs/for-next (7e5c8c02911b smb3: cleanup and clarify status of tre=
e connections)
...
ct_io)
Merging gfs2/for-next (9e349f23802b gfs2: Make sure FITRIM minlen is rounde=
...
Merging jc_docs/docs-next (8d6451b9a51b Documentation: Fix duplicate statem=
ent about raw_spinlock_t type)
...
Merging amdgpu/drm-next (8f8cc3fb4350 drm/amdgpu: remove table_freed param =
from the VM code)
...
Merging sound/for-next (0112f822f8a6 ALSA: cs4236: fix an incorrect NULL ch=
eck on list iterator)
...
Merging block/for-next (95281b7d8392 Merge branch 'for-5.18/io_uring' into =
for-next)
...
Merging kspp-gustavo/for-next/kspp (d39f6b9b7ee9 drm/amd/display: Fix Wstri=
...
Merging akpm/master (9af1ea298cd0 kselftest/vm: override TARGETS from argum=
ents)
...

=5S35
-----END PGP SIGNATURE-----
