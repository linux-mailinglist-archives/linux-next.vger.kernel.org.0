Return-Path: <linux-next+bounces-2298-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id E21828C4CC1
	for <lists+linux-next@lfdr.de>; Tue, 14 May 2024 09:22:56 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 929F9282387
	for <lists+linux-next@lfdr.de>; Tue, 14 May 2024 07:22:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5365A179B7;
	Tue, 14 May 2024 07:22:52 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="hpWhrz65"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 96E0B17577;
	Tue, 14 May 2024 07:22:47 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1715671372; cv=none; b=lsosAeAL96R9R9y9d1cg9jPBn8InV5uiiyYMuw9eD1shOrcc6WmHTPNLGqIJoeNPGn4/g5hvDbn88BqUyGO6jifzsAHVZIsoMjULL84nM9V+K0xsgtrGdkfUlPHTQgZU0uNAOpd2hHGf2c0UBTtf7FauXuX9IELrS45Q/XXVWjI=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1715671372; c=relaxed/simple;
	bh=soLlVHeI4aXl/Hd0NSHMSZbG7YCHKRpScS+1TQGHwu0=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=YQRrwqUMfZXFRgEX/pyK3+UApxBXMBtAr6b/uJmG9kj6R5QY8/5DkeX2RcZ9f/vqb5TR63JKG2bkYS03W05gVIzZ7YoFqOY6ZAz05jqE5ZsaNtV6xoADswROXBLHOb5v7ZhXsW3YVcF1I55R7mTnRkj2Ng2Xj3DZ57zM9ZmWzvQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=hpWhrz65; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1715671364;
	bh=qv7YuYK/BluYzIyIS4FMRBfDBp/stLioxnX0EDQKmWo=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Vdnr42P5nz4wcg;
	Tue, 14 May 2024 17:22:44 +1000 (AEST)
Date: Tue, 14 May 2024 17:22:43 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 14
Message-ID: <20240514172243.0fcd43a8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_//t3kZ.W013p4dE_VWtWAkq4";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_//t3kZ.W013p4dE_VWtWAkq4
...
Merging origin/master (8f5b5f78113e Merge tag 'rust-6.10' of https://github=
.com/Rust-for-Linux/linux)
...
Merging net/main (ecf848eb934b net: usb: ax88179_178a: fix link status when=
...
Merging loongarch/loongarch-next (e58ccb4888e0 LoongArch: Update Loongson-3=
 default config file)
...
-next)
Merging i2c/i2c/for-next (e1734eb57f03 power: supply: sbs-manager: Remove c=
lass argument from i2c_mux_add_adapter())
...
lation errors)
Merging net-next/main (5c1672705a1a net: revert partially applied PHY topol=
ogy series)
...
dgpu_discovery)
Merging drm-intel/for-linux-next (8a5fc5f0031e drm/xe/display: remove unuse=
d xe->sb_lock)
...
Merging block/for-next (b9efc18bb96c Merge branch 'net-accept-more' into fo=
r-next)
...
Merging tpmdd/next (40120763d00b certs: Add ECDSA signature verification se=
lf-test)
...

=zlBZ
-----END PGP SIGNATURE-----
