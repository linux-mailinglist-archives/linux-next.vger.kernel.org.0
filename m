Return-Path: <linux-next+bounces-2316-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 45C778C60DF
	for <lists+linux-next@lfdr.de>; Wed, 15 May 2024 08:41:34 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 49761B21050
	for <lists+linux-next@lfdr.de>; Wed, 15 May 2024 06:41:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 8523E3D3BF;
	Wed, 15 May 2024 06:41:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="iT53JRx5"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E2AE43C488;
	Wed, 15 May 2024 06:41:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1715755287; cv=none; b=b3ue3eij3bMaGVTcB8i5xW6Ajw47rnvuDr4Hda15xDXv4sDaOoOClEu3IgyTonhjrGL6dnoSwaKA8C2Dv12RmUp+H04gLHLEXTKt0irdpqddRB+VoGVES28gRQC2z9XpgfoLjYm7kRmlMC9iH1rd31eyTgkD5klt1LBxA1deHPo=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1715755287; c=relaxed/simple;
	bh=tFIP14S9YhcAGsMIrHFiV/tM3uIsNxTma+GcWi2Exvo=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=CDFEhLn9OkT1y165dU6RDpfhsVkOGqqIBAL6loXBjM45u1ihSJh6SnHRiw1BUrm9JWX/CLOEOYWJD2FDyPYIaA72HhwX8TbMd8ooGpBsINgLi/FrY1KmOL2Ek+pr+sChmqTWbXWMWBV3JefrUR1WPoj7t2CS6I8t4AKqeGDWwi0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=iT53JRx5; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1715755281;
	bh=ZBWQMHUke8opUxuBs942wkcHamz/7Jh33W2A4FFwAtw=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4VfNss1scxz4x1N;
	Wed, 15 May 2024 16:41:21 +1000 (AEST)
Date: Wed, 15 May 2024 16:41:20 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 15
Message-ID: <20240515164120.45f212bd@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/28briHWd_93y4ia//VpGYdY";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/28briHWd_93y4ia//VpGYdY
...
Merging origin/master (1b10b390d945 Merge tag 'efi-next-for-v6.10' of git:/=
...
Merging net/main (aea27a92a41d net: micrel: Fix receiving the timestamp in =
the frame for lan8841)
Merging bpf/master (aea27a92a41d net: micrel: Fix receiving the timestamp i=
n the frame for lan8841)
...
Merging sound-asoc-fixes/for-linus (c277ee8f90ab Merge remote-tracking bran=
...
ness.h
Merging kbuild/for-next (bfb57ef0544a rapidio: remove choice for enumeratio=
n)
...
for Ceph)
Merging cifs/for-next (edfc6481faf8 smb3: fix perf regression with cached w=
rites with netfs conversion)
...
lation errors)
Merging net-next/main (654de42f3fc6 Merge git://git.kernel.org/pub/scm/linu=
...
Merging netfilter-next/main (5c1672705a1a net: revert partially applied PHY=
 topology series)
Merging ipvs-next/main (fa23e0d4b756 netfilter: nf_tables: allow clone call=
backs to sleep)
Merging bluetooth/master (6a486c1361ea Bluetooth: btintel_pcie: Refactor an=
d code cleanup)
...
dgpu_discovery)
Merging drm-intel/for-linux-next (ce698dcf10d5 Documentation/i915: remove k=
ernel-doc for DMC wakelocks)
...
Merging drm-xe/drm-xe-next (b31cfb47b27a drm/xe/xe_guc_submit: Declare rese=
t if banned or killed or wedged)
...
Merging sound-asoc/for-next (c277ee8f90ab Merge remote-tracking branch 'aso=
...
Merging block/for-next (ba94750e4f90 Merge branch 'block-6.10' into for-nex=
t)
...
Merging workqueues/for-next (24283babc61f Merge branch 'for-6.9-fixes' into=
 for-next)
Merging drivers-x86/for-next (d41393f6c605 platform/x86: Add new MeeGoPad A=
...
Merging turbostat/next (dedcf3a8e704 tools/power turbostat: version 2024.05=
.10)
...

=qz3I
-----END PGP SIGNATURE-----
