...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 0EC4A60974D
	for <lists+linux-next@lfdr.de>; Mon, 24 Oct 2022 01:35:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229556AbiJWXfn (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 23 Oct 2022 19:35:43 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44500 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229619AbiJWXfm (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 23 Oct 2022 19:35:42 -0400
Received: from mail-pj1-x102c.google.com (mail-pj1-x102c.google.com [IPv6:2607:f8b0:4864:20::102c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6D99A57205
        for <linux-next@vger.kernel.org>; Sun, 23 Oct 2022 16:35:39 -0700 (PDT)
Received: by mail-pj1-x102c.google.com with SMTP id ez6so6906904pjb.1
        for <linux-next@vger.kernel.org>; Sun, 23 Oct 2022 16:35:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=S7HitIb18LqQVHRLtzFgS7dllmXRn4B2RRoRaVKMgAA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=S7HitIb18LqQVHRLtzFgS7dllmXRn4B2RRoRaVKMgAA=;
        b=
X-Gm-Message-State: ACrzQf1UaTFQr1QrwFyRToWQ2/GfcB+8DoX1OcEy8dXVGHQY21eWteyy
        Ve37gKOp8tu3MbiHzhfTTFa6vBrdfuwgke3R
X-Google-Smtp-Source: AMsMyM6MrZB4l15KMiBeXw/nSjT8APYJyJMIo/IcYWZFTjPmO2VdrGTk/YIYhnzVw3KESgGUZsnr+A==
X-Received: by 2002:a17:902:dacf:b0:186:1269:9292 with SMTP id q15-20020a170902dacf00b0018612699292mr32096216plx.129.1666568138075;
        Sun, 23 Oct 2022 16:35:38 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id e5-20020a17090301c500b00179c9219195sm4295010plh.16.2022.10.23.16.35.37
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 23 Oct 2022 16:35:37 -0700 (PDT)
Message-ID: <6355cfc9.170a0220.d754c.7531@mx.google.com>
Date:   Sun, 23 Oct 2022 16:35:37 -0700 (PDT)
...
Subject: next/pending-fixes build: 207 builds: 4 failed, 203 passed, 10 errors,
 64 warnings (v6.1-rc1-732-g1ba9b7ebae841)
...
next/pending-fixes build: 207 builds: 4 failed, 203 passed, 10 errors, 64 w=
arnings (v6.1-rc1-732-g1ba9b7ebae841)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v6.1-rc1-732-g1ba9b7ebae841/

Tree: next
Branch: pending-fixes
Git Describe: v6.1-rc1-732-g1ba9b7ebae841
Git Commit: 1ba9b7ebae841ac3c9df3a14d8ebaca27695acc8
...
arm64:
    ...
    defconfig+CONFIG_CPU_BIG_ENDIAN=3Dy (gcc-10): 2 warnings
    ...
    defconfig+crypto (gcc-10): 2 warnings
    defconfig+debug (gcc-10): 2 warnings
    defconfig+ima (gcc-10): 2 warnings
...
=80=98-mhard-float=E2=80=99
    2    drivers/hwtracing/coresight/coresight-cti-core.c:93:17: error: unu=
sed variable =E2=80=98dev=E2=80=99 [-Werror=3Dunused-variable]
    2    drivers/hwtracing/coresight/coresight-cti-core.c:154:17: error: un=
used variable =E2=80=98dev=E2=80=99 [-Werror=3Dunused-variable]
...
Warnings summary:
    ...
    11   drivers/hwtracing/coresight/coresight-cti-core.c:93:17: warning: u=
nused variable =E2=80=98dev=E2=80=99 [-Wunused-variable]
    11   drivers/hwtracing/coresight/coresight-cti-core.c:154:17: warning: =
unused variable =E2=80=98dev=E2=80=99 [-Wunused-variable]
...
Errors:
    drivers/hwtracing/coresight/coresight-cti-core.c:93:17: error: unused v=
ariable =E2=80=98dev=E2=80=99 [-Werror=3Dunused-variable]
    drivers/hwtracing/coresight/coresight-cti-core.c:154:17: error: unused =
variable =E2=80=98dev=E2=80=99 [-Werror=3Dunused-variable]
...
Warnings:
    drivers/hwtracing/coresight/coresight-cti-core.c:93:17: warning: unused=
 variable =E2=80=98dev=E2=80=99 [-Wunused-variable]
    drivers/hwtracing/coresight/coresight-cti-core.c:154:17: warning: unuse=
d variable =E2=80=98dev=E2=80=99 [-Wunused-variable]
...
---------------------------------------------------------------------------=
-----
defconfig+crypto (arm64, gcc-10) =E2=80=94 PASS, 0 errors, 2 warnings, 0 se=
ction mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+ima (arm64, gcc-10) =E2=80=94 PASS, 0 errors, 2 warnings, 0 secti=
on mismatches
