...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 2EE8B41E802
	for <lists+linux-next@lfdr.de>; Fri,  1 Oct 2021 09:10:03 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230523AbhJAHLp (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 1 Oct 2021 03:11:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:36544 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229829AbhJAHLo (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 1 Oct 2021 03:11:44 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D0EDDC061775;
        Fri,  1 Oct 2021 00:10:00 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HLLpb2ncnz4xbQ;
        Fri,  1 Oct 2021 17:09:59 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1633072199;
        bh=U/AkVi1Jdm34sn4ysjTFS6NH0tRIPa4CUn0Z7BMe09Q=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 1 Oct 2021 17:09:58 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 1
Message-ID: <20211001170958.3acc7bb5@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/B=X.DTUsKxgsvGEVKfahW4=";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/B=X.DTUsKxgsvGEVKfahW4=
...
Non-merge commits (relative to Linus' tree): 4751
 4540 files changed, 237208 insertions(+), 95014 deletions(-)
...
Merging origin/master (4de593fb965f Merge tag 'net-5.15-rc4' of git://git.k=
...
Merging net/master (4de593fb965f Merge tag 'net-5.15-rc4' of git://git.kern=
el.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (4729445b47ef libbpf: Fix segfault in light skeleton for=
 objects without BTF)
...
Merging sound-current/for-linus (1f8763c59c4e ALSA: seq: Fix a potential UA=
F by wrong private_free call order)
Merging sound-asoc-fixes/for-linus (002494ca389b Merge remote-tracking bran=
...
Merging kvm-fixes/master (7b0035eaa7da KVM: selftests: Ensure all migration=
s are performed when test is affined)
...
Merging perf/perf/core (2b775152bbe8 perf tests vmlinux-kallsyms: Ignore hi=
dden symbols)
...
t)
Merging clk-imx/for-next (47f56bcf97dc clk: imx: imx6ul: Fix csi clk gate r=
egister)
...
Merging parisc-hd/for-next (d5fd1c46a3ce parisc/unwind: call callback with =
toplevel address)
...
Merging ksmbd/ksmbd-for-next (4227f811cdeb ksmbd: fix transform header vali=
dation)
...
Merging cel/for-next (1d625050c7c2 nfsd: fix error handling of register_per=
net_subsys() in init_nfsd())
...
Merging v4l-dvb/master (4114978dcd24 media: ir_toy: prevent device from han=
ging during transmit)
CONFLICT (content): Merge conflict in drivers/media/rc/ir_toy.c
Merging v4l-dvb-next/master (4114978dcd24 media: ir_toy: prevent device fro=
m hanging during transmit)
...
Merging net-next/master (129291980f49 net: sched: Use struct_size() helper =
in kvmalloc())
Merging bpf-next/for-next (6bbc7103738f bpf, xdp, docs: Correct some Englis=
...
Merging bluetooth/master (4d51fb04c3c4 Bluetooth: btrtl: Add support for MS=
FT extension to rtl8821c devices)
...
Merging drm-misc/for-linux-next (241ffeb028e4 drm/dp: Add Additional DP2 He=
aders)
Merging amdgpu/drm-next (098e4a2e199b drm/radeon: Add HD-audio component no=
tifier support (v2))
Merging drm-intel/for-linux-next (7f6002e58025 drm/i915/display: Enable PSR=
2 selective fetch by default)
...
Merging sound/for-next (813a17cab9b7 ALSA: usb-audio: Avoid killing in-flig=
ht URBs during draining)
Merging sound-asoc/for-next (5bffa57e573f Merge remote-tracking branch 'aso=
...
Merging block/for-next (6ac425ab0890 Merge branch 'for-5.16/io_uring' into =
for-next)
...
Merging battery/for-next (5ce39985c604 power: supply: core: Move psy_has_pr=
operty() to fix build)
Merging regulator/for-next (13c25d475c29 Merge remote-tracking branch 'regu=
...
iescent states)
Merging kvm/next (35b330bba6a7 KVM: x86: only allocate gfn_track when neces=
sary)
...
ed_cdevs list)
Merging ipmi/for-next (3f4f170b0ec4 ipmi: Fix a typo)
$ git reset --hard HEAD^
Merging next-20210930 version of ipmi
...
Merging iio/togreg (a5ae0cfd53aa iio: adis16460: make use of the new unmask=
ed_drdy flag)
...
Merging fpga/for-next (8001f21fcd03 MAINTAINERS: Add Hao and Yilun as maint=
ainers)
...
Merging akpm/master (af06aff2a000 mm: unexport {,un}lock_page_memcg)
...

=e1sd
-----END PGP SIGNATURE-----
