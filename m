Return-Path: <linux-next+bounces-3495-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4D612963CBE
	for <lists+linux-next@lfdr.de>; Thu, 29 Aug 2024 09:25:16 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id EE1AF281D25
	for <lists+linux-next@lfdr.de>; Thu, 29 Aug 2024 07:25:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E189716C86D;
	Thu, 29 Aug 2024 07:25:10 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="bFufesQR"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9AAE9146D7E;
	Thu, 29 Aug 2024 07:25:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1724916310; cv=none; b=IABqVdK2c7ycHKbB09qhSSyQA17droh4s+pfN3miC6h5vznfxuippFtH0MywCG7knU8+MbSYzqUM8MC0h2XBlEbfwETDyW7+nlcTTEyNJIQYzb33OiVD7KCHPR51X6dVnMx5VjBw3AZv2mJT3svPwhkXVWPZ/pbCBuj0qTA3HGc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1724916310; c=relaxed/simple;
	bh=VBf8c5FH6ADMY7jdIooDHi/xAlyNTrcfo7BNjfwnuDM=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=nMb32uB206LAP0ZtaP0A+d9YSFMB/8JW+lluoTVhK9iPoqAHVJOTb5+cU3AnBZiD2cWcHbX29WPJy9p+EpGaf7H9blBa+ZQfgjzyQWOgrx8gEpFsgRHPVBe1U5HKzRCDfJibipfIhfwxeG8mtYp2CbpcQw5873A4TwbKtHkcl70=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=bFufesQR; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1724916302;
	bh=Uey9S919pWp+BRXCgUR3+v62fdMJZ3ojAizt9ap3FDs=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WvXqL0qchz4x21;
	Thu, 29 Aug 2024 17:25:02 +1000 (AEST)
Date: Thu, 29 Aug 2024 17:25:01 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 29
Message-ID: <20240829172501.2f19c58f@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/.hz0TCwOmLSSNZvQd4wk_A2";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/.hz0TCwOmLSSNZvQd4wk_A2
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240828:
...
Non-merge commits (relative to Linus' tree): 6856
 7200 files changed, 265180 insertions(+), 139591 deletions(-)
...
Merging origin/master (928f79a188aa Merge tag 'loongarch-fixes-6.11-2' of g=
...
Merging fs-current (6af5dfc5dfa3 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (3a0504d54b3b sctp: fix association labeling in the duplic=
ate COOKIE-ECHO case)
...
ill policy)
Merging netfilter/main (70c261d50095 netfilter: nf_tables_ipv6: consider ne=
twork offset in netdev/egress validation)
...
Merging sound-asoc-fixes/for-linus (e0be875c5bf0 ASoc: SOF: topology: Clear=
 SOF link platform name upon unload)
...
Merging rockchip/for-next (a1bccba154c5 Merge branch 'v6.12-clk/next' into =
for-next)
...
6.11' into next)
Merging tegra/for-next (99aac2e58234 Merge branch for-6.12/arm64/dt into fo=
r-next)
...
Merging clk/clk-next (1ebfd0bf0625 Merge branch 'clk-cleanup' into clk-next)
...
Merging fs-next (e7034c173d91 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging hwmon-staging/hwmon-next (98845e775390 hwmon: (oxp-sensors) Add mis=
sing breaks to fix -Wimplicit-fallthrough with clang)
...
Merging drm-misc/for-linux-next (b290af0500f0 drm/tegra: hub: Use fn parame=
ter directly to fix Coccinelle warning)
...
Merging drm-xe/drm-xe-next (87d8ecf01544 drm/xe: replace #include <drm/xe_d=
rm.h> with <uapi/drm/xe_drm.h>)
...
Merging sound-asoc/for-next (ab1441e8ac95 Merge remote-tracking branch 'aso=
...
Merging block/for-next (dd596ed342be Merge branch 'for-6.12/block' into for=
-next)
...
Merging security/next (9f4906be89ad Automated merge of 'dev' into 'next')
...
Merging spi/for-next (486ccdbc42e6 Merge remote-tracking branch 'spi/for-6.=
12' into spi-next)
...
Merging dmaengine/next (4bb59323450d dmaengine: ti: k3-udma: Remove unused =
declarations)
...
Merging random/master (ec309dd12628 random: vDSO: minimize and simplify hea=
der includes)
...

=jC0E
-----END PGP SIGNATURE-----
