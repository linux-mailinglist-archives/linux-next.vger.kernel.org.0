...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 83D5C20ACC5
	for <lists+linux-next@lfdr.de>; Fri, 26 Jun 2020 09:06:57 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728105AbgFZHG4 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 26 Jun 2020 03:06:56 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:32791 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728101AbgFZHGz (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 26 Jun 2020 03:06:55 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49tSc96nFXz9sT6;
        Fri, 26 Jun 2020 17:06:49 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1593155210;
        bh=5XokQSNwl5FXKPHTyrw5h9lXHj4obaVazAS6MUlcBq4=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 26 Jun 2020 17:06:49 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 26
Message-ID: <20200626170649.0b3da2a9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/sh6I+I4omFX_4QKY1g71S1E";
...
The rcu tree gained a conflict against the tip tree and lost its build
failure.

The usb tree gained a conflict against the usb.current tree.

The akpm-current tree gained a build failure for which I reverted a
commit.

Non-merge commits (relative to Linus' tree): 3465
 3814 files changed, 271848 insertions(+), 63184 deletions(-)
...
Merging origin/master (52366a107bf0 Merge tag 'fsnotify_for_v5.8-rc3' of gi=
...
Merging powerpc-fixes/fixes (c1ed1754f271 powerpc/kvm/book3s64: Fix kernel =
crash with nested kvm & DEBUG_VIRTUAL)
...
Merging net/master (f4926d513b4c Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/pablo/nf)
Merging bpf/master (7a64135f3229 libbpf: Adjust SEC short cut for expected =
attach type BPF_XDP_DEVMAP)
Merging ipsec/master (0275875530f6 Merge branch 'Two-phylink-pause-fixes')
Merging netfilter/master (619ae8e0697a selftests: netfilter: add test case =
for conntrack helper assignment)
...
er size)
Merging mac80211/master (5af7fef39d79 mac80211: skip mpath lookup also for =
control port tx)
...
ked ahead of hp_mic)
Merging sound-asoc-fixes/for-linus (94f491396945 Merge remote-tracking bran=
...
Merging regulator-fixes/for-linus (69541f6520c0 Merge remote-tracking branc=
...
Merging usb.current/usb-linus (ea0efd687b01 usb: renesas_usbhs: getting res=
idue from callback_result)
...
ins to 1)
Merging hwmon-fixes/hwmon (a899847a6012 hwmon: (acpi_power_meter) Fix poten=
...
Merging btrfs-fixes/next-fixes (d23a6f9bf694 Merge branch 'misc-5.8' into n=
ext-fixes)
...
Merging scsi-fixes/fixes (afe89f115e84 scsi: mptscsih: Fix read sense data =
size)
Merging drm-fixes/drm-fixes (5b83c254571b Merge tag 'amd-drm-fixes-5.8-2020=
-06-24' of git://people.freedesktop.org/~agd5f/linux into drm-fixes)
...
Merging risc-v-fixes/fixes (e93b327dbf3d riscv: Add extern declarations for=
 vDSO time-related functions)
...
t_copy())
Merging cifs/for-next (bf1028a41eaf cifs: misc: Use array_size() in if-stat=
...
e release)
Merging hwmon-staging/hwmon-next (2c1bba1a36e5 hwmon (pmbus/max20730): add =
max20710 support)
...
in imxfb_probe())
Merging pm/linux-next (dcc4e8ba3539 Merge branches 'acpi-tables' and 'acpi-=
pad' into linux-next)
...
es)
Merging net-next/master (a5440cbecd99 net: dsa/ar9331: convert to mac_link_=
up())
CONFLICT (content): Merge conflict in net/xfrm/xfrm_device.c
Merging bpf-next/master (16d37ee3d2b1 tools, bpftool: Define attach_type_na=
me array only once)
...
ifi/iwlwifi-next)
Merging bluetooth/master (5ea7c81a4f34 Bluetooth: btusb: Refactor of firmwa=
re download flow for Intel conrollers)
...
Merging amdgpu/drm-next (7aebbbd59a2e drm/amdgpu: add some additional DCE6 =
registers)
...
s.c
Merging drm-intel/for-linux-next (3625a1f5bf6b drm/i915: Fix DP_TRAIN_MAX_{=
PRE_EMPHASIS,SWING}_REACHED handling)
Merging drm-tegra/drm/tegra/for-next (fce3a51d9b31 drm/tegra: Add zpos prop=
erty for cursor planes)
Merging drm-misc/for-linux-next (41752663b410 drm/debug: Expose connector V=
RR monitor range via debugfs)
...
Merging sound-asoc/for-next (cdde2941f857 Merge remote-tracking branch 'aso=
...
y)
Merging block/for-next (fc546eb3c94e Merge branch 'for-5.9/io_uring' into f=
or-next)
...
Merging regulator/for-next (57de4dfa26f4 Merge remote-tracking branch 'regu=
...
9' into spi-next)
Merging tip/auto-latest (489eb109cb9d Merge branch 'WIP.core/headers')
...
Merging ftrace/for-next (20dc3847cc2f tracing/boottime: Fix kprobe multiple=
 events)
Merging rcu/rcu/next (3b9946ebaf2b rcu: Fixup noinstr warnings)
CONFLICT (content): Merge conflict in include/linux/compiler.h
Applying: merge fix for "rcu: Fixup noinstr warnings"
...
Merging usb/usb-next (fb5746826a0c usbip: tools: fix module name in man pag=
e)
...
patible)
Merging tty/tty-next (5de30b286e71 tty/vt: check allocation size in con_set=
_unimap())
...
oup)
Merging scsi/for-next (5f8c63eb95a1 Merge branch 'fixes' into for-next)
Merging scsi-mkp/for-next (b2bc2200e89b scsi: ufs: ufs-exynos: Fix return v=
alue check in exynos_ufs_init())
...
Merging akpm-current/current (649a1683fc0d kcov: unconditionally add -fno-s=
tack-protector to compiler options)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (fb6d2d6da58d sh: add missing EXPORT_SYMBOL() for __del=
ay)
Applying: Revert "mm/slab: add naive detection of double free"
...

=s/sl
-----END PGP SIGNATURE-----
