...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5CA43265A3E
	for <lists+linux-next@lfdr.de>; Fri, 11 Sep 2020 09:16:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725613AbgIKHQA (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 11 Sep 2020 03:16:00 -0400
Received: from ozlabs.org ([203.11.71.1]:33877 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725562AbgIKHP4 (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 11 Sep 2020 03:15:56 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Bnn9220NMz9sTK;
        Fri, 11 Sep 2020 17:15:50 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1599808550;
        bh=j9xNAm/BXKLrhTTMvkXufT4bGFnRywjbiFpHcV+Twf8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 11 Sep 2020 17:15:47 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 11
Message-ID: <20200911171547.2689d95d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/STRUCp8Ty/lv+6MhyjwVAPv";
...
Merging origin/master (581cb3a26baf Merge tag 'f2fs-for-5.9-rc5' of git://g=
...
Merging net/master (553d87b658fe netlink: fix doc about nlmsg_parse/nla_val=
idate)
...
ml-rebuild)
Merging aspeed/for-next (4e589cb46a1b ARM: config: aspeed_g5: Enable IBM OP=
 Panel driver)
...
Merging omap/for-next (34766a7d60e9 Merge branch 'omap-for-v5.10/defconfig'=
 into for-next)
Merging qcom/for-next (75894849c81a Merge branches 'arm64-for-5.10' and 'ar=
...
Merging renesas/next (8bf393104609 Merge branches 'renesas-arm-dt-for-v5.10=
', 'renesas-arm-soc-for-v5.10', 'renesas-drivers-for-v5.10' and 'renesas-dt=
-bindings-for-v5.10' into renesas-next)
...
nto for-next)
Merging samsung-krzk/for-next (d8eab2b0dcaf Merge branch 'next/defconfig' i=
nto for-next)
...
Merging ext4/dev (27bc446e2def ext4: limit the length of per-inode prealloc=
 list)
Merging f2fs/dev (3a4b7e4a3aca f2fs: change virtual mapping way for compres=
sion pages)
...
ible-array member)
Merging nfs/linux-next (7fe10096c150 Merge branch 'linus' of git://git.kern=
el.org/pub/scm/linux/kernel/git/herbert/crypto-2.6)
...
Merging jc_docs/docs-next (5ff4aa70bf34 docs: submitting-patches: use :doc:=
 for references)
Merging v4l-dvb/master (93c16fabdb74 media: ov8856: Add support for 3264x24=
48 mode)
...
asklet_setup() API)
Merging net-next/master (b55353e2cc14 Merge branch 'nfc-s3fwrn5-Few-cleanup=
s')
CONFLICT (content): Merge conflict in drivers/net/dsa/microchip/ksz9477.c
Merging bpf-next/master (d66423fbe11e bpf: Plug hole in struct bpf_sk_looku=
p_kern)
...
Merging drm-misc/for-linux-next (8c3c818c23a5 drm/panfrost: Ensure GPU quir=
ks are always initialised)
Merging drm-msm/msm-next (fdf38426cda6 drm/msm: Convert shrinker msgs to tr=
acepoints)
...
Merging block/for-next (20a67a7dd783 Merge branch 'for-5.10/io_uring' into =
for-next)
...
Merging akpm/master (43ab669c7198 fix for "mm/madvise: introduce process_ma=
...

=rux4
-----END PGP SIGNATURE-----
