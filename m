...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 554D010D002
	for <lists+linux-next@lfdr.de>; Fri, 29 Nov 2019 00:57:07 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726609AbfK1X5G (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 28 Nov 2019 18:57:06 -0500
Received: from mail-wr1-f66.google.com ([209.85.221.66]:39532 "EHLO
        mail-wr1-f66.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726582AbfK1X5G (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 28 Nov 2019 18:57:06 -0500
Received: by mail-wr1-f66.google.com with SMTP id y11so29823852wrt.6
        for <linux-next@vger.kernel.org>; Thu, 28 Nov 2019 15:57:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=XDT+DP7S4c8we2geFRsksFopgS72O/bdfjH/7rZ2+Xo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=XDT+DP7S4c8we2geFRsksFopgS72O/bdfjH/7rZ2+Xo=;
        b=
X-Gm-Message-State: APjAAAWtNekLxTW2LwHKClOEdL7IlgCTAeL+3nV7Q+6LmfjNDUlf/RiQ
        lTT0L4Zxw/afHXqGktzs0xNhz67CPbxDjw==
X-Google-Smtp-Source: APXvYqxA/jnDldPq3XpDjLtuY0zQa0FGg+fliHy2l7fi2Xb/i2unZm61e6DITs7UgEdeK/T43iZWvQ==
X-Received: by 2002:adf:f850:: with SMTP id d16mr42365750wrq.161.1574985418447;
        Thu, 28 Nov 2019 15:56:58 -0800 (PST)
Received: from [148.251.42.114] ([2a01:4f8:201:9271::2])
        by smtp.gmail.com with ESMTPSA id g8sm11424717wmk.23.2019.11.28.15.56.57
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 28 Nov 2019 15:56:57 -0800 (PST)
Message-ID: <5de05ec9.1c69fb81.f8746.b5ff@mx.google.com>
Date:   Thu, 28 Nov 2019 15:56:57 -0800 (PST)
...
Subject: next/pending-fixes build: 217 builds: 4 failed, 213 passed, 9 errors,
 132 warnings (v5.4-8981-g4bd8408b6dc3)
...
next/pending-fixes build: 217 builds: 4 failed, 213 passed, 9 errors, 132 w=
arnings (v5.4-8981-g4bd8408b6dc3)
...
m integer of different size [-Wint-to-pointer-cast]
    4    WARNING: modpost: missing MODULE_LICENSE() in drivers/pinctrl/pinc=
trl-equilibrium.o
...
integer of different size [-Wpointer-to-int-cast]
    1    /tmp/ccBnkJNE.s:18191: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccBnkJNE.s:18119: Warning: using r15 results in unpredictable=
 behaviour
...
rence from the function free_memmap() to the function .meminit.text:membloc=
k_free()
    1    WARNING: vmlinux.o(.text.unlikely+0x3924): Section mismatch in ref=
erence from the function pmax_setup_memory_region() to the function .init.t=
ext:add_memory_region()
    1    WARNING: vmlinux.o(.text.unlikely+0x3614): Section mismatch in ref=
erence from the function pmax_setup_memory_region() to the function .init.t=
ext:add_memory_region()
...
types lacks a cast
    /tmp/ccBnkJNE.s:18119: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccBnkJNE.s:18191: Warning: using r15 results in unpredictable beha=
viour
    fs/btrfs/tree-checker.c:230:43: warning: format '%lu' expects argument =
of type 'long unsigned int', but argument 5 has type 'unsigned int' [-Wform=
at=3D]
...
Section mismatches:
    WARNING: vmlinux.o(.text.unlikely+0x3924): Section mismatch in referenc=
...
Section mismatches:
    WARNING: vmlinux.o(.text.unlikely+0x3614): Section mismatch in referenc=
e from the function pmax_setup_memory_region() to the function .init.text:a=
dd_memory_region()
