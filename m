Return-Path: <linux-next+bounces-1050-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 80A6984C511
	for <lists+linux-next@lfdr.de>; Wed,  7 Feb 2024 07:40:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 35B832819F2
	for <lists+linux-next@lfdr.de>; Wed,  7 Feb 2024 06:40:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C539C1CD2C;
	Wed,  7 Feb 2024 06:40:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="imyBNQl1"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 4A69B1CD19;
	Wed,  7 Feb 2024 06:40:15 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707288021; cv=none; b=tjmYQLPM+8VeEkF9YrOYSzaFpPhGRmvvIksby2EHjfk7RFrfC4qLSom+qBaUbg9/gkcM5sg5KjsgB/geEivARIow8WJ6ziziPP4WGEoJMDuwCyvdJ/68kaJWz688GhtqJePHOmdJyK9L+WWjEJIjRjvJCvL6C/GH81/mTZRbEyg=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707288021; c=relaxed/simple;
	bh=emm6mlEtJf4wwFZvXwVDDdm6mWlWU5DzII8LhO0dKac=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=o0Zvb+oHDuVXcPyLvQi8MtRp8C+5UrFP0ERW8+B/fyHW7DrkpeB/FlVtDwtQSEMnbHxwtoXPfjK0w/4tRjt+RXPcsc0CAUuYyyLbaIDCyR39FM5jCdjg85+fu/8qYg6EnEMREM8+chWU+3r67gW9/uqzLK3XfJhcNz3vRCpjwKQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=imyBNQl1; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1707288014;
	bh=HkCOEOvk6C7nKf2J2lfI9Z2bIWrYsQ3zqC65y9Ka5io=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4TV9Tp2Zbjz4wck;
	Wed,  7 Feb 2024 17:40:14 +1100 (AEDT)
Date: Wed, 7 Feb 2024 17:40:13 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 7
Message-ID: <20240207174013.05871ed2@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/R0700rYvfSgr0_pMCMEnSUu";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/R0700rYvfSgr0_pMCMEnSUu
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240206:
...
The bcachefs tree gained a build failure so I used the version from
next-20240206.
...
Non-merge commits (relative to Linus' tree): 4310
 4634 files changed, 165235 insertions(+), 95461 deletions(-)
...
Merging origin/master (99bd3cb0d12e Merge tag 'bcachefs-2024-02-05' of http=
s://evilpiepirate.org/git/bcachefs)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (2fc82eb0f980 mm/swap_state: updat=
e zswap LRU's protection range with the folio locked)
...
Merging net/main (1ce2654d87e2 net: stmmac: xgmac: fix a typo of register n=
ame in DPP safety handling)
...
Merging sound-asoc-fixes/for-linus (610010737f74 ASoC: amd: yc: Add DMI qui=
rk for Lenovo Ideapad Pro 5 16ARP8)
...
Merging phy/fixes (54be6c6c5ae8 Linux 6.8-rc3)
...
Merging dmaengine-fixes/fixes (54be6c6c5ae8 Linux 6.8-rc3)
...
Merging mm/mm-everything (fd01e57c7956 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Merging kbuild/for-next (a8fdabe1e15d kbuild: deb-pkg: call more misc debhe=
lper commands)
Merging clang-format/clang-format (5a205c6a9f79 clang-format: Update with v=
6.7-rc4's `for_each` macro list)
Merging perf/perf-tools-next (e024fa6a5566 perf/pmu-events/powerpc: Update =
json mapfile with Power11 PVR)
$ git reset --hard HEAD^
Merging next-20240206 version of perf
...
to for-next)
Merging samsung-krzk/for-next (b57058d218cc Merge branch 'next/dt' into for=
-next)
...
ist on errors)
Merging cifs/for-next (018edd04d0aa cifs: Use more fields from netfs_io_sub=
request)
...
Merging nfsd/nfsd-next (deb2beb8fa2c MAINTAINERS: add Alex Aring as Reviewe=
r for file locking code)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (23b006406f6b Merge branch 'vfs.super' into vfs=
.all)
...
Merging pmdomain/next (c8634d885a77 pmdomain: imx8mp-blk-ctrl: imx8mp_blk: =
...
Merging net-next/main (60b4dfcda647 Merge branch 'nfc-hci-save-a-few-bytes-=
of-memory-when-registering-a-nfc_llc-engine')
...
Merging drm-misc/for-linux-next (1f36d634670d drm/bridge: imx: add bridge w=
rapper driver for i.MX8MP DWC HDMI)
CONFLICT (content): Merge conflict in drivers/gpu/drm/bridge/samsung-dsim.c
Applying: drm/ttm: initialise places
$ git reset --hard HEAD^
Merging next-20240205 version of drm-misc
...
Merging drm-intel/for-linux-next (074146f45783 drm/i915: Annotate more of t=
he BIOS fb takeover failure paths)
...
Merging sound-asoc/for-next (2d742f069c1c Merge remote-tracking branch 'aso=
...
Merging block/for-next (69c95a16fe48 Merge branch 'for-6.9/block' into for-=
next)
CONFLICT (content): Merge conflict in block/blk.h
Merging device-mapper/for-next (076f0dbc1ae2 dm vdo: move encoding constant=
s to encodings.h)
$ git reset --hard HEAD^
Merging next-20240206 version of device-mapper
...
upport for mt8188)
Merging spi/for-next (80fa6a033ac8 Merge remote-tracking branch 'spi/for-6.=
9' into spi-next)
Merging tip/master (6d461dc4863f Merge branch into tip/master: 'x86/sev')
...
Merging tty/tty-next (52b56990d214 Revert "tty: serial: amba-pl011: Remove =
QDF2xxx workarounds")
...
Merging seccomp/for-next/seccomp (b068d070cb99 selftests/seccomp: Pin bench=
mark to single CPU)
...
uild for PREEMPT_RT)
Applying: fix up for "mm/swap: fix race condition in direct swapin path"
...

=cqko
-----END PGP SIGNATURE-----
