...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 30F6B28FC3E
	for <lists+linux-next@lfdr.de>; Fri, 16 Oct 2020 03:31:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2388969AbgJPBbp (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 15 Oct 2020 21:31:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47020 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S2388966AbgJPBbo (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 15 Oct 2020 21:31:44 -0400
Received: from mail-pj1-x102c.google.com (mail-pj1-x102c.google.com [IPv6:2607:f8b0:4864:20::102c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id AC95DC061755
        for <linux-next@vger.kernel.org>; Thu, 15 Oct 2020 18:31:44 -0700 (PDT)
Received: by mail-pj1-x102c.google.com with SMTP id gm14so464831pjb.2
        for <linux-next@vger.kernel.org>; Thu, 15 Oct 2020 18:31:44 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=xgvs4y8f5lVXZFUbjdULgomRATI8MMAqXjUnX9yOg8Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xgvs4y8f5lVXZFUbjdULgomRATI8MMAqXjUnX9yOg8Y=;
        b=
X-Gm-Message-State: AOAM531LCsjcuPrboP4P26P2F0lXVQzYOPeUe/JpsQD/QPlD3lIB+EaN
        rFOQR7vPp4OhGaB7Em3x3SoIHeIUQthyvQ==
X-Google-Smtp-Source: ABdhPJzQVBM6Unt38oGe9YVydlxM2c0FK6pFC8vzFRT1/335ueKFRkdPgn+1+oiAUxDyrbcFw8lTnw==
X-Received: by 2002:a17:902:6545:b029:d3:d1fc:ff28 with SMTP id d5-20020a1709026545b02900d3d1fcff28mr1546035pln.34.1602811901856;
        Thu, 15 Oct 2020 18:31:41 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id f5sm560120pgi.86.2020.10.15.18.31.40
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 15 Oct 2020 18:31:40 -0700 (PDT)
Message-ID: <5f88f7fc.1c69fb81.9d774.1a3b@mx.google.com>
Date:   Thu, 15 Oct 2020 18:31:40 -0700 (PDT)
...
Subject: next/pending-fixes build: 202 builds: 2 failed, 200 passed, 964 errors,
 291 warnings (v5.9-10224-g4054eebdfdd6)
...
next/pending-fixes build: 202 builds: 2 failed, 200 passed, 964 errors, 291=
 warnings (v5.9-10224-g4054eebdfdd6)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.9-10224-g4054eebdfdd6/

Tree: next
Branch: pending-fixes
Git Describe: v5.9-10224-g4054eebdfdd6
Git Commit: 4054eebdfdd6659984837d69af89cd829bea94fa
...
arc:
    haps_hs_smp_defconfig+kselftest (gcc-8): 166 errors, 24 warnings
...
gs
    ...
    multi_v7_defconfig+kselftest (gcc-8): 74 errors, 54 warnings
...
i386:
    ...
    i386_defconfig+kselftest (gcc-8): 76 errors, 44 warnings
...
thread=E2=80=99
    12   /bin/sh: 3: llc: not found
    12   /bin/sh: 1: llc: not found
    12   /bin/sh: 1: clang: not found
    9    ionmap_test.c:14:10: fatal error: drm/drm.h: No such file or direc=
tory
    8    /usr/include/stdlib.h:25:10: fatal error: bits/libc-header-start.h=
: No such file or directory
    6    param_test.c:1245:6: error: =E2=80=98MEMBARRIER_CMD_FLAG_CPU=E2=80=
=99 undeclared (first use in this function); did you mean =E2=80=98MEMBARRI=
ER_CMD_SHARED=E2=80=99?
    6    param_test.c:1244:22: error: =E2=80=98MEMBARRIER_CMD_PRIVATE_EXPED=
ITED_RSEQ=E2=80=99 undeclared (first use in this function); did you mean =
=E2=80=98MEMBARRIER_CMD_PRIVATE_EXPEDITED=E2=80=99?
    6    hmm-tests.c:24:10: fatal error: hugetlbfs.h: No such file or direc=
tory
    6    cgroup_util.c:346:33: error: invalid application of =E2=80=98sizeo=
f=E2=80=99 to incomplete type =E2=80=98struct clone_args=E2=80=99
    6    cgroup_util.c:343:4: error: =E2=80=98struct clone_args=E2=80=99 ha=
s no member named =E2=80=98cgroup=E2=80=99
    6    cgroup_util.c:342:4: error: =E2=80=98struct clone_args=E2=80=99 ha=
s no member named =E2=80=98exit_signal=E2=80=99
    6    cgroup_util.c:341:4: error: =E2=80=98struct clone_args=E2=80=99 ha=
s no member named =E2=80=98flags=E2=80=99
    6    cgroup_util.c:340:9: error: variable =E2=80=98args=E2=80=99 has in=
itializer but incomplete type
    6    cgroup_util.c:340:20: error: storage size of =E2=80=98args=E2=80=
=99 isn=E2=80=99t known
    6    binderfs_test.c:22:10: fatal error: linux/android/binderfs.h: No s=
...
: No such file or directory
    3    udmabuf.c:13:10: fatal error: linux/udmabuf.h: No such file or dir=
ectory
    3    tls.c:1284:27: error: =E2=80=98TLS_CIPHER_AES_GCM_256=E2=80=99 und=
eclared (first use in this function); did you mean =E2=80=98TLS_CIPHER_AES_=
GCM_128=E2=80=99?
    3    tls.c:1273:39: error: storage size of =E2=80=98tls12=E2=80=99 isn=
=E2=80=99t known
    3    tls.c:1230:27: error: =E2=80=98TLS_CIPHER_AES_GCM_256=E2=80=99 und=
eclared (first use in this function); did you mean =E2=80=98TLS_CIPHER_AES_=
GCM_128=E2=80=99?
    3    tls.c:1221:39: error: storage size of =E2=80=98tls12=E2=80=99 isn=
=E2=80=99t known
    3    tls.c:116:17: error: =E2=80=98TLS_1_3_VERSION=E2=80=99 undeclared =
here (not in a function); did you mean =E2=80=98TLS_1_2_VERSION=E2=80=99?
    3    reuseport_bpf_numa.c:24:10: fatal error: numa.h: No such file or d=
irectory
    3    proc-fsconfig-hidepid.c:20:10: fatal error: linux/mount.h: No such=
 file or directory
    3    pm_nl_ctl.c:19:10: fatal error: linux/mptcp.h: No such file or dir=
ectory
    3    pidfd_wait.c:97:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98exit_signal=E2=80=99
    3    pidfd_wait.c:96:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98flags=E2=80=99
    3    pidfd_wait.c:95:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98pidfd=E2=80=99
    3    pidfd_wait.c:94:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98parent_tid=E2=80=99
    3    pidfd_wait.c:93:9: error: variable =E2=80=98args=E2=80=99 has init=
ializer but incomplete type
    3    pidfd_wait.c:93:20: error: storage size of =E2=80=98args=E2=80=99 =
isn=E2=80=99t known
    3    pidfd_wait.c:48:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98exit_signal=E2=80=99
    3    pidfd_wait.c:47:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98flags=E2=80=99
    3    pidfd_wait.c:46:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98pidfd=E2=80=99
    3    pidfd_wait.c:45:4: error: =E2=80=98struct clone_args=E2=80=99 has =
no member named =E2=80=98parent_tid=E2=80=99
    3    pidfd_wait.c:44:9: error: variable =E2=80=98args=E2=80=99 has init=
ializer but incomplete type
    3    pidfd_wait.c:44:20: error: storage size of =E2=80=98args=E2=80=99 =
isn=E2=80=99t known
    3    pidfd_wait.c:31:43: error: invalid application of =E2=80=98sizeof=
=E2=80=99 to incomplete type =E2=80=98struct clone_args=E2=80=99
    3    pidfd_wait.c:149:4: error: =E2=80=98struct clone_args=E2=80=99 has=
 no member named =E2=80=98exit_signal=E2=80=99
    3    pidfd_wait.c:148:4: error: =E2=80=98struct clone_args=E2=80=99 has=
 no member named =E2=80=98flags=E2=80=99
    3    pidfd_wait.c:147:4: error: =E2=80=98struct clone_args=E2=80=99 has=
 no member named =E2=80=98parent_tid=E2=80=99
    3    pidfd_wait.c:146:9: error: variable =E2=80=98args=E2=80=99 has ini=
tializer but incomplete type
    3    pidfd_wait.c:146:20: error: storage size of =E2=80=98args=E2=80=99=
 isn=E2=80=99t known
    3    pidfd_setns_test.c:84:34: error: invalid application of =E2=80=98s=
izeof=E2=80=99 to incomplete type =E2=80=98struct clone_args=E2=80=99
    3    nf-queue.c:13:10: fatal error: libmnl/libmnl.h: No such file or di=
rectory
...
ry
    ...
    3    fuse_mnt.c:17:10: fatal error: fuse.h: No such file or directory
    3    close_range_test.c:55:10: error: expected expression before =E2=80=
=98return=E2=80=99
    3    close_range_test.c:47:11: error: expected expression before =E2=80=
=98return=E2=80=99
    3    close_range_test.c:200:11: error: expected expression before =E2=
=80=98return=E2=80=99
    3    close_range_test.c:191:4: error: =E2=80=98struct clone_args=E2=80=
=99 has no member named =E2=80=98exit_signal=E2=80=99
    3    close_range_test.c:190:4: error: =E2=80=98struct clone_args=E2=80=
=99 has no member named =E2=80=98flags=E2=80=99
    3    close_range_test.c:189:9: error: variable =E2=80=98args=E2=80=99 h=
as initializer but incomplete type
    3    close_range_test.c:189:20: error: storage size of =E2=80=98args=E2=
=80=99 isn=E2=80=99t known
    3    close_range_test.c:111:11: error: expected expression before =E2=
=80=98return=E2=80=99
    3    close_range_test.c:102:4: error: =E2=80=98struct clone_args=E2=80=
=99 has no member named =E2=80=98exit_signal=E2=80=99
    3    close_range_test.c:101:4: error: =E2=80=98struct clone_args=E2=80=
=99 has no member named =E2=80=98flags=E2=80=99
    3    close_range_test.c:100:9: error: variable =E2=80=98args=E2=80=99 h=
as initializer but incomplete type
    3    close_range_test.c:100:20: error: storage size of =E2=80=98args=E2=
=80=99 isn=E2=80=99t known
    3    clone3_cap_checkpoint_restore.c:148:9: error: expected expression =
...
Warnings summary:
    ...
    15   pidfd_wait.c:22:25: warning: excess elements in struct initializer
...
.sh
    ...
    6    clone3/clone3_selftests.h:19:27: warning: excess elements in struc=
t initializer
    6    cgroup_util.c:343:13: warning: excess elements in struct initializ=
er
    6    cgroup_util.c:342:18: warning: excess elements in struct initializ=
er
    6    cgroup_util.c:340:20: warning: unused variable =E2=80=98args=E2=80=
=99 [-Wunused-variable]
...
its #address-cells (1) differs from / (2)
    3    tls.c:1273:39: warning: unused variable =E2=80=98tls12=E2=80=99 [-=
Wunused-variable]
    3    tls.c:1221:39: warning: unused variable =E2=80=98tls12=E2=80=99 [-=
Wunused-variable]
    3    proc-uptime-002.c:18: warning: "_GNU_SOURCE" redefined
    3    proc-self-syscall.c:16: warning: "_GNU_SOURCE" redefined
    3    proc-loadavg-001.c:17: warning: "_GNU_SOURCE" redefined
    3    pidfd_wait.c:97:18: warning: excess elements in struct initializer
    3    pidfd_wait.c:48:18: warning: excess elements in struct initializer
    3    pidfd_wait.c:29:32: warning: =E2=80=98struct clone_args=E2=80=99 d=
eclared inside parameter list will not be visible outside of this definitio=
n or declaration
    3    pidfd_wait.c:149:18: warning: excess elements in struct initializer
    3    pidfd_wait.c:148:12: warning: excess elements in struct initializer
    3    memfd_test.c:90:6: warning: implicit declaration of function =E2=
=80=98fcntl=E2=80=99; did you mean =E2=80=98fcvt=E2=80=99? [-Wimplicit-func=
tion-declaration]
    3    memfd_test.c:64:7: warning: implicit declaration of function =E2=
=80=98open=E2=80=99; did you mean =E2=80=98popen=E2=80=99? [-Wimplicit-func=
tion-declaration]
    3    memfd_test.c:397:6: warning: implicit declaration of function =E2=
=80=98fallocate=E2=80=99; did you mean =E2=80=98alloca=E2=80=99? [-Wimplici=
t-function-declaration]
    3    fuse_test.c:67:6: warning: implicit declaration of function =E2=80=
=98fcntl=E2=80=99; did you mean =E2=80=98fcvt=E2=80=99? [-Wimplicit-functio=
n-declaration]
    3    fuse_test.c:261:7: warning: implicit declaration of function =E2=
=80=98open=E2=80=99; did you mean =E2=80=98popen=E2=80=99? [-Wimplicit-func=
tion-declaration]
    3    close_range_test.c:191:18: warning: excess elements in struct init=
ializer
    3    close_range_test.c:190:12: warning: excess elements in struct init=
ializer
    3    close_range_test.c:102:18: warning: excess elements in struct init=
ializer
    3    close_range_test.c:101:12: warning: excess elements in struct init=
ializer
    3    Warning: Kernel ABI header at 'tools/include/uapi/linux/netlink.h'=
 differs from latest version at 'include/uapi/linux/netlink.h'
    3    Warning: Kernel ABI header at 'tools/include/uapi/linux/if_link.h'=
...
=E2=80=98error_debugfs=E2=80=99 defined but not used [-Wunused-label]
    2    param_test.c:1164:10: warning: implicit declaration of function =
...
d [-Wcpp]
    2    /scratch/linux/kernel/rcu/tasks.h:710:13: warning: =E2=80=98show_r=
...
ction-declaration]
    1    proc-pid-vm.c:214:19: warning: =E2=80=98str_vsyscall=E2=80=99 defi=
ned but not used [-Wunused-const-variable=3D]
    1    proc-pid-vm.c:212:13: warning: =E2=80=98g_vsyscall=E2=80=99 define=
...
=99? [-Wimplicit-function-declaration]
    1    /tmp/ccRgIaSZ.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccRgIaSZ.s:18120: Warning: using r15 results in unpredictable=
 behaviour
    1    /scratch/linux/drivers/vhost/vhost.c:1919:1: warning: the frame si=
...
Section mismatches summary:
    ...
    1    WARNING: modpost: vmlinux.o(.text.unlikely+0x2a88): Section mismat=
...
Warnings:
    /tmp/ccRgIaSZ.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccRgIaSZ.s:18192: Warning: using r15 results in unpredictable beha=
viour
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text.unlikely+0x2a88): Section mismatch in=
...
---------------------------------------------------------------------------=
-----
haps_hs_smp_defconfig+kselftest (arc, gcc-8) =E2=80=94 PASS, 166 errors, 24=
...
---------------------------------------------------------------------------=
-----
i386_defconfig+kselftest (i386, gcc-8) =E2=80=94 PASS, 76 errors, 44 warnin=
...
1040 bytes is larger than 1024 bytes [-Wframe-larger-than=3D]
    /scratch/linux/drivers/vhost/vhost.c:1919:1: warning: the frame size of=
 1040 bytes is larger than 1024 bytes [-Wframe-larger-than=3D]
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+kselftest (arm, gcc-8) =E2=80=94 PASS, 74 errors, 54 war=
nings, 0 section mismatches
