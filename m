...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1E7406875A2
	for <lists+linux-next@lfdr.de>; Thu,  2 Feb 2023 07:03:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229485AbjBBGDz (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 2 Feb 2023 01:03:55 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51464 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229479AbjBBGDy (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 2 Feb 2023 01:03:54 -0500
Received: from mail-pj1-x102f.google.com (mail-pj1-x102f.google.com [IPv6:2607:f8b0:4864:20::102f])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 07A5B19F15
        for <linux-next@vger.kernel.org>; Wed,  1 Feb 2023 22:03:51 -0800 (PST)
Received: by mail-pj1-x102f.google.com with SMTP id j5so923947pjn.5
        for <linux-next@vger.kernel.org>; Wed, 01 Feb 2023 22:03:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=6y7L1MP8trTkPAerFlX6bTDu/8yYd5J5jXPSNyg1JZk=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=6y7L1MP8trTkPAerFlX6bTDu/8yYd5J5jXPSNyg1JZk=;
        b=
X-Gm-Message-State: AO0yUKX9RuQT9jy3ww6+naF1wNPjdlEv9ao6dHdwyPJ82fZhSCV9bpwC
        LxdHXyAFDCZaDIkzeFWD3Mq0rmi2ZjjmC482rg266Q==
X-Google-Smtp-Source: AK7set8K0YpkAdKC1suXoZWEJQsTU3fsxcO6qnkK90SQnyB1DGEf6Mze23j3oSlq+qLwIQPetF5apA==
X-Received: by 2002:a05:6a20:9589:b0:bf:7ae0:5f97 with SMTP id iu9-20020a056a20958900b000bf7ae05f97mr2367859pzb.21.1675317829603;
        Wed, 01 Feb 2023 22:03:49 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id z28-20020a63b91c000000b004785a63b44bsm11655083pge.43.2023.02.01.22.03.49
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 01 Feb 2023 22:03:49 -0800 (PST)
Message-ID: <63db5245.630a0220.ac197.45ee@mx.google.com>
Date:   Wed, 01 Feb 2023 22:03:49 -0800 (PST)
...
Subject: next/master build: 169 builds: 17 failed, 152 passed, 25 errors,
 45 warnings (next-20230202)
...
next/master build: 169 builds: 17 failed, 152 passed, 25 errors, 45 warning=
s (next-20230202)
...
Tree: next
Branch: master
Git Describe: next-20230202
Git Commit: ea4dabbb4ad7eb52632a2ca0b8f89f0ea7c55dcf
...
arm64:
    allmodconfig (clang-16): 3 errors, 3 warnings
    cros://chromeos-5.10/arm64/chromiumos-mediatek.flavour.config+arm64-chr=
...
x86_64:
    allmodconfig (clang-16): 3 errors, 5 warnings
    cros://chromeos-5.10/x86_64/chromeos-amd-stoneyridge.flavour.config+x86=
...
Errors summary:
    ...
    8    drivers/md/dm-flakey.c:369:28: error: equality comparison with ext=
raneous parentheses [-Werror,-Wparentheses-equality]
    3    sound/soc/atmel/mchp-spdifrx.c:455:3: error: variable 'mr' is unin=
...
-Wcpp]
    8    drivers/md/dm-flakey.c:369:28: note: remove extraneous parentheses=
 around the comparison to silence this warning
    4    drivers/gpu/host1x/dev.c:490:16: note: initialize the variable 'sy=
ncpt_irq' to silence this warning
    3    sound/soc/atmel/mchp-spdifrx.c:432:8: note: initialize the variabl=
e 'mr' to silence this warning
    3    fs/udf/partition.c:52:14: note: initialize the variable 'loc' to s=
ilence this warning
    3    drivers/gpu/host1x/dev.c:520:6: warning: variable 'syncpt_irq' is =
...
---------------------------------------------------------------------------=
-----
allmodconfig (arm64, clang-16) =E2=80=94 FAIL, 3 errors, 3 warnings, 0 sect=
ion mismatches

Errors:
    sound/soc/atmel/mchp-spdifrx.c:455:3: error: variable 'mr' is uninitial=
...
Warnings:
    sound/soc/atmel/mchp-spdifrx.c:432:8: note: initialize the variable 'mr=
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-16) =E2=80=94 FAIL, 3 errors, 5 warnings, 0 sec=
tion mismatches
...
ized when used here [-Werror,-Wuninitialized]
    fs/udf/partition.c:86:28: error: variable 'loc' is uninitialized when u=
sed here [-Werror,-Wuninitialized]
    drivers/md/dm-flakey.c:369:28: error: equality comparison with extraneo=
us parentheses [-Werror,-Wparentheses-equality]
...
alls through to next function __cfi_m5mols_open()
    drivers/md/dm-flakey.c:369:28: note: remove extraneous parentheses arou=
nd the comparison to silence this warning
