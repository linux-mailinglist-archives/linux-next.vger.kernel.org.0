...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5506111C505
	for <lists+linux-next@lfdr.de>; Thu, 12 Dec 2019 05:50:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727858AbfLLEur (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 11 Dec 2019 23:50:47 -0500
Received: from ozlabs.org ([203.11.71.1]:52769 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727795AbfLLEur (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 11 Dec 2019 23:50:47 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47YLvz18cHz9sNH;
        Thu, 12 Dec 2019 15:50:39 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1576126239;
        bh=8Bl1QJlOIxT4QS2SN2g9kdrjRhUO/hPu1ZFu2zhySBA=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 12 Dec 2019 15:50:38 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 12
Message-ID: <20191212155038.7996ab0b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/HFhn_K_S7MF_7Lv9I8Wvm+A";
...
--Sig_/HFhn_K_S7MF_7Lv9I8Wvm+A
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20191211:
...
The keys tree gained build failures so I used the version from
next-20191211.
...
Non-merge commits (relative to Linus' tree): 2544
 2730 files changed, 125051 insertions(+), 32324 deletions(-)
...
Merging origin/master (687dec9b9459 Merge tag 'erofs-for-5.5-rc2-fixes' of =
...
Merging arm-soc-fixes/arm/fixes (9103bb419aef Merge tag 'reset-fixes-for-v5=
.5-2' of git://git.pengutronix.de/git/pza/linux into arm/fixes)
...
Merging net/master (24dee0c7478d net: ena: fix napi handler misbehavior whe=
n the napi budget is zero)
Merging bpf/master (5b79bcdf0362 bpftool: Don't crash on missing jited insn=
s or ksyms)
...
Merging usb.current/usb-linus (bd82873f23c9 xhci: make sure interrupts are =
...
Merging omap-fixes/fixes (c6b16761c690 ARM: dts: am437x-gp/epos-evm: fix pa=
nel compatible)
...
Merging arm-soc/for-next (15ee122d1414 ARM: Document merges)
...
xt' into for-next)
Merging imx-mxs/for-next (d3898f7511a3 Merge branch 'imx/defconfig' into fo=
r-next)
$ git reset --hard HEAD^
Merging next-20191211 version of imx-mxs
...
Merging mvebu/for-next (cd592187f9de arm64: dts: uDPU: SFP cages support 3W=
 modules)
Merging omap/for-next (43f18979568a Merge branch 'fixes' into for-next)
Merging qcom/for-next (edde693e0eb9 Merge branches 'arm64-for-5.5-fixes', '=
...
to for-next)
Merging samsung-krzk/for-next (337c3820ca0a Merge branch 'next/defconfig' i=
nto for-next)
...
in imxfb_probe())
Merging pm/linux-next (2ff67ccb962d Merge branches 'pm-cpuidle' and 'acpi-p=
m' into linux-next)
...
support)
$ git reset --hard HEAD^
Merging next-20191211 version of thermal
...
Merging net-next/master (b58e9fd48348 Merge branch 'sfp-copper-modules')
Merging bpf-next/master (bae141f54be8 bpf: Emit audit messages upon success=
ful prog load and unload)
...
ice.c
Merging drm-intel/for-linux-next (6aacb5a3b0bc drm/i915: Align start for me=
mcpy_from_wc)
...
Merging sound/for-next (dc5eafe7787c ALSA: usb-audio: Support PCM sync_stop)
...
CONFLICT (content): Merge conflict in arch/arm/tools/syscall.tbl
CONFLICT (content): Merge conflict in arch/alpha/kernel/syscalls/syscall.tbl
[master dd8c8e06f616] next-20191211/keys
...
Merging rcu/rcu/next (1802de53ec76 rcu: React to callback overload by boost=
ing RCU readers)
...
Merging staging/staging-next (4d17363db021 staging: rtl8723bs: Fix line len=
gth)
...
Merging gpio-brgl/gpio/for-next (cfdca14c44a7 gpio: bcm-kona: use platform_=
irq_count)
...
Merging devfreq/devfreq-next (252ef98ed524 PM / devfreq: tegra: Add COMMON_=
CLK dependency)
...
rflow
Merging akpm/master (26e55b564397 drivers/media/platform/sti/delta/delta-ip=
...

=W+Co
-----END PGP SIGNATURE-----
