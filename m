...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id BF0A040D30E
	for <lists+linux-next@lfdr.de>; Thu, 16 Sep 2021 08:11:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232714AbhIPGMm (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 16 Sep 2021 02:12:42 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:54789 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S231281AbhIPGMl (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 16 Sep 2021 02:12:41 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1631772673;
        bh=jd1OW6jfgZyKAAPjDnEhMvtFxh7N1lcBHDUE3IAlZvM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4H96Cj50XQz9sW8;
        Thu, 16 Sep 2021 16:11:13 +1000 (AEST)
Date:   Thu, 16 Sep 2021 16:11:11 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 16
Message-ID: <20210916161111.7f44d2a3@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/H+nyMPcJwuLj/P2u.Yo=3Vd";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/H+nyMPcJwuLj/P2u.Yo=3Vd
...
Merging net/master (a57d8c217aad net: dsa: flush switchdev workqueue before=
...
Merging sound-asoc-fixes/for-linus (8ba4d271dec5 Merge remote-tracking bran=
...
ll in error flow)
Merging kselftest-fixes/fixes (8914a7a247e0 selftests: be sure to make khdr=
...
nto for-next)
Merging samsung-krzk/for-next (bf38db50e9eb Merge branch 'next/drivers' int=
o for-next)
...
Merging clk-imx/for-next (ac061f88cf1d clk: imx: Rework imx_clk_hw_pll14xx =
wrapper)
...
t unsigned long)
Merging hid/for-next (8b52e0e06827 Merge branch 'for-5.15/upstream-fixes' i=
nto for-next)
...
Merging hwmon-staging/hwmon-next (a5da30eed75c hwmon: Add Maxim MAX6620 har=
dware monitoring driver)
...
Merging pm/linux-next (7f2d17677d02 Merge branches 'pm-cpufreq' and 'acpi-x=
86' into linux-next)
...
nter comparison)
Merging net-next/master (5706383b30cf Merge branch 'mlxsw-Add-support-for-t=
ransceiver-modules-reset')
...
Merging amdgpu/drm-next (d654f1a778aa drm/radeon: Add HD-audio component no=
tifier support (v2))
Merging drm-intel/for-linux-next (f6d66fc8cf5f drm/i915: Update memory band=
width parameters)
...
Gen2 laptops.)
Merging sound-asoc/for-next (d275ba2f11f7 Merge remote-tracking branch 'aso=
...
s-sf)
Merging block/for-next (103ae307a281 Merge branch 'for-5.16/cdrom' into for=
-next)
...
Merging edac/edac-for-next (fca611656418 EDAC/mc: Replace strcpy(), sprintf=
() and snprintf() with strscpy() or scnprintf())
...
Merging rcu/rcu/next (bc16d19516ea rcu: Replace ________p1 and _________p1 =
...
Merging kspp/for-next/kspp (420d688ff297 treewide: Replace 0-element memcpy=
...
eted in HEAD and modified in 0c2406ffcdfe9d34834f126a0c7e903306ce51a4. Vers=
ion 0c2406ffcdfe9d34834f126a0c7e903306ce51a4 of drivers/staging/rtl8188eu/i=
nclude/ieee80211.h left in tree.
...
Merging akpm/master (4a96b31a76ad mm/vmalloc: add __alloc_size attributes f=
...

=GHTh
-----END PGP SIGNATURE-----
