...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 85E794900F5
	for <lists+linux-next@lfdr.de>; Mon, 17 Jan 2022 06:04:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230367AbiAQFEX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 17 Jan 2022 00:04:23 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49776 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229543AbiAQFEX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 17 Jan 2022 00:04:23 -0500
Received: from mail-pf1-x434.google.com (mail-pf1-x434.google.com [IPv6:2607:f8b0:4864:20::434])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E61DFC061574
        for <linux-next@vger.kernel.org>; Sun, 16 Jan 2022 21:04:22 -0800 (PST)
Received: by mail-pf1-x434.google.com with SMTP id x83so9202238pfc.0
        for <linux-next@vger.kernel.org>; Sun, 16 Jan 2022 21:04:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=t89EV8LOsPecFQ5XGWKmrwPGQG6CjPM0FQOnSPirqYQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=t89EV8LOsPecFQ5XGWKmrwPGQG6CjPM0FQOnSPirqYQ=;
        b=
X-Gm-Message-State: AOAM530upOqIv0bcGsXRkFgXGepwZyuSBSAwIZHTPFT0BXGW4YtJH3ME
        e7kNKQfPhYgrejo/6y0dZYA7KvkeQgn4KSQG
X-Google-Smtp-Source: ABdhPJy+zEn2zvKiLAbT7LsK+eZxvwFJqc9rj1VjvfjP5QEMpXYIWfpCyvlAMAu9umk0YJHRnvL5Sg==
X-Received: by 2002:a63:f551:: with SMTP id e17mr17726713pgk.243.1642395860301;
        Sun, 16 Jan 2022 21:04:20 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id g10sm11029208pjs.1.2022.01.16.21.04.19
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 16 Jan 2022 21:04:19 -0800 (PST)
Message-ID: <61e4f8d3.1c69fb81.d91c8.f7db@mx.google.com>
Date:   Sun, 16 Jan 2022 21:04:19 -0800 (PST)
...
Subject: next/master build: 225 builds: 17 failed, 208 passed, 28 errors,
 118 warnings (next-20220117)
...
next/master build: 225 builds: 17 failed, 208 passed, 28 errors, 118 warnin=
gs (next-20220117)
...
Tree: next
Branch: master
Git Describe: next-20220117
Git Commit: 68e0667e38d92a8f461fa2e4ccf268ecf4ea1307
...
i386:
    allmodconfig (clang-14): 7 errors, 9 warnings
...
lized]
    10   scripts/sorttable.h:288:30: note: initialize the variable 'mcount_=
...
Section mismatches summary:
    ...
    1    WARNING: modpost: vmlinux.o(.text+0x155497): Section mismatch in r=
eference from the function __next_node() to the variable .init.data:numa_no=
des_parsed
    1    WARNING: modpost: vmlinux.o(.text+0x155422): Section mismatch in r=
eference from the function test_bit() to the variable .init.data:numa_nodes=
_parsed
    1    WARNING: modpost: vmlinux.o(.text+0x15540e): Section mismatch in r=
eference from the function test_bit() to the variable .init.data:numa_nodes=
_parsed
...
Section mismatches:
    WARNING: modpost: vmlinux.o(.text+0x15540e): Section mismatch in refere=
nce from the function test_bit() to the variable .init.data:numa_nodes_pars=
ed
    WARNING: modpost: vmlinux.o(.text+0x155422): Section mismatch in refere=
nce from the function test_bit() to the variable .init.data:numa_nodes_pars=
ed
    WARNING: modpost: vmlinux.o(.text+0x155497): Section mismatch in refere=
nce from the function __next_node() to the variable .init.data:numa_nodes_p=
arsed

---------------------------------------------------------------------------=
-----
allmodconfig (i386, clang-14) =E2=80=94 FAIL, 7 errors, 9 warnings, 0 secti=
on mismatches
