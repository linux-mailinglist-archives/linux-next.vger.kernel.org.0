Return-Path: <linux-next+bounces-3955-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 189B8983C59
	for <lists+linux-next@lfdr.de>; Tue, 24 Sep 2024 07:26:32 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 45B741F225A6
	for <lists+linux-next@lfdr.de>; Tue, 24 Sep 2024 05:26:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EDE62328DB;
	Tue, 24 Sep 2024 05:26:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="Pc7zaAlX"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D1462282FE;
	Tue, 24 Sep 2024 05:26:21 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1727155586; cv=none; b=heYIQWT0XW0VKumczo+WmZdJroKY7rzKzYWUkm51w7KKetJBn2Uu/I5Rh3f1AUXUIdg6pF5g0XA8qjh7csT7JROYzD1Wld/RJmxgdR45zFYglyLwV+nZ9KyHc9a3H26M4KC1urDzCd6WWhbs7v8A1Ws25w1fzr7DX8c3ssPggBY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1727155586; c=relaxed/simple;
	bh=Ir5ZQQAze6nx8g1JJmYN67Ck0hdAofE9PZWHwiUqAAc=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=giceOsHIACXfBFOCE/zpqSCg4Ox30hqMxcuHV23ocmYadPKT6nc80J5gRgac1P3NfpTUukwDnGytGPRJvBWRGAEb4TZa4vpLj9p0kMUt8LsgTL5mdm8n9ALbIZEtbDhOgstUgXjB68N6asw5BpwfwfhPlzlei2Fv8YJIJyBzb58=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=Pc7zaAlX; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1727155579;
	bh=ZRg4/ZOgQs7F3EhWtu18MzzZQWpL/RCEb6CFOETs6XU=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XCSyM5wJWz4w2L;
	Tue, 24 Sep 2024 15:26:19 +1000 (AEST)
Date: Tue, 24 Sep 2024 15:26:19 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 24
Message-ID: <20240924152619.3bbca693@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/rwSssNGr=kkdUhRU7wQqvyz";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/rwSssNGr=kkdUhRU7wQqvyz
...
The memblock tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 2162
 2181 files changed, 73821 insertions(+), 40465 deletions(-)
...
Merging origin/master (abf2050f51fd Merge tag 'media/v6.12-1' of git://git.=
...
Merging ceph/master (db138fb5ac9e ceph: Remove empty definition in header f=
ile)
...
Merging fuse/for-next (106e4593ed1b fs/fuse: convert to use invalid_mnt_idm=
ap)
...
Merging nfs-anna/linux-next (736cd2c1ae7f nfs: add "NFS Client and Server I=
nterlock" section to localio.rst)
...
Merging fs-current (9eb22d77e4ea Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (c8770db2d544 tcp: check skb is non-NULL in tcp_rto_delta_=
us())
Merging bpf/master (de5cb0dcb74c Merge branch 'address-masking')
...
Merging drm-misc-fixes/for-linux-next-fixes (440d52b370b0 drm/sched: Fix dy=
namic job-flow control race)
...
Merging fs-next (c158d81aeb5c Merge branch 'vfs.all' of git://git.kernel.or=
...
eback on SM6350)
Merging drm-xe/drm-xe-next (876253165f3e drm/xe/xe2: Add performance tuning=
 for L3 cache flushing)
...
Merging fbdev/for-next (2887c21375f3 fbcon: Use 'bool' where appopriate)
...
for-next)
Merging device-mapper/for-next (ada4392e9e5f Return error code for failure =
input for sscanf in parse_cblock_range())
...
Merging tomoyo/master (96f32dffd7ca tomoyo: allow building as a loadable LS=
M module)
...
11' into spi-linus)
Merging tip/master (919299cf5d3c Merge branch into tip/master: 'x86/splitlo=
ck')
...
o for-next)
Merging sched-ext/for-next (431844b65f4c sched_ext: Provide a sysfs enable_=
seq counter)
...
Merging random/master (48ff48b8a275 LoongArch: vDSO: Tune chacha implementa=
tion)
...

=EpfW
-----END PGP SIGNATURE-----
