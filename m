...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E5BDE46CE6E
	for <lists+linux-next@lfdr.de>; Wed,  8 Dec 2021 08:38:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240771AbhLHHlt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 8 Dec 2021 02:41:49 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58694 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231469AbhLHHlt (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 8 Dec 2021 02:41:49 -0500
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [IPv6:2404:9400:2:0:216:3eff:fee2:21ea])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 61784C061574;
        Tue,  7 Dec 2021 23:38:17 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4J88Cq2X81z4xRC;
        Wed,  8 Dec 2021 18:38:15 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1638949095;
        bh=5U0rhdkB3pwJL3MRLOgz7uriY+CCcM2TM05aO3khPEw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 8 Dec 2021 18:38:14 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 8
Message-ID: <20211208183814.71b0c51e@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/50CXd.r=fFL.L5y_i9ja2mN";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/50CXd.r=fFL.L5y_i9ja2mN
...
Merging origin/master (cd8c917a56f2 Makefile: Do not quote value for CONFIG=
_CC_IMPLICIT_FALLTHROUGH)
...
Merging net/master (d17b9737c2bc net/qla3xxx: fix an error code in ql_adapt=
er_up())
...
Merging ipvs/master (b43c2793f5e9 netfilter: nfnetlink_queue: silence bogus=
 compiler warning)
...
Merging sound-current/for-linus (d7f32791a9fc ALSA: hda/realtek - Add heads=
et Mic support for Lenovo ALC897 platform)
...
Merging input-current/for-linus (81e818869be5 Input: goodix - add id->model=
 mapping for the "9111" model)
...
Merging hwmon-fixes/hwmon (a2ca752055ed hwmon: (pwm-fan) Ensure the fan goi=
ng on in .probe())
...
Merging devicetree-fixes/dt/linus (656eb419b507 dt-bindings: bq25980: Fixup=
 the example)
Merging scsi-fixes/fixes (69002c8ce914 scsi: qla2xxx: Format log strings on=
ly if needed)
...
Merging irqchip-fixes/irq/irqchip-fixes (3d9e575f2ace irqchip/apple-aic: Ma=
rk aic_init_smp() as __init)
Merging renesas-fixes/fixes (432b52eea3dc ARM: shmobile: defconfig: Restore=
 graphical consoles)
Merging perf-current/perf/urgent (5a897531e002 perf bpf_skel: Do not use ty=
pedef to avoid error on old clang)
...
Merging dma-mapping/for-next (8d7c141bb80f dma-direct: add a dma_direct_use=
_pool helper)
...
Merging renesas/next (0940300f8e1d Merge branches 'renesas-arm-defconfig-fo=
r-v5.17', 'renesas-arm-dt-for-v5.17', 'renesas-drivers-for-v5.17' and 'rene=
sas-dt-bindings-for-v5.17' into renesas-next)
...
Merging tegra/for-next (66b3fe7a2e9a Merge branch for-5.17/arm64/dt into fo=
r-next)
...
he audio_root_clk)
Merging clk-renesas/renesas-clk (6496166cb5d7 clk: renesas: r9a07g044: Add =
...
Merging powerpc/next (2a2ac8a7018b powerpc/xive: Fix compile when !CONFIG_P=
PC_POWERNV.)
...
Merging f2fs/dev (38f953da2e35 f2fs: add gc_urgent_high_remaining sysfs nod=
e)
Merging fsverity/fsverity (07c99001312c fs-verity: support reading signatur=
e with ioctl)
Merging fuse/for-next (e388164ea385 fuse: Pass correct lend value to filema=
p_write_and_wait_range())
...
Merging nfsd/nfsd-next (fd1fb812be24 nfsd: minor unash_delegation_locked cl=
eanup)
...
Merging hwmon-staging/hwmon-next (4ded7796ed52 hwmon: (ntc_thermistor) Move=
...
Merging v4l-dvb-next/master (9b4d7b5c81a2 media: bttv: use DEVICE_ATTR_RO()=
 helper macro)
Merging pm/linux-next (3a18d25cb836 Merge branches 'thermal-int340x' and 't=
hermal-tools' into linux-next)
...
Merging rdma/for-next (0a0575a12e31 RDMA/bnxt_re: Fix endianness warning fo=
r req.pkey)
Merging net-next/master (59d58d93af94 Merge branch 'mptcp-new-features-for-=
mptcp-sockets-and-netlink-pm')
Merging bpf-next/for-next (fda684fb5ec9 Merge branch 'samples: bpf: fix bui=
ld issues with Clang/LLVM')
...
Merging bluetooth/master (d32bd9ffd536 Bluetooth: mgmt: Make use of mgmt_se=
...
_aux_backlight.c
Merging drm-misc/for-linux-next (f8378c040381 drm/bridge: parade-ps8640: Ad=
d backpointer to drm_device in drm_dp_aux)
Merging amdgpu/drm-next (1ebaf8d2448d drm/amdgpu: bump driver version for P=
ROFILE IOCTL)
...
Merging drm-intel/for-linux-next (d4a23930490d drm/i915: Allow cdclk squash=
er to be reconfigured live)
...
Merging drm-msm/msm-next (2027e5b3413d drm/msm: Initialize MDSS irq domain =
at probe time)
...
Merging sound/for-next (6fadb494a638 ALSA: seq: Set upper limit of processe=
d events)
...
Merging input/next (8c374ef45416 Input: ff-core - correct magnitude setting=
 for rumble compatibility)
Merging block/for-next (cb3b5daece09 Merge branch 'for-5.17/io_uring' into =
for-next)
...
P_TEMP)
Merging regulator/for-next (8d9f738f16a3 regulator: fix bullet lists of reg=
ulator_ops comment)
...
Merging devicetree/for-next (a3ebdcc8fb3d dt-bindings: Use correct vendor p=
refix for Asahi Kasei Corp.)
...
Merging rcu/rcu/next (6a3aa1f6d19e fixup! rcu-tasks: Use spin_lock_rcu_node=
() and friends)
Merging kvm/next (ad5b353240c8 KVM: SVM: Do not terminate SEV-ES guests on =
GHCB validation failure)
Merging kvm-arm/next (94b4a6d52173 Merge branch kvm-arm64/misc-5.17 into kv=
marm-master/next)
...
ion number read)
Merging thunderbolt/next (ce05b997426d thunderbolt: Add debug logging of Di=
splayPort resource allocation)
...
Merging scsi-mkp/for-next (4437503bfbec scsi: lpfc: Update lpfc version to =
14.0.0.4)
...
Merging mhi/mhi-next (622e96fb58d6 bus: mhi: core: Fix reading wake_capable=
...
Merging akpm-current/current (2549b429bc95 mm: move tlb_flush_pending inlin=
e helpers to mm_inline.h)
...
Merging akpm/master (c667c19642ee lib/stackdepot: always do filter_irq_stac=
...

=YyNL
-----END PGP SIGNATURE-----
