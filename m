...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A1CD37B2AF2
	for <lists+linux-next@lfdr.de>; Fri, 29 Sep 2023 06:26:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230246AbjI2E0B (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 29 Sep 2023 00:26:01 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59646 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229577AbjI2E0A (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 29 Sep 2023 00:26:00 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6B5F21A2;
        Thu, 28 Sep 2023 21:25:53 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1695961551;
        bh=2R4uunJgYCzYDlpY8nsSwm9DWCljGqnKdEv45ozeTac=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RxcjC2rT3z4x5j;
        Fri, 29 Sep 2023 14:25:51 +1000 (AEST)
Date:   Fri, 29 Sep 2023 14:25:49 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 29
Message-ID: <20230929142549.1feca43f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_r7eO2XbaEGUhq+UG0dz=QY";
...
Non-merge commits (relative to Linus' tree): 8080
 6189 files changed, 529441 insertions(+), 148975 deletions(-)
...
Merging origin/master (9ed22ae6be81 Merge tag 'spi-fix-v6.6-rc3' of git://g=
...
Merging net/main (c070e51db5e2 ice: always add legacy 32byte RXDID in suppo=
rted_rxdids)
...
Merging sound-asoc-fixes/for-linus (7e1fe5d9e7ea ASoC: SOF: amd: fix for fi=
rmware reload failure after playback)
...
Merging spi-fixes/for-linus (1a8196a93e49 spi: spi-gxp: BUG: Correct spi wr=
ite return value)
...
Merging perf/perf-tools-next (0e501a65d35b perf record: Fix BTF type checks=
 in the off-cpu profiling)
...
o for-next)
Merging scmi/for-linux-next (1da0d9064122 Merge branches 'for-next/scmi/fix=
...
() only when updating)
Merging cifs/for-next (e6e43b8aa7cd fs/smb/client: Reset password pointer t=
o NULL)
...
Merging nfsd/nfsd-next (a18c6aa5da1a nfsd: Clean up errors in nfs3proc.c)
Merging ntfs3/master (e4494770a5ca fs/ntfs3: Avoid possible memory leak)
Merging orangefs/for-next (31720a2b109b orangefs: Fix kmemleak in orangefs_=
{kernel,client}_debug_init())
Merging overlayfs/overlayfs-next (102cfd9980bf ovl: Add documentation on ne=
...
Merging net-next/main (7c7dd1d64910 pktgen: Introducing 'SHARED' flag for t=
esting with non-shared skb)
Merging bpf-next/for-next (9e09b75079e2 samples/bpf: Add -fsanitize=3Dbound=
s to userspace programs)
Merging ipsec-next/master (3a69ab875233 Merge branch 'ionic-better-tx-sg=3D=
handling')
Merging mlx5-next/mlx5-next (6581da706473 Merge branch 'mlx5-vfio' into mlx=
5-next)
...
l to struct_size())
Merging bluetooth/master (62dc24251217 Bluetooth: ISO: Fix invalid context =
error)
Merging wireless-next/for-next (9896f0608f9f Merge ath-next from git://git.=
...
- add missing escape)
Merging drm-misc/for-linux-next (fc5fb9e7f81e MAINTAINERS: Document that th=
e NXP i.MX 8MQ DCSS driver goes thru drm-misc)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (f67ff36f2117 drm/i915/fdi: Recompute stat=
e for affected CRTCs on FDI links)
...
ith __counted_by)
Merging sound-asoc/for-next (545d09515ddf Merge remote-tracking branch 'aso=
...
Merging spi/for-next (0165de63e890 Merge remote-tracking branch 'spi/for-6.=
7' into spi-next)
Merging tip/master (5d5ef6a7641b Merge branch into tip/master: 'x86/urgent')
...
Merging kvm-x86/next (e2c8c2928d93 Merge branches 'docs', 'misc' and 'pmu')
...
Merging dmaengine/next (10c060edf581 dt-bindings: dmaengine: qcom: gpi: All=
ow dma-coherent)
$ git reset --hard HEAD^
Merging next-20230928 version of dmaengine
...
Merging pinctrl/for-next (ea62b2d042b8 Merge branch 'devel' into for-next)
...
Merging kspp/for-next/kspp (4ae7f6320aeb MAINTAINERS: hardening: Add Gustav=
o as Reviewer)
...

=3G3H
-----END PGP SIGNATURE-----
