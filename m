...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 550764E4D9F
	for <lists+linux-next@lfdr.de>; Wed, 23 Mar 2022 08:53:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231811AbiCWHzP (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 23 Mar 2022 03:55:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59046 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229850AbiCWHzP (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 23 Mar 2022 03:55:15 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ABDA762EE;
        Wed, 23 Mar 2022 00:53:42 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KNgb61NKpz4xc3;
        Wed, 23 Mar 2022 18:53:38 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1648022018;
        bh=tmu04iLsnaL68nNR28pKw0EgBnr/mQSsXLQ5UP1Xt+E=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 23 Mar 2022 18:53:37 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 23
Message-ID: <20220323185337.39c98e08@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=HgKbuMtrEQFPZ9Tz+y8rO=";
...
Non-merge commits (relative to Linus' tree): 11506
 11401 files changed, 990955 insertions(+), 265342 deletions(-)
...
Merging origin/master (519129040766 Merge tag 'for-5.18-tag' of git://git.k=
...
Merging net/master (6a7d8cff4a33 tipc: fix the timer expires after interval=
 100ms)
...
lue)
Merging risc-v/for-next (6ae1af9ca0e8 perf: RISC-V: Add support for SBI PMU=
 and Sscofpmf)
...
Merging cifs/for-next (70ef38515b66 cifs: writeback fix)
...
Merging net-next/master (b20bdd9cc974 iwlwifi: mvm: Don't fail if PPAG isn'=
t supported)
Applying: fxup for "net/mlx5e: Don't prefill WQEs in XDP SQ in the multi bu=
ffer mode"
Merging bpf-next/for-next (7f0059b58f02 selftests/bpf: Fix kprobe_multi tes=
t.)
...
Merging block/for-next (9c5ed4675cd7 Merge branch 'for-5.18/io_uring' into =
for-next)
...
rules)
Merging devicetree/for-next (3d8fa7a22dcd dt-bindings: ufs: qcom: Add SM635=
0 compatible string)
...
Merging pinctrl/for-next (0c3c8458428a pinctrl: nuvoton: Fix sparse warning)
...
nto slab/for-next)
Merging random/master (fc66b3cd6f06 random: re-add removed comment about ge=
t_random_{u32,u64} reseeding)
CONFLICT (modify/delete): arch/nds32/include/asm/pgtable.h deleted in HEAD =
and modified in random/master.  Version random/master of arch/nds32/include=
/asm/pgtable.h left in tree.
CONFLICT (modify/delete): arch/nds32/mm/init.c deleted in HEAD and modified=
 in random/master.  Version random/master of arch/nds32/mm/init.c left in t=
ree.
...
Merging akpm/master (a9bd411e873f kselftest/vm: override TARGETS from argum=
ents)
...

=Fj6S
-----END PGP SIGNATURE-----
