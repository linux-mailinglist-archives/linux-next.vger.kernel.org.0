...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 201D23607C8
	for <lists+linux-next@lfdr.de>; Thu, 15 Apr 2021 12:54:01 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232836AbhDOKx0 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 15 Apr 2021 06:53:26 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47294 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232666AbhDOKxW (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 15 Apr 2021 06:53:22 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7F3FFC061756;
        Thu, 15 Apr 2021 03:52:58 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FLblq00PFz9sV5;
        Thu, 15 Apr 2021 20:52:54 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1618483975;
        bh=KixGxNAWtCnHq0WTkoR1uMH2e3pGUEOfSQUmXAX7OEs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 15 Apr 2021 20:52:54 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 15
Message-ID: <20210415205254.6507af3b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/mMUiKH.lMcUIs/vg14uDwGf";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/mMUiKH.lMcUIs/vg14uDwGf
...
Merging origin/master (7f75285ca572 Merge tag 'for-5.12/dm-fixes-3' of git:=
...
Merging net/master (00423969d806 Revert "net: stmmac: re-init rx buffers wh=
en mac resume back")
...
Merging sound-asoc-fixes/for-linus (2077f5503437 Merge remote-tracking bran=
...
or-next)
Merging arm64/for-next/core (48794a525154 Merge branch 'for-next/pac-set-ge=
...
b is used)
Merging cifs/for-next (c89698c5ea92 cifs: Return correct error code from sm=
b2_get_enc_key)
...
ext)
Merging i2c/i2c/for-next (42a65e6bcd40 Merge branch 'i2c/for-5.13' into i2c=
/for-next)
...
Merging net-next/master (3a1aa533f7f6 Merge tag 'linux-can-next-for-5.13-20=
210414' of git://git.kernel.org/pub/scm/linux/kernel/git/mkl/linux-can-next)
...
Applying: merger fix for "netfilter: bridge: add pre_exit hooks for ebtable=
 unregistration"
Merging bpf-next/for-next (069904ce318e tools/testing: Remove unused variab=
le)
...
ruct net)
Merging wireless-drivers-next/master (5871d0c6b8ea ionic: return -EFAULT if=
 copy_to_user() fails)
...
Merging sound-asoc/for-next (6ba95fcc795c Merge remote-tracking branch 'aso=
...
chpanel series)
Merging block/for-next (901b8e44f6b0 Merge branch 'for-5.13/io_uring' into =
for-next)
...
Merging drivers-x86/for-next (d21e5abd3a00 platform/x86: pmc_atom: Match al=
l Beckhoff Automation baytrail boards with critclk_systems DMI table)
...
Merging driver-core/driver-core-next (a00fcbc115f9 Merge tag 'v5.12-rc7' in=
to driver-core-next)
...
CONFLICT (content): Merge conflict in arch/powerpc/kernel/module.c
CONFLICT (content): Merge conflict in arch/arm64/Kconfig
CONFLICT (content): Merge conflict in Documentation/admin-guide/kernel-para=
meters.txt
Applying: merge fix up for powerpc merge fix
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (f79c41ca3bdf memfd_secret: use unsigned int rather tha=
...

=QEDT
-----END PGP SIGNATURE-----
