...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id EA9C154DB34
	for <lists+linux-next@lfdr.de>; Thu, 16 Jun 2022 09:06:18 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230043AbiFPHGR (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 16 Jun 2022 03:06:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52392 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229462AbiFPHGR (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 16 Jun 2022 03:06:17 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C89F55BD16;
        Thu, 16 Jun 2022 00:06:13 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LNtW42D43z4xXh;
        Thu, 16 Jun 2022 17:06:08 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1655363168;
        bh=+E+mWub61w1Rx7hK7zV8FDm+jLawRt+sZpX57sg5S30=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 16 Jun 2022 17:06:06 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 16
Message-ID: <20220616170606.278d68e6@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/JoUDWNtWbfIDaUZrlM3gGW6";
...
--Sig_/JoUDWNtWbfIDaUZrlM3gGW6
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220615:

New trees: broadcom-fixes, broadcom, drm-msm-lumag

The net-next tree gained a conflict against the rockchip tree.

The amdgpu tree lost one build failure.
The amdgpu tree still had its build failures, so I used the
version from next-20220601 again.

Non-merge commits (relative to Linus' tree): 3480
 4117 files changed, 215956 insertions(+), 66506 deletions(-)
...
Merging origin/master (30306f6194ca Merge tag 'hardening-v5.19-rc3' of git:=
//git.kernel.org/pub/scm/linux/kernel/git/kees/linux)
Merging fixes/fixes (d06c942efea4 Merge tag 'for_linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/mst/vhost)
Merging mm-hotfixes/mm-hotfixes-unstable (1e8d6502ba4b mm/memory-failure: d=
isable unpoison once hw error happens)
...
Merging arm-current/fixes (3cfb30199796 ARM: 9197/1: spectre-bhb: fix loop8=
 sequence for Thumb2)
Merging arm64-fixes/for-next/fixes (0d8116ccd83b arm64: ftrace: remove redu=
ndant label)
...
Merging net/master (219b51a6f040 net: ax25: Fix deadlock caused by skb_recv=
_datagram in ax25_recvmsg)
Merging bpf/master (d1a374a1aeb7 bpf: Limit maximum modifier chain length i=
n btf_check_type_tags)
...
Merging sound-asoc-fixes/for-linus (0a6d2c147bed Merge remote-tracking bran=
...
Merging btrfs/for-next (9685dd451a3f Merge branch 'for-next-next-v5.19-2022=
0615' into for-next-20220615)
...
Merging v9fs/9p-next (74b37b2b0864 9p: fix EBADF errors in cached mode)
...
Merging net-next/master (fbb89d02e33a net: sparx5: Allow mdb entries to bot=
h CPU and ports)
...
Merging drm-misc/for-linux-next (abf0ba5a34ea drm/bridge: it6505: Add missi=
ng CRYPTO_HASH dependency)
CONFLICT (content): Merge conflict in include/uapi/linux/dma-buf.h
Applying: drm/amdgpu/display: fix build when CONFIG_DEBUG_FS is not set
Merging drm-intel/for-linux-next (8d2ba05b099a drm/i915/bios: split ddi por=
t parsing and debug printing)
...
river co-maintainer)
Merging drm-msm-lumag/msm-next-lumag (fef1db6b1b62 Merge branches 'msm-next=
...
into for-next)
Merging sound-asoc/for-next (63cddf7cc93e Merge remote-tracking branch 'aso=
...
Merging block/for-next (d0e6f0db59e7 Merge branch 'for-5.20/io_uring' into =
for-next)
Merging device-mapper/for-next (10eb3a0d517f dm: fix race in dm_start_io_ac=
ct)
...
to trace/for-next)
Merging rcu/rcu/next (e607cc386016 context_tracking: Interrupts always disa=
bled for ct_idle_exit())
Applying: Contextual conflict between kspp and rcu trees
...
Merging mm/mm-everything (6f7bb9d7feed Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
/dccg.h
[master 92fde8e54dd3] next-20220601/amdgpu
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (92fde8e54dd3 next-20220601/amdgpu)
...

=5U1Q
-----END PGP SIGNATURE-----
