...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D5A15431381
	for <lists+linux-next@lfdr.de>; Mon, 18 Oct 2021 11:30:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231448AbhJRJch (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 18 Oct 2021 05:32:37 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:54119 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231420AbhJRJcg (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 18 Oct 2021 05:32:36 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HXs6m32zVz4xbP;
        Mon, 18 Oct 2021 20:30:24 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1634549424;
        bh=g0c7cBBaOEATCFPe00dwoz8m8fY7AKVEcEqqDY1onq8=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 18 Oct 2021 20:30:23 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 18
Message-ID: <20211018203023.036d8362@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/IQOyNikXFc0Wi=kTnSbx=t0";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/IQOyNikXFc0Wi=kTnSbx=t0
...
The kspp-gustavo tree lost its build failure but gained another for
which I applied a patch and another for which I reverted a commit.

The rust tree gained a conflict against the bpf-next tree.

The akpm-current tree gained a semantic conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 8101
 7932 files changed, 523940 insertions(+), 174726 deletions(-)
...
Merging origin/master (d999ade1cc86 Merge tag 'perf-tools-fixes-for-v5.15-2=
021-10-16' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
Merging net/master (fac3cb82a54a net: bridge: mcast: use multicast_membersh=
ip_interval for IGMPv3)
...
-linus)
Merging sound-asoc-fixes/for-linus (7aec49b9c33e Merge remote-tracking bran=
...
Merging regulator-fixes/for-linus (48de340548af Merge remote-tracking branc=
h 'regulator/for-5.15' into regulator-linus)
Merging spi-fixes/for-linus (7d41322d82e3 Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (cd932c2a1ecc Merge tag 'usb-serial-5.15-rc6'=
...
Merging char-misc.current/char-misc-linus (f42752729e20 eeprom: 93xx46: fix=
 MODULE_DEVICE_TABLE)
...
ice node)
Merging kvm-fixes/master (b41562b71d54 KVM: VMX: Remove redundant handling =
of bus lock vmexit)
...
Merging omap/for-next (92d190433bd8 Merge branch 'omap-for-v5.16/gpmc' into=
 for-next)
Merging qcom/for-next (31bf1ffea584 Merge branches 'arm64-defconfig-for-5.1=
...
rt)
Merging rockchip/for-next (6d466f37770e Merge branch 'v5.16-armsoc/dts64' i=
nto for-next)
...
d MLP clocks)
Merging clk-samsung/for-next (7d4901d96584 clk: samsung: exynos5433: update=
 apollo and atlas clock probing)
...
etattr)
Merging gfs2/for-next (325af8803f46 gfs2: Fix unused value warning in do_gf=
s2_set_flags())
...
hout CONFIG_PRINTK)
Merging pci/next (8f0e5f43f764 Merge branch 'remotes/lorenzo/pci/xgene')
$ git reset --hard HEAD^
Merging next-20211015 version of pci
...
Merging hwmon-staging/hwmon-next (efb389b8c34f hwmon: (max31722) Warn about=
 failure to put device in stand-by in .remove())
...
Merging rdma/for-next (ac0fffa0859b RDMA/core: Set sgtable nents when using=
 ib_dma_virt_map_sg())
Merging net-next/master (4e6e167bc049 Merge branch 'smc-rv23')
...
e.c
Merging drm-misc/for-linux-next (5a614570172e drm/rockchip: dsi: Disable PL=
L clock on bind error)
...
Merging drm-intel/for-linux-next (c974cf01b248 drm/i915: Clean up PXP Kconf=
ig info.)
Merging drm-tegra/drm/tegra/for-next (5dccbc9de8f0 drm/tegra: dc: rgb: Allo=
w changing PLLD rate on Tegra30+)
Merging drm-msm/msm-next (c8f01ffc8392 drm/msm/dsi: fix off by one in dsi_b=
...
Merging sound/for-next (3c05f1477e62 ALSA: ISA: not for M68K)
$ git reset --hard HEAD^
Merging next-20211015 version of sound
Merging sound-asoc/for-next (48772ddbb336 Merge remote-tracking branch 'aso=
...
te support)
Merging block/for-next (22056523d144 Merge branch 'for-5.16/drivers' into f=
or-next)
...
andard phandle)
Merging regulator/for-next (2eea51d9fcc9 Merge remote-tracking branch 'regu=
...
plicit conversion)
Merging watchdog/master (d999ade1cc86 Merge tag 'perf-tools-fixes-for-v5.15=
-2021-10-16' of git://git.kernel.org/pub/scm/linux/kernel/git/acme/linux)
...
Merging mailbox/mailbox-for-next (0ff9a987584f mailbox: mtk-cmdq: Fix local=
 clock ID usage)
Merging spi/for-next (fea34b1d9dd2 Merge remote-tracking branch 'spi/for-5.=
16' into spi-next)
...
Merging clockevents/timers/drivers/next (4c261c08ee8f Merge branch 'timers/=
...
Merging kvm-arm/next (5f8b2591decb Merge branch kvm-arm64/memory-accounting=
...
te build error)
Merging driver-core/driver-core-next (1f8818e352f7 dyndbg: fix spurious vNp=
r_info change)
Merging usb/usb-next (660a92a59b9e usb: xhci: Enable runtime-pm by default =
on AMD Yellow Carp platform)
...
Merging staging/staging-next (502408a61f4b staging: wlan-ng: Avoid bitwise =
vs logical OR warning in hfa384x_usb_throttlefn())
Merging iio/togreg (34130fd8980b Merge tag 'counter-for-5.16a' into togreg)
...
Merging rtc/rtc-next (9f08c9ed580a rtc: pcf85063: Always clear EXT_TEST fro=
m set_time)
...
Merging akpm-current/current (02447a21fbc7 ipc/ipc_sysctl.c: remove fallbac=
...
Merging akpm/master (0a27c9dd0b0e mm: unexport {,un}lock_page_memcg)
...

=wyqK
-----END PGP SIGNATURE-----
