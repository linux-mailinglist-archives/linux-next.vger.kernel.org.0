...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 943D2424E31
	for <lists+linux-next@lfdr.de>; Thu,  7 Oct 2021 09:42:38 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240394AbhJGHoa (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 7 Oct 2021 03:44:30 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:40357 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232512AbhJGHo3 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 7 Oct 2021 03:44:29 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HQ3FQ42Z3z4xbT;
        Thu,  7 Oct 2021 18:42:34 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1633592554;
        bh=5YBf5EwDBrlo2sCgEtHsI3nXW5ZkrJsbzGY3Pae/Z8s=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 7 Oct 2021 18:42:33 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 7
Message-ID: <20211007184233.7d7562c9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/.T4tQyeM=t_8iFXeHskqXYJ";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/.T4tQyeM=t_8iFXeHskqXYJ
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211006:
...
The selinux tree gained a conflict against the block tree.
...
Non-merge commits (relative to Linus' tree): 6024
 5846 files changed, 336173 insertions(+), 138849 deletions(-)
...
Merging net/master (a50a0595230d dt-bindings: net: dsa: marvell: fix compat=
ible in example)
Merging bpf/master (d0c6416bd709 unix: Fix an issue in unix_shutdown causin=
g the other end read/write failures)
...
Merging sound-current/for-linus (dd6dd6e3c791 ALSA: hda/realtek: Add quirk =
for TongFang PHxTxX1)
...
/linux)
Merging drm-misc-fixes/for-linux-next-fixes (f5a8703a9c41 drm/nouveau/debug=
...
or-next)
Merging omap/for-next (3803d055e16f Merge branch 'omap-for-v5.16/dt' into f=
or-next)
...
Merging tegra/for-next (cd42abcb200b Merge branch for-5.16/arm64/dt into fo=
r-next)
...
Merging ksmbd/ksmbd-for-next (6870bdcc86b4 ksmbd: fix oops from fuse driver)
...
Merging net-next/master (9cbfc51af026 qed: Fix spelling mistake "ctx_bsaed"=
 -> "ctx_based")
Merging bpf-next/for-next (0e545dbaa279 Merge branch 'libbpf: Deprecate bpf=
_{map,program}__{prev,next} APIs since v0.7')
...
Merging bluetooth/master (f363f0eccfa4 Bluetooth: mgmt: Fix Experimental Fe=
ature Changed event)
...
Merging drm-misc/for-linux-next (15184965783a drm/bridge/lontium-lt9611uxc:=
 fix provided connector suport)
Merging amdgpu/drm-next (7d89172afed6 drm/amdgpu/pm: properly handle sclk f=
or profiling modes on vangogh)
Merging drm-intel/for-linux-next (210de399659a drm/i915: Call intel_dp_dump=
_link_status() for CR failures)
Merging drm-tegra/drm/tegra/for-next (29e08b1e60b4 drm/tegra: dc: rgb: Move=
 PCLK shifter programming to CRTC)
...
16' into spi-next)
Merging tip/auto-latest (1f3e1d891876 Merge branch 'x86/urgent')
...
ed_cdevs list)
Merging ipmi/for-next (396c84bbfd79 ipmi: bt-bmc: Use registers directly)
...
Merging usb/usb-next (f3351eca1fb1 usb: core: config: Change sizeof(struct =
...) to sizeof(*...))
...
Merging tty/tty-next (32262e2e429c serial: 8250: Fix reporting real baudrat=
e value in c_ospeed field)
...
[master f5e0b30b9ff4] next-20211006/userns
...
Merging akpm/master (b73c329b130a mm: unexport {,un}lock_page_memcg)
...

=Dbew
-----END PGP SIGNATURE-----
