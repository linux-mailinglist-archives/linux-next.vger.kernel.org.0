...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A9DFF45D40D
	for <lists+linux-next@lfdr.de>; Thu, 25 Nov 2021 06:12:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233360AbhKYFPN (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 25 Nov 2021 00:15:13 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:40243 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229748AbhKYFNN (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 25 Nov 2021 00:13:13 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4J05Xm4zjlz4xZ0;
        Thu, 25 Nov 2021 16:10:00 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1637817000;
        bh=4YkP/WXEK9I4qpDalrNMCLbvtdRXkI8NtAk/nF4mjd0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 25 Nov 2021 16:09:57 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 25
Message-ID: <20211125160957.4ffdeb88@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/AQ+3uvU8hCS5a8_C.WwDHM4";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/AQ+3uvU8hCS5a8_C.WwDHM4
...
The vhost tree gained a semantic conflict against the net tree for which
I reverted a commit.

The gpio-brgl tree still had its build failure so I used the version from
next-20211115.

Non-merge commits (relative to Linus' tree): 3065
 3576 files changed, 139703 insertions(+), 54790 deletions(-)
...
Merging origin/master (5f53fa508db0 Merge tag 'for-5.16/parisc-5' of git://=
...
Merging net/master (ac132852147a net/ncsi : Add payload to be 32-bit aligne=
d to fix dropped packets)
...
Merging sound-asoc-fixes/for-linus (8fc6f1e59c87 Merge remote-tracking bran=
...
n IRQ helper docs)
Merging spi-fixes/for-linus (edf041a53a92 Merge remote-tracking branch 'spi=
...
Merging net-next/master (d156250018ab Merge branch 'hns3-next')
...
Merging bluetooth/master (899663be5e75 Bluetooth: refactor malicious adv da=
ta check)
...
Merging drm-misc/for-linux-next (0bae5687bc68 drm/bridge: anx7625: Fix edid=
_read break case in sp_tx_edid_read())
...
Merging drm-intel-gt/for-linux-next-gt (b6b56df519a7 Revert "drm/i915/dmabu=
f: fix broken build")
...
ce assignment)
Merging sound-asoc/for-next (cd2f33e93d57 ASoC: SOF: Intel: power optimizat=
ions with HDaudio SPIB register)
...
t)
Merging block/for-next (f0afafc21027 Merge branch 'for-5.17/io_uring' into =
for-next)
...
LP S4 MU)
Merging spi/for-next (b79332ef9d61 spi: Fix condition in the __spi_register=
_driver())
...
t in event printing)
Merging rcu/rcu/next (a3d09240cbfd rcu-tasks: Avoid raw-spinlocked wakeups =
from call_rcu_tasks_generic())
...
318 CPNC data)
Merging xen-tip/linux-next (36e8f60f0867 xen: detect uninitialized xenbus i=
n xenbus_init)
...
Merging akpm/master (777026df61f9 lib/stackdepot: allow optional init and s=
...

=7v7g
-----END PGP SIGNATURE-----
