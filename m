Return-Path: <linux-next+bounces-226-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id E7A4E80455F
	for <lists+linux-next@lfdr.de>; Tue,  5 Dec 2023 03:57:25 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 4360C1F21311
	for <lists+linux-next@lfdr.de>; Tue,  5 Dec 2023 02:57:25 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 5D1714A0F;
	Tue,  5 Dec 2023 02:57:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="T5q3e2jX"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D8F74BF;
	Mon,  4 Dec 2023 18:57:10 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1701745029;
	bh=NUxn7lctYHfjeeLkJ4Tk1J428wTgbicA3XL4bPa76vg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4SklYx3ZPmz4wc6;
	Tue,  5 Dec 2023 13:57:09 +1100 (AEDT)
Date: Tue, 5 Dec 2023 13:57:08 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 5
Message-ID: <20231205135708.4a5a8413@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/T5WNpTTQQmRu1yikMyqm4w1";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/T5WNpTTQQmRu1yikMyqm4w1
...
Non-merge commits (relative to Linus' tree): 4285
 4786 files changed, 187711 insertions(+), 117303 deletions(-)
...
Merging mm-hotfixes/mm-hotfixes-unstable (bf08732fc96c kexec: select CRYPTO=
...
Merging net/main (79321a793945 r8152: Add RTL8152_INACCESSIBLE to r8153_ald=
ps_en())
...
Merging sound-asoc-fixes/for-linus (29046a78a3c0 ASoC: wm_adsp: fix memleak=
 in wm_adsp_buffer_populate)
...
Merging spi-fixes/for-linus (49d8575ca613 spi: atmel: Drop unused defines)
...
Merging usb.current/usb-linus (b17b7fe6dd5c usb: typec: class: fix typec_al=
tmode_put_partner to put plugs)
...
Merging char-misc.current/char-misc-linus (52eb67861ebe greybus: gb-beaglep=
lay: Ensure le for values in transport)
...
s)
Merging mm/mm-everything (f948c6c04c38 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging asm-generic/master (e183130c9a87 sparc: Use $(kecho) to announce ke=
rnel images being ready)
...
-next)
Merging ti/ti-next (8a48674190de Merge branches 'ti-k3-config-next' and 'ti=
...
Merging bcachefs/for-next (7b9c2240f97d bcachefs: Convert compression_stats=
 to for_each_btree_key2)
...
Merging net-next/main (21f49681658d Merge branch 'octeontx2-multicast-mirro=
r-offload')
Merging bpf-next/for-next (153de60e8bfb selftests/bpf: Fix spelling mistake=
 "get_signaure_size" -> "get_signature_size")
...
- add missing escape)
Merging drm-misc/for-linux-next (dce94061f0d0 drm/v3d: Fix missing error co=
de in v3d_submit_cpu_ioctl())
...
Merging drm-intel/for-linux-next (4de77156a2ac drm/i915/dsi: Use devm_gpiod=
_get() for all GPIOs)
Merging drm-tegra/for-next (2429b3c529da drm/tegra: Avoid potential 32-bit =
integer overflow)
Merging drm-msm/msm-next (07e6de738aa6 drm/msm/a690: Fix reg values for a69=
0)
Merging drm-msm-lumag/msm-next-lumag (801207c18834 drm/msm/dp: add a missin=
g unlock in dp_hpd_plug_handle())
...
ith __counted_by)
Merging sound-asoc/for-next (1345f8732cf9 Merge remote-tracking branch 'aso=
...
Merging spi/for-next (4283a333f1d7 Merge remote-tracking branch 'spi/for-6.=
8' into spi-next)
...
Merging extcon/extcon-next (e66523c72c9a extcon: fix possible name leak in =
extcon_dev_register())
...
inodes)
Merging slab/slab/for-next (4fed85d8da89 Merge branch 'slab/for-6.8/slab-re=
...

=OR6P
-----END PGP SIGNATURE-----
