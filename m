Return-Path: <linux-next+bounces-9044-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ams.mirrors.kernel.org (ams.mirrors.kernel.org [213.196.21.55])
	by mail.lfdr.de (Postfix) with ESMTPS id 02FD9C62F7F
	for <lists+linux-next@lfdr.de>; Mon, 17 Nov 2025 09:50:49 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ams.mirrors.kernel.org (Postfix) with ESMTPS id 7C3B53459D8
	for <lists+linux-next@lfdr.de>; Mon, 17 Nov 2025 08:49:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id EF580320A0D;
	Mon, 17 Nov 2025 08:49:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="XPLf8cs5"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A4E3131E11C;
	Mon, 17 Nov 2025 08:49:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763369377; cv=none; b=iKVWvXwCl8yLm/37yiiihVk37jHIWOp5BCoCFTwuiBiW7yzl3cz+oRpQLLFNespszXpfyj4m02ovnpnfunXbZI5wHwJc0kNSdabrttvLaJHVe4VlRew7yx01nNF2b5eLVRrU4u+SQAumgvFbffQKgd/pd02+2J8lkV/aILUaqXY=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763369377; c=relaxed/simple;
	bh=MNGkMGCeISm/wcPnYnzHZGC5ppe1JkoyyL8kxSqBXdY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=AvVogyivJUiz2rjplD40uDDekQ0LnFj18o0+b/+bvMA56iajUtuAVbv5NR4Nw9vRgN4VDbFjjH0xIbr2WoPuuFKDP5x07kuy5U4pqMUX777aMxqEhbpt/2H781bdE6TKNlTEc4tYjzSAyiCiapMR4d1iX8Xe8CIj93uH7kWczCU=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=XPLf8cs5; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1763369364;
	bh=R9+xzUHz8e2Vdm4DWUrqkSzQtizJFoT39tHVHppYNvg=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4d91dJ470qz58bX;
	Mon, 17 Nov 2025 19:49:24 +1100 (AEDT)
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/yXb9i5Z/8jil6tTcw.vAns=";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/yXb9i5Z/8jil6tTcw.vAns=
...
Merging btrfs/for-next (596fd0bbc028 Merge branch 'for-next-next-v6.18-2025=
1114' into for-next-20251114)
Merging ceph/master (87ab14795a89 libceph: drop started parameter of __ceph=
_open_session())
Merging cifs/for-next (30158616cee7 smb: client: show smb lease key in open=
_dirs output)
...
Merging nfsd/nfsd-next (377c0011055d nfsd: Use MD5 library instead of crypt=
o_shash)
...
into for-next)
Merging mm-hotfixes/mm-hotfixes-unstable (c76424db9f54 selftests/mm: fix di=
vision-by-zero in uffd-unit-tests)
Merging fs-current (ee1fcb297d41 Merge branch 'fixes' of https://git.kernel=
...
Merging sound-current/for-linus (21a9ab5b90b3 ALSA: usb-audio: Add native D=
SD quirks for PureAudio DAC series)
...
Merging drm-fixes/drm-fixes (362a7d4fd5c4 Merge tag 'drm-xe-fixes-2025-11-1=
...
ile_smp_* alignment)
Merging perf-current/perf-tools (b72b8132d8fd perf libbfd: Ensure libbfd is=
...
Merging tip-fixes/tip/urgent (7254a2b52279 Merge tag 'firewire-fixes-6.18-r=
c6' of git://git.kernel.org/pub/scm/linux/kernel/git/ieee1394/linux1394)
...
Merging mm-nonmm-unstable/mm-nonmm-unstable (013e5819ec8b ceph: replace loc=
...
orkqueue users)
Merging imx-mxs/for-next (e127c2c20d96 Merge branch 'imx/defconfig' into fo=
r-next)
...
Merging rockchip/for-next (6c1eee3fb218 Merge branch 'v6.19-armsoc/dts64' i=
nto for-next)
...
Merging tee/next (8a6b5e90893d Merge branch 'qcomtee_fixes_for_6.18' into n=
ext)
...
Merging fs-next (bcc24deb7d5a Merge branch 'for-next' of https://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging hwmon-staging/hwmon-next (93a8cb5b69c9 MAINTAINERS: Add entry for S=
T TSC1641 driver)
...
Merging pm/linux-next (ebe6873de1a2 Merge branch 'pm-cpuidle' into linux-ne=
xt)
...
Merging drm-msm/msm-next (cfbb4c0c9c19 drm/msm: Wait for MMU devcoredump wh=
en waiting for GMU)
...
Merging drm-rust/drm-rust-next (ce89e3e019f1 gpu: nova-core: provide a clea=
r error report for unsupported GPUs)
...
Merging block/for-next (d6bf99202b7a Merge branch 'for-6.19/block' into for=
-next)
...
Merging devicetree/for-next (e0f5d8e3fe94 kbuild: Ensure .dtbo targets are =
...
ema")
CONFLICT (add/add): Merge conflict in Documentation/devicetree/bindings/wat=
chdog/ti,omap2-wdt.yaml
$ git reset --hard HEAD^
...
Merging spi/for-next (33af0f00ac96 Merge remote-tracking branch 'spi/for-6.=
19' into spi-next)
...
Merging sched-ext/for-next (dda380a14e39 Merge branch 'for-6.19' into for-n=
ext)
...
Merging vhost/linux-next (ad9d909c0f9a ptr_ring: support peeking at last pr=
oduced entry)
...
Merging cxl/next (33bedb92d26b Merge branch 'for-6.19/cxl-prm' into cxl-for=
-next)
...

=c3YR
-----END PGP SIGNATURE-----
