Return-Path: <linux-next+bounces-3093-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 04961938869
	for <lists+linux-next@lfdr.de>; Mon, 22 Jul 2024 07:32:25 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id B9D2DB20B2C
	for <lists+linux-next@lfdr.de>; Mon, 22 Jul 2024 05:32:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 03B5E1758E;
	Mon, 22 Jul 2024 05:32:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="A76T5GJ2"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A8D7014F70;
	Mon, 22 Jul 2024 05:32:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721626336; cv=none; b=oyl5/i5tp6vsJnJvA38bf0x47IIew/r/r+0QekKvj9D+/+4yqrKoiNT+Bx0IlAnkZf0Ha2iLf1d/YpzO+YywUjdlFBtyDhvRX3+lTY6HxfEa/sRB5L3IPHRGUcj79PR1o08XQ2/HhaJIXi+gABFo5kByNLeTS9Hm8rrsVz6zxtE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721626336; c=relaxed/simple;
	bh=qXsssDV76jvZChHTiBqhY9ipDZo7VHSVFpyVxsoWO5U=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=GaX+9v2osalNwocAJPUNNZ85uXXh/tYlh+s0IYwenp6SixHBH+nds0+jdYf9ai2ojyv7FYQUaTdtLbWzAWamMFcOEBv+5MiThIASiNhB34UJQ9XmiBfS2cWTZN3Rs599yZri/VN8nilmUIKK8DNt+n72TcBM3vCPakl3TwtbX5Q=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=A76T5GJ2; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1721626327;
	bh=4LNhKnB/joKypUTojaXZZtS6eGl4VCrFXKy65ytaFiI=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WS86b17pmz4wbr;
	Mon, 22 Jul 2024 15:32:07 +1000 (AEST)
Date: Mon, 22 Jul 2024 15:32:06 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 22
Message-ID: <20240722153206.60dd052d@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/5voxWWiN=pRvkl0o8e4me+2";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/5voxWWiN=pRvkl0o8e4me+2
...
Changes since 20240719:

Non-merge commits (relative to Linus' tree): 1694
 1887 files changed, 73020 insertions(+), 27915 deletions(-)
...
Merging origin/master (7846b618e0a4 Merge tag 'rtc-6.11' of git://git.kerne=
l.org/pub/scm/linux/kernel/git/abelloni/linux)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (2cf89193373b alloc_tag: outline a=
nd export free_reserved_page())
Merging vfs-brauner-fixes/vfs.fixes (284004432c83 vfs: correct the comments=
 of vfs_*() helpers)
...
Merging nfsd-fixes/nfsd-fixes (785280973472 sunrpc: avoid -Wformat-security=
 warning)
Merging v9fs-fixes/fixes/next (0c3836482481 Linux 6.10)
Merging overlayfs-fixes/ovl-fixes (77a28aa47687 ovl: relax WARN_ON in ovl_v=
erify_area())
Merging fs-current (4b9298ca36cd Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (d7e78951a8b8 Merge tag 'net-6.11-rc0' of git://git.kernel=
.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (0be9ae5486cd bpf, events: Use prog to emit ksymbol even=
t for main program)
...
Merging sound-current/for-linus (a2d6d8aee4a4 ALSA: hda: tas2781: mark cons=
t variables as __maybe_unused)
Merging sound-asoc-fixes/for-linus (f2038c12e813 ASoC: sof: amd: fix for fi=
rmware reload failure in Vangogh platform)
...
Merging tty.current/tty-linus (3c3ff7be9729 Merge tag 'powerpc-6.11-1' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging usb.current/usb-linus (3c3ff7be9729 Merge tag 'powerpc-6.11-1' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging usb-serial-fixes/usb-linus (c15a688e4998 USB: serial: mos7840: fix =
crash on resume)
Merging phy/fixes (f2661062f16b Linux 6.10-rc5)
Merging staging.current/staging-linus (3c3ff7be9729 Merge tag 'powerpc-6.11=
...
Merging char-misc.current/char-misc-linus (3c3ff7be9729 Merge tag 'powerpc-=
6.11-1' of git://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
...
Merging drm-misc-fixes/for-linux-next-fixes (12c35c5582ac drm/ast: Fix blac=
k screen after resume)
Merging mm-stable/mm-stable (30d77b7eef01 mm/mglru: fix ineffective protect=
ion calculation)
...
Merging mm-nonmm-stable/mm-nonmm-stable (67856f44da38 ia64: scrub ia64 from=
 poison.h)
...
Merging mm/mm-everything (cf03638ca9ed foo)
Merging kbuild/for-next (1a7c8d2459ed kallsyms: change sym_entry::percpu_ab=
solute to bool type)
...
xt)
Merging clk/clk-next (5a6a25ea5bcd clk: sophgo: clk-sg2042-pll: Fix uniniti=
alized variable in debug output)
...
Merging s390/for-next (055500281b2e s390/setup: Fix __pa/__va for modules u=
nder non-GPL licenses)
...
-doc warnings)
Merging cifs/for-next (9e0b2eeece7c cifs: fix potential null pointer use in=
 destroy_workqueue in init_cifs error path)
Merging configfs/for-next (4425c1d9b44d configfs: improve item creation per=
formance)
Merging dlm/next (89b01913dc73 dlm: add rcu_barrier before destroy kmem cac=
he)
Merging erofs/dev (8a3d6d57d111 erofs: support STATX_DIOALIGN)
...
Merging fs-next (ed3ac9f6fd2f Merge branch 'vfs.all' of git://git.kernel.or=
g/pub/scm/linux/kernel/git/vfs/vfs.git)
Merging printk/for-next (07c2ab22a8da Merge branch 'for-6.11' into for-next)
Merging pci/next (45659274e608 Merge branch 'pci/misc')
Merging pstore/for-next/pstore (9b3c13c9ea4e pstore: platform: add missing =
MODULE_DESCRIPTION() macro)
Merging hid/for-next (46b2b1f8a7a0 Merge branch 'for-6.11/upstream-fixes' i=
nto for-next)
...
ove_new)
Merging pm/linux-next (41f11a809ce7 Merge branch 'thermal-fixes' into linux=
-next)
...
iver-fails-to-probe')
Merging bluetooth/master (52828ea60dfd Bluetooth: btmtk: Fix btmtk.c undefi=
ned reference build error)
...
ev())
Merging drm/drm-next (7d4ecf3707b5 Merge tag 'drm-intel-next-fixes-2024-07-=
18' of https://gitlab.freedesktop.org/drm/i915/kernel into drm-next)
...
Merging drm-xe/drm-xe-next (d930c19fdff3 drm/xe: Build PM into GuC CT layer)
...
Merging sound/for-next (a2d6d8aee4a4 ALSA: hda: tas2781: mark const variabl=
es as __maybe_unused)
Merging ieee1394/for-next (06dcc4c9baa9 firewire: core: move copy_port_stat=
us() helper function to TP_fast_assign() block)
Merging sound-asoc/for-next (f2038c12e813 ASoC: sof: amd: fix for firmware =
reload failure in Vangogh platform)
...
Merging block/for-next (bb563f8b667b Merge branch 'for-6.11/block' into for=
-next)
...
10' into spi-linus)
Merging tip/master (5f2105a374ae Merge branch into tip/master: 'x86/mm')
...
Merging usb/usb-next (3c3ff7be9729 Merge tag 'powerpc-6.11-1' of git://git.=
...
Merging tty/tty-next (3c3ff7be9729 Merge tag 'powerpc-6.11-1' of git://git.=
kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
Merging char-misc/char-misc-next (3c3ff7be9729 Merge tag 'powerpc-6.11-1' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/powerpc/linux)
...
Merging staging/staging-next (3c3ff7be9729 Merge tag 'powerpc-6.11-1' of gi=
...

=I1QF
-----END PGP SIGNATURE-----
