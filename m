Return-Path: <linux-next+bounces-5245-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 3404DA14996
	for <lists+linux-next@lfdr.de>; Fri, 17 Jan 2025 07:17:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7D8233A0883
	for <lists+linux-next@lfdr.de>; Fri, 17 Jan 2025 06:16:58 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 46F2C1F7586;
	Fri, 17 Jan 2025 06:17:01 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="tn+YdDG0"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 28DA91F5602;
	Fri, 17 Jan 2025 06:16:55 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1737094621; cv=none; b=f/11aERk1ze2fnDswnpcxkKDLE/+GV8JENRNwgfGN+Y80COjC0HQnpcvcfIURXDmBF4feHOS8/FN7a17GPf2H/R9L+DgECOY5A4IiNfvIzT0eNrxEGm9ytFqfop4zn8eov+pM3Qd1GDFR8WjupVRKy/5FBw1RBwmPTSBnbV6J+M=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1737094621; c=relaxed/simple;
	bh=BgNeBhQTNDljZCsU0FNnGGcDDDLN74ujrtGml622ZUk=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=kxlW4DXk+uIi4atPjraL/cwjEM59e98pCSEw7EOuJevQOYH5T0JRzlYNpF4Zu/qpnXu/hK6w8W4b6HO7/vKxiU186pXv0aBSo67OodtQDEWHgPJDdA7j3HLCFsSuQMs8wC0I+nSo+MewZdCcNq+IDWPnLbsaffX0XnaVn0AcvsE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=tn+YdDG0; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1737094606;
	bh=XP+pQOQVg1ZBdvzeryKsq7YsvupUB8JBGWNjfPXkeIA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4YZ8dV25x2z4wgp;
	Fri, 17 Jan 2025 17:16:46 +1100 (AEDT)
Date: Fri, 17 Jan 2025 17:16:53 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 17
Message-ID: <20250117171653.2e9d09a7@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_95ind.aOGmfSeiAlq5.SvJ";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/_95ind.aOGmfSeiAlq5.SvJ
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250116:
...
Non-merge commits (relative to Linus' tree): 8544
 8635 files changed, 397064 insertions(+), 139201 deletions(-)
...
Merging origin/master (ce69b4019001 Merge tag 'net-6.13-rc8' of git://git.k=
...
tch())
Merging cifs/for-next (c3af3c65ecdc smb: client: fix oops due to unset link=
 speed)
$ git reset --hard HEAD^
Merging next-20250116 version of cifs
...
Merging erofs/dev (41fb0fabc401 erofs: return SHRINK_EMPTY if no objects to=
 free)
...
Merging vfs/for-next (5cc68af412a9 fs/overlayfs/namei.c: get rid of include=
 ../internal.h)
Merging mm-hotfixes/mm-hotfixes-unstable (dfac7a5ad425 mailmap, docs: updat=
e email to carlos.bilbao@kernel.org)
Merging fs-current (768a164c68c7 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (ce69b4019001 Merge tag 'net-6.13-rc8' of git://git.kernel=
...
Merging tip-fixes/tip/urgent (afe325cac424 Merge branch into tip/master: 'x=
86/urgent')
...
Merging mm/mm-everything (7acb844a672d foo)
...
ew discard mode)
Merging arm-soc/for-next (5f74534254f2 soc: document merges)
...
nto tmp/omap-next-20250107.145157)
  77f40f1983c4 ("ARM: dts: ti/omap: omap3-gta04: use proper touchscreen pro=
perties")
...
Merging fs-next (2fa342b1fb22 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging pm/linux-next (116c927d7c15 Merge branches 'pm-cpufreq' and 'pm-sle=
ep' into linux-next)
...
Merging pmdomain/next (9cba6947104a pmdomain: Merge branch fixes into next)
...
Merging rdma/for-next (edc4ef0e0154 RDMA/rxe: Fix the warning "__rxe_cleanu=
p+0x12c/0x170 [rdma_rxe]")
...
Merging net-next/main (2ee738e90e80 Merge git://git.kernel.org/pub/scm/linu=
...
Merging wireless-next/for-next (68abd0c4ebf2 wifi: brcmfmac: fix NULL point=
er dereference in brcmf_txfinalize())
...
ary checking)
Merging drm-misc/for-linux-next (1ee1bb64f718 drm: xlnx: zynqmp_dpsub: Fix =
kernel doc)
...
Merging drm-xe/drm-xe-next (b824709ee1d0 drm/xe: Fix a typo in xe_vm_doc.h)
...
Merging block/for-next (ea228a79af2a Merge branch 'for-6.14/block' into for=
-next)
...
Merging tpmdd/next (bc1f38c38e68 tpm: Map the ACPI provided event log)
...
14' into spi-next)
Merging tip/master (37bc915c6ad0 Merge branch into tip/master: 'x86/tdx')
...
Merging ftrace/for-next (3cb9ca0d12cb Merge tools/for-next)
...
Merging kvm-arm/next (502777ff0cf5 Merge branch kvm-arm64/nv-timers into kv=
marm-master/next)
Merging kvms390/next (430383766377 KVM: s390: move pv gmap functions into k=
vm)
...
ext)
Merging drivers-x86/for-next (d98bf6a6ed61 platform/x86: lenovo-wmi-camera:=
...
out CAP_SYS_ADMIN)
Merging char-misc/char-misc-next (0e7d523b5f7a ntsync: fix a file reference=
 leak in drivers/misc/ntsync.c)
  576a67fbec3d ("dt-bindings: interconnect: qcom-bwmon: Document QCS615 bwm=
on compatibles")
...

=IwXM
-----END PGP SIGNATURE-----
