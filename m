...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 4096E6468DA
	for <lists+linux-next@lfdr.de>; Thu,  8 Dec 2022 07:04:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229564AbiLHGEm (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 8 Dec 2022 01:04:42 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49016 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229612AbiLHGEk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 8 Dec 2022 01:04:40 -0500
Received: from mail-pl1-x635.google.com (mail-pl1-x635.google.com [IPv6:2607:f8b0:4864:20::635])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 39D7B7BC02
        for <linux-next@vger.kernel.org>; Wed,  7 Dec 2022 22:04:37 -0800 (PST)
Received: by mail-pl1-x635.google.com with SMTP id jn7so549126plb.13
        for <linux-next@vger.kernel.org>; Wed, 07 Dec 2022 22:04:37 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=uA2liSBpYOHAAOY3BpPiM1qlF1Oq0IMsRFAZ1PoQdCw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=uA2liSBpYOHAAOY3BpPiM1qlF1Oq0IMsRFAZ1PoQdCw=;
        b=
X-Gm-Message-State: ANoB5pnxWBfO/891SwO4Y/li5Hw+U3ghUmqTnhA8qhacdE/IAGcAcGWZ
        A9CdfR3NpA4Jw5l/ibuemdnbzxu5l6Xjg4z+9AMR9Q==
X-Google-Smtp-Source: AA0mqf5ykS9cj+Tvw36ivQNHV6gYSL+/dN+6fYimypdTPOjZ1mgBYRxz5BMsftuI3BQD7qRGrdXKTA==
X-Received: by 2002:a17:902:c209:b0:189:774d:5a99 with SMTP id 9-20020a170902c20900b00189774d5a99mr1569824pll.49.1670479474667;
        Wed, 07 Dec 2022 22:04:34 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id o8-20020a170902778800b001785fa792f4sm15539798pll.243.2022.12.07.22.04.33
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 07 Dec 2022 22:04:33 -0800 (PST)
Message-ID: <63917e71.170a0220.2f7ef.e235@mx.google.com>
Date:   Wed, 07 Dec 2022 22:04:33 -0800 (PST)
Content-Type: text/plain; charset="utf-8"
MIME-Version: 1.0
Content-Transfer-Encoding: quoted-printable
X-Kernelci-Branch: master
X-Kernelci-Kernel: next-20221208
X-Kernelci-Report-Type: build
X-Kernelci-Tree: next
Subject: next/master build: 233 builds: 14 failed, 219 passed, 69 errors,
 572 warnings (next-20221208)
...
next/master build: 233 builds: 14 failed, 219 passed, 69 errors, 572 warnin=
gs (next-20221208)
...
Tree: next
Branch: master
Git Describe: next-20221208
Git Commit: f925116b24c0c42dc6d5ab5111c55fd7f74e8dc7
...
riscv:
    defconfig: (clang-16) FAIL
    rv32_defconfig: (clang-16) FAIL
...
riscv:
    defconfig (clang-16): 9 errors
    defconfig (gcc-10): 9 errors
    defconfig+debug (gcc-10): 9 errors
    defconfig+kselftest (gcc-10): 9 errors
    rv32_defconfig (clang-16): 9 errors
    rv32_defconfig (gcc-10): 9 errors
...
x86_64:
    allmodconfig (clang-16): 1 error, 4 warnings

Errors summary:

    4    security/apparmor/policy_unpack.c:674:42: error: =E2=80=98TRI_TRUE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:611:42: error: =E2=80=98TRI_TRUE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:559:42: error: =E2=80=98TRI_TRUE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:529:42: error: =E2=80=98TRI_TRUE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:455:42: error: =E2=80=98TRI_TRUE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:331:9: error: =E2=80=98TRI_FALSE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:328:9: error: =E2=80=98TRI_NONE=
=E2=80=99 undeclared (first use in this function); did you mean =E2=80=98IR=
Q_NONE=E2=80=99?
    4    security/apparmor/policy_unpack.c:325:10: error: =E2=80=98TRI_TRUE=
=E2=80=99 undeclared (first use in this function)
    4    security/apparmor/policy_unpack.c:316:18: error: unknown type name=
 =E2=80=98tri=E2=80=99
...
n [-Werror,-Wsometimes-uninitialized]
    2    security/apparmor/policy_unpack.c:674:42: error: use of undeclared=
 identifier 'TRI_TRUE'
    2    security/apparmor/policy_unpack.c:611:42: error: use of undeclared=
 identifier 'TRI_TRUE'
    2    security/apparmor/policy_unpack.c:559:42: error: use of undeclared=
 identifier 'TRI_TRUE'
    2    security/apparmor/policy_unpack.c:529:42: error: use of undeclared=
 identifier 'TRI_TRUE'
    2    security/apparmor/policy_unpack.c:455:42: error: use of undeclared=
 identifier 'TRI_TRUE'
    2    security/apparmor/policy_unpack.c:331:9: error: use of undeclared =
identifier 'TRI_FALSE'
    2    security/apparmor/policy_unpack.c:328:9: error: use of undeclared =
identifier 'TRI_NONE'
    2    security/apparmor/policy_unpack.c:325:10: error: use of undeclared=
 identifier 'TRI_TRUE'
    2    security/apparmor/policy_unpack.c:316:18: error: unknown type name=
 'tri'
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-16) =E2=80=94 FAIL, 1 error, 4 warnings, 0 sect=
ion mismatches
...
---------------------------------------------------------------------------=
-----
defconfig (riscv, clang-16) =E2=80=94 FAIL, 9 errors, 0 warnings, 0 section=
 mismatches

Errors:
    security/apparmor/policy_unpack.c:316:18: error: unknown type name 'tri'
    security/apparmor/policy_unpack.c:325:10: error: use of undeclared iden=
tifier 'TRI_TRUE'
    security/apparmor/policy_unpack.c:328:9: error: use of undeclared ident=
ifier 'TRI_NONE'
    security/apparmor/policy_unpack.c:331:9: error: use of undeclared ident=
ifier 'TRI_FALSE'
    security/apparmor/policy_unpack.c:455:42: error: use of undeclared iden=
tifier 'TRI_TRUE'
    security/apparmor/policy_unpack.c:529:42: error: use of undeclared iden=
tifier 'TRI_TRUE'
    security/apparmor/policy_unpack.c:559:42: error: use of undeclared iden=
tifier 'TRI_TRUE'
    security/apparmor/policy_unpack.c:611:42: error: use of undeclared iden=
tifier 'TRI_TRUE'
    security/apparmor/policy_unpack.c:674:42: error: use of undeclared iden=
tifier 'TRI_TRUE'

---------------------------------------------------------------------------=
-----
defconfig (riscv, gcc-10) =E2=80=94 FAIL, 9 errors, 0 warnings, 0 section m=
ismatches

Errors:
    security/apparmor/policy_unpack.c:316:18: error: unknown type name =E2=
=80=98tri=E2=80=99
    security/apparmor/policy_unpack.c:325:10: error: =E2=80=98TRI_TRUE=E2=
=80=99 undeclared (first use in this function)
    security/apparmor/policy_unpack.c:328:9: error: =E2=80=98TRI_NONE=E2=80=
=99 undeclared (first use in this function); did you mean =E2=80=98IRQ_NONE=
=E2=80=99?
    security/apparmor/policy_unpack.c:331:9: error: =E2=80=98TRI_FALSE=E2=
=80=99 undeclared (first use in this function)
    security/apparmor/policy_unpack.c:455:42: error: =E2=80=98TRI_TRUE=E2=
=80=99 undeclared (first use in this function)
    security/apparmor/policy_unpack.c:529:42: error: =E2=80=98TRI_TRUE=E2=
=80=99 undeclared (first use in this function)
    security/apparmor/policy_unpack.c:559:42: error: =E2=80=98TRI_TRUE=E2=
=80=99 undeclared (first use in this function)
    security/apparmor/policy_unpack.c:611:42: error: =E2=80=98TRI_TRUE=E2=
=80=99 undeclared (first use in this function)
    security/apparmor/policy_unpack.c:674:42: error: =E2=80=98TRI_TRUE=E2=
=80=99 undeclared (first use in this function)
...
---------------------------------------------------------------------------=
-----
defconfig+debug (riscv, gcc-10) =E2=80=94 FAIL, 9 errors, 0 warnings, 0 sec=
tion mismatches
...
---------------------------------------------------------------------------=
-----
defconfig+kselftest (riscv, gcc-10) =E2=80=94 FAIL, 9 errors, 0 warnings, 0=
 section mismatches
...
---------------------------------------------------------------------------=
-----
rv32_defconfig (riscv, clang-16) =E2=80=94 FAIL, 9 errors, 0 warnings, 0 se=
ction mismatches
...
---------------------------------------------------------------------------=
-----
rv32_defconfig (riscv, gcc-10) =E2=80=94 FAIL, 9 errors, 0 warnings, 0 sect=
ion mismatches
