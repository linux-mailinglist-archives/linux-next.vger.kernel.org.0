...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 992AEE6E85
	for <lists+linux-next@lfdr.de>; Mon, 28 Oct 2019 09:52:04 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2387692AbfJ1IwD (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 28 Oct 2019 04:52:03 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:54131 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731992AbfJ1IwC (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Mon, 28 Oct 2019 04:52:02 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 471pP74y2hz9sP3;
        Mon, 28 Oct 2019 19:51:55 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1572252715;
        bh=FWtv5QrRugN/eG/yL4/691wRsylv3Y3sxIc0SgoUZlw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 28 Oct 2019 19:51:54 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 28
Message-ID: <20191028195154.4b6651dd@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/.bxvUJpFOg0tBVZ.V3E8gKQ";
...
The scsi tree inherited the scsi-mkp tree build failure so I applied a
supplied patch.

Non-merge commits (relative to Linus' tree): 6373
 5913 files changed, 230375 insertions(+), 103450 deletions(-)
...
Merging origin/master (d6d5df1db6e9 Linux 5.4-rc5)
...
Merging arm-soc-fixes/arm/fixes (86ec2e1739aa ARM: dts: stm32: relax qspi p=
ins slew-rate for stm32mp157)
...
Merging net/master (fc11078dd351 Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/pablo/nf)
Merging bpf/master (2afd23f78f39 xsk: Fix registration of Rx-only sockets)
Merging ipsec/master (68ce6688a5ba net: sched: taprio: Fix potential intege=
r overflow in taprio_set_picos_per_byte)
Merging netfilter/master (52b33b4f8186 Merge tag 'ipvs-fixes-for-v5.4' of h=
ttps://git.kernel.org/pub/scm/linux/kernel/git/horms/ipvs)
...
Merging rdma-fixes/for-rc (a9018adfde80 RDMA/uverbs: Prevent potential unde=
rflow)
Merging sound-current/for-linus (f2bbdbcb075f ALSA: bebob: Fix prototype of=
 helper function to return negative value)
Merging sound-asoc-fixes/for-linus (5f763bce68ab Merge branch 'asoc-5.4' in=
to asoc-linus)
Merging regmap-fixes/for-linus (da0c9ea146cb Linux 5.4-rc2)
Merging regulator-fixes/for-linus (aeaf6c5495fc Merge branch 'regulator-5.4=
' into regulator-linus)
Merging spi-fixes/for-linus (82f6af0bbc55 Merge branch 'spi-5.4' into spi-l=
inus)
...
Merging usb.current/usb-linus (d6d5df1db6e9 Linux 5.4-rc5)
...
Merging reset-fixes/reset/fixes (b9e9348d381e reset: fix reset_control_get_=
exclusive kerneldoc comment)
...
Merging scsi-fixes/fixes (0cf9f4e547ce scsi: sd: define variable dif as uns=
igned int instead of bool)
Merging drm-fixes/drm-fixes (2a3608409f46 Merge tag 'drm-fixes-5.4-2019-10-=
23' of git://people.freedesktop.org/~agd5f/linux into drm-fixes)
...
_pin_request())
Merging risc-v-fixes/fixes (601a2b660eeb riscv: for C functions called only=
...
Merging drm-misc-fixes/for-linux-next-fixes (29cd13cfd762 drm/v3d: Fix memo=
ry leak in v3d_submit_cl_ioctl)
...
lt BUG_ON(x))
Merging arc/for-next (4f51914dbf5f ARC: nSIM_700: remove unused network opt=
ions)
Merging arm/for-next (d91230f0a3aa Merge branch 'fixes' into for-next)
Merging arm64/for-next/core (ff3fd98661d0 Merge branches 'for-next/elf-hwca=
...
ult', 'for-next/neoverse-n1-stale-instr' and 'for-next/misc' into for-next/=
core)
...
Merging arm-soc/for-next (e0eb651bfacd ARM: Document merges)
...
to for-next)
Merging samsung-krzk/for-next (5846cab6e022 Merge branch 'next/dt' into for=
-next)
...
into sunxi/for-next)
Merging tegra/for-next (2122527303a6 Merge branch for-5.5/clk into for-next)
...
Merging clk-samsung/for-next (e9323b664ce2 clk: samsung: exynos5420: Preser=
ve PLL configuration during suspend/resume)
...
_del)
Merging risc-v/for-next (4f10f3dfa0b0 Merge branch 'next/tlb-opt' into dev/=
riscv/for-v5.5-rc1)
...
ion)
Merging nfs/linux-next (7d194c2100ad Linux 5.4-rc4)
...
Merging xfs/for-next (3dd4d40b4208 xfs: Sanity check flags of Q_XQUOTARM ca=
ll)
...
in imxfb_probe())
Merging pm/linux-next (78f25df384a8 Merge branch 'pm-cpuidle' into linux-ne=
xt)
...
Merging net-next/master (5b7fe93db008 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/bpf/bpf-next)
CONFLICT (content): Merge conflict in include/linux/netdevice.h
Merging bpf-next/master (5b7fe93db008 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/bpf/bpf-next)
...
Merging netfilter-next/master (b951248518e6 tc-testing: list required kerne=
l options for act_ct action)
...
ad)
Merging drm/drm-next (3275a71e76fa Merge tag 'drm-next-5.5-2019-10-09' of g=
...
Merging amdgpu/drm-next (25e5a57e06a7 drm/amdgpu: work around llvm bug #425=
76)
...
n.c
Merging drm-tegra/drm/tegra/for-next (4cf9dce84820 drm/tegra: sor: Introduc=
e audio enable/disable callbacks)
Merging drm-misc/for-linux-next (588b9828f074 drm: Don't free jobs in wait_=
event_interruptible())
...
Merging sound/for-next (0a671dc50055 ALSA: intel_hdmi: Remove dev_err() on =
platform_get_irq() failure)
Merging sound-asoc/for-next (39fe61041d6b Merge branch 'asoc-5.5' into asoc=
-next)
...
Merging input/next (78e45917bf7a Input: wacom_i2c - remove unneeded gpio.h =
header file)
Merging block/for-next (f32a94798bb3 Merge branch 'for-5.5/io_uring-test' i=
nto for-next)
$ git reset --hard HEAD^
Merging next-20191025 version of block
CONFLICT (content): Merge conflict in fs/io_uring.c
[master 27caa3c2cd42] next-20191025/block
...
Merging regulator/for-next (22406bc9d513 Merge branch 'regulator-5.5' into =
regulator-next)
...
Merging audit/next (c34c78dfc1fc audit: remove redundant condition check in=
 kauditd_thread())
Merging devicetree/for-next (52ac2f9d54fc MAINTAINERS: update the list of m=
...
register value)
Merging spi/for-next (c6bd9e110ce9 Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
...
Merging kvm-arm/next (a4b28f5c6798 Merge remote-tracking branch 'kvmarm/kvm=
-arm64/stolen-time' into kvmarm-master/next)
...
Merging scsi/for-next (ca8fc44db49b Merge branch 'misc' into for-next)
Applying: lpfc: fix build error of lpfc_debugfs.c for vfree/vmalloc
Merging scsi-mkp/for-next (b48c8f0dd657 Merge branch '5.4/scsi-fixes' into =
5.5/scsi-next)
Merging vhost/linux-next (c69f648e1214 vhost: last descriptor must have NEX=
T clear)
...
Merging kgdb/kgdb/for-next (d07ce4e32a8d kdb: Avoid array subscript warning=
s on non-SMP builds)
...
rflow
Merging akpm/master (94f5c9252858 drivers/media/platform/sti/delta/delta-ip=
...

=pk7k
-----END PGP SIGNATURE-----
