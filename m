...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 26BBD36E47C
	for <lists+linux-next@lfdr.de>; Thu, 29 Apr 2021 07:27:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229814AbhD2F23 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 29 Apr 2021 01:28:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33278 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229792AbhD2F22 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 29 Apr 2021 01:28:28 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B0D4DC06138B;
        Wed, 28 Apr 2021 22:27:36 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4FW3sx0z6Mz9sVv;
        Thu, 29 Apr 2021 15:27:33 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1619674053;
        bh=j9CGI7oz/uXqkvONrrEieazT2iOTJX66lvp3LfLhHLE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 29 Apr 2021 15:27:31 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 29
Message-ID: <20210429152731.0bb23d49@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/EeLCcyJleUp.jIx+kqtCtyP";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/EeLCcyJleUp.jIx+kqtCtyP
...
Changes since 20210428:

Non-merge commits (relative to Linus' tree): 7662
 6582 files changed, 330317 insertions(+), 108383 deletions(-)
...
Merging origin/master (16b3d0cf5bad Merge tag 'sched-core-2021-04-28' of gi=
...
Merging net/master (bbd6f0a94813 bnxt_en: Fix RX consumer index logic in th=
e error path.)
Merging bpf/master (bbd6f0a94813 bnxt_en: Fix RX consumer index logic in th=
e error path.)
Merging ipsec/master (b515d2637276 xfrm: xfrm_state_mtu should return at le=
ast 1280 for ipv6)
Merging netfilter/master (bbd6f0a94813 bnxt_en: Fix RX consumer index logic=
 in the error path.)
...
Merging sound-current/for-linus (a3ffcebc8748 ALSA: usb-audio: Remove redun=
dant assignment to len)
...
Merging spi-fixes/for-linus (7481525ac659 Merge remote-tracking branch 'spi=
/for-5.13' into spi-linus)
Merging pci-current/for-linus (cf673bd0cc97 PCI: switchtec: Fix Spectre v1 =
vulnerability)
Merging driver-core.current/driver-core-linus (acd3d2859453 Merge tag 'fixe=
s-v5.13' of git://git.kernel.org/pub/scm/linux/kernel/git/jmorris/linux-sec=
urity)
...
Merging staging.current/staging-linus (4a0225c3d208 Merge tag 'spi-v5.13' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/broonie/spi)
Merging iio-fixes/fixes-togreg (4d28b580e80a iio: core: fix ioctl handlers =
removal)
Merging char-misc.current/char-misc-linus (8e3a3249502d Merge tag 'char-mis=
c-5.13-rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gregkh/char-mi=
sc)
...
o not link ".*,nr-gpios")
Merging scsi-fixes/fixes (e4ec10228fdf scsi: lpfc: Fix bad memory access du=
ring VPD DUMP mailbox command)
...
or-next)
Merging arm64/for-next/core (2a20b08f06e7 ACPI: irq: Prevent unregistering =
of GIC SGIs)
...
r-next)
Merging scmi/for-linux-next (9f4ad9e425a1 Linux 5.12)
...
Merging csky/linux-next (e58a41c22268 csky: uaccess.h: Coding convention wi=
th asm generic)
...
r file inclusion)
Merging parisc-hd/for-next (adf27404e8a0 parisc: syscalls: switch to generi=
c syscallhdr.sh)
Merging powerpc/next (ee1bc694fbae powerpc/kvm: Fix build error when PPC_ME=
M_KEYS/PPC_PSERIES=3Dn)
Merging fsl/next (a76bea0287ce powerpc/kmcent2: add ranges to the pci bridg=
es)
Merging soc-fsl/next (242b0b398ccd soc: fsl: enable acpi support in RCPM dr=
iver)
Merging risc-v/for-next (df29598aaf5c MAINTAINERS: add microchip polarfire =
soc support)
...
Merging s390/for-next (6daa755f813e Merge tag 's390-5.13-1' of git://git.ke=
...
Merging ceph/master (7856ec4e9ccf Merge commit 'ed94f87c2b123241ae5644cf823=
27e2da653adb6')
Merging cifs/for-next (9d637eda5858 Cifs: Fix kernel oops caused by deferre=
d close for files.)
...
Merging pci/next (26622d60c18f Merge branch 'pci/tegra')
...
ver)
Merging jc_docs/docs-next (80342d484afc kernel-doc: Add support for __depre=
cated)
...
in imxfb_probe())
Merging pm/linux-next (f0728bfeb21a Merge tag 'devprop-5.13-rc1' of git://g=
...
pt_from_sock())
Merging swiotlb/linux-next (95b079d8215b swiotlb: Fix the type of index)
Merging rdma/for-next (6cc9e215eb27 RDMA/nldev: Add copy-on-fork attribute =
to get sys command)
CONFLICT (content): Merge conflict in drivers/infiniband/hw/hfi1/hfi.h
Merging net-next/master (4a52dd8fefb4 net: selftest: fix build issue if INE=
T is disabled)
...
Merging bpf-next/for-next (4a52dd8fefb4 net: selftest: fix build issue if I=
NET is disabled)
...
lated bits)
Merging netfilter-next/master (99ba0ea616aa sfc: adjust efx->xdp_tx_queue_c=
ount with the real number of initialized queues)
Merging ipvs-next/master (e9377a911d77 ethtool: add missing EEPROM to list =
of messages)
...
n CRYPTO_SHA256)
Merging drm/drm-next (a1a1ca70deb3 Merge tag 'drm-misc-next-fixes-2021-04-2=
2' of git://anongit.freedesktop.org/drm/drm-misc into drm-next)
Applying: merge fix for "drm: Switch to %p4cc format modifier"
Merging drm-misc/for-linux-next (74deef03a44a efifb: Check efifb_pci_dev be=
fore using it)
Merging amdgpu/drm-next (2d571da89389 drm/amdgpu/display: add documentation=
 for dmcub_trace_event_en)
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/display/amdgpu_dm=
/amdgpu_dm.c
Merging drm-intel/for-linux-next (270e3cc5aa38 drm/i915: Fix docbook descri=
ptions for i915_gem_shrinker)
...
Merging sound/for-next (e861431303d2 ALSA: virtio: fix kernel-doc)
...
Merging block/for-next (fe324cc61c3c Merge branch 'io_uring-5.13' into for-=
next)
...
Merging spi/for-next (7481525ac659 Merge remote-tracking branch 'spi/for-5.=
13' into spi-linus)
Merging tip/auto-latest (eb4fae8d3b9e Merge tag 'v5.12')
CONFLICT (content): Merge conflict in arch/x86/include/asm/cpu.h
...
c-for-next)
Merging irqchip/irq/irqchip-next (debf69cfd4c6 irqchip/xilinx: Expose Kconf=
ig option for Zynq/ZynqMP)
...
Merging rcu/rcu/next (7982b0dd319f Merge branch 'clocksource.2021.04.25a' i=
nto HEAD)
...
Merging driver-core/driver-core-next (acd3d2859453 Merge tag 'fixes-v5.13' =
...
Merging staging/staging-next (4a0225c3d208 Merge tag 'spi-v5.13' of git://g=
...
Merging akpm/master (340bb1c800da memfd_secret: use unsigned int rather tha=
...

=dLMF
-----END PGP SIGNATURE-----
