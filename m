...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5B864CB445
	for <lists+linux-next@lfdr.de>; Fri,  4 Oct 2019 07:59:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728441AbfJDF7h (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 4 Oct 2019 01:59:37 -0400
Received: from ozlabs.org ([203.11.71.1]:48279 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728264AbfJDF7g (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 4 Oct 2019 01:59:36 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46kzjF4C1Yz9sCJ;
        Fri,  4 Oct 2019 15:59:29 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1570168769;
        bh=wXONu2aU1ALbT4uPsP6QPEDbuX5ShQZx7Egcw5WECWw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 4 Oct 2019 15:59:29 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 4
Message-ID: <20191004155929.3ac043b5@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/aPuAWXN2BUsPGp8+6O5yrSe";
...
Merging origin/master (cc3a7bfe62b9 vfs: Fix EOVERFLOW testing in put_compa=
t_statfs64)
...
_valid of arm)
Merging arm-soc-fixes/arm/fixes (bcec1221c945 Merge tag 'omap-for-v5.4/fixe=
...
Merging net/master (3afb09618840 tcp: fix slab-out-of-bounds in tcp_zerocop=
y_receive())
...
Merging netfilter/master (134cc4cefad3 net: stmmac: Avoid deadlock on suspe=
nd/resume)
...
Merging mips-fixes/mips-fixes (25b69a889b63 mips: Loongson: Fix the link ti=
me qualifier of 'serial_exit()')
...
Merging hwmon-fixes/hwmon (6bbfdcbc8e45 hwmon: (nct7904) Add array fan_alar=
m and vsen_alarm to store the alarms in nct7904_data struct.)
...
efile for clang)
Merging drm-intel-fixes/for-linux-next-fixes (485f682be9fc Revert "drm/i915=
...
r device tree blob)
Merging pidfd-fixes/fixes (78f6face5af3 sched: add kernel-doc for struct cl=
one_args)
...
Merging arm-soc/for-next (b7f1866c1782 Merge branch 'arm/fixes' into for-ne=
xt)
Merging actions/for-next (fb9c1c1deb5e Merge branch 'v4.20/drivers+s900-sps=
' into next)
Merging amlogic/for-next (1811b8867712 Merge branch 'v5.5/dt64' into tmp/am=
l-rebuild)
...
support)
Merging rockchip/for-next (7157e50bf728 Merge branch 'v5.4-armsoc/dtsfixes'=
 into for-next)
...
_fs_client)
Merging cifs/for-next (a860055e6b09 fs: cifs: mute -Wunused-const-variable =
message)
...
Merging hid/for-next (e4dfa33d8c6e Merge branch 'for-5.5/logitech' into for=
-next)
$ git reset --hard HEAD^
...
Merging hwmon-staging/hwmon-next (56ef4d6aa440 hwmon: (applesmc) switch to =
using input device polling mode)
Merging jc_docs/docs-next (185271a1fa07 riscv-docs: correct the sequence of=
 the magic number 2 since it's little endian)
...
Merging net-next/master (9077f052abd5 net: propagate errors correctly in re=
gister_netdevice())
Merging bpf-next/master (c58814637896 selftests/bpf: Correct path to includ=
e msg + path)
...
Merging mlx5-next/mlx5-next (fc603294267f net/mlx5: Set only stag for match=
 untagged packets)
Merging netfilter-next/master (fab401e1ee96 net/rds: Log vendor error if se=
nd/recv Work requests fail)
Merging nfc-next/master (1f008cfec5d5 NFC: fdp: Fix unused variable warning=
s)
CONFLICT (content): Merge conflict in drivers/nfc/st21nfca/se.c
Merging ipvs-next/master (e5dc8d0d2672 ipvs: batch __ip_vs_dev_cleanup)
Merging wireless-drivers-next/master (97ef12263fce Merge ath-next from git:=
...
Merging amdgpu/drm-next (c51785b9be2b drm/amdgpu/powerplay: fix typo in mvd=
d table setup)
...
of cleanup code)
Merging drm-misc/for-linux-next (4092de1ba34e Merge drm/drm-next into drm-m=
isc-next)
...
er)
Merging mfd/for-mfd-next (81281b0a477c mfd: intel-lpss: Add default I2C dev=
ice properties for Gemini Lake)
...
Merging kvm/linux-next (fd3edd4a9066 KVM: nVMX: cleanup and fix host 64-bit=
 mode checks)
Merging kvm-arm/next (14933b51fbe7 KVM: arm64: pmu: Fix cycle counter trunc=
ation on counter stop)
...
derX2)
Merging rtc/rtc-next (1e2c8aadedbe rtc: cmos: fix the AltCentury value on A=
MD/Hygon platform)
...
rflow
Merging akpm/master (d9e39da22050 drivers/media/platform/sti/delta/delta-ip=
...

=Suwe
-----END PGP SIGNATURE-----
