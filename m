...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 83E39159F5C
	for <lists+linux-next@lfdr.de>; Wed, 12 Feb 2020 04:00:24 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727649AbgBLC6p (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 11 Feb 2020 21:58:45 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:46481 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1727608AbgBLC6p (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 11 Feb 2020 21:58:45 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48HPV56rvSz9s3x;
        Wed, 12 Feb 2020 13:58:37 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1581476318;
        bh=FVyVPMK+9rh8xGLDZiTUjo+eEFf3O/etdcg9d0WqLNQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 12 Feb 2020 13:58:36 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 12
Message-ID: <20200212135836.5b03e755@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/QlTubLY6xmoe3icZKrYEfb_";
...
Merging origin/master (0a679e13ea30 Merge branch 'for-5.6-fixes' of git://g=
...
nfig options)
Merging arm64-fixes/for-next/fixes (74a44bed8d93 arm64: Fix CONFIG_ARCH_RAN=
DOM=3Dn build)
...
rfaces)
Merging bpf/master (30744a68626d xsk: Publish global consumer pointers when=
 NAPI is finished)
...
Merging sound-current/for-linus (93f9d1a4ac59 ALSA: usb-audio: Apply sample=
 rate quirk for Audioengine D1)
...
Merging tty.current/tty-linus (3f4ef485be9d vt: fix scrollback flushing on =
background consoles)
...
e release)
Merging hwmon-staging/hwmon-next (10c3bf052672 bindings: (hwmon/ltc2978.txt=
...
in imxfb_probe())
Merging pm/linux-next (38c78de71ce8 Merge branches 'acpi-watchdog' and 'pm-=
acpi' into linux-next)
...
Merging amdgpu/drm-next (cedba3cbcb7c drm/amdgpu: drop legacy drm load and =
unload callbacks)
$ git reset --hard HEAD^
Merging next-20200211 version of amdgpu
Merging drm-intel/for-linux-next (e4edd4fcbf4d drm/i915: Check activity on =
i915_vma after confirming pin_count=3D=3D0)
...
rflow
Merging akpm/master (2c01de8da834 drivers/media/platform/sti/delta/delta-ip=
...

=gJvA
-----END PGP SIGNATURE-----
