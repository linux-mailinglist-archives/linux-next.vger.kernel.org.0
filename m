...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1ECDD76DF6F
	for <lists+linux-next@lfdr.de>; Thu,  3 Aug 2023 06:36:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230369AbjHCEgT (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 3 Aug 2023 00:36:19 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41140 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230209AbjHCEgS (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 3 Aug 2023 00:36:18 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 28BFD10CA;
        Wed,  2 Aug 2023 21:36:14 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1691037368;
        bh=Q18HkfefzSjrG/pu3XzIfc1v7zfNnwpSAMnZGQEeQWo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RGbdM6sXcz4wqW;
        Thu,  3 Aug 2023 14:36:07 +1000 (AEST)
Date:   Thu, 3 Aug 2023 14:36:05 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 3
Message-ID: <20230803143605.41bce779@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/72aL2JJ.JtpYQpD5TOXtFX1";
...
--Sig_/72aL2JJ.JtpYQpD5TOXtFX1
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20230802:

The ti tree gained a conflict against the imx-mxs tree.

The vfs-brauner tree gained a semantic conflict against the ext3 tree.

The block tree gained a conflict against the djw-vfs tree.

Non-merge commits (relative to Linus' tree): 6161
 7869 files changed, 217730 insertions(+), 96181 deletions(-)
...
Merging origin/master (4b954598a47b Merge tag 'exfat-for-6.5-rc5' of git://=
...
mbx")
Merging mm-hotfixes/mm-hotfixes-unstable (6c4df4048506 mm/damon/core: initi=
...
Merging net/main (0756384fb1bd vxlan: Fix nexthop hash size)
...
linus)
Merging sound-asoc-fixes/for-linus (613fcf307158 Merge remote-tracking bran=
...
Merging drm-misc-fixes/for-linux-next-fixes (c71b7aa8619a drm/panel: samsun=
g-s6d7aa0: Add MODULE_DEVICE_TABLE)
Merging mm-stable/mm-stable (6eaae1980760 Linux 6.5-rc3)
Merging mm-nonmm-stable/mm-nonmm-stable (6eaae1980760 Linux 6.5-rc3)
Merging mm/mm-everything (2d438ed70c51 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging perf/perf-tools-next (76efcf004289 perf vendor events intel: Update=
 Icelake+ metric constraints)
...
tdev_vlan_ipv6())
Merging net-next/main (30ff01ee99bc pds_core: Fix documentation for pds_cli=
ent_register)
...
Merging bpf-next/for-next (87dc2bb32918 Merge branch 'bpf-xdp-add-tracepoin=
t-to-xdp-attaching-failure')
...
Merging wireless-next/for-next (288c63d5cb46 wifi: mwifiex: fix error recov=
ery in PCIE buffer descriptor management)
...
Merging drm-misc/for-linux-next (cc69c93bcb50 accel/qaic: remove redundant =
pointer pexec)
...
ort)
Merging drm-msm-lumag/msm-next-lumag (08bfcdc2c358 drm/msm/dpu: increase me=
mtype count to 16 for sm8550)
...
Merging sound-asoc/for-next (a8dc5097d92a Merge remote-tracking branch 'aso=
c/for-6.6' into asoc-next)
Merging modules/modules-next (9011e49d54dc modules: only allow symbol_get o=
f EXPORT_SYMBOL_GPL modules)
Merging input/next (54116d442e00 Input: rpckbd - fix the return value handl=
e for platform_get_irq())
Merging block/for-next (473ddd99450c Merge branch 'for-6.6/io_uring' into f=
or-next)
...
6' into spi-next)
Merging tip/master (a5f24614110e Merge branch into tip/master: 'x86/core')
...
Merging kvm-riscv/riscv_kvm_next (07f225b58424 RISC-V: KVM: Remove unneeded=
 semicolon)
Merging kvm-x86/next (74c2185c5b74 Merge branches 'misc', 'mmu', 'selftests=
', 'svm', 'vmx' and 'pmu')
...

=MupN
-----END PGP SIGNATURE-----
