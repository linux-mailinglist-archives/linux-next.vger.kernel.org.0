...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C88DDEAAC1
	for <lists+linux-next@lfdr.de>; Thu, 31 Oct 2019 07:52:33 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726490AbfJaGwc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 31 Oct 2019 02:52:32 -0400
Received: from ozlabs.org ([203.11.71.1]:47935 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726479AbfJaGwc (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 31 Oct 2019 02:52:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 473bbt2FhSz9sP4;
        Thu, 31 Oct 2019 17:52:26 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1572504746;
        bh=QMIOzf2nflD41eVFrmJX534/LoUtnuuIyG+DEufde84=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 31 Oct 2019 17:52:24 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 31
Message-ID: <20191031175224.2e313bef@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ywMCGV1a.Q.ziJ.uZ7jzxdZ";
...
Non-merge commits (relative to Linus' tree): 7206
 6591 files changed, 270169 insertions(+), 118425 deletions(-)
...
Merging origin/master (320000e72ec0 Merge tag 'iommu-fixes-v5.4-rc5' of git=
...
Merging net/master (b7265a0df82c mlxsw: core: Unpublish devlink parameters =
during reload)
Merging bpf/master (7541c87c9b7a bpf: Allow narrow loads of bpf_sysctl fiel=
ds with offset > 0)
...
q->buf_list)
Merging sound-current/for-linus (302d5a80d232 ALSA: hda - Fix mutex deadloc=
k in HDMI codec driver)
Merging sound-asoc-fixes/for-linus (26c83a427603 Merge branch 'asoc-5.4' in=
to asoc-linus)
...
Merging spi-fixes/for-linus (6daec2f11be4 Merge branch 'spi-5.4' into spi-l=
inus)
...
Merging usb.current/usb-linus (94e259f81a71 usb: cdns3: gadget: Fix g_audio=
 use case when connected to Super-Speed host)
...
efile for clang)
Merging drm-intel-fixes/for-linux-next-fixes (59cd826fb5e7 drm/i915: Fix PC=
H reference clock for FDI on HSW/BDW)
...
Merging dma-mapping/for-next (ca66536845cd kernel: dma-contiguous: mark CMA=
 parameters __initdata/__initconst)
...
Merging arm/for-next (dced4c0e705c ARM: 8928/1: ARM_ERRATA_775420: Spelling=
 s/date/data/)
Merging arm64/for-next/core (84ec93433092 Merge branches 'for-next/elf-hwca=
...
p)
Merging parisc-hd/for-next (3d252454edd0 parisc: fix frame pointer in ftrac=
e_regs_caller())
...
ptfs_init_messaging())
Merging erofs/dev (f0a6634246f9 erofs: support superblock checksum)
Merging ext3/for_next (e03bf86ce045 Pull ext2 allocation fix from Chengguan=
g.)
...
Merging xfs/for-next (21f55993eb7a xfs: merge xfs_showargs into xfs_fs_show=
_options)
...
linux-next)
Merging thermal/thermal/linux-next (5803b42be4e9 thermal: no need to set .o=
...
Merging net-next/master (c4917bfc3a6f tc-testing: fixed two failing pedit t=
ests)
CONFLICT (content): Merge conflict in include/linux/netdevice.h
Merging bpf-next/master (cf204a718357 bpf, testing: Introduce 'gso_linear_n=
o_head_frag' skb_segment test)
...
ad)
Merging drm/drm-next (57c2af791b6c Merge tag 'topic/mst-suspend-resume-repr=
obe-2019-10-29-2' of git://anongit.freedesktop.org/drm/drm-misc into drm-ne=
xt)
...
Merging drm-misc/for-linux-next (fae7d7d5f374 Revert "dma-buf: Add dma-buf =
heaps framework")
...
Merging sound/for-next (0929249e3be3 ALSA: firewire-motu: Correct a typo in=
 the clock proc string)
Merging sound-asoc/for-next (b31b51abc493 Merge branch 'asoc-5.5' into asoc=
-next)
...
Merging input/next (78713dfade75 Input: kxtj9 - switch to using polled mode=
 of input devices)
Merging block/for-next (a097567ae349 Merge branch 'for-5.5/io_uring' into f=
or-next)
...
register value)
Merging spi/for-next (543f0615832d Merge remote-tracking branch 'spi/topic/=
ptp' into spi-next)
Merging tip/auto-latest (785ea1a3dae1 Merge branch 'linus')
...
ute for devices)
Merging staging/staging-next (09ef6fde7d89 staging: kpc2000: kpc_i2c: Remov=
e commented code)
...
Merging hmm/hmm (ac541f250372 mm/hmm: allow snapshot of the special zero pa=
ge)
...
rflow
Merging akpm/master (528ab4a96af0 drivers/media/platform/sti/delta/delta-ip=
...

=N4d1
-----END PGP SIGNATURE-----
