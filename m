...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 1CA513B1A39
	for <lists+linux-next@lfdr.de>; Wed, 23 Jun 2021 14:33:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230182AbhFWMed (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 23 Jun 2021 08:34:33 -0400
Received: from ozlabs.org ([203.11.71.1]:37827 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S230286AbhFWMec (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 23 Jun 2021 08:34:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4G92hX51FVz9t2p;
        Wed, 23 Jun 2021 22:32:12 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1624451532;
        bh=gSiSvhxIiOJww4YpG/3swztXK1x/iVqs5vDl75Ex/iY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 23 Jun 2021 22:32:08 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jun 23
Message-ID: <20210623223208.7df2d4c6@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/=xOy4nLc7N/Nfx0OPueQxq8";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/=xOy4nLc7N/Nfx0OPueQxq8
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210622:

This tree fails its modules_install test.

The f2fs tree gained a semantic conflict against the ext3 tree for which
...
The kvm-arm tree gained conflicts against the arm64, powerpc and kvm trees.

The akpm-current tree gained conflicts against the printk tree.

The akpm tree still had its build failures.

Non-merge commits (relative to Linus' tree): 11602
 10872 files changed, 712447 insertions(+), 324645 deletions(-)
...
Merging origin/master (0c18f29aae7c module: limit enabling module.sig_enfor=
ce)
...
Merging net/master (ce8eb4c728ef net: ti: am65-cpsw-nuss: Fix crash when ch=
anging number of TX queues)
Merging bpf/master (7506d211b932 bpf: Fix null ptr deref with mixed tail ca=
lls and subprogs)
...
q_timer_open())
Merging sound-asoc-fixes/for-linus (d0e142724c73 Merge remote-tracking bran=
ch 'asoc/for-5.13' into asoc-linus)
Merging regmap-fixes/for-linus (614124bea77e Linux 5.13-rc5)
Merging regulator-fixes/for-linus (a43ccca51aa0 Merge remote-tracking branc=
h 'regulator/for-5.13' into regulator-linus)
Merging spi-fixes/for-linus (014eba8ce7fd Merge remote-tracking branch 'spi=
...
Merging kspp-gustavo/for-next/kspp (0678371bf1a8 Merge branch 'for-next/War=
...
ent.c)
Merging cifs/for-next (7c3cbf7dbc5d cifs: remove two cases where rc is set =
unnecessarily in sid_to_id)
...
fat_readdir())
Merging ext3/for_next (102afe98cb1a Pull hole punch fixes.)
...
A pool)
Merging rdma/for-next (20ec0a6d6016 RDMA/rxe: Don't overwrite errno from ib=
_umem_get())
CONFLICT (content): Merge conflict in drivers/infiniband/sw/rxe/rxe_comp.c
Merging net-next/master (38f75922a690 Merge branch 'mptcp-C-flag-and-fixes')
...
ink-trap.rst
Merging bpf-next/for-next (ee62a5c6bb10 libbpf: Switch to void * casting in=
 netlink helpers)
...
Merging wireless-drivers-next/master (829eea7c94e0 mt7601u: add USB device =
ID for some versions of XiaoDu WiFi Dongle.)
...
Merging sound/for-next (8c1321244323 ALSA: hda: Add IRQ check for platform_=
get_irq())
Merging sound-asoc/for-next (2a6c47512c77 Merge remote-tracking branch 'aso=
...
Merging block/for-next (a33615e559e4 Merge branch 'for-5.14/io_uring' into =
for-next)
...
Merging regulator/for-next (fe423b98b360 Merge remote-tracking branch 'regu=
...
Merging spi/for-next (4d43e6911818 Merge remote-tracking branch 'spi/for-5.=
14' into spi-next)
...
Merging kvms390/next (c6e183701d62 KVM: s390: allow facility 192 (vector-pa=
...
Merging akpm/master (986fad968b7c afs: fix tracepoint string placement with=
 built-in AFS)
...

=1DEP
-----END PGP SIGNATURE-----
