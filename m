...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3B9264478F6
	for <lists+linux-next@lfdr.de>; Mon,  8 Nov 2021 04:51:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235603AbhKHDx4 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 7 Nov 2021 22:53:56 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:57757 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234035AbhKHDx4 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 7 Nov 2021 22:53:56 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Hncbf3Mt0z4xdJ;
        Mon,  8 Nov 2021 14:51:10 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1636343470;
        bh=/rSnO621mgTLOliftcp2KC8BmaaeDD8VK4PFFJDDw8s=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 8 Nov 2021 14:51:08 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 8
Message-ID: <20211108145108.1585f2c5@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/ApkeCEBqLByp+4nWQmo4BR3";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/ApkeCEBqLByp+4nWQmo4BR3
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20211106:

The pci tree gained a build failure for which I applied a merge fix patch.

The drm-misc tree gained a conflict against the origin tree.

I have disabled the ntfs file system write capabaility for now as it
fails for builds with 64k pages.

Non-merge commits (relative to Linus' tree): 1785
 2133 files changed, 100023 insertions(+), 40256 deletions(-)
...
Merging origin/master (6b75d88fa81b Merge branch 'i2c/for-current' of git:/=
...
Merging net/master (9fec40f85065 nfc: pn533: Fix double free when pn533_fil=
l_fragment_skbs() fails)
Merging bpf/master (47b3708c6088 Merge branch 'bpf: Fix out-of-bound issue =
when jit-ing bpf_pseudo_func')
...
ubtraction warning)
Merging mac80211/master (436014e860d3 Merge branch 'mctp-sockaddr-padding-c=
heck-initialisation-fixup')
Merging rdma-fixes/for-rc (4f960393a0ee RDMA/qedr: Fix NULL deref for query=
_qp on the GSI QP)
Merging sound-current/for-linus (8e537d5dec34 ALSA: PCM: Fix NULL dereferen=
ce at mmap checks)
...
Merging driver-core.current/driver-core-linus (b5013d084e03 Merge tag '5.16=
-rc-part1-smb3-client-fixes' of git://git.samba.org/sfrench/cifs-2.6)
Merging tty.current/tty-linus (b5013d084e03 Merge tag '5.16-rc-part1-smb3-c=
...
Merging staging.current/staging-linus (b5013d084e03 Merge tag '5.16-rc-part=
1-smb3-client-fixes' of git://git.samba.org/sfrench/cifs-2.6)
...
Merging erofs-fixes/fixes (c186b38dc7f9 erofs: fix unsafe pagevec reuse of =
hooked pclusters)
...
Merging memblock-fixes/fixes (b484d7f223db arm64: Track no early_pgtable_al=
loc() for kmemleak)
...
tion)
Merging cifs/for-next (c9f1c19cf7c5 cifs: nosharesock should not share sock=
et with future sessions)
...
Merging gfs2/for-next (f3506eee81d1 gfs2: Fix length of holes reported at e=
nd-of-file)
Merging jfs/jfs-next (c48a14dca2cb JFS: fix memleak in jfs_mount)
Merging ksmbd/ksmbd-for-next (79364beea4d1 ksmbd: Use the SMB3_Create defin=
itions from the shared)
Merging nfs/linux-next (aa97a3ef15c3 NFSv4.2: alloc_file_pseudo() takes an =
open flag, not an f_mode)
...
for pkcs1pad)
Merging drm/drm-next (806acd381960 Merge tag 'amd-drm-fixes-5.16-2021-11-03=
' of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
Applying: drm/locking: fix for name conflict
Merging drm-misc/for-linux-next (14d9a37c9525 Revert "drm/imx: Annotate dma=
-fence critical section in commit path")
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/amdgpu/amdgpu_gem=
.c
Merging amdgpu/drm-next (0e502fb10d8e drm/amdgpu: bump driver version for I=
...
Merging sound/for-next (8e537d5dec34 ALSA: PCM: Fix NULL dereference at mma=
p checks)
...
Merging block/for-next (2d81841aa5c3 Merge branch 'for-5.16/drivers' into f=
or-next)
...
Merging driver-core/driver-core-next (b5013d084e03 Merge tag '5.16-rc-part1=
-smb3-client-fixes' of git://git.samba.org/sfrench/cifs-2.6)
...
Merging tty/tty-next (b5013d084e03 Merge tag '5.16-rc-part1-smb3-client-fix=
es' of git://git.samba.org/sfrench/cifs-2.6)
...
ated_iommu_dev())
Merging staging/staging-next (b5013d084e03 Merge tag '5.16-rc-part1-smb3-cl=
...
Merging scsi-mkp/for-next (3344b58b53a7 scsi: scsi_debug: Don't call kcallo=
c() if size arg is zero)
...
Merging userns/for-next (a21aa98d069a Merge of per_signal_struct_coredumps-=
...
Merging akpm-current/current (8cfbd4096945 kernel.h: split out instruction =
pointer accessors)
...
Merging akpm/master (cb3cc26151a9 kasan: add kasan mode messages when kasan=
 init)
...

=toq6
-----END PGP SIGNATURE-----
