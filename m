...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id BC22C56302D
	for <lists+linux-next@lfdr.de>; Fri,  1 Jul 2022 11:34:23 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231503AbiGAJdl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 1 Jul 2022 05:33:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53254 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232029AbiGAJdk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 1 Jul 2022 05:33:40 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3887274377;
        Fri,  1 Jul 2022 02:33:36 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4LZ94G2204z4xXF;
        Fri,  1 Jul 2022 19:33:34 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1656668014;
        bh=x039w4M2XYD/+eyeFGuBkE6QryRQhVpphOGnQvGmf24=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 1 Jul 2022 19:33:32 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 1
Message-ID: <20220701193332.0de68d98@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/+7dcTTDM6hpL9X=znbFQ=+L";
...
--Sig_/+7dcTTDM6hpL9X=znbFQ=+L
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220630:
...
Non-merge commits (relative to Linus' tree): 6483
 7297 files changed, 663292 insertions(+), 117116 deletions(-)
...
Merging origin/master (5e8379351dbd Merge tag 'net-5.19-rc5' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/netdev/net)
Merging fixes/fixes (d06c942efea4 Merge tag 'for_linus' of git://git.kernel=
.org/pub/scm/linux/kernel/git/mst/vhost)
Merging mm-hotfixes/mm-hotfixes-unstable (f8354b03f53f mailmap: update Seth=
...
Merging net/master (58bf4db69528 net: dsa: felix: fix race between reading =
PSFP stats and port stats)
...
Merging sound-asoc-fixes/for-linus (bbe1560e0a77 Merge remote-tracking bran=
...
Merging scsi-fixes/fixes (fce54ed02757 scsi: hisi_sas: Limit max hw sectors=
 for v3 HW)
Merging drm-fixes/drm-fixes (078a3be79325 Merge tag 'amd-drm-fixes-5.19-202=
2-06-29' of https://gitlab.freedesktop.org/agd5f/linux into drm-fixes)
...
r-next)
Merging scmi/for-linux-next (666f1ccd1b7c Merge branch 'for-next/scmi' of g=
it://git.kernel.org/pub/scm/linux/kernel/git/sudeep.holla/linux into for-li=
nux-next)
$ git reset --hard HEAD^
Merging next-20220630 version of scmi
Merging stm32/stm32-next (a77ece9a9d51 ARM: dts: stm32: Fix SPI2 pinmux pin=
 comments on stm32mp15)
...
Merging net-next/master (0d8730f07c82 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/netdev/net)
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/rockchip/rk3568-b=
pi-r2-pro.dts
Merging bpf-next/for-next (7a255ae77216 bpftool: Show also the name of type=
 BPF_OBJ_LINK)
...
.c
Merging drm-misc/for-linux-next (3019a8d7c189 drm: Remove unnecessary junk =
from drm_crtc.h)
...
Merging drm-intel/for-linux-next (87a7d5350c67 drm/i915: Drain freed object=
 after suspend display)
...
Merging fbdev/for-next (86b032eb6841 fbcon: Use fbcon_info_from_console() i=
...
ile draining output)
Merging sound-asoc/for-next (fc86afe3634e Merge remote-tracking branch 'aso=
...
Merging input/next (a6a87c36165e Input: i8042 - add TUXEDO devices to i8042=
 quirk tables)
Merging block/for-next (1f1f831ffe41 Merge branch 'for-5.20/io_uring-buffer=
...
Merging spi/for-next (2ab6630e1714 Merge remote-tracking branch 'spi/for-5.=
20' into spi-next)
Merging tip/master (f4fadf62be8d Merge branch into tip/master: 'x86/vmware')
...
Merging usb/usb-next (3b91edd624ab usb: gadget: f_mass_storage: Make CD-ROM=
...
Merging iio/togreg (fab6a48eb378 iio: adc: stm32-adc: disable adc before ca=
libration)
...
Merging pinctrl-renesas/renesas-pinctrl (5dbccf2753bf pinctrl: renesas: Add=
...
Applying: Revert "iio: adc: qcom-vadc: Move symbol exports to IIO_QCOM_VADC=
 namespace"
...

=GziW
-----END PGP SIGNATURE-----
