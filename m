...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D0D9976A82F
	for <lists+linux-next@lfdr.de>; Tue,  1 Aug 2023 07:19:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229662AbjHAFTv (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 1 Aug 2023 01:19:51 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43662 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229603AbjHAFTu (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 1 Aug 2023 01:19:50 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7BE671FC3;
        Mon, 31 Jul 2023 22:19:45 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1690867183;
        bh=/u21aFlsJaBZP0+E9y8rsFcfZoHtVLhex58EpQX6qbE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RFNhb63GFz4wbj;
        Tue,  1 Aug 2023 15:19:43 +1000 (AEST)
Date:   Tue, 1 Aug 2023 15:19:41 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 1
Message-ID: <20230801151941.7f02b8d9@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/xa/l_H1Ycr3Dj39Vy/SyG_S";
...
--Sig_/xa/l_H1Ycr3Dj39Vy/SyG_S
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20230731:

New trees: i2c-host, i2c-host-fixes
...
Non-merge commits (relative to Linus' tree): 5324
 6920 files changed, 190129 insertions(+), 79433 deletions(-)
...
Merging net/main (611e1b016c7b octeon_ep: initialize mbox mutexes)
...
linus)
Merging sound-asoc-fixes/for-linus (3f14556dd3be Merge remote-tracking bran=
ch 'asoc/for-6.4' into asoc-linus)
Merging regmap-fixes/for-linus (5d0c230f1de8 Linux 6.5-rc4)
Merging regulator-fixes/for-linus (11d6f56fa9eb Merge remote-tracking branc=
...
Merging tty.current/tty-linus (5d0c230f1de8 Linux 6.5-rc4)
...
Merging drm-intel-fixes/for-linux-next-fixes (5d0c230f1de8 Linux 6.5-rc4)
...
Merging i2c-host-fixes/i2c/andi-for-current (e0be05a600b0 i2c: designware: =
...
Merging dma-mapping/for-next (3fa6456ebe13 dma-contiguous: check for memory=
 region overlap)
...
ree with READ_PLUS)
Merging nfsd/nfsd-next (401be0473fef exportfs: remove kernel-doc warnings i=
n exportfs)
...
Merging i2c-host/i2c/andi-for-next (1851a80ee87d dt-bindings: i2c: arb-gpio=
...
f statement)
Merging pm/linux-next (015a64bab2b5 Merge branch 'powercap' into linux-next)
...
tdev_vlan_ipv6())
Merging net-next/main (079082c60aff tcx: Fix splat during dev unregister)
...
Merging bpf-next/for-next (74bdfab4fd7c net: remove duplicate INDIRECT_CALL=
ABLE_DECLARE of udp[6]_ehashfn)
...
Merging drm-misc/for-linux-next (7cb8d1ab8cbd drm/virtio: Support sync obje=
cts)
...
Merging sound-asoc/for-next (bfbff98f827c Merge remote-tracking branch 'aso=
...
Merging tty/tty-next (fe3015748a90 Merge 6.5-rc4 into tty-next)
...

=RkFi
-----END PGP SIGNATURE-----
