...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 0048C23C380
	for <lists+linux-next@lfdr.de>; Wed,  5 Aug 2020 04:31:42 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725999AbgHECbm (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 4 Aug 2020 22:31:42 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55364 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725864AbgHECbl (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 4 Aug 2020 22:31:41 -0400
Received: from mail-pj1-x1044.google.com (mail-pj1-x1044.google.com [IPv6:2607:f8b0:4864:20::1044])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9D4CAC06174A
        for <linux-next@vger.kernel.org>; Tue,  4 Aug 2020 19:31:41 -0700 (PDT)
Received: by mail-pj1-x1044.google.com with SMTP id i92so2437705pje.0
        for <linux-next@vger.kernel.org>; Tue, 04 Aug 2020 19:31:41 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=xQ/TIeUpG2AZ5rtmPuBU9d72cbiX5pPztd7yn5i2m84=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=xQ/TIeUpG2AZ5rtmPuBU9d72cbiX5pPztd7yn5i2m84=;
        b=
X-Gm-Message-State: AOAM533ysDLlj+jXE8OE9DHEQYiElnDlYF1B3CQ5BIE82ng49P1TM3kV
        3hOhB4cgKe2smQ0H4FmBItKw5zDK7oQ=
X-Google-Smtp-Source: ABdhPJzaKkT02U/ZDNEtq5e3yczffupsWN+Ei4JxbzRjDF6qqx8cS21DVFDQ46y7Q7Yx81VK39VOJQ==
X-Received: by 2002:a17:902:c410:: with SMTP id k16mr1060194plk.340.1596594699163;
        Tue, 04 Aug 2020 19:31:39 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id i66sm714057pfc.12.2020.08.04.19.31.38
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 04 Aug 2020 19:31:38 -0700 (PDT)
Message-ID: <5f2a1a0a.1c69fb81.c421c.19bb@mx.google.com>
Date:   Tue, 04 Aug 2020 19:31:38 -0700 (PDT)
...
Subject: next/pending-fixes build: 212 builds: 13 failed, 199 passed, 19 errors,
 77 warnings (v5.8-3221-g983112062f35)
...
next/pending-fixes build: 212 builds: 13 failed, 199 passed, 19 errors, 77 =
warnings (v5.8-3221-g983112062f35)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.8-3221-g983112062f35/

Tree: next
Branch: pending-fixes
Git Describe: v5.8-3221-g983112062f35
Git Commit: 983112062f35f324bcd3fcfdaa679a7b5ce5095f
...
i:313.15-16 syntax error
    5    /scratch/linux/arch/arm/plat-orion/gpio.c:457:41: error: expected =
=E2=80=98;=E2=80=99 before =E2=80=98{=E2=80=99 token
    5    /scratch/linux/arch/arm/plat-orion/gpio.c:457:2: error: implicit d=
eclaration of function =E2=80=98for_each_requested_gpio=E2=80=99; did you m=
ean =E2=80=98for_each_present_cpu=E2=80=99? [-Werror=3Dimplicit-function-de=
claration]
...
tiple instructions
    1    /scratch/linux/include/linux/compiler_attributes.h:214:41: warning=
...
Errors:
    /scratch/linux/arch/arm/plat-orion/gpio.c:457:2: error: implicit declar=
ation of function =E2=80=98for_each_requested_gpio=E2=80=99; did you mean =
=E2=80=98for_each_present_cpu=E2=80=99? [-Werror=3Dimplicit-function-declar=
ation]
    /scratch/linux/arch/arm/plat-orion/gpio.c:457:41: error: expected =E2=
