...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id B86F57A1375
	for <lists+linux-next@lfdr.de>; Fri, 15 Sep 2023 04:01:34 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231341AbjIOCBh (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 14 Sep 2023 22:01:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:48608 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231234AbjIOCBg (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 14 Sep 2023 22:01:36 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C40B21AE;
        Thu, 14 Sep 2023 19:01:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1694743290;
        bh=LZnluVC2Q9r7IkgcphlPotro4XVzpO8D9PX/EfeeUWM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Rmy961LMFz4x2Y;
        Fri, 15 Sep 2023 12:01:30 +1000 (AEST)
Date:   Fri, 15 Sep 2023 12:01:27 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 15
Message-ID: <20230915120127.1bc03420@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/0TAz4WC03FzIUguYgrbXI4g";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/0TAz4WC03FzIUguYgrbXI4g
...
Merging origin/master (9fdfb15a3dbf Merge tag 'net-6.6-rc2' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/netdev/net)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (63f29827e9c2 filemap: add filemap=
_map_order0_folio() to handle order0 folio)
...
Merging net/main (9fdfb15a3dbf Merge tag 'net-6.6-rc2' of git://git.kernel.=
org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (6bd5bcb18f94 netfilter, bpf: Adjust timeouts of non-con=
firmed CTs in bpf_ct_insert_entry())
...
Merging sound-current/for-linus (72ca56664e48 ALSA: hda: cs35l56: Don't 're=
turn ret' if ret is always zero)
Merging sound-asoc-fixes/for-linus (fac58baf8fcf ASoC: imx-rpmsg: Set ignor=
e_pmdown_time for dai_link)
...
Merging drm-fixes/drm-fixes (15794f9dc371 Merge tag 'drm-misc-fixes-2023-09=
...
Merging memblock-fixes/fixes (4b2d63123693 memblock tests: Fix compilation =
errors.)
...
stem to pmdomain)
Merging drm-misc-fixes/for-linux-next-fixes (139a27854bf5 drm/tests: helper=
s: Avoid a driver uaf)
Merging mm-stable/mm-stable (0bb80ecc33a8 Linux 6.6-rc1)
Merging mm-nonmm-stable/mm-nonmm-stable (0bb80ecc33a8 Linux 6.6-rc1)
Merging mm/mm-everything (0afa242a6ce9 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging perf/perf-tools-next (19d8ab40f89b perf test stat+shadow_stat.sh: A=
dd threshold for rounding errors)
...
to for-next)
Merging qcom/for-next (8bd7b2c3151a Merge branches 'arm64-defconfig-for-6.7=
...
om being encrypted)
Merging ext4/dev (b016ebb300e5 ext4: do not let fstrim block system suspend)
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (f1aeef9b7b37 Merge branch 'vfs.mount.write' in=
to vfs.all)
...
Merging net-next/main (f2fa1c812c91 Merge git://git.kernel.org/pub/scm/linu=
x/kernel/git/netdev/net)
Merging bpf-next/for-next (971f7c32147f selftests/bpf: Skip module_fentry_s=
hadow test when bpf_testmod is not available)
...
- add missing escape)
Merging drm-misc/for-linux-next (d51f9fbd98b6 drm/ssd130x: Store the HW buf=
fer in the driver-private CRTC state)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (3106c34df6ac drm/i915/dsc: Fix pic_width =
readout)
...
k after snprintf())
Merging sound/for-next (72ca56664e48 ALSA: hda: cs35l56: Don't 'return ret'=
 if ret is always zero)
Merging ieee1394/for-next (2dde18cd1d8f Linux 6.5)
Merging sound-asoc/for-next (b7c53e82862b Merge remote-tracking branch 'aso=
...
-next)
Merging device-mapper/for-next (edcabec81f12 dm thin: Use the extent alloca=
tor)
$ git reset --hard HEAD^
Merging next-20230914 version of device-mapper
...
Merging battery/for-next (1769142a14c3 power: supply: rk817: query battery =
properties right after resume)
...
7' into spi-next)
Merging tip/master (8bfcf4ca8b48 Merge branch into tip/master: 'x86/urgent')
...

=lDKW
-----END PGP SIGNATURE-----
