...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 7BF7652B80C
	for <lists+linux-next@lfdr.de>; Wed, 18 May 2022 12:45:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235090AbiERK3o (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 18 May 2022 06:29:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:38892 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235089AbiERK3m (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 18 May 2022 06:29:42 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 139CD2C652;
        Wed, 18 May 2022 03:29:39 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4L38PC3LC2z4xXS;
        Wed, 18 May 2022 20:29:35 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1652869775;
        bh=irlzT7Zn6N2XSYVewjQJ4RubSzEqT57ixejuh6kSRmo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 18 May 2022 20:29:34 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 18
Message-ID: <20220518202934.730a8aba@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Rq_ZUd8BOYjiEWTiX5zu8jy";
...
Non-merge commits (relative to Linus' tree): 11485
 11273 files changed, 957402 insertions(+), 234424 deletions(-)
...
Merging mm-hotfixes/mm-hotfixes-unstable (74a1bc7b915c assoc_array: Fix BUG=
...
Merging net/master (edf410cb74dc net: vmxnet3: fix possible NULL pointer de=
reference in vmxnet3_rq_cleanup())
...
Merging input-current/for-linus (70509676739f dt-bindings: input: mediatek,=
mt6779-keypad: update maintainer)
...
Merging perf/perf/core (df36d2572e05 perf bench breakpoint: Fix build on 32=
-bit arches)
...
Merging arm64/for-next/core (bded719c642f Merge branch 'for-next/misc' into=
 for-next/core)
...
ry types)
Merging s390/for-next (80862059eead Merge branch 'features' into for-next)
...
Merging f2fs/dev (ad241fae0124 f2fs: separate NOCoW and pinfile semantics)
...
Merging hwmon-staging/hwmon-next (b944872ff51c hwmon: (dimmtemp) Fix bitmap=
 handling)
...
Merging devfreq/devfreq-next (26984d9d581e PM / devfreq: passive: Keep cpuf=
...
Merging net-next/master (76e1e5df4b7c octeontx2-pf: Use memset_startat() he=
lper in otx2_stop())
...
Merging wireless-next/main (a456021c6f14 rtw89: pci: only mask out INT indi=
cator register for disable interrupt v1)
...
Merging sound/for-next (44d30762cde7 ALSA: seq: replace ternary operator wi=
th max())
...
Merging input/next (f8cafefb5e09 Merge branch 'ib/5.17-cros-ec-keyb' into n=
ext)
Merging block/for-next (67f954bddf0c Merge branch 'for-5.19/block' into for=
-next)
...
to spi-mem)
Merging tip/master (bcde61d57872 Merge branch into tip/master: 'x86/core')
...
Merging pinctrl-intel/for-next (68aa84ff28ba pinctrl: cherryview: Use GPIO =
chip pointer in chv_gpio_irq_mask_unmask())
...
Merging rtc/rtc-next (a37bdde620c2 rtc: meson: Fix email address in MODULE_=
AUTHOR)
...
Merging kunit-next/kunit (1b11063d32d7 kunit: fix executor OOM error handli=
ng logic on non-UML)
...
Merging random/master (239b912ea1f5 random: unify batched entropy implement=
ations)
...
Merging mm/mm-everything (698c4bf1c808 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: fixup for "mm: change huge_ptep_clear_flush() to return the origi=
nal pte"
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (391fb257b0de mm/oom_kill.c: fix vm_oom_kill_table[] if=
deffery)
...

=yJLI
-----END PGP SIGNATURE-----
