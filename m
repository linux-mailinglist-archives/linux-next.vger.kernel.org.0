...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 665443F85C0
	for <lists+linux-next@lfdr.de>; Thu, 26 Aug 2021 12:42:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234055AbhHZKnd (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 26 Aug 2021 06:43:33 -0400
Received: from ozlabs.org ([203.11.71.1]:38583 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S241276AbhHZKnc (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Thu, 26 Aug 2021 06:43:32 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GwKDg5YsXz9sR4;
        Thu, 26 Aug 2021 20:42:43 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1629974563;
        bh=IBqI9TRGPz3yC9P1m92AIlr/BIaK0qGt/aAD8Wj7llw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 26 Aug 2021 20:42:42 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 26
Message-ID: <20210826204242.7585e3af@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/yX8+HybFREL.Tm0e=/p/aPc";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/yX8+HybFREL.Tm0e=/p/aPc
...
Merging origin/master (73f3af7b4611 Merge branch 'akpm' (patches from Andre=
w))
...
Merging net/master (cd9b50adc6bb net/sched: ets: fix crash when flipping fr=
om 'strict' to 'quantum')
...
Merging sound-asoc-fixes/for-linus (7dc488712d9f Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (651d7bf3536d Merge remote-tracking branch 'spi=
...
Merging kbuild/for-next (89abbf642699 checkkconfigsymbols.py: Forbid passin=
g 'HEAD' to --commit)
...
iver)
Merging risc-v/for-next (fde9c59aebaf riscv: explicitly use symbol offsets =
for VDSO)
...
Merging cifs/for-next (77af3f8b5616 cifs: add cifs_common directory to MAIN=
TAINERS file)
...
encode_getaclres)
Merging cel/for-next (7aa6133a15d6 nfsd: fix crash on LOCKT on reexported N=
FSv3)
...
Merging pm/linux-next (4d51a7d02bd1 Merge branch 'pm-domains-fixes' into li=
nux-next)
...
Merging rdma/for-next (f0a64199195e RDMA/hns: Delete unused hns bitmap inte=
rface)
...
Merging bpf-next/for-next (0584e965fb25 Merge branch 'bpf: tcp: Allow bpf-t=
cp-cc to call bpf_(get|set)sockopt')
$ git reset --hard HEAD^
...
Merging amdgpu/drm-next (4c2b33ac5eec drm/radeon: Add HD-audio component no=
tifier support (v2))
...
Merging sound-asoc/for-next (516270ef2f3b Merge remote-tracking branch 'aso=
...
Merging spi/for-next (fcda07171274 Merge remote-tracking branch 'spi/for-5.=
15' into spi-next)
...
pecific naming)
Merging dmaengine/next (42c7ada5aa37 dmaengine: xilinx_dma: Set DMA mask fo=
r coherent APIs)
...
Merging userns/for-next (4f125116ffe0 Merge of ucount-fixes-for-5.14, sigin=
fo-si_trapno-for-v5.15, and exit-cleanups-for-v5.15 for testing in linux-ne=
xt)
Merging ktest/for-next (170f4869e662 ktest.pl: Fix the logic for truncating=
 the size of the log file for email)
Merging kselftest/next (a051b2e56f2a selftests/x86: Fix error: variably mod=
ified 'altstack_data' at file scope)
...

=nMBu
-----END PGP SIGNATURE-----
