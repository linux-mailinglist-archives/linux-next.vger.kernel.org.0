...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C43863ECF4E
	for <lists+linux-next@lfdr.de>; Mon, 16 Aug 2021 09:24:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234127AbhHPHYz (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 16 Aug 2021 03:24:55 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50698 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234092AbhHPHYy (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 16 Aug 2021 03:24:54 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 31521C061764;
        Mon, 16 Aug 2021 00:24:23 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Gp5JN0CrXz9sWS;
        Mon, 16 Aug 2021 17:24:20 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1629098660;
        bh=HbXq2nzALhNi69Ig/rzJi/8UhrBJkjZ+xY7RbTxXvWI=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 16 Aug 2021 17:24:17 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 16
Message-ID: <20210816172417.0ddc982a@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/.gp5VcYDp7A26=wTfriLGqD";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/.gp5VcYDp7A26=wTfriLGqD
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20210813:
...
The staging tree gained a build failure due to a commit in the net-next
tree for which I reverted that commit.

Non-merge commits (relative to Linus' tree): 7334
 7338 files changed, 448047 insertions(+), 175522 deletions(-)
...
Merging origin/master (ecf93431963a Merge tag 'powerpc-5.14-5' of git://git=
...
Merging arm64-fixes/for-next/fixes (017f5fb9ce79 arm64: clean vdso & vdso32=
 files)
Merging arm-soc-fixes/arm/fixes (cbfece75186d ARM: ixp4xx: fix building bot=
h pci drivers)
...
Merging net/master (5f7735196390 ice: Fix perout start time rounding)
...
Merging mac80211/master (a9a507013a6f Merge tag 'ieee802154-for-davem-2021-=
08-12' of git://git.kernel.org/pub/scm/linux/kernel/git/sschmidt/wpan)
...
Merging sound-asoc-fixes/for-linus (fcccea2dd0db Merge remote-tracking bran=
...
robing)
Merging btrfs-fixes/next-fixes (6b0c9b06c4ed Merge branch 'misc-5.14' into =
next-fixes)
...
Merging drm-fixes/drm-fixes (a1fa72683166 Merge tag 'drm-misc-fixes-2021-08=
...
ed to avoid any DIV)
Merging arc/for-next (702b4e904d89 ARC: mm: move MMU specific bits out of e=
ntry code ...)
...
Merging arm-soc/for-next (ffc192c81705 soc: document merges)
...
Merging cifs/for-next (27b2eaa1180e Merge tag '5.14-rc5-smb3-fixes' of git:=
...
terface for uverbs)
Merging net-next/master (e4637f621203 MAINTAINERS: Remove the ipx network l=
ayer info)
Applying: NET_VENDOR_CIRRUS is not ready for COMPILE_TEST
Merging bpf-next/for-next (fa183a86eefd Merge branch 'BPF iterator for UNIX=
 domain socket.')
...
c comment)
Merging drm/drm-next (a22c074fd1dd Merge tag 'drm-intel-next-2021-08-10-1' =
...
tifier support (v2))
Merging drm-intel/for-linux-next (2817efaeb608 drm/i915/dg2: add SNPS PHY t=
ranslations for UHBR link rates)
...
allback)
Merging sound-asoc/for-next (f7c0c6dcc230 Merge remote-tracking branch 'aso=
...
Merging block/for-next (0f6eedb0a71c Merge branch 'for-5.15/io_uring' into =
for-next)
...
Merging battery/for-next (4eef766b7d4d power: supply: core: Parse battery c=
hemistry/technology)
...
it.h)
Merging devicetree/for-next (39c6b3a3dd11 of: fdt: Remove weak early_init_d=
t_mark_hotplug_memory_arch())
...
Merging spi/for-next (d88c829877a7 Merge remote-tracking branch 'spi/for-5.=
15' into spi-next)
...
Merging rcu/rcu/next (ed3b30c24e44 rcu-tasks: Move RTGS_WAIT_CBS to beginni=
ng of rcu_tasks_kthread() loop)
...
Merging usb/usb-next (cea45a3bd2dd usb: gadget: udc: renesas_usb3: Fix soc_=
device_match() abuse)
...
data)
Merging char-misc/char-misc-next (3683b761fe3a nvmem: nintendo-otp: Add new=
 driver for the Wii and Wii U OTP)
...
lease)
Merging staging/staging-next (f805ef1ce5d6 Merge tag 'iio-for-5.15a' of htt=
...
Applying: Revert "net: Remove net/ipx.h and uapi/linux/ipx.h header files"
Merging iio/togreg (f805ef1ce5d6 Merge tag 'iio-for-5.15a' of https://git.k=
...
isting file)
Merging gpio-brgl/gpio/for-next (0a6e7e411896 Merge tag 'intel-gpio-v5.15-1=
...
atform data)
Merging pinctrl/for-next (6319e82de98d Merge branch 'devel' into for-next)
...
Merging akpm-current/current (1119a8dd34d2 ipc: replace costly bailout chec=
...
Merging akpm/master (f5e0cc2c9f5f arch: remove compat_alloc_user_space)
...

=vmN4
-----END PGP SIGNATURE-----
