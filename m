...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id A49E91B387A
	for <lists+linux-next@lfdr.de>; Wed, 22 Apr 2020 09:10:28 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725924AbgDVHK1 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 22 Apr 2020 03:10:27 -0400
Received: from ozlabs.org ([203.11.71.1]:50665 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725907AbgDVHKZ (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 22 Apr 2020 03:10:25 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 496WmB6WFwz9sSJ;
        Wed, 22 Apr 2020 17:10:18 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1587539419;
        bh=yQ9kMpXKVtnHOfqp+LBsiEGEDDyjbyuQmiF6tPYH8+g=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 22 Apr 2020 17:10:16 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 22
Message-ID: <20200422171016.484b031d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Y.rzZGXnt3bwLPSEzm=o/7H";
...
The btrfs tree still had its build failure for which I applied a patch.
...
Tthe device-mapper tree gained a build failure do I used the version
from next-20200421.
...
The akpm tree gained a semantic conflict against the powerpc tree.

Non-merge commits (relative to Linus' tree): 3308
 4406 files changed, 100369 insertions(+), 45983 deletions(-)
...
Merging origin/master (18bf34080c4c Merge branch 'akpm' (patches from Andre=
w))
...
Merging net/master (76fc6a9a9a6a Merge git://git.kernel.org/pub/scm/linux/k=
ernel/git/pablo/nf)
...
estruct)
Merging netfilter/master (b4faef1739dd netfilter: nat: fix error handling u=
pon registering inet hook)
...
Merging sound-current/for-linus (e7b6b3ec01c1 Merge tag 'asoc-fix-v5.7-rc2'=
 of https://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-=
linus)
Merging sound-asoc-fixes/for-linus (b50fbd561bc2 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (bedad93ec5f8 Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (8f97250c21f0 xhci: Don't clear hub TT buffer=
 on ep0 protocol stall)
...
Merging hyperv-fixes/hyperv-fixes (421f090c819d x86/hyperv: Suspend/resume =
the VP assist page for hibernation)
Merging soc-fsl-fixes/fix (fe8fe7723a3a soc: fsl: dpio: register dpio irq h=
andlers after dpio create)
Merging risc-v-fixes/fixes (3c1918c8f541 riscv: fix vdso build with lld)
...
Merging kspp-gustavo/for-next/kspp (d496496793ff treewide: Replace zero-len=
...
async dirops cb's)
Merging cifs/for-next (b182dc9eb9a5 cifs: protect updating server->dstaddr =
with a spinlock)
...
Merging exfat/dev (faa273ed6d2f exfat: truncate atimes to 2s granularity)
...
Merging v4l-dvb/master (b2965c912a3d media: dt-bindings: media: rockchip-rg=
a: add power-domains property)
$ git reset --hard HEAD^
Merging next-20200421 version of v4l-dvb
...
nr_ops)
Merging net-next/master (44dd5efc97da Merge branch 'Support-programmable-pi=
ns-for-Ocelot-PTP-driver')
...
Merging drm/drm-next (ae83d0b416db Linux 5.7-rc2)
...
.c
Merging drm-intel/for-linux-next (33883310cd8e drm/i915/selftests: Unroll t=
he CS frequency loop)
...
Merging sound-asoc/for-next (1d79c3c69dfa Merge remote-tracking branch 'aso=
...
next)
Merging device-mapper/for-next (2d56364c7c7b dm mpath: switch paths in dm_b=
lk_ioctl() code path)
$ git reset --hard HEAD^
Merging next-20200421 version of device-mapper
...
port)
Merging spi/for-next (c5a7b42434ff Merge remote-tracking branch 'spi/for-5.=
8' into spi-next)
Merging tip/auto-latest (f091a1f17abd Merge branch 'core/core')
...
Merging rcu/rcu/next (1952fda8f5b6 rcu: Simplify the calculation of rcu_sta=
te.ncpus)
...
Merging ipmi/for-next (cee1e7e1fb48 ipmi: use vzalloc instead of kmalloc fo=
r user creation)
...
rflow
Merging akpm/master (d7b7d5f7953a drivers/media/platform/sti/delta/delta-ip=
...

=XD6f
-----END PGP SIGNATURE-----
