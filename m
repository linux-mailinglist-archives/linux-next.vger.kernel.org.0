...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D6187785070
	for <lists+linux-next@lfdr.de>; Wed, 23 Aug 2023 08:14:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S232849AbjHWGOh (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 23 Aug 2023 02:14:37 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41468 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232418AbjHWGOg (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 23 Aug 2023 02:14:36 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 7106D184;
        Tue, 22 Aug 2023 23:14:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1692771269;
        bh=mM5gLgJ4Mg+c99lFQrRtzs+eSf7cLrmhq/Yugp60MLQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RVwsd162Cz4wZJ;
        Wed, 23 Aug 2023 16:14:29 +1000 (AEST)
Date:   Wed, 23 Aug 2023 16:14:28 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 23
Message-ID: <20230823161428.3af51dee@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/VpF4w=jMSGHgN+_C0eSjVRU";
...
and gained another for which I reverted another commit.

The djw-vfs tree gained a conflict against the xfs tree.
...
The kselftest tree gained a conflict against the mm-hotfixes tree.

The nvmem tree lost its build failure.

The efi tree lost its build failure.

Non-merge commits (relative to Linus' tree): 11108
 12584 files changed, 547053 insertions(+), 186355 deletions(-)
...
Merging origin/master (89bf6209cad6 Merge tag 'devicetree-fixes-for-6.5-2' =
...
mbx")
Merging mm-hotfixes/mm-hotfixes-unstable (8d55633e168b selftests: cachestat=
: catch failing fsync test on tmpfs)
...
Merging net/main (6dc5774deefe sfc: allocate a big enough SKB for loopback =
selftest packet)
...
Merging sound-asoc-fixes/for-linus (49b1a322c87f Merge remote-tracking bran=
ch 'asoc/for-6.4' into asoc-linus)
Merging regmap-fixes/for-linus (52a93d39b17d Linux 6.5-rc5)
Merging regulator-fixes/for-linus (372c9577d143 Merge remote-tracking branc=
...
Merging drm-intel-fixes/for-linux-next-fixes (e0d25c591ac6 drm/i915: fix Sp=
hinx indentation warning)
...
Merging drm-misc-fixes/for-linux-next-fixes (5ad1ab30ac08 drm/display/dp: F=
ix the DP DSC Receiver cap size)
...
Merging mm-nonmm-stable/mm-nonmm-stable (3d0b71398490 kstrtox: consistently=
 use _tolower())
Merging mm/mm-everything (6389063fa12c Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: Revert "mm: remove enum page_entry_size"
Applying: Revert "proc/ksm: add ksm stats to /proc/pid/smaps"
Merging kbuild/for-next (e930d97f6d3e alpha: remove <asm/export.h>)
Merging clang-format/clang-format (5d0c230f1de8 Linux 6.5-rc4)
Merging perf/perf-tools-next (58a8d2edd57b perf stat-display: Check if snpr=
intf()'s fmt argument is NULL)
...
s inlines)
Merging parisc-hd/for-next (8f01caf0c5c1 parisc: Avoid ioremap() for same a=
...
Merging ceph/master (42610b765fc1 ceph: switch ceph_lookup/atomic_open() to=
 use new fscrypt helper)
Merging cifs/for-next (064b45489ee0 fs/jfs: Use common ucs2 upper case tabl=
e)
Merging configfs/for-next (77992f896745 configfs: remove mentions of commit=
table items)
Merging ecryptfs/next (a3d78fe3e1ae fs: ecryptfs: comment typo fix)
Merging erofs/dev (4e81269b705c erofs: release ztailpacking pclusters prope=
rly)
...
'cpumask_setall()')
Merging vfs-brauner/vfs.all (253a2adf5604 Merge branch 'vfs.fs_context' int=
o vfs.all)
...
Merging hid/for-next (6554a855d416 Merge branch 'for-6.6/logitech' into for=
-next)
...
Merging pm/linux-next (85ad73d0eb58 Merge branch 'thermal' into linux-next)
...
tection)
Merging rdma/for-next (c6c0052df25a RDMA/bnxt_re: Fix kernel doc errors)
Merging net-next/main (981736337256 Merge tag 'mlx5-updates-2023-08-16' of =
...
Merging bpf-next/for-next (29d67fdebc42 libbpf: Free btf_vmlinux when closi=
ng bpf_object)
...
Merging bluetooth/master (a0c33fb2c3b2 Bluetooth: btintel: Send new command=
 for PPAG)
Merging wireless-next/for-next (9e261e6da0a8 wifi: Fix ieee80211.h kernel-d=
oc issues)
...
u_v13_0_6_ppt.c
Merging drm-misc/for-linux-next (9c319a0f6d52 drm/ttm/tests: Fix type conve=
rsion in ttm_pool_test)
Merging amdgpu/drm-next (38518054183f drm/amdgpu: Fix the return for gpu mo=
de1_reset)
Merging drm-intel/for-linux-next (f2ac6402760a drm/i915: Fix TLB-Invalidati=
on seqno store)
...
Merging sound-asoc/for-next (f1c0853256a3 Merge remote-tracking branch 'aso=
...
Merging block/for-next (f20085ad6491 Merge branch 'for-6.6/block' into for-=
next)
...
Merging regulator/for-next (8950c4a350c1 Merge remote-tracking branch 'regu=
...
ne)
Merging devicetree/for-next (26409dd04589 of: unittest: Add pci_dt_testdrv =
pci driver)
...
eak)
Merging kvm-arm/next (37c951a5ee6d Merge branch kvm-arm64/6.6/pmu-fixes int=
...
t warning)
Merging driver-core/driver-core-next (1b28cb81dab7 kobject: Remove redundan=
t checks for whether ktype is NULL)
Merging usb/usb-next (26f4f8358d89 dt-bindings: usb: samsung,exynos-dwc3: F=
ix Exynos5433 compatible)
...
Merging tty/tty-next (2f4926723ac7 tty: gdm724x: use min_t() for size_t var=
able and a constant)
...
Merging char-misc/char-misc-next (48e3210920b9 Merge tag 'extcon-next-for-6=
...
Merging gpio-brgl/gpio/for-next (db3b16dcc7e4 gpio: pcf857x: Extend match d=
ata support for OF tables)
...
at availability)
CONFLICT (content): Merge conflict in tools/testing/selftests/cachestat/tes=
t_cachestat.c
...
Merging nvmem/for-next (2b30c8e6c9ac nvmem: sec-qfprom: Remove unused varia=
ble 'ret')
...
Merging drm-ci/topic/drm-ci (882a25ee2005 drm: Add initial ci/ subdirectory)
...

=DsGa
-----END PGP SIGNATURE-----
