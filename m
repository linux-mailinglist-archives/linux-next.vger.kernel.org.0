...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A576F74E537
	for <lists+linux-next@lfdr.de>; Tue, 11 Jul 2023 05:20:48 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229503AbjGKDUr (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 10 Jul 2023 23:20:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54994 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229928AbjGKDUq (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 10 Jul 2023 23:20:46 -0400
Received: from mail-pl1-x632.google.com (mail-pl1-x632.google.com [IPv6:2607:f8b0:4864:20::632])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 363CEC2
        for <linux-next@vger.kernel.org>; Mon, 10 Jul 2023 20:20:42 -0700 (PDT)
Received: by mail-pl1-x632.google.com with SMTP id d9443c01a7336-1b8b2886364so33769215ad.0
        for <linux-next@vger.kernel.org>; Mon, 10 Jul 2023 20:20:42 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20221208.gappssmtp.com; s=20221208; t=1689045641; x=1691637641;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=YI5RM3BqbKReIFT0loglCsFfqjZLlWNXKEFyUXc47ss=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689045641; x=1691637641;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=YI5RM3BqbKReIFT0loglCsFfqjZLlWNXKEFyUXc47ss=;
        b=
X-Gm-Message-State: ABy/qLZMxzT37wu9SNd5bflqSlY66ohlXJFX+3TGtsrqu6pGIuYMdFO6
        kEism8nqdAKt/N6c0Do/koBeRiQgdAhdyfi/kw84DQ==
X-Google-Smtp-Source: APBJJlHtXRKqi/D/89dStQJDwQaJ6CSCpLKZID/BHanAMefMlxho49M3M/T5CycfD7cFzlkb1RdtjQ==
X-Received: by 2002:a17:903:246:b0:1b0:3637:384e with SMTP id j6-20020a170903024600b001b03637384emr14411249plh.25.1689045640773;
        Mon, 10 Jul 2023 20:20:40 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id v4-20020a1709029a0400b001b83dc8649dsm608184plp.250.2023.07.10.20.20.39
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 10 Jul 2023 20:20:40 -0700 (PDT)
Message-ID: <64acca88.170a0220.cb8e.1e28@mx.google.com>
Date:   Mon, 10 Jul 2023 20:20:40 -0700 (PDT)
...
Subject: next/master build: 121 builds: 2 failed, 119 passed, 3 errors,
 42 warnings (next-20230711)
...
next/master build: 121 builds: 2 failed, 119 passed, 3 errors, 42 warnings =
(next-20230711)
...
Tree: next
Branch: master
Git Describe: next-20230711
Git Commit: 8e4b7f2f3d6071665b1dfd70786229c8a5d6c256
...
Warnings summary:
    ...
    22   kernel/cgroup/cgroup.c:503:36: warning: =E2=80=98cgroup_tryget_css=
=E2=80=99 defined but not used [-Wunused-function]
    4    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [=
-Wcpp]
    3    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_io=
vec_from_user.part.0() with UACCESS enabled
    2    vmlinux.o: warning: objtool: __import_iovec+0x147: call to copy_io=
vec_from_user.part.0() with UACCESS enabled
    2    vmlinux.o: warning: objtool: .altinstr_replacement+0x1deb: redunda=
nt UACCESS disable
    2    kernel/cgroup/cgroup.c:503:36: warning: unused function 'cgroup_tr=
yget_css' [-Wunused-function]
    2    1 warning generated.
    1    vmlinux.o: warning: objtool: __import_iovec+0x342: call to copy_io=
vec_from_user.part.0() with UACCESS enabled
    1    vmlinux.o: warning: objtool: .altinstr_replacement+0x19b9: redunda=
nt UACCESS disable
...
Warnings:
    kernel/cgroup/cgroup.c:503:36: warning: =E2=80=98cgroup_tryget_css=E2=
...
Warnings:
    kernel/cgroup/cgroup.c:503:36: warning: unused function 'cgroup_tryget_=
css' [-Wunused-function]
    1 warning generated.
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x19b9: redundant UA=
CCESS disable
...
Warnings:
    vmlinux.o: warning: objtool: .altinstr_replacement+0x1deb: redundant UA=
CCESS disable
    vmlinux.o: warning: objtool: iovec_from_user+0x88: call to copy_iovec_f=
rom_user.part.0() with UACCESS enabled
