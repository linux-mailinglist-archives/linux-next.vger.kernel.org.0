...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 05E3F491F26
	for <lists+linux-next@lfdr.de>; Tue, 18 Jan 2022 06:50:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239750AbiARFul (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 18 Jan 2022 00:50:41 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50600 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239742AbiARFul (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 18 Jan 2022 00:50:41 -0500
Received: from mail-pl1-x630.google.com (mail-pl1-x630.google.com [IPv6:2607:f8b0:4864:20::630])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A5E28C061574
        for <linux-next@vger.kernel.org>; Mon, 17 Jan 2022 21:50:40 -0800 (PST)
Received: by mail-pl1-x630.google.com with SMTP id f13so13130731plg.0
        for <linux-next@vger.kernel.org>; Mon, 17 Jan 2022 21:50:40 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=A1fmI9DG3drVKviifUS8UVfFrndkWRIrefFhokhAvuA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=A1fmI9DG3drVKviifUS8UVfFrndkWRIrefFhokhAvuA=;
        b=
X-Gm-Message-State: AOAM533wqkBdjCRU5DLb+Ysx23fmGMsuE9NxwFs1HJySl+NHTUSNSZgs
        cdQ9vrx9JeyZ105pQDx1avumtGIuk9HCjbiz
X-Google-Smtp-Source: ABdhPJza17pHPzCmDNc/jy52e1ZkTRStiRGnCwHBMrSLAtuNPn/Vh9SRNUG3AFqZFoVovQb2hTHLng==
X-Received: by 2002:a17:903:110c:b0:149:8018:e9d4 with SMTP id n12-20020a170903110c00b001498018e9d4mr25925727plh.117.1642485038782;
        Mon, 17 Jan 2022 21:50:38 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id pf16sm518897pjb.35.2022.01.17.21.50.37
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 17 Jan 2022 21:50:38 -0800 (PST)
Message-ID: <61e6552e.1c69fb81.e3873.111e@mx.google.com>
Date:   Mon, 17 Jan 2022 21:50:38 -0800 (PST)
...
Subject: next/master build: 224 builds: 20 failed, 204 passed, 35 errors,
 122 warnings (next-20220118)
...
next/master build: 224 builds: 20 failed, 204 passed, 35 errors, 122 warnin=
gs (next-20220118)
...
Tree: next
Branch: master
Git Describe: next-20220118
Git Commit: 6f59bc242877fcb9c9a5136ea62d383fce5615df
...
x86_64:
    allmodconfig (clang-14): 1 error, 36 warnings
...
ld not have leading "0x"
    1    :288:30: note: initialize the variable 'mcount_sort_thread' to sil=
ence this warning
...
---------------------------------------------------------------------------=
-----
allmodconfig (x86_64, clang-14) =E2=80=94 FAIL, 1 error, 36 warnings, 0 sec=
tion mismatches
...
ed uninitialized whenever '||' condition is true [-Wsometimes-uninitialized]
    scripts/sorttable.h:380:6: warning: variable 'mcount_sort_thread' is us=
ed uninitialized whenever '||' condition is true [-Wsometimes-uninitialized]
    :288:30: note: initialize the variable 'mcount_sort_thread' to silence =
this warning
    scripts/sorttable.h:380:6: warning: variable 'mcount_sort_thread' is us=
ed uninitialized whenever 'if' condition is true [-Wsometimes-uninitialized]
    scripts/sorttable.h:380:6: warning: variable 'mcount_sort_thread' is us=
