...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D9ADC3FC470
	for <lists+linux-next@lfdr.de>; Tue, 31 Aug 2021 11:00:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240155AbhHaIoV (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 31 Aug 2021 04:44:21 -0400
Received: from ozlabs.org ([203.11.71.1]:60765 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S236028AbhHaIoU (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 31 Aug 2021 04:44:20 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4GzLLd4dnxz9s5R;
        Tue, 31 Aug 2021 18:43:21 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1630399401;
        bh=QiXqfso6I6ZMq8BLv0yes47WKSPZ/9F0fb8gPsII6aM=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 31 Aug 2021 18:43:18 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 31
Message-ID: <20210831184318.57a359a6@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/gahahwqIIlQp24.B1gYU.9T";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/gahahwqIIlQp24.B1gYU.9T
...
Changes since 20210830:

The net-next tree still had its build failure for which I applied a
patch.

Non-merge commits (relative to Linus' tree): 9814
 9474 files changed, 561210 insertions(+), 229080 deletions(-)
...
Merging origin/master (46f4945e2b39 Merge tag 'efi-core-2021-08-30' of git:=
...
struct rxe_queue)
Merging sound-current/for-linus (a8729efbbb84 Merge tag 'asoc-v5.15' of htt=
ps://git.kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-linus)
Merging sound-asoc-fixes/for-linus (38b767300094 Merge remote-tracking bran=
...
Merging kbuild/for-next (d16a693cf932 kbuild: clean up objtool_args slightl=
y)
...
setup)
Merging parisc-hd/for-next (a59d984c56c8 drivers: parisc: ccio-dma.c: Added=
...
tion)
Merging s390/for-next (3cc5b5ea09f2 Merge branch 'features' into for-next)
...
e handling)
Merging f2fs/dev (f7db8dd6981e f2fs: enable realtime discard iff device sup=
ports discard)
...
Merging ntfs3/master (e8b8e97f91b8 fs/ntfs3: Restyle comments to better ali=
gn with kernel-doc)
...
or-next)
Merging net-next/master (ca49bfd90a9d sch_htb: Fix inconsistency when leaf =
qdisc creation fails)
...
Merging bpf-next/for-next (fca35b11e18a MAINTAINERS: Remove self from power=
pc BPF JIT)
...
Merging bluetooth/master (d850bf086280 Bluetooth: Fix using RPA when addres=
s has been resolved)
...
Merging amdgpu/drm-next (13f85ec0de14 drm/radeon: Add HD-audio component no=
tifier support (v2))
...
Merging sound/for-next (a8729efbbb84 Merge tag 'asoc-v5.15' of https://git.=
kernel.org/pub/scm/linux/kernel/git/broonie/sound into for-linus)
Merging sound-asoc/for-next (38b767300094 Merge remote-tracking branch 'aso=
...
ML schema)
Merging block/for-next (95a9fb447ba3 Merge branch 'for-5.15/io_uring' into =
for-next)
...
Merging devicetree/for-next (751ca492f131 dt-bindings: PCI: imx6: convert t=
he imx pcie controller to dtschema)
...
Merging mailbox/mailbox-for-next (e5c11ee31060 mailbox: qcom-apcs-ipc: Add =
compatible for MSM8953 SoC)
Merging spi/for-next (6e9c846aa0c5 Merge remote-tracking branch 'spi/for-5.=
15' into spi-next)
Merging tip/auto-latest (272f581a50a2 Merge branch 'efi/core')
...
vcpu_idx)
Merging xen-tip/linux-next (1a0df28c0983 x86: xen: platform-pci-unplug: use=
 pr_err() and pr_warn() instead of raw printk())
...
Merging akpm/master (e55a5b2da906 arch: remove compat_alloc_user_space)
...

=vBCl
-----END PGP SIGNATURE-----
