...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B1EB327E843
	for <lists+linux-next@lfdr.de>; Wed, 30 Sep 2020 14:11:10 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728235AbgI3MLJ (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 30 Sep 2020 08:11:09 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:38317 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728043AbgI3MLJ (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 30 Sep 2020 08:11:09 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4C1Zpv0FY5z9sT6;
        Wed, 30 Sep 2020 22:11:03 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1601467863;
        bh=rRyU+FJb83l+vJ42eh2N0o5AofbBnAOTRFG6rcTCG1k=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 30 Sep 2020 22:11:01 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 30
Message-ID: <20200930221101.4946f936@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/WMk_G4TlPcwbz2lucvO0F2Y";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/WMk_G4TlPcwbz2lucvO0F2Y
...
Non-merge commits (relative to Linus' tree): 11024
 11127 files changed, 414486 insertions(+), 210725 deletions(-)
...
Merging origin/master (ccc1d052eff9 Merge tag 'dmaengine-fix-5.9' of git://=
...
Merging net/master (4972c6ccf9a5 Merge branch 'via-rhine-Resume-fix-and-oth=
er-maintenance-work')
...
destruction)
Merging sound-current/for-linus (13468bfa8c58 ALSA: hda/realtek - set mic t=
o auto detect on a HP AIO machine)
...
Merging btrfs-fixes/next-fixes (5be4bf85f47c Merge branch 'misc-5.9' into n=
ext-fixes)
...
_info.h)
Merging s390/for-next (72dabcdbf536 Merge branch 'features' into for-next)
...
ping and unmapping)
Merging cifs/for-next (fdaa33e20a05 cifs: update internal module version nu=
mber)
...
it_table())
Merging net-next/master (879456bedbe5 net: mvneta: avoid possible cache mis=
ses in mvneta_rx_swbm)
...
Merging bpf-next/master (b0efc216f577 libbpf: Compile in PIC mode only for =
shared library case)
...
ssary NULL check)
Merging bluetooth/master (b40f58b97386 Bluetooth: btusb: Add Qualcomm Bluet=
ooth SoC WCN6855 support)
...
de() macro)
Merging nand/nand/next (796a2a4b6ba8 mtd: onenand: simplify the return expr=
...
Merging amdgpu/drm-next (1ebf4588bcd8 drm/amdgpu: add another raven1 gfxoff=
 quirk)
...
-next)
Merging device-mapper/for-next (3a6434fb7a71 dm: fix missing imposition of =
queue_limits from dm_wq_work() thread)
...
Merging battery/for-next (3c8b5fb9983b MAINTAINERS: Remove Andrew F. Davis)
...
Merging rcu/rcu/next (250c33dc20de locktorture: Invoke percpu_free_rwsem() =
to do percpu-rwsem cleanup)
Merging kvm/linux-next (e792415c5d3e KVM: MIPS/VZ: Fix build error caused b=
y 'kvm_run' cleanup)
Merging kvm-arm/next (2e02cbb236d6 Merge branch 'kvm-arm64/pmu-5.9' into kv=
marm-master/next)
CONFLICT (content): Merge conflict in arch/arm64/kvm/hyp/Makefile
...
do_copy)
Merging akpm-current/current (43371e0211d5 x86: add failure injection to ge=
t/put/clear_user)
...
Merging akpm/master (4e3acc36171d lib/mpi: fix off-by-one check on index "n=
o")
...

=PUi+
-----END PGP SIGNATURE-----
