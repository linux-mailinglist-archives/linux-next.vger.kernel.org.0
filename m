...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id E062177EFFA
	for <lists+linux-next@lfdr.de>; Thu, 17 Aug 2023 06:51:09 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1348051AbjHQEr4 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 17 Aug 2023 00:47:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50844 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1348044AbjHQErg (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 17 Aug 2023 00:47:36 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CA8DE10E9;
        Wed, 16 Aug 2023 21:47:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1692247650;
        bh=Df2a7hBJSxAAp5xz8S03gmWYZePrmls0w988gRm/Hcc=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4RRCD22Yfpz4wZs;
        Thu, 17 Aug 2023 14:47:30 +1000 (AEST)
Date:   Thu, 17 Aug 2023 14:47:29 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 17
Message-ID: <20230817144729.7d2b1b53@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/RwgBU9/xFNgBruA8jfRJih2";
...
The driver-core tree lost its build failures.

The nvmem tree still had its build failure so I used the version from
next-20230809.

The nolibc tree gained conflicts against the mm-stable and vfs-brauner
trees.

Non-merge commits (relative to Linus' tree): 9826
 11028 files changed, 349269 insertions(+), 163422 deletions(-)
...
Merging net/main (de4c5efeeca7 Merge tag 'nf-23-08-16' of https://git.kerne=
...
Merging sound-asoc-fixes/for-linus (20d8f52afc2a Merge remote-tracking bran=
...
Merging drm-misc-fixes/for-linux-next-fixes (1b254b791d7b drm/nouveau/disp:=
 fix use-after-free in error handling of nouveau_connector_create)
...
Merging perf/perf-tools-next (1836480429d1 perf bpf_skel augmented_raw_sysc=
alls: Cap the socklen parameter using &=3D sizeof(saddr))
...
0 AON PMU support)
Merging s390/for-next (bff857f946b6 Merge branch 'features' into for-next)
...
ums)
Merging btrfs/for-next (7b1ea87cecbb Merge branch 'for-next-next-v6.5-20230=
816' into for-next-20230816)
...
Merging erofs/dev (681352dc72c2 erofs: remove redundant erofs_fs_type decla=
ration in super.c)
...
ap)
Merging net-next/main (950fe35831af Merge branch 'ipv6-expired-routes')
Merging bpf-next/for-next (de40537364c3 Merge branch 'bpf: Force to MPTCP')
...
Merging bluetooth/master (ef6d9b23aa58 Bluetooth: qca: add support for WCN7=
850)
...
n314/dcn314_fpu.c
Merging drm-misc/for-linux-next (438cf3271ca1 drm/panel: simple: Fix Innolu=
x G156HCE-L01 LVDS clock)
Merging amdgpu/drm-next (ef35c7ba6041 Revert "Revert "drm/amdgpu/display: c=
hange pipe policy for DCN 2.0"")
Merging drm-intel/for-linux-next (c0eeae21425e drm/i915/display: Remove unu=
sed POWER_DOMAIN_MASK)
...
Merging sound/for-next (905240d169eb ALSA: hda: intel-dsp-cfg: Add Chromebo=
ok quirk to ADL/RPL)
Merging ieee1394/for-next (06c2afb862f9 Linux 6.5-rc1)
Merging sound-asoc/for-next (eaf68dc03253 Merge remote-tracking branch 'aso=
...
Merging block/for-next (55f563e018ac Merge branch 'for-6.6/io_uring' into f=
or-next)
...
ion)
Merging tpmdd/next (99df99bfa27d integrity: Enforce digitalSignature usage =
...
ne)
Merging devicetree/for-next (7cd8f2ab7953 dt-bindings: PCI: dwc: rockchip: =
Add missing legacy-interrupt-controller)
...
6' into spi-next)
Merging tip/master (3cb61f6101a3 Merge x86/sev into tip/master)
CONFLICT (content): Merge conflict in arch/s390/Kconfig
...
reate_dir())
Merging seccomp/for-next/seccomp (4697b5848bd9 ARM: ptrace: Restore syscall=
 skipping for tracers)
...
Merging kspp/for-next/kspp (be8dffa04de3 um: refactor deprecated strncpy to=
 memcpy)
...

=oflE
-----END PGP SIGNATURE-----
