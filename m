...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 2CD6F682AA1
	for <lists+linux-next@lfdr.de>; Tue, 31 Jan 2023 11:37:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230413AbjAaKhE (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 31 Jan 2023 05:37:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:58526 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230239AbjAaKhD (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 31 Jan 2023 05:37:03 -0500
Received: from mail-pf1-x433.google.com (mail-pf1-x433.google.com [IPv6:2607:f8b0:4864:20::433])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6A1E11449A
        for <linux-next@vger.kernel.org>; Tue, 31 Jan 2023 02:37:00 -0800 (PST)
Received: by mail-pf1-x433.google.com with SMTP id g9so7837583pfk.13
        for <linux-next@vger.kernel.org>; Tue, 31 Jan 2023 02:37:00 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=RUWV7GDGRrQLXSRmQTQ/x/c+fyfxRGJ20RaqCDQzD5k=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=RUWV7GDGRrQLXSRmQTQ/x/c+fyfxRGJ20RaqCDQzD5k=;
        b=
X-Gm-Message-State: AO0yUKWj15HRCH2SeCF5pv8xci2za9qDN95ePldG7Jjbtx2NymG2lEex
        auP7WfZZ2DZl58j9qsXXnfLKuRUnMXfVQakwKXMSqw==
X-Google-Smtp-Source: AK7set+/V66Zdt6XpZ/Hrhu54ZTxf1qhxMLLONCIZEsqpKJKvVeOvrOEOkZLGo9bN8TbLIJ73TY+AA==
X-Received: by 2002:a05:6a00:450e:b0:593:b2b2:9544 with SMTP id cw14-20020a056a00450e00b00593b2b29544mr8575069pfb.0.1675161418905;
        Tue, 31 Jan 2023 02:36:58 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id e5-20020aa78c45000000b0058d9710cb18sm4501777pfd.2.2023.01.31.02.36.57
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 31 Jan 2023 02:36:58 -0800 (PST)
Message-ID: <63d8ef4a.a70a0220.e7841.84e9@mx.google.com>
Date:   Tue, 31 Jan 2023 02:36:58 -0800 (PST)
...
Subject: next/master build: 191 builds: 7 failed, 184 passed, 10 errors,
 31 warnings (next-20230131)
...
next/master build: 191 builds: 7 failed, 184 passed, 10 errors, 31 warnings=
 (next-20230131)
...
Tree: next
Branch: master
Git Describe: next-20230131
Git Commit: 80bd9028fecadae4e8e3a278cd32d74badc2a6e0
...
directory
    1    fs/udf/partition.c:86:28: error: variable 'loc' is uninitialized w=
...
=99} [-Wformat=3D]
    1    fs/udf/partition.c:52:14: note: initialize the variable 'loc' to s=
ilence this warning
