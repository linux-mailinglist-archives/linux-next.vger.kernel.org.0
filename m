...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 1B3EC19A390
	for <lists+linux-next@lfdr.de>; Wed,  1 Apr 2020 04:25:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731573AbgDACZe (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 31 Mar 2020 22:25:34 -0400
Received: from mail-pg1-f193.google.com ([209.85.215.193]:35683 "EHLO
        mail-pg1-f193.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731531AbgDACZe (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 31 Mar 2020 22:25:34 -0400
Received: by mail-pg1-f193.google.com with SMTP id k5so9141414pga.2
        for <linux-next@vger.kernel.org>; Tue, 31 Mar 2020 19:25:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=qFP497w8gP/EFNXP+nOLrBdDMPrRj1cubkvcsn1F6js=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=qFP497w8gP/EFNXP+nOLrBdDMPrRj1cubkvcsn1F6js=;
        b=
X-Gm-Message-State: ANhLgQ3lfkN/vZvPiWviuYsh5Zjf4aF1Xh993dDVWZ9GgaoxKvo3nmr6
        zzPmchHcy/iJ8QPTzMFvaYDrxsd5Dvg=
X-Google-Smtp-Source: ADFU+vsl7s8M5Vc7JDp0sdA6tK/4cPEbgK7/J4UcRuR8dsEJ0wGu6K4wWCkit6/8gi4KTTY/TOsMTQ==
X-Received: by 2002:aa7:9844:: with SMTP id n4mr20017977pfq.98.1585707928561;
        Tue, 31 Mar 2020 19:25:28 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id y4sm379254pfo.39.2020.03.31.19.25.27
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 31 Mar 2020 19:25:27 -0700 (PDT)
Message-ID: <5e83fb97.1c69fb81.99a70.220f@mx.google.com>
Date:   Tue, 31 Mar 2020 19:25:27 -0700 (PDT)
...
Subject: next/pending-fixes build: 216 builds: 1 failed, 215 passed, 4 errors,
 145 warnings (v5.6-3095-g771732386d6d)
...
next/pending-fixes build: 216 builds: 1 failed, 215 passed, 4 errors, 145 w=
arnings (v5.6-3095-g771732386d6d)
...
g to symbol LEDS_TRIGGER_ONESHOT
    1    /tmp/ccyDwX2b.s:18191: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccyDwX2b.s:18119: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccyDwX2b.s:18119: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccyDwX2b.s:18191: Warning: using r15 results in unpredictable beha=
viour
...
Section mismatches:
    WARNING: vmlinux.o(.text.unlikely+0x3a40): Section mismatch in referenc=
...
Section mismatches:
    WARNING: vmlinux.o(.text.unlikely+0x36e4): Section mismatch in referenc=
e from the function pmax_setup_memory_region() to the function .init.text:a=
dd_memory_region()
