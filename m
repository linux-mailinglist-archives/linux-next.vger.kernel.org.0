...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 311B96A38E9
	for <lists+linux-next@lfdr.de>; Mon, 27 Feb 2023 03:41:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231640AbjB0Cli (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sun, 26 Feb 2023 21:41:38 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59668 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231689AbjB0ClZ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Sun, 26 Feb 2023 21:41:25 -0500
Received: from mail-qt1-x82b.google.com (mail-qt1-x82b.google.com [IPv6:2607:f8b0:4864:20::82b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0E6431F925
        for <linux-next@vger.kernel.org>; Sun, 26 Feb 2023 18:40:42 -0800 (PST)
Received: by mail-qt1-x82b.google.com with SMTP id s12so5230890qtq.11
        for <linux-next@vger.kernel.org>; Sun, 26 Feb 2023 18:40:42 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=ahQTvdmr18r1lzavNeRfljO33bOWKZdjXyrbSl58w9Y=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=ahQTvdmr18r1lzavNeRfljO33bOWKZdjXyrbSl58w9Y=;
        b=
X-Gm-Message-State: AO0yUKUI21oMYB0IrLbKHB363UZ5cLbhrHAmTJex9t+srpaEpREyWEcR
        +3ySsquZfi2U5RKplmD6uhyiwr9tjOvZ8tNZlQYV7g==
X-Google-Smtp-Source: AK7set8RkW63xER1Bu54D6Y9WP2fkMNQSASqH5ZwIs1M/JIjUG+3pH9WgC726/fsPNma4ChZWP1LKw==
X-Received: by 2002:a62:38d8:0:b0:5ac:41d5:ded2 with SMTP id f207-20020a6238d8000000b005ac41d5ded2mr19418109pfa.1.1677464887282;
        Sun, 26 Feb 2023 18:28:07 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id c24-20020aa78c18000000b005ac419804d5sm3133124pfd.98.2023.02.26.18.28.06
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Sun, 26 Feb 2023 18:28:06 -0800 (PST)
Message-ID: <63fc1536.a70a0220.16bbf.4d7d@mx.google.com>
Date:   Sun, 26 Feb 2023 18:28:06 -0800 (PST)
...
Subject: next/master build: 195 builds: 10 failed, 185 passed, 14 errors,
 16 warnings (next-20230227)
...
next/master build: 195 builds: 10 failed, 185 passed, 14 errors, 16 warning=
s (next-20230227)
...
Tree: next
Branch: master
Git Describe: next-20230227
Git Commit: 7f7a8831520f12a3cf894b0627641fad33971221
...
=80=98-mhard-float=E2=80=99
    3    drivers/block/zram/zram_drv.c:1234:23: error: passing argument 1 o=
f =E2=80=98atomic64_read=E2=80=99 from incompatible pointer type [-Werror=
=3Dincompatible-pointer-types]
    2    drivers/block/zram/zram_drv.c:1234:23: error: incompatible pointer=
 types passing 'atomic_long_t *' (aka 'atomic_t *') to parameter of type 'c=
onst atomic64_t *' [-Werror,-Wincompatible-pointer-types]
...
Errors:
    drivers/block/zram/zram_drv.c:1234:23: error: incompatible pointer type=
s passing 'atomic_long_t *' (aka 'atomic_t *') to parameter of type 'const =
