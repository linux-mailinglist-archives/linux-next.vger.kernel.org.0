...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 63F6169F088
	for <lists+linux-next@lfdr.de>; Wed, 22 Feb 2023 09:41:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231398AbjBVIlC (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 22 Feb 2023 03:41:02 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59362 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231305AbjBVIkz (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 22 Feb 2023 03:40:55 -0500
Received: from mail-pj1-x1034.google.com (mail-pj1-x1034.google.com [IPv6:2607:f8b0:4864:20::1034])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 265E31E5CA
        for <linux-next@vger.kernel.org>; Wed, 22 Feb 2023 00:40:51 -0800 (PST)
Received: by mail-pj1-x1034.google.com with SMTP id i1-20020a17090ad34100b00234463de251so7771128pjx.3
        for <linux-next@vger.kernel.org>; Wed, 22 Feb 2023 00:40:51 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=/9W868wOc3ezxBoJvAprs/eSGkTKC+mz5mFNdoyv/7o=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=/9W868wOc3ezxBoJvAprs/eSGkTKC+mz5mFNdoyv/7o=;
        b=
X-Gm-Message-State: AO0yUKUsL+ZgCbNMdlNI5pmDksuelCqkVboLbL1O1eDn/3wQv2rzjIxG
        hRZ8X7uTsDe9hkX96GOXy5CEkRPn0IBMvNGjUyY=
X-Google-Smtp-Source: AK7set+JUKG9QNXl5qFy9N8BQxtOnql6NbZqa+YT8v5Iko0aUdmPZ2R0s30o85Q4mBJHK9k7yaHQvg==
X-Received: by 2002:a17:902:f543:b0:19a:96f0:b0f with SMTP id h3-20020a170902f54300b0019a96f00b0fmr6244612plf.28.1677055249666;
        Wed, 22 Feb 2023 00:40:49 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id jc4-20020a17090325c400b0019a9751096asm11211633plb.305.2023.02.22.00.40.49
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 22 Feb 2023 00:40:49 -0800 (PST)
Message-ID: <63f5d511.170a0220.6aae2.4841@mx.google.com>
Date:   Wed, 22 Feb 2023 00:40:49 -0800 (PST)
...
Subject: next/master build: 204 builds: 10 failed, 194 passed, 15 errors,
 40 warnings (next-20230222)
...
next/master build: 204 builds: 10 failed, 194 passed, 15 errors, 40 warning=
s (next-20230222)
...
Tree: next
Branch: master
Git Describe: next-20230222
Git Commit: aaf70d5ad5e2b06a8050c51e278b0c3a14fabef5
...
=80=98-mhard-float=E2=80=99
    3    drivers/gpu/drm/msm/msm_fbdev.c:144:6: error: variable 'helper' is=
...
-Wcpp]
    6    drivers/gpu/drm/msm/msm_fbdev.c:140:30: note: initialize the varia=
...
_base_destroy=E2=80=99 defined but not used [-Wunused-function]
    3    drivers/gpu/drm/msm/msm_fbdev.c:144:6: warning: variable 'helper' =
...
Warnings:
    drivers/gpu/drm/msm/msm_fbdev.c:144:6: warning: variable 'helper' is us=
