...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 26C764FCF1D
	for <lists+linux-next@lfdr.de>; Tue, 12 Apr 2022 07:51:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243858AbiDLFxR (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 12 Apr 2022 01:53:17 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:45142 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239798AbiDLFxQ (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 12 Apr 2022 01:53:16 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C5D132DA9C;
        Mon, 11 Apr 2022 22:50:57 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4KcvwH18pDz4xLS;
        Tue, 12 Apr 2022 15:50:55 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1649742655;
        bh=vv7BmAap/fUNUbbbjoOmVQ7C1amjo2/449bDt8e9OMQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 12 Apr 2022 15:50:53 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 12
Message-ID: <20220412155053.1c7a903b@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/DpM.pg0czs3gTOlUdXsdzSw";
...
--Sig_/DpM.pg0czs3gTOlUdXsdzSw
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220411:

The dmaengine tree gained a conflict against the dmaengine-fixes tree.

Non-merge commits (relative to Linus' tree): 3000
 3726 files changed, 138892 insertions(+), 66343 deletions(-)
...
Merging net/master (e3fa461d8b0e ipv6: fix panic when forwarding a pkt with=
 no in6 dev)
...
Merging sound-current/for-linus (264fb03497ec ALSA: hda/realtek: add quirk =
for Lenovo Thinkpad X12 speakers)
...
evkit8000)
Merging kvm-fixes/master (c538dc792ff7 KVM: SVM: Do not activate AVIC for S=
EV-enabled guest)
...
Merging gpio-brgl-fixes/gpio/for-current (29964c90f2e8 gpiolib: of: fix bou=
nds check for valid mask)
...
ATC2603C PMIC)
Merging amlogic/for-next (862203e9f566 Merge branch 'v5.19/dt64' into for-n=
ext)
...
or-next)
Merging omap/for-next (bf194bb4328b Merge branches 'omap-for-v5.19/dt-bindi=
ngs' and 'omap-for-v5.19/dt' into for-next)
Merging qcom/for-next (3db7b4314937 Merge branches 'arm64-for-5.19', 'arm64=
...
Merging exfat/dev (870e49e30362 exfat: introduce mount option 'sys_tz')
...
ort)
Merging net-next/master (d072c88c28e1 net: ethernet: ti: cpsw: drop CPSW_HE=
ADROOM define)
...
Merging wireless-next/main (046d2e7c50e3 mac80211: prepare sta handling for=
 MLO support)
...
Merging drm-misc/for-linux-next (73c3ed7495c6 drm: mali-dp: potential deref=
erence of null pointer)
Applying: fixup for "spi: make remove callback a void function"
Merging amdgpu/drm-next (6866a60a8ef7 drm/radeon: remove r600_blit_shaders.=
[c|h])
...
Merging drm-intel/for-linux-next (82c362f2c690 drm/i915/dg2: Do not explode=
 on phy calibration error)
...
Merging fbdev/for-next (15cf0b82271b video: fbdev: i740fb: Error out if 'pi=
xclock' equals zero)
...
s with CVQ)
Merging rpmsg/for-next (68d9787bdd5c remoteproc: Don't bother checking the =
return value of debugfs_create*)
...
Merging akpm/master (a30238d7ce65 kselftest/vm: override TARGETS from argum=
ents)
...

=TEGR
-----END PGP SIGNATURE-----
