...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 6518E273EDA
	for <lists+linux-next@lfdr.de>; Tue, 22 Sep 2020 11:49:54 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726658AbgIVJtt (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 22 Sep 2020 05:49:49 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:51096 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726341AbgIVJts (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Tue, 22 Sep 2020 05:49:48 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 2A9ABC061755;
        Tue, 22 Sep 2020 02:49:48 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Bwc3Y2Dsqz9sR4;
        Tue, 22 Sep 2020 19:49:45 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1600768185;
        bh=xw1hDOL9wUIp8BJpZQvfQMIGHU3y9wEMm0N/zjgaQ4c=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 22 Sep 2020 19:49:44 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 22
Message-ID: <20200922194944.17f95db2@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/oSbznGevE.b9RKjxE4vzxFY";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/oSbznGevE.b9RKjxE4vzxFY
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200921:
...
Non-merge commits (relative to Linus' tree): 8731
 9391 files changed, 320530 insertions(+), 163478 deletions(-)
...
Merging origin/master (98477740630f Merge branch 'rcu/urgent' of git://git.=
...
Merging net/master (25b8ab916dd7 Merge tag 'mac80211-for-net-2020-09-21' of=
...
destruction)
Merging sound-current/for-linus (8f8bf00b1c00 Revert "ALSA: hda - Fix silen=
t audio output and corrupted input on MSI X570-A PRO")
Merging sound-asoc-fixes/for-linus (f026a5bba4d6 Merge remote-tracking bran=
ch 'asoc/for-5.9' into asoc-linus)
Merging regmap-fixes/for-linus (1221717faeca Merge remote-tracking branch '=
regmap/for-5.9' into regmap-linus)
Merging regulator-fixes/for-linus (ba4f184e126b Linux 5.9-rc6)
Merging spi-fixes/for-linus (51b1418e5962 Merge remote-tracking branch 'spi=
...
Merging usb.current/usb-linus (ba4f184e126b Linux 5.9-rc6)
...
Merging btrfs-fixes/next-fixes (2af37bc42839 Merge branch 'misc-5.9' into n=
ext-fixes)
...
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (ba4f184e126b Linux 5.9-rc6)
...
o ti-k3-next)
Merging ti-k3-new/ti-k3-next (cf087d9c043a Merge tag 'ti-k3-dt-fixes-for-v5=
.9' into ti-k3-dts-next)
...
Merging fscrypt/master (4cbbe7b8f3da fscrypt: use sha256() instead of open =
coding)
...
in imxfb_probe())
Merging pm/linux-next (24a16b940f0b Merge branches 'pm-cpuidle' and 'pm-cor=
e' into linux-next)
...
eters alignment)
Merging net-next/master (92ec804f3dbf net: phy: bcm7xxx: Add an entry for B=
CM72113)
...
Merging wireless-drivers-next/master (02686841d58f rtlwifi: rtl8723be: fix =
comparison to bool warning in hw.c)
...
Merging drm-misc/for-linux-next (d7b1c018140f drm/panel: samsung: make vint=
_table static const)
...
Merging sound/for-next (534ad9afb19b ALSA: hda - fix CONTROLLER_IN_GPU macr=
o name)
Merging sound-asoc/for-next (6b309cf7557a Merge remote-tracking branch 'aso=
...
-next)
Merging device-mapper/for-next (cf9c37865557 dm: fix comment in dm_process_=
bio())
...
Merging usb/usb-next (55be22adf11b Merge a31128384dfd ("Merge tag 'libnvdim=
m-fixes-5.9-rc7' of git://git.kernel.org/pub/scm/linux/kernel/git/nvdimm/nv=
dimm") into usb-next)
...
Merging akpm/master (31052435f835 mm: introduce memfd_secret system call to=
...

=abwt
-----END PGP SIGNATURE-----
