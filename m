...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5274628B1DC
	for <lists+linux-next@lfdr.de>; Mon, 12 Oct 2020 11:59:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726988AbgJLJ7O (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 12 Oct 2020 05:59:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53322 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726104AbgJLJ7M (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 12 Oct 2020 05:59:12 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4D2CBC0613CE;
        Mon, 12 Oct 2020 02:59:11 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4C8vK81q1sz9sSs;
        Mon, 12 Oct 2020 20:59:08 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1602496748;
        bh=Wfa7uynqPvhnhXggNPfQNCZCtaQL+CBeCvomsY6amiw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 12 Oct 2020 20:59:06 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 12
Message-ID: <20201012205906.51237c67@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/o5gJ89.dNmNcovMYEZwNGSr";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/o5gJ89.dNmNcovMYEZwNGSr
...
The irqchip tree gained a conflict against the mfd tree.

The counters tree gained a conflict against the ipmi tree.

The akpm-current tree gained conflicts against the counters and kunit-next
trees.

Non-merge commits (relative to Linus' tree): 13357
 12900 files changed, 716926 insertions(+), 280924 deletions(-)
...
Merging origin/master (bbf5c979011a Linux 5.9)
...
Merging net/master (874fb9e2ca94 ipv4: Restore flowi4_oif update before cal=
l to xfrm_lookup_route)
...
Merging asm-generic/master (1ed4c95761e7 xtensa: use asm-generic/mmu_contex=
t.h for no-op implementations)
...
ping and unmapping)
Merging cifs/for-next (e913b52c8903 SMB3.1.1: add defines for new signing n=
egotiate context)
...
d_nolock mount opt)
Merging f2fs/dev (7369daac4fb8 f2fs: f2fs_get_meta_page_nofail should not b=
e failed)
...
Merging nfs-anna/linux-next (39d43d164127 NFSv4: Use the net namespace uniq=
uifier if it is set)
...
Merging v9fs/9p-next (316a1bef0d16 9p/xen: Fix format argument warning)
...
Merging jc_docs/docs-next (6575aeab72e0 Documentation: better locations for=
...
Merging rdma/for-next (1c39c16d64bc Merge branch 'dynamic_sg' into rdma.git=
 for-next)
Merging net-next/master (bc081a693a56 Merge branch 'Offload-tc-vlan-mangle-=
to-mscc_ocelot-switch')
...
Merging mtd/mtd/next (9113ba38fb81 Merge tag 'cfi/for-5.10' of gitolite.ker=
nel.org:pub/scm/linux/kernel/git/mtd/linux into mtd/next)
...
ist size."
Merging amdgpu/drm-next (0b26c37d90d6 drm/amdgpu: add another raven1 gfxoff=
 quirk)
Merging drm-intel/for-linux-next (8fbde422e026 drm/i915: Fix TGL DKL PHY DP=
 vswing handling)
Merging drm-tegra/drm/tegra/for-next (d9f980ebcd01 drm/tegra: output: rgb: =
Wrap directly-connected panel into DRM bridge)
Merging drm-misc/for-linux-next (c2df75ad2a9f drm/panfrost: increase readl_=
relaxed_poll_timeout values)
...
Merging sound/for-next (96e503f9000f ALSA: hda/i915 - fix list corruption w=
ith concurrent probes)
...
10' into spi-next)
Merging tip/auto-latest (820e6f502f02 Merge branch 'efi/core')
...
Merging rcu/rcu/next (75c79a5dd72c rcutorture: Don't do need_resched() test=
ing if ->sync is NULL)
...
Merging akpm/master (9efd6f90761e mm: remove duplicate include statement in=
 mmu.c)
...

=/XQg
-----END PGP SIGNATURE-----
