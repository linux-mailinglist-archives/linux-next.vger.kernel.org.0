...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B7AA031E9B8
	for <lists+linux-next@lfdr.de>; Thu, 18 Feb 2021 13:26:44 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230009AbhBRMZK (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 18 Feb 2021 07:25:10 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43874 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230165AbhBRJzY (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 18 Feb 2021 04:55:24 -0500
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 22AFAC0617A9;
        Thu, 18 Feb 2021 01:54:37 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4Dh96K5JNjz9sRf;
        Thu, 18 Feb 2021 20:54:33 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1613642073;
        bh=8GAQM6xkmBicsa/kVvHE/SwglBNPgvdlMeQVcMaFSvs=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 18 Feb 2021 20:54:31 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Feb 18
Message-ID: <20210218205431.6e4c823d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/M47pjE1mbv+MR8BeLWgnJNJ";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/M47pjE1mbv+MR8BeLWgnJNJ
...
Merging at91-fixes/at91-fixes (a3db58a392c8 ARM: dts: at91-sama5d27_som1: f=
ix phy address to 7)
...
t into Kconfig)
Merging hid/for-next (364c69ced8f9 Merge branch 'for-5.12/playstation-v2' i=
nto for-next)
...
in imxfb_probe())
Merging pm/linux-next (c9756fcd3979 Merge branch 'pm-cpufreq-fixes' into li=
nux-next)
...
Merging rdma/for-next (ed4085296797 RDMA/rtrs-srv: Do not pass a valid poin=
ter to PTR_ERR())
...
tion mode support)
Merging netfilter-next/master (6001a930ce03 netfilter: nftables: introduce =
table ownership)
...
Merging gfs2/for-next (76e78e0b97a1 Merge branch 'gfs2-revoke' into for-nex=
t)
...
Merging amdgpu/drm-next (85f4f00c1e88 Revert "drm/amd/display: reuse curren=
t context instead of recreating one")
...
Merging input/next (b0b7d2815839 Input: sur40 - fix an error code in sur40_=
probe())
...
isting file)
Merging gpio-brgl/gpio/for-next (ab94f4c529bc gpio: pcf857x: Fix missing fi=
rst interrupt)
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/toshiba/tmpv7708-=
rm-mbrc.dts
CONFLICT (content): Merge conflict in MAINTAINERS
$ git reset --hard HEAD^
Merging next-20210217 version of gpio-brgl
CONFLICT (content): Merge conflict in arch/arm64/boot/dts/toshiba/tmpv7708-=
rm-mbrc.dts
CONFLICT (content): Merge conflict in MAINTAINERS
[master 41d0ffbd5edc] next-20210217/gpio-brgl
...
Merging akpm/master (1a9c8f47ec78 MIPS: make userspace mapping young by def=
ault)
...

=r6Gl
-----END PGP SIGNATURE-----
