Return-Path: <linux-next+bounces-4951-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id DBA089F03E3
	for <lists+linux-next@lfdr.de>; Fri, 13 Dec 2024 05:47:52 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 9176028439F
	for <lists+linux-next@lfdr.de>; Fri, 13 Dec 2024 04:47:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 06FD6152E12;
	Fri, 13 Dec 2024 04:47:49 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="HBvQrtDc"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id A6B4B54765;
	Fri, 13 Dec 2024 04:47:43 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1734065268; cv=none; b=KSDIZy5GJp6le+A33tvOru4uyWfOeelPzsMzBpD4NLCzsWaXJs4gujs4c/o37yRocvPhTU1X9lm9za4Jn6hZB+W20l1uYr3wPR0odOLis4Ezt4+2H5CxSQ/2Kfj0ypy6Us4KuOQCNtKeiu7oPK81ez+kVJV/pBe3qg4F6rYIY1w=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1734065268; c=relaxed/simple;
	bh=g/9/PPSCP61f3+0nUv5iyRdzECWCOLZl4ABGz+Uvd5Y=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=PsK2NjRZvra483BAhoD3weV8xjJppLFxDNkDjtdM2tQqn9M4aKntI8Q/n+jqoqikmLX0EBqbp4CC4VHRYL5+NfMHLusZo1dUippYcVffKSyHbH4FCDO7nFkku3e/9VEzVqV9QkPyJ8+8AwHWjFHAu4gkJ2tjwIXGldyBW/l09eA=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=HBvQrtDc; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1734065256;
	bh=7OkH0AhMX28kTbYkZAljCAfENxKFWQoCLxXg4A8OVpA=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Y8cJm4gM7z4wcl;
	Fri, 13 Dec 2024 15:47:36 +1100 (AEDT)
Date: Fri, 13 Dec 2024 15:47:40 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 13
Message-ID: <20241213154740.6bb3103c@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/z2fd_/sXbXfZuhoCBpHw9lQ";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/z2fd_/sXbXfZuhoCBpHw9lQ
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20241212:

The erofs-fixes tree gained a build failure so I used the version from
next-20241212.

The vfs-brauner tree lost its build failure.

Non-merge commits (relative to Linus' tree): 3146
 3461 files changed, 134340 insertions(+), 55657 deletions(-)
...
Merging origin/master (eefa7a9c0699 Merge tag 'for-linus' of https://github=
.com/openrisc/linux)
...
Merging vfs-brauner-fixes/vfs.fixes (867f85679cb4 Merge patch series "iomap=
: fix zero padding data issue in concurrent append writes")
...
Merging erofs-fixes/fixes (320077e635e7 erofs: use buffered I/O for file-ba=
cked mounts by default)
$ git reset --hard HEAD^
Merging next-20241212 version of erofs-fixes
...
when mounting)
Merging cifs/for-next (d3672e392474 smb: client: fix TCP timers deadlock af=
ter rmmod with non-init_net ns)
...
Merging fuse/for-next (7a4f54187373 fuse: fix direct io folio offset and le=
ngth calculation)
...
Merging ksmbd/ksmbd-for-next (21e46a79bbe6 ksmbd: set ATTR_CTIME flags when=
 setting mtime)
...
Merging xfs/for-next (e2b718c00102 Merge tag 'fixes-6.13_2024-12-11' of htt=
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (7e21130d9f3e Merge branch 'vfs-6.14.mount' int=
o vfs.all)
Merging vfs/for-next (5cc68af412a9 fs/overlayfs/namei.c: get rid of include=
 ../internal.h)
Merging mm-hotfixes/mm-hotfixes-unstable (303b27971012 mm/page_alloc: don't=
 call pfn_to_page() on possibly non-existent PFN in split_large_buddy())
Merging fs-current (f9c1cad48b09 next-20241212/erofs-fixes)
...
Merging arm64-fixes/for-next/fixes (65ac33bed8b9 arm64: stacktrace: Don't W=
ARN when unwinding other tasks)
...
Merging s390-fixes/fixes (5fa49dd8e521 s390/ipl: Fix never less than zero w=
arning)
Merging net/main (150b567e0d57 Merge tag 'net-6.13-rc3' of git://git.kernel=
.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (e4c80f69758e Merge branch 'add-missing-size-check-for-b=
tf-based-ctx-access')
...
Merging v4l-dvb-fixes/fixes (2dd59fe0e19e media: dvb-frontends: dib3000mb: =
fix uninit-value in dib3000_write_reg)
...
Merging tip-fixes/tip/urgent (e3d63da5b654 Merge branch into tip/master: 's=
ched/urgent')
Merging slab-fixes/slab/for-next-fixes (b7ffecbe198e memcg: slub: fix SUnre=
claim for post charged objects)
Merging drm-misc-fixes/for-linux-next-fixes (0cff90dec63d dma-buf: Fix __dm=
a_buf_debugfs_list_del argument for !CONFIG_DEBUG_FS)
...
Merging mm/mm-everything (1598c9729d07 foo)
...
Merging amlogic/for-next (1b0dd099567b Merge branch 'v6.14/drivers' into fo=
r-next)
...
or-next)
Merging omap/for-next (9d252d6ba0a8 Merge branch 'omap-for-v6.14/drivers' i=
nto tmp/omap-next-20241210.161808)
...
Merging renesas/next (799d21bcf268 Merge branch 'renesas-dts-for-v6.14' int=
o renesas-next)
...
nto for-next)
Merging samsung-krzk/for-next (b04bf13919e8 Merge branch 'next/dt64' into f=
or-next)
...
next)
Merging thead-dt/thead-dt-for-next (40384c840ea1 Linux 6.13-rc1)
...
Merging fs-next (a939bd8aa693 Merge branch 'for-next' of git://git.kernel.o=
...
Merging jc_docs/docs-next (92b3d24de890 Merge branch 'docs-fixes' into docs=
-next)
Merging v4l-dvb/next (686f27f7ea37 media: stm32: dcmipp: add core support f=
or the stm32mp25)
Merging v4l-dvb-next/master (b36c41c51e9d media: atomisp: set lock before c=
alling vb2_queue_init())
Merging pm/linux-next (a02f1f619c09 Merge branches 'pm-cpuidle' and 'pm-cpu=
freq' into linux-next)
Merging cpufreq-arm/cpufreq/arm/linux-next (636387e1ffed cpufreq: airoha: A=
...
MADs)
Merging net-next/main (5098462fbac6 Merge git://git.kernel.org/pub/scm/linu=
...
stable)
Merging wireless-next/for-next (73e456b402fa wifi: qtnfmac: fix spelling er=
ror in core.h)
...
ary checking)
Merging drm-misc/for-linux-next (322a00efec6a drm/log: select CONFIG_FONT_S=
UPPORT)
...
mentation comments)
Merging drm-xe/drm-xe-next (4d79a1266d4c drm/xe: Make irq enabled flag atom=
ic)
...
anagement)
Merging sound-asoc/for-next (3a192024163c Merge remote-tracking branch 'aso=
...
Merging battery/for-next (5d417a5e7ade power: supply: bq24190_charger: Add =
support for "charge_types" property)
...
Merging selinux/next (034294fbfdf0 selinux: Fix SCTP error inconsistency in=
 selinux_socket_bind())
...
Merging iommu/next (7460d43bd75d Merge tag 'arm-smmu-fixes' of git://git.ke=
rnel.org/pub/scm/linux/kernel/git/will/linux into fixes)
...
hecks)
Merging tip/master (95ff56760ec6 Merge branch into tip/master: 'x86/tdx')
...
Merging edac/edac-for-next (8024765f43c5 Merge edac-urgent into for-next)
...
ueue traits)
Merging sched-ext/for-next (353b2a7de2a3 Merge branch 'for-6.13-fixes' into=
 for-next)
...
Merging gpio-brgl/gpio/for-next (b7bbaff8c1bc gpio: omap: save two lines by=
 using devm_clk_get_prepared())
...
Merging kthread/for-next (2e6edb4e3ae0 rcu: Use kthread preferred affinity =
...

=/IrS
-----END PGP SIGNATURE-----
