...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 42DC075306E
	for <lists+linux-next@lfdr.de>; Fri, 14 Jul 2023 06:15:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233913AbjGNEPc (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 14 Jul 2023 00:15:32 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:32996 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232770AbjGNEPb (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 14 Jul 2023 00:15:31 -0400
Received: from gandalf.ozlabs.org (mail.ozlabs.org [IPv6:2404:9400:2221:ea00::3])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 47B3A272A;
        Thu, 13 Jul 2023 21:15:25 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1689308120;
        bh=aZhypDNbsBWuYwfrEp0gGzR0uRScssqB62HdqaFW8vk=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4R2J6c43lrz4whq;
        Fri, 14 Jul 2023 14:15:20 +1000 (AEST)
Date:   Fri, 14 Jul 2023 14:15:18 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 14
Message-ID: <20230714141518.01d31358@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/DAH0wVjYdtZSxM6IsO7seLO";
...
Merging origin/master (4b810bf037e5 Merge tag 'erofs-for-6.5-rc2-fixes' of =
git://git.kernel.org/pub/scm/linux/kernel/git/xiang/erofs)
Merging fixes/fixes (d528014517f2 Revert ".gitignore: ignore *.cover and *.=
mbx")
Merging mm-hotfixes/mm-hotfixes-unstable (46575249388f mm-shmem-fix-race-in=
...
Merging sound-current/for-linus (645e583d2689 selftests: ALSA: Fix fclose o=
n an already fclosed file pointer)
Merging sound-asoc-fixes/for-linus (a3e64c2b2c65 Merge remote-tracking bran=
...
Merging regulator-fixes/for-linus (31e112d5bb1c Merge remote-tracking branc=
...
Merging kselftest-fixes/fixes (b33b8731566d selftests/mincore: fix skip con=
dition for check_huge_pages test)
...
Merging mmc-fixes/fixes (d44263222134 mmc: moxart: read scr register withou=
t changing byte order)
...
Merging drm-misc-fixes/for-linux-next-fixes (2329cc7a101a drm/client: Fix m=
emory leak in drm_client_modeset_probe)
Merging mm-stable/mm-stable (06c2afb862f9 Linux 6.5-rc1)
Merging mm-nonmm-stable/mm-nonmm-stable (06c2afb862f9 Linux 6.5-rc1)
Merging mm/mm-everything (8a5829411a1e Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
...
Merging tee/next (6a8b7e801054 tee: optee: Use kmemdup() to replace kmalloc=
 + memcpy)
Merging tegra/for-next (492a5be06fb0 Merge branch for-6.6/arm64/dt into for=
-next)
...
gth checks)
Merging cifs/for-next (b04a27544103 smb: add missing create options for O_D=
IRECT and O_SYNC flags)
Merging configfs/for-next (77992f896745 configfs: remove mentions of commit=
table items)
Merging ecryptfs/next (a3d78fe3e1ae fs: ecryptfs: comment typo fix)
Merging erofs/dev (06c2afb862f9 Linux 6.5-rc1)
Merging exfat/dev (d42334578eba exfat: check if filename entries exceeds ma=
x filename length)
...
'cpumask_setall()')
Merging vfs-brauner/vfs.all (cf22d118b89a Merge branches 'vfs.readdir', 'vf=
...
Merging pm/linux-next (998829ca60f7 Merge branch 'thermal-core' into linux-=
next)
$ git reset --hard HEAD^
...
Merging bpf-next/for-next (1cd0e7715cad selftests/bpf: Add selftest for PTR=
_UNTRUSTED)
...
(void*) conversions)
Merging nand/nand/next (2b42d718c7d7 dt-bindings: mtd: Fix nand-controller.=
yaml license)
...
Merging drm-misc/for-linux-next (7dae503584a1 drm/ssd130x: Change pixel for=
mat used to compute the buffer size)
...
Merging sound/for-next (67192cc0f026 ALSA: emu10k1: remove superfluous IRQ =
enable state saving)
Merging ieee1394/for-next (06c2afb862f9 Linux 6.5-rc1)
Merging sound-asoc/for-next (3acd333049b8 Merge remote-tracking branch 'aso=
...
tly)
Merging block/for-next (cfd18f91a154 Merge branch 'for-6.6/block' into for-=
next)
...
Flash driver)
Merging mmc/next (9289a19bce21 mmc: pxamci: Use devm_platform_get_and_iorem=
ap_resource())
...
Merging regulator/for-next (f5f8fe9226b1 Merge remote-tracking branch 'regu=
...

=kfSg
-----END PGP SIGNATURE-----
