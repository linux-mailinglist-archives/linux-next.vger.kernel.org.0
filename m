=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed; d=suse.cz;
	s=susede2_ed25519; t=1737735210;
	h=from:from:reply-to:date:date:message-id:message-id:to:to:cc:
	 mime-version:mime-version:content-type:content-type:
	 content-transfer-encoding:content-transfer-encoding:
	 in-reply-to:in-reply-to:references:references;
	bh=HhQ6l7BwYTkvLafQlW/cjDXGoo6Q7C18KB02j7HRdBk=;
	b=ypvGBjQP+F/4L0mywF+nJOKsH7D0mePtkIfgAL4K3PjCD8YIYN3BPeifaqv4I1R3Djo/oD
	pJRXjf2OC9ntGYDg==
Received: from imap1.dmz-prg2.suse.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by imap1.dmz-prg2.suse.org (Postfix) with ESMTPS id 5375E13999;
	Fri, 24 Jan 2025 16:13:30 +0000 (UTC)
Received: from dovecot-director2.suse.de ([2a07:de40:b281:106:10:150:64:167])
	by imap1.dmz-prg2.suse.org with ESMTPSA
	id GVCwEyq8k2e2ewAAD6G6ig
	(envelope-from <vbabka@suse.cz>); Fri, 24 Jan 2025 16:13:30 +0000
Message-ID: <fab7e387-a86c-483a-a472-22e7b3ae82b7@suse.cz>
Date: Fri, 24 Jan 2025 17:13:29 +0100
Precedence: bulk
...
Subject: Re: next-20250121: kvm selftests: RIP:
 0010:__kmalloc_node_noprof+0xff/0x490
Content-Language: en-US
To: "Aithal, Srikanth" <sraithal@amd.com>, linux-mm@kvack.org,
 linux-kernel@vger.kernel.org, linux-next@vger.kernel.org,
 KVM <kvm@vger.kernel.org>, Steven Rostedt <rostedt@goodmis.org>,
...
On 1/22/25 05:48, Aithal, Srikanth wrote:
> Hello all,
> 
> While running kvm selftests on AMD EPYC platform with 6.13.0-next-20250121
> below general protection fault is being hit.
> 
> /Jan 22 00:45:35 kernel: Oops: general protection fault, probably for non-
> canonical address 0xe659260b3c31e5e0: 0000 [#1] PREEMPT SMP NOPTI
...
Could it have been the tracing related corruption? See:
https://lore.kernel.org/all/Z4_OHKESRSiJcr-b@lappy/

> Jan 22 00:45:35 kernel: Code: 0f 84 0b 01 00 00 84 c9 0f 85 03 01 00 00 41
> 83 fb ff 0f 85 e9 00 00 00 41 bb ff ff ff ff 41 8b 44 24 28 49 8b 34 24 48
...
> Jan 22 00:45:35 kernel: Code: ff ff ff 85 c0 79 9b 49 c7 c4 ff ff ff ff 5b
> 5d 4c 89 e0 41 5c c3 66 0f 1f 84 00 00 00 00 00 f3 0f 1e fa b8 10 00 00 00
> 0f 05 <48> 3d 01 f0 ff ff 73 01 c3 48 8b 0d 6d 57 0f 00 f7 d8 64 89 01 48
...
> i2c_piix4 rapl wmi_bmof k10temp acpi_power_meter efi_pstore pcspkr i2c_smbus
> ipmi_si acpi_ipmi ipmi_devintf ipmi_msghandler mac_hid sch_fq_codel
> dmi_sysfs xfs mgag200 drm_client_lib i2c_algo_bit drm_shmem_helper mpt3sas
> drm_kms_helper ghash_clmulni_intel sha512_ssse3 raid_class sha256_ssse3 drm
> ccp tg3 scsi_transport_sas sp5100_tco sha1_ssse3 wmi dm_mirror
> dm_region_hash dm_log msr autofs4 aesni_intel crypto_simd cryptd
