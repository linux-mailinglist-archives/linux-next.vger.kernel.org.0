Return-Path: <linux-next+bounces-5655-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id A784AA4FB5A
	for <lists+linux-next@lfdr.de>; Wed,  5 Mar 2025 11:11:19 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id E0AAA3A6FC1
	for <lists+linux-next@lfdr.de>; Wed,  5 Mar 2025 10:11:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B391A205E33;
	Wed,  5 Mar 2025 10:11:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="bC2J7nr8"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 25C13205E1C;
	Wed,  5 Mar 2025 10:10:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1741169464; cv=none; b=jJSU6viJUpD0pc4K/bNd44Cm+ykkXwqXv6YgNMFV3ApLMF1EeBujsql9swxujcI8x5CfV8pTMthTsI5KwADSCvODckxqyOAe/hVDcvIpuuucULPYgrlMXWL/xL8ySeGXEIwBCEorinJ1FMSPmz55mk6BBoL6ZNJqY+XN+/gAU48=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1741169464; c=relaxed/simple;
	bh=rv7SU3USWTCxtQw1Fp0TspZLSff5vcnZuwm1PgqDeUI=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=FudRgOOCmPp+/CLnRcPN2/aB4pp2DwY6Om6RFmHilsb1qs8ZYDg1KTo95060RFWG8F+kxkGbogSbyDPbXWQb+/yTAnoTn14HKwOXStpL7hRlAwKaK8Sdcr2rWpb+dP4NmsLk+IYxtdC1ieLNh+bKmz7aqM8C0zvzyVXJC3ez5BE=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=bC2J7nr8; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1741169458;
	bh=tMigRnTDaXDZ1HA1xlwRFwWGTHuEyQVh/zkyB9qMw8E=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4Z77c236tyz4wcD;
	Wed,  5 Mar 2025 21:10:58 +1100 (AEDT)
Date: Wed, 5 Mar 2025 21:10:57 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 5
Message-ID: <20250305211057.150fa8d8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/TeHNEz7aO+u6O2irg1v6c0M";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/TeHNEz7aO+u6O2irg1v6c0M
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250304:
...
Non-merge commits (relative to Linus' tree): 7936
 8326 files changed, 418486 insertions(+), 167092 deletions(-)
...
Merging origin/master (48a5eed9ad58 Merge tag 'devicetree-fixes-for-6.14-2'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/robh/linux)
Merging fixes/fixes (fac04efc5c79 Linux 6.13-rc2)
Merging ext4-fixes/fixes (4bbf9020becb Linux 6.13-rc4)
Merging vfs-brauner-fixes/vfs.fixes (e04918dc5946 cred: Fix RCU warnings in=
...
king and fragments)
Merging exfat/dev (79f05f4f921c exfat: remove count used cluster from exfat=
_statfs())
...
Merging f2fs/dev (4116a6f1172c f2fs: introduce FAULT_INCONSISTENT_FOOTER)
...
YSFSPATH)
Merging vfs-brauner/vfs.all (ea47e99a3a23 Merge branch 'vfs-6.15.initramfs'=
 into vfs.all)
CONFLICT (content): Merge conflict in fs/fuse/dir.c
Merging vfs/for-next (2e72b1e0aac2 Merge branch 'work.d_revalidate' into fo=
r-next)
Merging mm-hotfixes/mm-hotfixes-unstable (f61f3fa97904 mm: page_isolation: =
avoid calling folio_hstate() without hugetlb_lock)
Merging fs-current (0a43e4fac76d Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (3c6a041b317a Merge tag 'wireless-2025-03-04' of https://g=
...
())
Merging wireless/for-next (1f860eb4cdda wifi: nl80211: disable multi-link r=
econfiguration)
...
Merging sound-current/for-linus (d0bbe332669c ALSA: hda: realtek: fix incor=
rect IS_REACHABLE() usage)
Merging sound-asoc-fixes/for-linus (164b7dd4546b ASoC: cs42l43: Add jack de=
lay debounce after suspend)
...
Merging drm-intel-fixes/for-linux-next-fixes (7eb172143d55 Linux 6.14-rc5)
...
Merging gpio-brgl-fixes/gpio/for-current (7eb172143d55 Linux 6.14-rc5)
...
Merging tip-fixes/tip/urgent (8d34a3b65cda Merge branch into tip/master: 'x=
86/urgent')
...
Merging mm/mm-everything (143d7cf88300 foo)
Merging kbuild/for-next (a77b570b6c3f modpost: use strstarts() to clean up =
parse_source_files())
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (be9f3e95a938 perf stat: Fix non-uniquified hy=
brid legacy events)
...
lbox node)
Merging ti/ti-next (3546b51dae6d Merge branch 'ti-k3-dts-next' into ti-next)
...
Merging fs-next (c0be97666e4d Merge branch 'for-next' of git://git.kernel.o=
...
age size to u32)
Merging hid/for-next (e7e55d2852db Merge branch 'for-6.14/upstream-fixes' i=
nto for-next)
...
Merging v4l-dvb/next (7a419b3bb84d media: cx23885: Add analog support for A=
VerMedia H789-C PCIe card)
Merging v4l-dvb-next/master (b36c41c51e9d media: atomisp: set lock before c=
alling vb2_queue_init())
Merging pm/linux-next (0a83aab6f941 Merge branch 'thermal-core' into linux-=
next)
...
for-next)
Merging net-next/main (71f8992e34a9 Merge tag 'wireless-next-2025-03-04-v2'=
...
Merging bluetooth/master (aaa9cc6993d3 Bluetooth: btintel_pcie: Add support=
 for device coredump)
Merging wireless-next/for-next (799b7f93c010 wifi: iwlwifi: remove mld/roc.=
c)
...
ary checking)
Merging drm-misc/for-linux-next (4006be2f77cd drm/rockchip: lvds: lower log=
 severity for missing pinctrl settings)
Merging amdgpu/drm-next (7d83c129a8d7 drm/amdgpu: Fix parameter annotation =
in vcn_v5_0_0_is_idle)
Merging drm-intel/for-linux-next (af23476af8a9 drm/i915/fbc: handle dirty r=
ect coords for the first frame)
...
rnel-doc markup")
Merging sound-asoc/for-next (88253d8e70dd Merge remote-tracking branch 'aso=
...
ssing property)
Merging block/for-next (6499457f08ac Merge branch 'for-6.15/block' into for=
-next)
...
15' into spi-next)
Merging tip/master (361e02af3235 Merge branch into tip/master: 'x86/sev')
...
CONFLICT (content): Merge conflict in drivers/mailbox/mailbox.c
CONFLICT (content): Merge conflict in net/core/dev.c
[master 8eeb4c675982] next-20250303/tip
...
Merging edac/edac-for-next (0a110b1e8ea1 Merge ras/edac-misc into for-next)
Merging ftrace/for-next (5cea3da83a11 Merge sorttable/for-next)
...
tion)
Merging kvm-arm/next (164f95739b68 Merge branch 'kvm-arm64/nv-vgic' into kv=
marm/next)
...
ry vcpu kick)
Merging kvm-x86/next (7d2154117a02 Merge branch 'xen')
...
Merging iio/togreg (443238858a2d iio: imu: adis: fix uninitialized symbol w=
arning)
...
omem)
Merging gpio-brgl/gpio/for-next (a45faa2aba2c gpiolib: Align FLAG_* definit=
ions in the struct gpio_desc)
...
Merging livepatching/for-next (8bd10336f1af Merge branch 'for-6.15/trivial'=
 into for-next)
Merging rtc/rtc-next (d659dfec7d35 rtc: ds3232: Use HWMON_CHANNEL_INFO macr=
o to simplify code)
...
Merging slab/slab/for-next (46569b75fba9 Merge branch 'slab/for-6.15/kfree_=
...

=Mhhh
-----END PGP SIGNATURE-----
