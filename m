...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3B8DA115B71
	for <lists+linux-next@lfdr.de>; Sat,  7 Dec 2019 08:07:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725923AbfLGHHk (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Sat, 7 Dec 2019 02:07:40 -0500
Received: from bilbo.ozlabs.org ([203.11.71.1]:57417 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1725869AbfLGHHk (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Sat, 7 Dec 2019 02:07:40 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 47VLBF397xz9sPL;
        Sat,  7 Dec 2019 18:07:33 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1575702453;
        bh=kk8xpaPI435pOEqq4js633NpwoRuO0lQortNxxW8Gds=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Sat, 7 Dec 2019 18:07:31 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 7
Message-ID: <20191207180731.6c204343@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/Wj9Iwk29EuVXh=_r6RCMcxh";
...
Changes since 20191206:

The qcom tree gained a conflict against Linus' tree.

The vhost tree still had its build failures so I used the version from
next-20191203.

Non-merge commits (relative to Linus' tree): 1096
 1221 files changed, 32987 insertions(+), 12051 deletions(-)
...
Merging origin/master (347f56fb3890 Merge tag 'armsoc-fixes' of git://git.k=
...
Merging net/master (9f104c773690 mqprio: Fix out-of-bounds access in mqprio=
_dump)
...
Merging driver-core.current/driver-core-linus (b0d4beaa5a4b Merge branch 'n=
ext.autofs' of git://git.kernel.org/pub/scm/linux/kernel/git/viro/vfs)
...
w mount API)
Merging cifs/for-next (fdef665ba44a smb3: fix mode passed in on create for =
...
Merging nfsd/nfsd-next (b367e99140b9 nfsd: depend on CRYPTO_MD5 for legacy =
client tracking)
...
ltages at runtime)
Merging thermal/thermal/linux-next (d6532afcabab MAINTAINERS: thermal: Chan=
...
Merging driver-core/driver-core-next (b0d4beaa5a4b Merge branch 'next.autof=
...
Merging akpm-current/current (5c1919f9a7c9 ipc/msg.c: consolidate all xxxct=
l_down() functions)
...
rflow
Merging akpm/master (da41855fc48f drivers/media/platform/sti/delta/delta-ip=
...

=fLOw
-----END PGP SIGNATURE-----
