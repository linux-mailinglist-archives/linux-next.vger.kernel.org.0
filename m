...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id B7C822DDE14
	for <lists+linux-next@lfdr.de>; Fri, 18 Dec 2020 06:34:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726789AbgLRFeb (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 18 Dec 2020 00:34:31 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34374 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725870AbgLRFea (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 18 Dec 2020 00:34:30 -0500
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 81174C0617A7;
        Thu, 17 Dec 2020 21:33:49 -0800 (PST)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4CxyG15XVqz9sVj;
        Fri, 18 Dec 2020 16:33:45 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1608269625;
        bh=wGyzvs1RBfkN2suVSRsgX/kb6EQ0Mmuq/oKx3dCG36U=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 18 Dec 2020 16:33:44 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Dec 18
Message-ID: <20201218163344.2734c78d@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/bPVsTllaJIXNG=H4bSFBpWF";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/bPVsTllaJIXNG=H4bSFBpWF
...
Merging origin/master (6daa90439e91 Merge tag 'dmaengine-5.11-rc1' of git:/=
...
Merging wireless-drivers/master (4dfde294b979 rtlwifi: rise completion at t=
he last step of firmware callback)
...
Merging sound-current/for-linus (725124d10d00 ALSA: usb-audio: Add VID to s=
upport native DSD reproduction on FiiO devices)
...
avoars/linux)
Merging char-misc.current/char-misc-linus (accefff5b547 Merge tag 'arm-soc-=
omap-genpd-5.11' of git://git.kernel.org/pub/scm/linux/kernel/git/soc/soc)
...
uthorizer())
Merging cifs/for-next (afee4410bc6c cifs: update internal module version nu=
mber)
...
ent class)
Merging cel/cel-next (6d589dcf10f5 nfsd: Don't set eof on a truncated READ_=
PLUS)
...
in imxfb_probe())
Merging pm/linux-next (cd83902d91a2 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
logic in qat_4xxx)
Merging drm/drm-next (efd3043790c6 Merge tag 'amd-drm-fixes-5.11-2020-12-16=
...
Merging sound/for-next (725124d10d00 ALSA: usb-audio: Add VID to support na=
tive DSD reproduction on FiiO devices)
...
ength)
Merging block/for-next (86248e8f6fd6 Merge branch 'block-5.11' into for-nex=
t)
...
rc1' of git://git.kernel.org/pub/scm/linux/kernel/git/gustavoars/linux)
Merging char-misc/char-misc-next (accefff5b547 Merge tag 'arm-soc-omap-genp=
d-5.11' of git://git.kernel.org/pub/scm/linux/kernel/git/soc/soc)
...
Merging akpm/master (1c5b0b60b03f secretmem-test-add-basic-selftest-for-mem=
fd_secret2-fix)
...

=hg/k
-----END PGP SIGNATURE-----
