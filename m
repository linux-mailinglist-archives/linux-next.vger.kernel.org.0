Return-Path: <linux-next+bounces-1499-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id CF7FB872F38
	for <lists+linux-next@lfdr.de>; Wed,  6 Mar 2024 08:06:10 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 7B14F280F2C
	for <lists+linux-next@lfdr.de>; Wed,  6 Mar 2024 07:06:09 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 67F944D9EA;
	Wed,  6 Mar 2024 07:06:08 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b="CSguvtCC"
X-Original-To: linux-next@vger.kernel.org
Received: from mail-oi1-f177.google.com (mail-oi1-f177.google.com [209.85.167.177])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 48E9A5C057
	for <linux-next@vger.kernel.org>; Wed,  6 Mar 2024 07:06:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.167.177
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1709708768; cv=none; b=AhdXY6/dx5+S/faskZIlQD61RVPp504GFu4BtAyhGXqfW6+OSmWdyEtuS7flIvI5ofseLI+sTUeIhrlF9xI5erwTfAJR6OqmA8oeRhSTu3h0moOY+X6uTjgsc4XDbLBge0/HfsiJnFC9XCVB2P8uUFj1LkyoGdbWX1jn5hYBH4o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1709708768; c=relaxed/simple;
	bh=K9Gn2cWAlcvD8H4guKW2EiAbt8g3JLlq8AoWnNQ4fxY=;
	h=Message-ID:Date:Content-Type:MIME-Version:Subject:To:From; b=A0rvSCWSGqRLxzFC4tMqmeK9ngl1rYDl8gdMQ7IVKfCnW1476TVTPwa3/AQ11MJOG++/9GUzBZF/C6cKcdpkVqsGaVtHv4uP8O1zJsWYNDespqUnT8QsFEHBq+rBCs4+pdH5s5cv5d0CDcUa1PkaZ4eev9cuqBKFItI0ZPPBOQ4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org; spf=none smtp.mailfrom=kernelci.org; dkim=pass (2048-bit key) header.d=kernelci-org.20230601.gappssmtp.com header.i=@kernelci-org.20230601.gappssmtp.com header.b=CSguvtCC; arc=none smtp.client-ip=209.85.167.177
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=kernelci.org
Authentication-Results: smtp.subspace.kernel.org; spf=none smtp.mailfrom=kernelci.org
Received: by mail-oi1-f177.google.com with SMTP id 5614622812f47-3c1a2f7e302so3567089b6e.0
        for <linux-next@vger.kernel.org>; Tue, 05 Mar 2024 23:06:03 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20230601.gappssmtp.com; s=20230601; t=1709708762; x=1710313562; darn=vger.kernel.org;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=5D+VmgtHgx59VC6rfSKPyua/xHI6PSWUQRyBY1r9+d0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1709708762; x=1710313562;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:x-gm-message-state:from:to:cc:subject:date:message-id
         :reply-to;
        bh=5D+VmgtHgx59VC6rfSKPyua/xHI6PSWUQRyBY1r9+d0=;
        b=
X-Gm-Message-State: AOJu0YwnpJlWBFiyNPp6SPcXTNAVvJLb9/dOxQNJL7pj89LKCxXNDqFU
	fHC+a710YzyYbJrfRV58q/tirXp7cri0eQtRC/ZyJoixGfAG+OtQInoPLihxxLEnW9TSRn2ShF5
	m1BY=
X-Google-Smtp-Source: AGHT+IHII4cpRr8ih7VfPtFW1ksaf9Y18ZHKm7DjP9PNjQpirNMbTX+lu0qCwyBsg+bxs54PvnanwQ==
X-Received: by 2002:a05:6871:340b:b0:21e:9aa5:f3f7 with SMTP id nh11-20020a056871340b00b0021e9aa5f3f7mr4369761oac.58.1709708760494;
        Tue, 05 Mar 2024 23:06:00 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([20.171.243.82])
        by smtp.gmail.com with ESMTPSA id gx1-20020a056a001e0100b006e59a311e2dsm10142852pfb.92.2024.03.05.23.05.59
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 05 Mar 2024 23:05:59 -0800 (PST)
Message-ID: <65e815d7.050a0220.328d3.7ffb@mx.google.com>
Date: Tue, 05 Mar 2024 23:05:59 -0800 (PST)
...
Subject: next/master build: 172 builds: 13 failed, 159 passed, 12 errors,
 337 warnings (next-20240306)
To: linux-next@vger.kernel.org
From: "kernelci.org bot" <bot@kernelci.org>

next/master build: 172 builds: 13 failed, 159 passed, 12 errors, 337 warnin=
gs (next-20240306)
...
Tree: next
Branch: master
Git Describe: next-20240306
Git Commit: 61996c073c9b070922ad3a36c981ca6ddbea19a5
...
arm:
    ...
    multi_v7_defconfig+CONFIG_CPU_BIG_ENDIAN=3Dy: (gcc-10) FAIL
    multi_v7_defconfig+CONFIG_EFI=3Dy+CONFIG_ARM_LPAE=3Dy: (gcc-10) FAIL
    multi_v7_defconfig+CONFIG_SMP=3Dn: (gcc-10) FAIL
    multi_v7_defconfig+CONFIG_THUMB2_KERNEL=3Dy: (gcc-10) FAIL
...
arm:
    ...
    multi_v7_defconfig+CONFIG_CPU_BIG_ENDIAN=3Dy (gcc-10): 1 error
    multi_v7_defconfig+CONFIG_EFI=3Dy+CONFIG_ARM_LPAE=3Dy (gcc-10): 1 error
    multi_v7_defconfig+CONFIG_SMP=3Dn (gcc-10): 1 error
    multi_v7_defconfig+CONFIG_THUMB2_KERNEL=3Dy (gcc-10): 1 error
...
Errors summary:
    ...
    7    ERROR: modpost: "__aeabi_uldivmod" [drivers/gpu/drm/sun4i/sun4i-dr=
m-hdmi.ko] undefined!
    3    ERROR: modpost: "acpi_device_notify_remove" [drivers/i2c/i2c-core.=
ko] undefined!
    1    sun4i_hdmi_enc.c:(.text+0x380): undefined reference to `__aeabi_ul=
divmod'
    1    sun4i_hdmi_enc.c:(.text+0x138): undefined reference to `__aeabi_ul=
divmod'
...
=E2=80=98sgiwd93_reset=E2=80=99 [-Wmissing-prototypes]
    2    drivers/pci/controller/dwc/pci-imx6.c:1333:2: warning: unannotated=
...
ious prototype for =E2=80=98do_mcd_err=E2=80=99 [-Wmissing-prototypes]
    1    ....................../arch/arc/kernel/ptrace.c:342:16: warning: n=
o previous prototype for 'syscall_trace_enter' [-Wmissing-prototypes]
    1    ..................................................../arch/sparc/ke=
rnel/traps_64.c:253:6: warning: no previous prototype for =E2=80=98is_no_fa=
ult_exception=E2=80=99 [-Wmissing-prototypes]
...
Errors:
    ERROR: modpost: "acpi_device_notify_remove" [drivers/i2c/i2c-core.ko] u=
ndefined!
...
Warnings:
    drivers/pci/controller/dwc/pci-imx6.c:1333:2: warning: unannotated fall=
-through between switch labels [-Wimplicit-fallthrough]
    1 warning generated.
...
ider
    arch/arc/boot/dts/haps_hs_idu.dtb: Warning (interrupt_map): Failed prer=
equisite 'interrupt_provider'
    ....................../arch/arc/kernel/ptrace.c:342:16: warning: no pre=
vious prototype for 'syscall_trace_enter' [-Wmissing-prototypes]
    arch/arc/kernel/kprobes.c:193:15: warning: no previous prototype for 'a=
rc_kprobe_handler' [-Wmissing-prototypes]
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig (arm, clang-17) =E2=80=94 FAIL, 1 error, 0 warnings, 0 s=
ection mismatches
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+CONFIG_CPU_BIG_ENDIAN=3Dy (arm, gcc-10) =E2=80=94 FAIL, =
1 error, 0 warnings, 0 section mismatches
...
=94 FAIL, 1 error, 0 warnings, 0 section mismatches
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+CONFIG_SMP=3Dn (arm, gcc-10) =E2=80=94 FAIL, 1 error, 0 =
...
---------------------------------------------------------------------------=
-----
multi_v7_defconfig+CONFIG_THUMB2_KERNEL=3Dy (arm, gcc-10) =E2=80=94 FAIL, 1=
 error, 0 warnings, 0 section mismatches
...
Warnings:
    <stdin>:1519:2: warning: #warning syscall clone3 not implemented [-Wcpp]
    ..................................................../arch/sparc/kernel/=
traps_64.c:253:6: warning: no previous prototype for =E2=80=98is_no_fault_e=
xception=E2=80=99 [-Wmissing-prototypes]
...
---------------------------------------------------------------------------=
-----
sunxi_defconfig (arm, gcc-10) =E2=80=94 FAIL, 2 errors, 0 warnings, 0 secti=
on mismatches

Errors:
    sun4i_hdmi_enc.c:(.text+0x138): undefined reference to `__aeabi_uldivmo=
d'
    sun4i_hdmi_enc.c:(.text+0x380): undefined reference to `__aeabi_uldivmo=
d'
