Return-Path: <linux-next+bounces-4840-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 49AD59D7ABA
	for <lists+linux-next@lfdr.de>; Mon, 25 Nov 2024 05:18:55 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id B75BE162533
	for <lists+linux-next@lfdr.de>; Mon, 25 Nov 2024 04:18:51 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9952918EA2;
	Mon, 25 Nov 2024 04:18:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="iL2etMkh"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E1239383;
	Mon, 25 Nov 2024 04:18:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1732508330; cv=none; b=GLh45kA174DupymszKVNAWbLMFicdT4JG3foWvoN+tjNhWilYAUmJ9jCtBeOXNwjHedjAHlsMvIBigp2dQ+26MZcw0MhpmyivmM/fo1g4xERb3yGBgIe5NtBecevGXNRYgEQjF7RDamVexbfdZ3NorEh+Kjz/inkyzmNDxox5eQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1732508330; c=relaxed/simple;
	bh=9V4h9J6FaKsnXxPLIIIEREhGxx/p0zZ5ym29ES0WVo8=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=FIHKePvdhUGahHZKU+TvURG9Py5fxJ+CYGUS5BbzI35CQKflffjecsniHjxumZbJYNkUr+LdRU4RYCcn8ZktipdW41WOAmP2mQVSeGF8pyZOYcZy2EAM+9YW/S8nlXJxlJhG0KLeSzXwv4mVZq6EcYwr4MD7jo0hh7Feww3lKDM=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=iL2etMkh; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1732508313;
	bh=i0vSWF0euuqlyLFssOt7UkxTDn06eE7hWpb/s8f2IU4=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4XxXWY6Hdgz4xDQ;
	Mon, 25 Nov 2024 15:18:33 +1100 (AEDT)
Date: Mon, 25 Nov 2024 15:18:36 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 25
Message-ID: <20241125151836.202f227f@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/3ysF22z_AR243Ye.GRl91n8";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/3ysF22z_AR243Ye.GRl91n8
...
Changes since 20241122:

The drm-xe tree gained a conflict against Linus' tree.

The mailbox tree gained a conflict against Linus' tree.

The rtc tree gained a conflict against Linus' tree.

Non-merge commits (relative to Linus' tree): 3121
 3881 files changed, 145547 insertions(+), 119455 deletions(-)
...
erify_area())
Merging bcachefs/for-next (2c771ca008eb bcachefs: New backpointers helpers)
...
Merging cifs/for-next (e3ff256d2df8 cifs: update internal version number)
...
Merging fs-current (419159bc19d7 Merge branch 'next-fixes' of git://git.ker=
...
Merging net/main (f26a29a038ee net: phy: ensure that genphy_c45_an_config_e=
ee_aneg() sees new value of phydev->eee_cfg.eee_enabled)
Merging bpf/master (28eb75e178d3 Merge tag 'drm-next-2024-11-21' of https:/=
...
Merging sound-current/for-linus (9d5ce1aa91db selftests/alsa: Add a few mis=
sing gitignore files)
...
Merging fs-next (111133a98098 Merge branch 'for-next' of git://git.kernel.o=
...
an to Ryan")
  68e7aa7ae92f ("MAINTAINERS: transfer i2c-aspeed maintainership from Brend=
an to Ryan")
...
mentation comments)
Merging drm-xe/drm-xe-next (a9f7b97ddae3 drm/xe/guc: Add support for G2G co=
mmunications)
...
Merging sound/for-next (9d5ce1aa91db selftests/alsa: Add a few missing giti=
gnore files)
...
12' into spi-linus)
Merging tip/master (dad0983b3043 Merge branch into tip/master: 'x86/tdx')
...
Merging rtc/rtc-next (1ec371bab200 m68k: mvme147, mvme16x: Adopt rtc-m48t59=
 platform driver)
...

=k0r9
-----END PGP SIGNATURE-----
