...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 64CBA48670F
	for <lists+linux-next@lfdr.de>; Thu,  6 Jan 2022 16:50:45 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240680AbiAFPuo (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 6 Jan 2022 10:50:44 -0500
Received: from gandalf.ozlabs.org ([150.107.74.76]:50345 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230138AbiAFPun (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 6 Jan 2022 10:50:43 -0500
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4JV9mf3bY5z4xsl;
        Fri,  7 Jan 2022 02:50:42 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1641484242;
        bh=LgiVGjjVuQDRzKdvZ+xCkkTeMAD/ESKinRskix8GHAY=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 7 Jan 2022 02:50:41 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jan 6
Message-ID: <20220107025041.6298f92f@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/l63AXN5SQlf.yK8laEeSl0=";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/l63AXN5SQlf.yK8laEeSl0=
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20220105:
...
Non-merge commits (relative to Linus' tree): 10203
 10050 files changed, 459486 insertions(+), 206290 deletions(-)
...
Merging origin/master (49ef78e59b07 Merge tag 'gpio-fixes-for-v5.16' of git=
...
Merging net/master (db54c12a3d7e selftests: set amt.sh executable)
...
Merging sound-asoc-fixes/for-linus (809ec1679461 Merge remote-tracking bran=
...
Merging drm-fixes/drm-fixes (c9e6606c7fe9 Linux 5.16-rc8)
...
dt' into for-next)
Merging clk/clk-next (393cd2028df8 Merge branch 'clk-samsung' into clk-next)
...
Merging parisc-hd/for-next (d6fd97622206 parisc: Provide a trivial PDC-base=
d io_module for kgdb)
...
Merging ext4/dev (db19c4cdc28a ext4: allow to change s_last_trim_minblks vi=
a sysfs)
...
ocumentation)
Merging cel/for-next (9dc9f18789b8 nfsd: fix crash on COPY_NOTIFY with spec=
ial stateid)
...
Merging net-next/master (b9adba350a84 Merge git://git.kernel.org/pub/scm/li=
nux/kernel/git/netdev/net)
Merging bpf-next/for-next (5f6082642814 libbpf 1.0: Deprecate bpf_object__f=
ind_map_by_offset() API)
...
Merging bluetooth/master (4e4f325a0a55 net: gemini: allow any RGMII interfa=
ce mode)
...
Merging sound-asoc/for-next (e4c35e75209b ASoC: ak4375: Fix unused function=
 error)
...
me memory)
Merging block/for-next (32758247e3c4 Merge branch 'for-5.17/io_uring' into =
for-next)
Merging device-mapper/for-next (cba23ac158db dm space map common: add bound=
s check to sm_ll_lookup_bitmap())
Merging libata/for-next (5e53cac53b30 ata: pata_octeon_cf: remove redundant=
 val variable)
...
y)
Merging driver-core/driver-core-next (99a6a4b39575 sh: sq: use default_grou=
ps in kobj_type)
...
Merging efi/next (2125d3c3ce9b efi: use default_groups in kobj_type)
...
o for-next)
Merging random/master (9f7d64006aa4 random: don't reset crng_init_cnt on ur=
andom_read())
Merging landlock/next (2585cf9dfaad Linux 5.16-rc5)
Applying: Revert "ata: pata_cs5535: add compile test support"
...
Merging akpm/master (eaa21721f0b3 mm: hide the FRONTSWAP Kconfig symbol)
...

=s7YQ
-----END PGP SIGNATURE-----
