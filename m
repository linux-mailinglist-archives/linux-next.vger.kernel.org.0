...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id A76617B7770
	for <lists+linux-next@lfdr.de>; Wed,  4 Oct 2023 07:21:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S241337AbjJDFVl (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 4 Oct 2023 01:21:41 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:44724 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232178AbjJDFVk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 4 Oct 2023 01:21:40 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 36A9AA7;
        Tue,  3 Oct 2023 22:21:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1696396892;
        bh=CzX510wyY6lI/GzKAasxXfy9PmXJJXREMMudAn1rgJU=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (prime256v1) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4S0jj85ckgz4xPy;
        Wed,  4 Oct 2023 16:21:32 +1100 (AEDT)
Date:   Wed, 4 Oct 2023 16:21:30 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 4
Message-ID: <20231004162130.7899b2ef@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/lG47D=nvulSLBY4N+BCvqG6";
...
--Sig_/lG47D=nvulSLBY4N+BCvqG6
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20231003:
...
The execve tree lost its build failure.

Non-merge commits (relative to Linus' tree): 8872
 6932 files changed, 554196 insertions(+), 157811 deletions(-)
...
Merging origin/master (cbf3a2cb156a Merge tag 'nfs-for-6.6-3' of git://git.=
linux-nfs.org/projects/anna/linux-nfs)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (0a60db9b4e55 mmap: fix error path=
s with dup_anon_vma())
...
Merging net/main (dfc7f7a988da net: nfc: llcp: Add lock when modifying devi=
ce list)
...
problem)
Merging netfilter/main (dfc7f7a988da net: nfc: llcp: Add lock when modifyin=
g device list)
...
Merging drm-misc-fixes/for-linux-next-fixes (cbb7eb2dbd94 drm: panel-orient=
ation-quirks: Add quirk for One Mix 2S)
Merging mm-stable/mm-stable (8a749fd1a872 Linux 6.6-rc4)
Merging mm-nonmm-stable/mm-nonmm-stable (8a749fd1a872 Linux 6.6-rc4)
Merging mm/mm-everything (b3d6d11e6083 Merge branch 'mm-nonmm-unstable' int=
o mm-everything)
Applying: Revert "compiler.h: move __is_constexpr() to compiler.h"
...
nto for-next)
Merging scmi/for-linux-next (2ec7f1800ff2 Merge branches 'for-next/scmi/upd=
...
Merging net-next/main (473267a4911f net: add sysctl to disable rfc4862 5.5.=
3e lifetime handling)
...
l to struct_size())
Merging bluetooth/master (cffdc28aa2e2 Bluetooth: ISO: Match QoS adv handle=
 with BIG handle)
...
- add missing escape)
Merging drm-misc/for-linux-next (653e2486450a drm/vblank: Warn when silentl=
y cancelling vblank works)
Merging amdgpu/drm-next (c4c8955b8acb drm/amd: Fix detection of _PR3 on the=
 PCIe root port)
...
u_v13_0_6_ppt.c
Merging drm-intel/for-linux-next (f2a7b9cd5b06 drm/i915/lnl: update the sup=
ported plane formats with FBC)
...
ith __counted_by)
Merging sound-asoc/for-next (f0652bfad595 Merge remote-tracking branch 'aso=
...
7' into spi-next)
Merging tip/master (8b3fe25c48e0 Merge branch into tip/master: 'x86/tdx')
...
Merging usb/usb-next (fc85c59b85d1 usb: gadgetfs: return USB_GADGET_DELAYED=
_STATUS from setup())
$ git reset --hard HEAD^
Merging next-20231003 version of usb
...
Merging landlock/next (adcebe926c04 landlock: Document Landlock's network s=
upport)
...

nf7tsh8AvcDDk8r08TCnasnxEsbs
=7lIo
-----END PGP SIGNATURE-----
