...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 99A806975FB
	for <lists+linux-next@lfdr.de>; Wed, 15 Feb 2023 06:49:02 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229650AbjBOFtB (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 15 Feb 2023 00:49:01 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54490 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229553AbjBOFtA (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 15 Feb 2023 00:49:00 -0500
Received: from mail-pg1-x536.google.com (mail-pg1-x536.google.com [IPv6:2607:f8b0:4864:20::536])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1917F2B0A1
        for <linux-next@vger.kernel.org>; Tue, 14 Feb 2023 21:48:56 -0800 (PST)
Received: by mail-pg1-x536.google.com with SMTP id b22so6530015pgw.3
        for <linux-next@vger.kernel.org>; Tue, 14 Feb 2023 21:48:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=from:to:subject:content-transfer-encoding:mime-version:date
         :message-id:from:to:cc:subject:date:message-id:reply-to;
        bh=zg0quK3p5Wpofvkgu1RLzD+vh15kLtVeBPIi50cR8ew=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=from:to:subject:content-transfer-encoding:mime-version:date
         ...
         :reply-to;
        bh=zg0quK3p5Wpofvkgu1RLzD+vh15kLtVeBPIi50cR8ew=;
        b=
X-Gm-Message-State: AO0yUKWg4pdT9CImWuZx5gBJk6OH1xkgaTiHG4YhgCK6SCo+R/u94TKa
        vAWCvoQZQh93AcjFEMnwo6fG1oGShruLhRpx
X-Google-Smtp-Source: AK7set9RvnORWuT5VuIAOyCTvGBUhl3rZPG353/CDjgZw9bkJ/epyhvcm7O8kxFEiXJHJno7G+5cgg==
X-Received: by 2002:a62:1dce:0:b0:5a8:bbde:a074 with SMTP id d197-20020a621dce000000b005a8bbdea074mr753397pfd.12.1676440134479;
        Tue, 14 Feb 2023 21:48:54 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id l13-20020a62be0d000000b005a7c892b435sm10740630pff.25.2023.02.14.21.48.53
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Tue, 14 Feb 2023 21:48:54 -0800 (PST)
Message-ID: <63ec7246.620a0220.46a6b.360a@mx.google.com>
Date:   Tue, 14 Feb 2023 21:48:54 -0800 (PST)
...
Subject: next/master build: 206 builds: 12 failed, 194 passed, 19 errors,
 21 warnings (next-20230215)
...
next/master build: 206 builds: 12 failed, 194 passed, 19 errors, 21 warning=
s (next-20230215)
...
Tree: next
Branch: master
Git Describe: next-20230215
Git Commit: 9d9019bcea1aac7eed64a1a4966282b6b7b141c8
...
=99 has no member named =E2=80=98mod_mem=E2=80=99
    1    odroid-go-ultra-poweroff.c:(.text+0x1cc): undefined reference to `=
i2c_find_device_by_fwnode'
    1    net/bpfilter/main.c:3:10: fatal error: sys/uio.h: No such file or =
directory
    1    ld.lld: error: undefined symbol: i2c_find_device_by_fwnode
...
-distinct-pointer-types]
    1    drivers/cxl/core/region.c:2628:6: error: variable 'rc' is used uni=
...
!ENDBR: native_write_cr4+0x4
    1    drivers/cxl/core/region.c:2600:8: note: initialize the variable 'r=
...
Errors:
    ld.lld: error: undefined symbol: i2c_find_device_by_fwnode
...
Errors:
    odroid-go-ultra-poweroff.c:(.text+0x1cc): undefined reference to `i2c_f=
ind_device_by_fwnode'
