...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3F83F19A635
	for <lists+linux-next@lfdr.de>; Wed,  1 Apr 2020 09:28:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1731863AbgDAH2P (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 1 Apr 2020 03:28:15 -0400
Received: from ozlabs.org ([203.11.71.1]:33387 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1731680AbgDAH2O (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Wed, 1 Apr 2020 03:28:14 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 48sd8Q1Rxgz9sR4;
        Wed,  1 Apr 2020 18:28:05 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1585726086;
        bh=4LPBor4RUZ05olITIaXZ2+3d8asHoNcPu1JkQ/5tCRQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 1 Apr 2020 18:28:02 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Apr 1
Message-ID: <20200401182802.49308409@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/65oEywTm4hcwTX_+oE5Ora5";
...
The gpio tree lost its build failures but gained a conflict against
Linus' tree.  It also gained another build failure for which I applied
a patch.
...
Non-merge commits (relative to Linus' tree): 9680
 8166 files changed, 397423 insertions(+), 150770 deletions(-)
...
Merging origin/master (42595ce90b9d Merge branch 'x86-vmware-for-linus' of =
...
Merging net/master (0141317611ab Merge branch 'hns3-fixes')
...
Merging netfilter/master (0141317611ab Merge branch 'hns3-fixes')
...
Merging sound-asoc-fixes/for-linus (b8356d9bff22 Merge branch 'asoc-5.7' in=
to asoc-linus)
...
I driver path)
Merging driver-core.current/driver-core-linus (458ef2a25e0c Merge tag 'x86-=
timers-2020-03-30' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging tty.current/tty-linus (16fbf79b0f83 Linux 5.6-rc7)
Merging usb.current/usb-linus (458ef2a25e0c Merge tag 'x86-timers-2020-03-3=
0' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
ng wake-up handling)
Merging staging.current/staging-linus (458ef2a25e0c Merge tag 'x86-timers-2=
020-03-30' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
...
Merging kbuild/for-next (40af14644bab Merge branch 'kbuild-asinstr' into fo=
r-next)
...
_notify_op_lock())
Merging cifs/for-next (645c248d6fc4 Merge tag '5.7-rc-smb3-fixes-part1' of =
...
ic)
Merging net-next/master (7f80ccfe9968 net: ipv6: rpl_iptunnel: Fix potentia=
l memory leak in rpl_do_srh_inline)
...
Merging bpf-next/master (3902baf9abfa netdevsim: dev: Fix memory leak in ns=
im_dev_take_snapshot_write)
...
Merging amdgpu/drm-next (3dd9b27dacc7 drm/amdgpu/display: fix logic inversi=
...
Merging sound-asoc/for-next (b8356d9bff22 Merge branch 'asoc-5.7' into asoc=
-linus)
...
o rules present)
Merging devicetree/for-next (28d5ee04d9f9 dt-bindings: usb: dwc2: fix bindi=
ngs for amlogic, meson-gxbb-usb)
...
gnore
Merging kvm/linux-next (4f4af841f06a Merge tag 'kvm-ppc-next-5.7-1' of git:=
...
Merging driver-core/driver-core-next (458ef2a25e0c Merge tag 'x86-timers-20=
20-03-30' of git://git.kernel.org/pub/scm/linux/kernel/git/tip/tip)
Merging usb/usb-next (458ef2a25e0c Merge tag 'x86-timers-2020-03-30' of git=
...
Merging staging/staging-next (458ef2a25e0c Merge tag 'x86-timers-2020-03-30=
...
Merging scsi-mkp/for-next (60f537d57552 scsi: bnx2fc: fix boolreturn.cocci =
warnings)
CONFLICT (content): Merge conflict in drivers/scsi/bnx2fc/bnx2fc_hwi.c
Merging vhost/linux-next (a4be40cbcedb vdpa: move to drivers/vdpa)
...
Merging gpio/for-next (e45ee71ae101 pinctrl: Define of_pinctrl_get() dummy =
for !PINCTRL)
CONFLICT (content): Merge conflict in drivers/gpio/gpiolib.c
Applying: gpio: export of_pinctrl_get to modules
...
rflow
Merging akpm/master (e3af011bd153 drivers/media/platform/sti/delta/delta-ip=
...

=21dv
-----END PGP SIGNATURE-----
