Return-Path: <linux-next+bounces-1745-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [139.178.88.99])
	by mail.lfdr.de (Postfix) with ESMTPS id 5653A88D4E3
	for <lists+linux-next@lfdr.de>; Wed, 27 Mar 2024 04:06:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 0AC892A73FE
	for <lists+linux-next@lfdr.de>; Wed, 27 Mar 2024 03:06:37 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 452C9219FD;
	Wed, 27 Mar 2024 03:06:33 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="ksNgEomu"
X-Original-To: linux-next@vger.kernel.org
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 8E00421101;
	Wed, 27 Mar 2024 03:06:26 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711508793; cv=none; b=DJKFBuTthOmQcVrPrhjoIYXGo4VM3NvooD9c0GI6GCKMYR4H6EkJ1bMIWpbqNo6ATUv0QBiGvd0wZ6PGzqMRR+OoKEq72MeZHQ8i/3o5hjV026dzVfDFb64Bf6tUghWCbjwMjbvVl0JTPH8V+/lMfYzdxM2SwJf5rTc3eWzI0dc=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711508793; c=relaxed/simple;
	bh=9GJTfCrSoUxojflCIsviSn/Zfp9w/bUfnGRxqQSZQ1w=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=azCX5Z0ZQnqm+MP/KgZFyOP2PbCPYa5i50YVbRM5LJ2fVVVyS7kRF8rwYY8i1396/V0e8rAudRuLiUKxQ0hQNtXLuGrJxPH80iKHj55S3JvWLY4ZUgGIcvocw6nra27uMVO49ZSlh14VfUiinZRxyEUbhOcobEsY/VAnobH6IRQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=ksNgEomu; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1711508785;
	bh=h+B6g/OjgekhXiateNBvlIbcm6943ksZ3MIiC6cCl/Y=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(No client certificate requested)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4V4BQT0RC4z4wcF;
	Wed, 27 Mar 2024 14:06:25 +1100 (AEDT)
Date: Wed, 27 Mar 2024 14:06:24 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 27
Message-ID: <20240327140624.40ce6db8@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/dAZ_RPCTUzL=rDqgj+RFrWP";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/dAZ_RPCTUzL=rDqgj+RFrWP
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20240326:

The selinux tree gained a build failure for which I reverted a commit.
...
Non-merge commits (relative to Linus' tree): 1775
 1866 files changed, 75662 insertions(+), 25898 deletions(-)
...
Merging origin/master (7033999ecd7b Merge tag 'printk-for-6.9-rc2' of git:/=
...
Merging net/main (c1fd3a9433a2 Merge branch 'there-are-some-bugfix-for-the-=
hns3-ethernet-driver')
Merging bpf/master (c1fd3a9433a2 Merge branch 'there-are-some-bugfix-for-th=
e-hns3-ethernet-driver')
...
Merging sound-current/for-linus (051e0840ffa8 ALSA: sh: aica: reorder clean=
up operations to avoid UAF bugs)
Merging sound-asoc-fixes/for-linus (a9e34681df71 Merge remote-tracking bran=
...
Merging kselftest-fixes/fixes (e327975cc99c selftests/exec: execveat: Impro=
ve debug reporting)
...
Merging drm-intel-fixes/for-linux-next-fixes (4cece7649650 Linux 6.9-rc1)
...
Merging risc-v-fixes/fixes (ad14f7ca9f0d riscv: hwprobe: do not produce frt=
ace relocation)
Merging riscv-dt-fixes/riscv-dt-fixes (0b163f43920d riscv: dts: starfive: R=
...
Merging drm-misc-fixes/for-linux-next-fixes (905f7d53a1bc drm/rockchip: vop=
2: Remove AR30 and AB30 format support)
...
Merging rockchip/for-next (cb42a8e46831 Merge branch 'v6.10-armsoc/dts64' i=
nto for-next)
...
quest for read)
Merging cifs/for-next (e9e9fbeb83f6 smb3: add trace event for mknod)
...
of devices)
Merging pm/linux-next (b7eacaa4b4af Merge branch 'thermal-core' into linux-=
next)
...
Merging net-next/main (6e0631203503 net: remove skb_free_datagram_locked())
...
Merging bluetooth/master (e9c62fdc7f3e Bluetooth: hci_sync: Fix not checkin=
g error on hci_cmd_sync_cancel_sync)
...
pare stage)
Merging drm-intel/for-linux-next (e580fc47b50c drm/i915: Delete stray .rej =
file)
...
Merging drm-xe/drm-xe-next (5dffaa1bb94a drm/xe: Create a helper function t=
o init job's user fence)
...
Merging sound-asoc/for-next (0f6530d3953f Merge remote-tracking branch 'aso=
...
MEPADs)
Merging block/for-next (58bc22f3c003 Merge branch 'for-6.10/block' into for=
-next)
...
Merging selinux/next (42c773238037 selinux: improve error checking in sel_w=
rite_load())
...
())
Merging tip/master (8bbf3f9c5171 Merge branch into tip/master: 'x86/shstk')
...
Merging scsi-mkp/for-next (e5abf748fcd5 Merge patch series "ufs: host: medi=
atek: Provide features and fixes in MediaTek platforms")
$ git reset --hard HEAD^
Merging next-20240326 version of scsi-mkp
...
uild for PREEMPT_RT)
Applying: Revert "selinux: reject invalid ebitmaps"
...

=gPw3
-----END PGP SIGNATURE-----
