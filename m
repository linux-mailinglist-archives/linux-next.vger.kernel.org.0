...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 3351043250F
	for <lists+linux-next@lfdr.de>; Mon, 18 Oct 2021 19:30:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233976AbhJRRcX (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 18 Oct 2021 13:32:23 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34418 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S232211AbhJRRcX (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 18 Oct 2021 13:32:23 -0400
Received: from mail-pf1-x433.google.com (mail-pf1-x433.google.com [IPv6:2607:f8b0:4864:20::433])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ABDD7C06161C
        for <linux-next@vger.kernel.org>; Mon, 18 Oct 2021 10:30:11 -0700 (PDT)
Received: by mail-pf1-x433.google.com with SMTP id m14so15241249pfc.9
        for <linux-next@vger.kernel.org>; Mon, 18 Oct 2021 10:30:11 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20210112.gappssmtp.com; s=20210112;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=Wslh6y4/xFiZkT3Dd6X7pfkNOBla7huuF2QQjFwgho8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Wslh6y4/xFiZkT3Dd6X7pfkNOBla7huuF2QQjFwgho8=;
        b=
X-Gm-Message-State: AOAM532uXJp8uOREEIrkaT+lqbsVAx/qVh5GEqjfjquLreGYCgPLNiDx
        DqK3cbnT/aQg5B9PT2qnkJ0gkL4YQr90KCL/
X-Google-Smtp-Source: ABdhPJyXwJ261PqHtb9GdYHi+IP01+6te0DIdO+UeSsO4J1xcPL7mgqWCBIcsyOSj4OVfasHei+HRw==
X-Received: by 2002:a63:9d06:: with SMTP id i6mr24910490pgd.42.1634578209856;
        Mon, 18 Oct 2021 10:30:09 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id p4sm13149728pgc.15.2021.10.18.10.30.09
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 18 Oct 2021 10:30:09 -0700 (PDT)
Message-ID: <616daf21.1c69fb81.f4252.4125@mx.google.com>
Date:   Mon, 18 Oct 2021 10:30:09 -0700 (PDT)
Content-Type: text/plain; charset="utf-8"
MIME-Version: 1.0
Content-Transfer-Encoding: quoted-printable
X-Kernelci-Branch: master
X-Kernelci-Tree: next
X-Kernelci-Kernel: next-20211018
X-Kernelci-Report-Type: build
Subject: next/master build: 167 builds: 18 failed, 149 passed, 18 errors,
 168 warnings (next-20211018)
...
next/master build: 167 builds: 18 failed, 149 passed, 18 errors, 168 warnin=
gs (next-20211018)
...
y one of the following would fix this:
    ...
    1    sev.c:(.text+0x130f): undefined reference to `__udivdi3'
...
armv7-a' [-Wunused-command-line-argument]
    2    drivers/clocksource/arm_arch_timer.c:183:3: warning: variable 'val=
' is used uninitialized whenever switch default is taken [-Wsometimes-unini=
tialized]
    2    drivers/clocksource/arm_arch_timer.c:174:3: warning: variable 'val=
' is used uninitialized whenever switch default is taken [-Wsometimes-unini=
tialized]
    2    drivers/clocksource/arm_arch_timer.c:166:9: note: initialize the v=
...
Errors:
    sev.c:(.text+0x130f): undefined reference to `__udivdi3'
