...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F22C2A71D6
	for <lists+linux-next@lfdr.de>; Thu,  5 Nov 2020 00:33:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1732833AbgKDXd2 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 4 Nov 2020 18:33:28 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46408 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1731539AbgKDXd2 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 4 Nov 2020 18:33:28 -0500
Received: from mail-pg1-x530.google.com (mail-pg1-x530.google.com [IPv6:2607:f8b0:4864:20::530])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ECB14C0613CF
        for <linux-next@vger.kernel.org>; Wed,  4 Nov 2020 15:33:26 -0800 (PST)
Received: by mail-pg1-x530.google.com with SMTP id i26so179735pgl.5
        for <linux-next@vger.kernel.org>; Wed, 04 Nov 2020 15:33:26 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=/PUM2bmdB2MRXNiQ8t8b2I+ajbJiy0NzguZ/4wD+ehQ=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=/PUM2bmdB2MRXNiQ8t8b2I+ajbJiy0NzguZ/4wD+ehQ=;
        b=
X-Gm-Message-State: AOAM533GLS3F45XGWNcjHo6n0TK5h8Z9pp8GsARbpUU4v3P9S5uZqXOt
        ufXh3rncZd0P3pE4g+6+2ffw6c2exgMnLg==
X-Google-Smtp-Source: ABdhPJyodeOlIPEQZjvfOLOdvmWXXhp3rlzuKctuTNVxT50FItrktJpx3cmaqJjlP5Dkbbdox3tkuQ==
X-Received: by 2002:a17:90a:1596:: with SMTP id m22mr257780pja.189.1604532804065;
        Wed, 04 Nov 2020 15:33:24 -0800 (PST)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id 26sm3331731pgm.92.2020.11.04.15.33.22
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 04 Nov 2020 15:33:22 -0800 (PST)
Message-ID: <5fa33a42.1c69fb81.c7677.7b56@mx.google.com>
Date:   Wed, 04 Nov 2020 15:33:22 -0800 (PST)
...
Subject: next/pending-fixes build: 203 builds: 1 failed, 202 passed, 807 errors,
 367 warnings (v5.10-rc2-396-ga212a20610dd8)
...
next/pending-fixes build: 203 builds: 1 failed, 202 passed, 807 errors, 367=
 warnings (v5.10-rc2-396-ga212a20610dd8)

Full Build Summary: https://kernelci.org/build/next/branch/pending-fixes/ke=
rnel/v5.10-rc2-396-ga212a20610dd8/

Tree: next
Branch: pending-fixes
Git Describe: v5.10-rc2-396-ga212a20610dd8
Git Commit: a212a20610dd80ed34b53afaf8da8549471740ae
...
arm64:
    ...
    defconfig+kselftest (gcc-8): 124 errors, 79 warnings
...
t-ll64.h: No such file or directory
    1    /bin/sh: 1: clang: not found/bin/sh: 3:
...
gument of type =E2=80=98long unsigned int=E2=80=99, but argument 7 has type=
 =E2=80=98vm_vaddr_t=E2=80=99 {aka =E2=80=98long long unsigned int=E2=80=99=
    ...
    1    /tmp/ccmGTjDb.s:18192: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccmGTjDb.s:18120: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccmGTjDb.s:18120: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccmGTjDb.s:18192: Warning: using r15 results in unpredictable beha=
viour
...
---------------------------------------------------------------------------=
-----
defconfig+kselftest (arm64, gcc-8) =E2=80=94 PASS, 124 errors, 79 warnings,=
 0 section mismatches
...
D_SHARED=E2=80=99?
    /bin/sh: 1: llc: not found
    /bin/sh: 1: clang: not found/bin/sh: 3:
