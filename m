Return-Path: <linux-next+bounces-9067-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from dfw.mirrors.kernel.org (dfw.mirrors.kernel.org [IPv6:2605:f480:58:1:0:1994:3:14])
	by mail.lfdr.de (Postfix) with ESMTPS id CD9B8C67318
	for <lists+linux-next@lfdr.de>; Tue, 18 Nov 2025 04:56:01 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by dfw.mirrors.kernel.org (Postfix) with ESMTPS id 98AAD4ECEC4
	for <lists+linux-next@lfdr.de>; Tue, 18 Nov 2025 03:56:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1393C2D23A3;
	Tue, 18 Nov 2025 03:55:56 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="UwFvZAEe"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 53B7835972;
	Tue, 18 Nov 2025 03:55:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1763438156; cv=none; b=qjxDrzK1i4O0PAT0wfqCrnD9N4R2RhR4MLLOgv7NDGgS4tulitsZAygj316J0KTG7akOcAkh9Yw8xwN+S02PqE5Yav0xig+PG0t3Pc8kzjSLq+HL0Owgf8XVFXMCeN/OPieYZmIl/E2dSLrWYA1uprDb+xma/vHnte6S1QdMC70=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1763438156; c=relaxed/simple;
	bh=F0z5N+j2cC2ffgf00ts93/Aib6mMlnEAplAnLd2odlg=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=NGdBsTPA+wom4/4H8Bhb3st4aje5lW9XAsYTaxiPe+V3J8kgyaTs1JGQjioBmBUcZBKs3q4h1phVRa1pGrJsXXkTkQQn0xtx3hR/2kr/CTbSR+0mw/iRnBqRJXoShEN3zZVaSUnbAYZSeXMUdXsV+WZiyv3ywkTLxF5eheFdym0=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=UwFvZAEe; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=202503; t=1763438148;
	bh=h4FfC5yB0/NL2vTF0XVyxjS3+jHB13Ku1Te4XtBP4Jk=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange secp256r1 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4d9W443gfTz4wCB;
	Tue, 18 Nov 2025 14:55:48 +1100 (AEDT)
Date: Tue, 18 Nov 2025 14:55:47 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 18
Message-ID: <20251118145547.2b166da1@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/tSN_tWvOnegYQXy0bTtxcrg";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/tSN_tWvOnegYQXy0bTtxcrg
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20251117:

This kernel produces a warning at boot time.

The devicetree-fixes tree gained a build failure so I used the version from
next-20251117.

The vfs-brauner tree still had its build failure so I used a supplied patch.
The vfs-brauner tree gained a conflict against the s390 tree.

The mm-nonmm-unstable tree lost one build failure but still had the
other for which I reverted 2 commits.

The devicetree tree lost its build failure.

The rust tree lost its build failures.

Non-merge commits (relative to Linus' tree): 8690
 9225 files changed, 411037 insertions(+), 137484 deletions(-)
...
Merging origin/master (e7c375b18160 Merge tag 'vfs-6.18-rc7.fixes' of gitol=
ite.kernel.org:pub/scm/linux/kernel/git/vfs/vfs)
...
Merging btrfs/for-next (f38b2041dbb9 Merge branch 'for-next-next-v6.18-2025=
1117' into for-next-20251117)
Merging ceph/master (87ab14795a89 libceph: drop started parameter of __ceph=
_open_session())
Merging cifs/for-next (530dd30593e0 smb: client: show smb lease key in open=
_dirs output)
...
into for-next)
Merging mm-hotfixes/mm-hotfixes-unstable (b8c432f46d5e selftests/mm: fix di=
vision-by-zero in uffd-unit-tests)
Merging fs-current (be527e15d353 Merge branch 'fixes' of https://git.kernel=
...
Merging arm-soc-fixes/arm/fixes (124c98b10001 Merge tag 'tee-fix-for-v6.18'=
 of git://git.kernel.org/pub/scm/linux/kernel/git/jenswi/linux-tee into arm=
/fixes)
...
embly)
Merging net/main (5442a9da6978 veth: more robust handing of race to avoid t=
xq getting stuck)
...
Merging sound-current/for-linus (c83fc1396064 ALSA: usb-audio: Add DSD quir=
k for LEAK Stereo 230)
...
Merging spi-fixes/for-linus (10eaa4c4a257 spi: spi-cadence-quadspi: Remove =
duplicate pm_runtime_put_autosuspend() call)
...
Merging devicetree-fixes/dt/linus (227c4e0e70fe of: dynamic: Fix overlayed =
devices not probing because of fw_devlink)
$ git reset --hard HEAD^
Merging next-20251117 version of devicetree-fixes
...
Merging drm-intel-fixes/for-linux-next-fixes (fa766e759ff7 drm/i915/xe3lpd:=
...
Merging risc-v-fixes/fixes (e2cb69263e79 tools: riscv: Fixed misalignment o=
f CSR related definitions)
...
Merging tip-fixes/tip/urgent (6a23ae0a96a6 Linux 6.18-rc6)
...
rc1)
Merging drm-misc-fixes/for-linux-next-fixes (660b299bed2a Revert "drm/tegra=
...
Merging mm-unstable/mm-unstable (2a8f76e45800 zram: drop wb_limit_lock)
Merging mm-nonmm-unstable/mm-nonmm-unstable (6ec5c7644fbb ceph: replace loc=
...
Merging perf/perf-tools-next (c1932fb85af8 perf vendor metrics s390: Avoid =
...
or-next)
Merging arm64/for-next/core (fc11a25552c8 Merge branch 'for-next/sme-ptrace=
-disable' into for-next/core)
...
Merging arm-soc/for-next (a12dacb5d1ea Merge branch 'arm/fixes' into for-ne=
xt)
...
Merging qcom/for-next (a471bda8d169 Merge branches 'arm32-for-6.19', 'arm64=
...
Merging rockchip/for-next (ed0d2a1a2754 Merge branch 'v6.19-armsoc/drivers'=
 into for-next)
Merging samsung-krzk/for-next (9b23effed3a9 Merge branches 'next/clk', 'nex=
t/defconfig', 'next/drivers' and 'next/dt64' into for-next)
...
s' of ssh://gitolite.kernel.org/pub/scm/linux/kernel/git/sudeep.holla/linux=
 into for-linux-next)
Merging sophgo/for-next (6ac40f461073 Merge branch 'dt/riscv' into for-next)
...
Merging riscv-soc/riscv-soc-for-next (01ad0927f243 Merge branch 'riscv-cach=
...
Merging fs-next (21a6e13f3623 Merge branch 'for-next' of https://git.kernel=
.org/pub/scm/linux/kernel/git/viro/vfs.git)
...
Merging hwmon-staging/hwmon-next (b286d66631bb hwmon: (k10temp) Add AMD Ste=
am Deck APU ID)
...
Merging pm/linux-next (213a25ea89bc Merge branch 'thermal-intel' into linux=
-next)
...
Merging pmdomain/next (e0b972121a15 pmdomain: Extend the genpd governor for=
...
Merging net-next/main (c9dfb92de073 Merge branch 'mlx5-next' of git://git.k=
...
Merging drm/drm-next (f3a1d69f9b38 Merge tag 'amd-drm-next-6.19-2025-11-14'=
 of https://gitlab.freedesktop.org/agd5f/linux into drm-next)
  a63db39a578b ("drm/i915/xe3lpd: Load DMC for Xe3_LPD version 30.02")
...
Merging drm-misc/for-linux-next (92c49b3f4df8 drm/bridge: simple: add the P=
arade PS185HDM DP-to-HDMI bridge)
Merging amdgpu/drm-next (ccd3b4c7c37f drm/amdgpu: Use amdgpu by default on =
SI dedicated GPUs (v2))
Merging drm-intel/for-linux-next (b84befa31266 drm/i915/display: Add defaul=
t case to mipi_exec_send_packet)
Merging drm-msm/msm-next (50a0b122cfc8 drm/msm: Wait for MMU devcoredump wh=
en waiting for GMU)
...
Merging drm-xe/drm-xe-next (c34a14bce709 drm/xe/irq: Handle msix vector0 in=
terrupt)
...
Merging sound/for-next (9c3af1b2f73c ALSA: hda: controllers: intel: add sup=
port for Nova Lake S)
Merging ieee1394/for-next (036176d9dba7 firewire: core: abort pending trans=
actions at card removal)
Merging sound-asoc/for-next (ef86ca232318 Merge remote-tracking branch 'aso=
...
Merging block/for-next (5674abb82e2b Merge branch 'for-6.19/block' into for=
-next)
...
Merging devicetree/for-next (d8c8a575f5aa kbuild: Ensure .dtbo targets are =
applied to a base .dtb)
...
Merging spi/for-next (e86b03c4fcbb Merge remote-tracking branch 'spi/for-6.=
19' into spi-next)
Merging tip/master (6f85aad74a70 Merge branch into tip/master: 'x86/sgx')
...
Merging kvm-x86/next (4531ff85d925 Merge branch 'vmx')
...
PMI driver)
Merging driver-core/driver-core-next (dd6ff5cf56fb rust: io: add typedef fo=
r phys_addr_t)
...
Merging gnss/gnss-next (e738ca230702 gnss: ubx: add support for the safeboo=
t gpio)
...
Merging vhost/linux-next (64990de8c297 vhost: switch to arrays of feature b=
its)
Merging rpmsg/for-next (f982fbb1a6ca Merge branches 'rpmsg-next' and 'rproc=
-next' into for-next)
Merging gpio-brgl/gpio/for-next (67f9b828d4e5 gpio: tegra186: Fix GPIO name=
 collisions for Tegra410)
...
Merging pwm/pwm/for-next (a5d51e02d6fa Merge branch 'pwm/th1520' into pwm/f=
or-next)
...
Merging cxl/next (7ec9db66cc55 Merge branch 'for-6.19/cxl-elc-test' into cx=
l-for-next)
...
Merging rust/rust-next (e5d330e13f67 rust: allow `clippy::disallowed_names`=
 for doctests)
...

=XuLy
-----END PGP SIGNATURE-----
