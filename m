...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id ED4EE42393F
	for <lists+linux-next@lfdr.de>; Wed,  6 Oct 2021 09:57:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S237411AbhJFH67 (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 6 Oct 2021 03:58:59 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:38249 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S237384AbhJFH65 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 6 Oct 2021 03:58:57 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HPRcW6tBRz4xbC;
        Wed,  6 Oct 2021 18:56:59 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1633507020;
        bh=vEMjRGIBKhO1GQ6zEVQLqQEmRlBOj63gAz3ATN8H+Ic=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Wed, 6 Oct 2021 18:56:59 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 6
Message-ID: <20211006185659.09c39219@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/iiQNEAp2YKw5bbuJ3aZ+7pE";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/iiQNEAp2YKw5bbuJ3aZ+7pE
...
The ntfs3 tree gained a conflict against Linus' tree.
...
Non-merge commits (relative to Linus' tree): 5707
 5543 files changed, 293367 insertions(+), 118818 deletions(-)
...
Merging origin/master (60a9483534ed Merge tag 'warning-fixes-20211005' of g=
...
mapping regression)
Merging arm64-fixes/for-next/fixes (12074b059fdc arm64: entry: avoid double=
-accounting IRQ RCU entry)
Merging arm-soc-fixes/arm/fixes (34186b48d29b ARM: sharpsl_param: work arou=
nd -Wstringop-overread warning)
...
Merging net/master (7707a4d01a64 netlink: annotate data races around nlk->b=
ound)
...
Merging sound-current/for-linus (5963e5262180 ALSA: usb-audio: Enable rate =
validation for Scarlett devices)
Merging sound-asoc-fixes/for-linus (602957c1f5ff Merge remote-tracking bran=
ch 'asoc/for-5.15' into asoc-linus)
Merging regmap-fixes/for-linus (6880fa6c5660 Linux 5.15-rc1)
Merging regulator-fixes/for-linus (b2a61dc28505 Merge remote-tracking branc=
h 'regulator/for-5.15' into regulator-linus)
Merging spi-fixes/for-linus (10a5788d2ede Merge remote-tracking branch 'spi=
...
Merging iio-fixes/fixes-togreg (37f12202c5d2 staging: r8188eu: prevent arra=
y underflow in rtw_hal_update_ra_mask())
Merging char-misc.current/char-misc-linus (dfffaf0238e5 Merge tag 'fpga-fix=
es-5.15-rc5' of git://git.kernel.org/pub/scm/linux/kernel/git/mdf/linux-fpg=
...
/linux)
Merging drm-misc-fixes/for-linux-next-fixes (34a1671d48b4 drm/nouveau/debug=
fs: fix file release memory leak)
...
Merging kbuild/for-next (2836b7a7bd05 [for -next only] kconfig: generate in=
...
into for-next)
Merging imx-mxs/for-next (7e651aa2e11c Merge branch 'imx/maintainers' into =
for-next)
...
Merging tegra/for-next (68241c188c90 Merge branch for-5.16/arm64/dt into fo=
r-next)
...
CONFLICT (content): Merge conflict in fs/9p/cache.c
...
X_CHANNELS define)
Merging jc_docs/docs-next (b19511926cb5 Revert "docs: checkpatch: add UNNEC=
ESSARY/UNSPECIFIED_INT and UNNECESSARY_ELSE")
...
Merging pm/linux-next (8e0efc215fb1 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
Merging net-next/master (d0f1c248b4ff Merge tag 'for-net-next-2021-10-01' o=
f git://git.kernel.org/pub/scm/linux/kernel/git/bluetooth/bluetooth-next)
Applying: ethernet: fix up ps3_gelic_net.c for "ethernet: use eth_hw_addr_s=
et()"
...
Merging wireless-drivers-next/master (b3fcf9c5faaa Merge ath-next from git:=
//git.kernel.org/pub/scm/linux/kernel/git/kvalo/ath.git)
Merging bluetooth/master (d0f1c248b4ff Merge tag 'for-net-next-2021-10-01' =
...
Merging amdgpu/drm-next (6b2fb7a0ab99 drm/amdgpu/pm: properly handle sclk f=
or profiling modes on vangogh)
Merging drm-intel/for-linux-next (85bb2f6e1c4b drm/i915/tc: Delete bogus NU=
LL check in intel_ddi_encoder_destroy())
...
lation regression)
Merging sound-asoc/for-next (78ae88f24af1 Merge remote-tracking branch 'aso=
...
Merging block/for-next (a229cea69958 Merge branch 'for-5.16/block' into for=
-next)
...
sung batteries)
Merging regulator/for-next (fd9fed51c4af Merge remote-tracking branch 'regu=
...
Merging spi/for-next (42798d6d6204 Merge remote-tracking branch 'spi/for-5.=
16' into spi-next)
Merging tip/auto-latest (2dd2d9736bc7 Merge branch 'irq/core')
$ git reset --hard HEAD^
Merging next-20211005 version of tip
...
Merging ftrace/for-next (bf094cffea2a x86/kprobes: Fixup return address in =
...
_pv_init_vm)
Merging xen-tip/linux-next (9c11112c0ec7 xen/x86: adjust data placement)
...
ed_cdevs list)
Merging ipmi/for-next (39ce73504695 ipmi: ipmb: Fix off-by-one size check o=
n rcvlen)
...
Merging char-misc/char-misc-next (349f2fe48dfe ipack: ipoctal: rename tty-d=
river pointer)
...
t_string)
Merging akpm-current/current (6a5f6d2737eb ipc/ipc_sysctl.c: remove fallbac=
k for !CONFIG_PROC_SYSCTL)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (049c1f3338f8 mm: unexport {,un}lock_page_memcg)
...

=jvno
-----END PGP SIGNATURE-----
