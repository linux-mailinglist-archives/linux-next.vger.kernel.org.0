...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 26DAA1EB3CA
	for <lists+linux-next@lfdr.de>; Tue,  2 Jun 2020 05:29:21 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725872AbgFBD3U (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 1 Jun 2020 23:29:20 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41704 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725850AbgFBD3U (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 1 Jun 2020 23:29:20 -0400
Received: from mail-pl1-x641.google.com (mail-pl1-x641.google.com [IPv6:2607:f8b0:4864:20::641])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CA140C061A0E
        for <linux-next@vger.kernel.org>; Mon,  1 Jun 2020 20:29:19 -0700 (PDT)
Received: by mail-pl1-x641.google.com with SMTP id n9so784368plk.1
        for <linux-next@vger.kernel.org>; Mon, 01 Jun 2020 20:29:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=kernelci-org.20150623.gappssmtp.com; s=20150623;
        h=message-id:date:mime-version:content-transfer-encoding:subject:to
         :from;
        bh=omXn+2FrpEqRMNjGBBJUmCLuIa2c8SNQqc1JyBvSAco=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=omXn+2FrpEqRMNjGBBJUmCLuIa2c8SNQqc1JyBvSAco=;
        b=
X-Gm-Message-State: AOAM532jLAv07Q0SlZF0ykVbr0AA4PEE43HJZ3LAbBT/oj+Dx0Nc1Rpc
        +qUcALCuHg72ac8/EVTZ0URnLiyJcq4=
X-Google-Smtp-Source: ABdhPJzGVPcpJEUyr1tR5E3W1RBId1C3Ux53n564AV5xh6jmcFEMTMONWgQ0yzReMCh+ptJKV1Ojag==
X-Received: by 2002:a17:90b:4c52:: with SMTP id np18mr2948678pjb.35.1591068557299;
        Mon, 01 Jun 2020 20:29:17 -0700 (PDT)
Received: from kernelci-production.internal.cloudapp.net ([52.250.1.28])
        by smtp.gmail.com with ESMTPSA id z140sm777383pfc.135.2020.06.01.20.29.16
        for <linux-next@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 01 Jun 2020 20:29:16 -0700 (PDT)
Message-ID: <5ed5c78c.1c69fb81.5e079.36f7@mx.google.com>
Date:   Mon, 01 Jun 2020 20:29:16 -0700 (PDT)
...
Subject: next/pending-fixes build: 162 builds: 1 failed, 161 passed, 1 error,
 150 warnings (v5.7-930-g3a1d4c3e458b)
...
next/pending-fixes build: 162 builds: 1 failed, 161 passed, 1 error, 150 wa=
rnings (v5.7-930-g3a1d4c3e458b)
...
tiple instructions
    1    sound/soc/codecs/max98390.c:781:3: warning: format =E2=80=98%ld=E2=
=80=99 expects argument of type =E2=80=98long int=E2=80=99, but argument 4 =
has type =E2=80=98size_t=E2=80=99 {aka =E2=80=98const unsigned int=E2=80=99=
} [-Wformat=3D]
...
g to symbol LEDS_TRIGGER_ONESHOT
    1    /tmp/ccy4pjjC.s:18191: Warning: using r15 results in unpredictable=
 behaviour
    1    /tmp/ccy4pjjC.s:18119: Warning: using r15 results in unpredictable=
 behaviour
...
Warnings:
    /tmp/ccy4pjjC.s:18119: Warning: using r15 results in unpredictable beha=
viour
    /tmp/ccy4pjjC.s:18191: Warning: using r15 results in unpredictable beha=
viour
...
=99 expects argument of type =E2=80=98long int=E2=80=99, but argument 4 has=
 type =E2=80=98size_t=E2=80=99 {aka =E2=80=98const unsigned int=E2=80=99} [=
-Wformat=3D]
