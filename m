...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7059324AED0
	for <lists+linux-next@lfdr.de>; Thu, 20 Aug 2020 07:55:51 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1725793AbgHTFzu (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Thu, 20 Aug 2020 01:55:50 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52162 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725768AbgHTFzk (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Thu, 20 Aug 2020 01:55:40 -0400
Received: from ozlabs.org (bilbo.ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E3126C061757;
        Wed, 19 Aug 2020 22:55:39 -0700 (PDT)
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4BXDQc2G4Tz9sR4;
        Thu, 20 Aug 2020 15:55:36 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1597902936;
        bh=Glvj2Ci+JBN4u1Jqjvpi4MeoEF/G+kXOctvahgzpMKE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Thu, 20 Aug 2020 15:55:35 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Aug 20
Message-ID: <20200820155535.2051ff36@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/s1rLsMPk=4WrgYMTd5sYmrL";
...
I applied a supplied patch for a runtime fault to the selinux tree.

The rcu tree lost its build failure.

The pinctrl-intel tree gained a build failure so I used the version
from next-20200819.

The mhi tree lost its failures.

Non-merge commits (relative to Linus' tree): 1787
 3241 files changed, 56930 insertions(+), 22206 deletions(-)
...
Merging net/master (d1fb55592909 netlink: fix state reallocation in policy =
export)
Merging bpf/master (00fa1d83a8b5 bpftool: Handle EAGAIN error code properly=
 in pids collection)
...
Merging mac80211/master (ad6641189c59 net: ipv4: remove duplicate "the the"=
 phrase in Kconfig text)
...
_limit)
Merging sound-asoc-fixes/for-linus (65e25c29b158 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (41bc5599fe08 Merge remote-tracking branch 'spi=
...
Merging nvdimm-fixes/libnvdimm-fixes (080b2a9dbf93 dax: do not print error =
...
Merging kspp-gustavo/for-next/kspp (efd46a8da025 treewide: Use fallthrough =
pseudo-keyword)
...
Merging dma-mapping/for-next (04d324bf549d dma-mapping: set default segment=
...
Merging ext4/dev (12ada33d7ac4 ext4: limit the length of per-inode prealloc=
 list)
...
in imxfb_probe())
Merging pm/linux-next (1f08d51cd57f Merge branch 'opp/fixes' of git://git.k=
...
Merging net-next/master (e5b15f5af21a Merge branch 'ptp-Add-generic-helper-=
functions')
CONFLICT (content): Merge conflict in lib/nlattr.c
Merging bpf-next/master (c1447efdafff Merge branch 'type-and-enum-value-rel=
os')
...
Merging mac80211-next/master (e3ec1e8ca02b net: eliminate meaningless memcp=
y to data in pskb_carve_inside_nonlinear())
...
Merging sound/for-next (b90b925fd52c ALSA: hda: avoid reset of sdo_limit)
Merging sound-asoc/for-next (8828feede9b2 Merge remote-tracking branch 'aso=
...
Merging selinux/next (69ea651c40f7 selinux: fix allocation failure check on=
 newpolicy->sidtab)
Applying: selinux: avoid dereferencing the policy prior to initialization
...
Merging spi/for-next (e6bf656ae6bf Merge remote-tracking branch 'spi/for-5.=
10' into spi-next)
...
Merging pinctrl-intel/for-next (80c1050d3f49 pinctrl: intel: Update header =
block to reflect direct dependencies)
$ git reset --hard HEAD^
Merging next-20200819 version of pinctrl-intel
...
do_copy)
Merging akpm-current/current (8c4285719116 ROMFS: support inode blocks calc=
ulation)
$ git checkout -b akpm remotes/origin/akpm/master
$ git rebase --onto master remotes/origin/akpm/master-base
Merging akpm/master (cc3af00352dd mm/mmap: add inline munmap_vma_range() fo=
r code readability)
Applying: Revert "dma-mapping: set default segment_boundary_mask to ULONG_M=
AX"
...

=JMhd
-----END PGP SIGNATURE-----
