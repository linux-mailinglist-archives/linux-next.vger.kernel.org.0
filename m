...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9F0C01C0F4E
	for <lists+linux-next@lfdr.de>; Fri,  1 May 2020 10:18:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728325AbgEAISS (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 1 May 2020 04:18:18 -0400
Received: from bilbo.ozlabs.org ([203.11.71.1]:34131 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1728277AbgEAISO (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Fri, 1 May 2020 04:18:14 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 49D4rH30Rdz9sTF;
        Fri,  1 May 2020 18:18:07 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1588321087;
        bh=tv2X3z4yUNQXvG6g+7J8z3JhMW+C3KCJwcfdHLPXDJo=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Fri, 1 May 2020 18:18:03 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for May 1
Message-ID: <20200501181803.04a509f5@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/pEX3KK1XIZONdF_g6QpHJyM";
...
--Sig_/pEX3KK1XIZONdF_g6QpHJyM
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20200430:

The qcom tree still had its build failure for which I reverted a commit.

The btrfs tree gained conflicts against the btrfs-fixes tree.

The net-next tree gained conflicts against the net and kspp-gustavo trees.
...
Non-merge commits (relative to Linus' tree): 5402
 6364 files changed, 192670 insertions(+), 81658 deletions(-)
...
Merging net/master (81d6bc44fa94 Merge tag 'mlx5-fixes-2020-04-29' of git:/=
...
Merging sound-current/for-linus (547d2c9cf4f1 ALSA: usb-audio: Correct a ty=
po of NuPrime DAC-10 USB ID)
Merging sound-asoc-fixes/for-linus (c13d5ffdc541 Merge remote-tracking bran=
...
Merging spi-fixes/for-linus (4aa8da006e71 Merge remote-tracking branch 'spi=
...
vent pool release)
Merging drm-fixes/drm-fixes (6a8b55ed4056 Linux 5.7-rc3)
...
Merging drm-misc-fixes/for-linux-next-fixes (6f49c2515e22 dma-buf: fix docu=
mentation build warnings)
Merging kspp-gustavo/for-next/kspp (f7e2b2478af2 ath10k: fix gcc-10 zero-le=
ngth-bounds warnings)
...
r-next)
Merging qcom/for-next (a7a1e895ef7f Merge branches 'arm64-defconfig-for-5.8=
...
Merging mips/mips-next (da1bd29742b1 MIPS: Loongson64: Probe CPU features v=
ia CPUCFG)
...
ible-array member)
Merging nfs/linux-next (9c07b75b80ee NFS: Fix a race in __nfs_list_for_each=
_server())
...
Merging djw-vfs/vfs-for-next (ee058f43d3e0 fs/xfs: Update xfs_ioctl_setattr=
_dax_invalidate())
...
Merging net-next/master (550cbea0b0f0 Merge branch 'netlink-validation-impr=
ovements-refactoring')
CONFLICT (content): Merge conflict in include/net/mptcp.h
CONFLICT (content): Merge conflict in include/linux/mlx5/mlx5_ifc.h
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlxsw/s=
pectrum_span.c
CONFLICT (content): Merge conflict in drivers/net/ethernet/mellanox/mlx5/co=
re/steering/dr_send.c
Merging bpf-next/master (c32102224470 selftests/bpf: Test allowed maps for =
...
rtion field)
Merging netfilter-next/master (323e395f197f Merge git://git.kernel.org/pub/=
...
/amdgpu_dm.c
Merging amdgpu/drm-next (b7a222c7ddd5 drm/amdgpu: re-enable runtime pm on v=
ega10)
Merging drm-intel/for-linux-next (16e87459673a drm/i915/gt: Move the batch =
buffer pool from the engine to the gt)
CONFLICT (content): Merge conflict in drivers/gpu/drm/i915/display/intel_dd=
i.c
Merging drm-tegra/drm/tegra/for-next (757338371608 drm/tegra: Clean up GPIO=
 includes)
Merging drm-misc/for-linux-next (7837300c250c drm: Correct DP DSC macro typ=
o)
...
Merging sound/for-next (87dc36482cab ALSA: hda/realtek - Add LED class supp=
ort for micmute LED)
Merging sound-asoc/for-next (e2050914084a Merge remote-tracking branch 'aso=
...
Merging block/for-next (95f78d19c346 Merge branch 'io_uring-5.7' into for-n=
ext)
...
Merging battery/for-next (0edb259c98fc power: reset: introduce oxnas-restar=
t)
...
ons)
Merging devicetree/for-next (040636668bff Merge branch 'dt/linus' into 'dt/=
next')
Merging mailbox/mailbox-for-next (0a67003b1985 mailbox: imx: add SCU MU sup=
port)
Merging spi/for-next (c8c4fea4cb1b Merge remote-tracking branch 'spi/for-5.=
8' into spi-next)
...
hvc_open)
Merging char-misc/char-misc-next (7aa428dfc83c greybus: fix typos in GREYBU=
S/GREYBUS_ES2 help text)
...
dropping 87e479430fc43f5f0178755971921f8871cf3709 i915/gvt: remove unused x=
en bits -- patch contents already upstream
Merging akpm/master (25c04a75f14f drivers/media/platform/sti/delta/delta-ip=
...

=I2EN
-----END PGP SIGNATURE-----
