...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id ECE5BA6663
	for <lists+linux-next@lfdr.de>; Tue,  3 Sep 2019 12:17:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726631AbfICKRr (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Tue, 3 Sep 2019 06:17:47 -0400
Received: from ozlabs.org ([203.11.71.1]:49001 "EHLO ozlabs.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726946AbfICKRq (ORCPT <rfc822;linux-next@vger.kernel.org>);
        Tue, 3 Sep 2019 06:17:46 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 46N2vR34K2z9s4Y;
        Tue,  3 Sep 2019 20:17:39 +1000 (AEST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=canb.auug.org.au;
        s=201702; t=1567505859;
        bh=71pX0fF/X2N8bQGeoU3UVsK4/xMs1RJFDNUD8FtyHJE=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Tue, 3 Sep 2019 20:17:37 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 3
Message-ID: <20190903201737.063254ef@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/OwjurPVsHLGw/D0BfMr+X6f";
...
The iommu tree still had its build failure due to an interaction with
the powerpc tree for which I applied a patch.

The devicetree tree gained a conflict against the samsung-krzk tree.

The hmm tree lost its build failure.

Non-merge commits (relative to Linus' tree): 10065
 9921 files changed, 588332 insertions(+), 276201 deletions(-)
...
erging nodes)
Merging netfilter/master (039b1f4f24ec netfilter: nft_socket: fix erroneous=
 socket assignment)
...
g)
Merging sound-current/for-linus (d33cd42d8667 ALSA: hda/realtek - Add quirk=
 for HP Pavilion 15)
Merging sound-asoc-fixes/for-linus (3fbb7e449772 Merge branch 'asoc-5.3' in=
to asoc-linus)
Merging regmap-fixes/for-linus (0161b8716465 Merge branch 'regmap-5.3' into=
 regmap-linus)
Merging regulator-fixes/for-linus (71f0c4894d98 Merge branch 'regulator-5.3=
' into regulator-linus)
Merging spi-fixes/for-linus (12e0a6314389 Merge branch 'spi-5.3' into spi-l=
inus)
...
c_target())
Merging cifs/for-next (f25a9f638c3f smb3: add mount option to allow RW cach=
ing of share accessed by only 1 client)
...
CONFLICT (content): Merge conflict in fs/ext4/ioctl.c
Merging fuse/for-next (0cd80c707791 virtio-fs: add Documentation/filesystem=
s/virtiofs.rst)
...
Merging file-locks/locks-next (cfddf9f4c9f0 locks: fix a memory leak bug in=
 __break_lease())
Merging vfs/for-next (c12b37d7f766 Merge branches 'work.misc', 'work.mount'=
...
Merging hwmon-staging/hwmon-next (9c551fac9ea9 hwmon: (nct7904) Fix incorre=
ct temperature limitation register setting of LTD.)
...
Merging net-next/master (67538eb5c00f Merge branch 'mvpp2-per-cpu-buffers')
...
ence check)
Merging drm-intel/for-linux-next (9e362992ff34 drm/i915: Clean up HDMI deep=
 color handling a bit)
...
-next)
Merging sound/for-next (94044dfb0bcf MAINTAINERS: update entry of firewire =
audio drivers)
Merging sound-asoc/for-next (323b6383af9f Merge branch 'asoc-5.4' into asoc=
-next)
...
Merging regulator/for-next (375e9dad5e3e Merge branch 'regulator-5.4' into =
regulator-next)
Applying: regulator: stubs in header files should be static inline
...
Merging keys/keys-next (c8af88036941 Merge branch 'notifications-core' into=
 keys-next)
...
.c
Applying: iommu: use mem_encrypt_active() instead of sme_active()
...
Merging spi/for-next (a27a6bb4fac7 Merge branch 'spi-5.4' into spi-next)
...
Merging usb/usb-next (7a8114620485 Merge 5.3-rc7 into usb-next)
...
port)
Merging char-misc/char-misc-next (99097a214b0c Merge 5.3-rc7 into char-misc=
-next)
...
Merging staging/staging-next (544b3e7fd2d3 staging: exfat: make exfat depen=
d on BLOCK)
CONFLICT (content): Merge conflict in drivers/staging/Makefile
CONFLICT (content): Merge conflict in drivers/staging/Kconfig
...
Merging kgdb-dt/kgdb/for-next (f12dc871e3ec kgdb: fix comment regarding sta=
tic function)
...
rflow
Merging akpm/master (00b3bd28c4c4 drivers/media/platform/sti/delta/delta-ip=
...

=k/te
-----END PGP SIGNATURE-----
