...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id D795944188D
	for <lists+linux-next@lfdr.de>; Mon,  1 Nov 2021 10:48:51 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233193AbhKAJtU (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Mon, 1 Nov 2021 05:49:20 -0400
Received: from gandalf.ozlabs.org ([150.107.74.76]:52943 "EHLO
        gandalf.ozlabs.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234241AbhKAJr1 (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Mon, 1 Nov 2021 05:47:27 -0400
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4HjSmy1s70z4xfF;
        Mon,  1 Nov 2021 20:44:50 +1100 (AEDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1635759890;
        bh=/j5jGySbSAooqyLSlj6mo+FlFPOPz7tbyisz30d9sVw=;
        h=Date:From:To:Cc:Subject:From;
        b=
Date:   Mon, 1 Nov 2021 20:44:48 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Nov 1
Message-ID: <20211101204448.36494154@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/8QhJKytpVrxU2IDgL+deu9h";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/8QhJKytpVrxU2IDgL+deu9h
...
The btrfs tree lost its build failure but gained a conflict against
Linus' tree.

The drm-misc tree has required a build failure so I applied te same patch.

The block tree gained a conflict against Linus' tree.

The mailbox tree gained conflicts against the arm-soc and devicetree trees.

The scsi tree gained a conflict against the block tree.

The userns tree gained a conflict against the staging tree.

The folios tree inherited a semantic conflict from the akpm-current tree
(a patch from akpm-current was merged into Linus' tree).

I have disabled the ntfs file system for now as it fails a powerpc
allyesconfig build.

Non-merge commits (relative to Linus' tree): 11752
 10926 files changed, 663336 insertions(+), 243304 deletions(-)
...
Merging origin/master (8bb7eca972ad Linux 5.15)
...
Merging net/master (6de6e46d27ef cls_flower: Fix inability to match GRE/IPI=
P packets)
...
ws)
Merging drm-fixes/drm-fixes (b112166a894d MAINTAINERS: dri-devel is for all=
 of drivers/gpu)
Merging amdgpu-fixes/drm-fixes (2c409ba81be2 drm/radeon: fix si_enable_smc_=
cac() failed issue)
Merging drm-intel-fixes/for-linux-next-fixes (9a4aa3a2f160 drm/i915: Revert=
 'guc_id' from i915_request tracepoint)
...
Merging renesas-fixes/fixes (432b52eea3dc ARM: shmobile: defconfig: Restore=
 graphical consoles)
Merging perf-current/perf/urgent (27730c8cd60d perf script: Fix PERF_SAMPLE=
_WEIGHT_STRUCT support)
...
Merging perf/perf/core (624ff63abfd3 perf intel-pt: Support itrace d+o opti=
on to direct debug log to stdout)
...
UG_SIG macro)
Merging parisc-hd/for-next (84345349641c parisc: Fix code/instruction patch=
...
CONFLICT (content): Merge conflict in fs/btrfs/lzo.c
...
_put() before return)
Merging jc_docs/docs-next (1f57bd42b77c docs: submitting-patches: make sect=
...
se_lockspace)
Merging rdma/for-next (6d202d9f70a3 RDMA/hns: Use the core code to manage t=
he fixed mmap entries)
Merging net-next/master (ae0393500e3b net: bridge: switchdev: fix shim defi=
nition for br_switchdev_mdb_notify)
Merging bpf-next/for-next (f48ad69097fe selftests/bpf: Fix fclose/pclose mi=
smatch in test_progs)
...
ifi/iwlwifi-next)
Merging bluetooth/master (d6cba4e6d0e2 Bluetooth: btusb: Add support using =
different nvm for variant WCN6855 controller)
...
Merging amdgpu/drm-next (5930f124b0bb drm/amdgpu: bump driver version for I=
...
Merging sound/for-next (2672e1970ab0 ALSA: firewire-motu: remove TODO for i=
nteraction with userspace about control message)
...
te support)
Merging block/for-next (b43fadb6631f Merge branch 'for-5.16/drivers' into f=
or-next)
CONFLICT (content): Merge conflict in fs/io_uring.c
CONFLICT (content): Merge conflict in drivers/scsi/ufs/ufshpb.c
...
Merging audit/next (d9516f346e8b audit: return early if the filter rule has=
 a lower priority)
CONFLICT (content): Merge conflict in include/uapi/linux/audit.h
Merging devicetree/for-next (a16c4510683f of/unittest: Disable new dtc node=
_name_vs_property_name and interrupt_map warnings)
...
Merging tip/auto-latest (5989725f40fa Merge x86/core into tip/master)
...
Merging ftrace/for-next (93d76e4a0e01 tracing/histogram: Fix documentation =
inline emphasis warning)
...
318 CPNC data)
Merging xen-tip/linux-next (837b21d4c304 xen-pciback: allow compiling on ot=
her archs than x86)
...
Merging drivers-x86/for-next (bf653b61cf5f platform/x86: touchscreen_dmi: A=
dd info for the Viglen Connect 10 tablet)
...
_state())
Merging userns/for-next (2302fcb6e492 Merge of per_signal_struct_coredumps-=
...
Merging akpm/master (2276c629fb05 kasan: add kasan mode messages when kasan=
 init)
...

=ITmh
-----END PGP SIGNATURE-----
