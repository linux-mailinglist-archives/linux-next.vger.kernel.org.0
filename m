...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 62AB67C7D49
	for <lists+linux-next@lfdr.de>; Fri, 13 Oct 2023 07:55:46 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229684AbjJMFzp (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Fri, 13 Oct 2023 01:55:45 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55916 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229671AbjJMFzo (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Fri, 13 Oct 2023 01:55:44 -0400
Received: from gandalf.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1B256C0;
        Thu, 12 Oct 2023 22:55:39 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1697176537;
        bh=NoYOnTYnvkmDNYueXUuWak7F5ce2BEbutch92gntHTQ=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4S6G2K5WL5z4xGC;
        Fri, 13 Oct 2023 16:55:37 +1100 (AEDT)
Date:   Fri, 13 Oct 2023 16:55:36 +1100
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Oct 13
Message-ID: <20231013165536.294d7786@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/_l97k5Tg0dQX9Aie3ac_SQ9";
...
--Sig_/_l97k5Tg0dQX9Aie3ac_SQ9
Content-Type: text/plain; charset=UTF-8
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20231012:

The vfs-brauner tree lost its complex conflicts.

The bpf-next tree gained a build failure for which I applied a patch.

The drm-misc tree gained a conflict agsinst the asm-generic tree.
...
Non-merge commits (relative to Linus' tree): 11227
 9377 files changed, 638634 insertions(+), 194247 deletions(-)
...
Merging origin/master (e8c127b05766 Merge tag 'net-6.6-rc6' of git://git.ke=
...
s.c)
Merging powerpc-fixes/fixes (2205457db485 powerpc/mm: Allow ARCH_FORCE_MAX_=
ORDER up to 12)
...
Merging net/main (b91e8403373c Merge branch 'rswitch-fix-issues-on-specific=
-conditions')
...
problem)
Merging netfilter/main (50e492143374 octeontx2-pf: Fix page pool frag alloc=
ation warning)
...
Merging btrfs-fixes/next-fixes (0e46fb5c8c12 Merge branch 'misc-6.6' into n=
ext-fixes)
...
MA2 channel)
Merging overlayfs-fixes/ovl-fixes (001cef5143c3 ovl: fix regression in show=
...
tems)
Merging cifs/for-next (c1b6e8c524df Add definition for new smb3.1.1 command=
 type)
...
Alloc)
Merging ksmbd/ksmbd-for-next (65a018eab7ee ksmbd: fix potential double free=
 on smb2_read_pipe() error path)
...
Merging nfsd/nfsd-next (568a94b4db76 NFSD: clean up alloc_init_deleg())
...
-mw1' of git://git.kernel.org/pub/scm/linux/kernel/git/riscv/linux)
Merging vfs-brauner/vfs.all (be636e0fa5fd Merge branch 'vfs.super' into vfs=
.all)
...
Merging net-next/main (2f0968a030f2 net: gso_test: fix build with gcc-12 an=
d earlier)
CONFLICT (content): Merge conflict in include/linux/mlx5/device.h
CONFLICT (content): Merge conflict in net/mac80211/key.c
Merging bpf-next/for-next (d2dc885b8c9d Merge branch 'Add cgroup sockaddr h=
ooks for unix sockets')
...
Merging netfilter-next/main (21b2e2624d2e Merge tag 'nf-next-23-10-10' of h=
ttps://git.kernel.org/pub/scm/linux/kernel/git/netfilter/nf-next)
...
Merging wireless-next/for-next (618071ae0f7e wifi: rtw89: coex: add annotat=
ion __counted_by() to struct rtw89_btc_btf_set_mon_reg)
...
21a entry)
Merging crypto/master (30febae71c61 crypto: testmgr - Remove zlib-deflate)
...
- add missing escape)
Merging drm-misc/for-linux-next (a18f17248944 accel/ivpu: Add ivpu_bo_vaddr=
() and ivpu_bo_size())
...
CONFLICT (content): Merge conflict in drivers/gpu/drm/amd/pm/swsmu/smu13/sm=
u_v13_0_6_ppt.c
[master 54f9721bc502] next-20231009/amdgpu
Merging drm-intel/for-linux-next (d0c908d2978e drm/i915: Add new DG2 PCI ID=
s)
...
ith __counted_by)
Merging sound-asoc/for-next (ec31ae5b7533 Merge remote-tracking branch 'aso=
...
Merging input/next (68ede283a1d8 Input: axp20x-pek - avoid needless newline=
 removal)
Merging block/for-next (0f9e710280bf Merge branch 'for-6.7/block' into for-=
next)
...
7' into spi-next)
Merging tip/master (74dd06bc129d Merge branch into tip/master: 'x86/tdx')
...
Merging fpga/for-next (de7a352aabb8 fpga: versal: Add support for 44-bit DM=
A operations)
...
Merging gpio-brgl/gpio/for-next (0c7ef3f861c8 gpio: hisi: Fix format specif=
ier)
$ git reset --hard HEAD^
Merging next-20231012 version of gpio-brgl
...
Merging pinctrl-renesas/renesas-pinctrl (9c43d48c42de pinctrl: renesas: rzn=
...
Merging pwm/for-next (b02229080a8e pwm: bcm2835: Add support for suspend/re=
sume)
...
Applying: fix up for "bpf: Propagate modified uaddrlen from cgroup sockaddr=
 programs"
...

=3L4k
-----END PGP SIGNATURE-----
