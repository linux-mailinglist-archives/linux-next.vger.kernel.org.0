Return-Path: <linux-next+bounces-5906-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 104A7A6A2E8
	for <lists+linux-next@lfdr.de>; Thu, 20 Mar 2025 10:46:08 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 6797A16CB2F
	for <lists+linux-next@lfdr.de>; Thu, 20 Mar 2025 09:46:07 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1E3531581F0;
	Thu, 20 Mar 2025 09:46:04 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="NsVk+73M"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 6825023A0;
	Thu, 20 Mar 2025 09:45:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1742463964; cv=none; b=Qw6q8PnbwU6NonJcylKt9QA03xETaqxp5IDHNmJxlT/J6jz5+OC0IcNVYX+LYp3tQDj84ainM1PHYoPLZYe6JmQ0PnkP0nCbWkdNfXz6TRMS9vwDT83+ddadAXmHegHFK2+cMTyo5o9JgzWwyzXvoE5lfoV4WegKhGd/D4qxvPk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1742463964; c=relaxed/simple;
	bh=s/RVW/6GRBmu6r+u7JyHXdgEzZhLD7GHc/Dnld0nSJE=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=XDWZNHnBUQwZpuhK3MfprSFlgvBe5TFvQdESsjWKaw0yLlcaMdn9sJbvurMV/1b/koNMLZzFMm3SwqHQU+j1zZpYTPjlMm4OVsUfx0r0mYDe9gPrcHCJxjAXhN7tDmq4yb4BOJC0RqgwfOEg48z1PzwIMDvKaZVEu7Ei2TDXiD4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=NsVk+73M; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1742463956;
	bh=OjNQgMFyrsAV7ddGrWQ5WY7h8d94Kk67fbQKKX2jajw=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4ZJLLD2h4sz4x04;
	Thu, 20 Mar 2025 20:45:56 +1100 (AEDT)
Date: Thu, 20 Mar 2025 20:45:55 +1100
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Mar 20
Message-ID: <20250320204555.2e181fd3@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/f4VHpU/jl1+Wo5wr+vbJMFb";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/f4VHpU/jl1+Wo5wr+vbJMFb
Content-Type: text/plain; charset=US-ASCII
Content-Transfer-Encoding: quoted-printable

Hi all,

Changes since 20250319:

The rdma tree gained a conflict against Linus' tree.

The bpf-next tree lost its build failure.

The kvm-arm tree gained a build failure for which I applied a patch.

The driver-core tree still had its build failure due to an interaction
with the drm tree but I applied a supplied patch.

Non-merge commits (relative to Linus' tree): 11572
 11371 files changed, 628545 insertions(+), 240827 deletions(-)
...
Merging origin/master (a7f2e10ecd8f Merge tag 'hwmon-fixes-for-v6.14-rc8/6.=
14' of git://git.kernel.org/pub/scm/linux/kernel/git/groeck/linux-staging)
Merging fixes/fixes (fac04efc5c79 Linux 6.13-rc2)
Merging ext4-fixes/fixes (4bbf9020becb Linux 6.13-rc4)
Merging vfs-brauner-fixes/vfs.fixes (613218fc74b3 Merge patch series "netfs=
: Miscellaneous fixes")
...
YSFSPATH)
Merging vfs-brauner/vfs.all (ddfa097d0d7c Merge branch 'vfs-6.15.rust' into=
 vfs.all)
Merging vfs/for-next (2e72b1e0aac2 Merge branch 'work.d_revalidate' into fo=
r-next)
Merging mm-hotfixes/mm-hotfixes-unstable (76dc47f45176 mm: page_isolation: =
avoid calling folio_hstate() without hugetlb_lock)
Merging fs-current (d7d46b811b75 Merge branch 'fixes' of git://git.kernel.o=
...
Merging net/main (a0aff75e1553 Merge tag 'for-net-2025-03-14' of git://git.=
...
Merging tip-fixes/tip/urgent (5103393f862b Merge branch into tip/master: 'x=
86/urgent')
...
Merging mm/mm-everything (53c20551dddb foo)
Merging kbuild/for-next (1a78774bb350 rust: kbuild: skip `--remap-path-pref=
ix` for `rustdoc`)
Merging clang-format/clang-format (c147f663b6a5 clang-format: Update with v=
6.11-rc1's `for_each` macro list)
Merging perf/perf-tools-next (2b5b834cc3b9 perf kwork: Remove unreachable j=
udgments)
...
.h include)
Merging arm-soc/for-next (2577a0000c59 soc: document merges)
...
Merging fs-next (2401cb9ce290 Merge branch 'for-next' of git://git.kernel.o=
rg/pub/scm/linux/kernel/git/viro/vfs.git)
...
i2c/for-next)
Merging i2c-host/i2c/i2c-host (95a8ca229032 i2c: spacemit: add support for =
SpacemiT K1 SoC)
...
Merging net-next/main (3d97da0ee625 net: macb: Add __nonstring annotations =
...
ntation)
Merging drm-xe/drm-xe-next (b96dabdba9b9 drm/xe: Fix exporting xe buffers m=
ultiple times)
...
Merging sound/for-next (765fee28fe0e ALSA: echoaudio: remove unused variabl=
e)
...
lin-A series)
Merging block/for-next (a11367f141b4 Merge branch 'for-6.15/block' into for=
-next)
...
TION() macros)
Merging mmc/next (f4dfef81e971 mmc: Merge branch fixes into next)
...
type and location)
Merging spi/for-next (91e79a907ca7 Merge remote-tracking branch 'spi/for-6.=
15' into spi-next)
Merging tip/master (050783af2093 Merge branch 'WIP.sched/core')
...
Merging kvm/next (e335300095c3 Merge tag 'loongarch-kvm-6.15' of git://git.=
kernel.org/pub/scm/linux/kernel/git/chenhuacai/linux-loongson into HEAD)
Merging kvm-arm/next (19a3bf93b63a Merge branch 'kvm-arm64/pmu-fixes' into =
new-next)
...
Merging kvm-riscv/riscv_kvm_next (2d117e67f318 RISC-V: KVM: Teardown riscv =
specific bits after kvm_exit)
...
Merging hmm/hmm (739eeb5e6e18 pds_fwctl: add Documentation entries)
...
setuid())
Merging rust/rust-next (4a47eec07be6 rust: kunit: allow to know if we are i=
n a test)
...
name to match code)
Applying: fix up for "Merge branch 'kvm-arm64/pv-cpuid' into new-next"
...

=LBY3
-----END PGP SIGNATURE-----
