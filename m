Return-Path: <linux-next+bounces-3127-lists+linux-next=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-next@lfdr.de
Delivered-To: lists+linux-next@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 9ECF693BADF
	for <lists+linux-next@lfdr.de>; Thu, 25 Jul 2024 04:34:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 34246283A55
	for <lists+linux-next@lfdr.de>; Thu, 25 Jul 2024 02:34:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id ACB9AC8F6;
	Thu, 25 Jul 2024 02:34:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b="AZBbI63m"
X-Original-To: linux-next@vger.kernel.org
Received: from mail.ozlabs.org (gandalf.ozlabs.org [150.107.74.76])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B36BC380;
	Thu, 25 Jul 2024 02:34:17 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=150.107.74.76
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1721874865; cv=none; b=tLWIq1CBFTo4Tb3sgcs9ou2RmJLQp4HdGr4k5EHxybu9NaGdck4wsW92dyqumEVM8UX2fTNr2vwc+sX3l3yqsKztx4kFahd9dVKeSM0BLtfwlfUTBrbX2Rsdv3u10ZI15zVmi2Qe6SsKVGsKulj1S0E/GtPz7rt7YTr7vK2ECRM=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1721874865; c=relaxed/simple;
	bh=sbBt9OuuBUIvPNT8jFfKi0+kiQ3Lxvzp1JOH7se3IZY=;
	h=Date:From:To:Cc:Subject:Message-ID:MIME-Version:Content-Type; b=Gk6ABrOEyWRZRqIRzWVtYNth6eQV9WmEesO9g9QD/GYEd0RYoegJkMfsIouQ9HCOrlsZEi5Nc3mj6QdZ0FAhwx3yR9FURkQeJfoOkb24mMIv9K9uevgDKUPHkEpIgdFLQdWhp2wnF/o0m3mg6BUR02BOgm0HwDZMf4jUdMZcLwY=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au; spf=pass smtp.mailfrom=canb.auug.org.au; dkim=pass (2048-bit key) header.d=canb.auug.org.au header.i=@canb.auug.org.au header.b=AZBbI63m; arc=none smtp.client-ip=150.107.74.76
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=canb.auug.org.au
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=canb.auug.org.au
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
	s=201702; t=1721874856;
	bh=QoIiCnLoO+RZcBTeTIOOoxyKbrzJusNOoE5MbjVyMcM=;
	h=Date:From:To:Cc:Subject:From;
	b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
	(using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
	 key-exchange X25519 server-signature RSA-PSS (4096 bits) server-digest SHA256)
	(Client did not present a certificate)
	by mail.ozlabs.org (Postfix) with ESMTPSA id 4WTw1z74dbz4wbr;
	Thu, 25 Jul 2024 12:34:15 +1000 (AEST)
Date: Thu, 25 Jul 2024 12:34:14 +1000
From: Stephen Rothwell <sfr@canb.auug.org.au>
To: Linux Next Mailing List <linux-next@vger.kernel.org>
Cc: Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Jul 25
Message-ID: <20240725123414.487973c7@canb.auug.org.au>
Precedence: bulk
...
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/7Zgw9OJr6aOOSNkoQJBIdqi";
 protocol="application/pgp-signature"; micalg=pgp-sha256

--Sig_/7Zgw9OJr6aOOSNkoQJBIdqi
...
Changes since 20240724:

Non-merge commits (relative to Linus' tree): 991
 1406 files changed, 53842 insertions(+), 17020 deletions(-)
...
Merging origin/master (c33ffdb70cc6 Merge tag 'phy-for-6.11' of git://git.k=
ernel.org/pub/scm/linux/kernel/git/phy/linux-phy)
Merging fixes/fixes (2dde18cd1d8f Linux 6.5)
Merging mm-hotfixes/mm-hotfixes-unstable (baa280e4ddb3 selftests: mm: add s=
390 to ARCH check)
Merging vfs-brauner-fixes/vfs.fixes (7d82086d2a9f xattr: use simple helper =
to copy xattr name)
...
erify_area())
Merging fs-current (077ec828f8af Merge branch 'nfsd-fixes' of git://git.ker=
...
Merging net/main (7c938e438c56 MAINTAINERS: make Breno the netconsole maint=
ainer)
...
Merging sound-current/for-linus (e6e18021ddd0 ALSA: hda/realtek: cs35l41: F=
ixup remaining asus strix models)
Merging sound-asoc-fixes/for-linus (e6fc5fcaeffa ASoC: SOF: ipc4-topology: =
Preserve the DMA Link ID for ChainDMA on unprepare)
...
Merging staging.current/staging-linus (786c8248dbd3 Merge tag 'perf-tools-f=
ixes-for-v6.11-2024-07-23' of git://git.kernel.org/pub/scm/linux/kernel/git=
/perf/perf-tools)
...
Merging drm-misc-fixes/for-linux-next-fixes (445d336cd158 drm/virtio: Fix t=
ype of dma-fence context variable)
...
Merging ceph/master (5c9e62c1afd3 rbd: don't assume rbd_is_lock_owner() for=
 exclusive mappings)
Merging cifs/for-next (9a819f135764 smb3: add four dynamic tracepoints for =
...
Merging f2fs/dev (786c8248dbd3 Merge tag 'perf-tools-fixes-for-v6.11-2024-0=
7-23' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/perf-tools)
...
[fs-next f919adac9ab0] Merge branch 'vfs.all' of git://git.kernel.org/pub/s=
cm/linux/kernel/git/vfs/vfs.git
Merging vfs/for-next (a38297e3fb01 Linux 6.9)
Merging fs-next (f919adac9ab0 Merge branch 'vfs.all' of git://git.kernel.or=
...
Merging amdgpu/drm-next (629568d25fea drm/amdkfd: Validate queue cwsr area =
and eop buffer size)
...
Merging drm-xe/drm-xe-next (1a394b4f504f drm/xe: Fix possible UAF in guc_ex=
ec_queue_process_msg)
...
Merging sound/for-next (e6e18021ddd0 ALSA: hda/realtek: cs35l41: Fixup rema=
ining asus strix models)
Merging ieee1394/for-next (06dcc4c9baa9 firewire: core: move copy_port_stat=
us() helper function to TP_fast_assign() block)
Merging sound-asoc/for-next (e6fc5fcaeffa ASoC: SOF: ipc4-topology: Preserv=
e the DMA Link ID for ChainDMA on unprepare)
...
Merging staging/staging-next (786c8248dbd3 Merge tag 'perf-tools-fixes-for-=
v6.11-2024-07-23' of git://git.kernel.org/pub/scm/linux/kernel/git/perf/per=
f-tools)
...

=vJzi
-----END PGP SIGNATURE-----
