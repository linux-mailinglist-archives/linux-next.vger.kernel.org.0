...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 35CFA40337C
	for <lists+linux-next@lfdr.de>; Wed,  8 Sep 2021 06:55:26 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230390AbhIHE4b (ORCPT <rfc822;lists+linux-next@lfdr.de>);
        Wed, 8 Sep 2021 00:56:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41478 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229523AbhIHE4b (ORCPT
        <rfc822;linux-next@vger.kernel.org>); Wed, 8 Sep 2021 00:56:31 -0400
Received: from ozlabs.org (ozlabs.org [IPv6:2401:3900:2:1::2])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BA60DC061575;
        Tue,  7 Sep 2021 21:55:23 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=canb.auug.org.au;
        s=201702; t=1631076919;
        bh=Sa+vj+2yaWMKqv4wt0kCtAEyc7Wxy7VZqexN/DRuG+0=;
        h=Date:From:To:Cc:Subject:From;
        b=
Received: from authenticated.ozlabs.org (localhost [127.0.0.1])
        (using TLSv1.3 with cipher TLS_AES_256_GCM_SHA384 (256/256 bits)
         key-exchange ECDHE (P-256) server-signature RSA-PSS (4096 bits) server-digest SHA256)
        (No client certificate requested)
        by mail.ozlabs.org (Postfix) with ESMTPSA id 4H48vq5dhXz9t9b;
        Wed,  8 Sep 2021 14:55:19 +1000 (AEST)
Date:   Wed, 8 Sep 2021 14:55:18 +1000
From:   Stephen Rothwell <sfr@canb.auug.org.au>
To:     Linux Next Mailing List <linux-next@vger.kernel.org>
Cc:     Linux Kernel Mailing List <linux-kernel@vger.kernel.org>
Subject: linux-next: Tree for Sep 8
Message-ID: <20210908145518.1a030729@canb.auug.org.au>
MIME-Version: 1.0
Content-Type: multipart/signed; boundary="Sig_/9uoZ.KAQNZR9nYIDxbZqvtA";
 protocol="application/pgp-signature"; micalg=pgp-sha256
Precedence: bulk
List-ID: <linux-next.vger.kernel.org>
X-Mailing-List: linux-next@vger.kernel.org

--Sig_/9uoZ.KAQNZR9nYIDxbZqvtA
...
Changes since 20210907:

The cxl tree lost its build failure.

I have cherry-picked "kbuild: Only default to -Werror if COMPILE_TEST'
from Linus' tree (since it arrived after I started building linux-next
today).  Hopefulyl this will reduce the failures in the overnight builds.

Non-merge commits (relative to Linus' tree): 1559
 1741 files changed, 92190 insertions(+), 19926 deletions(-)
...
Merging origin/master (626bf91a292e Merge tag 'net-5.15-rc1' of git://git.k=
...
Merging net/master (626bf91a292e Merge tag 'net-5.15-rc1' of git://git.kern=
el.org/pub/scm/linux/kernel/git/netdev/net)
Merging bpf/master (3a029e1f3d6e selftests/bpf: Fix build of task_pt_regs t=
est for arm64)
Merging ipsec/master (b539c44df067 net: wwan: iosm: Unify IO accessors used=
 in the driver)
...
struct rxe_queue)
Merging sound-current/for-linus (c5433f026b27 ALSA: gus: Fix repeated probe=
 for ISA interwave card)
...
Merging parisc-hd/for-next (a9ab1f50b6ca parisc: Reduce sigreturn trampolin=
e to 3 instructions)
...
Merging s390/for-next (7d665612dd5a s390/hmcdrv_ftp: fix kernel doc comment)
...
st_wait())
Merging cifs/for-next (f748b57ebfc5 cifs: move NEGOTIATE_PROTOCOL definitio=
ns out into the common area)
...
Merging pm/linux-next (54f9cb2466e1 Merge branch 'pm-cpufreq' into linux-ne=
xt)
...
Merging drm-misc/for-linux-next (87fd9ef47597 dma-buf: DMABUF_SYSFS_STATS s=
...
Merging sound/for-next (c5433f026b27 ALSA: gus: Fix repeated probe for ISA =
interwave card)
...
Merging block/for-next (fe8452804ee2 Merge branch 'block-5.15' into for-nex=
t)
...
Merging akpm/master (62ebbd49a519 arch: remove compat_alloc_user_space)
Applying: kbuild: Only default to -Werror if COMPILE_TEST
...

=uuO/
-----END PGP SIGNATURE-----
